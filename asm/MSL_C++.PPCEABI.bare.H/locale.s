...
/* 80014974 000107B4  34 63 00 04 */	addic. r3, r3, 0x4
...
/* 800149C4 00010804  81 41 00 00 */	lwz r10, 0x0(r1)
/* 800149C8 00010808  80 0A 00 04 */	lwz r0, 0x4(r10)
...
/* 800149F0 00010830  93 C1 00 08 */	stw r30, 0x8(r1)
/* 800149F4 00010834  7C 7E 1B 78 */	mr r30, r3
/* 800149F8 00010838  41 82 00 28 */	beq lbl_80014A20
/* 800149FC 0001083C  80 03 00 00 */	lwz r0, 0x0(r3)
...
/* 80014A28 00010868  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80014A5C 0001089C  90 A1 00 08 */	stw r5, 0x8(r1)
/* 80014A60 000108A0  80 03 00 00 */	lwz r0, 0x0(r3)
/* 80014A64 000108A4  54 1F 0F FF */	srwi. r31, r0, 31
/* 80014A68 000108A8  40 82 00 18 */	bne lbl_80014A80
/* 80014A6C 000108AC  88 03 00 00 */	lbz r0, 0x0(r3)
/* 80014A70 000108B0  3B 83 00 01 */	addi r28, r3, 0x1
/* 80014A74 000108B4  3B 40 00 0B */	li r26, 0xb
/* 80014A78 000108B8  54 1B 06 7E */	clrlwi r27, r0, 25
/* 80014A7C 000108BC  48 00 00 10 */	b lbl_80014A8C
.global lbl_80014A80
lbl_80014A80:
/* 80014A80 000108C0  83 83 00 08 */	lwz r28, 0x8(r3)
/* 80014A84 000108C4  54 1A 00 7E */	clrlwi r26, r0, 1
/* 80014A88 000108C8  83 63 00 04 */	lwz r27, 0x4(r3)
.global lbl_80014A8C
lbl_80014A8C:
...
.global lbl_80014B10
lbl_80014B10:
/* 80014B10 00010950  38 00 00 00 */	li r0, 0x0
...
/* 80014B64 000109A4  38 81 00 08 */	addi r4, r1, 0x8
...
.global lbl_80014B74
lbl_80014B74:
/* 80014B74 000109B4  3C 60 80 00 */	lis r3, 0x8000
/* 80014B78 000109B8  7F 16 B8 50 */	subf r24, r22, r23
/* 80014B7C 000109BC  38 03 FF FE */	addi r0, r3, -0x2
/* 80014B80 000109C0  83 24 00 00 */	lwz r25, 0x0(r4)
...
.global lbl_80014C18
lbl_80014C18:
/* 80014C18 00010A58  38 00 00 00 */	li r0, 0x0
...
/* 80014C7C 00010ABC  38 1D 00 01 */	addi r0, r29, 0x1
/* 80014C80 00010AC0  54 7A 00 36 */	clrrwi r26, r3, 4
...
/* 80014C90 00010AD0  54 7A 00 36 */	clrrwi r26, r3, 4
.global lbl_80014C94
lbl_80014C94:
...
.global lbl_80014D08
lbl_80014D08:
/* 80014D08 00010B48  80 14 00 00 */	lwz r0, 0x0(r20)
/* 80014D0C 00010B4C  64 00 80 00 */	oris r0, r0, 0x8000
/* 80014D10 00010B50  90 14 00 00 */	stw r0, 0x0(r20)
.global lbl_80014D14
lbl_80014D14:
/* 80014D14 00010B54  80 14 00 00 */	lwz r0, 0x0(r20)
/* 80014D18 00010B58  53 40 00 7E */	rlwimi r0, r26, 0, 1, 31
/* 80014D1C 00010B5C  92 74 00 08 */	stw r19, 0x8(r20)
/* 80014D20 00010B60  93 B4 00 04 */	stw r29, 0x4(r20)
/* 80014D24 00010B64  90 14 00 00 */	stw r0, 0x0(r20)
/* 80014D28 00010B68  48 00 00 EC */	b lbl_80014E14
.global lbl_80014D2C
lbl_80014D2C:
/* 80014D2C 00010B6C  2C 1E 00 00 */	cmpwi r30, 0x0
/* 80014D30 00010B70  38 60 00 00 */	li r3, 0x0
...
.global lbl_80014DB0
lbl_80014DB0:
/* 80014DB0 00010BF0  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 80014DEC 00010C2C  88 14 00 00 */	lbz r0, 0x0(r20)
/* 80014DF0 00010C30  53 A0 06 7E */	rlwimi r0, r29, 0, 25, 31
/* 80014DF4 00010C34  98 14 00 00 */	stb r0, 0x0(r20)
/* 80014DF8 00010C38  48 00 00 08 */	b lbl_80014E00
.global lbl_80014DFC
lbl_80014DFC:
/* 80014DFC 00010C3C  93 B4 00 04 */	stw r29, 0x4(r20)
.global lbl_80014E00
lbl_80014E00:
...
/* 80014E5C 00010C9C  34 63 00 04 */	addic. r3, r3, 0x4
...
/* 80014EAC 00010CEC  81 41 00 00 */	lwz r10, 0x0(r1)
/* 80014EB0 00010CF0  80 0A 00 04 */	lwz r0, 0x4(r10)
