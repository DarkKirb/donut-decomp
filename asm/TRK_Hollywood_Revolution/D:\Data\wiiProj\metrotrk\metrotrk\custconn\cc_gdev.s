...
/* 80015080 00010EC0  38 60 00 00 */	li r3, 0
...
.global gdev_cc_open
gdev_cc_open:
/* 80015094 00010ED4  80 0D E3 08 */	lwz r0, gIsInitialized-_SDA_BASE_(r13)
/* 80015098 00010ED8  2C 00 00 00 */	cmpwi r0, 0
/* 8001509C 00010EDC  41 82 00 0C */	beq lbl_800150A8
/* 800150A0 00010EE0  38 60 D8 EB */	li r3, -10005
/* 800150A4 00010EE4  4E 80 00 20 */	blr 
lbl_800150A8:
/* 800150A8 00010EE8  38 00 00 01 */	li r0, 1
/* 800150AC 00010EEC  90 0D E3 08 */	stw r0, gIsInitialized-_SDA_BASE_(r13)
/* 800150B0 00010EF0  38 60 00 00 */	li r3, 0
...
/* 800150D4 00010F14  3B C0 00 00 */	li r30, 0
/* 800150D8 00010F18  80 0D E3 08 */	lwz r0, gIsInitialized-_SDA_BASE_(r13)
/* 800150DC 00010F1C  2C 00 00 00 */	cmpwi r0, 0
/* 800150E0 00010F20  40 82 00 0C */	bne lbl_800150EC
/* 800150E4 00010F24  38 60 D8 EF */	li r3, -10001
/* 800150E8 00010F28  48 00 00 74 */	b lbl_8001515C
lbl_800150EC:
/* 800150EC 00010F2C  3F E0 80 49 */	lis r31, 0x8049
/* 800150F0 00010F30  48 00 00 40 */	b lbl_80015130
lbl_800150F4:
/* 800150F4 00010F34  3B C0 00 00 */	li r30, 0
/* 800150F8 00010F38  48 03 EC F9 */	bl __wpadNoAlloc
/* 800150FC 00010F3C  2C 03 00 00 */	cmpwi r3, 0
...
/* 8001510C 00010F4C  38 61 00 08 */	addi r3, r1, 8
/* 80015110 00010F50  48 03 EC E1 */	bl __wpadNoAlloc
/* 80015114 00010F54  2C 03 00 00 */	cmpwi r3, 0
...
/* 80015124 00010F64  38 7F 70 D8 */	addi r3, r31, 0x70d8
/* 80015128 00010F68  38 81 00 08 */	addi r4, r1, 8
...
/* 80015140 00010F80  2C 1E 00 00 */	cmpwi r30, 0
...
/* 80015184 00010FC4  93 C1 00 08 */	stw r30, 8(r1)
/* 80015188 00010FC8  7C 7E 1B 78 */	mr r30, r3
/* 8001518C 00010FCC  80 0D E3 08 */	lwz r0, gIsInitialized-_SDA_BASE_(r13)
/* 80015190 00010FD0  2C 00 00 00 */	cmpwi r0, 0
/* 80015194 00010FD4  40 82 00 2C */	bne lbl_800151C0
/* 80015198 00010FD8  38 60 D8 EF */	li r3, -10001
...
/* 800151B0 00010FF0  2C 03 00 00 */	cmpwi r3, 0
...
/* 800151F8 00011038  38 60 00 00 */	li r3, 0
...
/* 8001521C 0001105C  38 60 00 00 */	li r3, 0
...
/* 800152B4 000110F4  38 60 00 00 */	li r3, 0
