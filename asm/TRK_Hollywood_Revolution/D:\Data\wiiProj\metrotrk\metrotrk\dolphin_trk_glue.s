...
/* 80015D3C 00011B7C  80 23 00 04 */	lwz r1, 4(r3)
/* 80015D40 00011B80  80 43 00 08 */	lwz r2, 8(r3)
/* 80015D44 00011B84  A0 A3 01 A2 */	lhz r5, 0x1a2(r3)
/* 80015D48 00011B88  54 A6 07 BD */	rlwinm. r6, r5, 0, 0x1e, 0x1e
/* 80015D4C 00011B8C  41 82 00 14 */	beq lbl_80015D60
/* 80015D50 00011B90  54 A5 07 FA */	rlwinm r5, r5, 0, 0x1f, 0x1d
...
/* 80015D70 00011BB0  7C 8F F1 20 */	mtcrf 0xff, r4
...
/* 80015D90 00011BD0  54 84 04 5E */	rlwinm r4, r4, 0, 0x11, 0xf
/* 80015D94 00011BD4  54 84 07 FA */	rlwinm r4, r4, 0, 0x1f, 0x1d
/* 80015D98 00011BD8  7C 80 01 24 */	mtmsr r4
/* 80015D9C 00011BDC  7C 51 43 A6 */	mtspr 0x111, r2
/* 80015DA0 00011BE0  80 9F 00 0C */	lwz r4, 0xc(r31)
/* 80015DA4 00011BE4  7C 92 43 A6 */	mtspr 0x112, r4
/* 80015DA8 00011BE8  80 9F 00 10 */	lwz r4, 0x10(r31)
/* 80015DAC 00011BEC  7C 93 43 A6 */	mtspr 0x113, r4
...
/* 80015E10 00011C50  93 C1 00 08 */	stw r30, 8(r1)
/* 80015E14 00011C54  3F C0 80 42 */	lis r30, $$2stringBase0@ha
/* 80015E18 00011C58  38 7E 1B 68 */	addi r3, r30, $$2stringBase0@l
/* 80015E1C 00011C5C  4C C6 31 82 */	crclr 6
...
/* 80015E30 00011C70  4C C6 31 82 */	crclr 6
/* 80015E34 00011C74  48 00 7B 5D */	bl OSReport
/* 80015E38 00011C78  2C 1F 00 02 */	cmpwi r31, 2
/* 80015E3C 00011C7C  38 00 00 00 */	li r0, 0
/* 80015E40 00011C80  98 0D E3 20 */	stb r0, TRK_Use_BBA-_SDA_BASE_(r13)
/* 80015E44 00011C84  40 82 00 0C */	bne lbl_80015E50
/* 80015E48 00011C88  38 60 00 00 */	li r3, 0
/* 80015E4C 00011C8C  48 00 00 CC */	b lbl_80015F18
lbl_80015E50:
/* 80015E50 00011C90  2C 1F 00 01 */	cmpwi r31, 1
/* 80015E54 00011C94  40 82 00 98 */	bne lbl_80015EEC
/* 80015E58 00011C98  38 7E 00 3A */	addi r3, r30, 0x3a
/* 80015E5C 00011C9C  4C C6 31 82 */	crclr 6
...
/* 80015EC0 00011D00  38 60 00 00 */	li r3, 0
...
/* 80015ED4 00011D14  91 0C 00 08 */	stw r8, 8(r12)
...
/* 80015EE4 00011D24  90 8C 00 04 */	stw r4, 4(r12)
...
/* 80015F70 00011DB0  38 60 00 00 */	li r3, 0
...
/* 80015F84 00011DC4  88 0D E3 20 */	lbz r0, TRK_Use_BBA-_SDA_BASE_(r13)
/* 80015F88 00011DC8  2C 00 00 00 */	cmpwi r0, 0
...
/* 80015F98 00011DD8  81 83 00 04 */	lwz r12, 4(r3)
/* 80015F9C 00011DDC  2C 0C 00 00 */	cmpwi r12, 0
...
/* 80015FEC 00011E2C  7C 03 FE 70 */	srawi r3, r0, 0x1f
...
/* 80016028 00011E68  7C 03 FE 70 */	srawi r3, r0, 0x1f
...
TRK_board_display:
/* 80016064 00011EA4  3C A0 80 42 */	lis r5, $$2stringBase0@ha
/* 80016068 00011EA8  7C 64 1B 78 */	mr r4, r3
/* 8001606C 00011EAC  38 A5 1B 68 */	addi r5, r5, $$2stringBase0@l
/* 80016070 00011EB0  38 65 00 DD */	addi r3, r5, 0xdd
/* 80016074 00011EB4  4C C6 31 82 */	crclr 6
...
/* 80016084 00011EC4  38 82 85 40 */	addi r4, r2, EndofProgramInstruction$631-_SDA2_BASE_
/* 80016088 00011EC8  38 A0 00 04 */	li r5, 4
...
/* 8001609C 00011EDC  38 7F 00 04 */	addi r3, r31, 4
/* 800160A0 00011EE0  4B FF F5 F1 */	bl TRK_memcpy
/* 800160A4 00011EE4  38 7F 00 04 */	addi r3, r31, 4
/* 800160A8 00011EE8  38 80 00 04 */	li r4, 4
/* 800160AC 00011EEC  48 00 69 C5 */	bl ICInvalidateRange
/* 800160B0 00011EF0  38 7F 00 04 */	addi r3, r31, 4
/* 800160B4 00011EF4  38 80 00 04 */	li r4, 4
