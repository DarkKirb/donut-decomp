...
/* 8001630C 0001214C  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80016310 00012150  48 00 00 C9 */	bl TRK_InitializeEndian
/* 80016314 00012154  2C 03 00 00 */	cmpwi r3, 0x0
...
.global lbl_80016328
lbl_80016328:
/* 80016328 00012168  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8001633C 0001217C  2C 1F 00 00 */	cmpwi r31, 0x0
...
.global lbl_8001634C
lbl_8001634C:
/* 8001634C 0001218C  2C 1F 00 00 */	cmpwi r31, 0x0
...
.global lbl_8001635C
lbl_8001635C:
/* 8001635C 0001219C  2C 1F 00 00 */	cmpwi r31, 0x0
/* 80016360 000121A0  40 82 00 2C */	bne lbl_8001638C
/* 80016364 000121A4  38 60 00 01 */	li r3, 0x1
/* 80016368 000121A8  38 80 00 00 */	li r4, 0x0
/* 8001636C 000121AC  38 AD E3 30 */	addi r5, r13, gTRKInputPendingPtr@sda21
/* 80016370 000121B0  4B FF FB C1 */	bl TRK_InitializeIntDrivenUART
/* 80016374 000121B4  7C 7E 1B 78 */	mr r30, r3
/* 80016378 000121B8  80 6D E3 30 */	lwz r3, gTRKInputPendingPtr@sda21(r13)
/* 8001637C 000121BC  48 00 3C 75 */	bl TRKTargetSetInputPendingPtr
/* 80016380 000121C0  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 80016394 000121D4  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 800163BC 000121FC  38 60 00 00 */	li r3, 0x0
...
TRK_NubWelcome:
/* 800163CC 0001220C  3C 60 80 42 */	lis r3, "@stringBase0_80421C70"@ha
/* 800163D0 00012210  38 63 1C 70 */	addi r3, r3, "@stringBase0_80421C70"@l
...
/* 800163EC 0001222C  98 61 00 08 */	stb r3, 0x8(r1)
/* 800163F0 00012230  38 C0 00 01 */	li r6, 0x1
/* 800163F4 00012234  38 60 00 00 */	li r3, 0x0
/* 800163F8 00012238  98 A1 00 09 */	stb r5, 0x9(r1)
/* 800163FC 0001223C  98 81 00 0A */	stb r4, 0xa(r1)
/* 80016400 00012240  98 01 00 0B */	stb r0, 0xb(r1)
/* 80016404 00012244  80 81 00 08 */	lwz r4, 0x8(r1)
/* 80016408 00012248  90 CD E3 28 */	stw r6, gTRKBigEndian@sda21(r13)
...
/* 80016418 00012258  90 CD E3 28 */	stw r6, gTRKBigEndian@sda21(r13)
...
/* 8001642C 0001226C  38 00 00 00 */	li r0, 0x0
/* 80016430 00012270  90 0D E3 28 */	stw r0, gTRKBigEndian@sda21(r13)
.global lbl_80016434
lbl_80016434:
...
/* 80016440 00012280  38 60 00 01 */	li r3, 0x1
.global lbl_80016444
lbl_80016444:
