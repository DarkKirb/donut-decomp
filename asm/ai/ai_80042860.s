...
/* 80042878 0003E6B8  83 ED E7 58 */	lwz r31, lbl_8055CB78@sda21(r13)
/* 8004287C 0003E6BC  4B FD EF A5 */	bl lbl_80021820
/* 80042880 0003E6C0  93 CD E7 58 */	stw r30, lbl_8055CB78@sda21(r13)
/* 80042884 0003E6C4  4B FD EF DD */	bl lbl_80021860
...
/* 800428CC 0003E70C  4B FD EF 55 */	bl lbl_80021820
...
/* 80042910 0003E750  4B FD EF 51 */	bl lbl_80021860
...
.global lbl_80042990
lbl_80042990:
/* 80042990 0003E7D0  80 6D E7 20 */	lwz r3, lbl_8055CB40@sda21(r13)
...
/* 800429BC 0003E7FC  80 0D E7 20 */	lwz r0, lbl_8055CB40@sda21(r13)
/* 800429C0 0003E800  2C 00 00 01 */	cmpwi r0, 0x1
/* 800429C4 0003E804  41 82 01 40 */	beq lbl_80042B04
/* 800429C8 0003E808  80 6D 81 F0 */	lwz r3, lbl_80556610@sda21(r13)
/* 800429CC 0003E80C  4B FD 8D 15 */	bl lbl_8001B6E0
...
/* 800429FC 0003E83C  90 ED E7 48 */	stw r7, lbl_8055CB68@sda21(r13)
...
/* 80042A0C 0003E84C  90 ED E7 40 */	stw r7, lbl_8055CB60@sda21(r13)
/* 80042A10 0003E850  7C CA 01 D6 */	mullw r6, r10, r0
/* 80042A14 0003E854  3F C0 CD 00 */	lis r30, 0xCD006C00@ha
/* 80042A18 0003E858  90 ED E7 38 */	stw r7, lbl_8055CB58@sda21(r13)
/* 80042A1C 0003E85C  38 00 FF EA */	li r0, -0x16
/* 80042A20 0003E860  90 ED E7 30 */	stw r7, lbl_8055CB50@sda21(r13)
/* 80042A24 0003E864  7C AA 21 D6 */	mullw r5, r10, r4
/* 80042A28 0003E868  90 ED E7 28 */	stw r7, lbl_8055CB48@sda21(r13)
...
/* 80042AB8 0003E8F8  4B FD ED 69 */	bl lbl_80021820
/* 80042ABC 0003E8FC  7C 7D 1B 78 */	mr r29, r3
/* 80042AC0 0003E900  48 00 01 81 */	bl lbl_80042C40
...
/* 80042AD4 0003E914  4B FD ED 8D */	bl lbl_80021860
.global lbl_80042AD8
lbl_80042AD8:
/* 80042AD8 0003E918  38 00 00 00 */	li r0, 0x0
/* 80042ADC 0003E91C  3C 80 80 04 */	lis r4, lbl_80042B20@ha
/* 80042AE0 0003E920  90 0D E7 58 */	stw r0, lbl_8055CB78@sda21(r13)
/* 80042AE4 0003E924  38 84 2B 20 */	addi r4, r4, lbl_80042B20@l
/* 80042AE8 0003E928  38 60 00 05 */	li r3, 0x5
/* 80042AEC 0003E92C  93 ED E7 54 */	stw r31, lbl_8055CB74@sda21(r13)
/* 80042AF0 0003E930  4B FD ED A1 */	bl lbl_80021890
/* 80042AF4 0003E934  3C 60 04 00 */	lis r3, 0x400
/* 80042AF8 0003E938  4B FD F1 79 */	bl lbl_80021C70
/* 80042AFC 0003E93C  38 00 00 01 */	li r0, 0x1
/* 80042B00 0003E940  90 0D E7 20 */	stw r0, lbl_8055CB40@sda21(r13)
.global lbl_80042B04
lbl_80042B04:
...
/* 80042B50 0003E990  4B FD A8 F1 */	bl lbl_8001D440
/* 80042B54 0003E994  38 61 00 08 */	addi r3, r1, 0x8
/* 80042B58 0003E998  4B FD A6 A9 */	bl lbl_8001D200
/* 80042B5C 0003E99C  80 6D E7 58 */	lwz r3, lbl_8055CB78@sda21(r13)
/* 80042B60 0003E9A0  2C 03 00 00 */	cmpwi r3, 0x0
/* 80042B64 0003E9A4  41 82 00 40 */	beq lbl_80042BA4
/* 80042B68 0003E9A8  80 0D E7 24 */	lwz r0, lbl_8055CB44@sda21(r13)
/* 80042B6C 0003E9AC  2C 00 00 00 */	cmpwi r0, 0x0
/* 80042B70 0003E9B0  40 82 00 34 */	bne lbl_80042BA4
/* 80042B74 0003E9B4  80 0D E7 54 */	lwz r0, lbl_8055CB74@sda21(r13)
/* 80042B78 0003E9B8  38 80 00 01 */	li r4, 0x1
/* 80042B7C 0003E9BC  90 8D E7 24 */	stw r4, lbl_8055CB44@sda21(r13)
/* 80042B80 0003E9C0  2C 00 00 00 */	cmpwi r0, 0x0
/* 80042B84 0003E9C4  41 82 00 0C */	beq lbl_80042B90
/* 80042B88 0003E9C8  48 00 00 49 */	bl lbl_80042BD0
...
/* 80042BA0 0003E9E0  90 0D E7 24 */	stw r0, lbl_8055CB44@sda21(r13)
.global lbl_80042BA4
lbl_80042BA4:
/* 80042BA4 0003E9E4  38 61 00 08 */	addi r3, r1, 0x8
/* 80042BA8 0003E9E8  4B FD A8 99 */	bl lbl_8001D440
/* 80042BAC 0003E9EC  7F E3 FB 78 */	mr r3, r31
/* 80042BB0 0003E9F0  4B FD A6 51 */	bl lbl_8001D200
...
/* 80042BE8 0003EA28  3C A0 80 56 */	lis r5, lbl_8055CB70@ha
/* 80042BEC 0003EA2C  38 A5 CB 70 */	addi r5, r5, lbl_8055CB70@l
/* 80042BF0 0003EA30  90 25 00 00 */	stw r1, 0x0(r5)
/* 80042BF4 0003EA34  3C A0 80 56 */	lis r5, lbl_8055CB74@ha
/* 80042BF8 0003EA38  38 A5 CB 74 */	addi r5, r5, lbl_8055CB74@l
...
/* 80042C0C 0003EA4C  3C A0 80 56 */	lis r5, lbl_8055CB70@ha
/* 80042C10 0003EA50  38 A5 CB 70 */	addi r5, r5, lbl_8055CB70@l
...
/* 80042CB8 0003EAF8  4B FE 2E 89 */	bl lbl_80025B40
...
/* 80042D00 0003EB40  4B FE 2E 41 */	bl lbl_80025B40
...
/* 80042D30 0003EB70  81 2D E7 28 */	lwz r9, lbl_8055CB48@sda21(r13)
/* 80042D34 0003EB74  81 6D E7 48 */	lwz r11, lbl_8055CB68@sda21(r13)
...
/* 80042D58 0003EB98  83 CD E7 38 */	lwz r30, lbl_8055CB58@sda21(r13)
...
/* 80042D8C 0003EBCC  80 0D E7 40 */	lwz r0, lbl_8055CB60@sda21(r13)
...
/* 80042DB0 0003EBF0  83 CD E7 30 */	lwz r30, lbl_8055CB50@sda21(r13)
...
.global lbl_80042DD4
lbl_80042DD4:
/* 80042DD4 0003EC14  4B FE 2D 6D */	bl lbl_80025B40
