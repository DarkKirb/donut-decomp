...
/* 8007D4F4 00079334  4B F8 9E 45 */	bl func_80007338
/* 8007D4F8 00079338  3F E0 80 44 */	lis r31, $$2811@ha
/* 8007D4FC 0007933C  7C 7B 1B 78 */	mr r27, r3
/* 8007D500 00079340  7C 9C 23 78 */	mr r28, r4
/* 8007D504 00079344  7C BD 2B 78 */	mr r29, r5
/* 8007D508 00079348  3B FF B1 10 */	addi r31, r31, $$2811@l
/* 8007D50C 0007934C  38 61 00 08 */	addi r3, r1, 8
/* 8007D510 00079350  3B C0 00 00 */	li r30, 0
/* 8007D514 00079354  38 80 00 00 */	li r4, 0
/* 8007D518 00079358  38 A0 00 20 */	li r5, 0x20
/* 8007D51C 0007935C  4B F8 6E 35 */	bl memset
/* 8007D520 00079360  2C 1B 00 00 */	cmpwi r27, 0
...
/* 8007D534 00079374  2C 00 00 00 */	cmpwi r0, 0
...
lbl_8007D56C:
/* 8007D56C 000793AC  38 61 00 08 */	addi r3, r1, 8
/* 8007D570 000793B0  38 9D 00 08 */	addi r4, r29, 8
/* 8007D574 000793B4  3B C0 00 02 */	li r30, 2
/* 8007D578 000793B8  4B FF A9 BD */	bl bdcpy
/* 8007D57C 000793BC  38 60 00 09 */	li r3, 9
...
/* 8007D59C 000793DC  38 61 00 08 */	addi r3, r1, 8
/* 8007D5A0 000793E0  38 9D 00 08 */	addi r4, r29, 8
/* 8007D5A4 000793E4  4B FF A9 91 */	bl bdcpy
/* 8007D5A8 000793E8  38 60 00 09 */	li r3, 9
...
/* 8007D5C4 00079404  A0 1D 00 06 */	lhz r0, 6(r29)
/* 8007D5C8 00079408  98 01 00 0F */	stb r0, 0xf(r1)
/* 8007D5CC 0007940C  48 00 00 8C */	b lbl_8007D658
lbl_8007D5D0:
/* 8007D5D0 00079410  8B DD 00 08 */	lbz r30, 8(r29)
/* 8007D5D4 00079414  28 1E 00 07 */	cmplwi r30, 7
/* 8007D5D8 00079418  41 82 00 14 */	beq lbl_8007D5EC
/* 8007D5DC 0007941C  28 1E 00 05 */	cmplwi r30, 5
/* 8007D5E0 00079420  41 82 00 0C */	beq lbl_8007D5EC
/* 8007D5E4 00079424  28 1E 00 09 */	cmplwi r30, 9
/* 8007D5E8 00079428  40 82 00 18 */	bne lbl_8007D600
lbl_8007D5EC:
/* 8007D5EC 0007942C  38 00 00 0D */	li r0, 0xd
/* 8007D5F0 00079430  98 01 00 08 */	stb r0, 8(r1)
/* 8007D5F4 00079434  A0 1D 00 06 */	lhz r0, 6(r29)
/* 8007D5F8 00079438  98 01 00 09 */	stb r0, 9(r1)
...
/* 8007D608 00079448  28 1E 00 01 */	cmplwi r30, 1
/* 8007D60C 0007944C  41 82 00 4C */	beq lbl_8007D658
/* 8007D610 00079450  A0 7D 00 06 */	lhz r3, 6(r29)
/* 8007D614 00079454  38 00 00 0D */	li r0, 0xd
/* 8007D618 00079458  98 61 00 09 */	stb r3, 9(r1)
/* 8007D61C 0007945C  98 01 00 08 */	stb r0, 8(r1)
/* 8007D620 00079460  48 00 00 38 */	b lbl_8007D658
lbl_8007D624:
/* 8007D624 00079464  38 00 00 0D */	li r0, 0xd
/* 8007D628 00079468  3B C0 00 03 */	li r30, 3
/* 8007D62C 0007946C  98 01 00 08 */	stb r0, 8(r1)
/* 8007D630 00079470  A0 1D 00 06 */	lhz r0, 6(r29)
/* 8007D634 00079474  98 01 00 09 */	stb r0, 9(r1)
/* 8007D638 00079478  48 00 00 20 */	b lbl_8007D658
lbl_8007D63C:
/* 8007D63C 0007947C  88 0D EA F0 */	lbz r0, appl_trace_level-_SDA_BASE_(r13)
/* 8007D640 00079480  28 00 00 01 */	cmplwi r0, 1
/* 8007D644 00079484  41 80 00 14 */	blt lbl_8007D658
/* 8007D648 00079488  A0 BD 00 06 */	lhz r5, 6(r29)
/* 8007D64C 0007948C  38 9F 00 00 */	addi r4, r31, 0
/* 8007D650 00079490  38 60 05 00 */	li r3, 0x500
/* 8007D654 00079494  4B FF A3 0D */	bl LogMsg_0
lbl_8007D658:
/* 8007D658 00079498  57 C3 04 3F */	clrlwi. r3, r30, 0x10
/* 8007D65C 0007949C  41 82 01 C4 */	beq lbl_8007D820
/* 8007D660 000794A0  3C A0 80 4F */	lis r5, bta_hh_cb@ha
/* 8007D664 000794A4  38 81 00 08 */	addi r4, r1, 8
...
lbl_8007D67C:
/* 8007D67C 000794BC  88 0D EA F0 */	lbz r0, appl_trace_level-_SDA_BASE_(r13)
/* 8007D680 000794C0  8B DB 00 1C */	lbz r30, 0x1c(r27)
/* 8007D684 000794C4  28 00 00 04 */	cmplwi r0, 4
/* 8007D688 000794C8  41 80 00 70 */	blt lbl_8007D6F8
/* 8007D68C 000794CC  2C 1E 00 02 */	cmpwi r30, 2
/* 8007D690 000794D0  41 82 00 34 */	beq lbl_8007D6C4
/* 8007D694 000794D4  40 80 00 14 */	bge lbl_8007D6A8
/* 8007D698 000794D8  2C 1E 00 00 */	cmpwi r30, 0
...
lbl_8007D6A8:
/* 8007D6A8 000794E8  2C 1E 00 04 */	cmpwi r30, 4
...
/* 8007D704 00079544  57 9C 06 3E */	clrlwi r28, r28, 0x18
/* 8007D708 00079548  38 04 FF FF */	addi r0, r4, -1
...
/* 8007D71C 0007955C  88 03 00 01 */	lbz r0, 1(r3)
...
/* 8007D734 00079574  54 00 15 BA */	rlwinm r0, r0, 2, 0x16, 0x1d
...
/* 8007D75C 0007959C  88 0D EA F0 */	lbz r0, appl_trace_level-_SDA_BASE_(r13)
/* 8007D760 000795A0  28 00 00 05 */	cmplwi r0, 5
/* 8007D764 000795A4  41 80 00 BC */	blt lbl_8007D820
/* 8007D768 000795A8  2C 1E 00 02 */	cmpwi r30, 2
/* 8007D76C 000795AC  41 82 00 34 */	beq lbl_8007D7A0
/* 8007D770 000795B0  40 80 00 14 */	bge lbl_8007D784
/* 8007D774 000795B4  2C 1E 00 00 */	cmpwi r30, 0
...
lbl_8007D784:
/* 8007D784 000795C4  2C 1E 00 04 */	cmpwi r30, 4
...
lbl_8007D7D0:
/* 8007D7D0 00079610  2C 03 00 04 */	cmpwi r3, 4
...
/* 8007D824 00079664  4B F8 9B 61 */	bl func_80007384
...
/* 8007D84C 0007968C  3B E0 00 00 */	li r31, 0
/* 8007D850 00079690  93 C1 00 08 */	stw r30, 8(r1)
/* 8007D854 00079694  7C 7E 1B 78 */	mr r30, r3
/* 8007D858 00079698  A0 03 00 00 */	lhz r0, 0(r3)
...
/* 8007D8AC 000796EC  38 63 00 08 */	addi r3, r3, 8
...
/* 8007D8D0 00079710  38 63 00 08 */	addi r3, r3, 8
...
/* 8007D8E4 00079724  A0 03 00 06 */	lhz r0, 6(r3)
...
lbl_8007D8F8:
/* 8007D8F8 00079738  A0 03 00 06 */	lhz r0, 6(r3)
...
lbl_8007D914:
/* 8007D914 00079754  54 C0 06 3E */	clrlwi r0, r6, 0x18
...
/* 8007D924 00079764  54 C0 2C F4 */	rlwinm r0, r6, 5, 0x13, 0x1a
...
lbl_8007D934:
/* 8007D934 00079774  88 0D EA F0 */	lbz r0, appl_trace_level-_SDA_BASE_(r13)
/* 8007D938 00079778  28 00 00 05 */	cmplwi r0, 5
/* 8007D93C 0007977C  41 80 00 1C */	blt lbl_8007D958
/* 8007D940 00079780  3C 80 80 44 */	lis r4, $$2840@ha
/* 8007D944 00079784  A0 BE 00 06 */	lhz r5, 6(r30)
/* 8007D948 00079788  38 84 B1 EC */	addi r4, r4, $$2840@l
/* 8007D94C 0007978C  54 C6 06 3E */	clrlwi r6, r6, 0x18
/* 8007D950 00079790  38 60 05 04 */	li r3, 0x504
/* 8007D954 00079794  4B FF A0 0D */	bl LogMsg_0
lbl_8007D958:
/* 8007D958 00079798  A0 9E 00 00 */	lhz r4, 0(r30)
...
/* 8007D96C 000797AC  38 60 00 01 */	li r3, 1
/* 8007D970 000797B0  83 C1 00 08 */	lwz r30, 8(r1)
...
bta_hh_evt_code:
/* 8007D984 000797C4  38 03 E9 00 */	addi r0, r3, -5888
/* 8007D988 000797C8  3C 80 80 44 */	lis r4, $$2811@ha
/* 8007D98C 000797CC  28 00 00 0F */	cmplwi r0, 0xf
/* 8007D990 000797D0  38 84 B1 10 */	addi r4, r4, $$2811@l
/* 8007D994 000797D4  41 81 00 9C */	bgt lbl_8007DA30
/* 8007D998 000797D8  3C 60 80 44 */	lis r3, $$2877@ha
/* 8007D99C 000797DC  54 00 10 3A */	slwi r0, r0, 2
/* 8007D9A0 000797E0  38 63 B3 B0 */	addi r3, r3, $$2877@l
