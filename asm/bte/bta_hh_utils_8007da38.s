...
/* 8007DA48 00079888  4B F8 98 F5 */	bl lbl_8000733C
/* 8007DA4C 0007988C  3F E0 80 4F */	lis r31, lbl_804F5D28@ha
/* 8007DA50 00079890  3F C0 80 44 */	lis r30, lbl_8043B3F0@ha
/* 8007DA54 00079894  7C 7B 1B 78 */	mr r27, r3
/* 8007DA58 00079898  3B 80 00 00 */	li r28, 0x0
/* 8007DA5C 0007989C  3B DE B3 F0 */	addi r30, r30, lbl_8043B3F0@l
/* 8007DA60 000798A0  3B FF 5D 28 */	addi r31, r31, lbl_804F5D28@l
.global lbl_8007DA64
lbl_8007DA64:
/* 8007DA64 000798A4  57 9D 2C F4 */	rlwinm r29, r28, 5, 19, 26
...
/* 8007DA74 000798B4  4B FF A4 F5 */	bl lbl_80077F68
/* 8007DA78 000798B8  2C 03 00 00 */	cmpwi r3, 0x0
/* 8007DA7C 000798BC  40 82 00 44 */	bne lbl_8007DAC0
/* 8007DA80 000798C0  7F 63 DB 78 */	mr r3, r27
/* 8007DA84 000798C4  38 82 E4 48 */	addi r4, r2, lbl_805643C8@sda21
/* 8007DA88 000798C8  4B FF A4 E1 */	bl lbl_80077F68
/* 8007DA8C 000798CC  2C 03 00 00 */	cmpwi r3, 0x0
/* 8007DA90 000798D0  41 82 00 30 */	beq lbl_8007DAC0
/* 8007DA94 000798D4  88 0D EA F0 */	lbz r0, lbl_8055CF10@sda21(r13)
/* 8007DA98 000798D8  28 00 00 05 */	cmplwi r0, 0x5
/* 8007DA9C 000798DC  41 80 00 1C */	blt lbl_8007DAB8
/* 8007DAA0 000798E0  7C 7F EA 14 */	add r3, r31, r29
/* 8007DAA4 000798E4  38 9E 00 00 */	addi r4, r30, 0x0
/* 8007DAA8 000798E8  88 C3 00 26 */	lbz r6, 0x26(r3)
/* 8007DAAC 000798EC  57 85 06 3E */	clrlwi r5, r28, 24
/* 8007DAB0 000798F0  38 60 05 04 */	li r3, 0x504
/* 8007DAB4 000798F4  4B FF 9E AD */	bl lbl_80077960
.global lbl_8007DAB8
lbl_8007DAB8:
...
.global lbl_8007DAC0
lbl_8007DAC0:
/* 8007DAC0 00079900  88 0D EA F0 */	lbz r0, lbl_8055CF10@sda21(r13)
/* 8007DAC4 00079904  28 00 00 05 */	cmplwi r0, 0x5
...
/* 8007DAD8 00079918  57 86 06 3E */	clrlwi r6, r28, 24
...
/* 8007DAE8 00079928  4B FF 9E 79 */	bl lbl_80077960
.global lbl_8007DAEC
lbl_8007DAEC:
/* 8007DAEC 0007992C  3B 9C 00 01 */	addi r28, r28, 0x1
/* 8007DAF0 00079930  28 1C 00 10 */	cmplwi r28, 0x10
/* 8007DAF4 00079934  41 80 FF 70 */	blt lbl_8007DA64
/* 8007DAF8 00079938  3C 80 80 4F */	lis r4, lbl_804F5D28@ha
/* 8007DAFC 0007993C  38 00 00 10 */	li r0, 0x10
/* 8007DB00 00079940  38 84 5D 28 */	addi r4, r4, lbl_804F5D28@l
/* 8007DB04 00079944  3B A0 00 00 */	li r29, 0x0
/* 8007DB08 00079948  7C 09 03 A6 */	mtctr r0
.global lbl_8007DB0C
lbl_8007DB0C:
/* 8007DB0C 0007994C  57 A0 2C F4 */	rlwinm r0, r29, 5, 19, 26
/* 8007DB10 00079950  7C 64 02 14 */	add r3, r4, r0
/* 8007DB14 00079954  88 03 00 28 */	lbz r0, 0x28(r3)
/* 8007DB18 00079958  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8007DB28 00079968  4B FF A4 0D */	bl lbl_80077F34
/* 8007DB2C 0007996C  48 00 00 0C */	b lbl_8007DB38
.global lbl_8007DB30
lbl_8007DB30:
/* 8007DB30 00079970  3B BD 00 01 */	addi r29, r29, 0x1
/* 8007DB34 00079974  42 00 FF D8 */	bdnz lbl_8007DB0C
.global lbl_8007DB38
lbl_8007DB38:
/* 8007DB38 00079978  88 0D EA F0 */	lbz r0, lbl_8055CF10@sda21(r13)
/* 8007DB3C 0007997C  28 00 00 05 */	cmplwi r0, 0x5
/* 8007DB40 00079980  41 80 00 18 */	blt lbl_8007DB58
/* 8007DB44 00079984  38 9E 00 58 */	addi r4, r30, 0x58
/* 8007DB48 00079988  57 A5 06 3E */	clrlwi r5, r29, 24
/* 8007DB4C 0007998C  38 60 05 04 */	li r3, 0x504
/* 8007DB50 00079990  38 C0 00 10 */	li r6, 0x10
/* 8007DB54 00079994  4B FF 9E 0D */	bl lbl_80077960
.global lbl_8007DB58
lbl_8007DB58:
...
/* 8007DB60 000799A0  4B F8 98 29 */	bl lbl_80007388
...
/* 8007DB84 000799C4  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8007DB98 000799D8  3C 80 80 4F */	lis r4, lbl_804F5D28@ha
/* 8007DB9C 000799DC  38 00 00 10 */	li r0, 0x10
/* 8007DBA0 000799E0  38 84 5D 28 */	addi r4, r4, lbl_804F5D28@l
...
/* 8007DBB0 000799F0  38 63 00 04 */	addi r3, r3, 0x4
/* 8007DBB4 000799F4  4B FF AA CD */	bl lbl_80078680
/* 8007DBB8 000799F8  7F C3 F3 78 */	mr r3, r30
/* 8007DBBC 000799FC  38 80 00 00 */	li r4, 0x0
/* 8007DBC0 00079A00  38 A0 00 20 */	li r5, 0x20
/* 8007DBC4 00079A04  4B F8 67 8D */	bl func_80004350
/* 8007DBC8 00079A08  38 60 00 01 */	li r3, 0x1
...
/* 8007DBE0 00079A20  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8007DC04 00079A44  4B F8 97 35 */	bl lbl_80007338
/* 8007DC08 00079A48  88 0D EA F0 */	lbz r0, lbl_8055CF10@sda21(r13)
/* 8007DC0C 00079A4C  7C 7A 1B 78 */	mr r26, r3
/* 8007DC10 00079A50  7C 9B 23 78 */	mr r27, r4
/* 8007DC14 00079A54  7C BC 2B 78 */	mr r28, r5
/* 8007DC18 00079A58  28 00 00 05 */	cmplwi r0, 0x5
...
/* 8007DC2C 00079A6C  3C 80 80 44 */	lis r4, lbl_8043B474@ha
/* 8007DC30 00079A70  7F C5 F3 78 */	mr r5, r30
/* 8007DC34 00079A74  38 84 B4 74 */	addi r4, r4, lbl_8043B474@l
/* 8007DC38 00079A78  38 60 05 04 */	li r3, 0x504
/* 8007DC3C 00079A7C  4B FF 9D 25 */	bl lbl_80077960
.global lbl_8007DC40
lbl_8007DC40:
/* 8007DC40 00079A80  38 00 00 01 */	li r0, 0x1
/* 8007DC44 00079A84  2C 1D 00 00 */	cmpwi r29, 0x0
...
/* 8007DC60 00079AA0  38 7A 00 04 */	addi r3, r26, 0x4
/* 8007DC64 00079AA4  4B FF AA 1D */	bl lbl_80078680
/* 8007DC68 00079AA8  A0 7D 00 00 */	lhz r3, 0x0(r29)
/* 8007DC6C 00079AAC  2C 03 00 00 */	cmpwi r3, 0x0
/* 8007DC70 00079AB0  41 82 00 28 */	beq lbl_8007DC98
/* 8007DC74 00079AB4  4B FF 70 0D */	bl lbl_80074C80
/* 8007DC78 00079AB8  2C 03 00 00 */	cmpwi r3, 0x0
/* 8007DC7C 00079ABC  90 7A 00 04 */	stw r3, 0x4(r26)
/* 8007DC80 00079AC0  41 82 00 18 */	beq lbl_8007DC98
/* 8007DC84 00079AC4  A0 1D 00 00 */	lhz r0, 0x0(r29)
/* 8007DC88 00079AC8  B0 1A 00 00 */	sth r0, 0x0(r26)
/* 8007DC8C 00079ACC  80 9D 00 04 */	lwz r4, 0x4(r29)
/* 8007DC90 00079AD0  A0 BD 00 00 */	lhz r5, 0x0(r29)
/* 8007DC94 00079AD4  4B F8 63 6D */	bl func_80004000
.global lbl_8007DC98
lbl_8007DC98:
/* 8007DC98 00079AD8  39 61 00 20 */	addi r11, r1, 0x20
/* 8007DC9C 00079ADC  4B F8 96 E9 */	bl lbl_80007384
...
.global lbl_8007DCB0
lbl_8007DCB0:
/* 8007DCB0 00079AF0  80 ED 84 B0 */	lwz r7, lbl_805568D0@sda21(r13)
/* 8007DCB4 00079AF4  54 89 F6 BE */	extrwi r9, r4, 6, 24
/* 8007DCB8 00079AF8  39 00 00 00 */	li r8, 0x0
/* 8007DCBC 00079AFC  88 A7 00 00 */	lbz r5, 0x0(r7)
/* 8007DCC0 00079B00  48 00 00 30 */	b lbl_8007DCF0
.global lbl_8007DCC4
lbl_8007DCC4:
/* 8007DCC4 00079B04  80 87 00 04 */	lwz r4, 0x4(r7)
/* 8007DCC8 00079B08  55 06 0D FC */	rlwinm r6, r8, 1, 23, 30
...
/* 8007DCDC 00079B1C  88 04 00 01 */	lbz r0, 0x1(r4)
/* 8007DCE0 00079B20  98 03 00 15 */	stb r0, 0x15(r3)
/* 8007DCE4 00079B24  38 60 00 01 */	li r3, 0x1
/* 8007DCE8 00079B28  4E 80 00 20 */	blr
.global lbl_8007DCEC
lbl_8007DCEC:
/* 8007DCEC 00079B2C  39 08 00 01 */	addi r8, r8, 0x1
.global lbl_8007DCF0
lbl_8007DCF0:
/* 8007DCF0 00079B30  55 00 06 3E */	clrlwi r0, r8, 24
/* 8007DCF4 00079B34  7C 00 28 40 */	cmplw r0, r5
/* 8007DCF8 00079B38  41 80 FF CC */	blt lbl_8007DCC4
/* 8007DCFC 00079B3C  38 60 00 00 */	li r3, 0x0
...
/* 8007DD18 00079B58  3F C0 80 44 */	lis r30, lbl_8043B3F0@ha
/* 8007DD1C 00079B5C  3B DE B3 F0 */	addi r30, r30, lbl_8043B3F0@l
/* 8007DD20 00079B60  93 A1 00 14 */	stw r29, 0x14(r1)
/* 8007DD24 00079B64  88 0D EA F0 */	lbz r0, lbl_8055CF10@sda21(r13)
/* 8007DD28 00079B68  28 00 00 05 */	cmplwi r0, 0x5
...
/* 8007DD38 00079B78  4B FF 9C 29 */	bl lbl_80077960
.global lbl_8007DD3C
lbl_8007DD3C:
/* 8007DD3C 00079B7C  3C 60 80 4F */	lis r3, lbl_804F5D28@ha
/* 8007DD40 00079B80  3B A0 00 00 */	li r29, 0x0
/* 8007DD44 00079B84  3B E3 5D 28 */	addi r31, r3, lbl_804F5D28@l
.global lbl_8007DD48
lbl_8007DD48:
/* 8007DD48 00079B88  88 0D EA F0 */	lbz r0, lbl_8055CF10@sda21(r13)
/* 8007DD4C 00079B8C  28 00 00 05 */	cmplwi r0, 0x5
/* 8007DD50 00079B90  41 80 00 24 */	blt lbl_8007DD74
/* 8007DD54 00079B94  57 A0 2C F4 */	rlwinm r0, r29, 5, 19, 26
/* 8007DD58 00079B98  38 9E 02 20 */	addi r4, r30, 0x220
/* 8007DD5C 00079B9C  7C FF 02 14 */	add r7, r31, r0
/* 8007DD60 00079BA0  57 A5 06 3E */	clrlwi r5, r29, 24
...
/* 8007DD70 00079BB0  4B FF 9B F1 */	bl lbl_80077960
.global lbl_8007DD74
lbl_8007DD74:
/* 8007DD74 00079BB4  88 0D EA F0 */	lbz r0, lbl_8055CF10@sda21(r13)
/* 8007DD78 00079BB8  28 00 00 05 */	cmplwi r0, 0x5
/* 8007DD7C 00079BBC  41 80 00 28 */	blt lbl_8007DDA4
/* 8007DD80 00079BC0  57 A0 2C F4 */	rlwinm r0, r29, 5, 19, 26
...
/* 8007DDA0 00079BE0  4B FF 9B C1 */	bl lbl_80077960
.global lbl_8007DDA4
lbl_8007DDA4:
/* 8007DDA4 00079BE4  3B BD 00 01 */	addi r29, r29, 0x1
/* 8007DDA8 00079BE8  28 1D 00 10 */	cmplwi r29, 0x10
/* 8007DDAC 00079BEC  41 80 FF 9C */	blt lbl_8007DD48
/* 8007DDB0 00079BF0  88 0D EA F0 */	lbz r0, lbl_8055CF10@sda21(r13)
/* 8007DDB4 00079BF4  28 00 00 05 */	cmplwi r0, 0x5
...
/* 8007DDC4 00079C04  4B FF 9B 9D */	bl lbl_80077960
.global lbl_8007DDC8
lbl_8007DDC8:
