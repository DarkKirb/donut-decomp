...
/* 80078264 000740A4  38 80 00 00 */	li r4, 0x0
...
/* 80078280 000740C0  80 AD 84 B8 */	lwz r5, p_bta_sys_cfg@sda21(r13)
...
/* 80078290 000740D0  88 A5 00 03 */	lbz r5, 0x3(r5)
...
/* 800782A0 000740E0  80 6D 84 B8 */	lwz r3, p_bta_sys_cfg@sda21(r13)
/* 800782A4 000740E4  88 03 00 04 */	lbz r0, 0x4(r3)
/* 800782A8 000740E8  98 0D EA F0 */	stb r0, appl_trace_level@sda21(r13)
...
/* 800782D0 00074110  3B E0 00 01 */	li r31, 0x1
/* 800782D4 00074114  93 C1 00 08 */	stw r30, 0x8(r1)
/* 800782D8 00074118  7C 7E 1B 78 */	mr r30, r3
/* 800782DC 0007411C  88 0D EA F0 */	lbz r0, appl_trace_level@sda21(r13)
/* 800782E0 00074120  28 00 00 04 */	cmplwi r0, 0x4
/* 800782E4 00074124  41 80 00 18 */	blt lbl_800782FC
/* 800782E8 00074128  3C 80 80 44 */	lis r4, "@587_8043AA20"@ha
/* 800782EC 0007412C  A0 BE 00 00 */	lhz r5, 0x0(r30)
/* 800782F0 00074130  38 84 AA 20 */	addi r4, r4, "@587_8043AA20"@l
...
/* 80078300 00074140  A0 9E 00 00 */	lhz r4, 0x0(r30)
...
/* 80078310 00074150  2C 00 00 00 */	cmpwi r0, 0x0
...
.global lbl_80078330
lbl_80078330:
/* 80078330 00074170  54 A0 06 3E */	clrlwi r0, r5, 24
/* 80078334 00074174  28 00 00 1A */	cmplwi r0, 0x1a
/* 80078338 00074178  40 80 00 2C */	bge lbl_80078364
/* 8007833C 0007417C  54 A0 15 BA */	rlwinm r0, r5, 2, 22, 29
/* 80078340 00074180  7C 63 00 2E */	lwzx r3, r3, r0
/* 80078344 00074184  2C 03 00 00 */	cmpwi r3, 0x0
/* 80078348 00074188  41 82 00 1C */	beq lbl_80078364
/* 8007834C 0007418C  81 83 00 00 */	lwz r12, 0x0(r3)
...
.global lbl_80078364
lbl_80078364:
/* 80078364 000741A4  88 0D EA F0 */	lbz r0, appl_trace_level@sda21(r13)
/* 80078368 000741A8  28 00 00 02 */	cmplwi r0, 0x2
/* 8007836C 000741AC  41 80 00 18 */	blt lbl_80078384
/* 80078370 000741B0  3C 80 80 44 */	lis r4, "@588_8043AA34"@ha
/* 80078374 000741B4  54 A5 06 3E */	clrlwi r5, r5, 24
/* 80078378 000741B8  38 84 AA 34 */	addi r4, r4, "@588_8043AA34"@l
/* 8007837C 000741BC  38 60 05 01 */	li r3, 0x501
/* 80078380 000741C0  4B FF F5 E1 */	bl LogMsg_0
.global lbl_80078384
lbl_80078384:
/* 80078384 000741C4  57 E0 06 3F */	clrlwi. r0, r31, 24
...
/* 8007839C 000741DC  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 800783B8 000741F8  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 800783D0 00074210  54 60 15 BA */	rlwinm r0, r3, 2, 22, 29
...
bta_sys_sendmsg:
/* 800783E0 00074220  80 8D 84 B8 */	lwz r4, p_bta_sys_cfg@sda21(r13)
...
/* 800783F4 00074234  88 84 00 02 */	lbz r4, 0x2(r4)
...
/* 80078448 00074288  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8007844C 0007428C  3B C0 00 00 */	li r30, 0x0
.global lbl_80078450
lbl_80078450:
/* 80078450 00074290  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 80078454 00074294  2C 03 00 00 */	cmpwi r3, 0x0
/* 80078458 00074298  41 82 00 18 */	beq lbl_80078470
/* 8007845C 0007429C  81 83 00 04 */	lwz r12, 0x4(r3)
/* 80078460 000742A0  2C 0C 00 00 */	cmpwi r12, 0x0
/* 80078464 000742A4  41 82 00 0C */	beq lbl_80078470
/* 80078468 000742A8  7D 89 03 A6 */	mtctr r12
/* 8007846C 000742AC  4E 80 04 21 */	bctrl
.global lbl_80078470
lbl_80078470:
/* 80078470 000742B0  3B DE 00 01 */	addi r30, r30, 0x1
/* 80078474 000742B4  3B FF 00 04 */	addi r31, r31, 0x4
...
/* 80078488 000742C8  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80078498 000742D8  98 6D EA F0 */	stb r3, appl_trace_level@sda21(r13)
