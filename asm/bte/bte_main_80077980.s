...
/* 80077998 000737D8  00 00 00 00 */	.4byte 0x00000000
/* 8007799C 000737DC  00 00 00 00 */	.4byte 0x00000000
.global BTA_Init
BTA_Init:
...
/* 800779AC 000737EC  38 00 00 00 */	li r0, 0x0
/* 800779B0 000737F0  93 E1 00 0C */	stw r31, 0xc(r1)
/* 800779B4 000737F4  90 0D EA E4 */	stw r0, _bte_app_info@sda21(r13)
...
/* 800779C8 00073808  38 0D 84 C8 */	addi r0, r13, bte_hcisu_h2_cfg@sda21
/* 800779CC 0007380C  38 63 7D E8 */	addi r3, r3, hcisu_h2@l
/* 800779D0 00073810  90 6D EA D8 */	stw r3, p_hcisu_if@sda21(r13)
/* 800779D4 00073814  38 60 00 00 */	li r3, 0x0
/* 800779D8 00073818  90 0D EA DC */	stw r0, p_hcisu_cfg@sda21(r13)
...
.global lbl_800779EC
lbl_800779EC:
/* 800779EC 0007382C  80 0D 84 80 */	lwz r0, wait4hci@sda21(r13)
/* 800779F0 00073830  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80077A38 00073878  38 E0 00 00 */	li r7, 0x0
/* 80077A3C 0007387C  54 08 D9 7C */	rlwinm r8, r0, 27, 5, 30
/* 80077A40 00073880  4B FA 40 91 */	bl OSSetPeriodicAlarm
/* 80077A44 00073884  38 60 00 00 */	li r3, 0x0
...
/* 80077A7C 000738BC  00 00 00 00 */	.4byte 0x00000000
.global BTA_CleanUp
BTA_CleanUp:
...
/* 80077A8C 000738CC  90 6D EA E4 */	stw r3, _bte_app_info@sda21(r13)
...
/* 80077AB4 000738F4  00 00 00 00 */	.4byte 0x00000000
/* 80077AB8 000738F8  00 00 00 00 */	.4byte 0x00000000
/* 80077ABC 000738FC  00 00 00 00 */	.4byte 0x00000000
.global bta_usb_close_evt
bta_usb_close_evt:
/* 80077AC0 00073900  81 8D EA E4 */	lwz r12, _bte_app_info@sda21(r13)
/* 80077AC4 00073904  2C 0C 00 00 */	cmpwi r12, 0x0
...
/* 80077AD4 00073914  38 60 00 00 */	li r3, 0x0
/* 80077AD8 00073918  7D 89 03 A6 */	mtctr r12
/* 80077ADC 0007391C  4E 80 04 20 */	bctr
.global lbl_80077AE0
lbl_80077AE0:
/* 80077AE0 00073920  38 60 00 01 */	li r3, 0x1
