...
/* 80077AF8 00073938  38 60 00 01 */	li r3, 1
/* 80077AFC 0007393C  90 01 00 14 */	stw r0, 0x14(r1)
/* 80077B00 00073940  38 00 00 00 */	li r0, 0
/* 80077B04 00073944  98 6D 84 D0 */	stb r3, btu_count-_SDA_BASE_(r13)
/* 80077B08 00073948  90 6D 84 D4 */	stw r3, execute_btu-_SDA_BASE_(r13)
/* 80077B0C 0007394C  90 0D EA E8 */	stw r0, _btu_g_count-_SDA_BASE_(r13)
/* 80077B10 00073950  90 0D EA EC */	stw r0, _btu_last_timer_tick-_SDA_BASE_(r13)
...
/* 80077B40 00073980  4B F8 F7 F9 */	bl func_80007338
/* 80077B44 00073984  3B C0 00 00 */	li r30, 0
/* 80077B48 00073988  4B FA DF F9 */	bl OSGetTime
/* 80077B4C 0007398C  80 6D EA E8 */	lwz r3, _btu_g_count-_SDA_BASE_(r13)
/* 80077B50 00073990  38 03 00 01 */	addi r0, r3, 1
/* 80077B54 00073994  90 0D EA E8 */	stw r0, _btu_g_count-_SDA_BASE_(r13)
/* 80077B58 00073998  4B FF E8 89 */	bl GKI_disable
/* 80077B5C 0007399C  80 0D 84 D4 */	lwz r0, execute_btu-_SDA_BASE_(r13)
/* 80077B60 000739A0  2C 00 00 00 */	cmpwi r0, 0
/* 80077B64 000739A4  41 82 00 18 */	beq lbl_80077B7C
/* 80077B68 000739A8  38 60 00 00 */	li r3, 0
/* 80077B6C 000739AC  38 00 00 01 */	li r0, 1
/* 80077B70 000739B0  90 6D 84 D4 */	stw r3, execute_btu-_SDA_BASE_(r13)
/* 80077B74 000739B4  98 0D 84 D0 */	stb r0, btu_count-_SDA_BASE_(r13)
/* 80077B78 000739B8  48 00 00 18 */	b lbl_80077B90
lbl_80077B7C:
/* 80077B7C 000739BC  88 6D 84 D0 */	lbz r3, btu_count-_SDA_BASE_(r13)
/* 80077B80 000739C0  38 03 00 01 */	addi r0, r3, 1
/* 80077B84 000739C4  98 0D 84 D0 */	stb r0, btu_count-_SDA_BASE_(r13)
...
/* 80077B94 000739D4  80 6D EA EC */	lwz r3, _btu_last_timer_tick-_SDA_BASE_(r13)
/* 80077B98 000739D8  3B E0 00 05 */	li r31, 5
/* 80077B9C 000739DC  80 8D EA E8 */	lwz r4, _btu_g_count-_SDA_BASE_(r13)
...
/* 80077BAC 000739EC  90 8D EA EC */	stw r4, _btu_last_timer_tick-_SDA_BASE_(r13)
...
lbl_80077BC0:
/* 80077BC0 00073A00  57 E0 07 FF */	clrlwi. r0, r31, 0x1f
/* 80077BC4 00073A04  3B C0 00 01 */	li r30, 1
/* 80077BC8 00073A08  41 82 01 00 */	beq lbl_80077CC8
/* 80077BCC 00073A0C  48 00 00 E8 */	b lbl_80077CB4
lbl_80077BD0:
/* 80077BD0 00073A10  A0 03 00 00 */	lhz r0, 0(r3)
/* 80077BD4 00073A14  3B C0 00 00 */	li r30, 0
/* 80077BD8 00073A18  54 1C 04 2E */	rlwinm r28, r0, 0, 0x10, 0x17
...
lbl_80077C4C:
/* 80077C4C 00073A8C  3B 40 00 00 */	li r26, 0
/* 80077C50 00073A90  38 80 00 00 */	li r4, 0
/* 80077C54 00073A94  48 00 00 3C */	b lbl_80077C90
lbl_80077C58:
/* 80077C58 00073A98  57 40 1D 78 */	rlwinm r0, r26, 3, 0x15, 0x1c
/* 80077C5C 00073A9C  7C 7D 02 14 */	add r3, r29, r0
/* 80077C60 00073AA0  81 83 00 14 */	lwz r12, 0x14(r3)
/* 80077C64 00073AA4  2C 8C 00 00 */	cmpwi cr1, r12, 0
...
/* 80077C88 00073AC8  38 80 00 01 */	li r4, 1
lbl_80077C8C:
/* 80077C8C 00073ACC  3B 5A 00 01 */	addi r26, r26, 1
lbl_80077C90:
/* 80077C90 00073AD0  2C 04 00 00 */	cmpwi r4, 0
/* 80077C94 00073AD4  40 82 00 10 */	bne lbl_80077CA4
/* 80077C98 00073AD8  57 40 06 3E */	clrlwi r0, r26, 0x18
/* 80077C9C 00073ADC  28 00 00 06 */	cmplwi r0, 6
/* 80077CA0 00073AE0  41 80 FF B8 */	blt lbl_80077C58
lbl_80077CA4:
/* 80077CA4 00073AE4  2C 04 00 00 */	cmpwi r4, 0
...
/* 80077CF0 00073B30  3B C0 00 00 */	li r30, 0
...
lbl_80077D24:
/* 80077D24 00073B64  2C 00 00 08 */	cmpwi r0, 8
...
lbl_80077DD8:
/* 80077DD8 00073C18  3B 60 00 00 */	li r27, 0
/* 80077DDC 00073C1C  38 80 00 00 */	li r4, 0
/* 80077DE0 00073C20  48 00 00 38 */	b lbl_80077E18
lbl_80077DE4:
/* 80077DE4 00073C24  57 60 1D 78 */	rlwinm r0, r27, 3, 0x15, 0x1c
/* 80077DE8 00073C28  7C 7D 02 14 */	add r3, r29, r0
/* 80077DEC 00073C2C  81 83 00 04 */	lwz r12, 4(r3)
/* 80077DF0 00073C30  2C 0C 00 00 */	cmpwi r12, 0
/* 80077DF4 00073C34  41 82 00 20 */	beq lbl_80077E14
/* 80077DF8 00073C38  80 03 00 00 */	lwz r0, 0(r3)
...
/* 80077E10 00073C50  38 80 00 01 */	li r4, 1
lbl_80077E14:
/* 80077E14 00073C54  3B 7B 00 01 */	addi r27, r27, 1
lbl_80077E18:
/* 80077E18 00073C58  2C 04 00 00 */	cmpwi r4, 0
/* 80077E1C 00073C5C  40 82 00 10 */	bne lbl_80077E2C
/* 80077E20 00073C60  57 60 06 3E */	clrlwi r0, r27, 0x18
/* 80077E24 00073C64  28 00 00 02 */	cmplwi r0, 2
/* 80077E28 00073C68  41 80 FF BC */	blt lbl_80077DE4
lbl_80077E2C:
/* 80077E2C 00073C6C  83 9D 00 40 */	lwz r28, 0x40(r29)
/* 80077E30 00073C70  2C 1C 00 00 */	cmpwi r28, 0
/* 80077E34 00073C74  41 82 00 10 */	beq lbl_80077E44
/* 80077E38 00073C78  80 1C 00 0C */	lwz r0, 0xc(r28)
/* 80077E3C 00073C7C  2C 00 00 00 */	cmpwi r0, 0
/* 80077E40 00073C80  41 82 FE A8 */	beq lbl_80077CE8
lbl_80077E44:
/* 80077E44 00073C84  57 E0 07 7B */	rlwinm. r0, r31, 0, 0x1d, 0x1d
/* 80077E48 00073C88  41 82 00 20 */	beq lbl_80077E68
/* 80077E4C 00073C8C  48 00 00 0C */	b lbl_80077E58
lbl_80077E50:
/* 80077E50 00073C90  3B C0 00 00 */	li r30, 0
/* 80077E54 00073C94  48 00 04 6D */	bl bta_sys_event
lbl_80077E58:
/* 80077E58 00073C98  38 60 00 02 */	li r3, 2
/* 80077E5C 00073C9C  4B FF D4 35 */	bl GKI_read_mbox
/* 80077E60 00073CA0  2C 03 00 00 */	cmpwi r3, 0
/* 80077E64 00073CA4  40 82 FF EC */	bne lbl_80077E50
lbl_80077E68:
/* 80077E68 00073CA8  57 E0 06 B5 */	rlwinm. r0, r31, 0, 0x1a, 0x1a
/* 80077E6C 00073CAC  41 82 00 10 */	beq lbl_80077E7C
/* 80077E70 00073CB0  57 E0 06 F2 */	rlwinm r0, r31, 0, 0x1b, 0x19
/* 80077E74 00073CB4  54 1F 04 3E */	clrlwi r31, r0, 0x10
/* 80077E78 00073CB8  48 00 05 35 */	bl bta_sys_timer_update
lbl_80077E7C:
/* 80077E7C 00073CBC  57 E0 04 21 */	rlwinm. r0, r31, 0, 0x10, 0x10
/* 80077E80 00073CC0  40 82 00 0C */	bne lbl_80077E8C
lbl_80077E84:
/* 80077E84 00073CC4  2C 1E 00 00 */	cmpwi r30, 0
/* 80077E88 00073CC8  41 82 FD 38 */	beq lbl_80077BC0
lbl_80077E8C:
/* 80077E8C 00073CCC  38 00 00 01 */	li r0, 1
/* 80077E90 00073CD0  90 0D 84 D4 */	stw r0, execute_btu-_SDA_BASE_(r13)
lbl_80077E94:
/* 80077E94 00073CD4  39 61 00 20 */	addi r11, r1, 0x20
/* 80077E98 00073CD8  4B F8 F4 ED */	bl func_80007384
...
/* 80077EAC 00073CEC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
