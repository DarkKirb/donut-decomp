...
/* 800761C8 00072008  3C A0 00 03 */	lis r5, 0x00028AE0@ha
/* 800761CC 0007200C  38 80 00 00 */	li r4, 0
/* 800761D0 00072010  90 01 00 14 */	stw r0, 0x14(r1)
/* 800761D4 00072014  38 A5 8A E0 */	addi r5, r5, 0x00028AE0@l
/* 800761D8 00072018  93 E1 00 0C */	stw r31, 0xc(r1)
/* 800761DC 0007201C  93 C1 00 08 */	stw r30, 8(r1)
...
/* 800761F4 00072034  3B FE 96 A8 */	addi r31, r30, -26968
/* 800761F8 00072038  38 80 00 01 */	li r4, 1
/* 800761FC 0007203C  3C 7F 00 03 */	addis r3, r31, 3
/* 80076200 00072040  38 00 00 00 */	li r0, 0
...
/* 8007629C 000720DC  38 03 FF FF */	addi r0, r3, -1
/* 800762A0 000720E0  98 1E 96 A8 */	stb r0, -0x6958(r30)
/* 800762A4 000720E4  54 00 15 BA */	rlwinm r0, r0, 2, 0x16, 0x1d
/* 800762A8 000720E8  7C 7F 02 14 */	add r3, r31, r0
/* 800762AC 000720EC  80 63 00 04 */	lwz r3, 4(r3)
...
/* 80076334 00072174  57 C0 0D FC */	rlwinm r0, r30, 1, 0x17, 0x1e
/* 80076338 00072178  88 A7 96 A8 */	lbz r5, gki_cb@l(r7)
/* 8007633C 0007217C  38 C7 96 A8 */	addi r6, r7, -26968
/* 80076340 00072180  3C 86 00 03 */	addis r4, r6, 3
...
/* 80076350 00072190  90 65 00 04 */	stw r3, 4(r5)
/* 80076354 00072194  88 67 96 A8 */	lbz r3, -0x6958(r7)
/* 80076358 00072198  38 03 00 01 */	addi r0, r3, 1
...
/* 80076370 000721B0  38 03 FF FF */	addi r0, r3, -1
/* 80076374 000721B4  98 07 96 A8 */	stb r0, -0x6958(r7)
/* 80076378 000721B8  54 00 15 BA */	rlwinm r0, r0, 2, 0x16, 0x1d
/* 8007637C 000721BC  7C 66 02 14 */	add r3, r6, r0
/* 80076380 000721C0  80 63 00 04 */	lwz r3, 4(r3)
/* 80076384 000721C4  4B FA B4 DD */	bl OSRestoreInterrupts
/* 80076388 000721C8  38 60 00 00 */	li r3, 0
lbl_8007638C:
/* 8007638C 000721CC  80 01 00 14 */	lwz r0, 0x14(r1)
/* 80076390 000721D0  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 80076394 000721D4  83 C1 00 08 */	lwz r30, 8(r1)
/* 80076398 000721D8  7C 08 03 A6 */	mtlr r0
/* 8007639C 000721DC  38 21 00 10 */	addi r1, r1, 0x10
/* 800763A0 000721E0  4E 80 00 20 */	blr 
/* 800763A4 000721E4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800763A8 000721E8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800763AC 000721EC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global GKI_enable
GKI_enable:
/* 800763B0 000721F0  3C A0 80 4D */	lis r5, gki_cb@ha
/* 800763B4 000721F4  88 85 96 A8 */	lbz r4, gki_cb@l(r5)
/* 800763B8 000721F8  38 65 96 A8 */	addi r3, r5, -26968
/* 800763BC 000721FC  38 04 FF FF */	addi r0, r4, -1
/* 800763C0 00072200  98 05 96 A8 */	stb r0, -0x6958(r5)
/* 800763C4 00072204  54 00 15 BA */	rlwinm r0, r0, 2, 0x16, 0x1d
/* 800763C8 00072208  7C 63 02 14 */	add r3, r3, r0
/* 800763CC 0007220C  80 63 00 04 */	lwz r3, 4(r3)
/* 800763D0 00072210  4B FA B4 90 */	b OSRestoreInterrupts
/* 800763D4 00072214  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800763D8 00072218  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800763DC 0007221C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80076424 00072264  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80076428 00072268  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8007642C 0007226C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80076440 00072280  2C 03 00 00 */	cmpwi r3, 0
/* 80076444 00072284  40 82 00 08 */	bne lbl_8007644C
/* 80076448 00072288  38 60 00 00 */	li r3, 0
lbl_8007644C:
...
/* 8007645C 0007229C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global GKI_os_free
GKI_os_free:
/* 80076460 000722A0  4B FE F3 10 */	b App_MEMfree
/* 80076464 000722A4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80076468 000722A8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8007646C 000722AC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
