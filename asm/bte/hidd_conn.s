...
/* 8008CF40 00088D80  28 00 00 04 */	cmplwi r0, 4
/* 8008CF44 00088D84  41 80 00 18 */	blt lbl_8008CF5C
/* 8008CF48 00088D88  3C 60 00 1E */	lis r3, 0x001E0003@ha
/* 8008CF4C 00088D8C  3C 80 80 44 */	lis r4, $$21275@ha
/* 8008CF50 00088D90  38 63 00 03 */	addi r3, r3, 0x001E0003@l
/* 8008CF54 00088D94  38 84 D0 E0 */	addi r4, r4, $$21275@l
/* 8008CF58 00088D98  4B FE AA 09 */	bl LogMsg_0
lbl_8008CF5C:
/* 8008CF5C 00088D9C  38 00 00 00 */	li r0, 0
/* 8008CF60 00088DA0  3B C0 00 01 */	li r30, 1
...
/* 8008CF80 00088DC0  54 60 04 3F */	clrlwi. r0, r3, 0x10
/* 8008CF84 00088DC4  B0 7D 00 14 */	sth r3, 0x14(r29)
/* 8008CF88 00088DC8  40 82 00 30 */	bne lbl_8008CFB8
/* 8008CF8C 00088DCC  38 7F 8A D0 */	addi r3, r31, -30000
/* 8008CF90 00088DD0  88 03 01 41 */	lbz r0, 0x141(r3)
/* 8008CF94 00088DD4  28 00 00 02 */	cmplwi r0, 2
/* 8008CF98 00088DD8  41 80 00 18 */	blt lbl_8008CFB0
/* 8008CF9C 00088DDC  3C 60 00 1E */	lis r3, 0x001E0001@ha
/* 8008CFA0 00088DE0  3C 80 80 44 */	lis r4, $$21276@ha
/* 8008CFA4 00088DE4  38 63 00 01 */	addi r3, r3, 0x001E0001@l
/* 8008CFA8 00088DE8  38 84 D0 F8 */	addi r4, r4, $$21276@l
...
/* 8008CFBC 00088DFC  38 60 00 00 */	li r3, 0
lbl_8008CFC0:
