...
/* 800A00C8 0009BF08  38 63 00 08 */	addi r3, r3, 8
/* 800A00CC 0009BF0C  A0 A4 00 04 */	lhz r5, 4(r4)
/* 800A00D0 0009BF10  A0 04 00 02 */	lhz r0, 2(r4)
/* 800A00D4 0009BF14  7C A4 2A 14 */	add r5, r4, r5
/* 800A00D8 0009BF18  38 80 00 05 */	li r4, 5
/* 800A00DC 0009BF1C  3B E5 00 08 */	addi r31, r5, 8
...
/* 800A016C 0009BFAC  38 DF 00 04 */	addi r6, r31, 4
...
/* 800A0180 0009BFC0  38 DF 00 04 */	addi r6, r31, 4
...
/* 800A0194 0009BFD4  38 DF 00 04 */	addi r6, r31, 4
...
/* 800A01A4 0009BFE4  38 A0 00 03 */	li r5, 3
/* 800A01A8 0009BFE8  38 C0 00 00 */	li r6, 0
...
/* 800A01BC 0009BFFC  28 00 00 02 */	cmplwi r0, 2
/* 800A01C0 0009C000  41 80 00 1C */	blt lbl_800A01DC
/* 800A01C4 0009C004  3C 60 00 0A */	lis r3, 0x000A0001@ha
/* 800A01C8 0009C008  3C 80 80 44 */	lis r4, $$21040@ha
/* 800A01CC 0009C00C  7F A5 EB 78 */	mr r5, r29
/* 800A01D0 0009C010  38 63 00 01 */	addi r3, r3, 0x000A0001@l
/* 800A01D4 0009C014  38 84 FE F8 */	addi r4, r4, $$21040@l
...
/* 800A0210 0009C050  38 00 00 00 */	li r0, 0
...
/* 800A022C 0009C06C  3A 60 00 00 */	li r19, 0
/* 800A0230 0009C070  48 00 11 25 */	bl sdpu_extract_uid_seq
/* 800A0234 0009C074  2C 03 00 00 */	cmpwi r3, 0
...
/* 800A0244 0009C084  2C 00 00 00 */	cmpwi r0, 0
...
/* 800A0254 0009C094  38 A0 00 03 */	li r5, 3
/* 800A0258 0009C098  38 C0 00 00 */	li r6, 0
/* 800A025C 0009C09C  48 00 0F BD */	bl sdpu_build_n_send_error
/* 800A0260 0009C0A0  48 00 03 94 */	b lbl_800A05F4
lbl_800A0264:
/* 800A0264 0009C0A4  88 83 00 00 */	lbz r4, 0(r3)
/* 800A0268 0009C0A8  88 03 00 01 */	lbz r0, 1(r3)
/* 800A026C 0009C0AC  54 83 40 2E */	slwi r3, r4, 8
/* 800A0270 0009C0B0  7C 03 02 14 */	add r0, r3, r0
/* 800A0274 0009C0B4  54 12 04 3E */	clrlwi r18, r0, 0x10
...
lbl_800A0284:
/* 800A0284 0009C0C4  39 C1 00 08 */	addi r14, r1, 8
/* 800A0288 0009C0C8  3A 00 00 00 */	li r16, 0
...
/* 800A029C 0009C0DC  2C 03 00 00 */	cmpwi r3, 0
/* 800A02A0 0009C0E0  7C 73 1B 78 */	mr r19, r3
/* 800A02A4 0009C0E4  41 82 00 20 */	beq lbl_800A02C4
/* 800A02A8 0009C0E8  80 63 00 00 */	lwz r3, 0(r3)
/* 800A02AC 0009C0EC  56 00 13 BA */	rlwinm r0, r16, 2, 0xe, 0x1d
/* 800A02B0 0009C0F0  3A 10 00 01 */	addi r16, r16, 1
/* 800A02B4 0009C0F4  7C 6E 01 2E */	stwx r3, r14, r0
lbl_800A02B8:
/* 800A02B8 0009C0F8  56 00 04 3E */	clrlwi r0, r16, 0x10
/* 800A02BC 0009C0FC  7C 00 90 40 */	cmplw r0, r18
/* 800A02C0 0009C100  41 80 FF D0 */	blt lbl_800A0290
lbl_800A02C4:
/* 800A02C4 0009C104  88 0F 00 02 */	lbz r0, 2(r15)
/* 800A02C8 0009C108  2C 00 00 00 */	cmpwi r0, 0
/* 800A02CC 0009C10C  41 82 00 6C */	beq lbl_800A0338
/* 800A02D0 0009C110  28 00 00 02 */	cmplwi r0, 2
/* 800A02D4 0009C114  38 6F 00 03 */	addi r3, r15, 3
...
/* 800A02E4 0009C124  38 A0 00 05 */	li r5, 5
/* 800A02E8 0009C128  38 C0 00 00 */	li r6, 0
/* 800A02EC 0009C12C  48 00 0F 2D */	bl sdpu_build_n_send_error
/* 800A02F0 0009C130  48 00 03 04 */	b lbl_800A05F4
lbl_800A02F4:
/* 800A02F4 0009C134  88 03 00 00 */	lbz r0, 0(r3)
/* 800A02F8 0009C138  88 63 00 01 */	lbz r3, 1(r3)
...
/* 800A0308 0009C148  54 7F 04 3E */	clrlwi r31, r3, 0x10
...
/* 800A031C 0009C15C  38 A0 00 05 */	li r5, 5
/* 800A0320 0009C160  38 C0 00 00 */	li r6, 0
...
/* 800A0330 0009C170  54 04 04 3E */	clrlwi r4, r0, 0x10
/* 800A0334 0009C174  48 00 00 0C */	b lbl_800A0340
lbl_800A0338:
/* 800A0338 0009C178  7E 04 83 78 */	mr r4, r16
/* 800A033C 0009C17C  3B E0 00 00 */	li r31, 0
lbl_800A0340:
/* 800A0340 0009C180  A0 7E 00 20 */	lhz r3, 0x20(r30)
/* 800A0344 0009C184  54 80 04 3E */	clrlwi r0, r4, 0x10
/* 800A0348 0009C188  38 63 FF F4 */	addi r3, r3, -12
/* 800A034C 0009C18C  7C 63 16 70 */	srawi r3, r3, 2
/* 800A0350 0009C190  7C 63 01 94 */	addze r3, r3
/* 800A0354 0009C194  54 6F 04 3E */	clrlwi r15, r3, 0x10
...
/* 800A036C 0009C1AC  38 00 00 01 */	li r0, 1
...
lbl_800A037C:
/* 800A037C 0009C1BC  38 60 00 02 */	li r3, 2
/* 800A0380 0009C1C0  4B FD 4A A1 */	bl GKI_getpoolbuf
/* 800A0384 0009C1C4  2C 03 00 00 */	cmpwi r3, 0
...
/* 800A0398 0009C1D8  28 00 00 01 */	cmplwi r0, 1
/* 800A039C 0009C1DC  41 80 02 58 */	blt lbl_800A05F4
/* 800A03A0 0009C1E0  3C 80 80 44 */	lis r4, $$21122@ha
/* 800A03A4 0009C1E4  3C 60 00 0A */	lis r3, 0xa
/* 800A03A8 0009C1E8  38 84 FF 1C */	addi r4, r4, $$21122@l
/* 800A03AC 0009C1EC  4B FD 75 B5 */	bl LogMsg_0
/* 800A03B0 0009C1F0  48 00 02 44 */	b lbl_800A05F4
lbl_800A03B4:
/* 800A03B4 0009C1F4  38 00 00 09 */	li r0, 9
/* 800A03B8 0009C1F8  39 C3 00 11 */	addi r14, r3, 0x11
/* 800A03BC 0009C1FC  B0 03 00 04 */	sth r0, 4(r3)
/* 800A03C0 0009C200  38 80 00 03 */	li r4, 3
/* 800A03C4 0009C204  55 E0 04 3E */	clrlwi r0, r15, 0x10
/* 800A03C8 0009C208  39 6E 00 03 */	addi r11, r14, 3
...
/* 800A03D8 0009C218  56 04 C6 3E */	rlwinm r4, r16, 0x18, 0x18, 0x1f
/* 800A03DC 0009C21C  98 A3 00 12 */	stb r5, 0x12(r3)
/* 800A03E0 0009C220  55 E0 C6 3E */	rlwinm r0, r15, 0x18, 0x18, 0x1f
...
/* 800A03FC 0009C23C  39 6B 00 06 */	addi r11, r11, 6
/* 800A0400 0009C240  99 E3 00 19 */	stb r15, 0x19(r3)
/* 800A0404 0009C244  40 80 01 84 */	bge lbl_800A0588
/* 800A0408 0009C248  55 45 04 3E */	clrlwi r5, r10, 0x10
/* 800A040C 0009C24C  38 0A FF F8 */	addi r0, r10, -8
/* 800A0410 0009C250  7C 9F 28 50 */	subf r4, r31, r5
/* 800A0414 0009C254  54 84 04 3E */	clrlwi r4, r4, 0x10
/* 800A0418 0009C258  28 04 00 08 */	cmplwi r4, 8
...
lbl_800A042C:
/* 800A042C 0009C26C  57 E4 13 BA */	rlwinm r4, r31, 2, 0xe, 0x1d
/* 800A0430 0009C270  3A 21 00 08 */	addi r17, r1, 8
/* 800A0434 0009C274  7D 11 20 6E */	lwzux r8, r17, r4
/* 800A0438 0009C278  3B FF 00 08 */	addi r31, r31, 8
/* 800A043C 0009C27C  55 05 46 3E */	srwi r5, r8, 0x18
/* 800A0440 0009C280  83 11 00 04 */	lwz r24, 4(r17)
/* 800A0444 0009C284  98 AB 00 00 */	stb r5, 0(r11)
/* 800A0448 0009C288  55 06 86 3E */	rlwinm r6, r8, 0x10, 0x18, 0x1f
/* 800A044C 0009C28C  80 91 00 08 */	lwz r4, 8(r17)
/* 800A0450 0009C290  55 07 C6 3E */	rlwinm r7, r8, 0x18, 0x18, 0x1f
/* 800A0454 0009C294  98 CB 00 01 */	stb r6, 1(r11)
/* 800A0458 0009C298  57 09 46 3E */	srwi r9, r24, 0x18
/* 800A045C 0009C29C  80 D1 00 10 */	lwz r6, 0x10(r17)
/* 800A0460 0009C2A0  57 12 86 3E */	rlwinm r18, r24, 0x10, 0x18, 0x1f
/* 800A0464 0009C2A4  98 EB 00 02 */	stb r7, 2(r11)
/* 800A0468 0009C2A8  57 15 C6 3E */	rlwinm r21, r24, 0x18, 0x18, 0x1f
/* 800A046C 0009C2AC  80 F1 00 14 */	lwz r7, 0x14(r17)
/* 800A0470 0009C2B0  54 9B 46 3E */	srwi r27, r4, 0x18
/* 800A0474 0009C2B4  99 0B 00 03 */	stb r8, 3(r11)
/* 800A0478 0009C2B8  54 8C 86 3E */	rlwinm r12, r4, 0x10, 0x18, 0x1f
/* 800A047C 0009C2BC  81 11 00 18 */	lwz r8, 0x18(r17)
/* 800A0480 0009C2C0  54 8F C6 3E */	rlwinm r15, r4, 0x18, 0x18, 0x1f
/* 800A0484 0009C2C4  99 2B 00 04 */	stb r9, 4(r11)
/* 800A0488 0009C2C8  54 D3 46 3E */	srwi r19, r6, 0x18
/* 800A048C 0009C2CC  81 31 00 1C */	lwz r9, 0x1c(r17)
/* 800A0490 0009C2D0  54 D4 86 3E */	rlwinm r20, r6, 0x10, 0x18, 0x1f
/* 800A0494 0009C2D4  9A 4B 00 05 */	stb r18, 5(r11)
/* 800A0498 0009C2D8  54 F6 46 3E */	srwi r22, r7, 0x18
/* 800A049C 0009C2DC  80 B1 00 0C */	lwz r5, 0xc(r17)
/* 800A04A0 0009C2E0  54 F7 86 3E */	rlwinm r23, r7, 0x10, 0x18, 0x1f
/* 800A04A4 0009C2E4  9A AB 00 06 */	stb r21, 6(r11)
/* 800A04A8 0009C2E8  54 D5 C6 3E */	rlwinm r21, r6, 0x18, 0x18, 0x1f
/* 800A04AC 0009C2EC  54 B0 46 3E */	srwi r16, r5, 0x18
/* 800A04B0 0009C2F0  54 B1 86 3E */	rlwinm r17, r5, 0x10, 0x18, 0x1f
/* 800A04B4 0009C2F4  9B 0B 00 07 */	stb r24, 7(r11)
/* 800A04B8 0009C2F8  54 B2 C6 3E */	rlwinm r18, r5, 0x18, 0x18, 0x1f
/* 800A04BC 0009C2FC  54 F8 C6 3E */	rlwinm r24, r7, 0x18, 0x18, 0x1f
/* 800A04C0 0009C300  55 19 46 3E */	srwi r25, r8, 0x18
/* 800A04C4 0009C304  9B 6B 00 08 */	stb r27, 8(r11)
/* 800A04C8 0009C308  55 1A 86 3E */	rlwinm r26, r8, 0x10, 0x18, 0x1f
/* 800A04CC 0009C30C  55 1B C6 3E */	rlwinm r27, r8, 0x18, 0x18, 0x1f
/* 800A04D0 0009C310  55 3C 46 3E */	srwi r28, r9, 0x18
/* 800A04D4 0009C314  99 8B 00 09 */	stb r12, 9(r11)
/* 800A04D8 0009C318  55 3D 86 3E */	rlwinm r29, r9, 0x10, 0x18, 0x1f
/* 800A04DC 0009C31C  55 2C C6 3E */	rlwinm r12, r9, 0x18, 0x18, 0x1f
...
lbl_800A053C:
/* 800A053C 0009C37C  57 E4 04 3E */	clrlwi r4, r31, 0x10
/* 800A0540 0009C380  7C 04 00 00 */	cmpw r4, r0
/* 800A0544 0009C384  41 80 FE E8 */	blt lbl_800A042C
lbl_800A0548:
/* 800A0548 0009C388  38 A1 00 08 */	addi r5, r1, 8
/* 800A054C 0009C38C  48 00 00 30 */	b lbl_800A057C
lbl_800A0550:
/* 800A0550 0009C390  57 E0 13 BA */	rlwinm r0, r31, 2, 0xe, 0x1d
/* 800A0554 0009C394  3B FF 00 01 */	addi r31, r31, 1
/* 800A0558 0009C398  7C C5 00 2E */	lwzx r6, r5, r0
/* 800A055C 0009C39C  54 C0 46 3E */	srwi r0, r6, 0x18
/* 800A0560 0009C3A0  54 C4 86 3E */	rlwinm r4, r6, 0x10, 0x18, 0x1f
/* 800A0564 0009C3A4  98 0B 00 00 */	stb r0, 0(r11)
/* 800A0568 0009C3A8  54 C0 C6 3E */	rlwinm r0, r6, 0x18, 0x18, 0x1f
/* 800A056C 0009C3AC  98 8B 00 01 */	stb r4, 1(r11)
/* 800A0570 0009C3B0  98 0B 00 02 */	stb r0, 2(r11)
/* 800A0574 0009C3B4  98 CB 00 03 */	stb r6, 3(r11)
/* 800A0578 0009C3B8  39 6B 00 04 */	addi r11, r11, 4
lbl_800A057C:
/* 800A057C 0009C3BC  57 E0 04 3E */	clrlwi r0, r31, 0x10
...
/* 800A058C 0009C3CC  2C 00 00 00 */	cmpwi r0, 0
/* 800A0590 0009C3D0  41 82 00 28 */	beq lbl_800A05B8
/* 800A0594 0009C3D4  38 00 00 02 */	li r0, 2
/* 800A0598 0009C3D8  98 0B 00 00 */	stb r0, 0(r11)
/* 800A059C 0009C3DC  A0 1E 04 76 */	lhz r0, 0x476(r30)
/* 800A05A0 0009C3E0  7C 00 46 70 */	srawi r0, r0, 8
/* 800A05A4 0009C3E4  98 0B 00 01 */	stb r0, 1(r11)
/* 800A05A8 0009C3E8  A0 1E 04 76 */	lhz r0, 0x476(r30)
/* 800A05AC 0009C3EC  98 0B 00 02 */	stb r0, 2(r11)
/* 800A05B0 0009C3F0  39 6B 00 03 */	addi r11, r11, 3
/* 800A05B4 0009C3F4  48 00 00 10 */	b lbl_800A05C4
lbl_800A05B8:
/* 800A05B8 0009C3F8  38 00 00 00 */	li r0, 0
/* 800A05BC 0009C3FC  98 0B 00 00 */	stb r0, 0(r11)
/* 800A05C0 0009C400  39 6B 00 01 */	addi r11, r11, 1
lbl_800A05C4:
...
/* 800A05D4 0009C414  38 E4 FF FE */	addi r7, r4, -2
/* 800A05D8 0009C418  54 E6 C6 3E */	rlwinm r6, r7, 0x18, 0x18, 0x1f
/* 800A05DC 0009C41C  7C 64 1B 78 */	mr r4, r3
/* 800A05E0 0009C420  98 C5 00 00 */	stb r6, 0(r5)
/* 800A05E4 0009C424  98 E5 00 01 */	stb r7, 1(r5)
/* 800A05E8 0009C428  B0 03 00 02 */	sth r0, 2(r3)
...
/* 800A061C 0009C45C  4B F6 6D 15 */	bl func_80007330
/* 800A0620 0009C460  89 26 00 00 */	lbz r9, 0(r6)
/* 800A0624 0009C464  38 06 00 04 */	addi r0, r6, 4
/* 800A0628 0009C468  89 06 00 01 */	lbz r8, 1(r6)
/* 800A062C 0009C46C  7C 00 38 40 */	cmplw r0, r7
/* 800A0630 0009C470  88 06 00 02 */	lbz r0, 2(r6)
/* 800A0634 0009C474  55 2A C0 0E */	slwi r10, r9, 0x18
/* 800A0638 0009C478  55 08 80 1E */	slwi r8, r8, 0x10
/* 800A063C 0009C47C  89 26 00 03 */	lbz r9, 3(r6)
...
/* 800A0660 0009C4A0  38 A0 00 02 */	li r5, 2
/* 800A0664 0009C4A4  38 C0 00 00 */	li r6, 0
/* 800A0668 0009C4A8  48 00 0B B1 */	bl sdpu_build_n_send_error
/* 800A066C 0009C4AC  48 00 03 18 */	b lbl_800A0984
lbl_800A0670:
/* 800A0670 0009C4B0  88 86 00 04 */	lbz r4, 4(r6)
/* 800A0674 0009C4B4  88 06 00 05 */	lbz r0, 5(r6)
...
/* 800A0684 0009C4C4  54 1E 04 3E */	clrlwi r30, r0, 0x10
/* 800A0688 0009C4C8  38 03 FF F6 */	addi r0, r3, -10
/* 800A068C 0009C4CC  7C 1E 00 00 */	cmpw r30, r0
/* 800A0690 0009C4D0  40 81 00 08 */	ble lbl_800A0698
/* 800A0694 0009C4D4  54 1E 04 3E */	clrlwi r30, r0, 0x10
lbl_800A0698:
/* 800A0698 0009C4D8  7C A4 2B 78 */	mr r4, r5
/* 800A069C 0009C4DC  38 66 00 06 */	addi r3, r6, 6
/* 800A06A0 0009C4E0  38 A1 00 08 */	addi r5, r1, 8
/* 800A06A4 0009C4E4  48 00 10 01 */	bl sdpu_extract_attr_seq
/* 800A06A8 0009C4E8  2C 03 00 00 */	cmpwi r3, 0
/* 800A06AC 0009C4EC  7C 7C 1B 78 */	mr r28, r3
/* 800A06B0 0009C4F0  41 82 00 18 */	beq lbl_800A06C8
/* 800A06B4 0009C4F4  A0 01 00 08 */	lhz r0, 8(r1)
/* 800A06B8 0009C4F8  2C 00 00 00 */	cmpwi r0, 0
...
/* 800A06D0 0009C510  38 A0 00 03 */	li r5, 3
/* 800A06D4 0009C514  38 C0 00 00 */	li r6, 0
...
/* 800A06E8 0009C528  2C 03 00 00 */	cmpwi r3, 0
...
/* 800A06FC 0009C53C  38 A0 00 02 */	li r5, 2
/* 800A0700 0009C540  38 C0 00 00 */	li r6, 0
/* 800A0704 0009C544  48 00 0B 15 */	bl sdpu_build_n_send_error
/* 800A0708 0009C548  48 00 02 7C */	b lbl_800A0984
lbl_800A070C:
/* 800A070C 0009C54C  88 1C 00 00 */	lbz r0, 0(r28)
/* 800A0710 0009C550  2C 00 00 00 */	cmpwi r0, 0
/* 800A0714 0009C554  41 82 00 5C */	beq lbl_800A0770
/* 800A0718 0009C558  28 00 00 02 */	cmplwi r0, 2
...
/* 800A0728 0009C568  38 A0 00 05 */	li r5, 5
/* 800A072C 0009C56C  38 C0 00 00 */	li r6, 0
/* 800A0730 0009C570  48 00 0A E9 */	bl sdpu_build_n_send_error
/* 800A0734 0009C574  48 00 02 50 */	b lbl_800A0984
lbl_800A0738:
/* 800A0738 0009C578  88 1C 00 01 */	lbz r0, 1(r28)
/* 800A073C 0009C57C  88 7C 00 02 */	lbz r3, 2(r28)
...
/* 800A074C 0009C58C  54 63 04 3E */	clrlwi r3, r3, 0x10
...
/* 800A07B0 0009C5F0  80 83 00 00 */	lwz r4, 0(r3)
/* 800A07B4 0009C5F4  7C 00 E8 50 */	subf r0, r0, r29
/* 800A07B8 0009C5F8  54 00 04 3E */	clrlwi r0, r0, 0x10
/* 800A07BC 0009C5FC  20 00 03 E8 */	subfic r0, r0, 0x3e8
/* 800A07C0 0009C600  54 03 04 3E */	clrlwi r3, r0, 0x10
/* 800A07C4 0009C604  38 03 FF FA */	addi r0, r3, -6
...
/* 800A07DC 0009C61C  A0 9F 00 02 */	lhz r4, 2(r31)
/* 800A07E0 0009C620  7C 7D 1B 78 */	mr r29, r3
/* 800A07E4 0009C624  A0 1F 00 04 */	lhz r0, 4(r31)
/* 800A07E8 0009C628  7C 04 00 40 */	cmplw r4, r0
/* 800A07EC 0009C62C  41 82 00 14 */	beq lbl_800A0800
/* 800A07F0 0009C630  A0 78 00 08 */	lhz r3, 8(r24)
/* 800A07F4 0009C634  3B 9C FF FF */	addi r28, r28, -1
/* 800A07F8 0009C638  38 03 00 01 */	addi r0, r3, 1
/* 800A07FC 0009C63C  B0 1F 00 02 */	sth r0, 2(r31)
lbl_800A0800:
/* 800A0800 0009C640  3B 9C 00 01 */	addi r28, r28, 1
lbl_800A0804:
/* 800A0804 0009C644  A0 01 00 08 */	lhz r0, 8(r1)
/* 800A0808 0009C648  57 83 04 3E */	clrlwi r3, r28, 0x10
...
/* 800A081C 0009C65C  54 04 04 3E */	clrlwi r4, r0, 0x10
...
/* 800A082C 0009C66C  38 64 FF FD */	addi r3, r4, -3
...
lbl_800A0848:
/* 800A0848 0009C688  38 64 FF FD */	addi r3, r4, -3
/* 800A084C 0009C68C  38 04 FF FF */	addi r0, r4, -1
/* 800A0850 0009C690  38 A0 00 01 */	li r5, 1
...
lbl_800A0868:
/* 800A0868 0009C6A8  38 60 00 02 */	li r3, 2
/* 800A086C 0009C6AC  4B FD 45 B5 */	bl GKI_getpoolbuf
/* 800A0870 0009C6B0  2C 03 00 00 */	cmpwi r3, 0
...
/* 800A0888 0009C6C8  28 00 00 01 */	cmplwi r0, 1
/* 800A088C 0009C6CC  41 80 00 F8 */	blt lbl_800A0984
/* 800A0890 0009C6D0  3C 80 80 44 */	lis r4, $$21122@ha
/* 800A0894 0009C6D4  3C 60 00 0A */	lis r3, 0xa
/* 800A0898 0009C6D8  38 84 FF 1C */	addi r4, r4, $$21122@l
/* 800A089C 0009C6DC  4B FD 70 C5 */	bl LogMsg_0
/* 800A08A0 0009C6E0  48 00 00 E4 */	b lbl_800A0984
lbl_800A08A4:
/* 800A08A4 0009C6E4  38 00 00 09 */	li r0, 9
/* 800A08A8 0009C6E8  3B A3 00 11 */	addi r29, r3, 0x11
/* 800A08AC 0009C6EC  B0 03 00 04 */	sth r0, 4(r3)
/* 800A08B0 0009C6F0  38 60 00 05 */	li r3, 5
/* 800A08B4 0009C6F4  3B FD 00 03 */	addi r31, r29, 3
/* 800A08B8 0009C6F8  57 40 C6 3E */	rlwinm r0, r26, 0x18, 0x18, 0x1f
/* 800A08BC 0009C6FC  98 7D 00 00 */	stb r3, 0(r29)
/* 800A08C0 0009C700  7F FC FB 78 */	mr r28, r31
/* 800A08C4 0009C704  98 1D 00 01 */	stb r0, 1(r29)
/* 800A08C8 0009C708  9B 5D 00 02 */	stb r26, 2(r29)
...
lbl_800A08DC:
/* 800A08DC 0009C71C  57 C0 C6 3E */	rlwinm r0, r30, 0x18, 0x18, 0x1f
/* 800A08E0 0009C720  57 C5 04 3E */	clrlwi r5, r30, 0x10
/* 800A08E4 0009C724  98 1F 00 02 */	stb r0, 2(r31)
/* 800A08E8 0009C728  9B DF 00 03 */	stb r30, 3(r31)
/* 800A08EC 0009C72C  3B FF 00 04 */	addi r31, r31, 4
...
/* 800A0908 0009C748  57 C3 04 3E */	clrlwi r3, r30, 0x10
...
/* 800A0918 0009C758  54 60 04 3F */	clrlwi. r0, r3, 0x10
...
/* 800A092C 0009C76C  38 00 00 02 */	li r0, 2
/* 800A0930 0009C770  98 1F 00 00 */	stb r0, 0(r31)
/* 800A0934 0009C774  A0 19 04 76 */	lhz r0, 0x476(r25)
/* 800A0938 0009C778  7C 00 46 70 */	srawi r0, r0, 8
/* 800A093C 0009C77C  98 1F 00 01 */	stb r0, 1(r31)
/* 800A0940 0009C780  A0 19 04 76 */	lhz r0, 0x476(r25)
/* 800A0944 0009C784  98 1F 00 02 */	stb r0, 2(r31)
/* 800A0948 0009C788  3B FF 00 03 */	addi r31, r31, 3
/* 800A094C 0009C78C  48 00 00 10 */	b lbl_800A095C
lbl_800A0950:
/* 800A0950 0009C790  38 00 00 00 */	li r0, 0
/* 800A0954 0009C794  98 1F 00 00 */	stb r0, 0(r31)
/* 800A0958 0009C798  3B FF 00 01 */	addi r31, r31, 1
lbl_800A095C:
/* 800A095C 0009C79C  7C 7C F8 50 */	subf r3, r28, r31
/* 800A0960 0009C7A0  7C 1D F8 50 */	subf r0, r29, r31
/* 800A0964 0009C7A4  38 A3 FF FE */	addi r5, r3, -2
/* 800A0968 0009C7A8  7F 64 DB 78 */	mr r4, r27
/* 800A096C 0009C7AC  54 A3 C6 3E */	rlwinm r3, r5, 0x18, 0x18, 0x1f
/* 800A0970 0009C7B0  98 7C 00 00 */	stb r3, 0(r28)
/* 800A0974 0009C7B4  98 BC 00 01 */	stb r5, 1(r28)
/* 800A0978 0009C7B8  B0 1B 00 02 */	sth r0, 2(r27)
...
/* 800A0988 0009C7C8  4B F6 69 F5 */	bl func_8000737C
...
/* 800A09AC 0009C7EC  4B F6 69 75 */	bl func_80007320
...
/* 800A09EC 0009C82C  38 A0 00 03 */	li r5, 3
/* 800A09F0 0009C830  38 C0 00 00 */	li r6, 0
/* 800A09F4 0009C834  48 00 08 25 */	bl sdpu_build_n_send_error
/* 800A09F8 0009C838  48 00 03 A8 */	b lbl_800A0DA0
lbl_800A09FC:
/* 800A09FC 0009C83C  88 83 00 00 */	lbz r4, 0(r3)
/* 800A0A00 0009C840  88 03 00 01 */	lbz r0, 1(r3)
...
/* 800A0A50 0009C890  38 A0 00 03 */	li r5, 3
/* 800A0A54 0009C894  38 C0 00 00 */	li r6, 0
/* 800A0A58 0009C898  48 00 07 C1 */	bl sdpu_build_n_send_error
/* 800A0A5C 0009C89C  48 00 03 44 */	b lbl_800A0DA0
lbl_800A0A60:
/* 800A0A60 0009C8A0  38 00 00 08 */	li r0, 8
/* 800A0A64 0009C8A4  38 C1 00 04 */	addi r6, r1, 4
/* 800A0A68 0009C8A8  38 A1 00 48 */	addi r5, r1, 0x48
/* 800A0A6C 0009C8AC  7C 09 03 A6 */	mtctr r0
lbl_800A0A70:
/* 800A0A70 0009C8B0  80 85 00 04 */	lwz r4, 4(r5)
/* 800A0A74 0009C8B4  84 05 00 08 */	lwzu r0, 8(r5)
/* 800A0A78 0009C8B8  90 86 00 04 */	stw r4, 4(r6)
/* 800A0A7C 0009C8BC  94 06 00 08 */	stwu r0, 8(r6)
/* 800A0A80 0009C8C0  42 00 FF F0 */	bdnz lbl_800A0A70
/* 800A0A84 0009C8C4  A0 05 00 04 */	lhz r0, 4(r5)
/* 800A0A88 0009C8C8  B0 06 00 04 */	sth r0, 4(r6)
/* 800A0A8C 0009C8CC  88 03 00 00 */	lbz r0, 0(r3)
/* 800A0A90 0009C8D0  2C 00 00 00 */	cmpwi r0, 0
/* 800A0A94 0009C8D4  41 82 00 5C */	beq lbl_800A0AF0
/* 800A0A98 0009C8D8  28 00 00 02 */	cmplwi r0, 2
...
/* 800A0AA8 0009C8E8  38 A0 00 05 */	li r5, 5
/* 800A0AAC 0009C8EC  38 C0 00 00 */	li r6, 0
/* 800A0AB0 0009C8F0  48 00 07 69 */	bl sdpu_build_n_send_error
/* 800A0AB4 0009C8F4  48 00 02 EC */	b lbl_800A0DA0
lbl_800A0AB8:
/* 800A0AB8 0009C8F8  88 03 00 01 */	lbz r0, 1(r3)
/* 800A0ABC 0009C8FC  88 63 00 02 */	lbz r3, 2(r3)
...
/* 800A0ACC 0009C90C  54 63 04 3E */	clrlwi r3, r3, 0x10
...
/* 800A0AE0 0009C920  38 A0 00 05 */	li r5, 5
/* 800A0AE4 0009C924  38 C0 00 00 */	li r6, 0
/* 800A0AE8 0009C928  48 00 07 31 */	bl sdpu_build_n_send_error
/* 800A0AEC 0009C92C  48 00 02 B4 */	b lbl_800A0DA0
lbl_800A0AF0:
/* 800A0AF0 0009C930  38 00 00 00 */	li r0, 0
...
/* 800A0B1C 0009C95C  38 81 00 04 */	addi r4, r1, 4
/* 800A0B20 0009C960  7F E9 03 A6 */	mtctr r31
lbl_800A0B24:
/* 800A0B24 0009C964  80 64 00 04 */	lwz r3, 4(r4)
/* 800A0B28 0009C968  84 04 00 08 */	lwzu r0, 8(r4)
/* 800A0B2C 0009C96C  90 65 00 04 */	stw r3, 4(r5)
/* 800A0B30 0009C970  94 05 00 08 */	stwu r0, 8(r5)
/* 800A0B34 0009C974  42 00 FF F0 */	bdnz lbl_800A0B24
/* 800A0B38 0009C978  A0 04 00 04 */	lhz r0, 4(r4)
/* 800A0B3C 0009C97C  7F 97 E3 78 */	mr r23, r28
/* 800A0B40 0009C980  3B 60 00 00 */	li r27, 0
/* 800A0B44 0009C984  3B 9C 00 03 */	addi r28, r28, 3
/* 800A0B48 0009C988  B0 05 00 04 */	sth r0, 4(r5)
/* 800A0B4C 0009C98C  48 00 00 8C */	b lbl_800A0BD8
lbl_800A0B50:
/* 800A0B50 0009C990  57 60 13 BA */	rlwinm r0, r27, 2, 0xe, 0x1d
...
/* 800A0B60 0009C9A0  A0 9E 00 02 */	lhz r4, 2(r30)
/* 800A0B64 0009C9A4  A0 BE 00 04 */	lhz r5, 4(r30)
/* 800A0B68 0009C9A8  4B FF CD 01 */	bl sdp_db_find_attr_in_rec
/* 800A0B6C 0009C9AC  2C 03 00 00 */	cmpwi r3, 0
...
/* 800A0B7C 0009C9BC  80 83 00 00 */	lwz r4, 0(r3)
/* 800A0B80 0009C9C0  7C 00 E0 50 */	subf r0, r0, r28
/* 800A0B84 0009C9C4  54 00 04 3E */	clrlwi r0, r0, 0x10
/* 800A0B88 0009C9C8  20 00 03 E8 */	subfic r0, r0, 0x3e8
/* 800A0B8C 0009C9CC  54 03 04 3E */	clrlwi r3, r0, 0x10
/* 800A0B90 0009C9D0  38 03 FF FA */	addi r0, r3, -6
/* 800A0B94 0009C9D4  7C 04 00 40 */	cmplw r4, r0
/* 800A0B98 0009C9D8  40 81 00 0C */	ble lbl_800A0BA4
/* 800A0B9C 0009C9DC  3B 00 00 01 */	li r24, 1
...
/* 800A0BB0 0009C9F0  A0 9E 00 02 */	lhz r4, 2(r30)
/* 800A0BB4 0009C9F4  7C 7C 1B 78 */	mr r28, r3
/* 800A0BB8 0009C9F8  A0 1E 00 04 */	lhz r0, 4(r30)
/* 800A0BBC 0009C9FC  7C 04 00 40 */	cmplw r4, r0
/* 800A0BC0 0009CA00  41 82 00 14 */	beq lbl_800A0BD4
/* 800A0BC4 0009CA04  A0 79 00 08 */	lhz r3, 8(r25)
/* 800A0BC8 0009CA08  3B 7B FF FF */	addi r27, r27, -1
/* 800A0BCC 0009CA0C  38 03 00 01 */	addi r0, r3, 1
/* 800A0BD0 0009CA10  B0 1E 00 02 */	sth r0, 2(r30)
lbl_800A0BD4:
/* 800A0BD4 0009CA14  3B 7B 00 01 */	addi r27, r27, 1
lbl_800A0BD8:
/* 800A0BD8 0009CA18  A0 01 00 4C */	lhz r0, 0x4c(r1)
/* 800A0BDC 0009CA1C  57 63 04 3E */	clrlwi r3, r27, 0x10
/* 800A0BE0 0009CA20  7C 03 00 40 */	cmplw r3, r0
/* 800A0BE4 0009CA24  41 80 FF 6C */	blt lbl_800A0B50
lbl_800A0BE8:
/* 800A0BE8 0009CA28  2C 18 00 00 */	cmpwi r24, 0
/* 800A0BEC 0009CA2C  40 82 00 44 */	bne lbl_800A0C30
/* 800A0BF0 0009CA30  7C 77 E0 50 */	subf r3, r23, r28
/* 800A0BF4 0009CA34  38 03 FF FD */	addi r0, r3, -3
/* 800A0BF8 0009CA38  54 03 04 3F */	clrlwi. r3, r0, 0x10
/* 800A0BFC 0009CA3C  41 82 00 18 */	beq lbl_800A0C14
/* 800A0C00 0009CA40  9A 97 00 00 */	stb r20, 0(r23)
/* 800A0C04 0009CA44  54 60 C6 3E */	rlwinm r0, r3, 0x18, 0x18, 0x1f
/* 800A0C08 0009CA48  98 17 00 01 */	stb r0, 1(r23)
/* 800A0C0C 0009CA4C  98 77 00 02 */	stb r3, 2(r23)
...
lbl_800A0C28:
/* 800A0C28 0009CA68  2C 1A 00 00 */	cmpwi r26, 0
...
/* 800A0C38 0009CA78  54 04 04 3E */	clrlwi r4, r0, 0x10
...
/* 800A0C48 0009CA88  38 64 FF FD */	addi r3, r4, -3
...
lbl_800A0C64:
/* 800A0C64 0009CAA4  38 64 FF FD */	addi r3, r4, -3
/* 800A0C68 0009CAA8  38 04 FF FF */	addi r0, r4, -1
/* 800A0C6C 0009CAAC  38 A0 00 01 */	li r5, 1
...
lbl_800A0C84:
/* 800A0C84 0009CAC4  38 60 00 02 */	li r3, 2
/* 800A0C88 0009CAC8  4B FD 41 99 */	bl GKI_getpoolbuf
/* 800A0C8C 0009CACC  2C 03 00 00 */	cmpwi r3, 0
...
/* 800A0CA4 0009CAE4  28 00 00 01 */	cmplwi r0, 1
/* 800A0CA8 0009CAE8  41 80 00 F8 */	blt lbl_800A0DA0
/* 800A0CAC 0009CAEC  3C 80 80 44 */	lis r4, $$21122@ha
/* 800A0CB0 0009CAF0  3C 60 00 0A */	lis r3, 0xa
/* 800A0CB4 0009CAF4  38 84 FF 1C */	addi r4, r4, $$21122@l
/* 800A0CB8 0009CAF8  4B FD 6C A9 */	bl LogMsg_0
/* 800A0CBC 0009CAFC  48 00 00 E4 */	b lbl_800A0DA0
lbl_800A0CC0:
/* 800A0CC0 0009CB00  38 00 00 09 */	li r0, 9
/* 800A0CC4 0009CB04  3B 83 00 11 */	addi r28, r3, 0x11
/* 800A0CC8 0009CB08  B0 03 00 04 */	sth r0, 4(r3)
/* 800A0CCC 0009CB0C  38 60 00 07 */	li r3, 7
/* 800A0CD0 0009CB10  3B DC 00 03 */	addi r30, r28, 3
/* 800A0CD4 0009CB14  56 C0 C6 3E */	rlwinm r0, r22, 0x18, 0x18, 0x1f
/* 800A0CD8 0009CB18  98 7C 00 00 */	stb r3, 0(r28)
/* 800A0CDC 0009CB1C  7F DF F3 78 */	mr r31, r30
/* 800A0CE0 0009CB20  98 1C 00 01 */	stb r0, 1(r28)
/* 800A0CE4 0009CB24  9A DC 00 02 */	stb r22, 2(r28)
...
lbl_800A0CF8:
/* 800A0CF8 0009CB38  57 A0 C6 3E */	rlwinm r0, r29, 0x18, 0x18, 0x1f
/* 800A0CFC 0009CB3C  57 A5 04 3E */	clrlwi r5, r29, 0x10
/* 800A0D00 0009CB40  98 1E 00 02 */	stb r0, 2(r30)
/* 800A0D04 0009CB44  9B BE 00 03 */	stb r29, 3(r30)
/* 800A0D08 0009CB48  3B DE 00 04 */	addi r30, r30, 4
...
/* 800A0D24 0009CB64  57 A3 04 3E */	clrlwi r3, r29, 0x10
...
/* 800A0D34 0009CB74  54 60 04 3F */	clrlwi. r0, r3, 0x10
...
/* 800A0D48 0009CB88  38 00 00 02 */	li r0, 2
/* 800A0D4C 0009CB8C  98 1E 00 00 */	stb r0, 0(r30)
/* 800A0D50 0009CB90  A0 15 04 76 */	lhz r0, 0x476(r21)
/* 800A0D54 0009CB94  7C 00 46 70 */	srawi r0, r0, 8
/* 800A0D58 0009CB98  98 1E 00 01 */	stb r0, 1(r30)
/* 800A0D5C 0009CB9C  A0 15 04 76 */	lhz r0, 0x476(r21)
/* 800A0D60 0009CBA0  98 1E 00 02 */	stb r0, 2(r30)
/* 800A0D64 0009CBA4  3B DE 00 03 */	addi r30, r30, 3
/* 800A0D68 0009CBA8  48 00 00 10 */	b lbl_800A0D78
lbl_800A0D6C:
/* 800A0D6C 0009CBAC  38 00 00 00 */	li r0, 0
/* 800A0D70 0009CBB0  98 1E 00 00 */	stb r0, 0(r30)
/* 800A0D74 0009CBB4  3B DE 00 01 */	addi r30, r30, 1
lbl_800A0D78:
/* 800A0D78 0009CBB8  7C 7F F0 50 */	subf r3, r31, r30
/* 800A0D7C 0009CBBC  7C 1C F0 50 */	subf r0, r28, r30
/* 800A0D80 0009CBC0  38 A3 FF FE */	addi r5, r3, -2
/* 800A0D84 0009CBC4  7F 24 CB 78 */	mr r4, r25
/* 800A0D88 0009CBC8  54 A3 C6 3E */	rlwinm r3, r5, 0x18, 0x18, 0x1f
/* 800A0D8C 0009CBCC  98 7F 00 00 */	stb r3, 0(r31)
/* 800A0D90 0009CBD0  98 BF 00 01 */	stb r5, 1(r31)
/* 800A0D94 0009CBD4  B0 19 00 02 */	sth r0, 2(r25)
...
/* 800A0DA4 0009CBE4  4B F6 65 C9 */	bl func_8000736C
