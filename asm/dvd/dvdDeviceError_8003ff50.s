...
.global lbl_8003FF50
lbl_8003FF50:
/* 8003FF50 0003BD90  90 6D E6 F0 */	stw r3, lbl_8055CB10@sda21(r13)
/* 8003FF54 0003BD94  38 00 00 01 */	li r0, 0x1
/* 8003FF58 0003BD98  90 0D 81 D8 */	stw r0, lbl_805565F8@sda21(r13)
...
/* 8003FF7C 0003BDBC  4B FE 23 75 */	bl lbl_800222F0
...
/* 8003FF98 0003BDD8  4B FD A4 59 */	bl lbl_8001A3F0
...
/* 8003FFD0 0003BE10  3C 60 80 4A */	lis r3, lbl_8049FD40@ha
/* 8003FFD4 0003BE14  3C C0 80 04 */	lis r6, lbl_8003FF50@ha
/* 8003FFD8 0003BE18  90 0D 81 D8 */	stw r0, lbl_805565F8@sda21(r13)
/* 8003FFDC 0003BE1C  7F A5 EB 78 */	mr r5, r29
/* 8003FFE0 0003BE20  38 63 FD 40 */	addi r3, r3, lbl_8049FD40@l
/* 8003FFE4 0003BE24  38 C6 FF 50 */	addi r6, r6, lbl_8003FF50@l
/* 8003FFE8 0003BE28  38 80 00 20 */	li r4, 0x20
/* 8003FFEC 0003BE2C  48 00 12 C5 */	bl lbl_800412B0
.global lbl_8003FFF0
lbl_8003FFF0:
/* 8003FFF0 0003BE30  80 0D 81 D8 */	lwz r0, lbl_805565F8@sda21(r13)
/* 8003FFF4 0003BE34  2C 00 00 00 */	cmpwi r0, 0x0
/* 8003FFF8 0003BE38  41 82 FF F8 */	beq lbl_8003FFF0
/* 8003FFFC 0003BE3C  80 0D E6 F0 */	lwz r0, lbl_8055CB10@sda21(r13)
...
/* 8004001C 0003BE5C  3C 60 80 04 */	lis r3, lbl_8003FF50@ha
/* 80040020 0003BE60  90 0D 81 D8 */	stw r0, lbl_805565F8@sda21(r13)
/* 80040024 0003BE64  38 63 FF 50 */	addi r3, r3, lbl_8003FF50@l
/* 80040028 0003BE68  48 00 17 39 */	bl lbl_80041760
/* 8004002C 0003BE6C  60 00 00 00 */	nop
.global lbl_80040030
lbl_80040030:
/* 80040030 0003BE70  80 0D 81 D8 */	lwz r0, lbl_805565F8@sda21(r13)
/* 80040034 0003BE74  2C 00 00 00 */	cmpwi r0, 0x0
/* 80040038 0003BE78  41 82 FF F8 */	beq lbl_80040030
/* 8004003C 0003BE7C  48 00 26 A5 */	bl lbl_800426E0
/* 80040040 0003BE80  80 0D E6 F0 */	lwz r0, lbl_8055CB10@sda21(r13)
...
/* 8004007C 0003BEBC  3C 60 80 4A */	lis r3, lbl_8049FD40@ha
/* 80040080 0003BEC0  3C C0 80 04 */	lis r6, lbl_8003FF50@ha
/* 80040084 0003BEC4  90 0D 81 D8 */	stw r0, lbl_805565F8@sda21(r13)
/* 80040088 0003BEC8  38 63 FD 40 */	addi r3, r3, lbl_8049FD40@l
/* 8004008C 0003BECC  3C 80 00 04 */	lis r4, 0x4
/* 80040090 0003BED0  38 C6 FF 50 */	addi r6, r6, lbl_8003FF50@l
/* 80040094 0003BED4  38 A0 00 00 */	li r5, 0x0
/* 80040098 0003BED8  48 00 1B 69 */	bl lbl_80041C00
/* 8004009C 0003BEDC  60 00 00 00 */	nop
.global lbl_800400A0
lbl_800400A0:
/* 800400A0 0003BEE0  80 0D 81 D8 */	lwz r0, lbl_805565F8@sda21(r13)
/* 800400A4 0003BEE4  2C 00 00 00 */	cmpwi r0, 0x0
/* 800400A8 0003BEE8  41 82 FF F8 */	beq lbl_800400A0
/* 800400AC 0003BEEC  80 0D E6 F0 */	lwz r0, lbl_8055CB10@sda21(r13)
...
/* 800400CC 0003BF0C  3C 60 80 04 */	lis r3, lbl_8003FF50@ha
/* 800400D0 0003BF10  90 0D 81 D8 */	stw r0, lbl_805565F8@sda21(r13)
/* 800400D4 0003BF14  38 63 FF 50 */	addi r3, r3, lbl_8003FF50@l
/* 800400D8 0003BF18  48 00 16 89 */	bl lbl_80041760
/* 800400DC 0003BF1C  60 00 00 00 */	nop
.global lbl_800400E0
lbl_800400E0:
/* 800400E0 0003BF20  80 0D 81 D8 */	lwz r0, lbl_805565F8@sda21(r13)
/* 800400E4 0003BF24  2C 00 00 00 */	cmpwi r0, 0x0
/* 800400E8 0003BF28  41 82 FF F8 */	beq lbl_800400E0
/* 800400EC 0003BF2C  48 00 25 F5 */	bl lbl_800426E0
/* 800400F0 0003BF30  80 0D E6 F0 */	lwz r0, lbl_8055CB10@sda21(r13)
...
.global lbl_80040140
lbl_80040140:
/* 80040140 0003BF80  83 C2 87 20 */	lwz r30, lbl_8055E6A0@sda21(r2)
/* 80040144 0003BF84  3B E0 00 00 */	li r31, 0x0
/* 80040148 0003BF88  48 00 CC E9 */	bl lbl_8004CE30
...
/* 80040158 0003BF98  4B FE 06 79 */	bl lbl_800207D0
/* 8004015C 0003BF9C  48 00 00 0C */	b lbl_80040168
.global lbl_80040160
lbl_80040160:
/* 80040160 0003BFA0  38 60 00 00 */	li r3, 0x0
/* 80040164 0003BFA4  4B FE 06 6D */	bl lbl_800207D0
.global lbl_80040168
lbl_80040168:
/* 80040168 0003BFA8  3F A0 80 40 */	lis r29, lbl_80407888@ha
/* 8004016C 0003BFAC  3B BD 78 88 */	addi r29, r29, lbl_80407888@l
/* 80040170 0003BFB0  48 00 CC C1 */	bl lbl_8004CE30
...
.global lbl_80040188
lbl_80040188:
/* 80040188 0003BFC8  48 00 CC A9 */	bl lbl_8004CE30
...
/* 800401A4 0003BFE4  4B FD FB 0D */	bl lbl_8001FCB0
...
.global lbl_800401B8
lbl_800401B8:
/* 800401B8 0003BFF8  4B FF FC 29 */	bl lbl_8003FDE0
