...
/* 8003F058 0003AE98  90 C6 00 00 */	stw r6, 0(r6)
/* 8003F05C 0003AE9C  38 A6 00 08 */	addi r5, r6, 8
/* 8003F060 0003AEA0  38 86 00 10 */	addi r4, r6, 0x10
/* 8003F064 0003AEA4  38 66 00 18 */	addi r3, r6, 0x18
/* 8003F068 0003AEA8  90 C6 00 04 */	stw r6, 4(r6)
/* 8003F06C 0003AEAC  90 A5 00 00 */	stw r5, 0(r5)
/* 8003F070 0003AEB0  90 A5 00 04 */	stw r5, 4(r5)
/* 8003F074 0003AEB4  90 84 00 00 */	stw r4, 0(r4)
/* 8003F078 0003AEB8  90 84 00 04 */	stw r4, 4(r4)
/* 8003F07C 0003AEBC  90 63 00 00 */	stw r3, 0(r3)
/* 8003F080 0003AEC0  90 63 00 04 */	stw r3, 4(r3)
/* 8003F084 0003AEC4  4E 80 00 20 */	blr 
/* 8003F088 0003AEC8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8003F08C 0003AECC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8003F0A4 0003AEE4  93 C1 00 08 */	stw r30, 8(r1)
...
/* 8003F0C0 0003AF00  80 85 00 04 */	lwz r4, 4(r5)
/* 8003F0C4 0003AF04  93 E4 00 00 */	stw r31, 0(r4)
/* 8003F0C8 0003AF08  80 05 00 04 */	lwz r0, 4(r5)
/* 8003F0CC 0003AF0C  90 1F 00 04 */	stw r0, 4(r31)
/* 8003F0D0 0003AF10  90 BF 00 00 */	stw r5, 0(r31)
/* 8003F0D4 0003AF14  93 E5 00 04 */	stw r31, 4(r5)
/* 8003F0D8 0003AF18  4B FE 27 89 */	bl OSRestoreInterrupts
/* 8003F0DC 0003AF1C  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 8003F0E0 0003AF20  38 60 00 01 */	li r3, 1
/* 8003F0E4 0003AF24  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 8003F0F8 0003AF38  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8003F0FC 0003AF3C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8003F118 0003AF58  38 00 00 04 */	li r0, 4
/* 8003F11C 0003AF5C  3B E0 00 00 */	li r31, 0
/* 8003F120 0003AF60  38 84 FA B0 */	addi r4, r4, WaitingQueue@l
/* 8003F124 0003AF64  7C 09 03 A6 */	mtctr r0
lbl_8003F128:
/* 8003F128 0003AF68  80 04 00 00 */	lwz r0, 0(r4)
...
/* 8003F150 0003AF90  80 1F 00 00 */	lwz r0, 0(r31)
/* 8003F154 0003AF94  90 05 00 00 */	stw r0, 0(r5)
/* 8003F158 0003AF98  80 9F 00 00 */	lwz r4, 0(r31)
/* 8003F15C 0003AF9C  90 A4 00 04 */	stw r5, 4(r4)
/* 8003F160 0003AFA0  4B FE 27 01 */	bl OSRestoreInterrupts
/* 8003F164 0003AFA4  38 00 00 00 */	li r0, 0
/* 8003F168 0003AFA8  90 1F 00 00 */	stw r0, 0(r31)
/* 8003F16C 0003AFAC  7F E3 FB 78 */	mr r3, r31
/* 8003F170 0003AFB0  90 1F 00 04 */	stw r0, 4(r31)
/* 8003F174 0003AFB4  48 00 00 18 */	b lbl_8003F18C
lbl_8003F178:
/* 8003F178 0003AFB8  38 84 00 08 */	addi r4, r4, 8
/* 8003F17C 0003AFBC  3B FF 00 01 */	addi r31, r31, 1
/* 8003F180 0003AFC0  42 00 FF A8 */	bdnz lbl_8003F128
/* 8003F184 0003AFC4  4B FE 26 DD */	bl OSRestoreInterrupts
/* 8003F188 0003AFC8  38 60 00 00 */	li r3, 0
lbl_8003F18C:
...
/* 8003F1F8 0003B038  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8003F1FC 0003B03C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8003F218 0003B058  38 00 00 04 */	li r0, 4
...
lbl_8003F228:
/* 8003F228 0003B068  83 E4 00 00 */	lwz r31, 0(r4)
...
/* 8003F264 0003B0A4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8003F268 0003B0A8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8003F26C 0003B0AC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8003F288 0003B0C8  80 9F 00 04 */	lwz r4, 4(r31)
/* 8003F28C 0003B0CC  80 BF 00 00 */	lwz r5, 0(r31)
/* 8003F290 0003B0D0  2C 04 00 00 */	cmpwi r4, 0
/* 8003F294 0003B0D4  41 82 00 0C */	beq lbl_8003F2A0
/* 8003F298 0003B0D8  2C 05 00 00 */	cmpwi r5, 0
/* 8003F29C 0003B0DC  40 82 00 10 */	bne lbl_8003F2AC
lbl_8003F2A0:
/* 8003F2A0 0003B0E0  4B FE 25 C1 */	bl OSRestoreInterrupts
/* 8003F2A4 0003B0E4  38 60 00 00 */	li r3, 0
/* 8003F2A8 0003B0E8  48 00 00 14 */	b lbl_8003F2BC
lbl_8003F2AC:
/* 8003F2AC 0003B0EC  90 A4 00 00 */	stw r5, 0(r4)
/* 8003F2B0 0003B0F0  90 85 00 04 */	stw r4, 4(r5)
/* 8003F2B4 0003B0F4  4B FE 25 AD */	bl OSRestoreInterrupts
/* 8003F2B8 0003B0F8  38 60 00 01 */	li r3, 1
lbl_8003F2BC:
