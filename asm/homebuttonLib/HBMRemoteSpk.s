...
/* 8012AC50 00126A90  4B ED C6 E9 */	bl func_80007338
...
/* 8012AC5C 00126A9C  2C 1D 00 00 */	cmpwi r29, 0
/* 8012AC60 00126AA0  41 82 02 34 */	beq lbl_8012AE94
/* 8012AC64 00126AA4  3B 80 00 00 */	li r28, 0
/* 8012AC68 00126AA8  3B E0 00 00 */	li r31, 0
/* 8012AC6C 00126AAC  3F C0 66 66 */	lis r30, 0x6666
/* 8012AC70 00126AB0  3B 40 FF FF */	li r26, -1
lbl_8012AC74:
/* 8012AC74 00126AB4  80 1D 00 50 */	lwz r0, 0x50(r29)
/* 8012AC78 00126AB8  2C 00 00 00 */	cmpwi r0, 0
...
/* 8012AC88 00126AC8  2C 03 00 00 */	cmpwi r3, 0
...
/* 8012ACA0 00126AE0  2C 03 00 00 */	cmpwi r3, 0
...
/* 8012ACF8 00126B38  54 03 0F FE */	srwi r3, r0, 0x1f
/* 8012ACFC 00126B3C  7C 00 1A 14 */	add r0, r0, r3
/* 8012AD00 00126B40  B0 07 00 00 */	sth r0, 0(r7)
/* 8012AD04 00126B44  A8 06 00 02 */	lha r0, 2(r6)
...
/* 8012AD14 00126B54  54 03 0F FE */	srwi r3, r0, 0x1f
/* 8012AD18 00126B58  7C 00 1A 14 */	add r0, r0, r3
/* 8012AD1C 00126B5C  B0 07 00 02 */	sth r0, 2(r7)
/* 8012AD20 00126B60  A8 06 00 04 */	lha r0, 4(r6)
...
/* 8012AD30 00126B70  54 03 0F FE */	srwi r3, r0, 0x1f
/* 8012AD34 00126B74  7C 00 1A 14 */	add r0, r0, r3
/* 8012AD38 00126B78  B0 07 00 04 */	sth r0, 4(r7)
/* 8012AD3C 00126B7C  A8 06 00 06 */	lha r0, 6(r6)
/* 8012AD40 00126B80  38 C6 00 08 */	addi r6, r6, 8
...
/* 8012AD50 00126B90  54 03 0F FE */	srwi r3, r0, 0x1f
/* 8012AD54 00126B94  7C 00 1A 14 */	add r0, r0, r3
/* 8012AD58 00126B98  B0 07 00 06 */	sth r0, 6(r7)
/* 8012AD5C 00126B9C  38 E7 00 08 */	addi r7, r7, 8
/* 8012AD60 00126BA0  42 00 FF 88 */	bdnz lbl_8012ACE8
/* 8012AD64 00126BA4  70 A5 00 03 */	andi. r5, r5, 3
/* 8012AD68 00126BA8  41 82 00 30 */	beq lbl_8012AD98
lbl_8012AD6C:
/* 8012AD6C 00126BAC  7C A9 03 A6 */	mtctr r5
lbl_8012AD70:
/* 8012AD70 00126BB0  A8 06 00 00 */	lha r0, 0(r6)
/* 8012AD74 00126BB4  38 C6 00 02 */	addi r6, r6, 2
...
/* 8012AD84 00126BC4  54 03 0F FE */	srwi r3, r0, 0x1f
/* 8012AD88 00126BC8  7C 00 1A 14 */	add r0, r0, r3
/* 8012AD8C 00126BCC  B0 07 00 00 */	sth r0, 0(r7)
/* 8012AD90 00126BD0  38 E7 00 02 */	addi r7, r7, 2
...
/* 8012ADA4 00126BE4  28 03 00 00 */	cmplwi r3, 0
/* 8012ADA8 00126BE8  40 81 00 54 */	ble lbl_8012ADFC
/* 8012ADAC 00126BEC  54 60 E8 FF */	rlwinm. r0, r3, 0x1d, 3, 0x1f
/* 8012ADB0 00126BF0  7C 09 03 A6 */	mtctr r0
/* 8012ADB4 00126BF4  41 82 00 34 */	beq lbl_8012ADE8
lbl_8012ADB8:
/* 8012ADB8 00126BF8  B3 E7 00 00 */	sth r31, 0(r7)
/* 8012ADBC 00126BFC  B3 E7 00 02 */	sth r31, 2(r7)
/* 8012ADC0 00126C00  B3 E7 00 04 */	sth r31, 4(r7)
/* 8012ADC4 00126C04  B3 E7 00 06 */	sth r31, 6(r7)
/* 8012ADC8 00126C08  B3 E7 00 08 */	sth r31, 8(r7)
...
/* 8012ADE0 00126C20  70 63 00 07 */	andi. r3, r3, 7
/* 8012ADE4 00126C24  41 82 00 18 */	beq lbl_8012ADFC
lbl_8012ADE8:
/* 8012ADE8 00126C28  7C 69 03 A6 */	mtctr r3
/* 8012ADEC 00126C2C  60 00 00 00 */	nop 
lbl_8012ADF0:
/* 8012ADF0 00126C30  B3 E7 00 00 */	sth r31, 0(r7)
/* 8012ADF4 00126C34  38 E7 00 02 */	addi r7, r7, 2
...
/* 8012AE08 00126C48  38 E1 00 08 */	addi r7, r1, 8
...
/* 8012AE20 00126C60  38 81 00 08 */	addi r4, r1, 8
...
/* 8012AE44 00126C84  34 03 FF B0 */	addic. r0, r3, -80
...
/* 8012AE60 00126CA0  38 03 00 01 */	addi r0, r3, 1
/* 8012AE64 00126CA4  98 1D 00 5E */	stb r0, 0x5e(r29)
/* 8012AE68 00126CA8  54 00 06 3E */	clrlwi r0, r0, 0x18
...
/* 8012AEAC 00126CEC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global ClearPcm__Q210homebutton9RemoteSpkFv
ClearPcm__Q210homebutton9RemoteSpkFv:
/* 8012AEB0 00126CF0  38 80 00 00 */	li r4, 0
/* 8012AEB4 00126CF4  38 00 FF FF */	li r0, -1
...
/* 8012AEDC 00126D1C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8012AEF0 00126D30  4B ED C4 49 */	bl func_80007338
/* 8012AEF4 00126D34  3C A0 80 44 */	lis r5, __vt__Q210homebutton9RemoteSpk@ha
/* 8012AEF8 00126D38  2C 04 00 00 */	cmpwi r4, 0
...
/* 8012AF48 00126D88  3B 60 00 00 */	li r27, 0
/* 8012AF4C 00126D8C  3B A0 00 00 */	li r29, 0
/* 8012AF50 00126D90  3B C0 FF FF */	li r30, -1
/* 8012AF54 00126D94  3B E0 00 01 */	li r31, 1
lbl_8012AF58:
...
/* 8012AF64 00126DA4  3B 7B 00 01 */	addi r27, r27, 1
/* 8012AF68 00126DA8  2C 1B 00 04 */	cmpwi r27, 4
...
/* 8012AF88 00126DC8  4B ED C3 FD */	bl func_80007384
...
/* 8012AF9C 00126DDC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8012AFA8 00126DE8  2C 03 00 00 */	cmpwi r3, 0
...
/* 8012AFDC 00126E1C  38 00 00 00 */	li r0, 0
...
/* 8012B044 00126E84  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8012B048 00126E88  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8012B04C 00126E8C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8012B060 00126EA0  4B ED C2 DD */	bl func_8000733C
/* 8012B064 00126EA4  88 03 01 EC */	lbz r0, 0x1ec(r3)
/* 8012B068 00126EA8  7C 7F 1B 78 */	mr r31, r3
/* 8012B06C 00126EAC  2C 00 00 00 */	cmpwi r0, 0
...
/* 8012B084 00126EC4  3C A0 43 1C */	lis r5, 0x431BDE83@ha
/* 8012B088 00126EC8  80 06 00 F8 */	lwz r0, 0x800000F8@l(r6)
/* 8012B08C 00126ECC  3C C0 10 62 */	lis r6, 0x10624DD3@ha
/* 8012B090 00126ED0  39 46 4D D3 */	addi r10, r6, 0x10624DD3@l
...
/* 8012B09C 00126EDC  38 A5 DE 83 */	addi r5, r5, 0x431BDE83@l
/* 8012B0A0 00126EE0  7D 05 00 16 */	mulhwu r8, r5, r0
/* 8012B0A4 00126EE4  3C E0 00 66 */	lis r7, 0x0065B9AB@ha
/* 8012B0A8 00126EE8  7C 86 23 78 */	mr r6, r4
/* 8012B0AC 00126EEC  38 07 B9 AB */	addi r0, r7, 0x0065B9AB@l
/* 8012B0B0 00126EF0  7C 65 1B 78 */	mr r5, r3
/* 8012B0B4 00126EF4  38 7F 01 A0 */	addi r3, r31, 0x1a0
/* 8012B0B8 00126EF8  55 04 8B FE */	srwi r4, r8, 0xf
...
/* 8012B0C4 00126F04  38 E0 00 00 */	li r7, 0
...
/* 8012B0D4 00126F14  3B 60 00 00 */	li r27, 0
/* 8012B0D8 00126F18  3B 80 00 00 */	li r28, 0
/* 8012B0DC 00126F1C  3B A0 FF FF */	li r29, -1
/* 8012B0E0 00126F20  3B C0 00 01 */	li r30, 1
lbl_8012B0E4:
...
/* 8012B0F0 00126F30  3B 7B 00 01 */	addi r27, r27, 1
/* 8012B0F4 00126F34  2C 1B 00 04 */	cmpwi r27, 4
...
/* 8012B110 00126F50  4B ED C2 79 */	bl func_80007388
...
/* 8012B124 00126F64  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8012B128 00126F68  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8012B12C 00126F6C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8012B140 00126F80  93 C1 00 08 */	stw r30, 8(r1)
...
/* 8012B174 00126FB4  83 C1 00 08 */	lwz r30, 8(r1)
/* 8012B178 00126FB8  7C 08 03 A6 */	mtlr r0
/* 8012B17C 00126FBC  38 21 00 10 */	addi r1, r1, 0x10
/* 8012B180 00126FC0  4E 80 00 20 */	blr 
/* 8012B184 00126FC4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8012B188 00126FC8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8012B18C 00126FCC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8012B1A4 00126FE4  38 80 00 01 */	li r4, 1
...
/* 8012B1D8 00127018  2C 06 00 00 */	cmpwi r6, 0
/* 8012B1DC 0012701C  41 82 00 A8 */	beq lbl_8012B284
/* 8012B1E0 00127020  2C 04 00 00 */	cmpwi r4, 0
/* 8012B1E4 00127024  41 82 00 18 */	beq lbl_8012B1FC
/* 8012B1E8 00127028  2C 04 FF FD */	cmpwi r4, -3
/* 8012B1EC 0012702C  41 82 00 34 */	beq lbl_8012B220
/* 8012B1F0 00127030  2C 04 FF FE */	cmpwi r4, -2
...
/* 8012B204 00127044  38 E0 00 01 */	li r7, 1
...
/* 8012B210 00127050  38 80 00 04 */	li r4, 4
...
/* 8012B224 00127064  38 80 00 00 */	li r4, 0
...
/* 8012B25C 0012709C  3C 60 10 62 */	lis r3, 0x10624DD3@ha
/* 8012B260 001270A0  38 83 4D D3 */	addi r4, r3, 0x10624DD3@l
...
/* 8012B274 001270B4  38 A0 00 00 */	li r5, 0
...
/* 8012B298 001270D8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8012B29C 001270DC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8012B2B4 001270F4  38 80 00 04 */	li r4, 4
...
/* 8012B2E8 00127128  2C 05 00 00 */	cmpwi r5, 0
/* 8012B2EC 0012712C  41 82 00 B4 */	beq lbl_8012B3A0
/* 8012B2F0 00127130  2C 04 00 00 */	cmpwi r4, 0
/* 8012B2F4 00127134  41 82 00 20 */	beq lbl_8012B314
/* 8012B2F8 00127138  2C 04 FF FD */	cmpwi r4, -3
/* 8012B2FC 0012713C  41 82 00 2C */	beq lbl_8012B328
/* 8012B300 00127140  2C 04 FF FF */	cmpwi r4, -1
/* 8012B304 00127144  41 82 00 38 */	beq lbl_8012B33C
/* 8012B308 00127148  2C 04 FF FE */	cmpwi r4, -2
...
/* 8012B318 00127158  38 80 00 01 */	li r4, 1
...
/* 8012B32C 0012716C  38 80 00 00 */	li r4, 0
...
/* 8012B340 00127180  38 80 00 00 */	li r4, 0
...
/* 8012B378 001271B8  3C 60 10 62 */	lis r3, 0x10624DD3@ha
/* 8012B37C 001271BC  38 83 4D D3 */	addi r4, r3, 0x10624DD3@l
...
/* 8012B390 001271D0  38 A0 00 00 */	li r5, 0
...
/* 8012B3B4 001271F4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8012B3B8 001271F8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8012B3BC 001271FC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8012B3F4 00127234  38 80 00 01 */	li r4, 1
/* 8012B3F8 00127238  4B F2 D5 B9 */	bl WPADControlSpeaker
/* 8012B3FC 0012723C  1C 9F 00 68 */	mulli r4, r31, 0x68
/* 8012B400 00127240  38 60 00 00 */	li r3, 0
/* 8012B404 00127244  38 00 00 01 */	li r0, 1
...
/* 8012B460 001272A0  4B ED BE D9 */	bl func_80007338
...
/* 8012B474 001272B4  2C 00 00 00 */	cmpwi r0, 0
...
/* 8012B4D4 00127314  4B ED BE B1 */	bl func_80007384
...
/* 8012B4E8 00127328  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8012B4EC 0012732C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8012B504 00127344  54 03 0F FE */	srwi r3, r0, 0x1f
/* 8012B508 00127348  4E 80 00 20 */	blr 
/* 8012B50C 0012734C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8012B51C 0012735C  2C 00 00 00 */	cmpwi r0, 0
...
/* 8012B530 00127370  38 60 00 01 */	li r3, 1
/* 8012B534 00127374  4E 80 00 20 */	blr 
lbl_8012B538:
/* 8012B538 00127378  38 60 00 00 */	li r3, 0
...
/* 8012B554 00127394  54 03 0F FE */	srwi r3, r0, 0x1f
