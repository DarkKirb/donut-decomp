...
/* 8013BB7C 001379BC  90 7C 00 00 */	stw r3, 0(r28)
...
/* 8013BB8C 001379CC  38 C0 00 04 */	li r6, 4
/* 8013BB90 001379D0  38 E0 00 04 */	li r7, 4
...
/* 8013BBA4 001379E4  3B E0 00 08 */	li r31, 8
/* 8013BBA8 001379E8  28 00 00 08 */	cmplwi r0, 8
/* 8013BBAC 001379EC  41 81 00 08 */	bgt lbl_8013BBB4
/* 8013BBB0 001379F0  7C 1F 03 78 */	mr r31, r0
lbl_8013BBB4:
/* 8013BBB4 001379F4  57 E4 06 3F */	clrlwi. r4, r31, 0x18
...
/* 8013BBC8 00137A08  57 E5 06 3F */	clrlwi. r5, r31, 0x18
...
/* 8013BBF0 00137A30  2C 00 00 00 */	cmpwi r0, 0
...
/* 8013BC68 00137AA8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8013BC6C 00137AAC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8013BC78 00137AB8  2C 03 00 00 */	cmpwi r3, 0
...
/* 8013BC88 00137AC8  93 C1 00 08 */	stw r30, 8(r1)
...
/* 8013BCA0 00137AE0  90 83 00 00 */	stw r4, 0(r3)
/* 8013BCA4 00137AE4  2C 05 00 00 */	cmpwi r5, 0
/* 8013BCA8 00137AE8  41 82 00 40 */	beq lbl_8013BCE8
/* 8013BCAC 00137AEC  88 05 00 54 */	lbz r0, 0x54(r5)
/* 8013BCB0 00137AF0  2C 00 00 00 */	cmpwi r0, 0
/* 8013BCB4 00137AF4  40 82 00 34 */	bne lbl_8013BCE8
/* 8013BCB8 00137AF8  81 85 00 00 */	lwz r12, 0(r5)
/* 8013BCBC 00137AFC  7C A3 2B 78 */	mr r3, r5
/* 8013BCC0 00137B00  38 80 FF FF */	li r4, -1
/* 8013BCC4 00137B04  81 8C 00 08 */	lwz r12, 8(r12)
...
/* 8013BCE0 00137B20  38 00 00 00 */	li r0, 0
...
/* 8013BCFC 00137B3C  38 A0 00 04 */	li r5, 4
/* 8013BD00 00137B40  38 C0 00 04 */	li r6, 4
/* 8013BD04 00137B44  4B EC B4 19 */	bl __destroy_arr
/* 8013BD08 00137B48  7F C3 F3 78 */	mr r3, r30
/* 8013BD0C 00137B4C  38 80 00 00 */	li r4, 0
/* 8013BD10 00137B50  4B FF EE 91 */	bl __dt__Q36nw4hbm3lyt4PaneFv
/* 8013BD14 00137B54  2C 1F 00 00 */	cmpwi r31, 0
...
/* 8013BD2C 00137B6C  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 8013BD48 00137B88  38 A0 00 00 */	li r5, 0
...
/* 8013BD8C 00137BCC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8013BDC0 00137C00  54 1C 27 3E */	srwi r28, r0, 0x1c
/* 8013BDC4 00137C04  54 60 27 3E */	srwi r0, r3, 0x1c
/* 8013BDC8 00137C08  7C 1C 00 40 */	cmplw r28, r0
/* 8013BDCC 00137C0C  40 80 01 14 */	bge lbl_8013BEE0
/* 8013BDD0 00137C10  54 60 67 3E */	rlwinm r0, r3, 0xc, 0x1c, 0x1f
...
lbl_8013BDE0:
/* 8013BDE0 00137C20  38 1C 00 01 */	addi r0, r28, 1
/* 8013BDE4 00137C24  7C A3 2B 78 */	mr r3, r5
/* 8013BDE8 00137C28  54 04 06 3E */	clrlwi r4, r0, 0x18
...
/* 8013BE08 00137C48  54 04 27 3E */	srwi r4, r0, 0x1c
/* 8013BE0C 00137C4C  4B FF D7 B5 */	bl SetTexCoordGenNum__Q36nw4hbm3lyt8MaterialFUc
/* 8013BE10 00137C50  3B A0 00 00 */	li r29, 0
/* 8013BE14 00137C54  3B C0 00 01 */	li r30, 1
/* 8013BE18 00137C58  38 80 00 04 */	li r4, 4
...
/* 8013BE28 00137C68  9B C1 00 08 */	stb r30, 8(r1)
/* 8013BE2C 00137C6C  98 81 00 09 */	stb r4, 9(r1)
/* 8013BE30 00137C70  98 01 00 0A */	stb r0, 0xa(r1)
/* 8013BE34 00137C74  80 01 00 08 */	lwz r0, 8(r1)
/* 8013BE38 00137C78  90 01 00 0C */	stw r0, 0xc(r1)
/* 8013BE3C 00137C7C  4B FF D6 75 */	bl GetTexCoordGenAry__Q36nw4hbm3lyt8MaterialFv
/* 8013BE40 00137C80  57 80 15 BA */	rlwinm r0, r28, 2, 0x16, 0x1d
...
lbl_8013BEA8:
/* 8013BEA8 00137CE8  2C 1D 00 00 */	cmpwi r29, 0
...
/* 8013BEB8 00137CF8  54 00 27 3E */	srwi r0, r0, 0x1c
/* 8013BEBC 00137CFC  28 00 00 01 */	cmplwi r0, 1
/* 8013BEC0 00137D00  40 82 00 20 */	bne lbl_8013BEE0
/* 8013BEC4 00137D04  38 61 00 10 */	addi r3, r1, 0x10
/* 8013BEC8 00137D08  38 A0 00 00 */	li r5, 0
...
/* 8013BF0C 00137D4C  90 03 00 00 */	stw r0, 0(r3)
/* 8013BF10 00137D50  4E 80 00 20 */	blr 
/* 8013BF14 00137D54  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8013BF18 00137D58  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8013BF1C 00137D5C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8013BF68 00137DA8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8013BF6C 00137DAC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global SetVtxColorElement__Q36nw4hbm3lyt7PictureFUlUc
SetVtxColorElement__Q36nw4hbm3lyt7PictureFUlUc:
/* 8013BF70 00137DB0  54 86 00 3A */	rlwinm r6, r4, 0, 0, 0x1d
/* 8013BF74 00137DB4  54 80 07 BE */	clrlwi r0, r4, 0x1e
...
/* 8013BF88 00137DC8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8013BF8C 00137DCC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8013BFB4 00137DF4  2C 00 00 00 */	cmpwi r0, 0
/* 8013BFB8 00137DF8  41 82 00 94 */	beq lbl_8013C04C
/* 8013BFBC 00137DFC  81 83 00 00 */	lwz r12, 0(r3)
...
/* 8013BFE8 00137E28  81 83 00 00 */	lwz r12, 0(r3)
...
/* 8013C004 00137E44  2C 1D 00 00 */	cmpwi r29, 0
...
lbl_8013C014:
/* 8013C014 00137E54  3B C0 00 00 */	li r30, 0
lbl_8013C018:
...
/* 8013C038 00137E78  90 61 00 08 */	stw r3, 8(r1)
/* 8013C03C 00137E7C  38 61 00 08 */	addi r3, r1, 8
...
/* 8013C06C 00137EAC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8013C07C 00137EBC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8013C094 00137ED4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
