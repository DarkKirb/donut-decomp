...
/* 801418F4 0013D734  90 9F 00 00 */	stw r4, 0(r31)
...
/* 8014190C 0013D74C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80141918 0013D758  2C 03 00 00 */	cmpwi r3, 0
...
/* 80141954 0013D794  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 80141968 0013D7A8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8014196C 0013D7AC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80141978 0013D7B8  38 A0 00 00 */	li r5, 0
...
/* 801419C4 0013D804  2C 03 00 00 */	cmpwi r3, 0
/* 801419C8 0013D808  40 81 00 98 */	ble lbl_80141A60
/* 801419CC 0013D80C  60 00 00 00 */	nop 
lbl_801419D0:
/* 801419D0 0013D810  80 64 00 00 */	lwz r3, 0(r4)
...
/* 801419E0 0013D820  38 A4 00 08 */	addi r5, r4, 8
/* 801419E4 0013D824  48 00 00 7C */	b lbl_80141A60
lbl_801419E8:
/* 801419E8 0013D828  80 04 00 04 */	lwz r0, 4(r4)
...
lbl_80141A60:
/* 80141A60 0013D8A0  2C 05 00 00 */	cmpwi r5, 0
/* 80141A64 0013D8A4  40 82 00 0C */	bne lbl_80141A70
/* 80141A68 0013D8A8  38 60 00 00 */	li r3, 0
...
/* 80141A7C 0013D8BC  81 9E 00 00 */	lwz r12, 0(r30)
...
/* 80141A9C 0013D8DC  38 60 00 01 */	li r3, 1
lbl_80141AA0:
/* 80141AA0 0013D8E0  80 01 00 14 */	lwz r0, 0x14(r1)
/* 80141AA4 0013D8E4  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 80141AA8 0013D8E8  83 C1 00 08 */	lwz r30, 8(r1)
/* 80141AAC 0013D8EC  7C 08 03 A6 */	mtlr r0
/* 80141AB0 0013D8F0  38 21 00 10 */	addi r1, r1, 0x10
/* 80141AB4 0013D8F4  4E 80 00 20 */	blr 
/* 80141AB8 0013D8F8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80141ABC 0013D8FC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.section .data, "wa"  # 0x80421040 - 0x80496700
.global __vt__Q36nw4hbm2ut7ResFont
__vt__Q36nw4hbm2ut7ResFont:
	.byte4 __RTTI__Q36nw4hbm2ut7ResFont
	.4byte 0
	.byte4 __dt__Q36nw4hbm2ut7ResFontFv
