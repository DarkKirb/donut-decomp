...
/* 800507B8 0004C5F8  38 60 00 00 */	li r3, 0
/* 800507BC 0004C5FC  90 01 00 14 */	stw r0, 0x14(r1)
/* 800507C0 0004C600  38 00 00 06 */	li r0, 6
...
/* 800507D0 0004C610  90 6D E9 20 */	stw r3, IpcNumPendingReqs-_SDA_BASE_(r13)
/* 800507D4 0004C614  38 9F 0C 00 */	addi r4, r31, 0xc00
/* 800507D8 0004C618  38 BF 0D 80 */	addi r5, r31, 0xd80
/* 800507DC 0004C61C  90 6D E9 24 */	stw r3, IpcNumUnIssuedReqs-_SDA_BASE_(r13)
/* 800507E0 0004C620  7C 09 03 A6 */	mtctr r0
lbl_800507E4:
/* 800507E4 0004C624  90 65 00 04 */	stw r3, 4(r5)
/* 800507E8 0004C628  90 65 00 00 */	stw r3, 0(r5)
/* 800507EC 0004C62C  90 65 00 0C */	stw r3, 0xc(r5)
/* 800507F0 0004C630  90 65 00 08 */	stw r3, 8(r5)
...
/* 80050824 0004C664  90 64 00 00 */	stw r3, 0(r4)
/* 80050828 0004C668  90 65 00 44 */	stw r3, 0x44(r5)
/* 8005082C 0004C66C  90 64 00 04 */	stw r3, 4(r4)
/* 80050830 0004C670  90 65 00 40 */	stw r3, 0x40(r5)
/* 80050834 0004C674  90 64 00 08 */	stw r3, 8(r4)
...
/* 800508B4 0004C6F4  38 80 00 00 */	li r4, 0
...
/* 800508C4 0004C704  38 80 00 00 */	li r4, 0
/* 800508C8 0004C708  38 A0 12 00 */	li r5, 0x1200
/* 800508CC 0004C70C  4B FB 3A 85 */	bl memset
/* 800508D0 0004C710  38 7F 00 00 */	addi r3, r31, 0
/* 800508D4 0004C714  38 80 00 00 */	li r4, 0
...
/* 800508F4 0004C734  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800508F8 0004C738  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800508FC 0004C73C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global IPCiProfQueueReq
IPCiProfQueueReq:
/* 80050900 0004C740  80 AD E9 20 */	lwz r5, IpcNumPendingReqs-_SDA_BASE_(r13)
/* 80050904 0004C744  80 8D E9 24 */	lwz r4, IpcNumUnIssuedReqs-_SDA_BASE_(r13)
/* 80050908 0004C748  38 05 00 01 */	addi r0, r5, 1
/* 8005090C 0004C74C  90 0D E9 20 */	stw r0, IpcNumPendingReqs-_SDA_BASE_(r13)
/* 80050910 0004C750  38 04 00 01 */	addi r0, r4, 1
/* 80050914 0004C754  90 0D E9 24 */	stw r0, IpcNumUnIssuedReqs-_SDA_BASE_(r13)
/* 80050918 0004C758  48 00 00 28 */	b AddReqInfo
/* 8005091C 0004C75C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global IPCiProfAck
IPCiProfAck:
/* 80050920 0004C760  80 6D E9 24 */	lwz r3, IpcNumUnIssuedReqs-_SDA_BASE_(r13)
/* 80050924 0004C764  38 03 FF FF */	addi r0, r3, -1
/* 80050928 0004C768  90 0D E9 24 */	stw r0, IpcNumUnIssuedReqs-_SDA_BASE_(r13)
/* 8005092C 0004C76C  4E 80 00 20 */	blr 

.global IPCiProfReply
IPCiProfReply:
/* 80050930 0004C770  80 8D E9 20 */	lwz r4, IpcNumPendingReqs-_SDA_BASE_(r13)
/* 80050934 0004C774  38 04 FF FF */	addi r0, r4, -1
/* 80050938 0004C778  90 0D E9 20 */	stw r0, IpcNumPendingReqs-_SDA_BASE_(r13)
...
/* 80050950 0004C790  4B FB 69 E5 */	bl func_80007334
...
/* 80050968 0004C7A8  3B 60 00 00 */	li r27, 0
/* 8005096C 0004C7AC  7C 09 03 A6 */	mtctr r0
lbl_80050970:
/* 80050970 0004C7B0  80 03 00 00 */	lwz r0, 0(r3)
/* 80050974 0004C7B4  2C 00 00 00 */	cmpwi r0, 0
...
/* 80050994 0004C7D4  3B FE 00 00 */	addi r31, r30, 0
/* 80050998 0004C7D8  80 19 00 04 */	lwz r0, 4(r25)
/* 8005099C 0004C7DC  7F BF E2 14 */	add r29, r31, r28
/* 800509A0 0004C7E0  80 79 00 00 */	lwz r3, 0(r25)
/* 800509A4 0004C7E4  7C 7F E1 2E */	stwx r3, r31, r28
/* 800509A8 0004C7E8  90 1D 00 04 */	stw r0, 4(r29)
/* 800509AC 0004C7EC  80 19 00 0C */	lwz r0, 0xc(r25)
/* 800509B0 0004C7F0  80 79 00 08 */	lwz r3, 8(r25)
/* 800509B4 0004C7F4  90 7D 00 08 */	stw r3, 8(r29)
...
/* 800509EC 0004C82C  80 1D 00 00 */	lwz r0, 0(r29)
/* 800509F0 0004C830  90 85 00 04 */	stw r4, 4(r5)
/* 800509F4 0004C834  28 00 00 01 */	cmplwi r0, 1
/* 800509F8 0004C838  90 65 00 00 */	stw r3, 0(r5)
...
/* 80050A24 0004C864  38 00 00 00 */	li r0, 0
...
lbl_80050A3C:
/* 80050A3C 0004C87C  38 63 00 04 */	addi r3, r3, 4
/* 80050A40 0004C880  3B 7B 00 01 */	addi r27, r27, 1
/* 80050A44 0004C884  42 00 FF 2C */	bdnz lbl_80050970
lbl_80050A48:
/* 80050A48 0004C888  39 61 00 30 */	addi r11, r1, 0x30
/* 80050A4C 0004C88C  4B FB 69 35 */	bl func_80007380
...
/* 80050A70 0004C8B0  4B FB 68 C5 */	bl func_80007334
...
/* 80050A88 0004C8C8  3B 80 00 00 */	li r28, 0
/* 80050A8C 0004C8CC  38 DF 00 00 */	addi r6, r31, 0
/* 80050A90 0004C8D0  7C 09 03 A6 */	mtctr r0
/* 80050A94 0004C8D4  60 00 00 00 */	nop 
lbl_80050A98:
/* 80050A98 0004C8D8  80 05 00 00 */	lwz r0, 0(r5)
/* 80050A9C 0004C8DC  7C 03 00 40 */	cmplw r3, r0
/* 80050AA0 0004C8E0  40 82 00 F4 */	bne lbl_80050B94
/* 80050AA4 0004C8E4  80 83 00 08 */	lwz r4, 8(r3)
/* 80050AA8 0004C8E8  80 06 00 00 */	lwz r0, 0(r6)
...
/* 80050ABC 0004C8FC  38 1F 00 00 */	addi r0, r31, 0
...
/* 80050ACC 0004C90C  28 00 00 01 */	cmplwi r0, 1
/* 80050AD0 0004C910  40 82 00 54 */	bne lbl_80050B24
/* 80050AD4 0004C914  80 19 00 04 */	lwz r0, 4(r25)
/* 80050AD8 0004C918  2C 00 00 00 */	cmpwi r0, 0
...
lbl_80050B24:
/* 80050B24 0004C964  80 1D 00 00 */	lwz r0, 0(r29)
/* 80050B28 0004C968  28 00 00 02 */	cmplwi r0, 2
/* 80050B2C 0004C96C  40 82 00 28 */	bne lbl_80050B54
/* 80050B30 0004C970  38 7F 00 00 */	addi r3, r31, 0
/* 80050B34 0004C974  38 1F 10 80 */	addi r0, r31, 0x1080
/* 80050B38 0004C978  7C 63 F2 14 */	add r3, r3, r30
/* 80050B3C 0004C97C  38 80 00 00 */	li r4, 0
/* 80050B40 0004C980  80 63 00 08 */	lwz r3, 8(r3)
...
/* 80050BBC 0004C9FC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
IpcReqPtrArray:
	.skip 0x180
.global IpcStartTimeArray
IpcStartTimeArray:
	.skip 0x300
.global IpcHandlePathBuf
IpcHandlePathBuf:
	.skip 0x1800
.global IpcOpenPathBuf
IpcOpenPathBuf:
	.skip 0x1200
