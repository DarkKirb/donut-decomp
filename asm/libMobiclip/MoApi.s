...
/* 8014ED50 0014AB90  80 6D 86 90 */	lwz r3, __MOBICLIP_MOVersion@sda21(r13)
...
/* 8014ED7C 0014ABBC  80 0D EC B0 */	lwz r0, MOiNbCreatedInstances@sda21(r13)
...
.global lbl_8014EE4C
lbl_8014EE4C:
/* 8014EE4C 0014AC8C  80 8D EC B0 */	lwz r4, MOiNbCreatedInstances@sda21(r13)
/* 8014EE50 0014AC90  38 60 00 00 */	li r3, 0x0
/* 8014EE54 0014AC94  38 04 00 01 */	addi r0, r4, 0x1
/* 8014EE58 0014AC98  90 0D EC B0 */	stw r0, MOiNbCreatedInstances@sda21(r13)
.global lbl_8014EE5C
lbl_8014EE5C:
...
/* 8014EE94 0014ACD4  3F E0 80 44 */	lis r31, "@2662"@ha
/* 8014EE98 0014ACD8  3B FF 7B 88 */	addi r31, r31, "@2662"@l
...
/* 8014EF5C 0014AD9C  3C 60 80 44 */	lis r3, "@3402"@ha
/* 8014EF60 0014ADA0  54 00 10 3A */	slwi r0, r0, 2
/* 8014EF64 0014ADA4  38 63 7C 28 */	addi r3, r3, "@3402"@l
...
/* 8014EFF0 0014AE30  3C 80 80 44 */	lis r4, "@3409"@ha
/* 8014EFF4 0014AE34  38 84 7C 4C */	addi r4, r4, "@3409"@l
...
/* 8014F014 0014AE54  3C 80 80 44 */	lis r4, "@3410"@ha
/* 8014F018 0014AE58  7F E3 FB 78 */	mr r3, r31
/* 8014F01C 0014AE5C  38 84 7C 68 */	addi r4, r4, "@3410"@l
...
/* 8014F078 0014AEB8  3C 80 80 44 */	lis r4, "@3417"@ha
/* 8014F07C 0014AEBC  38 84 7C 80 */	addi r4, r4, "@3417"@l
...
/* 8014F0E0 0014AF20  3C 80 80 44 */	lis r4, "@3425"@ha
/* 8014F0E4 0014AF24  38 84 7C A0 */	addi r4, r4, "@3425"@l
...
.global lbl_8014F110
lbl_8014F110:
/* 8014F110 0014AF50  80 8D EC B0 */	lwz r4, MOiNbCreatedInstances@sda21(r13)
/* 8014F114 0014AF54  38 60 00 00 */	li r3, 0x0
/* 8014F118 0014AF58  38 04 FF FF */	addi r0, r4, -0x1
/* 8014F11C 0014AF5C  90 0D EC B0 */	stw r0, MOiNbCreatedInstances@sda21(r13)
.global lbl_8014F120
lbl_8014F120:
...
/* 8014F320 0014B160  3C 80 80 44 */	lis r4, "@3509"@ha
/* 8014F324 0014B164  38 84 7C CC */	addi r4, r4, "@3509"@l
...
/* 8014F380 0014B1C0  3C 80 80 44 */	lis r4, "@3546"@ha
/* 8014F384 0014B1C4  38 84 7D 1C */	addi r4, r4, "@3546"@l
...
/* 8014F3E0 0014B220  4B EB 7F 59 */	bl _savegpr_26
/* 8014F3E4 0014B224  2C 03 00 00 */	cmpwi r3, 0x0
/* 8014F3E8 0014B228  3F C0 80 44 */	lis r30, "@2662"@ha
...
/* 8014F3FC 0014B23C  3B DE 7B 88 */	addi r30, r30, "@2662"@l
...
/* 8014F5E4 0014B424  4B EB 7D A1 */	bl _restgpr_26
...
/* 8014F638 0014B478  3C 80 80 44 */	lis r4, "@3600"@ha
/* 8014F63C 0014B47C  38 84 7D FC */	addi r4, r4, "@3600"@l
...
.global lbl_8014F67C
lbl_8014F67C:
/* 8014F67C 0014B4BC  3C 80 80 44 */	lis r4, "@3601"@ha
/* 8014F680 0014B4C0  7F E3 FB 78 */	mr r3, r31
/* 8014F684 0014B4C4  38 84 7E 28 */	addi r4, r4, "@3601"@l
...
/* 8014F6F0 0014B530  3C 80 80 44 */	lis r4, "@3614"@ha
/* 8014F6F4 0014B534  38 84 7E 58 */	addi r4, r4, "@3614"@l
...
/* 8014F730 0014B570  3C 80 80 44 */	lis r4, "@3615"@ha
/* 8014F734 0014B574  7F E3 FB 78 */	mr r3, r31
/* 8014F738 0014B578  38 84 7E 8C */	addi r4, r4, "@3615"@l
