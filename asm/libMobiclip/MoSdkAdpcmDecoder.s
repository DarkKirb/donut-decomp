...
/* 80151B4C 0014D98C  38 A1 00 08 */	addi r5, r1, 8
...
/* 80151B6C 0014D9AC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80151B78 0014D9B8  2C 03 00 00 */	cmpwi r3, 0
...
/* 80151B88 0014D9C8  93 C1 00 08 */	stw r30, 8(r1)
...
/* 80151BA8 0014D9E8  38 80 00 00 */	li r4, 0
/* 80151BAC 0014D9EC  48 00 04 A5 */	bl __dt__17MoSdkAudioDecoderFv
/* 80151BB0 0014D9F0  2C 1F 00 00 */	cmpwi r31, 0
...
/* 80151BC8 0014DA08  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 80151BDC 0014DA1C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80151BE8 0014DA28  3C A0 3E 10 */	lis r5, 0x3E0F83E1@ha
/* 80151BEC 0014DA2C  90 01 00 14 */	stw r0, 0x14(r1)
/* 80151BF0 0014DA30  38 05 83 E1 */	addi r0, r5, 0x3E0F83E1@l
...
/* 80151C0C 0014DA4C  3C 80 80 45 */	lis r4, $$22535@ha
/* 80151C10 0014DA50  80 63 00 0C */	lwz r3, 0xc(r3)
/* 80151C14 0014DA54  38 84 81 80 */	addi r4, r4, $$22535@l
/* 80151C18 0014DA58  4C C6 31 82 */	crclr 6
...
/* 80151C38 0014DA78  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80151C3C 0014DA7C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80151CA0 0014DAE0  38 9B 00 04 */	addi r4, r27, 4
...
/* 80151CB4 0014DAF4  3B 39 00 01 */	addi r25, r25, 1
lbl_80151CB8:
...
/* 80151CC4 0014DB04  90 1D 00 00 */	stw r0, 0(r29)
/* 80151CC8 0014DB08  38 60 00 01 */	li r3, 1
/* 80151CCC 0014DB0C  48 00 01 84 */	b lbl_80151E50
lbl_80151CD0:
/* 80151CD0 0014DB10  3B C0 00 00 */	li r30, 0
...
/* 80151CE0 0014DB20  38 61 00 08 */	addi r3, r1, 8
/* 80151CE4 0014DB24  4B FF CE 3D */	bl ImaAdpcmSetContext
/* 80151CE8 0014DB28  38 61 00 08 */	addi r3, r1, 8
/* 80151CEC 0014DB2C  38 9B 00 04 */	addi r4, r27, 4
...
/* 80151D2C 0014DB6C  B0 1C 00 00 */	sth r0, 0(r28)
/* 80151D30 0014DB70  A0 03 02 14 */	lhz r0, 0x214(r3)
/* 80151D34 0014DB74  B0 1C 00 02 */	sth r0, 2(r28)
/* 80151D38 0014DB78  A0 03 00 16 */	lhz r0, 0x16(r3)
/* 80151D3C 0014DB7C  B0 1C 00 04 */	sth r0, 4(r28)
/* 80151D40 0014DB80  A0 03 02 16 */	lhz r0, 0x216(r3)
/* 80151D44 0014DB84  B0 1C 00 06 */	sth r0, 6(r28)
/* 80151D48 0014DB88  A0 03 00 18 */	lhz r0, 0x18(r3)
/* 80151D4C 0014DB8C  B0 1C 00 08 */	sth r0, 8(r28)
...
/* 80151E34 0014DC74  80 7D 00 00 */	lwz r3, 0(r29)
/* 80151E38 0014DC78  3B DE 00 01 */	addi r30, r30, 1
/* 80151E3C 0014DC7C  38 03 04 00 */	addi r0, r3, 0x400
/* 80151E40 0014DC80  90 1D 00 00 */	stw r0, 0(r29)
lbl_80151E44:
/* 80151E44 0014DC84  7C 1E F8 40 */	cmplw r30, r31
/* 80151E48 0014DC88  41 80 FE 94 */	blt lbl_80151CDC
/* 80151E4C 0014DC8C  38 60 00 01 */	li r3, 1
lbl_80151E50:
/* 80151E50 0014DC90  39 61 00 40 */	addi r11, r1, 0x40
/* 80151E54 0014DC94  4B EB 55 2D */	bl func_80007380
...
/* 80151E68 0014DCA8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80151E6C 0014DCAC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
