...
.global $$23024
$$23024:
	.asciz "[SDK] ReadingHeaderLoop need %d bytes, got %d\n"
	.balign 4
.global $$23025
$$23025:
	.asciz "[SDK] readingHeaderLoop, unhandled case\n"
	.balign 4
.global $$23099
$$23099:
	.asciz "[SDK] fps %f, total frame %d \n"
	.balign 4
	.4byte 0
.global $$23101
$$23101:
...
.global $$23102
$$23102:
	.asciz "[SDK] Found %d keyframes\n"
	.balign 4
.global $$23136
$$23136:
	.asciz "[SDK] FastAudio found %d Hz, %d Channels\n"
	.balign 4
.global $$23137
$$23137:
	.asciz "[SDK] ADPCM found %d Hz, %d Channels\n"
	.balign 4
.global $$23138
$$23138:
	.asciz "[SDK] PCM found %d Hz, %d Channels\n"
	.4byte 0
