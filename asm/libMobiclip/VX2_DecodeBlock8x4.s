...
/* 8015FA50 0015B890  93 C1 00 08 */	stw r30, 8(r1)
...
/* 8015FA70 0015B8B0  80 A3 00 00 */	lwz r5, 0(r3)
/* 8015FA74 0015B8B4  7D 26 0E 70 */	srawi r6, r9, 1
/* 8015FA78 0015B8B8  57 E4 07 7E */	clrlwi r4, r31, 0x1d
/* 8015FA7C 0015B8BC  55 20 1F 38 */	rlwinm r0, r9, 3, 0x1c, 0x1c
...
/* 8015FABC 0015B8FC  80 7E 00 00 */	lwz r3, 0(r30)
/* 8015FAC0 0015B900  57 E4 FF 7E */	rlwinm r4, r31, 0x1f, 0x1d, 0x1f
...
/* 8015FAD8 0015B918  54 60 17 38 */	rlwinm r0, r3, 2, 0x1c, 0x1c
...
/* 8015FB14 0015B954  80 1E 00 00 */	lwz r0, 0(r30)
...
/* 8015FB60 0015B9A0  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 8015FB90 0015B9D0  93 C1 00 08 */	stw r30, 8(r1)
...
/* 8015FBA0 0015B9E0  55 06 7C 7E */	srwi r6, r8, 0x11
...
/* 8015FBD0 0015BA10  7C C0 26 2C */	lhbrx r6, 0, r4
/* 8015FBD4 0015BA14  7C A7 00 D0 */	neg r5, r7
/* 8015FBD8 0015BA18  38 84 00 02 */	addi r4, r4, 2
...
/* 8015FC0C 0015BA4C  54 C0 7C 7E */	srwi r0, r6, 0x11
...
/* 8015FC48 0015BA88  7C C0 26 2C */	lhbrx r6, 0, r4
/* 8015FC4C 0015BA8C  7C A7 00 D0 */	neg r5, r7
/* 8015FC50 0015BA90  38 84 00 02 */	addi r4, r4, 2
...
/* 8015FC7C 0015BABC  80 A3 00 00 */	lwz r5, 0(r3)
...
/* 8015FC98 0015BAD8  55 20 1F 38 */	rlwinm r0, r9, 3, 0x1c, 0x1c
/* 8015FC9C 0015BADC  57 E4 07 7E */	clrlwi r4, r31, 0x1d
...
/* 8015FCD4 0015BB14  80 7E 00 00 */	lwz r3, 0(r30)
/* 8015FCD8 0015BB18  57 E4 FF 7E */	rlwinm r4, r31, 0x1f, 0x1d, 0x1f
...
/* 8015FCF0 0015BB30  54 60 17 38 */	rlwinm r0, r3, 2, 0x1c, 0x1c
...
/* 8015FD2C 0015BB6C  80 1E 00 00 */	lwz r0, 0(r30)
...
/* 8015FD78 0015BBB8  83 C1 00 08 */	lwz r30, 8(r1)
/* 8015FD7C 0015BBBC  7C 08 03 A6 */	mtlr r0
/* 8015FD80 0015BBC0  38 21 00 10 */	addi r1, r1, 0x10
/* 8015FD84 0015BBC4  4E 80 00 20 */	blr 
/* 8015FD88 0015BBC8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8015FD8C 0015BBCC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8015FDB0 0015BBF0  93 C1 00 08 */	stw r30, 8(r1)
...
/* 8015FDC0 0015BC00  55 06 7C 7E */	srwi r6, r8, 0x11
...
/* 8015FDF0 0015BC30  7C C0 26 2C */	lhbrx r6, 0, r4
/* 8015FDF4 0015BC34  7C A7 00 D0 */	neg r5, r7
/* 8015FDF8 0015BC38  38 84 00 02 */	addi r4, r4, 2
...
/* 8015FE2C 0015BC6C  54 C0 7C 7E */	srwi r0, r6, 0x11
...
/* 8015FE68 0015BCA8  7C C0 26 2C */	lhbrx r6, 0, r4
/* 8015FE6C 0015BCAC  7C A7 00 D0 */	neg r5, r7
/* 8015FE70 0015BCB0  38 84 00 02 */	addi r4, r4, 2
...
/* 8015FE9C 0015BCDC  80 A3 00 00 */	lwz r5, 0(r3)
...
/* 8015FEB8 0015BCF8  55 20 1F 38 */	rlwinm r0, r9, 3, 0x1c, 0x1c
/* 8015FEBC 0015BCFC  57 E4 07 7E */	clrlwi r4, r31, 0x1d
...
/* 8015FEF4 0015BD34  80 7E 00 00 */	lwz r3, 0(r30)
/* 8015FEF8 0015BD38  57 E4 FF 7E */	rlwinm r4, r31, 0x1f, 0x1d, 0x1f
...
/* 8015FF10 0015BD50  54 60 17 38 */	rlwinm r0, r3, 2, 0x1c, 0x1c
...
/* 8015FF4C 0015BD8C  80 1E 00 00 */	lwz r0, 0(r30)
...
/* 8015FF98 0015BDD8  83 C1 00 08 */	lwz r30, 8(r1)
/* 8015FF9C 0015BDDC  7C 08 03 A6 */	mtlr r0
/* 8015FFA0 0015BDE0  38 21 00 10 */	addi r1, r1, 0x10
/* 8015FFA4 0015BDE4  4E 80 00 20 */	blr 
/* 8015FFA8 0015BDE8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8015FFAC 0015BDEC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8015FFD0 0015BE10  93 C1 00 08 */	stw r30, 8(r1)
...
/* 8015FFE0 0015BE20  55 06 7C 7E */	srwi r6, r8, 0x11
...
/* 80160010 0015BE50  7C C0 26 2C */	lhbrx r6, 0, r4
/* 80160014 0015BE54  7C A7 00 D0 */	neg r5, r7
/* 80160018 0015BE58  38 84 00 02 */	addi r4, r4, 2
...
/* 8016004C 0015BE8C  54 C0 7C 7E */	srwi r0, r6, 0x11
...
/* 80160088 0015BEC8  7C C0 26 2C */	lhbrx r6, 0, r4
/* 8016008C 0015BECC  7C A7 00 D0 */	neg r5, r7
/* 80160090 0015BED0  38 84 00 02 */	addi r4, r4, 2
...
/* 801600BC 0015BEFC  80 A3 00 00 */	lwz r5, 0(r3)
...
/* 801600D8 0015BF18  55 20 1F 38 */	rlwinm r0, r9, 3, 0x1c, 0x1c
/* 801600DC 0015BF1C  57 E4 07 7E */	clrlwi r4, r31, 0x1d
...
/* 80160114 0015BF54  80 7E 00 00 */	lwz r3, 0(r30)
/* 80160118 0015BF58  57 E4 FF 7E */	rlwinm r4, r31, 0x1f, 0x1d, 0x1f
...
/* 80160130 0015BF70  54 60 17 38 */	rlwinm r0, r3, 2, 0x1c, 0x1c
...
/* 8016016C 0015BFAC  80 1E 00 00 */	lwz r0, 0(r30)
...
/* 801601B8 0015BFF8  83 C1 00 08 */	lwz r30, 8(r1)
/* 801601BC 0015BFFC  7C 08 03 A6 */	mtlr r0
/* 801601C0 0015C000  38 21 00 10 */	addi r1, r1, 0x10
/* 801601C4 0015C004  4E 80 00 20 */	blr 
/* 801601C8 0015C008  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 801601CC 0015C00C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 801601F0 0015C030  93 C1 00 08 */	stw r30, 8(r1)
...
/* 80160200 0015C040  55 06 7C 7E */	srwi r6, r8, 0x11
...
/* 80160230 0015C070  7C C0 26 2C */	lhbrx r6, 0, r4
/* 80160234 0015C074  7C A7 00 D0 */	neg r5, r7
/* 80160238 0015C078  38 84 00 02 */	addi r4, r4, 2
...
/* 8016026C 0015C0AC  54 C0 7C 7E */	srwi r0, r6, 0x11
...
/* 801602A8 0015C0E8  7C C0 26 2C */	lhbrx r6, 0, r4
/* 801602AC 0015C0EC  7C A7 00 D0 */	neg r5, r7
/* 801602B0 0015C0F0  38 84 00 02 */	addi r4, r4, 2
...
/* 801602DC 0015C11C  80 A3 00 00 */	lwz r5, 0(r3)
...
/* 801602F8 0015C138  55 20 1F 38 */	rlwinm r0, r9, 3, 0x1c, 0x1c
/* 801602FC 0015C13C  57 E4 07 7E */	clrlwi r4, r31, 0x1d
...
/* 80160334 0015C174  80 7E 00 00 */	lwz r3, 0(r30)
/* 80160338 0015C178  57 E4 FF 7E */	rlwinm r4, r31, 0x1f, 0x1d, 0x1f
...
/* 80160350 0015C190  54 60 17 38 */	rlwinm r0, r3, 2, 0x1c, 0x1c
...
/* 8016038C 0015C1CC  80 1E 00 00 */	lwz r0, 0(r30)
...
/* 801603D8 0015C218  83 C1 00 08 */	lwz r30, 8(r1)
/* 801603DC 0015C21C  7C 08 03 A6 */	mtlr r0
/* 801603E0 0015C220  38 21 00 10 */	addi r1, r1, 0x10
/* 801603E4 0015C224  4E 80 00 20 */	blr 
/* 801603E8 0015C228  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 801603EC 0015C22C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80160410 0015C250  93 C1 00 08 */	stw r30, 8(r1)
...
/* 80160420 0015C260  55 06 7C 7E */	srwi r6, r8, 0x11
...
/* 80160450 0015C290  7C C0 26 2C */	lhbrx r6, 0, r4
/* 80160454 0015C294  7C A7 00 D0 */	neg r5, r7
/* 80160458 0015C298  38 84 00 02 */	addi r4, r4, 2
...
/* 8016048C 0015C2CC  54 C0 7C 7E */	srwi r0, r6, 0x11
...
/* 801604C8 0015C308  7C C0 26 2C */	lhbrx r6, 0, r4
/* 801604CC 0015C30C  7C A7 00 D0 */	neg r5, r7
/* 801604D0 0015C310  38 84 00 02 */	addi r4, r4, 2
...
/* 801604FC 0015C33C  80 A3 00 00 */	lwz r5, 0(r3)
...
/* 80160518 0015C358  55 20 1F 38 */	rlwinm r0, r9, 3, 0x1c, 0x1c
/* 8016051C 0015C35C  57 E4 07 7E */	clrlwi r4, r31, 0x1d
...
/* 80160554 0015C394  80 7E 00 00 */	lwz r3, 0(r30)
/* 80160558 0015C398  57 E4 FF 7E */	rlwinm r4, r31, 0x1f, 0x1d, 0x1f
...
/* 80160570 0015C3B0  54 60 17 38 */	rlwinm r0, r3, 2, 0x1c, 0x1c
...
/* 801605AC 0015C3EC  80 1E 00 00 */	lwz r0, 0(r30)
...
/* 801605F8 0015C438  83 C1 00 08 */	lwz r30, 8(r1)
/* 801605FC 0015C43C  7C 08 03 A6 */	mtlr r0
/* 80160600 0015C440  38 21 00 10 */	addi r1, r1, 0x10
/* 80160604 0015C444  4E 80 00 20 */	blr 
/* 80160608 0015C448  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8016060C 0015C44C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80160628 0015C468  80 1F 00 00 */	lwz r0, 0(r31)
...
/* 80160654 0015C494  80 7F 00 00 */	lwz r3, 0(r31)
...
/* 8016068C 0015C4CC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 801606B4 0015C4F4  38 05 00 04 */	addi r0, r5, 4
/* 801606B8 0015C4F8  90 1F 08 B4 */	stw r0, 0x8b4(r31)
/* 801606BC 0015C4FC  38 04 00 02 */	addi r0, r4, 2
...
/* 801606D0 0015C510  38 04 FF FC */	addi r0, r4, -4
/* 801606D4 0015C514  90 1F 08 B4 */	stw r0, 0x8b4(r31)
/* 801606D8 0015C518  38 03 FF FE */	addi r0, r3, -2
...
/* 801606F4 0015C534  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 801606F8 0015C538  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 801606FC 0015C53C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80160704 0015C544  3C 80 80 41 */	lis r4, $$2LOCAL$$2VX2DecodeBlockInter8x4__FR14VX2DecoderData$$2command@ha
/* 80160708 0015C548  3C A0 80 41 */	lis r5, $$2LOCAL$$2VX2DecodeBlockInter8x4__FR14VX2DecoderData$$2size$$20@ha
/* 8016070C 0015C54C  80 03 0A 04 */	lwz r0, 0xa04(r3)
/* 80160710 0015C550  54 C6 3E 7A */	rlwinm r6, r6, 7, 0x19, 0x1d
/* 80160714 0015C554  38 84 F2 70 */	addi r4, r4, $$2LOCAL$$2VX2DecodeBlockInter8x4__FR14VX2DecoderData$$2command@l
/* 80160718 0015C558  7C C4 30 2E */	lwzx r6, r4, r6
/* 8016071C 0015C55C  38 A5 F2 F0 */	addi r5, r5, $$2LOCAL$$2VX2DecodeBlockInter8x4__FR14VX2DecoderData$$2size$$20@l
...
/* 80160744 0015C584  7C C0 26 2C */	lhbrx r6, 0, r4
/* 80160748 0015C588  7C A7 00 D0 */	neg r5, r7
/* 8016074C 0015C58C  38 84 00 02 */	addi r4, r4, 2
...
/* 8016077C 0015C5BC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.section .rodata, "wa"  # 0x80406560 - 0x80421040
.global VX2CommandTable8x4
VX2CommandTable8x4:
	.byte4 VX2CommandSkip18x4__FR14VX2DecoderData
	.byte4 VX2CommandBack18x4__FR14VX2DecoderData
	.byte4 VX2CommandBack28x4__FR14VX2DecoderData
	.byte4 VX2CommandBack38x4__FR14VX2DecoderData
	.byte4 VX2CommandBack48x4__FR14VX2DecoderData
	.byte4 VX2CommandBack58x4__FR14VX2DecoderData
	.4byte 0
	.4byte 0
	.byte4 VX2CommandCutH8x4__FR14VX2DecoderData
	.byte4 VX2CommandCutV8x4__FR14VX2DecoderData
.global $$2LOCAL$$2VX2DecodeBlockInter8x4__FR14VX2DecoderData$$2command
$$2LOCAL$$2VX2DecodeBlockInter8x4__FR14VX2DecoderData$$2command:
	.4byte 0x00000001
	.4byte 0x00000001
	.4byte 0x00000001
	.4byte 0x00000001
	...
	.4byte 0x00000005
	.4byte 0x00000004
.global $$2LOCAL$$2VX2DecodeBlockInter8x4__FR14VX2DecoderData$$2size$$20
$$2LOCAL$$2VX2DecodeBlockInter8x4__FR14VX2DecoderData$$2size$$20:
	.4byte 0x00000003
	.4byte 0x00000001
	.4byte 0x00000003
	.4byte 0x00000004
