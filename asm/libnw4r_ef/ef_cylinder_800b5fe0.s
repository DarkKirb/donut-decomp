...
/* 800B60A8 000B1EE8  C2 62 8C AC */	lfs f19, "@7776_8055EC2C"@sda21(r2)
/* 800B60AC 000B1EEC  FF A0 30 90 */	fmr f29, f6
/* 800B60B0 000B1EF0  C2 82 8C A8 */	lfs f20, "@7775_8055EC28"@sda21(r2)
/* 800B60B4 000B1EF4  FF C0 38 90 */	fmr f30, f7
/* 800B60B8 000B1EF8  CA 02 8C B8 */	lfd f16, "@7786"@sda21(r2)
/* 800B60BC 000B1EFC  FF E0 40 90 */	fmr f31, f8
/* 800B60C0 000B1F00  C2 22 8C A0 */	lfs f17, "@7773_8055EC20"@sda21(r2)
/* 800B60C4 000B1F04  C2 42 8C A4 */	lfs f18, "@7774_8055EC24"@sda21(r2)
/* 800B60C8 000B1F08  7C 74 1B 78 */	mr r20, r3
/* 800B60CC 000B1F0C  C2 A2 8C B0 */	lfs f21, "@7777"@sda21(r2)
/* 800B60D0 000B1F10  7C 95 23 78 */	mr r21, r4
/* 800B60D4 000B1F14  CA C2 8C C0 */	lfd f22, "@7787"@sda21(r2)
/* 800B60D8 000B1F18  7C B6 2B 78 */	mr r22, r5
/* 800B60DC 000B1F1C  C2 E2 8C B4 */	lfs f23, "@7778"@sda21(r2)
...
/* 800B64E0 000B2320  C0 02 8C C8 */	lfs f0, "@7845_8055EC48"@sda21(r2)
...
/* 800B6500 000B2340  C0 02 8C C8 */	lfs f0, "@7845_8055EC48"@sda21(r2)
...
/* 800B6530 000B2370  C0 02 8C C8 */	lfs f0, "@7845_8055EC48"@sda21(r2)
...
/* 800B6550 000B2390  C3 82 8C A8 */	lfs f28, "@7775_8055EC28"@sda21(r2)
...
/* 800B656C 000B23AC  C8 82 8C B8 */	lfd f4, "@7786"@sda21(r2)
/* 800B6570 000B23B0  7C 65 01 D6 */	mullw r3, r5, r0
/* 800B6574 000B23B4  C0 42 8C A0 */	lfs f2, "@7773_8055EC20"@sda21(r2)
/* 800B6578 000B23B8  C0 22 8C CC */	lfs f1, "@7846_8055EC4C"@sda21(r2)
/* 800B657C 000B23BC  C0 02 8C B0 */	lfs f0, "@7777"@sda21(r2)
...
/* 800B65B8 000B23F8  C8 42 8C D0 */	lfd f2, "@7847_8055EC50"@sda21(r2)
...
/* 800B65C8 000B2408  C0 02 8C D8 */	lfs f0, "@7848_8055EC58"@sda21(r2)
/* 800B65CC 000B240C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800B65D0 000B2410  41 80 00 1C */	blt lbl_800B65EC
/* 800B65D4 000B2414  C0 02 8C DC */	lfs f0, "@7849_8055EC5C"@sda21(r2)
...
/* 800B65FC 000B243C  C8 22 8C B8 */	lfd f1, "@7786"@sda21(r2)
...
/* 800B6628 000B2468  C8 22 8C C0 */	lfd f1, "@7787"@sda21(r2)
...
.global lbl_800B663C
lbl_800B663C:
/* 800B663C 000B247C  CA E2 8C C0 */	lfd f23, "@7787"@sda21(r2)
/* 800B6640 000B2480  3A E0 00 00 */	li r23, 0x0
/* 800B6644 000B2484  C3 02 8C E0 */	lfs f24, "@7850_8055EC60"@sda21(r2)
/* 800B6648 000B2488  C3 22 8C B0 */	lfs f25, "@7777"@sda21(r2)
...
/* 800B6658 000B2498  C1 02 8C A8 */	lfs f8, "@7775_8055EC28"@sda21(r2)
...
/* 800B66E8 000B2528  C1 02 8C A8 */	lfs f8, "@7775_8055EC28"@sda21(r2)
