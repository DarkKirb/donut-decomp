...
/* 800B5308 000B1148  C0 02 8C 08 */	lfs f0, lbl_8055EB88@sda21(r2)
...
/* 800B5338 000B1178  C0 02 8C 08 */	lfs f0, lbl_8055EB88@sda21(r2)
...
.global lbl_800B5354
lbl_800B5354:
/* 800B5354 000B1194  C2 C2 8C 0C */	lfs f22, lbl_8055EB8C@sda21(r2)
...
/* 800B5378 000B11B8  C8 82 8C 40 */	lfd f4, lbl_8055EBC0@sda21(r2)
/* 800B537C 000B11BC  7C 65 01 D6 */	mullw r3, r5, r0
/* 800B5380 000B11C0  C0 42 8C 10 */	lfs f2, lbl_8055EB90@sda21(r2)
/* 800B5384 000B11C4  C0 22 8C 18 */	lfs f1, lbl_8055EB98@sda21(r2)
/* 800B5388 000B11C8  C0 02 8C 14 */	lfs f0, lbl_8055EB94@sda21(r2)
...
/* 800B53C4 000B1204  C8 42 8C 20 */	lfd f2, lbl_8055EBA0@sda21(r2)
/* 800B53C8 000B1208  EC 21 00 28 */	fsubs f1, f1, f0
/* 800B53CC 000B120C  4B F5 F1 C9 */	bl lbl_80014594
/* 800B53D0 000B1210  FC 20 08 18 */	frsp f1, f1
/* 800B53D4 000B1214  C0 02 8C 28 */	lfs f0, lbl_8055EBA8@sda21(r2)
/* 800B53D8 000B1218  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800B53DC 000B121C  41 80 00 1C */	blt lbl_800B53F8
/* 800B53E0 000B1220  C0 02 8C 2C */	lfs f0, lbl_8055EBAC@sda21(r2)
...
/* 800B5408 000B1248  C8 22 8C 40 */	lfd f1, lbl_8055EBC0@sda21(r2)
...
/* 800B5434 000B1274  C8 22 8C 48 */	lfd f1, lbl_8055EBC8@sda21(r2)
...
/* 800B544C 000B128C  C3 A2 8C 34 */	lfs f29, lbl_8055EBB4@sda21(r2)
/* 800B5450 000B1290  57 7D 01 CE */	rlwinm r29, r27, 0, 7, 7
/* 800B5454 000B1294  C3 C2 8C 0C */	lfs f30, lbl_8055EB8C@sda21(r2)
/* 800B5458 000B1298  CB 42 8C 40 */	lfd f26, lbl_8055EBC0@sda21(r2)
/* 800B545C 000B129C  3B DF 43 FD */	addi r30, r31, 0x43fd
/* 800B5460 000B12A0  C3 62 8C 10 */	lfs f27, lbl_8055EB90@sda21(r2)
/* 800B5464 000B12A4  3B 60 00 00 */	li r27, 0x0
/* 800B5468 000B12A8  C3 82 8C 30 */	lfs f28, lbl_8055EBB0@sda21(r2)
/* 800B546C 000B12AC  CB E2 8C 48 */	lfd f31, lbl_8055EBC8@sda21(r2)
/* 800B5470 000B12B0  C2 22 8C 38 */	lfs f17, lbl_8055EBB8@sda21(r2)
...
.global lbl_800B54D4
lbl_800B54D4:
/* 800B54D4 000B1314  48 04 95 9D */	bl lbl_800FEA70
...
/* 800B554C 000B138C  4B FF E5 75 */	bl lbl_800B3AC0
...
/* 800B55C4 000B1404  4B FF E4 7D */	bl lbl_800B3A40
...
/* 800B5604 000B1444  4B FF EA ED */	bl lbl_800B40F0
...
/* 800B5670 000B14B0  4B FF EF 41 */	bl lbl_800B45B0
