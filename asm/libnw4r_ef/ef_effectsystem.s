...
/* 800A4678 000A04B8  2C 03 00 00 */	cmpwi r3, 0
...
/* 800A469C 000A04DC  3F E3 00 01 */	addis r31, r3, 1
/* 800A46A0 000A04E0  3B C0 00 00 */	li r30, 0
...
/* 800A46B4 000A04F4  3B DE 00 01 */	addi r30, r30, 1
lbl_800A46B8:
...
/* 800A46C4 000A0504  2C 1D 00 00 */	cmpwi r29, 0
...
/* 800A46F8 000A0538  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800A46FC 000A053C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800A470C 000A054C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800A4720 000A0560  4B F6 2C 19 */	bl func_80007338
/* 800A4724 000A0564  3C A3 00 01 */	addis r5, r3, 1
...
/* 800A4734 000A0574  80 63 00 00 */	lwz r3, 0(r3)
/* 800A4738 000A0578  1C 84 00 1C */	mulli r4, r4, 0x1c
/* 800A473C 000A057C  81 83 00 00 */	lwz r12, 0(r3)
...
/* 800A475C 000A059C  38 A0 00 00 */	li r5, 0
/* 800A4760 000A05A0  38 C0 00 1C */	li r6, 0x1c
/* 800A4764 000A05A4  4B F6 27 01 */	bl __construct_new_array
/* 800A4768 000A05A8  3F DA 00 01 */	addis r30, r26, 1
/* 800A476C 000A05AC  3B 60 00 00 */	li r27, 0
/* 800A4770 000A05B0  90 7E C0 18 */	stw r3, -0x3fe8(r30)
/* 800A4774 000A05B4  3B 80 00 00 */	li r28, 0
/* 800A4778 000A05B8  3B E0 00 00 */	li r31, 0
...
/* 800A47A4 000A05E4  3B 7B 00 01 */	addi r27, r27, 1
...
/* 800A47B8 000A05F8  B3 E3 00 08 */	sth r31, 8(r3)
/* 800A47BC 000A05FC  93 E3 00 04 */	stw r31, 4(r3)
...
/* 800A47DC 000A061C  38 60 00 00 */	li r3, 0
/* 800A47E0 000A0620  38 AD EB 00 */	addi r5, r13, gBasicDrawOrder__Q24nw4r2ef-_SDA_BASE_
/* 800A47E4 000A0624  38 8D EB 04 */	addi r4, r13, gBasicDrawStrategyBuilder__Q24nw4r2ef-_SDA_BASE_
/* 800A47E8 000A0628  38 0D EB 08 */	addi r0, r13, gBasicEmitFormBuilder__Q24nw4r2ef-_SDA_BASE_
/* 800A47EC 000A062C  90 7E C0 1C */	stw r3, -0x3fe4(r30)
/* 800A47F0 000A0630  39 61 00 20 */	addi r11, r1, 0x20
/* 800A47F4 000A0634  38 60 00 01 */	li r3, 1
/* 800A47F8 000A0638  90 BA 00 04 */	stw r5, 4(r26)
/* 800A47FC 000A063C  90 9A 00 08 */	stw r4, 8(r26)
/* 800A4800 000A0640  90 1A 00 0C */	stw r0, 0xc(r26)
/* 800A4804 000A0644  4B F6 2B 81 */	bl func_80007384
...
/* 800A4818 000A0658  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800A481C 000A065C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800A4828 000A0668  38 80 00 00 */	li r4, 0
...
/* 800A4840 000A0680  38 80 00 00 */	li r4, 0
/* 800A4844 000A0684  4B FF EF ED */	bl MEMInitList
/* 800A4848 000A0688  38 00 00 00 */	li r0, 0
...
/* 800A4868 000A06A8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800A486C 000A06AC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800A48B0 000A06F0  38 00 00 03 */	li r0, 3
/* 800A48B4 000A06F4  90 1E 00 0C */	stw r0, 0xc(r30)
/* 800A48B8 000A06F8  38 60 00 01 */	li r3, 1
/* 800A48BC 000A06FC  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 800A48C0 000A0700  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 800A48D4 000A0714  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800A48D8 000A0718  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800A48DC 000A071C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800A48F0 000A0730  4B F6 2A 4D */	bl func_8000733C
/* 800A48F4 000A0734  2C 04 00 00 */	cmpwi r4, 0
...
/* 800A49B8 000A07F8  38 A0 00 01 */	li r5, 1
/* 800A49BC 000A07FC  3C 9B 00 01 */	addis r4, r27, 1
/* 800A49C0 000A0800  38 00 00 02 */	li r0, 2
/* 800A49C4 000A0804  38 63 00 01 */	addi r3, r3, 1
...
/* 800A49E0 000A0820  38 84 FF FF */	addi r4, r4, -1
...
/* 800A49F0 000A0830  4B F6 29 99 */	bl func_80007388
...
/* 800A4A04 000A0844  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800A4A08 000A0848  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800A4A0C 000A084C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800A4A20 000A0860  4B F6 29 15 */	bl func_80007334
/* 800A4A24 000A0864  1C 04 00 1C */	mulli r0, r4, 0x1c
/* 800A4A28 000A0868  3C A3 00 01 */	addis r5, r3, 1
/* 800A4A2C 000A086C  7C 7E 1B 78 */	mr r30, r3
/* 800A4A30 000A0870  80 65 C0 18 */	lwz r3, -0x3fe8(r5)
/* 800A4A34 000A0874  38 81 00 08 */	addi r4, r1, 8
/* 800A4A38 000A0878  7C 63 02 14 */	add r3, r3, r0
/* 800A4A3C 000A087C  A0 A3 00 08 */	lhz r5, 8(r3)
/* 800A4A40 000A0880  3B E0 00 00 */	li r31, 0
/* 800A4A44 000A0884  48 00 E6 6D */	bl UtlistToArray__Q24nw4r2efFPCQ34nw4r2ut4ListPPvi
/* 800A4A48 000A0888  3B 61 00 08 */	addi r27, r1, 8
/* 800A4A4C 000A088C  54 7D 04 3E */	clrlwi r29, r3, 0x10
/* 800A4A50 000A0890  3B 40 00 00 */	li r26, 0
/* 800A4A54 000A0894  3B 80 00 02 */	li r28, 2
/* 800A4A58 000A0898  48 00 00 78 */	b lbl_800A4AD0
lbl_800A4A5C:
/* 800A4A5C 000A089C  57 40 13 BA */	rlwinm r0, r26, 2, 0xe, 0x1d
/* 800A4A60 000A08A0  7F 3B 00 2E */	lwzx r25, r27, r0
/* 800A4A64 000A08A4  80 19 00 0C */	lwz r0, 0xc(r25)
/* 800A4A68 000A08A8  2C 00 00 01 */	cmpwi r0, 1
/* 800A4A6C 000A08AC  40 82 00 60 */	bne lbl_800A4ACC
/* 800A4A70 000A08B0  80 19 00 40 */	lwz r0, 0x40(r25)
/* 800A4A74 000A08B4  3C 7E 00 01 */	addis r3, r30, 1
...
/* 800A4A8C 000A08CC  38 04 FF FF */	addi r0, r4, -1
...
/* 800A4AAC 000A08EC  2C 00 00 00 */	cmpwi r0, 0
...
/* 800A4ABC 000A08FC  81 8C 00 08 */	lwz r12, 8(r12)
/* 800A4AC0 000A0900  7D 89 03 A6 */	mtctr r12
/* 800A4AC4 000A0904  4E 80 04 21 */	bctrl 
lbl_800A4AC8:
/* 800A4AC8 000A0908  3B FF 00 01 */	addi r31, r31, 1
lbl_800A4ACC:
/* 800A4ACC 000A090C  3B 5A 00 01 */	addi r26, r26, 1
lbl_800A4AD0:
/* 800A4AD0 000A0910  57 40 04 3E */	clrlwi r0, r26, 0x10
...
/* 800A4AE4 000A0924  4B F6 28 9D */	bl func_80007380
...
/* 800A4AF8 000A0938  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800A4AFC 000A093C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800A4B10 000A0950  3F E3 00 01 */	addis r31, r3, 1
...
/* 800A4B20 000A0960  3B A0 00 00 */	li r29, 0
...
/* 800A4B58 000A0998  2C 03 00 00 */	cmpwi r3, 0
...
/* 800A4B84 000A09C4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800A4B88 000A09C8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800A4B8C 000A09CC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800A4BD8 000A0A18  38 84 C0 2C */	addi r4, r4, -16340
...
/* 800A4BE8 000A0A28  3C 7F 00 01 */	addis r3, r31, 1
/* 800A4BEC 000A0A2C  D3 C3 C0 60 */	stfs f30, -0x3fa0(r3)
/* 800A4BF0 000A0A30  D3 E3 C0 5C */	stfs f31, -0x3fa4(r3)
/* 800A4BF4 000A0A34  E3 E1 00 28 */	psq_l f31, 40(r1), 0, qr0
/* 800A4BF8 000A0A38  CB E1 00 20 */	lfd f31, 0x20(r1)
/* 800A4BFC 000A0A3C  E3 C1 00 18 */	psq_l f30, 24(r1), 0, qr0
...
/* 800A4C18 000A0A58  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800A4C1C 000A0A5C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800A4C58 000A0A98  90 6D EB 00 */	stw r3, gBasicDrawOrder__Q24nw4r2ef-_SDA_BASE_(r13)
/* 800A4C5C 000A0A9C  38 7D 00 00 */	addi r3, r29, 0
/* 800A4C60 000A0AA0  90 AD EB 04 */	stw r5, gBasicDrawStrategyBuilder__Q24nw4r2ef-_SDA_BASE_(r13)
/* 800A4C64 000A0AA4  90 8D EB 08 */	stw r4, gBasicEmitFormBuilder__Q24nw4r2ef-_SDA_BASE_(r13)
/* 800A4C68 000A0AA8  4B F8 B8 79 */	bl PSMTXIdentity
/* 800A4C6C 000A0AAC  3B DD 00 00 */	addi r30, r29, 0
/* 800A4C70 000A0AB0  38 7E 00 30 */	addi r3, r30, 0x30
/* 800A4C74 000A0AB4  4B F8 B8 6D */	bl PSMTXIdentity
/* 800A4C78 000A0AB8  C0 22 89 F8 */	lfs f1, $$28588-_SDA2_BASE_(r2)
/* 800A4C7C 000A0ABC  38 80 00 00 */	li r4, 0
/* 800A4C80 000A0AC0  38 00 00 FF */	li r0, 0xff
/* 800A4C84 000A0AC4  C0 02 89 FC */	lfs f0, $$28613-_SDA2_BASE_(r2)
/* 800A4C88 000A0AC8  38 7D 00 AC */	addi r3, r29, 0xac
/* 800A4C8C 000A0ACC  3B E0 00 01 */	li r31, 1
...
/* 800A4CEC 000A0B2C  80 0D EB 0C */	lwz r0, mDisplayVersion__Q34nw4r2ef12EffectSystem-_SDA_BASE_(r13)
/* 800A4CF0 000A0B30  2C 00 00 00 */	cmpwi r0, 0
/* 800A4CF4 000A0B34  40 82 00 10 */	bne lbl_800A4D04
/* 800A4CF8 000A0B38  93 ED EB 0C */	stw r31, mDisplayVersion__Q34nw4r2ef12EffectSystem-_SDA_BASE_(r13)
/* 800A4CFC 000A0B3C  80 6D 85 38 */	lwz r3, NW4R_EF_Version___29$$2unnamed$$2ef_effectsystem_cpp$$2-_SDA_BASE_(r13)
/* 800A4D00 000A0B40  4B F7 69 E1 */	bl OSRegisterVersion
lbl_800A4D04:
/* 800A4D04 000A0B44  38 7D 00 AC */	addi r3, r29, 0xac
/* 800A4D08 000A0B48  38 00 00 00 */	li r0, 0
/* 800A4D0C 000A0B4C  90 1D 00 AC */	stw r0, 0xac(r29)
/* 800A4D10 000A0B50  3C C3 00 01 */	addis r6, r3, 1
...
/* 800A4D2C 000A0B6C  4B F6 1E 45 */	bl __register_global_object
