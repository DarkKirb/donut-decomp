...
/* 800A5118 000A0F58  C8 82 8A 10 */	lfd f4, "@9116"@sda21(r2)
...
/* 800A5394 000A11D4  C0 02 8A 08 */	lfs f0, "@9110"@sda21(r2)
...
/* 800A5634 000A1474  C0 02 8A 04 */	lfs f0, "@9109"@sda21(r2)
...
/* 800A5970 000A17B0  C0 02 8A 04 */	lfs f0, "@9109"@sda21(r2)
...
/* 800A59F0 000A1830  C0 02 8A 20 */	lfs f0, "@9451"@sda21(r2)
...
/* 800A5A58 000A1898  C0 02 8A 04 */	lfs f0, "@9109"@sda21(r2)
...
/* 800A6004 000A1E44  C0 02 8A 04 */	lfs f0, "@9109"@sda21(r2)
...
/* 800A6038 000A1E78  C0 22 8A 24 */	lfs f1, "@9488"@sda21(r2)
...
/* 800A6048 000A1E88  C0 22 8A 04 */	lfs f1, "@9109"@sda21(r2)
/* 800A604C 000A1E8C  48 00 00 28 */	b lbl_800A6074
.global lbl_800A6050
lbl_800A6050:
/* 800A6050 000A1E90  EC 61 10 28 */	fsubs f3, f1, f2
/* 800A6054 000A1E94  C0 22 8A 04 */	lfs f1, "@9109"@sda21(r2)
...
/* 800A6068 000A1EA8  C0 02 8A 24 */	lfs f0, "@9488"@sda21(r2)
...
.global lbl_800A6104
lbl_800A6104:
/* 800A6104 000A1F44  C0 02 8A 04 */	lfs f0, "@9109"@sda21(r2)
...
/* 800A6130 000A1F70  C8 62 8A 10 */	lfd f3, "@9116"@sda21(r2)
/* 800A6134 000A1F74  C8 01 00 78 */	lfd f0, 0x78(r1)
/* 800A6138 000A1F78  C0 42 8A 28 */	lfs f2, "@9546_8055E9A8"@sda21(r2)
/* 800A613C 000A1F7C  EC 20 18 28 */	fsubs f1, f0, f3
/* 800A6140 000A1F80  C0 02 8A 24 */	lfs f0, "@9488"@sda21(r2)
...
/* 800A61A4 000A1FE4  C8 22 8A 10 */	lfd f1, "@9116"@sda21(r2)
...
.global lbl_800A61B8
lbl_800A61B8:
/* 800A61B8 000A1FF8  C0 22 8A 04 */	lfs f1, "@9109"@sda21(r2)
...
/* 800A61E4 000A2024  C8 C2 8A 10 */	lfd f6, "@9116"@sda21(r2)
/* 800A61E8 000A2028  EC 43 00 32 */	fmuls f2, f3, f0
/* 800A61EC 000A202C  C0 82 8A 28 */	lfs f4, "@9546_8055E9A8"@sda21(r2)
/* 800A61F0 000A2030  C0 22 8A 2C */	lfs f1, "@9547_8055E9AC"@sda21(r2)
/* 800A61F4 000A2034  C0 02 8A 24 */	lfs f0, "@9488"@sda21(r2)
...
/* 800A6274 000A20B4  C0 02 8A 24 */	lfs f0, "@9488"@sda21(r2)
...
/* 800A62A4 000A20E4  C0 22 8A 04 */	lfs f1, "@9109"@sda21(r2)
...
/* 800A62B4 000A20F4  C0 02 8A 24 */	lfs f0, "@9488"@sda21(r2)
...
/* 800A62C8 000A2108  C0 02 8A 24 */	lfs f0, "@9488"@sda21(r2)
...
/* 800A6304 000A2144  C8 42 8A 18 */	lfd f2, "@9117"@sda21(r2)
/* 800A6308 000A2148  7F C4 F3 78 */	mr r4, r30
/* 800A630C 000A214C  FC 20 00 1E */	fctiwz f1, f0
/* 800A6310 000A2150  C0 02 8A 00 */	lfs f0, "@9108"@sda21(r2)
...
/* 800A6460 000A22A0  C8 22 8A 18 */	lfd f1, "@9117"@sda21(r2)
...
/* 800A6478 000A22B8  C0 02 8A 00 */	lfs f0, "@9108"@sda21(r2)
...
/* 800A649C 000A22DC  C8 22 8A 18 */	lfd f1, "@9117"@sda21(r2)
...
.global lbl_800A68B8
lbl_800A68B8:
/* 800A68B8 000A26F8  C0 02 8A 04 */	lfs f0, "@9109"@sda21(r2)
...
/* 800A6964 000A27A4  C0 02 8A 04 */	lfs f0, "@9109"@sda21(r2)
...
/* 800A6980 000A27C0  C0 02 8A 04 */	lfs f0, "@9109"@sda21(r2)
...
/* 800A699C 000A27DC  C0 42 8A 04 */	lfs f2, "@9109"@sda21(r2)
...
/* 800A69BC 000A27FC  C0 22 8A 30 */	lfs f1, "@9717"@sda21(r2)
...
/* 800A6B70 000A29B0  C8 42 8A 18 */	lfd f2, "@9117"@sda21(r2)
...
/* 800A6B80 000A29C0  C0 02 8A 00 */	lfs f0, "@9108"@sda21(r2)
...
/* 800A6C44 000A2A84  C0 02 8A 20 */	lfs f0, "@9451"@sda21(r2)
...
/* 800A6E14 000A2C54  80 6D EB 10 */	lwz r3, smMtxInvId__Q34nw4r2ef15ParticleManager@sda21(r13)
...
/* 800A6E24 000A2C64  93 CD EB 10 */	stw r30, smMtxInvId__Q34nw4r2ef15ParticleManager@sda21(r13)
.global lbl_800A6E28
lbl_800A6E28:
...
/* 800A6E88 000A2CC8  80 6D EB 10 */	lwz r3, smMtxInvId__Q34nw4r2ef15ParticleManager@sda21(r13)
...
/* 800A6E98 000A2CD8  93 ED EB 10 */	stw r31, smMtxInvId__Q34nw4r2ef15ParticleManager@sda21(r13)
.global lbl_800A6E9C
lbl_800A6E9C:
