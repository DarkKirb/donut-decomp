...
/* 800B40F8 000AFF38  C0 22 8B 80 */	lfs f1, $$27729-_SDA2_BASE_(r2)
...
/* 800B4108 000AFF48  F3 E1 01 08 */	xsmaddadp f31, f1, f0
/* 800B410C 000AFF4C  DB C1 00 F0 */	stfd f30, 0xf0(r1)
/* 800B4110 000AFF50  F3 C1 00 F8 */	psq_st f30, 248(r1), 0, qr0
...
/* 800B4140 000AFF80  E0 48 00 00 */	psq_l f2, 0(r8), 0, qr0
/* 800B4144 000AFF84  10 22 00 18 */	ps_muls0 f1, f2, f0
/* 800B4148 000AFF88  E0 48 80 08 */	psq_l f2, 8(r8), 1, qr0
/* 800B414C 000AFF8C  F0 24 00 00 */	psq_st f1, 0(r4), 0, qr0
/* 800B4150 000AFF90  10 22 00 18 */	ps_muls0 f1, f2, f0
/* 800B4154 000AFF94  F0 24 80 08 */	psq_st f1, 8(r4), 1, qr0
/* 800B4158 000AFF98  48 00 00 10 */	b lbl_800B4168
lbl_800B415C:
/* 800B415C 000AFF9C  D0 24 00 00 */	stfs f1, 0(r4)
/* 800B4160 000AFFA0  D0 24 00 04 */	stfs f1, 4(r4)
/* 800B4164 000AFFA4  D0 24 00 08 */	stfs f1, 8(r4)
lbl_800B4168:
/* 800B4168 000AFFA8  C0 22 8B 80 */	lfs f1, $$27729-_SDA2_BASE_(r2)
...
/* 800B4178 000AFFB8  E0 49 00 00 */	psq_l f2, 0(r9), 0, qr0
/* 800B417C 000AFFBC  38 61 00 2C */	addi r3, r1, 0x2c
/* 800B4180 000AFFC0  E0 64 00 00 */	psq_l f3, 0(r4), 0, qr0
/* 800B4184 000AFFC4  10 22 00 18 */	ps_muls0 f1, f2, f0
/* 800B4188 000AFFC8  E0 49 80 08 */	psq_l f2, 8(r9), 1, qr0
/* 800B418C 000AFFCC  F0 23 00 00 */	psq_st f1, 0(r3), 0, qr0
/* 800B4190 000AFFD0  10 22 00 18 */	ps_muls0 f1, f2, f0
/* 800B4194 000AFFD4  E0 03 00 00 */	psq_l f0, 0(r3), 0, qr0
/* 800B4198 000AFFD8  F0 23 80 08 */	psq_st f1, 8(r3), 1, qr0
/* 800B419C 000AFFDC  10 03 00 2A */	ps_add f0, f3, f0
/* 800B41A0 000AFFE0  E0 64 80 08 */	psq_l f3, 8(r4), 1, qr0
/* 800B41A4 000AFFE4  F0 04 00 00 */	psq_st f0, 0(r4), 0, qr0
/* 800B41A8 000AFFE8  10 03 08 2A */	ps_add f0, f3, f1
/* 800B41AC 000AFFEC  F0 04 80 08 */	psq_st f0, 8(r4), 1, qr0
lbl_800B41B0:
/* 800B41B0 000AFFF0  C0 22 8B 80 */	lfs f1, $$27729-_SDA2_BASE_(r2)
...
/* 800B41C0 000B0000  3C 60 00 03 */	lis r3, 0x000343FD@ha
/* 800B41C4 000B0004  80 05 00 EC */	lwz r0, 0xec(r5)
/* 800B41C8 000B0008  38 E3 43 FD */	addi r7, r3, 0x000343FD@l
/* 800B41CC 000B000C  C8 C2 8B 98 */	lfd f6, $$27742-_SDA2_BASE_(r2)
/* 800B41D0 000B0010  7C C0 39 D6 */	mullw r6, r0, r7
/* 800B41D4 000B0014  C0 A2 8B 84 */	lfs f5, $$27730-_SDA2_BASE_(r2)
/* 800B41D8 000B0018  C0 82 8B 8C */	lfs f4, $$27732-_SDA2_BASE_(r2)
/* 800B41DC 000B001C  38 61 00 1C */	addi r3, r1, 0x1c
/* 800B41E0 000B0020  C0 62 8B 88 */	lfs f3, $$27731-_SDA2_BASE_(r2)
/* 800B41E4 000B0024  38 81 00 18 */	addi r4, r1, 0x18
/* 800B41E8 000B0028  3C C6 00 27 */	addis r6, r6, 0x27
/* 800B41EC 000B002C  38 06 9E C3 */	addi r0, r6, -24893
/* 800B41F0 000B0030  7C C0 39 D6 */	mullw r6, r0, r7
/* 800B41F4 000B0034  54 00 84 3E */	srwi r0, r0, 0x10
...
/* 800B4208 000B0048  38 06 9E C3 */	addi r0, r6, -24893
/* 800B420C 000B004C  7C C0 39 D6 */	mullw r6, r0, r7
/* 800B4210 000B0050  54 00 84 3E */	srwi r0, r0, 0x10
...
/* 800B4224 000B0064  38 06 9E C3 */	addi r0, r6, -24893
/* 800B4228 000B0068  90 05 00 EC */	stw r0, 0xec(r5)
/* 800B422C 000B006C  54 00 84 3E */	srwi r0, r0, 0x10
...
/* 800B427C 000B00BC  38 81 00 08 */	addi r4, r1, 8
...
/* 800B428C 000B00CC  C0 41 00 08 */	lfs f2, 8(r1)
...
/* 800B42A4 000B00E4  C0 5D 00 00 */	lfs f2, 0(r29)
/* 800B42A8 000B00E8  EC 81 00 32 */	fmuls f4, f1, f0
/* 800B42AC 000B00EC  C0 3D 00 04 */	lfs f1, 4(r29)
/* 800B42B0 000B00F0  C0 1D 00 08 */	lfs f0, 8(r29)
...
/* 800B42C0 000B0100  D0 5D 00 00 */	stfs f2, 0(r29)
...
/* 800B42D8 000B0118  C0 61 00 08 */	lfs f3, 8(r1)
...
/* 800B42F4 000B0134  D0 3D 00 04 */	stfs f1, 4(r29)
...
/* 800B4310 000B0150  D0 1D 00 08 */	stfs f0, 8(r29)
lbl_800B4314:
/* 800B4314 000B0154  C0 02 8B 80 */	lfs f0, $$27729-_SDA2_BASE_(r2)
...
/* 800B4324 000B0164  C0 3F 00 00 */	lfs f1, 0(r31)
/* 800B4328 000B0168  C0 1D 00 00 */	lfs f0, 0(r29)
/* 800B432C 000B016C  EC 61 00 B2 */	fmuls f3, f1, f2
/* 800B4330 000B0170  C0 9F 00 04 */	lfs f4, 4(r31)
/* 800B4334 000B0174  C0 3D 00 04 */	lfs f1, 4(r29)
/* 800B4338 000B0178  C0 5F 00 08 */	lfs f2, 8(r31)
/* 800B433C 000B017C  EC 60 18 2A */	fadds f3, f0, f3
/* 800B4340 000B0180  C0 1D 00 08 */	lfs f0, 8(r29)
/* 800B4344 000B0184  D0 7D 00 00 */	stfs f3, 0(r29)
...
/* 800B4354 000B0194  D0 3D 00 04 */	stfs f1, 4(r29)
...
/* 800B4364 000B01A4  D0 1D 00 08 */	stfs f0, 8(r29)
lbl_800B4368:
/* 800B4368 000B01A8  C0 62 8B 80 */	lfs f3, $$27729-_SDA2_BASE_(r2)
...
/* 800B4398 000B01D8  C0 22 8B 80 */	lfs f1, $$27729-_SDA2_BASE_(r2)
/* 800B439C 000B01DC  38 81 00 20 */	addi r4, r1, 0x20
/* 800B43A0 000B01E0  C0 02 8B 90 */	lfs f0, $$27733-_SDA2_BASE_(r2)
...
/* 800B43C4 000B0204  C0 5D 00 00 */	lfs f2, 0(r29)
/* 800B43C8 000B0208  EC 61 00 32 */	fmuls f3, f1, f0
/* 800B43CC 000B020C  C0 3D 00 04 */	lfs f1, 4(r29)
/* 800B43D0 000B0210  C0 1D 00 08 */	lfs f0, 8(r29)
/* 800B43D4 000B0214  EC 42 18 2A */	fadds f2, f2, f3
/* 800B43D8 000B0218  D0 5D 00 00 */	stfs f2, 0(r29)
...
/* 800B43EC 000B022C  D0 3D 00 04 */	stfs f1, 4(r29)
...
/* 800B4400 000B0240  D0 1D 00 08 */	stfs f0, 8(r29)
/* 800B4404 000B0244  48 00 00 E4 */	b lbl_800B44E8
lbl_800B4408:
/* 800B4408 000B0248  3C 60 00 03 */	lis r3, 0x000343FD@ha
/* 800B440C 000B024C  80 1E 00 EC */	lwz r0, 0xec(r30)
/* 800B4410 000B0250  38 A3 43 FD */	addi r5, r3, 0x000343FD@l
/* 800B4414 000B0254  C8 82 8B 98 */	lfd f4, $$27742-_SDA2_BASE_(r2)
/* 800B4418 000B0258  7C 80 29 D6 */	mullw r4, r0, r5
/* 800B441C 000B025C  C0 A2 8B 84 */	lfs f5, $$27730-_SDA2_BASE_(r2)
/* 800B4420 000B0260  C0 22 8B 8C */	lfs f1, $$27732-_SDA2_BASE_(r2)
/* 800B4424 000B0264  38 61 00 68 */	addi r3, r1, 0x68
/* 800B4428 000B0268  C0 02 8B 88 */	lfs f0, $$27731-_SDA2_BASE_(r2)
/* 800B442C 000B026C  3C 84 00 27 */	addis r4, r4, 0x27
/* 800B4430 000B0270  38 04 9E C3 */	addi r0, r4, -24893
/* 800B4434 000B0274  7C 80 29 D6 */	mullw r4, r0, r5
/* 800B4438 000B0278  54 00 84 3E */	srwi r0, r0, 0x10
...
/* 800B444C 000B028C  38 04 9E C3 */	addi r0, r4, -24893
/* 800B4450 000B0290  90 1E 00 EC */	stw r0, 0xec(r30)
/* 800B4454 000B0294  54 00 84 3E */	srwi r0, r0, 0x10
...
/* 800B44A8 000B02E8  C0 5D 00 00 */	lfs f2, 0(r29)
/* 800B44AC 000B02EC  EC 61 00 32 */	fmuls f3, f1, f0
/* 800B44B0 000B02F0  C0 3D 00 04 */	lfs f1, 4(r29)
/* 800B44B4 000B02F4  C0 1D 00 08 */	lfs f0, 8(r29)
/* 800B44B8 000B02F8  EC 42 18 2A */	fadds f2, f2, f3
/* 800B44BC 000B02FC  D0 5D 00 00 */	stfs f2, 0(r29)
...
/* 800B44D0 000B0310  D0 3D 00 04 */	stfs f1, 4(r29)
...
/* 800B44E4 000B0324  D0 1D 00 08 */	stfs f0, 8(r29)
lbl_800B44E8:
...
/* 800B44F4 000B0334  3C 60 00 03 */	lis r3, 0x000343FD@ha
/* 800B44F8 000B0338  80 9E 00 EC */	lwz r4, 0xec(r30)
/* 800B44FC 000B033C  38 63 43 FD */	addi r3, r3, 0x000343FD@l
...
/* 800B450C 000B034C  C8 E2 8B 98 */	lfd f7, $$27742-_SDA2_BASE_(r2)
/* 800B4510 000B0350  C0 C2 8B 84 */	lfs f6, $$27730-_SDA2_BASE_(r2)
/* 800B4514 000B0354  C8 22 8B A0 */	lfd f1, $$27743-_SDA2_BASE_(r2)
...
/* 800B4524 000B0364  38 03 9E C3 */	addi r0, r3, -24893
/* 800B4528 000B0368  90 1E 00 EC */	stw r0, 0xec(r30)
/* 800B452C 000B036C  54 00 84 3E */	srwi r0, r0, 0x10
/* 800B4530 000B0370  C0 02 8B 94 */	lfs f0, $$27734-_SDA2_BASE_(r2)
/* 800B4534 000B0374  90 01 00 D4 */	stw r0, 0xd4(r1)
/* 800B4538 000B0378  EC A0 00 72 */	fmuls f5, f0, f1
/* 800B453C 000B037C  C0 62 8B 88 */	lfs f3, $$27731-_SDA2_BASE_(r2)
/* 800B4540 000B0380  C8 41 00 D0 */	lfd f2, 0xd0(r1)
/* 800B4544 000B0384  C0 82 8B 90 */	lfs f4, $$27733-_SDA2_BASE_(r2)
/* 800B4548 000B0388  EC E2 38 28 */	fsubs f7, f2, f7
/* 800B454C 000B038C  C0 5D 00 00 */	lfs f2, 0(r29)
/* 800B4550 000B0390  C0 3D 00 04 */	lfs f1, 4(r29)
/* 800B4554 000B0394  C0 1D 00 08 */	lfs f0, 8(r29)
...
/* 800B4578 000B03B8  D0 5D 00 00 */	stfs f2, 0(r29)
/* 800B457C 000B03BC  D0 3D 00 04 */	stfs f1, 4(r29)
/* 800B4580 000B03C0  D0 1D 00 08 */	stfs f0, 8(r29)
lbl_800B4584:
/* 800B4584 000B03C4  80 01 01 14 */	lwz r0, 0x114(r1)
/* 800B4588 000B03C8  E3 E1 01 08 */	psq_l f31, 264(r1), 0, qr0
/* 800B458C 000B03CC  CB E1 01 00 */	lfd f31, 0x100(r1)
/* 800B4590 000B03D0  E3 C1 00 F8 */	psq_l f30, 248(r1), 0, qr0
...
/* 800B45B0 000B03F0  C0 02 8B 80 */	lfs f0, $$27729-_SDA2_BASE_(r2)
...
/* 800B4634 000B0474  38 80 00 01 */	li r4, 1
/* 800B4638 000B0478  48 00 00 40 */	b lbl_800B4678
lbl_800B463C:
/* 800B463C 000B047C  90 81 00 14 */	stw r4, 0x14(r1)
/* 800B4640 000B0480  C0 02 8B A8 */	lfs f0, $$27754-_SDA2_BASE_(r2)
...
/* 800B4658 000B0498  3C 60 00 01 */	lis r3, 0x0000FFFF@ha
/* 800B465C 000B049C  38 83 FF FF */	addi r4, r3, 0x0000FFFF@l
...
/* 800B4674 000B04B4  54 04 04 3E */	clrlwi r4, r0, 0x10
lbl_800B4678:
/* 800B4678 000B04B8  7C 83 23 78 */	mr r3, r4
/* 800B467C 000B04BC  38 21 00 20 */	addi r1, r1, 0x20
/* 800B4680 000B04C0  4E 80 00 20 */	blr 
/* 800B4684 000B04C4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800B4688 000B04C8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800B468C 000B04CC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.section .data7, "wa"  # 0x8055DF80 - 0x805643C0
.global $$27729
$$27729:
	.incbin "baserom.dol", 0x499640, 0x4
.global $$27730
$$27730:
	.incbin "baserom.dol", 0x499644, 0x4
.global $$27731
$$27731:
	.incbin "baserom.dol", 0x499648, 0x4
.global $$27732
$$27732:
	.incbin "baserom.dol", 0x49964C, 0x4
.global $$27733
$$27733:
	.incbin "baserom.dol", 0x499650, 0x4
.global $$27734
$$27734:
	.incbin "baserom.dol", 0x499654, 0x4
.global $$27742
$$27742:
	.incbin "baserom.dol", 0x499658, 0x8
.global $$27743
$$27743:
	.incbin "baserom.dol", 0x499660, 0x8
.global $$27754
$$27754:
	.incbin "baserom.dol", 0x499668, 0x8
