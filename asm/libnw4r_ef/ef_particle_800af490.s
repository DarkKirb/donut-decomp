...
.global lbl_800AF490
lbl_800AF490:
/* 800AF490 000AB2D0  3C 80 80 44 */	lis r4, lbl_80440308@ha
/* 800AF494 000AB2D4  38 84 03 08 */	addi r4, r4, lbl_80440308@l
/* 800AF498 000AB2D8  90 83 00 1C */	stw r4, 0x1c(r3)
/* 800AF49C 000AB2DC  4E 80 00 20 */	blr
.global lbl_800AF4A0
lbl_800AF4A0:
/* 800AF4A0 000AB2E0  4B FF 59 10 */	b lbl_800A4DB0
...
/* 800AF4B8 000AB2F8  48 00 0E 28 */	b lbl_800B02E0
...
/* 800AF534 000AB374  CB E2 8A C8 */	lfd f31, lbl_8055EA48@sda21(r2)
...
/* 800AF54C 000AB38C  C3 02 8A A8 */	lfs f24, lbl_8055EA28@sda21(r2)
...
/* 800AF698 000AB4D8  4B F6 47 2D */	bl lbl_80013DC4
...
/* 800AF874 000AB6B4  48 00 2C CD */	bl lbl_800B2540
...
/* 800AF890 000AB6D0  4B FF FC 41 */	bl lbl_800AF4D0
...
/* 800AF8A0 000AB6E0  C0 22 8A D8 */	lfs f1, lbl_8055EA58@sda21(r2)
...
/* 800AF980 000AB7C0  4B FF 73 11 */	bl lbl_800A6C90
/* 800AF984 000AB7C4  38 61 00 98 */	addi r3, r1, 0x98
/* 800AF988 000AB7C8  7C 64 1B 78 */	mr r4, r3
/* 800AF98C 000AB7CC  4B F8 0E 75 */	bl lbl_80030800
/* 800AF990 000AB7D0  C0 02 8A D8 */	lfs f0, lbl_8055EA58@sda21(r2)
...
/* 800AF9AC 000AB7EC  4B F8 17 45 */	bl lbl_800310F0
...
/* 800AF9E8 000AB828  4B F8 17 09 */	bl lbl_800310F0
...
/* 800AFA04 000AB844  C0 02 8A D8 */	lfs f0, lbl_8055EA58@sda21(r2)
...
/* 800AFA68 000AB8A8  4B F8 16 89 */	bl lbl_800310F0
.global lbl_800AFA6C
lbl_800AFA6C:
/* 800AFA6C 000AB8AC  C0 02 8A D8 */	lfs f0, lbl_8055EA58@sda21(r2)
/* 800AFA70 000AB8B0  2C 1B 00 00 */	cmpwi r27, 0x0
/* 800AFA74 000AB8B4  C0 22 8A AC */	lfs f1, lbl_8055EA2C@sda21(r2)
...
/* 800AFAB0 000AB8F0  48 00 23 C1 */	bl lbl_800B1E70
/* 800AFAB4 000AB8F4  C0 02 8A D8 */	lfs f0, lbl_8055EA58@sda21(r2)
...
/* 800AFAD0 000AB910  4B F8 16 21 */	bl lbl_800310F0
/* 800AFAD4 000AB914  80 78 00 C8 */	lwz r3, 0xc8(r24)
/* 800AFAD8 000AB918  38 81 00 38 */	addi r4, r1, 0x38
/* 800AFADC 000AB91C  48 00 23 95 */	bl lbl_800B1E70
/* 800AFAE0 000AB920  C0 02 8A D8 */	lfs f0, lbl_8055EA58@sda21(r2)
...
/* 800AFAF8 000AB938  4B F8 0D 09 */	bl lbl_80030800
...
/* 800AFB08 000AB948  4B F8 15 E9 */	bl lbl_800310F0
/* 800AFB0C 000AB94C  A8 1A 00 00 */	lha r0, 0x0(r26)
/* 800AFB10 000AB950  C8 E2 8A E8 */	lfd f7, lbl_8055EA68@sda21(r2)
...
/* 800AFB24 000AB964  C0 C2 8A DC */	lfs f6, lbl_8055EA5C@sda21(r2)
...
/* 800AFBA8 000AB9E8  C8 42 8A C8 */	lfd f2, lbl_8055EA48@sda21(r2)
...
/* 800AFBB8 000AB9F8  C0 02 8A DC */	lfs f0, lbl_8055EA5C@sda21(r2)
...
/* 800AFC40 000ABA80  C8 42 8A C8 */	lfd f2, lbl_8055EA48@sda21(r2)
/* 800AFC44 000ABA84  C8 21 00 C8 */	lfd f1, 0xc8(r1)
/* 800AFC48 000ABA88  EC 63 00 32 */	fmuls f3, f3, f0
/* 800AFC4C 000ABA8C  C0 02 8A DC */	lfs f0, lbl_8055EA5C@sda21(r2)
...
/* 800AFC6C 000ABAAC  80 62 8A D0 */	lwz r3, lbl_8055EA50@sda21(r2)
/* 800AFC70 000ABAB0  7F 64 DB 78 */	mr r4, r27
/* 800AFC74 000ABAB4  80 02 8A D4 */	lwz r0, lbl_8055EA54@sda21(r2)
...
/* 800AFC8C 000ABACC  48 00 24 85 */	bl lbl_800B2110
...
/* 800AFCF0 000ABB30  48 00 03 31 */	bl lbl_800B0020
...
/* 800AFD78 000ABBB8  48 00 02 A9 */	bl lbl_800B0020
...
/* 800AFECC 000ABD0C  C8 42 8A C8 */	lfd f2, lbl_8055EA48@sda21(r2)
/* 800AFED0 000ABD10  C8 21 00 D0 */	lfd f1, 0xd0(r1)
/* 800AFED4 000ABD14  C0 02 8A E0 */	lfs f0, lbl_8055EA60@sda21(r2)
/* 800AFED8 000ABD18  EC 61 10 28 */	fsubs f3, f1, f2
/* 800AFEDC 000ABD1C  C0 9B 00 40 */	lfs f4, 0x40(r27)
/* 800AFEE0 000ABD20  C0 42 8A BC */	lfs f2, lbl_8055EA3C@sda21(r2)
/* 800AFEE4 000ABD24  C0 22 8A B8 */	lfs f1, lbl_8055EA38@sda21(r2)
/* 800AFEE8 000ABD28  EC 60 00 F2 */	fmuls f3, f0, f3
/* 800AFEEC 000ABD2C  C0 02 8A C0 */	lfs f0, lbl_8055EA40@sda21(r2)
...
/* 800AFF00 000ABD40  4B F6 3E C5 */	bl lbl_80013DC4
/* 800AFF04 000ABD44  FC 00 08 18 */	frsp f0, f1
/* 800AFF08 000ABD48  C8 A2 8A C8 */	lfd f5, lbl_8055EA48@sda21(r2)
/* 800AFF0C 000ABD4C  C0 62 8A E0 */	lfs f3, lbl_8055EA60@sda21(r2)
/* 800AFF10 000ABD50  C0 42 8A BC */	lfs f2, lbl_8055EA3C@sda21(r2)
/* 800AFF14 000ABD54  FC 80 00 1E */	fctiwz f4, f0
/* 800AFF18 000ABD58  C0 22 8A B8 */	lfs f1, lbl_8055EA38@sda21(r2)
/* 800AFF1C 000ABD5C  C0 02 8A C0 */	lfs f0, lbl_8055EA40@sda21(r2)
...
/* 800AFF68 000ABDA8  4B F6 3E 5D */	bl lbl_80013DC4
/* 800AFF6C 000ABDAC  FC 00 08 18 */	frsp f0, f1
/* 800AFF70 000ABDB0  C8 A2 8A C8 */	lfd f5, lbl_8055EA48@sda21(r2)
/* 800AFF74 000ABDB4  C0 62 8A E0 */	lfs f3, lbl_8055EA60@sda21(r2)
/* 800AFF78 000ABDB8  C0 42 8A BC */	lfs f2, lbl_8055EA3C@sda21(r2)
/* 800AFF7C 000ABDBC  FC 80 00 1E */	fctiwz f4, f0
/* 800AFF80 000ABDC0  C0 22 8A B8 */	lfs f1, lbl_8055EA38@sda21(r2)
/* 800AFF84 000ABDC4  C0 02 8A C0 */	lfs f0, lbl_8055EA40@sda21(r2)
...
/* 800AFFD0 000ABE10  4B F6 3D F5 */	bl lbl_80013DC4
...
/* 800B01B4 000ABFF4  C8 82 8A C8 */	lfd f4, lbl_8055EA48@sda21(r2)
/* 800B01B8 000ABFF8  93 C1 00 08 */	stw r30, 0x8(r1)
/* 800B01BC 000ABFFC  C0 42 8A F4 */	lfs f2, lbl_8055EA74@sda21(r2)
...
/* 800B01CC 000AC00C  C0 02 8A F0 */	lfs f0, lbl_8055EA70@sda21(r2)
...
/* 800B01E8 000AC028  48 04 E8 B9 */	bl lbl_800FEAA0
/* 800B01EC 000AC02C  88 1F 01 11 */	lbz r0, 0x111(r31)
/* 800B01F0 000AC030  90 01 00 1C */	stw r0, 0x1c(r1)
/* 800B01F4 000AC034  C8 62 8A C8 */	lfd f3, lbl_8055EA48@sda21(r2)
/* 800B01F8 000AC038  93 C1 00 18 */	stw r30, 0x18(r1)
/* 800B01FC 000AC03C  C0 02 8A B8 */	lfs f0, lbl_8055EA38@sda21(r2)
