...
/* 800B4C58 000B0A98  C3 02 8B B0 */	lfs f24, lbl_8055EB30@sda21(r2)
/* 800B4C5C 000B0A9C  CB 22 8B D0 */	lfd f25, lbl_8055EB50@sda21(r2)
/* 800B4C60 000B0AA0  3B E3 43 FD */	addi r31, r3, 0x43fd
/* 800B4C64 000B0AA4  C3 42 8B B4 */	lfs f26, lbl_8055EB34@sda21(r2)
/* 800B4C68 000B0AA8  3B C0 00 00 */	li r30, 0x0
/* 800B4C6C 000B0AAC  C3 62 8B B8 */	lfs f27, lbl_8055EB38@sda21(r2)
/* 800B4C70 000B0AB0  C3 82 8B BC */	lfs f28, lbl_8055EB3C@sda21(r2)
/* 800B4C74 000B0AB4  C3 A2 8B C4 */	lfs f29, lbl_8055EB44@sda21(r2)
/* 800B4C78 000B0AB8  C3 C2 8B C0 */	lfs f30, lbl_8055EB40@sda21(r2)
/* 800B4C7C 000B0ABC  C3 E2 8B C8 */	lfs f31, lbl_8055EB48@sda21(r2)
/* 800B4C80 000B0AC0  CA A2 8B D8 */	lfd f21, lbl_8055EB58@sda21(r2)
/* 800B4C84 000B0AC4  C2 C2 8B CC */	lfs f22, lbl_8055EB4C@sda21(r2)
...
/* 800B4D18 000B0B58  48 04 9D 59 */	bl lbl_800FEA70
...
/* 800B4D58 000B0B98  4B FF ED 69 */	bl lbl_800B3AC0
...
/* 800B4D8C 000B0BCC  4B FF EC 45 */	bl lbl_800B39D0
...
/* 800B4DAC 000B0BEC  4B FF F3 45 */	bl lbl_800B40F0
...
/* 800B4E18 000B0C58  4B FF F7 99 */	bl lbl_800B45B0
