...
/* 800B5860 000B16A0  C0 02 8C 50 */	lfs f0, lbl_8055EBD0@sda21(r2)
/* 800B5864 000B16A4  C3 E8 00 00 */	lfs f31, 0x0(r8)
/* 800B5868 000B16A8  EF C1 00 24 */	fdivs f30, f1, f0
/* 800B586C 000B16AC  C0 02 8C 54 */	lfs f0, lbl_8055EBD4@sda21(r2)
...
/* 800B58A0 000B16E0  C0 02 8C 54 */	lfs f0, lbl_8055EBD4@sda21(r2)
...
/* 800B58C0 000B1700  C0 02 8C 54 */	lfs f0, lbl_8055EBD4@sda21(r2)
...
/* 800B58F4 000B1734  C8 82 8C 90 */	lfd f4, lbl_8055EC10@sda21(r2)
/* 800B58F8 000B1738  7C 65 01 D6 */	mullw r3, r5, r0
/* 800B58FC 000B173C  C0 42 8C 58 */	lfs f2, lbl_8055EBD8@sda21(r2)
/* 800B5900 000B1740  C0 22 8C 60 */	lfs f1, lbl_8055EBE0@sda21(r2)
/* 800B5904 000B1744  C0 02 8C 5C */	lfs f0, lbl_8055EBDC@sda21(r2)
...
/* 800B594C 000B178C  C8 42 8C 68 */	lfd f2, lbl_8055EBE8@sda21(r2)
...
/* 800B5968 000B17A8  4B F5 EC 2D */	bl lbl_80014594
/* 800B596C 000B17AC  FC 20 08 18 */	frsp f1, f1
/* 800B5970 000B17B0  C0 02 8C 70 */	lfs f0, lbl_8055EBF0@sda21(r2)
/* 800B5974 000B17B4  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800B5978 000B17B8  41 80 00 10 */	blt lbl_800B5988
/* 800B597C 000B17BC  C0 02 8C 74 */	lfs f0, lbl_8055EBF4@sda21(r2)
...
/* 800B5990 000B17D0  C2 E2 8C 7C */	lfs f23, lbl_8055EBFC@sda21(r2)
/* 800B5994 000B17D4  7C 96 01 D6 */	mullw r4, r22, r0
/* 800B5998 000B17D8  FE 60 E8 50 */	fneg f19, f29
/* 800B599C 000B17DC  C0 02 8C 88 */	lfs f0, lbl_8055EC08@sda21(r2)
...
/* 800B59B0 000B17F0  CA 02 8C 98 */	lfd f16, lbl_8055EC18@sda21(r2)
/* 800B59B4 000B17F4  C2 22 8C 60 */	lfs f17, lbl_8055EBE0@sda21(r2)
/* 800B59B8 000B17F8  3A C4 00 02 */	addi r22, r4, 0x2
/* 800B59BC 000B17FC  C2 42 8C 78 */	lfs f18, lbl_8055EBF8@sda21(r2)
/* 800B59C0 000B1800  6C 19 80 00 */	xoris r25, r0, 0x8000
/* 800B59C4 000B1804  CB A2 8C 90 */	lfd f29, lbl_8055EC10@sda21(r2)
/* 800B59C8 000B1808  3B 43 43 FD */	addi r26, r3, 0x43fd
/* 800B59CC 000B180C  C3 02 8C 58 */	lfs f24, lbl_8055EBD8@sda21(r2)
/* 800B59D0 000B1810  3A 00 00 00 */	li r16, 0x0
/* 800B59D4 000B1814  C2 A2 8C 80 */	lfs f21, lbl_8055EC00@sda21(r2)
/* 800B59D8 000B1818  3B 00 00 00 */	li r24, 0x0
/* 800B59DC 000B181C  C2 82 8C 84 */	lfs f20, lbl_8055EC04@sda21(r2)
...
/* 800B5B24 000B1964  4B FF DF 9D */	bl lbl_800B3AC0
...
/* 800B5B3C 000B197C  4B FF DF 05 */	bl lbl_800B3A40
...
/* 800B5B84 000B19C4  4B FF DE 4D */	bl lbl_800B39D0
/* 800B5B88 000B19C8  FC 20 70 90 */	fmr f1, f14
/* 800B5B8C 000B19CC  4B F5 E3 B1 */	bl lbl_80013F3C
...
/* 800B5BD0 000B1A10  4B FF E5 21 */	bl lbl_800B40F0
...
/* 800B5C3C 000B1A7C  4B FF E9 75 */	bl lbl_800B45B0
...
/* 800B5CB0 000B1AF0  CA 62 8C 90 */	lfd f19, lbl_8055EC10@sda21(r2)
/* 800B5CB4 000B1AF4  C2 82 8C 58 */	lfs f20, lbl_8055EBD8@sda21(r2)
/* 800B5CB8 000B1AF8  54 F9 01 CE */	rlwinm r25, r7, 0, 7, 7
/* 800B5CBC 000B1AFC  C2 A2 8C 50 */	lfs f21, lbl_8055EBD0@sda21(r2)
/* 800B5CC0 000B1B00  3B 43 43 FD */	addi r26, r3, 0x43fd
/* 800B5CC4 000B1B04  C2 C2 8C 7C */	lfs f22, lbl_8055EBFC@sda21(r2)
/* 800B5CC8 000B1B08  3A 00 00 00 */	li r16, 0x0
/* 800B5CCC 000B1B0C  C2 E2 8C 60 */	lfs f23, lbl_8055EBE0@sda21(r2)
/* 800B5CD0 000B1B10  C3 02 8C 78 */	lfs f24, lbl_8055EBF8@sda21(r2)
/* 800B5CD4 000B1B14  C3 C2 8C 80 */	lfs f30, lbl_8055EC00@sda21(r2)
/* 800B5CD8 000B1B18  CB 42 8C 98 */	lfd f26, lbl_8055EC18@sda21(r2)
/* 800B5CDC 000B1B1C  C1 C2 8C 88 */	lfs f14, lbl_8055EC08@sda21(r2)
...
/* 800B5DB0 000B1BF0  4B FF DD 11 */	bl lbl_800B3AC0
...
/* 800B5DC0 000B1C00  4B FF DD 01 */	bl lbl_800B3AC0
...
/* 800B5E10 000B1C50  4B FF DB C1 */	bl lbl_800B39D0
...
/* 800B5E38 000B1C78  4B FF DB 99 */	bl lbl_800B39D0
...
/* 800B5E58 000B1C98  4B FF E2 99 */	bl lbl_800B40F0
...
/* 800B5EC4 000B1D04  4B FF E6 ED */	bl lbl_800B45B0
