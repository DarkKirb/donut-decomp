...
/* 800B686C 000B26AC  C0 02 8C E8 */	lfs f0, lbl_8055EC68@sda21(r2)
...
/* 800B688C 000B26CC  C0 02 8C E8 */	lfs f0, lbl_8055EC68@sda21(r2)
...
/* 800B68BC 000B26FC  C0 02 8C E8 */	lfs f0, lbl_8055EC68@sda21(r2)
...
.global lbl_800B68D8
lbl_800B68D8:
/* 800B68D8 000B2718  C2 22 8C EC */	lfs f17, lbl_8055EC6C@sda21(r2)
...
/* 800B68FC 000B273C  C8 82 8D 20 */	lfd f4, lbl_8055ECA0@sda21(r2)
/* 800B6900 000B2740  7C 65 01 D6 */	mullw r3, r5, r0
/* 800B6904 000B2744  C0 42 8C F0 */	lfs f2, lbl_8055EC70@sda21(r2)
/* 800B6908 000B2748  C0 22 8C F8 */	lfs f1, lbl_8055EC78@sda21(r2)
/* 800B690C 000B274C  C0 02 8C F4 */	lfs f0, lbl_8055EC74@sda21(r2)
...
/* 800B6948 000B2788  C8 42 8D 00 */	lfd f2, lbl_8055EC80@sda21(r2)
/* 800B694C 000B278C  EC 21 00 28 */	fsubs f1, f1, f0
/* 800B6950 000B2790  4B F5 DC 45 */	bl lbl_80014594
/* 800B6954 000B2794  FC 20 08 18 */	frsp f1, f1
/* 800B6958 000B2798  C0 02 8D 08 */	lfs f0, lbl_8055EC88@sda21(r2)
/* 800B695C 000B279C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800B6960 000B27A0  41 80 00 1C */	blt lbl_800B697C
/* 800B6964 000B27A4  C0 02 8D 0C */	lfs f0, lbl_8055EC8C@sda21(r2)
...
/* 800B698C 000B27CC  C8 22 8D 20 */	lfd f1, lbl_8055ECA0@sda21(r2)
...
/* 800B69B8 000B27F8  C8 22 8D 28 */	lfd f1, lbl_8055ECA8@sda21(r2)
...
.global lbl_800B69DC
lbl_800B69DC:
/* 800B69DC 000B281C  C1 C2 8C EC */	lfs f14, lbl_8055EC6C@sda21(r2)
/* 800B69E0 000B2820  3F C0 00 03 */	lis r30, 0x3
/* 800B69E4 000B2824  C0 02 8D 18 */	lfs f0, lbl_8055EC98@sda21(r2)
...
/* 800B69F4 000B2834  C0 02 8D 1C */	lfs f0, lbl_8055EC9C@sda21(r2)
/* 800B69F8 000B2838  FF A0 70 90 */	fmr f29, f14
/* 800B69FC 000B283C  CA E2 8D 20 */	lfd f23, lbl_8055ECA0@sda21(r2)
/* 800B6A00 000B2840  3B 60 00 00 */	li r27, 0x0
/* 800B6A04 000B2844  C3 02 8C F0 */	lfs f24, lbl_8055EC70@sda21(r2)
/* 800B6A08 000B2848  C3 22 8C F8 */	lfs f25, lbl_8055EC78@sda21(r2)
/* 800B6A0C 000B284C  C3 42 8C F4 */	lfs f26, lbl_8055EC74@sda21(r2)
/* 800B6A10 000B2850  C2 C2 8D 10 */	lfs f22, lbl_8055EC90@sda21(r2)
/* 800B6A14 000B2854  C3 62 8D 14 */	lfs f27, lbl_8055EC94@sda21(r2)
/* 800B6A18 000B2858  CB C2 8D 28 */	lfd f30, lbl_8055ECA8@sda21(r2)
...
/* 800B6AB0 000B28F0  4B FF D0 11 */	bl lbl_800B3AC0
...
/* 800B6AC0 000B2900  4B FF D0 01 */	bl lbl_800B3AC0
...
/* 800B6B34 000B2974  4B FF CE 9D */	bl lbl_800B39D0
...
/* 800B6B54 000B2994  4B FF CE 7D */	bl lbl_800B39D0
...
/* 800B6BE8 000B2A28  4B FF CD E9 */	bl lbl_800B39D0
...
/* 800B6C08 000B2A48  4B FF D4 E9 */	bl lbl_800B40F0
...
/* 800B6C74 000B2AB4  4B FF D9 3D */	bl lbl_800B45B0
...
/* 800B6CF4 000B2B34  C1 C2 8C EC */	lfs f14, lbl_8055EC6C@sda21(r2)
