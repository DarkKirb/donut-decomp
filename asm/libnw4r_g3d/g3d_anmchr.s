...
/* 800D7E80 000D3CC0  C0 22 8F E0 */	lfs f1, "@8469"@sda21(r2)
...
.global lbl_800D807C
lbl_800D807C:
/* 800D807C 000D3EBC  C0 22 8F E0 */	lfs f1, "@8469"@sda21(r2)
...
.global lbl_800D80EC
lbl_800D80EC:
/* 800D80EC 000D3F2C  C0 22 8F E4 */	lfs f1, "@8582"@sda21(r2)
...
/* 800D84BC 000D42FC  C0 02 8F E4 */	lfs f0, "@8582"@sda21(r2)
...
/* 800D856C 000D43AC  C2 E2 8F E0 */	lfs f23, "@8469"@sda21(r2)
...
/* 800D864C 000D448C  C3 82 8F E0 */	lfs f28, "@8469"@sda21(r2)
/* 800D8650 000D4490  C0 02 8F E4 */	lfs f0, "@8582"@sda21(r2)
...
/* 800D869C 000D44DC  C3 C2 8F E0 */	lfs f30, "@8469"@sda21(r2)
/* 800D86A0 000D44E0  3B 60 00 00 */	li r27, 0x0
/* 800D86A4 000D44E4  C3 E2 8F E4 */	lfs f31, "@8582"@sda21(r2)
...
.global lbl_800D8728
lbl_800D8728:
/* 800D8728 000D4568  C0 22 8F E8 */	lfs f1, "@8854"@sda21(r2)
.global lbl_800D872C
lbl_800D872C:
...
.global lbl_800D8748
lbl_800D8748:
/* 800D8748 000D4588  C0 22 8F E8 */	lfs f1, "@8854"@sda21(r2)
.global lbl_800D874C
lbl_800D874C:
...
.global lbl_800D8768
lbl_800D8768:
/* 800D8768 000D45A8  C0 22 8F E8 */	lfs f1, "@8854"@sda21(r2)
.global lbl_800D876C
lbl_800D876C:
...
/* 800D8A3C 000D487C  C0 02 8F E0 */	lfs f0, "@8469"@sda21(r2)
...
/* 800D8C98 000D4AD8  38 AD 85 C8 */	addi r5, r13, "@LOCAL@GetAnmPlayPolicy__Q24nw4r3g3dFQ34nw4r3g3d9AnmPolicy@policyTable"@sda21
/* 800D8C9C 000D4ADC  7C A5 30 2E */	lwzx r5, r5, r6
/* 800D8CA0 000D4AE0  6C 84 80 00 */	xoris r4, r4, 0x8000
/* 800D8CA4 000D4AE4  C0 22 8F E0 */	lfs f1, "@8469"@sda21(r2)
...
/* 800D8CB4 000D4AF4  C0 02 8F E4 */	lfs f0, "@8582"@sda21(r2)
/* 800D8CB8 000D4AF8  90 01 00 08 */	stw r0, 0x8(r1)
/* 800D8CBC 000D4AFC  C8 62 8F F0 */	lfd f3, "@8928"@sda21(r2)
...
/* 800D8E38 000D4C78  C0 02 8F E0 */	lfs f0, "@8469"@sda21(r2)
...
/* 800D8F08 000D4D48  C0 02 8F E0 */	lfs f0, "@8469"@sda21(r2)
...
/* 800D8F38 000D4D78  C0 2D 85 D0 */	lfs f1, smBaseUpdateRate__Q34nw4r3g3d9FrameCtrl@sda21(r13)
