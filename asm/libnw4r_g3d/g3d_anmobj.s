...
/* 800DBE88 000D7CC8  00 00 00 00 */	.4byte 0x00000000
/* 800DBE8C 000D7CCC  00 00 00 00 */	.4byte 0x00000000
...
/* 800DBEA0 000D7CE0  F3 E1 00 18 */	psq_st f31, 0x18(r1), 0, qr0
/* 800DBEA4 000D7CE4  C0 02 90 28 */	lfs f0, "@5234"@sda21(r2)
/* 800DBEA8 000D7CE8  EF E2 08 28 */	fsubs f31, f2, f1
/* 800DBEAC 000D7CEC  FC 03 00 40 */	fcmpo cr0, f3, f0
/* 800DBEB0 000D7CF0  4C 41 13 82 */	cror eq, gt, eq
...
/* 800DBEDC 000D7D1C  C0 02 90 28 */	lfs f0, "@5234"@sda21(r2)
...
/* 800DBEEC 000D7D2C  E3 E1 00 18 */	psq_l f31, 0x18(r1), 0, qr0
...
/* 800DBF00 000D7D40  2C 05 00 00 */	cmpwi r5, 0x0
...
/* 800DBF28 000D7D68  00 00 00 00 */	.4byte 0x00000000
/* 800DBF2C 000D7D6C  00 00 00 00 */	.4byte 0x00000000
...
/* 800DBF40 000D7D80  54 03 0F FE */	srwi r3, r0, 31
/* 800DBF44 000D7D84  4E 80 00 20 */	blr
/* 800DBF48 000D7D88  00 00 00 00 */	.4byte 0x00000000
/* 800DBF4C 000D7D8C  00 00 00 00 */	.4byte 0x00000000
.include "macros.inc"
