...
/* 800F1480 000ED2C0  4B F1 5E A5 */	bl func_80007324
...
/* 800F14A4 000ED2E4  3B 60 00 00 */	li r27, 0
/* 800F14A8 000ED2E8  3B C0 00 00 */	li r30, 0
...
/* 800F14BC 000ED2FC  2C 18 00 00 */	cmpwi r24, 0
...
/* 800F14D4 000ED314  2C 03 00 00 */	cmpwi r3, 0
...
/* 800F14EC 000ED32C  38 1D 00 03 */	addi r0, r29, 3
...
lbl_800F1500:
/* 800F1500 000ED340  93 C3 00 00 */	stw r30, 0(r3)
/* 800F1504 000ED344  38 63 00 04 */	addi r3, r3, 4
...
/* 800F151C 000ED35C  38 1F 00 03 */	addi r0, r31, 3
...
lbl_800F1530:
/* 800F1530 000ED370  93 C3 00 00 */	stw r30, 0(r3)
/* 800F1534 000ED374  38 63 00 04 */	addi r3, r3, 4
/* 800F1538 000ED378  42 00 FF F8 */	bdnz lbl_800F1530
lbl_800F153C:
/* 800F153C 000ED37C  81 98 00 00 */	lwz r12, 0(r24)
...
lbl_800F1578:
/* 800F1578 000ED3B8  2C 19 00 00 */	cmpwi r25, 0
...
/* 800F158C 000ED3CC  2C 03 00 00 */	cmpwi r3, 0
...
/* 800F159C 000ED3DC  2C 00 00 00 */	cmpwi r0, 0
...
lbl_800F15AC:
/* 800F15AC 000ED3EC  38 60 00 00 */	li r3, 0
lbl_800F15B0:
...
/* 800F15C0 000ED400  81 99 00 00 */	lwz r12, 0(r25)
...
/* 800F15F4 000ED434  38 80 00 00 */	li r4, 0
/* 800F15F8 000ED438  4B FD B7 79 */	bl DCStore__Q34nw4r3g3d20ResMatIndMtxAndScaleFb
lbl_800F15FC:
/* 800F15FC 000ED43C  2C 1A 00 00 */	cmpwi r26, 0
...
lbl_800F162C:
/* 800F162C 000ED46C  38 60 00 00 */	li r3, 0
lbl_800F1630:
...
/* 800F1640 000ED480  81 9A 00 00 */	lwz r12, 0(r26)
...
/* 800F1660 000ED4A0  90 01 00 08 */	stw r0, 8(r1)
/* 800F1664 000ED4A4  38 61 00 0C */	addi r3, r1, 0xc
/* 800F1668 000ED4A8  38 81 00 08 */	addi r4, r1, 8
...
/* 800F1678 000ED4B8  38 80 00 00 */	li r4, 0
/* 800F167C 000ED4BC  4B FD B6 D5 */	bl DCStore__Q34nw4r3g3d14ResMatTevColorFb
lbl_800F1680:
/* 800F1680 000ED4C0  3B 7B 00 01 */	addi r27, r27, 1
lbl_800F1684:
...
/* 800F1690 000ED4D0  4B F1 5C E1 */	bl func_80007370
...
/* 800F16A4 000ED4E4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800F16A8 000ED4E8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800F16AC 000ED4EC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
