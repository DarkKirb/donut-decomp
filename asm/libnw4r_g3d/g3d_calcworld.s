...
/* 800E3184 000DEFC4  F3 E1 00 C8 */	psq_st f31, 200(r1), 0, qr0
/* 800E3188 000DEFC8  4B F2 41 81 */	bl __save_gpr
/* 800E318C 000DEFCC  2C 05 00 00 */	cmpwi r5, 0
...
/* 800E31B0 000DEFF0  3B E0 00 00 */	li r31, 0
/* 800E31B4 000DEFF4  40 82 00 20 */	bne lbl_800E31D4
/* 800E31B8 000DEFF8  3C 80 80 44 */	lis r4, $$29581@ha
/* 800E31BC 000DEFFC  7E A3 AB 78 */	mr r3, r21
/* 800E31C0 000DF000  38 84 0F 68 */	addi r4, r4, $$29581@l
/* 800E31C4 000DF004  4B FE 75 2D */	bl GetResByteCode__Q34nw4r3g3d6ResMdlCFPCc
/* 800E31C8 000DF008  2C 03 00 00 */	cmpwi r3, 0
/* 800E31CC 000DF00C  7C 74 1B 78 */	mr r20, r3
/* 800E31D0 000DF010  41 82 05 44 */	beq lbl_800E3714
lbl_800E31D4:
/* 800E31D4 000DF014  80 75 00 00 */	lwz r3, 0(r21)
/* 800E31D8 000DF018  55 E0 2F FE */	rlwinm r0, r15, 5, 0x1f, 0x1f
/* 800E31DC 000DF01C  90 01 00 74 */	stw r0, 0x74(r1)
/* 800E31E0 000DF020  38 63 00 4C */	addi r3, r3, 0x4c
/* 800E31E4 000DF024  80 63 00 08 */	lwz r3, 8(r3)
/* 800E31E8 000DF028  38 03 FF FF */	addi r0, r3, -1
...
/* 800E31FC 000DF03C  C0 02 90 A8 */	lfs f0, $$29400-_SDA2_BASE_(r2)
/* 800E3200 000DF040  7C 70 1B 78 */	mr r16, r3
/* 800E3204 000DF044  D0 03 00 08 */	stfs f0, 8(r3)
/* 800E3208 000DF048  7E 44 93 78 */	mr r4, r18
/* 800E320C 000DF04C  D0 03 00 04 */	stfs f0, 4(r3)
/* 800E3210 000DF050  D0 03 00 00 */	stfs f0, 0(r3)
...
/* 800E3220 000DF060  91 F3 00 00 */	stw r15, 0(r19)
/* 800E3224 000DF064  7C 7E 1B 78 */	mr r30, r3
/* 800E3228 000DF068  3B A0 00 00 */	li r29, 0
/* 800E322C 000DF06C  3A 20 00 00 */	li r17, 0
/* 800E3230 000DF070  48 00 04 3C */	b lbl_800E366C
lbl_800E3234:
/* 800E3234 000DF074  28 00 00 02 */	cmplwi r0, 2
/* 800E3238 000DF078  40 82 03 BC */	bne lbl_800E35F4
/* 800E323C 000DF07C  88 14 00 01 */	lbz r0, 1(r20)
/* 800E3240 000DF080  7E A3 AB 78 */	mr r3, r21
/* 800E3244 000DF084  88 94 00 03 */	lbz r4, 3(r20)
/* 800E3248 000DF088  54 07 40 2E */	slwi r7, r0, 8
/* 800E324C 000DF08C  88 D4 00 02 */	lbz r6, 2(r20)
/* 800E3250 000DF090  88 14 00 04 */	lbz r0, 4(r20)
...
/* 800E3268 000DF0A8  2C 03 00 00 */	cmpwi r3, 0
...
lbl_800E327C:
/* 800E327C 000DF0BC  39 E0 00 00 */	li r15, 0
lbl_800E3280:
...
/* 800E328C 000DF0CC  2C 0E 00 00 */	cmpwi r14, 0
/* 800E3290 000DF0D0  7E F3 00 2E */	lwzx r23, r19, r0
/* 800E3294 000DF0D4  3B BD 00 01 */	addi r29, r29, 1
/* 800E3298 000DF0D8  3A 31 00 04 */	addi r17, r17, 4
...
/* 800E32C8 000DF108  2C 05 00 00 */	cmpwi r5, 0
...
lbl_800E32D8:
/* 800E32D8 000DF118  38 A0 00 00 */	li r5, 0
lbl_800E32DC:
/* 800E32DC 000DF11C  81 83 00 00 */	lwz r12, 0(r3)
...
lbl_800E32F0:
/* 800E32F0 000DF130  2C 0E 00 00 */	cmpwi r14, 0
/* 800E32F4 000DF134  41 82 00 10 */	beq lbl_800E3304
/* 800E32F8 000DF138  80 1F 00 00 */	lwz r0, 0(r31)
/* 800E32FC 000DF13C  2C 00 00 00 */	cmpwi r0, 0
...
/* 800E3334 000DF174  80 1F 00 00 */	lwz r0, 0(r31)
/* 800E3338 000DF178  90 01 00 24 */	stw r0, 0x24(r1)
/* 800E333C 000DF17C  80 7F 00 04 */	lwz r3, 4(r31)
/* 800E3340 000DF180  80 1F 00 08 */	lwz r0, 8(r31)
...
lbl_800E33E8:
/* 800E33E8 000DF228  2C 16 00 00 */	cmpwi r22, 0
...
/* 800E33FC 000DF23C  80 1F 00 00 */	lwz r0, 0(r31)
/* 800E3400 000DF240  90 01 00 24 */	stw r0, 0x24(r1)
/* 800E3404 000DF244  80 7F 00 04 */	lwz r3, 4(r31)
/* 800E3408 000DF248  80 1F 00 08 */	lwz r0, 8(r31)
...
lbl_800E3498:
/* 800E3498 000DF2D8  A0 16 00 06 */	lhz r0, 6(r22)
/* 800E349C 000DF2DC  80 75 00 00 */	lwz r3, 0(r21)
/* 800E34A0 000DF2E0  7C 1C 00 40 */	cmplw r28, r0
/* 800E34A4 000DF2E4  40 82 00 34 */	bne lbl_800E34D8
/* 800E34A8 000DF2E8  88 16 00 04 */	lbz r0, 4(r22)
/* 800E34AC 000DF2EC  54 00 07 FF */	clrlwi. r0, r0, 0x1f
...
/* 800E34C4 000DF304  80 76 00 00 */	lwz r3, 0(r22)
/* 800E34C8 000DF308  81 83 00 00 */	lwz r12, 0(r3)
...
/* 800E34DC 000DF31C  2C 00 00 00 */	cmpwi r0, 0
...
/* 800E3508 000DF348  90 6F 00 00 */	stw r3, 0(r15)
/* 800E350C 000DF34C  48 00 00 64 */	b lbl_800E3570
lbl_800E3510:
/* 800E3510 000DF350  80 1F 00 00 */	lwz r0, 0(r31)
/* 800E3514 000DF354  54 00 05 6B */	rlwinm. r0, r0, 0, 0x15, 0x15
...
/* 800E3540 000DF380  90 6F 00 00 */	stw r3, 0(r15)
...
/* 800E356C 000DF3AC  90 6F 00 00 */	stw r3, 0(r15)
lbl_800E3570:
/* 800E3570 000DF3B0  80 61 00 14 */	lwz r3, 0x14(r1)
/* 800E3574 000DF3B4  2C 03 00 00 */	cmpwi r3, 0
...
lbl_800E3584:
/* 800E3584 000DF3C4  38 60 00 00 */	li r3, 0
lbl_800E3588:
/* 800E3588 000DF3C8  80 0F 00 00 */	lwz r0, 0(r15)
/* 800E358C 000DF3CC  2C 16 00 00 */	cmpwi r22, 0
/* 800E3590 000DF3D0  54 00 00 2E */	rlwinm r0, r0, 0, 0, 0x17
/* 800E3594 000DF3D4  7C 00 1B 78 */	or r0, r0, r3
/* 800E3598 000DF3D8  90 0F 00 00 */	stw r0, 0(r15)
/* 800E359C 000DF3DC  41 82 00 50 */	beq lbl_800E35EC
/* 800E35A0 000DF3E0  A0 16 00 06 */	lhz r0, 6(r22)
/* 800E35A4 000DF3E4  80 75 00 00 */	lwz r3, 0(r21)
/* 800E35A8 000DF3E8  7C 1C 00 40 */	cmplw r28, r0
/* 800E35AC 000DF3EC  40 82 00 40 */	bne lbl_800E35EC
/* 800E35B0 000DF3F0  88 16 00 04 */	lbz r0, 4(r22)
/* 800E35B4 000DF3F4  54 00 07 BD */	rlwinm. r0, r0, 0, 0x1e, 0x1e
...
/* 800E35D8 000DF418  80 76 00 00 */	lwz r3, 0(r22)
/* 800E35DC 000DF41C  81 83 00 00 */	lwz r12, 0(r3)
/* 800E35E0 000DF420  81 8C 00 10 */	lwz r12, 0x10(r12)
/* 800E35E4 000DF424  7D 89 03 A6 */	mtctr r12
/* 800E35E8 000DF428  4E 80 04 21 */	bctrl 
lbl_800E35EC:
/* 800E35EC 000DF42C  3A 94 00 05 */	addi r20, r20, 5
/* 800E35F0 000DF430  48 00 00 7C */	b lbl_800E366C
lbl_800E35F4:
/* 800E35F4 000DF434  88 14 00 01 */	lbz r0, 1(r20)
/* 800E35F8 000DF438  3B BD 00 01 */	addi r29, r29, 1
/* 800E35FC 000DF43C  88 74 00 03 */	lbz r3, 3(r20)
/* 800E3600 000DF440  54 05 40 2E */	slwi r5, r0, 8
/* 800E3604 000DF444  88 94 00 02 */	lbz r4, 2(r20)
/* 800E3608 000DF448  88 14 00 04 */	lbz r0, 4(r20)
...
/* 800E3630 000DF470  3A 31 00 04 */	addi r17, r17, 4
...
/* 800E3648 000DF488  3A 94 00 05 */	addi r20, r20, 5
...
/* 800E365C 000DF49C  C0 03 00 04 */	lfs f0, 4(r3)
/* 800E3660 000DF4A0  D0 04 00 04 */	stfs f0, 4(r4)
/* 800E3664 000DF4A4  C0 03 00 08 */	lfs f0, 8(r3)
/* 800E3668 000DF4A8  D0 04 00 08 */	stfs f0, 8(r4)
lbl_800E366C:
/* 800E366C 000DF4AC  88 14 00 00 */	lbz r0, 0(r20)
/* 800E3670 000DF4B0  28 00 00 01 */	cmplwi r0, 1
/* 800E3674 000DF4B4  40 82 FB C0 */	bne lbl_800E3234
/* 800E3678 000DF4B8  C3 E2 90 A8 */	lfs f31, $$29400-_SDA2_BASE_(r2)
/* 800E367C 000DF4BC  39 C0 00 00 */	li r14, 0
/* 800E3680 000DF4C0  48 00 00 50 */	b lbl_800E36D0
lbl_800E3684:
/* 800E3684 000DF4C4  80 9E 00 00 */	lwz r4, 0(r30)
...
lbl_800E36C8:
/* 800E36C8 000DF508  3B DE 00 04 */	addi r30, r30, 4
/* 800E36CC 000DF50C  39 CE 00 01 */	addi r14, r14, 1
lbl_800E36D0:
/* 800E36D0 000DF510  7C 0E E8 40 */	cmplw r14, r29
/* 800E36D4 000DF514  41 80 FF B0 */	blt lbl_800E3684
/* 800E36D8 000DF518  2C 16 00 00 */	cmpwi r22, 0
/* 800E36DC 000DF51C  41 82 00 38 */	beq lbl_800E3714
/* 800E36E0 000DF520  88 16 00 04 */	lbz r0, 4(r22)
/* 800E36E4 000DF524  80 75 00 00 */	lwz r3, 0(r21)
/* 800E36E8 000DF528  54 00 07 7B */	rlwinm. r0, r0, 0, 0x1d, 0x1d
/* 800E36EC 000DF52C  41 82 00 28 */	beq lbl_800E3714
/* 800E36F0 000DF530  90 61 00 08 */	stw r3, 8(r1)
/* 800E36F4 000DF534  7E 44 93 78 */	mr r4, r18
/* 800E36F8 000DF538  7E C6 B3 78 */	mr r6, r22
/* 800E36FC 000DF53C  38 A1 00 08 */	addi r5, r1, 8
/* 800E3700 000DF540  80 76 00 00 */	lwz r3, 0(r22)
/* 800E3704 000DF544  81 83 00 00 */	lwz r12, 0(r3)
...
/* 800E3718 000DF558  E3 E1 00 C8 */	psq_l f31, 200(r1), 0, qr0
...
/* 800E3734 000DF574  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800E3738 000DF578  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800E373C 000DF57C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800E3744 000DF584  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800E3748 000DF588  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800E374C 000DF58C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800E3754 000DF594  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800E3758 000DF598  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800E375C 000DF59C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800E3770 000DF5B0  4B F2 3B C5 */	bl func_80007334
/* 800E3774 000DF5B4  2C 06 00 00 */	cmpwi r6, 0
...
/* 800E3790 000DF5D0  38 8D 85 E0 */	addi r4, r13, $$29736-_SDA_BASE_
/* 800E3794 000DF5D4  4B FE 6F 5D */	bl GetResByteCode__Q34nw4r3g3d6ResMdlCFPCc
/* 800E3798 000DF5D8  2C 03 00 00 */	cmpwi r3, 0
...
lbl_800E37B4:
/* 800E37B4 000DF5F4  28 00 00 03 */	cmplwi r0, 3
/* 800E37B8 000DF5F8  40 82 02 20 */	bne lbl_800E39D8
/* 800E37BC 000DF5FC  C0 02 90 AC */	lfs f0, $$29737-_SDA2_BASE_(r2)
/* 800E37C0 000DF600  88 7D 00 01 */	lbz r3, 1(r29)
/* 800E37C4 000DF604  10 00 04 20 */	ps_merge00 f0, f0, f0
/* 800E37C8 000DF608  88 1D 00 02 */	lbz r0, 2(r29)
/* 800E37CC 000DF60C  89 7D 00 03 */	lbz r11, 3(r29)
/* 800E37D0 000DF610  54 63 40 2E */	slwi r3, r3, 8
/* 800E37D4 000DF614  7D 43 02 14 */	add r10, r3, r0
/* 800E37D8 000DF618  3B BD 00 04 */	addi r29, r29, 4
...
/* 800E37E8 000DF628  28 0B 00 00 */	cmplwi r11, 0
...
/* 800E3800 000DF640  55 60 F8 7F */	rlwinm. r0, r11, 0x1f, 1, 0x1f
/* 800E3804 000DF644  7C 09 03 A6 */	mtctr r0
/* 800E3808 000DF648  41 82 01 1C */	beq lbl_800E3924
lbl_800E380C:
/* 800E380C 000DF64C  88 9D 00 00 */	lbz r4, 0(r29)
/* 800E3810 000DF650  88 1D 00 01 */	lbz r0, 1(r29)
/* 800E3814 000DF654  54 84 40 2E */	slwi r4, r4, 8
/* 800E3818 000DF658  88 7D 00 03 */	lbz r3, 3(r29)
/* 800E381C 000DF65C  7C 04 02 14 */	add r0, r4, r0
/* 800E3820 000DF660  88 FD 00 05 */	lbz r7, 5(r29)
/* 800E3824 000DF664  1C 80 00 30 */	mulli r4, r0, 0x30
/* 800E3828 000DF668  89 1D 00 04 */	lbz r8, 4(r29)
/* 800E382C 000DF66C  54 00 10 3A */	slwi r0, r0, 2
/* 800E3830 000DF670  88 DD 00 02 */	lbz r6, 2(r29)
/* 800E3834 000DF674  54 65 80 1E */	slwi r5, r3, 0x10
...
/* 800E3844 000DF684  E0 EC 00 00 */	psq_l f7, 0(r12), 0, qr0
/* 800E3848 000DF688  51 07 44 2E */	rlwimi r7, r8, 8, 0x10, 0x17
/* 800E384C 000DF68C  E1 0C 00 08 */	psq_l f8, 8(r12), 0, qr0
/* 800E3850 000DF690  7C 60 00 38 */	and r0, r3, r0
/* 800E3854 000DF694  50 C5 C0 0E */	rlwimi r5, r6, 0x18, 0, 7
/* 800E3858 000DF698  E1 2C 00 10 */	psq_l f9, 16(r12), 0, qr0
/* 800E385C 000DF69C  7C E4 2B 78 */	or r4, r7, r5
/* 800E3860 000DF6A0  90 81 00 08 */	stw r4, 8(r1)
/* 800E3864 000DF6A4  E1 4C 00 18 */	psq_l f10, 24(r12), 0, qr0
/* 800E3868 000DF6A8  E1 6C 00 20 */	psq_l f11, 32(r12), 0, qr0
/* 800E386C 000DF6AC  E1 8C 00 28 */	psq_l f12, 40(r12), 0, qr0
/* 800E3870 000DF6B0  C0 C1 00 08 */	lfs f6, 8(r1)
/* 800E3874 000DF6B4  7C 1B 49 2E */	stwx r0, r27, r9
/* 800E3878 000DF6B8  10 07 01 9C */	ps_madds0 f0, f7, f6, f0
/* 800E387C 000DF6BC  88 9D 00 06 */	lbz r4, 6(r29)
/* 800E3880 000DF6C0  10 28 09 9C */	ps_madds0 f1, f8, f6, f1
/* 800E3884 000DF6C4  88 7D 00 09 */	lbz r3, 9(r29)
/* 800E3888 000DF6C8  10 49 11 9C */	ps_madds0 f2, f9, f6, f2
/* 800E388C 000DF6CC  88 1D 00 07 */	lbz r0, 7(r29)
/* 800E3890 000DF6D0  54 84 40 2E */	slwi r4, r4, 8
/* 800E3894 000DF6D4  54 65 80 1E */	slwi r5, r3, 0x10
/* 800E3898 000DF6D8  7C 04 02 14 */	add r0, r4, r0
/* 800E389C 000DF6DC  88 DD 00 08 */	lbz r6, 8(r29)
...
/* 800E38B0 000DF6F0  51 07 44 2E */	rlwimi r7, r8, 8, 0x10, 0x17
/* 800E38B4 000DF6F4  10 6A 19 9C */	ps_madds0 f3, f10, f6, f3
/* 800E38B8 000DF6F8  7D 9E 22 14 */	add r12, r30, r4
/* 800E38BC 000DF6FC  50 C5 C0 0E */	rlwimi r5, r6, 0x18, 0, 7
...
/* 800E38CC 000DF70C  90 81 00 08 */	stw r4, 8(r1)
/* 800E38D0 000DF710  E0 EC 00 00 */	psq_l f7, 0(r12), 0, qr0
/* 800E38D4 000DF714  3B BD 00 0C */	addi r29, r29, 0xc
/* 800E38D8 000DF718  C0 C1 00 08 */	lfs f6, 8(r1)
/* 800E38DC 000DF71C  E1 0C 00 08 */	psq_l f8, 8(r12), 0, qr0
/* 800E38E0 000DF720  E1 2C 00 10 */	psq_l f9, 16(r12), 0, qr0
/* 800E38E4 000DF724  10 07 01 9C */	ps_madds0 f0, f7, f6, f0
/* 800E38E8 000DF728  E1 4C 00 18 */	psq_l f10, 24(r12), 0, qr0
/* 800E38EC 000DF72C  10 28 09 9C */	ps_madds0 f1, f8, f6, f1
/* 800E38F0 000DF730  E1 6C 00 20 */	psq_l f11, 32(r12), 0, qr0
/* 800E38F4 000DF734  10 49 11 9C */	ps_madds0 f2, f9, f6, f2
/* 800E38F8 000DF738  E1 8C 00 28 */	psq_l f12, 40(r12), 0, qr0
...
/* 800E391C 000DF75C  71 6B 00 01 */	andi. r11, r11, 1
/* 800E3920 000DF760  41 82 00 94 */	beq lbl_800E39B4
lbl_800E3924:
/* 800E3924 000DF764  7D 69 03 A6 */	mtctr r11
lbl_800E3928:
/* 800E3928 000DF768  88 9D 00 00 */	lbz r4, 0(r29)
/* 800E392C 000DF76C  88 1D 00 01 */	lbz r0, 1(r29)
/* 800E3930 000DF770  54 84 40 2E */	slwi r4, r4, 8
/* 800E3934 000DF774  88 7D 00 03 */	lbz r3, 3(r29)
/* 800E3938 000DF778  7C 04 02 14 */	add r0, r4, r0
/* 800E393C 000DF77C  89 1D 00 04 */	lbz r8, 4(r29)
/* 800E3940 000DF780  1C 80 00 30 */	mulli r4, r0, 0x30
/* 800E3944 000DF784  88 DD 00 02 */	lbz r6, 2(r29)
/* 800E3948 000DF788  88 FD 00 05 */	lbz r7, 5(r29)
/* 800E394C 000DF78C  54 65 80 1E */	slwi r5, r3, 0x10
/* 800E3950 000DF790  51 07 44 2E */	rlwimi r7, r8, 8, 0x10, 0x17
/* 800E3954 000DF794  7C 7B 48 2E */	lwzx r3, r27, r9
/* 800E3958 000DF798  7D 9E 22 14 */	add r12, r30, r4
/* 800E395C 000DF79C  50 C5 C0 0E */	rlwimi r5, r6, 0x18, 0, 7
/* 800E3960 000DF7A0  7C E4 2B 78 */	or r4, r7, r5
/* 800E3964 000DF7A4  90 81 00 08 */	stw r4, 8(r1)
/* 800E3968 000DF7A8  54 00 10 3A */	slwi r0, r0, 2
/* 800E396C 000DF7AC  E0 EC 00 00 */	psq_l f7, 0(r12), 0, qr0
/* 800E3970 000DF7B0  C0 C1 00 08 */	lfs f6, 8(r1)
/* 800E3974 000DF7B4  3B BD 00 06 */	addi r29, r29, 6
/* 800E3978 000DF7B8  E1 0C 00 08 */	psq_l f8, 8(r12), 0, qr0
/* 800E397C 000DF7BC  E1 2C 00 10 */	psq_l f9, 16(r12), 0, qr0
/* 800E3980 000DF7C0  10 07 01 9C */	ps_madds0 f0, f7, f6, f0
/* 800E3984 000DF7C4  E1 4C 00 18 */	psq_l f10, 24(r12), 0, qr0
/* 800E3988 000DF7C8  10 28 09 9C */	ps_madds0 f1, f8, f6, f1
/* 800E398C 000DF7CC  E1 6C 00 20 */	psq_l f11, 32(r12), 0, qr0
/* 800E3990 000DF7D0  10 49 11 9C */	ps_madds0 f2, f9, f6, f2
/* 800E3994 000DF7D4  E1 8C 00 28 */	psq_l f12, 40(r12), 0, qr0
...
/* 800E39BC 000DF7FC  F0 03 00 00 */	psq_st f0, 0(r3), 0, qr0
/* 800E39C0 000DF800  F0 23 00 08 */	psq_st f1, 8(r3), 0, qr0
/* 800E39C4 000DF804  F0 43 00 10 */	psq_st f2, 16(r3), 0, qr0
/* 800E39C8 000DF808  F0 63 00 18 */	psq_st f3, 24(r3), 0, qr0
/* 800E39CC 000DF80C  F0 83 00 20 */	psq_st f4, 32(r3), 0, qr0
/* 800E39D0 000DF810  F0 A3 00 28 */	psq_st f5, 40(r3), 0, qr0
/* 800E39D4 000DF814  48 00 00 44 */	b lbl_800E3A18
lbl_800E39D8:
/* 800E39D8 000DF818  88 1D 00 01 */	lbz r0, 1(r29)
/* 800E39DC 000DF81C  7F 83 E3 78 */	mr r3, r28
/* 800E39E0 000DF820  88 9D 00 03 */	lbz r4, 3(r29)
/* 800E39E4 000DF824  54 06 40 2E */	slwi r6, r0, 8
/* 800E39E8 000DF828  88 BD 00 02 */	lbz r5, 2(r29)
/* 800E39EC 000DF82C  88 1D 00 04 */	lbz r0, 4(r29)
...
/* 800E3A14 000DF854  3B BD 00 05 */	addi r29, r29, 5
lbl_800E3A18:
/* 800E3A18 000DF858  88 1D 00 00 */	lbz r0, 0(r29)
/* 800E3A1C 000DF85C  28 00 00 01 */	cmplwi r0, 1
/* 800E3A20 000DF860  40 82 FD 94 */	bne lbl_800E37B4
/* 800E3A24 000DF864  80 7C 00 00 */	lwz r3, 0(r28)
/* 800E3A28 000DF868  88 03 00 6F */	lbz r0, 0x6f(r3)
/* 800E3A2C 000DF86C  3B 43 00 4C */	addi r26, r3, 0x4c
/* 800E3A30 000DF870  2C 00 00 00 */	cmpwi r0, 0
/* 800E3A34 000DF874  41 82 02 00 */	beq lbl_800E3C34
/* 800E3A38 000DF878  2C 00 00 01 */	cmpwi r0, 1
/* 800E3A3C 000DF87C  41 82 00 14 */	beq lbl_800E3A50
/* 800E3A40 000DF880  2C 00 00 02 */	cmpwi r0, 2
...
/* 800E3A78 000DF8B8  38 A4 FF F8 */	addi r5, r4, -8
/* 800E3A7C 000DF8BC  28 00 00 08 */	cmplwi r0, 8
/* 800E3A80 000DF8C0  40 81 00 94 */	ble lbl_800E3B14
/* 800E3A84 000DF8C4  41 85 00 90 */	bgt cr1, lbl_800E3B14
/* 800E3A88 000DF8C8  38 05 00 07 */	addi r0, r5, 7
...
lbl_800E3AA8:
/* 800E3AA8 000DF8E8  80 03 00 00 */	lwz r0, 0(r3)
/* 800E3AAC 000DF8EC  38 C6 00 08 */	addi r6, r6, 8
/* 800E3AB0 000DF8F0  64 00 30 00 */	oris r0, r0, 0x3000
/* 800E3AB4 000DF8F4  90 03 00 00 */	stw r0, 0(r3)
/* 800E3AB8 000DF8F8  80 03 00 04 */	lwz r0, 4(r3)
/* 800E3ABC 000DF8FC  64 00 30 00 */	oris r0, r0, 0x3000
/* 800E3AC0 000DF900  90 03 00 04 */	stw r0, 4(r3)
/* 800E3AC4 000DF904  80 03 00 08 */	lwz r0, 8(r3)
/* 800E3AC8 000DF908  64 00 30 00 */	oris r0, r0, 0x3000
/* 800E3ACC 000DF90C  90 03 00 08 */	stw r0, 8(r3)
...
lbl_800E3B2C:
/* 800E3B2C 000DF96C  80 03 00 00 */	lwz r0, 0(r3)
/* 800E3B30 000DF970  64 00 30 00 */	oris r0, r0, 0x3000
/* 800E3B34 000DF974  90 03 00 00 */	stw r0, 0(r3)
/* 800E3B38 000DF978  38 63 00 04 */	addi r3, r3, 4
...
/* 800E3B6C 000DF9AC  38 A4 FF F8 */	addi r5, r4, -8
/* 800E3B70 000DF9B0  28 00 00 08 */	cmplwi r0, 8
/* 800E3B74 000DF9B4  40 81 00 94 */	ble lbl_800E3C08
/* 800E3B78 000DF9B8  41 85 00 90 */	bgt cr1, lbl_800E3C08
/* 800E3B7C 000DF9BC  38 05 00 07 */	addi r0, r5, 7
...
lbl_800E3B9C:
/* 800E3B9C 000DF9DC  80 03 00 00 */	lwz r0, 0(r3)
/* 800E3BA0 000DF9E0  38 C6 00 08 */	addi r6, r6, 8
/* 800E3BA4 000DF9E4  54 00 00 C2 */	rlwinm r0, r0, 0, 3, 1
/* 800E3BA8 000DF9E8  90 03 00 00 */	stw r0, 0(r3)
/* 800E3BAC 000DF9EC  80 03 00 04 */	lwz r0, 4(r3)
/* 800E3BB0 000DF9F0  54 00 00 C2 */	rlwinm r0, r0, 0, 3, 1
/* 800E3BB4 000DF9F4  90 03 00 04 */	stw r0, 4(r3)
/* 800E3BB8 000DF9F8  80 03 00 08 */	lwz r0, 8(r3)
/* 800E3BBC 000DF9FC  54 00 00 C2 */	rlwinm r0, r0, 0, 3, 1
/* 800E3BC0 000DFA00  90 03 00 08 */	stw r0, 8(r3)
...
lbl_800E3C20:
/* 800E3C20 000DFA60  80 03 00 00 */	lwz r0, 0(r3)
/* 800E3C24 000DFA64  54 00 00 C2 */	rlwinm r0, r0, 0, 3, 1
/* 800E3C28 000DFA68  90 03 00 00 */	stw r0, 0(r3)
/* 800E3C2C 000DFA6C  38 63 00 04 */	addi r3, r3, 4
/* 800E3C30 000DFA70  42 00 FF F0 */	bdnz lbl_800E3C20
lbl_800E3C34:
/* 800E3C34 000DFA74  39 61 00 30 */	addi r11, r1, 0x30
/* 800E3C38 000DFA78  4B F2 37 49 */	bl func_80007380
