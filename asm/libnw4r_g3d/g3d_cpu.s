...
.global lbl_800DC7E4
lbl_800DC7E4:
/* 800DC7E4 000D8624  C8 04 00 00 */	lfd f0, 0x0(r4)
/* 800DC7E8 000D8628  D8 03 00 00 */	stfd f0, 0x0(r3)
/* 800DC7EC 000D862C  C8 04 00 08 */	lfd f0, 0x8(r4)
/* 800DC7F0 000D8630  D8 03 00 08 */	stfd f0, 0x8(r3)
...
/* 800DC870 000D86B0  70 A5 00 03 */	andi. r5, r5, 0x3
...
.global lbl_800DC87C
lbl_800DC87C:
/* 800DC87C 000D86BC  C8 04 00 00 */	lfd f0, 0x0(r4)
/* 800DC880 000D86C0  D8 03 00 00 */	stfd f0, 0x0(r3)
/* 800DC884 000D86C4  C8 04 00 08 */	lfd f0, 0x8(r4)
/* 800DC888 000D86C8  D8 03 00 08 */	stfd f0, 0x8(r3)
...
.global lbl_800DC8C8
lbl_800DC8C8:
/* 800DC8C8 000D8708  F0 03 00 00 */	psq_st f0, 0x0(r3), 0, qr0
/* 800DC8CC 000D870C  F0 03 00 08 */	psq_st f0, 0x8(r3), 0, qr0
/* 800DC8D0 000D8710  F0 03 00 10 */	psq_st f0, 0x10(r3), 0, qr0
/* 800DC8D4 000D8714  F0 03 00 18 */	psq_st f0, 0x18(r3), 0, qr0
/* 800DC8D8 000D8718  F0 03 00 20 */	psq_st f0, 0x20(r3), 0, qr0
/* 800DC8DC 000D871C  F0 03 00 28 */	psq_st f0, 0x28(r3), 0, qr0
/* 800DC8E0 000D8720  F0 03 00 30 */	psq_st f0, 0x30(r3), 0, qr0
/* 800DC8E4 000D8724  F0 03 00 38 */	psq_st f0, 0x38(r3), 0, qr0
/* 800DC8E8 000D8728  F0 03 00 40 */	psq_st f0, 0x40(r3), 0, qr0
/* 800DC8EC 000D872C  F0 03 00 48 */	psq_st f0, 0x48(r3), 0, qr0
/* 800DC8F0 000D8730  F0 03 00 50 */	psq_st f0, 0x50(r3), 0, qr0
/* 800DC8F4 000D8734  F0 03 00 58 */	psq_st f0, 0x58(r3), 0, qr0
/* 800DC8F8 000D8738  F0 03 00 60 */	psq_st f0, 0x60(r3), 0, qr0
/* 800DC8FC 000D873C  F0 03 00 68 */	psq_st f0, 0x68(r3), 0, qr0
/* 800DC900 000D8740  F0 03 00 70 */	psq_st f0, 0x70(r3), 0, qr0
/* 800DC904 000D8744  F0 03 00 78 */	psq_st f0, 0x78(r3), 0, qr0
/* 800DC908 000D8748  F0 03 00 80 */	psq_st f0, 0x80(r3), 0, qr0
/* 800DC90C 000D874C  F0 03 00 88 */	psq_st f0, 0x88(r3), 0, qr0
/* 800DC910 000D8750  F0 03 00 90 */	psq_st f0, 0x90(r3), 0, qr0
/* 800DC914 000D8754  F0 03 00 98 */	psq_st f0, 0x98(r3), 0, qr0
/* 800DC918 000D8758  F0 03 00 A0 */	psq_st f0, 0xa0(r3), 0, qr0
/* 800DC91C 000D875C  F0 03 00 A8 */	psq_st f0, 0xa8(r3), 0, qr0
/* 800DC920 000D8760  F0 03 00 B0 */	psq_st f0, 0xb0(r3), 0, qr0
/* 800DC924 000D8764  F0 03 00 B8 */	psq_st f0, 0xb8(r3), 0, qr0
/* 800DC928 000D8768  F0 03 00 C0 */	psq_st f0, 0xc0(r3), 0, qr0
/* 800DC92C 000D876C  F0 03 00 C8 */	psq_st f0, 0xc8(r3), 0, qr0
/* 800DC930 000D8770  F0 03 00 D0 */	psq_st f0, 0xd0(r3), 0, qr0
/* 800DC934 000D8774  F0 03 00 D8 */	psq_st f0, 0xd8(r3), 0, qr0
/* 800DC938 000D8778  F0 03 00 E0 */	psq_st f0, 0xe0(r3), 0, qr0
/* 800DC93C 000D877C  F0 03 00 E8 */	psq_st f0, 0xe8(r3), 0, qr0
/* 800DC940 000D8780  F0 03 00 F0 */	psq_st f0, 0xf0(r3), 0, qr0
/* 800DC944 000D8784  F0 03 00 F8 */	psq_st f0, 0xf8(r3), 0, qr0
/* 800DC948 000D8788  38 63 01 00 */	addi r3, r3, 0x100
/* 800DC94C 000D878C  42 00 FF 7C */	bdnz lbl_800DC8C8
/* 800DC950 000D8790  70 84 00 07 */	andi. r4, r4, 0x7
...
.global lbl_800DC960
lbl_800DC960:
/* 800DC960 000D87A0  F0 03 00 00 */	psq_st f0, 0x0(r3), 0, qr0
/* 800DC964 000D87A4  F0 03 00 08 */	psq_st f0, 0x8(r3), 0, qr0
/* 800DC968 000D87A8  F0 03 00 10 */	psq_st f0, 0x10(r3), 0, qr0
/* 800DC96C 000D87AC  F0 03 00 18 */	psq_st f0, 0x18(r3), 0, qr0
...
.global lbl_800DC998
lbl_800DC998:
/* 800DC998 000D87D8  F0 03 00 00 */	psq_st f0, 0x0(r3), 0, qr0
/* 800DC99C 000D87DC  F0 03 00 08 */	psq_st f0, 0x8(r3), 0, qr0
/* 800DC9A0 000D87E0  F0 03 00 10 */	psq_st f0, 0x10(r3), 0, qr0
/* 800DC9A4 000D87E4  F0 03 00 18 */	psq_st f0, 0x18(r3), 0, qr0
/* 800DC9A8 000D87E8  F0 03 00 20 */	psq_st f0, 0x20(r3), 0, qr0
/* 800DC9AC 000D87EC  F0 03 00 28 */	psq_st f0, 0x28(r3), 0, qr0
/* 800DC9B0 000D87F0  F0 03 00 30 */	psq_st f0, 0x30(r3), 0, qr0
/* 800DC9B4 000D87F4  F0 03 00 38 */	psq_st f0, 0x38(r3), 0, qr0
/* 800DC9B8 000D87F8  F0 03 00 40 */	psq_st f0, 0x40(r3), 0, qr0
/* 800DC9BC 000D87FC  F0 03 00 48 */	psq_st f0, 0x48(r3), 0, qr0
/* 800DC9C0 000D8800  F0 03 00 50 */	psq_st f0, 0x50(r3), 0, qr0
/* 800DC9C4 000D8804  F0 03 00 58 */	psq_st f0, 0x58(r3), 0, qr0
/* 800DC9C8 000D8808  F0 03 00 60 */	psq_st f0, 0x60(r3), 0, qr0
/* 800DC9CC 000D880C  F0 03 00 68 */	psq_st f0, 0x68(r3), 0, qr0
/* 800DC9D0 000D8810  F0 03 00 70 */	psq_st f0, 0x70(r3), 0, qr0
/* 800DC9D4 000D8814  F0 03 00 78 */	psq_st f0, 0x78(r3), 0, qr0
/* 800DC9D8 000D8818  38 63 00 80 */	addi r3, r3, 0x80
/* 800DC9DC 000D881C  42 00 FF BC */	bdnz lbl_800DC998
/* 800DC9E0 000D8820  70 84 00 07 */	andi. r4, r4, 0x7
...
.global lbl_800DC9F0
lbl_800DC9F0:
/* 800DC9F0 000D8830  F0 03 00 00 */	psq_st f0, 0x0(r3), 0, qr0
/* 800DC9F4 000D8834  F0 03 00 08 */	psq_st f0, 0x8(r3), 0, qr0
...
/* 800DCA04 000D8844  00 00 00 00 */	.4byte 0x00000000
/* 800DCA08 000D8848  00 00 00 00 */	.4byte 0x00000000
/* 800DCA0C 000D884C  00 00 00 00 */	.4byte 0x00000000
.include "macros.inc"
