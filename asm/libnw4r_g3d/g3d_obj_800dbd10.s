...
/* 800DBD18 000D7B58  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 800DBD2C 000D7B6C  3C A0 80 44 */	lis r5, lbl_80440F30@ha
/* 800DBD30 000D7B70  7F E4 FB 78 */	mr r4, r31
/* 800DBD34 000D7B74  38 A5 0F 30 */	addi r5, r5, lbl_80440F30@l
/* 800DBD38 000D7B78  90 A3 00 00 */	stw r5, 0x0(r3)
/* 800DBD3C 000D7B7C  80 63 00 08 */	lwz r3, 0x8(r3)
/* 800DBD40 000D7B80  4B FC 7A C1 */	bl lbl_800A3800
.global lbl_800DBD44
lbl_800DBD44:
...
/* 800DBD5C 000D7B9C  00 00 00 00 */	.4byte 0x00000000
.global lbl_800DBD60
lbl_800DBD60:
...
/* 800DBD74 000D7BB4  80 03 00 04 */	lwz r0, 0x4(r3)
/* 800DBD78 000D7BB8  2C 00 00 00 */	cmpwi r0, 0x0
/* 800DBD7C 000D7BBC  41 82 00 28 */	beq lbl_800DBDA4
/* 800DBD80 000D7BC0  7C 03 03 78 */	mr r3, r0
/* 800DBD84 000D7BC4  3C 80 00 01 */	lis r4, 0x1
/* 800DBD88 000D7BC8  81 83 00 00 */	lwz r12, 0x0(r3)
/* 800DBD8C 000D7BCC  7F E6 FB 78 */	mr r6, r31
/* 800DBD90 000D7BD0  38 84 00 01 */	addi r4, r4, 0x1
/* 800DBD94 000D7BD4  38 A0 00 00 */	li r5, 0x0
/* 800DBD98 000D7BD8  81 8C 00 0C */	lwz r12, 0xc(r12)
/* 800DBD9C 000D7BDC  7D 89 03 A6 */	mtctr r12
/* 800DBDA0 000D7BE0  4E 80 04 21 */	bctrl
.global lbl_800DBDA4
lbl_800DBDA4:
/* 800DBDA4 000D7BE4  2C 1F 00 00 */	cmpwi r31, 0x0
/* 800DBDA8 000D7BE8  41 82 00 1C */	beq lbl_800DBDC4
/* 800DBDAC 000D7BEC  81 9F 00 00 */	lwz r12, 0x0(r31)
/* 800DBDB0 000D7BF0  7F E3 FB 78 */	mr r3, r31
/* 800DBDB4 000D7BF4  38 80 00 01 */	li r4, 0x1
...
/* 800DBDD8 000D7C18  00 00 00 00 */	.4byte 0x00000000
/* 800DBDDC 000D7C1C  00 00 00 00 */	.4byte 0x00000000
.global lbl_800DBDE0
lbl_800DBDE0:
...
/* 800DBDF4 000D7C34  83 E3 00 04 */	lwz r31, 0x4(r3)
/* 800DBDF8 000D7C38  2C 1F 00 00 */	cmpwi r31, 0x0
/* 800DBDFC 000D7C3C  41 82 00 24 */	beq lbl_800DBE20
/* 800DBE00 000D7C40  81 9F 00 00 */	lwz r12, 0x0(r31)
/* 800DBE04 000D7C44  3C 80 00 01 */	lis r4, 0x1
/* 800DBE08 000D7C48  7F E3 FB 78 */	mr r3, r31
/* 800DBE0C 000D7C4C  38 A0 00 00 */	li r5, 0x0
/* 800DBE10 000D7C50  81 8C 00 0C */	lwz r12, 0xc(r12)
/* 800DBE14 000D7C54  38 84 00 01 */	addi r4, r4, 0x1
...
/* 800DBE38 000D7C78  00 00 00 00 */	.4byte 0x00000000
/* 800DBE3C 000D7C7C  00 00 00 00 */	.4byte 0x00000000

.global lbl_800DBE40
lbl_800DBE40:
/* 800DBE40 000D7C80  3C 60 80 41 */	lis r3, lbl_804085E8@ha
/* 800DBE44 000D7C84  80 04 00 00 */	lwz r0, 0x0(r4)
/* 800DBE48 000D7C88  38 63 85 E8 */	addi r3, r3, lbl_804085E8@l
...
/* 800DBE5C 000D7C9C  00 00 00 00 */	.4byte 0x00000000

.global lbl_800DBE60
lbl_800DBE60:
/* 800DBE60 000D7CA0  4B FF 89 C0 */	b lbl_800D4820
/* 800DBE64 000D7CA4  00 00 00 00 */	.4byte 0x00000000
/* 800DBE68 000D7CA8  00 00 00 00 */	.4byte 0x00000000
/* 800DBE6C 000D7CAC  00 00 00 00 */	.4byte 0x00000000

.global lbl_800DBE70
lbl_800DBE70:
/* 800DBE70 000D7CB0  3C 60 80 41 */	lis r3, lbl_804085E8@ha
/* 800DBE74 000D7CB4  38 63 85 E8 */	addi r3, r3, lbl_804085E8@l
/* 800DBE78 000D7CB8  4E 80 00 20 */	blr
/* 800DBE7C 000D7CBC  00 00 00 00 */	.4byte 0x00000000
