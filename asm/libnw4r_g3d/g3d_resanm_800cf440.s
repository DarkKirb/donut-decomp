...
/* 800CF45C 000CB29C  4C 40 13 82 */	cror eq, lt, eq
...
.global lbl_800CF46C
lbl_800CF46C:
/* 800CF46C 000CB2AC  C0 04 00 08 */	lfs f0, 0x8(r4)
/* 800CF470 000CB2B0  FC 00 08 40 */	fcmpo cr0, f0, f1
/* 800CF474 000CB2B4  4C 40 13 82 */	cror eq, lt, eq
...
/* 800CF490 000CB2D0  E0 64 B0 00 */	psq_l f3, 0x0(r4), 1, qr3
/* 800CF494 000CB2D4  38 81 00 0C */	addi r4, r1, 0xc
/* 800CF498 000CB2D8  C0 03 00 04 */	lfs f0, 0x4(r3)
...
/* 800CF4AC 000CB2EC  F0 04 B0 00 */	psq_st f0, 0x0(r4), 1, qr3
/* 800CF4B0 000CB2F0  A0 01 00 0C */	lhz r0, 0xc(r1)
/* 800CF4B4 000CB2F4  B0 01 00 08 */	sth r0, 0x8(r1)
/* 800CF4B8 000CB2F8  1C 00 00 0C */	mulli r0, r0, 0xc
/* 800CF4BC 000CB2FC  7C 63 02 14 */	add r3, r3, r0
/* 800CF4C0 000CB300  C4 03 00 08 */	lfsu f0, 0x8(r3)
...
/* 800CF4E8 000CB328  4C 40 13 82 */	cror eq, lt, eq
/* 800CF4EC 000CB32C  41 82 FF F4 */	beq lbl_800CF4E0
/* 800CF4F0 000CB330  38 63 FF F4 */	addi r3, r3, -0xc
.global lbl_800CF4F4
lbl_800CF4F4:
/* 800CF4F4 000CB334  C0 63 00 00 */	lfs f3, 0x0(r3)
/* 800CF4F8 000CB338  FC 03 08 00 */	fcmpu cr0, f3, f1
/* 800CF4FC 000CB33C  40 82 00 0C */	bne lbl_800CF508
/* 800CF500 000CB340  C0 23 00 04 */	lfs f1, 0x4(r3)
...
/* 800CF614 000CB454  F0 03 D0 00 */	psq_st f0, 0x0(r3), 1, qr5
...
/* 800CF64C 000CB48C  7C A5 7E 70 */	srawi r5, r5, 15
/* 800CF650 000CB490  B0 C1 00 08 */	sth r6, 0x8(r1)
...
/* 800CF664 000CB4A4  7C 84 7E 70 */	srawi r4, r4, 15
...
/* 800CF674 000CB4B4  7C 63 7E 70 */	srawi r3, r3, 15
...
/* 800CF684 000CB4C4  7C 00 7E 70 */	srawi r0, r0, 15
...
/* 800CF6A8 000CB4E8  00 00 00 00 */	.4byte 0x00000000
/* 800CF6AC 000CB4EC  00 00 00 00 */	.4byte 0x00000000
