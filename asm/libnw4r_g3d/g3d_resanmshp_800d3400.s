...
/* 800D3414 000CF254  F3 E1 00 38 */	psq_st f31, 0x38(r1), 0, qr0
/* 800D3418 000CF258  4B F3 3F 11 */	bl lbl_80007328
/* 800D341C 000CF25C  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 800D3430 000CF270  2C 00 00 00 */	cmpwi r0, 0x0
...
.global lbl_800D3440
lbl_800D3440:
/* 800D3440 000CF280  38 00 00 00 */	li r0, 0x0
.global lbl_800D3444
lbl_800D3444:
/* 800D3444 000CF284  2C 00 00 00 */	cmpwi r0, 0x0
/* 800D3448 000CF288  41 82 00 2C */	beq lbl_800D3474
/* 800D344C 000CF28C  38 65 00 01 */	addi r3, r5, 0x1
...
/* 800D345C 000CF29C  2C 03 00 00 */	cmpwi r3, 0x0
...
.global lbl_800D346C
lbl_800D346C:
/* 800D346C 000CF2AC  3B E0 00 00 */	li r31, 0x0
/* 800D3470 000CF2B0  48 00 00 08 */	b lbl_800D3478
.global lbl_800D3474
lbl_800D3474:
/* 800D3474 000CF2B4  3B E0 00 00 */	li r31, 0x0
.global lbl_800D3478
lbl_800D3478:
...
/* 800D3488 000CF2C8  80 1F 00 00 */	lwz r0, 0x0(r31)
...
/* 800D34A8 000CF2E8  A0 1F 00 08 */	lhz r0, 0x8(r31)
...
/* 800D34B8 000CF2F8  90 A4 00 08 */	stw r5, 0x8(r4)
/* 800D34BC 000CF2FC  80 66 00 04 */	lwz r3, 0x4(r6)
/* 800D34C0 000CF300  80 06 00 08 */	lwz r0, 0x8(r6)
...
.global lbl_800D34D0
lbl_800D34D0:
/* 800D34D0 000CF310  57 40 07 FF */	clrlwi. r0, r26, 31
/* 800D34D4 000CF314  A2 DD 00 00 */	lhz r22, 0x0(r29)
...
/* 800D34FC 000CF33C  3B BD 00 02 */	addi r29, r29, 0x2
/* 800D3500 000CF340  3B 9C 00 04 */	addi r28, r28, 0x4
/* 800D3504 000CF344  7C 78 02 14 */	add r3, r24, r0
/* 800D3508 000CF348  7C 18 00 2E */	lwzx r0, r24, r0
/* 800D350C 000CF34C  90 1E 00 00 */	stw r0, 0x0(r30)
/* 800D3510 000CF350  3B 7B 00 04 */	addi r27, r27, 0x4
/* 800D3514 000CF354  80 03 00 04 */	lwz r0, 0x4(r3)
/* 800D3518 000CF358  3B 39 00 01 */	addi r25, r25, 0x1
/* 800D351C 000CF35C  90 1E 00 04 */	stw r0, 0x4(r30)
/* 800D3520 000CF360  80 03 00 08 */	lwz r0, 0x8(r3)
/* 800D3524 000CF364  90 1E 00 08 */	stw r0, 0x8(r30)
...
/* 800D354C 000CF38C  E3 E1 00 38 */	psq_l f31, 0x38(r1), 0, qr0
/* 800D3550 000CF390  CB E1 00 30 */	lfd f31, 0x30(r1)
/* 800D3554 000CF394  4B F3 3E 21 */	bl lbl_80007374
...
/* 800D3568 000CF3A8  00 00 00 00 */	.4byte 0x00000000
/* 800D356C 000CF3AC  00 00 00 00 */	.4byte 0x00000000
