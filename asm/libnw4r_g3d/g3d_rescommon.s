...
/* 800C8AF0 000C4930  80 A3 00 00 */	lwz r5, 0x0(r3)
/* 800C8AF4 000C4934  80 04 00 00 */	lwz r0, 0x0(r4)
/* 800C8AF8 000C4938  80 65 00 00 */	lwz r3, 0x0(r5)
...
.global lbl_800C8B1C
lbl_800C8B1C:
/* 800C8B1C 000C495C  38 60 00 00 */	li r3, 0x0
.global lbl_800C8B20
lbl_800C8B20:
...
/* 800C8B40 000C4980  98 E3 00 00 */	stb r7, 0x0(r3)
/* 800C8B44 000C4984  98 C3 00 01 */	stb r6, 0x1(r3)
/* 800C8B48 000C4988  98 A3 00 02 */	stb r5, 0x2(r3)
/* 800C8B4C 000C498C  98 03 00 03 */	stb r0, 0x3(r3)
/* 800C8B50 000C4990  98 83 00 04 */	stb r4, 0x4(r3)
...
/* 800C8B70 000C49B0  88 E3 00 01 */	lbz r7, 0x1(r3)
/* 800C8B74 000C49B4  54 C6 80 1E */	slwi r6, r6, 16
/* 800C8B78 000C49B8  54 04 40 2E */	slwi r4, r0, 8
/* 800C8B7C 000C49BC  88 03 00 04 */	lbz r0, 0x4(r3)
/* 800C8B80 000C49C0  50 E6 C0 0E */	rlwimi r6, r7, 24, 0, 7
/* 800C8B84 000C49C4  99 03 00 00 */	stb r8, 0x0(r3)
...
/* 800C8B98 000C49D8  98 03 00 04 */	stb r0, 0x4(r3)
/* 800C8B9C 000C49DC  54 05 46 3E */	srwi r5, r0, 24
/* 800C8BA0 000C49E0  54 04 86 3E */	extrwi r4, r0, 8, 8
/* 800C8BA4 000C49E4  54 00 C6 3E */	extrwi r0, r0, 8, 16
/* 800C8BA8 000C49E8  98 A3 00 01 */	stb r5, 0x1(r3)
/* 800C8BAC 000C49EC  98 83 00 02 */	stb r4, 0x2(r3)
/* 800C8BB0 000C49F0  98 03 00 03 */	stb r0, 0x3(r3)
...
/* 800C8BCC 000C4A0C  39 00 00 08 */	li r8, 0x8
/* 800C8BD0 000C4A10  99 03 00 00 */	stb r8, 0x0(r3)
/* 800C8BD4 000C4A14  98 83 00 01 */	stb r4, 0x1(r3)
/* 800C8BD8 000C4A18  98 E3 00 02 */	stb r7, 0x2(r3)
/* 800C8BDC 000C4A1C  98 C3 00 03 */	stb r6, 0x3(r3)
/* 800C8BE0 000C4A20  98 03 00 04 */	stb r0, 0x4(r3)
...
/* 800C8BFC 000C4A3C  54 C8 80 1E */	slwi r8, r6, 16
/* 800C8C00 000C4A40  88 E3 00 01 */	lbz r7, 0x1(r3)
/* 800C8C04 000C4A44  54 A6 40 2E */	slwi r6, r5, 8
/* 800C8C08 000C4A48  88 A3 00 04 */	lbz r5, 0x4(r3)
/* 800C8C0C 000C4A4C  50 E8 C0 0E */	rlwimi r8, r7, 24, 0, 7
/* 800C8C10 000C4A50  98 03 00 00 */	stb r0, 0x0(r3)
...
/* 800C8C24 000C4A64  98 03 00 04 */	stb r0, 0x4(r3)
/* 800C8C28 000C4A68  54 05 46 3E */	srwi r5, r0, 24
/* 800C8C2C 000C4A6C  54 04 86 3E */	extrwi r4, r0, 8, 8
/* 800C8C30 000C4A70  54 00 C6 3E */	extrwi r0, r0, 8, 16
/* 800C8C34 000C4A74  98 A3 00 01 */	stb r5, 0x1(r3)
/* 800C8C38 000C4A78  98 83 00 02 */	stb r4, 0x2(r3)
/* 800C8C3C 000C4A7C  98 03 00 03 */	stb r0, 0x3(r3)
/* 800C8C40 000C4A80  4E 80 00 20 */	blr
/* 800C8C44 000C4A84  00 00 00 00 */	.4byte 0x00000000
/* 800C8C48 000C4A88  00 00 00 00 */	.4byte 0x00000000
/* 800C8C4C 000C4A8C  00 00 00 00 */	.4byte 0x00000000
