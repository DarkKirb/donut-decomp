...
/* 800C8C58 000C4A98  80 A3 00 00 */	lwz r5, 0(r3)
/* 800C8C5C 000C4A9C  90 01 00 24 */	stw r0, 0x24(r1)
/* 800C8C60 000C4AA0  39 05 00 08 */	addi r8, r5, 8
/* 800C8C64 000C4AA4  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 800C8C68 000C4AA8  A0 05 00 0C */	lhz r0, 0xc(r5)
/* 800C8C6C 000C4AAC  80 64 00 00 */	lwz r3, 0(r4)
/* 800C8C70 000C4AB0  54 00 20 36 */	slwi r0, r0, 4
/* 800C8C74 000C4AB4  38 E3 00 04 */	addi r7, r3, 4
/* 800C8C78 000C4AB8  80 C3 00 00 */	lwz r6, 0(r3)
/* 800C8C7C 000C4ABC  7C 65 02 14 */	add r3, r5, r0
/* 800C8C80 000C4AC0  3B E3 00 08 */	addi r31, r3, 8
/* 800C8C84 000C4AC4  48 00 00 50 */	b lbl_800C8CD4
lbl_800C8C88:
/* 800C8C88 000C4AC8  54 60 EC FE */	rlwinm r0, r3, 0x1d, 0x13, 0x1f
/* 800C8C8C 000C4ACC  7F E8 FB 78 */	mr r8, r31
/* 800C8C90 000C4AD0  7C 00 30 40 */	cmplw r0, r6
/* 800C8C94 000C4AD4  54 63 07 7E */	clrlwi r3, r3, 0x1d
...
/* 800C8CA8 000C4AE8  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 800C8CAC 000C4AEC  41 82 00 18 */	beq lbl_800C8CC4
/* 800C8CB0 000C4AF0  A0 1F 00 06 */	lhz r0, 6(r31)
/* 800C8CB4 000C4AF4  54 00 20 36 */	slwi r0, r0, 4
/* 800C8CB8 000C4AF8  7C 65 02 14 */	add r3, r5, r0
/* 800C8CBC 000C4AFC  3B E3 00 08 */	addi r31, r3, 8
/* 800C8CC0 000C4B00  48 00 00 14 */	b lbl_800C8CD4
lbl_800C8CC4:
/* 800C8CC4 000C4B04  A0 1F 00 04 */	lhz r0, 4(r31)
/* 800C8CC8 000C4B08  54 00 20 36 */	slwi r0, r0, 4
/* 800C8CCC 000C4B0C  7C 65 02 14 */	add r3, r5, r0
/* 800C8CD0 000C4B10  3B E3 00 08 */	addi r31, r3, 8
lbl_800C8CD4:
/* 800C8CD4 000C4B14  A0 7F 00 00 */	lhz r3, 0(r31)
/* 800C8CD8 000C4B18  A0 08 00 00 */	lhz r0, 0(r8)
/* 800C8CDC 000C4B1C  7C 00 18 40 */	cmplw r0, r3
/* 800C8CE0 000C4B20  41 81 FF A8 */	bgt lbl_800C8C88
/* 800C8CE4 000C4B24  80 1F 00 08 */	lwz r0, 8(r31)
/* 800C8CE8 000C4B28  7C 83 23 78 */	mr r3, r4
/* 800C8CEC 000C4B2C  38 81 00 08 */	addi r4, r1, 8
/* 800C8CF0 000C4B30  7C A5 02 14 */	add r5, r5, r0
/* 800C8CF4 000C4B34  38 05 FF FC */	addi r0, r5, -4
/* 800C8CF8 000C4B38  90 01 00 08 */	stw r0, 8(r1)
/* 800C8CFC 000C4B3C  4B FF FD E5 */	bl __eq__Q34nw4r3g3d7ResNameCFQ34nw4r3g3d7ResName
/* 800C8D00 000C4B40  2C 03 00 00 */	cmpwi r3, 0
...
lbl_800C8D10:
/* 800C8D10 000C4B50  38 60 00 00 */	li r3, 0
lbl_800C8D14:
...
/* 800C8D28 000C4B68  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800C8D2C 000C4B6C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800C8D38 000C4B78  80 C3 00 00 */	lwz r6, 0(r3)
/* 800C8D3C 000C4B7C  90 01 00 14 */	stw r0, 0x14(r1)
/* 800C8D40 000C4B80  38 E6 00 08 */	addi r7, r6, 8
...
/* 800C8D80 000C4BC0  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 800C8D84 000C4BC4  41 82 00 18 */	beq lbl_800C8D9C
/* 800C8D88 000C4BC8  A0 1F 00 06 */	lhz r0, 6(r31)
/* 800C8D8C 000C4BCC  54 00 20 36 */	slwi r0, r0, 4
/* 800C8D90 000C4BD0  7C 66 02 14 */	add r3, r6, r0
/* 800C8D94 000C4BD4  3B E3 00 08 */	addi r31, r3, 8
/* 800C8D98 000C4BD8  48 00 00 14 */	b lbl_800C8DAC
lbl_800C8D9C:
/* 800C8D9C 000C4BDC  A0 1F 00 04 */	lhz r0, 4(r31)
/* 800C8DA0 000C4BE0  54 00 20 36 */	slwi r0, r0, 4
/* 800C8DA4 000C4BE4  7C 66 02 14 */	add r3, r6, r0
/* 800C8DA8 000C4BE8  3B E3 00 08 */	addi r31, r3, 8
lbl_800C8DAC:
/* 800C8DAC 000C4BEC  A0 7F 00 00 */	lhz r3, 0(r31)
/* 800C8DB0 000C4BF0  A0 07 00 00 */	lhz r0, 0(r7)
/* 800C8DB4 000C4BF4  7C 00 18 40 */	cmplw r0, r3
/* 800C8DB8 000C4BF8  41 81 FF A8 */	bgt lbl_800C8D60
/* 800C8DBC 000C4BFC  80 1F 00 08 */	lwz r0, 8(r31)
/* 800C8DC0 000C4C00  2C 00 00 00 */	cmpwi r0, 0
...
lbl_800C8DD8:
/* 800C8DD8 000C4C18  38 80 00 00 */	li r4, 0
lbl_800C8DDC:
/* 800C8DDC 000C4C1C  4B F4 4D 61 */	bl strcmp
/* 800C8DE0 000C4C20  2C 03 00 00 */	cmpwi r3, 0
...
lbl_800C8DF0:
/* 800C8DF0 000C4C30  38 60 00 00 */	li r3, 0
lbl_800C8DF4:
...
/* 800C8E08 000C4C48  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800C8E0C 000C4C4C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800C8E24 000C4C64  93 C1 00 08 */	stw r30, 8(r1)
/* 800C8E28 000C4C68  7C 7E 1B 78 */	mr r30, r3
/* 800C8E2C 000C4C6C  80 03 00 00 */	lwz r0, 0(r3)
/* 800C8E30 000C4C70  2C 00 00 00 */	cmpwi r0, 0
/* 800C8E34 000C4C74  41 82 00 3C */	beq lbl_800C8E70
/* 800C8E38 000C4C78  2C 04 00 00 */	cmpwi r4, 0
...
/* 800C8E58 000C4C98  2C 03 00 00 */	cmpwi r3, 0
/* 800C8E5C 000C4C9C  41 82 00 14 */	beq lbl_800C8E70
/* 800C8E60 000C4CA0  80 9E 00 00 */	lwz r4, 0(r30)
...
/* 800C8EA4 000C4CE4  80 03 00 00 */	lwz r0, 0(r3)
/* 800C8EA8 000C4CE8  2C 00 00 00 */	cmpwi r0, 0
/* 800C8EAC 000C4CEC  41 82 00 34 */	beq lbl_800C8EE0
/* 800C8EB0 000C4CF0  80 04 00 00 */	lwz r0, 0(r4)
/* 800C8EB4 000C4CF4  2C 00 00 00 */	cmpwi r0, 0
/* 800C8EB8 000C4CF8  41 82 00 28 */	beq lbl_800C8EE0
/* 800C8EBC 000C4CFC  90 01 00 08 */	stw r0, 8(r1)
/* 800C8EC0 000C4D00  38 81 00 08 */	addi r4, r1, 8
/* 800C8EC4 000C4D04  4B FF FD 8D */	bl Get__Q34nw4r3g3d6ResDicCFQ34nw4r3g3d7ResName
/* 800C8EC8 000C4D08  2C 03 00 00 */	cmpwi r3, 0
/* 800C8ECC 000C4D0C  41 82 00 14 */	beq lbl_800C8EE0
/* 800C8ED0 000C4D10  80 9F 00 00 */	lwz r4, 0(r31)
...
lbl_800C8EE0:
/* 800C8EE0 000C4D20  38 60 00 00 */	li r3, 0
lbl_800C8EE4:
...
/* 800C8EF8 000C4D38  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800C8EFC 000C4D3C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800C8F14 000C4D54  80 03 00 00 */	lwz r0, 0(r3)
/* 800C8F18 000C4D58  2C 00 00 00 */	cmpwi r0, 0
/* 800C8F1C 000C4D5C  41 82 00 3C */	beq lbl_800C8F58
/* 800C8F20 000C4D60  80 04 00 00 */	lwz r0, 0(r4)
/* 800C8F24 000C4D64  2C 00 00 00 */	cmpwi r0, 0
/* 800C8F28 000C4D68  41 82 00 30 */	beq lbl_800C8F58
/* 800C8F2C 000C4D6C  90 01 00 08 */	stw r0, 8(r1)
/* 800C8F30 000C4D70  38 81 00 08 */	addi r4, r1, 8
/* 800C8F34 000C4D74  4B FF FD 1D */	bl Get__Q34nw4r3g3d6ResDicCFQ34nw4r3g3d7ResName
/* 800C8F38 000C4D78  2C 03 00 00 */	cmpwi r3, 0
/* 800C8F3C 000C4D7C  41 82 00 1C */	beq lbl_800C8F58
/* 800C8F40 000C4D80  80 9F 00 00 */	lwz r4, 0(r31)
...
lbl_800C8F58:
/* 800C8F58 000C4D98  38 60 FF FF */	li r3, -1
lbl_800C8F5C:
