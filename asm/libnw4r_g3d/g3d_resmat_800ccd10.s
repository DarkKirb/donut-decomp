...
/* 800CD378 000C91B8  C8 42 8E B8 */	lfd f2, "@14094"@sda21(r2)
...
/* 800CD3A0 000C91E0  C8 62 8E B8 */	lfd f3, "@14094"@sda21(r2)
...
/* 800CD3B4 000C91F4  C8 42 8E B0 */	lfd f2, "@14090"@sda21(r2)
...
.global lbl_800CD3CC
lbl_800CD3CC:
/* 800CD3CC 000C920C  C0 22 8E A8 */	lfs f1, "@13919"@sda21(r2)
/* 800CD3D0 000C9210  48 00 00 08 */	b lbl_800CD3D8
.global lbl_800CD3D4
lbl_800CD3D4:
/* 800CD3D4 000C9214  C0 22 8E A8 */	lfs f1, "@13919"@sda21(r2)
.global lbl_800CD3D8
lbl_800CD3D8:
...
/* 800CD7D0 000C9610  C1 42 8E AC */	lfs f10, "@13982"@sda21(r2)
...
/* 800CD7EC 000C962C  C0 02 8E C0 */	lfs f0, "@14587"@sda21(r2)
...
/* 800CD84C 000C968C  C0 02 8E C4 */	lfs f0, "@14588"@sda21(r2)
...
/* 800CD8B0 000C96F0  C0 82 8E A8 */	lfs f4, "@13919"@sda21(r2)
...
/* 800CD8D8 000C9718  C9 22 8E D0 */	lfd f9, "@14594"@sda21(r2)
...
/* 800CD928 000C9768  C0 02 8E AC */	lfs f0, "@13982"@sda21(r2)
...
/* 800CD940 000C9780  C1 02 8E C8 */	lfs f8, "@14589"@sda21(r2)
...
/* 800CDAB8 000C98F8  C0 82 8E A8 */	lfs f4, "@13919"@sda21(r2)
/* 800CDABC 000C98FC  7C 66 AE 70 */	srawi r6, r3, 21
/* 800CDAC0 000C9900  C9 22 8E D0 */	lfd f9, "@14594"@sda21(r2)
/* 800CDAC4 000C9904  54 03 A8 14 */	slwi r3, r0, 21
/* 800CDAC8 000C9908  C1 02 8E C8 */	lfs f8, "@14589"@sda21(r2)
...
/* 800CDB50 000C9990  C0 02 8E AC */	lfs f0, "@13982"@sda21(r2)
...
.global lbl_800CDC18
lbl_800CDC18:
/* 800CDC18 000C9A58  C0 42 8E D8 */	lfs f2, "@14686"@sda21(r2)
...
/* 800CDC64 000C9AA4  C0 42 8E D8 */	lfs f2, "@14686"@sda21(r2)
...
/* 800CDCB0 000C9AF0  C0 42 8E D8 */	lfs f2, "@14686"@sda21(r2)
