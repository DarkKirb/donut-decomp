...
/* 800CC0D4 000C7F14  54 80 07 FE */	clrlwi r0, r4, 0x1f
/* 800CC0D8 000C7F18  7C E9 22 14 */	add r7, r9, r4
/* 800CC0DC 000C7F1C  81 43 00 00 */	lwz r10, 0(r3)
...
/* 800CC108 000C7F48  54 00 C0 0E */	slwi r0, r0, 0x18
...
/* 800CC128 000C7F68  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800CC12C 000C7F6C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800CC130 000C7F70  54 89 0F FE */	srwi r9, r4, 0x1f
/* 800CC134 000C7F74  54 80 07 FE */	clrlwi r0, r4, 0x1f
/* 800CC138 000C7F78  7C 89 22 14 */	add r4, r9, r4
/* 800CC13C 000C7F7C  81 43 00 00 */	lwz r10, 0(r3)
...
/* 800CC190 000C7FD0  50 8A C0 0E */	rlwimi r10, r4, 0x18, 0, 7
...
/* 800CC1A0 000C7FE0  55 40 9F 7E */	rlwinm r0, r10, 0x13, 0x1d, 0x1f
/* 800CC1A4 000C7FE4  90 05 00 00 */	stw r0, 0(r5)
lbl_800CC1A8:
/* 800CC1A8 000C7FE8  2C 06 00 00 */	cmpwi r6, 0
/* 800CC1AC 000C7FEC  41 82 00 0C */	beq lbl_800CC1B8
/* 800CC1B0 000C7FF0  55 40 B7 7E */	rlwinm r0, r10, 0x16, 0x1d, 0x1f
/* 800CC1B4 000C7FF4  90 06 00 00 */	stw r0, 0(r6)
lbl_800CC1B8:
/* 800CC1B8 000C7FF8  2C 07 00 00 */	cmpwi r7, 0
/* 800CC1BC 000C7FFC  41 82 00 0C */	beq lbl_800CC1C8
/* 800CC1C0 000C8000  55 40 CF 7E */	rlwinm r0, r10, 0x19, 0x1d, 0x1f
/* 800CC1C4 000C8004  90 07 00 00 */	stw r0, 0(r7)
lbl_800CC1C8:
/* 800CC1C8 000C8008  2C 08 00 00 */	cmpwi r8, 0
/* 800CC1CC 000C800C  41 82 00 0C */	beq lbl_800CC1D8
/* 800CC1D0 000C8010  55 40 E7 7E */	rlwinm r0, r10, 0x1c, 0x1d, 0x1f
/* 800CC1D4 000C8014  90 08 00 00 */	stw r0, 0(r8)
lbl_800CC1D8:
/* 800CC1D8 000C8018  38 60 00 01 */	li r3, 1
...
/* 800CC1E0 000C8020  54 8A 0F FE */	srwi r10, r4, 0x1f
/* 800CC1E4 000C8024  54 80 07 FE */	clrlwi r0, r4, 0x1f
/* 800CC1E8 000C8028  7C 8A 22 14 */	add r4, r10, r4
/* 800CC1EC 000C802C  81 63 00 00 */	lwz r11, 0(r3)
...
/* 800CC240 000C8080  50 8B C0 0E */	rlwimi r11, r4, 0x18, 0, 7
/* 800CC244 000C8084  7D 6B 1B 78 */	or r11, r11, r3
/* 800CC248 000C8088  7D 6B 03 78 */	or r11, r11, r0
/* 800CC24C 000C808C  55 64 87 BE */	rlwinm r4, r11, 0x10, 0x1e, 0x1f
/* 800CC250 000C8090  41 82 00 0C */	beq lbl_800CC25C
/* 800CC254 000C8094  55 60 6F FE */	rlwinm r0, r11, 0xd, 0x1f, 0x1f
/* 800CC258 000C8098  98 08 00 00 */	stb r0, 0(r8)
lbl_800CC25C:
/* 800CC25C 000C809C  2C 09 00 00 */	cmpwi r9, 0
/* 800CC260 000C80A0  41 82 00 0C */	beq lbl_800CC26C
/* 800CC264 000C80A4  55 60 57 BE */	rlwinm r0, r11, 0xa, 0x1e, 0x1f
/* 800CC268 000C80A8  90 09 00 00 */	stw r0, 0(r9)
lbl_800CC26C:
/* 800CC26C 000C80AC  2C 04 00 03 */	cmpwi r4, 3
/* 800CC270 000C80B0  55 63 77 FE */	rlwinm r3, r11, 0xe, 0x1f, 0x1f
/* 800CC274 000C80B4  55 60 67 BE */	rlwinm r0, r11, 0xc, 0x1e, 0x1f
/* 800CC278 000C80B8  40 82 00 18 */	bne lbl_800CC290
/* 800CC27C 000C80BC  54 00 08 3C */	slwi r0, r0, 1
/* 800CC280 000C80C0  38 80 00 00 */	li r4, 0
/* 800CC284 000C80C4  7C 63 03 78 */	or r3, r3, r0
/* 800CC288 000C80C8  38 00 00 00 */	li r0, 0
/* 800CC28C 000C80CC  38 63 00 08 */	addi r3, r3, 8
lbl_800CC290:
/* 800CC290 000C80D0  2C 06 00 00 */	cmpwi r6, 0
/* 800CC294 000C80D4  41 82 00 08 */	beq lbl_800CC29C
/* 800CC298 000C80D8  90 86 00 00 */	stw r4, 0(r6)
lbl_800CC29C:
/* 800CC29C 000C80DC  2C 05 00 00 */	cmpwi r5, 0
/* 800CC2A0 000C80E0  41 82 00 08 */	beq lbl_800CC2A8
/* 800CC2A4 000C80E4  90 65 00 00 */	stw r3, 0(r5)
lbl_800CC2A8:
/* 800CC2A8 000C80E8  2C 07 00 00 */	cmpwi r7, 0
/* 800CC2AC 000C80EC  41 82 00 08 */	beq lbl_800CC2B4
/* 800CC2B0 000C80F0  90 07 00 00 */	stw r0, 0(r7)
lbl_800CC2B4:
/* 800CC2B4 000C80F4  38 60 00 01 */	li r3, 1
/* 800CC2B8 000C80F8  4E 80 00 20 */	blr 
/* 800CC2BC 000C80FC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800CC2C8 000C8108  54 8A 0F FE */	srwi r10, r4, 0x1f
/* 800CC2CC 000C810C  54 C6 50 2A */	slwi r6, r6, 0xa
/* 800CC2D0 000C8110  90 01 00 14 */	stw r0, 0x14(r1)
/* 800CC2D4 000C8114  7D 2A 22 14 */	add r9, r10, r4
/* 800CC2D8 000C8118  54 80 07 FE */	clrlwi r0, r4, 0x1f
...
/* 800CC2F0 000C8130  83 E3 00 00 */	lwz r31, 0(r3)
...
/* 800CC300 000C8140  54 A9 68 24 */	slwi r9, r5, 0xd
...
/* 800CC320 000C8160  54 00 C0 0E */	slwi r0, r0, 0x18
...
/* 800CC350 000C8190  54 8B 0F FE */	srwi r11, r4, 0x1f
/* 800CC354 000C8194  54 80 07 FE */	clrlwi r0, r4, 0x1f
/* 800CC358 000C8198  7D 4B 22 14 */	add r10, r11, r4
/* 800CC35C 000C819C  81 83 00 00 */	lwz r12, 0(r3)
...
/* 800CC36C 000C81AC  2C 05 00 01 */	cmpwi r5, 1
...
/* 800CC38C 000C81CC  55 08 99 58 */	rlwinm r8, r8, 0x13, 5, 0xc
/* 800CC390 000C81D0  54 C0 80 1E */	slwi r0, r6, 0x10
...
/* 800CC3A0 000C81E0  54 A5 93 5A */	rlwinm r5, r5, 0x12, 0xd, 0xd
/* 800CC3A4 000C81E4  7C C4 2B 78 */	or r4, r6, r5
/* 800CC3A8 000C81E8  55 28 B0 12 */	slwi r8, r9, 0x16
/* 800CC3AC 000C81EC  54 E7 A0 16 */	slwi r7, r7, 0x14
/* 800CC3B0 000C81F0  54 00 C0 0E */	slwi r0, r0, 0x18
...
lbl_800CC3C8:
/* 800CC3C8 000C8208  55 00 99 58 */	rlwinm r0, r8, 0x13, 5, 0xc
/* 800CC3CC 000C820C  54 84 08 3C */	slwi r4, r4, 1
/* 800CC3D0 000C8210  64 06 00 03 */	oris r6, r0, 3
/* 800CC3D4 000C8214  54 A7 9A 96 */	rlwinm r7, r5, 0x13, 0xa, 0xb
/* 800CC3D8 000C8218  38 04 00 C1 */	addi r0, r4, 0xc1
/* 800CC3DC 000C821C  50 A6 93 5A */	rlwimi r6, r5, 0x12, 0xd, 0xd
/* 800CC3E0 000C8220  51 27 B0 12 */	rlwimi r7, r9, 0x16, 0, 9
/* 800CC3E4 000C8224  7C E4 33 78 */	or r4, r7, r6
/* 800CC3E8 000C8228  54 00 C0 0E */	slwi r0, r0, 0x18
/* 800CC3EC 000C822C  7C 84 03 78 */	or r4, r4, r0
/* 800CC3F0 000C8230  3C A0 FF FF */	lis r5, 0xffff
/* 800CC3F4 000C8234  4B FF C7 6C */	b ResWriteBPCmd__Q34nw4r3g3d6detailFPUcUlUl
/* 800CC3F8 000C8238  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800CC3FC 000C823C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800CC400 000C8240  54 80 0F FE */	srwi r0, r4, 0x1f
/* 800CC404 000C8244  80 63 00 00 */	lwz r3, 0(r3)
...
/* 800CC41C 000C825C  2C 00 00 00 */	cmpwi r0, 0
/* 800CC420 000C8260  40 82 00 0C */	bne lbl_800CC42C
/* 800CC424 000C8264  38 60 00 00 */	li r3, 0
/* 800CC428 000C8268  4E 80 00 20 */	blr 
lbl_800CC42C:
/* 800CC42C 000C826C  54 80 07 FF */	clrlwi. r0, r4, 0x1f
...
/* 800CC43C 000C827C  54 67 80 1E */	slwi r7, r3, 0x10
/* 800CC440 000C8280  54 03 40 2E */	slwi r3, r0, 8
/* 800CC444 000C8284  88 06 00 89 */	lbz r0, 0x89(r6)
/* 800CC448 000C8288  50 87 C0 0E */	rlwimi r7, r4, 0x18, 0, 7
...
/* 800CC458 000C8298  54 E0 96 FE */	rlwinm r0, r7, 0x12, 0x1b, 0x1f
/* 800CC45C 000C829C  90 05 00 00 */	stw r0, 0(r5)
/* 800CC460 000C82A0  48 00 00 0C */	b lbl_800CC46C
lbl_800CC464:
/* 800CC464 000C82A4  54 E0 E6 FE */	rlwinm r0, r7, 0x1c, 0x1b, 0x1f
/* 800CC468 000C82A8  90 05 00 00 */	stw r0, 0(r5)
lbl_800CC46C:
/* 800CC46C 000C82AC  38 60 00 01 */	li r3, 1
/* 800CC470 000C82B0  4E 80 00 20 */	blr 
/* 800CC474 000C82B4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800CC478 000C82B8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800CC47C 000C82BC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800CC480 000C82C0  54 80 0F FE */	srwi r0, r4, 0x1f
/* 800CC484 000C82C4  80 63 00 00 */	lwz r3, 0(r3)
...
/* 800CC49C 000C82DC  2C 00 00 00 */	cmpwi r0, 0
/* 800CC4A0 000C82E0  40 82 00 0C */	bne lbl_800CC4AC
/* 800CC4A4 000C82E4  38 60 00 00 */	li r3, 0
/* 800CC4A8 000C82E8  4E 80 00 20 */	blr 
lbl_800CC4AC:
/* 800CC4AC 000C82EC  54 80 07 FF */	clrlwi. r0, r4, 0x1f
...
/* 800CC4BC 000C82FC  54 67 80 1E */	slwi r7, r3, 0x10
/* 800CC4C0 000C8300  54 03 40 2E */	slwi r3, r0, 8
/* 800CC4C4 000C8304  88 06 00 89 */	lbz r0, 0x89(r6)
/* 800CC4C8 000C8308  50 87 C0 0E */	rlwimi r7, r4, 0x18, 0, 7
...
/* 800CC4D8 000C8318  54 E0 6E FE */	rlwinm r0, r7, 0xd, 0x1b, 0x1f
/* 800CC4DC 000C831C  90 05 00 00 */	stw r0, 0(r5)
/* 800CC4E0 000C8320  48 00 00 0C */	b lbl_800CC4EC
lbl_800CC4E4:
/* 800CC4E4 000C8324  54 E0 BE FE */	rlwinm r0, r7, 0x17, 0x1b, 0x1f
/* 800CC4E8 000C8328  90 05 00 00 */	stw r0, 0(r5)
lbl_800CC4EC:
/* 800CC4EC 000C832C  38 60 00 01 */	li r3, 1
/* 800CC4F0 000C8330  4E 80 00 20 */	blr 
/* 800CC4F4 000C8334  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800CC4F8 000C8338  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800CC4FC 000C833C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800CC510 000C8350  4B F3 AE 2D */	bl func_8000733C
/* 800CC514 000C8354  54 80 07 FF */	clrlwi. r0, r4, 0x1f
/* 800CC518 000C8358  54 86 0F FE */	srwi r6, r4, 0x1f
/* 800CC51C 000C835C  7C 06 22 14 */	add r0, r6, r4
/* 800CC520 000C8360  80 63 00 00 */	lwz r3, 0(r3)
/* 800CC524 000C8364  7C BB 2B 78 */	mr r27, r5
/* 800CC528 000C8368  3B E0 00 04 */	li r31, 4
...
/* 800CC560 000C83A0  54 64 C0 0E */	slwi r4, r3, 0x18
/* 800CC564 000C83A4  67 85 FF 00 */	oris r5, r28, 0xff00
/* 800CC568 000C83A8  38 7D 00 05 */	addi r3, r29, 5
...
/* 800CC578 000C83B8  4B F3 AE 11 */	bl func_80007388
...
/* 800CC58C 000C83CC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800CC5A0 000C83E0  4B F3 AD 9D */	bl func_8000733C
/* 800CC5A4 000C83E4  54 80 07 FF */	clrlwi. r0, r4, 0x1f
/* 800CC5A8 000C83E8  54 86 0F FE */	srwi r6, r4, 0x1f
/* 800CC5AC 000C83EC  7C 06 22 14 */	add r0, r6, r4
/* 800CC5B0 000C83F0  80 63 00 00 */	lwz r3, 0(r3)
/* 800CC5B4 000C83F4  7C BB 2B 78 */	mr r27, r5
/* 800CC5B8 000C83F8  3B E0 00 09 */	li r31, 9
...
/* 800CC5F0 000C8430  54 64 C0 0E */	slwi r4, r3, 0x18
/* 800CC5F4 000C8434  67 85 FF 00 */	oris r5, r28, 0xff00
/* 800CC5F8 000C8438  38 7D 00 05 */	addi r3, r29, 5
...
/* 800CC608 000C8448  4B F3 AD 81 */	bl func_80007388
...
/* 800CC61C 000C845C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800CC620 000C8460  54 80 0F FE */	srwi r0, r4, 0x1f
/* 800CC624 000C8464  80 63 00 00 */	lwz r3, 0(r3)
...
/* 800CC63C 000C847C  2C 00 00 00 */	cmpwi r0, 0
/* 800CC640 000C8480  40 82 00 0C */	bne lbl_800CC64C
/* 800CC644 000C8484  38 60 00 00 */	li r3, 0
/* 800CC648 000C8488  4E 80 00 20 */	blr 
lbl_800CC64C:
/* 800CC64C 000C848C  54 80 07 FF */	clrlwi. r0, r4, 0x1f
...
/* 800CC65C 000C849C  54 69 80 1E */	slwi r9, r3, 0x10
/* 800CC660 000C84A0  54 03 40 2E */	slwi r3, r0, 8
/* 800CC664 000C84A4  88 08 00 8E */	lbz r0, 0x8e(r8)
/* 800CC668 000C84A8  50 89 C0 0E */	rlwimi r9, r4, 0x18, 0, 7
...
/* 800CC678 000C84B8  3C 60 80 41 */	lis r3, $$2LOCAL$$2GXGetTevOrder__Q34nw4r3g3d6ResTevCF13_GXTevStageIDP13_GXTexCoordIDP11_GXTexMapIDP12_GXChannelID$$2r2c@ha
/* 800CC67C 000C84BC  55 20 7E FA */	rlwinm r0, r9, 0xf, 0x1b, 0x1d
/* 800CC680 000C84C0  38 63 83 20 */	addi r3, r3, $$2LOCAL$$2GXGetTevOrder__Q34nw4r3g3d6ResTevCF13_GXTevStageIDP13_GXTexCoordIDP11_GXTexMapIDP12_GXChannelID$$2r2c@l
/* 800CC684 000C84C4  55 24 8F 7E */	rlwinm r4, r9, 0x11, 0x1d, 0x1f
/* 800CC688 000C84C8  7D 03 00 2E */	lwzx r8, r3, r0
/* 800CC68C 000C84CC  55 20 77 FE */	rlwinm r0, r9, 0xe, 0x1f, 0x1f
/* 800CC690 000C84D0  55 23 A7 7E */	rlwinm r3, r9, 0x14, 0x1d, 0x1f
/* 800CC694 000C84D4  48 00 00 20 */	b lbl_800CC6B4
lbl_800CC698:
/* 800CC698 000C84D8  3C 60 80 41 */	lis r3, $$2LOCAL$$2GXGetTevOrder__Q34nw4r3g3d6ResTevCF13_GXTevStageIDP13_GXTexCoordIDP11_GXTexMapIDP12_GXChannelID$$2r2c@ha
/* 800CC69C 000C84DC  55 20 DE FA */	rlwinm r0, r9, 0x1b, 0x1b, 0x1d
/* 800CC6A0 000C84E0  38 63 83 20 */	addi r3, r3, $$2LOCAL$$2GXGetTevOrder__Q34nw4r3g3d6ResTevCF13_GXTevStageIDP13_GXTexCoordIDP11_GXTexMapIDP12_GXChannelID$$2r2c@l
/* 800CC6A4 000C84E4  55 24 EF 7E */	rlwinm r4, r9, 0x1d, 0x1d, 0x1f
/* 800CC6A8 000C84E8  7D 03 00 2E */	lwzx r8, r3, r0
/* 800CC6AC 000C84EC  55 20 D7 FE */	rlwinm r0, r9, 0x1a, 0x1f, 0x1f
/* 800CC6B0 000C84F0  55 23 07 7E */	clrlwi r3, r9, 0x1d
lbl_800CC6B4:
/* 800CC6B4 000C84F4  2C 05 00 00 */	cmpwi r5, 0
/* 800CC6B8 000C84F8  41 82 00 08 */	beq lbl_800CC6C0
/* 800CC6BC 000C84FC  90 85 00 00 */	stw r4, 0(r5)
lbl_800CC6C0:
/* 800CC6C0 000C8500  2C 07 00 00 */	cmpwi r7, 0
/* 800CC6C4 000C8504  41 82 00 08 */	beq lbl_800CC6CC
/* 800CC6C8 000C8508  91 07 00 00 */	stw r8, 0(r7)
lbl_800CC6CC:
/* 800CC6CC 000C850C  2C 00 00 00 */	cmpwi r0, 0
/* 800CC6D0 000C8510  40 82 00 08 */	bne lbl_800CC6D8
/* 800CC6D4 000C8514  38 60 00 FF */	li r3, 0xff
lbl_800CC6D8:
/* 800CC6D8 000C8518  2C 06 00 00 */	cmpwi r6, 0
/* 800CC6DC 000C851C  41 82 00 08 */	beq lbl_800CC6E4
/* 800CC6E0 000C8520  90 66 00 00 */	stw r3, 0(r6)
lbl_800CC6E4:
/* 800CC6E4 000C8524  38 60 00 01 */	li r3, 1
/* 800CC6E8 000C8528  4E 80 00 20 */	blr 
/* 800CC6EC 000C852C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800CC700 000C8540  4B F3 AC 3D */	bl func_8000733C
...
/* 800CC71C 000C855C  38 C1 00 08 */	addi r6, r1, 8
/* 800CC720 000C8560  38 E0 00 00 */	li r7, 0
...
/* 800CC728 000C8568  2C 03 00 00 */	cmpwi r3, 0
...
/* 800CC760 000C85A0  80 1C 00 00 */	lwz r0, 0(r28)
/* 800CC764 000C85A4  7C 60 EA 14 */	add r3, r0, r29
/* 800CC768 000C85A8  9B C3 00 10 */	stb r30, 0x10(r3)
lbl_800CC76C:
/* 800CC76C 000C85AC  57 63 0F FE */	srwi r3, r27, 0x1f
/* 800CC770 000C85B0  57 60 07 FE */	clrlwi r0, r27, 0x1f
/* 800CC774 000C85B4  7C 83 DA 14 */	add r4, r3, r27
/* 800CC778 000C85B8  80 DC 00 00 */	lwz r6, 0(r28)
/* 800CC77C 000C85BC  7C 88 0E 70 */	srawi r8, r4, 1
/* 800CC780 000C85C0  3C 60 80 44 */	lis r3, $$2LOCAL$$2GXSetTevOrder__Q34nw4r3g3d6ResTevF13_GXTevStageID13_GXTexCoordID11_GXTexMapID12_GXChannelID$$2c2r@ha
/* 800CC784 000C85C4  1C A8 00 30 */	mulli r5, r8, 0x30
/* 800CC788 000C85C8  7C 80 00 D0 */	neg r4, r0
/* 800CC78C 000C85CC  57 E0 07 3E */	clrlwi r0, r31, 0x1c
/* 800CC790 000C85D0  38 63 06 40 */	addi r3, r3, $$2LOCAL$$2GXSetTevOrder__Q34nw4r3g3d6ResTevF13_GXTevStageID13_GXTexCoordID11_GXTexMapID12_GXChannelID$$2c2r@l
/* 800CC794 000C85D4  7C 03 00 AE */	lbzx r0, r3, r0
/* 800CC798 000C85D8  7C A6 2A 14 */	add r5, r6, r5
/* 800CC79C 000C85DC  57 A6 1E B8 */	rlwinm r6, r29, 3, 0x1a, 0x1c
/* 800CC7A0 000C85E0  2C 1E 00 FF */	cmpwi r30, 0xff
/* 800CC7A4 000C85E4  54 89 07 3A */	rlwinm r9, r4, 0, 0x1c, 0x1d
...
/* 800CC7B8 000C85F8  53 C6 07 7E */	rlwimi r6, r30, 0, 0x1d, 0x1f
/* 800CC7BC 000C85FC  64 85 FF 00 */	oris r5, r4, 0xff00
/* 800CC7C0 000C8600  38 80 00 00 */	li r4, 0
/* 800CC7C4 000C8604  41 82 00 10 */	beq lbl_800CC7D4
/* 800CC7C8 000C8608  57 C0 05 EF */	rlwinm. r0, r30, 0, 0x17, 0x17
/* 800CC7CC 000C860C  40 82 00 08 */	bne lbl_800CC7D4
/* 800CC7D0 000C8610  38 80 00 01 */	li r4, 1
lbl_800CC7D4:
...
/* 800CC7E4 000C8624  54 00 C0 0E */	slwi r0, r0, 0x18
...
/* 800CC7F8 000C8638  4B F3 AB 91 */	bl func_80007388
...
/* 800CC80C 000C864C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800CC810 000C8650  54 89 0F FE */	srwi r9, r4, 0x1f
/* 800CC814 000C8654  54 80 07 FE */	clrlwi r0, r4, 0x1f
/* 800CC818 000C8658  7C 89 22 14 */	add r4, r9, r4
/* 800CC81C 000C865C  81 43 00 00 */	lwz r10, 0(r3)
...
/* 800CC870 000C86B0  50 8A C0 0E */	rlwimi r10, r4, 0x18, 0, 7
...
/* 800CC880 000C86C0  55 40 A7 3E */	rlwinm r0, r10, 0x14, 0x1c, 0x1f
/* 800CC884 000C86C4  90 05 00 00 */	stw r0, 0(r5)
lbl_800CC888:
/* 800CC888 000C86C8  2C 06 00 00 */	cmpwi r6, 0
/* 800CC88C 000C86CC  41 82 00 0C */	beq lbl_800CC898
/* 800CC890 000C86D0  55 40 C7 3E */	rlwinm r0, r10, 0x18, 0x1c, 0x1f
/* 800CC894 000C86D4  90 06 00 00 */	stw r0, 0(r6)
lbl_800CC898:
/* 800CC898 000C86D8  2C 07 00 00 */	cmpwi r7, 0
/* 800CC89C 000C86DC  41 82 00 0C */	beq lbl_800CC8A8
/* 800CC8A0 000C86E0  55 40 E7 3E */	rlwinm r0, r10, 0x1c, 0x1c, 0x1f
/* 800CC8A4 000C86E4  90 07 00 00 */	stw r0, 0(r7)
lbl_800CC8A8:
/* 800CC8A8 000C86E8  2C 08 00 00 */	cmpwi r8, 0
/* 800CC8AC 000C86EC  41 82 00 0C */	beq lbl_800CC8B8
/* 800CC8B0 000C86F0  55 40 07 3E */	clrlwi r0, r10, 0x1c
/* 800CC8B4 000C86F4  90 08 00 00 */	stw r0, 0(r8)
lbl_800CC8B8:
/* 800CC8B8 000C86F8  38 60 00 01 */	li r3, 1
...
/* 800CC8C0 000C8700  54 8A 0F FE */	srwi r10, r4, 0x1f
/* 800CC8C4 000C8704  54 80 07 FE */	clrlwi r0, r4, 0x1f
/* 800CC8C8 000C8708  7C 8A 22 14 */	add r4, r10, r4
/* 800CC8CC 000C870C  81 63 00 00 */	lwz r11, 0(r3)
...
/* 800CC920 000C8760  50 8B C0 0E */	rlwimi r11, r4, 0x18, 0, 7
/* 800CC924 000C8764  7D 6B 1B 78 */	or r11, r11, r3
/* 800CC928 000C8768  7D 6B 03 78 */	or r11, r11, r0
/* 800CC92C 000C876C  55 64 87 BE */	rlwinm r4, r11, 0x10, 0x1e, 0x1f
/* 800CC930 000C8770  41 82 00 0C */	beq lbl_800CC93C
/* 800CC934 000C8774  55 60 6F FE */	rlwinm r0, r11, 0xd, 0x1f, 0x1f
/* 800CC938 000C8778  98 08 00 00 */	stb r0, 0(r8)
lbl_800CC93C:
/* 800CC93C 000C877C  2C 09 00 00 */	cmpwi r9, 0
/* 800CC940 000C8780  41 82 00 0C */	beq lbl_800CC94C
/* 800CC944 000C8784  55 60 57 BE */	rlwinm r0, r11, 0xa, 0x1e, 0x1f
/* 800CC948 000C8788  90 09 00 00 */	stw r0, 0(r9)
lbl_800CC94C:
/* 800CC94C 000C878C  2C 04 00 03 */	cmpwi r4, 3
/* 800CC950 000C8790  55 63 77 FE */	rlwinm r3, r11, 0xe, 0x1f, 0x1f
/* 800CC954 000C8794  55 60 67 BE */	rlwinm r0, r11, 0xc, 0x1e, 0x1f
/* 800CC958 000C8798  40 82 00 18 */	bne lbl_800CC970
/* 800CC95C 000C879C  54 00 08 3C */	slwi r0, r0, 1
/* 800CC960 000C87A0  38 80 00 00 */	li r4, 0
/* 800CC964 000C87A4  7C 63 03 78 */	or r3, r3, r0
/* 800CC968 000C87A8  38 00 00 00 */	li r0, 0
/* 800CC96C 000C87AC  38 63 00 08 */	addi r3, r3, 8
lbl_800CC970:
/* 800CC970 000C87B0  2C 06 00 00 */	cmpwi r6, 0
/* 800CC974 000C87B4  41 82 00 08 */	beq lbl_800CC97C
/* 800CC978 000C87B8  90 86 00 00 */	stw r4, 0(r6)
lbl_800CC97C:
/* 800CC97C 000C87BC  2C 05 00 00 */	cmpwi r5, 0
/* 800CC980 000C87C0  41 82 00 08 */	beq lbl_800CC988
/* 800CC984 000C87C4  90 65 00 00 */	stw r3, 0(r5)
lbl_800CC988:
/* 800CC988 000C87C8  2C 07 00 00 */	cmpwi r7, 0
/* 800CC98C 000C87CC  41 82 00 08 */	beq lbl_800CC994
/* 800CC990 000C87D0  90 07 00 00 */	stw r0, 0(r7)
lbl_800CC994:
/* 800CC994 000C87D4  38 60 00 01 */	li r3, 1
/* 800CC998 000C87D8  4E 80 00 20 */	blr 
/* 800CC99C 000C87DC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800CC9A8 000C87E8  54 8C 0F FE */	srwi r12, r4, 0x1f
/* 800CC9AC 000C87EC  54 89 07 FE */	clrlwi r9, r4, 0x1f
...
/* 800CC9CC 000C880C  54 A5 60 26 */	slwi r5, r5, 0xc
/* 800CC9D0 000C8810  7D 4C 30 50 */	subf r10, r12, r6
/* 800CC9D4 000C8814  83 E3 00 00 */	lwz r31, 0(r3)
...
/* 800CC9F4 000C8834  54 00 C0 0E */	slwi r0, r0, 0x18
...
/* 800CCA2C 000C886C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800CCA30 000C8870  54 8B 0F FE */	srwi r11, r4, 0x1f
/* 800CCA34 000C8874  54 80 07 FE */	clrlwi r0, r4, 0x1f
/* 800CCA38 000C8878  7D 4B 22 14 */	add r10, r11, r4
/* 800CCA3C 000C887C  81 83 00 00 */	lwz r12, 0(r3)
...
/* 800CCA4C 000C888C  2C 05 00 01 */	cmpwi r5, 1
...
/* 800CCA6C 000C88AC  55 08 99 58 */	rlwinm r8, r8, 0x13, 5, 0xc
/* 800CCA70 000C88B0  54 C0 80 1E */	slwi r0, r6, 0x10
...
/* 800CCA80 000C88C0  54 A5 93 5A */	rlwinm r5, r5, 0x12, 0xd, 0xd
/* 800CCA84 000C88C4  7C C4 2B 78 */	or r4, r6, r5
/* 800CCA88 000C88C8  55 28 B0 12 */	slwi r8, r9, 0x16
/* 800CCA8C 000C88CC  54 E7 A0 16 */	slwi r7, r7, 0x14
/* 800CCA90 000C88D0  54 00 C0 0E */	slwi r0, r0, 0x18
...
lbl_800CCAA8:
/* 800CCAA8 000C88E8  55 00 99 58 */	rlwinm r0, r8, 0x13, 5, 0xc
/* 800CCAAC 000C88EC  54 84 08 3C */	slwi r4, r4, 1
/* 800CCAB0 000C88F0  64 06 00 03 */	oris r6, r0, 3
/* 800CCAB4 000C88F4  54 A7 9A 96 */	rlwinm r7, r5, 0x13, 0xa, 0xb
/* 800CCAB8 000C88F8  38 04 00 C0 */	addi r0, r4, 0xc0
/* 800CCABC 000C88FC  50 A6 93 5A */	rlwimi r6, r5, 0x12, 0xd, 0xd
/* 800CCAC0 000C8900  51 27 B0 12 */	rlwimi r7, r9, 0x16, 0, 9
/* 800CCAC4 000C8904  7C E4 33 78 */	or r4, r7, r6
/* 800CCAC8 000C8908  54 00 C0 0E */	slwi r0, r0, 0x18
...
/* 800CCAD8 000C8918  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800CCADC 000C891C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global GXSetTevDirect__Q34nw4r3g3d6ResTevF13_GXTevStageID
GXSetTevDirect__Q34nw4r3g3d6ResTevF13_GXTevStageID:
/* 800CCAE0 000C8920  54 87 0F FE */	srwi r7, r4, 0x1f
/* 800CCAE4 000C8924  54 80 07 FE */	clrlwi r0, r4, 0x1f
/* 800CCAE8 000C8928  7C A7 22 14 */	add r5, r7, r4
/* 800CCAEC 000C892C  54 84 07 3E */	clrlwi r4, r4, 0x1c
...
/* 800CCAFC 000C893C  81 03 00 00 */	lwz r8, 0(r3)
...
/* 800CCB0C 000C894C  54 04 C0 0E */	slwi r4, r0, 0x18
...
/* 800CCB24 000C8964  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800CCB28 000C8968  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800CCB2C 000C896C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800CCB40 000C8980  54 00 06 3E */	clrlwi r0, r0, 0x18
...
/* 800CCB64 000C89A4  83 E3 00 00 */	lwz r31, 0(r3)
...
/* 800CCB94 000C89D4  3B BD 00 01 */	addi r29, r29, 1
lbl_800CCB98:
...
/* 800CCBA4 000C89E4  38 7C 00 01 */	addi r3, r28, 1
/* 800CCBA8 000C89E8  54 60 0F FE */	srwi r0, r3, 0x1f
...
/* 800CCBE0 000C8A20  3B BD 00 01 */	addi r29, r29, 1
lbl_800CCBE4:
/* 800CCBE4 000C8A24  88 7F 00 0C */	lbz r3, 0xc(r31)
/* 800CCBE8 000C8A28  38 03 00 01 */	addi r0, r3, 1
...
/* 800CCC1C 000C8A5C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800CCC28 000C8A68  2C 04 00 00 */	cmpwi r4, 0
...
lbl_800CCC40:
/* 800CCC40 000C8A80  80 7F 00 00 */	lwz r3, 0(r31)
/* 800CCC44 000C8A84  3C 80 80 41 */	lis r4, $$2LOCAL$$2CallDisplayList__Q34nw4r3g3d6ResTevCFb$$2dlsize@ha
/* 800CCC48 000C8A88  38 84 83 40 */	addi r4, r4, $$2LOCAL$$2CallDisplayList__Q34nw4r3g3d6ResTevCFb$$2dlsize@l
/* 800CCC4C 000C8A8C  88 A3 00 0C */	lbz r5, 0xc(r3)
/* 800CCC50 000C8A90  38 63 00 20 */	addi r3, r3, 0x20
/* 800CCC54 000C8A94  38 05 FF FF */	addi r0, r5, -1
...
/* 800CCC78 000C8AB8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800CCC7C 000C8ABC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800CCC94 000C8AD4  93 C1 00 08 */	stw r30, 8(r1)
/* 800CCC98 000C8AD8  7C 9E 23 78 */	mr r30, r4
/* 800CCC9C 000C8ADC  83 E3 00 00 */	lwz r31, 0(r3)
...
/* 800CCCAC 000C8AEC  80 1E 00 04 */	lwz r0, 4(r30)
...
/* 800CCCBC 000C8AFC  90 1E 00 04 */	stw r0, 4(r30)
/* 800CCCC0 000C8B00  80 9E 00 00 */	lwz r4, 0(r30)
...
/* 800CCCD0 000C8B10  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 800CCCE4 000C8B24  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800CCCE8 000C8B28  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800CCCEC 000C8B2C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global DCStore__Q34nw4r3g3d6ResTevFb
DCStore__Q34nw4r3g3d6ResTevFb:
/* 800CCCF0 000C8B30  80 63 00 00 */	lwz r3, 0(r3)
/* 800CCCF4 000C8B34  2C 04 00 00 */	cmpwi r4, 0
/* 800CCCF8 000C8B38  80 83 00 00 */	lwz r4, 0(r3)
