...
/* 800D3580 000CF3C0  E0 64 00 14 */	psq_l f3, 0x14(r4), 0, qr0
/* 800D3584 000CF3C4  E0 84 80 20 */	psq_l f4, 0x20(r4), 1, qr0
/* 800D3588 000CF3C8  10 E3 14 A0 */	ps_merge10 f7, f3, f2
/* 800D358C 000CF3CC  E0 A4 00 24 */	psq_l f5, 0x24(r4), 0, qr0
...
/* 800D35E0 000CF420  F0 03 80 00 */	psq_st f0, 0x0(r3), 1, qr0
/* 800D35E4 000CF424  F0 43 80 0C */	psq_st f2, 0xc(r3), 1, qr0
/* 800D35E8 000CF428  F0 83 80 18 */	psq_st f4, 0x18(r3), 1, qr0
/* 800D35EC 000CF42C  F0 23 00 04 */	psq_st f1, 0x4(r3), 0, qr0
/* 800D35F0 000CF430  F0 63 00 10 */	psq_st f3, 0x10(r3), 0, qr0
/* 800D35F4 000CF434  F0 A3 00 1C */	psq_st f5, 0x1c(r3), 0, qr0
/* 800D35F8 000CF438  38 60 00 00 */	li r3, 0x0
...
/* 800D3624 000CF464  F1 A3 00 00 */	psq_st f13, 0x0(r3), 0, qr0
/* 800D3628 000CF468  11 6B 00 18 */	ps_muls0 f11, f11, f0
/* 800D362C 000CF46C  F1 83 00 0C */	psq_st f12, 0xc(r3), 0, qr0
/* 800D3630 000CF470  11 4A 00 18 */	ps_muls0 f10, f10, f0
/* 800D3634 000CF474  F1 63 00 18 */	psq_st f11, 0x18(r3), 0, qr0
/* 800D3638 000CF478  11 29 00 18 */	ps_muls0 f9, f9, f0
/* 800D363C 000CF47C  F1 43 80 08 */	psq_st f10, 0x8(r3), 1, qr0
/* 800D3640 000CF480  11 08 00 18 */	ps_muls0 f8, f8, f0
/* 800D3644 000CF484  F1 23 80 14 */	psq_st f9, 0x14(r3), 1, qr0
/* 800D3648 000CF488  F1 03 80 20 */	psq_st f8, 0x20(r3), 1, qr0
/* 800D364C 000CF48C  38 60 00 01 */	li r3, 0x1
...
/* 800D3670 000CF4B0  E0 64 00 14 */	psq_l f3, 0x14(r4), 0, qr0
/* 800D3674 000CF4B4  E0 84 80 20 */	psq_l f4, 0x20(r4), 1, qr0
/* 800D3678 000CF4B8  10 E3 14 A0 */	ps_merge10 f7, f3, f2
/* 800D367C 000CF4BC  E0 A4 00 24 */	psq_l f5, 0x24(r4), 0, qr0
...
/* 800D36D8 000CF518  F0 03 80 00 */	psq_st f0, 0x0(r3), 1, qr0
/* 800D36DC 000CF51C  F0 43 80 10 */	psq_st f2, 0x10(r3), 1, qr0
/* 800D36E0 000CF520  F0 83 80 20 */	psq_st f4, 0x20(r3), 1, qr0
/* 800D36E4 000CF524  10 C6 30 28 */	ps_sub f6, f6, f6
/* 800D36E8 000CF528  F0 23 00 04 */	psq_st f1, 0x4(r3), 0, qr0
/* 800D36EC 000CF52C  F0 63 00 14 */	psq_st f3, 0x14(r3), 0, qr0
/* 800D36F0 000CF530  F0 A3 00 24 */	psq_st f5, 0x24(r3), 0, qr0
/* 800D36F4 000CF534  F0 C3 80 0C */	psq_st f6, 0xc(r3), 1, qr0
/* 800D36F8 000CF538  F0 C3 80 1C */	psq_st f6, 0x1c(r3), 1, qr0
/* 800D36FC 000CF53C  F0 C3 80 2C */	psq_st f6, 0x2c(r3), 1, qr0
.global lbl_800D3700
lbl_800D3700:
/* 800D3700 000CF540  38 60 00 00 */	li r3, 0x0
...
/* 800D371C 000CF55C  F0 C3 80 0C */	psq_st f6, 0xc(r3), 1, qr0
/* 800D3720 000CF560  10 47 01 72 */	ps_mul f2, f7, f5
/* 800D3724 000CF564  F0 C3 80 1C */	psq_st f6, 0x1c(r3), 1, qr0
/* 800D3728 000CF568  F0 C3 80 2C */	psq_st f6, 0x2c(r3), 1, qr0
...
/* 800D3738 000CF578  F1 A3 00 00 */	psq_st f13, 0x0(r3), 0, qr0
/* 800D373C 000CF57C  11 6B 00 18 */	ps_muls0 f11, f11, f0
/* 800D3740 000CF580  F1 83 00 10 */	psq_st f12, 0x10(r3), 0, qr0
/* 800D3744 000CF584  11 4A 00 18 */	ps_muls0 f10, f10, f0
/* 800D3748 000CF588  F1 63 00 20 */	psq_st f11, 0x20(r3), 0, qr0
/* 800D374C 000CF58C  11 29 00 18 */	ps_muls0 f9, f9, f0
/* 800D3750 000CF590  F1 43 80 08 */	psq_st f10, 0x8(r3), 1, qr0
/* 800D3754 000CF594  11 08 00 18 */	ps_muls0 f8, f8, f0
/* 800D3758 000CF598  F1 23 80 18 */	psq_st f9, 0x18(r3), 1, qr0
/* 800D375C 000CF59C  F1 03 80 28 */	psq_st f8, 0x28(r3), 1, qr0
/* 800D3760 000CF5A0  38 60 00 01 */	li r3, 0x1
...
/* 800D3780 000CF5C0  E0 64 00 14 */	psq_l f3, 0x14(r4), 0, qr0
/* 800D3784 000CF5C4  E0 84 80 20 */	psq_l f4, 0x20(r4), 1, qr0
/* 800D3788 000CF5C8  10 E3 14 A0 */	ps_merge10 f7, f3, f2
/* 800D378C 000CF5CC  E0 A4 00 24 */	psq_l f5, 0x24(r4), 0, qr0
...
/* 800D37E0 000CF620  38 60 00 00 */	li r3, 0x0
...
/* 800D3824 000CF664  F0 A3 00 00 */	psq_st f5, 0x0(r3), 0, qr0
/* 800D3828 000CF668  F0 83 00 10 */	psq_st f4, 0x10(r3), 0, qr0
...
/* 800D3838 000CF678  F1 43 80 20 */	psq_st f10, 0x20(r3), 1, qr0
/* 800D383C 000CF67C  11 08 00 18 */	ps_muls0 f8, f8, f0
/* 800D3840 000CF680  10 CB 30 FE */	ps_nmadd f6, f11, f3, f6
/* 800D3844 000CF684  F1 23 80 24 */	psq_st f9, 0x24(r3), 1, qr0
/* 800D3848 000CF688  10 EA 00 72 */	ps_mul f7, f10, f1
/* 800D384C 000CF68C  10 AB 34 20 */	ps_merge00 f5, f11, f6
/* 800D3850 000CF690  F1 03 80 28 */	psq_st f8, 0x28(r3), 1, qr0
/* 800D3854 000CF694  10 E9 38 BA */	ps_madd f7, f9, f2, f7
/* 800D3858 000CF698  10 8B 34 E0 */	ps_merge11 f4, f11, f6
/* 800D385C 000CF69C  F0 A3 00 08 */	psq_st f5, 0x8(r3), 0, qr0
/* 800D3860 000CF6A0  10 E8 38 FE */	ps_nmadd f7, f8, f3, f7
/* 800D3864 000CF6A4  F0 83 00 18 */	psq_st f4, 0x18(r3), 0, qr0
/* 800D3868 000CF6A8  F0 E3 80 2C */	psq_st f7, 0x2c(r3), 1, qr0
/* 800D386C 000CF6AC  38 60 00 01 */	li r3, 0x1
/* 800D3870 000CF6B0  4E 80 00 20 */	blr
/* 800D3874 000CF6B4  00 00 00 00 */	.4byte 0x00000000
/* 800D3878 000CF6B8  00 00 00 00 */	.4byte 0x00000000
/* 800D387C 000CF6BC  00 00 00 00 */	.4byte 0x00000000
.include "macros.inc"
