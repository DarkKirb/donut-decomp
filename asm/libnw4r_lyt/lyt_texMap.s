...
/* 800FC010 000F7E50  55 47 27 3E */	srwi r7, r10, 0x1c
/* 800FC014 000F7E54  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 800FC018 000F7E58  38 07 FF F8 */	addi r0, r7, -8
/* 800FC01C 000F7E5C  28 00 00 02 */	cmplwi r0, 2
...
/* 800FC03C 000F7E7C  90 61 00 08 */	stw r3, 8(r1)
/* 800FC040 000F7E80  7F E3 FB 78 */	mr r3, r31
/* 800FC044 000F7E84  80 9E 00 00 */	lwz r4, 0(r30)
/* 800FC048 000F7E88  54 07 27 3E */	srwi r7, r0, 0x1c
/* 800FC04C 000F7E8C  A0 BE 00 08 */	lhz r5, 8(r30)
/* 800FC050 000F7E90  54 08 3F BE */	rlwinm r8, r0, 7, 0x1e, 0x1f
/* 800FC054 000F7E94  A0 DE 00 0A */	lhz r6, 0xa(r30)
/* 800FC058 000F7E98  54 09 4F BE */	rlwinm r9, r0, 9, 0x1e, 0x1f
/* 800FC05C 000F7E9C  54 0A 2F FE */	rlwinm r10, r0, 5, 0x1f, 0x1f
/* 800FC060 000F7EA0  4B F3 A9 61 */	bl GXInitTexObjCI
/* 800FC064 000F7EA4  48 00 00 24 */	b lbl_800FC088
lbl_800FC068:
/* 800FC068 000F7EA8  80 9E 00 00 */	lwz r4, 0(r30)
/* 800FC06C 000F7EAC  7F E3 FB 78 */	mr r3, r31
/* 800FC070 000F7EB0  A0 BE 00 08 */	lhz r5, 8(r30)
/* 800FC074 000F7EB4  55 48 3F BE */	rlwinm r8, r10, 7, 0x1e, 0x1f
/* 800FC078 000F7EB8  55 49 4F BE */	rlwinm r9, r10, 9, 0x1e, 0x1f
/* 800FC07C 000F7EBC  A0 DE 00 0A */	lhz r6, 0xa(r30)
/* 800FC080 000F7EC0  55 4A 2F FE */	rlwinm r10, r10, 5, 0x1f, 0x1f
...
/* 800FC0A0 000F7EE0  C8 42 92 20 */	lfd f2, $$27568-_SDA2_BASE_(r2)
/* 800FC0A4 000F7EE4  54 04 67 7E */	rlwinm r4, r0, 0xc, 0x1d, 0x1f
/* 800FC0A8 000F7EE8  C8 21 00 10 */	lfd f1, 0x10(r1)
/* 800FC0AC 000F7EEC  54 05 6F FE */	rlwinm r5, r0, 0xd, 0x1f, 0x1f
/* 800FC0B0 000F7EF0  C0 02 92 18 */	lfs f0, $$27564-_SDA2_BASE_(r2)
/* 800FC0B4 000F7EF4  54 06 77 FE */	rlwinm r6, r0, 0xe, 0x1f, 0x1f
...
/* 800FC0C4 000F7F04  54 07 7F FE */	rlwinm r7, r0, 0xf, 0x1f, 0x1f
/* 800FC0C8 000F7F08  54 08 8F BE */	rlwinm r8, r0, 0x11, 0x1e, 0x1f
...
/* 800FC0EC 000F7F2C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800FC0FC 000F7F3C  80 85 00 04 */	lwz r4, 4(r5)
/* 800FC100 000F7F40  A0 C5 00 16 */	lhz r6, 0x16(r5)
/* 800FC104 000F7F44  54 05 9F BE */	rlwinm r5, r0, 0x13, 0x1e, 0x1f
/* 800FC108 000F7F48  4B F3 AD 88 */	b GXInitTlutObj
/* 800FC10C 000F7F4C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800FC138 000F7F78  80 C4 00 08 */	lwz r6, 8(r4)
...
/* 800FC158 000F7F98  80 C3 00 00 */	lwz r6, 0(r3)
/* 800FC15C 000F7F9C  80 9D 00 18 */	lwz r4, 0x18(r29)
/* 800FC160 000F7FA0  80 06 00 08 */	lwz r0, 8(r6)
/* 800FC164 000F7FA4  90 1D 00 00 */	stw r0, 0(r29)
/* 800FC168 000F7FA8  A0 A6 00 00 */	lhz r5, 0(r6)
/* 800FC16C 000F7FAC  A0 06 00 02 */	lhz r0, 2(r6)
/* 800FC170 000F7FB0  B0 1D 00 08 */	sth r0, 8(r29)
/* 800FC174 000F7FB4  B0 BD 00 0A */	sth r5, 0xa(r29)
/* 800FC178 000F7FB8  80 06 00 04 */	lwz r0, 4(r6)
/* 800FC17C 000F7FBC  50 04 E0 06 */	rlwimi r4, r0, 0x1c, 0, 3
/* 800FC180 000F7FC0  90 9D 00 18 */	stw r4, 0x18(r29)
/* 800FC184 000F7FC4  80 63 00 04 */	lwz r3, 4(r3)
/* 800FC188 000F7FC8  2C 03 00 00 */	cmpwi r3, 0
/* 800FC18C 000F7FCC  41 82 00 24 */	beq lbl_800FC1B0
/* 800FC190 000F7FD0  80 03 00 08 */	lwz r0, 8(r3)
/* 800FC194 000F7FD4  90 1D 00 04 */	stw r0, 4(r29)
/* 800FC198 000F7FD8  80 03 00 04 */	lwz r0, 4(r3)
/* 800FC19C 000F7FDC  50 04 6C 64 */	rlwimi r4, r0, 0xd, 0x11, 0x12
/* 800FC1A0 000F7FE0  90 9D 00 18 */	stw r4, 0x18(r29)
/* 800FC1A4 000F7FE4  A0 03 00 00 */	lhz r0, 0(r3)
/* 800FC1A8 000F7FE8  B0 1D 00 16 */	sth r0, 0x16(r29)
/* 800FC1AC 000F7FEC  48 00 00 18 */	b lbl_800FC1C4
lbl_800FC1B0:
/* 800FC1B0 000F7FF0  38 60 00 00 */	li r3, 0
/* 800FC1B4 000F7FF4  54 80 04 E0 */	rlwinm r0, r4, 0, 0x13, 0x10
/* 800FC1B8 000F7FF8  90 7D 00 04 */	stw r3, 4(r29)
...
.global $$27564
$$27564:
	.incbin "baserom.dol", 0x499CD8, 0x8
.global $$27568
$$27568:
	.incbin "baserom.dol", 0x499CE0, 0x8
