...
/* 800FE920 000FA760  F0 03 D0 00 */	psq_st f0, 0(r3), 1, qr5
...
/* 800FE934 000FA774  E0 83 D0 00 */	psq_l f4, 0(r3), 1, qr5
/* 800FE938 000FA778  38 61 00 18 */	addi r3, r1, 0x18
/* 800FE93C 000FA77C  C0 62 92 5C */	lfs f3, $$22457-_SDA2_BASE_(r2)
/* 800FE940 000FA780  FC 40 20 18 */	frsp f2, f4
/* 800FE944 000FA784  C0 02 92 60 */	lfs f0, $$22458-_SDA2_BASE_(r2)
...
/* 800FE95C 000FA79C  F0 23 B0 00 */	psq_st f1, 0(r3), 1, qr3
...
/* 800FE96C 000FA7AC  B0 81 00 08 */	sth r4, 8(r1)
/* 800FE970 000FA7B0  E0 03 B0 00 */	psq_l f0, 0(r3), 1, qr3
/* 800FE974 000FA7B4  3C A0 80 44 */	lis r5, sExpTbl__Q34nw4r4math29$$2unnamed$$2math_arithmetic_cpp$$2@ha
/* 800FE978 000FA7B8  54 86 18 38 */	slwi r6, r4, 3
/* 800FE97C 000FA7BC  54 03 B8 10 */	slwi r3, r0, 0x17
/* 800FE980 000FA7C0  38 A5 15 C0 */	addi r5, r5, sExpTbl__Q34nw4r4math29$$2unnamed$$2math_arithmetic_cpp$$2@l
...
/* 800FE990 000FA7D0  C0 24 00 04 */	lfs f1, 4(r4)
...
/* 800FE9BC 000FA7FC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800FE9D8 000FA818  54 05 4E 3E */	rlwinm r5, r0, 9, 0x18, 0x1f
/* 800FE9DC 000FA81C  38 05 FF 81 */	addi r0, r5, -127
...
/* 800FE9F4 000FA834  E0 43 D0 00 */	psq_l f2, 0(r3), 1, qr5
/* 800FE9F8 000FA838  38 61 00 10 */	addi r3, r1, 0x10
/* 800FE9FC 000FA83C  C0 22 92 68 */	lfs f1, $$22495-_SDA2_BASE_(r2)
/* 800FEA00 000FA840  C0 02 92 64 */	lfs f0, $$22494-_SDA2_BASE_(r2)
...
/* 800FEA14 000FA854  F0 43 B0 00 */	psq_st f2, 0(r3), 1, qr3
...
/* 800FEA24 000FA864  B0 01 00 08 */	sth r0, 8(r1)
/* 800FEA28 000FA868  E0 23 B0 00 */	psq_l f1, 0(r3), 1, qr3
/* 800FEA2C 000FA86C  3C 80 80 44 */	lis r4, sLogTbl__Q34nw4r4math29$$2unnamed$$2math_arithmetic_cpp$$2@ha
/* 800FEA30 000FA870  C0 02 92 5C */	lfs f0, $$22457-_SDA2_BASE_(r2)
/* 800FEA34 000FA874  54 00 18 38 */	slwi r0, r0, 3
/* 800FEA38 000FA878  38 84 16 C8 */	addi r4, r4, sLogTbl__Q34nw4r4math29$$2unnamed$$2math_arithmetic_cpp$$2@l
...
/* 800FEA48 000FA888  C0 43 00 04 */	lfs f2, 4(r3)
...
/* 800FEA64 000FA8A4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800FEA68 000FA8A8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800FEA6C 000FA8AC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global FrSqrt__Q24nw4r4mathFf
FrSqrt__Q24nw4r4mathFf:
/* 800FEA70 000FA8B0  FC 00 08 34 */	frsqrte f0, f1
/* 800FEA74 000FA8B4  C0 42 92 6C */	lfs f2, $$22497-_SDA2_BASE_(r2)
/* 800FEA78 000FA8B8  C0 62 92 70 */	lfs f3, $$22498-_SDA2_BASE_(r2)
...
/* 800FEA94 000FA8D4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
.global sLogTbl__Q34nw4r4math29$$2unnamed$$2math_arithmetic_cpp$$2
...
.global $$22457
$$22457:
	.incbin "baserom.dol", 0x499D1C, 0x4
.global $$22458
$$22458:
	.incbin "baserom.dol", 0x499D20, 0x4
.global $$22494
$$22494:
	.incbin "baserom.dol", 0x499D24, 0x4
.global $$22495
$$22495:
	.incbin "baserom.dol", 0x499D28, 0x4
.global $$22497
$$22497:
	.incbin "baserom.dol", 0x499D2C, 0x4
.global $$22498
$$22498:
	.incbin "baserom.dol", 0x499D30, 0x8
