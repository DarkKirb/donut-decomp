...
/* 800FEAA8 000FA8E8  C0 02 92 78 */	lfs f0, lbl_8055F1F8@sda21(r2)
...
/* 800FEADC 000FA91C  3C 80 80 41 */	lis r4, lbl_80408F10@ha
/* 800FEAE0 000FA920  54 00 25 36 */	rlwinm r0, r0, 4, 20, 27
/* 800FEAE4 000FA924  C0 02 92 7C */	lfs f0, lbl_8055F1FC@sda21(r2)
/* 800FEAE8 000FA928  38 84 8F 10 */	addi r4, r4, lbl_80408F10@l
...
/* 800FEB28 000FA968  C0 02 92 78 */	lfs f0, lbl_8055F1F8@sda21(r2)
...
/* 800FEB5C 000FA99C  3C 60 80 41 */	lis r3, lbl_80408F10@ha
/* 800FEB60 000FA9A0  54 00 25 36 */	rlwinm r0, r0, 4, 20, 27
/* 800FEB64 000FA9A4  38 63 8F 10 */	addi r3, r3, lbl_80408F10@l
...
/* 800FEB94 000FA9D4  3C A0 80 41 */	lis r5, lbl_80408F10@ha
/* 800FEB98 000FA9D8  C0 42 92 78 */	lfs f2, lbl_8055F1F8@sda21(r2)
/* 800FEB9C 000FA9DC  38 A5 8F 10 */	addi r5, r5, lbl_80408F10@l
...
.global lbl_800FEC00
lbl_800FEC00:
/* 800FEC00 000FAA40  C0 02 92 7C */	lfs f0, lbl_8055F1FC@sda21(r2)
...
.global lbl_800FEC20
lbl_800FEC20:
/* 800FEC20 000FAA60  C0 82 92 7C */	lfs f4, lbl_8055F1FC@sda21(r2)
...
/* 800FEC58 000FAA98  C0 82 92 84 */	lfs f4, lbl_8055F204@sda21(r2)
...
/* 800FEC88 000FAAC8  C0 82 92 88 */	lfs f4, lbl_8055F208@sda21(r2)
...
/* 800FECB8 000FAAF8  C0 82 92 8C */	lfs f4, lbl_8055F20C@sda21(r2)
...
/* 800FECC8 000FAB08  C0 82 92 84 */	lfs f4, lbl_8055F204@sda21(r2)
...
/* 800FECF0 000FAB30  C0 82 92 90 */	lfs f4, lbl_8055F210@sda21(r2)
...
/* 800FED00 000FAB40  C0 82 92 88 */	lfs f4, lbl_8055F208@sda21(r2)
...
/* 800FED18 000FAB58  C0 02 92 80 */	lfs f0, lbl_8055F200@sda21(r2)
...
/* 800FED3C 000FAB7C  3C 80 80 44 */	lis r4, lbl_80441ED0@ha
/* 800FED40 000FAB80  54 00 18 38 */	slwi r0, r0, 3
/* 800FED44 000FAB84  38 84 1E D0 */	addi r4, r4, lbl_80441ED0@l
...
/* 800FED6C 000FABAC  C0 02 92 80 */	lfs f0, lbl_8055F200@sda21(r2)
...
/* 800FED90 000FABD0  3C 80 80 44 */	lis r4, lbl_80441ED0@ha
/* 800FED94 000FABD4  54 00 18 38 */	slwi r0, r0, 3
/* 800FED98 000FABD8  38 84 1E D0 */	addi r4, r4, lbl_80441ED0@l
