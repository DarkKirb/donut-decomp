...
/* 8010D72C 0010956C  93 C1 00 08 */	stw r30, 8(r1)
...
/* 8010D744 00109584  90 9E 00 00 */	stw r4, 0(r30)
...
/* 8010D750 00109590  38 00 00 00 */	li r0, 0
...
/* 8010D798 001095D8  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 8010D7AC 001095EC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010D7B8 001095F8  2C 03 00 00 */	cmpwi r3, 0
...
/* 8010D7F4 00109634  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 8010D808 00109648  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010D80C 0010964C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010D828 00109668  38 00 00 00 */	li r0, 0
...
/* 8010D844 00109684  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010D848 00109688  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010D84C 0010968C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010D87C 001096BC  81 83 00 00 */	lwz r12, 0(r3)
...
/* 8010D8CC 0010970C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010D8FC 0010973C  2C 1F 00 00 */	cmpwi r31, 0
...
lbl_8010D914:
/* 8010D914 00109754  38 00 00 01 */	li r0, 1
...
/* 8010D938 00109778  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010D93C 0010977C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010D94C 0010978C  38 00 00 01 */	li r0, 1
...
/* 8010D960 001097A0  83 C3 00 04 */	lwz r30, 4(r3)
/* 8010D964 001097A4  90 83 02 8C */	stw r4, 0x28c(r3)
/* 8010D968 001097A8  2C 1E 00 00 */	cmpwi r30, 0
...
/* 8010D980 001097C0  38 00 00 00 */	li r0, 0
/* 8010D984 001097C4  48 00 00 78 */	b lbl_8010D9FC
lbl_8010D988:
/* 8010D988 001097C8  81 84 00 00 */	lwz r12, 0(r4)
...
/* 8010D99C 001097DC  81 9E 00 00 */	lwz r12, 0(r30)
...
/* 8010D9B8 001097F8  2C 03 00 00 */	cmpwi r3, 0
/* 8010D9BC 001097FC  40 82 00 0C */	bne lbl_8010D9C8
/* 8010D9C0 00109800  38 00 00 00 */	li r0, 0
...
/* 8010D9F0 00109830  38 A0 00 01 */	li r5, 1
...
/* 8010D9F8 00109838  38 00 00 01 */	li r0, 1
lbl_8010D9FC:
/* 8010D9FC 0010983C  2C 00 00 00 */	cmpwi r0, 0
/* 8010DA00 00109840  40 82 00 18 */	bne lbl_8010DA18
/* 8010DA04 00109844  81 9D 00 00 */	lwz r12, 0(r29)
...
/* 8010DA34 00109874  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DA38 00109878  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DA3C 0010987C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010DA48 00109888  2C 03 00 00 */	cmpwi r3, 0
/* 8010DA4C 0010988C  90 01 00 14 */	stw r0, 0x14(r1)
/* 8010DA50 00109890  38 00 00 00 */	li r0, 0
...
/* 8010DA68 001098A8  38 80 00 00 */	li r4, 0
...
/* 8010DA84 001098C4  2C 05 00 00 */	cmpwi r5, 0
...
lbl_8010DA98:
/* 8010DA98 001098D8  38 00 00 01 */	li r0, 1
...
/* 8010DAB4 001098F4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DAB8 001098F8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DABC 001098FC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010DAE0 00109920  2C 00 00 00 */	cmpwi r0, 0
...
/* 8010DB30 00109970  80 1E 00 04 */	lwz r0, 4(r30)
/* 8010DB34 00109974  2C 00 00 00 */	cmpwi r0, 0
...
lbl_8010DB48:
/* 8010DB48 00109988  38 7E 00 04 */	addi r3, r30, 4
...
/* 8010DB54 00109994  81 9D 00 00 */	lwz r12, 0(r29)
/* 8010DB58 00109998  7F A3 EB 78 */	mr r3, r29
/* 8010DB5C 0010999C  38 80 FF FF */	li r4, -1
...
/* 8010DB9C 001099DC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010DBA8 001099E8  2C 03 00 00 */	cmpwi r3, 0
...
/* 8010DBB8 001099F8  93 C1 00 08 */	stw r30, 8(r1)
...
/* 8010DBF8 00109A38  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 8010DC0C 00109A4C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010DC18 00109A58  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DC1C 00109A5C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010DC28 00109A68  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DC2C 00109A6C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010DC38 00109A78  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DC3C 00109A7C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
lbl_8010DC7C:
/* 8010DC7C 00109ABC  7C 80 FE 70 */	srawi r0, r4, 0x1f
...
/* 8010DC98 00109AD8  38 7E 00 04 */	addi r3, r30, 4
...
/* 8010DCA4 00109AE4  80 7E 00 08 */	lwz r3, 8(r30)
/* 8010DCA8 00109AE8  38 1E 00 08 */	addi r0, r30, 8
...
lbl_8010DCCC:
/* 8010DCCC 00109B0C  7C A4 FE 70 */	srawi r4, r5, 0x1f
...
/* 8010DCDC 00109B1C  80 63 00 00 */	lwz r3, 0(r3)
lbl_8010DCE0:
/* 8010DCE0 00109B20  7C 03 00 40 */	cmplw r3, r0
/* 8010DCE4 00109B24  40 82 FF CC */	bne lbl_8010DCB0
lbl_8010DCE8:
/* 8010DCE8 00109B28  90 61 00 08 */	stw r3, 8(r1)
/* 8010DCEC 00109B2C  7F 85 E3 78 */	mr r5, r28
/* 8010DCF0 00109B30  38 7E 00 04 */	addi r3, r30, 4
/* 8010DCF4 00109B34  38 81 00 08 */	addi r4, r1, 8
...
/* 8010DD24 00109B64  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DD28 00109B68  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DD2C 00109B6C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010DD3C 00109B7C  54 03 0F FE */	srwi r3, r0, 0x1f
/* 8010DD40 00109B80  4E 80 00 20 */	blr 
/* 8010DD44 00109B84  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DD48 00109B88  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DD4C 00109B8C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010DD58 00109B98  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DD5C 00109B9C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010DD68 00109BA8  38 80 00 00 */	li r4, 0
/* 8010DD6C 00109BAC  38 A0 00 00 */	li r5, 0
...
/* 8010DD80 00109BC0  81 83 00 00 */	lwz r12, 0(r3)
...
/* 8010DD98 00109BD8  81 83 00 00 */	lwz r12, 0(r3)
...
/* 8010DDAC 00109BEC  2C 03 FF FD */	cmpwi r3, -3
/* 8010DDB0 00109BF0  38 00 00 00 */	li r0, 0
...
/* 8010DDC0 00109C00  2C 0C 00 00 */	cmpwi r12, 0
/* 8010DDC4 00109C04  41 82 00 80 */	beq lbl_8010DE44
/* 8010DDC8 00109C08  80 BF 00 20 */	lwz r5, 0x20(r31)
/* 8010DDCC 00109C0C  38 60 00 00 */	li r3, 0
/* 8010DDD0 00109C10  38 80 00 00 */	li r4, 0
...
/* 8010DDF0 00109C30  2C 0C 00 00 */	cmpwi r12, 0
/* 8010DDF4 00109C34  41 82 00 50 */	beq lbl_8010DE44
/* 8010DDF8 00109C38  80 BF 00 20 */	lwz r5, 0x20(r31)
/* 8010DDFC 00109C3C  38 60 00 00 */	li r3, 0
/* 8010DE00 00109C40  38 80 00 00 */	li r4, 0
...
/* 8010DE14 00109C54  38 61 00 08 */	addi r3, r1, 8
/* 8010DE18 00109C58  4B FF E2 99 */	bl __ct__Q44nw4r3snd6detail13SeqFileReaderFPCv
/* 8010DE1C 00109C5C  38 61 00 08 */	addi r3, r1, 8
...
/* 8010DE28 00109C68  2C 0C 00 00 */	cmpwi r12, 0
...
/* 8010DE38 00109C78  38 60 00 01 */	li r3, 1
...
/* 8010DE58 00109C98  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DE5C 00109C9C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010DE64 00109CA4  2C 0C 00 00 */	cmpwi r12, 0
/* 8010DE68 00109CA8  4D 82 00 20 */	beqlr 
/* 8010DE6C 00109CAC  80 A3 00 20 */	lwz r5, 0x20(r3)
/* 8010DE70 00109CB0  38 60 00 00 */	li r3, 0
/* 8010DE74 00109CB4  38 80 00 00 */	li r4, 0
/* 8010DE78 00109CB8  7D 89 03 A6 */	mtctr r12
/* 8010DE7C 00109CBC  4E 80 04 20 */	bctr 
/* 8010DE80 00109CC0  4E 80 00 20 */	blr 
/* 8010DE84 00109CC4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DE88 00109CC8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DE8C 00109CCC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010DE94 00109CD4  38 00 00 00 */	li r0, 0
/* 8010DE98 00109CD8  90 03 00 1C */	stw r0, 0x1c(r3)
/* 8010DE9C 00109CDC  2C 04 00 00 */	cmpwi r4, 0
/* 8010DEA0 00109CE0  4D 82 00 20 */	beqlr 
/* 8010DEA4 00109CE4  81 84 00 00 */	lwz r12, 0(r4)
...
/* 8010DEBC 00109CFC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010DEC8 00109D08  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DECC 00109D0C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010DED4 00109D14  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DED8 00109D18  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DEDC 00109D1C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010DEE8 00109D28  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DEEC 00109D2C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global GetRuntimeTypeInfo__Q44nw4r3snd6detail8SeqSoundCFv
GetRuntimeTypeInfo__Q44nw4r3snd6detail8SeqSoundCFv:
/* 8010DEF0 00109D30  38 6D EC 00 */	addi r3, r13, typeInfo__Q44nw4r3snd6detail8SeqSound-_SDA_BASE_
/* 8010DEF4 00109D34  4E 80 00 20 */	blr 
/* 8010DEF8 00109D38  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010DEFC 00109D3C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global __sinit_$$3snd_SeqSound_cpp
__sinit_$$3snd_SeqSound_cpp:
/* 8010DF00 00109D40  38 0D EB D8 */	addi r0, r13, typeInfo__Q44nw4r3snd6detail10BasicSound-_SDA_BASE_
/* 8010DF04 00109D44  90 0D EC 00 */	stw r0, typeInfo__Q44nw4r3snd6detail8SeqSound-_SDA_BASE_(r13)
