...
/* 8010FD34 0010BB74  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010FD38 0010BB78  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010FD3C 0010BB7C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global Init__Q44nw4r3snd6detail22SoundArchiveFileReaderFPCv
Init__Q44nw4r3snd6detail22SoundArchiveFileReaderFPCv:
/* 8010FD40 0010BB80  80 A4 00 00 */	lwz r5, 0(r4)
...
/* 8010FD88 0010BBC8  54 00 0F FE */	srwi r0, r0, 0x1f
lbl_8010FD8C:
/* 8010FD8C 0010BBCC  2C 00 00 00 */	cmpwi r0, 0
/* 8010FD90 0010BBD0  41 82 00 54 */	beq lbl_8010FDE4
/* 8010FD94 0010BBD4  83 E4 00 00 */	lwz r31, 0(r4)
/* 8010FD98 0010BBD8  81 84 00 04 */	lwz r12, 4(r4)
/* 8010FD9C 0010BBDC  81 64 00 08 */	lwz r11, 8(r4)
...
/* 8010FDBC 0010BBFC  93 E3 00 00 */	stw r31, 0(r3)
/* 8010FDC0 0010BC00  91 83 00 04 */	stw r12, 4(r3)
/* 8010FDC4 0010BC04  91 63 00 08 */	stw r11, 8(r3)
...
/* 8010FDF0 0010BC30  38 A4 00 08 */	addi r5, r4, 8
/* 8010FDF4 0010BC34  90 A3 00 2C */	stw r5, 0x2c(r3)
/* 8010FDF8 0010BC38  80 04 00 08 */	lwz r0, 8(r4)
/* 8010FDFC 0010BC3C  2C 00 00 00 */	cmpwi r0, 0
/* 8010FE00 0010BC40  40 82 00 0C */	bne lbl_8010FE0C
/* 8010FE04 0010BC44  38 00 00 00 */	li r0, 0
...
/* 8010FE18 0010BC58  80 85 00 04 */	lwz r4, 4(r5)
/* 8010FE1C 0010BC5C  2C 04 00 00 */	cmpwi r4, 0
/* 8010FE20 0010BC60  40 82 00 0C */	bne lbl_8010FE2C
/* 8010FE24 0010BC64  38 00 00 00 */	li r0, 0
...
/* 8010FE38 0010BC78  80 85 00 08 */	lwz r4, 8(r5)
/* 8010FE3C 0010BC7C  2C 04 00 00 */	cmpwi r4, 0
/* 8010FE40 0010BC80  40 82 00 0C */	bne lbl_8010FE4C
/* 8010FE44 0010BC84  38 00 00 00 */	li r0, 0
...
/* 8010FE5C 0010BC9C  2C 04 00 00 */	cmpwi r4, 0
/* 8010FE60 0010BCA0  40 82 00 0C */	bne lbl_8010FE6C
/* 8010FE64 0010BCA4  38 00 00 00 */	li r0, 0
...
/* 8010FE7C 0010BCBC  2C 04 00 00 */	cmpwi r4, 0
/* 8010FE80 0010BCC0  40 82 00 0C */	bne lbl_8010FE8C
/* 8010FE84 0010BCC4  38 00 00 00 */	li r0, 0
...
/* 8010FE98 0010BCD8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8010FE9C 0010BCDC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8010FEA0 0010BCE0  38 04 00 08 */	addi r0, r4, 8
/* 8010FEA4 0010BCE4  90 03 00 28 */	stw r0, 0x28(r3)
/* 8010FEA8 0010BCE8  4E 80 00 20 */	blr 
/* 8010FEAC 0010BCEC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80110014 0010BE54  88 64 00 04 */	lbz r3, 4(r4)
/* 80110018 0010BE58  80 84 00 08 */	lwz r4, 8(r4)
...
/* 80110030 0010BE70  80 63 00 08 */	lwz r3, 8(r3)
/* 80110034 0010BE74  7C 63 02 14 */	add r3, r3, r0
lbl_80110038:
/* 80110038 0010BE78  2C 03 00 00 */	cmpwi r3, 0
/* 8011003C 0010BE7C  40 82 00 0C */	bne lbl_80110048
/* 80110040 0010BE80  38 60 00 00 */	li r3, 0
/* 80110044 0010BE84  48 00 00 68 */	b lbl_801100AC
lbl_80110048:
/* 80110048 0010BE88  80 03 00 04 */	lwz r0, 4(r3)
/* 8011004C 0010BE8C  90 1F 00 00 */	stw r0, 0(r31)
/* 80110050 0010BE90  A0 1D 00 06 */	lhz r0, 6(r29)
/* 80110054 0010BE94  80 83 00 08 */	lwz r4, 8(r3)
/* 80110058 0010BE98  90 9F 00 04 */	stw r4, 4(r31)
/* 8011005C 0010BE9C  28 00 01 02 */	cmplwi r0, 0x102
/* 80110060 0010BEA0  88 03 00 2A */	lbz r0, 0x2a(r3)
/* 80110064 0010BEA4  90 1F 00 08 */	stw r0, 8(r31)
...
lbl_80110098:
/* 80110098 0010BED8  38 60 00 01 */	li r3, 1
/* 8011009C 0010BEDC  38 00 00 00 */	li r0, 0
/* 801100A0 0010BEE0  90 7F 00 18 */	stw r3, 0x18(r31)
/* 801100A4 0010BEE4  90 1F 00 1C */	stw r0, 0x1c(r31)
lbl_801100A8:
/* 801100A8 0010BEE8  38 60 00 01 */	li r3, 1
lbl_801100AC:
...
/* 801100C8 0010BF08  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 801100CC 0010BF0C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 801100F8 0010BF38  2C 03 00 01 */	cmpwi r3, 1
/* 801100FC 0010BF3C  41 82 00 0C */	beq lbl_80110108
/* 80110100 0010BF40  38 60 00 00 */	li r3, 0
...
/* 80110110 0010BF50  38 A1 00 08 */	addi r5, r1, 8
/* 80110114 0010BF54  48 00 0B 2D */	bl impl_GetSoundInfoOffset__Q44nw4r3snd6detail22SoundArchiveFileReaderCFUlPQ54nw4r3snd6detail4Util165DataRef$$0v$$4Q54nw4r3snd6detail16SoundArchiveFile12SeqSoundInfo$$4Q54nw4r3snd6detail16SoundArchiveFile13StrmSoundInfo$$4Q54nw4r3snd6detail16SoundArchiveFile13WaveSoundInfo$$1
/* 80110118 0010BF58  2C 03 00 00 */	cmpwi r3, 0
/* 8011011C 0010BF5C  40 82 00 0C */	bne lbl_80110128
/* 80110120 0010BF60  38 60 00 00 */	li r3, 0
/* 80110124 0010BF64  48 00 00 14 */	b lbl_80110138
lbl_80110128:
/* 80110128 0010BF68  88 61 00 08 */	lbz r3, 8(r1)
...
lbl_80110138:
/* 80110138 0010BF78  2C 03 00 00 */	cmpwi r3, 0
/* 8011013C 0010BF7C  40 82 00 0C */	bne lbl_80110148
/* 80110140 0010BF80  38 60 00 00 */	li r3, 0
/* 80110144 0010BF84  48 00 00 54 */	b lbl_80110198
lbl_80110148:
/* 80110148 0010BF88  80 03 00 00 */	lwz r0, 0(r3)
/* 8011014C 0010BF8C  90 1F 00 00 */	stw r0, 0(r31)
/* 80110150 0010BF90  80 03 00 04 */	lwz r0, 4(r3)
/* 80110154 0010BF94  90 1F 00 04 */	stw r0, 4(r31)
/* 80110158 0010BF98  88 03 00 0C */	lbz r0, 0xc(r3)
/* 8011015C 0010BF9C  90 1F 00 0C */	stw r0, 0xc(r31)
/* 80110160 0010BFA0  80 03 00 08 */	lwz r0, 8(r3)
/* 80110164 0010BFA4  90 1F 00 08 */	stw r0, 8(r31)
/* 80110168 0010BFA8  A0 1D 00 06 */	lhz r0, 6(r29)
...
/* 801101B4 0010BFF4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 801101B8 0010BFF8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 801101BC 0010BFFC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 801101E8 0010C028  2C 03 00 02 */	cmpwi r3, 2
/* 801101EC 0010C02C  41 82 00 0C */	beq lbl_801101F8
/* 801101F0 0010C030  38 60 00 00 */	li r3, 0
...
/* 80110200 0010C040  38 A1 00 08 */	addi r5, r1, 8
/* 80110204 0010C044  48 00 0A 3D */	bl impl_GetSoundInfoOffset__Q44nw4r3snd6detail22SoundArchiveFileReaderCFUlPQ54nw4r3snd6detail4Util165DataRef$$0v$$4Q54nw4r3snd6detail16SoundArchiveFile12SeqSoundInfo$$4Q54nw4r3snd6detail16SoundArchiveFile13StrmSoundInfo$$4Q54nw4r3snd6detail16SoundArchiveFile13WaveSoundInfo$$1
/* 80110208 0010C048  2C 03 00 00 */	cmpwi r3, 0
/* 8011020C 0010C04C  40 82 00 0C */	bne lbl_80110218
/* 80110210 0010C050  38 60 00 00 */	li r3, 0
/* 80110214 0010C054  48 00 00 14 */	b lbl_80110228
lbl_80110218:
/* 80110218 0010C058  88 61 00 08 */	lbz r3, 8(r1)
...
lbl_80110228:
/* 80110228 0010C068  2C 03 00 00 */	cmpwi r3, 0
/* 8011022C 0010C06C  40 82 00 0C */	bne lbl_80110238
/* 80110230 0010C070  38 60 00 00 */	li r3, 0
/* 80110234 0010C074  48 00 00 74 */	b lbl_801102A8
lbl_80110238:
/* 80110238 0010C078  80 03 00 00 */	lwz r0, 0(r3)
/* 8011023C 0010C07C  90 1F 00 00 */	stw r0, 0(r31)
/* 80110240 0010C080  A0 03 00 06 */	lhz r0, 6(r3)
/* 80110244 0010C084  B0 1F 00 06 */	sth r0, 6(r31)
/* 80110248 0010C088  A0 1D 00 06 */	lhz r0, 6(r29)
/* 8011024C 0010C08C  28 00 01 04 */	cmplwi r0, 0x104
/* 80110250 0010C090  41 80 00 10 */	blt lbl_80110260
/* 80110254 0010C094  A0 03 00 04 */	lhz r0, 4(r3)
/* 80110258 0010C098  B0 1F 00 04 */	sth r0, 4(r31)
/* 8011025C 0010C09C  48 00 00 48 */	b lbl_801102A4
lbl_80110260:
/* 80110260 0010C0A0  38 00 00 00 */	li r0, 0
/* 80110264 0010C0A4  B0 1F 00 04 */	sth r0, 4(r31)
/* 80110268 0010C0A8  A0 83 00 04 */	lhz r4, 4(r3)
/* 8011026C 0010C0AC  48 00 00 30 */	b lbl_8011029C
lbl_80110270:
/* 80110270 0010C0B0  54 80 07 FF */	clrlwi. r0, r4, 0x1f
/* 80110274 0010C0B4  41 82 00 14 */	beq lbl_80110288
/* 80110278 0010C0B8  A0 7F 00 04 */	lhz r3, 4(r31)
/* 8011027C 0010C0BC  38 03 00 01 */	addi r0, r3, 1
/* 80110280 0010C0C0  B0 1F 00 04 */	sth r0, 4(r31)
/* 80110284 0010C0C4  48 00 00 14 */	b lbl_80110298
lbl_80110288:
/* 80110288 0010C0C8  54 80 04 3F */	clrlwi. r0, r4, 0x10
/* 8011028C 0010C0CC  41 82 00 0C */	beq lbl_80110298
/* 80110290 0010C0D0  38 60 00 00 */	li r3, 0
/* 80110294 0010C0D4  48 00 00 14 */	b lbl_801102A8
lbl_80110298:
/* 80110298 0010C0D8  54 84 FC 7E */	rlwinm r4, r4, 0x1f, 0x11, 0x1f
lbl_8011029C:
/* 8011029C 0010C0DC  54 80 04 3F */	clrlwi. r0, r4, 0x10
/* 801102A0 0010C0E0  40 82 FF D0 */	bne lbl_80110270
lbl_801102A4:
/* 801102A4 0010C0E4  38 60 00 01 */	li r3, 1
lbl_801102A8:
...
/* 801102C4 0010C104  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 801102C8 0010C108  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 801102CC 0010C10C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 801102F8 0010C138  2C 03 00 03 */	cmpwi r3, 3
/* 801102FC 0010C13C  41 82 00 0C */	beq lbl_80110308
/* 80110300 0010C140  38 60 00 00 */	li r3, 0
...
/* 80110310 0010C150  38 A1 00 08 */	addi r5, r1, 8
/* 80110314 0010C154  48 00 09 2D */	bl impl_GetSoundInfoOffset__Q44nw4r3snd6detail22SoundArchiveFileReaderCFUlPQ54nw4r3snd6detail4Util165DataRef$$0v$$4Q54nw4r3snd6detail16SoundArchiveFile12SeqSoundInfo$$4Q54nw4r3snd6detail16SoundArchiveFile13StrmSoundInfo$$4Q54nw4r3snd6detail16SoundArchiveFile13WaveSoundInfo$$1
/* 80110318 0010C158  2C 03 00 00 */	cmpwi r3, 0
/* 8011031C 0010C15C  40 82 00 0C */	bne lbl_80110328
/* 80110320 0010C160  38 60 00 00 */	li r3, 0
/* 80110324 0010C164  48 00 00 14 */	b lbl_80110338
lbl_80110328:
/* 80110328 0010C168  88 61 00 08 */	lbz r3, 8(r1)
...
lbl_80110338:
/* 80110338 0010C178  2C 03 00 00 */	cmpwi r3, 0
/* 8011033C 0010C17C  40 82 00 0C */	bne lbl_80110348
/* 80110340 0010C180  38 60 00 00 */	li r3, 0
/* 80110344 0010C184  48 00 00 44 */	b lbl_80110388
lbl_80110348:
/* 80110348 0010C188  80 03 00 00 */	lwz r0, 0(r3)
/* 8011034C 0010C18C  90 1F 00 00 */	stw r0, 0(r31)
/* 80110350 0010C190  88 03 00 08 */	lbz r0, 8(r3)
/* 80110354 0010C194  90 1F 00 04 */	stw r0, 4(r31)
/* 80110358 0010C198  A0 1D 00 06 */	lhz r0, 6(r29)
/* 8011035C 0010C19C  28 00 01 03 */	cmplwi r0, 0x103
/* 80110360 0010C1A0  41 80 00 1C */	blt lbl_8011037C
/* 80110364 0010C1A4  88 63 00 09 */	lbz r3, 9(r3)
/* 80110368 0010C1A8  7C 03 00 D0 */	neg r0, r3
/* 8011036C 0010C1AC  7C 00 1B 78 */	or r0, r0, r3
/* 80110370 0010C1B0  54 00 0F FE */	srwi r0, r0, 0x1f
/* 80110374 0010C1B4  98 1F 00 08 */	stb r0, 8(r31)
/* 80110378 0010C1B8  48 00 00 0C */	b lbl_80110384
lbl_8011037C:
/* 8011037C 0010C1BC  38 00 00 00 */	li r0, 0
/* 80110380 0010C1C0  98 1F 00 08 */	stb r0, 8(r31)
lbl_80110384:
/* 80110384 0010C1C4  38 60 00 01 */	li r3, 1
lbl_80110388:
...
/* 801103A4 0010C1E4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 801103A8 0010C1E8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 801103AC 0010C1EC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 801103DC 0010C21C  88 66 00 08 */	lbz r3, 8(r6)
...
/* 80110418 0010C258  88 64 00 04 */	lbz r3, 4(r4)
/* 8011041C 0010C25C  80 84 00 08 */	lwz r4, 8(r4)
/* 80110420 0010C260  48 00 CD 11 */	bl GetDataRefAddressImpl__Q44nw4r3snd6detail4UtilFQ54nw4r3snd6detail4Util7RefTypeUlPCv
lbl_80110424:
/* 80110424 0010C264  2C 03 00 00 */	cmpwi r3, 0
/* 80110428 0010C268  40 82 00 0C */	bne lbl_80110434
/* 8011042C 0010C26C  38 60 00 00 */	li r3, 0
/* 80110430 0010C270  48 00 00 10 */	b lbl_80110440
lbl_80110434:
/* 80110434 0010C274  80 03 00 04 */	lwz r0, 4(r3)
/* 80110438 0010C278  38 60 00 01 */	li r3, 1
/* 8011043C 0010C27C  90 1F 00 00 */	stw r0, 0(r31)
lbl_80110440:
...
/* 8011045C 0010C29C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 801104C8 0010C308  88 64 00 04 */	lbz r3, 4(r4)
/* 801104CC 0010C30C  80 84 00 08 */	lwz r4, 8(r4)
...
lbl_801104D8:
/* 801104D8 0010C318  2C 04 00 00 */	cmpwi r4, 0
/* 801104DC 0010C31C  40 82 00 0C */	bne lbl_801104E8
/* 801104E0 0010C320  38 60 00 00 */	li r3, 0
/* 801104E4 0010C324  48 00 00 18 */	b lbl_801104FC
lbl_801104E8:
/* 801104E8 0010C328  88 04 00 04 */	lbz r0, 4(r4)
/* 801104EC 0010C32C  38 60 00 01 */	li r3, 1
/* 801104F0 0010C330  90 1F 00 00 */	stw r0, 0(r31)
/* 801104F4 0010C334  80 04 00 08 */	lwz r0, 8(r4)
/* 801104F8 0010C338  90 1F 00 04 */	stw r0, 4(r31)
lbl_801104FC:
...
/* 80110518 0010C358  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8011051C 0010C35C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8011058C 0010C3CC  88 64 00 04 */	lbz r3, 4(r4)
/* 80110590 0010C3D0  80 84 00 08 */	lwz r4, 8(r4)
...
lbl_8011059C:
/* 8011059C 0010C3DC  2C 1E 00 00 */	cmpwi r30, 0
/* 801105A0 0010C3E0  40 82 00 0C */	bne lbl_801105AC
/* 801105A4 0010C3E4  38 60 00 00 */	li r3, 0
...
/* 801105E0 0010C420  90 7D 00 04 */	stw r3, 4(r29)
/* 801105E4 0010C424  38 60 00 01 */	li r3, 1
/* 801105E8 0010C428  80 1E 00 10 */	lwz r0, 0x10(r30)
/* 801105EC 0010C42C  90 1D 00 08 */	stw r0, 8(r29)
...
/* 80110608 0010C448  80 1F 00 00 */	lwz r0, 0(r31)
/* 8011060C 0010C44C  90 1D 00 00 */	stw r0, 0(r29)
lbl_80110610:
...
/* 801106A0 0010C4E0  88 64 00 04 */	lbz r3, 4(r4)
/* 801106A4 0010C4E4  80 84 00 08 */	lwz r4, 8(r4)
...
lbl_801106B0:
/* 801106B0 0010C4F0  2C 04 00 00 */	cmpwi r4, 0
/* 801106B4 0010C4F4  40 82 00 0C */	bne lbl_801106C0
/* 801106B8 0010C4F8  38 60 00 00 */	li r3, 0
...
/* 80110700 0010C540  88 64 00 04 */	lbz r3, 4(r4)
/* 80110704 0010C544  80 84 00 08 */	lwz r4, 8(r4)
/* 80110708 0010C548  48 00 CA 29 */	bl GetDataRefAddressImpl__Q44nw4r3snd6detail4UtilFQ54nw4r3snd6detail4Util7RefTypeUlPCv
/* 8011070C 0010C54C  2C 03 00 00 */	cmpwi r3, 0
/* 80110710 0010C550  40 82 00 0C */	bne lbl_8011071C
/* 80110714 0010C554  38 60 00 00 */	li r3, 0
/* 80110718 0010C558  48 00 00 30 */	b lbl_80110748
lbl_8011071C:
/* 8011071C 0010C55C  80 03 00 00 */	lwz r0, 0(r3)
/* 80110720 0010C560  90 1F 00 00 */	stw r0, 0(r31)
/* 80110724 0010C564  80 03 00 04 */	lwz r0, 4(r3)
/* 80110728 0010C568  90 1F 00 04 */	stw r0, 4(r31)
/* 8011072C 0010C56C  80 03 00 08 */	lwz r0, 8(r3)
/* 80110730 0010C570  90 1F 00 08 */	stw r0, 8(r31)
...
/* 80110740 0010C580  38 60 00 01 */	li r3, 1
...
/* 80110768 0010C5A8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8011076C 0010C5AC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80110794 0010C5D4  2C 1F 00 00 */	cmpwi r31, 0
/* 80110798 0010C5D8  40 82 00 0C */	bne lbl_801107A4
/* 8011079C 0010C5DC  38 60 00 00 */	li r3, 0
/* 801107A0 0010C5E0  48 00 00 40 */	b lbl_801107E0
lbl_801107A4:
/* 801107A4 0010C5E4  A0 03 00 00 */	lhz r0, 0(r3)
/* 801107A8 0010C5E8  90 1F 00 00 */	stw r0, 0(r31)
/* 801107AC 0010C5EC  A0 03 00 02 */	lhz r0, 2(r3)
/* 801107B0 0010C5F0  90 1F 00 04 */	stw r0, 4(r31)
/* 801107B4 0010C5F4  A0 03 00 04 */	lhz r0, 4(r3)
/* 801107B8 0010C5F8  90 1F 00 08 */	stw r0, 8(r31)
/* 801107BC 0010C5FC  A0 03 00 06 */	lhz r0, 6(r3)
/* 801107C0 0010C600  90 1F 00 0C */	stw r0, 0xc(r31)
/* 801107C4 0010C604  A0 03 00 08 */	lhz r0, 8(r3)
...
/* 801107D8 0010C618  38 60 00 01 */	li r3, 1
...
/* 801107F4 0010C634  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 801107F8 0010C638  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 801107FC 0010C63C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8011081C 0010C65C  2C 03 00 00 */	cmpwi r3, 0
/* 80110820 0010C660  40 82 00 0C */	bne lbl_8011082C
/* 80110824 0010C664  38 60 00 00 */	li r3, 0
/* 80110828 0010C668  48 00 00 08 */	b lbl_80110830
lbl_8011082C:
/* 8011082C 0010C66C  80 63 00 00 */	lwz r3, 0(r3)
lbl_80110830:
...
/* 8011085C 0010C69C  2C 03 00 00 */	cmpwi r3, 0
/* 80110860 0010C6A0  40 82 00 0C */	bne lbl_8011086C
/* 80110864 0010C6A4  38 60 00 00 */	li r3, 0
/* 80110868 0010C6A8  48 00 00 0C */	b lbl_80110874
lbl_8011086C:
/* 8011086C 0010C6AC  80 63 00 00 */	lwz r3, 0(r3)
/* 80110870 0010C6B0  38 63 FF FF */	addi r3, r3, -1
lbl_80110874:
...
/* 80110884 0010C6C4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80110888 0010C6C8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8011088C 0010C6CC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 801108AC 0010C6EC  2C 03 00 00 */	cmpwi r3, 0
/* 801108B0 0010C6F0  40 82 00 0C */	bne lbl_801108BC
/* 801108B4 0010C6F4  38 60 00 00 */	li r3, 0
/* 801108B8 0010C6F8  48 00 00 08 */	b lbl_801108C0
lbl_801108BC:
/* 801108BC 0010C6FC  80 63 00 00 */	lwz r3, 0(r3)
lbl_801108C0:
...
/* 8011096C 0010C7AC  2C 03 00 00 */	cmpwi r3, 0
/* 80110970 0010C7B0  7C 7F 1B 78 */	mr r31, r3
/* 80110974 0010C7B4  40 82 00 0C */	bne lbl_80110980
/* 80110978 0010C7B8  38 60 00 00 */	li r3, 0
/* 8011097C 0010C7BC  48 00 00 34 */	b lbl_801109B0
lbl_80110980:
/* 80110980 0010C7C0  80 1E 00 00 */	lwz r0, 0(r30)
/* 80110984 0010C7C4  90 1D 00 00 */	stw r0, 0(r29)
/* 80110988 0010C7C8  80 BC 00 28 */	lwz r5, 0x28(r28)
/* 8011098C 0010C7CC  80 1E 00 04 */	lwz r0, 4(r30)
/* 80110990 0010C7D0  90 1D 00 04 */	stw r0, 4(r29)
...
/* 801109A0 0010C7E0  90 7D 00 08 */	stw r3, 8(r29)
/* 801109A4 0010C7E4  38 60 00 01 */	li r3, 1
/* 801109A8 0010C7E8  80 1F 00 00 */	lwz r0, 0(r31)
...
/* 80110AA0 0010C8E0  88 64 00 04 */	lbz r3, 4(r4)
/* 80110AA4 0010C8E4  80 84 00 08 */	lwz r4, 8(r4)
/* 80110AA8 0010C8E8  48 00 C6 89 */	bl GetDataRefAddressImpl__Q44nw4r3snd6detail4UtilFQ54nw4r3snd6detail4Util7RefTypeUlPCv
/* 80110AAC 0010C8EC  2C 03 00 00 */	cmpwi r3, 0
/* 80110AB0 0010C8F0  40 82 00 0C */	bne lbl_80110ABC
/* 80110AB4 0010C8F4  38 60 00 00 */	li r3, 0
/* 80110AB8 0010C8F8  48 00 00 18 */	b lbl_80110AD0
lbl_80110ABC:
/* 80110ABC 0010C8FC  80 03 00 00 */	lwz r0, 0(r3)
/* 80110AC0 0010C900  90 1F 00 00 */	stw r0, 0(r31)
/* 80110AC4 0010C904  80 03 00 04 */	lwz r0, 4(r3)
/* 80110AC8 0010C908  38 60 00 01 */	li r3, 1
/* 80110ACC 0010C90C  90 1F 00 04 */	stw r0, 4(r31)
lbl_80110AD0:
...
/* 80110AF8 0010C938  2C 04 00 00 */	cmpwi r4, 0
...
/* 80110B20 0010C960  38 60 FF FF */	li r3, -1
/* 80110B24 0010C964  48 00 00 F8 */	b lbl_80110C1C
lbl_80110B28:
/* 80110B28 0010C968  80 64 00 00 */	lwz r3, 0(r4)
/* 80110B2C 0010C96C  80 04 00 04 */	lwz r0, 4(r4)
/* 80110B30 0010C970  7C 03 00 40 */	cmplw r3, r0
/* 80110B34 0010C974  41 80 00 0C */	blt lbl_80110B40
/* 80110B38 0010C978  38 60 FF FF */	li r3, -1
...
/* 80110B4C 0010C98C  3B E4 00 08 */	addi r31, r4, 8
/* 80110B50 0010C990  4B EF 5F 3D */	bl strlen
/* 80110B54 0010C994  38 A0 00 01 */	li r5, 1
/* 80110B58 0010C998  48 00 00 4C */	b lbl_80110BA4
/* 80110B5C 0010C99C  60 00 00 00 */	nop 
lbl_80110B60:
/* 80110B60 0010C9A0  A0 1F 00 02 */	lhz r0, 2(r31)
/* 80110B64 0010C9A4  7C 04 1E 70 */	srawi r4, r0, 3
/* 80110B68 0010C9A8  54 06 07 7E */	clrlwi r6, r0, 0x1d
...
/* 80110B78 0010C9B8  20 86 00 07 */	subfic r4, r6, 7
...
/* 80110BE8 0010CA28  80 03 00 04 */	lwz r0, 4(r3)
/* 80110BEC 0010CA2C  2C 00 00 00 */	cmpwi r0, 0
/* 80110BF0 0010CA30  40 82 00 0C */	bne lbl_80110BFC
/* 80110BF4 0010CA34  38 80 00 00 */	li r4, 0
...
/* 80110C08 0010CA48  2C 03 00 00 */	cmpwi r3, 0
...
lbl_80110C18:
/* 80110C18 0010CA58  38 60 FF FF */	li r3, -1
lbl_80110C1C:
...
/* 80110C3C 0010CA7C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global impl_GetSoundInfoOffset__Q44nw4r3snd6detail22SoundArchiveFileReaderCFUlPQ54nw4r3snd6detail4Util165DataRef$$0v$$4Q54nw4r3snd6detail16SoundArchiveFile12SeqSoundInfo$$4Q54nw4r3snd6detail16SoundArchiveFile13StrmSoundInfo$$4Q54nw4r3snd6detail16SoundArchiveFile13WaveSoundInfo$$1
impl_GetSoundInfoOffset__Q44nw4r3snd6detail22SoundArchiveFileReaderCFUlPQ54nw4r3snd6detail4Util165DataRef$$0v$$4Q54nw4r3snd6detail16SoundArchiveFile12SeqSoundInfo$$4Q54nw4r3snd6detail16SoundArchiveFile13StrmSoundInfo$$4Q54nw4r3snd6detail16SoundArchiveFile13WaveSoundInfo$$1:
...
/* 80110D00 0010CB40  38 60 00 01 */	li r3, 1
/* 80110D04 0010CB44  80 86 00 08 */	lwz r4, 8(r6)
/* 80110D08 0010CB48  88 A6 00 05 */	lbz r5, 5(r6)
/* 80110D0C 0010CB4C  88 06 00 04 */	lbz r0, 4(r6)
/* 80110D10 0010CB50  38 84 00 1C */	addi r4, r4, 0x1c
/* 80110D14 0010CB54  98 1F 00 00 */	stb r0, 0(r31)
/* 80110D18 0010CB58  98 BF 00 01 */	stb r5, 1(r31)
/* 80110D1C 0010CB5C  B0 FF 00 02 */	sth r7, 2(r31)
/* 80110D20 0010CB60  90 9F 00 04 */	stw r4, 4(r31)
lbl_80110D24:
