...
/* 80113BE4 0010FA24  93 E3 00 08 */	stw r31, 0x8(r3)
...
/* 80113C0C 0010FA4C  80 04 00 08 */	lwz r0, 0x8(r4)
/* 80113C10 0010FA50  7C 00 18 40 */	cmplw r0, r3
/* 80113C14 0010FA54  40 82 00 0C */	bne lbl_80113C20
/* 80113C18 0010FA58  38 00 00 00 */	li r0, 0x0
/* 80113C1C 0010FA5C  90 04 00 08 */	stw r0, 0x8(r4)
.global lbl_80113C20
lbl_80113C20:
/* 80113C20 0010FA60  80 83 00 00 */	lwz r4, 0x0(r3)
...
/* 80113C30 0010FA70  38 00 00 00 */	li r0, 0x0
/* 80113C34 0010FA74  90 04 00 0C */	stw r0, 0xc(r4)
.global lbl_80113C38
lbl_80113C38:
/* 80113C38 0010FA78  80 03 00 00 */	lwz r0, 0x0(r3)
/* 80113C3C 0010FA7C  2C 00 00 00 */	cmpwi r0, 0x0
/* 80113C40 0010FA80  4D 82 00 20 */	beqlr
/* 80113C44 0010FA84  38 00 00 00 */	li r0, 0x0
/* 80113C48 0010FA88  90 03 00 00 */	stw r0, 0x0(r3)
