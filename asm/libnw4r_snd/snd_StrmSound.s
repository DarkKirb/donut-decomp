...
.global lbl_80118AF0
lbl_80118AF0:
/* 80118AF0 00114930  D0 05 00 00 */	stfs f0, 0x0(r5)
/* 80118AF4 00114934  D0 05 00 04 */	stfs f0, 0x4(r5)
/* 80118AF8 00114938  90 85 00 08 */	stw r4, 0x8(r5)
...
/* 80118B10 00114950  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80118B24 00114964  00 00 00 00 */	.4byte 0x00000000
...
/* 80118B9C 001149DC  90 81 00 08 */	stw r4, 0x8(r1)
/* 80118BA0 001149E0  C0 7F 0E 30 */	lfs f3, 0xe30(r31)
/* 80118BA4 001149E4  C8 81 00 08 */	lfd f4, 0x8(r1)
...
/* 80118C08 00114A48  90 81 00 08 */	stw r4, 0x8(r1)
/* 80118C0C 00114A4C  C0 7F 0E 40 */	lfs f3, 0xe40(r31)
/* 80118C10 00114A50  C8 81 00 08 */	lfd f4, 0x8(r1)
...
/* 80118C3C 00114A7C  38 C6 00 01 */	addi r6, r6, 0x1
...
/* 80118C9C 00114ADC  81 83 00 00 */	lwz r12, 0x0(r3)
...
.global lbl_80118D38
lbl_80118D38:
/* 80118D38 00114B78  38 60 00 01 */	li r3, 0x1
.global lbl_80118D3C
lbl_80118D3C:
...
/* 80118D9C 00114BDC  38 03 00 01 */	addi r0, r3, 0x1
/* 80118DA0 00114BE0  90 1F 0E 3C */	stw r0, 0xe3c(r31)
.global lbl_80118DA4
lbl_80118DA4:
/* 80118DA4 00114BE4  3B DE 00 01 */	addi r30, r30, 0x1
/* 80118DA8 00114BE8  3B FF 00 10 */	addi r31, r31, 0x10
/* 80118DAC 00114BEC  2C 1E 00 08 */	cmpwi r30, 0x8
...
/* 80118DE8 00114C28  4B EE E5 55 */	bl _savegpr_27
...
/* 80118E4C 00114C8C  93 E1 00 08 */	stw r31, 0x8(r1)
/* 80118E50 00114C90  C0 5D 0E 30 */	lfs f2, 0xe30(r29)
/* 80118E54 00114C94  C8 61 00 08 */	lfd f3, 0x8(r1)
...
/* 80118E88 00114CC8  2C 1C 00 08 */	cmpwi r28, 0x8
/* 80118E8C 00114CCC  41 80 FF 7C */	blt lbl_80118E08
/* 80118E90 00114CD0  39 61 00 30 */	addi r11, r1, 0x30
/* 80118E94 00114CD4  E3 E1 00 38 */	psq_l f31, 0x38(r1), 0, qr0
/* 80118E98 00114CD8  CB E1 00 30 */	lfd f31, 0x30(r1)
/* 80118E9C 00114CDC  4B EE E4 ED */	bl _restgpr_27
...
/* 80118F68 00114DA8  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 80118F98 00114DD8  83 C1 00 08 */	lwz r30, 0x8(r1)
...
.global lbl_80118FEC
lbl_80118FEC:
/* 80118FEC 00114E2C  7C 80 FE 70 */	srawi r0, r4, 31
...
.global lbl_8011903C
lbl_8011903C:
/* 8011903C 00114E7C  7C A4 FE 70 */	srawi r4, r5, 31
...
/* 8011904C 00114E8C  80 63 00 00 */	lwz r3, 0x0(r3)
.global lbl_80119050
lbl_80119050:
...
.global lbl_80119058
lbl_80119058:
/* 80119058 00114E98  90 61 00 08 */	stw r3, 0x8(r1)
...
/* 80119094 00114ED4  00 00 00 00 */	.4byte 0x00000000
...
/* 801190AC 00114EEC  54 03 0F FE */	srwi r3, r0, 31
/* 801190B0 00114EF0  4E 80 00 20 */	blr
/* 801190B4 00114EF4  00 00 00 00 */	.4byte 0x00000000
...
.section .ctors, "wa"  # 0x80406260 - 0x80406540 ; 0x000002E0
	.4byte "__sinit_@@1snd_StrmSound_cpp"
.include "macros.inc"
