...
/* 80120668 0011C4A8  80 03 00 04 */	lwz r0, 4(r3)
/* 8012066C 0011C4AC  38 A0 00 00 */	li r5, 0
/* 80120670 0011C4B0  80 C3 00 00 */	lwz r6, 0(r3)
...
lbl_80120694:
/* 80120694 0011C4D4  38 C0 00 00 */	li r6, 0
...
lbl_801206B8:
/* 801206B8 0011C4F8  90 C3 00 04 */	stw r6, 4(r3)
lbl_801206BC:
/* 801206BC 0011C4FC  80 63 00 04 */	lwz r3, 4(r3)
/* 801206C0 0011C500  4E 80 00 20 */	blr 
/* 801206C4 0011C504  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 801206C8 0011C508  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 801206CC 0011C50C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global Seek__Q44nw4r2ut10FileStream12FilePositionFlUl
Seek__Q44nw4r2ut10FileStream12FilePositionFlUl:
/* 801206D0 0011C510  2C 05 00 00 */	cmpwi r5, 0
/* 801206D4 0011C514  41 82 00 10 */	beq lbl_801206E4
/* 801206D8 0011C518  28 05 00 02 */	cmplwi r5, 2
/* 801206DC 0011C51C  41 82 00 14 */	beq lbl_801206F0
/* 801206E0 0011C520  48 00 00 18 */	b lbl_801206F8
lbl_801206E4:
/* 801206E4 0011C524  38 00 00 00 */	li r0, 0
/* 801206E8 0011C528  90 03 00 04 */	stw r0, 4(r3)
/* 801206EC 0011C52C  48 00 00 0C */	b lbl_801206F8
lbl_801206F0:
/* 801206F0 0011C530  80 03 00 00 */	lwz r0, 0(r3)
/* 801206F4 0011C534  90 03 00 04 */	stw r0, 4(r3)
lbl_801206F8:
/* 801206F8 0011C538  2C 04 00 00 */	cmpwi r4, 0
/* 801206FC 0011C53C  4D 82 00 20 */	beqlr 
/* 80120700 0011C540  80 03 00 04 */	lwz r0, 4(r3)
/* 80120704 0011C544  38 A0 00 00 */	li r5, 0
/* 80120708 0011C548  80 C3 00 00 */	lwz r6, 0(r3)
...
lbl_8012072C:
/* 8012072C 0011C56C  38 C0 00 00 */	li r6, 0
...
lbl_80120750:
/* 80120750 0011C590  90 C3 00 04 */	stw r6, 4(r3)
/* 80120754 0011C594  4E 80 00 20 */	blr 
/* 80120758 0011C598  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8012075C 0011C59C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global __sinit_$$3ut_FileStream_cpp
__sinit_$$3ut_FileStream_cpp:
/* 80120760 0011C5A0  38 0D EC 48 */	addi r0, r13, typeInfo__Q34nw4r2ut8IOStream-_SDA_BASE_
/* 80120764 0011C5A4  90 0D EC 50 */	stw r0, typeInfo__Q34nw4r2ut10FileStream-_SDA_BASE_(r13)
