...
/* 80122324 0011E164  90 9F 00 00 */	stw r4, 0x0(r31)
...
/* 8012233C 0011E17C  00 00 00 00 */	.4byte 0x00000000
...
/* 80122348 0011E188  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80122384 0011E1C4  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80122398 0011E1D8  00 00 00 00 */	.4byte 0x00000000
/* 8012239C 0011E1DC  00 00 00 00 */	.4byte 0x00000000
...
/* 801223A8 0011E1E8  38 A0 00 00 */	li r5, 0x0
...
/* 801223F4 0011E234  2C 03 00 00 */	cmpwi r3, 0x0
/* 801223F8 0011E238  40 81 00 98 */	ble lbl_80122490
/* 801223FC 0011E23C  60 00 00 00 */	nop
.global lbl_80122400
lbl_80122400:
/* 80122400 0011E240  80 64 00 00 */	lwz r3, 0x0(r4)
...
/* 80122410 0011E250  38 A4 00 08 */	addi r5, r4, 0x8
/* 80122414 0011E254  48 00 00 7C */	b lbl_80122490
.global lbl_80122418
lbl_80122418:
/* 80122418 0011E258  80 04 00 04 */	lwz r0, 0x4(r4)
...
.global lbl_80122490
lbl_80122490:
/* 80122490 0011E2D0  2C 05 00 00 */	cmpwi r5, 0x0
/* 80122494 0011E2D4  40 82 00 0C */	bne lbl_801224A0
/* 80122498 0011E2D8  38 60 00 00 */	li r3, 0x0
...
/* 801224AC 0011E2EC  81 9E 00 00 */	lwz r12, 0x0(r30)
...
/* 801224F4 0011E334  00 00 00 00 */	.4byte 0x00000000
/* 801224F8 0011E338  00 00 00 00 */	.4byte 0x00000000
/* 801224FC 0011E33C  00 00 00 00 */	.4byte 0x00000000
...
/* 80122504 0011E344  38 C0 00 00 */	li r6, 0x0
/* 80122508 0011E348  38 E0 00 00 */	li r7, 0x0
/* 8012250C 0011E34C  7C A3 02 14 */	add r5, r3, r0
/* 80122510 0011E350  48 00 00 DC */	b lbl_801225EC
/* 80122514 0011E354  60 00 00 00 */	nop
.global lbl_80122518
lbl_80122518:
/* 80122518 0011E358  80 85 00 00 */	lwz r4, 0x0(r5)
...
/* 80122560 0011E3A0  38 C5 00 08 */	addi r6, r5, 0x8
...
/* 80122570 0011E3B0  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80122584 0011E3C4  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 801225AC 0011E3EC  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 801225C4 0011E404  2C 00 00 00 */	cmpwi r0, 0x0
...
.global lbl_801225D8
lbl_801225D8:
/* 801225D8 0011E418  38 60 00 00 */	li r3, 0x0
/* 801225DC 0011E41C  4E 80 00 20 */	blr
.global lbl_801225E0
lbl_801225E0:
/* 801225E0 0011E420  80 05 00 04 */	lwz r0, 0x4(r5)
/* 801225E4 0011E424  38 E7 00 01 */	addi r7, r7, 0x1
...
/* 801225F8 0011E438  3C 80 52 46 */	lis r4, 0x5246
/* 801225FC 0011E43C  38 04 4E 55 */	addi r0, r4, 0x4e55
/* 80122600 0011E440  90 03 00 00 */	stw r0, 0x0(r3)
