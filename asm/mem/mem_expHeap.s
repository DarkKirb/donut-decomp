...
/* 800A2AC0 0009E900  4B F6 48 79 */	bl func_80007338
/* 800A2AC4 0009E904  81 04 00 08 */	lwz r8, 8(r4)
/* 800A2AC8 0009E908  7F C6 2A 14 */	add r30, r6, r5
/* 800A2ACC 0009E90C  A0 C4 00 02 */	lhz r6, 2(r4)
/* 800A2AD0 0009E910  3B A5 FF F0 */	addi r29, r5, -16
/* 800A2AD4 0009E914  80 04 00 04 */	lwz r0, 4(r4)
/* 800A2AD8 0009E918  2C 08 00 00 */	cmpwi r8, 0
/* 800A2ADC 0009E91C  54 C9 C6 7E */	rlwinm r9, r6, 0x18, 0x19, 0x1f
...
lbl_800A2B0C:
/* 800A2B0C 0009E94C  91 43 00 00 */	stw r10, 0(r3)
lbl_800A2B10:
/* 800A2B10 0009E950  2C 0A 00 00 */	cmpwi r10, 0
/* 800A2B14 0009E954  41 82 00 0C */	beq lbl_800A2B20
/* 800A2B18 0009E958  91 0A 00 08 */	stw r8, 8(r10)
/* 800A2B1C 0009E95C  48 00 00 08 */	b lbl_800A2B24
lbl_800A2B20:
/* 800A2B20 0009E960  91 03 00 04 */	stw r8, 4(r3)
lbl_800A2B24:
...
/* 800A2B30 0009E970  2C 07 00 00 */	cmpwi r7, 0
/* 800A2B34 0009E974  40 82 00 18 */	bne lbl_800A2B4C
/* 800A2B38 0009E978  A0 03 00 12 */	lhz r0, 0x12(r3)
/* 800A2B3C 0009E97C  54 00 FF FF */	rlwinm. r0, r0, 0x1f, 0x1f, 0x1f
...
/* 800A2B50 0009E990  B0 05 00 00 */	sth r0, 0(r5)
/* 800A2B54 0009E994  38 80 00 00 */	li r4, 0
/* 800A2B58 0009E998  2C 08 00 00 */	cmpwi r8, 0
/* 800A2B5C 0009E99C  B0 85 00 02 */	sth r4, 2(r5)
/* 800A2B60 0009E9A0  38 05 00 10 */	addi r0, r5, 0x10
/* 800A2B64 0009E9A4  7C 00 E8 50 */	subf r0, r0, r29
/* 800A2B68 0009E9A8  90 05 00 04 */	stw r0, 4(r5)
/* 800A2B6C 0009E9AC  90 85 00 0C */	stw r4, 0xc(r5)
/* 800A2B70 0009E9B0  91 05 00 08 */	stw r8, 8(r5)
...
lbl_800A2B84:
/* 800A2B84 0009E9C4  80 83 00 00 */	lwz r4, 0(r3)
/* 800A2B88 0009E9C8  90 A3 00 00 */	stw r5, 0(r3)
lbl_800A2B8C:
/* 800A2B8C 0009E9CC  2C 04 00 00 */	cmpwi r4, 0
/* 800A2B90 0009E9D0  90 85 00 0C */	stw r4, 0xc(r5)
/* 800A2B94 0009E9D4  41 82 00 0C */	beq lbl_800A2BA0
/* 800A2B98 0009E9D8  90 A4 00 08 */	stw r5, 8(r4)
/* 800A2B9C 0009E9DC  48 00 00 08 */	b lbl_800A2BA4
lbl_800A2BA0:
/* 800A2BA0 0009E9E0  90 A3 00 04 */	stw r5, 4(r3)
lbl_800A2BA4:
...
/* 800A2BB4 0009E9F4  28 07 00 01 */	cmplwi r7, 1
/* 800A2BB8 0009E9F8  40 82 00 18 */	bne lbl_800A2BD0
/* 800A2BBC 0009E9FC  A0 03 00 12 */	lhz r0, 0x12(r3)
/* 800A2BC0 0009EA00  54 00 FF FF */	rlwinm. r0, r0, 0x1f, 0x1f, 0x1f
...
/* 800A2BD4 0009EA14  B0 1E 00 00 */	sth r0, 0(r30)
/* 800A2BD8 0009EA18  38 80 00 00 */	li r4, 0
/* 800A2BDC 0009EA1C  2C 08 00 00 */	cmpwi r8, 0
/* 800A2BE0 0009EA20  B0 9E 00 02 */	sth r4, 2(r30)
/* 800A2BE4 0009EA24  38 1E 00 10 */	addi r0, r30, 0x10
/* 800A2BE8 0009EA28  7C 00 30 50 */	subf r0, r0, r6
/* 800A2BEC 0009EA2C  90 1E 00 04 */	stw r0, 4(r30)
/* 800A2BF0 0009EA30  90 9E 00 0C */	stw r4, 0xc(r30)
/* 800A2BF4 0009EA34  91 1E 00 08 */	stw r8, 8(r30)
...
lbl_800A2C08:
/* 800A2C08 0009EA48  80 83 00 00 */	lwz r4, 0(r3)
/* 800A2C0C 0009EA4C  93 C3 00 00 */	stw r30, 0(r3)
lbl_800A2C10:
/* 800A2C10 0009EA50  2C 04 00 00 */	cmpwi r4, 0
/* 800A2C14 0009EA54  90 9E 00 0C */	stw r4, 0xc(r30)
/* 800A2C18 0009EA58  41 82 00 0C */	beq lbl_800A2C24
/* 800A2C1C 0009EA5C  93 C4 00 08 */	stw r30, 8(r4)
/* 800A2C20 0009EA60  48 00 00 08 */	b lbl_800A2C28
lbl_800A2C24:
/* 800A2C24 0009EA64  93 C3 00 04 */	stw r30, 4(r3)
lbl_800A2C28:
/* 800A2C28 0009EA68  80 03 FF FC */	lwz r0, -4(r3)
/* 800A2C2C 0009EA6C  7C BF F0 50 */	subf r5, r31, r30
/* 800A2C30 0009EA70  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 800A2C34 0009EA74  41 82 00 10 */	beq lbl_800A2C44
/* 800A2C38 0009EA78  7F E3 FB 78 */	mr r3, r31
/* 800A2C3C 0009EA7C  38 80 00 00 */	li r4, 0
/* 800A2C40 0009EA80  4B F6 17 11 */	bl memset
lbl_800A2C44:
/* 800A2C44 0009EA84  38 A0 00 00 */	li r5, 0
...
/* 800A2C5C 0009EA9C  53 83 7C 20 */	rlwimi r3, r28, 0xf, 0x10, 0x10
/* 800A2C60 0009EAA0  B0 DD 00 00 */	sth r6, 0(r29)
/* 800A2C64 0009EAA4  50 03 44 6E */	rlwimi r3, r0, 8, 0x11, 0x17
/* 800A2C68 0009EAA8  90 9D 00 04 */	stw r4, 4(r29)
/* 800A2C6C 0009EAAC  90 BD 00 08 */	stw r5, 8(r29)
/* 800A2C70 0009EAB0  90 BD 00 0C */	stw r5, 0xc(r29)
/* 800A2C74 0009EAB4  B0 7D 00 02 */	sth r3, 2(r29)
/* 800A2C78 0009EAB8  A0 1A 00 10 */	lhz r0, 0x10(r26)
/* 800A2C7C 0009EABC  50 03 06 3E */	rlwimi r3, r0, 0, 0x18, 0x1f
/* 800A2C80 0009EAC0  B0 7D 00 02 */	sth r3, 2(r29)
/* 800A2C84 0009EAC4  80 9A 00 0C */	lwz r4, 0xc(r26)
/* 800A2C88 0009EAC8  90 9D 00 08 */	stw r4, 8(r29)
/* 800A2C8C 0009EACC  2C 04 00 00 */	cmpwi r4, 0
...
lbl_800A2CA0:
/* 800A2CA0 0009EAE0  80 7A 00 08 */	lwz r3, 8(r26)
/* 800A2CA4 0009EAE4  93 BA 00 08 */	stw r29, 8(r26)
lbl_800A2CA8:
/* 800A2CA8 0009EAE8  2C 03 00 00 */	cmpwi r3, 0
/* 800A2CAC 0009EAEC  90 7D 00 0C */	stw r3, 0xc(r29)
/* 800A2CB0 0009EAF0  41 82 00 0C */	beq lbl_800A2CBC
/* 800A2CB4 0009EAF4  93 A3 00 08 */	stw r29, 8(r3)
...
/* 800A2CC8 0009EB08  4B F6 46 BD */	bl func_80007384
...
/* 800A2CDC 0009EB1C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800A2CF4 0009EB34  38 05 FF FF */	addi r0, r5, -1
/* 800A2CF8 0009EB38  7C 09 00 F8 */	nor r9, r0, r0
/* 800A2CFC 0009EB3C  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 800A2D00 0009EB40  3B E0 00 00 */	li r31, 0
/* 800A2D04 0009EB44  93 C1 00 18 */	stw r30, 0x18(r1)
/* 800A2D08 0009EB48  3B C0 FF FF */	li r30, -1
/* 800A2D0C 0009EB4C  93 A1 00 14 */	stw r29, 0x14(r1)
/* 800A2D10 0009EB50  3B A0 00 00 */	li r29, 0
/* 800A2D14 0009EB54  A0 E3 00 12 */	lhz r7, 0x12(r3)
/* 800A2D18 0009EB58  81 83 00 00 */	lwz r12, 0(r3)
/* 800A2D1C 0009EB5C  54 E0 07 FE */	clrlwi r0, r7, 0x1f
...
/* 800A2D30 0009EB70  81 4C 00 04 */	lwz r10, 4(r12)
/* 800A2D34 0009EB74  7C E5 42 14 */	add r7, r5, r8
/* 800A2D38 0009EB78  38 07 FF FF */	addi r0, r7, -1
...
/* 800A2D58 0009EB98  2C 0B 00 00 */	cmpwi r11, 0
...
lbl_800A2D78:
/* 800A2D78 0009EBB8  2C 0C 00 00 */	cmpwi r12, 0
/* 800A2D7C 0009EBBC  40 82 FF B0 */	bne lbl_800A2D2C
lbl_800A2D80:
/* 800A2D80 0009EBC0  2C 1F 00 00 */	cmpwi r31, 0
...
/* 800A2DBC 0009EBFC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800A2DD4 0009EC14  38 05 FF FF */	addi r0, r5, -1
/* 800A2DD8 0009EC18  7C 08 00 F8 */	nor r8, r0, r0
/* 800A2DDC 0009EC1C  39 80 00 00 */	li r12, 0
/* 800A2DE0 0009EC20  93 E1 00 0C */	stw r31, 0xc(r1)
/* 800A2DE4 0009EC24  3B E0 FF FF */	li r31, -1
/* 800A2DE8 0009EC28  93 C1 00 08 */	stw r30, 8(r1)
/* 800A2DEC 0009EC2C  A0 A3 00 12 */	lhz r5, 0x12(r3)
/* 800A2DF0 0009EC30  81 63 00 04 */	lwz r11, 4(r3)
/* 800A2DF4 0009EC34  54 A0 07 FE */	clrlwi r0, r5, 0x1f
/* 800A2DF8 0009EC38  38 A0 00 00 */	li r5, 0
...
lbl_800A2E08:
/* 800A2E08 0009EC48  81 2B 00 04 */	lwz r9, 4(r11)
...
/* 800A2E2C 0009EC6C  2C 0A 00 00 */	cmpwi r10, 0
...
lbl_800A2E48:
/* 800A2E48 0009EC88  81 6B 00 08 */	lwz r11, 8(r11)
lbl_800A2E4C:
/* 800A2E4C 0009EC8C  2C 0B 00 00 */	cmpwi r11, 0
/* 800A2E50 0009EC90  40 82 FF B8 */	bne lbl_800A2E08
lbl_800A2E54:
/* 800A2E54 0009EC94  2C 0C 00 00 */	cmpwi r12, 0
/* 800A2E58 0009EC98  41 82 00 14 */	beq lbl_800A2E6C
/* 800A2E5C 0009EC9C  7D 84 63 78 */	mr r4, r12
/* 800A2E60 0009ECA0  38 E0 00 01 */	li r7, 1
/* 800A2E64 0009ECA4  4B FF FC 4D */	bl AllocUsedBlockFromFreeBlock_
/* 800A2E68 0009ECA8  48 00 00 08 */	b lbl_800A2E70
lbl_800A2E6C:
/* 800A2E6C 0009ECAC  38 60 00 00 */	li r3, 0
lbl_800A2E70:
/* 800A2E70 0009ECB0  80 01 00 14 */	lwz r0, 0x14(r1)
/* 800A2E74 0009ECB4  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 800A2E78 0009ECB8  83 C1 00 08 */	lwz r30, 8(r1)
/* 800A2E7C 0009ECBC  7C 08 03 A6 */	mtlr r0
/* 800A2E80 0009ECC0  38 21 00 10 */	addi r1, r1, 0x10
/* 800A2E84 0009ECC4  4E 80 00 20 */	blr 
/* 800A2E88 0009ECC8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800A2E8C 0009ECCC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global RecycleRegion_
RecycleRegion_:
/* 800A2E90 0009ECD0  94 21 FF F0 */	stwu r1, -0x10(r1)
/* 800A2E94 0009ECD4  39 00 00 00 */	li r8, 0
/* 800A2E98 0009ECD8  80 A4 00 00 */	lwz r5, 0(r4)
/* 800A2E9C 0009ECDC  80 04 00 04 */	lwz r0, 4(r4)
/* 800A2EA0 0009ECE0  90 A1 00 08 */	stw r5, 8(r1)
/* 800A2EA4 0009ECE4  80 C3 00 00 */	lwz r6, 0(r3)
/* 800A2EA8 0009ECE8  90 01 00 0C */	stw r0, 0xc(r1)
/* 800A2EAC 0009ECEC  48 00 00 6C */	b lbl_800A2F18
lbl_800A2EB0:
/* 800A2EB0 0009ECF0  80 04 00 00 */	lwz r0, 0(r4)
...
lbl_800A2EC4:
/* 800A2EC4 0009ED04  80 04 00 04 */	lwz r0, 4(r4)
/* 800A2EC8 0009ED08  7C 06 00 40 */	cmplw r6, r0
/* 800A2ECC 0009ED0C  40 82 00 54 */	bne lbl_800A2F20
/* 800A2ED0 0009ED10  80 06 00 04 */	lwz r0, 4(r6)
/* 800A2ED4 0009ED14  80 E6 00 08 */	lwz r7, 8(r6)
...
/* 800A2EE4 0009ED24  2C 07 00 00 */	cmpwi r7, 0
...
lbl_800A2EF8:
/* 800A2EF8 0009ED38  90 C3 00 00 */	stw r6, 0(r3)
lbl_800A2EFC:
/* 800A2EFC 0009ED3C  2C 06 00 00 */	cmpwi r6, 0
/* 800A2F00 0009ED40  41 82 00 0C */	beq lbl_800A2F0C
/* 800A2F04 0009ED44  90 E6 00 08 */	stw r7, 8(r6)
/* 800A2F08 0009ED48  48 00 00 18 */	b lbl_800A2F20
lbl_800A2F0C:
/* 800A2F0C 0009ED4C  90 E3 00 04 */	stw r7, 4(r3)
/* 800A2F10 0009ED50  48 00 00 10 */	b lbl_800A2F20
lbl_800A2F14:
/* 800A2F14 0009ED54  80 C6 00 0C */	lwz r6, 0xc(r6)
lbl_800A2F18:
/* 800A2F18 0009ED58  2C 06 00 00 */	cmpwi r6, 0
/* 800A2F1C 0009ED5C  40 82 FF 94 */	bne lbl_800A2EB0
lbl_800A2F20:
/* 800A2F20 0009ED60  2C 08 00 00 */	cmpwi r8, 0
/* 800A2F24 0009ED64  41 82 00 54 */	beq lbl_800A2F78
/* 800A2F28 0009ED68  80 A8 00 04 */	lwz r5, 4(r8)
/* 800A2F2C 0009ED6C  80 04 00 00 */	lwz r0, 0(r4)
...
/* 800A2F40 0009ED80  80 A8 00 08 */	lwz r5, 8(r8)
/* 800A2F44 0009ED84  91 01 00 08 */	stw r8, 8(r1)
/* 800A2F48 0009ED88  2C 05 00 00 */	cmpwi r5, 0
...
lbl_800A2F5C:
/* 800A2F5C 0009ED9C  90 83 00 00 */	stw r4, 0(r3)
lbl_800A2F60:
/* 800A2F60 0009EDA0  2C 04 00 00 */	cmpwi r4, 0
/* 800A2F64 0009EDA4  41 82 00 0C */	beq lbl_800A2F70
/* 800A2F68 0009EDA8  90 A4 00 08 */	stw r5, 8(r4)
/* 800A2F6C 0009EDAC  48 00 00 08 */	b lbl_800A2F74
lbl_800A2F70:
/* 800A2F70 0009EDB0  90 A3 00 04 */	stw r5, 4(r3)
lbl_800A2F74:
/* 800A2F74 0009EDB4  7C A8 2B 78 */	mr r8, r5
lbl_800A2F78:
/* 800A2F78 0009EDB8  80 C1 00 0C */	lwz r6, 0xc(r1)
/* 800A2F7C 0009EDBC  80 A1 00 08 */	lwz r5, 8(r1)
...
/* 800A2F8C 0009EDCC  38 60 00 00 */	li r3, 0
/* 800A2F90 0009EDD0  48 00 00 60 */	b lbl_800A2FF0
lbl_800A2F94:
/* 800A2F94 0009EDD4  38 00 46 52 */	li r0, 0x4652
/* 800A2F98 0009EDD8  B0 05 00 00 */	sth r0, 0(r5)
/* 800A2F9C 0009EDDC  38 80 00 00 */	li r4, 0
/* 800A2FA0 0009EDE0  2C 08 00 00 */	cmpwi r8, 0
/* 800A2FA4 0009EDE4  B0 85 00 02 */	sth r4, 2(r5)
/* 800A2FA8 0009EDE8  38 05 00 10 */	addi r0, r5, 0x10
/* 800A2FAC 0009EDEC  7C 00 30 50 */	subf r0, r0, r6
/* 800A2FB0 0009EDF0  90 05 00 04 */	stw r0, 4(r5)
/* 800A2FB4 0009EDF4  90 85 00 0C */	stw r4, 0xc(r5)
/* 800A2FB8 0009EDF8  91 05 00 08 */	stw r8, 8(r5)
...
lbl_800A2FCC:
/* 800A2FCC 0009EE0C  80 83 00 00 */	lwz r4, 0(r3)
/* 800A2FD0 0009EE10  90 A3 00 00 */	stw r5, 0(r3)
lbl_800A2FD4:
/* 800A2FD4 0009EE14  2C 04 00 00 */	cmpwi r4, 0
/* 800A2FD8 0009EE18  90 85 00 0C */	stw r4, 0xc(r5)
/* 800A2FDC 0009EE1C  41 82 00 0C */	beq lbl_800A2FE8
/* 800A2FE0 0009EE20  90 A4 00 08 */	stw r5, 8(r4)
/* 800A2FE4 0009EE24  48 00 00 08 */	b lbl_800A2FEC
lbl_800A2FE8:
/* 800A2FE8 0009EE28  90 A3 00 04 */	stw r5, 4(r3)
lbl_800A2FEC:
/* 800A2FEC 0009EE2C  38 60 00 01 */	li r3, 1
lbl_800A2FF0:
/* 800A2FF0 0009EE30  38 21 00 10 */	addi r1, r1, 0x10
/* 800A2FF4 0009EE34  4E 80 00 20 */	blr 
/* 800A2FF8 0009EE38  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800A2FFC 0009EE3C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800A3010 0009EE50  38 03 00 03 */	addi r0, r3, 3
/* 800A3014 0009EE54  54 86 00 3A */	rlwinm r6, r4, 0, 0, 0x1d
/* 800A3018 0009EE58  93 E1 00 0C */	stw r31, 0xc(r1)
/* 800A301C 0009EE5C  54 1F 00 3A */	rlwinm r31, r0, 0, 0, 0x1d
...
lbl_800A3034:
/* 800A3034 0009EE74  38 60 00 00 */	li r3, 0
/* 800A3038 0009EE78  48 00 00 64 */	b lbl_800A309C
lbl_800A303C:
/* 800A303C 0009EE7C  3C 80 45 58 */	lis r4, 0x45585048@ha
...
/* 800A304C 0009EE8C  38 84 50 48 */	addi r4, r4, 0x45585048@l
/* 800A3050 0009EE90  4B FF F7 31 */	bl MEMiInitHeapHead
/* 800A3054 0009EE94  38 A0 00 00 */	li r5, 0
...
/* 800A3074 0009EEB4  B0 86 00 00 */	sth r4, 0(r6)
/* 800A3078 0009EEB8  7C 00 38 50 */	subf r0, r0, r7
/* 800A307C 0009EEBC  B0 A6 00 02 */	sth r5, 2(r6)
/* 800A3080 0009EEC0  90 06 00 04 */	stw r0, 4(r6)
/* 800A3084 0009EEC4  90 A6 00 08 */	stw r5, 8(r6)
...
/* 800A30E8 0009EF28  2C 04 00 00 */	cmpwi r4, 0
...
/* 800A310C 0009EF4C  3B C0 00 01 */	li r30, 1
lbl_800A3110:
/* 800A3110 0009EF50  80 03 00 38 */	lwz r0, 0x38(r3)
/* 800A3114 0009EF54  38 9E 00 03 */	addi r4, r30, 3
/* 800A3118 0009EF58  54 9E 00 3A */	rlwinm r30, r4, 0, 0, 0x1d
/* 800A311C 0009EF5C  54 00 07 7B */	rlwinm. r0, r0, 0, 0x1d, 0x1d
...
lbl_800A312C:
/* 800A312C 0009EF6C  2C 1F 00 00 */	cmpwi r31, 0
...
/* 800A3160 0009EFA0  54 00 07 7B */	rlwinm. r0, r0, 0, 0x1d, 0x1d
...
/* 800A3198 0009EFD8  2C 04 00 00 */	cmpwi r4, 0
...
/* 800A31B8 0009EFF8  54 00 07 7B */	rlwinm. r0, r0, 0, 0x1d, 0x1d
...
/* 800A31CC 0009F00C  38 DF FF F0 */	addi r6, r31, -16
/* 800A31D0 0009F010  38 7E 00 3C */	addi r3, r30, 0x3c
/* 800A31D4 0009F014  54 00 C6 7E */	rlwinm r0, r0, 0x18, 0x19, 0x1f
/* 800A31D8 0009F018  7C 00 30 50 */	subf r0, r0, r6
/* 800A31DC 0009F01C  90 01 00 08 */	stw r0, 8(r1)
...
/* 800A31F0 0009F030  80 BF FF F8 */	lwz r5, -8(r31)
/* 800A31F4 0009F034  80 9F FF FC */	lwz r4, -4(r31)
/* 800A31F8 0009F038  2C 05 00 00 */	cmpwi r5, 0
...
/* 800A3254 0009F094  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800A3258 0009F098  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800A325C 0009F09C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800A3270 0009F0B0  3B E0 00 00 */	li r31, 0
/* 800A3274 0009F0B4  93 C1 00 08 */	stw r30, 8(r1)
/* 800A3278 0009F0B8  7C 7E 1B 78 */	mr r30, r3
/* 800A327C 0009F0BC  80 03 00 38 */	lwz r0, 0x38(r3)
/* 800A3280 0009F0C0  54 00 07 7B */	rlwinm. r0, r0, 0, 0x1d, 0x1d
...
/* 800A32C8 0009F108  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 800A32DC 0009F11C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
