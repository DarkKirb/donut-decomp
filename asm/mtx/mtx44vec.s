...
PSMTX44MultVec:
/* 800314F0 0002D330  E0 04 00 00 */	psq_l f0, 0(r4), 0, qr0
/* 800314F4 0002D334  E0 43 00 30 */	psq_l f2, 48(r3), 0, qr0
/* 800314F8 0002D338  E0 24 80 08 */	psq_l f1, 8(r4), 1, qr0
/* 800314FC 0002D33C  10 80 00 B2 */	ps_mul f4, f0, f2
/* 80031500 0002D340  E0 63 00 38 */	psq_l f3, 56(r3), 0, qr0
...
/* 80031510 0002D350  E0 83 00 00 */	psq_l f4, 0(r3), 0, qr0
/* 80031514 0002D354  11 AD 6C 20 */	ps_merge00 f13, f13, f13
/* 80031518 0002D358  E0 A3 00 08 */	psq_l f5, 8(r3), 0, qr0
/* 8003151C 0002D35C  11 AC 68 24 */	vmsumubm v13, v12, v13, v0
/* 80031520 0002D360  E0 C3 00 10 */	psq_l f6, 16(r3), 0, qr0
/* 80031524 0002D364  E0 E3 00 18 */	psq_l f7, 24(r3), 0, qr0
/* 80031528 0002D368  E1 03 00 20 */	psq_l f8, 32(r3), 0, qr0
/* 8003152C 0002D36C  E1 23 00 28 */	psq_l f9, 40(r3), 0, qr0
...
/* 80031558 0002D398  F0 45 00 00 */	psq_st f2, 0(r5), 0, qr0
/* 8003155C 0002D39C  10 63 03 72 */	ps_mul f3, f3, f13
/* 80031560 0002D3A0  F0 65 80 08 */	psq_st f3, 8(r5), 1, qr0
/* 80031564 0002D3A4  4E 80 00 20 */	blr 
/* 80031568 0002D3A8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8003156C 0002D3AC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
