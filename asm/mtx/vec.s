...
/* 80031574 0002D3B4  E0 84 00 00 */	psq_l f4, 0(r4), 0, qr0
/* 80031578 0002D3B8  10 C2 20 2A */	ps_add f6, f2, f4
/* 8003157C 0002D3BC  F0 C5 00 00 */	psq_st f6, 0(r5), 0, qr0
/* 80031580 0002D3C0  E0 63 80 08 */	psq_l f3, 8(r3), 1, qr0
/* 80031584 0002D3C4  E0 A4 80 08 */	psq_l f5, 8(r4), 1, qr0
/* 80031588 0002D3C8  10 E3 28 2A */	ps_add f7, f3, f5
/* 8003158C 0002D3CC  F0 E5 80 08 */	psq_st f7, 8(r5), 1, qr0
/* 80031590 0002D3D0  4E 80 00 20 */	blr 
/* 80031594 0002D3D4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80031598 0002D3D8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8003159C 0002D3DC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global PSVECNormalize
PSVECNormalize:
/* 800315A0 0002D3E0  E0 43 00 00 */	psq_l f2, 0(r3), 0, qr0
/* 800315A4 0002D3E4  E0 63 80 08 */	psq_l f3, 8(r3), 1, qr0
/* 800315A8 0002D3E8  10 A2 00 B2 */	ps_mul f5, f2, f2
/* 800315AC 0002D3EC  C0 02 85 E8 */	lfs f0, $$21414-_SDA2_BASE_(r2)
/* 800315B0 0002D3F0  C0 22 85 EC */	lfs f1, $$21415-_SDA2_BASE_(r2)
...
/* 800315D8 0002D418  F0 44 00 00 */	psq_st f2, 0(r4), 0, qr0
/* 800315DC 0002D41C  F0 64 80 08 */	psq_st f3, 8(r4), 1, qr0
/* 800315E0 0002D420  4E 80 00 20 */	blr 
/* 800315E4 0002D424  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800315E8 0002D428  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800315EC 0002D42C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global PSVECMag
PSVECMag:
/* 800315F0 0002D430  E0 03 00 00 */	psq_l f0, 0(r3), 0, qr0
/* 800315F4 0002D434  C0 82 85 E8 */	lfs f4, $$21414-_SDA2_BASE_(r2)
/* 800315F8 0002D438  10 00 00 32 */	ps_mul f0, f0, f0
/* 800315FC 0002D43C  C0 23 00 08 */	lfs f1, 8(r3)
...
/* 80031618 0002D458  C0 62 85 EC */	lfs f3, $$21415-_SDA2_BASE_(r2)
...
/* 80031634 0002D474  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80031638 0002D478  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8003163C 0002D47C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global PSVECDotProduct
PSVECDotProduct:
/* 80031640 0002D480  E0 43 00 04 */	psq_l f2, 4(r3), 0, qr0
/* 80031644 0002D484  E0 64 00 04 */	psq_l f3, 4(r4), 0, qr0
/* 80031648 0002D488  10 42 00 F2 */	ps_mul f2, f2, f3
/* 8003164C 0002D48C  E0 A3 00 00 */	psq_l f5, 0(r3), 0, qr0
/* 80031650 0002D490  E0 84 00 00 */	psq_l f4, 0(r4), 0, qr0
...
PSVECCrossProduct:
/* 80031660 0002D4A0  E0 24 00 00 */	psq_l f1, 0(r4), 0, qr0
/* 80031664 0002D4A4  C0 43 00 08 */	lfs f2, 8(r3)
/* 80031668 0002D4A8  E0 03 00 00 */	psq_l f0, 0(r3), 0, qr0
/* 8003166C 0002D4AC  10 C1 0C A0 */	ps_merge10 f6, f1, f1
/* 80031670 0002D4B0  C0 64 00 08 */	lfs f3, 8(r4)
...
/* 8003168C 0002D4CC  F1 25 80 00 */	psq_st f9, 0(r5), 1, qr0
/* 80031690 0002D4D0  11 40 50 50 */	ps_neg f10, f10
/* 80031694 0002D4D4  F1 45 00 04 */	psq_st f10, 4(r5), 0, qr0
/* 80031698 0002D4D8  4E 80 00 20 */	blr 
/* 8003169C 0002D4DC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global C_VECHalfAngle
C_VECHalfAngle:
/* 800316A0 0002D4E0  94 21 FF C0 */	stwu r1, -0x40(r1)
/* 800316A4 0002D4E4  7C 08 02 A6 */	mflr r0
/* 800316A8 0002D4E8  C0 43 00 00 */	lfs f2, 0(r3)
/* 800316AC 0002D4EC  C0 23 00 04 */	lfs f1, 4(r3)
/* 800316B0 0002D4F0  C0 03 00 08 */	lfs f0, 8(r3)
...
/* 8003171C 0002D55C  38 A1 00 08 */	addi r5, r1, 8
/* 80031720 0002D560  4B FF FE 51 */	bl PSVECAdd
/* 80031724 0002D564  38 61 00 08 */	addi r3, r1, 8
/* 80031728 0002D568  7C 64 1B 78 */	mr r4, r3
/* 8003172C 0002D56C  4B FF FF 15 */	bl PSVECDotProduct
/* 80031730 0002D570  C0 02 85 F0 */	lfs f0, $$21443-_SDA2_BASE_(r2)
...
/* 80031740 0002D580  38 61 00 08 */	addi r3, r1, 8
/* 80031744 0002D584  4B FF FE 5D */	bl PSVECNormalize
/* 80031748 0002D588  48 00 00 1C */	b lbl_80031764
lbl_8003174C:
/* 8003174C 0002D58C  80 61 00 08 */	lwz r3, 8(r1)
/* 80031750 0002D590  80 01 00 0C */	lwz r0, 0xc(r1)
/* 80031754 0002D594  90 1F 00 04 */	stw r0, 4(r31)
/* 80031758 0002D598  90 7F 00 00 */	stw r3, 0(r31)
/* 8003175C 0002D59C  80 01 00 10 */	lwz r0, 0x10(r1)
/* 80031760 0002D5A0  90 1F 00 08 */	stw r0, 8(r31)
lbl_80031764:
...
/* 80031778 0002D5B8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8003177C 0002D5BC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global PSVECSquareDistance
PSVECSquareDistance:
/* 80031780 0002D5C0  E0 03 00 04 */	psq_l f0, 4(r3), 0, qr0
/* 80031784 0002D5C4  E0 24 00 04 */	psq_l f1, 4(r4), 0, qr0
/* 80031788 0002D5C8  E0 43 00 00 */	psq_l f2, 0(r3), 0, qr0
/* 8003178C 0002D5CC  10 60 08 28 */	ps_sub f3, f0, f1
/* 80031790 0002D5D0  E0 04 00 00 */	psq_l f0, 0(r4), 0, qr0
