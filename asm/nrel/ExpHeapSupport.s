...
/* 8014D08C 00148ECC  80 1F 00 04 */	lwz r0, 0x4(r31)
...
/* 8014D0B8 00148EF8  4B EB A2 8D */	bl lbl_80007344
/* 8014D0BC 00148EFC  7C 7D 1B 78 */	mr r29, r3
/* 8014D0C0 00148F00  7C 9E 23 78 */	mr r30, r4
/* 8014D0C4 00148F04  A0 04 00 02 */	lhz r0, 0x2(r4)
/* 8014D0C8 00148F08  54 00 C6 7E */	extrwi r0, r0, 7, 17
...
/* 8014D110 00148F50  54 00 06 3E */	clrlwi r0, r0, 24
/* 8014D114 00148F54  54 03 07 7A */	rlwinm r3, r0, 0, 29, 29
/* 8014D118 00148F58  30 03 FF FF */	addic r0, r3, -0x1
...
/* 8014D13C 00148F7C  2C 03 00 00 */	cmpwi r3, 0x0
/* 8014D140 00148F80  40 82 00 20 */	bne lbl_8014D160
/* 8014D144 00148F84  3C 60 80 44 */	lis r3, "@789"@ha
/* 8014D148 00148F88  38 63 75 E8 */	addi r3, r3, "@789"@l
/* 8014D14C 00148F8C  38 80 00 54 */	li r4, 0x54
/* 8014D150 00148F90  3C A0 80 44 */	lis r5, "@790"@ha
/* 8014D154 00148F94  38 A5 75 FC */	addi r5, r5, "@790"@l
/* 8014D158 00148F98  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 8014D190 00148FD0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8014D1D0 00149010  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8014D1F8 00149038  00 00 00 00 */	.4byte 0x00000000
/* 8014D1FC 0014903C  00 00 00 00 */	.4byte 0x00000000
.include "macros.inc"
