...
/* 8014C314 00148154  C0 22 95 E8 */	lfs f1, $$2795-_SDA2_BASE_(r2)
/* 8014C318 00148158  FC 40 08 90 */	fmr f2, f1
/* 8014C31C 0014815C  C0 62 95 EC */	lfs f3, $$2796-_SDA2_BASE_(r2)
/* 8014C320 00148160  C0 82 95 F0 */	lfs f4, $$2797-_SDA2_BASE_(r2)
/* 8014C324 00148164  FC A0 08 90 */	fmr f5, f1
/* 8014C328 00148168  C0 C2 95 F4 */	lfs f6, $$2798-_SDA2_BASE_(r2)
/* 8014C32C 0014816C  48 00 01 15 */	bl create__Q34nrel8ezrender18OrthoCameraSettingFffffff
/* 8014C330 00148170  38 BF FF FC */	addi r5, r31, -4
/* 8014C334 00148174  38 81 00 1C */	addi r4, r1, 0x1c
/* 8014C338 00148178  38 00 00 03 */	li r0, 3
/* 8014C33C 0014817C  7C 09 03 A6 */	mtctr r0
lbl_8014C340:
/* 8014C340 00148180  80 64 00 04 */	lwz r3, 4(r4)
/* 8014C344 00148184  84 04 00 08 */	lwzu r0, 8(r4)
/* 8014C348 00148188  90 65 00 04 */	stw r3, 4(r5)
/* 8014C34C 0014818C  94 05 00 08 */	stwu r0, 8(r5)
/* 8014C350 00148190  42 00 FF F0 */	bdnz lbl_8014C340
/* 8014C354 00148194  38 61 00 08 */	addi r3, r1, 8
/* 8014C358 00148198  C0 22 95 E8 */	lfs f1, $$2795-_SDA2_BASE_(r2)
/* 8014C35C 0014819C  FC 40 08 90 */	fmr f2, f1
/* 8014C360 001481A0  C0 62 95 EC */	lfs f3, $$2796-_SDA2_BASE_(r2)
/* 8014C364 001481A4  C0 82 95 F0 */	lfs f4, $$2797-_SDA2_BASE_(r2)
/* 8014C368 001481A8  FC A0 08 90 */	fmr f5, f1
/* 8014C36C 001481AC  C0 C2 95 F4 */	lfs f6, $$2798-_SDA2_BASE_(r2)
...
/* 8014C378 001481B8  38 81 00 04 */	addi r4, r1, 4
/* 8014C37C 001481BC  38 00 00 03 */	li r0, 3
/* 8014C380 001481C0  7C 09 03 A6 */	mtctr r0
lbl_8014C384:
/* 8014C384 001481C4  80 64 00 04 */	lwz r3, 4(r4)
/* 8014C388 001481C8  84 04 00 08 */	lwzu r0, 8(r4)
/* 8014C38C 001481CC  90 65 00 04 */	stw r3, 4(r5)
/* 8014C390 001481D0  94 05 00 08 */	stwu r0, 8(r5)
...
/* 8014C3B0 001481F0  38 A3 FF FC */	addi r5, r3, -4
/* 8014C3B4 001481F4  38 84 FF FC */	addi r4, r4, -4
/* 8014C3B8 001481F8  38 00 00 03 */	li r0, 3
/* 8014C3BC 001481FC  7C 09 03 A6 */	mtctr r0
lbl_8014C3C0:
/* 8014C3C0 00148200  80 64 00 04 */	lwz r3, 4(r4)
/* 8014C3C4 00148204  84 04 00 08 */	lwzu r0, 8(r4)
/* 8014C3C8 00148208  90 65 00 04 */	stw r3, 4(r5)
/* 8014C3CC 0014820C  94 05 00 08 */	stwu r0, 8(r5)
...
/* 8014C3DC 0014821C  C0 04 00 00 */	lfs f0, 0(r4)
/* 8014C3E0 00148220  D0 03 00 00 */	stfs f0, 0(r3)
/* 8014C3E4 00148224  C0 04 00 04 */	lfs f0, 4(r4)
/* 8014C3E8 00148228  D0 03 00 04 */	stfs f0, 4(r3)
/* 8014C3EC 0014822C  C0 04 00 08 */	lfs f0, 8(r4)
/* 8014C3F0 00148230  D0 03 00 08 */	stfs f0, 8(r3)
...
/* 8014C410 00148250  38 A3 FF FC */	addi r5, r3, -4
/* 8014C414 00148254  38 84 00 14 */	addi r4, r4, 0x14
/* 8014C418 00148258  38 00 00 03 */	li r0, 3
/* 8014C41C 0014825C  7C 09 03 A6 */	mtctr r0
lbl_8014C420:
/* 8014C420 00148260  80 64 00 04 */	lwz r3, 4(r4)
/* 8014C424 00148264  84 04 00 08 */	lwzu r0, 8(r4)
/* 8014C428 00148268  90 65 00 04 */	stw r3, 4(r5)
/* 8014C42C 0014826C  94 05 00 08 */	stwu r0, 8(r5)
