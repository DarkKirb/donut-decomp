...
/* 8001D9C4 00019804  38 01 00 08 */	addi r0, r1, 8
...
/* 8001D9D4 00019814  90 61 00 08 */	stw r3, 8(r1)
...
/* 8001DA14 00019854  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8001DA18 00019858  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8001DA1C 0001985C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8001DA4C 0001988C  57 A0 13 BA */	rlwinm r0, r29, 2, 0xe, 0x1d
...
/* 8001DA7C 000198BC  2C 1C 00 00 */	cmpwi r28, 0
/* 8001DA80 000198C0  41 82 01 9C */	beq lbl_8001DC1C
/* 8001DA84 000198C4  3C A0 80 00 */	lis r5, 0x800000DC@ha
/* 8001DA88 000198C8  3C 80 60 06 */	lis r4, 0x6005F8FF@ha
/* 8001DA8C 000198CC  81 25 00 DC */	lwz r9, 0x800000DC@l(r5)
/* 8001DA90 000198D0  38 A4 F8 FF */	addi r5, r4, 0x6005F8FF@l
/* 8001DA94 000198D4  39 00 FF FF */	li r8, -1
/* 8001DA98 000198D8  38 E0 00 04 */	li r7, 4
/* 8001DA9C 000198DC  38 00 00 02 */	li r0, 2
...
/* 8001DAB8 000198F8  54 C4 07 FF */	clrlwi. r4, r6, 0x1f
/* 8001DABC 000198FC  40 82 01 28 */	bne lbl_8001DBE4
/* 8001DAC0 00019900  60 C4 00 01 */	ori r4, r6, 1
...
lbl_8001DAD4:
/* 8001DAD4 00019914  91 04 00 04 */	stw r8, 4(r4)
/* 8001DAD8 00019918  91 04 00 00 */	stw r8, 0(r4)
/* 8001DADC 0001991C  91 06 00 04 */	stw r8, 4(r6)
/* 8001DAE0 00019920  91 06 00 00 */	stw r8, 0(r6)
/* 8001DAE4 00019924  91 04 00 0C */	stw r8, 0xc(r4)
/* 8001DAE8 00019928  91 04 00 08 */	stw r8, 8(r4)
/* 8001DAEC 0001992C  91 06 00 0C */	stw r8, 0xc(r6)
/* 8001DAF0 00019930  91 06 00 08 */	stw r8, 8(r6)
...
lbl_8001DBE4:
/* 8001DBE4 00019A24  80 8D 80 A8 */	lwz r4, __OSFpscrEnableBits-_SDA_BASE_(r13)
/* 8001DBE8 00019A28  80 C9 01 94 */	lwz r6, 0x194(r9)
/* 8001DBEC 00019A2C  54 84 06 38 */	rlwinm r4, r4, 0, 0x18, 0x1c
...
lbl_8001DC00:
/* 8001DC00 00019A40  2C 09 00 00 */	cmpwi r9, 0
/* 8001DC04 00019A44  40 82 FE A4 */	bne lbl_8001DAA8
/* 8001DC08 00019A48  80 0D 80 A8 */	lwz r0, __OSFpscrEnableBits-_SDA_BASE_(r13)
/* 8001DC0C 00019A4C  63 FF 09 00 */	ori r31, r31, 0x900
/* 8001DC10 00019A50  54 00 06 38 */	rlwinm r0, r0, 0, 0x18, 0x1c
...
/* 8001DC20 00019A60  3C 80 60 06 */	lis r4, 0x6005F8FF@ha
/* 8001DC24 00019A64  80 C5 00 DC */	lwz r6, 0x800000DC@l(r5)
/* 8001DC28 00019A68  38 84 F8 FF */	addi r4, r4, 0x6005F8FF@l
/* 8001DC2C 00019A6C  38 A0 F6 FF */	li r5, -2305
...
/* 8001DC44 00019A84  54 00 07 6E */	rlwinm r0, r0, 0, 0x1d, 0x17
...
lbl_8001DC54:
/* 8001DC54 00019A94  2C 06 00 00 */	cmpwi r6, 0
/* 8001DC58 00019A98  40 82 FF DC */	bne lbl_8001DC34
/* 8001DC5C 00019A9C  38 00 F6 FF */	li r0, -2305
/* 8001DC60 00019AA0  54 64 07 6E */	rlwinm r4, r3, 0, 0x1d, 0x17
/* 8001DC64 00019AA4  7F FF 00 38 */	and r31, r31, r0
lbl_8001DC68:
/* 8001DC68 00019AA8  3C 60 60 06 */	lis r3, 0x6005F8FF@ha
/* 8001DC6C 00019AAC  38 03 F8 FF */	addi r0, r3, 0x6005F8FF@l
...
/* 8001DCAC 00019AEC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8001DCC0 00019B00  4B FE 96 6D */	bl func_8000732C
/* 8001DCC4 00019B04  3F E0 80 42 */	lis r31, $$2641@ha
...
/* 8001DCD8 00019B18  3B FF 25 B8 */	addi r31, r31, $$2641@l
...
/* 8001DCEC 00019B2C  54 A0 07 BD */	rlwinm. r0, r5, 0, 0x1e, 0x1e
...
/* 8001DCFC 00019B3C  4C C6 31 82 */	crclr 6
/* 8001DD00 00019B40  4B FF FC 91 */	bl OSReport
/* 8001DD04 00019B44  48 00 01 60 */	b lbl_8001DE64
lbl_8001DD08:
/* 8001DD08 00019B48  28 19 00 06 */	cmplwi r25, 6
/* 8001DD0C 00019B4C  40 82 00 EC */	bne lbl_8001DDF8
/* 8001DD10 00019B50  54 A0 02 D7 */	rlwinm. r0, r5, 0, 0xb, 0xb
...
/* 8001DD24 00019B64  2C 00 00 00 */	cmpwi r0, 0
...
/* 8001DD48 00019B88  2C 03 00 00 */	cmpwi r3, 0
...
/* 8001DD58 00019B98  3F 00 60 06 */	lis r24, 0x6005F8FF@ha
/* 8001DD5C 00019B9C  38 18 F8 FF */	addi r0, r24, 0x6005F8FF@l
...
/* 8001DD94 00019BD4  4C C6 31 82 */	crclr 6
...
/* 8001DDB0 00019BF0  38 60 00 00 */	li r3, 0
/* 8001DDB4 00019BF4  38 18 F8 FF */	addi r0, r24, -1793
/* 8001DDB8 00019BF8  54 84 04 E2 */	rlwinm r4, r4, 0, 0x13, 0x11
...
/* 8001DDE0 00019C20  38 00 00 00 */	li r0, 0
/* 8001DDE4 00019C24  54 63 04 E2 */	rlwinm r3, r3, 0, 0x13, 0x11
...
/* 8001DE24 00019C64  4C C6 31 82 */	crclr 6
...
lbl_8001DE44:
/* 8001DE44 00019C84  28 19 00 08 */	cmplwi r25, 8
...
/* 8001DE5C 00019C9C  4C C6 31 82 */	crclr 6
/* 8001DE60 00019CA0  4B FF FB 31 */	bl OSReport
lbl_8001DE64:
/* 8001DE64 00019CA4  38 6D 80 AC */	addi r3, r13, $$2703-_SDA_BASE_
/* 8001DE68 00019CA8  4C C6 31 82 */	crclr 6
...
/* 8001DE84 00019CC4  4C C6 31 82 */	crclr 6
...
/* 8001DE98 00019CD8  4C C6 31 82 */	crclr 6
/* 8001DE9C 00019CDC  4B FF FA F5 */	bl OSReport
/* 8001DEA0 00019CE0  2C 19 00 02 */	cmpwi r25, 2
/* 8001DEA4 00019CE4  41 82 00 28 */	beq lbl_8001DECC
/* 8001DEA8 00019CE8  2C 19 00 03 */	cmpwi r25, 3
/* 8001DEAC 00019CEC  41 82 00 38 */	beq lbl_8001DEE4
/* 8001DEB0 00019CF0  2C 19 00 05 */	cmpwi r25, 5
/* 8001DEB4 00019CF4  41 82 00 44 */	beq lbl_8001DEF8
/* 8001DEB8 00019CF8  2C 19 00 06 */	cmpwi r25, 6
...
/* 8001DED8 00019D18  4C C6 31 82 */	crclr 6
...
/* 8001DEEC 00019D2C  4C C6 31 82 */	crclr 6
...
/* 8001DF04 00019D44  4C C6 31 82 */	crclr 6
...
/* 8001DF1C 00019D5C  4C C6 31 82 */	crclr 6
/* 8001DF20 00019D60  4B FF FA 71 */	bl OSReport
/* 8001DF24 00019D64  48 00 00 50 */	b lbl_8001DF74
lbl_8001DF28:
/* 8001DF28 00019D68  38 6D 80 AC */	addi r3, r13, $$2703-_SDA_BASE_
/* 8001DF2C 00019D6C  4C C6 31 82 */	crclr 6
...
/* 8001DF44 00019D84  4C C6 31 82 */	crclr 6
...
/* 8001DF58 00019D98  4C C6 31 82 */	crclr 6
...
/* 8001DF6C 00019DAC  4C C6 31 82 */	crclr 6
/* 8001DF70 00019DB0  4B FF FA 21 */	bl OSReport
lbl_8001DF74:
/* 8001DF74 00019DB4  A8 8D E3 EC */	lha r4, __OSLastInterrupt-_SDA_BASE_(r13)
/* 8001DF78 00019DB8  38 7F 02 A4 */	addi r3, r31, 0x2a4
/* 8001DF7C 00019DBC  80 AD E3 E8 */	lwz r5, __OSLastInterruptSrr0-_SDA_BASE_(r13)
/* 8001DF80 00019DC0  80 ED E3 F0 */	lwz r7, __OSLastInterruptTime-_SDA_BASE_(r13)
/* 8001DF84 00019DC4  81 0D E3 F4 */	lwz r8, lbl_8055C814-_SDA_BASE_(r13)
/* 8001DF88 00019DC8  4C C6 31 82 */	crclr 6
...
/* 8001DF98 00019DD8  4B FE 93 E1 */	bl func_80007378
