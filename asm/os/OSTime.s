...
/* 80025B44 00021984  7C 8C 42 E6 */	mftb r4, 0x10c
/* 80025B48 00021988  7C AD 42 E6 */	mftbu r5
/* 80025B4C 0002198C  7C 03 28 00 */	cmpw r3, r5
/* 80025B50 00021990  40 82 FF F0 */	bne OSGetTime
/* 80025B54 00021994  4E 80 00 20 */	blr 
/* 80025B58 00021998  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80025B5C 0002199C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global OSGetTick
OSGetTick:
/* 80025B60 000219A0  7C 6C 42 E6 */	mftb r3, 0x10c
/* 80025B64 000219A4  4E 80 00 20 */	blr 
/* 80025B68 000219A8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80025B6C 000219AC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80025BD4 00021A14  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80025BD8 00021A18  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80025BDC 00021A1C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80025BF4 00021A34  93 C1 00 08 */	stw r30, 8(r1)
...
/* 80025C24 00021A64  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 80025C38 00021A78  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80025C3C 00021A7C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80025C50 00021A90  4B FE 16 E9 */	bl func_80007338
...
/* 80025C68 00021AA8  38 A0 00 00 */	li r5, 0
...
/* 80025C78 00021AB8  38 E0 00 00 */	li r7, 0
...
lbl_80025CA8:
/* 80025CA8 00021AE8  3C 80 43 1C */	lis r4, 0x431BDE83@ha
/* 80025CAC 00021AEC  57 E3 18 38 */	slwi r3, r31, 3
/* 80025CB0 00021AF0  38 04 DE 83 */	addi r0, r4, 0x431BDE83@l
/* 80025CB4 00021AF4  38 A0 00 00 */	li r5, 0
/* 80025CB8 00021AF8  7C 00 D0 16 */	mulhwu r0, r0, r26
/* 80025CBC 00021AFC  57 C4 18 38 */	slwi r4, r30, 3
/* 80025CC0 00021B00  53 C3 1F 7E */	rlwimi r3, r30, 3, 0x1d, 0x1f
/* 80025CC4 00021B04  54 06 8B FE */	srwi r6, r0, 0xf
/* 80025CC8 00021B08  4B FE 17 C5 */	bl __div2i
/* 80025CCC 00021B0C  38 C0 03 E8 */	li r6, 0x3e8
/* 80025CD0 00021B10  38 A0 00 00 */	li r5, 0
...
/* 80025CE0 00021B20  3C 80 10 62 */	lis r4, 0x10624DD3@ha
/* 80025CE4 00021B24  7F E3 FB 78 */	mr r3, r31
/* 80025CE8 00021B28  80 1A 00 F8 */	lwz r0, 0x800000F8@l(r26)
/* 80025CEC 00021B2C  38 C4 4D D3 */	addi r6, r4, 0x10624DD3@l
/* 80025CF0 00021B30  7F C4 F3 78 */	mr r4, r30
/* 80025CF4 00021B34  38 A0 00 00 */	li r5, 0
...
/* 80025D0C 00021B4C  38 A0 00 00 */	li r5, 0
...
/* 80025D20 00021B60  38 A0 00 00 */	li r5, 0
...
/* 80025D30 00021B70  3F 60 00 01 */	lis r27, 0x00015180@ha
/* 80025D34 00021B74  7C 9C 23 78 */	mr r28, r4
/* 80025D38 00021B78  7C 7A 1B 78 */	mr r26, r3
/* 80025D3C 00021B7C  38 A0 00 00 */	li r5, 0
/* 80025D40 00021B80  38 DB 51 80 */	addi r6, r27, 0x00015180@l
/* 80025D44 00021B84  4B FE 17 49 */	bl __div2i
/* 80025D48 00021B88  3C 60 00 0B */	lis r3, 0x000B2575@ha
/* 80025D4C 00021B8C  38 DB 51 80 */	addi r6, r27, 0x5180
/* 80025D50 00021B90  38 03 25 75 */	addi r0, r3, 0x000B2575@l
/* 80025D54 00021B94  38 A0 00 00 */	li r5, 0
...
/* 80025D68 00021BA8  2C 04 00 00 */	cmpwi r4, 0
/* 80025D6C 00021BAC  40 80 00 10 */	bge lbl_80025D7C
/* 80025D70 00021BB0  3C 84 00 01 */	addis r4, r4, 1
/* 80025D74 00021BB4  3B FF FF FF */	addi r31, r31, -1
...
/* 80025D84 00021BC4  38 FF 00 06 */	addi r7, r31, 6
/* 80025D88 00021BC8  3C 60 51 EC */	lis r3, 0x51EB851F@ha
...
/* 80025D98 00021BD8  39 23 85 1F */	addi r9, r3, 0x51EB851F@l
...
/* 80025DA8 00021BE8  54 65 0F FE */	srwi r5, r3, 0x1f
...
/* 80025DB8 00021BF8  1C A3 00 07 */	mulli r5, r3, 7
/* 80025DBC 00021BFC  54 03 0F FE */	srwi r3, r0, 0x1f
...
lbl_80025DD8:
/* 80025DD8 00021C18  39 4A FE 93 */	addi r10, r10, -365
/* 80025DDC 00021C1C  38 63 FF FF */	addi r3, r3, -1
lbl_80025DE0:
/* 80025DE0 00021C20  2C 03 00 01 */	cmpwi r3, 1
/* 80025DE4 00021C24  41 80 00 3C */	blt lbl_80025E20
/* 80025DE8 00021C28  38 A3 FF FF */	addi r5, r3, -1
/* 80025DEC 00021C2C  38 03 00 03 */	addi r0, r3, 3
...
/* 80025DFC 00021C3C  54 A6 0F FE */	srwi r6, r5, 0x1f
/* 80025E00 00021C40  7C 00 16 70 */	srawi r0, r0, 2
/* 80025E04 00021C44  54 E8 0F FE */	srwi r8, r7, 0x1f
...
lbl_80025E20:
/* 80025E20 00021C60  38 00 00 00 */	li r0, 0
lbl_80025E24:
...
/* 80025E30 00021C70  54 60 F0 02 */	slwi r0, r3, 0x1e
/* 80025E34 00021C74  54 66 0F FE */	srwi r6, r3, 0x1f
...
/* 80025E50 00021C90  38 E0 00 00 */	li r7, 0
/* 80025E54 00021C94  40 82 00 28 */	bne lbl_80025E7C
/* 80025E58 00021C98  3C A0 51 EC */	lis r5, 0x51EB851F@ha
/* 80025E5C 00021C9C  38 A5 85 1F */	addi r5, r5, 0x51EB851F@l
/* 80025E60 00021CA0  7C A5 18 96 */	mulhw r5, r5, r3
/* 80025E64 00021CA4  7C A5 2E 70 */	srawi r5, r5, 5
/* 80025E68 00021CA8  54 A6 0F FE */	srwi r6, r5, 0x1f
...
lbl_80025E7C:
/* 80025E7C 00021CBC  3C A0 51 EC */	lis r5, 0x51EB851F@ha
/* 80025E80 00021CC0  38 A5 85 1F */	addi r5, r5, 0x51EB851F@l
/* 80025E84 00021CC4  7C A5 18 96 */	mulhw r5, r5, r3
/* 80025E88 00021CC8  7C A5 3E 70 */	srawi r5, r5, 7
/* 80025E8C 00021CCC  54 A6 0F FE */	srwi r6, r5, 0x1f
...
lbl_80025EA0:
/* 80025EA0 00021CE0  38 E0 00 01 */	li r7, 1
lbl_80025EA4:
/* 80025EA4 00021CE4  2C 07 00 00 */	cmpwi r7, 0
...
lbl_80025EC8:
/* 80025EC8 00021D08  38 63 FF FC */	addi r3, r3, -4
/* 80025ECC 00021D0C  38 C6 FF FF */	addi r6, r6, -1
...
/* 80025EF8 00021D38  38 03 00 01 */	addi r0, r3, 1
...
/* 80025F08 00021D48  54 05 0F FE */	srwi r5, r0, 0x1f
...
/* 80025F24 00021D64  54 E8 0F FE */	srwi r8, r7, 0x1f
/* 80025F28 00021D68  54 A6 0F FE */	srwi r6, r5, 0x1f
/* 80025F2C 00021D6C  54 03 0F FE */	srwi r3, r0, 0x1f
...
/* 80025F40 00021D80  90 FD 00 08 */	stw r7, 8(r29)
/* 80025F44 00021D84  1C 00 00 3C */	mulli r0, r0, 0x3c
/* 80025F48 00021D88  7C 63 48 50 */	subf r3, r3, r9
/* 80025F4C 00021D8C  90 7D 00 04 */	stw r3, 4(r29)
/* 80025F50 00021D90  7C 00 20 50 */	subf r0, r0, r4
/* 80025F54 00021D94  90 1D 00 00 */	stw r0, 0(r29)
/* 80025F58 00021D98  4B FE 14 2D */	bl func_80007384
...
.global LeapYearDays
LeapYearDays:
	.incbin "baserom.dol", 0x41FAD0, 0x30
