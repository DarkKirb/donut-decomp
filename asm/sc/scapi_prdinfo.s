...
/* 8004D1F8 00049038  39 66 DB FA */	addi r11, r6, 0x73B5DBFA@l
/* 8004D1FC 0004903C  39 20 00 00 */	li r9, 0
/* 8004D200 00049040  39 80 00 00 */	li r12, 0
/* 8004D204 00049044  38 C0 00 00 */	li r6, 0
/* 8004D208 00049048  39 40 00 00 */	li r10, 0
...
/* 8004D218 00049058  2C 08 00 00 */	cmpwi r8, 0
...
/* 8004D228 00049068  54 08 06 3E */	clrlwi r8, r0, 0x18
...
/* 8004D258 00049098  54 E7 DF FE */	rlwinm r7, r7, 0x1b, 0x1f, 0x1f
/* 8004D25C 0004909C  7C E7 00 D0 */	neg r7, r7
/* 8004D260 000490A0  7C 0C 38 38 */	and r12, r0, r7
lbl_8004D264:
/* 8004D264 000490A4  39 4A 00 01 */	addi r10, r10, 1
/* 8004D268 000490A8  55 67 0F FE */	srwi r7, r11, 0x1f
...
/* 8004D27C 000490BC  2C 08 00 00 */	cmpwi r8, 0
...
/* 8004D28C 000490CC  54 08 06 3E */	clrlwi r8, r0, 0x18
...
/* 8004D2F4 00049134  55 67 0F FE */	srwi r7, r11, 0x1f
...
lbl_8004D324:
/* 8004D324 00049164  38 60 00 00 */	li r3, 0
lbl_8004D328:
/* 8004D328 00049168  2C 03 00 00 */	cmpwi r3, 0
/* 8004D32C 0004916C  98 64 00 00 */	stb r3, 0(r4)
/* 8004D330 00049170  38 C6 00 01 */	addi r6, r6, 1
/* 8004D334 00049174  38 84 00 01 */	addi r4, r4, 1
/* 8004D338 00049178  40 82 00 0C */	bne lbl_8004D344
/* 8004D33C 0004917C  38 60 00 01 */	li r3, 1
/* 8004D340 00049180  4E 80 00 20 */	blr 
lbl_8004D344:
/* 8004D344 00049184  39 4A 00 01 */	addi r10, r10, 1
lbl_8004D348:
...
lbl_8004D358:
/* 8004D358 00049198  38 60 00 00 */	li r3, 0
...
/* 8004D368 000491A8  38 6D 83 68 */	addi r3, r13, $$21016-_SDA_BASE_
/* 8004D36C 000491AC  38 A0 00 04 */	li r5, 4
/* 8004D370 000491B0  90 01 00 24 */	stw r0, 0x24(r1)
/* 8004D374 000491B4  38 81 00 08 */	addi r4, r1, 8
...
/* 8004D38C 000491CC  2C 03 00 00 */	cmpwi r3, 0
/* 8004D390 000491D0  41 82 00 38 */	beq lbl_8004D3C8
/* 8004D394 000491D4  48 00 00 24 */	b lbl_8004D3B8
lbl_8004D398:
/* 8004D398 000491D8  38 7E 00 01 */	addi r3, r30, 1
/* 8004D39C 000491DC  38 81 00 08 */	addi r4, r1, 8
/* 8004D3A0 000491E0  4B FC 07 9D */	bl strcmp
/* 8004D3A4 000491E4  2C 03 00 00 */	cmpwi r3, 0
...
lbl_8004D3B4:
/* 8004D3B4 000491F4  3B DE 00 05 */	addi r30, r30, 5
lbl_8004D3B8:
/* 8004D3B8 000491F8  8B FE 00 00 */	lbz r31, 0(r30)
/* 8004D3BC 000491FC  7F E0 07 74 */	extsb r0, r31
/* 8004D3C0 00049200  2C 00 FF FF */	cmpwi r0, -1
/* 8004D3C4 00049204  40 82 FF D4 */	bne lbl_8004D398
lbl_8004D3C8:
/* 8004D3C8 00049208  38 60 FF FF */	li r3, -1
lbl_8004D3CC:
...
/* 8004D3E4 00049224  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8004D3E8 00049228  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8004D3EC 0004922C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 8004D3F8 00049238  38 6D 83 70 */	addi r3, r13, $$21065-_SDA_BASE_
/* 8004D3FC 0004923C  38 A0 00 03 */	li r5, 3
/* 8004D400 00049240  90 01 00 24 */	stw r0, 0x24(r1)
/* 8004D404 00049244  38 81 00 08 */	addi r4, r1, 8
...
/* 8004D41C 0004925C  2C 03 00 00 */	cmpwi r3, 0
/* 8004D420 00049260  41 82 00 38 */	beq lbl_8004D458
/* 8004D424 00049264  48 00 00 24 */	b lbl_8004D448
lbl_8004D428:
/* 8004D428 00049268  38 7E 00 01 */	addi r3, r30, 1
/* 8004D42C 0004926C  38 81 00 08 */	addi r4, r1, 8
/* 8004D430 00049270  4B FC 07 0D */	bl strcmp
/* 8004D434 00049274  2C 03 00 00 */	cmpwi r3, 0
...
lbl_8004D444:
/* 8004D444 00049284  3B DE 00 04 */	addi r30, r30, 4
lbl_8004D448:
/* 8004D448 00049288  8B FE 00 00 */	lbz r31, 0(r30)
/* 8004D44C 0004928C  7F E0 07 74 */	extsb r0, r31
/* 8004D450 00049290  2C 00 FF FF */	cmpwi r0, -1
/* 8004D454 00049294  40 82 FF D4 */	bne lbl_8004D428
lbl_8004D458:
/* 8004D458 00049298  38 60 FF FF */	li r3, -1
lbl_8004D45C:
