...
/* 803CC8B0 003C86F0  C0 02 DB E8 */	lfs f0, lbl_80563B68@sda21(r2)
/* 803CC8B4 003C86F4  D0 03 00 08 */	stfs f0, 0x8(r3)
/* 803CC8B8 003C86F8  80 02 DB E0 */	lwz r0, lbl_80563B60@sda21(r2)
/* 803CC8BC 003C86FC  90 03 00 0C */	stw r0, 0xc(r3)
/* 803CC8C0 003C8700  80 02 DB E4 */	lwz r0, lbl_80563B64@sda21(r2)
...
/* 803CC8F0 003C8730  C0 02 DB EC */	lfs f0, lbl_80563B6C@sda21(r2)
/* 803CC8F4 003C8734  48 00 00 08 */	b lbl_803CC8FC
.global lbl_803CC8F8
lbl_803CC8F8:
/* 803CC8F8 003C8738  C0 02 DB E8 */	lfs f0, lbl_80563B68@sda21(r2)
.global lbl_803CC8FC
lbl_803CC8FC:
/* 803CC8FC 003C873C  C0 43 00 08 */	lfs f2, 0x8(r3)
/* 803CC900 003C8740  EC 20 10 28 */	fsubs f1, f0, f2
/* 803CC904 003C8744  C0 02 DB F0 */	lfs f0, lbl_80563B70@sda21(r2)
...
/* 803CC918 003C8758  4B D7 EF FD */	bl lbl_8014B914
/* 803CC91C 003C875C  88 1F 00 0F */	lbz r0, 0xf(r31)
/* 803CC920 003C8760  C8 22 DB F8 */	lfd f1, lbl_80563B78@sda21(r2)
...
/* 803CC980 003C87C0  4B E5 43 41 */	bl lbl_80220CC0
/* 803CC984 003C87C4  38 80 00 00 */	li r4, 0x0
/* 803CC988 003C87C8  4B E5 AD 21 */	bl lbl_802276A8
/* 803CC98C 003C87CC  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 803CC990 003C87D0  4B E5 43 31 */	bl lbl_80220CC0
/* 803CC994 003C87D4  4B DF 12 C5 */	bl lbl_801BDC58
/* 803CC998 003C87D8  38 80 00 00 */	li r4, 0x0
/* 803CC99C 003C87DC  4B E5 6F A9 */	bl lbl_80223944
/* 803CC9A0 003C87E0  48 00 00 28 */	b lbl_803CC9C8
.global lbl_803CC9A4
lbl_803CC9A4:
/* 803CC9A4 003C87E4  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 803CC9A8 003C87E8  4B E5 43 19 */	bl lbl_80220CC0
/* 803CC9AC 003C87EC  38 80 00 01 */	li r4, 0x1
/* 803CC9B0 003C87F0  4B E5 AC F9 */	bl lbl_802276A8
/* 803CC9B4 003C87F4  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 803CC9B8 003C87F8  4B E5 43 09 */	bl lbl_80220CC0
/* 803CC9BC 003C87FC  4B DF 12 9D */	bl lbl_801BDC58
/* 803CC9C0 003C8800  38 80 00 01 */	li r4, 0x1
/* 803CC9C4 003C8804  4B E5 6F 81 */	bl lbl_80223944
.global lbl_803CC9C8
lbl_803CC9C8:
...
/* 803CCA00 003C8840  C0 22 DB E8 */	lfs f1, lbl_80563B68@sda21(r2)
/* 803CCA04 003C8844  C0 42 DB EC */	lfs f2, lbl_80563B6C@sda21(r2)
...
/* 803CCA18 003C8858  4B DD 21 11 */	bl lbl_8019EB28
/* 803CCA1C 003C885C  38 61 00 68 */	addi r3, r1, 0x68
/* 803CCA20 003C8860  38 80 00 00 */	li r4, 0x0
/* 803CCA24 003C8864  4B DC 86 31 */	bl lbl_80195054
/* 803CCA28 003C8868  38 7F 00 10 */	addi r3, r31, 0x10
/* 803CCA2C 003C886C  4B DC 88 B9 */	bl lbl_801952E4
/* 803CCA30 003C8870  38 60 00 01 */	li r3, 0x1
/* 803CCA34 003C8874  38 80 00 01 */	li r4, 0x1
/* 803CCA38 003C8878  38 A0 00 00 */	li r5, 0x0
/* 803CCA3C 003C887C  4B C6 BD E5 */	bl lbl_80038820
/* 803CCA40 003C8880  C0 22 DB E8 */	lfs f1, lbl_80563B68@sda21(r2)
/* 803CCA44 003C8884  D0 21 00 08 */	stfs f1, 0x8(r1)
/* 803CCA48 003C8888  C0 02 DB EC */	lfs f0, lbl_80563B6C@sda21(r2)
...
/* 803CCA7C 003C88BC  4B C6 3A 65 */	bl lbl_800304E0
...
/* 803CCA94 003C88D4  4B DC 8A D1 */	bl lbl_80195564
.global lbl_803CCA98
lbl_803CCA98:
