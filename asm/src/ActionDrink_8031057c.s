...
/* 80310590 0030C3D0  90 83 00 04 */	stw r4, 0x4(r3)
...
/* 8031059C 0030C3DC  90 03 00 00 */	stw r0, 0x0(r3)
/* 803105A0 0030C3E0  38 63 00 08 */	addi r3, r3, 0x8
/* 803105A4 0030C3E4  4B D0 B2 5D */	bl OSCreateAlarm
/* 803105A8 0030C3E8  38 00 00 00 */	li r0, 0x0
...
/* 803105C8 0030C408  38 6D C3 08 */	addi r3, r13, "@52894_8055A728"@sda21
...
/* 80310638 0030C478  80 63 00 04 */	lwz r3, 0x4(r3)
...
/* 80310644 0030C484  80 7F 00 04 */	lwz r3, 0x4(r31)
...
/* 80310730 0030C570  F3 E1 00 68 */	psq_st f31, 0x68(r1), 0, qr0
/* 80310734 0030C574  DB C1 00 50 */	stfd f30, 0x50(r1)
/* 80310738 0030C578  F3 C1 00 58 */	psq_st f30, 0x58(r1), 0, qr0
/* 8031073C 0030C57C  DB A1 00 40 */	stfd f29, 0x40(r1)
/* 80310740 0030C580  F3 A1 00 48 */	psq_st f29, 0x48(r1), 0, qr0
...
/* 80310758 0030C598  2C 00 00 00 */	cmpwi r0, 0x0
/* 8031075C 0030C59C  40 82 00 FC */	bne lbl_80310858
/* 80310760 0030C5A0  80 63 00 04 */	lwz r3, 0x4(r3)
/* 80310764 0030C5A4  4B EE 98 E9 */	bl "data<Q43scn4step9challenge5Param>__Q25param13ParamAccessorCFv_RCQ43scn4step9challenge5Param"
/* 80310768 0030C5A8  C3 E3 00 2C */	lfs f31, 0x2c(r3)
/* 8031076C 0030C5AC  80 7E 00 04 */	lwz r3, 0x4(r30)
/* 80310770 0030C5B0  4B EE 98 DD */	bl "data<Q43scn4step9challenge5Param>__Q25param13ParamAccessorCFv_RCQ43scn4step9challenge5Param"
/* 80310774 0030C5B4  C3 C3 00 30 */	lfs f30, 0x30(r3)
/* 80310778 0030C5B8  80 7E 00 04 */	lwz r3, 0x4(r30)
/* 8031077C 0030C5BC  4B EE 98 D1 */	bl "data<Q43scn4step9challenge5Param>__Q25param13ParamAccessorCFv_RCQ43scn4step9challenge5Param"
/* 80310780 0030C5C0  C3 A3 00 34 */	lfs f29, 0x34(r3)
/* 80310784 0030C5C4  38 61 00 28 */	addi r3, r1, 0x28
/* 80310788 0030C5C8  80 9E 00 04 */	lwz r4, 0x4(r30)
...
/* 803107B4 0030C5F4  C0 1F 00 00 */	lfs f0, 0x0(r31)
...
/* 803107C8 0030C608  80 9E 00 04 */	lwz r4, 0x4(r30)
...
/* 803107F4 0030C634  C0 1F 00 00 */	lfs f0, 0x0(r31)
...
.global lbl_80310804
lbl_80310804:
/* 80310804 0030C644  38 61 00 08 */	addi r3, r1, 0x8
/* 80310808 0030C648  80 9E 00 04 */	lwz r4, 0x4(r30)
...
/* 80310814 0030C654  C0 1F 00 04 */	lfs f0, 0x4(r31)
/* 80310818 0030C658  EC 21 00 28 */	fsubs f1, f1, f0
/* 8031081C 0030C65C  4B E8 F6 99 */	bl "Abs<f>__Q33hel4math4MathFf_Cf"
...
/* 803108A4 0030C6E4  F3 E1 00 68 */	psq_st f31, 0x68(r1), 0, qr0
/* 803108A8 0030C6E8  DB C1 00 50 */	stfd f30, 0x50(r1)
/* 803108AC 0030C6EC  F3 C1 00 58 */	psq_st f30, 0x58(r1), 0, qr0
/* 803108B0 0030C6F0  DB A1 00 40 */	stfd f29, 0x40(r1)
/* 803108B4 0030C6F4  F3 A1 00 48 */	psq_st f29, 0x48(r1), 0, qr0
...
/* 803108CC 0030C70C  2C 00 00 01 */	cmpwi r0, 0x1
/* 803108D0 0030C710  40 82 00 F0 */	bne lbl_803109C0
/* 803108D4 0030C714  80 63 00 04 */	lwz r3, 0x4(r3)
/* 803108D8 0030C718  4B EE 97 75 */	bl "data<Q43scn4step9challenge5Param>__Q25param13ParamAccessorCFv_RCQ43scn4step9challenge5Param"
/* 803108DC 0030C71C  C3 E3 00 2C */	lfs f31, 0x2c(r3)
/* 803108E0 0030C720  80 7E 00 04 */	lwz r3, 0x4(r30)
/* 803108E4 0030C724  4B EE 97 69 */	bl "data<Q43scn4step9challenge5Param>__Q25param13ParamAccessorCFv_RCQ43scn4step9challenge5Param"
/* 803108E8 0030C728  C3 C3 00 30 */	lfs f30, 0x30(r3)
/* 803108EC 0030C72C  80 7E 00 04 */	lwz r3, 0x4(r30)
/* 803108F0 0030C730  4B EE 97 5D */	bl "data<Q43scn4step9challenge5Param>__Q25param13ParamAccessorCFv_RCQ43scn4step9challenge5Param"
/* 803108F4 0030C734  C3 A3 00 34 */	lfs f29, 0x34(r3)
/* 803108F8 0030C738  38 61 00 28 */	addi r3, r1, 0x28
/* 803108FC 0030C73C  80 9E 00 04 */	lwz r4, 0x4(r30)
...
/* 80310928 0030C768  C0 1F 00 00 */	lfs f0, 0x0(r31)
...
/* 8031093C 0030C77C  80 9E 00 04 */	lwz r4, 0x4(r30)
...
/* 80310968 0030C7A8  C0 1F 00 00 */	lfs f0, 0x0(r31)
...
.global lbl_80310978
lbl_80310978:
/* 80310978 0030C7B8  38 61 00 08 */	addi r3, r1, 0x8
/* 8031097C 0030C7BC  80 9E 00 04 */	lwz r4, 0x4(r30)
...
/* 80310988 0030C7C8  C0 1F 00 04 */	lfs f0, 0x4(r31)
/* 8031098C 0030C7CC  EC 21 00 28 */	fsubs f1, f1, f0
/* 80310990 0030C7D0  4B E8 F5 25 */	bl "Abs<f>__Q33hel4math4MathFf_Cf"
...
.global lbl_803109A0
lbl_803109A0:
/* 803109A0 0030C7E0  38 00 00 02 */	li r0, 0x2
/* 803109A4 0030C7E4  90 1E 00 10 */	stw r0, 0x10(r30)
/* 803109A8 0030C7E8  80 7E 00 04 */	lwz r3, 0x4(r30)
/* 803109AC 0030C7EC  4B EE 96 A1 */	bl "data<Q43scn4step9challenge5Param>__Q25param13ParamAccessorCFv_RCQ43scn4step9challenge5Param"
/* 803109B0 0030C7F0  7C 64 1B 78 */	mr r4, r3
/* 803109B4 0030C7F4  38 7E 00 08 */	addi r3, r30, 0x8
