...
/* 801A0DA0 0019CBE0  C8 22 99 60 */	lfd f1, $$252188-_SDA2_BASE_(r2)
...
/* 801A0DB0 0019CBF0  90 01 00 08 */	stw r0, 8(r1)
/* 801A0DB4 0019CBF4  C8 01 00 08 */	lfd f0, 8(r1)
...
.global t_F2I__Q33hel4mint23$$2unnamed$$2AddOnCast_cpp$$2Ff
t_F2I__Q33hel4mint23$$2unnamed$$2AddOnCast_cpp$$2Ff:
/* 801A0DC4 0019CC04  94 21 FF F0 */	stwu r1, -0x10(r1)
/* 801A0DC8 0019CC08  FC 00 08 1E */	fctiwz f0, f1
/* 801A0DCC 0019CC0C  D8 01 00 08 */	stfd f0, 8(r1)
...
/* 801A0DEC 0019CC2C  93 C1 00 08 */	stw r30, 8(r1)
/* 801A0DF0 0019CC30  7C 7E 1B 78 */	mr r30, r3
/* 801A0DF4 0019CC34  3C 80 80 45 */	lis r4, $$252192@ha
/* 801A0DF8 0019CC38  3B E4 69 E0 */	addi r31, r4, $$252192@l
/* 801A0DFC 0019CC3C  38 9F 00 00 */	addi r4, r31, 0
...
/* 801A0E14 0019CC54  38 9F 00 00 */	addi r4, r31, 0
...
/* 801A0E2C 0019CC6C  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 801A0E50 0019CC90  93 C1 00 08 */	stw r30, 8(r1)
...
/* 801A0E68 0019CCA8  2C 03 00 00 */	cmpwi r3, 0
/* 801A0E6C 0019CCAC  41 82 00 1C */	beq lbl_801A0E88
/* 801A0E70 0019CCB0  7F C3 F3 78 */	mr r3, r30
/* 801A0E74 0019CCB4  38 80 00 00 */	li r4, 0
/* 801A0E78 0019CCB8  4B FF 77 7D */	bl internal_getArg_addr__Q26mintvm13MintFuncProxyCFUi
/* 801A0E7C 0019CCBC  C0 23 00 00 */	lfs f1, 0(r3)
/* 801A0E80 0019CCC0  4B FF FF 45 */	bl t_F2I__Q33hel4mint23$$2unnamed$$2AddOnCast_cpp$$2Ff
/* 801A0E84 0019CCC4  90 7F 00 00 */	stw r3, 0(r31)
lbl_801A0E88:
/* 801A0E88 0019CCC8  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 801A0E8C 0019CCCC  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 801A0EB0 0019CCF0  93 C1 00 08 */	stw r30, 8(r1)
...
/* 801A0EC8 0019CD08  2C 03 00 00 */	cmpwi r3, 0
/* 801A0ECC 0019CD0C  41 82 00 1C */	beq lbl_801A0EE8
/* 801A0ED0 0019CD10  7F C3 F3 78 */	mr r3, r30
/* 801A0ED4 0019CD14  38 80 00 00 */	li r4, 0
/* 801A0ED8 0019CD18  4B FF 77 1D */	bl internal_getArg_addr__Q26mintvm13MintFuncProxyCFUi
/* 801A0EDC 0019CD1C  80 63 00 00 */	lwz r3, 0(r3)
/* 801A0EE0 0019CD20  4B FF FE BD */	bl t_I2F__Q33hel4mint23$$2unnamed$$2AddOnCast_cpp$$2Fi
/* 801A0EE4 0019CD24  D0 3F 00 00 */	stfs f1, 0(r31)
lbl_801A0EE8:
/* 801A0EE8 0019CD28  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 801A0EEC 0019CD2C  83 C1 00 08 */	lwz r30, 8(r1)
