...
/* 802ACD18 002A8B58  4B FD E0 B5 */	bl lbl_8028ADCC
/* 802ACD1C 002A8B5C  7C 7E 1B 78 */	mr r30, r3
/* 802ACD20 002A8B60  4B FD E0 AD */	bl lbl_8028ADCC
/* 802ACD24 002A8B64  4B FD B4 81 */	bl lbl_802881A4
/* 802ACD28 002A8B68  7C 7F 1B 78 */	mr r31, r3
/* 802ACD2C 002A8B6C  48 15 91 D5 */	bl lbl_80405F00
...
/* 802ACD3C 002A8B7C  3C 60 80 46 */	lis r3, lbl_80464478@ha
/* 802ACD40 002A8B80  38 03 44 78 */	addi r0, r3, lbl_80464478@l
...
/* 802ACD50 002A8B90  3C 60 80 47 */	lis r3, lbl_80475E08@ha
/* 802ACD54 002A8B94  38 03 5E 08 */	addi r0, r3, lbl_80475E08@l
...
/* 802ACD90 002A8BD0  4B FD E0 3D */	bl lbl_8028ADCC
/* 802ACD94 002A8BD4  4B FD B4 01 */	bl lbl_80288194
/* 802ACD98 002A8BD8  7C 7E 1B 78 */	mr r30, r3
/* 802ACD9C 002A8BDC  4B FD 5C C1 */	bl lbl_80282A5C
...
/* 802ACDF8 002A8C38  4B F2 68 CD */	bl lbl_801D36C4
...
/* 802ACE2C 002A8C6C  3C 80 80 47 */	lis r4, lbl_80475DA0@ha
/* 802ACE30 002A8C70  3B E4 5D A0 */	addi r31, r4, lbl_80475DA0@l
/* 802ACE34 002A8C74  38 9F 00 00 */	addi r4, r31, 0x0
/* 802ACE38 002A8C78  38 BF 00 24 */	addi r5, r31, 0x24
/* 802ACE3C 002A8C7C  3C C0 80 2B */	lis r6, lbl_802ACF18@ha
/* 802ACE40 002A8C80  38 C6 CF 18 */	addi r6, r6, lbl_802ACF18@l
/* 802ACE44 002A8C84  4B F1 F7 35 */	bl lbl_801CC578
...
/* 802ACE54 002A8C94  3C C0 80 2B */	lis r6, lbl_802ACE78@ha
/* 802ACE58 002A8C98  38 C6 CE 78 */	addi r6, r6, lbl_802ACE78@l
/* 802ACE5C 002A8C9C  4B F1 F7 1D */	bl lbl_801CC578
...
/* 802ACEA8 002A8CE8  3C 60 80 45 */	lis r3, lbl_8045411C@ha
/* 802ACEAC 002A8CEC  38 63 41 1C */	addi r3, r3, lbl_8045411C@l
/* 802ACEB0 002A8CF0  38 80 00 92 */	li r4, 0x92
/* 802ACEB4 002A8CF4  3C A0 80 45 */	lis r5, lbl_80454108@ha
/* 802ACEB8 002A8CF8  38 A5 41 08 */	addi r5, r5, lbl_80454108@l
/* 802ACEBC 002A8CFC  4C C6 31 82 */	crclr 4*cr1+eq
/* 802ACEC0 002A8D00  4B F1 90 E5 */	bl lbl_801C5FA4
.global lbl_802ACEC4
lbl_802ACEC4:
...
/* 802ACED8 002A8D18  4B ED E9 01 */	bl lbl_8018B7D8
...
/* 802ACEEC 002A8D2C  4B ED E8 ED */	bl lbl_8018B7D8
...
/* 802ACEFC 002A8D3C  4B FF FE 81 */	bl lbl_802ACD7C
...
.global lbl_802ACF18
lbl_802ACF18:
/* 802ACF18 002A8D58  4B FF FD EC */	b lbl_802ACD04
...
/* 802ACF30 002A8D70  48 00 04 F8 */	b lbl_802AD428
/* 802ACF34 002A8D74  4E 80 00 20 */	blr

.global lbl_802ACF38
lbl_802ACF38:
/* 802ACF38 002A8D78  4B F8 17 68 */	b lbl_8022E6A0
