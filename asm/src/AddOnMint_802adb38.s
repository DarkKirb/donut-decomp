...
/* 802ADB54 002A9994  4B FD D2 79 */	bl lbl_8028ADCC
/* 802ADB58 002A9998  7C 7E 1B 78 */	mr r30, r3
/* 802ADB5C 002A999C  4B FD D2 71 */	bl lbl_8028ADCC
/* 802ADB60 002A99A0  4B FD A6 45 */	bl lbl_802881A4
/* 802ADB64 002A99A4  7C 7F 1B 78 */	mr r31, r3
/* 802ADB68 002A99A8  48 15 83 99 */	bl lbl_80405F00
...
/* 802ADB80 002A99C0  4B F8 8C E9 */	bl lbl_80236868
/* 802ADB84 002A99C4  3C 60 80 47 */	lis r3, lbl_80476138@ha
/* 802ADB88 002A99C8  38 03 61 38 */	addi r0, r3, lbl_80476138@l
...
/* 802ADBD8 002A9A18  4B FD D1 F5 */	bl lbl_8028ADCC
/* 802ADBDC 002A9A1C  4B FD A4 A9 */	bl lbl_80288084
/* 802ADBE0 002A9A20  4B FD FC 21 */	bl lbl_8028D800
/* 802ADBE4 002A9A24  7C 7F 1B 78 */	mr r31, r3
/* 802ADBE8 002A9A28  4B FD D1 E5 */	bl lbl_8028ADCC
/* 802ADBEC 002A9A2C  7C 7E 1B 78 */	mr r30, r3
/* 802ADBF0 002A9A30  4B FD D1 DD */	bl lbl_8028ADCC
/* 802ADBF4 002A9A34  4B FD A5 B1 */	bl lbl_802881A4
...
/* 802ADC04 002A9A44  48 00 00 29 */	bl lbl_802ADC2C
...
/* 802ADC58 002A9A98  48 15 82 A9 */	bl lbl_80405F00
...
/* 802ADC70 002A9AB0  4B F8 8B F9 */	bl lbl_80236868
/* 802ADC74 002A9AB4  3C 60 80 47 */	lis r3, lbl_80476128@ha
/* 802ADC78 002A9AB8  38 03 61 28 */	addi r0, r3, lbl_80476128@l
...
/* 802ADCD0 002A9B10  4B FD D0 FD */	bl lbl_8028ADCC
/* 802ADCD4 002A9B14  4B FD A3 B1 */	bl lbl_80288084
/* 802ADCD8 002A9B18  4B FD FB 29 */	bl lbl_8028D800
/* 802ADCDC 002A9B1C  7C 7F 1B 78 */	mr r31, r3
/* 802ADCE0 002A9B20  4B FD D0 ED */	bl lbl_8028ADCC
/* 802ADCE4 002A9B24  7C 7E 1B 78 */	mr r30, r3
/* 802ADCE8 002A9B28  4B FD D0 E5 */	bl lbl_8028ADCC
/* 802ADCEC 002A9B2C  4B FD A4 B9 */	bl lbl_802881A4
...
/* 802ADCFC 002A9B3C  4B FF FF 31 */	bl lbl_802ADC2C
...
/* 802ADD40 002A9B80  4B FD D0 8D */	bl lbl_8028ADCC
/* 802ADD44 002A9B84  7C 7E 1B 78 */	mr r30, r3
/* 802ADD48 002A9B88  4B FD D0 85 */	bl lbl_8028ADCC
/* 802ADD4C 002A9B8C  4B FD A4 59 */	bl lbl_802881A4
/* 802ADD50 002A9B90  7C 7F 1B 78 */	mr r31, r3
/* 802ADD54 002A9B94  48 15 81 AD */	bl lbl_80405F00
...
/* 802ADD6C 002A9BAC  4B F8 8A FD */	bl lbl_80236868
/* 802ADD70 002A9BB0  3C 60 80 47 */	lis r3, lbl_80476118@ha
/* 802ADD74 002A9BB4  38 03 61 18 */	addi r0, r3, lbl_80476118@l
...
/* 802ADDBC 002A9BFC  3C 80 80 47 */	lis r4, lbl_804760A0@ha
/* 802ADDC0 002A9C00  3B E4 60 A0 */	addi r31, r4, lbl_804760A0@l
/* 802ADDC4 002A9C04  38 9F 00 00 */	addi r4, r31, 0x0
/* 802ADDC8 002A9C08  38 BF 00 28 */	addi r5, r31, 0x28
/* 802ADDCC 002A9C0C  3C C0 80 2B */	lis r6, lbl_802ADE68@ha
/* 802ADDD0 002A9C10  38 C6 DE 68 */	addi r6, r6, lbl_802ADE68@l
/* 802ADDD4 002A9C14  4B F1 E7 A5 */	bl lbl_801CC578
...
/* 802ADDE4 002A9C24  3C C0 80 2B */	lis r6, lbl_802ADE58@ha
/* 802ADDE8 002A9C28  38 C6 DE 58 */	addi r6, r6, lbl_802ADE58@l
/* 802ADDEC 002A9C2C  4B F1 E7 8D */	bl lbl_801CC578
...
/* 802ADDFC 002A9C3C  3C C0 80 2B */	lis r6, lbl_802ADE48@ha
/* 802ADE00 002A9C40  38 C6 DE 48 */	addi r6, r6, lbl_802ADE48@l
/* 802ADE04 002A9C44  4B F1 E7 75 */	bl lbl_801CC578
...
/* 802ADE14 002A9C54  3C C0 80 2B */	lis r6, lbl_802ADE38@ha
/* 802ADE18 002A9C58  38 C6 DE 38 */	addi r6, r6, lbl_802ADE38@l
/* 802ADE1C 002A9C5C  4B F1 E7 5D */	bl lbl_801CC578
...
/* 802ADE3C 002A9C7C  3C 60 80 2B */	lis r3, lbl_802ADD24@ha
/* 802ADE40 002A9C80  38 63 DD 24 */	addi r3, r3, lbl_802ADD24@l
/* 802ADE44 002A9C84  4B EE A8 9C */	b lbl_801986E0
.global lbl_802ADE48
lbl_802ADE48:
/* 802ADE48 002A9C88  7C 64 1B 78 */	mr r4, r3
/* 802ADE4C 002A9C8C  3C 60 80 2B */	lis r3, lbl_802ADCB0@ha
/* 802ADE50 002A9C90  38 63 DC B0 */	addi r3, r3, lbl_802ADCB0@l
/* 802ADE54 002A9C94  4B EE A8 8C */	b lbl_801986E0
.global lbl_802ADE58
lbl_802ADE58:
/* 802ADE58 002A9C98  7C 64 1B 78 */	mr r4, r3
/* 802ADE5C 002A9C9C  3C 60 80 2B */	lis r3, lbl_802ADBB8@ha
/* 802ADE60 002A9CA0  38 63 DB B8 */	addi r3, r3, lbl_802ADBB8@l
/* 802ADE64 002A9CA4  4B EE A8 7C */	b lbl_801986E0
.global lbl_802ADE68
lbl_802ADE68:
/* 802ADE68 002A9CA8  7C 64 1B 78 */	mr r4, r3
/* 802ADE6C 002A9CAC  3C 60 80 2B */	lis r3, lbl_802ADB38@ha
/* 802ADE70 002A9CB0  38 63 DB 38 */	addi r3, r3, lbl_802ADB38@l
/* 802ADE74 002A9CB4  4B EE A8 6C */	b lbl_801986E0
...
/* 802ADE94 002A9CD4  48 00 08 64 */	b lbl_802AE6F8
...
/* 802ADEB4 002A9CF4  48 00 04 78 */	b lbl_802AE32C
...
/* 802ADED4 002A9D14  48 00 07 10 */	b lbl_802AE5E4
/* 802ADED8 002A9D18  4E 80 00 20 */	blr

.global lbl_802ADEDC
lbl_802ADEDC:
/* 802ADEDC 002A9D1C  4B F8 07 C4 */	b lbl_8022E6A0

.global lbl_802ADEE0
lbl_802ADEE0:
/* 802ADEE0 002A9D20  4B F8 07 C0 */	b lbl_8022E6A0

.global lbl_802ADEE4
lbl_802ADEE4:
/* 802ADEE4 002A9D24  4B F8 07 BC */	b lbl_8022E6A0
