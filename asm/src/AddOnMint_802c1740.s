...
/* 802C1754 002BD594  4B FC 96 79 */	bl lbl_8028ADCC
/* 802C1758 002BD598  7C 7E 1B 78 */	mr r30, r3
/* 802C175C 002BD59C  4B FC 96 71 */	bl lbl_8028ADCC
/* 802C1760 002BD5A0  4B FC 6A 45 */	bl lbl_802881A4
/* 802C1764 002BD5A4  7C 7F 1B 78 */	mr r31, r3
/* 802C1768 002BD5A8  48 14 47 99 */	bl lbl_80405F00
...
/* 802C1780 002BD5C0  4B F7 50 E9 */	bl lbl_80236868
/* 802C1784 002BD5C4  3C 60 80 48 */	lis r3, lbl_80478AD8@ha
/* 802C1788 002BD5C8  38 03 8A D8 */	addi r0, r3, lbl_80478AD8@l
...
/* 802C17C4 002BD604  4B FC 96 09 */	bl lbl_8028ADCC
/* 802C17C8 002BD608  7C 7E 1B 78 */	mr r30, r3
/* 802C17CC 002BD60C  4B FC 96 01 */	bl lbl_8028ADCC
/* 802C17D0 002BD610  4B FC 69 D5 */	bl lbl_802881A4
/* 802C17D4 002BD614  7C 7F 1B 78 */	mr r31, r3
/* 802C17D8 002BD618  48 14 47 29 */	bl lbl_80405F00
...
/* 802C17F0 002BD630  4B F7 50 79 */	bl lbl_80236868
/* 802C17F4 002BD634  3C 60 80 48 */	lis r3, lbl_80478AC8@ha
/* 802C17F8 002BD638  38 03 8A C8 */	addi r0, r3, lbl_80478AC8@l
...
/* 802C1834 002BD674  4B FC 95 99 */	bl lbl_8028ADCC
/* 802C1838 002BD678  7C 7E 1B 78 */	mr r30, r3
/* 802C183C 002BD67C  4B FC 95 91 */	bl lbl_8028ADCC
/* 802C1840 002BD680  4B FC 69 65 */	bl lbl_802881A4
/* 802C1844 002BD684  7C 7F 1B 78 */	mr r31, r3
/* 802C1848 002BD688  48 14 46 B9 */	bl lbl_80405F00
...
/* 802C1860 002BD6A0  4B F7 50 09 */	bl lbl_80236868
/* 802C1864 002BD6A4  3C 60 80 48 */	lis r3, lbl_80478AB8@ha
/* 802C1868 002BD6A8  38 03 8A B8 */	addi r0, r3, lbl_80478AB8@l
...
/* 802C18A4 002BD6E4  4B FC 95 29 */	bl lbl_8028ADCC
/* 802C18A8 002BD6E8  7C 7E 1B 78 */	mr r30, r3
/* 802C18AC 002BD6EC  4B FC 95 21 */	bl lbl_8028ADCC
/* 802C18B0 002BD6F0  4B FC 68 F5 */	bl lbl_802881A4
/* 802C18B4 002BD6F4  7C 7F 1B 78 */	mr r31, r3
/* 802C18B8 002BD6F8  48 14 46 49 */	bl lbl_80405F00
...
/* 802C18D0 002BD710  4B F7 4F 99 */	bl lbl_80236868
/* 802C18D4 002BD714  3C 60 80 48 */	lis r3, lbl_80478AA8@ha
/* 802C18D8 002BD718  38 03 8A A8 */	addi r0, r3, lbl_80478AA8@l
...
/* 802C1914 002BD754  4B FC 94 B9 */	bl lbl_8028ADCC
/* 802C1918 002BD758  4B FC 67 95 */	bl lbl_802880AC
/* 802C191C 002BD75C  4B ED A7 85 */	bl lbl_8019C0A0
/* 802C1920 002BD760  FF E0 08 90 */	fmr f31, f1
/* 802C1924 002BD764  38 61 00 08 */	addi r3, r1, 0x8
/* 802C1928 002BD768  C0 22 BC D0 */	lfs f1, lbl_80561C50@sda21(r2)
/* 802C192C 002BD76C  FC 40 08 90 */	fmr f2, f1
/* 802C1930 002BD770  FC 60 F8 50 */	fneg f3, f31
/* 802C1934 002BD774  4B DF C7 8D */	bl lbl_800BE0C0
/* 802C1938 002BD778  C0 42 BC D0 */	lfs f2, lbl_80561C50@sda21(r2)
/* 802C193C 002BD77C  D0 41 00 14 */	stfs f2, 0x14(r1)
/* 802C1940 002BD780  C0 02 BC D4 */	lfs f0, lbl_80561C54@sda21(r2)
...
/* 802C1958 002BD798  4B DF C7 69 */	bl lbl_800BE0C0
...
/* 802C197C 002BD7BC  4B EB AC 4D */	bl lbl_8017C5C8
/* 802C1980 002BD7C0  38 61 00 44 */	addi r3, r1, 0x44
/* 802C1984 002BD7C4  38 81 00 08 */	addi r4, r1, 0x8
/* 802C1988 002BD7C8  4B EB AC 41 */	bl lbl_8017C5C8
/* 802C198C 002BD7CC  4B FC 94 41 */	bl lbl_8028ADCC
/* 802C1990 002BD7D0  4B FC 67 45 */	bl lbl_802880D4
/* 802C1994 002BD7D4  4B EF 4F 25 */	bl lbl_801B68B8
...
/* 802C19A4 002BD7E4  4B FA C7 95 */	bl lbl_8026E138
...
/* 802C19DC 002BD81C  3C 80 80 48 */	lis r4, lbl_80478A10@ha
/* 802C19E0 002BD820  3B E4 8A 10 */	addi r31, r4, lbl_80478A10@l
/* 802C19E4 002BD824  38 9F 00 00 */	addi r4, r31, 0x0
/* 802C19E8 002BD828  38 BF 00 24 */	addi r5, r31, 0x24
/* 802C19EC 002BD82C  3C C0 80 2C */	lis r6, lbl_802C1A80@ha
/* 802C19F0 002BD830  38 C6 1A 80 */	addi r6, r6, lbl_802C1A80@l
/* 802C19F4 002BD834  4B F0 AB 85 */	bl lbl_801CC578
...
/* 802C1A04 002BD844  3C C0 80 2C */	lis r6, lbl_802C1A7C@ha
/* 802C1A08 002BD848  38 C6 1A 7C */	addi r6, r6, lbl_802C1A7C@l
/* 802C1A0C 002BD84C  4B F0 AB 6D */	bl lbl_801CC578
...
/* 802C1A1C 002BD85C  3C C0 80 2C */	lis r6, lbl_802C1A78@ha
/* 802C1A20 002BD860  38 C6 1A 78 */	addi r6, r6, lbl_802C1A78@l
/* 802C1A24 002BD864  4B F0 AB 55 */	bl lbl_801CC578
...
/* 802C1A34 002BD874  3C C0 80 2C */	lis r6, lbl_802C1A74@ha
/* 802C1A38 002BD878  38 C6 1A 74 */	addi r6, r6, lbl_802C1A74@l
/* 802C1A3C 002BD87C  4B F0 AB 3D */	bl lbl_801CC578
...
/* 802C1A4C 002BD88C  3C C0 80 2C */	lis r6, lbl_802C1A70@ha
/* 802C1A50 002BD890  38 C6 1A 70 */	addi r6, r6, lbl_802C1A70@l
/* 802C1A54 002BD894  4B F0 AB 25 */	bl lbl_801CC578
...
.global lbl_802C1A70
lbl_802C1A70:
/* 802C1A70 002BD8B0  4B FF FE 90 */	b lbl_802C1900
.global lbl_802C1A74
lbl_802C1A74:
/* 802C1A74 002BD8B4  4B FF FE 1C */	b lbl_802C1890
.global lbl_802C1A78
lbl_802C1A78:
/* 802C1A78 002BD8B8  4B FF FD A8 */	b lbl_802C1820
.global lbl_802C1A7C
lbl_802C1A7C:
/* 802C1A7C 002BD8BC  4B FF FD 34 */	b lbl_802C17B0
.global lbl_802C1A80
lbl_802C1A80:
/* 802C1A80 002BD8C0  4B FF FC C0 */	b lbl_802C1740
...
/* 802C1A98 002BD8D8  48 00 07 D0 */	b lbl_802C2268
...
/* 802C1AB4 002BD8F4  48 00 11 A4 */	b lbl_802C2C58
...
/* 802C1AD0 002BD910  48 00 0C 80 */	b lbl_802C2750
...
/* 802C1AEC 002BD92C  48 00 0B B0 */	b lbl_802C269C
/* 802C1AF0 002BD930  4E 80 00 20 */	blr

.global lbl_802C1AF4
lbl_802C1AF4:
/* 802C1AF4 002BD934  4B F6 CB AC */	b lbl_8022E6A0

.global lbl_802C1AF8
lbl_802C1AF8:
/* 802C1AF8 002BD938  4B F6 CB A8 */	b lbl_8022E6A0

.global lbl_802C1AFC
lbl_802C1AFC:
/* 802C1AFC 002BD93C  4B F6 CB A4 */	b lbl_8022E6A0

.global lbl_802C1B00
lbl_802C1B00:
/* 802C1B00 002BD940  4B F6 CB A0 */	b lbl_8022E6A0
