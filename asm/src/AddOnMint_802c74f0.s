...
/* 802C7504 002C3344  4B FC 38 C9 */	bl lbl_8028ADCC
/* 802C7508 002C3348  7C 7E 1B 78 */	mr r30, r3
/* 802C750C 002C334C  4B FC 38 C1 */	bl lbl_8028ADCC
/* 802C7510 002C3350  4B FC 0C 95 */	bl lbl_802881A4
/* 802C7514 002C3354  7C 7F 1B 78 */	mr r31, r3
/* 802C7518 002C3358  48 13 E9 E9 */	bl lbl_80405F00
...
/* 802C7530 002C3370  4B F6 F3 39 */	bl lbl_80236868
/* 802C7534 002C3374  3C 60 80 48 */	lis r3, lbl_804796F0@ha
/* 802C7538 002C3378  38 03 96 F0 */	addi r0, r3, lbl_804796F0@l
...
/* 802C7574 002C33B4  4B FC 38 59 */	bl lbl_8028ADCC
/* 802C7578 002C33B8  7C 7E 1B 78 */	mr r30, r3
/* 802C757C 002C33BC  4B FC 38 51 */	bl lbl_8028ADCC
/* 802C7580 002C33C0  4B FC 0C 25 */	bl lbl_802881A4
/* 802C7584 002C33C4  7C 7F 1B 78 */	mr r31, r3
/* 802C7588 002C33C8  48 13 E9 79 */	bl lbl_80405F00
...
/* 802C75A0 002C33E0  4B F6 F2 C9 */	bl lbl_80236868
/* 802C75A4 002C33E4  3C 60 80 48 */	lis r3, lbl_804796E0@ha
/* 802C75A8 002C33E8  38 03 96 E0 */	addi r0, r3, lbl_804796E0@l
...
/* 802C75DC 002C341C  4B FC 37 F1 */	bl lbl_8028ADCC
/* 802C75E0 002C3420  4B FC 0A ED */	bl lbl_802880CC
/* 802C75E4 002C3424  38 80 00 03 */	li r4, 0x3
/* 802C75E8 002C3428  4B FA 9C 95 */	bl lbl_8027127C
...
/* 802C7610 002C3450  4B FC 37 BD */	bl lbl_8028ADCC
/* 802C7614 002C3454  7C 7E 1B 78 */	mr r30, r3
/* 802C7618 002C3458  4B FC 37 B5 */	bl lbl_8028ADCC
/* 802C761C 002C345C  4B FC 0B 89 */	bl lbl_802881A4
/* 802C7620 002C3460  7C 7F 1B 78 */	mr r31, r3
/* 802C7624 002C3464  48 13 E8 DD */	bl lbl_80405F00
...
/* 802C763C 002C347C  4B F6 F2 2D */	bl lbl_80236868
/* 802C7640 002C3480  3C 60 80 48 */	lis r3, lbl_804796D0@ha
/* 802C7644 002C3484  38 03 96 D0 */	addi r0, r3, lbl_804796D0@l
...
/* 802C7684 002C34C4  3C 80 80 48 */	lis r4, lbl_80479640@ha
/* 802C7688 002C34C8  3B E4 96 40 */	addi r31, r4, lbl_80479640@l
/* 802C768C 002C34CC  38 9F 00 00 */	addi r4, r31, 0x0
/* 802C7690 002C34D0  38 BF 00 24 */	addi r5, r31, 0x24
/* 802C7694 002C34D4  3C C0 80 2C */	lis r6, lbl_802C770C@ha
/* 802C7698 002C34D8  38 C6 77 0C */	addi r6, r6, lbl_802C770C@l
/* 802C769C 002C34DC  4B F0 4E DD */	bl lbl_801CC578
...
/* 802C76AC 002C34EC  3C C0 80 2C */	lis r6, lbl_802C7708@ha
/* 802C76B0 002C34F0  38 C6 77 08 */	addi r6, r6, lbl_802C7708@l
/* 802C76B4 002C34F4  4B F0 4E C5 */	bl lbl_801CC578
...
/* 802C76C4 002C3504  3C C0 80 2C */	lis r6, lbl_802C7704@ha
/* 802C76C8 002C3508  38 C6 77 04 */	addi r6, r6, lbl_802C7704@l
/* 802C76CC 002C350C  4B F0 4E AD */	bl lbl_801CC578
...
/* 802C76DC 002C351C  3C C0 80 2C */	lis r6, lbl_802C7700@ha
/* 802C76E0 002C3520  38 C6 77 00 */	addi r6, r6, lbl_802C7700@l
/* 802C76E4 002C3524  4B F0 4E 95 */	bl lbl_801CC578
...
.global lbl_802C7700
lbl_802C7700:
/* 802C7700 002C3540  4B FF FE D0 */	b lbl_802C75D0
.global lbl_802C7704
lbl_802C7704:
/* 802C7704 002C3544  4B FF FE F8 */	b lbl_802C75FC
.global lbl_802C7708
lbl_802C7708:
/* 802C7708 002C3548  4B FF FE 58 */	b lbl_802C7560
.global lbl_802C770C
lbl_802C770C:
/* 802C770C 002C354C  4B FF FD E4 */	b lbl_802C74F0
...
/* 802C7724 002C3564  48 00 10 B8 */	b lbl_802C87DC
...
/* 802C7740 002C3580  48 00 11 D0 */	b lbl_802C8910
...
/* 802C775C 002C359C  48 00 19 FC */	b lbl_802C9158
/* 802C7760 002C35A0  4E 80 00 20 */	blr

.global lbl_802C7764
lbl_802C7764:
/* 802C7764 002C35A4  4B F6 6F 3C */	b lbl_8022E6A0

.global lbl_802C7768
lbl_802C7768:
/* 802C7768 002C35A8  4B F6 6F 38 */	b lbl_8022E6A0

.global lbl_802C776C
lbl_802C776C:
/* 802C776C 002C35AC  4B F6 6F 34 */	b lbl_8022E6A0
