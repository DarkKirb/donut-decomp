...
/* 802C9804 002C5644  4B FC 15 C9 */	bl lbl_8028ADCC
/* 802C9808 002C5648  4B FB E8 7D */	bl lbl_80288084
/* 802C980C 002C564C  4B FC 3A 1D */	bl lbl_8028D228
/* 802C9810 002C5650  83 C3 00 1C */	lwz r30, 0x1c(r3)
/* 802C9814 002C5654  38 60 00 64 */	li r3, 0x64
/* 802C9818 002C5658  4B EB 12 B5 */	bl lbl_8017AACC
/* 802C981C 002C565C  7C 03 F0 40 */	cmplw r3, r30
/* 802C9820 002C5660  40 80 00 4C */	bge lbl_802C986C
/* 802C9824 002C5664  4B FC 15 A9 */	bl lbl_8028ADCC
/* 802C9828 002C5668  7C 7F 1B 78 */	mr r31, r3
/* 802C982C 002C566C  4B FC 15 A1 */	bl lbl_8028ADCC
/* 802C9830 002C5670  4B FB E9 75 */	bl lbl_802881A4
/* 802C9834 002C5674  7C 7E 1B 78 */	mr r30, r3
/* 802C9838 002C5678  48 13 C6 C9 */	bl lbl_80405F00
...
/* 802C9850 002C5690  4B F6 D0 19 */	bl lbl_80236868
/* 802C9854 002C5694  3C 60 80 48 */	lis r3, lbl_80479B10@ha
/* 802C9858 002C5698  38 03 9B 10 */	addi r0, r3, lbl_80479B10@l
...
.global lbl_802C986C
lbl_802C986C:
/* 802C986C 002C56AC  4B FC 15 61 */	bl lbl_8028ADCC
/* 802C9870 002C56B0  7C 7E 1B 78 */	mr r30, r3
/* 802C9874 002C56B4  4B FC 15 59 */	bl lbl_8028ADCC
/* 802C9878 002C56B8  4B FB E9 2D */	bl lbl_802881A4
/* 802C987C 002C56BC  7C 7F 1B 78 */	mr r31, r3
/* 802C9880 002C56C0  48 13 C6 81 */	bl lbl_80405F00
...
/* 802C9898 002C56D8  4B F6 CF D1 */	bl lbl_80236868
/* 802C989C 002C56DC  3C 60 80 48 */	lis r3, lbl_80479B20@ha
/* 802C98A0 002C56E0  38 03 9B 20 */	addi r0, r3, lbl_80479B20@l
...
/* 802C98E0 002C5720  3C 80 80 48 */	lis r4, lbl_80479A78@ha
/* 802C98E4 002C5724  3B E4 9A 78 */	addi r31, r4, lbl_80479A78@l
/* 802C98E8 002C5728  38 9F 00 00 */	addi r4, r31, 0x0
/* 802C98EC 002C572C  38 BF 00 24 */	addi r5, r31, 0x24
/* 802C98F0 002C5730  3C C0 80 2D */	lis r6, lbl_802C9A48@ha
/* 802C98F4 002C5734  38 C6 9A 48 */	addi r6, r6, lbl_802C9A48@l
/* 802C98F8 002C5738  4B F0 2C 81 */	bl lbl_801CC578
...
/* 802C9908 002C5748  3C C0 80 2D */	lis r6, lbl_802C99D4@ha
/* 802C990C 002C574C  38 C6 99 D4 */	addi r6, r6, lbl_802C99D4@l
/* 802C9910 002C5750  4B F0 2C 69 */	bl lbl_801CC578
...
/* 802C9920 002C5760  3C C0 80 2D */	lis r6, lbl_802C9960@ha
/* 802C9924 002C5764  38 C6 99 60 */	addi r6, r6, lbl_802C9960@l
/* 802C9928 002C5768  4B F0 2C 51 */	bl lbl_801CC578
...
/* 802C9938 002C5778  3C C0 80 2D */	lis r6, lbl_802C995C@ha
/* 802C993C 002C577C  38 C6 99 5C */	addi r6, r6, lbl_802C995C@l
/* 802C9940 002C5780  4B F0 2C 39 */	bl lbl_801CC578
...
.global lbl_802C995C
lbl_802C995C:
/* 802C995C 002C579C  4B FF FE 94 */	b lbl_802C97F0
.global lbl_802C9960
lbl_802C9960:
/* 802C9960 002C57A0  48 00 00 04 */	b lbl_802C9964
.global lbl_802C9964
lbl_802C9964:
...
/* 802C9978 002C57B8  4B FC 14 55 */	bl lbl_8028ADCC
/* 802C997C 002C57BC  7C 7E 1B 78 */	mr r30, r3
/* 802C9980 002C57C0  4B FC 14 4D */	bl lbl_8028ADCC
/* 802C9984 002C57C4  4B FB E8 21 */	bl lbl_802881A4
/* 802C9988 002C57C8  7C 7F 1B 78 */	mr r31, r3
/* 802C998C 002C57CC  48 13 C5 75 */	bl lbl_80405F00
...
/* 802C99A4 002C57E4  4B F6 CE C5 */	bl lbl_80236868
/* 802C99A8 002C57E8  3C 60 80 48 */	lis r3, lbl_80479B00@ha
/* 802C99AC 002C57EC  38 03 9B 00 */	addi r0, r3, lbl_80479B00@l
...
.global lbl_802C99D4
lbl_802C99D4:
/* 802C99D4 002C5814  48 00 00 04 */	b lbl_802C99D8
.global lbl_802C99D8
lbl_802C99D8:
...
/* 802C99EC 002C582C  4B FC 13 E1 */	bl lbl_8028ADCC
/* 802C99F0 002C5830  7C 7E 1B 78 */	mr r30, r3
/* 802C99F4 002C5834  4B FC 13 D9 */	bl lbl_8028ADCC
/* 802C99F8 002C5838  4B FB E7 AD */	bl lbl_802881A4
/* 802C99FC 002C583C  7C 7F 1B 78 */	mr r31, r3
/* 802C9A00 002C5840  48 13 C5 01 */	bl lbl_80405F00
...
/* 802C9A18 002C5858  4B F6 CE 51 */	bl lbl_80236868
/* 802C9A1C 002C585C  3C 60 80 48 */	lis r3, lbl_80479AF0@ha
/* 802C9A20 002C5860  38 03 9A F0 */	addi r0, r3, lbl_80479AF0@l
...
.global lbl_802C9A48
lbl_802C9A48:
/* 802C9A48 002C5888  4B FC 72 90 */	b lbl_80290CD8
...
/* 802C9A60 002C58A0  48 00 0E E0 */	b lbl_802CA940
...
/* 802C9A7C 002C58BC  48 00 0C B0 */	b lbl_802CA72C
...
/* 802C9A98 002C58D8  48 00 05 6C */	b lbl_802CA004
...
/* 802C9AB4 002C58F4  48 00 08 B8 */	b lbl_802CA36C
/* 802C9AB8 002C58F8  4E 80 00 20 */	blr

.global lbl_802C9ABC
lbl_802C9ABC:
/* 802C9ABC 002C58FC  4B F6 4B E4 */	b lbl_8022E6A0

.global lbl_802C9AC0
lbl_802C9AC0:
/* 802C9AC0 002C5900  4B F6 4B E0 */	b lbl_8022E6A0

.global lbl_802C9AC4
lbl_802C9AC4:
/* 802C9AC4 002C5904  4B F6 4B DC */	b lbl_8022E6A0

.global lbl_802C9AC8
lbl_802C9AC8:
/* 802C9AC8 002C5908  4B F6 4B D8 */	b lbl_8022E6A0
