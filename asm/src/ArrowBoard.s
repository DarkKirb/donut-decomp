...
/* 802FE40C 002FA24C  80 9D 00 08 */	lwz r4, 8(r29)
/* 802FE410 002FA250  38 CD C1 24 */	addi r6, r13, $$254296-_SDA_BASE_
/* 802FE414 002FA254  38 E0 00 01 */	li r7, 1
/* 802FE418 002FA258  39 00 00 00 */	li r8, 0
...
/* 802FE448 002FA288  38 A0 00 02 */	li r5, 2
...
/* 802FE470 002FA2B0  80 9D 00 08 */	lwz r4, 8(r29)
...
/* 802FE48C 002FA2CC  38 00 00 00 */	li r0, 0
...
/* 802FE4AC 002FA2EC  3C 60 80 42 */	lis r3, $$253055@ha
/* 802FE4B0 002FA2F0  38 83 96 E8 */	addi r4, r3, $$253055@l
/* 802FE4B4 002FA2F4  80 64 00 00 */	lwz r3, 0(r4)
/* 802FE4B8 002FA2F8  80 04 00 04 */	lwz r0, 4(r4)
/* 802FE4BC 002FA2FC  90 61 00 28 */	stw r3, 0x28(r1)
/* 802FE4C0 002FA300  90 01 00 2C */	stw r0, 0x2c(r1)
/* 802FE4C4 002FA304  80 64 00 08 */	lwz r3, 8(r4)
...
/* 802FE508 002FA348  38 80 FF FD */	li r4, -3
...
/* 802FE538 002FA378  4B D0 8E 59 */	bl func_80007390
...
/* 802FE55C 002FA39C  93 C1 00 08 */	stw r30, 8(r1)
/* 802FE560 002FA3A0  7C 7E 1B 78 */	mr r30, r3
/* 802FE564 002FA3A4  7C 9F 23 78 */	mr r31, r4
/* 802FE568 002FA3A8  2C 03 00 00 */	cmpwi r3, 0
...
/* 802FE5F8 002FA438  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 802FE61C 002FA45C  F3 E1 00 38 */	psq_st f31, 56(r1), 0, qr0
...
/* 802FE634 002FA474  2C 03 00 00 */	cmpwi r3, 0
...
/* 802FE648 002FA488  2C 00 00 01 */	cmpwi r0, 1
/* 802FE64C 002FA48C  40 82 00 D0 */	bne lbl_802FE71C
/* 802FE650 002FA490  7F C3 F3 78 */	mr r3, r30
/* 802FE654 002FA494  4B EF B9 F9 */	bl data$$0Q43scn4step9challenge5Param$$1__Q25param13ParamAccessorCFv_RCQ43scn4step9challenge5Param
/* 802FE658 002FA498  C3 E3 00 00 */	lfs f31, 0(r3)
/* 802FE65C 002FA49C  3B E0 00 00 */	li r31, 0
/* 802FE660 002FA4A0  80 7E 00 08 */	lwz r3, 8(r30)
...
/* 802FE688 002FA4C8  3B E0 00 01 */	li r31, 1
lbl_802FE68C:
...
/* 802FE6A0 002FA4E0  3B E0 00 01 */	li r31, 1
lbl_802FE6A4:
...
/* 802FE6B8 002FA4F8  3B E0 00 01 */	li r31, 1
lbl_802FE6BC:
...
/* 802FE6D0 002FA510  3B E0 00 01 */	li r31, 1
lbl_802FE6D4:
/* 802FE6D4 002FA514  2C 1F 00 00 */	cmpwi r31, 0
/* 802FE6D8 002FA518  41 82 00 38 */	beq lbl_802FE710
/* 802FE6DC 002FA51C  38 61 00 08 */	addi r3, r1, 8
/* 802FE6E0 002FA520  38 9E 00 14 */	addi r4, r30, 0x14
/* 802FE6E4 002FA524  4B FF 8B 29 */	bl model__Q43scn4step7gimmick5ModelFv
/* 802FE6E8 002FA528  38 61 00 08 */	addi r3, r1, 8
/* 802FE6EC 002FA52C  38 80 00 01 */	li r4, 1
/* 802FE6F0 002FA530  4B E9 20 51 */	bl setVisibility__Q23g3d13ModelAccessorCFb
/* 802FE6F4 002FA534  38 61 00 08 */	addi r3, r1, 8
/* 802FE6F8 002FA538  38 80 FF FF */	li r4, -1
...
/* 802FE748 002FA588  38 80 00 00 */	li r4, 0
...
/* 802FE7AC 002FA5EC  2C 03 00 00 */	cmpwi r3, 0
...
/* 802FE7BC 002FA5FC  2C 03 00 00 */	cmpwi r3, 0
...
/* 802FE800 002FA640  38 81 00 08 */	addi r4, r1, 8
...
/* 802FE814 002FA654  38 C0 00 00 */	li r6, 0
...
/* 802FE830 002FA670  38 00 00 01 */	li r0, 1
...
/* 802FE890 002FA6D0  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 802FE8D8 002FA718  38 AD C1 24 */	addi r5, r13, $$254296-_SDA_BASE_
/* 802FE8DC 002FA71C  4B E9 1E 55 */	bl nodeByName__Q23g3d13ModelAccessorCFPCc
/* 802FE8E0 002FA720  38 61 00 44 */	addi r3, r1, 0x44
/* 802FE8E4 002FA724  4B E7 DD 01 */	bl isLink__Q24util51ObjListNode$$0Q23g3d5Model$$4Q24util16ObjListDummyType$$1CFv
/* 802FE8E8 002FA728  2C 03 00 00 */	cmpwi r3, 0
/* 802FE8EC 002FA72C  41 82 00 0C */	beq lbl_802FE8F8
/* 802FE8F0 002FA730  38 61 00 44 */	addi r3, r1, 0x44
/* 802FE8F4 002FA734  4B E7 DD 01 */	bl unlink__Q24util51ObjListNode$$0Q23g3d5Model$$4Q24util16ObjListDummyType$$1Fv
lbl_802FE8F8:
/* 802FE8F8 002FA738  38 00 00 00 */	li r0, 0
/* 802FE8FC 002FA73C  90 01 00 50 */	stw r0, 0x50(r1)
/* 802FE900 002FA740  80 01 00 3C */	lwz r0, 0x3c(r1)
/* 802FE904 002FA744  2C 00 00 00 */	cmpwi r0, 0
...
/* 802FE914 002FA754  4B E7 DC D1 */	bl isLink__Q24util51ObjListNode$$0Q23g3d5Model$$4Q24util16ObjListDummyType$$1CFv
/* 802FE918 002FA758  2C 03 00 00 */	cmpwi r3, 0
...
/* 802FE928 002FA768  38 1F 00 04 */	addi r0, r31, 4
/* 802FE92C 002FA76C  90 01 00 08 */	stw r0, 8(r1)
/* 802FE930 002FA770  38 61 00 44 */	addi r3, r1, 0x44
/* 802FE934 002FA774  4B E7 DD 0D */	bl GetNodeFromPointer__Q34nw4r2ut72LinkList$$0Q24util51ObjListNode$$0Q23g3d5Model$$4Q24util16ObjListDummyType$$1$$40$$1FPQ24util51ObjListNode$$0Q23g3d5Model$$4Q24util16ObjListDummyType$$1
/* 802FE938 002FA778  7C 65 1B 78 */	mr r5, r3
/* 802FE93C 002FA77C  7F E3 FB 78 */	mr r3, r31
/* 802FE940 002FA780  38 81 00 08 */	addi r4, r1, 8
...
/* 802FE954 002FA794  38 80 FF FF */	li r4, -1
/* 802FE958 002FA798  4B E7 DD 39 */	bl __dt__Q23g3d12NodeAccessorFv
/* 802FE95C 002FA79C  38 61 00 20 */	addi r3, r1, 0x20
/* 802FE960 002FA7A0  38 80 FF FF */	li r4, -1
/* 802FE964 002FA7A4  4B E7 D5 E5 */	bl __dt__Q23g3d13ModelAccessorFv
/* 802FE968 002FA7A8  7F C3 F3 78 */	mr r3, r30
/* 802FE96C 002FA7AC  4B EF B6 E1 */	bl data$$0Q43scn4step9challenge5Param$$1__Q25param13ParamAccessorCFv_RCQ43scn4step9challenge5Param
/* 802FE970 002FA7B0  C0 03 00 04 */	lfs f0, 4(r3)
...
/* 802FE9A8 002FA7E8  38 00 00 00 */	li r0, 0
...
/* 802FE9C0 002FA800  38 80 FF FF */	li r4, -1
...
/* 802FE9F8 002FA838  4B EF B6 55 */	bl data$$0Q43scn4step9challenge5Param$$1__Q25param13ParamAccessorCFv_RCQ43scn4step9challenge5Param
/* 802FE9FC 002FA83C  C0 03 00 08 */	lfs f0, 8(r3)
/* 802FEA00 002FA840  D0 1F 00 00 */	stfs f0, 0(r31)
/* 802FEA04 002FA844  C0 03 00 0C */	lfs f0, 0xc(r3)
/* 802FEA08 002FA848  D0 1F 00 04 */	stfs f0, 4(r31)
...
/* 802FEA44 002FA884  38 61 00 08 */	addi r3, r1, 8
...
/* 802FEAA4 002FA8E4  3C 80 80 48 */	lis r4, $$254295@ha
/* 802FEAA8 002FA8E8  3B E4 F9 70 */	addi r31, r4, $$254295@l
/* 802FEAAC 002FA8EC  80 63 00 08 */	lwz r3, 8(r3)
...
/* 802FEAB8 002FA8F8  38 03 FF FE */	addi r0, r3, -2
/* 802FEABC 002FA8FC  28 00 00 01 */	cmplwi r0, 1
/* 802FEAC0 002FA900  40 81 00 28 */	ble lbl_802FEAE8
/* 802FEAC4 002FA904  2C 03 00 00 */	cmpwi r3, 0
/* 802FEAC8 002FA908  41 82 00 10 */	beq lbl_802FEAD8
/* 802FEACC 002FA90C  2C 03 00 01 */	cmpwi r3, 1
...
lbl_802FEAF0:
/* 802FEAF0 002FA930  38 6D C1 2C */	addi r3, r13, $$254469-_SDA_BASE_
lbl_802FEAF4:
