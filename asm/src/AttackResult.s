...
/* 801D4D90 001D0BD0  90 83 00 00 */	stw r4, 0(r3)
/* 801D4D94 001D0BD4  38 A3 00 08 */	addi r5, r3, 8
/* 801D4D98 001D0BD8  C0 02 9C F8 */	lfs f0, $$250282-_SDA2_BASE_(r2)
/* 801D4D9C 001D0BDC  38 03 01 98 */	addi r0, r3, 0x198
lbl_801D4DA0:
/* 801D4DA0 001D0BE0  90 85 00 00 */	stw r4, 0(r5)
/* 801D4DA4 001D0BE4  90 85 00 04 */	stw r4, 4(r5)
/* 801D4DA8 001D0BE8  D0 05 00 0C */	stfs f0, 0xc(r5)
/* 801D4DAC 001D0BEC  D0 05 00 08 */	stfs f0, 8(r5)
...
/* 801D4DE4 001D0C24  93 C1 00 08 */	stw r30, 8(r1)
/* 801D4DE8 001D0C28  7C 7E 1B 78 */	mr r30, r3
/* 801D4DEC 001D0C2C  7C 9F 23 78 */	mr r31, r4
/* 801D4DF0 001D0C30  80 03 00 00 */	lwz r0, 0(r3)
/* 801D4DF4 001D0C34  28 00 00 0A */	cmplwi r0, 0xa
/* 801D4DF8 001D0C38  41 82 00 24 */	beq lbl_801D4E1C
/* 801D4DFC 001D0C3C  38 63 00 08 */	addi r3, r3, 8
/* 801D4E00 001D0C40  80 9E 00 00 */	lwz r4, 0(r30)
/* 801D4E04 001D0C44  48 00 00 31 */	bl __vc__Q33hel6common38Array$$0Q35ocoll12AttackResult5Datum$$410$$1FUl
...
/* 801D4E10 001D0C50  80 7E 00 00 */	lwz r3, 0(r30)
/* 801D4E14 001D0C54  38 03 00 01 */	addi r0, r3, 1
/* 801D4E18 001D0C58  90 1E 00 00 */	stw r0, 0(r30)
lbl_801D4E1C:
/* 801D4E1C 001D0C5C  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 801D4E20 001D0C60  83 C1 00 08 */	lwz r30, 8(r1)
...
.global __vc__Q33hel6common38Array$$0Q35ocoll12AttackResult5Datum$$410$$1FUl
__vc__Q33hel6common38Array$$0Q35ocoll12AttackResult5Datum$$410$$1FUl:
...
/* 801D4E44 001D0C84  93 C1 00 08 */	stw r30, 8(r1)
...
/* 801D4E68 001D0CA8  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 801D4E7C 001D0CBC  80 04 00 00 */	lwz r0, 0(r4)
/* 801D4E80 001D0CC0  90 03 00 00 */	stw r0, 0(r3)
/* 801D4E84 001D0CC4  80 04 00 04 */	lwz r0, 4(r4)
/* 801D4E88 001D0CC8  90 03 00 04 */	stw r0, 4(r3)
/* 801D4E8C 001D0CCC  80 A4 00 08 */	lwz r5, 8(r4)
/* 801D4E90 001D0CD0  80 04 00 0C */	lwz r0, 0xc(r4)
/* 801D4E94 001D0CD4  90 A3 00 08 */	stw r5, 8(r3)
...
/* 801D4ED8 001D0D18  4B E3 24 6D */	bl func_80007344
/* 801D4EDC 001D0D1C  7C 7D 1B 78 */	mr r29, r3
/* 801D4EE0 001D0D20  7C 9E 23 78 */	mr r30, r4
/* 801D4EE4 001D0D24  3B E0 00 00 */	li r31, 0
...
/* 801D4EF4 001D0D34  48 00 00 45 */	bl __vc__Q33hel6common45MutableArray$$0Q35ocoll12AttackResult5Datum$$410$$1CFUl
/* 801D4EF8 001D0D38  80 03 00 00 */	lwz r0, 0(r3)
/* 801D4EFC 001D0D3C  7C 1E 00 40 */	cmplw r30, r0
/* 801D4F00 001D0D40  40 82 00 0C */	bne lbl_801D4F0C
/* 801D4F04 001D0D44  38 60 00 01 */	li r3, 1
/* 801D4F08 001D0D48  48 00 00 18 */	b lbl_801D4F20
lbl_801D4F0C:
/* 801D4F0C 001D0D4C  3B FF 00 01 */	addi r31, r31, 1
lbl_801D4F10:
/* 801D4F10 001D0D50  80 1D 00 00 */	lwz r0, 0(r29)
/* 801D4F14 001D0D54  7C 1F 00 40 */	cmplw r31, r0
/* 801D4F18 001D0D58  41 80 FF D4 */	blt lbl_801D4EEC
/* 801D4F1C 001D0D5C  38 60 00 00 */	li r3, 0
lbl_801D4F20:
/* 801D4F20 001D0D60  39 61 00 20 */	addi r11, r1, 0x20
/* 801D4F24 001D0D64  4B E3 24 6D */	bl func_80007390
...
.global __vc__Q33hel6common45MutableArray$$0Q35ocoll12AttackResult5Datum$$410$$1CFUl
__vc__Q33hel6common45MutableArray$$0Q35ocoll12AttackResult5Datum$$410$$1CFUl:
...
/* 801D4F74 001D0DB4  38 63 00 08 */	addi r3, r3, 8
/* 801D4F78 001D0DB8  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 801D4F7C 001D0DBC  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 801D4F90 001D0DD0  4B FF FF A8 */	b __vc__Q33hel6common45MutableArray$$0Q35ocoll12AttackResult5Datum$$410$$1CFUl
...
/* 801D4FA4 001D0DE4  4B E3 23 99 */	bl func_8000733C
/* 801D4FA8 001D0DE8  7C 7E 1B 78 */	mr r30, r3
/* 801D4FAC 001D0DEC  7C 9F 23 78 */	mr r31, r4
/* 801D4FB0 001D0DF0  80 03 00 00 */	lwz r0, 0(r3)
/* 801D4FB4 001D0DF4  28 00 00 02 */	cmplwi r0, 2
/* 801D4FB8 001D0DF8  41 80 01 04 */	blt lbl_801D50BC
/* 801D4FBC 001D0DFC  3B 80 00 00 */	li r28, 0
...
/* 801D4FD0 001D0E10  48 00 01 05 */	bl __vc__Q33hel6common45MutableArray$$0Q35ocoll12AttackResult5Datum$$410$$1FUl
/* 801D4FD4 001D0E14  7C 64 1B 78 */	mr r4, r3
/* 801D4FD8 001D0E18  7F E3 FB 78 */	mr r3, r31
/* 801D4FDC 001D0E1C  80 84 00 04 */	lwz r4, 4(r4)
/* 801D4FE0 001D0E20  48 00 0B E9 */	bl getAttackData__Q25ocoll13CollDataTableCFUl
/* 801D4FE4 001D0E24  A3 A3 00 00 */	lhz r29, 0(r3)
/* 801D4FE8 001D0E28  7F C3 F3 78 */	mr r3, r30
/* 801D4FEC 001D0E2C  38 9B FF FF */	addi r4, r27, -1
/* 801D4FF0 001D0E30  48 00 00 E5 */	bl __vc__Q33hel6common45MutableArray$$0Q35ocoll12AttackResult5Datum$$410$$1FUl
/* 801D4FF4 001D0E34  7C 64 1B 78 */	mr r4, r3
/* 801D4FF8 001D0E38  7F E3 FB 78 */	mr r3, r31
/* 801D4FFC 001D0E3C  80 84 00 04 */	lwz r4, 4(r4)
/* 801D5000 001D0E40  48 00 0B C9 */	bl getAttackData__Q25ocoll13CollDataTableCFUl
/* 801D5004 001D0E44  A0 03 00 00 */	lhz r0, 0(r3)
...
/* 801D5018 001D0E58  48 00 00 BD */	bl __vc__Q33hel6common45MutableArray$$0Q35ocoll12AttackResult5Datum$$410$$1FUl
/* 801D501C 001D0E5C  80 03 00 00 */	lwz r0, 0(r3)
/* 801D5020 001D0E60  90 01 00 08 */	stw r0, 8(r1)
/* 801D5024 001D0E64  80 03 00 04 */	lwz r0, 4(r3)
/* 801D5028 001D0E68  90 01 00 0C */	stw r0, 0xc(r1)
/* 801D502C 001D0E6C  C0 03 00 08 */	lfs f0, 8(r3)
...
/* 801D5068 001D0EA8  38 9B FF FF */	addi r4, r27, -1
/* 801D506C 001D0EAC  48 00 00 69 */	bl __vc__Q33hel6common45MutableArray$$0Q35ocoll12AttackResult5Datum$$410$$1FUl
/* 801D5070 001D0EB0  7C 7D 1B 78 */	mr r29, r3
/* 801D5074 001D0EB4  7F C3 F3 78 */	mr r3, r30
/* 801D5078 001D0EB8  7F 64 DB 78 */	mr r4, r27
/* 801D507C 001D0EBC  48 00 00 59 */	bl __vc__Q33hel6common45MutableArray$$0Q35ocoll12AttackResult5Datum$$410$$1FUl
...
/* 801D508C 001D0ECC  38 9B FF FF */	addi r4, r27, -1
/* 801D5090 001D0ED0  48 00 00 45 */	bl __vc__Q33hel6common45MutableArray$$0Q35ocoll12AttackResult5Datum$$410$$1FUl
/* 801D5094 001D0ED4  38 81 00 08 */	addi r4, r1, 8
/* 801D5098 001D0ED8  4B FF FD E5 */	bl __as__Q35ocoll12AttackResult5DatumFRCQ35ocoll12AttackResult5Datum
lbl_801D509C:
/* 801D509C 001D0EDC  3B 7B FF FF */	addi r27, r27, -1
lbl_801D50A0:
/* 801D50A0 001D0EE0  7C 1B E0 40 */	cmplw r27, r28
/* 801D50A4 001D0EE4  41 81 FF 24 */	bgt lbl_801D4FC8
/* 801D50A8 001D0EE8  3B 9C 00 01 */	addi r28, r28, 1
lbl_801D50AC:
/* 801D50AC 001D0EEC  80 7E 00 00 */	lwz r3, 0(r30)
/* 801D50B0 001D0EF0  3B 63 FF FF */	addi r27, r3, -1
...
/* 801D50C0 001D0F00  4B E3 22 C9 */	bl func_80007388
...
.global __vc__Q33hel6common45MutableArray$$0Q35ocoll12AttackResult5Datum$$410$$1FUl
__vc__Q33hel6common45MutableArray$$0Q35ocoll12AttackResult5Datum$$410$$1FUl:
...
/* 801D50E4 001D0F24  93 C1 00 08 */	stw r30, 8(r1)
/* 801D50E8 001D0F28  7C 7E 1B 78 */	mr r30, r3
/* 801D50EC 001D0F2C  7C 9F 23 78 */	mr r31, r4
/* 801D50F0 001D0F30  7F E3 FB 78 */	mr r3, r31
/* 801D50F4 001D0F34  80 9E 00 00 */	lwz r4, 0(r30)
/* 801D50F8 001D0F38  4B E4 F3 A9 */	bl DefaultSwitchThreadCallback
/* 801D50FC 001D0F3C  38 7E 00 08 */	addi r3, r30, 8
/* 801D5100 001D0F40  7F E4 FB 78 */	mr r4, r31
/* 801D5104 001D0F44  4B FF FD 31 */	bl __vc__Q33hel6common38Array$$0Q35ocoll12AttackResult5Datum$$410$$1FUl
/* 801D5108 001D0F48  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 801D510C 001D0F4C  83 C1 00 08 */	lwz r30, 8(r1)
