...
/* 80404354 00400194  38 04 00 01 */	addi r0, r4, 1
/* 80404358 00400198  90 03 00 1C */	stw r0, 0x1c(r3)
/* 8040435C 0040019C  2C 00 00 03 */	cmpwi r0, 3
/* 80404360 004001A0  4C 81 00 20 */	blelr 
/* 80404364 004001A4  38 00 00 03 */	li r0, 3
...
/* 8040437C 004001BC  38 C0 00 00 */	li r6, 0
/* 80404380 004001C0  38 E0 00 00 */	li r7, 0
/* 80404384 004001C4  38 80 00 00 */	li r4, 0
/* 80404388 004001C8  38 00 00 10 */	li r0, 0x10
/* 8040438C 004001CC  7C 09 03 A6 */	mtctr r0
lbl_80404390:
/* 80404390 004001D0  38 07 FF F3 */	addi r0, r7, -13
/* 80404394 004001D4  28 00 00 02 */	cmplwi r0, 2
/* 80404398 004001D8  40 81 00 1C */	ble lbl_804043B4
/* 8040439C 004001DC  7C A3 22 14 */	add r5, r3, r4
/* 804043A0 004001E0  80 05 00 00 */	lwz r0, 0(r5)
/* 804043A4 004001E4  2C 00 00 01 */	cmpwi r0, 1
/* 804043A8 004001E8  41 80 00 0C */	blt lbl_804043B4
/* 804043AC 004001EC  80 05 00 04 */	lwz r0, 4(r5)
/* 804043B0 004001F0  7C C6 02 14 */	add r6, r6, r0
lbl_804043B4:
/* 804043B4 004001F4  38 E7 00 01 */	addi r7, r7, 1
...
/* 804043D8 00400218  4B C0 2F 69 */	bl func_80007340
...
/* 804043EC 0040022C  83 BE 00 00 */	lwz r29, 0(r30)
/* 804043F0 00400230  38 C0 00 00 */	li r6, 0
/* 804043F4 00400234  38 60 00 00 */	li r3, 0
/* 804043F8 00400238  38 1D 00 01 */	addi r0, r29, 1
/* 804043FC 0040023C  7C 09 03 A6 */	mtctr r0
/* 80404400 00400240  2C 00 00 00 */	cmpwi r0, 0
...
/* 80404460 004002A0  90 A3 00 04 */	stw r5, 4(r3)
/* 80404464 004002A4  90 E3 00 10 */	stw r7, 0x10(r3)
/* 80404468 004002A8  2C 06 00 00 */	cmpwi r6, 0
/* 8040446C 004002AC  40 82 00 24 */	bne lbl_80404490
/* 80404470 004002B0  80 6D ED 10 */	lwz r3, object___Q33hel6common38ExplicitSingleton$$0Q23app11Application$$1-_SDA_BASE_(r13)
...
lbl_80404484:
/* 80404484 004002C4  38 C6 00 01 */	addi r6, r6, 1
/* 80404488 004002C8  38 63 00 04 */	addi r3, r3, 4
/* 8040448C 004002CC  42 00 FF 7C */	bdnz lbl_80404408
lbl_80404490:
/* 80404490 004002D0  2C 1D 00 03 */	cmpwi r29, 3
/* 80404494 004002D4  40 80 00 0C */	bge lbl_804044A0
/* 80404498 004002D8  38 1D 00 01 */	addi r0, r29, 1
/* 8040449C 004002DC  90 1E 00 00 */	stw r0, 0(r30)
lbl_804044A0:
...
/* 804044B4 004002F4  4B C0 2E D9 */	bl func_8000738C
...
/* 804044F0 00400330  93 C1 00 08 */	stw r30, 8(r1)
/* 804044F4 00400334  7C 7E 1B 78 */	mr r30, r3
/* 804044F8 00400338  3B E0 00 00 */	li r31, 0
/* 804044FC 0040033C  80 6D ED 10 */	lwz r3, object___Q33hel6common38ExplicitSingleton$$0Q23app11Application$$1-_SDA_BASE_(r13)
...
/* 8040453C 0040037C  38 80 00 00 */	li r4, 0
...
/* 80404550 00400390  2C 00 00 04 */	cmpwi r0, 4
/* 80404554 00400394  41 82 00 0C */	beq lbl_80404560
/* 80404558 00400398  38 60 00 00 */	li r3, 0
...
/* 80404568 004003A8  38 60 00 01 */	li r3, 1
...
/* 80404598 004003D8  38 60 00 01 */	li r3, 1
...
/* 804045A4 004003E4  39 20 00 00 */	li r9, 0
/* 804045A8 004003E8  38 04 FF F6 */	addi r0, r4, -10
/* 804045AC 004003EC  28 00 00 01 */	cmplwi r0, 1
/* 804045B0 004003F0  40 81 00 14 */	ble lbl_804045C4
/* 804045B4 004003F4  2C 04 00 03 */	cmpwi r4, 3
/* 804045B8 004003F8  41 82 00 0C */	beq lbl_804045C4
/* 804045BC 004003FC  2C 04 00 07 */	cmpwi r4, 7
/* 804045C0 00400400  40 82 00 C8 */	bne lbl_80404688
lbl_804045C4:
/* 804045C4 00400404  39 40 FF FF */	li r10, -1
/* 804045C8 00400408  39 60 FF FF */	li r11, -1
/* 804045CC 0040040C  39 80 00 00 */	li r12, 0
/* 804045D0 00400410  38 C0 00 00 */	li r6, 0
/* 804045D4 00400414  3C E0 80 42 */	lis r7, challengeMasterDataTbl__Q27storage29$$2unnamed$$2BackupFileData2_cpp$$2@ha
/* 804045D8 00400418  38 E7 10 00 */	addi r7, r7, challengeMasterDataTbl__Q27storage29$$2unnamed$$2BackupFileData2_cpp$$2@l
/* 804045DC 0040041C  38 00 00 04 */	li r0, 4
/* 804045E0 00400420  7C 09 03 A6 */	mtctr r0
lbl_804045E4:
/* 804045E4 00400424  7D 07 32 14 */	add r8, r7, r6
/* 804045E8 00400428  80 08 00 00 */	lwz r0, 0(r8)
...
/* 804045F8 00400438  38 E0 00 00 */	li r7, 0
/* 804045FC 0040043C  38 80 00 00 */	li r4, 0
/* 80404600 00400440  80 08 00 04 */	lwz r0, 4(r8)
/* 80404604 00400444  80 C8 00 08 */	lwz r6, 8(r8)
/* 80404608 00400448  7C 09 03 A6 */	mtctr r0
/* 8040460C 0040044C  2C 00 00 00 */	cmpwi r0, 0
...
/* 80404678 004004B8  38 61 00 08 */	addi r3, r1, 8
...
/* 804046A4 004004E4  3B E0 00 00 */	li r31, 0
...
/* 804046AC 004004EC  2C 03 00 00 */	cmpwi r3, 0
/* 804046B0 004004F0  41 82 00 08 */	beq lbl_804046B8
/* 804046B4 004004F4  83 E3 00 00 */	lwz r31, 0(r3)
lbl_804046B8:
...
/* 804046E8 00400528  2C 03 00 00 */	cmpwi r3, 0
/* 804046EC 0040052C  41 82 00 1C */	beq lbl_80404708
/* 804046F0 00400530  80 03 00 00 */	lwz r0, 0(r3)
/* 804046F4 00400534  7C 1F 00 00 */	cmpw r31, r0
/* 804046F8 00400538  40 81 00 10 */	ble lbl_80404708
/* 804046FC 0040053C  93 E3 00 00 */	stw r31, 0(r3)
/* 80404700 00400540  38 60 00 01 */	li r3, 1
/* 80404704 00400544  48 00 00 08 */	b lbl_8040470C
lbl_80404708:
/* 80404708 00400548  38 60 00 00 */	li r3, 0
lbl_8040470C:
...
/* 80404724 00400564  38 04 FF F6 */	addi r0, r4, -10
/* 80404728 00400568  28 00 00 01 */	cmplwi r0, 1
/* 8040472C 0040056C  40 81 00 14 */	ble lbl_80404740
/* 80404730 00400570  2C 04 00 03 */	cmpwi r4, 3
/* 80404734 00400574  41 82 00 0C */	beq lbl_80404740
/* 80404738 00400578  2C 04 00 07 */	cmpwi r4, 7
/* 8040473C 0040057C  40 82 00 9C */	bne lbl_804047D8
lbl_80404740:
/* 80404740 00400580  39 00 00 00 */	li r8, 0
/* 80404744 00400584  38 A0 00 00 */	li r5, 0
/* 80404748 00400588  3C C0 80 42 */	lis r6, challengeMasterDataTbl__Q27storage29$$2unnamed$$2BackupFileData2_cpp$$2@ha
/* 8040474C 0040058C  38 C6 10 00 */	addi r6, r6, challengeMasterDataTbl__Q27storage29$$2unnamed$$2BackupFileData2_cpp$$2@l
/* 80404750 00400590  38 00 00 04 */	li r0, 4
/* 80404754 00400594  7C 09 03 A6 */	mtctr r0
lbl_80404758:
/* 80404758 00400598  7C E6 2A 14 */	add r7, r6, r5
/* 8040475C 0040059C  80 07 00 00 */	lwz r0, 0(r7)
...
/* 8040476C 004005AC  90 01 00 08 */	stw r0, 8(r1)
...
challengeMasterDataTbl__Q27storage29$$2unnamed$$2BackupFileData2_cpp$$2:
	.4byte 0x00000003
	.4byte 0x00000003
	.4byte UseMaster1AbilityTbl__Q27storage29$$2unnamed$$2BackupFileData2_cpp$$2
	.4byte 0x00000007
	.4byte 0x00000003
	.4byte UseMaster2AbilityTbl__Q27storage29$$2unnamed$$2BackupFileData2_cpp$$2
	.4byte 0x0000000A
	.4byte 0x00000007
	.4byte UseMaster3AbilityTbl__Q27storage29$$2unnamed$$2BackupFileData2_cpp$$2
	.4byte 0x0000000B
	.4byte 0x00000007
	.4byte UseMaster3AbilityTbl__Q27storage29$$2unnamed$$2BackupFileData2_cpp$$2
	.4byte 0
