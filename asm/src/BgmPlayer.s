...
/* 80402658 003FE498  90 A3 00 04 */	stw r5, 4(r3)
/* 8040265C 003FE49C  38 80 00 00 */	li r4, 0
/* 80402660 003FE4A0  90 83 00 08 */	stw r4, 8(r3)
/* 80402664 003FE4A4  38 00 FF FF */	li r0, -1
...
/* 804026C4 003FE504  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 804026D8 003FE518  38 A0 00 00 */	li r5, 0
...
/* 804026E0 003FE520  38 C0 00 00 */	li r6, 0
...
/* 804026F8 003FE538  4B C0 4C 49 */	bl func_80007340
...
/* 80402720 003FE560  3C 1D 00 01 */	addis r0, r29, 1
...
lbl_80402738:
/* 80402738 003FE578  38 00 00 00 */	li r0, 0
/* 8040273C 003FE57C  90 01 00 08 */	stw r0, 8(r1)
/* 80402740 003FE580  90 01 00 20 */	stw r0, 0x20(r1)
/* 80402744 003FE584  90 01 00 24 */	stw r0, 0x24(r1)
/* 80402748 003FE588  2C 1E 00 00 */	cmpwi r30, 0
/* 8040274C 003FE58C  41 82 00 18 */	beq lbl_80402764
/* 80402750 003FE590  38 00 00 01 */	li r0, 1
/* 80402754 003FE594  90 01 00 08 */	stw r0, 8(r1)
/* 80402758 003FE598  38 00 00 02 */	li r0, 2
/* 8040275C 003FE59C  90 01 00 0C */	stw r0, 0xc(r1)
/* 80402760 003FE5A0  93 C1 00 10 */	stw r30, 0x10(r1)
lbl_80402764:
/* 80402764 003FE5A4  80 7C 00 04 */	lwz r3, 4(r28)
/* 80402768 003FE5A8  38 63 00 0C */	addi r3, r3, 0xc
/* 8040276C 003FE5AC  38 9C 00 08 */	addi r4, r28, 8
/* 80402770 003FE5B0  7F A5 EB 78 */	mr r5, r29
/* 80402774 003FE5B4  38 C1 00 08 */	addi r6, r1, 8
...
/* 8040277C 003FE5BC  80 7C 00 08 */	lwz r3, 8(r28)
/* 80402780 003FE5C0  2C 03 00 00 */	cmpwi r3, 0
...
/* 804027B4 003FE5F4  38 80 00 00 */	li r4, 0
...
/* 804027D0 003FE610  38 63 00 08 */	addi r3, r3, 8
/* 804027D4 003FE614  48 00 00 21 */	bl Stop__Q34nw4r3snd11SoundHandleFi
/* 804027D8 003FE618  38 00 FF FF */	li r0, -1
...
/* 804027F4 003FE634  80 63 00 00 */	lwz r3, 0(r3)
/* 804027F8 003FE638  2C 03 00 00 */	cmpwi r3, 0
...
/* 8040281C 003FE65C  38 61 00 08 */	addi r3, r1, 8
/* 80402820 003FE660  38 84 00 08 */	addi r4, r4, 8
/* 80402824 003FE664  4B D1 68 FD */	bl __ct__Q34nw4r3snd15StrmSoundHandleFPQ34nw4r3snd11SoundHandle
/* 80402828 003FE668  80 01 00 08 */	lwz r0, 8(r1)
/* 8040282C 003FE66C  2C 00 00 00 */	cmpwi r0, 0
/* 80402830 003FE670  40 82 00 0C */	bne lbl_8040283C
/* 80402834 003FE674  3B E0 FF FF */	li r31, -1
/* 80402838 003FE678  48 00 00 14 */	b lbl_8040284C
lbl_8040283C:
/* 8040283C 003FE67C  80 61 00 08 */	lwz r3, 8(r1)
...
lbl_8040284C:
/* 8040284C 003FE68C  38 61 00 08 */	addi r3, r1, 8
/* 80402850 003FE690  38 80 FF FF */	li r4, -1
...
/* 80402880 003FE6C0  93 C1 00 08 */	stw r30, 8(r1)
/* 80402884 003FE6C4  7C 7E 1B 78 */	mr r30, r3
/* 80402888 003FE6C8  7C 9F 23 78 */	mr r31, r4
/* 8040288C 003FE6CC  2C 03 00 00 */	cmpwi r3, 0
...
/* 804028C0 003FE700  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 804028E0 003FE720  DB E1 00 08 */	stfd f31, 8(r1)
/* 804028E4 003FE724  FF E0 08 90 */	fmr f31, f1
/* 804028E8 003FE728  80 63 00 04 */	lwz r3, 4(r3)
/* 804028EC 003FE72C  38 80 00 00 */	li r4, 0
...
/* 804028FC 003FE73C  CB E1 00 08 */	lfd f31, 8(r1)
...
/* 80402928 003FE768  2C 00 00 00 */	cmpwi r0, 0
/* 8040292C 003FE76C  40 82 00 14 */	bne lbl_80402940
/* 80402930 003FE770  38 63 00 08 */	addi r3, r3, 8
/* 80402934 003FE774  38 80 00 01 */	li r4, 1
/* 80402938 003FE778  38 A0 00 00 */	li r5, 0
/* 8040293C 003FE77C  48 00 00 25 */	bl Pause__Q34nw4r3snd11SoundHandleFbi
lbl_80402940:
/* 80402940 003FE780  80 7F 00 10 */	lwz r3, 0x10(r31)
/* 80402944 003FE784  38 03 00 01 */	addi r0, r3, 1
...
/* 80402960 003FE7A0  80 63 00 00 */	lwz r3, 0(r3)
/* 80402964 003FE7A4  2C 03 00 00 */	cmpwi r3, 0
...
/* 80402978 003FE7B8  2C 00 00 00 */	cmpwi r0, 0
/* 8040297C 003FE7BC  40 82 00 0C */	bne lbl_80402988
/* 80402980 003FE7C0  38 00 00 01 */	li r0, 1
/* 80402984 003FE7C4  90 03 00 10 */	stw r0, 0x10(r3)
lbl_80402988:
/* 80402988 003FE7C8  80 83 00 10 */	lwz r4, 0x10(r3)
/* 8040298C 003FE7CC  38 04 FF FF */	addi r0, r4, -1
/* 80402990 003FE7D0  90 03 00 10 */	stw r0, 0x10(r3)
/* 80402994 003FE7D4  2C 00 00 00 */	cmpwi r0, 0
/* 80402998 003FE7D8  4C 82 00 20 */	bnelr 
/* 8040299C 003FE7DC  38 63 00 08 */	addi r3, r3, 8
/* 804029A0 003FE7E0  38 80 00 00 */	li r4, 0
/* 804029A4 003FE7E4  38 A0 00 00 */	li r5, 0
...
/* 804029D8 003FE818  2C 00 00 00 */	cmpwi r0, 0
...
/* 804029F4 003FE834  38 63 00 08 */	addi r3, r3, 8
/* 804029F8 003FE838  C0 22 E3 DC */	lfs f1, $$249208-_SDA2_BASE_(r2)
/* 804029FC 003FE83C  2C 04 00 00 */	cmpwi r4, 0
...
/* 80402A10 003FE850  80 63 00 00 */	lwz r3, 0(r3)
/* 80402A14 003FE854  2C 03 00 00 */	cmpwi r3, 0
...
/* 80402A24 003FE864  38 63 00 08 */	addi r3, r3, 8
/* 80402A28 003FE868  C0 22 E3 D8 */	lfs f1, $$249146-_SDA2_BASE_(r2)
