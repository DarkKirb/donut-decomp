...
/* 80330774 0032C5B4  98 03 00 00 */	stb r0, 0(r3)
/* 80330778 0032C5B8  90 03 00 04 */	stw r0, 4(r3)
/* 8033077C 0032C5BC  90 03 00 08 */	stw r0, 8(r3)
/* 80330780 0032C5C0  C0 02 CB 90 */	lfs f0, $$248846-_SDA2_BASE_(r2)
...
/* 80330798 0032C5D8  80 83 00 08 */	lwz r4, 8(r3)
/* 8033079C 0032C5DC  2C 04 00 00 */	cmpwi r4, 0
/* 803307A0 0032C5E0  41 82 00 0C */	beq lbl_803307AC
/* 803307A4 0032C5E4  38 04 FF FF */	addi r0, r4, -1
/* 803307A8 0032C5E8  90 03 00 08 */	stw r0, 8(r3)
lbl_803307AC:
/* 803307AC 0032C5EC  80 03 00 08 */	lwz r0, 8(r3)
/* 803307B0 0032C5F0  2C 00 00 00 */	cmpwi r0, 0
/* 803307B4 0032C5F4  4C 82 00 20 */	bnelr 
/* 803307B8 0032C5F8  38 00 00 00 */	li r0, 0
/* 803307BC 0032C5FC  90 03 00 04 */	stw r0, 4(r3)
...
/* 803307C4 0032C604  38 A0 00 00 */	li r5, 0
/* 803307C8 0032C608  88 03 00 00 */	lbz r0, 0(r3)
/* 803307CC 0032C60C  2C 00 00 00 */	cmpwi r0, 0
...
/* 803307E0 0032C620  38 A0 00 01 */	li r5, 1
lbl_803307E4:
...
/* 803307EC 0032C62C  38 80 00 00 */	li r4, 0
/* 803307F0 0032C630  88 03 00 00 */	lbz r0, 0(r3)
/* 803307F4 0032C634  2C 00 00 00 */	cmpwi r0, 0
/* 803307F8 0032C638  41 82 00 14 */	beq lbl_8033080C
/* 803307FC 0032C63C  88 03 00 18 */	lbz r0, 0x18(r3)
/* 80330800 0032C640  2C 00 00 00 */	cmpwi r0, 0
/* 80330804 0032C644  41 82 00 08 */	beq lbl_8033080C
/* 80330808 0032C648  38 80 00 01 */	li r4, 1
lbl_8033080C:
...
/* 80330814 0032C654  90 83 00 04 */	stw r4, 4(r3)
/* 80330818 0032C658  38 00 00 02 */	li r0, 2
