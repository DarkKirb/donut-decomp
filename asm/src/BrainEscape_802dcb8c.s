...
/* 802DCBAC 002D89EC  90 1F 00 00 */	stw r0, 0x0(r31)
...
/* 802DCBD8 002D8A18  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 802DCC00 002D8A40  2C 04 00 00 */	cmpwi r4, 0x0
/* 802DCC04 002D8A44  41 82 00 28 */	beq lbl_802DCC2C
/* 802DCC08 002D8A48  3C 60 80 46 */	lis r3, "__vt__Q24util28StateFactory<Q24util6IState>"@ha
/* 802DCC0C 002D8A4C  38 03 44 78 */	addi r0, r3, "__vt__Q24util28StateFactory<Q24util6IState>"@l
/* 802DCC10 002D8A50  90 04 00 00 */	stw r0, 0x0(r4)
/* 802DCC14 002D8A54  38 1F 00 90 */	addi r0, r31, 0x90
/* 802DCC18 002D8A58  90 04 00 04 */	stw r0, 0x4(r4)
/* 802DCC1C 002D8A5C  3C 60 80 48 */	lis r3, "__vt__Q24util94StateFactoryArg1<Q24util6IState,Q53scn4step5enemy5sheld11StateEscape,PQ43scn4step5enemy5Enemy>"@ha
/* 802DCC20 002D8A60  38 03 B9 50 */	addi r0, r3, "__vt__Q24util94StateFactoryArg1<Q24util6IState,Q53scn4step5enemy5sheld11StateEscape,PQ43scn4step5enemy5Enemy>"@l
/* 802DCC24 002D8A64  90 04 00 00 */	stw r0, 0x0(r4)
/* 802DCC28 002D8A68  93 C4 00 08 */	stw r30, 0x8(r4)
.global lbl_802DCC2C
lbl_802DCC2C:
/* 802DCC2C 002D8A6C  90 9F 00 0C */	stw r4, 0xc(r31)
/* 802DCC30 002D8A70  38 60 00 01 */	li r3, 0x1
/* 802DCC34 002D8A74  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 802DCC38 002D8A78  83 C1 00 08 */	lwz r30, 0x8(r1)
