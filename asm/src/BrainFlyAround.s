...
/* 802C9AF4 002C5934  90 1E 00 00 */	stw r0, 0(r30)
...
/* 802C9B04 002C5944  38 61 00 08 */	addi r3, r1, 8
/* 802C9B08 002C5948  4B FA 5B AD */	bl pos__Q43scn4step5chara8LocationCFv
/* 802C9B0C 002C594C  C0 01 00 08 */	lfs f0, 8(r1)
/* 802C9B10 002C5950  D0 1E 00 08 */	stfs f0, 8(r30)
...
/* 802C9B40 002C5980  93 C1 00 08 */	stw r30, 8(r1)
...
/* 802C9B68 002C59A8  2C 04 00 00 */	cmpwi r4, 0
/* 802C9B6C 002C59AC  41 82 00 28 */	beq lbl_802C9B94
/* 802C9B70 002C59B0  3C 60 80 46 */	lis r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@ha
/* 802C9B74 002C59B4  38 03 44 78 */	addi r0, r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@l
/* 802C9B78 002C59B8  90 04 00 00 */	stw r0, 0(r4)
/* 802C9B7C 002C59BC  38 1F 00 90 */	addi r0, r31, 0x90
/* 802C9B80 002C59C0  90 04 00 04 */	stw r0, 4(r4)
/* 802C9B84 002C59C4  3C 60 80 48 */	lis r3, __vt__Q24util100StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy6owgulf16StateFlyStraight$$4PQ43scn4step5enemy5Enemy$$1@ha
/* 802C9B88 002C59C8  38 03 9B 00 */	addi r0, r3, __vt__Q24util100StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy6owgulf16StateFlyStraight$$4PQ43scn4step5enemy5Enemy$$1@l
/* 802C9B8C 002C59CC  90 04 00 00 */	stw r0, 0(r4)
/* 802C9B90 002C59D0  93 C4 00 08 */	stw r30, 8(r4)
lbl_802C9B94:
/* 802C9B94 002C59D4  90 9F 00 0C */	stw r4, 0xc(r31)
/* 802C9B98 002C59D8  38 60 00 01 */	li r3, 1
/* 802C9B9C 002C59DC  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 802C9BA0 002C59E0  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 802C9BFC 002C5A3C  C0 3E 00 08 */	lfs f1, 8(r30)
/* 802C9C00 002C5A40  C0 1F 00 00 */	lfs f0, 0(r31)
...
/* 802C9C20 002C5A60  2C 03 00 00 */	cmpwi r3, 0
...
/* 802C9C44 002C5A84  38 80 00 00 */	li r4, 0
/* 802C9C48 002C5A88  4B EC EA 39 */	bl __ct__25mint_wrapNative_helper$$0b$$1Fb
...
/* 802C9C60 002C5AA0  38 61 00 08 */	addi r3, r1, 8
/* 802C9C64 002C5AA4  4B FA 5A 51 */	bl pos__Q43scn4step5chara8LocationCFv
/* 802C9C68 002C5AA8  C0 41 00 08 */	lfs f2, 8(r1)
/* 802C9C6C 002C5AAC  C0 3E 00 08 */	lfs f1, 8(r30)
/* 802C9C70 002C5AB0  C0 1F 00 00 */	lfs f0, 0(r31)
...
/* 802C9C90 002C5AD0  2C 03 00 00 */	cmpwi r3, 0
...
/* 802C9CB4 002C5AF4  38 80 00 01 */	li r4, 1
/* 802C9CB8 002C5AF8  4B EC E9 C9 */	bl __ct__25mint_wrapNative_helper$$0b$$1Fb
lbl_802C9CBC:
