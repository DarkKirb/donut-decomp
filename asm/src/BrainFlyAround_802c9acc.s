...
/* 802C9AE8 002C5928  4B FB 53 2D */	bl lbl_8027EE14
/* 802C9AEC 002C592C  3C 60 80 48 */	lis r3, lbl_80479B50@ha
/* 802C9AF0 002C5930  38 03 9B 50 */	addi r0, r3, lbl_80479B50@l
/* 802C9AF4 002C5934  90 1E 00 00 */	stw r0, 0x0(r30)
/* 802C9AF8 002C5938  7F E3 FB 78 */	mr r3, r31
/* 802C9AFC 002C593C  4B FB E5 C1 */	bl lbl_802880BC
/* 802C9B00 002C5940  7C 64 1B 78 */	mr r4, r3
/* 802C9B04 002C5944  38 61 00 08 */	addi r3, r1, 0x8
/* 802C9B08 002C5948  4B FA 5B AD */	bl lbl_8026F6B4
...
/* 802C9B48 002C5988  4B E3 6C 99 */	bl lbl_801007E0
/* 802C9B4C 002C598C  7C 7E 1B 78 */	mr r30, r3
/* 802C9B50 002C5990  7F E3 FB 78 */	mr r3, r31
/* 802C9B54 002C5994  4B E3 6C 8D */	bl lbl_801007E0
/* 802C9B58 002C5998  4B FB E6 4D */	bl lbl_802881A4
/* 802C9B5C 002C599C  7C 7F 1B 78 */	mr r31, r3
/* 802C9B60 002C59A0  48 13 C3 A1 */	bl lbl_80405F00
...
/* 802C9B70 002C59B0  3C 60 80 46 */	lis r3, lbl_80464478@ha
/* 802C9B74 002C59B4  38 03 44 78 */	addi r0, r3, lbl_80464478@l
...
/* 802C9B84 002C59C4  3C 60 80 48 */	lis r3, lbl_80479B00@ha
/* 802C9B88 002C59C8  38 03 9B 00 */	addi r0, r3, lbl_80479B00@l
...
.global lbl_802C9BB4
lbl_802C9BB4:
/* 802C9BB4 002C59F4  4B F5 DB 0C */	b lbl_802276C0
...
/* 802C9BD0 002C5A10  4B E3 6C 11 */	bl lbl_801007E0
/* 802C9BD4 002C5A14  4B FB E4 B1 */	bl lbl_80288084
/* 802C9BD8 002C5A18  4B FC 36 51 */	bl lbl_8028D228
/* 802C9BDC 002C5A1C  7C 7F 1B 78 */	mr r31, r3
/* 802C9BE0 002C5A20  7F C3 F3 78 */	mr r3, r30
/* 802C9BE4 002C5A24  4B E3 6B FD */	bl lbl_801007E0
/* 802C9BE8 002C5A28  4B FB E4 D5 */	bl lbl_802880BC
/* 802C9BEC 002C5A2C  7C 64 1B 78 */	mr r4, r3
/* 802C9BF0 002C5A30  38 61 00 14 */	addi r3, r1, 0x14
/* 802C9BF4 002C5A34  4B FA 5A C1 */	bl lbl_8026F6B4
...
/* 802C9C14 002C5A54  4B E3 6B CD */	bl lbl_801007E0
/* 802C9C18 002C5A58  4B FB E4 95 */	bl lbl_802880AC
/* 802C9C1C 002C5A5C  4B EB 7A B9 */	bl lbl_801816D4
...
/* 802C9C2C 002C5A6C  4B E3 6B B5 */	bl lbl_801007E0
/* 802C9C30 002C5A70  4B FB E4 95 */	bl lbl_802880C4
/* 802C9C34 002C5A74  4B ED 17 69 */	bl lbl_8019B39C
/* 802C9C38 002C5A78  7F C3 F3 78 */	mr r3, r30
/* 802C9C3C 002C5A7C  4B E3 6B A5 */	bl lbl_801007E0
/* 802C9C40 002C5A80  4B FB E4 6D */	bl lbl_802880AC
/* 802C9C44 002C5A84  38 80 00 00 */	li r4, 0x0
/* 802C9C48 002C5A88  4B EC EA 39 */	bl lbl_80198680
/* 802C9C4C 002C5A8C  48 00 00 70 */	b lbl_802C9CBC
.global lbl_802C9C50
lbl_802C9C50:
/* 802C9C50 002C5A90  7F C3 F3 78 */	mr r3, r30
/* 802C9C54 002C5A94  4B E3 6B 8D */	bl lbl_801007E0
/* 802C9C58 002C5A98  4B FB E4 65 */	bl lbl_802880BC
/* 802C9C5C 002C5A9C  7C 64 1B 78 */	mr r4, r3
/* 802C9C60 002C5AA0  38 61 00 08 */	addi r3, r1, 0x8
/* 802C9C64 002C5AA4  4B FA 5A 51 */	bl lbl_8026F6B4
...
/* 802C9C84 002C5AC4  4B E3 6B 5D */	bl lbl_801007E0
/* 802C9C88 002C5AC8  4B FB E4 25 */	bl lbl_802880AC
/* 802C9C8C 002C5ACC  4B EB 7A 49 */	bl lbl_801816D4
...
/* 802C9C9C 002C5ADC  4B E3 6B 45 */	bl lbl_801007E0
/* 802C9CA0 002C5AE0  4B FB E4 25 */	bl lbl_802880C4
/* 802C9CA4 002C5AE4  4B ED 16 F9 */	bl lbl_8019B39C
/* 802C9CA8 002C5AE8  7F C3 F3 78 */	mr r3, r30
/* 802C9CAC 002C5AEC  4B E3 6B 35 */	bl lbl_801007E0
/* 802C9CB0 002C5AF0  4B FB E3 FD */	bl lbl_802880AC
/* 802C9CB4 002C5AF4  38 80 00 01 */	li r4, 0x1
/* 802C9CB8 002C5AF8  4B EC E9 C9 */	bl lbl_80198680
.global lbl_802C9CBC
lbl_802C9CBC:
...
.global lbl_802C9CD4
lbl_802C9CD4:
/* 802C9CD4 002C5B14  4B FC 73 98 */	b lbl_8029106C
