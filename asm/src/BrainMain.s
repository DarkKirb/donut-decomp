...
/* 802ADF08 002A9D48  90 1F 00 00 */	stw r0, 0(r31)
...
/* 802ADF34 002A9D74  93 C1 00 08 */	stw r30, 8(r1)
...
/* 802ADF5C 002A9D9C  2C 04 00 00 */	cmpwi r4, 0
/* 802ADF60 002A9DA0  41 82 00 30 */	beq lbl_802ADF90
/* 802ADF64 002A9DA4  3C 60 80 46 */	lis r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@ha
/* 802ADF68 002A9DA8  38 03 44 78 */	addi r0, r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@l
/* 802ADF6C 002A9DAC  90 04 00 00 */	stw r0, 0(r4)
/* 802ADF70 002A9DB0  38 1F 00 90 */	addi r0, r31, 0x90
/* 802ADF74 002A9DB4  90 04 00 04 */	stw r0, 4(r4)
/* 802ADF78 002A9DB8  3C 60 80 47 */	lis r3, __vt__Q24util95StateFactoryArg2$$0Q24util6IState$$4Q53scn4step5enemy8dubiorjr8StateFly$$4PQ43scn4step5enemy5Enemy$$4f$$1@ha
/* 802ADF7C 002A9DBC  38 03 61 38 */	addi r0, r3, __vt__Q24util95StateFactoryArg2$$0Q24util6IState$$4Q53scn4step5enemy8dubiorjr8StateFly$$4PQ43scn4step5enemy5Enemy$$4f$$1@l
/* 802ADF80 002A9DC0  90 04 00 00 */	stw r0, 0(r4)
/* 802ADF84 002A9DC4  93 C4 00 08 */	stw r30, 8(r4)
/* 802ADF88 002A9DC8  C0 02 B8 28 */	lfs f0, $$254871-_SDA2_BASE_(r2)
/* 802ADF8C 002A9DCC  D0 04 00 0C */	stfs f0, 0xc(r4)
lbl_802ADF90:
/* 802ADF90 002A9DD0  90 9F 00 0C */	stw r4, 0xc(r31)
/* 802ADF94 002A9DD4  38 60 00 01 */	li r3, 1
/* 802ADF98 002A9DD8  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 802ADF9C 002A9DDC  83 C1 00 08 */	lwz r30, 8(r1)
