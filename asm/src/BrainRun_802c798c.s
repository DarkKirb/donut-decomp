...
/* 802C79AC 002C37EC  90 1F 00 00 */	stw r0, 0x0(r31)
...
/* 802C79D8 002C3818  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 802C79E8 002C3828  38 80 00 03 */	li r4, 0x3
...
/* 802C7A14 002C3854  2C 04 00 00 */	cmpwi r4, 0x0
/* 802C7A18 002C3858  41 82 00 28 */	beq lbl_802C7A40
/* 802C7A1C 002C385C  3C 60 80 46 */	lis r3, "__vt__Q24util28StateFactory<Q24util6IState>"@ha
/* 802C7A20 002C3860  38 03 44 78 */	addi r0, r3, "__vt__Q24util28StateFactory<Q24util6IState>"@l
/* 802C7A24 002C3864  90 04 00 00 */	stw r0, 0x0(r4)
/* 802C7A28 002C3868  38 1F 00 90 */	addi r0, r31, 0x90
/* 802C7A2C 002C386C  90 04 00 04 */	stw r0, 0x4(r4)
/* 802C7A30 002C3870  3C 60 80 48 */	lis r3, "__vt__Q24util91StateFactoryArg1<Q24util6IState,Q53scn4step5enemy5nruff9StateFall,PQ43scn4step5enemy5Enemy>"@ha
/* 802C7A34 002C3874  38 03 97 20 */	addi r0, r3, "__vt__Q24util91StateFactoryArg1<Q24util6IState,Q53scn4step5enemy5nruff9StateFall,PQ43scn4step5enemy5Enemy>"@l
/* 802C7A38 002C3878  90 04 00 00 */	stw r0, 0x0(r4)
/* 802C7A3C 002C387C  93 C4 00 08 */	stw r30, 0x8(r4)
.global lbl_802C7A40
lbl_802C7A40:
/* 802C7A40 002C3880  90 9F 00 0C */	stw r4, 0xc(r31)
/* 802C7A44 002C3884  38 60 00 01 */	li r3, 0x1
/* 802C7A48 002C3888  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 802C7A4C 002C388C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
__vt__Q53scn4step5enemy5nruff8BrainRun:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step5enemy5nruff8BrainRunFv
	.4byte onStart__Q53scn4step5enemy5nruff8BrainRunFv
	.4byte onRecover__Q53scn4step5enemy5nruff8BrainRunFv
