...
/* 803F2B2C 003EE96C  F3 E1 00 48 */	psq_st f31, 72(r1), 0, qr0
/* 803F2B30 003EE970  DB C1 00 30 */	stfd f30, 0x30(r1)
/* 803F2B34 003EE974  F3 C1 00 38 */	psq_st f30, 56(r1), 0, qr0
/* 803F2B38 003EE978  DB A1 00 20 */	stfd f29, 0x20(r1)
/* 803F2B3C 003EE97C  F3 A1 00 28 */	psq_st f29, 40(r1), 0, qr0
...
/* 803F2B58 003EE998  C8 22 E2 78 */	lfd f1, $$251513-_SDA2_BASE_(r2)
/* 803F2B5C 003EE99C  90 61 00 0C */	stw r3, 0xc(r1)
/* 803F2B60 003EE9A0  3F E0 43 30 */	lis r31, 0x4330
/* 803F2B64 003EE9A4  93 E1 00 08 */	stw r31, 8(r1)
/* 803F2B68 003EE9A8  C8 01 00 08 */	lfd f0, 8(r1)
/* 803F2B6C 003EE9AC  EF E0 08 28 */	fsubs f31, f0, f1
/* 803F2B70 003EE9B0  4B DA 4B F5 */	bl CurrentGameWidth__Q23gfx7UtilityFv
/* 803F2B74 003EE9B4  C8 22 E2 78 */	lfd f1, $$251513-_SDA2_BASE_(r2)
...
/* 803F2B8C 003EE9CC  D0 1E 00 00 */	stfs f0, 0(r30)
/* 803F2B90 003EE9D0  D3 BE 00 04 */	stfs f29, 4(r30)
/* 803F2B94 003EE9D4  C0 02 E2 70 */	lfs f0, $$251509-_SDA2_BASE_(r2)
/* 803F2B98 003EE9D8  D0 1E 00 08 */	stfs f0, 8(r30)
...
/* 803F2BAC 003EE9EC  C0 5E 00 04 */	lfs f2, 4(r30)
/* 803F2BB0 003EE9F0  FC 20 F0 90 */	fmr f1, f30
/* 803F2BB4 003EE9F4  4B D0 C0 4D */	bl Atan2FIdx__Q24nw4r4mathFff
/* 803F2BB8 003EE9F8  C0 02 E2 74 */	lfs f0, $$251510-_SDA2_BASE_(r2)
/* 803F2BBC 003EE9FC  EC 00 00 72 */	fmuls f0, f0, f1
/* 803F2BC0 003EEA00  D0 1E 00 08 */	stfs f0, 8(r30)
...
/* 803F2C38 003EEA78  C0 44 00 04 */	lfs f2, 4(r4)
/* 803F2C3C 003EEA7C  C0 22 E2 88 */	lfs f1, $$251536-_SDA2_BASE_(r2)
...
/* 803F2C54 003EEA94  90 61 00 08 */	stw r3, 8(r1)
...
/* 803F2C64 003EEAA4  C0 01 00 08 */	lfs f0, 8(r1)
/* 803F2C68 003EEAA8  EC 00 08 2A */	fadds f0, f0, f1
/* 803F2C6C 003EEAAC  D0 01 00 08 */	stfs f0, 8(r1)
...
/* 803F2C8C 003EEACC  38 81 00 08 */	addi r4, r1, 8
