...
/* 803F8C18 003F4A58  38 00 00 00 */	li r0, 0
/* 803F8C1C 003F4A5C  90 03 00 04 */	stw r0, 4(r3)
/* 803F8C20 003F4A60  90 03 00 08 */	stw r0, 8(r3)
/* 803F8C24 003F4A64  C0 02 E2 D0 */	lfs f0, $$254825-_SDA2_BASE_(r2)
...
/* 803F8C74 003F4AB4  80 7F 00 00 */	lwz r3, 0(r31)
...
/* 803F8C84 003F4AC4  38 84 00 08 */	addi r4, r4, 8
/* 803F8C88 003F4AC8  4B F6 63 19 */	bl LimitMax$$0f$$1__Q33hel4math4MathFRCfRCf_Cf
/* 803F8C8C 003F4ACC  D0 3F 00 0C */	stfs f1, 0xc(r31)
/* 803F8C90 003F4AD0  80 7F 00 00 */	lwz r3, 0(r31)
...
/* 803F8C9C 003F4ADC  80 9F 00 08 */	lwz r4, 8(r31)
...
lbl_803F8CAC:
/* 803F8CAC 003F4AEC  80 63 00 00 */	lwz r3, 0(r3)
...
/* 803F8CC0 003F4B00  D0 01 00 08 */	stfs f0, 8(r1)
/* 803F8CC4 003F4B04  80 7F 00 00 */	lwz r3, 0(r31)
/* 803F8CC8 003F4B08  4B DF 43 71 */	bl paramGlobal__Q33scn14challengetitle9ComponentCFv
/* 803F8CCC 003F4B0C  7C 64 1B 78 */	mr r4, r3
/* 803F8CD0 003F4B10  38 61 00 08 */	addi r3, r1, 8
/* 803F8CD4 003F4B14  38 84 00 18 */	addi r4, r4, 0x18
/* 803F8CD8 003F4B18  4B F6 62 C9 */	bl LimitMax$$0f$$1__Q33hel4math4MathFRCfRCf_Cf
/* 803F8CDC 003F4B1C  D0 3F 00 0C */	stfs f1, 0xc(r31)
/* 803F8CE0 003F4B20  80 7F 00 00 */	lwz r3, 0(r31)
...
/* 803F8CEC 003F4B2C  80 9F 00 08 */	lwz r4, 8(r31)
...
/* 803F8D1C 003F4B5C  F3 E1 00 48 */	psq_st f31, 72(r1), 0, qr0
/* 803F8D20 003F4B60  93 E1 00 3C */	stw r31, 0x3c(r1)
/* 803F8D24 003F4B64  7C 7F 1B 78 */	mr r31, r3
/* 803F8D28 003F4B68  80 03 00 04 */	lwz r0, 4(r3)
/* 803F8D2C 003F4B6C  2C 00 00 00 */	cmpwi r0, 0
/* 803F8D30 003F4B70  40 82 00 CC */	bne lbl_803F8DFC
/* 803F8D34 003F4B74  38 00 00 01 */	li r0, 1
/* 803F8D38 003F4B78  90 03 00 04 */	stw r0, 4(r3)
/* 803F8D3C 003F4B7C  80 63 00 00 */	lwz r3, 0(r3)
...
/* 803F8D74 003F4BB4  80 7F 00 00 */	lwz r3, 0(r31)
...
/* 803F8DD0 003F4C10  80 7F 00 00 */	lwz r3, 0(r31)
...
/* 803F8E2C 003F4C6C  F3 E1 00 48 */	psq_st f31, 72(r1), 0, qr0
/* 803F8E30 003F4C70  93 E1 00 3C */	stw r31, 0x3c(r1)
/* 803F8E34 003F4C74  7C 7F 1B 78 */	mr r31, r3
/* 803F8E38 003F4C78  80 03 00 04 */	lwz r0, 4(r3)
/* 803F8E3C 003F4C7C  2C 00 00 01 */	cmpwi r0, 1
/* 803F8E40 003F4C80  40 82 00 BC */	bne lbl_803F8EFC
/* 803F8E44 003F4C84  38 00 00 02 */	li r0, 2
/* 803F8E48 003F4C88  90 03 00 04 */	stw r0, 4(r3)
/* 803F8E4C 003F4C8C  80 63 00 00 */	lwz r3, 0(r3)
...
/* 803F8E70 003F4CB0  80 7F 00 00 */	lwz r3, 0(r31)
...
/* 803F8EB4 003F4CF4  80 7F 00 00 */	lwz r3, 0(r31)
...
/* 803F8EC0 003F4D00  80 9F 00 08 */	lwz r4, 8(r31)
...
/* 803F8ED0 003F4D10  C0 02 E2 D0 */	lfs f0, $$254825-_SDA2_BASE_(r2)
/* 803F8ED4 003F4D14  D0 1F 00 0C */	stfs f0, 0xc(r31)
/* 803F8ED8 003F4D18  80 7F 00 00 */	lwz r3, 0(r31)
...
/* 803F8EE4 003F4D24  80 9F 00 08 */	lwz r4, 8(r31)
...
/* 803F8EF4 003F4D34  38 80 FF FF */	li r4, -1
...
/* 803F8F30 003F4D70  80 03 00 04 */	lwz r0, 4(r3)
/* 803F8F34 003F4D74  2C 00 00 01 */	cmpwi r0, 1
/* 803F8F38 003F4D78  41 82 00 0C */	beq lbl_803F8F44
/* 803F8F3C 003F4D7C  2C 00 00 02 */	cmpwi r0, 2
/* 803F8F40 003F4D80  40 82 00 44 */	bne lbl_803F8F84
lbl_803F8F44:
/* 803F8F44 003F4D84  38 00 00 00 */	li r0, 0
/* 803F8F48 003F4D88  90 03 00 04 */	stw r0, 4(r3)
/* 803F8F4C 003F4D8C  80 63 00 00 */	lwz r3, 0(r3)
...
/* 803F8F70 003F4DB0  80 7F 00 00 */	lwz r3, 0(r31)
...
/* 803F8F7C 003F4DBC  80 9F 00 08 */	lwz r4, 8(r31)
...
/* 803F8FA8 003F4DE8  F3 E1 00 48 */	psq_st f31, 72(r1), 0, qr0
...
/* 803F8FB8 003F4DF8  80 03 00 04 */	lwz r0, 4(r3)
/* 803F8FBC 003F4DFC  2C 00 00 00 */	cmpwi r0, 0
/* 803F8FC0 003F4E00  40 82 00 BC */	bne lbl_803F907C
/* 803F8FC4 003F4E04  38 00 00 03 */	li r0, 3
/* 803F8FC8 003F4E08  90 03 00 04 */	stw r0, 4(r3)
/* 803F8FCC 003F4E0C  80 63 00 00 */	lwz r3, 0(r3)
...
/* 803F9018 003F4E58  80 7E 00 00 */	lwz r3, 0(r30)
...
/* 803F902C 003F4E6C  D0 01 00 08 */	stfs f0, 8(r1)
/* 803F9030 003F4E70  80 7E 00 00 */	lwz r3, 0(r30)
...
/* 803F904C 003F4E8C  80 7E 00 00 */	lwz r3, 0(r30)
...
/* 803F90B4 003F4EF4  80 03 00 04 */	lwz r0, 4(r3)
/* 803F90B8 003F4EF8  2C 00 00 03 */	cmpwi r0, 3
/* 803F90BC 003F4EFC  40 82 00 20 */	bne lbl_803F90DC
/* 803F90C0 003F4F00  38 00 00 00 */	li r0, 0
/* 803F90C4 003F4F04  90 03 00 04 */	stw r0, 4(r3)
/* 803F90C8 003F4F08  80 63 00 00 */	lwz r3, 0(r3)
...
/* 803F90D4 003F4F14  80 9F 00 08 */	lwz r4, 8(r31)
