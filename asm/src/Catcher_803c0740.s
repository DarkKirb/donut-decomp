...
/* 803C0774 003BC5B4  48 00 0C 91 */	bl lbl_803C1404
...
/* 803C0784 003BC5C4  C0 02 DA 28 */	lfs f0, lbl_805639A8@sda21(r2)
...
/* 803C081C 003BC65C  48 00 00 35 */	bl lbl_803C0850
...
/* 803C0830 003BC670  4B DF EE E5 */	bl lbl_801BF714
.global lbl_803C0834
lbl_803C0834:
...
/* 803C0874 003BC6B4  48 00 A5 55 */	bl lbl_803CADC8
...
/* 803C08B8 003BC6F8  3F 80 80 49 */	lis r28, lbl_80491D3C@ha
/* 803C08BC 003BC6FC  3F A0 80 49 */	lis r29, lbl_80491D18@ha
/* 803C08C0 003BC700  3F C0 80 49 */	lis r30, lbl_80491D0C@ha
/* 803C08C4 003BC704  3F E0 80 49 */	lis r31, lbl_80491CE8@ha
...
/* 803C08D4 003BC714  38 7C 1D 3C */	addi r3, r28, lbl_80491D3C@l
/* 803C08D8 003BC718  38 80 01 FB */	li r4, 0x1fb
/* 803C08DC 003BC71C  38 BD 1D 18 */	addi r5, r29, lbl_80491D18@l
/* 803C08E0 003BC720  4C C6 31 82 */	crclr 4*cr1+eq
/* 803C08E4 003BC724  4B D6 7A 6D */	bl lbl_80128350
.global lbl_803C08E8
lbl_803C08E8:
/* 803C08E8 003BC728  7F 23 CB 78 */	mr r3, r25
/* 803C08EC 003BC72C  4B DB D7 0D */	bl lbl_8017DFF8
/* 803C08F0 003BC730  90 61 00 08 */	stw r3, 0x8(r1)
/* 803C08F4 003BC734  38 61 00 08 */	addi r3, r1, 0x8
/* 803C08F8 003BC738  4B DB D6 F1 */	bl lbl_8017DFE8
/* 803C08FC 003BC73C  38 61 00 08 */	addi r3, r1, 0x8
/* 803C0900 003BC740  48 00 00 A1 */	bl lbl_803C09A0
...
/* 803C0910 003BC750  38 7E 1D 0C */	addi r3, r30, lbl_80491D0C@l
/* 803C0914 003BC754  38 80 01 93 */	li r4, 0x193
/* 803C0918 003BC758  38 BF 1C E8 */	addi r5, r31, lbl_80491CE8@l
/* 803C091C 003BC75C  4C C6 31 82 */	crclr 4*cr1+eq
/* 803C0920 003BC760  4B D6 7A 31 */	bl lbl_80128350
.global lbl_803C0924
lbl_803C0924:
/* 803C0924 003BC764  7F 23 CB 78 */	mr r3, r25
/* 803C0928 003BC768  4B DE 62 E1 */	bl lbl_801A6C08
/* 803C092C 003BC76C  90 61 00 0C */	stw r3, 0xc(r1)
/* 803C0930 003BC770  38 61 00 0C */	addi r3, r1, 0xc
/* 803C0934 003BC774  4B DB D6 B5 */	bl lbl_8017DFE8
...
/* 803C0948 003BC788  4B D5 F3 C9 */	bl lbl_8011FD10
/* 803C094C 003BC78C  7F 23 CB 78 */	mr r3, r25
/* 803C0950 003BC790  7F 64 DB 78 */	mr r4, r27
/* 803C0954 003BC794  4B DB D6 F9 */	bl lbl_8017E04C
.global lbl_803C0958
lbl_803C0958:
...
/* 803C096C 003BC7AC  4B DB D5 15 */	bl lbl_8017DE80
...
/* 803C0980 003BC7C0  4B DF ED 95 */	bl lbl_801BF714
.global lbl_803C0984
lbl_803C0984:
...
/* 803C09BC 003BC7FC  3C 60 80 49 */	lis r3, lbl_80491CDC@ha
/* 803C09C0 003BC800  38 63 1C DC */	addi r3, r3, lbl_80491CDC@l
/* 803C09C4 003BC804  38 80 02 3D */	li r4, 0x23d
/* 803C09C8 003BC808  3C A0 80 49 */	lis r5, lbl_80491CB8@ha
/* 803C09CC 003BC80C  38 A5 1C B8 */	addi r5, r5, lbl_80491CB8@l
/* 803C09D0 003BC810  4C C6 31 82 */	crclr 4*cr1+eq
/* 803C09D4 003BC814  4B D6 79 7D */	bl lbl_80128350
.global lbl_803C09D8
lbl_803C09D8:
...
/* 803C0A34 003BC874  4B FF FF 6D */	bl lbl_803C09A0
...
/* 803C0A4C 003BC88C  4B DB D5 AD */	bl lbl_8017DFF8
...
/* 803C0A6C 003BC8AC  4B FF FE 29 */	bl lbl_803C0894
...
/* 803C0A80 003BC8C0  4B DF EC 95 */	bl lbl_801BF714
.global lbl_803C0A84
lbl_803C0A84:
...
/* 803C0AFC 003BC93C  4B DF EC 19 */	bl lbl_801BF714
.global lbl_803C0B00
lbl_803C0B00:
...
/* 803C0B3C 003BC97C  4B C6 39 65 */	bl lbl_800244A0
/* 803C0B40 003BC980  38 7D 00 08 */	addi r3, r29, 0x8
/* 803C0B44 003BC984  38 80 00 00 */	li r4, 0x0
/* 803C0B48 003BC988  48 00 00 89 */	bl lbl_803C0BD0
...
/* 803C0B78 003BC9B8  48 00 00 59 */	bl lbl_803C0BD0
...
/* 803C0B88 003BC9C8  48 00 00 49 */	bl lbl_803C0BD0
/* 803C0B8C 003BC9CC  7F E4 FB 78 */	mr r4, r31
/* 803C0B90 003BC9D0  4B DB EB 99 */	bl lbl_8017F728
...
/* 803C0BF4 003BCA34  4B C6 38 AD */	bl lbl_800244A0
...
/* 803C0C40 003BCA80  4B E6 01 C1 */	bl lbl_80220E00
...
/* 803C0C58 003BCA98  48 00 33 95 */	bl lbl_803C3FEC
...
/* 803C0C9C 003BCADC  4B E6 01 65 */	bl lbl_80220E00
/* 803C0CA0 003BCAE0  7F A4 EB 78 */	mr r4, r29
/* 803C0CA4 003BCAE4  7F C5 F3 78 */	mr r5, r30
/* 803C0CA8 003BCAE8  48 00 35 55 */	bl lbl_803C41FC
...
/* 803C0D04 003BCB44  4B FF FE CD */	bl lbl_803C0BD0
/* 803C0D08 003BCB48  7F E4 FB 78 */	mr r4, r31
/* 803C0D0C 003BCB4C  4B DB EA 1D */	bl lbl_8017F728
...
/* 803C0D88 003BCBC8  48 00 A1 A8 */	b lbl_803CAF30
.global lbl_803C0D8C
lbl_803C0D8C:
...
/* 803C0DB4 003BCBF4  48 00 A0 D1 */	bl lbl_803CAE84
/* 803C0DB8 003BCBF8  38 7F 01 18 */	addi r3, r31, 0x118
/* 803C0DBC 003BCBFC  4B FF FA 95 */	bl lbl_803C0850
.global lbl_803C0DC0
lbl_803C0DC0:
...
/* 803C0DEC 003BCC2C  48 00 A0 F5 */	bl lbl_803CAEE0
...
/* 803C0E00 003BCC40  4B E1 94 DD */	bl lbl_801DA2DC
