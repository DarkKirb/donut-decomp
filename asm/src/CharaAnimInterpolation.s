...
/* 8018CCA4 00188AE4  38 A0 00 04 */	li r5, 4
...
/* 8018CCB8 00188AF8  38 00 00 00 */	li r0, 0
/* 8018CCBC 00188AFC  90 1E 00 20 */	stw r0, 0x20(r30)
/* 8018CCC0 00188B00  C0 02 97 00 */	lfs f0, $$250437-_SDA2_BASE_(r2)
...
/* 8018CCFC 00188B3C  90 61 00 08 */	stw r3, 8(r1)
/* 8018CD00 00188B40  80 7E 00 20 */	lwz r3, 0x20(r30)
/* 8018CD04 00188B44  38 81 00 08 */	addi r4, r1, 8
/* 8018CD08 00188B48  81 83 00 00 */	lwz r12, 0(r3)
...
/* 8018CDAC 00188BEC  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 8018CDD0 00188C10  C0 22 97 00 */	lfs f1, $$250437-_SDA2_BASE_(r2)
/* 8018CDD4 00188C14  D0 23 00 24 */	stfs f1, 0x24(r3)
/* 8018CDD8 00188C18  C0 02 97 04 */	lfs f0, $$250463-_SDA2_BASE_(r2)
/* 8018CDDC 00188C1C  D0 03 00 28 */	stfs f0, 0x28(r3)
/* 8018CDE0 00188C20  D0 23 00 2C */	stfs f1, 0x2c(r3)
/* 8018CDE4 00188C24  38 00 00 00 */	li r0, 0
...
/* 8018CE18 00188C58  2C 00 00 00 */	cmpwi r0, 0
...
/* 8018CE2C 00188C6C  D0 21 00 08 */	stfs f1, 8(r1)
...
/* 8018CE80 00188CC0  38 00 00 01 */	li r0, 1
...
/* 8018CEB8 00188CF8  4C 40 13 82 */	cror 2, 0, 2
/* 8018CEBC 00188CFC  7C 60 00 26 */	mfcr r3
/* 8018CEC0 00188D00  54 63 1F FE */	rlwinm r3, r3, 3, 0x1f, 0x1f
...
/* 8018CEE0 00188D20  2C 03 00 00 */	cmpwi r3, 0
/* 8018CEE4 00188D24  41 82 00 0C */	beq lbl_8018CEF0
/* 8018CEE8 00188D28  38 00 00 00 */	li r0, 0
...
/* 8018CF1C 00188D5C  2C 03 00 00 */	cmpwi r3, 0
/* 8018CF20 00188D60  41 82 00 14 */	beq lbl_8018CF34
/* 8018CF24 00188D64  80 7F 00 20 */	lwz r3, 0x20(r31)
/* 8018CF28 00188D68  C0 22 97 04 */	lfs f1, $$250463-_SDA2_BASE_(r2)
...
.global $$250463
$$250463:
	.incbin "baserom.dol", 0x49A1C4, 0x4
