...
.global __ct__Q23g3d17CharaModelContextFRCQ23g3d15ResModelContextRCQ23g3d17ModelBufferOptionUlUlUlRQ23mem10IAllocatorbUlRCQ33hel6common15FixedString$$032$$1
__ct__Q23g3d17CharaModelContextFRCQ23g3d15ResModelContextRCQ23g3d17ModelBufferOptionUlUlUlRQ23mem10IAllocatorbUlRCQ33hel6common15FixedString$$032$$1:
/* 8018D780 001895C0  94 21 FF F0 */	stwu r1, -0x10(r1)
/* 8018D784 001895C4  93 E1 00 0C */	stw r31, 0xc(r1)
/* 8018D788 001895C8  93 C1 00 08 */	stw r30, 8(r1)
/* 8018D78C 001895CC  80 01 00 18 */	lwz r0, 0x18(r1)
/* 8018D790 001895D0  81 61 00 1C */	lwz r11, 0x1c(r1)
/* 8018D794 001895D4  81 84 00 00 */	lwz r12, 0(r4)
/* 8018D798 001895D8  91 83 00 00 */	stw r12, 0(r3)
/* 8018D79C 001895DC  7C 7E 1B 78 */	mr r30, r3
/* 8018D7A0 001895E0  39 80 00 05 */	li r12, 5
/* 8018D7A4 001895E4  7D 89 03 A6 */	mtctr r12
lbl_8018D7A8:
/* 8018D7A8 001895E8  83 E4 00 04 */	lwz r31, 4(r4)
/* 8018D7AC 001895EC  85 84 00 08 */	lwzu r12, 8(r4)
/* 8018D7B0 001895F0  93 FE 00 04 */	stw r31, 4(r30)
/* 8018D7B4 001895F4  95 9E 00 08 */	stwu r12, 8(r30)
/* 8018D7B8 001895F8  42 00 FF F0 */	bdnz lbl_8018D7A8
/* 8018D7BC 001895FC  88 85 00 00 */	lbz r4, 0(r5)
/* 8018D7C0 00189600  98 83 00 2C */	stb r4, 0x2c(r3)
/* 8018D7C4 00189604  88 85 00 01 */	lbz r4, 1(r5)
/* 8018D7C8 00189608  98 83 00 2D */	stb r4, 0x2d(r3)
/* 8018D7CC 0018960C  88 85 00 02 */	lbz r4, 2(r5)
/* 8018D7D0 00189610  98 83 00 2E */	stb r4, 0x2e(r3)
/* 8018D7D4 00189614  88 85 00 03 */	lbz r4, 3(r5)
/* 8018D7D8 00189618  98 83 00 2F */	stb r4, 0x2f(r3)
/* 8018D7DC 0018961C  88 85 00 04 */	lbz r4, 4(r5)
/* 8018D7E0 00189620  98 83 00 30 */	stb r4, 0x30(r3)
/* 8018D7E4 00189624  88 85 00 05 */	lbz r4, 5(r5)
/* 8018D7E8 00189628  98 83 00 31 */	stb r4, 0x31(r3)
/* 8018D7EC 0018962C  88 85 00 06 */	lbz r4, 6(r5)
/* 8018D7F0 00189630  98 83 00 32 */	stb r4, 0x32(r3)
/* 8018D7F4 00189634  88 85 00 07 */	lbz r4, 7(r5)
/* 8018D7F8 00189638  98 83 00 33 */	stb r4, 0x33(r3)
/* 8018D7FC 0018963C  88 85 00 08 */	lbz r4, 8(r5)
/* 8018D800 00189640  98 83 00 34 */	stb r4, 0x34(r3)
/* 8018D804 00189644  88 85 00 09 */	lbz r4, 9(r5)
...
/* 8018D858 00189698  38 AB FF FC */	addi r5, r11, -4
/* 8018D85C 0018969C  38 00 00 04 */	li r0, 4
/* 8018D860 001896A0  7C 09 03 A6 */	mtctr r0
lbl_8018D864:
/* 8018D864 001896A4  80 85 00 04 */	lwz r4, 4(r5)
/* 8018D868 001896A8  84 05 00 08 */	lwzu r0, 8(r5)
/* 8018D86C 001896AC  90 86 00 04 */	stw r4, 4(r6)
/* 8018D870 001896B0  94 06 00 08 */	stwu r0, 8(r6)
/* 8018D874 001896B4  42 00 FF F0 */	bdnz lbl_8018D864
/* 8018D878 001896B8  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 8018D87C 001896BC  83 C1 00 08 */	lwz r30, 8(r1)
