...
/* 80207464 002032A4  3C 60 80 46 */	lis r3, "PRODUCTS__Q33scn7history24@unnamed@Chronology_cpp@"@ha
/* 80207468 002032A8  38 63 0D 38 */	addi r3, r3, "PRODUCTS__Q33scn7history24@unnamed@Chronology_cpp@"@l
...
/* 80207478 002032B8  38 60 00 00 */	li r3, 0x0
/* 8020747C 002032BC  38 C0 FF FF */	li r6, -0x1
/* 80207480 002032C0  38 80 00 00 */	li r4, 0x0
/* 80207484 002032C4  3C A0 80 46 */	lis r5, "PRODUCTS__Q33scn7history24@unnamed@Chronology_cpp@"@ha
/* 80207488 002032C8  38 A5 0D 38 */	addi r5, r5, "PRODUCTS__Q33scn7history24@unnamed@Chronology_cpp@"@l
...
/* 802074A0 002032E0  38 63 00 01 */	addi r3, r3, 0x1
...
/* 802074C4 00203304  4B DF FE 71 */	bl lbl_80007334
/* 802074C8 00203308  3C 80 80 46 */	lis r4, "@48725_80460CD0"@ha
/* 802074CC 0020330C  3B E4 0C D0 */	addi r31, r4, "@48725_80460CD0"@l
/* 802074D0 00203310  38 80 00 00 */	li r4, 0x0
...
/* 802074EC 0020332C  3B C0 00 01 */	li r30, 0x1
/* 802074F0 00203330  3B A0 00 01 */	li r29, 0x1
/* 802074F4 00203334  3B 80 00 01 */	li r28, 0x1
/* 802074F8 00203338  3B 60 00 01 */	li r27, 0x1
/* 802074FC 0020333C  3B 40 00 01 */	li r26, 0x1
/* 80207500 00203340  7C 65 22 14 */	add r3, r5, r4
/* 80207504 00203344  83 23 00 08 */	lwz r25, 0x8(r3)
...
/* 80207514 00203354  2C 03 00 00 */	cmpwi r3, 0x0
/* 80207518 00203358  41 82 00 1C */	beq lbl_80207534
/* 8020751C 0020335C  7F 23 CB 78 */	mr r3, r25
/* 80207520 00203360  38 8D A0 D4 */	addi r4, r13, "@48901_805584F4"@sda21
/* 80207524 00203364  4B E0 66 19 */	bl strcmp
/* 80207528 00203368  2C 03 00 00 */	cmpwi r3, 0x0
/* 8020752C 0020336C  41 82 00 08 */	beq lbl_80207534
/* 80207530 00203370  3B 40 00 00 */	li r26, 0x0
.global lbl_80207534
lbl_80207534:
/* 80207534 00203374  2C 1A 00 00 */	cmpwi r26, 0x0
/* 80207538 00203378  40 82 00 1C */	bne lbl_80207554
/* 8020753C 0020337C  7F 23 CB 78 */	mr r3, r25
/* 80207540 00203380  38 8D A0 DC */	addi r4, r13, "@48902_805584FC"@sda21
/* 80207544 00203384  4B E0 65 F9 */	bl strcmp
/* 80207548 00203388  2C 03 00 00 */	cmpwi r3, 0x0
/* 8020754C 0020338C  41 82 00 08 */	beq lbl_80207554
/* 80207550 00203390  3B 60 00 00 */	li r27, 0x0
.global lbl_80207554
lbl_80207554:
/* 80207554 00203394  2C 1B 00 00 */	cmpwi r27, 0x0
/* 80207558 00203398  40 82 00 1C */	bne lbl_80207574
/* 8020755C 0020339C  7F 23 CB 78 */	mr r3, r25
/* 80207560 002033A0  38 8D A0 E8 */	addi r4, r13, "@48903_80558508"@sda21
/* 80207564 002033A4  4B E0 65 D9 */	bl strcmp
/* 80207568 002033A8  2C 03 00 00 */	cmpwi r3, 0x0
/* 8020756C 002033AC  41 82 00 08 */	beq lbl_80207574
/* 80207570 002033B0  3B 80 00 00 */	li r28, 0x0
.global lbl_80207574
lbl_80207574:
/* 80207574 002033B4  2C 1C 00 00 */	cmpwi r28, 0x0
...
/* 80207588 002033C8  2C 03 00 00 */	cmpwi r3, 0x0
/* 8020758C 002033CC  41 82 00 08 */	beq lbl_80207594
/* 80207590 002033D0  3B A0 00 00 */	li r29, 0x0
.global lbl_80207594
lbl_80207594:
/* 80207594 002033D4  2C 1D 00 00 */	cmpwi r29, 0x0
/* 80207598 002033D8  40 82 00 1C */	bne lbl_802075B4
/* 8020759C 002033DC  7F 23 CB 78 */	mr r3, r25
/* 802075A0 002033E0  38 8D A0 F0 */	addi r4, r13, "@48905_80558510"@sda21
/* 802075A4 002033E4  4B E0 65 99 */	bl strcmp
/* 802075A8 002033E8  2C 03 00 00 */	cmpwi r3, 0x0
/* 802075AC 002033EC  41 82 00 08 */	beq lbl_802075B4
/* 802075B0 002033F0  3B C0 00 00 */	li r30, 0x0
.global lbl_802075B4
lbl_802075B4:
...
/* 802075C4 00203404  38 60 00 00 */	li r3, 0x0
.global lbl_802075C8
lbl_802075C8:
/* 802075C8 00203408  39 61 00 30 */	addi r11, r1, 0x30
/* 802075CC 0020340C  4B DF FD B5 */	bl lbl_80007380
