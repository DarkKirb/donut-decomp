...
/* 803C0E44 003BCC84  D0 23 00 04 */	stfs f1, 4(r3)
/* 803C0E48 003BCC88  D0 43 00 08 */	stfs f2, 8(r3)
/* 803C0E4C 003BCC8C  38 00 00 00 */	li r0, 0
...
/* 803C0E5C 003BCC9C  2C 04 00 00 */	cmpwi r4, 0
/* 803C0E60 003BCCA0  4D 82 00 20 */	beqlr 
/* 803C0E64 003BCCA4  38 04 FF FF */	addi r0, r4, -1
...
/* 803C0E80 003BCCC0  F3 E1 00 18 */	psq_st f31, 24(r1), 0, qr0
...
/* 803C0E90 003BCCD0  2C 00 00 00 */	cmpwi r0, 0
/* 803C0E94 003BCCD4  41 82 00 0C */	beq lbl_803C0EA0
/* 803C0E98 003BCCD8  38 60 00 00 */	li r3, 0
/* 803C0E9C 003BCCDC  48 00 00 70 */	b lbl_803C0F0C
lbl_803C0EA0:
/* 803C0EA0 003BCCE0  80 63 00 00 */	lwz r3, 0(r3)
...
/* 803C0EAC 003BCCEC  2C 03 00 00 */	cmpwi r3, 0
/* 803C0EB0 003BCCF0  40 82 00 0C */	bne lbl_803C0EBC
/* 803C0EB4 003BCCF4  38 60 00 00 */	li r3, 0
/* 803C0EB8 003BCCF8  48 00 00 54 */	b lbl_803C0F0C
lbl_803C0EBC:
/* 803C0EBC 003BCCFC  80 7F 00 00 */	lwz r3, 0(r31)
...
/* 803C0EC8 003BCD08  2C 03 00 00 */	cmpwi r3, 0
/* 803C0ECC 003BCD0C  41 82 00 0C */	beq lbl_803C0ED8
/* 803C0ED0 003BCD10  C3 E2 DA 30 */	lfs f31, $$252540-_SDA2_BASE_(r2)
/* 803C0ED4 003BCD14  48 00 00 08 */	b lbl_803C0EDC
lbl_803C0ED8:
/* 803C0ED8 003BCD18  C3 E2 DA 34 */	lfs f31, $$252541-_SDA2_BASE_(r2)
lbl_803C0EDC:
/* 803C0EDC 003BCD1C  80 7F 00 00 */	lwz r3, 0(r31)
/* 803C0EE0 003BCD20  48 00 1E 01 */	bl move__Q43scn4step4item4ItemFv
/* 803C0EE4 003BCD24  C0 1F 00 04 */	lfs f0, 4(r31)
...
/* 803C0EF0 003BCD30  80 7F 00 00 */	lwz r3, 0(r31)
/* 803C0EF4 003BCD34  48 00 1D ED */	bl move__Q43scn4step4item4ItemFv
/* 803C0EF8 003BCD38  C0 3F 00 08 */	lfs f1, 8(r31)
...
/* 803C0F08 003BCD48  38 60 00 01 */	li r3, 1
lbl_803C0F0C:
...
.global $$252541
$$252541:
	.incbin "baserom.dol", 0x49E4F4, 0x4
