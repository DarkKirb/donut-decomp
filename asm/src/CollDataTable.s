...
/* 801D580C 001D164C  4B E3 1B 31 */	bl func_8000733C
/* 801D5810 001D1650  7C 7B 1B 78 */	mr r27, r3
/* 801D5814 001D1654  7C 9C 23 78 */	mr r28, r4
/* 801D5818 001D1658  7C BD 2B 78 */	mr r29, r5
/* 801D581C 001D165C  90 83 00 00 */	stw r4, 0(r3)
/* 801D5820 001D1660  90 A3 00 04 */	stw r5, 4(r3)
/* 801D5824 001D1664  38 63 00 08 */	addi r3, r3, 8
/* 801D5828 001D1668  4B F0 7B B9 */	bl __ct__Q34nw4r3g3d8LightObjFv
/* 801D582C 001D166C  80 1B 00 04 */	lwz r0, 4(r27)
/* 801D5830 001D1670  2C 00 00 00 */	cmpwi r0, 0
...
/* 801D5844 001D1684  38 7B 00 08 */	addi r3, r27, 8
/* 801D5848 001D1688  1C 9D 00 2C */	mulli r4, r29, 0x2c
/* 801D584C 001D168C  38 A0 00 04 */	li r5, 4
/* 801D5850 001D1690  38 C1 00 0C */	addi r6, r1, 0xc
/* 801D5854 001D1694  4B FA D8 51 */	bl construct$$0Ul$$4l$$4Q33std3tr137reference_wrapper$$0Q23mem10IAllocator$$1$$1__Q24util30PlacementNew$$0Q23mem9DataBlock$$1FUllQ33std3tr137reference_wrapper$$0Q23mem10IAllocator$$1_v
/* 801D5858 001D1698  3B E0 00 00 */	li r31, 0
/* 801D585C 001D169C  48 00 00 10 */	b lbl_801D586C
lbl_801D5860:
/* 801D5860 001D16A0  7F 63 DB 78 */	mr r3, r27
/* 801D5864 001D16A4  4B FA D8 A1 */	bl head__Q23mem50RuntimeFixedArray$$0Q36effect6detail13PolyEffectRes$$1Fv
/* 801D5868 001D16A8  3B FF 00 01 */	addi r31, r31, 1
lbl_801D586C:
/* 801D586C 001D16AC  80 1B 00 04 */	lwz r0, 4(r27)
...
/* 801D587C 001D16BC  93 9E 00 00 */	stw r28, 0(r30)
/* 801D5880 001D16C0  93 BE 00 04 */	stw r29, 4(r30)
/* 801D5884 001D16C4  38 7E 00 08 */	addi r3, r30, 8
/* 801D5888 001D16C8  4B F0 7B 59 */	bl __ct__Q34nw4r3g3d8LightObjFv
/* 801D588C 001D16CC  80 1E 00 04 */	lwz r0, 4(r30)
/* 801D5890 001D16D0  2C 00 00 00 */	cmpwi r0, 0
...
/* 801D58A0 001D16E0  90 61 00 08 */	stw r3, 8(r1)
/* 801D58A4 001D16E4  38 7E 00 08 */	addi r3, r30, 8
/* 801D58A8 001D16E8  57 A4 10 3A */	slwi r4, r29, 2
/* 801D58AC 001D16EC  38 A0 00 04 */	li r5, 4
/* 801D58B0 001D16F0  38 C1 00 08 */	addi r6, r1, 8
/* 801D58B4 001D16F4  4B FA D7 F1 */	bl construct$$0Ul$$4l$$4Q33std3tr137reference_wrapper$$0Q23mem10IAllocator$$1$$1__Q24util30PlacementNew$$0Q23mem9DataBlock$$1FUllQ33std3tr137reference_wrapper$$0Q23mem10IAllocator$$1_v
/* 801D58B8 001D16F8  3B A0 00 00 */	li r29, 0
/* 801D58BC 001D16FC  3B E0 00 00 */	li r31, 0
/* 801D58C0 001D1700  48 00 00 20 */	b lbl_801D58E0
lbl_801D58C4:
/* 801D58C4 001D1704  7F C3 F3 78 */	mr r3, r30
/* 801D58C8 001D1708  4B FA D8 3D */	bl head__Q23mem50RuntimeFixedArray$$0Q36effect6detail13PolyEffectRes$$1Fv
/* 801D58CC 001D170C  7C 63 EA 14 */	add r3, r3, r29
/* 801D58D0 001D1710  2C 03 00 00 */	cmpwi r3, 0
/* 801D58D4 001D1714  41 82 00 08 */	beq lbl_801D58DC
/* 801D58D8 001D1718  9B E3 00 00 */	stb r31, 0(r3)
lbl_801D58DC:
/* 801D58DC 001D171C  3B BD 00 01 */	addi r29, r29, 1
lbl_801D58E0:
/* 801D58E0 001D1720  80 1E 00 04 */	lwz r0, 4(r30)
/* 801D58E4 001D1724  7C 1D 00 40 */	cmplw r29, r0
/* 801D58E8 001D1728  41 80 FF DC */	blt lbl_801D58C4
lbl_801D58EC:
/* 801D58EC 001D172C  3B A0 00 00 */	li r29, 0
/* 801D58F0 001D1730  3B E0 00 00 */	li r31, 0
...
/* 801D5900 001D1740  48 00 01 4D */	bl __vc__Q23mem20RuntimeFixedArray$$0b$$1FUl
/* 801D5904 001D1744  9B E3 00 00 */	stb r31, 0(r3)
/* 801D5908 001D1748  3B BD 00 01 */	addi r29, r29, 1
lbl_801D590C:
/* 801D590C 001D174C  80 1B 00 04 */	lwz r0, 4(r27)
...
/* 801D5920 001D1760  4B E3 1A 69 */	bl func_80007388
...
.global __dt__Q23mem39RuntimeFixedArray$$0Q25ocoll10AttackData$$1Fv
__dt__Q23mem39RuntimeFixedArray$$0Q25ocoll10AttackData$$1Fv:
...
/* 801D5944 001D1784  4B E3 1A 01 */	bl func_80007344
/* 801D5948 001D1788  7C 7D 1B 78 */	mr r29, r3
/* 801D594C 001D178C  7C 9E 23 78 */	mr r30, r4
/* 801D5950 001D1790  2C 03 00 00 */	cmpwi r3, 0
/* 801D5954 001D1794  41 82 00 50 */	beq lbl_801D59A4
/* 801D5958 001D1798  83 E3 00 04 */	lwz r31, 4(r3)
/* 801D595C 001D179C  2C 1F 00 00 */	cmpwi r31, 0
...
/* 801D596C 001D17AC  4B FA D7 99 */	bl head__Q23mem50RuntimeFixedArray$$0Q36effect6detail13PolyEffectRes$$1Fv
/* 801D5970 001D17B0  3B FF FF FF */	addi r31, r31, -1
lbl_801D5974:
/* 801D5974 001D17B4  2C 1F 00 00 */	cmpwi r31, 0
/* 801D5978 001D17B8  40 82 FF F0 */	bne lbl_801D5968
/* 801D597C 001D17BC  38 7D 00 08 */	addi r3, r29, 8
/* 801D5980 001D17C0  4B FA 87 79 */	bl destruct__Q24util30PlacementNew$$0Q23mem9DataBlock$$1Fv
lbl_801D5984:
/* 801D5984 001D17C4  38 7D 00 08 */	addi r3, r29, 8
/* 801D5988 001D17C8  38 80 FF FF */	li r4, -1
/* 801D598C 001D17CC  4B FA 87 B1 */	bl __dt__Q24util30PlacementNew$$0Q23mem9DataBlock$$1Fv
/* 801D5990 001D17D0  7F C0 07 34 */	extsh r0, r30
/* 801D5994 001D17D4  2C 00 00 00 */	cmpwi r0, 0
...
/* 801D59AC 001D17EC  4B E3 19 E5 */	bl func_80007390
...
.global __dt__Q23mem20RuntimeFixedArray$$0b$$1Fv
__dt__Q23mem20RuntimeFixedArray$$0b$$1Fv:
...
/* 801D59D0 001D1810  4B E3 19 75 */	bl func_80007344
/* 801D59D4 001D1814  7C 7D 1B 78 */	mr r29, r3
/* 801D59D8 001D1818  7C 9E 23 78 */	mr r30, r4
/* 801D59DC 001D181C  2C 03 00 00 */	cmpwi r3, 0
/* 801D59E0 001D1820  41 82 00 50 */	beq lbl_801D5A30
/* 801D59E4 001D1824  83 E3 00 04 */	lwz r31, 4(r3)
/* 801D59E8 001D1828  2C 1F 00 00 */	cmpwi r31, 0
...
/* 801D59F8 001D1838  4B FA D7 0D */	bl head__Q23mem50RuntimeFixedArray$$0Q36effect6detail13PolyEffectRes$$1Fv
/* 801D59FC 001D183C  3B FF FF FF */	addi r31, r31, -1
lbl_801D5A00:
/* 801D5A00 001D1840  2C 1F 00 00 */	cmpwi r31, 0
/* 801D5A04 001D1844  40 82 FF F0 */	bne lbl_801D59F4
/* 801D5A08 001D1848  38 7D 00 08 */	addi r3, r29, 8
/* 801D5A0C 001D184C  4B FA 86 ED */	bl destruct__Q24util30PlacementNew$$0Q23mem9DataBlock$$1Fv
lbl_801D5A10:
/* 801D5A10 001D1850  38 7D 00 08 */	addi r3, r29, 8
/* 801D5A14 001D1854  38 80 FF FF */	li r4, -1
/* 801D5A18 001D1858  4B FA 87 25 */	bl __dt__Q24util30PlacementNew$$0Q23mem9DataBlock$$1Fv
/* 801D5A1C 001D185C  7F C0 07 34 */	extsh r0, r30
/* 801D5A20 001D1860  2C 00 00 00 */	cmpwi r0, 0
...
/* 801D5A38 001D1878  4B E3 19 59 */	bl func_80007390
...
.global __vc__Q23mem20RuntimeFixedArray$$0b$$1FUl
__vc__Q23mem20RuntimeFixedArray$$0b$$1FUl:
...
/* 801D5AA8 001D18E8  4B E3 18 9D */	bl func_80007344
...
/* 801D5ABC 001D18FC  80 9D 00 04 */	lwz r4, 4(r29)
/* 801D5AC0 001D1900  4B E4 E9 E1 */	bl DefaultSwitchThreadCallback
/* 801D5AC4 001D1904  7F A3 EB 78 */	mr r3, r29
/* 801D5AC8 001D1908  4B FA D6 3D */	bl head__Q23mem50RuntimeFixedArray$$0Q36effect6detail13PolyEffectRes$$1Fv
/* 801D5ACC 001D190C  1C 1E 00 2C */	mulli r0, r30, 0x2c
/* 801D5AD0 001D1910  7C 63 02 14 */	add r3, r3, r0
/* 801D5AD4 001D1914  A0 1F 00 00 */	lhz r0, 0(r31)
/* 801D5AD8 001D1918  B0 03 00 00 */	sth r0, 0(r3)
/* 801D5ADC 001D191C  A0 1F 00 02 */	lhz r0, 2(r31)
/* 801D5AE0 001D1920  B0 03 00 02 */	sth r0, 2(r3)
/* 801D5AE4 001D1924  88 1F 00 04 */	lbz r0, 4(r31)
/* 801D5AE8 001D1928  98 03 00 04 */	stb r0, 4(r3)
/* 801D5AEC 001D192C  88 1F 00 05 */	lbz r0, 5(r31)
/* 801D5AF0 001D1930  98 03 00 05 */	stb r0, 5(r3)
/* 801D5AF4 001D1934  88 1F 00 06 */	lbz r0, 6(r31)
/* 801D5AF8 001D1938  98 03 00 06 */	stb r0, 6(r3)
/* 801D5AFC 001D193C  88 1F 00 07 */	lbz r0, 7(r31)
/* 801D5B00 001D1940  98 03 00 07 */	stb r0, 7(r3)
/* 801D5B04 001D1944  88 1F 00 08 */	lbz r0, 8(r31)
/* 801D5B08 001D1948  98 03 00 08 */	stb r0, 8(r3)
/* 801D5B0C 001D194C  88 1F 00 09 */	lbz r0, 9(r31)
/* 801D5B10 001D1950  98 03 00 09 */	stb r0, 9(r3)
...
/* 801D5B9C 001D19DC  3B E0 00 01 */	li r31, 1
/* 801D5BA0 001D19E0  38 7D 00 18 */	addi r3, r29, 0x18
/* 801D5BA4 001D19E4  7F C4 F3 78 */	mr r4, r30
/* 801D5BA8 001D19E8  4B FF FE A5 */	bl __vc__Q23mem20RuntimeFixedArray$$0b$$1FUl
/* 801D5BAC 001D19EC  9B E3 00 00 */	stb r31, 0(r3)
/* 801D5BB0 001D19F0  39 61 00 20 */	addi r11, r1, 0x20
/* 801D5BB4 001D19F4  4B E3 17 DD */	bl func_80007390
...
/* 801D5BE8 001D1A28  80 9E 00 04 */	lwz r4, 4(r30)
/* 801D5BEC 001D1A2C  4B E4 E8 B5 */	bl DefaultSwitchThreadCallback
/* 801D5BF0 001D1A30  80 7E 00 08 */	lwz r3, 8(r30)
/* 801D5BF4 001D1A34  4B FA D5 45 */	bl block__Q23mem9DataBlockCFv
/* 801D5BF8 001D1A38  90 81 00 0C */	stw r4, 0xc(r1)
/* 801D5BFC 001D1A3C  90 61 00 08 */	stw r3, 8(r1)
/* 801D5C00 001D1A40  38 61 00 08 */	addi r3, r1, 8
