...
/* 801B68D8 001B2718  93 C1 00 08 */	stw r30, 0x8(r1)
/* 801B68DC 001B271C  7C 7E 1B 78 */	mr r30, r3
/* 801B68E0 001B2720  3B E0 00 00 */	li r31, 0x0
/* 801B68E4 001B2724  9B E3 00 00 */	stb r31, 0x0(r3)
/* 801B68E8 001B2728  38 63 00 04 */	addi r3, r3, 0x4
...
/* 801B6914 001B2754  38 8D EE 20 */	addi r4, r13, ORIGIN__Q33hel4math6Point2@sda21
...
/* 801B6920 001B2760  38 8D EE 38 */	addi r4, r13, BASIS_X__Q33hel4math7Vector2@sda21
...
/* 801B692C 001B276C  38 8D EE 40 */	addi r4, r13, BASIS_Y__Q33hel4math7Vector2@sda21
...
/* 801B693C 001B277C  C0 02 9A C0 */	lfs f0, "@50421_8055FA40"@sda21(r2)
...
/* 801B695C 001B279C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 801B6984 001B27C4  4B E5 09 B9 */	bl lbl_8000733C
...
/* 801B69A0 001B27E0  38 00 00 01 */	li r0, 0x1
/* 801B69A4 001B27E4  98 03 00 00 */	stb r0, 0x0(r3)
/* 801B69A8 001B27E8  38 63 00 04 */	addi r3, r3, 0x4
...
/* 801B69CC 001B280C  80 1E 00 00 */	lwz r0, 0x0(r30)
...
/* 801B69EC 001B282C  4B E5 09 9D */	bl lbl_80007388
...
/* 801B6A10 001B2850  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 801B6A20 001B2860  38 7E 00 08 */	addi r3, r30, 0x8
/* 801B6A24 001B2864  38 9F 00 08 */	addi r4, r31, 0x8
...
/* 801B6A3C 001B287C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 801B6A60 001B28A0  93 C1 00 08 */	stw r30, 0x8(r1)
/* 801B6A64 001B28A4  7C 7E 1B 78 */	mr r30, r3
/* 801B6A68 001B28A8  7C 9F 23 78 */	mr r31, r4
/* 801B6A6C 001B28AC  88 04 00 00 */	lbz r0, 0x0(r4)
/* 801B6A70 001B28B0  98 03 00 00 */	stb r0, 0x0(r3)
/* 801B6A74 001B28B4  88 04 00 01 */	lbz r0, 0x1(r4)
/* 801B6A78 001B28B8  98 03 00 01 */	stb r0, 0x1(r3)
/* 801B6A7C 001B28BC  88 04 00 02 */	lbz r0, 0x2(r4)
/* 801B6A80 001B28C0  98 03 00 02 */	stb r0, 0x2(r3)
/* 801B6A84 001B28C4  88 04 00 03 */	lbz r0, 0x3(r4)
/* 801B6A88 001B28C8  98 03 00 03 */	stb r0, 0x3(r3)
/* 801B6A8C 001B28CC  88 04 00 04 */	lbz r0, 0x4(r4)
/* 801B6A90 001B28D0  98 03 00 04 */	stb r0, 0x4(r3)
/* 801B6A94 001B28D4  88 04 00 05 */	lbz r0, 0x5(r4)
/* 801B6A98 001B28D8  98 03 00 05 */	stb r0, 0x5(r3)
/* 801B6A9C 001B28DC  88 04 00 06 */	lbz r0, 0x6(r4)
/* 801B6AA0 001B28E0  98 03 00 06 */	stb r0, 0x6(r3)
/* 801B6AA4 001B28E4  38 63 00 08 */	addi r3, r3, 0x8
/* 801B6AA8 001B28E8  38 84 00 08 */	addi r4, r4, 0x8
...
/* 801B6AD0 001B2910  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 801B6AE4 001B2924  38 84 00 04 */	addi r4, r4, 0x4
