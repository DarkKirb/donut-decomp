...
/* 801DB328 001D7168  4B E2 C0 15 */	bl func_8000733C
...
/* 801DB344 001D7184  93 9B 00 00 */	stw r28, 0(r27)
/* 801DB348 001D7188  93 DB 00 04 */	stw r30, 4(r27)
/* 801DB34C 001D718C  9B FB 00 08 */	stb r31, 8(r27)
/* 801DB350 001D7190  80 1D 00 00 */	lwz r0, 0(r29)
/* 801DB354 001D7194  90 1B 00 0C */	stw r0, 0xc(r27)
/* 801DB358 001D7198  39 61 00 20 */	addi r11, r1, 0x20
/* 801DB35C 001D719C  4B E2 C0 2D */	bl func_80007388
...
/* 801DB370 001D71B0  38 C0 00 00 */	li r6, 0
/* 801DB374 001D71B4  80 A3 00 00 */	lwz r5, 0(r3)
/* 801DB378 001D71B8  80 04 00 00 */	lwz r0, 0(r4)
/* 801DB37C 001D71BC  7C 05 00 40 */	cmplw r5, r0
/* 801DB380 001D71C0  40 82 00 28 */	bne lbl_801DB3A8
/* 801DB384 001D71C4  80 A3 00 04 */	lwz r5, 4(r3)
/* 801DB388 001D71C8  80 04 00 04 */	lwz r0, 4(r4)
/* 801DB38C 001D71CC  7C 05 00 00 */	cmpw r5, r0
/* 801DB390 001D71D0  40 82 00 18 */	bne lbl_801DB3A8
/* 801DB394 001D71D4  88 63 00 08 */	lbz r3, 8(r3)
/* 801DB398 001D71D8  88 04 00 08 */	lbz r0, 8(r4)
/* 801DB39C 001D71DC  7C 03 00 40 */	cmplw r3, r0
/* 801DB3A0 001D71E0  40 82 00 08 */	bne lbl_801DB3A8
/* 801DB3A4 001D71E4  38 C0 00 01 */	li r6, 1
lbl_801DB3A8:
...
/* 801DB3CC 001D720C  38 00 00 00 */	li r0, 0
/* 801DB3D0 001D7210  90 01 00 08 */	stw r0, 8(r1)
/* 801DB3D4 001D7214  90 01 00 0C */	stw r0, 0xc(r1)
/* 801DB3D8 001D7218  90 01 00 10 */	stw r0, 0x10(r1)
/* 801DB3DC 001D721C  90 1F 00 00 */	stw r0, 0(r31)
/* 801DB3E0 001D7220  90 1F 00 04 */	stw r0, 4(r31)
/* 801DB3E4 001D7224  88 01 00 10 */	lbz r0, 0x10(r1)
/* 801DB3E8 001D7228  98 1F 00 08 */	stb r0, 8(r31)
