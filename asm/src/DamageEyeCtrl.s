...
/* 8025C180 00257FC0  88 03 00 04 */	lbz r0, 4(r3)
/* 8025C184 00257FC4  2C 00 00 00 */	cmpwi r0, 0
/* 8025C188 00257FC8  41 82 00 4C */	beq lbl_8025C1D4
/* 8025C18C 00257FCC  80 63 00 00 */	lwz r3, 0(r3)
...
/* 8025C1C4 00258004  38 80 00 00 */	li r4, 0
/* 8025C1C8 00258008  4B F3 D6 35 */	bl subAnimClear__Q24gobj4AnimFUl
/* 8025C1CC 0025800C  38 00 00 00 */	li r0, 0
/* 8025C1D0 00258010  98 1F 00 04 */	stb r0, 4(r31)
lbl_8025C1D4:
...
/* 8025C1FC 0025803C  80 63 00 00 */	lwz r3, 0(r3)
...
/* 8025C208 00258048  38 80 00 00 */	li r4, 0
/* 8025C20C 0025804C  38 A0 00 15 */	li r5, 0x15
/* 8025C210 00258050  38 C0 00 01 */	li r6, 1
/* 8025C214 00258054  4B F3 D5 3D */	bl subAnimSet__Q24gobj4AnimFUlUlUl
/* 8025C218 00258058  80 7F 00 00 */	lwz r3, 0(r31)
...
/* 8025C224 00258064  38 80 00 00 */	li r4, 0
/* 8025C228 00258068  4B F3 D6 85 */	bl subAnimAccessor__Q24gobj4AnimFUl
/* 8025C22C 0025806C  90 81 00 0C */	stw r4, 0xc(r1)
/* 8025C230 00258070  90 61 00 08 */	stw r3, 8(r1)
/* 8025C234 00258074  38 61 00 08 */	addi r3, r1, 8
/* 8025C238 00258078  38 80 00 00 */	li r4, 0
/* 8025C23C 0025807C  4B F3 5A 55 */	bl start__Q23g3d17ModelAnimAccessorCFb
/* 8025C240 00258080  38 00 00 01 */	li r0, 1
/* 8025C244 00258084  98 1F 00 04 */	stb r0, 4(r31)
