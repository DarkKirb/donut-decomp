...
/* 8026DB74 002699B4  38 00 00 00 */	li r0, 0
/* 8026DB78 002699B8  98 03 00 00 */	stb r0, 0(r3)
/* 8026DB7C 002699BC  38 63 00 08 */	addi r3, r3, 8
...
/* 8026DBAC 002699EC  F3 E1 00 F8 */	psq_st f31, 248(r1), 0, qr0
/* 8026DBB0 002699F0  DB C1 00 E0 */	stfd f30, 0xe0(r1)
/* 8026DBB4 002699F4  F3 C1 00 E8 */	psq_st f30, 232(r1), 0, qr0
/* 8026DBB8 002699F8  DB A1 00 D0 */	stfd f29, 0xd0(r1)
/* 8026DBBC 002699FC  F3 A1 00 D8 */	psq_st f29, 216(r1), 0, qr0
/* 8026DBC0 00269A00  DB 81 00 C0 */	stfd f28, 0xc0(r1)
/* 8026DBC4 00269A04  F3 81 00 C8 */	psq_st f28, 200(r1), 0, qr0
...
/* 8026DC38 00269A78  38 00 00 01 */	li r0, 1
/* 8026DC3C 00269A7C  98 03 00 00 */	stb r0, 0(r3)
/* 8026DC40 00269A80  38 63 00 08 */	addi r3, r3, 8
/* 8026DC44 00269A84  48 00 01 C1 */	bl __ct__Q53scn4step5chara10DamageInfo4DataFv
/* 8026DC48 00269A88  38 81 00 04 */	addi r4, r1, 4
/* 8026DC4C 00269A8C  38 60 00 00 */	li r3, 0
/* 8026DC50 00269A90  38 00 00 0D */	li r0, 0xd
/* 8026DC54 00269A94  7C 09 03 A6 */	mtctr r0
lbl_8026DC58:
/* 8026DC58 00269A98  90 64 00 04 */	stw r3, 4(r4)
/* 8026DC5C 00269A9C  94 64 00 08 */	stwu r3, 8(r4)
/* 8026DC60 00269AA0  42 00 FF F8 */	bdnz lbl_8026DC58
/* 8026DC64 00269AA4  38 61 00 08 */	addi r3, r1, 8
/* 8026DC68 00269AA8  48 00 01 9D */	bl __ct__Q53scn4step5chara10DamageInfo4DataFv
/* 8026DC6C 00269AAC  80 61 00 08 */	lwz r3, 8(r1)
/* 8026DC70 00269AB0  80 01 00 0C */	lwz r0, 0xc(r1)
/* 8026DC74 00269AB4  90 6F 00 08 */	stw r3, 8(r15)
...
/* 8026DD3C 00269B7C  38 6F 00 08 */	addi r3, r15, 8
...
/* 8026DE14 00269C54  93 C1 00 08 */	stw r30, 8(r1)
/* 8026DE18 00269C58  7C 7E 1B 78 */	mr r30, r3
/* 8026DE1C 00269C5C  4B F3 16 61 */	bl __ct__Q33hel4math7Vector2Fv
/* 8026DE20 00269C60  3B E0 00 00 */	li r31, 0
/* 8026DE24 00269C64  93 FE 00 08 */	stw r31, 8(r30)
...
/* 8026DE50 00269C90  C0 02 AC D8 */	lfs f0, $$249900-_SDA2_BASE_(r2)
...
/* 8026DE90 00269CD0  83 C1 00 08 */	lwz r30, 8(r1)
...
.global $$249900
$$249900:
	.incbin "baserom.dol", 0x49B798, 0x8
