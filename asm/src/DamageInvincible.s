...
/* 8022F0F0 0022AF30  2C 04 00 00 */	cmpwi r4, 0
/* 8022F0F4 0022AF34  4D 82 00 20 */	beqlr 
/* 8022F0F8 0022AF38  38 04 FF FF */	addi r0, r4, -1
/* 8022F0FC 0022AF3C  90 03 00 04 */	stw r0, 4(r3)
...
/* 8022F114 0022AF54  4B DD 82 31 */	bl func_80007344
...
/* 8022F13C 0022AF7C  38 A0 00 00 */	li r5, 0
/* 8022F140 0022AF80  38 60 00 00 */	li r3, 0
/* 8022F144 0022AF84  3C 80 80 46 */	lis r4, T_FRAME_BY_DAMAGE_TABLE__Q43scn4step4boss30$$2unnamed$$2DamageInvincible_cpp$$2@ha
/* 8022F148 0022AF88  38 84 45 50 */	addi r4, r4, T_FRAME_BY_DAMAGE_TABLE__Q43scn4step4boss30$$2unnamed$$2DamageInvincible_cpp$$2@l
/* 8022F14C 0022AF8C  38 00 00 07 */	li r0, 7
...
/* 8022F1D0 0022B010  93 C1 00 08 */	stw r30, 8(r1)
...
/* 8022F1E8 0022B028  2C 00 00 00 */	cmpwi r0, 0
/* 8022F1EC 0022B02C  41 82 00 0C */	beq lbl_8022F1F8
/* 8022F1F0 0022B030  38 60 00 00 */	li r3, 0
...
/* 8022F200 0022B040  38 03 FE F9 */	addi r0, r3, -263
/* 8022F204 0022B044  28 00 00 03 */	cmplwi r0, 3
/* 8022F208 0022B048  40 81 00 10 */	ble lbl_8022F218
/* 8022F20C 0022B04C  38 03 FE FC */	addi r0, r3, -260
/* 8022F210 0022B050  28 00 00 01 */	cmplwi r0, 1
/* 8022F214 0022B054  41 81 00 0C */	bgt lbl_8022F220
lbl_8022F218:
/* 8022F218 0022B058  38 60 00 00 */	li r3, 0
/* 8022F21C 0022B05C  48 00 00 0C */	b lbl_8022F228
lbl_8022F220:
/* 8022F220 0022B060  7F C3 F3 78 */	mr r3, r30
/* 8022F224 0022B064  4B F4 88 91 */	bl isConstruct__Q23mem43ExplicitScopedPtr$$0Q23app16HIDErrorMenuImpl$$1CFv
lbl_8022F228:
/* 8022F228 0022B068  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 8022F22C 0022B06C  83 C1 00 08 */	lwz r30, 8(r1)
