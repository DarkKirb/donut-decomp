...
/* 803CCDFC 003C8C3C  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803CCE00 003C8C40  7C 7E 1B 78 */	mr r30, r3
/* 803CCE04 003C8C44  7C 9F 23 78 */	mr r31, r4
/* 803CCE08 003C8C48  3C 80 80 49 */	lis r4, lbl_80492C38@ha
/* 803CCE0C 003C8C4C  38 84 2C 38 */	addi r4, r4, lbl_80492C38@l
/* 803CCE10 003C8C50  4B E0 8E 19 */	bl lbl_801D5C28
/* 803CCE14 003C8C54  38 00 00 00 */	li r0, 0x0
/* 803CCE18 003C8C58  98 1E 00 10 */	stb r0, 0x10(r30)
/* 803CCE1C 003C8C5C  7F E3 FB 78 */	mr r3, r31
/* 803CCE20 003C8C60  4B DA 95 A1 */	bl lbl_801763C0
...
/* 803CCE30 003C8C70  38 00 00 01 */	li r0, 0x1
...
/* 803CCE40 003C8C80  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 803CCE6C 003C8CAC  C0 22 DC 00 */	lfs f1, lbl_80563B80@sda21(r2)
/* 803CCE70 003C8CB0  C0 42 DC 04 */	lfs f2, lbl_80563B84@sda21(r2)
/* 803CCE74 003C8CB4  FC 60 10 90 */	fmr f3, f2
/* 803CCE78 003C8CB8  FC 80 08 90 */	fmr f4, f1
/* 803CCE7C 003C8CBC  C0 A2 DC 08 */	lfs f5, lbl_80563B88@sda21(r2)
/* 803CCE80 003C8CC0  FC C0 08 90 */	fmr f6, f1
/* 803CCE84 003C8CC4  4B DD 1C A5 */	bl lbl_8019EB28
/* 803CCE88 003C8CC8  38 61 00 B0 */	addi r3, r1, 0xb0
/* 803CCE8C 003C8CCC  38 80 00 00 */	li r4, 0x0
/* 803CCE90 003C8CD0  4B DC 81 C5 */	bl lbl_80195054
/* 803CCE94 003C8CD4  3C 60 80 54 */	lis r3, lbl_80545300@ha
/* 803CCE98 003C8CD8  38 83 53 00 */	addi r4, r3, lbl_80545300@l
/* 803CCE9C 003C8CDC  80 64 00 00 */	lwz r3, 0x0(r4)
/* 803CCEA0 003C8CE0  80 04 00 04 */	lwz r0, 0x4(r4)
/* 803CCEA4 003C8CE4  90 61 00 08 */	stw r3, 0x8(r1)
/* 803CCEA8 003C8CE8  90 01 00 0C */	stw r0, 0xc(r1)
/* 803CCEAC 003C8CEC  80 04 00 08 */	lwz r0, 0x8(r4)
/* 803CCEB0 003C8CF0  90 01 00 10 */	stw r0, 0x10(r1)
/* 803CCEB4 003C8CF4  C0 01 00 08 */	lfs f0, 0x8(r1)
/* 803CCEB8 003C8CF8  C0 22 DC 04 */	lfs f1, lbl_80563B84@sda21(r2)
/* 803CCEBC 003C8CFC  EC 00 00 72 */	fmuls f0, f0, f1
/* 803CCEC0 003C8D00  D0 01 00 08 */	stfs f0, 0x8(r1)
...
/* 803CCEDC 003C8D1C  80 61 00 08 */	lwz r3, 0x8(r1)
...
/* 803CCEF8 003C8D38  3C 80 80 54 */	lis r4, lbl_805452D0@ha
/* 803CCEFC 003C8D3C  38 84 52 D0 */	addi r4, r4, lbl_805452D0@l
/* 803CCF00 003C8D40  3C A0 80 54 */	lis r5, lbl_805452F4@ha
/* 803CCF04 003C8D44  38 A5 52 F4 */	addi r5, r5, lbl_805452F4@l
/* 803CCF08 003C8D48  38 C1 00 44 */	addi r6, r1, 0x44
/* 803CCF0C 003C8D4C  4B DD 18 A5 */	bl lbl_8019E7B0
/* 803CCF10 003C8D50  38 61 00 80 */	addi r3, r1, 0x80
/* 803CCF14 003C8D54  4B DC 84 01 */	bl lbl_80195314
/* 803CCF18 003C8D58  7F E3 FB 78 */	mr r3, r31
/* 803CCF1C 003C8D5C  4B F7 4C 31 */	bl lbl_80341B4C
/* 803CCF20 003C8D60  4B DC 83 C5 */	bl lbl_801952E4
/* 803CCF24 003C8D64  C0 22 DC 08 */	lfs f1, lbl_80563B88@sda21(r2)
/* 803CCF28 003C8D68  C0 42 DC 00 */	lfs f2, lbl_80563B80@sda21(r2)
/* 803CCF2C 003C8D6C  4B DC A8 91 */	bl lbl_801977BC
/* 803CCF30 003C8D70  38 60 00 01 */	li r3, 0x1
/* 803CCF34 003C8D74  38 80 00 05 */	li r4, 0x5
/* 803CCF38 003C8D78  38 A0 00 00 */	li r5, 0x0
/* 803CCF3C 003C8D7C  4B C6 B8 E5 */	bl lbl_80038820
/* 803CCF40 003C8D80  C0 22 DC 04 */	lfs f1, lbl_80563B84@sda21(r2)
...
/* 803CCF50 003C8D90  C0 02 DC 00 */	lfs f0, lbl_80563B80@sda21(r2)
...
/* 803CCF7C 003C8DBC  4B C6 35 65 */	bl lbl_800304E0
...
/* 803CCF94 003C8DD4  4B DC 85 D1 */	bl lbl_80195564
