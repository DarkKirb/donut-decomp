...
/* 803CCFBC 003C8DFC  4B C3 A3 81 */	bl func_8000733C
...
/* 803CCFD0 003C8E10  90 83 00 00 */	stw r4, 0(r3)
...
/* 803CCFE0 003C8E20  90 61 00 08 */	stw r3, 8(r1)
/* 803CCFE4 003C8E24  38 61 00 08 */	addi r3, r1, 8
/* 803CCFE8 003C8E28  4B FF C9 81 */	bl isEnableSFXDarkness__Q43scn4step3map12DataAccessorCFv
/* 803CCFEC 003C8E2C  98 7F 00 04 */	stb r3, 4(r31)
/* 803CCFF0 003C8E30  C0 02 DC 10 */	lfs f0, $$252572-_SDA2_BASE_(r2)
/* 803CCFF4 003C8E34  D0 1F 00 10 */	stfs f0, 0x10(r31)
/* 803CCFF8 003C8E38  D0 1F 00 0C */	stfs f0, 0xc(r31)
/* 803CCFFC 003C8E3C  D0 1F 00 08 */	stfs f0, 8(r31)
...
/* 803CD020 003C8E60  C0 02 DC 14 */	lfs f0, $$252573-_SDA2_BASE_(r2)
...
/* 803CD060 003C8EA0  88 1F 00 04 */	lbz r0, 4(r31)
/* 803CD064 003C8EA4  2C 00 00 00 */	cmpwi r0, 0
...
/* 803CD074 003C8EB4  3C 80 80 49 */	lis r4, $$252574@ha
/* 803CD078 003C8EB8  38 84 2C 50 */	addi r4, r4, $$252574@l
/* 803CD07C 003C8EBC  38 A0 00 00 */	li r5, 0
...
/* 803CD090 003C8ED0  80 7F 00 00 */	lwz r3, 0(r31)
...
/* 803CD0F4 003C8F34  38 83 FF FC */	addi r4, r3, -4
/* 803CD0F8 003C8F38  38 00 00 09 */	li r0, 9
/* 803CD0FC 003C8F3C  7C 09 03 A6 */	mtctr r0
lbl_803CD100:
/* 803CD100 003C8F40  80 64 00 04 */	lwz r3, 4(r4)
/* 803CD104 003C8F44  84 04 00 08 */	lwzu r0, 8(r4)
/* 803CD108 003C8F48  90 65 00 04 */	stw r3, 4(r5)
/* 803CD10C 003C8F4C  94 05 00 08 */	stwu r0, 8(r5)
/* 803CD110 003C8F50  42 00 FF F0 */	bdnz lbl_803CD100
/* 803CD114 003C8F54  80 04 00 04 */	lwz r0, 4(r4)
/* 803CD118 003C8F58  90 05 00 04 */	stw r0, 4(r5)
/* 803CD11C 003C8F5C  38 7F 00 28 */	addi r3, r31, 0x28
/* 803CD120 003C8F60  38 81 01 6C */	addi r4, r1, 0x16c
/* 803CD124 003C8F64  48 00 00 C1 */	bl construct$$0Q23g3d15StdModelContext$$1__Q23mem34ExplicitScopedPtr$$0Q23g3d8StdModel$$1FQ23g3d15StdModelContext_v
...
/* 803CD130 003C8F70  80 7F 00 00 */	lwz r3, 0(r31)
...
/* 803CD194 003C8FD4  38 83 FF FC */	addi r4, r3, -4
/* 803CD198 003C8FD8  38 00 00 09 */	li r0, 9
/* 803CD19C 003C8FDC  7C 09 03 A6 */	mtctr r0
lbl_803CD1A0:
/* 803CD1A0 003C8FE0  80 64 00 04 */	lwz r3, 4(r4)
/* 803CD1A4 003C8FE4  84 04 00 08 */	lwzu r0, 8(r4)
/* 803CD1A8 003C8FE8  90 65 00 04 */	stw r3, 4(r5)
/* 803CD1AC 003C8FEC  94 05 00 08 */	stwu r0, 8(r5)
/* 803CD1B0 003C8FF0  42 00 FF F0 */	bdnz lbl_803CD1A0
/* 803CD1B4 003C8FF4  80 04 00 04 */	lwz r0, 4(r4)
/* 803CD1B8 003C8FF8  90 05 00 04 */	stw r0, 4(r5)
/* 803CD1BC 003C8FFC  38 7F 00 30 */	addi r3, r31, 0x30
/* 803CD1C0 003C9000  38 81 00 D4 */	addi r4, r1, 0xd4
/* 803CD1C4 003C9004  48 00 00 21 */	bl construct$$0Q23g3d15StdModelContext$$1__Q23mem34ExplicitScopedPtr$$0Q23g3d8StdModel$$1FQ23g3d15StdModelContext_v
lbl_803CD1C8:
/* 803CD1C8 003C9008  7F E3 FB 78 */	mr r3, r31
/* 803CD1CC 003C900C  39 61 01 D0 */	addi r11, r1, 0x1d0
/* 803CD1D0 003C9010  4B C3 A1 B9 */	bl func_80007388
...
.global construct$$0Q23g3d15StdModelContext$$1__Q23mem34ExplicitScopedPtr$$0Q23g3d8StdModel$$1FQ23g3d15StdModelContext_v
construct$$0Q23g3d15StdModelContext$$1__Q23mem34ExplicitScopedPtr$$0Q23g3d8StdModel$$1FQ23g3d15StdModelContext_v:
...
lbl_803CD21C:
/* 803CD21C 003C905C  90 7E 00 04 */	stw r3, 4(r30)
/* 803CD220 003C9060  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 803CD224 003C9064  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 803CD24C 003C908C  C0 04 00 00 */	lfs f0, 0(r4)
/* 803CD250 003C9090  D0 03 00 08 */	stfs f0, 8(r3)
/* 803CD254 003C9094  C0 04 00 04 */	lfs f0, 4(r4)
/* 803CD258 003C9098  D0 03 00 0C */	stfs f0, 0xc(r3)
/* 803CD25C 003C909C  C0 04 00 08 */	lfs f0, 8(r4)
/* 803CD260 003C90A0  D0 03 00 10 */	stfs f0, 0x10(r3)
/* 803CD264 003C90A4  88 03 00 04 */	lbz r0, 4(r3)
/* 803CD268 003C90A8  2C 00 00 00 */	cmpwi r0, 0
/* 803CD26C 003C90AC  41 82 00 30 */	beq lbl_803CD29C
/* 803CD270 003C90B0  38 61 00 08 */	addi r3, r1, 8
/* 803CD274 003C90B4  38 9F 00 08 */	addi r4, r31, 8
...
/* 803CD280 003C90C0  4B DA A9 6D */	bl __rf__Q23mem43ExplicitScopedPtr$$0Q23app16HIDErrorMenuImpl$$1CFv
/* 803CD284 003C90C4  38 81 00 08 */	addi r4, r1, 8
...
/* 803CD290 003C90D0  4B DA A9 5D */	bl __rf__Q23mem43ExplicitScopedPtr$$0Q23app16HIDErrorMenuImpl$$1CFv
/* 803CD294 003C90D4  38 81 00 08 */	addi r4, r1, 8
...
/* 803CD2CC 003C910C  C0 02 DC 1C */	lfs f0, $$252628-_SDA2_BASE_(r2)
/* 803CD2D0 003C9110  EC 40 00 72 */	fmuls f2, f0, f1
/* 803CD2D4 003C9114  C0 22 DC 18 */	lfs f1, $$252627-_SDA2_BASE_(r2)
...
/* 803CD2FC 003C913C  28 00 00 01 */	cmplwi r0, 1
/* 803CD300 003C9140  41 81 00 0C */	bgt lbl_803CD30C
/* 803CD304 003C9144  C0 22 DC 20 */	lfs f1, $$252639-_SDA2_BASE_(r2)
/* 803CD308 003C9148  4E 80 00 20 */	blr 
lbl_803CD30C:
/* 803CD30C 003C914C  C0 22 DC 14 */	lfs f1, $$252573-_SDA2_BASE_(r2)
...
/* 803CD324 003C9164  F3 E1 00 38 */	psq_st f31, 56(r1), 0, qr0
...
/* 803CD334 003C9174  88 03 00 04 */	lbz r0, 4(r3)
/* 803CD338 003C9178  2C 00 00 00 */	cmpwi r0, 0
/* 803CD33C 003C917C  41 82 00 80 */	beq lbl_803CD3BC
/* 803CD340 003C9180  88 03 00 1D */	lbz r0, 0x1d(r3)
/* 803CD344 003C9184  2C 00 00 00 */	cmpwi r0, 0
/* 803CD348 003C9188  41 82 00 10 */	beq lbl_803CD358
/* 803CD34C 003C918C  C0 02 DC 24 */	lfs f0, $$252645-_SDA2_BASE_(r2)
/* 803CD350 003C9190  EF E1 00 32 */	fmuls f31, f1, f0
/* 803CD354 003C9194  48 00 00 0C */	b lbl_803CD360
lbl_803CD358:
/* 803CD358 003C9198  C0 02 DC 24 */	lfs f0, $$252645-_SDA2_BASE_(r2)
...
/* 803CD374 003C91B4  C0 62 DC 14 */	lfs f3, $$252573-_SDA2_BASE_(r2)
...
/* 803CD384 003C91C4  4B DA A8 69 */	bl __rf__Q23mem43ExplicitScopedPtr$$0Q23app16HIDErrorMenuImpl$$1CFv
...
/* 803CD390 003C91D0  38 61 00 08 */	addi r3, r1, 8
/* 803CD394 003C91D4  C0 02 DC 1C */	lfs f0, $$252628-_SDA2_BASE_(r2)
/* 803CD398 003C91D8  EC 20 F8 2A */	fadds f1, f0, f31
/* 803CD39C 003C91DC  FC 40 08 90 */	fmr f2, f1
/* 803CD3A0 003C91E0  C0 62 DC 14 */	lfs f3, $$252573-_SDA2_BASE_(r2)
...
/* 803CD3B0 003C91F0  4B DA A8 3D */	bl __rf__Q23mem43ExplicitScopedPtr$$0Q23app16HIDErrorMenuImpl$$1CFv
...
/* 803CD3F0 003C9230  93 C1 00 08 */	stw r30, 8(r1)
/* 803CD3F4 003C9234  7C 7E 1B 78 */	mr r30, r3
/* 803CD3F8 003C9238  88 03 00 04 */	lbz r0, 4(r3)
/* 803CD3FC 003C923C  2C 00 00 00 */	cmpwi r0, 0
/* 803CD400 003C9240  41 82 00 5C */	beq lbl_803CD45C
/* 803CD404 003C9244  88 03 00 1C */	lbz r0, 0x1c(r3)
/* 803CD408 003C9248  2C 00 00 00 */	cmpwi r0, 0
/* 803CD40C 003C924C  41 82 00 2C */	beq lbl_803CD438
/* 803CD410 003C9250  80 63 00 00 */	lwz r3, 0(r3)
...
/* 803CD428 003C9268  4B DA A7 C5 */	bl __rf__Q23mem43ExplicitScopedPtr$$0Q23app16HIDErrorMenuImpl$$1CFv
...
lbl_803CD438:
/* 803CD438 003C9278  80 63 00 00 */	lwz r3, 0(r3)
...
/* 803CD450 003C9290  4B DA A7 9D */	bl __rf__Q23mem43ExplicitScopedPtr$$0Q23app16HIDErrorMenuImpl$$1CFv
...
/* 803CD460 003C92A0  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 803CD478 003C92B8  38 83 FF FE */	addi r4, r3, -2
/* 803CD47C 003C92BC  38 00 00 05 */	li r0, 5
/* 803CD480 003C92C0  38 60 FF FF */	li r3, -1
...
/* 803CD490 003C92D0  2C 03 00 00 */	cmpwi r3, 0
/* 803CD494 003C92D4  38 6D DB E8 */	addi r3, r13, $$252676-_SDA_BASE_
/* 803CD498 003C92D8  4D 82 00 20 */	beqlr 
/* 803CD49C 003C92DC  38 6D DB E0 */	addi r3, r13, $$252675-_SDA_BASE_
...
/* 803CD4A4 003C92E4  28 03 00 07 */	cmplwi r3, 7
/* 803CD4A8 003C92E8  41 81 00 5C */	bgt lbl_803CD504
/* 803CD4AC 003C92EC  3C 80 80 49 */	lis r4, $$252694@ha
/* 803CD4B0 003C92F0  38 84 2C 68 */	addi r4, r4, $$252694@l
...
/* 803CD4C4 003C9304  C0 22 DC 28 */	lfs f1, $$252687-_SDA2_BASE_(r2)
/* 803CD4C8 003C9308  4E 80 00 20 */	blr 
/* 803CD4CC 003C930C  C0 22 DC 14 */	lfs f1, $$252573-_SDA2_BASE_(r2)
/* 803CD4D0 003C9310  4E 80 00 20 */	blr 
/* 803CD4D4 003C9314  C0 22 DC 2C */	lfs f1, $$252688-_SDA2_BASE_(r2)
/* 803CD4D8 003C9318  4E 80 00 20 */	blr 
/* 803CD4DC 003C931C  C0 22 DC 30 */	lfs f1, $$252689-_SDA2_BASE_(r2)
/* 803CD4E0 003C9320  4E 80 00 20 */	blr 
/* 803CD4E4 003C9324  C0 22 DC 34 */	lfs f1, $$252690-_SDA2_BASE_(r2)
/* 803CD4E8 003C9328  4E 80 00 20 */	blr 
/* 803CD4EC 003C932C  C0 22 DC 38 */	lfs f1, $$252691-_SDA2_BASE_(r2)
/* 803CD4F0 003C9330  4E 80 00 20 */	blr 
/* 803CD4F4 003C9334  C0 22 DC 3C */	lfs f1, $$252692-_SDA2_BASE_(r2)
/* 803CD4F8 003C9338  4E 80 00 20 */	blr 
/* 803CD4FC 003C933C  C0 22 DC 40 */	lfs f1, $$252693-_SDA2_BASE_(r2)
...
.global $$252573
$$252573:
	.incbin "baserom.dol", 0x49E6D4, 0x4
.global $$252627
$$252627:
	.incbin "baserom.dol", 0x49E6D8, 0x4
.global $$252628
$$252628:
	.incbin "baserom.dol", 0x49E6DC, 0x4
.global $$252639
$$252639:
	.incbin "baserom.dol", 0x49E6E0, 0x4
.global $$252645
$$252645:
	.incbin "baserom.dol", 0x49E6E4, 0x4
.global $$252687
$$252687:
	.incbin "baserom.dol", 0x49E6E8, 0x4
.global $$252688
$$252688:
	.incbin "baserom.dol", 0x49E6EC, 0x4
.global $$252689
$$252689:
	.incbin "baserom.dol", 0x49E6F0, 0x4
.global $$252690
$$252690:
	.incbin "baserom.dol", 0x49E6F4, 0x4
.global $$252691
$$252691:
	.incbin "baserom.dol", 0x49E6F8, 0x4
.global $$252692
$$252692:
	.incbin "baserom.dol", 0x49E6FC, 0x4
.global $$252693
$$252693:
	.incbin "baserom.dol", 0x49E700, 0x8
