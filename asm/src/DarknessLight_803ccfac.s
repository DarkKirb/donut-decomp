...
/* 803CCFD8 003C8E18  4B E1 DA 19 */	bl lbl_801EA9F0
/* 803CCFDC 003C8E1C  4B FF CA BD */	bl lbl_803C9A98
/* 803CCFE0 003C8E20  90 61 00 08 */	stw r3, 0x8(r1)
/* 803CCFE4 003C8E24  38 61 00 08 */	addi r3, r1, 0x8
/* 803CCFE8 003C8E28  4B FF C9 81 */	bl lbl_803C9968
/* 803CCFEC 003C8E2C  98 7F 00 04 */	stb r3, 0x4(r31)
/* 803CCFF0 003C8E30  C0 02 DC 10 */	lfs f0, lbl_80563B90@sda21(r2)
...
/* 803CD008 003C8E48  48 00 04 9D */	bl lbl_803CD4A4
...
/* 803CD018 003C8E58  48 00 04 5D */	bl lbl_803CD474
/* 803CD01C 003C8E5C  98 7F 00 1D */	stb r3, 0x1d(r31)
/* 803CD020 003C8E60  C0 02 DC 14 */	lfs f0, lbl_80563B94@sda21(r2)
/* 803CD024 003C8E64  D0 1F 00 20 */	stfs f0, 0x20(r31)
/* 803CD028 003C8E68  38 7F 00 24 */	addi r3, r31, 0x24
/* 803CD02C 003C8E6C  4B D1 03 B5 */	bl lbl_800DD3E0
/* 803CD030 003C8E70  7F A3 EB 78 */	mr r3, r29
/* 803CD034 003C8E74  4B E5 3C 59 */	bl lbl_80220C8C
/* 803CD038 003C8E78  4B FF D7 21 */	bl lbl_803CA758
/* 803CD03C 003C8E7C  7C 64 1B 78 */	mr r4, r3
/* 803CD040 003C8E80  38 7F 00 28 */	addi r3, r31, 0x28
/* 803CD044 003C8E84  4B E0 8B E5 */	bl lbl_801D5C28
/* 803CD048 003C8E88  7F A3 EB 78 */	mr r3, r29
/* 803CD04C 003C8E8C  4B E5 3C 41 */	bl lbl_80220C8C
/* 803CD050 003C8E90  4B FF D7 09 */	bl lbl_803CA758
/* 803CD054 003C8E94  7C 64 1B 78 */	mr r4, r3
/* 803CD058 003C8E98  38 7F 00 30 */	addi r3, r31, 0x30
/* 803CD05C 003C8E9C  4B E0 8B CD */	bl lbl_801D5C28
...
/* 803CD070 003C8EB0  4B E3 F1 C9 */	bl lbl_8020C238
/* 803CD074 003C8EB4  3C 80 80 49 */	lis r4, lbl_80492C50@ha
/* 803CD078 003C8EB8  38 84 2C 50 */	addi r4, r4, lbl_80492C50@l
/* 803CD07C 003C8EBC  38 A0 00 00 */	li r5, 0x0
/* 803CD080 003C8EC0  4B DC 68 59 */	bl lbl_801938D8
/* 803CD084 003C8EC4  90 7F 00 24 */	stw r3, 0x24(r31)
/* 803CD088 003C8EC8  4B DC 06 E5 */	bl lbl_8018D76C
/* 803CD08C 003C8ECC  7C 7E 1B 78 */	mr r30, r3
/* 803CD090 003C8ED0  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 803CD094 003C8ED4  4B E5 3B F9 */	bl lbl_80220C8C
/* 803CD098 003C8ED8  4B FF D6 C1 */	bl lbl_803CA758
/* 803CD09C 003C8EDC  7C 7D 1B 78 */	mr r29, r3
/* 803CD0A0 003C8EE0  4B DC 06 D9 */	bl lbl_8018D778
/* 803CD0A4 003C8EE4  7C 7C 1B 78 */	mr r28, r3
/* 803CD0A8 003C8EE8  4B DC 06 C9 */	bl lbl_8018D770
/* 803CD0AC 003C8EEC  7C 7B 1B 78 */	mr r27, r3
/* 803CD0B0 003C8EF0  38 61 00 20 */	addi r3, r1, 0x20
/* 803CD0B4 003C8EF4  4B DC 06 C1 */	bl lbl_8018D774
/* 803CD0B8 003C8EF8  88 7F 00 1D */	lbz r3, 0x1d(r31)
/* 803CD0BC 003C8EFC  48 00 03 D5 */	bl lbl_803CD490
...
/* 803CD0CC 003C8F0C  4B DC 6C 05 */	bl lbl_80193CD0
...
/* 803CD0EC 003C8F2C  4B DC 50 61 */	bl lbl_8019214C
...
/* 803CD124 003C8F64  48 00 00 C1 */	bl lbl_803CD1E4
/* 803CD128 003C8F68  4B DC 06 45 */	bl lbl_8018D76C
/* 803CD12C 003C8F6C  7C 7B 1B 78 */	mr r27, r3
/* 803CD130 003C8F70  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 803CD134 003C8F74  4B E5 3B 59 */	bl lbl_80220C8C
/* 803CD138 003C8F78  4B FF D6 21 */	bl lbl_803CA758
/* 803CD13C 003C8F7C  7C 7C 1B 78 */	mr r28, r3
/* 803CD140 003C8F80  4B DC 06 39 */	bl lbl_8018D778
/* 803CD144 003C8F84  7C 7D 1B 78 */	mr r29, r3
/* 803CD148 003C8F88  4B DC 06 29 */	bl lbl_8018D770
/* 803CD14C 003C8F8C  7C 7E 1B 78 */	mr r30, r3
/* 803CD150 003C8F90  38 61 00 10 */	addi r3, r1, 0x10
/* 803CD154 003C8F94  4B DC 06 21 */	bl lbl_8018D774
/* 803CD158 003C8F98  88 7F 00 1D */	lbz r3, 0x1d(r31)
/* 803CD15C 003C8F9C  48 00 03 35 */	bl lbl_803CD490
...
/* 803CD16C 003C8FAC  4B DC 6B 65 */	bl lbl_80193CD0
...
/* 803CD18C 003C8FCC  4B DC 4F C1 */	bl lbl_8019214C
...
/* 803CD1C4 003C9004  48 00 00 21 */	bl lbl_803CD1E4
.global lbl_803CD1C8
lbl_803CD1C8:
...
/* 803CD208 003C9048  4B DF 25 05 */	bl lbl_801BF70C
...
/* 803CD218 003C9058  4B DC 77 D5 */	bl lbl_801949EC
.global lbl_803CD21C
lbl_803CD21C:
...
/* 803CD278 003C90B8  4B DD 13 19 */	bl lbl_8019E590
/* 803CD27C 003C90BC  38 7F 00 28 */	addi r3, r31, 0x28
/* 803CD280 003C90C0  4B DA A9 6D */	bl lbl_80177BEC
/* 803CD284 003C90C4  38 81 00 08 */	addi r4, r1, 0x8
/* 803CD288 003C90C8  4B DC 78 BD */	bl lbl_80194B44
/* 803CD28C 003C90CC  38 7F 00 30 */	addi r3, r31, 0x30
/* 803CD290 003C90D0  4B DA A9 5D */	bl lbl_80177BEC
/* 803CD294 003C90D4  38 81 00 08 */	addi r4, r1, 0x8
/* 803CD298 003C90D8  4B DC 78 AD */	bl lbl_80194B44
.global lbl_803CD29C
lbl_803CD29C:
...
/* 803CD2C8 003C9108  48 00 01 DD */	bl lbl_803CD4A4
/* 803CD2CC 003C910C  C0 02 DC 1C */	lfs f0, lbl_80563B9C@sda21(r2)
/* 803CD2D0 003C9110  EC 40 00 72 */	fmuls f2, f0, f1
/* 803CD2D4 003C9114  C0 22 DC 18 */	lfs f1, lbl_80563B98@sda21(r2)
...
/* 803CD304 003C9144  C0 22 DC 20 */	lfs f1, lbl_80563BA0@sda21(r2)
/* 803CD308 003C9148  4E 80 00 20 */	blr
.global lbl_803CD30C
lbl_803CD30C:
/* 803CD30C 003C914C  C0 22 DC 14 */	lfs f1, lbl_80563B94@sda21(r2)
...
/* 803CD34C 003C918C  C0 02 DC 24 */	lfs f0, lbl_80563BA4@sda21(r2)
/* 803CD350 003C9190  EF E1 00 32 */	fmuls f31, f1, f0
/* 803CD354 003C9194  48 00 00 0C */	b lbl_803CD360
.global lbl_803CD358
lbl_803CD358:
/* 803CD358 003C9198  C0 02 DC 24 */	lfs f0, lbl_80563BA4@sda21(r2)
...
/* 803CD374 003C91B4  C0 62 DC 14 */	lfs f3, lbl_80563B94@sda21(r2)
/* 803CD378 003C91B8  4B CF 0D 49 */	bl lbl_800BE0C0
/* 803CD37C 003C91BC  7C 7F 1B 78 */	mr r31, r3
/* 803CD380 003C91C0  38 7E 00 28 */	addi r3, r30, 0x28
/* 803CD384 003C91C4  4B DA A8 69 */	bl lbl_80177BEC
/* 803CD388 003C91C8  7F E4 FB 78 */	mr r4, r31
/* 803CD38C 003C91CC  4B DC 77 ED */	bl lbl_80194B78
/* 803CD390 003C91D0  38 61 00 08 */	addi r3, r1, 0x8
/* 803CD394 003C91D4  C0 02 DC 1C */	lfs f0, lbl_80563B9C@sda21(r2)
/* 803CD398 003C91D8  EC 20 F8 2A */	fadds f1, f0, f31
/* 803CD39C 003C91DC  FC 40 08 90 */	fmr f2, f1
/* 803CD3A0 003C91E0  C0 62 DC 14 */	lfs f3, lbl_80563B94@sda21(r2)
/* 803CD3A4 003C91E4  4B CF 0D 1D */	bl lbl_800BE0C0
/* 803CD3A8 003C91E8  7C 7F 1B 78 */	mr r31, r3
/* 803CD3AC 003C91EC  38 7E 00 30 */	addi r3, r30, 0x30
/* 803CD3B0 003C91F0  4B DA A8 3D */	bl lbl_80177BEC
/* 803CD3B4 003C91F4  7F E4 FB 78 */	mr r4, r31
/* 803CD3B8 003C91F8  4B DC 77 C1 */	bl lbl_80194B78
.global lbl_803CD3BC
lbl_803CD3BC:
...
/* 803CD494 003C92D4  38 6D DB E8 */	addi r3, r13, lbl_8055C008@sda21
/* 803CD498 003C92D8  4D 82 00 20 */	beqlr
/* 803CD49C 003C92DC  38 6D DB E0 */	addi r3, r13, lbl_8055C000@sda21
...
/* 803CD4AC 003C92EC  3C 80 80 49 */	lis r4, lbl_80492C68@ha
/* 803CD4B0 003C92F0  38 84 2C 68 */	addi r4, r4, lbl_80492C68@l
...
.global lbl_803CD4C4
lbl_803CD4C4:
/* 803CD4C4 003C9304  C0 22 DC 28 */	lfs f1, lbl_80563BA8@sda21(r2)
/* 803CD4C8 003C9308  4E 80 00 20 */	blr

.global lbl_803CD4CC
lbl_803CD4CC:
/* 803CD4CC 003C930C  C0 22 DC 14 */	lfs f1, lbl_80563B94@sda21(r2)
/* 803CD4D0 003C9310  4E 80 00 20 */	blr

.global lbl_803CD4D4
lbl_803CD4D4:
/* 803CD4D4 003C9314  C0 22 DC 2C */	lfs f1, lbl_80563BAC@sda21(r2)
/* 803CD4D8 003C9318  4E 80 00 20 */	blr

.global lbl_803CD4DC
lbl_803CD4DC:
/* 803CD4DC 003C931C  C0 22 DC 30 */	lfs f1, lbl_80563BB0@sda21(r2)
/* 803CD4E0 003C9320  4E 80 00 20 */	blr

.global lbl_803CD4E4
lbl_803CD4E4:
/* 803CD4E4 003C9324  C0 22 DC 34 */	lfs f1, lbl_80563BB4@sda21(r2)
/* 803CD4E8 003C9328  4E 80 00 20 */	blr

.global lbl_803CD4EC
lbl_803CD4EC:
/* 803CD4EC 003C932C  C0 22 DC 38 */	lfs f1, lbl_80563BB8@sda21(r2)
/* 803CD4F0 003C9330  4E 80 00 20 */	blr

.global lbl_803CD4F4
lbl_803CD4F4:
/* 803CD4F4 003C9334  C0 22 DC 3C */	lfs f1, lbl_80563BBC@sda21(r2)
/* 803CD4F8 003C9338  4E 80 00 20 */	blr

.global lbl_803CD4FC
lbl_803CD4FC:
/* 803CD4FC 003C933C  C0 22 DC 40 */	lfs f1, lbl_80563BC0@sda21(r2)
/* 803CD500 003C9340  4E 80 00 20 */	blr
.global lbl_803CD504
lbl_803CD504:
/* 803CD504 003C9344  C0 22 DC 10 */	lfs f1, lbl_80563B90@sda21(r2)
