...
/* 801BFB7C 001BB9BC  38 8D 8E 98 */	addi r4, r13, $$251818-_SDA_BASE_
...
/* 801BFBF4 001BBA34  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 801BFC18 001BBA58  4B E4 77 29 */	bl func_80007340
/* 801BFC1C 001BBA5C  7C 7C 1B 78 */	mr r28, r3
/* 801BFC20 001BBA60  7C 9D 23 78 */	mr r29, r4
/* 801BFC24 001BBA64  80 63 00 00 */	lwz r3, 0(r3)
...
/* 801BFC34 001BBA74  38 8D 8E A0 */	addi r4, r13, $$251855-_SDA_BASE_
/* 801BFC38 001BBA78  7F A5 EB 78 */	mr r5, r29
/* 801BFC3C 001BBA7C  4C C6 31 82 */	crclr 6
/* 801BFC40 001BBA80  4B FE D8 4D */	bl FromFormat__Q33hel6common19FixedStringIN$$0c$$464$$1FPCce
/* 801BFC44 001BBA84  38 A1 00 4C */	addi r5, r1, 0x4c
/* 801BFC48 001BBA88  38 81 00 0C */	addi r4, r1, 0xc
/* 801BFC4C 001BBA8C  38 00 00 08 */	li r0, 8
/* 801BFC50 001BBA90  7C 09 03 A6 */	mtctr r0
lbl_801BFC54:
/* 801BFC54 001BBA94  80 64 00 04 */	lwz r3, 4(r4)
/* 801BFC58 001BBA98  84 04 00 08 */	lwzu r0, 8(r4)
/* 801BFC5C 001BBA9C  90 65 00 04 */	stw r3, 4(r5)
/* 801BFC60 001BBAA0  94 05 00 08 */	stwu r0, 8(r5)
/* 801BFC64 001BBAA4  42 00 FF F0 */	bdnz lbl_801BFC54
/* 801BFC68 001BBAA8  38 61 00 50 */	addi r3, r1, 0x50
/* 801BFC6C 001BBAAC  4B FD DD 4D */	bl Strlen__Q33hel6common9Traits$$0c$$1FPCc
/* 801BFC70 001BBAB0  7C 7E 1B 78 */	mr r30, r3
/* 801BFC74 001BBAB4  3B A0 00 00 */	li r29, 0
...
/* 801BFC8C 001BBACC  90 61 00 08 */	stw r3, 8(r1)
/* 801BFC90 001BBAD0  80 03 00 00 */	lwz r0, 0(r3)
/* 801BFC94 001BBAD4  7C 00 F0 40 */	cmplw r0, r30
/* 801BFC98 001BBAD8  41 80 00 28 */	blt lbl_801BFCC0
/* 801BFC9C 001BBADC  38 63 00 04 */	addi r3, r3, 4
...
/* 801BFCD8 001BBB18  4B E4 76 B5 */	bl func_8000738C
