...
/* 8018E470 0018A2B0  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8018E4A8 0018A2E8  2C 03 00 00 */	cmpwi r3, 0x0
/* 8018E4AC 0018A2EC  41 82 00 08 */	beq lbl_8018E4B4
/* 8018E4B0 0018A2F0  93 E3 00 00 */	stw r31, 0x0(r3)
.global lbl_8018E4B4
lbl_8018E4B4:
/* 8018E4B4 0018A2F4  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 8018E4B8 0018A2F8  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8018E51C 0018A35C  2C 03 00 00 */	cmpwi r3, 0x0
/* 8018E520 0018A360  41 82 00 0C */	beq lbl_8018E52C
/* 8018E524 0018A364  D3 C3 00 04 */	stfs f30, 0x4(r3)
/* 8018E528 0018A368  D3 E3 00 08 */	stfs f31, 0x8(r3)
.global lbl_8018E52C
lbl_8018E52C:
...
/* 8018E55C 0018A39C  80 04 00 00 */	lwz r0, 0x0(r4)
/* 8018E560 0018A3A0  90 01 00 08 */	stw r0, 0x8(r1)
...
/* 8018E590 0018A3D0  2C 03 00 00 */	cmpwi r3, 0x0
/* 8018E594 0018A3D4  41 82 00 24 */	beq lbl_8018E5B8
/* 8018E598 0018A3D8  88 01 00 08 */	lbz r0, 0x8(r1)
/* 8018E59C 0018A3DC  98 03 00 14 */	stb r0, 0x14(r3)
/* 8018E5A0 0018A3E0  88 01 00 09 */	lbz r0, 0x9(r1)
...
/* 8018E5DC 0018A41C  93 C1 00 08 */	stw r30, 0x8(r1)
