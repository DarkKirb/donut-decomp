...
/* 80405988 004017C8  80 83 00 04 */	lwz r4, 4(r3)
/* 8040598C 004017CC  80 03 00 00 */	lwz r0, 0(r3)
...
/* 804059B8 004017F8  2C 03 00 00 */	cmpwi r3, 0
...
/* 804059DC 0040181C  80 03 00 00 */	lwz r0, 0(r3)
/* 804059E0 00401820  90 03 00 04 */	stw r0, 4(r3)
...
/* 80405A00 00401840  2C 03 00 00 */	cmpwi r3, 0
...
/* 80405A28 00401868  80 83 00 00 */	lwz r4, 0(r3)
/* 80405A2C 0040186C  2C 04 00 00 */	cmpwi r4, 0
/* 80405A30 00401870  40 82 00 0C */	bne lbl_80405A3C
/* 80405A34 00401874  C0 22 E4 18 */	lfs f1, $$248873-_SDA2_BASE_(r2)
/* 80405A38 00401878  48 00 00 34 */	b lbl_80405A6C
lbl_80405A3C:
/* 80405A3C 0040187C  80 03 00 04 */	lwz r0, 4(r3)
/* 80405A40 00401880  C8 42 E4 20 */	lfd f2, $$248876-_SDA2_BASE_(r2)
/* 80405A44 00401884  90 01 00 0C */	stw r0, 0xc(r1)
/* 80405A48 00401888  3C 00 43 30 */	lis r0, 0x4330
/* 80405A4C 0040188C  90 01 00 08 */	stw r0, 8(r1)
/* 80405A50 00401890  C8 01 00 08 */	lfd f0, 8(r1)
...
/* 80405A84 004018C4  C0 02 E4 18 */	lfs f0, $$248873-_SDA2_BASE_(r2)
...
.global $$248876
$$248876:
	.incbin "baserom.dol", 0x49EEE0, 0x8
