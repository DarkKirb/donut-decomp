...
/* 803C1000 003BCE40  48 00 00 55 */	bl lbl_803C1054
/* 803C1004 003BCE44  38 C2 DA 38 */	addi r6, r2, lbl_805639B8@sda21
/* 803C1008 003BCE48  C0 02 DA 50 */	lfs f0, lbl_805639D0@sda21(r2)
/* 803C100C 003BCE4C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 803C1010 003BCE50  40 80 00 0C */	bge lbl_803C101C
/* 803C1014 003BCE54  38 C2 DA 48 */	addi r6, r2, lbl_805639C8@sda21
/* 803C1018 003BCE58  48 00 00 14 */	b lbl_803C102C
.global lbl_803C101C
lbl_803C101C:
/* 803C101C 003BCE5C  C0 02 DA 54 */	lfs f0, lbl_805639D4@sda21(r2)
/* 803C1020 003BCE60  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 803C1024 003BCE64  40 80 00 08 */	bge lbl_803C102C
/* 803C1028 003BCE68  38 C2 DA 40 */	addi r6, r2, lbl_805639C0@sda21
.global lbl_803C102C
lbl_803C102C:
/* 803C102C 003BCE6C  7F A3 EB 78 */	mr r3, r29
/* 803C1030 003BCE70  7F C4 F3 78 */	mr r4, r30
/* 803C1034 003BCE74  7F E5 FB 78 */	mr r5, r31
/* 803C1038 003BCE78  48 00 00 F1 */	bl lbl_803C1128
...
/* 803C1074 003BCEB4  C3 E2 DA 58 */	lfs f31, lbl_805639D8@sda21(r2)
...
/* 803C1088 003BCEC8  4B E5 FD 71 */	bl lbl_80220DF8
/* 803C108C 003BCECC  7F C4 F3 78 */	mr r4, r30
/* 803C1090 003BCED0  4B F8 60 A1 */	bl lbl_80347130
/* 803C1094 003BCED4  7C 7D 1B 78 */	mr r29, r3
/* 803C1098 003BCED8  4B F7 F3 05 */	bl lbl_8034039C
/* 803C109C 003BCEDC  4B E1 95 95 */	bl lbl_801DA630
...
/* 803C10AC 003BCEEC  4B F7 F2 E1 */	bl lbl_8034038C
/* 803C10B0 003BCEF0  4B EA DB F9 */	bl lbl_8026ECA8
...
/* 803C10C4 003BCF04  4B E5 FD 35 */	bl lbl_80220DF8
/* 803C10C8 003BCF08  4B F8 60 35 */	bl lbl_803470FC
...
/* 803C10DC 003BCF1C  C8 22 DA 60 */	lfd f1, lbl_805639E0@sda21(r2)
...
.global lbl_803C10FC
lbl_803C10FC:
/* 803C10FC 003BCF3C  C3 E2 DA 5C */	lfs f31, lbl_805639DC@sda21(r2)
.global lbl_803C1100
lbl_803C1100:
...
/* 803C1150 003BCF90  4B DB 99 7D */	bl lbl_8017AACC
...
/* 803C1170 003BCFB0  48 00 01 25 */	bl lbl_803C1294
...
/* 803C1198 003BCFD8  48 00 00 FD */	bl lbl_803C1294
...
/* 803C11AC 003BCFEC  48 00 00 1D */	bl lbl_803C11C8
.global lbl_803C11B0
lbl_803C11B0:
...
/* 803C11DC 003BD01C  4B E7 8D A9 */	bl lbl_80239F84
...
/* 803C1214 003BD054  48 00 00 31 */	bl lbl_803C1244
/* 803C1218 003BD058  7C 64 1B 78 */	mr r4, r3
/* 803C121C 003BD05C  7F E3 FB 78 */	mr r3, r31
/* 803C1220 003BD060  4B D5 EB C1 */	bl lbl_8011FDE0
...
/* 803C1260 003BD0A0  3C 60 80 46 */	lis r3, lbl_80464894@ha
/* 803C1264 003BD0A4  38 63 48 94 */	addi r3, r3, lbl_80464894@l
/* 803C1268 003BD0A8  38 80 02 33 */	li r4, 0x233
/* 803C126C 003BD0AC  3C A0 80 46 */	lis r5, lbl_80464870@ha
/* 803C1270 003BD0B0  38 A5 48 70 */	addi r5, r5, lbl_80464870@l
/* 803C1274 003BD0B4  4C C6 31 82 */	crclr 4*cr1+eq
/* 803C1278 003BD0B8  4B D6 70 D9 */	bl lbl_80128350
.global lbl_803C127C
lbl_803C127C:
...
/* 803C12B8 003BD0F8  4B DB 51 09 */	bl lbl_801763C0
/* 803C12BC 003BD0FC  80 63 04 9C */	lwz r3, 0x49c(r3)
/* 803C12C0 003BD100  4B C9 2B 31 */	bl lbl_80053DF0
...
/* 803C12D0 003BD110  4B FF FE F9 */	bl lbl_803C11C8
...
/* 803C12E0 003BD120  4B DB 50 E1 */	bl lbl_801763C0
/* 803C12E4 003BD124  80 63 04 9C */	lwz r3, 0x49c(r3)
/* 803C12E8 003BD128  4B C9 2B 09 */	bl lbl_80053DF0
...
/* 803C12FC 003BD13C  4B E5 F9 C5 */	bl lbl_80220CC0
/* 803C1300 003BD140  4B E6 62 65 */	bl lbl_80227564
/* 803C1304 003BD144  48 00 7C 21 */	bl lbl_803C8F24
/* 803C1308 003BD148  4B FF FC 8D */	bl lbl_803C0F94
...
/* 803C1324 003BD164  4B FF FC 09 */	bl lbl_803C0F2C
/* 803C1328 003BD168  80 7D 00 00 */	lwz r3, 0x0(r29)
/* 803C132C 003BD16C  4B E5 FA D5 */	bl lbl_80220E00
...
/* 803C133C 003BD17C  48 00 27 D9 */	bl lbl_803C3B14
/* 803C1340 003BD180  38 61 00 10 */	addi r3, r1, 0x10
/* 803C1344 003BD184  4B DC 73 85 */	bl lbl_801886C8
...
/* 803C135C 003BD19C  48 00 19 DD */	bl lbl_803C2D38
/* 803C1360 003BD1A0  38 80 02 58 */	li r4, 0x258
/* 803C1364 003BD1A4  4B EA E2 E9 */	bl lbl_8026F64C
.global lbl_803C1368
lbl_803C1368:
/* 803C1368 003BD1A8  7F 83 E3 78 */	mr r3, r28
/* 803C136C 003BD1AC  4B E7 8C 19 */	bl lbl_80239F84
/* 803C1370 003BD1B0  7F 83 E3 78 */	mr r3, r28
/* 803C1374 003BD1B4  4B DB B2 71 */	bl lbl_8017C5E4
...
/* 803C1384 003BD1C4  4B FF FE 75 */	bl lbl_803C11F8
.global lbl_803C1388
lbl_803C1388:
...
/* 803C1394 003BD1D4  4B DC 73 35 */	bl lbl_801886C8
...
/* 803C13AC 003BD1EC  4B DB B2 39 */	bl lbl_8017C5E4
...
/* 803C13CC 003BD20C  4B FF FE 79 */	bl lbl_803C1244
...
/* 803C13DC 003BD21C  4B D5 E9 D5 */	bl lbl_8011FDB0
.global lbl_803C13E0
lbl_803C13E0:
/* 803C13E0 003BD220  38 61 00 10 */	addi r3, r1, 0x10
/* 803C13E4 003BD224  38 80 FF FF */	li r4, -0x1
/* 803C13E8 003BD228  4B E7 40 15 */	bl lbl_802353FC
.global lbl_803C13EC
lbl_803C13EC:
