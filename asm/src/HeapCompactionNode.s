...
/* 801BE214 001BA054  38 61 00 08 */	addi r3, r1, 8
/* 801BE218 001BA058  80 9F 00 00 */	lwz r4, 0(r31)
/* 801BE21C 001BA05C  48 00 0F D1 */	bl __ct__Q23mem8MemBlockFPvUl
/* 801BE220 001BA060  7C 64 1B 78 */	mr r4, r3
/* 801BE224 001BA064  80 63 00 00 */	lwz r3, 0(r3)
/* 801BE228 001BA068  80 84 00 04 */	lwz r4, 4(r4)
...
/* 801BE240 001BA080  80 03 00 04 */	lwz r0, 4(r3)
...
/* 801BE24C 001BA08C  80 03 00 04 */	lwz r0, 4(r3)
/* 801BE250 001BA090  54 05 00 00 */	rlwinm r5, r0, 0, 0, 0
/* 801BE254 001BA094  54 80 00 7E */	clrlwi r0, r4, 1
/* 801BE258 001BA098  7C A0 03 78 */	or r0, r5, r0
/* 801BE25C 001BA09C  90 03 00 04 */	stw r0, 4(r3)
...
/* 801BE264 001BA0A4  90 83 00 00 */	stw r4, 0(r3)
...
/* 801BE270 001BA0B0  80 03 00 04 */	lwz r0, 4(r3)
/* 801BE274 001BA0B4  54 03 00 00 */	rlwinm r3, r0, 0, 0, 0
/* 801BE278 001BA0B8  30 03 FF FF */	addic r0, r3, -1
...
/* 801BE284 001BA0C4  80 03 00 04 */	lwz r0, 4(r3)
/* 801BE288 001BA0C8  54 05 00 7E */	clrlwi r5, r0, 1
/* 801BE28C 001BA0CC  20 04 00 00 */	subfic r0, r4, 0
...
/* 801BE2A0 001BA0E0  90 03 00 04 */	stw r0, 4(r3)
