...
/* 8026EAE4 0026A924  90 03 00 00 */	stw r0, 0(r3)
/* 8026EAE8 0026A928  90 03 00 04 */	stw r0, 4(r3)
/* 8026EAEC 0026A92C  90 03 00 08 */	stw r0, 8(r3)
...
/* 8026EB00 0026A940  80 83 00 00 */	lwz r4, 0(r3)
/* 8026EB04 0026A944  80 03 00 04 */	lwz r0, 4(r3)
...
/* 8026EB28 0026A968  90 83 00 04 */	stw r4, 4(r3)
/* 8026EB2C 0026A96C  90 83 00 10 */	stw r4, 0x10(r3)
/* 8026EB30 0026A970  90 83 00 00 */	stw r4, 0(r3)
...
/* 8026EB40 0026A980  80 A3 00 00 */	lwz r5, 0(r3)
/* 8026EB44 0026A984  90 A3 00 10 */	stw r5, 0x10(r3)
/* 8026EB48 0026A988  80 03 00 00 */	lwz r0, 0(r3)
/* 8026EB4C 0026A98C  2C 00 00 00 */	cmpwi r0, 0
...
/* 8026EB5C 0026A99C  80 03 00 08 */	lwz r0, 8(r3)
/* 8026EB60 0026A9A0  7C 04 00 00 */	cmpw r4, r0
/* 8026EB64 0026A9A4  40 80 00 0C */	bge lbl_8026EB70
/* 8026EB68 0026A9A8  90 03 00 00 */	stw r0, 0(r3)
/* 8026EB6C 0026A9AC  48 00 00 08 */	b lbl_8026EB74
lbl_8026EB70:
/* 8026EB70 0026A9B0  90 83 00 00 */	stw r4, 0(r3)
lbl_8026EB74:
/* 8026EB74 0026A9B4  80 83 00 14 */	lwz r4, 0x14(r3)
/* 8026EB78 0026A9B8  2C 04 00 00 */	cmpwi r4, 0
/* 8026EB7C 0026A9BC  4D 82 00 20 */	beqlr 
/* 8026EB80 0026A9C0  80 03 00 00 */	lwz r0, 0(r3)
/* 8026EB84 0026A9C4  2C 00 00 00 */	cmpwi r0, 0
...
/* 8026EB98 0026A9D8  38 00 00 01 */	li r0, 1
/* 8026EB9C 0026A9DC  90 03 00 00 */	stw r0, 0(r3)
...
/* 8026EBB8 0026A9F8  80 03 00 00 */	lwz r0, 0(r3)
/* 8026EBBC 0026A9FC  90 03 00 10 */	stw r0, 0x10(r3)
/* 8026EBC0 0026AA00  7C 00 22 14 */	add r0, r0, r4
/* 8026EBC4 0026AA04  90 01 00 08 */	stw r0, 8(r1)
/* 8026EBC8 0026AA08  38 63 00 04 */	addi r3, r3, 4
/* 8026EBCC 0026AA0C  38 81 00 08 */	addi r4, r1, 8
/* 8026EBD0 0026AA10  4B ED CC F5 */	bl min$$0Ul$$1__3stdFRCUlRCUl_RCUl
/* 8026EBD4 0026AA14  80 03 00 00 */	lwz r0, 0(r3)
/* 8026EBD8 0026AA18  90 1F 00 00 */	stw r0, 0(r31)
...
/* 8026EC04 0026AA44  90 81 00 08 */	stw r4, 8(r1)
/* 8026EC08 0026AA48  80 03 00 00 */	lwz r0, 0(r3)
/* 8026EC0C 0026AA4C  90 03 00 10 */	stw r0, 0x10(r3)
/* 8026EC10 0026AA50  38 63 00 04 */	addi r3, r3, 4
/* 8026EC14 0026AA54  38 81 00 08 */	addi r4, r1, 8
/* 8026EC18 0026AA58  4B ED CC AD */	bl min$$0Ul$$1__3stdFRCUlRCUl_RCUl
/* 8026EC1C 0026AA5C  7C 64 1B 78 */	mr r4, r3
/* 8026EC20 0026AA60  38 7F 00 08 */	addi r3, r31, 8
/* 8026EC24 0026AA64  4B ED D2 FD */	bl max$$0Ul$$1__3stdFRCUlRCUl_RCUl
/* 8026EC28 0026AA68  80 03 00 00 */	lwz r0, 0(r3)
/* 8026EC2C 0026AA6C  90 1F 00 00 */	stw r0, 0(r31)
...
/* 8026EC50 0026AA90  38 00 00 00 */	li r0, 0
...
/* 8026EC7C 0026AABC  90 83 00 08 */	stw r4, 8(r3)
/* 8026EC80 0026AAC0  38 63 00 08 */	addi r3, r3, 8
/* 8026EC84 0026AAC4  7F E4 FB 78 */	mr r4, r31
/* 8026EC88 0026AAC8  4B ED D2 99 */	bl max$$0Ul$$1__3stdFRCUlRCUl_RCUl
/* 8026EC8C 0026AACC  80 03 00 00 */	lwz r0, 0(r3)
/* 8026EC90 0026AAD0  90 1F 00 00 */	stw r0, 0(r31)
...
/* 8026ECAC 0026AAEC  80 03 00 00 */	lwz r0, 0(r3)
/* 8026ECB0 0026AAF0  C8 42 AD 08 */	lfd f2, $$249001-_SDA2_BASE_(r2)
/* 8026ECB4 0026AAF4  90 01 00 0C */	stw r0, 0xc(r1)
/* 8026ECB8 0026AAF8  3C 80 43 30 */	lis r4, 0x4330
/* 8026ECBC 0026AAFC  90 81 00 08 */	stw r4, 8(r1)
/* 8026ECC0 0026AB00  C8 01 00 08 */	lfd f0, 8(r1)
/* 8026ECC4 0026AB04  EC 20 10 28 */	fsubs f1, f0, f2
/* 8026ECC8 0026AB08  80 03 00 04 */	lwz r0, 4(r3)
