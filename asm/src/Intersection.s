...
/* 801A05E4 0019C424  C0 85 00 00 */	lfs f4, 0(r5)
/* 801A05E8 0019C428  EC 60 20 28 */	fsubs f3, f0, f4
/* 801A05EC 0019C42C  C0 04 00 04 */	lfs f0, 4(r4)
/* 801A05F0 0019C430  C0 25 00 04 */	lfs f1, 4(r5)
/* 801A05F4 0019C434  EC 40 08 28 */	fsubs f2, f0, f1
/* 801A05F8 0019C438  C0 03 00 04 */	lfs f0, 4(r3)
/* 801A05FC 0019C43C  EC 20 08 28 */	fsubs f1, f0, f1
/* 801A0600 0019C440  C0 04 00 00 */	lfs f0, 0(r4)
...
.global t_query__Q33hel5geo2d26$$2unnamed$$2Intersection_cpp$$2FRCQ33hel5geo2d7SegmentRCQ33hel4math7Vector2RCQ33hel5geo2d7SegmentRCQ33hel4math7Vector2
t_query__Q33hel5geo2d26$$2unnamed$$2Intersection_cpp$$2FRCQ33hel5geo2d7SegmentRCQ33hel4math7Vector2RCQ33hel5geo2d7SegmentRCQ33hel4math7Vector2:
...
/* 801A0624 0019C464  F3 E1 01 08 */	xsmaddadp f31, f1, f0
/* 801A0628 0019C468  39 61 01 00 */	addi r11, r1, 0x100
/* 801A062C 0019C46C  4B E6 6D 11 */	bl func_8000733C
...
/* 801A064C 0019C48C  2C 03 00 00 */	cmpwi r3, 0
...
/* 801A065C 0019C49C  2C 03 00 00 */	cmpwi r3, 0
...
/* 801A0670 0019C4B0  C0 02 99 48 */	lfs f0, $$250828-_SDA2_BASE_(r2)
/* 801A0674 0019C4B4  FC 00 08 40 */	fcmpo cr0, f0, f1
/* 801A0678 0019C4B8  4C 40 13 82 */	cror 2, 0, 2
...
/* 801A06A0 0019C4E0  38 00 00 00 */	li r0, 0
/* 801A06A4 0019C4E4  C0 42 99 4C */	lfs f2, $$250829-_SDA2_BASE_(r2)
/* 801A06A8 0019C4E8  C0 02 99 48 */	lfs f0, $$250828-_SDA2_BASE_(r2)
...
/* 801A0704 0019C544  C0 22 99 48 */	lfs f1, $$250828-_SDA2_BASE_(r2)
...
/* 801A076C 0019C5AC  C0 22 99 54 */	lfs f1, $$250831-_SDA2_BASE_(r2)
...
/* 801A0800 0019C640  38 81 00 08 */	addi r4, r1, 8
...
lbl_801A0860:
/* 801A0860 0019C6A0  2C 03 00 00 */	cmpwi r3, 0
...
/* 801A087C 0019C6BC  2C 00 00 00 */	cmpwi r0, 0
...
/* 801A08AC 0019C6EC  4B E6 6A DD */	bl func_80007388
...
/* 801A08C0 0019C700  38 00 00 00 */	li r0, 0
/* 801A08C4 0019C704  C0 23 00 00 */	lfs f1, 0(r3)
/* 801A08C8 0019C708  C0 0D EE 28 */	lfs f0, ZERO__Q33hel4math7Vector2-_SDA_BASE_(r13)
/* 801A08CC 0019C70C  FC 01 00 00 */	fcmpu cr0, f1, f0
/* 801A08D0 0019C710  40 82 00 1C */	bne lbl_801A08EC
/* 801A08D4 0019C714  C0 23 00 04 */	lfs f1, 4(r3)
/* 801A08D8 0019C718  38 6D EE 28 */	addi r3, r13, ZERO__Q33hel4math7Vector2-_SDA_BASE_
/* 801A08DC 0019C71C  C0 03 00 04 */	lfs f0, 4(r3)
/* 801A08E0 0019C720  FC 01 00 00 */	fcmpu cr0, f1, f0
/* 801A08E4 0019C724  40 82 00 08 */	bne lbl_801A08EC
/* 801A08E8 0019C728  38 00 00 01 */	li r0, 1
lbl_801A08EC:
...
/* 801A090C 0019C74C  C0 02 99 48 */	lfs f0, $$250828-_SDA2_BASE_(r2)
...
/* 801A092C 0019C76C  C0 02 99 48 */	lfs f0, $$250828-_SDA2_BASE_(r2)
/* 801A0930 0019C770  D0 03 00 04 */	stfs f0, 4(r3)
/* 801A0934 0019C774  D0 03 00 00 */	stfs f0, 0(r3)
/* 801A0938 0019C778  38 00 00 00 */	li r0, 0
/* 801A093C 0019C77C  98 03 00 08 */	stb r0, 8(r3)
...
/* 801A099C 0019C7DC  38 00 00 01 */	li r0, 1
/* 801A09A0 0019C7E0  98 1F 00 08 */	stb r0, 8(r31)
...
/* 801A09CC 0019C80C  93 C1 00 08 */	stw r30, 8(r1)
...
/* 801A09DC 0019C81C  38 7E 00 08 */	addi r3, r30, 8
...
/* 801A09F0 0019C830  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 801A0A04 0019C844  80 A4 00 00 */	lwz r5, 0(r4)
/* 801A0A08 0019C848  80 04 00 04 */	lwz r0, 4(r4)
/* 801A0A0C 0019C84C  90 A3 00 00 */	stw r5, 0(r3)
/* 801A0A10 0019C850  90 03 00 04 */	stw r0, 4(r3)
/* 801A0A14 0019C854  80 04 00 08 */	lwz r0, 8(r4)
/* 801A0A18 0019C858  90 03 00 08 */	stw r0, 8(r3)
...
/* 801A0A38 0019C878  93 C1 00 08 */	stw r30, 8(r1)
...
/* 801A0A48 0019C888  88 1F 00 08 */	lbz r0, 8(r31)
/* 801A0A4C 0019C88C  98 1E 00 08 */	stb r0, 8(r30)
...
/* 801A0A60 0019C8A0  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 801A0A84 0019C8C4  F3 E1 00 98 */	psq_st f31, 152(r1), 0, qr0
/* 801A0A88 0019C8C8  DB C1 00 80 */	stfd f30, 0x80(r1)
/* 801A0A8C 0019C8CC  F3 C1 00 88 */	psq_st f30, 136(r1), 0, qr0
/* 801A0A90 0019C8D0  DB A1 00 70 */	stfd f29, 0x70(r1)
/* 801A0A94 0019C8D4  F3 A1 00 78 */	psq_st f29, 120(r1), 0, qr0
/* 801A0A98 0019C8D8  39 61 00 70 */	addi r11, r1, 0x70
/* 801A0A9C 0019C8DC  4B E6 68 A9 */	bl func_80007344
...
/* 801A0AD0 0019C910  38 61 00 08 */	addi r3, r1, 8
/* 801A0AD4 0019C914  7F E4 FB 78 */	mr r4, r31
/* 801A0AD8 0019C918  4B FA AE 91 */	bl __as__Q34nw4r4math5_VEC2FRCQ34nw4r4math5_VEC2
/* 801A0ADC 0019C91C  38 61 00 08 */	addi r3, r1, 8
/* 801A0AE0 0019C920  38 9F 00 08 */	addi r4, r31, 8
...
/* 801A0AEC 0019C92C  38 81 00 08 */	addi r4, r1, 8
...
/* 801A0B0C 0019C94C  4B FF FA D5 */	bl t_signed2DTriArea__Q33hel5geo2d26$$2unnamed$$2Intersection_cpp$$2FRCQ33hel4math7Vector2RCQ33hel4math7Vector2RCQ33hel4math7Vector2
...
/* 801A0B20 0019C960  4B FF FA C1 */	bl t_signed2DTriArea__Q33hel5geo2d26$$2unnamed$$2Intersection_cpp$$2FRCQ33hel4math7Vector2RCQ33hel4math7Vector2RCQ33hel4math7Vector2
/* 801A0B24 0019C964  FF A0 08 90 */	fmr f29, f1
/* 801A0B28 0019C968  EC 3E 00 72 */	fmuls f1, f30, f1
/* 801A0B2C 0019C96C  C0 02 99 48 */	lfs f0, $$250828-_SDA2_BASE_(r2)
/* 801A0B30 0019C970  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 801A0B34 0019C974  4C 40 13 82 */	cror 2, 0, 2
...
/* 801A0B48 0019C988  4B FF FA 99 */	bl t_signed2DTriArea__Q33hel5geo2d26$$2unnamed$$2Intersection_cpp$$2FRCQ33hel4math7Vector2RCQ33hel4math7Vector2RCQ33hel4math7Vector2
...
/* 801A0B58 0019C998  C0 02 99 48 */	lfs f0, $$250828-_SDA2_BASE_(r2)
/* 801A0B5C 0019C99C  FC 03 00 40 */	fcmpo cr0, f3, f0
/* 801A0B60 0019C9A0  4C 40 13 82 */	cror 2, 0, 2
...
/* 801A0B7C 0019C9BC  2C 03 00 00 */	cmpwi r3, 0
/* 801A0B80 0019C9C0  41 82 00 0C */	beq lbl_801A0B8C
/* 801A0B84 0019C9C4  C3 A2 99 48 */	lfs f29, $$250828-_SDA2_BASE_(r2)
...
lbl_801A0C04:
/* 801A0C04 0019CA44  C3 A2 99 58 */	lfs f29, $$250946-_SDA2_BASE_(r2)
...
lbl_801A0C14:
/* 801A0C14 0019CA54  C3 A2 99 48 */	lfs f29, $$250828-_SDA2_BASE_(r2)
...
/* 801A0CA0 0019CAE0  4B E6 66 F1 */	bl func_80007390
...
/* 801A0CC4 0019CB04  4B E6 66 7D */	bl func_80007340
...
/* 801A0CE0 0019CB20  C0 02 99 48 */	lfs f0, $$250828-_SDA2_BASE_(r2)
...
/* 801A0D10 0019CB50  4B E6 66 7D */	bl func_8000738C
...
/* 801A0D24 0019CB64  38 ED EE 28 */	addi r7, r13, ZERO__Q33hel4math7Vector2-_SDA_BASE_
/* 801A0D28 0019CB68  4B FF F8 EC */	b t_query__Q33hel5geo2d26$$2unnamed$$2Intersection_cpp$$2FRCQ33hel5geo2d7SegmentRCQ33hel4math7Vector2RCQ33hel5geo2d7SegmentRCQ33hel4math7Vector2
...
/* 801A0D30 0019CB70  4B FF F8 E4 */	b t_query__Q33hel5geo2d26$$2unnamed$$2Intersection_cpp$$2FRCQ33hel5geo2d7SegmentRCQ33hel4math7Vector2RCQ33hel5geo2d7SegmentRCQ33hel4math7Vector2
...
.global $$250829
$$250829:
	.incbin "baserom.dol", 0x49A40C, 0x4
.global $$250830
$$250830:
	.incbin "baserom.dol", 0x49A410, 0x4
.global $$250831
$$250831:
	.incbin "baserom.dol", 0x49A414, 0x4
.global $$250946
$$250946:
	.incbin "baserom.dol", 0x49A418, 0x8
