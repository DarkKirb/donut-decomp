...
/* 80230BF8 0022CA38  90 83 00 00 */	stw r4, 0(r3)
/* 80230BFC 0022CA3C  38 63 00 04 */	addi r3, r3, 4
/* 80230C00 0022CA40  48 03 E2 49 */	bl __ct__Q43scn4step5chara10InvincibleFv
/* 80230C04 0022CA44  80 02 A3 C8 */	lwz r0, $$250018-_SDA2_BASE_(r2)
/* 80230C08 0022CA48  90 1F 00 10 */	stw r0, 0x10(r31)
/* 80230C0C 0022CA4C  38 00 00 00 */	li r0, 0
...
/* 80230C40 0022CA80  38 63 00 04 */	addi r3, r3, 4
/* 80230C44 0022CA84  48 03 E2 1D */	bl update__Q43scn4step5chara10InvincibleFv
/* 80230C48 0022CA88  38 7F 00 04 */	addi r3, r31, 4
...
/* 80230C54 0022CA94  2C 00 00 00 */	cmpwi r0, 0
/* 80230C58 0022CA98  41 82 00 08 */	beq lbl_80230C60
/* 80230C5C 0022CA9C  38 60 00 00 */	li r3, 0
lbl_80230C60:
/* 80230C60 0022CAA0  54 60 06 3E */	clrlwi r0, r3, 0x18
...
/* 80230C7C 0022CABC  38 63 00 04 */	addi r3, r3, 4
...
/* 80230C9C 0022CADC  38 00 00 01 */	li r0, 1
...
/* 80230D04 0022CB44  80 63 00 00 */	lwz r3, 0(r3)
...
/* 80230D10 0022CB50  2C 03 00 00 */	cmpwi r3, 0
/* 80230D14 0022CB54  41 82 00 0C */	beq lbl_80230D20
/* 80230D18 0022CB58  38 60 00 00 */	li r3, 0
/* 80230D1C 0022CB5C  48 00 00 0C */	b lbl_80230D28
lbl_80230D20:
/* 80230D20 0022CB60  38 7F 00 04 */	addi r3, r31, 4
...
/* 8026EE48 0026AC88  38 00 00 00 */	li r0, 0
/* 8026EE4C 0026AC8C  90 03 00 00 */	stw r0, 0(r3)
/* 8026EE50 0026AC90  90 03 00 04 */	stw r0, 4(r3)
/* 8026EE54 0026AC94  98 03 00 08 */	stb r0, 8(r3)
/* 8026EE58 0026AC98  98 03 00 09 */	stb r0, 9(r3)
...
/* 8026EE78 0026ACB8  2C 03 00 00 */	cmpwi r3, 0
...
/* 8026EE88 0026ACC8  80 7F 00 04 */	lwz r3, 4(r31)
/* 8026EE8C 0026ACCC  38 03 00 01 */	addi r0, r3, 1
/* 8026EE90 0026ACD0  90 1F 00 04 */	stw r0, 4(r31)
...
/* 8026EEA0 0026ACE0  90 1F 00 04 */	stw r0, 4(r31)
lbl_8026EEA4:
...
/* 8026EEB8 0026ACF8  38 80 00 00 */	li r4, 0
/* 8026EEBC 0026ACFC  88 03 00 08 */	lbz r0, 8(r3)
/* 8026EEC0 0026AD00  2C 00 00 00 */	cmpwi r0, 0
/* 8026EEC4 0026AD04  40 82 00 1C */	bne lbl_8026EEE0
/* 8026EEC8 0026AD08  88 03 00 09 */	lbz r0, 9(r3)
/* 8026EECC 0026AD0C  2C 00 00 00 */	cmpwi r0, 0
/* 8026EED0 0026AD10  40 82 00 10 */	bne lbl_8026EEE0
/* 8026EED4 0026AD14  80 03 00 00 */	lwz r0, 0(r3)
/* 8026EED8 0026AD18  2C 00 00 00 */	cmpwi r0, 0
/* 8026EEDC 0026AD1C  41 82 00 08 */	beq lbl_8026EEE4
lbl_8026EEE0:
/* 8026EEE0 0026AD20  38 80 00 01 */	li r4, 1
lbl_8026EEE4:
...
/* 8026EEEC 0026AD2C  80 03 00 00 */	lwz r0, 0(r3)
/* 8026EEF0 0026AD30  7C 00 20 40 */	cmplw r0, r4
/* 8026EEF4 0026AD34  40 80 00 08 */	bge lbl_8026EEFC
/* 8026EEF8 0026AD38  90 83 00 00 */	stw r4, 0(r3)
lbl_8026EEFC:
/* 8026EEFC 0026AD3C  38 00 00 00 */	li r0, 0
/* 8026EF00 0026AD40  90 03 00 04 */	stw r0, 4(r3)
/* 8026EF04 0026AD44  4E 80 00 20 */	blr 

.global clear__Q43scn4step5chara10InvincibleFv
clear__Q43scn4step5chara10InvincibleFv:
/* 8026EF08 0026AD48  38 00 00 00 */	li r0, 0
/* 8026EF0C 0026AD4C  90 03 00 00 */	stw r0, 0(r3)
...
/* 8026EF14 0026AD54  38 00 00 01 */	li r0, 1
/* 8026EF18 0026AD58  98 03 00 08 */	stb r0, 8(r3)
/* 8026EF1C 0026AD5C  38 00 00 00 */	li r0, 0
/* 8026EF20 0026AD60  90 03 00 04 */	stw r0, 4(r3)
...
/* 8026EF28 0026AD68  38 00 00 00 */	li r0, 0
/* 8026EF2C 0026AD6C  98 03 00 09 */	stb r0, 9(r3)
...
/* 8026EF34 0026AD74  88 63 00 09 */	lbz r3, 9(r3)
...
/* 8026EF54 0026AD94  2C 03 00 00 */	cmpwi r3, 0
/* 8026EF58 0026AD98  41 82 00 20 */	beq lbl_8026EF78
/* 8026EF5C 0026AD9C  80 1F 00 04 */	lwz r0, 4(r31)
/* 8026EF60 0026ADA0  54 00 F8 7E */	srwi r0, r0, 1
/* 8026EF64 0026ADA4  54 00 10 3A */	slwi r0, r0, 2
/* 8026EF68 0026ADA8  3C 60 80 41 */	lis r3, T_ALPHA_ANIM_TABLE__Q43scn4step5chara24$$2unnamed$$2Invincible_cpp$$2@ha
/* 8026EF6C 0026ADAC  38 63 79 60 */	addi r3, r3, T_ALPHA_ANIM_TABLE__Q43scn4step5chara24$$2unnamed$$2Invincible_cpp$$2@l
/* 8026EF70 0026ADB0  7C 63 00 2E */	lwzx r3, r3, r0
/* 8026EF74 0026ADB4  48 00 00 08 */	b lbl_8026EF7C
lbl_8026EF78:
/* 8026EF78 0026ADB8  38 60 00 00 */	li r3, 0
lbl_8026EF7C:
...
/* 8026EF90 0026ADD0  80 83 00 00 */	lwz r4, 0(r3)
/* 8026EF94 0026ADD4  2C 04 00 00 */	cmpwi r4, 0
/* 8026EF98 0026ADD8  4D 82 00 20 */	beqlr 
/* 8026EF9C 0026ADDC  38 04 FF FF */	addi r0, r4, -1
/* 8026EFA0 0026ADE0  90 03 00 00 */	stw r0, 0(r3)
...
/* 80342194 0033DFD4  90 83 00 00 */	stw r4, 0(r3)
/* 80342198 0033DFD8  38 63 00 04 */	addi r3, r3, 4
/* 8034219C 0033DFDC  4B F2 CC AD */	bl __ct__Q43scn4step5chara10InvincibleFv
/* 803421A0 0033DFE0  38 00 00 00 */	li r0, 0
...
/* 80342218 0033E058  80 7F 00 00 */	lwz r3, 0(r31)
/* 8034221C 0033E05C  4B FF E1 41 */	bl objColl__Q43scn4step4hero4HeroFv
/* 80342220 0033E060  38 80 00 01 */	li r4, 1
...
/* 80342234 0033E074  80 7F 00 00 */	lwz r3, 0(r31)
/* 80342238 0033E078  4B FF E1 25 */	bl objColl__Q43scn4step4hero4HeroFv
/* 8034223C 0033E07C  38 80 00 00 */	li r4, 0
...
/* 80342284 0033E0C4  38 00 00 00 */	li r0, 0
...
/* 80342294 0033E0D4  3C 60 80 42 */	lis r3, MIGHTY_COLOR_TABLE__24$$2unnamed$$2Invincible_cpp$$2@ha
/* 80342298 0033E0D8  38 63 9D A0 */	addi r3, r3, MIGHTY_COLOR_TABLE__24$$2unnamed$$2Invincible_cpp$$2@l
/* 8034229C 0033E0DC  7C 03 20 2E */	lwzx r0, r3, r4
/* 803422A0 0033E0E0  54 00 06 3E */	clrlwi r0, r0, 0x18
/* 803422A4 0033E0E4  98 1F 00 20 */	stb r0, 0x20(r31)
/* 803422A8 0033E0E8  7C 63 22 14 */	add r3, r3, r4
/* 803422AC 0033E0EC  80 03 00 04 */	lwz r0, 4(r3)
/* 803422B0 0033E0F0  54 00 06 3E */	clrlwi r0, r0, 0x18
/* 803422B4 0033E0F4  98 1F 00 21 */	stb r0, 0x21(r31)
/* 803422B8 0033E0F8  80 03 00 08 */	lwz r0, 8(r3)
/* 803422BC 0033E0FC  54 00 06 3E */	clrlwi r0, r0, 0x18
...
/* 803422D0 0033E110  2C 00 00 00 */	cmpwi r0, 0
...
/* 803422E0 0033E120  54 00 06 3E */	clrlwi r0, r0, 0x18
/* 803422E4 0033E124  98 1F 00 23 */	stb r0, 0x23(r31)
/* 803422E8 0033E128  48 00 00 48 */	b lbl_80342330
lbl_803422EC:
/* 803422EC 0033E12C  38 7F 00 04 */	addi r3, r31, 4
/* 803422F0 0033E130  4B F2 CC 4D */	bl getFlashAlpha__Q43scn4step5chara10InvincibleCFv
/* 803422F4 0033E134  54 63 06 3E */	clrlwi r3, r3, 0x18
/* 803422F8 0033E138  88 1F 00 24 */	lbz r0, 0x24(r31)
/* 803422FC 0033E13C  2C 00 00 00 */	cmpwi r0, 0
/* 80342300 0033E140  41 82 00 08 */	beq lbl_80342308
/* 80342304 0033E144  38 60 00 00 */	li r3, 0
lbl_80342308:
/* 80342308 0033E148  80 02 CC A8 */	lwz r0, $$253735-_SDA2_BASE_(r2)
/* 8034230C 0033E14C  90 01 00 08 */	stw r0, 8(r1)
/* 80342310 0033E150  98 61 00 0B */	stb r3, 0xb(r1)
/* 80342314 0033E154  88 01 00 08 */	lbz r0, 8(r1)
/* 80342318 0033E158  98 1F 00 20 */	stb r0, 0x20(r31)
/* 8034231C 0033E15C  88 01 00 09 */	lbz r0, 9(r1)
...
/* 8034237C 0033E1BC  80 7F 00 00 */	lwz r3, 0(r31)
...
/* 80342498 0033E2D8  38 00 00 01 */	li r0, 1
...
/* 80342550 0033E390  38 00 00 01 */	li r0, 1
...
/* 803425C8 0033E408  80 63 00 00 */	lwz r3, 0(r3)
...
/* 80342660 0033E4A0  80 7E 00 00 */	lwz r3, 0(r30)
/* 80342664 0033E4A4  4B FF B9 CD */	bl isVisible__Q43scn4step4hero4HeroCFv
/* 80342668 0033E4A8  2C 03 00 00 */	cmpwi r3, 0
...
/* 803426B4 0033E4F4  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 80342710 0033E550  38 00 00 01 */	li r0, 1
/* 80342714 0033E554  98 1E 00 10 */	stb r0, 0x10(r30)
/* 80342718 0033E558  38 00 00 00 */	li r0, 0
...
/* 80342734 0033E574  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 8034278C 0033E5CC  3B E0 00 00 */	li r31, 0
/* 80342790 0033E5D0  3B C0 00 00 */	li r30, 0
/* 80342794 0033E5D4  80 7D 00 00 */	lwz r3, 0(r29)
...
/* 803427A4 0033E5E4  80 7D 00 00 */	lwz r3, 0(r29)
...
/* 803427B4 0033E5F4  38 61 00 08 */	addi r3, r1, 8
/* 803427B8 0033E5F8  38 A0 00 00 */	li r5, 0
...
/* 803427C4 0033E604  2C 03 00 00 */	cmpwi r3, 0
/* 803427C8 0033E608  40 82 00 14 */	bne lbl_803427DC
/* 803427CC 0033E60C  38 61 00 08 */	addi r3, r1, 8
/* 803427D0 0033E610  38 80 FF FF */	li r4, -1
/* 803427D4 0033E614  4B EE DE F5 */	bl __dt__Q24util35ObjRefHandle$$0Q43scn4step4hero4Hero$$1Fv
...
/* 803427E4 0033E624  2C 00 00 00 */	cmpwi r0, 0
/* 803427E8 0033E628  41 82 00 08 */	beq lbl_803427F0
/* 803427EC 0033E62C  3B E0 00 01 */	li r31, 1
lbl_803427F0:
/* 803427F0 0033E630  38 61 00 08 */	addi r3, r1, 8
/* 803427F4 0033E634  38 80 FF FF */	li r4, -1
/* 803427F8 0033E638  4B EE DE D1 */	bl __dt__Q24util35ObjRefHandle$$0Q43scn4step4hero4Hero$$1Fv
lbl_803427FC:
/* 803427FC 0033E63C  2C 1F 00 00 */	cmpwi r31, 0
/* 80342800 0033E640  40 82 00 18 */	bne lbl_80342818
/* 80342804 0033E644  80 7D 00 00 */	lwz r3, 0(r29)
/* 80342808 0033E648  4B D3 2F 29 */	bl GKI_getfirst
/* 8034280C 0033E64C  4B EC 09 CD */	bl bgLayout__Q33scn10grandtitle9ComponentFv
/* 80342810 0033E650  38 80 00 02 */	li r4, 2
/* 80342814 0033E654  4B F3 1F 4D */	bl unrequest__Q43scn4step4core13BGMControllerFQ43scn4step4core11BGMCategory
lbl_80342818:
/* 80342818 0033E658  80 7D 00 00 */	lwz r3, 0(r29)
/* 8034281C 0033E65C  4B FF DA C1 */	bl param__Q43scn4step4hero4HeroFv
/* 80342820 0033E660  38 80 00 00 */	li r4, 0
...
/* 80342830 0033E670  80 7D 00 00 */	lwz r3, 0(r29)
...
/* 80342840 0033E680  4B CC 4B 51 */	bl func_80007390
...
/* 80342868 0033E6A8  38 63 00 04 */	addi r3, r3, 4
...
/* 80342878 0033E6B8  80 7F 00 00 */	lwz r3, 0(r31)
/* 8034287C 0033E6BC  4B FF DA E1 */	bl objColl__Q43scn4step4hero4HeroFv
/* 80342880 0033E6C0  38 63 00 08 */	addi r3, r3, 8
...
/* 8034288C 0033E6CC  38 00 00 00 */	li r0, 0
...
/* 803428D4 0033E714  38 63 00 04 */	addi r3, r3, 4
...
lbl_80342924:
/* 80342924 0033E764  80 7F 00 00 */	lwz r3, 0(r31)
/* 80342928 0033E768  4B FF DA 35 */	bl objColl__Q43scn4step4hero4HeroFv
/* 8034292C 0033E76C  38 63 00 08 */	addi r3, r3, 8
...
/* 80342958 0033E798  2C 00 00 00 */	cmpwi r0, 0
/* 8034295C 0033E79C  40 82 00 24 */	bne lbl_80342980
/* 80342960 0033E7A0  38 00 00 01 */	li r0, 1
/* 80342964 0033E7A4  98 03 00 12 */	stb r0, 0x12(r3)
/* 80342968 0033E7A8  80 63 00 00 */	lwz r3, 0(r3)
...
/* 80342978 0033E7B8  38 A0 00 01 */	li r5, 1
...
/* 803429A0 0033E7E0  2C 00 00 00 */	cmpwi r0, 0
/* 803429A4 0033E7E4  41 82 00 1C */	beq lbl_803429C0
/* 803429A8 0033E7E8  38 00 00 00 */	li r0, 0
/* 803429AC 0033E7EC  98 03 00 12 */	stb r0, 0x12(r3)
/* 803429B0 0033E7F0  80 63 00 00 */	lwz r3, 0(r3)
