...
/* 80344AF4 00340934  88 04 00 04 */	lbz r0, 4(r4)
/* 80344AF8 00340938  2C 00 00 00 */	cmpwi r0, 0
/* 80344AFC 0034093C  41 82 00 54 */	beq lbl_80344B50
/* 80344B00 00340940  80 64 00 00 */	lwz r3, 0(r4)
...
lbl_80344B50:
/* 80344B50 00340990  80 64 00 00 */	lwz r3, 0(r4)
...
/* 80344B8C 003409CC  F3 E1 00 38 */	psq_st f31, 56(r1), 0, qr0
/* 80344B90 003409D0  93 E1 00 2C */	stw r31, 0x2c(r1)
/* 80344B94 003409D4  7C 7F 1B 78 */	mr r31, r3
/* 80344B98 003409D8  88 03 00 04 */	lbz r0, 4(r3)
/* 80344B9C 003409DC  2C 00 00 00 */	cmpwi r0, 0
/* 80344BA0 003409E0  41 82 00 78 */	beq lbl_80344C18
/* 80344BA4 003409E4  80 63 00 00 */	lwz r3, 0(r3)
...
/* 80344BD8 00340A18  80 7F 00 00 */	lwz r3, 0(r31)
...
/* 80344BF4 00340A34  C0 02 CC E0 */	lfs f0, $$252449-_SDA2_BASE_(r2)
...
lbl_80344C04:
/* 80344C04 00340A44  C0 02 CC E4 */	lfs f0, $$252450-_SDA2_BASE_(r2)
/* 80344C08 00340A48  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80344C0C 00340A4C  7C 60 00 26 */	mfcr r3
/* 80344C10 00340A50  54 63 0F FE */	srwi r3, r3, 0x1f
/* 80344C14 00340A54  48 00 00 10 */	b lbl_80344C24
lbl_80344C18:
/* 80344C18 00340A58  80 63 00 00 */	lwz r3, 0(r3)
...
.global $$252450
$$252450:
	.incbin "baserom.dol", 0x49D7A4, 0x4
