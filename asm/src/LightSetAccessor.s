...
/* 8018E650 0018A490  80 03 00 00 */	lwz r0, 0(r3)
/* 8018E654 0018A494  2C 00 00 00 */	cmpwi r0, 0
/* 8018E658 0018A498  41 82 00 14 */	beq lbl_8018E66C
/* 8018E65C 0018A49C  80 03 00 04 */	lwz r0, 4(r3)
/* 8018E660 0018A4A0  2C 00 00 00 */	cmpwi r0, 0
/* 8018E664 0018A4A4  41 82 00 08 */	beq lbl_8018E66C
/* 8018E668 0018A4A8  38 80 00 01 */	li r4, 1
lbl_8018E66C:
...
/* 8018E678 0018A4B8  38 A0 FF FF */	li r5, -1
...
/* 8018E690 0018A4D0  93 C1 00 08 */	stw r30, 8(r1)
/* 8018E694 0018A4D4  7C 7E 1B 78 */	mr r30, r3
/* 8018E698 0018A4D8  3B E0 00 00 */	li r31, 0
lbl_8018E69C:
...
/* 8018E6A8 0018A4E8  3B FF 00 01 */	addi r31, r31, 1
/* 8018E6AC 0018A4EC  28 1F 00 08 */	cmplwi r31, 8
/* 8018E6B0 0018A4F0  41 80 FF EC */	blt lbl_8018E69C
/* 8018E6B4 0018A4F4  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 8018E6B8 0018A4F8  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 8018E6D0 0018A510  38 80 FF FF */	li r4, -1
...
/* 8018E724 0018A564  88 1F 00 00 */	lbz r0, 0(r31)
/* 8018E728 0018A568  98 03 00 00 */	stb r0, 0(r3)
/* 8018E72C 0018A56C  88 1F 00 01 */	lbz r0, 1(r31)
/* 8018E730 0018A570  98 03 00 01 */	stb r0, 1(r3)
/* 8018E734 0018A574  88 1F 00 02 */	lbz r0, 2(r31)
/* 8018E738 0018A578  98 03 00 02 */	stb r0, 2(r3)
/* 8018E73C 0018A57C  88 1F 00 03 */	lbz r0, 3(r31)
/* 8018E740 0018A580  98 03 00 03 */	stb r0, 3(r3)
