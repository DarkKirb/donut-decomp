...
/* 801E0BD0 001DCA10  4B E2 67 71 */	bl func_80007340
/* 801E0BD4 001DCA14  7C 7C 1B 78 */	mr r28, r3
/* 801E0BD8 001DCA18  7C 9D 23 78 */	mr r29, r4
/* 801E0BDC 001DCA1C  3C 80 80 46 */	lis r4, $$252060@ha
/* 801E0BE0 001DCA20  3B C4 DD 40 */	addi r30, r4, $$252060@l
/* 801E0BE4 001DCA24  3B E0 00 00 */	li r31, 0
/* 801E0BE8 001DCA28  93 E3 00 00 */	stw r31, 0(r3)
/* 801E0BEC 001DCA2C  38 61 00 A0 */	addi r3, r1, 0xa0
/* 801E0BF0 001DCA30  38 9E 00 00 */	addi r4, r30, 0
...
/* 801E0C04 001DCA44  38 7C 00 04 */	addi r3, r28, 4
...
/* 801E0C10 001DCA50  38 9E 00 00 */	addi r4, r30, 0
...
/* 801E0C40 001DCA80  38 9C 00 04 */	addi r4, r28, 4
/* 801E0C44 001DCA84  38 AD 95 C0 */	addi r5, r13, $$252063-_SDA_BASE_
...
/* 801E0C5C 001DCA9C  38 80 FF FF */	li r4, -1
/* 801E0C60 001DCAA0  4B F9 75 C1 */	bl __dt__Q23lyt12PaneAccessorFv
/* 801E0C64 001DCAA4  80 6D ED 08 */	lwz r3, object___Q33hel6common35ExplicitSingleton$$0Q23gfx9VISetting$$1-_SDA_BASE_(r13)
/* 801E0C68 001DCAA8  88 03 00 08 */	lbz r0, 8(r3)
/* 801E0C6C 001DCAAC  2C 00 00 00 */	cmpwi r0, 0
...
/* 801E0C80 001DCAC0  C0 02 9D 68 */	lfs f0, $$252064-_SDA2_BASE_(r2)
/* 801E0C84 001DCAC4  D0 01 00 08 */	stfs f0, 8(r1)
/* 801E0C88 001DCAC8  C0 02 9D 6C */	lfs f0, $$252065-_SDA2_BASE_(r2)
...
/* 801E0C98 001DCAD8  38 81 00 08 */	addi r4, r1, 8
...
/* 801E0CCC 001DCB0C  4B E2 66 C1 */	bl func_8000738C
...
/* 801E0CF4 001DCB34  38 63 00 04 */	addi r3, r3, 4
...
/* 801E0D0C 001DCB4C  80 1F 00 00 */	lwz r0, 0(r31)
/* 801E0D10 001DCB50  2C 00 00 01 */	cmpwi r0, 1
/* 801E0D14 001DCB54  41 82 00 20 */	beq lbl_801E0D34
/* 801E0D18 001DCB58  2C 00 00 02 */	cmpwi r0, 2
/* 801E0D1C 001DCB5C  41 82 00 4C */	beq lbl_801E0D68
/* 801E0D20 001DCB60  2C 00 00 03 */	cmpwi r0, 3
/* 801E0D24 001DCB64  41 82 00 60 */	beq lbl_801E0D84
/* 801E0D28 001DCB68  2C 00 00 04 */	cmpwi r0, 4
...
/* 801E0D3C 001DCB7C  2C 03 00 00 */	cmpwi r3, 0
/* 801E0D40 001DCB80  41 82 00 90 */	beq lbl_801E0DD0
/* 801E0D44 001DCB84  38 7F 00 04 */	addi r3, r31, 4
/* 801E0D48 001DCB88  38 8D 95 D0 */	addi r4, r13, $$252106-_SDA_BASE_
/* 801E0D4C 001DCB8C  4B FC C2 09 */	bl setAnimByName__Q23lyt6LayoutFPCc
/* 801E0D50 001DCB90  38 7F 00 04 */	addi r3, r31, 4
/* 801E0D54 001DCB94  38 80 00 00 */	li r4, 0
/* 801E0D58 001DCB98  4B FC C3 A9 */	bl start__Q23lyt6LayoutFb
/* 801E0D5C 001DCB9C  38 00 00 02 */	li r0, 2
/* 801E0D60 001DCBA0  90 1F 00 00 */	stw r0, 0(r31)
/* 801E0D64 001DCBA4  48 00 00 6C */	b lbl_801E0DD0
lbl_801E0D68:
/* 801E0D68 001DCBA8  38 7F 00 04 */	addi r3, r31, 4
/* 801E0D6C 001DCBAC  4B FC C3 AD */	bl isAnimEnd__Q23lyt6LayoutCFv
/* 801E0D70 001DCBB0  2C 03 00 00 */	cmpwi r3, 0
/* 801E0D74 001DCBB4  41 82 00 5C */	beq lbl_801E0DD0
/* 801E0D78 001DCBB8  38 00 00 03 */	li r0, 3
/* 801E0D7C 001DCBBC  90 1F 00 00 */	stw r0, 0(r31)
/* 801E0D80 001DCBC0  48 00 00 50 */	b lbl_801E0DD0
lbl_801E0D84:
/* 801E0D84 001DCBC4  88 1F 03 AC */	lbz r0, 0x3ac(r31)
/* 801E0D88 001DCBC8  2C 00 00 00 */	cmpwi r0, 0
/* 801E0D8C 001DCBCC  41 82 00 44 */	beq lbl_801E0DD0
/* 801E0D90 001DCBD0  38 7F 00 04 */	addi r3, r31, 4
/* 801E0D94 001DCBD4  38 8D 95 D8 */	addi r4, r13, $$252107-_SDA_BASE_
/* 801E0D98 001DCBD8  4B FC C1 BD */	bl setAnimByName__Q23lyt6LayoutFPCc
/* 801E0D9C 001DCBDC  38 7F 00 04 */	addi r3, r31, 4
/* 801E0DA0 001DCBE0  38 80 00 00 */	li r4, 0
/* 801E0DA4 001DCBE4  4B FC C3 5D */	bl start__Q23lyt6LayoutFb
/* 801E0DA8 001DCBE8  38 00 00 04 */	li r0, 4
/* 801E0DAC 001DCBEC  90 1F 00 00 */	stw r0, 0(r31)
/* 801E0DB0 001DCBF0  48 00 00 20 */	b lbl_801E0DD0
lbl_801E0DB4:
/* 801E0DB4 001DCBF4  38 7F 00 04 */	addi r3, r31, 4
/* 801E0DB8 001DCBF8  4B FC C3 61 */	bl isAnimEnd__Q23lyt6LayoutCFv
/* 801E0DBC 001DCBFC  2C 03 00 00 */	cmpwi r3, 0
/* 801E0DC0 001DCC00  41 82 00 10 */	beq lbl_801E0DD0
/* 801E0DC4 001DCC04  38 00 00 00 */	li r0, 0
/* 801E0DC8 001DCC08  98 1F 03 AC */	stb r0, 0x3ac(r31)
/* 801E0DCC 001DCC0C  90 1F 00 00 */	stw r0, 0(r31)
lbl_801E0DD0:
/* 801E0DD0 001DCC10  38 7F 00 04 */	addi r3, r31, 4
...
/* 801E0E00 001DCC40  80 03 00 00 */	lwz r0, 0(r3)
/* 801E0E04 001DCC44  28 00 00 01 */	cmplwi r0, 1
/* 801E0E08 001DCC48  40 81 00 10 */	ble lbl_801E0E18
/* 801E0E0C 001DCC4C  4B FD 05 31 */	bl SetupGX__Q23lyt7UtilityFv
/* 801E0E10 001DCC50  38 7F 00 04 */	addi r3, r31, 4
...
/* 801E0E48 001DCC88  38 00 00 01 */	li r0, 1
/* 801E0E4C 001DCC8C  90 1F 00 00 */	stw r0, 0(r31)
...
/* 801E0E64 001DCCA4  38 00 00 01 */	li r0, 1
/* 801E0E68 001DCCA8  98 03 03 AC */	stb r0, 0x3ac(r3)
/* 801E0E6C 001DCCAC  80 03 00 00 */	lwz r0, 0(r3)
/* 801E0E70 001DCCB0  2C 00 00 01 */	cmpwi r0, 1
/* 801E0E74 001DCCB4  4C 82 00 20 */	bnelr 
/* 801E0E78 001DCCB8  38 00 00 00 */	li r0, 0
