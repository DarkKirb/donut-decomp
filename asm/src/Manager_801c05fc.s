...
.global lbl_801C05FC
lbl_801C05FC:
/* 801C05FC 001BC43C  3C 60 80 46 */	lis r3, lbl_80459DC0@ha
/* 801C0600 001BC440  38 63 9D C0 */	addi r3, r3, lbl_80459DC0@l
/* 801C0604 001BC444  38 80 00 13 */	li r4, 0x13
/* 801C0608 001BC448  3C A0 80 46 */	lis r5, lbl_80459DCC@ha
/* 801C060C 001BC44C  38 A5 9D CC */	addi r5, r5, lbl_80459DCC@l
/* 801C0610 001BC450  4C C6 31 82 */	crclr 4*cr1+eq
/* 801C0614 001BC454  4B FC A1 DC */	b lbl_8018A7F0
.global lbl_801C0618
lbl_801C0618:
...
/* 801C0634 001BC474  98 0D EE 98 */	stb r0, lbl_8055D2B8@sda21(r13)
/* 801C0638 001BC478  48 00 54 B9 */	bl lbl_801C5AF0
/* 801C063C 001BC47C  38 7F 00 24 */	addi r3, r31, 0x24
/* 801C0640 001BC480  7F E4 FB 78 */	mr r4, r31
/* 801C0644 001BC484  4B FF F7 05 */	bl lbl_801BFD48
/* 801C0648 001BC488  38 7F 01 24 */	addi r3, r31, 0x124
/* 801C064C 001BC48C  48 00 04 B5 */	bl lbl_801C0B00
/* 801C0650 001BC490  3C 60 80 1C */	lis r3, lbl_801C05FC@ha
/* 801C0654 001BC494  38 03 05 FC */	addi r0, r3, lbl_801C05FC@l
/* 801C0658 001BC498  90 1F 00 18 */	stw r0, 0x18(r31)
/* 801C065C 001BC49C  3C 60 80 1C */	lis r3, lbl_801C0618@ha
/* 801C0660 001BC4A0  38 03 06 18 */	addi r0, r3, lbl_801C0618@l
/* 801C0664 001BC4A4  90 1F 00 20 */	stw r0, 0x20(r31)
/* 801C0668 001BC4A8  7F E3 FB 78 */	mr r3, r31
/* 801C066C 001BC4AC  48 00 56 ED */	bl lbl_801C5D58
...
/* 801C06B0 001BC4F0  98 0D EE 98 */	stb r0, lbl_8055D2B8@sda21(r13)
/* 801C06B4 001BC4F4  38 80 00 00 */	li r4, 0x0
/* 801C06B8 001BC4F8  4B FB 54 B1 */	bl lbl_80175B68
...
/* 801C06CC 001BC50C  4B FF F0 49 */	bl lbl_801BF714
.global lbl_801C06D0
lbl_801C06D0:
...
/* 801C0750 001BC590  4B FF EF C5 */	bl lbl_801BF714
.global lbl_801C0754
lbl_801C0754:
