...
/* 801DBE28 001D7C68  3C 80 80 41 */	lis r4, lbl_80415380@ha
/* 801DBE2C 001D7C6C  38 04 53 80 */	addi r0, r4, lbl_80415380@l
...
/* 801DBE7C 001D7CBC  4B FF FF A9 */	bl lbl_801DBE24
...
/* 801DBE94 001D7CD4  3C 80 80 46 */	lis r4, lbl_8045D71C@ha
/* 801DBE98 001D7CD8  38 84 D7 1C */	addi r4, r4, lbl_8045D71C@l
/* 801DBE9C 001D7CDC  4C C6 31 82 */	crclr 4*cr1+eq
/* 801DBEA0 001D7CE0  48 00 00 3D */	bl lbl_801DBEDC
...
/* 801DBF78 001D7DB8  4B FC 1A 89 */	bl lbl_8019DA00
...
/* 801DBFA4 001D7DE4  4B FF FE 81 */	bl lbl_801DBE24
/* 801DBFA8 001D7DE8  38 61 00 20 */	addi r3, r1, 0x20
/* 801DBFAC 001D7DEC  3C 80 80 46 */	lis r4, lbl_8045D738@ha
/* 801DBFB0 001D7DF0  38 84 D7 38 */	addi r4, r4, lbl_8045D738@l
/* 801DBFB4 001D7DF4  80 A1 00 0C */	lwz r5, 0xc(r1)
/* 801DBFB8 001D7DF8  4C C6 31 82 */	crclr 4*cr1+eq
/* 801DBFBC 001D7DFC  4B FF FF 21 */	bl lbl_801DBEDC
...
/* 801DC010 001D7E50  4B FF FE 15 */	bl lbl_801DBE24
/* 801DC014 001D7E54  38 61 00 20 */	addi r3, r1, 0x20
/* 801DC018 001D7E58  3C 80 80 46 */	lis r4, lbl_8045D744@ha
/* 801DC01C 001D7E5C  38 84 D7 44 */	addi r4, r4, lbl_8045D744@l
/* 801DC020 001D7E60  80 A1 00 0C */	lwz r5, 0xc(r1)
/* 801DC024 001D7E64  4C C6 31 82 */	crclr 4*cr1+eq
/* 801DC028 001D7E68  4B FF FE B5 */	bl lbl_801DBEDC
...
/* 801DC07C 001D7EBC  4B FF FD A9 */	bl lbl_801DBE24
/* 801DC080 001D7EC0  38 61 00 20 */	addi r3, r1, 0x20
/* 801DC084 001D7EC4  3C 80 80 46 */	lis r4, lbl_8045D75C@ha
/* 801DC088 001D7EC8  38 84 D7 5C */	addi r4, r4, lbl_8045D75C@l
/* 801DC08C 001D7ECC  80 A1 00 0C */	lwz r5, 0xc(r1)
/* 801DC090 001D7ED0  4C C6 31 82 */	crclr 4*cr1+eq
/* 801DC094 001D7ED4  4B FF FE 49 */	bl lbl_801DBEDC
...
/* 801DC0E4 001D7F24  4B FF FD 41 */	bl lbl_801DBE24
...
/* 801DC150 001D7F90  4B FF FC D5 */	bl lbl_801DBE24
...
/* 801DC160 001D7FA0  48 00 00 51 */	bl lbl_801DC1B0
...
/* 801DC238 001D8078  4B FF FB ED */	bl lbl_801DBE24
...
/* 801DC248 001D8088  4B FF FF 69 */	bl lbl_801DC1B0
...
/* 801DC2C4 001D8104  48 00 00 51 */	bl lbl_801DC314
/* 801DC2C8 001D8108  38 A1 00 08 */	addi r5, r1, 0x8
/* 801DC2CC 001D810C  38 61 00 38 */	addi r3, r1, 0x38
/* 801DC2D0 001D8110  38 8D 94 68 */	addi r4, r13, lbl_80557888@sda21
/* 801DC2D4 001D8114  4C C6 31 82 */	crclr 4*cr1+eq
/* 801DC2D8 001D8118  4B FF FC 05 */	bl lbl_801DBEDC
...
/* 801DC338 001D8178  4B FF FA ED */	bl lbl_801DBE24
...
/* 801DC348 001D8188  48 00 00 61 */	bl lbl_801DC3A8
...
/* 801DC35C 001D819C  38 8D 94 70 */	addi r4, r13, lbl_80557890@sda21
/* 801DC360 001D81A0  80 A1 00 14 */	lwz r5, 0x14(r1)
/* 801DC364 001D81A4  4C C6 31 82 */	crclr 4*cr1+eq
/* 801DC368 001D81A8  4B FF FB 75 */	bl lbl_801DBEDC
...
/* 801DC3C4 001D8204  4B FF FD ED */	bl lbl_801DC1B0
...
/* 801DC420 001D8260  4B FF FA 05 */	bl lbl_801DBE24
...
/* 801DC430 001D8270  4B FF FF 79 */	bl lbl_801DC3A8
