...
/* 801C5B04 001C1944  80 0D EE A0 */	lwz r0, lbl_8055D2C0@sda21(r13)
/* 801C5B08 001C1948  2C 00 00 00 */	cmpwi r0, 0x0
/* 801C5B0C 001C194C  41 82 00 20 */	beq lbl_801C5B2C
/* 801C5B10 001C1950  3C 60 80 46 */	lis r3, lbl_8045BBE4@ha
/* 801C5B14 001C1954  38 63 BB E4 */	addi r3, r3, lbl_8045BBE4@l
/* 801C5B18 001C1958  38 80 00 46 */	li r4, 0x46
/* 801C5B1C 001C195C  3C A0 80 46 */	lis r5, lbl_8045BBD0@ha
/* 801C5B20 001C1960  38 A5 BB D0 */	addi r5, r5, lbl_8045BBD0@l
/* 801C5B24 001C1964  4C C6 31 82 */	crclr 4*cr1+eq
/* 801C5B28 001C1968  48 00 04 7D */	bl lbl_801C5FA4
.global lbl_801C5B2C
lbl_801C5B2C:
/* 801C5B2C 001C196C  7F E3 FB 78 */	mr r3, r31
/* 801C5B30 001C1970  48 00 00 6D */	bl lbl_801C5B9C
/* 801C5B34 001C1974  38 7F 00 0C */	addi r3, r31, 0xc
/* 801C5B38 001C1978  48 00 00 65 */	bl lbl_801C5B9C
...
/* 801C5B4C 001C198C  3C 60 80 1C */	lis r3, lbl_801C5E2C@ha
/* 801C5B50 001C1990  38 03 5E 2C */	addi r0, r3, lbl_801C5E2C@l
/* 801C5B54 001C1994  90 1F 00 20 */	stw r0, 0x20(r31)
/* 801C5B58 001C1998  48 00 00 ED */	bl lbl_801C5C44
/* 801C5B5C 001C199C  2C 03 00 00 */	cmpwi r3, 0x0
/* 801C5B60 001C19A0  41 82 00 20 */	beq lbl_801C5B80
/* 801C5B64 001C19A4  3C 60 80 46 */	lis r3, lbl_8045BB8C@ha
/* 801C5B68 001C19A8  38 63 BB 8C */	addi r3, r3, lbl_8045BB8C@l
/* 801C5B6C 001C19AC  38 80 00 33 */	li r4, 0x33
/* 801C5B70 001C19B0  3C A0 80 46 */	lis r5, lbl_8045BB78@ha
/* 801C5B74 001C19B4  38 A5 BB 78 */	addi r5, r5, lbl_8045BB78@l
/* 801C5B78 001C19B8  4C C6 31 82 */	crclr 4*cr1+eq
/* 801C5B7C 001C19BC  48 00 04 29 */	bl lbl_801C5FA4
.global lbl_801C5B80
lbl_801C5B80:
/* 801C5B80 001C19C0  93 ED EE A0 */	stw r31, lbl_8055D2C0@sda21(r13)
...
.global lbl_801C5B9C
lbl_801C5B9C:
/* 801C5B9C 001C19DC  3C 80 80 46 */	lis r4, lbl_8045BB24@ha
/* 801C5BA0 001C19E0  38 04 BB 24 */	addi r0, r4, lbl_8045BB24@l
...
.global lbl_801C5BB8
lbl_801C5BB8:
/* 801C5BB8 001C19F8  4B FA FF B0 */	b lbl_80175B68
.global lbl_801C5BBC
lbl_801C5BBC:
...
/* 801C5BE0 001C1A20  48 00 00 65 */	bl lbl_801C5C44
/* 801C5BE4 001C1A24  2C 03 00 00 */	cmpwi r3, 0x0
/* 801C5BE8 001C1A28  41 82 00 20 */	beq lbl_801C5C08
/* 801C5BEC 001C1A2C  3C 60 80 46 */	lis r3, lbl_8045BBB8@ha
/* 801C5BF0 001C1A30  38 63 BB B8 */	addi r3, r3, lbl_8045BBB8@l
/* 801C5BF4 001C1A34  38 80 00 4C */	li r4, 0x4c
/* 801C5BF8 001C1A38  3C A0 80 46 */	lis r5, lbl_8045BBA4@ha
/* 801C5BFC 001C1A3C  38 A5 BB A4 */	addi r5, r5, lbl_8045BBA4@l
/* 801C5C00 001C1A40  4C C6 31 82 */	crclr 4*cr1+eq
/* 801C5C04 001C1A44  48 00 03 A1 */	bl lbl_801C5FA4
.global lbl_801C5C08
lbl_801C5C08:
/* 801C5C08 001C1A48  7F C3 F3 78 */	mr r3, r30
/* 801C5C0C 001C1A4C  38 80 00 00 */	li r4, 0x0
/* 801C5C10 001C1A50  4B FA FF 59 */	bl lbl_80175B68
...
/* 801C5C24 001C1A64  4B FF 9A F1 */	bl lbl_801BF714
.global lbl_801C5C28
lbl_801C5C28:
...
.global lbl_801C5C44
lbl_801C5C44:
/* 801C5C44 001C1A84  80 6D EE A0 */	lwz r3, lbl_8055D2C0@sda21(r13)
...
/* 801C5C7C 001C1ABC  4B FF FF 3D */	bl lbl_801C5BB8
...
/* 801C5C90 001C1AD0  4B FF 9A 85 */	bl lbl_801BF714
.global lbl_801C5C94
lbl_801C5C94:
...
/* 801C5CD4 001C1B14  4B FF FF 71 */	bl lbl_801C5C44
/* 801C5CD8 001C1B18  2C 03 00 00 */	cmpwi r3, 0x0
/* 801C5CDC 001C1B1C  40 82 00 20 */	bne lbl_801C5CFC
/* 801C5CE0 001C1B20  3C 60 80 46 */	lis r3, lbl_8045BB60@ha
/* 801C5CE4 001C1B24  38 63 BB 60 */	addi r3, r3, lbl_8045BB60@l
/* 801C5CE8 001C1B28  38 80 00 3E */	li r4, 0x3e
/* 801C5CEC 001C1B2C  3C A0 80 46 */	lis r5, lbl_8045BB4C@ha
/* 801C5CF0 001C1B30  38 A5 BB 4C */	addi r5, r5, lbl_8045BB4C@l
/* 801C5CF4 001C1B34  4C C6 31 82 */	crclr 4*cr1+eq
/* 801C5CF8 001C1B38  48 00 02 AD */	bl lbl_801C5FA4
.global lbl_801C5CFC
lbl_801C5CFC:
/* 801C5CFC 001C1B3C  38 00 00 00 */	li r0, 0x0
/* 801C5D00 001C1B40  90 0D EE A0 */	stw r0, lbl_8055D2C0@sda21(r13)
/* 801C5D04 001C1B44  38 7E 00 0C */	addi r3, r30, 0xc
/* 801C5D08 001C1B48  38 80 FF FF */	li r4, -0x1
/* 801C5D0C 001C1B4C  4B FF FF 49 */	bl lbl_801C5C54
/* 801C5D10 001C1B50  7F C3 F3 78 */	mr r3, r30
/* 801C5D14 001C1B54  38 80 FF FF */	li r4, -0x1
/* 801C5D18 001C1B58  4B FF FF 3D */	bl lbl_801C5C54
/* 801C5D1C 001C1B5C  7F C3 F3 78 */	mr r3, r30
/* 801C5D20 001C1B60  38 80 00 00 */	li r4, 0x0
/* 801C5D24 001C1B64  4B FF FE 99 */	bl lbl_801C5BBC
...
/* 801C5D38 001C1B78  4B FF 99 DD */	bl lbl_801BF714
.global lbl_801C5D3C
lbl_801C5D3C:
...
/* 801C5D6C 001C1BAC  48 00 00 49 */	bl lbl_801C5DB4
/* 801C5D70 001C1BB0  38 7F 00 0C */	addi r3, r31, 0xc
/* 801C5D74 001C1BB4  48 00 00 41 */	bl lbl_801C5DB4
...
/* 801C5D84 001C1BC4  3C 60 80 46 */	lis r3, lbl_8045BA30@ha
/* 801C5D88 001C1BC8  38 63 BA 30 */	addi r3, r3, lbl_8045BA30@l
/* 801C5D8C 001C1BCC  38 80 00 31 */	li r4, 0x31
/* 801C5D90 001C1BD0  3C A0 80 46 */	lis r5, lbl_8045BA40@ha
/* 801C5D94 001C1BD4  38 A5 BA 40 */	addi r5, r5, lbl_8045BA40@l
/* 801C5D98 001C1BD8  4C C6 31 82 */	crclr 4*cr1+eq
/* 801C5D9C 001C1BDC  48 00 02 09 */	bl lbl_801C5FA4
.global lbl_801C5DA0
lbl_801C5DA0:
...
/* 801C5DD4 001C1C14  3C 60 80 46 */	lis r3, lbl_8045BC88@ha
/* 801C5DD8 001C1C18  38 63 BC 88 */	addi r3, r3, lbl_8045BC88@l
/* 801C5DDC 001C1C1C  38 80 00 2E */	li r4, 0x2e
/* 801C5DE0 001C1C20  3C A0 80 46 */	lis r5, lbl_8045BC74@ha
/* 801C5DE4 001C1C24  38 A5 BC 74 */	addi r5, r5, lbl_8045BC74@l
/* 801C5DE8 001C1C28  4C C6 31 82 */	crclr 4*cr1+eq
/* 801C5DEC 001C1C2C  48 00 01 B9 */	bl lbl_801C5FA4
.global lbl_801C5DF0
lbl_801C5DF0:
...
/* 801C5DFC 001C1C3C  3C 60 80 46 */	lis r3, lbl_8045BC60@ha
/* 801C5E00 001C1C40  38 63 BC 60 */	addi r3, r3, lbl_8045BC60@l
/* 801C5E04 001C1C44  38 80 00 2F */	li r4, 0x2f
/* 801C5E08 001C1C48  3C A0 80 46 */	lis r5, lbl_8045BC4C@ha
/* 801C5E0C 001C1C4C  38 A5 BC 4C */	addi r5, r5, lbl_8045BC4C@l
/* 801C5E10 001C1C50  4C C6 31 82 */	crclr 4*cr1+eq
/* 801C5E14 001C1C54  48 00 01 91 */	bl lbl_801C5FA4
.global lbl_801C5E18
lbl_801C5E18:
...
/* 801C5E48 001C1C88  3C 80 80 46 */	lis r4, lbl_8045BA30@ha
/* 801C5E4C 001C1C8C  3B E4 BA 30 */	addi r31, r4, lbl_8045BA30@l
/* 801C5E50 001C1C90  48 00 00 69 */	bl lbl_801C5EB8
...
/* 801C5E60 001C1CA0  4B E4 74 D9 */	bl lbl_8000D338
...
/* 801C5EBC 001C1CFC  3C 60 80 46 */	lis r3, lbl_8045BB18@ha
/* 801C5EC0 001C1D00  38 63 BB 18 */	addi r3, r3, lbl_8045BB18@l
...
/* 801C5EF4 001C1D34  3C 60 80 46 */	lis r3, lbl_8045BC38@ha
/* 801C5EF8 001C1D38  38 63 BC 38 */	addi r3, r3, lbl_8045BC38@l
/* 801C5EFC 001C1D3C  38 80 00 28 */	li r4, 0x28
/* 801C5F00 001C1D40  3C A0 80 46 */	lis r5, lbl_8045BC24@ha
/* 801C5F04 001C1D44  38 A5 BC 24 */	addi r5, r5, lbl_8045BC24@l
/* 801C5F08 001C1D48  4C C6 31 82 */	crclr 4*cr1+eq
/* 801C5F0C 001C1D4C  48 00 00 99 */	bl lbl_801C5FA4
.global lbl_801C5F10
lbl_801C5F10:
...
/* 801C5F60 001C1DA0  3C 60 80 46 */	lis r3, lbl_8045BC10@ha
/* 801C5F64 001C1DA4  38 63 BC 10 */	addi r3, r3, lbl_8045BC10@l
/* 801C5F68 001C1DA8  38 80 00 22 */	li r4, 0x22
/* 801C5F6C 001C1DAC  3C A0 80 46 */	lis r5, lbl_8045BBFC@ha
/* 801C5F70 001C1DB0  38 A5 BB FC */	addi r5, r5, lbl_8045BBFC@l
/* 801C5F74 001C1DB4  4C C6 31 82 */	crclr 4*cr1+eq
/* 801C5F78 001C1DB8  48 00 00 2D */	bl lbl_801C5FA4
.global lbl_801C5F7C
lbl_801C5F7C:
