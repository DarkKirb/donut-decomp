...
lbl_801C5FE4:
/* 801C5FE4 001C1E24  90 61 00 08 */	stw r3, 8(r1)
...
/* 801C6018 001C1E58  38 01 00 08 */	addi r0, r1, 8
...
/* 801C6028 001C1E68  3C 60 80 46 */	lis r3, $$249097@ha
/* 801C602C 001C1E6C  38 63 BC A0 */	addi r3, r3, $$249097@l
/* 801C6030 001C1E70  7F C4 F3 78 */	mr r4, r30
/* 801C6034 001C1E74  7F E5 FB 78 */	mr r5, r31
/* 801C6038 001C1E78  4C C6 31 82 */	crclr 6
...
/* 801C6068 001C1EA8  48 00 00 21 */	bl Instance__Q26mintvm41ExplicitSingleton$$0Q26mintvm11MintSetting$$1Fv
...
.global Instance__Q26mintvm41ExplicitSingleton$$0Q26mintvm11MintSetting$$1Fv
Instance__Q26mintvm41ExplicitSingleton$$0Q26mintvm11MintSetting$$1Fv:
...
/* 801C6094 001C1ED4  80 0D EE A0 */	lwz r0, object___Q26mintvm41ExplicitSingleton$$0Q26mintvm11MintSetting$$1-_SDA_BASE_(r13)
/* 801C6098 001C1ED8  2C 00 00 00 */	cmpwi r0, 0
/* 801C609C 001C1EDC  40 82 00 20 */	bne lbl_801C60BC
/* 801C60A0 001C1EE0  3C 60 80 46 */	lis r3, $$2STRING$$2Instance__Q26mintvm41ExplicitSingleton$$0Q26mintvm11MintSetting$$1Fv@ha
/* 801C60A4 001C1EE4  38 63 9D F4 */	addi r3, r3, $$2STRING$$2Instance__Q26mintvm41ExplicitSingleton$$0Q26mintvm11MintSetting$$1Fv@l
/* 801C60A8 001C1EE8  38 80 00 21 */	li r4, 0x21
/* 801C60AC 001C1EEC  3C A0 80 46 */	lis r5, $$2STRING$$2Instance__Q26mintvm41ExplicitSingleton$$0Q26mintvm11MintSetting$$1Fv$$20@ha
/* 801C60B0 001C1EF0  38 A5 9D E0 */	addi r5, r5, $$2STRING$$2Instance__Q26mintvm41ExplicitSingleton$$0Q26mintvm11MintSetting$$1Fv$$20@l
/* 801C60B4 001C1EF4  4C C6 31 82 */	crclr 6
/* 801C60B8 001C1EF8  4B FF FE ED */	bl panic__Q26mintvm14MintSystemCallFPCciPCce
lbl_801C60BC:
/* 801C60BC 001C1EFC  80 6D EE A0 */	lwz r3, object___Q26mintvm41ExplicitSingleton$$0Q26mintvm11MintSetting$$1-_SDA_BASE_(r13)
...
/* 801C60E0 001C1F20  4B E4 12 65 */	bl func_80007344
/* 801C60E4 001C1F24  7C 7D 1B 78 */	mr r29, r3
/* 801C60E8 001C1F28  7C 9E 23 78 */	mr r30, r4
/* 801C60EC 001C1F2C  7C BF 2B 78 */	mr r31, r5
/* 801C60F0 001C1F30  4B FF FF 99 */	bl Instance__Q26mintvm41ExplicitSingleton$$0Q26mintvm11MintSetting$$1Fv
...
/* 801C6110 001C1F50  2C 1D 00 01 */	cmpwi r29, 1
...
/* 801C6120 001C1F60  4B E4 12 71 */	bl func_80007390
