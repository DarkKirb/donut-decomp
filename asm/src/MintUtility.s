...
/* 8034BF2C 00347D6C  F3 E1 00 28 */	psq_st f31, 40(r1), 0, qr0
...
/* 8034C004 00347E44  38 61 00 08 */	addi r3, r1, 8
/* 8034C008 00347E48  4B F2 36 AD */	bl pos__Q43scn4step5chara8LocationCFv
/* 8034C00C 00347E4C  38 61 00 08 */	addi r3, r1, 8
...
/* 8034C03C 00347E7C  38 61 00 08 */	addi r3, r1, 8
/* 8034C040 00347E80  4B E5 00 7D */	bl getDirection3__Q24gobj6TargetCFv
/* 8034C044 00347E84  38 61 00 08 */	addi r3, r1, 8
...
/* 8034C0D4 00347F14  2C 03 00 00 */	cmpwi r3, 0
/* 8034C0D8 00347F18  41 82 00 0C */	beq lbl_8034C0E4
/* 8034C0DC 00347F1C  C0 22 CD 88 */	lfs f1, $$259354-_SDA2_BASE_(r2)
/* 8034C0E0 00347F20  48 00 00 08 */	b lbl_8034C0E8
lbl_8034C0E4:
/* 8034C0E4 00347F24  C0 22 CD 8C */	lfs f1, $$259355-_SDA2_BASE_(r2)
lbl_8034C0E8:
...
/* 8034C114 00347F54  90 A1 00 08 */	stw r5, 8(r1)
...
/* 8034C12C 00347F6C  2C 03 00 00 */	cmpwi r3, 0
/* 8034C130 00347F70  41 82 00 0C */	beq lbl_8034C13C
/* 8034C134 00347F74  38 00 00 00 */	li r0, 0
...
/* 8034C14C 00347F8C  38 00 00 01 */	li r0, 1
lbl_8034C150:
/* 8034C150 00347F90  2C 00 00 00 */	cmpwi r0, 0
/* 8034C154 00347F94  41 82 00 10 */	beq lbl_8034C164
/* 8034C158 00347F98  38 61 00 08 */	addi r3, r1, 8
/* 8034C15C 00347F9C  4B E5 20 A9 */	bl restruct__Q43hel4math10Direction32UpFv
/* 8034C160 00347FA0  48 00 00 14 */	b lbl_8034C174
lbl_8034C164:
/* 8034C164 00347FA4  38 61 00 08 */	addi r3, r1, 8
...
/* 8034C1E8 00348028  93 E1 00 08 */	stw r31, 8(r1)
...
/* 8034C204 00348044  2C 03 00 00 */	cmpwi r3, 0
/* 8034C208 00348048  41 82 00 0C */	beq lbl_8034C214
/* 8034C20C 0034804C  38 00 00 00 */	li r0, 0
...
/* 8034C338 00348178  98 01 00 08 */	stb r0, 8(r1)
/* 8034C33C 0034817C  88 03 00 49 */	lbz r0, 0x49(r3)
/* 8034C340 00348180  98 01 00 09 */	stb r0, 9(r1)
...
/* 8034C3F4 00348234  80 63 00 08 */	lwz r3, 8(r3)
/* 8034C3F8 00348238  30 03 FF FF */	addic r0, r3, -1
...
/* 8034C57C 003483BC  38 A0 00 00 */	li r5, 0
...
/* 8034C594 003483D4  4B CB AD 11 */	bl func_800072A4
/* 8034C598 003483D8  39 61 00 78 */	addi r11, r1, 0x78
/* 8034C59C 003483DC  4B CB AD A9 */	bl func_80007344
...
/* 8034C5E8 00348428  4B E2 FF FD */	bl isLink__Q24util51ObjListNode$$0Q23g3d5Model$$4Q24util16ObjListDummyType$$1CFv
/* 8034C5EC 0034842C  2C 03 00 00 */	cmpwi r3, 0
/* 8034C5F0 00348430  41 82 00 0C */	beq lbl_8034C5FC
/* 8034C5F4 00348434  38 61 00 34 */	addi r3, r1, 0x34
/* 8034C5F8 00348438  4B E2 FF FD */	bl unlink__Q24util51ObjListNode$$0Q23g3d5Model$$4Q24util16ObjListDummyType$$1Fv
lbl_8034C5FC:
/* 8034C5FC 0034843C  38 00 00 00 */	li r0, 0
/* 8034C600 00348440  90 01 00 40 */	stw r0, 0x40(r1)
/* 8034C604 00348444  80 01 00 2C */	lwz r0, 0x2c(r1)
/* 8034C608 00348448  2C 00 00 00 */	cmpwi r0, 0
...
/* 8034C618 00348458  4B E2 FF CD */	bl isLink__Q24util51ObjListNode$$0Q23g3d5Model$$4Q24util16ObjListDummyType$$1CFv
/* 8034C61C 0034845C  2C 03 00 00 */	cmpwi r3, 0
...
/* 8034C62C 0034846C  38 1F 00 04 */	addi r0, r31, 4
/* 8034C630 00348470  90 01 00 08 */	stw r0, 8(r1)
/* 8034C634 00348474  38 61 00 34 */	addi r3, r1, 0x34
/* 8034C638 00348478  4B E3 00 09 */	bl GetNodeFromPointer__Q34nw4r2ut72LinkList$$0Q24util51ObjListNode$$0Q23g3d5Model$$4Q24util16ObjListDummyType$$1$$40$$1FPQ24util51ObjListNode$$0Q23g3d5Model$$4Q24util16ObjListDummyType$$1
/* 8034C63C 0034847C  7C 65 1B 78 */	mr r5, r3
/* 8034C640 00348480  7F E3 FB 78 */	mr r3, r31
/* 8034C644 00348484  38 81 00 08 */	addi r4, r1, 8
...
/* 8034C658 00348498  38 80 FF FF */	li r4, -1
...
/* 8034C69C 003484DC  57 C0 06 3E */	clrlwi r0, r30, 0x18
...
/* 8034C6AC 003484EC  38 63 00 08 */	addi r3, r3, 8
...
/* 8034C718 00348558  38 61 00 08 */	addi r3, r1, 8
...
/* 8034C72C 0034856C  38 A1 00 08 */	addi r5, r1, 8
/* 8034C730 00348570  4B F2 19 E9 */	bl requestN__Q43scn4step5chara6EffectFQ43scn4step6effect4KindRCQ23g3d12NodeAccessor
/* 8034C734 00348574  38 61 00 08 */	addi r3, r1, 8
/* 8034C738 00348578  38 80 FF FF */	li r4, -1
...
/* 8034C78C 003485CC  38 61 00 08 */	addi r3, r1, 8
...
/* 8034C7A0 003485E0  38 A1 00 08 */	addi r5, r1, 8
...
/* 8034C7AC 003485EC  38 61 00 08 */	addi r3, r1, 8
/* 8034C7B0 003485F0  38 80 FF FF */	li r4, -1
...
/* 8034C80C 0034864C  38 61 00 08 */	addi r3, r1, 8
...
/* 8034C820 00348660  38 C1 00 08 */	addi r6, r1, 8
...
/* 8034C82C 0034866C  38 80 FF FF */	li r4, -1
...
/* 8034C88C 003486CC  38 61 00 08 */	addi r3, r1, 8
...
/* 8034C8A0 003486E0  38 C1 00 08 */	addi r6, r1, 8
...
/* 8034C8B0 003486F0  38 80 FF FF */	li r4, -1
...
/* 8034C900 00348740  38 61 00 08 */	addi r3, r1, 8
...
/* 8034C91C 0034875C  38 A1 00 08 */	addi r5, r1, 8
...
/* 8034C928 00348768  38 61 00 08 */	addi r3, r1, 8
/* 8034C92C 0034876C  38 80 FF FF */	li r4, -1
...
/* 8034C980 003487C0  38 61 00 08 */	addi r3, r1, 8
...
/* 8034C99C 003487DC  38 A1 00 08 */	addi r5, r1, 8
...
/* 8034C9AC 003487EC  38 61 00 08 */	addi r3, r1, 8
/* 8034C9B0 003487F0  38 80 FF FF */	li r4, -1
...
/* 8034CA0C 0034884C  38 61 00 08 */	addi r3, r1, 8
...
/* 8034CA2C 0034886C  38 E1 00 08 */	addi r7, r1, 8
...
/* 8034CA38 00348878  38 80 FF FF */	li r4, -1
...
/* 8034CA98 003488D8  38 61 00 08 */	addi r3, r1, 8
...
/* 8034CAB8 003488F8  38 E1 00 08 */	addi r7, r1, 8
...
/* 8034CAC8 00348908  38 80 FF FF */	li r4, -1
