...
/* 80191F3C 0018DD7C  98 03 00 02 */	stb r0, 0x2(r3)
/* 80191F40 0018DD80  98 03 00 03 */	stb r0, 0x3(r3)
/* 80191F44 0018DD84  98 03 00 04 */	stb r0, 0x4(r3)
/* 80191F48 0018DD88  98 03 00 05 */	stb r0, 0x5(r3)
/* 80191F4C 0018DD8C  98 03 00 06 */	stb r0, 0x6(r3)
/* 80191F50 0018DD90  98 03 00 07 */	stb r0, 0x7(r3)
/* 80191F54 0018DD94  98 03 00 08 */	stb r0, 0x8(r3)
/* 80191F58 0018DD98  98 03 00 09 */	stb r0, 0x9(r3)
...
/* 80191FC0 0018DE00  54 00 07 BC */	rlwinm r0, r0, 0, 30, 30
/* 80191FC4 0018DE04  7C 80 03 78 */	or r0, r4, r0
/* 80191FC8 0018DE08  88 83 00 02 */	lbz r4, 0x2(r3)
/* 80191FCC 0018DE0C  20 84 00 00 */	subfic r4, r4, 0x0
/* 80191FD0 0018DE10  7C 84 21 10 */	subfe r4, r4, r4
/* 80191FD4 0018DE14  54 84 07 7A */	rlwinm r4, r4, 0, 29, 29
/* 80191FD8 0018DE18  7C 00 23 78 */	or r0, r0, r4
/* 80191FDC 0018DE1C  88 83 00 03 */	lbz r4, 0x3(r3)
/* 80191FE0 0018DE20  20 84 00 00 */	subfic r4, r4, 0x0
/* 80191FE4 0018DE24  7C 84 21 10 */	subfe r4, r4, r4
/* 80191FE8 0018DE28  54 84 07 38 */	rlwinm r4, r4, 0, 28, 28
/* 80191FEC 0018DE2C  7C 00 23 78 */	or r0, r0, r4
/* 80191FF0 0018DE30  88 83 00 04 */	lbz r4, 0x4(r3)
/* 80191FF4 0018DE34  20 84 00 00 */	subfic r4, r4, 0x0
/* 80191FF8 0018DE38  7C 84 21 10 */	subfe r4, r4, r4
/* 80191FFC 0018DE3C  54 84 06 F6 */	rlwinm r4, r4, 0, 27, 27
/* 80192000 0018DE40  7C 00 23 78 */	or r0, r0, r4
/* 80192004 0018DE44  88 83 00 05 */	lbz r4, 0x5(r3)
/* 80192008 0018DE48  20 84 00 00 */	subfic r4, r4, 0x0
/* 8019200C 0018DE4C  7C 84 21 10 */	subfe r4, r4, r4
/* 80192010 0018DE50  54 84 06 B4 */	rlwinm r4, r4, 0, 26, 26
/* 80192014 0018DE54  7C 00 23 78 */	or r0, r0, r4
/* 80192018 0018DE58  88 83 00 06 */	lbz r4, 0x6(r3)
/* 8019201C 0018DE5C  20 84 00 00 */	subfic r4, r4, 0x0
/* 80192020 0018DE60  7C 84 21 10 */	subfe r4, r4, r4
/* 80192024 0018DE64  54 84 06 72 */	rlwinm r4, r4, 0, 25, 25
/* 80192028 0018DE68  7C 00 23 78 */	or r0, r0, r4
/* 8019202C 0018DE6C  88 83 00 07 */	lbz r4, 0x7(r3)
/* 80192030 0018DE70  20 84 00 00 */	subfic r4, r4, 0x0
/* 80192034 0018DE74  7C 84 21 10 */	subfe r4, r4, r4
/* 80192038 0018DE78  54 84 06 30 */	rlwinm r4, r4, 0, 24, 24
/* 8019203C 0018DE7C  7C 00 23 78 */	or r0, r0, r4
/* 80192040 0018DE80  88 83 00 08 */	lbz r4, 0x8(r3)
/* 80192044 0018DE84  20 84 00 00 */	subfic r4, r4, 0x0
/* 80192048 0018DE88  7C 84 21 10 */	subfe r4, r4, r4
/* 8019204C 0018DE8C  54 84 05 EE */	rlwinm r4, r4, 0, 23, 23
/* 80192050 0018DE90  7C 00 23 78 */	or r0, r0, r4
/* 80192054 0018DE94  88 83 00 09 */	lbz r4, 0x9(r3)
/* 80192058 0018DE98  20 84 00 00 */	subfic r4, r4, 0x0
/* 8019205C 0018DE9C  7C 84 21 10 */	subfe r4, r4, r4
/* 80192060 0018DEA0  54 84 05 AC */	rlwinm r4, r4, 0, 22, 22
/* 80192064 0018DEA4  7C 00 23 78 */	or r0, r0, r4
/* 80192068 0018DEA8  88 83 00 0A */	lbz r4, 0xa(r3)
/* 8019206C 0018DEAC  20 84 00 00 */	subfic r4, r4, 0x0
/* 80192070 0018DEB0  7C 84 21 10 */	subfe r4, r4, r4
/* 80192074 0018DEB4  54 84 05 6A */	rlwinm r4, r4, 0, 21, 21
/* 80192078 0018DEB8  7C 00 23 78 */	or r0, r0, r4
/* 8019207C 0018DEBC  88 83 00 0B */	lbz r4, 0xb(r3)
/* 80192080 0018DEC0  20 84 00 00 */	subfic r4, r4, 0x0
/* 80192084 0018DEC4  7C 84 21 10 */	subfe r4, r4, r4
/* 80192088 0018DEC8  54 84 05 28 */	rlwinm r4, r4, 0, 20, 20
/* 8019208C 0018DECC  7C 00 23 78 */	or r0, r0, r4
/* 80192090 0018DED0  88 83 00 0C */	lbz r4, 0xc(r3)
/* 80192094 0018DED4  20 84 00 00 */	subfic r4, r4, 0x0
/* 80192098 0018DED8  7C 84 21 10 */	subfe r4, r4, r4
/* 8019209C 0018DEDC  54 84 04 E6 */	rlwinm r4, r4, 0, 19, 19
/* 801920A0 0018DEE0  7C 00 23 78 */	or r0, r0, r4
/* 801920A4 0018DEE4  88 83 00 0D */	lbz r4, 0xd(r3)
/* 801920A8 0018DEE8  20 84 00 00 */	subfic r4, r4, 0x0
/* 801920AC 0018DEEC  7C 84 21 10 */	subfe r4, r4, r4
/* 801920B0 0018DEF0  54 84 04 A4 */	rlwinm r4, r4, 0, 18, 18
/* 801920B4 0018DEF4  7C 00 23 78 */	or r0, r0, r4
/* 801920B8 0018DEF8  88 83 00 0E */	lbz r4, 0xe(r3)
/* 801920BC 0018DEFC  20 84 00 00 */	subfic r4, r4, 0x0
/* 801920C0 0018DF00  7C 84 21 10 */	subfe r4, r4, r4
/* 801920C4 0018DF04  54 84 04 62 */	rlwinm r4, r4, 0, 17, 17
/* 801920C8 0018DF08  7C 00 23 78 */	or r0, r0, r4
/* 801920CC 0018DF0C  88 63 00 0F */	lbz r3, 0xf(r3)
/* 801920D0 0018DF10  20 63 00 00 */	subfic r3, r3, 0x0
