...
/* 802A2DB8 0029EBF8  3C 60 80 47 */	lis r3, lbl_80475100@ha
/* 802A2DBC 0029EBFC  3B C3 51 00 */	addi r30, r3, lbl_80475100@l
/* 802A2DC0 0029EC00  3B 8D B4 38 */	addi r28, r13, lbl_80559858@sda21
/* 802A2DC4 0029EC04  3B BE 01 10 */	addi r29, r30, 0x110
/* 802A2DC8 0029EC08  88 0D F5 D0 */	lbz r0, lbl_8055D9F0@sda21(r13)
...
/* 802A2DD8 0029EC18  3C 60 80 55 */	lis r3, lbl_80550050@ha
/* 802A2DDC 0029EC1C  38 63 00 50 */	addi r3, r3, lbl_80550050@l
/* 802A2DE0 0029EC20  4B FC E7 31 */	bl lbl_80271510
/* 802A2DE4 0029EC24  38 00 00 01 */	li r0, 0x1
/* 802A2DE8 0029EC28  98 0D F5 D0 */	stb r0, lbl_8055D9F0@sda21(r13)
.global lbl_802A2DEC
lbl_802A2DEC:
/* 802A2DEC 0029EC2C  3C 60 80 42 */	lis r3, lbl_804186A0@ha
/* 802A2DF0 0029EC30  38 03 86 A0 */	addi r0, r3, lbl_804186A0@l
...
/* 802A2E08 0029EC48  3F E0 80 55 */	lis r31, lbl_80550050@ha
/* 802A2E0C 0029EC4C  38 7F 00 50 */	addi r3, r31, lbl_80550050@l
/* 802A2E10 0029EC50  3C 80 80 55 */	lis r4, lbl_805500D0@ha
/* 802A2E14 0029EC54  38 84 00 D0 */	addi r4, r4, lbl_805500D0@l
/* 802A2E18 0029EC58  3C A0 80 55 */	lis r5, lbl_805500DC@ha
/* 802A2E1C 0029EC5C  38 A5 00 DC */	addi r5, r5, lbl_805500DC@l
...
/* 802A2E34 0029EC74  4B FE 7F A9 */	bl lbl_8028ADDC
...
.global lbl_802A2E54
lbl_802A2E54:
/* 802A2E54 0029EC94  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802A2E58 0029EC98  3C 60 80 47 */	lis r3, lbl_80475148@ha
/* 802A2E5C 0029EC9C  90 03 51 48 */	stw r0, lbl_80475148@l(r3)
/* 802A2E60 0029ECA0  38 63 51 48 */	addi r3, r3, 0x5148
/* 802A2E64 0029ECA4  90 03 00 14 */	stw r0, 0x14(r3)
/* 802A2E68 0029ECA8  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
