...
/* 802A5594 002A13D4  3C 60 80 47 */	lis r3, lbl_804754A8@ha
/* 802A5598 002A13D8  3B E3 54 A8 */	addi r31, r3, lbl_804754A8@l
/* 802A559C 002A13DC  3B BF 00 E0 */	addi r29, r31, 0xe0
/* 802A55A0 002A13E0  3B DF 00 EC */	addi r30, r31, 0xec
/* 802A55A4 002A13E4  88 0D F5 E0 */	lbz r0, lbl_8055DA00@sda21(r13)
...
/* 802A55B4 002A13F4  3C 60 80 55 */	lis r3, lbl_80550180@ha
/* 802A55B8 002A13F8  38 63 01 80 */	addi r3, r3, lbl_80550180@l
/* 802A55BC 002A13FC  4B FC BF 55 */	bl lbl_80271510
/* 802A55C0 002A1400  38 00 00 01 */	li r0, 0x1
/* 802A55C4 002A1404  98 0D F5 E0 */	stb r0, lbl_8055DA00@sda21(r13)
.global lbl_802A55C8
lbl_802A55C8:
/* 802A55C8 002A1408  3C 60 80 42 */	lis r3, lbl_804186F8@ha
/* 802A55CC 002A140C  38 03 86 F8 */	addi r0, r3, lbl_804186F8@l
...
/* 802A55E4 002A1424  3F E0 80 55 */	lis r31, lbl_80550180@ha
/* 802A55E8 002A1428  38 7F 01 80 */	addi r3, r31, lbl_80550180@l
/* 802A55EC 002A142C  3C 80 80 55 */	lis r4, lbl_80550200@ha
/* 802A55F0 002A1430  38 84 02 00 */	addi r4, r4, lbl_80550200@l
/* 802A55F4 002A1434  3C A0 80 55 */	lis r5, lbl_8055020C@ha
/* 802A55F8 002A1438  38 A5 02 0C */	addi r5, r5, lbl_8055020C@l
/* 802A55FC 002A143C  7F C6 F3 78 */	mr r6, r30
/* 802A5600 002A1440  7F A7 EB 78 */	mr r7, r29
/* 802A5604 002A1444  39 00 00 02 */	li r8, 0x2
/* 802A5608 002A1448  39 2D B4 60 */	addi r9, r13, lbl_80559880@sda21
/* 802A560C 002A144C  39 40 00 09 */	li r10, 0x9
/* 802A5610 002A1450  4B FE 57 CD */	bl lbl_8028ADDC
...
.global lbl_802A5630
lbl_802A5630:
/* 802A5630 002A1470  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802A5634 002A1474  3C 60 80 47 */	lis r3, lbl_804754C0@ha
/* 802A5638 002A1478  90 03 54 C0 */	stw r0, lbl_804754C0@l(r3)
...
/* 802A564C 002A148C  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
