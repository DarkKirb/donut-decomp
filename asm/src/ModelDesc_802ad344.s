...
/* 802AD358 002A9198  3B AD B5 50 */	addi r29, r13, lbl_80559970@sda21
/* 802AD35C 002A919C  3C 60 80 47 */	lis r3, lbl_80476048@ha
/* 802AD360 002A91A0  3B C3 60 48 */	addi r30, r3, lbl_80476048@l
/* 802AD364 002A91A4  88 0D F6 08 */	lbz r0, lbl_8055DA28@sda21(r13)
...
/* 802AD374 002A91B4  3C 60 80 55 */	lis r3, lbl_80550348@ha
/* 802AD378 002A91B8  38 63 03 48 */	addi r3, r3, lbl_80550348@l
/* 802AD37C 002A91BC  4B FC 41 95 */	bl lbl_80271510
/* 802AD380 002A91C0  38 00 00 01 */	li r0, 0x1
/* 802AD384 002A91C4  98 0D F6 08 */	stb r0, lbl_8055DA28@sda21(r13)
.global lbl_802AD388
lbl_802AD388:
/* 802AD388 002A91C8  3C 60 80 42 */	lis r3, lbl_804187C8@ha
/* 802AD38C 002A91CC  38 03 87 C8 */	addi r0, r3, lbl_804187C8@l
...
/* 802AD39C 002A91DC  3C 60 80 47 */	lis r3, lbl_80475F58@ha
/* 802AD3A0 002A91E0  38 03 5F 58 */	addi r0, r3, lbl_80475F58@l
/* 802AD3A4 002A91E4  90 01 00 10 */	stw r0, 0x10(r1)
/* 802AD3A8 002A91E8  3F E0 80 55 */	lis r31, lbl_80550348@ha
/* 802AD3AC 002A91EC  38 7F 03 48 */	addi r3, r31, lbl_80550348@l
/* 802AD3B0 002A91F0  3C 80 80 55 */	lis r4, lbl_805503C8@ha
/* 802AD3B4 002A91F4  38 84 03 C8 */	addi r4, r4, lbl_805503C8@l
/* 802AD3B8 002A91F8  3C A0 80 55 */	lis r5, lbl_805503D4@ha
/* 802AD3BC 002A91FC  38 A5 03 D4 */	addi r5, r5, lbl_805503D4@l
/* 802AD3C0 002A9200  7F C6 F3 78 */	mr r6, r30
/* 802AD3C4 002A9204  7F A7 EB 78 */	mr r7, r29
/* 802AD3C8 002A9208  39 00 00 01 */	li r8, 0x1
/* 802AD3CC 002A920C  39 2D B5 18 */	addi r9, r13, lbl_80559938@sda21
/* 802AD3D0 002A9210  39 40 00 08 */	li r10, 0x8
/* 802AD3D4 002A9214  4B FD DA 09 */	bl lbl_8028ADDC
...
.global lbl_802AD3F4
lbl_802AD3F4:
/* 802AD3F4 002A9234  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802AD3F8 002A9238  3C 60 80 47 */	lis r3, lbl_80475F58@ha
/* 802AD3FC 002A923C  38 63 5F 58 */	addi r3, r3, lbl_80475F58@l
/* 802AD400 002A9240  90 03 00 50 */	stw r0, 0x50(r3)
/* 802AD404 002A9244  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
