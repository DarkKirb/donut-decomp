...
/* 802B49DC 002B081C  3C 60 80 47 */	lis r3, lbl_80476D80@ha
/* 802B49E0 002B0820  3B C3 6D 80 */	addi r30, r3, lbl_80476D80@l
/* 802B49E4 002B0824  3B 8D B6 68 */	addi r28, r13, lbl_80559A88@sda21
/* 802B49E8 002B0828  3B BE 00 E4 */	addi r29, r30, 0xe4
/* 802B49EC 002B082C  88 0D F6 30 */	lbz r0, lbl_8055DA50@sda21(r13)
...
/* 802B49FC 002B083C  3C 60 80 55 */	lis r3, lbl_805506E0@ha
/* 802B4A00 002B0840  38 63 06 E0 */	addi r3, r3, lbl_805506E0@l
/* 802B4A04 002B0844  4B FB CB 0D */	bl lbl_80271510
/* 802B4A08 002B0848  38 00 00 01 */	li r0, 0x1
/* 802B4A0C 002B084C  98 0D F6 30 */	stb r0, lbl_8055DA50@sda21(r13)
.global lbl_802B4A10
lbl_802B4A10:
/* 802B4A10 002B0850  3C 60 80 42 */	lis r3, lbl_80418898@ha
/* 802B4A14 002B0854  38 03 88 98 */	addi r0, r3, lbl_80418898@l
...
/* 802B4A2C 002B086C  3F E0 80 55 */	lis r31, lbl_805506E0@ha
/* 802B4A30 002B0870  38 7F 06 E0 */	addi r3, r31, lbl_805506E0@l
/* 802B4A34 002B0874  3C 80 80 55 */	lis r4, lbl_80550760@ha
/* 802B4A38 002B0878  38 84 07 60 */	addi r4, r4, lbl_80550760@l
/* 802B4A3C 002B087C  3C A0 80 55 */	lis r5, lbl_8055076C@ha
/* 802B4A40 002B0880  38 A5 07 6C */	addi r5, r5, lbl_8055076C@l
...
/* 802B4A58 002B0898  4B FD 63 85 */	bl lbl_8028ADDC
...
.global lbl_802B4A78
lbl_802B4A78:
/* 802B4A78 002B08B8  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802B4A7C 002B08BC  3C 60 80 47 */	lis r3, lbl_80476DB0@ha
/* 802B4A80 002B08C0  90 03 6D B0 */	stw r0, lbl_80476DB0@l(r3)
/* 802B4A84 002B08C4  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
