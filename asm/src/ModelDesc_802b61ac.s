...
/* 802B61C0 002B2000  3C 60 80 47 */	lis r3, lbl_80476FD8@ha
/* 802B61C4 002B2004  3B C3 6F D8 */	addi r30, r3, lbl_80476FD8@l
/* 802B61C8 002B2008  3B 8D B6 B8 */	addi r28, r13, lbl_80559AD8@sda21
/* 802B61CC 002B200C  3B BE 01 08 */	addi r29, r30, 0x108
/* 802B61D0 002B2010  88 0D F6 38 */	lbz r0, lbl_8055DA58@sda21(r13)
...
/* 802B61E0 002B2020  3C 60 80 55 */	lis r3, lbl_80550778@ha
/* 802B61E4 002B2024  38 63 07 78 */	addi r3, r3, lbl_80550778@l
/* 802B61E8 002B2028  4B FB B3 29 */	bl lbl_80271510
/* 802B61EC 002B202C  38 00 00 01 */	li r0, 0x1
/* 802B61F0 002B2030  98 0D F6 38 */	stb r0, lbl_8055DA58@sda21(r13)
.global lbl_802B61F4
lbl_802B61F4:
/* 802B61F4 002B2034  3C 60 80 42 */	lis r3, lbl_804188C0@ha
/* 802B61F8 002B2038  38 03 88 C0 */	addi r0, r3, lbl_804188C0@l
...
/* 802B6210 002B2050  3F E0 80 55 */	lis r31, lbl_80550778@ha
/* 802B6214 002B2054  38 7F 07 78 */	addi r3, r31, lbl_80550778@l
/* 802B6218 002B2058  3C 80 80 55 */	lis r4, lbl_805507F8@ha
/* 802B621C 002B205C  38 84 07 F8 */	addi r4, r4, lbl_805507F8@l
/* 802B6220 002B2060  3C A0 80 55 */	lis r5, lbl_80550804@ha
/* 802B6224 002B2064  38 A5 08 04 */	addi r5, r5, lbl_80550804@l
...
/* 802B623C 002B207C  4B FD 4B A1 */	bl lbl_8028ADDC
...
.global lbl_802B625C
lbl_802B625C:
/* 802B625C 002B209C  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802B6260 002B20A0  3C 60 80 47 */	lis r3, lbl_80477040@ha
/* 802B6264 002B20A4  90 03 70 40 */	stw r0, lbl_80477040@l(r3)
/* 802B6268 002B20A8  38 63 70 40 */	addi r3, r3, 0x7040
/* 802B626C 002B20AC  90 03 00 14 */	stw r0, 0x14(r3)
/* 802B6270 002B20B0  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
