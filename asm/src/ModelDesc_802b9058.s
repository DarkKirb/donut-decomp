...
/* 802B906C 002B4EAC  3B AD B7 48 */	addi r29, r13, lbl_80559B68@sda21
/* 802B9070 002B4EB0  3C 60 80 47 */	lis r3, lbl_8047763C@ha
/* 802B9074 002B4EB4  3B C3 76 3C */	addi r30, r3, lbl_8047763C@l
/* 802B9078 002B4EB8  88 0D F6 48 */	lbz r0, lbl_8055DA68@sda21(r13)
...
/* 802B9088 002B4EC8  3C 60 80 55 */	lis r3, lbl_805509D8@ha
/* 802B908C 002B4ECC  38 63 09 D8 */	addi r3, r3, lbl_805509D8@l
/* 802B9090 002B4ED0  4B FB 84 81 */	bl lbl_80271510
/* 802B9094 002B4ED4  38 00 00 01 */	li r0, 0x1
/* 802B9098 002B4ED8  98 0D F6 48 */	stb r0, lbl_8055DA68@sda21(r13)
.global lbl_802B909C
lbl_802B909C:
/* 802B909C 002B4EDC  3C 60 80 42 */	lis r3, lbl_80418918@ha
/* 802B90A0 002B4EE0  38 03 89 18 */	addi r0, r3, lbl_80418918@l
...
/* 802B90B0 002B4EF0  3C 60 80 47 */	lis r3, lbl_804775B0@ha
/* 802B90B4 002B4EF4  38 03 75 B0 */	addi r0, r3, lbl_804775B0@l
/* 802B90B8 002B4EF8  90 01 00 10 */	stw r0, 0x10(r1)
/* 802B90BC 002B4EFC  3F E0 80 55 */	lis r31, lbl_805509D8@ha
/* 802B90C0 002B4F00  38 7F 09 D8 */	addi r3, r31, lbl_805509D8@l
/* 802B90C4 002B4F04  3C 80 80 55 */	lis r4, lbl_80550A58@ha
/* 802B90C8 002B4F08  38 84 0A 58 */	addi r4, r4, lbl_80550A58@l
/* 802B90CC 002B4F0C  3C A0 80 55 */	lis r5, lbl_80550A64@ha
/* 802B90D0 002B4F10  38 A5 0A 64 */	addi r5, r5, lbl_80550A64@l
/* 802B90D4 002B4F14  7F C6 F3 78 */	mr r6, r30
/* 802B90D8 002B4F18  7F A7 EB 78 */	mr r7, r29
/* 802B90DC 002B4F1C  39 00 00 02 */	li r8, 0x2
/* 802B90E0 002B4F20  39 2D B7 38 */	addi r9, r13, lbl_80559B58@sda21
/* 802B90E4 002B4F24  39 40 00 06 */	li r10, 0x6
/* 802B90E8 002B4F28  4B FD 1C F5 */	bl lbl_8028ADDC
...
.global lbl_802B9108
lbl_802B9108:
/* 802B9108 002B4F48  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802B910C 002B4F4C  3C 60 80 47 */	lis r3, lbl_804775B0@ha
/* 802B9110 002B4F50  90 03 75 B0 */	stw r0, lbl_804775B0@l(r3)
/* 802B9114 002B4F54  38 63 75 B0 */	addi r3, r3, 0x75b0
/* 802B9118 002B4F58  90 03 00 14 */	stw r0, 0x14(r3)
/* 802B911C 002B4F5C  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
