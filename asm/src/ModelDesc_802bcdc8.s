...
/* 802BCDDC 002B8C1C  3B AD B8 30 */	addi r29, r13, lbl_80559C50@sda21
/* 802BCDE0 002B8C20  3C 60 80 48 */	lis r3, lbl_80478130@ha
/* 802BCDE4 002B8C24  3B C3 81 30 */	addi r30, r3, lbl_80478130@l
/* 802BCDE8 002B8C28  88 0D F6 60 */	lbz r0, lbl_8055DA80@sda21(r13)
...
/* 802BCDF8 002B8C38  3C 60 80 55 */	lis r3, lbl_80550BA0@ha
/* 802BCDFC 002B8C3C  38 63 0B A0 */	addi r3, r3, lbl_80550BA0@l
/* 802BCE00 002B8C40  4B FB 47 11 */	bl lbl_80271510
/* 802BCE04 002B8C44  38 00 00 01 */	li r0, 0x1
/* 802BCE08 002B8C48  98 0D F6 60 */	stb r0, lbl_8055DA80@sda21(r13)
.global lbl_802BCE0C
lbl_802BCE0C:
/* 802BCE0C 002B8C4C  3C 60 80 42 */	lis r3, lbl_804189B8@ha
/* 802BCE10 002B8C50  38 03 89 B8 */	addi r0, r3, lbl_804189B8@l
...
/* 802BCE20 002B8C60  3C 60 80 48 */	lis r3, lbl_80478018@ha
/* 802BCE24 002B8C64  38 03 80 18 */	addi r0, r3, lbl_80478018@l
/* 802BCE28 002B8C68  90 01 00 10 */	stw r0, 0x10(r1)
/* 802BCE2C 002B8C6C  3F E0 80 55 */	lis r31, lbl_80550BA0@ha
/* 802BCE30 002B8C70  38 7F 0B A0 */	addi r3, r31, lbl_80550BA0@l
/* 802BCE34 002B8C74  3C 80 80 55 */	lis r4, lbl_80550C20@ha
/* 802BCE38 002B8C78  38 84 0C 20 */	addi r4, r4, lbl_80550C20@l
/* 802BCE3C 002B8C7C  3C A0 80 55 */	lis r5, lbl_80550C2C@ha
/* 802BCE40 002B8C80  38 A5 0C 2C */	addi r5, r5, lbl_80550C2C@l
/* 802BCE44 002B8C84  7F C6 F3 78 */	mr r6, r30
/* 802BCE48 002B8C88  7F A7 EB 78 */	mr r7, r29
/* 802BCE4C 002B8C8C  39 00 00 02 */	li r8, 0x2
/* 802BCE50 002B8C90  39 2D B7 E8 */	addi r9, r13, lbl_80559C08@sda21
/* 802BCE54 002B8C94  39 40 00 0B */	li r10, 0xb
/* 802BCE58 002B8C98  4B FC DF 85 */	bl lbl_8028ADDC
...
.global lbl_802BCE78
lbl_802BCE78:
/* 802BCE78 002B8CB8  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802BCE7C 002B8CBC  3C 60 80 48 */	lis r3, lbl_80478018@ha
/* 802BCE80 002B8CC0  90 03 80 18 */	stw r0, lbl_80478018@l(r3)
/* 802BCE84 002B8CC4  38 63 80 18 */	addi r3, r3, -0x7fe8
/* 802BCE88 002B8CC8  90 03 00 14 */	stw r0, 0x14(r3)
/* 802BCE8C 002B8CCC  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
