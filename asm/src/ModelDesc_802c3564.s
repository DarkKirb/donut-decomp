...
/* 802C3578 002BF3B8  3B AD B9 18 */	addi r29, r13, lbl_80559D38@sda21
/* 802C357C 002BF3BC  3C 60 80 48 */	lis r3, lbl_80478F10@ha
/* 802C3580 002BF3C0  3B C3 8F 10 */	addi r30, r3, lbl_80478F10@l
/* 802C3584 002BF3C4  88 0D F6 88 */	lbz r0, lbl_8055DAA8@sda21(r13)
...
/* 802C3594 002BF3D4  3C 60 80 55 */	lis r3, lbl_80550F30@ha
/* 802C3598 002BF3D8  38 63 0F 30 */	addi r3, r3, lbl_80550F30@l
/* 802C359C 002BF3DC  4B FA DF 75 */	bl lbl_80271510
/* 802C35A0 002BF3E0  38 00 00 01 */	li r0, 0x1
/* 802C35A4 002BF3E4  98 0D F6 88 */	stb r0, lbl_8055DAA8@sda21(r13)
.global lbl_802C35A8
lbl_802C35A8:
/* 802C35A8 002BF3E8  3C 60 80 42 */	lis r3, lbl_80418B30@ha
/* 802C35AC 002BF3EC  38 03 8B 30 */	addi r0, r3, lbl_80418B30@l
...
/* 802C35BC 002BF3FC  3C 60 80 48 */	lis r3, lbl_80478E70@ha
/* 802C35C0 002BF400  38 03 8E 70 */	addi r0, r3, lbl_80478E70@l
/* 802C35C4 002BF404  90 01 00 10 */	stw r0, 0x10(r1)
/* 802C35C8 002BF408  3F E0 80 55 */	lis r31, lbl_80550F30@ha
/* 802C35CC 002BF40C  38 7F 0F 30 */	addi r3, r31, lbl_80550F30@l
/* 802C35D0 002BF410  3C 80 80 55 */	lis r4, lbl_80550FB0@ha
/* 802C35D4 002BF414  38 84 0F B0 */	addi r4, r4, lbl_80550FB0@l
/* 802C35D8 002BF418  3C A0 80 55 */	lis r5, lbl_80550FBC@ha
/* 802C35DC 002BF41C  38 A5 0F BC */	addi r5, r5, lbl_80550FBC@l
/* 802C35E0 002BF420  7F C6 F3 78 */	mr r6, r30
/* 802C35E4 002BF424  7F A7 EB 78 */	mr r7, r29
/* 802C35E8 002BF428  39 00 00 01 */	li r8, 0x1
/* 802C35EC 002BF42C  39 2D B8 E8 */	addi r9, r13, lbl_80559D08@sda21
/* 802C35F0 002BF430  39 40 00 07 */	li r10, 0x7
/* 802C35F4 002BF434  4B FC 77 E9 */	bl lbl_8028ADDC
...
.global lbl_802C3614
lbl_802C3614:
/* 802C3614 002BF454  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802C3618 002BF458  3C 60 80 48 */	lis r3, lbl_80478E70@ha
/* 802C361C 002BF45C  90 03 8E 70 */	stw r0, lbl_80478E70@l(r3)
/* 802C3620 002BF460  38 63 8E 70 */	addi r3, r3, -0x7190
/* 802C3624 002BF464  90 03 00 14 */	stw r0, 0x14(r3)
/* 802C3628 002BF468  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
