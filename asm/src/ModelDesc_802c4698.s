...
/* 802C46AC 002C04EC  3C 60 80 48 */	lis r3, lbl_80479040@ha
/* 802C46B0 002C04F0  3B A3 90 40 */	addi r29, r3, lbl_80479040@l
/* 802C46B4 002C04F4  3C 60 80 48 */	lis r3, lbl_8047904C@ha
/* 802C46B8 002C04F8  3B C3 90 4C */	addi r30, r3, lbl_8047904C@l
/* 802C46BC 002C04FC  88 0D F6 90 */	lbz r0, lbl_8055DAB0@sda21(r13)
...
/* 802C46CC 002C050C  3C 60 80 55 */	lis r3, lbl_80550FC8@ha
/* 802C46D0 002C0510  38 63 0F C8 */	addi r3, r3, lbl_80550FC8@l
/* 802C46D4 002C0514  4B FA CE 3D */	bl lbl_80271510
/* 802C46D8 002C0518  38 00 00 01 */	li r0, 0x1
/* 802C46DC 002C051C  98 0D F6 90 */	stb r0, lbl_8055DAB0@sda21(r13)
.global lbl_802C46E0
lbl_802C46E0:
...
/* 802C46F0 002C0530  3C 60 80 42 */	lis r3, lbl_80418B68@ha
/* 802C46F4 002C0534  38 03 8B 68 */	addi r0, r3, lbl_80418B68@l
/* 802C46F8 002C0538  90 01 00 10 */	stw r0, 0x10(r1)
/* 802C46FC 002C053C  3C 60 80 55 */	lis r3, lbl_80550FC8@ha
/* 802C4700 002C0540  38 63 0F C8 */	addi r3, r3, lbl_80550FC8@l
/* 802C4704 002C0544  3C 80 80 55 */	lis r4, lbl_80551048@ha
/* 802C4708 002C0548  38 84 10 48 */	addi r4, r4, lbl_80551048@l
/* 802C470C 002C054C  3C A0 80 55 */	lis r5, lbl_80551054@ha
/* 802C4710 002C0550  38 A5 10 54 */	addi r5, r5, lbl_80551054@l
/* 802C4714 002C0554  7F C6 F3 78 */	mr r6, r30
/* 802C4718 002C0558  7F A7 EB 78 */	mr r7, r29
/* 802C471C 002C055C  39 00 00 01 */	li r8, 0x1
/* 802C4720 002C0560  39 2D B9 28 */	addi r9, r13, lbl_80559D48@sda21
/* 802C4724 002C0564  39 40 00 00 */	li r10, 0x0
/* 802C4728 002C0568  4B FC 66 B5 */	bl lbl_8028ADDC
/* 802C472C 002C056C  38 8D B9 2C */	addi r4, r13, lbl_80559D4C@sda21
...
/* 802C4750 002C0590  4B ED 92 6D */	bl lbl_8019D9BC
/* 802C4754 002C0594  3C 60 80 55 */	lis r3, lbl_80550FC8@ha
/* 802C4758 002C0598  38 63 0F C8 */	addi r3, r3, lbl_80550FC8@l
...
/* 802C4780 002C05C0  3C 60 80 55 */	lis r3, lbl_80550FC8@ha
/* 802C4784 002C05C4  38 63 0F C8 */	addi r3, r3, lbl_80550FC8@l
