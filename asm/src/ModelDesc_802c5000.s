...
/* 802C5014 002C0E54  3B AD B9 60 */	addi r29, r13, lbl_80559D80@sda21
/* 802C5018 002C0E58  3C 60 80 48 */	lis r3, lbl_80479260@ha
/* 802C501C 002C0E5C  3B C3 92 60 */	addi r30, r3, lbl_80479260@l
/* 802C5020 002C0E60  88 0D F6 98 */	lbz r0, lbl_8055DAB8@sda21(r13)
...
/* 802C5030 002C0E70  3C 60 80 55 */	lis r3, lbl_80551060@ha
/* 802C5034 002C0E74  38 63 10 60 */	addi r3, r3, lbl_80551060@l
/* 802C5038 002C0E78  4B FA C4 D9 */	bl lbl_80271510
/* 802C503C 002C0E7C  38 00 00 01 */	li r0, 0x1
/* 802C5040 002C0E80  98 0D F6 98 */	stb r0, lbl_8055DAB8@sda21(r13)
.global lbl_802C5044
lbl_802C5044:
/* 802C5044 002C0E84  3C 60 80 42 */	lis r3, lbl_80418BF8@ha
/* 802C5048 002C0E88  38 03 8B F8 */	addi r0, r3, lbl_80418BF8@l
...
/* 802C5058 002C0E98  3C 60 80 48 */	lis r3, lbl_80479184@ha
/* 802C505C 002C0E9C  38 03 91 84 */	addi r0, r3, lbl_80479184@l
/* 802C5060 002C0EA0  90 01 00 10 */	stw r0, 0x10(r1)
/* 802C5064 002C0EA4  3F E0 80 55 */	lis r31, lbl_80551060@ha
/* 802C5068 002C0EA8  38 7F 10 60 */	addi r3, r31, lbl_80551060@l
/* 802C506C 002C0EAC  3C 80 80 55 */	lis r4, lbl_805510E0@ha
/* 802C5070 002C0EB0  38 84 10 E0 */	addi r4, r4, lbl_805510E0@l
/* 802C5074 002C0EB4  3C A0 80 55 */	lis r5, lbl_805510EC@ha
/* 802C5078 002C0EB8  38 A5 10 EC */	addi r5, r5, lbl_805510EC@l
/* 802C507C 002C0EBC  7F C6 F3 78 */	mr r6, r30
/* 802C5080 002C0EC0  7F A7 EB 78 */	mr r7, r29
/* 802C5084 002C0EC4  39 00 00 01 */	li r8, 0x1
/* 802C5088 002C0EC8  39 2D B9 40 */	addi r9, r13, lbl_80559D60@sda21
/* 802C508C 002C0ECC  39 40 00 07 */	li r10, 0x7
/* 802C5090 002C0ED0  4B FC 5D 4D */	bl lbl_8028ADDC
...
.global lbl_802C50B0
lbl_802C50B0:
/* 802C50B0 002C0EF0  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802C50B4 002C0EF4  3C 60 80 48 */	lis r3, lbl_80479184@ha
/* 802C50B8 002C0EF8  90 03 91 84 */	stw r0, lbl_80479184@l(r3)
...
/* 802C50CC 002C0F0C  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
