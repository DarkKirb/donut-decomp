...
/* 802C6218 002C2058  3C 60 80 48 */	lis r3, lbl_80479338@ha
/* 802C621C 002C205C  3B C3 93 38 */	addi r30, r3, lbl_80479338@l
/* 802C6220 002C2060  3B 9E 01 10 */	addi r28, r30, 0x110
/* 802C6224 002C2064  3B BE 01 1C */	addi r29, r30, 0x11c
/* 802C6228 002C2068  88 0D F6 A0 */	lbz r0, lbl_8055DAC0@sda21(r13)
...
/* 802C6238 002C2078  3C 60 80 55 */	lis r3, lbl_805510F8@ha
/* 802C623C 002C207C  38 63 10 F8 */	addi r3, r3, lbl_805510F8@l
/* 802C6240 002C2080  4B FA B2 D1 */	bl lbl_80271510
/* 802C6244 002C2084  38 00 00 01 */	li r0, 0x1
/* 802C6248 002C2088  98 0D F6 A0 */	stb r0, lbl_8055DAC0@sda21(r13)
.global lbl_802C624C
lbl_802C624C:
/* 802C624C 002C208C  3C 60 80 42 */	lis r3, lbl_80418C30@ha
/* 802C6250 002C2090  38 03 8C 30 */	addi r0, r3, lbl_80418C30@l
...
/* 802C6268 002C20A8  3F E0 80 55 */	lis r31, lbl_805510F8@ha
/* 802C626C 002C20AC  38 7F 10 F8 */	addi r3, r31, lbl_805510F8@l
/* 802C6270 002C20B0  3C 80 80 55 */	lis r4, lbl_80551178@ha
/* 802C6274 002C20B4  38 84 11 78 */	addi r4, r4, lbl_80551178@l
/* 802C6278 002C20B8  3C A0 80 55 */	lis r5, lbl_80551184@ha
/* 802C627C 002C20BC  38 A5 11 84 */	addi r5, r5, lbl_80551184@l
...
/* 802C6294 002C20D4  4B FC 4B 49 */	bl lbl_8028ADDC
...
.global lbl_802C62B4
lbl_802C62B4:
/* 802C62B4 002C20F4  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802C62B8 002C20F8  3C 60 80 48 */	lis r3, lbl_804793A8@ha
/* 802C62BC 002C20FC  90 03 93 A8 */	stw r0, lbl_804793A8@l(r3)
/* 802C62C0 002C2100  38 63 93 A8 */	addi r3, r3, -0x6c58
/* 802C62C4 002C2104  90 03 00 14 */	stw r0, 0x14(r3)
/* 802C62C8 002C2108  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
