...
/* 802C7340 002C3180  3B AD B9 E8 */	addi r29, r13, lbl_80559E08@sda21
/* 802C7344 002C3184  3C 60 80 48 */	lis r3, lbl_80479608@ha
/* 802C7348 002C3188  3B C3 96 08 */	addi r30, r3, lbl_80479608@l
/* 802C734C 002C318C  88 0D F6 A8 */	lbz r0, lbl_8055DAC8@sda21(r13)
...
/* 802C735C 002C319C  3C 60 80 55 */	lis r3, lbl_80551190@ha
/* 802C7360 002C31A0  38 63 11 90 */	addi r3, r3, lbl_80551190@l
/* 802C7364 002C31A4  4B FA A1 AD */	bl lbl_80271510
/* 802C7368 002C31A8  38 00 00 01 */	li r0, 0x1
/* 802C736C 002C31AC  98 0D F6 A8 */	stb r0, lbl_8055DAC8@sda21(r13)
.global lbl_802C7370
lbl_802C7370:
/* 802C7370 002C31B0  3C 60 80 42 */	lis r3, lbl_80418C78@ha
/* 802C7374 002C31B4  38 03 8C 78 */	addi r0, r3, lbl_80418C78@l
...
/* 802C7384 002C31C4  3C 60 80 48 */	lis r3, lbl_8047957C@ha
/* 802C7388 002C31C8  38 03 95 7C */	addi r0, r3, lbl_8047957C@l
/* 802C738C 002C31CC  90 01 00 10 */	stw r0, 0x10(r1)
/* 802C7390 002C31D0  3F E0 80 55 */	lis r31, lbl_80551190@ha
/* 802C7394 002C31D4  38 7F 11 90 */	addi r3, r31, lbl_80551190@l
/* 802C7398 002C31D8  3C 80 80 55 */	lis r4, lbl_80551210@ha
/* 802C739C 002C31DC  38 84 12 10 */	addi r4, r4, lbl_80551210@l
/* 802C73A0 002C31E0  3C A0 80 55 */	lis r5, lbl_8055121C@ha
/* 802C73A4 002C31E4  38 A5 12 1C */	addi r5, r5, lbl_8055121C@l
/* 802C73A8 002C31E8  7F C6 F3 78 */	mr r6, r30
/* 802C73AC 002C31EC  7F A7 EB 78 */	mr r7, r29
/* 802C73B0 002C31F0  39 00 00 01 */	li r8, 0x1
/* 802C73B4 002C31F4  39 2D B9 B8 */	addi r9, r13, lbl_80559DD8@sda21
/* 802C73B8 002C31F8  39 40 00 06 */	li r10, 0x6
/* 802C73BC 002C31FC  4B FC 3A 21 */	bl lbl_8028ADDC
...
.global lbl_802C73DC
lbl_802C73DC:
/* 802C73DC 002C321C  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802C73E0 002C3220  3C 60 80 48 */	lis r3, lbl_8047957C@ha
/* 802C73E4 002C3224  90 03 95 7C */	stw r0, lbl_8047957C@l(r3)
/* 802C73E8 002C3228  38 63 95 7C */	addi r3, r3, -0x6a84
/* 802C73EC 002C322C  90 03 00 14 */	stw r0, 0x14(r3)
/* 802C73F0 002C3230  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
