...
/* 802C7E14 002C3C54  3C 60 80 48 */	lis r3, lbl_804797C8@ha
/* 802C7E18 002C3C58  3B C3 97 C8 */	addi r30, r3, lbl_804797C8@l
/* 802C7E1C 002C3C5C  3B 8D BA 20 */	addi r28, r13, lbl_80559E40@sda21
/* 802C7E20 002C3C60  3B BE 01 68 */	addi r29, r30, 0x168
/* 802C7E24 002C3C64  88 0D F6 B0 */	lbz r0, lbl_8055DAD0@sda21(r13)
...
/* 802C7E34 002C3C74  3C 60 80 55 */	lis r3, lbl_80551228@ha
/* 802C7E38 002C3C78  38 63 12 28 */	addi r3, r3, lbl_80551228@l
/* 802C7E3C 002C3C7C  4B FA 96 D5 */	bl lbl_80271510
/* 802C7E40 002C3C80  38 00 00 01 */	li r0, 0x1
/* 802C7E44 002C3C84  98 0D F6 B0 */	stb r0, lbl_8055DAD0@sda21(r13)
.global lbl_802C7E48
lbl_802C7E48:
/* 802C7E48 002C3C88  3C 60 80 42 */	lis r3, lbl_80418CA8@ha
/* 802C7E4C 002C3C8C  38 03 8C A8 */	addi r0, r3, lbl_80418CA8@l
...
/* 802C7E64 002C3CA4  3F E0 80 55 */	lis r31, lbl_80551228@ha
/* 802C7E68 002C3CA8  38 7F 12 28 */	addi r3, r31, lbl_80551228@l
/* 802C7E6C 002C3CAC  3C 80 80 55 */	lis r4, lbl_805512A8@ha
/* 802C7E70 002C3CB0  38 84 12 A8 */	addi r4, r4, lbl_805512A8@l
/* 802C7E74 002C3CB4  3C A0 80 55 */	lis r5, lbl_805512B4@ha
/* 802C7E78 002C3CB8  38 A5 12 B4 */	addi r5, r5, lbl_805512B4@l
...
/* 802C7E90 002C3CD0  4B FC 2F 4D */	bl lbl_8028ADDC
...
.global lbl_802C7EB0
lbl_802C7EB0:
/* 802C7EB0 002C3CF0  80 0D 89 E4 */	lwz r0, lbl_80556E04@sda21(r13)
/* 802C7EB4 002C3CF4  3C 60 80 48 */	lis r3, lbl_80479868@ha
/* 802C7EB8 002C3CF8  90 03 98 68 */	stw r0, lbl_80479868@l(r3)
/* 802C7EBC 002C3CFC  80 8D 89 E0 */	lwz r4, lbl_80556E00@sda21(r13)
