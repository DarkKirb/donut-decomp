...
/* 802C9F2C 002C5D6C  3B AD BA 44 */	addi r29, r13, lbl_80559E64@sda21
/* 802C9F30 002C5D70  3C 60 80 48 */	lis r3, lbl_80479D00@ha
/* 802C9F34 002C5D74  3B C3 9D 00 */	addi r30, r3, lbl_80479D00@l
/* 802C9F38 002C5D78  88 0D F6 B8 */	lbz r0, lbl_8055DAD8@sda21(r13)
...
/* 802C9F48 002C5D88  3C 60 80 55 */	lis r3, lbl_805512C0@ha
/* 802C9F4C 002C5D8C  38 63 12 C0 */	addi r3, r3, lbl_805512C0@l
/* 802C9F50 002C5D90  4B FA 75 C1 */	bl lbl_80271510
/* 802C9F54 002C5D94  38 00 00 01 */	li r0, 0x1
/* 802C9F58 002C5D98  98 0D F6 B8 */	stb r0, lbl_8055DAD8@sda21(r13)
.global lbl_802C9F5C
lbl_802C9F5C:
/* 802C9F5C 002C5D9C  3C 60 80 42 */	lis r3, lbl_80418CD8@ha
/* 802C9F60 002C5DA0  38 03 8C D8 */	addi r0, r3, lbl_80418CD8@l
...
/* 802C9F70 002C5DB0  3C 60 80 48 */	lis r3, lbl_80479C38@ha
/* 802C9F74 002C5DB4  38 03 9C 38 */	addi r0, r3, lbl_80479C38@l
/* 802C9F78 002C5DB8  90 01 00 10 */	stw r0, 0x10(r1)
/* 802C9F7C 002C5DBC  3F E0 80 55 */	lis r31, lbl_805512C0@ha
/* 802C9F80 002C5DC0  38 7F 12 C0 */	addi r3, r31, lbl_805512C0@l
/* 802C9F84 002C5DC4  3C 80 80 55 */	lis r4, lbl_80551340@ha
/* 802C9F88 002C5DC8  38 84 13 40 */	addi r4, r4, lbl_80551340@l
/* 802C9F8C 002C5DCC  3C A0 80 55 */	lis r5, lbl_8055134C@ha
/* 802C9F90 002C5DD0  38 A5 13 4C */	addi r5, r5, lbl_8055134C@l
/* 802C9F94 002C5DD4  7F C6 F3 78 */	mr r6, r30
/* 802C9F98 002C5DD8  7F A7 EB 78 */	mr r7, r29
/* 802C9F9C 002C5DDC  39 00 00 02 */	li r8, 0x2
/* 802C9FA0 002C5DE0  39 2D BA 30 */	addi r9, r13, lbl_80559E50@sda21
/* 802C9FA4 002C5DE4  39 40 00 06 */	li r10, 0x6
/* 802C9FA8 002C5DE8  4B FC 0E 35 */	bl lbl_8028ADDC
...
.global lbl_802C9FC8
lbl_802C9FC8:
/* 802C9FC8 002C5E08  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802C9FCC 002C5E0C  3C 60 80 48 */	lis r3, lbl_80479C38@ha
/* 802C9FD0 002C5E10  90 03 9C 38 */	stw r0, lbl_80479C38@l(r3)
/* 802C9FD4 002C5E14  38 63 9C 38 */	addi r3, r3, -0x63c8
/* 802C9FD8 002C5E18  90 03 00 14 */	stw r0, 0x14(r3)
/* 802C9FDC 002C5E1C  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
