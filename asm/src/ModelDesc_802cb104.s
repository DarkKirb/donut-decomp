...
/* 802CB118 002C6F58  3C 60 80 48 */	lis r3, lbl_80479E10@ha
/* 802CB11C 002C6F5C  3B C3 9E 10 */	addi r30, r3, lbl_80479E10@l
/* 802CB120 002C6F60  3B 8D BA 78 */	addi r28, r13, lbl_80559E98@sda21
/* 802CB124 002C6F64  3B BE 01 1C */	addi r29, r30, 0x11c
/* 802CB128 002C6F68  88 0D F6 C0 */	lbz r0, lbl_8055DAE0@sda21(r13)
...
/* 802CB138 002C6F78  3C 60 80 55 */	lis r3, lbl_80551358@ha
/* 802CB13C 002C6F7C  38 63 13 58 */	addi r3, r3, lbl_80551358@l
/* 802CB140 002C6F80  4B FA 63 D1 */	bl lbl_80271510
/* 802CB144 002C6F84  38 00 00 01 */	li r0, 0x1
/* 802CB148 002C6F88  98 0D F6 C0 */	stb r0, lbl_8055DAE0@sda21(r13)
.global lbl_802CB14C
lbl_802CB14C:
/* 802CB14C 002C6F8C  3C 60 80 42 */	lis r3, lbl_80418D08@ha
/* 802CB150 002C6F90  38 03 8D 08 */	addi r0, r3, lbl_80418D08@l
...
/* 802CB168 002C6FA8  3F E0 80 55 */	lis r31, lbl_80551358@ha
/* 802CB16C 002C6FAC  38 7F 13 58 */	addi r3, r31, lbl_80551358@l
/* 802CB170 002C6FB0  3C 80 80 55 */	lis r4, lbl_805513D8@ha
/* 802CB174 002C6FB4  38 84 13 D8 */	addi r4, r4, lbl_805513D8@l
/* 802CB178 002C6FB8  3C A0 80 55 */	lis r5, lbl_805513E4@ha
/* 802CB17C 002C6FBC  38 A5 13 E4 */	addi r5, r5, lbl_805513E4@l
...
/* 802CB194 002C6FD4  4B FB FC 49 */	bl lbl_8028ADDC
...
.global lbl_802CB1B4
lbl_802CB1B4:
/* 802CB1B4 002C6FF4  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802CB1B8 002C6FF8  3C 60 80 48 */	lis r3, lbl_80479E50@ha
/* 802CB1BC 002C6FFC  90 03 9E 50 */	stw r0, lbl_80479E50@l(r3)
/* 802CB1C0 002C7000  38 63 9E 50 */	addi r3, r3, -0x61b0
/* 802CB1C4 002C7004  90 03 00 14 */	stw r0, 0x14(r3)
/* 802CB1C8 002C7008  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
