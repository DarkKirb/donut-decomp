...
/* 802D1D44 002CDB84  3C 60 80 48 */	lis r3, lbl_8047A780@ha
/* 802D1D48 002CDB88  3B E3 A7 80 */	addi r31, r3, lbl_8047A780@l
/* 802D1D4C 002CDB8C  3B DF 00 CC */	addi r30, r31, 0xcc
/* 802D1D50 002CDB90  3B BF 00 D8 */	addi r29, r31, 0xd8
/* 802D1D54 002CDB94  88 0D F6 E0 */	lbz r0, lbl_8055DB00@sda21(r13)
...
/* 802D1D64 002CDBA4  3C 60 80 55 */	lis r3, lbl_80551570@ha
/* 802D1D68 002CDBA8  38 63 15 70 */	addi r3, r3, lbl_80551570@l
/* 802D1D6C 002CDBAC  4B F9 F7 A5 */	bl lbl_80271510
/* 802D1D70 002CDBB0  38 00 00 01 */	li r0, 0x1
/* 802D1D74 002CDBB4  98 0D F6 E0 */	stb r0, lbl_8055DB00@sda21(r13)
.global lbl_802D1D78
lbl_802D1D78:
/* 802D1D78 002CDBB8  3C 60 80 42 */	lis r3, lbl_80418D90@ha
/* 802D1D7C 002CDBBC  38 03 8D 90 */	addi r0, r3, lbl_80418D90@l
...
/* 802D1D94 002CDBD4  3F 80 80 55 */	lis r28, lbl_80551570@ha
/* 802D1D98 002CDBD8  38 7C 15 70 */	addi r3, r28, lbl_80551570@l
/* 802D1D9C 002CDBDC  3C 80 80 55 */	lis r4, lbl_805515F0@ha
/* 802D1DA0 002CDBE0  38 84 15 F0 */	addi r4, r4, lbl_805515F0@l
/* 802D1DA4 002CDBE4  3C A0 80 55 */	lis r5, lbl_805515FC@ha
/* 802D1DA8 002CDBE8  38 A5 15 FC */	addi r5, r5, lbl_805515FC@l
/* 802D1DAC 002CDBEC  7F A6 EB 78 */	mr r6, r29
/* 802D1DB0 002CDBF0  7F C7 F3 78 */	mr r7, r30
/* 802D1DB4 002CDBF4  39 00 00 02 */	li r8, 0x2
/* 802D1DB8 002CDBF8  39 2D BA D8 */	addi r9, r13, lbl_80559EF8@sda21
/* 802D1DBC 002CDBFC  39 40 00 07 */	li r10, 0x7
/* 802D1DC0 002CDC00  4B FB 90 1D */	bl lbl_8028ADDC
/* 802D1DC4 002CDC04  3B DC 15 70 */	addi r30, r28, 0x1570
/* 802D1DC8 002CDC08  88 0D F6 D0 */	lbz r0, lbl_8055DAF0@sda21(r13)
...
/* 802D1DD8 002CDC18  3C 60 80 55 */	lis r3, lbl_80551488@ha
/* 802D1DDC 002CDC1C  38 C3 14 88 */	addi r6, r3, lbl_80551488@l
/* 802D1DE0 002CDC20  38 60 00 00 */	li r3, 0x0
/* 802D1DE4 002CDC24  38 06 00 E4 */	addi r0, r6, 0xe4
/* 802D1DE8 002CDC28  C0 02 BF E8 */	lfs f0, lbl_80561F68@sda21(r2)
...
/* 802D1E20 002CDC60  98 0D F6 D0 */	stb r0, lbl_8055DAF0@sda21(r13)
.global lbl_802D1E24
lbl_802D1E24:
/* 802D1E24 002CDC64  C3 E2 BF EC */	lfs f31, lbl_80561F6C@sda21(r2)
/* 802D1E28 002CDC68  3F 80 80 55 */	lis r28, lbl_80551488@ha
/* 802D1E2C 002CDC6C  38 7C 14 88 */	addi r3, r28, lbl_80551488@l
/* 802D1E30 002CDC70  38 80 00 00 */	li r4, 0x0
/* 802D1E34 002CDC74  4B FC 54 51 */	bl lbl_80297284
/* 802D1E38 002CDC78  D3 E3 00 00 */	stfs f31, 0x0(r3)
/* 802D1E3C 002CDC7C  C0 22 BF F0 */	lfs f1, lbl_80561F70@sda21(r2)
/* 802D1E40 002CDC80  D0 21 00 08 */	stfs f1, 0x8(r1)
/* 802D1E44 002CDC84  38 61 00 18 */	addi r3, r1, 0x18
/* 802D1E48 002CDC88  C0 42 BF E8 */	lfs f2, lbl_80561F68@sda21(r2)
/* 802D1E4C 002CDC8C  FC 60 10 90 */	fmr f3, f2
/* 802D1E50 002CDC90  C0 82 BF F4 */	lfs f4, lbl_80561F74@sda21(r2)
/* 802D1E54 002CDC94  C0 A2 BF F8 */	lfs f5, lbl_80561F78@sda21(r2)
/* 802D1E58 002CDC98  C0 C2 BF FC */	lfs f6, lbl_80561F7C@sda21(r2)
/* 802D1E5C 002CDC9C  C0 E2 C0 00 */	lfs f7, lbl_80561F80@sda21(r2)
/* 802D1E60 002CDCA0  C1 02 C0 04 */	lfs f8, lbl_80561F84@sda21(r2)
/* 802D1E64 002CDCA4  4B FC 53 61 */	bl lbl_802971C4
/* 802D1E68 002CDCA8  38 7C 14 88 */	addi r3, r28, 0x1488
/* 802D1E6C 002CDCAC  38 80 00 00 */	li r4, 0x0
/* 802D1E70 002CDCB0  4B FC 54 15 */	bl lbl_80297284
/* 802D1E74 002CDCB4  38 80 00 00 */	li r4, 0x0
/* 802D1E78 002CDCB8  38 A1 00 18 */	addi r5, r1, 0x18
/* 802D1E7C 002CDCBC  4B FC 53 75 */	bl lbl_802971F0
/* 802D1E80 002CDCC0  C0 22 BF F0 */	lfs f1, lbl_80561F70@sda21(r2)
/* 802D1E84 002CDCC4  D0 21 00 08 */	stfs f1, 0x8(r1)
/* 802D1E88 002CDCC8  38 61 00 3C */	addi r3, r1, 0x3c
/* 802D1E8C 002CDCCC  C0 42 BF E8 */	lfs f2, lbl_80561F68@sda21(r2)
/* 802D1E90 002CDCD0  FC 60 10 90 */	fmr f3, f2
/* 802D1E94 002CDCD4  C0 82 C0 08 */	lfs f4, lbl_80561F88@sda21(r2)
/* 802D1E98 002CDCD8  C0 A2 BF F8 */	lfs f5, lbl_80561F78@sda21(r2)
/* 802D1E9C 002CDCDC  C0 C2 BF FC */	lfs f6, lbl_80561F7C@sda21(r2)
/* 802D1EA0 002CDCE0  C0 E2 C0 00 */	lfs f7, lbl_80561F80@sda21(r2)
/* 802D1EA4 002CDCE4  C1 02 C0 04 */	lfs f8, lbl_80561F84@sda21(r2)
/* 802D1EA8 002CDCE8  4B FC 53 1D */	bl lbl_802971C4
/* 802D1EAC 002CDCEC  38 7C 14 88 */	addi r3, r28, 0x1488
/* 802D1EB0 002CDCF0  38 80 00 00 */	li r4, 0x0
/* 802D1EB4 002CDCF4  4B FC 53 D1 */	bl lbl_80297284
/* 802D1EB8 002CDCF8  38 80 00 01 */	li r4, 0x1
/* 802D1EBC 002CDCFC  38 A1 00 3C */	addi r5, r1, 0x3c
/* 802D1EC0 002CDD00  4B FC 53 31 */	bl lbl_802971F0
/* 802D1EC4 002CDD04  C0 22 BF F0 */	lfs f1, lbl_80561F70@sda21(r2)
/* 802D1EC8 002CDD08  D0 21 00 08 */	stfs f1, 0x8(r1)
/* 802D1ECC 002CDD0C  38 61 00 60 */	addi r3, r1, 0x60
/* 802D1ED0 002CDD10  C0 42 BF E8 */	lfs f2, lbl_80561F68@sda21(r2)
/* 802D1ED4 002CDD14  FC 60 10 90 */	fmr f3, f2
/* 802D1ED8 002CDD18  C0 82 C0 0C */	lfs f4, lbl_80561F8C@sda21(r2)
/* 802D1EDC 002CDD1C  C0 A2 BF F8 */	lfs f5, lbl_80561F78@sda21(r2)
/* 802D1EE0 002CDD20  C0 C2 BF FC */	lfs f6, lbl_80561F7C@sda21(r2)
/* 802D1EE4 002CDD24  C0 E2 C0 00 */	lfs f7, lbl_80561F80@sda21(r2)
/* 802D1EE8 002CDD28  C1 02 C0 04 */	lfs f8, lbl_80561F84@sda21(r2)
/* 802D1EEC 002CDD2C  4B FC 52 D9 */	bl lbl_802971C4
/* 802D1EF0 002CDD30  38 7C 14 88 */	addi r3, r28, 0x1488
/* 802D1EF4 002CDD34  38 80 00 00 */	li r4, 0x0
/* 802D1EF8 002CDD38  4B FC 53 8D */	bl lbl_80297284
/* 802D1EFC 002CDD3C  38 80 00 02 */	li r4, 0x2
/* 802D1F00 002CDD40  38 A1 00 60 */	addi r5, r1, 0x60
/* 802D1F04 002CDD44  4B FC 52 ED */	bl lbl_802971F0
...
/* 802D1F14 002CDD54  4B FC 53 71 */	bl lbl_80297284
...
/* 802D1F44 002CDD84  4B EC BA 79 */	bl lbl_8019D9BC
/* 802D1F48 002CDD88  3C 60 80 55 */	lis r3, lbl_80551488@ha
/* 802D1F4C 002CDD8C  38 63 14 88 */	addi r3, r3, lbl_80551488@l
/* 802D1F50 002CDD90  38 80 00 00 */	li r4, 0x0
/* 802D1F54 002CDD94  4B FC 53 31 */	bl lbl_80297284
...
/* 802D1F80 002CDDC0  90 0D F6 D8 */	stw r0, lbl_8055DAF8@sda21(r13)
/* 802D1F84 002CDDC4  3C 60 80 55 */	lis r3, lbl_80551488@ha
/* 802D1F88 002CDDC8  38 03 14 88 */	addi r0, r3, lbl_80551488@l
/* 802D1F8C 002CDDCC  38 6D F6 D8 */	addi r3, r13, lbl_8055DAF8@sda21
...
.global lbl_802D1FC0
lbl_802D1FC0:
/* 802D1FC0 002CDE00  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802D1FC4 002CDE04  3C 60 80 48 */	lis r3, lbl_8047A798@ha
/* 802D1FC8 002CDE08  90 03 A7 98 */	stw r0, lbl_8047A798@l(r3)
/* 802D1FCC 002CDE0C  38 63 A7 98 */	addi r3, r3, -0x5868
/* 802D1FD0 002CDE10  90 03 00 14 */	stw r0, 0x14(r3)
/* 802D1FD4 002CDE14  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
