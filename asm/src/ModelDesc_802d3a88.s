...
/* 802D3A9C 002CF8DC  3C 60 80 48 */	lis r3, lbl_8047AC18@ha
/* 802D3AA0 002CF8E0  3B C3 AC 18 */	addi r30, r3, lbl_8047AC18@l
/* 802D3AA4 002CF8E4  3B 8D BB F0 */	addi r28, r13, lbl_8055A010@sda21
/* 802D3AA8 002CF8E8  3B BE 01 88 */	addi r29, r30, 0x188
/* 802D3AAC 002CF8EC  88 0D F6 F8 */	lbz r0, lbl_8055DB18@sda21(r13)
...
/* 802D3ABC 002CF8FC  3C 60 80 55 */	lis r3, lbl_80551738@ha
/* 802D3AC0 002CF900  38 63 17 38 */	addi r3, r3, lbl_80551738@l
/* 802D3AC4 002CF904  4B F9 DA 4D */	bl lbl_80271510
/* 802D3AC8 002CF908  38 00 00 01 */	li r0, 0x1
/* 802D3ACC 002CF90C  98 0D F6 F8 */	stb r0, lbl_8055DB18@sda21(r13)
.global lbl_802D3AD0
lbl_802D3AD0:
/* 802D3AD0 002CF910  3C 60 80 42 */	lis r3, lbl_80418E88@ha
/* 802D3AD4 002CF914  38 03 8E 88 */	addi r0, r3, lbl_80418E88@l
...
/* 802D3AEC 002CF92C  3F E0 80 55 */	lis r31, lbl_80551738@ha
/* 802D3AF0 002CF930  38 7F 17 38 */	addi r3, r31, lbl_80551738@l
/* 802D3AF4 002CF934  3C 80 80 55 */	lis r4, lbl_805517B8@ha
/* 802D3AF8 002CF938  38 84 17 B8 */	addi r4, r4, lbl_805517B8@l
/* 802D3AFC 002CF93C  3C A0 80 55 */	lis r5, lbl_805517C4@ha
/* 802D3B00 002CF940  38 A5 17 C4 */	addi r5, r5, lbl_805517C4@l
...
/* 802D3B18 002CF958  4B FB 72 C5 */	bl lbl_8028ADDC
...
.global lbl_802D3B38
lbl_802D3B38:
/* 802D3B38 002CF978  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802D3B3C 002CF97C  3C 60 80 48 */	lis r3, lbl_8047AC88@ha
/* 802D3B40 002CF980  90 03 AC 88 */	stw r0, lbl_8047AC88@l(r3)
/* 802D3B44 002CF984  38 63 AC 88 */	addi r3, r3, -0x5378
/* 802D3B48 002CF988  90 03 00 14 */	stw r0, 0x14(r3)
/* 802D3B4C 002CF98C  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
