...
/* 802D9D6C 002D5BAC  3C 60 80 48 */	lis r3, lbl_8047B480@ha
/* 802D9D70 002D5BB0  3B C3 B4 80 */	addi r30, r3, lbl_8047B480@l
/* 802D9D74 002D5BB4  3B 8D BC 78 */	addi r28, r13, lbl_8055A098@sda21
/* 802D9D78 002D5BB8  3B BE 01 60 */	addi r29, r30, 0x160
/* 802D9D7C 002D5BBC  88 0D F7 10 */	lbz r0, lbl_8055DB30@sda21(r13)
...
/* 802D9D8C 002D5BCC  3C 60 80 55 */	lis r3, lbl_805519A8@ha
/* 802D9D90 002D5BD0  38 63 19 A8 */	addi r3, r3, lbl_805519A8@l
/* 802D9D94 002D5BD4  4B F9 77 7D */	bl lbl_80271510
/* 802D9D98 002D5BD8  38 00 00 01 */	li r0, 0x1
/* 802D9D9C 002D5BDC  98 0D F7 10 */	stb r0, lbl_8055DB30@sda21(r13)
.global lbl_802D9DA0
lbl_802D9DA0:
/* 802D9DA0 002D5BE0  3C 60 80 42 */	lis r3, lbl_80419038@ha
/* 802D9DA4 002D5BE4  38 03 90 38 */	addi r0, r3, lbl_80419038@l
...
/* 802D9DBC 002D5BFC  3F E0 80 55 */	lis r31, lbl_805519A8@ha
/* 802D9DC0 002D5C00  38 7F 19 A8 */	addi r3, r31, lbl_805519A8@l
/* 802D9DC4 002D5C04  3C 80 80 55 */	lis r4, lbl_80551A28@ha
/* 802D9DC8 002D5C08  38 84 1A 28 */	addi r4, r4, lbl_80551A28@l
/* 802D9DCC 002D5C0C  3C A0 80 55 */	lis r5, lbl_80551A34@ha
/* 802D9DD0 002D5C10  38 A5 1A 34 */	addi r5, r5, lbl_80551A34@l
...
/* 802D9DE8 002D5C28  4B FB 0F F5 */	bl lbl_8028ADDC
/* 802D9DEC 002D5C2C  38 00 00 00 */	li r0, 0x0
/* 802D9DF0 002D5C30  3C 60 80 55 */	lis r3, lbl_80551998@ha
/* 802D9DF4 002D5C34  90 03 19 98 */	stw r0, lbl_80551998@l(r3)
...
/* 802D9E04 002D5C44  38 02 C1 58 */	addi r0, r2, lbl_805620D8@sda21
...
.global lbl_802D9E2C
lbl_802D9E2C:
/* 802D9E2C 002D5C6C  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802D9E30 002D5C70  3C 60 80 48 */	lis r3, lbl_8047B4DC@ha
/* 802D9E34 002D5C74  90 03 B4 DC */	stw r0, lbl_8047B4DC@l(r3)
...
/* 802D9E4C 002D5C8C  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
