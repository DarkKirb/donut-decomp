...
/* 802DBE04 002D7C44  3C 60 80 48 */	lis r3, lbl_8047B760@ha
/* 802DBE08 002D7C48  3B E3 B7 60 */	addi r31, r3, lbl_8047B760@l
/* 802DBE0C 002D7C4C  3B BF 00 D8 */	addi r29, r31, 0xd8
/* 802DBE10 002D7C50  3B DF 00 E4 */	addi r30, r31, 0xe4
/* 802DBE14 002D7C54  88 0D F7 18 */	lbz r0, lbl_8055DB38@sda21(r13)
...
/* 802DBE24 002D7C64  3C 60 80 55 */	lis r3, lbl_80551A40@ha
/* 802DBE28 002D7C68  38 63 1A 40 */	addi r3, r3, lbl_80551A40@l
/* 802DBE2C 002D7C6C  4B F9 56 E5 */	bl lbl_80271510
/* 802DBE30 002D7C70  38 00 00 01 */	li r0, 0x1
/* 802DBE34 002D7C74  98 0D F7 18 */	stb r0, lbl_8055DB38@sda21(r13)
.global lbl_802DBE38
lbl_802DBE38:
/* 802DBE38 002D7C78  3C 60 80 42 */	lis r3, lbl_80419078@ha
/* 802DBE3C 002D7C7C  38 03 90 78 */	addi r0, r3, lbl_80419078@l
...
/* 802DBE54 002D7C94  3F E0 80 55 */	lis r31, lbl_80551A40@ha
/* 802DBE58 002D7C98  38 7F 1A 40 */	addi r3, r31, lbl_80551A40@l
/* 802DBE5C 002D7C9C  3C 80 80 55 */	lis r4, lbl_80551AC0@ha
/* 802DBE60 002D7CA0  38 84 1A C0 */	addi r4, r4, lbl_80551AC0@l
/* 802DBE64 002D7CA4  3C A0 80 55 */	lis r5, lbl_80551ACC@ha
/* 802DBE68 002D7CA8  38 A5 1A CC */	addi r5, r5, lbl_80551ACC@l
/* 802DBE6C 002D7CAC  7F C6 F3 78 */	mr r6, r30
/* 802DBE70 002D7CB0  7F A7 EB 78 */	mr r7, r29
/* 802DBE74 002D7CB4  39 00 00 01 */	li r8, 0x1
/* 802DBE78 002D7CB8  39 2D BC 88 */	addi r9, r13, lbl_8055A0A8@sda21
/* 802DBE7C 002D7CBC  39 40 00 05 */	li r10, 0x5
/* 802DBE80 002D7CC0  4B FA EF 5D */	bl lbl_8028ADDC
...
.global lbl_802DBEA0
lbl_802DBEA0:
/* 802DBEA0 002D7CE0  80 8D 89 E0 */	lwz r4, lbl_80556E00@sda21(r13)
/* 802DBEA4 002D7CE4  3C 60 80 48 */	lis r3, lbl_8047B798@ha
/* 802DBEA8 002D7CE8  38 63 B7 98 */	addi r3, r3, lbl_8047B798@l
/* 802DBEAC 002D7CEC  90 83 00 50 */	stw r4, 0x50(r3)
/* 802DBEB0 002D7CF0  80 0D 89 E4 */	lwz r0, lbl_80556E04@sda21(r13)
