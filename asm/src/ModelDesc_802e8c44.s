...
/* 802E8C58 002E4A98  3C 60 80 48 */	lis r3, lbl_8047D3F0@ha
/* 802E8C5C 002E4A9C  3B C3 D3 F0 */	addi r30, r3, lbl_8047D3F0@l
/* 802E8C60 002E4AA0  3B 8D BE C8 */	addi r28, r13, lbl_8055A2E8@sda21
/* 802E8C64 002E4AA4  3B BE 00 C0 */	addi r29, r30, 0xc0
/* 802E8C68 002E4AA8  88 0D F7 60 */	lbz r0, lbl_8055DB80@sda21(r13)
...
/* 802E8C78 002E4AB8  3C 60 80 55 */	lis r3, lbl_80551F98@ha
/* 802E8C7C 002E4ABC  38 63 1F 98 */	addi r3, r3, lbl_80551F98@l
/* 802E8C80 002E4AC0  4B F8 88 91 */	bl lbl_80271510
/* 802E8C84 002E4AC4  38 00 00 01 */	li r0, 0x1
/* 802E8C88 002E4AC8  98 0D F7 60 */	stb r0, lbl_8055DB80@sda21(r13)
.global lbl_802E8C8C
lbl_802E8C8C:
/* 802E8C8C 002E4ACC  3C 60 80 42 */	lis r3, lbl_80419328@ha
/* 802E8C90 002E4AD0  38 03 93 28 */	addi r0, r3, lbl_80419328@l
...
/* 802E8CA8 002E4AE8  3F E0 80 55 */	lis r31, lbl_80551F98@ha
/* 802E8CAC 002E4AEC  38 7F 1F 98 */	addi r3, r31, lbl_80551F98@l
/* 802E8CB0 002E4AF0  3C 80 80 55 */	lis r4, lbl_80552018@ha
/* 802E8CB4 002E4AF4  38 84 20 18 */	addi r4, r4, lbl_80552018@l
/* 802E8CB8 002E4AF8  3C A0 80 55 */	lis r5, lbl_80552024@ha
/* 802E8CBC 002E4AFC  38 A5 20 24 */	addi r5, r5, lbl_80552024@l
...
/* 802E8CD4 002E4B14  4B FA 21 09 */	bl lbl_8028ADDC
...
.global lbl_802E8CF4
lbl_802E8CF4:
/* 802E8CF4 002E4B34  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802E8CF8 002E4B38  3C 60 80 48 */	lis r3, lbl_8047D410@ha
/* 802E8CFC 002E4B3C  90 03 D4 10 */	stw r0, lbl_8047D410@l(r3)
/* 802E8D00 002E4B40  38 63 D4 10 */	addi r3, r3, -0x2bf0
/* 802E8D04 002E4B44  90 03 00 14 */	stw r0, 0x14(r3)
/* 802E8D08 002E4B48  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
