...
/* 802EFB48 002EB988  3C 60 80 48 */	lis r3, lbl_8047E498@ha
/* 802EFB4C 002EB98C  3B C3 E4 98 */	addi r30, r3, lbl_8047E498@l
/* 802EFB50 002EB990  3B 9E 03 10 */	addi r28, r30, 0x310
/* 802EFB54 002EB994  3B BE 03 1C */	addi r29, r30, 0x31c
/* 802EFB58 002EB998  88 0D F7 78 */	lbz r0, lbl_8055DB98@sda21(r13)
...
/* 802EFB68 002EB9A8  3C 60 80 55 */	lis r3, lbl_80552290@ha
/* 802EFB6C 002EB9AC  38 63 22 90 */	addi r3, r3, lbl_80552290@l
/* 802EFB70 002EB9B0  4B F8 19 A1 */	bl lbl_80271510
/* 802EFB74 002EB9B4  38 00 00 01 */	li r0, 0x1
/* 802EFB78 002EB9B8  98 0D F7 78 */	stb r0, lbl_8055DB98@sda21(r13)
.global lbl_802EFB7C
lbl_802EFB7C:
/* 802EFB7C 002EB9BC  3C 60 80 42 */	lis r3, lbl_80419480@ha
/* 802EFB80 002EB9C0  38 03 94 80 */	addi r0, r3, lbl_80419480@l
...
/* 802EFB98 002EB9D8  3F E0 80 55 */	lis r31, lbl_80552290@ha
/* 802EFB9C 002EB9DC  38 7F 22 90 */	addi r3, r31, lbl_80552290@l
/* 802EFBA0 002EB9E0  3C 80 80 55 */	lis r4, lbl_80552310@ha
/* 802EFBA4 002EB9E4  38 84 23 10 */	addi r4, r4, lbl_80552310@l
/* 802EFBA8 002EB9E8  3C A0 80 55 */	lis r5, lbl_8055231C@ha
/* 802EFBAC 002EB9EC  38 A5 23 1C */	addi r5, r5, lbl_8055231C@l
...
/* 802EFBC4 002EBA04  4B F9 B2 19 */	bl lbl_8028ADDC
...
.global lbl_802EFBEC
lbl_802EFBEC:
/* 802EFBEC 002EBA2C  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 802EFBF0 002EBA30  3C 60 80 48 */	lis r3, lbl_8047E604@ha
/* 802EFBF4 002EBA34  90 03 E6 04 */	stw r0, lbl_8047E604@l(r3)
/* 802EFBF8 002EBA38  38 63 E6 04 */	addi r3, r3, -0x19fc
/* 802EFBFC 002EBA3C  90 03 00 14 */	stw r0, 0x14(r3)
/* 802EFC00 002EBA40  80 8D 89 E4 */	lwz r4, lbl_80556E04@sda21(r13)
