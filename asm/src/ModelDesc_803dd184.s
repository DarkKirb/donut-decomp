...
/* 803DD198 003D8FD8  3C 60 80 49 */	lis r3, lbl_80494030@ha
/* 803DD19C 003D8FDC  3B E3 40 30 */	addi r31, r3, lbl_80494030@l
/* 803DD1A0 003D8FE0  3B BF 00 3C */	addi r29, r31, 0x3c
/* 803DD1A4 003D8FE4  3B DF 00 48 */	addi r30, r31, 0x48
/* 803DD1A8 003D8FE8  88 0D F9 80 */	lbz r0, lbl_8055DDA0@sda21(r13)
...
/* 803DD1B8 003D8FF8  3C 60 80 55 */	lis r3, lbl_80554C60@ha
/* 803DD1BC 003D8FFC  38 63 4C 60 */	addi r3, r3, lbl_80554C60@l
/* 803DD1C0 003D9000  4B E9 43 51 */	bl lbl_80271510
/* 803DD1C4 003D9004  38 00 00 01 */	li r0, 0x1
/* 803DD1C8 003D9008  98 0D F9 80 */	stb r0, lbl_8055DDA0@sda21(r13)
.global lbl_803DD1CC
lbl_803DD1CC:
/* 803DD1CC 003D900C  38 02 DE 50 */	addi r0, r2, lbl_80563DD0@sda21
...
/* 803DD1DC 003D901C  3C 60 80 55 */	lis r3, lbl_80554C48@ha
/* 803DD1E0 003D9020  38 03 4C 48 */	addi r0, r3, lbl_80554C48@l
/* 803DD1E4 003D9024  90 01 00 10 */	stw r0, 0x10(r1)
/* 803DD1E8 003D9028  3C 60 80 55 */	lis r3, lbl_80554C60@ha
/* 803DD1EC 003D902C  38 63 4C 60 */	addi r3, r3, lbl_80554C60@l
/* 803DD1F0 003D9030  3C 80 80 55 */	lis r4, lbl_80554CE0@ha
/* 803DD1F4 003D9034  38 84 4C E0 */	addi r4, r4, lbl_80554CE0@l
/* 803DD1F8 003D9038  3C A0 80 55 */	lis r5, lbl_80554CEC@ha
/* 803DD1FC 003D903C  38 A5 4C EC */	addi r5, r5, lbl_80554CEC@l
...
/* 803DD214 003D9054  4B FF A8 51 */	bl lbl_803D7A64
/* 803DD218 003D9058  38 8D DC B0 */	addi r4, r13, lbl_8055C0D0@sda21
...
/* 803DD240 003D9080  4B DC 07 7D */	bl lbl_8019D9BC
/* 803DD244 003D9084  3C 60 80 55 */	lis r3, lbl_80554C60@ha
/* 803DD248 003D9088  38 63 4C 60 */	addi r3, r3, lbl_80554C60@l
...
/* 803DD270 003D90B0  3C 60 80 55 */	lis r3, lbl_80554C60@ha
/* 803DD274 003D90B4  38 63 4C 60 */	addi r3, r3, lbl_80554C60@l
...
.global lbl_803DD290
lbl_803DD290:
/* 803DD290 003D90D0  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 803DD294 003D90D4  3C 60 80 55 */	lis r3, lbl_80554C48@ha
/* 803DD298 003D90D8  90 03 4C 48 */	stw r0, lbl_80554C48@l(r3)
