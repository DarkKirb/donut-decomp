...
/* 803DE414 003DA254  3C 60 80 49 */	lis r3, lbl_80494100@ha
/* 803DE418 003DA258  3B E3 41 00 */	addi r31, r3, lbl_80494100@l
...
/* 803DE428 003DA268  38 CD DC C8 */	addi r6, r13, lbl_8055C0E8@sda21
/* 803DE42C 003DA26C  38 E0 00 02 */	li r7, 0x2
/* 803DE430 003DA270  3D 00 80 42 */	lis r8, lbl_80420AB8@ha
/* 803DE434 003DA274  39 08 0A B8 */	addi r8, r8, lbl_80420AB8@l
/* 803DE438 003DA278  39 20 00 02 */	li r9, 0x2
/* 803DE43C 003DA27C  39 5F 00 00 */	addi r10, r31, 0x0
/* 803DE440 003DA280  48 00 00 45 */	bl lbl_803DE484
/* 803DE444 003DA284  7C 7E 1B 78 */	mr r30, r3
/* 803DE448 003DA288  38 61 00 08 */	addi r3, r1, 0x8
/* 803DE44C 003DA28C  38 8D DC E0 */	addi r4, r13, lbl_8055C100@sda21
/* 803DE450 003DA290  4B DA D9 91 */	bl lbl_8018BDE0
/* 803DE454 003DA294  7C 64 1B 78 */	mr r4, r3
/* 803DE458 003DA298  38 7E 00 30 */	addi r3, r30, 0x30
/* 803DE45C 003DA29C  4B DA 3C C1 */	bl lbl_8018211C
...
/* 803DE4B8 003DA2F8  88 0D F9 88 */	lbz r0, lbl_8055DDA8@sda21(r13)
...
/* 803DE4C8 003DA308  3C 60 80 55 */	lis r3, lbl_80554CF8@ha
/* 803DE4CC 003DA30C  38 63 4C F8 */	addi r3, r3, lbl_80554CF8@l
/* 803DE4D0 003DA310  4B E9 30 41 */	bl lbl_80271510
/* 803DE4D4 003DA314  38 00 00 01 */	li r0, 0x1
/* 803DE4D8 003DA318  98 0D F9 88 */	stb r0, lbl_8055DDA8@sda21(r13)
.global lbl_803DE4DC
lbl_803DE4DC:
...
/* 803DE4E8 003DA328  3F E0 80 55 */	lis r31, lbl_80554CF8@ha
/* 803DE4EC 003DA32C  38 7F 4C F8 */	addi r3, r31, lbl_80554CF8@l
/* 803DE4F0 003DA330  3C 80 80 55 */	lis r4, lbl_80554D78@ha
/* 803DE4F4 003DA334  38 84 4D 78 */	addi r4, r4, lbl_80554D78@l
/* 803DE4F8 003DA338  3C A0 80 55 */	lis r5, lbl_80554D84@ha
/* 803DE4FC 003DA33C  38 A5 4D 84 */	addi r5, r5, lbl_80554D84@l
...
/* 803DE514 003DA354  4B FF 95 51 */	bl lbl_803D7A64
...
/* 803DE548 003DA388  3C 60 80 49 */	lis r3, lbl_80494100@ha
/* 803DE54C 003DA38C  3B E3 41 00 */	addi r31, r3, lbl_80494100@l
...
/* 803DE55C 003DA39C  38 CD DC C8 */	addi r6, r13, lbl_8055C0E8@sda21
/* 803DE560 003DA3A0  38 E0 00 02 */	li r7, 0x2
/* 803DE564 003DA3A4  3D 00 80 42 */	lis r8, lbl_80420AB8@ha
/* 803DE568 003DA3A8  39 08 0A B8 */	addi r8, r8, lbl_80420AB8@l
/* 803DE56C 003DA3AC  39 20 00 02 */	li r9, 0x2
/* 803DE570 003DA3B0  39 5F 00 00 */	addi r10, r31, 0x0
/* 803DE574 003DA3B4  4B FF FF 11 */	bl lbl_803DE484
/* 803DE578 003DA3B8  7C 7E 1B 78 */	mr r30, r3
/* 803DE57C 003DA3BC  38 61 00 08 */	addi r3, r1, 0x8
/* 803DE580 003DA3C0  38 8D DC E0 */	addi r4, r13, lbl_8055C100@sda21
/* 803DE584 003DA3C4  4B DA D8 5D */	bl lbl_8018BDE0
/* 803DE588 003DA3C8  7C 64 1B 78 */	mr r4, r3
/* 803DE58C 003DA3CC  38 7E 00 30 */	addi r3, r30, 0x30
/* 803DE590 003DA3D0  4B DA 3B 8D */	bl lbl_8018211C
...
.global lbl_803DE5B8
lbl_803DE5B8:
/* 803DE5B8 003DA3F8  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 803DE5BC 003DA3FC  3C 60 80 49 */	lis r3, lbl_80494100@ha
/* 803DE5C0 003DA400  90 03 41 00 */	stw r0, lbl_80494100@l(r3)
