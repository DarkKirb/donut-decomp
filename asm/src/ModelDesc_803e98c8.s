...
/* 803E98DC 003E571C  3C 60 80 49 */	lis r3, lbl_80494BC0@ha
/* 803E98E0 003E5720  3B C3 4B C0 */	addi r30, r3, lbl_80494BC0@l
/* 803E98E4 003E5724  3C 60 80 49 */	lis r3, lbl_80494BCC@ha
/* 803E98E8 003E5728  3B E3 4B CC */	addi r31, r3, lbl_80494BCC@l
/* 803E98EC 003E572C  88 0D FA 00 */	lbz r0, lbl_8055DE20@sda21(r13)
...
/* 803E98FC 003E573C  3C 60 80 55 */	lis r3, lbl_80555820@ha
/* 803E9900 003E5740  38 63 58 20 */	addi r3, r3, lbl_80555820@l
/* 803E9904 003E5744  4B E8 7C 0D */	bl lbl_80271510
/* 803E9908 003E5748  38 00 00 01 */	li r0, 0x1
/* 803E990C 003E574C  98 0D FA 00 */	stb r0, lbl_8055DE20@sda21(r13)
.global lbl_803E9910
lbl_803E9910:
/* 803E9910 003E5750  38 02 E0 C8 */	addi r0, r2, lbl_80564048@sda21
...
/* 803E9920 003E5760  3C 60 80 55 */	lis r3, lbl_80555808@ha
/* 803E9924 003E5764  38 03 58 08 */	addi r0, r3, lbl_80555808@l
/* 803E9928 003E5768  90 01 00 10 */	stw r0, 0x10(r1)
/* 803E992C 003E576C  3C 60 80 55 */	lis r3, lbl_80555820@ha
/* 803E9930 003E5770  38 63 58 20 */	addi r3, r3, lbl_80555820@l
/* 803E9934 003E5774  3C 80 80 55 */	lis r4, lbl_805558A0@ha
/* 803E9938 003E5778  38 84 58 A0 */	addi r4, r4, lbl_805558A0@l
/* 803E993C 003E577C  3C A0 80 55 */	lis r5, lbl_805558AC@ha
/* 803E9940 003E5780  38 A5 58 AC */	addi r5, r5, lbl_805558AC@l
/* 803E9944 003E5784  7F E6 FB 78 */	mr r6, r31
/* 803E9948 003E5788  7F C7 F3 78 */	mr r7, r30
/* 803E994C 003E578C  39 00 00 02 */	li r8, 0x2
/* 803E9950 003E5790  39 2D DE A0 */	addi r9, r13, lbl_8055C2C0@sda21
/* 803E9954 003E5794  39 40 00 01 */	li r10, 0x1
/* 803E9958 003E5798  4B FE E1 0D */	bl lbl_803D7A64
/* 803E995C 003E579C  38 8D DE A8 */	addi r4, r13, lbl_8055C2C8@sda21
...
/* 803E9984 003E57C4  4B DB 40 39 */	bl lbl_8019D9BC
/* 803E9988 003E57C8  3C 60 80 55 */	lis r3, lbl_80555820@ha
/* 803E998C 003E57CC  38 63 58 20 */	addi r3, r3, lbl_80555820@l
...
/* 803E99B4 003E57F4  3C 60 80 55 */	lis r3, lbl_80555820@ha
/* 803E99B8 003E57F8  38 63 58 20 */	addi r3, r3, lbl_80555820@l
...
.global lbl_803E99D4
lbl_803E99D4:
/* 803E99D4 003E5814  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 803E99D8 003E5818  3C 60 80 55 */	lis r3, lbl_80555808@ha
/* 803E99DC 003E581C  90 03 58 08 */	stw r0, lbl_80555808@l(r3)
