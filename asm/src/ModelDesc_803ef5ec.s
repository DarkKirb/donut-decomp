...
/* 803EF600 003EB440  3C 60 80 49 */	lis r3, lbl_804952A0@ha
/* 803EF604 003EB444  3B C3 52 A0 */	addi r30, r3, lbl_804952A0@l
/* 803EF608 003EB448  3C 60 80 49 */	lis r3, lbl_804952B0@ha
/* 803EF60C 003EB44C  3B E3 52 B0 */	addi r31, r3, lbl_804952B0@l
/* 803EF610 003EB450  88 0D FA 40 */	lbz r0, lbl_8055DE60@sda21(r13)
...
/* 803EF620 003EB460  3C 60 80 55 */	lis r3, lbl_80556300@ha
/* 803EF624 003EB464  38 63 63 00 */	addi r3, r3, lbl_80556300@l
/* 803EF628 003EB468  4B E8 1E E9 */	bl lbl_80271510
/* 803EF62C 003EB46C  38 00 00 01 */	li r0, 0x1
/* 803EF630 003EB470  98 0D FA 40 */	stb r0, lbl_8055DE60@sda21(r13)
.global lbl_803EF634
lbl_803EF634:
/* 803EF634 003EB474  38 02 E1 B8 */	addi r0, r2, lbl_80564138@sda21
...
/* 803EF644 003EB484  3C 60 80 55 */	lis r3, lbl_805562E8@ha
/* 803EF648 003EB488  38 03 62 E8 */	addi r0, r3, lbl_805562E8@l
/* 803EF64C 003EB48C  90 01 00 10 */	stw r0, 0x10(r1)
/* 803EF650 003EB490  3C 60 80 55 */	lis r3, lbl_80556300@ha
/* 803EF654 003EB494  38 63 63 00 */	addi r3, r3, lbl_80556300@l
/* 803EF658 003EB498  3C 80 80 55 */	lis r4, lbl_80556380@ha
/* 803EF65C 003EB49C  38 84 63 80 */	addi r4, r4, lbl_80556380@l
/* 803EF660 003EB4A0  3C A0 80 55 */	lis r5, lbl_8055638C@ha
/* 803EF664 003EB4A4  38 A5 63 8C */	addi r5, r5, lbl_8055638C@l
/* 803EF668 003EB4A8  7F E6 FB 78 */	mr r6, r31
/* 803EF66C 003EB4AC  7F C7 F3 78 */	mr r7, r30
/* 803EF670 003EB4B0  39 00 00 01 */	li r8, 0x1
/* 803EF674 003EB4B4  39 2D E0 48 */	addi r9, r13, lbl_8055C468@sda21
/* 803EF678 003EB4B8  39 40 00 01 */	li r10, 0x1
/* 803EF67C 003EB4BC  4B FE 83 E9 */	bl lbl_803D7A64
/* 803EF680 003EB4C0  38 8D E0 54 */	addi r4, r13, lbl_8055C474@sda21
...
/* 803EF6A8 003EB4E8  4B DA E3 15 */	bl lbl_8019D9BC
/* 803EF6AC 003EB4EC  3C 60 80 55 */	lis r3, lbl_80556300@ha
/* 803EF6B0 003EB4F0  38 63 63 00 */	addi r3, r3, lbl_80556300@l
...
/* 803EF6D8 003EB518  3C 60 80 55 */	lis r3, lbl_80556300@ha
/* 803EF6DC 003EB51C  38 63 63 00 */	addi r3, r3, lbl_80556300@l
...
.global lbl_803EF6F8
lbl_803EF6F8:
/* 803EF6F8 003EB538  80 0D 89 E0 */	lwz r0, lbl_80556E00@sda21(r13)
/* 803EF6FC 003EB53C  3C 60 80 55 */	lis r3, lbl_805562E8@ha
/* 803EF700 003EB540  90 03 62 E8 */	stw r0, lbl_805562E8@l(r3)
