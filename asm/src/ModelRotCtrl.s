...
/* 80271584 0026D3C4  38 00 00 01 */	li r0, 1
/* 80271588 0026D3C8  98 03 00 04 */	stb r0, 4(r3)
/* 8027158C 0026D3CC  C0 42 AD 68 */	lfs f2, $$250889-_SDA2_BASE_(r2)
/* 80271590 0026D3D0  D0 43 00 08 */	stfs f2, 8(r3)
/* 80271594 0026D3D4  C0 22 AD 6C */	lfs f1, $$250890-_SDA2_BASE_(r2)
/* 80271598 0026D3D8  D0 23 00 0C */	stfs f1, 0xc(r3)
/* 8027159C 0026D3DC  C0 02 AD 70 */	lfs f0, $$250891-_SDA2_BASE_(r2)
...
/* 802715E0 0026D420  88 03 00 04 */	lbz r0, 4(r3)
/* 802715E4 0026D424  2C 00 00 00 */	cmpwi r0, 0
/* 802715E8 0026D428  41 82 00 68 */	beq lbl_80271650
/* 802715EC 0026D42C  80 63 00 00 */	lwz r3, 0(r3)
...
/* 802715FC 0026D43C  C0 62 AD 74 */	lfs f3, $$250896-_SDA2_BASE_(r2)
...
/* 8027160C 0026D44C  C0 1F 00 08 */	lfs f0, 8(r31)
/* 80271610 0026D450  EC 00 08 BA */	fmadds f0, f0, f2, f1
/* 80271614 0026D454  D0 1F 00 08 */	stfs f0, 8(r31)
...
/* 802716F4 0026D534  C0 02 AD 70 */	lfs f0, $$250891-_SDA2_BASE_(r2)
...
/* 80271754 0026D594  F3 E1 00 18 */	psq_st f31, 24(r1), 0, qr0
...
/* 802717A8 0026D5E8  80 63 00 00 */	lwz r3, 0(r3)
...
/* 802717B8 0026D5F8  D0 1F 00 08 */	stfs f0, 8(r31)
...
/* 8027183C 0026D67C  F3 E1 00 18 */	psq_st f31, 24(r1), 0, qr0
...
/* 8027184C 0026D68C  80 63 00 00 */	lwz r3, 0(r3)
...
/* 80271888 0026D6C8  C0 02 AD 68 */	lfs f0, $$250889-_SDA2_BASE_(r2)
/* 8027188C 0026D6CC  2C 04 00 00 */	cmpwi r4, 0
/* 80271890 0026D6D0  41 82 00 20 */	beq lbl_802718B0
/* 80271894 0026D6D4  EC 21 10 2A */	fadds f1, f1, f2
/* 80271898 0026D6D8  C0 02 AD 78 */	lfs f0, $$250956-_SDA2_BASE_(r2)
/* 8027189C 0026D6DC  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802718A0 0026D6E0  4C 41 13 82 */	cror 2, 1, 2
...
/* 802718BC 0026D6FC  C0 02 AD 78 */	lfs f0, $$250956-_SDA2_BASE_(r2)
