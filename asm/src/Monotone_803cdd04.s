...
/* 803CDD0C 003C9B4C  C8 22 DC 78 */	lfd f1, lbl_80563BF8@sda21(r2)
...
/* 803CDD88 003C9BC8  3C 80 80 49 */	lis r4, lbl_80492C88@ha
/* 803CDD8C 003C9BCC  38 84 2C 88 */	addi r4, r4, lbl_80492C88@l
/* 803CDD90 003C9BD0  4B E0 7E 99 */	bl lbl_801D5C28
/* 803CDD94 003C9BD4  38 7D 00 2C */	addi r3, r29, 0x2c
/* 803CDD98 003C9BD8  4B C4 DA 69 */	bl lbl_8001B800
/* 803CDD9C 003C9BDC  7F C3 F3 78 */	mr r3, r30
/* 803CDDA0 003C9BE0  4B E1 CC 51 */	bl lbl_801EA9F0
/* 803CDDA4 003C9BE4  4B FF BC F5 */	bl lbl_803C9A98
/* 803CDDA8 003C9BE8  90 61 00 08 */	stw r3, 0x8(r1)
/* 803CDDAC 003C9BEC  38 61 00 08 */	addi r3, r1, 0x8
/* 803CDDB0 003C9BF0  4B FF BB E9 */	bl lbl_803C9998
...
/* 803CDDC4 003C9C04  4B E1 CC 61 */	bl lbl_801EAA24
...
/* 803CDE04 003C9C44  3C 80 80 54 */	lis r4, lbl_805452D0@ha
/* 803CDE08 003C9C48  38 84 52 D0 */	addi r4, r4, lbl_805452D0@l
/* 803CDE0C 003C9C4C  4B DA E7 BD */	bl lbl_8017C5C8
/* 803CDE10 003C9C50  38 7D 00 38 */	addi r3, r29, 0x38
/* 803CDE14 003C9C54  38 80 00 03 */	li r4, 0x3
/* 803CDE18 003C9C58  4B EA D2 A5 */	bl lbl_8027B0BC
/* 803CDE1C 003C9C5C  38 7D 00 6C */	addi r3, r29, 0x6c
/* 803CDE20 003C9C60  38 9D 00 38 */	addi r4, r29, 0x38
/* 803CDE24 003C9C64  48 00 1B D1 */	bl lbl_803CF9F4
...
/* 803CDE40 003C9C80  48 00 03 29 */	bl lbl_803CE168
/* 803CDE44 003C9C84  7F A3 EB 78 */	mr r3, r29
/* 803CDE48 003C9C88  48 00 03 A5 */	bl lbl_803CE1EC
...
/* 803CDECC 003C9D0C  4B DF 18 49 */	bl lbl_801BF714
.global lbl_803CDED0
lbl_803CDED0:
...
/* 803CDF24 003C9D64  4B E6 59 35 */	bl lbl_80233858
...
/* 803CDF34 003C9D74  48 03 7A 6D */	bl lbl_804059A0
/* 803CDF38 003C9D78  38 7F 00 2C */	addi r3, r31, 0x2c
/* 803CDF3C 003C9D7C  48 03 7A 4D */	bl lbl_80405988
...
/* 803CDF4C 003C9D8C  4B D3 88 35 */	bl lbl_80106780
...
/* 803CDFEC 003C9E2C  48 00 00 B1 */	bl lbl_803CE09C
...
/* 803CE000 003C9E40  4B E1 C9 F1 */	bl lbl_801EA9F0
/* 803CE004 003C9E44  4B FF BA 95 */	bl lbl_803C9A98
/* 803CE008 003C9E48  90 61 00 08 */	stw r3, 0x8(r1)
/* 803CE00C 003C9E4C  38 61 00 08 */	addi r3, r1, 0x8
/* 803CE010 003C9E50  4B FF B2 3D */	bl lbl_803C924C
...
/* 803CE02C 003C9E6C  48 03 32 C9 */	bl lbl_804012F4
.global lbl_803CE030
lbl_803CE030:
...
/* 803CE054 003C9E94  48 03 79 D1 */	bl lbl_80405A24
/* 803CE058 003C9E98  7F C3 F3 78 */	mr r3, r30
/* 803CE05C 003C9E9C  48 00 03 ED */	bl lbl_803CE448
/* 803CE060 003C9EA0  48 00 00 24 */	b lbl_803CE084
.global lbl_803CE064
lbl_803CE064:
/* 803CE064 003C9EA4  7F C3 F3 78 */	mr r3, r30
/* 803CE068 003C9EA8  C0 22 DC 80 */	lfs f1, lbl_80563C00@sda21(r2)
/* 803CE06C 003C9EAC  48 00 03 DD */	bl lbl_803CE448
/* 803CE070 003C9EB0  48 00 00 14 */	b lbl_803CE084
.global lbl_803CE074
lbl_803CE074:
/* 803CE074 003C9EB4  38 7E 00 64 */	addi r3, r30, 0x64
/* 803CE078 003C9EB8  48 03 79 FD */	bl lbl_80405A74
/* 803CE07C 003C9EBC  7F C3 F3 78 */	mr r3, r30
/* 803CE080 003C9EC0  48 00 03 C9 */	bl lbl_803CE448
.global lbl_803CE084
lbl_803CE084:
...
/* 803CE0D0 003C9F10  48 00 00 29 */	bl lbl_803CE0F8
...
/* 803CE0E0 003C9F20  48 03 78 A1 */	bl lbl_80405980
...
/* 803CE0FC 003C9F3C  4B F7 3A 50 */	b lbl_80341B4C
.global lbl_803CE100
lbl_803CE100:
...
/* 803CE118 003C9F58  4B E6 57 41 */	bl lbl_80233858
...
/* 803CE128 003C9F68  4B E5 2A 61 */	bl lbl_80220B88
/* 803CE12C 003C9F6C  7C 64 1B 78 */	mr r4, r3
/* 803CE130 003C9F70  38 61 00 14 */	addi r3, r1, 0x14
/* 803CE134 003C9F74  4B E9 78 85 */	bl lbl_802659B8
...
/* 803CE144 003C9F84  4B DA E7 09 */	bl lbl_8017C84C
/* 803CE148 003C9F88  38 7F 00 38 */	addi r3, r31, 0x38
/* 803CE14C 003C9F8C  38 81 00 08 */	addi r4, r1, 0x8
/* 803CE150 003C9F90  4B EA CF A9 */	bl lbl_8027B0F8
.global lbl_803CE154
lbl_803CE154:
...
/* 803CE184 003C9FC4  4B F7 39 C9 */	bl lbl_80341B4C
/* 803CE188 003C9FC8  7C 7F 1B 78 */	mr r31, r3
/* 803CE18C 003C9FCC  80 7E 00 00 */	lwz r3, 0x0(r30)
/* 803CE190 003C9FD0  4B E1 C8 61 */	bl lbl_801EA9F0
/* 803CE194 003C9FD4  4B FF B9 05 */	bl lbl_803C9A98
/* 803CE198 003C9FD8  90 61 00 08 */	stw r3, 0x8(r1)
/* 803CE19C 003C9FDC  38 61 00 08 */	addi r3, r1, 0x8
/* 803CE1A0 003C9FE0  4B FF B0 AD */	bl lbl_803C924C
...
/* 803CE1D0 003CA010  48 03 77 B1 */	bl lbl_80405980
...
/* 803CE224 003CA064  48 03 78 01 */	bl lbl_80405A24
/* 803CE228 003CA068  C0 02 DC 80 */	lfs f0, lbl_80563C00@sda21(r2)
...
/* 803CE238 003CA078  48 03 77 ED */	bl lbl_80405A24
...
/* 803CE280 003CA0C0  48 00 00 D1 */	bl lbl_803CE350
...
/* 803CE294 003CA0D4  48 00 00 BD */	bl lbl_803CE350
/* 803CE298 003CA0D8  80 02 DC 88 */	lwz r0, lbl_80563C08@sda21(r2)
...
/* 803CE2DC 003CA11C  80 02 DC 84 */	lwz r0, lbl_80563C04@sda21(r2)
...
/* 803CE32C 003CA16C  48 03 2F C1 */	bl lbl_804012EC
.global lbl_803CE330
lbl_803CE330:
...
/* 803CE384 003CA1C4  4B DA E4 C9 */	bl lbl_8017C84C
...
/* 803CE3CC 003CA20C  4B DA E1 FD */	bl lbl_8017C5C8
...
/* 803CE420 003CA260  4B DA E1 A9 */	bl lbl_8017C5C8
...
/* 803CE460 003CA2A0  48 03 36 B1 */	bl lbl_80401B10
/* 803CE464 003CA2A4  C0 02 DC 90 */	lfs f0, lbl_80563C10@sda21(r2)
...
/* 803CE478 003CA2B8  80 02 DC 8C */	lwz r0, lbl_80563C0C@sda21(r2)
...
/* 803CE4D8 003CA318  4B FF FC 29 */	bl lbl_803CE100
/* 803CE4DC 003CA31C  7F E3 FB 78 */	mr r3, r31
/* 803CE4E0 003CA320  4B FF FD 0D */	bl lbl_803CE1EC
...
/* 803CE510 003CA350  48 03 74 91 */	bl lbl_804059A0
/* 803CE514 003CA354  38 7F 00 64 */	addi r3, r31, 0x64
/* 803CE518 003CA358  48 03 74 71 */	bl lbl_80405988
...
/* 803CE528 003CA368  4B EA CB E1 */	bl lbl_8027B108
...
/* 803CE538 003CA378  4B FF FB C1 */	bl lbl_803CE0F8
...
/* 803CE548 003CA388  48 03 74 39 */	bl lbl_80405980
.global lbl_803CE54C
lbl_803CE54C:
...
/* 803CE578 003CA3B8  48 03 74 29 */	bl lbl_804059A0
/* 803CE57C 003CA3BC  38 7F 00 64 */	addi r3, r31, 0x64
/* 803CE580 003CA3C0  48 03 74 09 */	bl lbl_80405988
...
/* 803CE598 003CA3D8  4B FF FB 61 */	bl lbl_803CE0F8
...
/* 803CE5A8 003CA3E8  48 03 73 D9 */	bl lbl_80405980
.global lbl_803CE5AC
lbl_803CE5AC:
...
/* 803CE5D8 003CA418  48 03 73 C9 */	bl lbl_804059A0
/* 803CE5DC 003CA41C  38 7F 00 64 */	addi r3, r31, 0x64
/* 803CE5E0 003CA420  48 03 73 A9 */	bl lbl_80405988
