...
/* 802718D8 0026D718  F3 E1 00 18 */	psq_st f31, 24(r1), 0, qr0
/* 802718DC 0026D71C  93 E1 00 0C */	stw r31, 0xc(r1)
/* 802718E0 0026D720  93 C1 00 08 */	stw r30, 8(r1)
/* 802718E4 0026D724  7C 7E 1B 78 */	mr r30, r3
/* 802718E8 0026D728  3B E0 00 00 */	li r31, 0
/* 802718EC 0026D72C  9B E3 00 00 */	stb r31, 0(r3)
/* 802718F0 0026D730  38 63 00 04 */	addi r3, r3, 4
...
/* 80271900 0026D740  C0 02 AD 80 */	lfs f0, $$251568-_SDA2_BASE_(r2)
/* 80271904 0026D744  D0 1E 00 14 */	stfs f0, 0x14(r30)
/* 80271908 0026D748  38 00 00 01 */	li r0, 1
/* 8027190C 0026D74C  90 1E 00 18 */	stw r0, 0x18(r30)
/* 80271910 0026D750  93 FE 00 1C */	stw r31, 0x1c(r30)
/* 80271914 0026D754  C0 02 AD 84 */	lfs f0, $$251569-_SDA2_BASE_(r2)
...
/* 80271924 0026D764  80 6D ED 10 */	lwz r3, object___Q33hel6common38ExplicitSingleton$$0Q23app11Application$$1-_SDA_BASE_(r13)
...
/* 80271930 0026D770  C0 02 AD 88 */	lfs f0, $$251570-_SDA2_BASE_(r2)
/* 80271934 0026D774  EF E0 00 72 */	fmuls f31, f0, f1
/* 80271938 0026D778  80 6D ED 10 */	lwz r3, object___Q33hel6common38ExplicitSingleton$$0Q23app11Application$$1-_SDA_BASE_(r13)
...
/* 80271944 0026D784  C0 02 AD 88 */	lfs f0, $$251570-_SDA2_BASE_(r2)
/* 80271948 0026D788  EC 20 00 72 */	fmuls f1, f0, f1
/* 8027194C 0026D78C  C0 02 AD 84 */	lfs f0, $$251569-_SDA2_BASE_(r2)
...
/* 8027195C 0026D79C  C0 02 AD 80 */	lfs f0, $$251568-_SDA2_BASE_(r2)
...
/* 80271988 0026D7C8  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 802719B0 0026D7F0  4B D9 59 91 */	bl func_80007340
...
/* 802719C8 0026D808  38 63 00 04 */	addi r3, r3, 4
...
/* 802719F0 0026D830  38 00 00 01 */	li r0, 1
/* 802719F4 0026D834  98 1C 00 00 */	stb r0, 0(r28)
/* 802719F8 0026D838  CB E1 00 18 */	lfd f31, 0x18(r1)
/* 802719FC 0026D83C  39 61 00 18 */	addi r11, r1, 0x18
/* 80271A00 0026D840  4B D9 59 8D */	bl func_8000738C
...
/* 80271A38 0026D878  38 04 00 01 */	addi r0, r4, 1
...
/* 80271AD4 0026D914  F3 E1 00 58 */	psq_st f31, 88(r1), 0, qr0
/* 80271AD8 0026D918  DB C1 00 40 */	stfd f30, 0x40(r1)
/* 80271ADC 0026D91C  F3 C1 00 48 */	psq_st f30, 72(r1), 0, qr0
...
/* 80271AEC 0026D92C  C8 42 AD 98 */	lfd f2, $$251620-_SDA2_BASE_(r2)
...
/* 80271B1C 0026D95C  C0 02 AD 90 */	lfs f0, $$251617-_SDA2_BASE_(r2)
/* 80271B20 0026D960  EC 20 07 B2 */	fmuls f1, f0, f30
/* 80271B24 0026D964  C0 02 AD 8C */	lfs f0, $$251616-_SDA2_BASE_(r2)
...
/* 80271B50 0026D990  C0 2D B0 38 */	lfs f1, $$251342-_SDA_BASE_(r13)
...
/* 80271BA4 0026D9E4  C0 42 AD 80 */	lfs f2, $$251568-_SDA2_BASE_(r2)
...
/* 80271C40 0026DA80  38 61 00 08 */	addi r3, r1, 8
...
/* 80271C4C 0026DA8C  38 61 00 08 */	addi r3, r1, 8
...
/* 80271C5C 0026DA9C  38 81 00 08 */	addi r4, r1, 8
...
/* 80271C80 0026DAC0  C0 22 AD A0 */	lfs f1, $$251639-_SDA2_BASE_(r2)
...
/* 80271CCC 0026DB0C  38 81 00 08 */	addi r4, r1, 8
...
.global $$251569
$$251569:
	.incbin "baserom.dol", 0x49B844, 0x4
.global $$251570
$$251570:
	.incbin "baserom.dol", 0x49B848, 0x4
.global $$251616
$$251616:
	.incbin "baserom.dol", 0x49B84C, 0x4
.global $$251617
$$251617:
	.incbin "baserom.dol", 0x49B850, 0x8
.global $$251620
$$251620:
	.incbin "baserom.dol", 0x49B858, 0x8
.global $$251639
$$251639:
	.incbin "baserom.dol", 0x49B860, 0x8
