...
/* 801CE918 001CA758  38 00 00 00 */	li r0, 0
/* 801CE91C 001CA75C  90 03 00 00 */	stw r0, 0(r3)
/* 801CE920 001CA760  90 03 00 04 */	stw r0, 4(r3)
/* 801CE924 001CA764  90 03 00 08 */	stw r0, 8(r3)
...
/* 801CE964 001CA7A4  38 61 00 08 */	addi r3, r1, 8
/* 801CE968 001CA7A8  38 9E 00 0C */	addi r4, r30, 0xc
/* 801CE96C 001CA7AC  48 23 71 69 */	bl __ct__Q24util11ScopedMutexFRQ24util5Mutex
/* 801CE970 001CA7B0  93 FE 00 08 */	stw r31, 8(r30)
/* 801CE974 001CA7B4  80 1E 00 00 */	lwz r0, 0(r30)
/* 801CE978 001CA7B8  60 00 00 10 */	ori r0, r0, 0x10
/* 801CE97C 001CA7BC  90 1E 00 00 */	stw r0, 0(r30)
/* 801CE980 001CA7C0  38 61 00 08 */	addi r3, r1, 8
/* 801CE984 001CA7C4  38 80 FF FF */	li r4, -1
...
/* 801CE9C0 001CA800  80 03 00 00 */	lwz r0, 0(r3)
/* 801CE9C4 001CA804  54 00 06 F6 */	rlwinm r0, r0, 0, 0x1b, 0x1b
/* 801CE9C8 001CA808  2C 00 00 00 */	cmpwi r0, 0
/* 801CE9CC 001CA80C  41 82 00 38 */	beq lbl_801CEA04
/* 801CE9D0 001CA810  38 61 00 08 */	addi r3, r1, 8
/* 801CE9D4 001CA814  38 9E 00 0C */	addi r4, r30, 0xc
/* 801CE9D8 001CA818  48 23 70 FD */	bl __ct__Q24util11ScopedMutexFRQ24util5Mutex
/* 801CE9DC 001CA81C  80 1E 00 00 */	lwz r0, 0(r30)
/* 801CE9E0 001CA820  54 00 07 34 */	rlwinm r0, r0, 0, 0x1c, 0x1a
/* 801CE9E4 001CA824  90 1E 00 00 */	stw r0, 0(r30)
/* 801CE9E8 001CA828  80 1E 00 08 */	lwz r0, 8(r30)
/* 801CE9EC 001CA82C  90 1F 00 00 */	stw r0, 0(r31)
/* 801CE9F0 001CA830  38 61 00 08 */	addi r3, r1, 8
/* 801CE9F4 001CA834  38 80 FF FF */	li r4, -1
/* 801CE9F8 001CA838  48 23 71 15 */	bl __dt__Q24util11ScopedMutexFv
/* 801CE9FC 001CA83C  38 60 00 01 */	li r3, 1
/* 801CEA00 001CA840  48 00 00 08 */	b lbl_801CEA08
lbl_801CEA04:
/* 801CEA04 001CA844  38 60 00 00 */	li r3, 0
lbl_801CEA08:
...
/* 801CEA3C 001CA87C  38 61 00 08 */	addi r3, r1, 8
/* 801CEA40 001CA880  38 9E 00 0C */	addi r4, r30, 0xc
/* 801CEA44 001CA884  48 23 70 91 */	bl __ct__Q24util11ScopedMutexFRQ24util5Mutex
/* 801CEA48 001CA888  93 FE 00 04 */	stw r31, 4(r30)
/* 801CEA4C 001CA88C  80 1E 00 00 */	lwz r0, 0(r30)
/* 801CEA50 001CA890  60 00 00 08 */	ori r0, r0, 8
/* 801CEA54 001CA894  90 1E 00 00 */	stw r0, 0(r30)
/* 801CEA58 001CA898  38 61 00 08 */	addi r3, r1, 8
/* 801CEA5C 001CA89C  38 80 FF FF */	li r4, -1
...
/* 801CEA98 001CA8D8  80 03 00 00 */	lwz r0, 0(r3)
/* 801CEA9C 001CA8DC  54 00 07 38 */	rlwinm r0, r0, 0, 0x1c, 0x1c
/* 801CEAA0 001CA8E0  2C 00 00 00 */	cmpwi r0, 0
/* 801CEAA4 001CA8E4  41 82 00 38 */	beq lbl_801CEADC
/* 801CEAA8 001CA8E8  38 61 00 08 */	addi r3, r1, 8
/* 801CEAAC 001CA8EC  38 9E 00 0C */	addi r4, r30, 0xc
/* 801CEAB0 001CA8F0  48 23 70 25 */	bl __ct__Q24util11ScopedMutexFRQ24util5Mutex
/* 801CEAB4 001CA8F4  80 1E 00 00 */	lwz r0, 0(r30)
/* 801CEAB8 001CA8F8  54 00 07 76 */	rlwinm r0, r0, 0, 0x1d, 0x1b
/* 801CEABC 001CA8FC  90 1E 00 00 */	stw r0, 0(r30)
/* 801CEAC0 001CA900  80 1E 00 04 */	lwz r0, 4(r30)
/* 801CEAC4 001CA904  90 1F 00 00 */	stw r0, 0(r31)
/* 801CEAC8 001CA908  38 61 00 08 */	addi r3, r1, 8
/* 801CEACC 001CA90C  38 80 FF FF */	li r4, -1
/* 801CEAD0 001CA910  48 23 70 3D */	bl __dt__Q24util11ScopedMutexFv
/* 801CEAD4 001CA914  38 60 00 01 */	li r3, 1
/* 801CEAD8 001CA918  48 00 00 08 */	b lbl_801CEAE0
lbl_801CEADC:
/* 801CEADC 001CA91C  38 60 00 00 */	li r3, 0
lbl_801CEAE0:
...
/* 801CEB14 001CA954  38 61 00 08 */	addi r3, r1, 8
/* 801CEB18 001CA958  38 9E 00 0C */	addi r4, r30, 0xc
/* 801CEB1C 001CA95C  48 23 6F B9 */	bl __ct__Q24util11ScopedMutexFRQ24util5Mutex
/* 801CEB20 001CA960  80 7E 00 00 */	lwz r3, 0(r30)
/* 801CEB24 001CA964  54 60 07 38 */	rlwinm r0, r3, 0, 0x1c, 0x1c
/* 801CEB28 001CA968  2C 00 00 00 */	cmpwi r0, 0
/* 801CEB2C 001CA96C  41 82 00 28 */	beq lbl_801CEB54
/* 801CEB30 001CA970  54 60 07 76 */	rlwinm r0, r3, 0, 0x1d, 0x1b
/* 801CEB34 001CA974  90 1E 00 00 */	stw r0, 0(r30)
/* 801CEB38 001CA978  80 1E 00 04 */	lwz r0, 4(r30)
/* 801CEB3C 001CA97C  90 1F 00 00 */	stw r0, 0(r31)
/* 801CEB40 001CA980  38 61 00 08 */	addi r3, r1, 8
/* 801CEB44 001CA984  38 80 FF FF */	li r4, -1
/* 801CEB48 001CA988  48 23 6F C5 */	bl __dt__Q24util11ScopedMutexFv
/* 801CEB4C 001CA98C  38 60 00 00 */	li r3, 0
/* 801CEB50 001CA990  48 00 00 1C */	b lbl_801CEB6C
lbl_801CEB54:
/* 801CEB54 001CA994  60 60 00 04 */	ori r0, r3, 4
/* 801CEB58 001CA998  90 1E 00 00 */	stw r0, 0(r30)
/* 801CEB5C 001CA99C  38 61 00 08 */	addi r3, r1, 8
/* 801CEB60 001CA9A0  38 80 FF FF */	li r4, -1
/* 801CEB64 001CA9A4  48 23 6F A9 */	bl __dt__Q24util11ScopedMutexFv
/* 801CEB68 001CA9A8  38 60 00 01 */	li r3, 1
lbl_801CEB6C:
...
/* 801CEB84 001CA9C4  38 80 00 01 */	li r4, 1
...
/* 801CEB8C 001CA9CC  38 80 00 01 */	li r4, 1
...
/* 801CEB94 001CA9D4  38 80 00 02 */	li r4, 2
...
/* 801CEB9C 001CA9DC  38 80 00 02 */	li r4, 2
...
/* 801CEBA4 001CA9E4  38 80 00 04 */	li r4, 4
...
/* 801CEBAC 001CA9EC  38 80 00 04 */	li r4, 4
...
/* 801CEBD0 001CAA10  38 61 00 08 */	addi r3, r1, 8
/* 801CEBD4 001CAA14  38 9E 00 0C */	addi r4, r30, 0xc
/* 801CEBD8 001CAA18  48 23 6E FD */	bl __ct__Q24util11ScopedMutexFRQ24util5Mutex
/* 801CEBDC 001CAA1C  80 1E 00 00 */	lwz r0, 0(r30)
/* 801CEBE0 001CAA20  7C 00 FB 78 */	or r0, r0, r31
/* 801CEBE4 001CAA24  90 1E 00 00 */	stw r0, 0(r30)
/* 801CEBE8 001CAA28  38 61 00 08 */	addi r3, r1, 8
/* 801CEBEC 001CAA2C  38 80 FF FF */	li r4, -1
...
/* 801CEC28 001CAA68  80 03 00 00 */	lwz r0, 0(r3)
/* 801CEC2C 001CAA6C  7C 00 20 38 */	and r0, r0, r4
/* 801CEC30 001CAA70  2C 00 00 00 */	cmpwi r0, 0
/* 801CEC34 001CAA74  41 82 00 30 */	beq lbl_801CEC64
/* 801CEC38 001CAA78  38 61 00 08 */	addi r3, r1, 8
/* 801CEC3C 001CAA7C  38 9E 00 0C */	addi r4, r30, 0xc
/* 801CEC40 001CAA80  48 23 6E 95 */	bl __ct__Q24util11ScopedMutexFRQ24util5Mutex
/* 801CEC44 001CAA84  80 1E 00 00 */	lwz r0, 0(r30)
/* 801CEC48 001CAA88  7C 00 F8 78 */	andc r0, r0, r31
/* 801CEC4C 001CAA8C  90 1E 00 00 */	stw r0, 0(r30)
/* 801CEC50 001CAA90  38 61 00 08 */	addi r3, r1, 8
/* 801CEC54 001CAA94  38 80 FF FF */	li r4, -1
/* 801CEC58 001CAA98  48 23 6E B5 */	bl __dt__Q24util11ScopedMutexFv
/* 801CEC5C 001CAA9C  38 60 00 01 */	li r3, 1
/* 801CEC60 001CAAA0  48 00 00 08 */	b lbl_801CEC68
lbl_801CEC64:
/* 801CEC64 001CAAA4  38 60 00 00 */	li r3, 0
lbl_801CEC68:
