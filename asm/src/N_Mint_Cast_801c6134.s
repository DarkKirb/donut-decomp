...
/* 801C6150 001C1F90  4B FD 23 D5 */	bl lbl_80198524
/* 801C6154 001C1F94  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801C6158 001C1F98  80 9F 00 08 */	lwz r4, 0x8(r31)
/* 801C615C 001C1F9C  48 00 00 7D */	bl lbl_801C61D8
/* 801C6160 001C1FA0  80 03 00 00 */	lwz r0, 0x0(r3)
/* 801C6164 001C1FA4  C8 22 9C 58 */	lfd f1, lbl_8055FBD8@sda21(r2)
...
/* 801C618C 001C1FCC  3C 60 80 46 */	lis r3, lbl_8045BD04@ha
/* 801C6190 001C1FD0  38 63 BD 04 */	addi r3, r3, lbl_8045BD04@l
/* 801C6194 001C1FD4  38 80 00 5A */	li r4, 0x5a
/* 801C6198 001C1FD8  3C A0 80 46 */	lis r5, lbl_8045BCF0@ha
/* 801C619C 001C1FDC  38 A5 BC F0 */	addi r5, r5, lbl_8045BCF0@l
/* 801C61A0 001C1FE0  4C C6 31 82 */	crclr 4*cr1+eq
/* 801C61A4 001C1FE4  4B FF FE 01 */	bl lbl_801C5FA4
.global lbl_801C61A8
lbl_801C61A8:
/* 801C61A8 001C1FE8  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801C61AC 001C1FEC  38 80 00 00 */	li r4, 0x0
/* 801C61B0 001C1FF0  4B FC 56 29 */	bl lbl_8018B7D8
...
/* 801C6200 001C2040  3C 60 80 45 */	lis r3, lbl_80454F98@ha
/* 801C6204 001C2044  38 63 4F 98 */	addi r3, r3, lbl_80454F98@l
/* 801C6208 001C2048  38 80 00 49 */	li r4, 0x49
/* 801C620C 001C204C  3C A0 80 45 */	lis r5, lbl_80454F80@ha
/* 801C6210 001C2050  38 A5 4F 80 */	addi r5, r5, lbl_80454F80@l
/* 801C6214 001C2054  7F E6 FB 78 */	mr r6, r31
/* 801C6218 001C2058  4C C6 31 82 */	crclr 4*cr1+eq
/* 801C621C 001C205C  4B FF FD 89 */	bl lbl_801C5FA4
.global lbl_801C6220
lbl_801C6220:
...
/* 801C625C 001C209C  4B FD 22 C9 */	bl lbl_80198524
/* 801C6260 001C20A0  80 7E 00 00 */	lwz r3, 0x0(r30)
/* 801C6264 001C20A4  80 9E 00 08 */	lwz r4, 0x8(r30)
/* 801C6268 001C20A8  4B FF FF 71 */	bl lbl_801C61D8
...
/* 801C6288 001C20C8  3C 60 80 46 */	lis r3, lbl_8045BCDC@ha
/* 801C628C 001C20CC  38 63 BC DC */	addi r3, r3, lbl_8045BCDC@l
/* 801C6290 001C20D0  38 80 00 59 */	li r4, 0x59
/* 801C6294 001C20D4  3C A0 80 46 */	lis r5, lbl_8045BCC8@ha
/* 801C6298 001C20D8  38 A5 BC C8 */	addi r5, r5, lbl_8045BCC8@l
/* 801C629C 001C20DC  4C C6 31 82 */	crclr 4*cr1+eq
/* 801C62A0 001C20E0  4B FF FD 05 */	bl lbl_801C5FA4
.global lbl_801C62A4
lbl_801C62A4:
/* 801C62A4 001C20E4  80 7E 00 00 */	lwz r3, 0x0(r30)
/* 801C62A8 001C20E8  38 80 00 00 */	li r4, 0x0
/* 801C62AC 001C20EC  4B FC 55 2D */	bl lbl_8018B7D8
