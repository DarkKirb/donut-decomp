...
/* 803D7BB4 003D39F4  48 00 35 7D */	bl lbl_803DB130
/* 803D7BB8 003D39F8  7C 7E 1B 78 */	mr r30, r3
/* 803D7BBC 003D39FC  80 63 04 88 */	lwz r3, 0x488(r3)
/* 803D7BC0 003D3A00  4B DF C6 D1 */	bl lbl_801D4290
...
/* 803D7BD0 003D3A10  4B DF C7 DD */	bl lbl_801D43AC
...
/* 803D7BE0 003D3A20  4B DF C7 A9 */	bl lbl_801D4388
/* 803D7BE4 003D3A24  7C 7F 1B 78 */	mr r31, r3
/* 803D7BE8 003D3A28  80 7D 00 00 */	lwz r3, 0x0(r29)
/* 803D7BEC 003D3A2C  48 00 35 65 */	bl lbl_803DB150
/* 803D7BF0 003D3A30  7F E4 FB 78 */	mr r4, r31
/* 803D7BF4 003D3A34  4B E9 71 CD */	bl lbl_8026EDC0
.global lbl_803D7BF8
lbl_803D7BF8:
/* 803D7BF8 003D3A38  80 7E 04 88 */	lwz r3, 0x488(r30)
/* 803D7BFC 003D3A3C  4B DF C8 CD */	bl lbl_801D44C8
...
/* 803D7C0C 003D3A4C  4B C9 DB 25 */	bl lbl_80075730
/* 803D7C10 003D3A50  4B E4 8E A9 */	bl lbl_80220AB8
/* 803D7C14 003D3A54  38 80 00 01 */	li r4, 0x1
/* 803D7C18 003D3A58  4B E8 C0 21 */	bl lbl_80263C38
/* 803D7C1C 003D3A5C  80 7D 00 00 */	lwz r3, 0x0(r29)
/* 803D7C20 003D3A60  48 00 35 31 */	bl lbl_803DB150
/* 803D7C24 003D3A64  38 80 00 06 */	li r4, 0x6
/* 803D7C28 003D3A68  4B E9 71 99 */	bl lbl_8026EDC0
.global lbl_803D7C2C
lbl_803D7C2C:
