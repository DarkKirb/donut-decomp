...
/* 803C4E40 003C0C80  3C A0 80 49 */	lis r5, lbl_80491EE8@ha
/* 803C4E44 003C0C84  38 05 1E E8 */	addi r0, r5, lbl_80491EE8@l
...
/* 803C4E54 003C0C94  4B CB 08 DD */	bl lbl_80075730
/* 803C4E58 003C0C98  4B E2 A0 79 */	bl lbl_801EEED0
...
/* 803C4E68 003C0CA8  48 00 5D 55 */	bl lbl_803CABBC
/* 803C4E6C 003C0CAC  38 7F 00 08 */	addi r3, r31, 0x8
/* 803C4E70 003C0CB0  7F E4 FB 78 */	mr r4, r31
/* 803C4E74 003C0CB4  48 00 5E 0D */	bl lbl_803CAC80
...
/* 803C4EB4 003C0CF4  3C 80 80 49 */	lis r4, lbl_80491EE8@ha
/* 803C4EB8 003C0CF8  38 04 1E E8 */	addi r0, r4, lbl_80491EE8@l
...
/* 803C4EF4 003C0D34  4B DF A8 21 */	bl lbl_801BF714
.global lbl_803C4EF8
lbl_803C4EF8:
...
/* 803C4F3C 003C0D7C  4B FF DD CD */	bl lbl_803C2D08
/* 803C4F40 003C0D80  4B EA DF 69 */	bl lbl_80272EA8
...
/* 803C4F78 003C0DB8  4B FF DD 91 */	bl lbl_803C2D08
/* 803C4F7C 003C0DBC  4B EA DF 35 */	bl lbl_80272EB0
...
/* 803C4FC8 003C0E08  4B FF DD 29 */	bl lbl_803C2CF0
/* 803C4FCC 003C0E0C  4B EA 93 4D */	bl lbl_8026E318
/* 803C4FD0 003C0E10  80 7F 00 04 */	lwz r3, 0x4(r31)
/* 803C4FD4 003C0E14  4B FF DD 25 */	bl lbl_803C2CF8
/* 803C4FD8 003C0E18  4B EA 93 41 */	bl lbl_8026E318
/* 803C4FDC 003C0E1C  80 7F 00 04 */	lwz r3, 0x4(r31)
/* 803C4FE0 003C0E20  4B FF DD 21 */	bl lbl_803C2D00
/* 803C4FE4 003C0E24  4B EA 93 35 */	bl lbl_8026E318
/* 803C4FE8 003C0E28  80 7F 00 04 */	lwz r3, 0x4(r31)
/* 803C4FEC 003C0E2C  4B FF DC FD */	bl lbl_803C2CE8
/* 803C4FF0 003C0E30  4B EA 93 29 */	bl lbl_8026E318
...
/* 803C5020 003C0E60  4B FF DC C9 */	bl lbl_803C2CE8
/* 803C5024 003C0E64  4B EA 92 FD */	bl lbl_8026E320
/* 803C5028 003C0E68  80 7F 00 04 */	lwz r3, 0x4(r31)
/* 803C502C 003C0E6C  4B FF DC C5 */	bl lbl_803C2CF0
/* 803C5030 003C0E70  4B EA 92 F1 */	bl lbl_8026E320
/* 803C5034 003C0E74  80 7F 00 04 */	lwz r3, 0x4(r31)
/* 803C5038 003C0E78  4B FF DC C1 */	bl lbl_803C2CF8
/* 803C503C 003C0E7C  4B EA 92 E5 */	bl lbl_8026E320
/* 803C5040 003C0E80  80 7F 00 04 */	lwz r3, 0x4(r31)
/* 803C5044 003C0E84  4B FF DC BD */	bl lbl_803C2D00
/* 803C5048 003C0E88  4B EA 92 D9 */	bl lbl_8026E320
