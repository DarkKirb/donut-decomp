...
/* 801D8170 001D3FB0  93 C1 00 08 */	stw r30, 0x8(r1)
/* 801D8174 001D3FB4  7C 7E 1B 78 */	mr r30, r3
/* 801D8178 001D3FB8  7C BF 2B 78 */	mr r31, r5
/* 801D817C 001D3FBC  90 83 00 00 */	stw r4, 0x0(r3)
/* 801D8180 001D3FC0  90 C3 00 04 */	stw r6, 0x4(r3)
/* 801D8184 001D3FC4  7C 83 23 78 */	mr r3, r4
/* 801D8188 001D3FC8  4B FF F6 45 */	bl lbl_801D77CC
/* 801D818C 001D3FCC  90 9E 00 0C */	stw r4, 0xc(r30)
/* 801D8190 001D3FD0  90 7E 00 08 */	stw r3, 0x8(r30)
...
/* 801D81A0 001D3FE0  38 00 00 00 */	li r0, 0x0
...
/* 801D81BC 001D3FFC  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 801D81E0 001D4020  93 C1 00 08 */	stw r30, 0x8(r1)
/* 801D81E4 001D4024  7C 7E 1B 78 */	mr r30, r3
/* 801D81E8 001D4028  7C BF 2B 78 */	mr r31, r5
/* 801D81EC 001D402C  90 83 00 00 */	stw r4, 0x0(r3)
/* 801D81F0 001D4030  90 C3 00 04 */	stw r6, 0x4(r3)
/* 801D81F4 001D4034  7C 83 23 78 */	mr r3, r4
/* 801D81F8 001D4038  4B FF F5 D5 */	bl lbl_801D77CC
/* 801D81FC 001D403C  90 9E 00 0C */	stw r4, 0xc(r30)
/* 801D8200 001D4040  90 7E 00 08 */	stw r3, 0x8(r30)
/* 801D8204 001D4044  7F E3 FB 78 */	mr r3, r31
/* 801D8208 001D4048  48 00 00 69 */	bl lbl_801D8270
...
/* 801D8218 001D4058  48 00 00 81 */	bl lbl_801D8298
/* 801D821C 001D405C  90 7E 00 18 */	stw r3, 0x18(r30)
/* 801D8220 001D4060  38 00 00 00 */	li r0, 0x0
/* 801D8224 001D4064  98 1E 00 1C */	stb r0, 0x1c(r30)
/* 801D8228 001D4068  7F E3 FB 78 */	mr r3, r31
/* 801D822C 001D406C  48 00 00 45 */	bl lbl_801D8270
...
/* 801D823C 001D407C  48 00 00 5D */	bl lbl_801D8298
...
/* 801D824C 001D408C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 801D8264 001D40A4  80 63 00 08 */	lwz r3, 0x8(r3)
...
/* 801D8278 001D40B8  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 801D829C 001D40DC  2C 00 00 00 */	cmpwi r0, 0x0
...
.global lbl_801D830C
lbl_801D830C:
/* 801D830C 001D414C  38 00 00 00 */	li r0, 0x0
