...
/* 801DC468 001D82A8  4B E2 AE D1 */	bl func_80007338
...
/* 801DC47C 001D82BC  3C A0 80 46 */	lis r5, $$252590@ha
/* 801DC480 001D82C0  3B C5 D7 68 */	addi r30, r5, $$252590@l
...
/* 801DC48C 001D82CC  90 03 00 00 */	stw r0, 0(r3)
/* 801DC490 001D82D0  90 83 00 04 */	stw r4, 4(r3)
...
/* 801DC4A0 001D82E0  38 60 00 02 */	li r3, 2
...
/* 801DC4B0 001D82F0  38 BE 00 00 */	addi r5, r30, 0
...
/* 801DC4C0 001D8300  38 7A 00 08 */	addi r3, r26, 8
/* 801DC4C4 001D8304  4B FC FC CD */	bl __ct__Q23lyt6LayoutFRCQ23lyt13LayoutContext
/* 801DC4C8 001D8308  38 00 00 00 */	li r0, 0
...
/* 801DC4E8 001D8328  4C C6 31 82 */	crclr 6
/* 801DC4EC 001D832C  4B FA A6 35 */	bl FromFormat__Q33hel6common19FixedStringIN$$0c$$480$$1FPCce
/* 801DC4F0 001D8330  38 81 01 C0 */	addi r4, r1, 0x1c0
/* 801DC4F4 001D8334  38 61 00 08 */	addi r3, r1, 8
/* 801DC4F8 001D8338  38 A0 00 00 */	li r5, 0
...
/* 801DC50C 001D834C  4C C6 31 82 */	crclr 6
/* 801DC510 001D8350  4B FA A6 11 */	bl FromFormat__Q33hel6common19FixedStringIN$$0c$$480$$1FPCce
/* 801DC514 001D8354  3B C1 01 70 */	addi r30, r1, 0x170
/* 801DC518 001D8358  38 61 00 08 */	addi r3, r1, 8
...
/* 801DC534 001D8374  38 C0 00 00 */	li r6, 0
/* 801DC538 001D8378  4B FA C2 21 */	bl addFile__Q24file8FileTreeFRCQ23mem8MemBlockPCcPCQ24file16IFileInitializer
/* 801DC53C 001D837C  38 61 00 08 */	addi r3, r1, 8
/* 801DC540 001D8380  38 80 FF FF */	li r4, -1
/* 801DC544 001D8384  4B F9 8A C1 */	bl __dt__Q33hel6common31ExplicitSingleton$$0Q23app5Reset$$1Fv
...
/* 801DC55C 001D839C  38 AD 94 78 */	addi r5, r13, $$252593-_SDA_BASE_
...
/* 801DC568 001D83A8  38 83 FF FC */	addi r4, r3, -4
/* 801DC56C 001D83AC  38 00 00 0C */	li r0, 0xc
/* 801DC570 001D83B0  7C 09 03 A6 */	mtctr r0
lbl_801DC574:
/* 801DC574 001D83B4  80 64 00 04 */	lwz r3, 4(r4)
/* 801DC578 001D83B8  84 04 00 08 */	lwzu r0, 8(r4)
/* 801DC57C 001D83BC  90 65 00 04 */	stw r3, 4(r5)
/* 801DC580 001D83C0  94 05 00 08 */	stwu r0, 8(r5)
/* 801DC584 001D83C4  42 00 FF F0 */	bdnz lbl_801DC574
/* 801DC588 001D83C8  80 04 00 04 */	lwz r0, 4(r4)
/* 801DC58C 001D83CC  90 05 00 04 */	stw r0, 4(r5)
/* 801DC590 001D83D0  38 7A 01 D8 */	addi r3, r26, 0x1d8
/* 801DC594 001D83D4  4B F9 F1 61 */	bl destruct__Q24util27PlacementNew$$0Q23lyt6Layout$$1Fv
/* 801DC598 001D83D8  38 7A 01 DC */	addi r3, r26, 0x1dc
/* 801DC59C 001D83DC  2C 03 00 00 */	cmpwi r3, 0
...
/* 801DC5B4 001D83F4  38 9A 00 08 */	addi r4, r26, 8
/* 801DC5B8 001D83F8  38 AD 94 80 */	addi r5, r13, $$252594-_SDA_BASE_
...
/* 801DC5D0 001D8410  38 80 FF FF */	li r4, -1
/* 801DC5D4 001D8414  4B F9 BC 4D */	bl __dt__Q23lyt12PaneAccessorFv
/* 801DC5D8 001D8418  38 61 00 20 */	addi r3, r1, 0x20
/* 801DC5DC 001D841C  38 9A 00 08 */	addi r4, r26, 8
/* 801DC5E0 001D8420  38 AD 94 88 */	addi r5, r13, $$252595-_SDA_BASE_
...
/* 801DC628 001D8468  38 80 FF FF */	li r4, -1
...
/* 801DC638 001D8478  4B E2 AD 4D */	bl func_80007384
...
/* 801DC65C 001D849C  38 61 00 08 */	addi r3, r1, 8
/* 801DC660 001D84A0  80 84 00 04 */	lwz r4, 4(r4)
/* 801DC664 001D84A4  4B FF EB AD */	bl contextOpen__Q25pause9ComponentCFv
/* 801DC668 001D84A8  38 61 00 08 */	addi r3, r1, 8
...
/* 801DC684 001D84C4  38 8D 94 90 */	addi r4, r13, $$252654-_SDA_BASE_
/* 801DC688 001D84C8  4C C6 31 82 */	crclr 6
/* 801DC68C 001D84CC  4B F9 CB A1 */	bl FromFormat__Q33hel6common19FixedStringIN$$0c$$432$$1FPCce
...
/* 801DC6AC 001D84EC  38 63 00 08 */	addi r3, r3, 8
...
/* 801DC720 001D8560  83 C1 00 08 */	lwz r30, 8(r1)
...
__vt__Q25pause11PageAbility:
	.4byte 0
	.4byte 0
	.4byte __dt__Q25pause11PageAbilityFv
	.4byte pageFrameTitle__Q25pause11PageAbilityCFv
	.4byte pageMainLayout__Q25pause11PageAbilityFv
	.4byte pageProcAnim__Q25pause11PageAbilityFv
	.4byte pageProcHID__Q25pause11PageAbilityFv
	.4byte pageIsBusy__Q25pause11PageAbilityCFv
