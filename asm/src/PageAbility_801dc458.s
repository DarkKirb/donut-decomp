...
/* 801DC47C 001D82BC  3C A0 80 46 */	lis r5, lbl_8045D768@ha
/* 801DC480 001D82C0  3B C5 D7 68 */	addi r30, r5, lbl_8045D768@l
/* 801DC484 001D82C4  3C A0 80 46 */	lis r5, lbl_8045D7A0@ha
/* 801DC488 001D82C8  38 05 D7 A0 */	addi r0, r5, lbl_8045D7A0@l
...
/* 801DC498 001D82D8  4B FF ED A5 */	bl lbl_801DB23C
/* 801DC49C 001D82DC  7C 7F 1B 78 */	mr r31, r3
/* 801DC4A0 001D82E0  38 60 00 02 */	li r3, 0x2
/* 801DC4A4 001D82E4  4B FF ED F5 */	bl lbl_801DB298
...
/* 801DC4B8 001D82F8  4B FD 18 AD */	bl lbl_801ADD64
/* 801DC4BC 001D82FC  7C 64 1B 78 */	mr r4, r3
/* 801DC4C0 001D8300  38 7A 00 08 */	addi r3, r26, 0x8
/* 801DC4C4 001D8304  4B FC FC CD */	bl lbl_801AC190
...
/* 801DC4D8 001D8318  4B FF FB 21 */	bl lbl_801DBFF8
...
/* 801DC4EC 001D832C  4B FA A6 35 */	bl lbl_80186B20
...
/* 801DC4FC 001D833C  4B FA B5 55 */	bl lbl_80187A50
...
/* 801DC538 001D8378  4B FA C2 21 */	bl lbl_80188758
/* 801DC53C 001D837C  38 61 00 08 */	addi r3, r1, 0x8
/* 801DC540 001D8380  38 80 FF FF */	li r4, -0x1
/* 801DC544 001D8384  4B F9 8A C1 */	bl lbl_80175004
/* 801DC548 001D8388  7F 63 DB 78 */	mr r3, r27
/* 801DC54C 001D838C  4B FF EC F1 */	bl lbl_801DB23C
...
/* 801DC55C 001D839C  38 AD 94 78 */	addi r5, r13, lbl_80557898@sda21
/* 801DC560 001D83A0  4B FD 18 05 */	bl lbl_801ADD64
...
/* 801DC594 001D83D4  4B F9 F1 61 */	bl lbl_8017B6F4
...
/* 801DC5A8 001D83E8  4B FC FB E9 */	bl lbl_801AC190
.global lbl_801DC5AC
lbl_801DC5AC:
...
/* 801DC5B8 001D83F8  38 AD 94 80 */	addi r5, r13, lbl_805578A0@sda21
/* 801DC5BC 001D83FC  4B FD 08 59 */	bl lbl_801ACE14
/* 801DC5C0 001D8400  80 7A 01 D8 */	lwz r3, 0x1d8(r26)
/* 801DC5C4 001D8404  38 81 00 34 */	addi r4, r1, 0x34
/* 801DC5C8 001D8408  4B FD 0B 71 */	bl lbl_801AD138
/* 801DC5CC 001D840C  38 61 00 34 */	addi r3, r1, 0x34
/* 801DC5D0 001D8410  38 80 FF FF */	li r4, -0x1
/* 801DC5D4 001D8414  4B F9 BC 4D */	bl lbl_80178220
/* 801DC5D8 001D8418  38 61 00 20 */	addi r3, r1, 0x20
/* 801DC5DC 001D841C  38 9A 00 08 */	addi r4, r26, 0x8
/* 801DC5E0 001D8420  38 AD 94 88 */	addi r5, r13, lbl_805578A8@sda21
/* 801DC5E4 001D8424  4B FD 08 31 */	bl lbl_801ACE14
/* 801DC5E8 001D8428  7F 63 DB 78 */	mr r3, r27
/* 801DC5EC 001D842C  4B FF EC 15 */	bl lbl_801DB200
...
/* 801DC5FC 001D843C  4B F2 41 E5 */	bl lbl_801007E0
...
.global lbl_801DC6A8
lbl_801DC6A8:
/* 801DC6A8 001D84E8  4B FE 15 B0 */	b lbl_801BDC58

.global lbl_801DC6AC
lbl_801DC6AC:
/* 801DC6AC 001D84EC  38 63 00 08 */	addi r3, r3, 0x8
/* 801DC6B0 001D84F0  4B FD 0A 08 */	b lbl_801AD0B8
...
.global lbl_801DC6B8
lbl_801DC6B8:
/* 801DC6B8 001D84F8  4B E7 77 38 */	b lbl_80053DF0
...
/* 801DC714 001D8554  4B FE 30 01 */	bl lbl_801BF714
.global lbl_801DC718
lbl_801DC718:
