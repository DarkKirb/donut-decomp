...
/* 801ADFDC 001A9E1C  48 08 BF A9 */	bl lbl_80239F84
...
/* 801AE020 001A9E60  4B FF EC DD */	bl lbl_801ACCFC
/* 801AE024 001A9E64  7F A3 EB 78 */	mr r3, r29
/* 801AE028 001A9E68  48 08 BF 5D */	bl lbl_80239F84
/* 801AE02C 001A9E6C  7F A3 EB 78 */	mr r3, r29
/* 801AE030 001A9E70  4B FC E5 B5 */	bl lbl_8017C5E4
...
/* 801AE040 001A9E80  4B FF DB 91 */	bl lbl_801ABBD0
.global lbl_801AE044
lbl_801AE044:
...
/* 801AE050 001A9E90  4B FD A6 79 */	bl lbl_801886C8
...
/* 801AE068 001A9EA8  4B FC E5 7D */	bl lbl_8017C5E4
...
/* 801AE088 001A9EC8  4B FF DB 95 */	bl lbl_801ABC1C
...
/* 801AE098 001A9ED8  4B F7 1D 19 */	bl lbl_8011FDB0
.global lbl_801AE09C
lbl_801AE09C:
/* 801AE09C 001A9EDC  38 61 00 10 */	addi r3, r1, 0x10
/* 801AE0A0 001A9EE0  38 80 FF FF */	li r4, -0x1
/* 801AE0A4 001A9EE4  4B FC A1 D9 */	bl lbl_8017827C
...
/* 801AE0CC 001A9F0C  48 00 00 04 */	b lbl_801AE0D0
.global lbl_801AE0D0
lbl_801AE0D0:
...
/* 801AE0E8 001A9F28  3B ED EB 98 */	addi r31, r13, lbl_8055CFB8@sda21
...
/* 801AE108 001A9F48  48 00 00 31 */	bl lbl_801AE138
...
/* 801AE19C 001A9FDC  4B FF FC 5D */	bl lbl_801ADDF8
...
/* 801AE224 001AA064  48 00 00 41 */	bl lbl_801AE264
/* 801AE228 001AA068  C0 02 9A 10 */	lfs f0, lbl_8055F990@sda21(r2)
...
/* 801AE274 001AA0B4  4B E8 22 9C */	b lbl_80030510
.global lbl_801AE278
lbl_801AE278:
...
/* 801AE284 001AA0C4  48 00 00 04 */	b lbl_801AE288
.global lbl_801AE288
lbl_801AE288:
...
/* 801AE2B8 001AA0F8  48 00 00 04 */	b lbl_801AE2BC
.global lbl_801AE2BC
lbl_801AE2BC:
...
/* 801AE328 001AA168  4B FF 10 81 */	bl lbl_8019F3A8
...
.global lbl_801AE364
lbl_801AE364:
/* 801AE364 001AA1A4  48 00 00 C4 */	b lbl_801AE428
.global lbl_801AE368
lbl_801AE368:
...
/* 801AE388 001AA1C8  48 25 74 E5 */	bl lbl_8040586C
...
/* 801AE39C 001AA1DC  48 00 00 8D */	bl lbl_801AE428
.global lbl_801AE3A0
lbl_801AE3A0:
...
/* 801AE3D0 001AA210  48 00 00 59 */	bl lbl_801AE428
/* 801AE3D4 001AA214  80 7F 00 10 */	lwz r3, 0x10(r31)
/* 801AE3D8 001AA218  4B FF FC F9 */	bl lbl_801AE0D0
...
/* 801AE3F0 001AA230  48 00 1B 59 */	bl lbl_801AFF48
...
/* 801AE408 001AA248  C0 02 9A 10 */	lfs f0, lbl_8055F990@sda21(r2)
...
/* 801AE448 001AA288  4B FF FC 89 */	bl lbl_801AE0D0
...
/* 801AE498 001AA2D8  4B FF DC 91 */	bl lbl_801AC128
...
/* 801AE4EC 001AA32C  4B FF FB E5 */	bl lbl_801AE0D0
...
/* 801AE4FC 001AA33C  C0 0D EE 28 */	lfs f0, lbl_8055D248@sda21(r13)
/* 801AE500 001AA340  D0 1F 00 00 */	stfs f0, 0x0(r31)
/* 801AE504 001AA344  38 6D EE 28 */	addi r3, r13, lbl_8055D248@sda21
...
/* 801AE518 001AA358  4B F4 73 59 */	bl lbl_800F5870
...
/* 801AE538 001AA378  4B FF 0E 71 */	bl lbl_8019F3A8
.global lbl_801AE53C
lbl_801AE53C:
