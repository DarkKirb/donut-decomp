...
/* 803537A0 0034F5E0  90 83 00 00 */	stw r4, 0(r3)
/* 803537A4 0034F5E4  38 00 00 00 */	li r0, 0
/* 803537A8 0034F5E8  90 03 00 04 */	stw r0, 4(r3)
/* 803537AC 0034F5EC  C0 02 CE 90 */	lfs f0, $$252532-_SDA2_BASE_(r2)
/* 803537B0 0034F5F0  D0 03 00 08 */	stfs f0, 8(r3)
...
/* 803537D4 0034F614  93 C1 00 08 */	stw r30, 8(r1)
/* 803537D8 0034F618  7C 7E 1B 78 */	mr r30, r3
/* 803537DC 0034F61C  C0 03 00 08 */	lfs f0, 8(r3)
/* 803537E0 0034F620  D0 03 00 0C */	stfs f0, 0xc(r3)
/* 803537E4 0034F624  80 63 00 00 */	lwz r3, 0(r3)
...
/* 803537F0 0034F630  D0 3E 00 08 */	stfs f1, 8(r30)
/* 803537F4 0034F634  80 7E 00 04 */	lwz r3, 4(r30)
/* 803537F8 0034F638  38 03 00 01 */	addi r0, r3, 1
/* 803537FC 0034F63C  90 1E 00 04 */	stw r0, 4(r30)
/* 80353800 0034F640  28 00 00 20 */	cmplwi r0, 0x20
/* 80353804 0034F644  41 80 00 0C */	blt lbl_80353810
/* 80353808 0034F648  38 00 00 00 */	li r0, 0
/* 8035380C 0034F64C  90 1E 00 04 */	stw r0, 4(r30)
lbl_80353810:
/* 80353810 0034F650  88 1E 00 11 */	lbz r0, 0x11(r30)
/* 80353814 0034F654  2C 00 00 00 */	cmpwi r0, 0
...
/* 8035383C 0034F67C  80 7E 00 00 */	lwz r3, 0(r30)
...
/* 80353860 0034F6A0  2C 03 00 00 */	cmpwi r3, 0
...
/* 80353870 0034F6B0  2C 03 00 00 */	cmpwi r3, 0
...
/* 80353880 0034F6C0  2C 03 00 00 */	cmpwi r3, 0
...
/* 80353890 0034F6D0  2C 03 00 00 */	cmpwi r3, 0
...
/* 803538A4 0034F6E4  80 7E 00 00 */	lwz r3, 0(r30)
...
/* 803538BC 0034F6FC  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 803538E4 0034F724  80 63 00 00 */	lwz r3, 0(r3)
...
/* 803538F4 0034F734  C0 1F 00 08 */	lfs f0, 8(r31)
/* 803538F8 0034F738  FC 00 08 40 */	fcmpo cr0, f0, f1
/* 803538FC 0034F73C  4C 40 13 82 */	cror 2, 0, 2
/* 80353900 0034F740  7C 60 00 26 */	mfcr r3
/* 80353904 0034F744  54 63 1F FE */	rlwinm r3, r3, 3, 0x1f, 0x1f
...
/* 80353930 0034F770  80 63 00 00 */	lwz r3, 0(r3)
...
/* 80353948 0034F788  4C 40 13 82 */	cror 2, 0, 2
/* 8035394C 0034F78C  7C 60 00 26 */	mfcr r3
/* 80353950 0034F790  54 63 1F FE */	rlwinm r3, r3, 3, 0x1f, 0x1f
...
/* 8035397C 0034F7BC  80 63 00 00 */	lwz r3, 0(r3)
...
/* 8035398C 0034F7CC  C0 02 CE 94 */	lfs f0, $$252551-_SDA2_BASE_(r2)
/* 80353990 0034F7D0  EC 20 00 72 */	fmuls f1, f0, f1
/* 80353994 0034F7D4  C0 1F 00 08 */	lfs f0, 8(r31)
/* 80353998 0034F7D8  FC 00 08 40 */	fcmpo cr0, f0, f1
/* 8035399C 0034F7DC  4C 40 13 82 */	cror 2, 0, 2
/* 803539A0 0034F7E0  7C 60 00 26 */	mfcr r3
/* 803539A4 0034F7E4  54 63 1F FE */	rlwinm r3, r3, 3, 0x1f, 0x1f
...
/* 803539D4 0034F814  3B E0 00 00 */	li r31, 0
/* 803539D8 0034F818  4B FF FF 91 */	bl isCritical__Q43scn4step4hero5PinchCFv
/* 803539DC 0034F81C  2C 03 00 00 */	cmpwi r3, 0
/* 803539E0 0034F820  41 82 00 1C */	beq lbl_803539FC
/* 803539E4 0034F824  80 1E 00 04 */	lwz r0, 4(r30)
/* 803539E8 0034F828  54 00 10 3A */	slwi r0, r0, 2
/* 803539EC 0034F82C  3C 60 80 42 */	lis r3, T_ALPHA_TABLE_2__19$$2unnamed$$2Pinch_cpp$$2@ha
/* 803539F0 0034F830  38 63 A2 A8 */	addi r3, r3, T_ALPHA_TABLE_2__19$$2unnamed$$2Pinch_cpp$$2@l
...
/* 80353A04 0034F844  2C 03 00 00 */	cmpwi r3, 0
/* 80353A08 0034F848  41 82 00 18 */	beq lbl_80353A20
/* 80353A0C 0034F84C  80 1E 00 04 */	lwz r0, 4(r30)
/* 80353A10 0034F850  54 00 10 3A */	slwi r0, r0, 2
/* 80353A14 0034F854  3C 60 80 42 */	lis r3, T_ALPHA_TABLE_1__19$$2unnamed$$2Pinch_cpp$$2@ha
/* 80353A18 0034F858  38 63 A2 28 */	addi r3, r3, T_ALPHA_TABLE_1__19$$2unnamed$$2Pinch_cpp$$2@l
/* 80353A1C 0034F85C  7F E3 00 2E */	lwzx r31, r3, r0
lbl_80353A20:
/* 80353A20 0034F860  38 00 00 FF */	li r0, 0xff
/* 80353A24 0034F864  98 01 00 08 */	stb r0, 8(r1)
/* 80353A28 0034F868  38 00 00 00 */	li r0, 0
/* 80353A2C 0034F86C  98 01 00 09 */	stb r0, 9(r1)
/* 80353A30 0034F870  98 01 00 0A */	stb r0, 0xa(r1)
/* 80353A34 0034F874  57 E0 06 3E */	clrlwi r0, r31, 0x18
/* 80353A38 0034F878  98 01 00 0B */	stb r0, 0xb(r1)
/* 80353A3C 0034F87C  80 61 00 08 */	lwz r3, 8(r1)
