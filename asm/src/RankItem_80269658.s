...
/* 802696A8 002654E8  4B D9 DC 79 */	bl lbl_80007320
...
/* 802696FC 0026553C  3A A0 00 00 */	li r21, 0x0
/* 80269700 00265540  3A E0 00 00 */	li r23, 0x0
.global lbl_80269704
lbl_80269704:
...
/* 80269738 00265578  3A F7 00 04 */	addi r23, r23, 0x4
/* 8026973C 0026557C  2C 15 00 03 */	cmpwi r21, 0x3
/* 80269740 00265580  41 80 FF C4 */	blt lbl_80269704
/* 80269744 00265584  3A A0 00 00 */	li r21, 0x0
/* 80269748 00265588  3A C0 00 00 */	li r22, 0x0
...
/* 8026975C 0026559C  80 85 00 04 */	lwz r4, 0x4(r5)
...
/* 8026978C 002655CC  3A D6 00 04 */	addi r22, r22, 0x4
.global lbl_80269790
lbl_80269790:
/* 80269790 002655D0  80 19 00 00 */	lwz r0, 0x0(r25)
/* 80269794 002655D4  7C 15 00 00 */	cmpw r21, r0
/* 80269798 002655D8  41 80 FF BC */	blt lbl_80269754
/* 8026979C 002655DC  2C 1B 00 00 */	cmpwi r27, 0x0
...
.global lbl_802697D4
lbl_802697D4:
/* 802697D4 00265614  3A A0 00 00 */	li r21, 0x0
/* 802697D8 00265618  3A C0 00 04 */	li r22, 0x4
...
.global lbl_8026980C
lbl_8026980C:
/* 8026980C 0026564C  80 64 00 04 */	lwz r3, 0x4(r4)
/* 80269810 00265650  84 04 00 08 */	lwzu r0, 0x8(r4)
/* 80269814 00265654  90 65 00 04 */	stw r3, 0x4(r5)
/* 80269818 00265658  94 05 00 08 */	stwu r0, 0x8(r5)
/* 8026981C 0026565C  42 00 FF F0 */	bdnz lbl_8026980C
/* 80269820 00265660  80 04 00 04 */	lwz r0, 0x4(r4)
/* 80269824 00265664  90 05 00 04 */	stw r0, 0x4(r5)
/* 80269828 00265668  80 01 00 58 */	lwz r0, 0x58(r1)
/* 8026982C 0026566C  2C 00 00 00 */	cmpwi r0, 0x0
/* 80269830 00265670  40 81 00 34 */	ble lbl_80269864
/* 80269834 00265674  38 61 00 08 */	addi r3, r1, 0x8
...
.global lbl_80269864
lbl_80269864:
/* 80269864 002656A4  3A B5 00 01 */	addi r21, r21, 0x1
/* 80269868 002656A8  28 15 00 03 */	cmplwi r21, 0x3
/* 8026986C 002656AC  41 80 FF 74 */	blt lbl_802697E0
/* 80269870 002656B0  3A BE FF FF */	addi r21, r30, -0x1
/* 80269874 002656B4  48 00 00 80 */	b lbl_802698F4
.global lbl_80269878
lbl_80269878:
/* 80269878 002656B8  3A E0 00 00 */	li r23, 0x0
/* 8026987C 002656BC  3B 20 00 00 */	li r25, 0x0
...
/* 8026988C 002656CC  80 83 00 00 */	lwz r4, 0x0(r3)
...
/* 8026989C 002656DC  80 03 00 00 */	lwz r0, 0x0(r3)
/* 802698A0 002656E0  90 01 00 48 */	stw r0, 0x48(r1)
/* 802698A4 002656E4  80 03 00 04 */	lwz r0, 0x4(r3)
/* 802698A8 002656E8  90 01 00 4C */	stw r0, 0x4c(r1)
/* 802698AC 002656EC  80 03 00 08 */	lwz r0, 0x8(r3)
...
/* 802698BC 002656FC  38 17 00 01 */	addi r0, r23, 0x1
...
/* 802698F0 00265730  3A B5 FF FF */	addi r21, r21, -0x1
.global lbl_802698F4
lbl_802698F4:
/* 802698F4 00265734  2C 15 00 00 */	cmpwi r21, 0x0
/* 802698F8 00265738  41 81 FF 80 */	bgt lbl_80269878
/* 802698FC 0026573C  38 60 00 40 */	li r3, 0x40
/* 80269900 00265740  38 1E FF FC */	addi r0, r30, -0x4
/* 80269904 00265744  7C 09 03 A6 */	mtctr r0
/* 80269908 00265748  2C 1E 00 04 */	cmpwi r30, 0x4
...
.global lbl_80269938
lbl_80269938:
/* 80269938 00265778  3A A0 00 00 */	li r21, 0x0
/* 8026993C 0026577C  3B 20 00 00 */	li r25, 0x0
.global lbl_80269940
lbl_80269940:
...
/* 80269964 002657A4  4B D9 DA 09 */	bl lbl_8000736C
...
/* 80269984 002657C4  90 03 00 04 */	stw r0, 0x4(r3)
/* 80269988 002657C8  80 04 00 08 */	lwz r0, 0x8(r4)
/* 8026998C 002657CC  90 03 00 08 */	stw r0, 0x8(r3)
