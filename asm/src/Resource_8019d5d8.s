...
/* 8019D5D8 00199418  38 00 00 00 */	li r0, 0x0
/* 8019D5DC 0019941C  98 03 00 00 */	stb r0, 0x0(r3)
/* 8019D5E0 00199420  90 83 00 04 */	stw r4, 0x4(r3)
/* 8019D5E4 00199424  90 03 00 08 */	stw r0, 0x8(r3)
/* 8019D5E8 00199428  98 A3 00 4C */	stb r5, 0x4c(r3)
/* 8019D5EC 0019942C  4E 80 00 20 */	blr
.global "__dt__Q24util30PlacementNew<Q24file8FileTree>Fv"
"__dt__Q24util30PlacementNew<Q24file8FileTree>Fv":
...
/* 8019D600 00199440  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8019D604 00199444  7C 7E 1B 78 */	mr r30, r3
/* 8019D608 00199448  7C 9F 23 78 */	mr r31, r4
/* 8019D60C 0019944C  2C 03 00 00 */	cmpwi r3, 0x0
/* 8019D610 00199450  41 82 00 1C */	beq lbl_8019D62C
/* 8019D614 00199454  48 00 00 35 */	bl "destruct__Q24util30PlacementNew<Q24file8FileTree>Fv"
/* 8019D618 00199458  7F E0 07 34 */	extsh r0, r31
/* 8019D61C 0019945C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8019D634 00199474  83 C1 00 08 */	lwz r30, 0x8(r1)
...
.global "destruct__Q24util30PlacementNew<Q24file8FileTree>Fv"
"destruct__Q24util30PlacementNew<Q24file8FileTree>Fv":
...
/* 8019D65C 0019949C  80 63 00 00 */	lwz r3, 0x0(r3)
/* 8019D660 001994A0  2C 03 00 00 */	cmpwi r3, 0x0
/* 8019D664 001994A4  41 82 00 14 */	beq lbl_8019D678
/* 8019D668 001994A8  38 80 FF FF */	li r4, -0x1
/* 8019D66C 001994AC  4B FE AF 45 */	bl __dt__Q24file8FileTreeFv
/* 8019D670 001994B0  38 00 00 00 */	li r0, 0x0
/* 8019D674 001994B4  90 1F 00 00 */	stw r0, 0x0(r31)
.global lbl_8019D678
lbl_8019D678:
...
/* 8019D69C 001994DC  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8019D6A0 001994E0  7C 7E 1B 78 */	mr r30, r3
/* 8019D6A4 001994E4  7C 9F 23 78 */	mr r31, r4
/* 8019D6A8 001994E8  2C 03 00 00 */	cmpwi r3, 0x0
/* 8019D6AC 001994EC  41 82 00 3C */	beq lbl_8019D6E8
/* 8019D6B0 001994F0  80 63 00 08 */	lwz r3, 0x8(r3)
/* 8019D6B4 001994F4  2C 03 00 00 */	cmpwi r3, 0x0
/* 8019D6B8 001994F8  41 82 00 10 */	beq lbl_8019D6C8
/* 8019D6BC 001994FC  4B FE AF D1 */	bl unsetParent__Q24file8FileTreeFv
/* 8019D6C0 00199500  38 7E 00 08 */	addi r3, r30, 0x8
/* 8019D6C4 00199504  4B FF FF 85 */	bl "destruct__Q24util30PlacementNew<Q24file8FileTree>Fv"
.global lbl_8019D6C8
lbl_8019D6C8:
/* 8019D6C8 00199508  38 7E 00 08 */	addi r3, r30, 0x8
/* 8019D6CC 0019950C  38 80 FF FF */	li r4, -0x1
/* 8019D6D0 00199510  4B FF FF 21 */	bl "__dt__Q24util30PlacementNew<Q24file8FileTree>Fv"
/* 8019D6D4 00199514  7F E0 07 34 */	extsh r0, r31
/* 8019D6D8 00199518  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8019D6F0 00199530  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8019D714 00199554  4B E6 9C 2D */	bl lbl_80007340
/* 8019D718 00199558  7C 7C 1B 78 */	mr r28, r3
/* 8019D71C 0019955C  88 03 00 00 */	lbz r0, 0x0(r3)
/* 8019D720 00199560  2C 00 00 00 */	cmpwi r0, 0x0
/* 8019D724 00199564  40 82 00 F8 */	bne lbl_8019D81C
/* 8019D728 00199568  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8019D72C 0019956C  4B E8 6D 75 */	bl DefaultSwitchThreadCallback
/* 8019D730 00199570  7C 7E 1B 78 */	mr r30, r3
/* 8019D734 00199574  80 7C 00 04 */	lwz r3, 0x4(r28)
/* 8019D738 00199578  4B E8 6D 69 */	bl DefaultSwitchThreadCallback
/* 8019D73C 0019957C  7C 7F 1B 78 */	mr r31, r3
/* 8019D740 00199580  38 7C 00 08 */	addi r3, r28, 0x8
/* 8019D744 00199584  4B FF FF 05 */	bl "destruct__Q24util30PlacementNew<Q24file8FileTree>Fv"
/* 8019D748 00199588  3B BC 00 0C */	addi r29, r28, 0xc
/* 8019D74C 0019958C  2C 1D 00 00 */	cmpwi r29, 0x0
...
/* 8019D764 001995A4  38 E0 00 00 */	li r7, 0x0
...
.global lbl_8019D770
lbl_8019D770:
/* 8019D770 001995B0  93 BC 00 08 */	stw r29, 0x8(r28)
/* 8019D774 001995B4  80 6D ED 10 */	lwz r3, "object___Q33hel6common38ExplicitSingleton<Q23app11Application>"@sda21(r13)
...
/* 8019D790 001995D0  54 64 06 3E */	clrlwi r4, r3, 24
/* 8019D794 001995D4  38 04 FF FD */	addi r0, r4, -0x3
/* 8019D798 001995D8  28 00 00 01 */	cmplwi r0, 0x1
/* 8019D79C 001995DC  40 81 00 10 */	ble lbl_8019D7AC
/* 8019D7A0 001995E0  2C 04 00 01 */	cmpwi r4, 0x1
/* 8019D7A4 001995E4  41 82 00 08 */	beq lbl_8019D7AC
/* 8019D7A8 001995E8  38 60 00 01 */	li r3, 0x1
.global lbl_8019D7AC
lbl_8019D7AC:
/* 8019D7AC 001995EC  83 BC 00 08 */	lwz r29, 0x8(r28)
/* 8019D7B0 001995F0  54 63 06 3E */	clrlwi r3, r3, 24
...
/* 8019D7C0 00199600  38 A0 00 00 */	li r5, 0x0
/* 8019D7C4 00199604  4B FE AF 8D */	bl addFile__Q24file8FileTreeFPCcPCQ24file16IFileInitializer
/* 8019D7C8 00199608  80 7C 00 08 */	lwz r3, 0x8(r28)
/* 8019D7CC 0019960C  80 82 98 9C */	lwz r4, SPEAKER_SE_FILENAME__Q23hbm16ResourceFileName@sda21(r2)
/* 8019D7D0 00199610  38 A0 00 00 */	li r5, 0x0
/* 8019D7D4 00199614  4B FE AF 7D */	bl addFile__Q24file8FileTreeFPCcPCQ24file16IFileInitializer
/* 8019D7D8 00199618  83 BC 00 08 */	lwz r29, 0x8(r28)
...
/* 8019D7EC 0019962C  38 A0 00 00 */	li r5, 0x0
/* 8019D7F0 00199630  4B FE AF 61 */	bl addFile__Q24file8FileTreeFPCcPCQ24file16IFileInitializer
/* 8019D7F4 00199634  80 7C 00 08 */	lwz r3, 0x8(r28)
/* 8019D7F8 00199638  80 82 98 98 */	lwz r4, CONFIG_FILENAME__Q23hbm16ResourceFileName@sda21(r2)
/* 8019D7FC 0019963C  38 A0 00 00 */	li r5, 0x0
/* 8019D800 00199640  4B FE AF 51 */	bl addFile__Q24file8FileTreeFPCcPCQ24file16IFileInitializer
/* 8019D804 00199644  80 7C 00 08 */	lwz r3, 0x8(r28)
/* 8019D808 00199648  80 82 98 A0 */	lwz r4, SE_FILENAME__Q23hbm16ResourceFileName@sda21(r2)
/* 8019D80C 0019964C  38 A0 00 00 */	li r5, 0x0
/* 8019D810 00199650  4B FE AF 41 */	bl addFile__Q24file8FileTreeFPCcPCQ24file16IFileInitializer
/* 8019D814 00199654  38 00 00 01 */	li r0, 0x1
/* 8019D818 00199658  98 1C 00 00 */	stb r0, 0x0(r28)
.global lbl_8019D81C
lbl_8019D81C:
/* 8019D81C 0019965C  39 61 00 20 */	addi r11, r1, 0x20
/* 8019D820 00199660  4B E6 9B 6D */	bl lbl_8000738C
