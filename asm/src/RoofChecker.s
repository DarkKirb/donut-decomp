...
/* 803540FC 0034FF3C  90 83 00 00 */	stw r4, 0(r3)
/* 80354100 0034FF40  90 A3 00 04 */	stw r5, 4(r3)
/* 80354104 0034FF44  38 00 00 00 */	li r0, 0
/* 80354108 0034FF48  98 03 00 08 */	stb r0, 8(r3)
/* 8035410C 0034FF4C  98 03 00 09 */	stb r0, 9(r3)
/* 80354110 0034FF50  C0 02 CE D0 */	lfs f0, $$252525-_SDA2_BASE_(r2)
...
/* 80354150 0034FF90  38 00 00 00 */	li r0, 0
/* 80354154 0034FF94  98 03 00 09 */	stb r0, 9(r3)
/* 80354158 0034FF98  88 03 00 08 */	lbz r0, 8(r3)
/* 8035415C 0034FF9C  2C 00 00 00 */	cmpwi r0, 0
/* 80354160 0034FFA0  41 82 01 90 */	beq lbl_803542F0
/* 80354164 0034FFA4  38 61 00 48 */	addi r3, r1, 0x48
/* 80354168 0034FFA8  80 9E 00 04 */	lwz r4, 4(r30)
...
/* 80354188 0034FFC8  C0 02 CE D0 */	lfs f0, $$252525-_SDA2_BASE_(r2)
/* 8035418C 0034FFCC  D0 01 00 38 */	stfs f0, 0x38(r1)
/* 80354190 0034FFD0  C0 02 CE DC */	lfs f0, $$252564-_SDA2_BASE_(r2)
...
/* 803541A8 0034FFE8  38 80 00 01 */	li r4, 1
...
/* 803541B4 0034FFF4  38 80 00 01 */	li r4, 1
/* 803541B8 0034FFF8  4B DB 4C 99 */	bl SetSustain__Q44nw4r3snd6detail12EnvGeneratorFi
/* 803541BC 0034FFFC  80 7E 00 00 */	lwz r3, 0(r30)
...
/* 803541DC 0035001C  80 02 CE D4 */	lwz r0, $$252271-_SDA2_BASE_(r2)
...
/* 80354228 00350068  80 7E 00 00 */	lwz r3, 0(r30)
...
/* 80354240 00350080  3B E0 00 00 */	li r31, 0
...
/* 80354250 00350090  38 A0 00 00 */	li r5, 0
...
/* 80354274 003500B4  B0 01 00 08 */	sth r0, 8(r1)
/* 80354278 003500B8  88 01 00 09 */	lbz r0, 9(r1)
/* 8035427C 003500BC  54 00 07 BC */	rlwinm r0, r0, 0, 0x1e, 0x1e
/* 80354280 003500C0  2C 00 00 00 */	cmpwi r0, 0
...
/* 803542A4 003500E4  80 02 CE D8 */	lwz r0, $$252282-_SDA2_BASE_(r2)
/* 803542A8 003500E8  90 01 00 0C */	stw r0, 0xc(r1)
/* 803542AC 003500EC  80 7E 00 00 */	lwz r3, 0(r30)
...
/* 803542C4 00350104  38 00 00 01 */	li r0, 1
/* 803542C8 00350108  98 1E 00 09 */	stb r0, 9(r30)
/* 803542CC 0035010C  48 00 00 18 */	b lbl_803542E4
lbl_803542D0:
/* 803542D0 00350110  3B FF 00 01 */	addi r31, r31, 1
lbl_803542D4:
...
/* 803542E8 00350128  38 80 FF FF */	li r4, -1
...
.global $$252271
$$252271:
	.incbin "baserom.dol", 0x49D994, 0x4
.global $$252282
$$252282:
	.incbin "baserom.dol", 0x49D998, 0x4
.global $$252564
$$252564:
	.incbin "baserom.dol", 0x49D99C, 0x4
