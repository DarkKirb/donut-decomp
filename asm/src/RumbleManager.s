...
/* 801A3A74 0019F8B4  38 80 00 00 */	li r4, 0
/* 801A3A78 0019F8B8  98 9F 00 08 */	stb r4, 8(r31)
/* 801A3A7C 0019F8BC  90 9F 00 0C */	stw r4, 0xc(r31)
/* 801A3A80 0019F8C0  38 7F 00 0C */	addi r3, r31, 0xc
/* 801A3A84 0019F8C4  38 00 00 08 */	li r0, 8
/* 801A3A88 0019F8C8  7C 09 03 A6 */	mtctr r0
lbl_801A3A8C:
/* 801A3A8C 0019F8CC  90 83 00 04 */	stw r4, 4(r3)
/* 801A3A90 0019F8D0  94 83 00 08 */	stwu r4, 8(r3)
...
/* 801A3AC0 0019F900  93 C1 00 08 */	stw r30, 8(r1)
/* 801A3AC4 0019F904  7C 7E 1B 78 */	mr r30, r3
/* 801A3AC8 0019F908  7C 9F 23 78 */	mr r31, r4
/* 801A3ACC 0019F90C  2C 03 00 00 */	cmpwi r3, 0
/* 801A3AD0 0019F910  41 82 00 20 */	beq lbl_801A3AF0
/* 801A3AD4 0019F914  38 80 FF FF */	li r4, -1
/* 801A3AD8 0019F918  4B FD 15 2D */	bl __dt__Q33hel6common31ExplicitSingleton$$0Q23app5Reset$$1Fv
/* 801A3ADC 0019F91C  7F E0 07 34 */	extsh r0, r31
/* 801A3AE0 0019F920  2C 00 00 00 */	cmpwi r0, 0
...
/* 801A3AF8 0019F938  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 801A3B64 0019F9A4  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 801A3B88 0019F9C8  93 C1 00 08 */	stw r30, 8(r1)
/* 801A3B8C 0019F9CC  7C 7E 1B 78 */	mr r30, r3
/* 801A3B90 0019F9D0  88 03 00 08 */	lbz r0, 8(r3)
/* 801A3B94 0019F9D4  2C 00 00 00 */	cmpwi r0, 0
/* 801A3B98 0019F9D8  40 82 00 30 */	bne lbl_801A3BC8
/* 801A3B9C 0019F9DC  3B E0 00 00 */	li r31, 0
...
/* 801A3BAC 0019F9EC  48 00 00 35 */	bl __vc__Q33hel6common41MutableArray$$0PQ23hid15RumbleRequestor$$416$$1FUl
/* 801A3BB0 0019F9F0  80 63 00 00 */	lwz r3, 0(r3)
/* 801A3BB4 0019F9F4  48 00 04 05 */	bl update__Q23hid15RumbleRequestorFv
/* 801A3BB8 0019F9F8  3B FF 00 01 */	addi r31, r31, 1
lbl_801A3BBC:
...
/* 801A3BCC 0019FA0C  83 C1 00 08 */	lwz r30, 8(r1)
...
.global __vc__Q33hel6common41MutableArray$$0PQ23hid15RumbleRequestor$$416$$1FUl
__vc__Q33hel6common41MutableArray$$0PQ23hid15RumbleRequestor$$416$$1FUl:
...
/* 801A3BF0 0019FA30  93 C1 00 08 */	stw r30, 8(r1)
/* 801A3BF4 0019FA34  7C 7E 1B 78 */	mr r30, r3
/* 801A3BF8 0019FA38  7C 9F 23 78 */	mr r31, r4
/* 801A3BFC 0019FA3C  7F E3 FB 78 */	mr r3, r31
/* 801A3C00 0019FA40  80 9E 00 00 */	lwz r4, 0(r30)
/* 801A3C04 0019FA44  4B E8 08 9D */	bl DefaultSwitchThreadCallback
/* 801A3C08 0019FA48  38 7E 00 04 */	addi r3, r30, 4
/* 801A3C0C 0019FA4C  7F E4 FB 78 */	mr r4, r31
/* 801A3C10 0019FA50  48 00 00 1D */	bl __vc__Q33hel6common34Array$$0PQ23hid15RumbleRequestor$$416$$1FUl
/* 801A3C14 0019FA54  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 801A3C18 0019FA58  83 C1 00 08 */	lwz r30, 8(r1)
...
.global __vc__Q33hel6common34Array$$0PQ23hid15RumbleRequestor$$416$$1FUl
__vc__Q33hel6common34Array$$0PQ23hid15RumbleRequestor$$416$$1FUl:
...
/* 801A3C3C 0019FA7C  93 C1 00 08 */	stw r30, 8(r1)
...
/* 801A3C60 0019FAA0  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 801A3C84 0019FAC4  38 00 00 01 */	li r0, 1
/* 801A3C88 0019FAC8  98 03 00 08 */	stb r0, 8(r3)
/* 801A3C8C 0019FACC  3B E0 00 00 */	li r31, 0
lbl_801A3C90:
/* 801A3C90 0019FAD0  7F E3 FB 78 */	mr r3, r31
/* 801A3C94 0019FAD4  38 80 00 00 */	li r4, 0
/* 801A3C98 0019FAD8  4B EB 44 B9 */	bl WPADControlMotor
/* 801A3C9C 0019FADC  3B FF 00 01 */	addi r31, r31, 1
/* 801A3CA0 0019FAE0  2C 1F 00 04 */	cmpwi r31, 4
...
/* 801A3CCC 0019FB0C  93 C1 00 08 */	stw r30, 8(r1)
/* 801A3CD0 0019FB10  7C 7E 1B 78 */	mr r30, r3
/* 801A3CD4 0019FB14  3B E0 00 00 */	li r31, 0
...
/* 801A3CE4 0019FB24  4B FF FE FD */	bl __vc__Q33hel6common41MutableArray$$0PQ23hid15RumbleRequestor$$416$$1FUl
/* 801A3CE8 0019FB28  80 63 00 00 */	lwz r3, 0(r3)
/* 801A3CEC 0019FB2C  48 00 02 B1 */	bl stop__Q23hid15RumbleRequestorFv
/* 801A3CF0 0019FB30  3B FF 00 01 */	addi r31, r31, 1
lbl_801A3CF4:
...
/* 801A3D04 0019FB44  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 801A3D28 0019FB68  93 C1 00 08 */	stw r30, 8(r1)
...
/* 801A3D48 0019FB88  4B FF FE E5 */	bl __vc__Q33hel6common34Array$$0PQ23hid15RumbleRequestor$$416$$1FUl
/* 801A3D4C 0019FB8C  93 E3 00 00 */	stw r31, 0(r3)
/* 801A3D50 0019FB90  80 7E 00 0C */	lwz r3, 0xc(r30)
/* 801A3D54 0019FB94  38 03 00 01 */	addi r0, r3, 1
/* 801A3D58 0019FB98  90 1E 00 0C */	stw r0, 0xc(r30)
lbl_801A3D5C:
/* 801A3D5C 0019FB9C  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 801A3D60 0019FBA0  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 801A3D84 0019FBC4  4B E6 35 BD */	bl func_80007340
/* 801A3D88 0019FBC8  7C 7C 1B 78 */	mr r28, r3
/* 801A3D8C 0019FBCC  7C 9D 23 78 */	mr r29, r4
/* 801A3D90 0019FBD0  3B C0 00 00 */	li r30, 0
/* 801A3D94 0019FBD4  3B E0 00 00 */	li r31, 0
...
lbl_801A3DC4:
/* 801A3DC4 0019FC04  3B DE 00 01 */	addi r30, r30, 1
/* 801A3DC8 0019FC08  3B FF 00 04 */	addi r31, r31, 4
lbl_801A3DCC:
...
/* 801A3DD8 0019FC18  3B C0 FF FF */	li r30, -1
lbl_801A3DDC:
...
/* 801A3DE8 0019FC28  3B DE 00 01 */	addi r30, r30, 1
...
/* 801A3DF8 0019FC38  4B FF FE 35 */	bl __vc__Q33hel6common34Array$$0PQ23hid15RumbleRequestor$$416$$1FUl
/* 801A3DFC 0019FC3C  83 E3 00 00 */	lwz r31, 0(r3)
/* 801A3E00 0019FC40  38 7C 00 10 */	addi r3, r28, 0x10
/* 801A3E04 0019FC44  38 9E FF FF */	addi r4, r30, -1
/* 801A3E08 0019FC48  4B FF FE 25 */	bl __vc__Q33hel6common34Array$$0PQ23hid15RumbleRequestor$$416$$1FUl
/* 801A3E0C 0019FC4C  93 E3 00 00 */	stw r31, 0(r3)
/* 801A3E10 0019FC50  3B DE 00 01 */	addi r30, r30, 1
lbl_801A3E14:
