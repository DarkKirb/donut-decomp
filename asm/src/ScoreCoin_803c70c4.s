...
/* 803C70D8 003C2F18  3C 80 80 49 */	lis r4, lbl_804924F8@ha
/* 803C70DC 003C2F1C  38 A4 24 F8 */	addi r5, r4, lbl_804924F8@l
/* 803C70E0 003C2F20  28 03 00 07 */	cmplwi r3, 0x7
/* 803C70E4 003C2F24  41 81 00 C4 */	bgt lbl_803C71A8
/* 803C70E8 003C2F28  3C 80 80 49 */	lis r4, lbl_80492540@ha
/* 803C70EC 003C2F2C  38 84 25 40 */	addi r4, r4, lbl_80492540@l
...
/* 803C7108 003C2F48  38 AD DA C8 */	addi r5, r13, lbl_8055BEE8@sda21
/* 803C710C 003C2F4C  48 00 00 C5 */	bl lbl_803C71D0
/* 803C7110 003C2F50  48 00 00 A8 */	b lbl_803C71B8

.global lbl_803C7114
lbl_803C7114:
/* 803C7114 003C2F54  3B 8D DA C8 */	addi r28, r13, lbl_8055BEE8@sda21
/* 803C7118 003C2F58  3B A5 00 24 */	addi r29, r5, 0x24
/* 803C711C 003C2F5C  3B C5 00 3C */	addi r30, r5, 0x3c
/* 803C7120 003C2F60  83 ED D9 50 */	lwz r31, lbl_8055BD70@sda21(r13)
/* 803C7124 003C2F64  88 0D F9 08 */	lbz r0, lbl_8055DD28@sda21(r13)
...
/* 803C7134 003C2F74  3C 60 80 55 */	lis r3, lbl_80554888@ha
/* 803C7138 003C2F78  38 63 48 88 */	addi r3, r3, lbl_80554888@l
/* 803C713C 003C2F7C  4B EA A3 D5 */	bl lbl_80271510
/* 803C7140 003C2F80  38 00 00 01 */	li r0, 0x1
/* 803C7144 003C2F84  98 0D F9 08 */	stb r0, lbl_8055DD28@sda21(r13)
.global lbl_803C7148
lbl_803C7148:
...
/* 803C7154 003C2F94  3F E0 80 55 */	lis r31, lbl_80554888@ha
/* 803C7158 003C2F98  38 7F 48 88 */	addi r3, r31, lbl_80554888@l
/* 803C715C 003C2F9C  3C 80 80 55 */	lis r4, lbl_80554908@ha
/* 803C7160 003C2FA0  38 84 49 08 */	addi r4, r4, lbl_80554908@l
/* 803C7164 003C2FA4  3C A0 80 55 */	lis r5, lbl_80554914@ha
/* 803C7168 003C2FA8  38 A5 49 14 */	addi r5, r5, lbl_80554914@l
/* 803C716C 003C2FAC  7F A6 EB 78 */	mr r6, r29
/* 803C7170 003C2FB0  7F C7 F3 78 */	mr r7, r30
/* 803C7174 003C2FB4  39 0D DA D8 */	addi r8, r13, lbl_8055BEF8@sda21
/* 803C7178 003C2FB8  39 20 00 00 */	li r9, 0x0
/* 803C717C 003C2FBC  39 40 00 00 */	li r10, 0x0
/* 803C7180 003C2FC0  4B FF DB 71 */	bl lbl_803C4CF0
/* 803C7184 003C2FC4  38 61 00 10 */	addi r3, r1, 0x10
/* 803C7188 003C2FC8  7F 84 E3 78 */	mr r4, r28
/* 803C718C 003C2FCC  4B DC 4C 55 */	bl lbl_8018BDE0
...
/* 803C719C 003C2FDC  4B DB AF 81 */	bl lbl_8018211C
...
/* 803C71B0 003C2FF0  38 AD DA C8 */	addi r5, r13, lbl_8055BEE8@sda21
/* 803C71B4 003C2FF4  48 00 00 1D */	bl lbl_803C71D0
.global lbl_803C71B8
lbl_803C71B8:
...
/* 803C71F0 003C3030  83 ED D9 50 */	lwz r31, lbl_8055BD70@sda21(r13)
/* 803C71F4 003C3034  88 0D F9 09 */	lbz r0, lbl_8055DD29@sda21(r13)
...
/* 803C7204 003C3044  3C 60 80 55 */	lis r3, lbl_80554920@ha
/* 803C7208 003C3048  38 63 49 20 */	addi r3, r3, lbl_80554920@l
/* 803C720C 003C304C  4B EA A3 05 */	bl lbl_80271510
/* 803C7210 003C3050  38 00 00 01 */	li r0, 0x1
/* 803C7214 003C3054  98 0D F9 09 */	stb r0, lbl_8055DD29@sda21(r13)
.global lbl_803C7218
lbl_803C7218:
...
/* 803C7224 003C3064  3F E0 80 55 */	lis r31, lbl_80554920@ha
/* 803C7228 003C3068  38 7F 49 20 */	addi r3, r31, lbl_80554920@l
/* 803C722C 003C306C  3C 80 80 55 */	lis r4, lbl_805549A0@ha
/* 803C7230 003C3070  38 84 49 A0 */	addi r4, r4, lbl_805549A0@l
/* 803C7234 003C3074  3C A0 80 55 */	lis r5, lbl_805549AC@ha
/* 803C7238 003C3078  38 A5 49 AC */	addi r5, r5, lbl_805549AC@l
/* 803C723C 003C307C  7F A6 EB 78 */	mr r6, r29
/* 803C7240 003C3080  7F 87 E3 78 */	mr r7, r28
/* 803C7244 003C3084  39 0D DA D0 */	addi r8, r13, lbl_8055BEF0@sda21
/* 803C7248 003C3088  39 20 00 00 */	li r9, 0x0
/* 803C724C 003C308C  39 40 00 00 */	li r10, 0x0
/* 803C7250 003C3090  4B FF DA A1 */	bl lbl_803C4CF0
/* 803C7254 003C3094  38 61 00 10 */	addi r3, r1, 0x10
/* 803C7258 003C3098  7F C4 F3 78 */	mr r4, r30
/* 803C725C 003C309C  4B DC 4B 85 */	bl lbl_8018BDE0
...
/* 803C726C 003C30AC  4B DB AE B1 */	bl lbl_8018211C
