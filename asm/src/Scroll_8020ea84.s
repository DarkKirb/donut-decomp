...
/* 8020EAA8 0020A8E8  C0 02 A1 80 */	lfs f0, lbl_80560100@sda21(r2)
...
/* 8020EAB8 0020A8F8  4B FC 71 71 */	bl lbl_801D5C28
/* 8020EABC 0020A8FC  C0 02 A1 80 */	lfs f0, lbl_80560100@sda21(r2)
...
/* 8020EB00 0020A940  48 1F 3F 6D */	bl lbl_80402A6C
/* 8020EB04 0020A944  38 7D 00 08 */	addi r3, r29, 0x8
/* 8020EB08 0020A948  48 1F 6E D5 */	bl lbl_804059DC
...
/* 8020EB64 0020A9A4  48 1F 6E 3D */	bl lbl_804059A0
...
/* 8020EC30 0020AA70  4B FF 88 49 */	bl lbl_80207478
...
/* 8020EC4C 0020AA8C  48 00 04 B5 */	bl lbl_8020F100
...
/* 8020EC70 0020AAB0  48 00 04 91 */	bl lbl_8020F100
...
/* 8020EC80 0020AAC0  4B FF 87 F9 */	bl lbl_80207478
...
/* 8020ECBC 0020AAFC  48 00 05 2D */	bl lbl_8020F1E8
/* 8020ECC0 0020AB00  48 00 03 DC */	b lbl_8020F09C
.global lbl_8020ECC4
lbl_8020ECC4:
/* 8020ECC4 0020AB04  38 7B 00 08 */	addi r3, r27, 0x8
/* 8020ECC8 0020AB08  4B EF 1B 19 */	bl lbl_801007E0
/* 8020ECCC 0020AB0C  C8 22 A1 90 */	lfd f1, lbl_80560110@sda21(r2)
...
/* 8020ECDC 0020AB1C  C0 02 A1 84 */	lfs f0, lbl_80560104@sda21(r2)
/* 8020ECE0 0020AB20  EC 41 00 24 */	fdivs f2, f1, f0
/* 8020ECE4 0020AB24  C0 02 A1 8C */	lfs f0, lbl_8056010C@sda21(r2)
...
/* 8020ECF4 0020AB34  C0 02 A1 88 */	lfs f0, lbl_80560108@sda21(r2)
...
/* 8020ED20 0020AB60  4B EF 1A C1 */	bl lbl_801007E0
...
/* 8020ED54 0020AB94  4B FF 87 25 */	bl lbl_80207478
...
/* 8020ED80 0020ABC0  48 00 03 81 */	bl lbl_8020F100
.global lbl_8020ED84
lbl_8020ED84:
...
/* 8020ED9C 0020ABDC  4B FF 86 DD */	bl lbl_80207478
...
/* 8020EE0C 0020AC4C  48 00 03 DD */	bl lbl_8020F1E8
/* 8020EE10 0020AC50  48 00 02 8C */	b lbl_8020F09C
.global lbl_8020EE14
lbl_8020EE14:
/* 8020EE14 0020AC54  38 7B 00 08 */	addi r3, r27, 0x8
/* 8020EE18 0020AC58  48 1F 6B 71 */	bl lbl_80405988
...
/* 8020EE54 0020AC94  4B FF 86 25 */	bl lbl_80207478
...
/* 8020EEC8 0020AD08  C0 0D EF 84 */	lfs f0, lbl_8055D3A4@sda21(r13)
...
/* 8020EEEC 0020AD2C  C0 0D EF 94 */	lfs f0, lbl_8055D3B4@sda21(r13)
...
/* 8020EF3C 0020AD7C  C8 22 A1 90 */	lfd f1, lbl_80560110@sda21(r2)
...
/* 8020EF4C 0020AD8C  C0 0D EF 80 */	lfs f0, lbl_8055D3A0@sda21(r13)
...
/* 8020EF74 0020ADB4  C8 22 A1 90 */	lfd f1, lbl_80560110@sda21(r2)
...
/* 8020EF84 0020ADC4  C0 0D EF 80 */	lfs f0, lbl_8055D3A0@sda21(r13)
...
/* 8020EFF4 0020AE34  4B FF 84 85 */	bl lbl_80207478
...
.global lbl_8020F01C
lbl_8020F01C:
/* 8020F01C 0020AE5C  C8 22 A1 90 */	lfd f1, lbl_80560110@sda21(r2)
...
/* 8020F02C 0020AE6C  C0 0D EF 80 */	lfs f0, lbl_8055D3A0@sda21(r13)
...
/* 8020F03C 0020AE7C  48 00 02 31 */	bl lbl_8020F26C
...
/* 8020F06C 0020AEAC  48 00 01 7D */	bl lbl_8020F1E8
/* 8020F070 0020AEB0  48 00 00 2C */	b lbl_8020F09C
.global lbl_8020F074
lbl_8020F074:
/* 8020F074 0020AEB4  80 1B 00 38 */	lwz r0, 0x38(r27)
/* 8020F078 0020AEB8  C8 22 A1 90 */	lfd f1, lbl_80560110@sda21(r2)
...
/* 8020F088 0020AEC8  C0 0D EF 80 */	lfs f0, lbl_8055D3A0@sda21(r13)
...
/* 8020F098 0020AED8  48 00 01 D5 */	bl lbl_8020F26C
.global lbl_8020F09C
lbl_8020F09C:
...
/* 8020F0BC 0020AEFC  C0 02 A1 80 */	lfs f0, lbl_80560100@sda21(r2)
...
/* 8020F0D4 0020AF14  C8 22 A1 90 */	lfd f1, lbl_80560110@sda21(r2)
...
/* 8020F0EC 0020AF2C  C0 0D EF 80 */	lfs f0, lbl_8055D3A0@sda21(r13)
...
/* 8020F134 0020AF74  C8 22 A1 90 */	lfd f1, lbl_80560110@sda21(r2)
...
/* 8020F14C 0020AF8C  C0 0D EF 80 */	lfs f0, lbl_8055D3A0@sda21(r13)
...
/* 8020F164 0020AFA4  C8 22 A1 90 */	lfd f1, lbl_80560110@sda21(r2)
...
/* 8020F17C 0020AFBC  C0 0D EF 80 */	lfs f0, lbl_8055D3A0@sda21(r13)
...
/* 8020F18C 0020AFCC  4B EF 75 F5 */	bl lbl_80106780
...
/* 8020F1B4 0020AFF4  4B FF A0 D9 */	bl lbl_8020928C
/* 8020F1B8 0020AFF8  48 00 00 0C */	b lbl_8020F1C4
.global lbl_8020F1BC
lbl_8020F1BC:
/* 8020F1BC 0020AFFC  80 7E 00 3C */	lwz r3, 0x3c(r30)
/* 8020F1C0 0020B000  4B FF A0 85 */	bl lbl_80209244
.global lbl_8020F1C4
lbl_8020F1C4:
...
/* 8020F210 0020B050  C0 02 A1 80 */	lfs f0, lbl_80560100@sda21(r2)
...
/* 8020F224 0020B064  C0 02 A1 80 */	lfs f0, lbl_80560100@sda21(r2)
...
/* 8020F238 0020B078  4B FF A1 55 */	bl lbl_8020938C
/* 8020F23C 0020B07C  48 00 00 0C */	b lbl_8020F248
.global lbl_8020F240
lbl_8020F240:
/* 8020F240 0020B080  80 63 00 3C */	lwz r3, 0x3c(r3)
/* 8020F244 0020B084  4B FF A0 91 */	bl lbl_802092D4
.global lbl_8020F248
lbl_8020F248:
...
/* 8020F284 0020B0C4  4B FF 9F 31 */	bl lbl_802091B4
...
.global lbl_8020F2A4
lbl_8020F2A4:
/* 8020F2A4 0020B0E4  C0 22 A1 D8 */	lfs f1, lbl_80560158@sda21(r2)
/* 8020F2A8 0020B0E8  D0 2D EF 80 */	stfs f1, lbl_8055D3A0@sda21(r13)
/* 8020F2AC 0020B0EC  C0 02 A1 98 */	lfs f0, lbl_80560118@sda21(r2)
/* 8020F2B0 0020B0F0  EC 41 00 24 */	fdivs f2, f1, f0
/* 8020F2B4 0020B0F4  D0 4D EF 84 */	stfs f2, lbl_8055D3A4@sda21(r13)
/* 8020F2B8 0020B0F8  C0 02 A1 9C */	lfs f0, lbl_8056011C@sda21(r2)
/* 8020F2BC 0020B0FC  EC 02 00 32 */	fmuls f0, f2, f0
/* 8020F2C0 0020B100  D0 0D EF 88 */	stfs f0, lbl_8055D3A8@sda21(r13)
/* 8020F2C4 0020B104  EC 22 00 28 */	fsubs f1, f2, f0
/* 8020F2C8 0020B108  C0 02 A1 A0 */	lfs f0, lbl_80560120@sda21(r2)
/* 8020F2CC 0020B10C  EC 21 00 24 */	fdivs f1, f1, f0
/* 8020F2D0 0020B110  D0 2D EF 8C */	stfs f1, lbl_8055D3AC@sda21(r13)
/* 8020F2D4 0020B114  C0 02 A1 A4 */	lfs f0, lbl_80560124@sda21(r2)
/* 8020F2D8 0020B118  EC 01 00 24 */	fdivs f0, f1, f0
/* 8020F2DC 0020B11C  D0 0D EF 90 */	stfs f0, lbl_8055D3B0@sda21(r13)
/* 8020F2E0 0020B120  C0 02 A1 A8 */	lfs f0, lbl_80560128@sda21(r2)
/* 8020F2E4 0020B124  EC 00 00 B2 */	fmuls f0, f0, f2
/* 8020F2E8 0020B128  D0 0D EF 94 */	stfs f0, lbl_8055D3B4@sda21(r13)
