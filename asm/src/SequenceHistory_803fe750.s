...
/* 803FE764 003FA5A4  3C 80 80 49 */	lis r4, lbl_80496450@ha
/* 803FE768 003FA5A8  38 04 64 50 */	addi r0, r4, lbl_80496450@l
/* 803FE76C 003FA5AC  90 03 00 00 */	stw r0, 0x0(r3)
/* 803FE770 003FA5B0  38 63 00 04 */	addi r3, r3, 0x4
/* 803FE774 003FA5B4  4B D8 93 E9 */	bl lbl_80187B5C
/* 803FE778 003FA5B8  38 60 00 00 */	li r3, 0x0
/* 803FE77C 003FA5BC  90 7F 00 08 */	stw r3, 0x8(r31)
/* 803FE780 003FA5C0  38 00 00 01 */	li r0, 0x1
...
.global lbl_803FE7C0
lbl_803FE7C0:
/* 803FE7C0 003FA600  80 03 00 08 */	lwz r0, 0x8(r3)
/* 803FE7C4 003FA604  28 00 00 02 */	cmplwi r0, 0x2
/* 803FE7C8 003FA608  40 81 00 20 */	ble lbl_803FE7E8
/* 803FE7CC 003FA60C  2C 00 00 04 */	cmpwi r0, 0x4
/* 803FE7D0 003FA610  41 82 00 18 */	beq lbl_803FE7E8
/* 803FE7D4 003FA614  2C 00 00 03 */	cmpwi r0, 0x3
/* 803FE7D8 003FA618  41 82 00 18 */	beq lbl_803FE7F0
/* 803FE7DC 003FA61C  2C 00 00 05 */	cmpwi r0, 0x5
/* 803FE7E0 003FA620  41 82 00 18 */	beq lbl_803FE7F8
/* 803FE7E4 003FA624  48 00 00 1C */	b lbl_803FE800
.global lbl_803FE7E8
lbl_803FE7E8:
/* 803FE7E8 003FA628  38 60 00 02 */	li r3, 0x2
/* 803FE7EC 003FA62C  4E 80 00 20 */	blr
.global lbl_803FE7F0
lbl_803FE7F0:
/* 803FE7F0 003FA630  38 60 00 01 */	li r3, 0x1
/* 803FE7F4 003FA634  4E 80 00 20 */	blr
.global lbl_803FE7F8
lbl_803FE7F8:
/* 803FE7F8 003FA638  38 60 00 00 */	li r3, 0x0
/* 803FE7FC 003FA63C  4E 80 00 20 */	blr
.global lbl_803FE800
lbl_803FE800:
/* 803FE800 003FA640  38 60 00 00 */	li r3, 0x0
...
/* 803FE820 003FA660  4B C2 5C 81 */	bl lbl_800244A0
/* 803FE824 003FA664  90 61 00 0C */	stw r3, 0xc(r1)
/* 803FE828 003FA668  38 60 00 0C */	li r3, 0xc
/* 803FE82C 003FA66C  4B FF E3 B1 */	bl lbl_803FCBDC
/* 803FE830 003FA670  2C 03 00 00 */	cmpwi r3, 0x0
/* 803FE834 003FA674  41 82 00 0C */	beq lbl_803FE840
/* 803FE838 003FA678  38 81 00 0C */	addi r4, r1, 0xc
/* 803FE83C 003FA67C  48 00 1C 05 */	bl lbl_80400440
.global lbl_803FE840
lbl_803FE840:
/* 803FE840 003FA680  38 00 00 00 */	li r0, 0x0
/* 803FE844 003FA684  90 01 00 08 */	stw r0, 0x8(r1)
/* 803FE848 003FA688  90 7F 00 00 */	stw r3, 0x0(r31)
/* 803FE84C 003FA68C  38 61 00 08 */	addi r3, r1, 0x8
/* 803FE850 003FA690  38 80 FF FF */	li r4, -0x1
/* 803FE854 003FA694  4B D7 6D AD */	bl lbl_80175600
...
/* 803FE8E4 003FA724  4B D4 D7 79 */	bl lbl_8014C05C
/* 803FE8E8 003FA728  38 61 00 30 */	addi r3, r1, 0x30
/* 803FE8EC 003FA72C  38 80 FF FF */	li r4, -0x1
/* 803FE8F0 003FA730  4B D7 6D 11 */	bl lbl_80175600
/* 803FE8F4 003FA734  48 00 01 28 */	b lbl_803FEA1C
.global lbl_803FE8F8
lbl_803FE8F8:
/* 803FE8F8 003FA738  38 60 00 0C */	li r3, 0xc
/* 803FE8FC 003FA73C  4B DC 0E 15 */	bl lbl_801BF710
/* 803FE900 003FA740  7C 7F 1B 78 */	mr r31, r3
/* 803FE904 003FA744  2C 03 00 00 */	cmpwi r3, 0x0
/* 803FE908 003FA748  41 82 00 20 */	beq lbl_803FE928
/* 803FE90C 003FA74C  80 7E 00 24 */	lwz r3, 0x24(r30)
/* 803FE910 003FA750  4B C2 5B 91 */	bl lbl_800244A0
...
/* 803FE920 003FA760  4B DE 40 85 */	bl lbl_801E29A4
...
/* 803FE930 003FA770  4B D7 6C BD */	bl lbl_801755EC
...
/* 803FE940 003FA780  4B D4 D7 1D */	bl lbl_8014C05C
/* 803FE944 003FA784  38 61 00 24 */	addi r3, r1, 0x24
/* 803FE948 003FA788  38 80 FF FF */	li r4, -0x1
/* 803FE94C 003FA78C  4B D7 6C B5 */	bl lbl_80175600
/* 803FE950 003FA790  48 00 00 CC */	b lbl_803FEA1C
.global lbl_803FE954
lbl_803FE954:
/* 803FE954 003FA794  38 60 00 08 */	li r3, 0x8
/* 803FE958 003FA798  4B DC 0D B9 */	bl lbl_801BF710
/* 803FE95C 003FA79C  7C 7F 1B 78 */	mr r31, r3
/* 803FE960 003FA7A0  2C 03 00 00 */	cmpwi r3, 0x0
/* 803FE964 003FA7A4  41 82 00 20 */	beq lbl_803FE984
/* 803FE968 003FA7A8  80 7E 00 28 */	lwz r3, 0x28(r30)
/* 803FE96C 003FA7AC  4B C2 5B 35 */	bl lbl_800244A0
...
/* 803FE97C 003FA7BC  4B E0 19 F9 */	bl lbl_80200374
...
/* 803FE98C 003FA7CC  4B D7 6C 61 */	bl lbl_801755EC
...
/* 803FE99C 003FA7DC  4B D4 D6 C1 */	bl lbl_8014C05C
/* 803FE9A0 003FA7E0  38 61 00 18 */	addi r3, r1, 0x18
/* 803FE9A4 003FA7E4  38 80 FF FF */	li r4, -0x1
/* 803FE9A8 003FA7E8  4B D7 6C 59 */	bl lbl_80175600
/* 803FE9AC 003FA7EC  48 00 00 70 */	b lbl_803FEA1C
.global lbl_803FE9B0
lbl_803FE9B0:
/* 803FE9B0 003FA7F0  38 60 00 08 */	li r3, 0x8
/* 803FE9B4 003FA7F4  4B DC 0D 5D */	bl lbl_801BF710
/* 803FE9B8 003FA7F8  2C 03 00 00 */	cmpwi r3, 0x0
/* 803FE9BC 003FA7FC  41 82 00 08 */	beq lbl_803FE9C4
/* 803FE9C0 003FA800  4B E1 DF E5 */	bl lbl_8021C9A4
.global lbl_803FE9C4
lbl_803FE9C4:
/* 803FE9C4 003FA804  90 61 00 10 */	stw r3, 0x10(r1)
/* 803FE9C8 003FA808  38 61 00 10 */	addi r3, r1, 0x10
/* 803FE9CC 003FA80C  4B D7 6C 21 */	bl lbl_801755EC
...
/* 803FE9DC 003FA81C  4B D4 D6 81 */	bl lbl_8014C05C
/* 803FE9E0 003FA820  38 61 00 10 */	addi r3, r1, 0x10
/* 803FE9E4 003FA824  38 80 FF FF */	li r4, -0x1
/* 803FE9E8 003FA828  4B D7 6C 19 */	bl lbl_80175600
/* 803FE9EC 003FA82C  48 00 00 30 */	b lbl_803FEA1C
.global lbl_803FE9F0
lbl_803FE9F0:
/* 803FE9F0 003FA830  38 00 00 00 */	li r0, 0x0
/* 803FE9F4 003FA834  90 01 00 08 */	stw r0, 0x8(r1)
/* 803FE9F8 003FA838  38 61 00 08 */	addi r3, r1, 0x8
/* 803FE9FC 003FA83C  4B D7 6B F1 */	bl lbl_801755EC
...
/* 803FEA0C 003FA84C  4B D4 D6 51 */	bl lbl_8014C05C
/* 803FEA10 003FA850  38 61 00 08 */	addi r3, r1, 0x8
/* 803FEA14 003FA854  38 80 FF FF */	li r4, -0x1
/* 803FEA18 003FA858  4B D7 6B E9 */	bl lbl_80175600
.global lbl_803FEA1C
lbl_803FEA1C:
/* 803FEA1C 003FA85C  39 61 00 50 */	addi r11, r1, 0x50
/* 803FEA20 003FA860  4B C0 89 71 */	bl lbl_80007390
...
/* 803FEA44 003FA884  4B C0 89 01 */	bl lbl_80007344
/* 803FEA48 003FA888  7C 7F 1B 78 */	mr r31, r3
/* 803FEA4C 003FA88C  7C 9D 23 78 */	mr r29, r4
/* 803FEA50 003FA890  80 03 00 08 */	lwz r0, 0x8(r3)
/* 803FEA54 003FA894  2C 00 00 00 */	cmpwi r0, 0x0
/* 803FEA58 003FA898  41 82 00 20 */	beq lbl_803FEA78
/* 803FEA5C 003FA89C  2C 00 00 01 */	cmpwi r0, 0x1
/* 803FEA60 003FA8A0  41 82 01 10 */	beq lbl_803FEB70
/* 803FEA64 003FA8A4  2C 00 00 02 */	cmpwi r0, 0x2
/* 803FEA68 003FA8A8  41 82 01 84 */	beq lbl_803FEBEC
/* 803FEA6C 003FA8AC  2C 00 00 04 */	cmpwi r0, 0x4
/* 803FEA70 003FA8B0  41 82 01 7C */	beq lbl_803FEBEC
/* 803FEA74 003FA8B4  48 00 01 8C */	b lbl_803FEC00
.global lbl_803FEA78
lbl_803FEA78:
/* 803FEA78 003FA8B8  4B E0 FB ED */	bl lbl_8020E664
/* 803FEA7C 003FA8BC  7C 7E 1B 78 */	mr r30, r3
/* 803FEA80 003FA8C0  2C 1D 00 00 */	cmpwi r29, 0x0
/* 803FEA84 003FA8C4  41 82 00 2C */	beq lbl_803FEAB0
/* 803FEA88 003FA8C8  7F A3 EB 78 */	mr r3, r29
/* 803FEA8C 003FA8CC  81 83 00 00 */	lwz r12, 0x0(r3)
/* 803FEA90 003FA8D0  81 8C 00 08 */	lwz r12, 0x8(r12)
/* 803FEA94 003FA8D4  7D 89 03 A6 */	mtctr r12
/* 803FEA98 003FA8D8  4E 80 04 21 */	bctrl
/* 803FEA9C 003FA8DC  7F C4 F3 78 */	mr r4, r30
/* 803FEAA0 003FA8E0  4B DA F6 99 */	bl lbl_801AE138
/* 803FEAA4 003FA8E4  2C 03 00 00 */	cmpwi r3, 0x0
/* 803FEAA8 003FA8E8  41 82 00 08 */	beq lbl_803FEAB0
/* 803FEAAC 003FA8EC  48 00 00 08 */	b lbl_803FEAB4
.global lbl_803FEAB0
lbl_803FEAB0:
/* 803FEAB0 003FA8F0  3B A0 00 00 */	li r29, 0x0
.global lbl_803FEAB4
lbl_803FEAB4:
/* 803FEAB4 003FA8F4  38 61 00 08 */	addi r3, r1, 0x8
/* 803FEAB8 003FA8F8  7F A4 EB 78 */	mr r4, r29
/* 803FEABC 003FA8FC  4B E0 FF 1D */	bl lbl_8020E9D8
/* 803FEAC0 003FA900  80 01 00 08 */	lwz r0, 0x8(r1)
...
/* 803FEAE8 003FA928  4B E0 FF 41 */	bl lbl_8020EA28
/* 803FEAEC 003FA92C  80 01 00 18 */	lwz r0, 0x18(r1)
/* 803FEAF0 003FA930  2C 00 00 00 */	cmpwi r0, 0x0
/* 803FEAF4 003FA934  41 82 00 28 */	beq lbl_803FEB1C
/* 803FEAF8 003FA938  2C 00 00 01 */	cmpwi r0, 0x1
/* 803FEAFC 003FA93C  41 82 00 34 */	beq lbl_803FEB30
/* 803FEB00 003FA940  2C 00 00 02 */	cmpwi r0, 0x2
/* 803FEB04 003FA944  41 82 00 40 */	beq lbl_803FEB44
/* 803FEB08 003FA948  2C 00 00 03 */	cmpwi r0, 0x3
/* 803FEB0C 003FA94C  41 82 00 4C */	beq lbl_803FEB58
/* 803FEB10 003FA950  2C 00 00 04 */	cmpwi r0, 0x4
/* 803FEB14 003FA954  41 82 00 50 */	beq lbl_803FEB64
/* 803FEB18 003FA958  48 00 00 E8 */	b lbl_803FEC00
.global lbl_803FEB1C
lbl_803FEB1C:
/* 803FEB1C 003FA95C  38 00 00 03 */	li r0, 0x3
/* 803FEB20 003FA960  90 1F 00 08 */	stw r0, 0x8(r31)
...
.global lbl_803FEB30
lbl_803FEB30:
/* 803FEB30 003FA970  38 00 00 01 */	li r0, 0x1
/* 803FEB34 003FA974  90 1F 00 08 */	stw r0, 0x8(r31)
...
.global lbl_803FEB44
lbl_803FEB44:
/* 803FEB44 003FA984  38 00 00 02 */	li r0, 0x2
/* 803FEB48 003FA988  90 1F 00 08 */	stw r0, 0x8(r31)
...
.global lbl_803FEB58
lbl_803FEB58:
/* 803FEB58 003FA998  38 00 00 04 */	li r0, 0x4
/* 803FEB5C 003FA99C  90 1F 00 08 */	stw r0, 0x8(r31)
/* 803FEB60 003FA9A0  48 00 00 A0 */	b lbl_803FEC00
.global lbl_803FEB64
lbl_803FEB64:
/* 803FEB64 003FA9A4  38 00 00 05 */	li r0, 0x5
/* 803FEB68 003FA9A8  90 1F 00 08 */	stw r0, 0x8(r31)
/* 803FEB6C 003FA9AC  48 00 00 94 */	b lbl_803FEC00
.global lbl_803FEB70
lbl_803FEB70:
/* 803FEB70 003FA9B0  4B DE 3D E5 */	bl lbl_801E2954
/* 803FEB74 003FA9B4  7C 7E 1B 78 */	mr r30, r3
/* 803FEB78 003FA9B8  2C 1D 00 00 */	cmpwi r29, 0x0
/* 803FEB7C 003FA9BC  41 82 00 2C */	beq lbl_803FEBA8
/* 803FEB80 003FA9C0  7F A3 EB 78 */	mr r3, r29
/* 803FEB84 003FA9C4  81 83 00 00 */	lwz r12, 0x0(r3)
/* 803FEB88 003FA9C8  81 8C 00 08 */	lwz r12, 0x8(r12)
/* 803FEB8C 003FA9CC  7D 89 03 A6 */	mtctr r12
/* 803FEB90 003FA9D0  4E 80 04 21 */	bctrl
/* 803FEB94 003FA9D4  7F C4 F3 78 */	mr r4, r30
/* 803FEB98 003FA9D8  4B DA F5 A1 */	bl lbl_801AE138
/* 803FEB9C 003FA9DC  2C 03 00 00 */	cmpwi r3, 0x0
/* 803FEBA0 003FA9E0  41 82 00 08 */	beq lbl_803FEBA8
/* 803FEBA4 003FA9E4  48 00 00 08 */	b lbl_803FEBAC
.global lbl_803FEBA8
lbl_803FEBA8:
/* 803FEBA8 003FA9E8  3B A0 00 00 */	li r29, 0x0
.global lbl_803FEBAC
lbl_803FEBAC:
/* 803FEBAC 003FA9EC  7F A3 EB 78 */	mr r3, r29
/* 803FEBB0 003FA9F0  4B DE 43 9D */	bl lbl_801E2F4C
/* 803FEBB4 003FA9F4  2C 03 00 00 */	cmpwi r3, 0x0
/* 803FEBB8 003FA9F8  41 82 00 10 */	beq lbl_803FEBC8
/* 803FEBBC 003FA9FC  2C 03 00 01 */	cmpwi r3, 0x1
/* 803FEBC0 003FAA00  41 82 00 20 */	beq lbl_803FEBE0
/* 803FEBC4 003FAA04  48 00 00 3C */	b lbl_803FEC00
.global lbl_803FEBC8
lbl_803FEBC8:
/* 803FEBC8 003FAA08  38 60 00 00 */	li r3, 0x0
/* 803FEBCC 003FAA0C  98 7F 00 0C */	stb r3, 0xc(r31)
/* 803FEBD0 003FAA10  38 00 00 01 */	li r0, 0x1
/* 803FEBD4 003FAA14  98 1F 00 0D */	stb r0, 0xd(r31)
/* 803FEBD8 003FAA18  90 7F 00 08 */	stw r3, 0x8(r31)
/* 803FEBDC 003FAA1C  48 00 00 24 */	b lbl_803FEC00
.global lbl_803FEBE0
lbl_803FEBE0:
/* 803FEBE0 003FAA20  38 00 00 01 */	li r0, 0x1
/* 803FEBE4 003FAA24  90 1F 00 08 */	stw r0, 0x8(r31)
/* 803FEBE8 003FAA28  48 00 00 18 */	b lbl_803FEC00
.global lbl_803FEBEC
lbl_803FEBEC:
/* 803FEBEC 003FAA2C  38 80 00 00 */	li r4, 0x0
/* 803FEBF0 003FAA30  98 83 00 0C */	stb r4, 0xc(r3)
/* 803FEBF4 003FAA34  38 00 00 01 */	li r0, 0x1
/* 803FEBF8 003FAA38  98 03 00 0D */	stb r0, 0xd(r3)
/* 803FEBFC 003FAA3C  90 83 00 08 */	stw r4, 0x8(r3)
.global lbl_803FEC00
lbl_803FEC00:
/* 803FEC00 003FAA40  39 61 00 40 */	addi r11, r1, 0x40
/* 803FEC04 003FAA44  4B C0 87 8D */	bl lbl_80007390
...
.global lbl_803FEC18
lbl_803FEC18:
/* 803FEC18 003FAA58  4B FF F6 FC */	b lbl_803FE314

.global lbl_803FEC1C
lbl_803FEC1C:
/* 803FEC1C 003FAA5C  4B FF E2 B0 */	b lbl_803FCECC
