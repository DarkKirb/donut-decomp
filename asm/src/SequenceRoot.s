...
/* 803FF974 003FB7B4  90 03 00 00 */	stw r0, 0(r3)
/* 803FF978 003FB7B8  98 83 00 04 */	stb r4, 4(r3)
/* 803FF97C 003FB7BC  98 A3 00 05 */	stb r5, 5(r3)
...
/* 803FF9AC 003FB7EC  2C 03 00 00 */	cmpwi r3, 0
/* 803FF9B0 003FB7F0  41 82 00 10 */	beq lbl_803FF9C0
/* 803FF9B4 003FB7F4  88 9F 00 04 */	lbz r4, 4(r31)
/* 803FF9B8 003FB7F8  88 BF 00 05 */	lbz r5, 5(r31)
/* 803FF9BC 003FB7FC  4B FF FA B9 */	bl __ct__Q23seq19SequenceProductRootFbb
lbl_803FF9C0:
/* 803FF9C0 003FB800  38 00 00 00 */	li r0, 0
/* 803FF9C4 003FB804  90 01 00 08 */	stw r0, 8(r1)
/* 803FF9C8 003FB808  90 7E 00 00 */	stw r3, 0(r30)
/* 803FF9CC 003FB80C  38 61 00 08 */	addi r3, r1, 8
/* 803FF9D0 003FB810  38 80 FF FF */	li r4, -1
/* 803FF9D4 003FB814  4B D7 5C 2D */	bl __dt__Q23std26auto_ptr$$0Q23seq9ISequence$$1Fv
...
/* 803FF9FC 003FB83C  4B D7 53 94 */	b RuntimeTypeInfoImpl$$0Q23seq12SequenceRoot$$1__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo
...
/* 803FFA48 003FB888  83 C1 00 08 */	lwz r30, 8(r1)
