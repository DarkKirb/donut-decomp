...
/* 803CEDD0 003CAC10  4B C3 85 71 */	bl func_80007340
...
/* 803CEDE8 003CAC28  38 00 00 01 */	li r0, 1
...
/* 803CEDFC 003CAC3C  3C 80 80 49 */	lis r4, $$252021@ha
/* 803CEE00 003CAC40  38 84 2C A0 */	addi r4, r4, $$252021@l
/* 803CEE04 003CAC44  38 A0 00 00 */	li r5, 0
/* 803CEE08 003CAC48  4B DC 4A D1 */	bl get__Q23g3d17ResFileRepositoryFPCcb
/* 803CEE0C 003CAC4C  90 61 00 08 */	stw r3, 8(r1)
...
/* 803CEE1C 003CAC5C  38 81 00 08 */	addi r4, r1, 8
/* 803CEE20 003CAC60  38 AD DB F0 */	addi r5, r13, $$252022-_SDA_BASE_
...
/* 803CEE54 003CAC94  38 00 00 00 */	li r0, 0
...
/* 803CEE74 003CACB4  80 02 DC E0 */	lwz r0, $$251593-_SDA2_BASE_(r2)
...
/* 803CEE98 003CACD8  4B C3 84 F5 */	bl func_8000738C
...
/* 803CEEB4 003CACF4  88 04 00 00 */	lbz r0, 0(r4)
/* 803CEEB8 003CACF8  98 03 01 AC */	stb r0, 0x1ac(r3)
/* 803CEEBC 003CACFC  88 04 00 01 */	lbz r0, 1(r4)
/* 803CEEC0 003CAD00  98 03 01 AD */	stb r0, 0x1ad(r3)
/* 803CEEC4 003CAD04  88 04 00 02 */	lbz r0, 2(r4)
/* 803CEEC8 003CAD08  98 03 01 AE */	stb r0, 0x1ae(r3)
/* 803CEECC 003CAD0C  88 04 00 03 */	lbz r0, 3(r4)
/* 803CEED0 003CAD10  98 03 01 AF */	stb r0, 0x1af(r3)
/* 803CEED4 003CAD14  38 00 00 01 */	li r0, 1
...
/* 803CEEE4 003CAD24  2C 00 00 00 */	cmpwi r0, 0
/* 803CEEE8 003CAD28  4D 82 00 20 */	beqlr 
/* 803CEEEC 003CAD2C  38 00 00 00 */	li r0, 0
...
/* 803CEF50 003CAD90  38 61 00 08 */	addi r3, r1, 8
...
/* 803CEF60 003CADA0  38 81 00 08 */	addi r4, r1, 8
/* 803CEF64 003CADA4  38 AD DC 00 */	addi r5, r13, $$252073-_SDA_BASE_
/* 803CEF68 003CADA8  4B DC 17 F1 */	bl materialByName__Q23g3d13ModelAccessorCFPCc
/* 803CEF6C 003CADAC  38 61 00 08 */	addi r3, r1, 8
/* 803CEF70 003CADB0  38 80 FF FF */	li r4, -1
/* 803CEF74 003CADB4  4B DA CF D5 */	bl __dt__Q23g3d13ModelAccessorFv
/* 803CEF78 003CADB8  38 61 00 28 */	addi r3, r1, 0x28
/* 803CEF7C 003CADBC  38 80 00 01 */	li r4, 1
...
.global $$252021
$$252021:
	.incbin "baserom.dol", 0x48EDA0, 0x10

.section .sdata, "wa"  # 0x80556420 - 0x8055C6E0
.global $$252022
$$252022:
	.incbin "baserom.dol", 0x4983F0, 0x8
.global $$252072
$$252072:
	.incbin "baserom.dol", 0x4983F8, 0x8
.global $$252073
$$252073:
	.incbin "baserom.dol", 0x498400, 0x8

.section .sdata2, "wa"  # 0x8055DF80 - 0x805643C0
.global $$251593
$$251593:
	.incbin "baserom.dol", 0x49E7A0, 0x8
