...
/* 80272D80 0026EBC0  90 03 00 00 */	stw r0, 0(r3)
/* 80272D84 0026EBC4  38 00 00 00 */	li r0, 0
/* 80272D88 0026EBC8  90 03 00 04 */	stw r0, 4(r3)
/* 80272D8C 0026EBCC  4E 80 00 20 */	blr 

.global update__Q43scn4step5chara5ShakeFv
update__Q43scn4step5chara5ShakeFv:
/* 80272D90 0026EBD0  80 03 00 00 */	lwz r0, 0(r3)
/* 80272D94 0026EBD4  2C 00 00 06 */	cmpwi r0, 6
/* 80272D98 0026EBD8  4D 82 00 20 */	beqlr 
/* 80272D9C 0026EBDC  80 83 00 04 */	lwz r4, 4(r3)
/* 80272DA0 0026EBE0  38 A4 00 01 */	addi r5, r4, 1
/* 80272DA4 0026EBE4  90 A3 00 04 */	stw r5, 4(r3)
/* 80272DA8 0026EBE8  54 00 18 38 */	slwi r0, r0, 3
/* 80272DAC 0026EBEC  3C 80 80 41 */	lis r4, T_TABLE__Q43scn4step5chara19$$2unnamed$$2Shake_cpp$$2@ha
/* 80272DB0 0026EBF0  38 84 79 F0 */	addi r4, r4, T_TABLE__Q43scn4step5chara19$$2unnamed$$2Shake_cpp$$2@l
...
/* 80272DC4 0026EC04  38 00 00 06 */	li r0, 6
/* 80272DC8 0026EC08  90 03 00 00 */	stw r0, 0(r3)
...
/* 80272DDC 0026EC1C  80 04 00 00 */	lwz r0, 0(r4)
/* 80272DE0 0026EC20  2C 00 00 06 */	cmpwi r0, 6
/* 80272DE4 0026EC24  40 82 00 10 */	bne lbl_80272DF4
/* 80272DE8 0026EC28  38 8D EE 28 */	addi r4, r13, ZERO__Q33hel4math7Vector2-_SDA_BASE_
...
/* 80272DF8 0026EC38  3C A0 80 41 */	lis r5, T_TABLE__Q43scn4step5chara19$$2unnamed$$2Shake_cpp$$2@ha
/* 80272DFC 0026EC3C  38 05 79 F0 */	addi r0, r5, T_TABLE__Q43scn4step5chara19$$2unnamed$$2Shake_cpp$$2@l
/* 80272E00 0026EC40  7C A0 32 14 */	add r5, r0, r6
/* 80272E04 0026EC44  C0 02 AD D8 */	lfs f0, $$249717-_SDA2_BASE_(r2)
/* 80272E08 0026EC48  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80272E0C 0026EC4C  D0 01 00 08 */	stfs f0, 8(r1)
/* 80272E10 0026EC50  80 A5 00 04 */	lwz r5, 4(r5)
/* 80272E14 0026EC54  80 84 00 04 */	lwz r4, 4(r4)
...
/* 80272E24 0026EC64  D0 01 00 08 */	stfs f0, 8(r1)
/* 80272E28 0026EC68  28 04 00 01 */	cmplwi r4, 1
/* 80272E2C 0026EC6C  41 80 00 20 */	blt lbl_80272E4C
/* 80272E30 0026EC70  38 04 FF FF */	addi r0, r4, -1
/* 80272E34 0026EC74  54 00 F8 7E */	srwi r0, r0, 1
/* 80272E38 0026EC78  54 00 10 3A */	slwi r0, r0, 2
/* 80272E3C 0026EC7C  C0 22 AD DC */	lfs f1, $$249718-_SDA2_BASE_(r2)
...
lbl_80272E4C:
/* 80272E4C 0026EC8C  38 81 00 08 */	addi r4, r1, 8
