...
/* 803A052C 0039C36C  90 1E 00 00 */	stw r0, 0(r30)
/* 803A0530 0039C370  3B E0 00 00 */	li r31, 0
/* 803A0534 0039C374  9B FE 00 0C */	stb r31, 0xc(r30)
/* 803A0538 0039C378  93 FE 00 10 */	stw r31, 0x10(r30)
/* 803A053C 0039C37C  80 7E 00 08 */	lwz r3, 8(r30)
...
/* 803A0560 0039C3A0  80 7E 00 08 */	lwz r3, 8(r30)
...
/* 803A0574 0039C3B4  3C A0 00 01 */	lis r5, 0x0000C000@ha
/* 803A0578 0039C3B8  38 A5 C0 00 */	addi r5, r5, 0x0000C000@l
/* 803A057C 0039C3BC  3C C0 80 49 */	lis r6, $$257442@ha
/* 803A0580 0039C3C0  38 C6 EB 38 */	addi r6, r6, $$257442@l
...
/* 803A0590 0039C3D0  90 61 00 08 */	stw r3, 8(r1)
...
/* 803A05CC 0039C40C  93 C1 00 08 */	stw r30, 8(r1)
/* 803A05D0 0039C410  7C 7E 1B 78 */	mr r30, r3
/* 803A05D4 0039C414  7C 9F 23 78 */	mr r31, r4
/* 803A05D8 0039C418  2C 03 00 00 */	cmpwi r3, 0
...
/* 803A05E8 0039C428  90 03 00 00 */	stw r0, 0(r3)
/* 803A05EC 0039C42C  88 03 00 0C */	lbz r0, 0xc(r3)
/* 803A05F0 0039C430  2C 00 00 00 */	cmpwi r0, 0
...
/* 803A064C 0039C48C  80 7E 00 08 */	lwz r3, 8(r30)
/* 803A0650 0039C490  4B F9 FC CD */	bl model__Q43scn4step4hero4HeroFv
/* 803A0654 0039C494  38 63 01 F8 */	addi r3, r3, 0x1f8
/* 803A0658 0039C498  38 80 00 08 */	li r4, 8
/* 803A065C 0039C49C  4B DF 8D F9 */	bl unregisterResFile__Q24gobj4AnimFUl
lbl_803A0660:
/* 803A0660 0039C4A0  38 7E 00 A4 */	addi r3, r30, 0xa4
/* 803A0664 0039C4A4  38 80 FF FF */	li r4, -1
/* 803A0668 0039C4A8  4B E7 06 45 */	bl __dt__Q24util37PlacementNew$$0Q23g3d15ResFileAccessor$$1Fv
/* 803A066C 0039C4AC  38 7E 00 3C */	addi r3, r30, 0x3c
/* 803A0670 0039C4B0  38 80 FF FF */	li r4, -1
/* 803A0674 0039C4B4  4B DD 4C 25 */	bl __dt__Q23mem11AutoHeapExpFv
/* 803A0678 0039C4B8  38 7E 00 24 */	addi r3, r30, 0x24
/* 803A067C 0039C4BC  38 80 FF FF */	li r4, -1
/* 803A0680 0039C4C0  4B DD 49 85 */	bl __dt__Q33hel6common31ExplicitSingleton$$0Q23app5Reset$$1Fv
/* 803A0684 0039C4C4  38 7E 00 14 */	addi r3, r30, 0x14
/* 803A0688 0039C4C8  38 80 FF FF */	li r4, -1
/* 803A068C 0039C4CC  4B DD 49 79 */	bl __dt__Q33hel6common31ExplicitSingleton$$0Q23app5Reset$$1Fv
/* 803A0690 0039C4D0  7F C3 F3 78 */	mr r3, r30
/* 803A0694 0039C4D4  38 80 00 00 */	li r4, 0
/* 803A0698 0039C4D8  4B F8 B1 01 */	bl __dt__Q43scn4step4hero11AbilityBaseFv
/* 803A069C 0039C4DC  7F E0 07 34 */	extsh r0, r31
/* 803A06A0 0039C4E0  2C 00 00 00 */	cmpwi r0, 0
...
/* 803A06B8 0039C4F8  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 803A0874 0039C6B4  4B C6 6A D1 */	bl func_80007344
/* 803A0878 0039C6B8  7C 7D 1B 78 */	mr r29, r3
/* 803A087C 0039C6BC  80 63 00 08 */	lwz r3, 8(r3)
...
/* 803A08DC 0039C71C  2C 03 00 00 */	cmpwi r3, 0
...
/* 803A08F0 0039C730  83 BD 00 08 */	lwz r29, 8(r29)
...
/* 803A0908 0039C748  2C 04 00 00 */	cmpwi r4, 0
/* 803A090C 0039C74C  41 82 00 2C */	beq lbl_803A0938
/* 803A0910 0039C750  3C 60 80 46 */	lis r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@ha
/* 803A0914 0039C754  38 03 44 78 */	addi r0, r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@l
/* 803A0918 0039C758  90 04 00 00 */	stw r0, 0(r4)
/* 803A091C 0039C75C  38 1E 00 90 */	addi r0, r30, 0x90
/* 803A0920 0039C760  90 04 00 04 */	stw r0, 4(r4)
/* 803A0924 0039C764  3C 60 80 49 */	lis r3, __vt__Q24util156StateFactoryArg2$$0Q24util6IState$$4Q53scn4step4hero5stone14StateStartJump$$4PQ43scn4step4hero4Hero$$4Q33std3tr149reference_wrapper$$0Q53scn4step4hero5stone7Context$$1$$1@ha
/* 803A0928 0039C768  38 03 DB 38 */	addi r0, r3, __vt__Q24util156StateFactoryArg2$$0Q24util6IState$$4Q53scn4step4hero5stone14StateStartJump$$4PQ43scn4step4hero4Hero$$4Q33std3tr149reference_wrapper$$0Q53scn4step4hero5stone7Context$$1$$1@l
/* 803A092C 0039C76C  90 04 00 00 */	stw r0, 0(r4)
/* 803A0930 0039C770  93 A4 00 08 */	stw r29, 8(r4)
/* 803A0934 0039C774  93 E4 00 0C */	stw r31, 0xc(r4)
lbl_803A0938:
/* 803A0938 0039C778  90 9E 00 0C */	stw r4, 0xc(r30)
/* 803A093C 0039C77C  38 60 00 01 */	li r3, 1
/* 803A0940 0039C780  48 00 00 70 */	b lbl_803A09B0
lbl_803A0944:
/* 803A0944 0039C784  80 7D 00 08 */	lwz r3, 8(r29)
/* 803A0948 0039C788  48 00 13 6D */	bl TryToChangeState__Q53scn4step4hero5smash18StateHammerAirSpinFPQ43scn4step4hero4Hero
/* 803A094C 0039C78C  2C 03 00 00 */	cmpwi r3, 0
/* 803A0950 0039C790  40 82 00 54 */	bne lbl_803A09A4
/* 803A0954 0039C794  80 7D 00 08 */	lwz r3, 8(r29)
/* 803A0958 0039C798  48 00 16 F5 */	bl TryToChangeState__Q53scn4step4hero5smash22StateHammerStrongSwingFPQ43scn4step4hero4Hero
/* 803A095C 0039C79C  2C 03 00 00 */	cmpwi r3, 0
/* 803A0960 0039C7A0  40 82 00 44 */	bne lbl_803A09A4
/* 803A0964 0039C7A4  80 7D 00 08 */	lwz r3, 8(r29)
/* 803A0968 0039C7A8  48 00 0D 2D */	bl TryToChangeState__Q53scn4step4hero5smash19StateFinalCutterPreFPQ43scn4step4hero4Hero
/* 803A096C 0039C7AC  2C 03 00 00 */	cmpwi r3, 0
/* 803A0970 0039C7B0  40 82 00 34 */	bne lbl_803A09A4
/* 803A0974 0039C7B4  80 7D 00 08 */	lwz r3, 8(r29)
/* 803A0978 0039C7B8  48 00 1C 4D */	bl TryToChangeState__Q53scn4step4hero5smash20StateSmashKickChargeFPQ43scn4step4hero4Hero
/* 803A097C 0039C7BC  2C 03 00 00 */	cmpwi r3, 0
/* 803A0980 0039C7C0  40 82 00 24 */	bne lbl_803A09A4
/* 803A0984 0039C7C4  80 7D 00 08 */	lwz r3, 8(r29)
/* 803A0988 0039C7C8  48 00 03 91 */	bl TryToChangeState__Q53scn4step4hero5smash12StateAirSpinFPQ43scn4step4hero4Hero
/* 803A098C 0039C7CC  2C 03 00 00 */	cmpwi r3, 0
/* 803A0990 0039C7D0  40 82 00 14 */	bne lbl_803A09A4
/* 803A0994 0039C7D4  80 7D 00 08 */	lwz r3, 8(r29)
/* 803A0998 0039C7D8  48 00 1F 69 */	bl TryToChangeState__Q53scn4step4hero5smash11StateVulcanFPQ43scn4step4hero4Hero
/* 803A099C 0039C7DC  2C 03 00 00 */	cmpwi r3, 0
/* 803A09A0 0039C7E0  41 82 00 0C */	beq lbl_803A09AC
lbl_803A09A4:
/* 803A09A4 0039C7E4  38 60 00 01 */	li r3, 1
/* 803A09A8 0039C7E8  48 00 00 08 */	b lbl_803A09B0
lbl_803A09AC:
/* 803A09AC 0039C7EC  38 60 00 00 */	li r3, 0
lbl_803A09B0:
/* 803A09B0 0039C7F0  39 61 00 20 */	addi r11, r1, 0x20
/* 803A09B4 0039C7F4  4B C6 69 DD */	bl func_80007390
...
/* 803A0A28 0039C868  2C 03 00 00 */	cmpwi r3, 0
/* 803A0A2C 0039C86C  41 82 00 2C */	beq lbl_803A0A58
/* 803A0A30 0039C870  80 7F 00 08 */	lwz r3, 8(r31)
...
/* 803A0A3C 0039C87C  2C 03 00 00 */	cmpwi r3, 0
/* 803A0A40 0039C880  40 82 00 18 */	bne lbl_803A0A58
/* 803A0A44 0039C884  80 7F 00 08 */	lwz r3, 8(r31)
...
lbl_803A0A58:
/* 803A0A58 0039C898  80 7F 00 08 */	lwz r3, 8(r31)
...
/* 803A0AD4 0039C914  4B C6 68 71 */	bl func_80007344
/* 803A0AD8 0039C918  7C 7D 1B 78 */	mr r29, r3
/* 803A0ADC 0039C91C  3C 80 80 42 */	lis r4, STONEBODY_TABLE_0__Q53scn4step4hero5smash19$$2unnamed$$2Smash_cpp$$2@ha
/* 803A0AE0 0039C920  38 84 FD 18 */	addi r4, r4, STONEBODY_TABLE_0__Q53scn4step4hero5smash19$$2unnamed$$2Smash_cpp$$2@l
/* 803A0AE4 0039C924  80 03 00 10 */	lwz r0, 0x10(r3)
/* 803A0AE8 0039C928  28 00 00 04 */	cmplwi r0, 4
...
lbl_803A0B04:
/* 803A0B04 0039C944  2C 00 00 00 */	cmpwi r0, 0
...
/* 803A0B24 0039C964  38 84 00 00 */	addi r4, r4, 0
...
/* 803A0B34 0039C974  38 03 00 01 */	addi r0, r3, 1
...
/* 803A0B58 0039C998  3C 80 80 49 */	lis r4, STONEBODY_MODEL_TABLE__Q53scn4step4hero5smash19$$2unnamed$$2Smash_cpp$$2@ha
/* 803A0B5C 0039C99C  38 84 EA F8 */	addi r4, r4, STONEBODY_MODEL_TABLE__Q53scn4step4hero5smash19$$2unnamed$$2Smash_cpp$$2@l
/* 803A0B60 0039C9A0  7C 84 00 2E */	lwzx r4, r4, r0
/* 803A0B64 0039C9A4  38 A0 00 00 */	li r5, 0
...
/* 803A0BBC 0039C9FC  90 01 00 08 */	stw r0, 8(r1)
/* 803A0BC0 0039CA00  38 61 00 10 */	addi r3, r1, 0x10
/* 803A0BC4 0039CA04  38 81 00 08 */	addi r4, r1, 8
...
/* 803A0BD8 0039CA18  4B DE FC CD */	bl destruct__Q24util33PlacementNew$$0Q23g3d11AutoReqAnim$$1Fv
/* 803A0BDC 0039CA1C  3B DD 00 A8 */	addi r30, r29, 0xa8
/* 803A0BE0 0039CA20  2C 1E 00 00 */	cmpwi r30, 0
...
/* 803A0BFC 0039CA3C  80 7D 00 08 */	lwz r3, 8(r29)
...
/* 803A0C4C 0039CA8C  38 80 FF FF */	li r4, -1
/* 803A0C50 0039CA90  4B DD 43 B5 */	bl __dt__Q33hel6common31ExplicitSingleton$$0Q23app5Reset$$1Fv
/* 803A0C54 0039CA94  39 61 00 40 */	addi r11, r1, 0x40
/* 803A0C58 0039CA98  4B C6 67 39 */	bl func_80007390
...
/* 803A0C80 0039CAC0  80 63 00 08 */	lwz r3, 8(r3)
...
/* 803A0C90 0039CAD0  2C 03 00 00 */	cmpwi r3, 0
/* 803A0C94 0039CAD4  41 82 00 70 */	beq lbl_803A0D04
/* 803A0C98 0039CAD8  80 7F 00 08 */	lwz r3, 8(r31)
...
/* 803A0CA8 0039CAE8  80 7F 00 08 */	lwz r3, 8(r31)
