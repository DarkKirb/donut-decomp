...
/* 803C72AC 003C30EC  90 1F 00 00 */	stw r0, 0(r31)
/* 803C72B0 003C30F0  C0 02 DA F0 */	lfs f0, $$255066-_SDA2_BASE_(r2)
/* 803C72B4 003C30F4  D0 1F 00 08 */	stfs f0, 8(r31)
...
/* 803C72C4 003C3104  38 80 00 00 */	li r4, 0
...
/* 803C7330 003C3170  C0 3E 00 08 */	lfs f1, 8(r30)
...
/* 803C7358 003C3198  C0 22 DA F4 */	lfs f1, $$255081-_SDA2_BASE_(r2)
/* 803C735C 003C319C  C0 1E 00 08 */	lfs f0, 8(r30)
...
/* 803C7370 003C31B0  90 61 00 08 */	stw r3, 8(r1)
...
/* 803C73B4 003C31F4  38 81 00 08 */	addi r4, r1, 8
...
/* 803C73D0 003C3210  C0 3E 00 08 */	lfs f1, 8(r30)
/* 803C73D4 003C3214  C0 1F 00 64 */	lfs f0, 0x64(r31)
/* 803C73D8 003C3218  EC 21 00 2A */	fadds f1, f1, f0
/* 803C73DC 003C321C  D0 3E 00 08 */	stfs f1, 8(r30)
/* 803C73E0 003C3220  C0 02 DA F4 */	lfs f0, $$255081-_SDA2_BASE_(r2)
/* 803C73E4 003C3224  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 803C73E8 003C3228  40 81 00 08 */	ble lbl_803C73F0
/* 803C73EC 003C322C  D0 1E 00 08 */	stfs f0, 8(r30)
lbl_803C73F0:
...
/* 803C7450 003C3290  83 C1 00 08 */	lwz r30, 8(r1)
