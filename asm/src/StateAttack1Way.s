...
/* 802CA028 002C5E68  90 1E 00 00 */	stw r0, 0(r30)
/* 802CA02C 002C5E6C  38 00 00 00 */	li r0, 0
/* 802CA030 002C5E70  90 1E 00 08 */	stw r0, 8(r30)
...
/* 802CA050 002C5E90  38 80 00 08 */	li r4, 8
...
/* 802CA068 002C5EA8  2C 03 00 00 */	cmpwi r3, 0
...
/* 802CA094 002C5ED4  38 A0 00 01 */	li r5, 1
...
/* 802CA0A8 002C5EE8  38 61 00 08 */	addi r3, r1, 8
...
/* 802CA0D0 002C5F10  38 A1 00 08 */	addi r5, r1, 8
...
/* 802CA0DC 002C5F1C  38 80 FF FF */	li r4, -1
...
/* 802CA110 002C5F50  F3 E1 00 88 */	psq_st f31, 136(r1), 0, qr0
/* 802CA114 002C5F54  DB C1 00 70 */	stfd f30, 0x70(r1)
/* 802CA118 002C5F58  F3 C1 00 78 */	psq_st f30, 120(r1), 0, qr0
/* 802CA11C 002C5F5C  39 61 00 70 */	addi r11, r1, 0x70
/* 802CA120 002C5F60  4B D3 D2 25 */	bl func_80007344
...
/* 802CA138 002C5F78  80 7D 00 08 */	lwz r3, 8(r29)
/* 802CA13C 002C5F7C  38 03 00 01 */	addi r0, r3, 1
/* 802CA140 002C5F80  90 1D 00 08 */	stw r0, 8(r29)
...
/* 802CA15C 002C5F9C  C0 23 00 04 */	lfs f1, 4(r3)
/* 802CA160 002C5FA0  C0 02 BE 64 */	lfs f0, $$255608-_SDA2_BASE_(r2)
/* 802CA164 002C5FA4  EC 20 00 72 */	fmuls f1, f0, f1
/* 802CA168 002C5FA8  C0 02 BE 60 */	lfs f0, $$255607-_SDA2_BASE_(r2)
...
/* 802CA188 002C5FC8  C0 23 00 04 */	lfs f1, 4(r3)
/* 802CA18C 002C5FCC  C0 02 BE 64 */	lfs f0, $$255608-_SDA2_BASE_(r2)
/* 802CA190 002C5FD0  EC 20 00 72 */	fmuls f1, f0, f1
/* 802CA194 002C5FD4  C0 02 BE 60 */	lfs f0, $$255607-_SDA2_BASE_(r2)
...
/* 802CA1B4 002C5FF4  4B FB 88 09 */	bl RuntimeTypeInfoImpl$$0Q53scn4step5enemy6owgulf6Custom$$1__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo
/* 802CA1B8 002C5FF8  7C 7F 1B 78 */	mr r31, r3
/* 802CA1BC 002C5FFC  2C 1E 00 00 */	cmpwi r30, 0
/* 802CA1C0 002C6000  41 82 00 48 */	beq lbl_802CA208
/* 802CA1C4 002C6004  7F C3 F3 78 */	mr r3, r30
/* 802CA1C8 002C6008  81 83 00 00 */	lwz r12, 0(r3)
/* 802CA1CC 002C600C  81 8C 00 08 */	lwz r12, 8(r12)
...
/* 802CA1E4 002C6024  38 00 00 01 */	li r0, 1
/* 802CA1E8 002C6028  48 00 00 14 */	b lbl_802CA1FC
lbl_802CA1EC:
/* 802CA1EC 002C602C  80 63 00 00 */	lwz r3, 0(r3)
lbl_802CA1F0:
/* 802CA1F0 002C6030  2C 03 00 00 */	cmpwi r3, 0
/* 802CA1F4 002C6034  40 82 FF E8 */	bne lbl_802CA1DC
/* 802CA1F8 002C6038  38 00 00 00 */	li r0, 0
lbl_802CA1FC:
/* 802CA1FC 002C603C  2C 00 00 00 */	cmpwi r0, 0
/* 802CA200 002C6040  41 82 00 08 */	beq lbl_802CA208
/* 802CA204 002C6044  48 00 00 08 */	b lbl_802CA20C
lbl_802CA208:
/* 802CA208 002C6048  3B C0 00 00 */	li r30, 0
lbl_802CA20C:
...
/* 802CA228 002C6068  C0 62 BE 68 */	lfs f3, $$255609-_SDA2_BASE_(r2)
/* 802CA22C 002C606C  4B DF 3E 95 */	bl __ct__Q34nw4r4math4VEC3Ffff
/* 802CA230 002C6070  80 83 00 00 */	lwz r4, 0(r3)
/* 802CA234 002C6074  80 03 00 04 */	lwz r0, 4(r3)
/* 802CA238 002C6078  90 81 00 08 */	stw r4, 8(r1)
/* 802CA23C 002C607C  90 01 00 0C */	stw r0, 0xc(r1)
/* 802CA240 002C6080  80 03 00 08 */	lwz r0, 8(r3)
/* 802CA244 002C6084  90 01 00 10 */	stw r0, 0x10(r1)
/* 802CA248 002C6088  C0 01 00 08 */	lfs f0, 8(r1)
/* 802CA24C 002C608C  C0 22 BE 6C */	lfs f1, $$255610-_SDA2_BASE_(r2)
/* 802CA250 002C6090  EC 00 00 72 */	fmuls f0, f0, f1
/* 802CA254 002C6094  D0 01 00 08 */	stfs f0, 8(r1)
...
/* 802CA274 002C60B4  38 81 00 08 */	addi r4, r1, 8
/* 802CA278 002C60B8  4B EB 23 51 */	bl __ct__Q33hel4math7Vector3FRCQ33hel4math7Vector3
/* 802CA27C 002C60BC  C0 22 BE 68 */	lfs f1, $$255609-_SDA2_BASE_(r2)
/* 802CA280 002C60C0  D0 21 00 38 */	stfs f1, 0x38(r1)
/* 802CA284 002C60C4  C0 02 BE 70 */	lfs f0, $$255611-_SDA2_BASE_(r2)
...
/* 802CA308 002C6148  38 C0 00 00 */	li r6, 0
...
/* 802CA320 002C6160  2C 03 00 00 */	cmpwi r3, 0
...
/* 802CA354 002C6194  4B D3 D0 3D */	bl func_80007390
...
__vt__Q53scn4step5enemy6owgulf15StateAttack1Way:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q53scn4step5enemy6owgulf15StateAttack1WayFv
	.byte4 procAnim__Q53scn4step5enemy6owgulf15StateAttack1WayFv
