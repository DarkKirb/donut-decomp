...
/* 802CA390 002C61D0  90 1E 00 00 */	stw r0, 0x0(r30)
/* 802CA394 002C61D4  38 00 00 00 */	li r0, 0x0
/* 802CA398 002C61D8  90 1E 00 08 */	stw r0, 0x8(r30)
...
/* 802CA3B8 002C61F8  38 80 00 09 */	li r4, 0x9
...
/* 802CA3D0 002C6210  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802CA3FC 002C623C  38 A0 00 01 */	li r5, 0x1
...
/* 802CA410 002C6250  38 61 00 08 */	addi r3, r1, 0x8
...
/* 802CA438 002C6278  38 A1 00 08 */	addi r5, r1, 0x8
...
/* 802CA444 002C6284  38 80 FF FF */	li r4, -0x1
...
/* 802CA478 002C62B8  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 802CA490 002C62D0  80 9E 00 08 */	lwz r4, 0x8(r30)
/* 802CA494 002C62D4  38 84 00 01 */	addi r4, r4, 0x1
/* 802CA498 002C62D8  90 9E 00 08 */	stw r4, 0x8(r30)
...
/* 802CA4AC 002C62EC  C0 3F 00 08 */	lfs f1, 0x8(r31)
...
/* 802CA4DC 002C631C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802CA4F8 002C6338  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 802CA51C 002C635C  F3 E1 00 98 */	psq_st f31, 0x98(r1), 0, qr0
/* 802CA520 002C6360  DB C1 00 80 */	stfd f30, 0x80(r1)
/* 802CA524 002C6364  F3 C1 00 88 */	psq_st f30, 0x88(r1), 0, qr0
/* 802CA528 002C6368  DB A1 00 70 */	stfd f29, 0x70(r1)
/* 802CA52C 002C636C  F3 A1 00 78 */	psq_st f29, 0x78(r1), 0, qr0
/* 802CA530 002C6370  39 61 00 70 */	addi r11, r1, 0x70
/* 802CA534 002C6374  4B D3 CE 11 */	bl lbl_80007344
/* 802CA538 002C6378  7C 7D 1B 78 */	mr r29, r3
/* 802CA53C 002C637C  FF A0 08 90 */	fmr f29, f1
/* 802CA540 002C6380  C0 02 BE 7C */	lfs f0, "@55580"@sda21(r2)
/* 802CA544 002C6384  EC 20 00 72 */	fmuls f1, f0, f1
/* 802CA548 002C6388  C0 02 BE 78 */	lfs f0, "@55579"@sda21(r2)
...
/* 802CA558 002C6398  C0 02 BE 7C */	lfs f0, "@55580"@sda21(r2)
/* 802CA55C 002C639C  EC 20 07 72 */	fmuls f1, f0, f29
/* 802CA560 002C63A0  C0 02 BE 78 */	lfs f0, "@55579"@sda21(r2)
...
/* 802CA580 002C63C0  4B FB 84 3D */	bl "RuntimeTypeInfoImpl<Q53scn4step5enemy6owgulf6Custom>__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo"
/* 802CA584 002C63C4  7C 7F 1B 78 */	mr r31, r3
/* 802CA588 002C63C8  2C 1E 00 00 */	cmpwi r30, 0x0
/* 802CA58C 002C63CC  41 82 00 48 */	beq lbl_802CA5D4
/* 802CA590 002C63D0  7F C3 F3 78 */	mr r3, r30
/* 802CA594 002C63D4  81 83 00 00 */	lwz r12, 0x0(r3)
/* 802CA598 002C63D8  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 802CA5B0 002C63F0  38 00 00 01 */	li r0, 0x1
/* 802CA5B4 002C63F4  48 00 00 14 */	b lbl_802CA5C8
.global lbl_802CA5B8
lbl_802CA5B8:
/* 802CA5B8 002C63F8  80 63 00 00 */	lwz r3, 0x0(r3)
.global lbl_802CA5BC
lbl_802CA5BC:
/* 802CA5BC 002C63FC  2C 03 00 00 */	cmpwi r3, 0x0
/* 802CA5C0 002C6400  40 82 FF E8 */	bne lbl_802CA5A8
/* 802CA5C4 002C6404  38 00 00 00 */	li r0, 0x0
.global lbl_802CA5C8
lbl_802CA5C8:
/* 802CA5C8 002C6408  2C 00 00 00 */	cmpwi r0, 0x0
/* 802CA5CC 002C640C  41 82 00 08 */	beq lbl_802CA5D4
/* 802CA5D0 002C6410  48 00 00 08 */	b lbl_802CA5D8
.global lbl_802CA5D4
lbl_802CA5D4:
/* 802CA5D4 002C6414  3B C0 00 00 */	li r30, 0x0
.global lbl_802CA5D8
lbl_802CA5D8:
...
/* 802CA608 002C6448  C0 62 BE 80 */	lfs f3, "@55581"@sda21(r2)
/* 802CA60C 002C644C  4B DF 3A B5 */	bl __ct__Q34nw4r4math4VEC3Ffff
/* 802CA610 002C6450  80 83 00 00 */	lwz r4, 0x0(r3)
/* 802CA614 002C6454  80 03 00 04 */	lwz r0, 0x4(r3)
/* 802CA618 002C6458  90 81 00 08 */	stw r4, 0x8(r1)
/* 802CA61C 002C645C  90 01 00 0C */	stw r0, 0xc(r1)
/* 802CA620 002C6460  80 03 00 08 */	lwz r0, 0x8(r3)
/* 802CA624 002C6464  90 01 00 10 */	stw r0, 0x10(r1)
/* 802CA628 002C6468  C0 01 00 08 */	lfs f0, 0x8(r1)
/* 802CA62C 002C646C  EC 00 07 72 */	fmuls f0, f0, f29
/* 802CA630 002C6470  D0 01 00 08 */	stfs f0, 0x8(r1)
...
/* 802CA650 002C6490  38 81 00 08 */	addi r4, r1, 0x8
/* 802CA654 002C6494  4B EB 1F 75 */	bl __ct__Q33hel4math7Vector3FRCQ33hel4math7Vector3
/* 802CA658 002C6498  C0 22 BE 80 */	lfs f1, "@55581"@sda21(r2)
/* 802CA65C 002C649C  D0 21 00 38 */	stfs f1, 0x38(r1)
/* 802CA660 002C64A0  C0 02 BE 84 */	lfs f0, "@55582"@sda21(r2)
...
/* 802CA6E4 002C6524  38 C0 00 01 */	li r6, 0x1
...
/* 802CA714 002C6554  4B D3 CC 7D */	bl lbl_80007390
