...
/* 802F2644 002EE484  90 1E 00 00 */	stw r0, 0(r30)
/* 802F2648 002EE488  38 00 00 00 */	li r0, 0
/* 802F264C 002EE48C  90 1E 00 08 */	stw r0, 8(r30)
...
/* 802F2674 002EE4B4  38 61 00 08 */	addi r3, r1, 8
...
/* 802F2694 002EE4D4  38 81 00 08 */	addi r4, r1, 8
...
/* 802F26A8 002EE4E8  38 80 00 08 */	li r4, 8
...
/* 802F26BC 002EE4FC  38 80 00 01 */	li r4, 1
...
/* 802F2718 002EE558  80 64 00 00 */	lwz r3, 0(r4)
/* 802F271C 002EE55C  80 04 00 04 */	lwz r0, 4(r4)
/* 802F2720 002EE560  90 61 00 2C */	stw r3, 0x2c(r1)
/* 802F2724 002EE564  90 01 00 30 */	stw r0, 0x30(r1)
/* 802F2728 002EE568  80 04 00 08 */	lwz r0, 8(r4)
...
/* 802F274C 002EE58C  C0 02 C6 18 */	lfs f0, $$256131-_SDA2_BASE_(r2)
...
/* 802F2768 002EE5A8  2C 03 00 00 */	cmpwi r3, 0
...
/* 802F278C 002EE5CC  C0 02 C6 18 */	lfs f0, $$256131-_SDA2_BASE_(r2)
...
/* 802F27A8 002EE5E8  2C 03 00 00 */	cmpwi r3, 0
/* 802F27AC 002EE5EC  40 82 00 50 */	bne lbl_802F27FC
lbl_802F27B0:
/* 802F27B0 002EE5F0  38 00 00 01 */	li r0, 1
/* 802F27B4 002EE5F4  90 1E 00 08 */	stw r0, 8(r30)
/* 802F27B8 002EE5F8  38 61 00 08 */	addi r3, r1, 8
...
/* 802F27D0 002EE610  C0 01 00 08 */	lfs f0, 8(r1)
...
/* 802F280C 002EE64C  2C 03 00 00 */	cmpwi r3, 0
/* 802F2810 002EE650  41 82 00 0C */	beq lbl_802F281C
/* 802F2814 002EE654  C0 22 C6 1C */	lfs f1, $$256132-_SDA2_BASE_(r2)
/* 802F2818 002EE658  48 00 00 08 */	b lbl_802F2820
lbl_802F281C:
/* 802F281C 002EE65C  C0 22 C6 20 */	lfs f1, $$256133-_SDA2_BASE_(r2)
lbl_802F2820:
...
/* 802F286C 002EE6AC  F3 E1 00 D8 */	psq_st f31, 216(r1), 0, qr0
/* 802F2870 002EE6B0  39 61 00 D0 */	addi r11, r1, 0xd0
/* 802F2874 002EE6B4  4B D1 4A D1 */	bl func_80007344
...
/* 802F28F4 002EE734  2C 03 00 00 */	cmpwi r3, 0
/* 802F28F8 002EE738  41 82 02 30 */	beq lbl_802F2B28
lbl_802F28FC:
/* 802F28FC 002EE73C  3B C0 00 00 */	li r30, 0
...
/* 802F2910 002EE750  2C 03 00 00 */	cmpwi r3, 0
/* 802F2914 002EE754  41 82 00 14 */	beq lbl_802F2928
/* 802F2918 002EE758  80 1F 00 08 */	lwz r0, 8(r31)
/* 802F291C 002EE75C  2C 00 00 01 */	cmpwi r0, 1
/* 802F2920 002EE760  40 82 00 08 */	bne lbl_802F2928
/* 802F2924 002EE764  3B C0 00 01 */	li r30, 1
lbl_802F2928:
/* 802F2928 002EE768  2C 1E 00 00 */	cmpwi r30, 0
...
/* 802F2940 002EE780  C0 02 C6 1C */	lfs f0, $$256132-_SDA2_BASE_(r2)
...
/* 802F2964 002EE7A4  38 8D EE 28 */	addi r4, r13, ZERO__Q33hel4math7Vector2-_SDA_BASE_
...
/* 802F2970 002EE7B0  38 8D EE 28 */	addi r4, r13, ZERO__Q33hel4math7Vector2-_SDA_BASE_
...
/* 802F297C 002EE7BC  2C 00 00 00 */	cmpwi r0, 0
...
/* 802F29D0 002EE810  C0 1D 00 00 */	lfs f0, 0(r29)
/* 802F29D4 002EE814  EC 20 07 F2 */	fmuls f1, f0, f31
/* 802F29D8 002EE818  C0 5D 00 04 */	lfs f2, 4(r29)
...
/* 802F29EC 002EE82C  38 61 00 08 */	addi r3, r1, 8
/* 802F29F0 002EE830  C0 1D 00 08 */	lfs f0, 8(r29)
...
/* 802F2A38 002EE878  2C 03 00 00 */	cmpwi r3, 0
...
lbl_802F2A50:
/* 802F2A50 002EE890  80 7E 00 00 */	lwz r3, 0(r30)
/* 802F2A54 002EE894  80 1E 00 04 */	lwz r0, 4(r30)
/* 802F2A58 002EE898  90 61 00 68 */	stw r3, 0x68(r1)
/* 802F2A5C 002EE89C  90 01 00 6C */	stw r0, 0x6c(r1)
/* 802F2A60 002EE8A0  80 1E 00 08 */	lwz r0, 8(r30)
...
/* 802F2B08 002EE948  38 63 00 08 */	addi r3, r3, 8
...
/* 802F2B38 002EE978  4B D1 48 59 */	bl func_80007390
...
__vt__Q53scn4step5enemy15zankibblecutter15StateBackCircle:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q53scn4step5enemy15zankibblecutter15StateBackCircleFv
	.byte4 procAnim__Q53scn4step5enemy15zankibblecutter15StateBackCircleFv
	.byte4 procMove__Q53scn4step5enemy15zankibblecutter15StateBackCircleFv
	.byte4 procConstraint__Q43scn4step5enemy9StateBaseFv
	.byte4 procFixPos__Q53scn4step5enemy15zankibblecutter15StateBackCircleFv
