...
/* 802F1B04 002ED944  90 1E 00 00 */	stw r0, 0(r30)
/* 802F1B08 002ED948  C0 02 C6 00 */	lfs f0, $$256802-_SDA2_BASE_(r2)
/* 802F1B0C 002ED94C  D0 1E 00 08 */	stfs f0, 8(r30)
...
/* 802F1B3C 002ED97C  38 61 00 08 */	addi r3, r1, 8
...
/* 802F1B60 002ED9A0  D0 3E 00 08 */	stfs f1, 8(r30)
...
/* 802F1B78 002ED9B8  C0 02 C6 00 */	lfs f0, $$256802-_SDA2_BASE_(r2)
...
/* 802F1B88 002ED9C8  2C 1F 00 00 */	cmpwi r31, 0
...
/* 802F1C08 002EDA48  38 80 00 00 */	li r4, 0
...
/* 802F1C80 002EDAC0  C0 1E 00 08 */	lfs f0, 8(r30)
/* 802F1C84 002EDAC4  EC 22 00 7A */	fmadds f1, f2, f1, f0
/* 802F1C88 002EDAC8  D0 3E 00 08 */	stfs f1, 8(r30)
/* 802F1C8C 002EDACC  C0 02 C6 04 */	lfs f0, $$256828-_SDA2_BASE_(r2)
/* 802F1C90 002EDAD0  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802F1C94 002EDAD4  4C 41 13 82 */	cror 2, 1, 2
/* 802F1C98 002EDAD8  40 82 00 0C */	bne lbl_802F1CA4
/* 802F1C9C 002EDADC  EC 01 00 28 */	fsubs f0, f1, f0
/* 802F1CA0 002EDAE0  D0 1E 00 08 */	stfs f0, 8(r30)
lbl_802F1CA4:
/* 802F1CA4 002EDAE4  C0 3E 00 08 */	lfs f1, 8(r30)
/* 802F1CA8 002EDAE8  C0 02 C6 00 */	lfs f0, $$256802-_SDA2_BASE_(r2)
/* 802F1CAC 002EDAEC  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802F1CB0 002EDAF0  40 80 00 10 */	bge lbl_802F1CC0
/* 802F1CB4 002EDAF4  C0 02 C6 04 */	lfs f0, $$256828-_SDA2_BASE_(r2)
/* 802F1CB8 002EDAF8  EC 01 00 2A */	fadds f0, f1, f0
/* 802F1CBC 002EDAFC  D0 1E 00 08 */	stfs f0, 8(r30)
lbl_802F1CC0:
...
/* 802F1CD0 002EDB10  C0 3E 00 08 */	lfs f1, 8(r30)
...
/* 802F1CE8 002EDB28  C0 02 C6 04 */	lfs f0, $$256828-_SDA2_BASE_(r2)
/* 802F1CEC 002EDB2C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802F1CF0 002EDB30  4C 41 13 82 */	cror 2, 1, 2
...
/* 802F1D04 002EDB44  C0 02 C6 00 */	lfs f0, $$256802-_SDA2_BASE_(r2)
/* 802F1D08 002EDB48  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802F1D0C 002EDB4C  40 80 00 10 */	bge lbl_802F1D1C
/* 802F1D10 002EDB50  C0 02 C6 04 */	lfs f0, $$256828-_SDA2_BASE_(r2)
...
/* 802F1D20 002EDB60  D0 01 00 08 */	stfs f0, 8(r1)
/* 802F1D24 002EDB64  C0 02 C6 00 */	lfs f0, $$256802-_SDA2_BASE_(r2)
...
/* 802F1D38 002EDB78  38 81 00 08 */	addi r4, r1, 8
...
/* 802F1D68 002EDBA8  93 C1 00 08 */	stw r30, 8(r1)
...
/* 802F1D9C 002EDBDC  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 802F1DC0 002EDC00  F3 E1 00 38 */	psq_st f31, 56(r1), 0, qr0
...
/* 802F1E14 002EDC54  38 80 00 00 */	li r4, 0
...
/* 802F1E64 002EDCA4  38 61 00 08 */	addi r3, r1, 8
...
/* 802F1EAC 002EDCEC  C0 01 00 08 */	lfs f0, 8(r1)
...
__vt__Q53scn4step5enemy11whispyapple14StateBoundNear:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q53scn4step5enemy11whispyapple14StateBoundNearFv
	.byte4 procAnim__Q53scn4step5enemy11whispyapple14StateBoundNearFv
	.byte4 procMove__Q53scn4step5enemy11whispyapple14StateBoundNearFv
	.byte4 procConstraint__Q43scn4step5enemy9StateBaseFv
	.byte4 procFixPos__Q53scn4step5enemy11whispyapple14StateBoundNearFv
