...
/* 803C7488 003C32C8  4B FF DD 61 */	bl lbl_803C51E8
/* 803C748C 003C32CC  3C 60 80 49 */	lis r3, lbl_80492578@ha
/* 803C7490 003C32D0  38 03 25 78 */	addi r0, r3, lbl_80492578@l
/* 803C7494 003C32D4  90 1E 00 00 */	stw r0, 0x0(r30)
/* 803C7498 003C32D8  7F E3 FB 78 */	mr r3, r31
/* 803C749C 003C32DC  4B FF B8 0D */	bl lbl_803C2CA8
/* 803C74A0 003C32E0  C3 E3 00 60 */	lfs f31, 0x60(r3)
/* 803C74A4 003C32E4  7F E3 FB 78 */	mr r3, r31
/* 803C74A8 003C32E8  4B FF B8 01 */	bl lbl_803C2CA8
...
/* 803C74BC 003C32FC  4B FF 99 85 */	bl lbl_803C0E40
/* 803C74C0 003C3300  7F C3 F3 78 */	mr r3, r30
/* 803C74C4 003C3304  4B D3 93 1D */	bl lbl_801007E0
/* 803C74C8 003C3308  4B FF B7 E1 */	bl lbl_803C2CA8
/* 803C74CC 003C330C  7C 7F 1B 78 */	mr r31, r3
/* 803C74D0 003C3310  7F C3 F3 78 */	mr r3, r30
/* 803C74D4 003C3314  4B D3 93 0D */	bl lbl_801007E0
/* 803C74D8 003C3318  4B FF B8 71 */	bl lbl_803C2D48
/* 803C74DC 003C331C  38 80 00 00 */	li r4, 0x0
/* 803C74E0 003C3320  4B D6 2B 11 */	bl lbl_80129FF0
/* 803C74E4 003C3324  7F C3 F3 78 */	mr r3, r30
/* 803C74E8 003C3328  4B D3 92 F9 */	bl lbl_801007E0
/* 803C74EC 003C332C  4B FF B8 35 */	bl lbl_803C2D20
/* 803C74F0 003C3330  38 80 00 01 */	li r4, 0x1
/* 803C74F4 003C3334  4B FF D5 D1 */	bl lbl_803C4AC4
/* 803C74F8 003C3338  7F C3 F3 78 */	mr r3, r30
/* 803C74FC 003C333C  4B D3 92 E5 */	bl lbl_801007E0
/* 803C7500 003C3340  4B FF B7 E1 */	bl lbl_803C2CE0
/* 803C7504 003C3344  C0 3F 00 34 */	lfs f1, 0x34(r31)
/* 803C7508 003C3348  4B DD 3E 79 */	bl lbl_8019B380
/* 803C750C 003C334C  C3 FF 00 38 */	lfs f31, 0x38(r31)
/* 803C7510 003C3350  7F C3 F3 78 */	mr r3, r30
/* 803C7514 003C3354  4B D3 92 CD */	bl lbl_801007E0
/* 803C7518 003C3358  4B CA E2 19 */	bl lbl_80075730
/* 803C751C 003C335C  4B DA EE A5 */	bl lbl_801763C0
/* 803C7520 003C3360  80 63 04 9C */	lwz r3, 0x49c(r3)
/* 803C7524 003C3364  48 00 2F F9 */	bl lbl_803CA51C
...
.global lbl_803C7534
lbl_803C7534:
/* 803C7534 003C3374  4B DB 36 79 */	bl lbl_8017ABAC
/* 803C7538 003C3378  EF FF 00 72 */	fmuls f31, f31, f1
/* 803C753C 003C337C  7F C3 F3 78 */	mr r3, r30
/* 803C7540 003C3380  4B D3 92 A1 */	bl lbl_801007E0
/* 803C7544 003C3384  4B FF B7 9D */	bl lbl_803C2CE0
/* 803C7548 003C3388  FC 20 F8 90 */	fmr f1, f31
/* 803C754C 003C338C  4B D6 31 B5 */	bl lbl_8012A700
...
/* 803C759C 003C33DC  3C 80 80 49 */	lis r4, lbl_80492578@ha
/* 803C75A0 003C33E0  38 04 25 78 */	addi r0, r4, lbl_80492578@l
/* 803C75A4 003C33E4  90 03 00 00 */	stw r0, 0x0(r3)
/* 803C75A8 003C33E8  4B D3 92 39 */	bl lbl_801007E0
/* 803C75AC 003C33EC  4B FF B7 75 */	bl lbl_803C2D20
/* 803C75B0 003C33F0  38 80 00 00 */	li r4, 0x0
/* 803C75B4 003C33F4  4B FF D5 11 */	bl lbl_803C4AC4
/* 803C75B8 003C33F8  7F C3 F3 78 */	mr r3, r30
/* 803C75BC 003C33FC  4B D3 92 25 */	bl lbl_801007E0
/* 803C75C0 003C3400  4B FF B2 9D */	bl lbl_803C285C
/* 803C75C4 003C3404  38 7E 00 08 */	addi r3, r30, 0x8
/* 803C75C8 003C3408  38 80 FF FF */	li r4, -0x1
/* 803C75CC 003C340C  4B DA E5 9D */	bl lbl_80175B68
/* 803C75D0 003C3410  7F C3 F3 78 */	mr r3, r30
/* 803C75D4 003C3414  38 80 00 00 */	li r4, 0x0
/* 803C75D8 003C3418  4B FF DC 31 */	bl lbl_803C5208
...
/* 803C75EC 003C342C  4B DF 81 29 */	bl lbl_801BF714
.global lbl_803C75F0
lbl_803C75F0:
...
/* 803C7624 003C3464  4B FF 98 35 */	bl lbl_803C0E58
/* 803C7628 003C3468  7F E3 FB 78 */	mr r3, r31
/* 803C762C 003C346C  4B D3 91 B5 */	bl lbl_801007E0
/* 803C7630 003C3470  4B FF B2 2D */	bl lbl_803C285C
...
/* 803C7660 003C34A0  4B D3 91 81 */	bl lbl_801007E0
/* 803C7664 003C34A4  4B FF B6 45 */	bl lbl_803C2CA8
/* 803C7668 003C34A8  7C 7F 1B 78 */	mr r31, r3
/* 803C766C 003C34AC  C0 23 00 40 */	lfs f1, 0x40(r3)
/* 803C7670 003C34B0  4B DD 43 8D */	bl lbl_8019B9FC
...
/* 803C7688 003C34C8  4B DD 43 2D */	bl lbl_8019B9B4
/* 803C768C 003C34CC  7F C3 F3 78 */	mr r3, r30
/* 803C7690 003C34D0  4B D3 91 51 */	bl lbl_801007E0
/* 803C7694 003C34D4  4B FF B6 4D */	bl lbl_803C2CE0
/* 803C7698 003C34D8  38 81 00 08 */	addi r4, r1, 0x8
/* 803C769C 003C34DC  38 A1 00 0C */	addi r5, r1, 0xc
/* 803C76A0 003C34E0  4B DD 3E 89 */	bl lbl_8019B528
...
/* 803C76D4 003C3514  4B D3 91 0D */	bl lbl_801007E0
/* 803C76D8 003C3518  4B FF B5 D1 */	bl lbl_803C2CA8
/* 803C76DC 003C351C  7C 7E 1B 78 */	mr r30, r3
/* 803C76E0 003C3520  7F A3 EB 78 */	mr r3, r29
/* 803C76E4 003C3524  4B D3 90 FD */	bl lbl_801007E0
/* 803C76E8 003C3528  4B FF B6 39 */	bl lbl_803C2D20
/* 803C76EC 003C352C  4B FF D4 29 */	bl lbl_803C4B14
...
/* 803C76FC 003C353C  4B D3 90 E5 */	bl lbl_801007E0
/* 803C7700 003C3540  4B FF B5 E1 */	bl lbl_803C2CE0
/* 803C7704 003C3544  7C 64 1B 78 */	mr r4, r3
/* 803C7708 003C3548  38 61 00 20 */	addi r3, r1, 0x20
/* 803C770C 003C354C  4B DD 3C 51 */	bl lbl_8019B35C
/* 803C7710 003C3550  7F A3 EB 78 */	mr r3, r29
/* 803C7714 003C3554  4B D3 90 CD */	bl lbl_801007E0
/* 803C7718 003C3558  4B FF B6 09 */	bl lbl_803C2D20
/* 803C771C 003C355C  7C 64 1B 78 */	mr r4, r3
/* 803C7720 003C3560  38 61 00 18 */	addi r3, r1, 0x18
/* 803C7724 003C3564  4B FF D3 F9 */	bl lbl_803C4B1C
/* 803C7728 003C3568  C0 21 00 1C */	lfs f1, 0x1c(r1)
/* 803C772C 003C356C  C0 02 DA F8 */	lfs f0, lbl_80563A78@sda21(r2)
...
/* 803C7770 003C35B0  4B D3 90 71 */	bl lbl_801007E0
/* 803C7774 003C35B4  4B FF B5 AD */	bl lbl_803C2D20
/* 803C7778 003C35B8  7C 64 1B 78 */	mr r4, r3
/* 803C777C 003C35BC  38 61 00 10 */	addi r3, r1, 0x10
/* 803C7780 003C35C0  4B FF D3 9D */	bl lbl_803C4B1C
/* 803C7784 003C35C4  C0 21 00 10 */	lfs f1, 0x10(r1)
/* 803C7788 003C35C8  4B DD 87 2D */	bl lbl_8019FEB4
/* 803C778C 003C35CC  C0 02 DA FC */	lfs f0, lbl_80563A7C@sda21(r2)
...
/* 803C779C 003C35DC  C0 02 DB 00 */	lfs f0, lbl_80563A80@sda21(r2)
...
/* 803C77AC 003C35EC  4B D3 90 35 */	bl lbl_801007E0
/* 803C77B0 003C35F0  4B FF B5 71 */	bl lbl_803C2D20
/* 803C77B4 003C35F4  7C 64 1B 78 */	mr r4, r3
/* 803C77B8 003C35F8  38 61 00 08 */	addi r3, r1, 0x8
/* 803C77BC 003C35FC  4B FF D3 61 */	bl lbl_803C4B1C
/* 803C77C0 003C3600  C0 21 00 0C */	lfs f1, 0xc(r1)
/* 803C77C4 003C3604  C0 02 DB 04 */	lfs f0, lbl_80563A84@sda21(r2)
...
/* 803C77D4 003C3614  4B DD 86 E1 */	bl lbl_8019FEB4
/* 803C77D8 003C3618  C0 02 DB 00 */	lfs f0, lbl_80563A80@sda21(r2)
...
/* 803C77E8 003C3628  4B FF 96 89 */	bl lbl_803C0E70
/* 803C77EC 003C362C  7F A3 EB 78 */	mr r3, r29
/* 803C77F0 003C3630  4B D3 8F F1 */	bl lbl_801007E0
/* 803C77F4 003C3634  4B FF B4 ED */	bl lbl_803C2CE0
/* 803C77F8 003C3638  38 81 00 20 */	addi r4, r1, 0x20
/* 803C77FC 003C363C  4B DD 3B 7D */	bl lbl_8019B378
/* 803C7800 003C3640  3B C0 00 00 */	li r30, 0x0
/* 803C7804 003C3644  C0 21 00 20 */	lfs f1, 0x20(r1)
/* 803C7808 003C3648  3F E0 80 54 */	lis r31, lbl_805452D0@ha
/* 803C780C 003C364C  C0 5F 52 D0 */	lfs f2, lbl_805452D0@l(r31)
/* 803C7810 003C3650  C0 62 DB 08 */	lfs f3, lbl_80563A88@sda21(r2)
/* 803C7814 003C3654  4B DE E1 21 */	bl lbl_801B5934
...
/* 803C782C 003C366C  C0 62 DB 08 */	lfs f3, lbl_80563A88@sda21(r2)
/* 803C7830 003C3670  4B DE E1 05 */	bl lbl_801B5934
...
/* 803C7844 003C3684  C0 62 DB 08 */	lfs f3, lbl_80563A88@sda21(r2)
/* 803C7848 003C3688  4B DE E0 ED */	bl lbl_801B5934
...
/* 803C7864 003C36A4  4B D3 8F 7D */	bl lbl_801007E0
/* 803C7868 003C36A8  4B FF B4 69 */	bl lbl_803C2CD0
/* 803C786C 003C36AC  4B DD 26 5D */	bl lbl_80199EC8
/* 803C7870 003C36B0  48 00 00 14 */	b lbl_803C7884
.global lbl_803C7874
lbl_803C7874:
/* 803C7874 003C36B4  7F A3 EB 78 */	mr r3, r29
/* 803C7878 003C36B8  4B D3 8F 69 */	bl lbl_801007E0
/* 803C787C 003C36BC  4B FF B4 55 */	bl lbl_803C2CD0
/* 803C7880 003C36C0  4B DB FC B9 */	bl lbl_80187538
.global lbl_803C7884
lbl_803C7884:
