...
/* 802A4648 002A0488  F3 E1 00 38 */	psq_st f31, 56(r1), 0, qr0
...
/* 802A4660 002A04A0  90 1F 00 00 */	stw r0, 0(r31)
...
/* 802A4678 002A04B8  90 7F 00 08 */	stw r3, 8(r31)
/* 802A467C 002A04BC  C0 02 B5 60 */	lfs f0, $$256967-_SDA2_BASE_(r2)
/* 802A4680 002A04C0  D0 1F 00 10 */	stfs f0, 0x10(r31)
/* 802A4684 002A04C4  38 00 00 00 */	li r0, 0
...
/* 802A46A8 002A04E8  38 80 00 06 */	li r4, 6
...
/* 802A46BC 002A04FC  38 80 00 00 */	li r4, 0
...
/* 802A46D4 002A0514  38 61 00 08 */	addi r3, r1, 8
/* 802A46D8 002A0518  4B FC AF DD */	bl pos__Q43scn4step5chara8LocationCFv
/* 802A46DC 002A051C  C3 E1 00 08 */	lfs f31, 8(r1)
...
/* 802A4704 002A0544  54 00 17 FE */	rlwinm r0, r0, 2, 0x1f, 0x1f
...
/* 802A4740 002A0580  93 C1 00 08 */	stw r30, 8(r1)
/* 802A4744 002A0584  7C 7E 1B 78 */	mr r30, r3
/* 802A4748 002A0588  7C 9F 23 78 */	mr r31, r4
/* 802A474C 002A058C  2C 03 00 00 */	cmpwi r3, 0
...
/* 802A475C 002A059C  90 03 00 00 */	stw r0, 0(r3)
...
/* 802A47A4 002A05E4  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 802A47C8 002A0608  F3 E1 00 98 */	psq_st f31, 152(r1), 0, qr0
/* 802A47CC 002A060C  DB C1 00 80 */	stfd f30, 0x80(r1)
/* 802A47D0 002A0610  F3 C1 00 88 */	psq_st f30, 136(r1), 0, qr0
/* 802A47D4 002A0614  39 61 00 80 */	addi r11, r1, 0x80
/* 802A47D8 002A0618  4B D6 2B 5D */	bl func_80007334
...
/* 802A47EC 002A062C  2C 03 00 00 */	cmpwi r3, 0
...
/* 802A4804 002A0644  2C 03 00 00 */	cmpwi r3, 0
...
/* 802A481C 002A065C  38 80 00 04 */	li r4, 4
...
/* 802A4858 002A0698  90 61 00 08 */	stw r3, 8(r1)
...
/* 802A4898 002A06D8  80 61 00 08 */	lwz r3, 8(r1)
...
/* 802A48D4 002A0714  C3 E2 B5 60 */	lfs f31, $$256967-_SDA2_BASE_(r2)
/* 802A48D8 002A0718  C3 C2 B5 64 */	lfs f30, $$257011-_SDA2_BASE_(r2)
...
/* 802A48F4 002A0734  80 B9 00 08 */	lwz r5, 8(r25)
...
/* 802A4904 002A0744  2C 03 00 00 */	cmpwi r3, 0
/* 802A4908 002A0748  41 82 00 4C */	beq lbl_802A4954
/* 802A490C 002A074C  48 09 BA 41 */	bl hid__Q43scn4step4hero4HeroFv
/* 802A4910 002A0750  38 80 00 02 */	li r4, 2
/* 802A4914 002A0754  4B EF D9 41 */	bl isTrigger__Q23hid6ButtonCFUl
/* 802A4918 002A0758  2C 03 00 00 */	cmpwi r3, 0
/* 802A491C 002A075C  41 82 00 14 */	beq lbl_802A4930
/* 802A4920 002A0760  C3 E2 B5 68 */	lfs f31, $$257012-_SDA2_BASE_(r2)
/* 802A4924 002A0764  C3 C2 B5 6C */	lfs f30, $$257013-_SDA2_BASE_(r2)
...
/* 802A4938 002A0778  38 80 00 01 */	li r4, 1
/* 802A493C 002A077C  4B EF D9 19 */	bl isTrigger__Q23hid6ButtonCFUl
/* 802A4940 002A0780  2C 03 00 00 */	cmpwi r3, 0
/* 802A4944 002A0784  41 82 00 10 */	beq lbl_802A4954
/* 802A4948 002A0788  C3 E2 B5 70 */	lfs f31, $$257014-_SDA2_BASE_(r2)
/* 802A494C 002A078C  C3 C2 B5 6C */	lfs f30, $$257013-_SDA2_BASE_(r2)
...
/* 802A495C 002A079C  C0 02 B5 60 */	lfs f0, $$256967-_SDA2_BASE_(r2)
...
/* 802A497C 002A07BC  38 80 FF FF */	li r4, -1
/* 802A4980 002A07C0  4B F8 BD 49 */	bl __dt__Q24util35ObjRefHandle$$0Q43scn4step4hero4Hero$$1Fv
/* 802A4984 002A07C4  83 B9 00 08 */	lwz r29, 8(r25)
...
/* 802A49B0 002A07F0  2C 1B 00 00 */	cmpwi r27, 0
...
/* 802A49C0 002A0800  4B F9 1E A9 */	bl __ct__Q24util28StateFactory$$0Q24util6IState$$1FPv
/* 802A49C4 002A0804  3C 60 80 47 */	lis r3, __vt__Q24util109StateFactoryArg3$$0Q24util6IState$$4Q53scn4step5enemy6damage19StateParasolRelease$$4PQ43scn4step5enemy5Enemy$$4Ux$$4Ul$$1@ha
/* 802A49C8 002A0808  38 03 54 18 */	addi r0, r3, __vt__Q24util109StateFactoryArg3$$0Q24util6IState$$4Q53scn4step5enemy6damage19StateParasolRelease$$4PQ43scn4step5enemy5Enemy$$4Ux$$4Ul$$1@l
/* 802A49CC 002A080C  90 1B 00 00 */	stw r0, 0(r27)
/* 802A49D0 002A0810  93 FB 00 08 */	stw r31, 8(r27)
...
/* 802A4A10 002A0850  2C 1C 00 00 */	cmpwi r28, 0
...
/* 802A4A20 002A0860  4B F9 1E 49 */	bl __ct__Q24util28StateFactory$$0Q24util6IState$$1FPv
/* 802A4A24 002A0864  3C 60 80 47 */	lis r3, __vt__Q24util109StateFactoryArg2$$0Q24util6IState$$4Q53scn4step5enemy6damage23StateDeadCaptureRelease$$4PQ43scn4step5enemy5Enemy$$4b$$1@ha
/* 802A4A28 002A0868  38 03 53 E8 */	addi r0, r3, __vt__Q24util109StateFactoryArg2$$0Q24util6IState$$4Q53scn4step5enemy6damage23StateDeadCaptureRelease$$4PQ43scn4step5enemy5Enemy$$4b$$1@l
/* 802A4A2C 002A086C  90 1C 00 00 */	stw r0, 0(r28)
/* 802A4A30 002A0870  93 DC 00 08 */	stw r30, 8(r28)
...
/* 802A4A4C 002A088C  38 03 00 01 */	addi r0, r3, 1
...
/* 802A4AA8 002A08E8  C0 22 B5 60 */	lfs f1, $$256967-_SDA2_BASE_(r2)
...
/* 802A4ACC 002A090C  4B D6 28 B5 */	bl func_80007380
...
/* 802A4B18 002A0958  38 61 00 08 */	addi r3, r1, 8
...
/* 802A4B24 002A0964  C0 01 00 08 */	lfs f0, 8(r1)
...
.global create__Q24util109StateFactoryArg3$$0Q24util6IState$$4Q53scn4step5enemy6damage19StateParasolRelease$$4PQ43scn4step5enemy5Enemy$$4Ux$$4Ul$$1Fv
create__Q24util109StateFactoryArg3$$0Q24util6IState$$4Q53scn4step5enemy6damage19StateParasolRelease$$4PQ43scn4step5enemy5Enemy$$4Ux$$4Ul$$1Fv:
/* 802A4B88 002A09C8  7C 67 1B 78 */	mr r7, r3
/* 802A4B8C 002A09CC  80 63 00 04 */	lwz r3, 4(r3)
/* 802A4B90 002A09D0  2C 03 00 00 */	cmpwi r3, 0
/* 802A4B94 002A09D4  4D 82 00 20 */	beqlr 
/* 802A4B98 002A09D8  80 87 00 08 */	lwz r4, 8(r7)
...
.global __dt__Q24util109StateFactoryArg3$$0Q24util6IState$$4Q53scn4step5enemy6damage19StateParasolRelease$$4PQ43scn4step5enemy5Enemy$$4Ux$$4Ul$$1Fv
