...
/* 802A6630 002A2470  90 1F 00 00 */	stw r0, 0(r31)
/* 802A6634 002A2474  38 00 00 00 */	li r0, 0
/* 802A6638 002A2478  90 1F 00 08 */	stw r0, 8(r31)
...
/* 802A6668 002A24A8  38 80 00 00 */	li r4, 0
...
/* 802A667C 002A24BC  38 80 00 00 */	li r4, 0
...
/* 802A66A0 002A24E0  38 80 00 00 */	li r4, 0
...
/* 802A66B4 002A24F4  38 80 00 07 */	li r4, 7
...
/* 802A66F4 002A2534  28 03 00 07 */	cmplwi r3, 7
/* 802A66F8 002A2538  40 82 00 10 */	bne lbl_802A6708
/* 802A66FC 002A253C  80 7F 00 08 */	lwz r3, 8(r31)
/* 802A6700 002A2540  38 03 00 01 */	addi r0, r3, 1
/* 802A6704 002A2544  90 1F 00 08 */	stw r0, 8(r31)
lbl_802A6708:
...
/* 802A6718 002A2558  2C 03 00 00 */	cmpwi r3, 0
...
/* 802A673C 002A257C  38 80 00 00 */	li r4, 0
/* 802A6740 002A2580  4B FC AB 3D */	bl reqScript__Q43scn4step5chara5ModelFUl
/* 802A6744 002A2584  38 00 00 00 */	li r0, 0
/* 802A6748 002A2588  90 1F 00 08 */	stw r0, 8(r31)
lbl_802A674C:
...
/* 802A6770 002A25B0  4B D6 0B D5 */	bl func_80007344
...
/* 802A6798 002A25D8  38 61 00 08 */	addi r3, r1, 8
/* 802A679C 002A25DC  4B FC 8F 19 */	bl pos__Q43scn4step5chara8LocationCFv
/* 802A67A0 002A25E0  80 7D 00 08 */	lwz r3, 8(r29)
/* 802A67A4 002A25E4  80 1E 00 04 */	lwz r0, 4(r30)
...
/* 802A67D8 002A2618  80 7E 00 04 */	lwz r3, 4(r30)
/* 802A67DC 002A261C  80 1D 00 08 */	lwz r0, 8(r29)
/* 802A67E0 002A2620  7C 03 00 50 */	subf r0, r3, r0
/* 802A67E4 002A2624  7C 00 F8 50 */	subf r0, r0, r31
/* 802A67E8 002A2628  C8 42 B5 B8 */	lfd f2, $$256568-_SDA2_BASE_(r2)
...
/* 802A6804 002A2644  C0 02 B5 B0 */	lfs f0, $$256565-_SDA2_BASE_(r2)
/* 802A6808 002A2648  EC 20 00 72 */	fmuls f1, f0, f1
/* 802A680C 002A264C  C0 1E 00 08 */	lfs f0, 8(r30)
/* 802A6810 002A2650  EC 20 00 72 */	fmuls f1, f0, f1
/* 802A6814 002A2654  C8 42 B5 C0 */	lfd f2, $$256570-_SDA2_BASE_(r2)
...
/* 802A6844 002A2684  C0 01 00 08 */	lfs f0, 8(r1)
/* 802A6848 002A2688  EC 00 08 2A */	fadds f0, f0, f1
/* 802A684C 002A268C  D0 01 00 08 */	stfs f0, 8(r1)
lbl_802A6850:
...
/* 802A685C 002A269C  38 81 00 08 */	addi r4, r1, 8
...
/* 802A6868 002A26A8  4B D6 0B 29 */	bl func_80007390
...
__vt__Q53scn4step5enemy6chilly15StateCreditMove:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q53scn4step5enemy6chilly15StateCreditMoveFv
	.byte4 procAnim__Q53scn4step5enemy6chilly15StateCreditMoveFv
	.byte4 procMove__Q53scn4step5enemy6chilly15StateCreditMoveFv
	.byte4 procConstraint__Q43scn4step5enemy9StateBaseFv
	.byte4 procFixPos__Q53scn4step5enemy6chilly15StateCreditMoveFv
