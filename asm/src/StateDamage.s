...
/* 802D67C8 002D2608  4B D3 0B 7D */	bl func_80007344
...
/* 802D67DC 002D261C  90 1D 00 00 */	stw r0, 0(r29)
...
/* 802D67F0 002D2630  4B FA C3 5D */	bl RuntimeTypeInfoImpl$$0Q53scn4step5enemy8rollball6Custom$$1__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo
/* 802D67F4 002D2634  7C 7F 1B 78 */	mr r31, r3
/* 802D67F8 002D2638  2C 1E 00 00 */	cmpwi r30, 0
/* 802D67FC 002D263C  41 82 00 48 */	beq lbl_802D6844
/* 802D6800 002D2640  7F C3 F3 78 */	mr r3, r30
/* 802D6804 002D2644  81 83 00 00 */	lwz r12, 0(r3)
/* 802D6808 002D2648  81 8C 00 08 */	lwz r12, 8(r12)
...
/* 802D6820 002D2660  38 00 00 01 */	li r0, 1
/* 802D6824 002D2664  48 00 00 14 */	b lbl_802D6838
lbl_802D6828:
/* 802D6828 002D2668  80 63 00 00 */	lwz r3, 0(r3)
lbl_802D682C:
/* 802D682C 002D266C  2C 03 00 00 */	cmpwi r3, 0
/* 802D6830 002D2670  40 82 FF E8 */	bne lbl_802D6818
/* 802D6834 002D2674  38 00 00 00 */	li r0, 0
lbl_802D6838:
/* 802D6838 002D2678  2C 00 00 00 */	cmpwi r0, 0
/* 802D683C 002D267C  41 82 00 08 */	beq lbl_802D6844
/* 802D6840 002D2680  48 00 00 08 */	b lbl_802D6848
lbl_802D6844:
/* 802D6844 002D2684  3B C0 00 00 */	li r30, 0
lbl_802D6848:
...
/* 802D6890 002D26D0  38 80 00 05 */	li r4, 5
...
/* 802D68B4 002D26F4  38 A0 00 01 */	li r5, 1
/* 802D68B8 002D26F8  4B EC 54 15 */	bl at__Q24gobj9NodeReposCFUl
/* 802D68BC 002D26FC  38 61 00 08 */	addi r3, r1, 8
...
/* 802D6908 002D2748  38 A0 00 01 */	li r5, 1
...
/* 802D6924 002D2764  38 63 00 08 */	addi r3, r3, 8
/* 802D6928 002D2768  38 80 00 F1 */	li r4, 0xf1
/* 802D692C 002D276C  38 A1 00 08 */	addi r5, r1, 8
...
/* 802D6948 002D2788  38 80 00 03 */	li r4, 3
...
/* 802D698C 002D27CC  4B D3 0A 05 */	bl func_80007390
...
/* 802D69C0 002D2800  2C 03 00 00 */	cmpwi r3, 0
