...
/* 802A9DF8 002A5C38  90 1E 00 00 */	stw r0, 0x0(r30)
/* 802A9DFC 002A5C3C  38 00 00 00 */	li r0, 0x0
/* 802A9E00 002A5C40  98 1E 00 08 */	stb r0, 0x8(r30)
...
/* 802A9E28 002A5C68  38 80 00 06 */	li r4, 0x6
...
/* 802A9E5C 002A5C9C  38 63 00 08 */	addi r3, r3, 0x8
/* 802A9E60 002A5CA0  4B F2 C6 49 */	bl isCollide__Q25ocoll3HitCFv
/* 802A9E64 002A5CA4  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A9EEC 002A5D2C  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802A9EF0 002A5D30  7C 7E 1B 78 */	mr r30, r3
/* 802A9EF4 002A5D34  7C 9F 23 78 */	mr r31, r4
/* 802A9EF8 002A5D38  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A9F08 002A5D48  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 802A9F4C 002A5D8C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 802A9F78 002A5DB8  2C 04 00 00 */	cmpwi r4, 0x0
/* 802A9F7C 002A5DBC  41 82 00 9C */	beq lbl_802AA018
/* 802A9F80 002A5DC0  38 04 FF FF */	addi r0, r4, -0x1
/* 802A9F84 002A5DC4  90 03 00 10 */	stw r0, 0x10(r3)
/* 802A9F88 002A5DC8  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802A9F9C 002A5DDC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802AA01C 002A5E5C  38 63 00 01 */	addi r3, r3, 0x1
/* 802AA020 002A5E60  90 7F 00 0C */	stw r3, 0xc(r31)
/* 802AA024 002A5E64  88 1F 00 08 */	lbz r0, 0x8(r31)
/* 802AA028 002A5E68  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802AA08C 002A5ECC  90 61 00 08 */	stw r3, 0x8(r1)
...
/* 802AA0B0 002A5EF0  38 81 00 08 */	addi r4, r1, 0x8
/* 802AA0B4 002A5EF4  38 BF 00 04 */	addi r5, r31, 0x4
...
/* 802AA0E4 002A5F24  F3 E1 00 68 */	psq_st f31, 0x68(r1), 0, qr0
...
/* 802AA108 002A5F48  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802AA12C 002A5F6C  C0 02 B6 E0 */	lfs f0, "@56724_80561660"@sda21(r2)
/* 802AA130 002A5F70  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802AA134 002A5F74  40 80 00 84 */	bge lbl_802AA1B8
/* 802AA138 002A5F78  88 1F 00 08 */	lbz r0, 0x8(r31)
/* 802AA13C 002A5F7C  2C 00 00 00 */	cmpwi r0, 0x0
/* 802AA140 002A5F80  40 82 00 60 */	bne lbl_802AA1A0
/* 802AA144 002A5F84  38 00 00 01 */	li r0, 0x1
/* 802AA148 002A5F88  98 1F 00 08 */	stb r0, 0x8(r31)
/* 802AA14C 002A5F8C  38 00 00 00 */	li r0, 0x0
...
/* 802AA174 002A5FB4  38 61 00 08 */	addi r3, r1, 0x8
/* 802AA178 002A5FB8  4B EF 11 E5 */	bl velocity__Q24gobj4MoveCFv
/* 802AA17C 002A5FBC  C3 E1 00 0C */	lfs f31, 0xc(r1)
/* 802AA180 002A5FC0  C0 02 B6 E4 */	lfs f0, "@56725_80561664"@sda21(r2)
...
/* 802AA1F8 002A6038  2C 03 00 00 */	cmpwi r3, 0x0
...
__vt__Q53scn4step5enemy6damage19StateDamageWingToss:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step5enemy6damage19StateDamageWingTossFv
	.4byte procAnim__Q53scn4step5enemy6damage19StateDamageWingTossFv
	.4byte procMove__Q53scn4step5enemy6damage19StateDamageWingTossFv
