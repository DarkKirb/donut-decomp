...
/* 802AA240 002A6080  F3 E1 00 58 */	psq_st f31, 88(r1), 0, qr0
/* 802AA244 002A6084  DB C1 00 40 */	stfd f30, 0x40(r1)
/* 802AA248 002A6088  F3 C1 00 48 */	psq_st f30, 72(r1), 0, qr0
/* 802AA24C 002A608C  39 61 00 40 */	addi r11, r1, 0x40
/* 802AA250 002A6090  4B D5 D0 F5 */	bl func_80007344
...
/* 802AA26C 002A60AC  90 1D 00 00 */	stw r0, 0(r29)
/* 802AA270 002A60B0  38 00 00 00 */	li r0, 0
/* 802AA274 002A60B4  90 1D 00 08 */	stw r0, 8(r29)
...
/* 802AA294 002A60D4  38 80 00 06 */	li r4, 6
...
/* 802AA2B0 002A60F0  4B EE E3 D1 */	bl __ct__25mint_wrapNative_helper$$0b$$1Fb
...
/* 802AA2BC 002A60FC  80 64 00 00 */	lwz r3, 0(r4)
/* 802AA2C0 002A6100  80 04 00 04 */	lwz r0, 4(r4)
/* 802AA2C4 002A6104  90 61 00 20 */	stw r3, 0x20(r1)
/* 802AA2C8 002A6108  90 01 00 24 */	stw r0, 0x24(r1)
/* 802AA2CC 002A610C  80 04 00 08 */	lwz r0, 8(r4)
/* 802AA2D0 002A6110  90 01 00 28 */	stw r0, 0x28(r1)
/* 802AA2D4 002A6114  C3 E2 B6 E8 */	lfs f31, $$256713-_SDA2_BASE_(r2)
/* 802AA2D8 002A6118  C3 C2 B6 EC */	lfs f30, $$256714-_SDA2_BASE_(r2)
/* 802AA2DC 002A611C  80 6D ED 10 */	lwz r3, object___Q33hel6common38ExplicitSingleton$$0Q23app11Application$$1-_SDA_BASE_(r13)
...
/* 802AA2F8 002A6138  C0 02 B6 F0 */	lfs f0, $$256715-_SDA2_BASE_(r2)
...
/* 802AA318 002A6158  C0 22 B6 F4 */	lfs f1, $$256716-_SDA2_BASE_(r2)
...
/* 802AA368 002A61A8  C0 02 B6 F8 */	lfs f0, $$256717-_SDA2_BASE_(r2)
...
/* 802AA384 002A61C4  38 61 00 08 */	addi r3, r1, 8
/* 802AA388 002A61C8  4B EF 0F D5 */	bl velocity__Q24gobj4MoveCFv
/* 802AA38C 002A61CC  C0 21 00 08 */	lfs f1, 8(r1)
/* 802AA390 002A61D0  C0 02 B6 F8 */	lfs f0, $$256717-_SDA2_BASE_(r2)
/* 802AA394 002A61D4  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802AA398 002A61D8  7F E0 00 26 */	mfcr r31
/* 802AA39C 002A61DC  57 FF 0F FE */	srwi r31, r31, 0x1f
...
/* 802AA3B0 002A61F0  4B EE E2 D1 */	bl __ct__25mint_wrapNative_helper$$0b$$1Fb
lbl_802AA3B4:
...
/* 802AA3E4 002A6224  38 80 00 00 */	li r4, 0
...
/* 802AA3F8 002A6238  38 80 00 00 */	li r4, 0
...
/* 802AA40C 002A624C  38 80 00 00 */	li r4, 0
...
/* 802AA420 002A6260  38 80 00 00 */	li r4, 0
...
/* 802AA434 002A6274  38 80 00 00 */	li r4, 0
...
/* 802AA45C 002A629C  4B D5 CF 35 */	bl func_80007390
...
/* 802AA474 002A62B4  80 83 00 08 */	lwz r4, 8(r3)
/* 802AA478 002A62B8  38 04 00 01 */	addi r0, r4, 1
/* 802AA47C 002A62BC  90 03 00 08 */	stw r0, 8(r3)
...
/* 802AA4E0 002A6320  38 61 00 08 */	addi r3, r1, 8
/* 802AA4E4 002A6324  4B FE 07 B5 */	bl result__Q43scn4step5enemy7MapCollCFv
/* 802AA4E8 002A6328  88 01 00 08 */	lbz r0, 8(r1)
/* 802AA4EC 002A632C  2C 00 00 00 */	cmpwi r0, 0
/* 802AA4F0 002A6330  40 82 00 10 */	bne lbl_802AA500
/* 802AA4F4 002A6334  80 1F 00 08 */	lwz r0, 8(r31)
...
__vt__Q53scn4step5enemy6damage23StateDeadCaptureRelease:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q53scn4step5enemy6damage23StateDeadCaptureReleaseFv
	.byte4 procAnim__Q53scn4step5enemy6damage23StateDeadCaptureReleaseFv
	.byte4 procMove__Q53scn4step5enemy6damage23StateDeadCaptureReleaseFv
	.byte4 procConstraint__Q43scn4step5enemy9StateBaseFv
	.byte4 procFixPos__Q53scn4step5enemy6damage23StateDeadCaptureReleaseFv
