...
/* 802AA530 002A6370  4B D5 CE 15 */	bl func_80007344
...
/* 802AA548 002A6388  90 1D 00 00 */	stw r0, 0(r29)
/* 802AA54C 002A638C  C0 02 B7 00 */	lfs f0, $$257029-_SDA2_BASE_(r2)
/* 802AA550 002A6390  D0 1D 00 08 */	stfs f0, 8(r29)
/* 802AA554 002A6394  38 60 00 00 */	li r3, 0
...
/* 802AA588 002A63C8  2C 03 00 00 */	cmpwi r3, 0
...
/* 802AA59C 002A63DC  38 80 00 00 */	li r4, 0
...
/* 802AA5B0 002A63F0  38 80 00 06 */	li r4, 6
...
/* 802AA608 002A6448  2C 03 00 00 */	cmpwi r3, 0
...
/* 802AA61C 002A645C  38 61 00 08 */	addi r3, r1, 8
...
/* 802AA638 002A6478  2C 03 00 00 */	cmpwi r3, 0
...
/* 802AA66C 002A64AC  38 C1 00 08 */	addi r6, r1, 8
...
/* 802AA67C 002A64BC  4B D5 CD 15 */	bl func_80007390
...
/* 802AA6A0 002A64E0  93 C1 00 08 */	stw r30, 8(r1)
/* 802AA6A4 002A64E4  7C 7E 1B 78 */	mr r30, r3
/* 802AA6A8 002A64E8  7C 9F 23 78 */	mr r31, r4
/* 802AA6AC 002A64EC  2C 03 00 00 */	cmpwi r3, 0
...
/* 802AA6BC 002A64FC  90 03 00 00 */	stw r0, 0(r3)
...
/* 802AA6CC 002A650C  C0 22 B7 00 */	lfs f1, $$257029-_SDA2_BASE_(r2)
...
/* 802AA6E4 002A6524  C0 22 B7 00 */	lfs f1, $$257029-_SDA2_BASE_(r2)
...
/* 802AA720 002A6560  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 802AA744 002A6584  F3 E1 00 38 */	psq_st f31, 56(r1), 0, qr0
...
/* 802AA754 002A6594  38 04 00 01 */	addi r0, r4, 1
...
/* 802AA768 002A65A8  2C 03 00 00 */	cmpwi r3, 0
...
/* 802AA78C 002A65CC  2C 03 00 00 */	cmpwi r3, 0
/* 802AA790 002A65D0  41 82 00 0C */	beq lbl_802AA79C
/* 802AA794 002A65D4  C3 E2 B7 04 */	lfs f31, $$257071-_SDA2_BASE_(r2)
/* 802AA798 002A65D8  48 00 00 08 */	b lbl_802AA7A0
lbl_802AA79C:
/* 802AA79C 002A65DC  C3 E2 B7 08 */	lfs f31, $$257072-_SDA2_BASE_(r2)
lbl_802AA7A0:
...
/* 802AA7B0 002A65F0  C0 1F 00 08 */	lfs f0, 8(r31)
/* 802AA7B4 002A65F4  EC 3F 00 7A */	fmadds f1, f31, f1, f0
/* 802AA7B8 002A65F8  D0 3F 00 08 */	stfs f1, 8(r31)
/* 802AA7BC 002A65FC  C0 02 B7 0C */	lfs f0, $$257073-_SDA2_BASE_(r2)
/* 802AA7C0 002A6600  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802AA7C4 002A6604  4C 41 13 82 */	cror 2, 1, 2
/* 802AA7C8 002A6608  40 82 00 0C */	bne lbl_802AA7D4
/* 802AA7CC 002A660C  EC 01 00 28 */	fsubs f0, f1, f0
/* 802AA7D0 002A6610  D0 1F 00 08 */	stfs f0, 8(r31)
lbl_802AA7D4:
/* 802AA7D4 002A6614  C0 3F 00 08 */	lfs f1, 8(r31)
/* 802AA7D8 002A6618  C0 02 B7 00 */	lfs f0, $$257029-_SDA2_BASE_(r2)
/* 802AA7DC 002A661C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802AA7E0 002A6620  40 80 00 10 */	bge lbl_802AA7F0
/* 802AA7E4 002A6624  C0 02 B7 0C */	lfs f0, $$257073-_SDA2_BASE_(r2)
/* 802AA7E8 002A6628  EC 01 00 2A */	fadds f0, f1, f0
/* 802AA7EC 002A662C  D0 1F 00 08 */	stfs f0, 8(r31)
lbl_802AA7F0:
...
/* 802AA820 002A6660  D0 21 00 08 */	stfs f1, 8(r1)
...
/* 802AA830 002A6670  C0 02 B7 00 */	lfs f0, $$257029-_SDA2_BASE_(r2)
/* 802AA834 002A6674  FC 1F 00 40 */	fcmpo cr0, f31, f0
/* 802AA838 002A6678  4C 41 13 82 */	cror 2, 1, 2
/* 802AA83C 002A667C  41 82 00 20 */	beq lbl_802AA85C
/* 802AA840 002A6680  3C 60 80 45 */	lis r3, $$2STRING$$2FSqrt__Q24nw4r4mathFf@ha
/* 802AA844 002A6684  38 63 31 54 */	addi r3, r3, $$2STRING$$2FSqrt__Q24nw4r4mathFf@l
/* 802AA848 002A6688  38 80 02 73 */	li r4, 0x273
/* 802AA84C 002A668C  3C A0 80 45 */	lis r5, $$2STRING$$2FSqrt__Q24nw4r4mathFf$$20@ha
/* 802AA850 002A6690  38 A5 31 30 */	addi r5, r5, $$2STRING$$2FSqrt__Q24nw4r4mathFf$$20@l
/* 802AA854 002A6694  4C C6 31 82 */	crclr 6
/* 802AA858 002A6698  4B E7 DB 99 */	bl Warning__Q24nw4r2dbFPCciPCce
lbl_802AA85C:
/* 802AA85C 002A669C  C0 22 B7 00 */	lfs f1, $$257029-_SDA2_BASE_(r2)
/* 802AA860 002A66A0  FC 1F 08 40 */	fcmpo cr0, f31, f1
/* 802AA864 002A66A4  4C 40 13 82 */	cror 2, 0, 2
...
lbl_802AA87C:
/* 802AA87C 002A66BC  C0 02 B7 00 */	lfs f0, $$257029-_SDA2_BASE_(r2)
...
lbl_802AA88C:
/* 802AA88C 002A66CC  C0 02 B7 10 */	lfs f0, $$257074-_SDA2_BASE_(r2)
/* 802AA890 002A66D0  EC 20 08 24 */	fdivs f1, f0, f1
/* 802AA894 002A66D4  C0 01 00 08 */	lfs f0, 8(r1)
/* 802AA898 002A66D8  EC 00 00 72 */	fmuls f0, f0, f1
/* 802AA89C 002A66DC  D0 01 00 08 */	stfs f0, 8(r1)
...
lbl_802AA8AC:
/* 802AA8AC 002A66EC  38 6D EE 40 */	addi r3, r13, BASIS_Y__Q33hel4math7Vector2-_SDA_BASE_
/* 802AA8B0 002A66F0  38 81 00 08 */	addi r4, r1, 8
...
/* 802AA8CC 002A670C  C0 02 B7 14 */	lfs f0, $$257075-_SDA2_BASE_(r2)
...
/* 802AA8E8 002A6728  C0 3F 00 08 */	lfs f1, 8(r31)
...
/* 802AA904 002A6744  C0 3F 00 08 */	lfs f1, 8(r31)
...
/* 802AA91C 002A675C  C0 22 B7 00 */	lfs f1, $$257029-_SDA2_BASE_(r2)
...
__vt__Q53scn4step5enemy6damage16StateDeadExtreme:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q53scn4step5enemy6damage16StateDeadExtremeFv
	.byte4 procAnim__Q53scn4step5enemy6damage16StateDeadExtremeFv
	.byte4 procMove__Q53scn4step5enemy6damage16StateDeadExtremeFv
	.byte4 procConstraint__Q43scn4step5enemy9StateBaseFv
	.byte4 procFixPos__Q53scn4step5enemy6damage16StateDeadExtremeFv
