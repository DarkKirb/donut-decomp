...
/* 802AA9C4 002A6804  4B D5 C9 81 */	bl func_80007344
...
/* 802AA9DC 002A681C  90 1D 00 00 */	stw r0, 0(r29)
/* 802AA9E0 002A6820  3B E0 00 00 */	li r31, 0
/* 802AA9E4 002A6824  93 FD 00 08 */	stw r31, 8(r29)
/* 802AA9E8 002A6828  38 00 00 01 */	li r0, 1
...
/* 802AAA04 002A6844  C0 02 B7 18 */	lfs f0, $$257302-_SDA2_BASE_(r2)
/* 802AAA08 002A6848  D0 1D 00 14 */	stfs f0, 0x14(r29)
/* 802AAA0C 002A684C  D0 1D 00 18 */	stfs f0, 0x18(r29)
/* 802AAA10 002A6850  C0 02 B7 1C */	lfs f0, $$257303-_SDA2_BASE_(r2)
...
/* 802AAA44 002A6884  C0 22 B7 18 */	lfs f1, $$257302-_SDA2_BASE_(r2)
...
/* 802AAA54 002A6894  C0 02 B7 20 */	lfs f0, $$257304-_SDA2_BASE_(r2)
...
/* 802AAA8C 002A68CC  38 61 00 08 */	addi r3, r1, 8
/* 802AAA90 002A68D0  4B FE 02 D1 */	bl floorNormal__Q43scn4step5enemy7MapCollCFv
/* 802AAA94 002A68D4  C0 01 00 08 */	lfs f0, 8(r1)
/* 802AAA98 002A68D8  C0 22 B7 18 */	lfs f1, $$257302-_SDA2_BASE_(r2)
...
/* 802AAAA8 002A68E8  C0 02 B7 24 */	lfs f0, $$257305-_SDA2_BASE_(r2)
...
/* 802AAAC8 002A6908  C0 02 B7 28 */	lfs f0, $$257306-_SDA2_BASE_(r2)
...
/* 802AAADC 002A691C  C0 02 B7 2C */	lfs f0, $$257307-_SDA2_BASE_(r2)
...
/* 802AAB08 002A6948  38 80 00 00 */	li r4, 0
...
/* 802AAB1C 002A695C  38 80 00 00 */	li r4, 0
...
/* 802AAB30 002A6970  38 80 00 00 */	li r4, 0
...
/* 802AAB44 002A6984  38 80 00 06 */	li r4, 6
...
/* 802AAB7C 002A69BC  38 80 00 01 */	li r4, 1
...
/* 802AAB90 002A69D0  38 80 00 00 */	li r4, 0
...
/* 802AABB4 002A69F4  4B D5 C7 DD */	bl func_80007390
...
/* 802AABDC 002A6A1C  F3 E1 00 68 */	psq_st f31, 104(r1), 0, qr0
/* 802AABE0 002A6A20  93 E1 00 5C */	stw r31, 0x5c(r1)
/* 802AABE4 002A6A24  7C 7F 1B 78 */	mr r31, r3
/* 802AABE8 002A6A28  80 83 00 08 */	lwz r4, 8(r3)
/* 802AABEC 002A6A2C  38 04 00 01 */	addi r0, r4, 1
/* 802AABF0 002A6A30  90 03 00 08 */	stw r0, 8(r3)
/* 802AABF4 002A6A34  48 00 02 25 */	bl deadFlash__Q53scn4step5enemy6damage16StateDeadInWaterFv
/* 802AABF8 002A6A38  80 1F 00 08 */	lwz r0, 8(r31)
...
/* 802AAC10 002A6A50  2C 00 00 00 */	cmpwi r0, 0
...
/* 802AAC28 002A6A68  C0 42 B7 18 */	lfs f2, $$257302-_SDA2_BASE_(r2)
/* 802AAC2C 002A6A6C  D0 41 00 20 */	stfs f2, 0x20(r1)
/* 802AAC30 002A6A70  C0 02 B7 30 */	lfs f0, $$257345-_SDA2_BASE_(r2)
...
/* 802AACA4 002A6AE4  90 61 00 08 */	stw r3, 8(r1)
...
/* 802AACE8 002A6B28  38 81 00 08 */	addi r4, r1, 8
...
lbl_802AAD10:
/* 802AAD10 002A6B50  80 1F 00 08 */	lwz r0, 8(r31)
/* 802AAD14 002A6B54  28 00 00 05 */	cmplwi r0, 5
...
/* 802AAD28 002A6B68  C0 02 B7 20 */	lfs f0, $$257304-_SDA2_BASE_(r2)
...
/* 802AAD44 002A6B84  C0 02 B7 34 */	lfs f0, $$257346-_SDA2_BASE_(r2)
...
/* 802AAD54 002A6B94  C0 02 B7 38 */	lfs f0, $$257347-_SDA2_BASE_(r2)
...
/* 802AAD7C 002A6BBC  80 1F 00 08 */	lwz r0, 8(r31)
...
/* 802AAD98 002A6BD8  2C 03 00 00 */	cmpwi r3, 0
...
/* 802AADE0 002A6C20  C0 22 B7 3C */	lfs f1, $$257353-_SDA2_BASE_(r2)
/* 802AADE4 002A6C24  4B EF 0C 19 */	bl Create__Q24gobj14MoveParamDecelFf
/* 802AADE8 002A6C28  90 61 00 08 */	stw r3, 8(r1)
...
/* 802AADF8 002A6C38  38 81 00 08 */	addi r4, r1, 8
...
/* 802AAE2C 002A6C6C  C0 22 B7 40 */	lfs f1, $$257381-_SDA2_BASE_(r2)
...
/* 802AAE68 002A6CA8  C0 22 B7 44 */	lfs f1, $$257382-_SDA2_BASE_(r2)
...
/* 802AAE84 002A6CC4  4C 40 13 82 */	cror 2, 0, 2
/* 802AAE88 002A6CC8  41 82 FF E8 */	beq lbl_802AAE70
/* 802AAE8C 002A6CCC  C0 42 B7 4C */	lfs f2, $$257384-_SDA2_BASE_(r2)
/* 802AAE90 002A6CD0  C0 23 00 1C */	lfs f1, 0x1c(r3)
/* 802AAE94 002A6CD4  C0 02 B7 48 */	lfs f0, $$257383-_SDA2_BASE_(r2)
/* 802AAE98 002A6CD8  EC 02 00 7A */	fmadds f0, f2, f1, f0
/* 802AAE9C 002A6CDC  D0 03 00 1C */	stfs f0, 0x1c(r3)
/* 802AAEA0 002A6CE0  C0 02 B7 54 */	lfs f0, $$257386-_SDA2_BASE_(r2)
/* 802AAEA4 002A6CE4  EC 20 00 F2 */	fmuls f1, f0, f3
/* 802AAEA8 002A6CE8  C0 02 B7 50 */	lfs f0, $$257385-_SDA2_BASE_(r2)
/* 802AAEAC 002A6CEC  EC 20 00 72 */	fmuls f1, f0, f1
/* 802AAEB0 002A6CF0  4B E5 3C 71 */	bl CosFIdx__Q24nw4r4mathFf
/* 802AAEB4 002A6CF4  C0 02 B7 1C */	lfs f0, $$257303-_SDA2_BASE_(r2)
/* 802AAEB8 002A6CF8  EC 20 08 2A */	fadds f1, f0, f1
/* 802AAEBC 002A6CFC  C0 02 B7 58 */	lfs f0, $$257387-_SDA2_BASE_(r2)
...
/* 802AAECC 002A6D0C  C0 02 B7 5C */	lfs f0, $$257388-_SDA2_BASE_(r2)
/* 802AAED0 002A6D10  EC 20 00 72 */	fmuls f1, f0, f1
/* 802AAED4 002A6D14  4B D5 C3 41 */	bl __cvt_fp2unsigned
/* 802AAED8 002A6D18  C0 62 B7 60 */	lfs f3, $$257389-_SDA2_BASE_(r2)
/* 802AAEDC 002A6D1C  D0 61 00 18 */	stfs f3, 0x18(r1)
/* 802AAEE0 002A6D20  C0 42 B7 64 */	lfs f2, $$257390-_SDA2_BASE_(r2)
/* 802AAEE4 002A6D24  D0 41 00 1C */	stfs f2, 0x1c(r1)
/* 802AAEE8 002A6D28  D0 41 00 20 */	stfs f2, 0x20(r1)
/* 802AAEEC 002A6D2C  C8 22 B7 68 */	lfd f1, $$257393-_SDA2_BASE_(r2)
...
/* 802AAF14 002A6D54  98 01 00 08 */	stb r0, 8(r1)
...
/* 802AAF24 002A6D64  98 01 00 09 */	stb r0, 9(r1)
...
/* 802AAF44 002A6D84  80 01 00 08 */	lwz r0, 8(r1)
...
.global $$257303
$$257303:
	.incbin "baserom.dol", 0x49C1DC, 0x4
.global $$257304
$$257304:
	.incbin "baserom.dol", 0x49C1E0, 0x4
.global $$257305
$$257305:
	.incbin "baserom.dol", 0x49C1E4, 0x4
.global $$257306
$$257306:
	.incbin "baserom.dol", 0x49C1E8, 0x4
.global $$257307
$$257307:
	.incbin "baserom.dol", 0x49C1EC, 0x4
.global $$257345
$$257345:
	.incbin "baserom.dol", 0x49C1F0, 0x4
.global $$257346
$$257346:
	.incbin "baserom.dol", 0x49C1F4, 0x4
.global $$257347
$$257347:
	.incbin "baserom.dol", 0x49C1F8, 0x4
.global $$257353
$$257353:
	.incbin "baserom.dol", 0x49C1FC, 0x4
.global $$257381
$$257381:
	.incbin "baserom.dol", 0x49C200, 0x4
.global $$257382
$$257382:
	.incbin "baserom.dol", 0x49C204, 0x4
.global $$257383
$$257383:
	.incbin "baserom.dol", 0x49C208, 0x4
.global $$257384
$$257384:
	.incbin "baserom.dol", 0x49C20C, 0x4
.global $$257385
$$257385:
	.incbin "baserom.dol", 0x49C210, 0x4
.global $$257386
$$257386:
	.incbin "baserom.dol", 0x49C214, 0x4
.global $$257387
$$257387:
	.incbin "baserom.dol", 0x49C218, 0x4
.global $$257388
$$257388:
	.incbin "baserom.dol", 0x49C21C, 0x4
.global $$257389
$$257389:
	.incbin "baserom.dol", 0x49C220, 0x4
.global $$257390
$$257390:
	.incbin "baserom.dol", 0x49C224, 0x4
.global $$257393
$$257393:
	.incbin "baserom.dol", 0x49C228, 0x8
