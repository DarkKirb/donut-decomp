...
/* 8039C684 003984C4  90 1F 00 00 */	stw r0, 0(r31)
/* 8039C688 003984C8  38 00 00 00 */	li r0, 0
/* 8039C68C 003984CC  98 1F 00 08 */	stb r0, 8(r31)
...
/* 8039C6AC 003984EC  38 80 00 01 */	li r4, 1
...
/* 8039C6C4 00398504  2C 03 00 00 */	cmpwi r3, 0
...
/* 8039C6D8 00398518  38 80 00 01 */	li r4, 1
...
/* 8039C720 00398560  93 C1 00 08 */	stw r30, 8(r1)
/* 8039C724 00398564  7C 7E 1B 78 */	mr r30, r3
/* 8039C728 00398568  7C 9F 23 78 */	mr r31, r4
/* 8039C72C 0039856C  2C 03 00 00 */	cmpwi r3, 0
...
/* 8039C73C 0039857C  90 03 00 00 */	stw r0, 0(r3)
...
/* 8039C778 003985B8  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 8039C7AC 003985EC  38 80 00 00 */	li r4, 0
/* 8039C7B0 003985F0  4B ED 62 F5 */	bl get__Q43scn4step5chara13ScriptTriggerFUl
/* 8039C7B4 003985F4  2C 03 00 00 */	cmpwi r3, 0
...
/* 8039C7D4 00398614  38 80 00 01 */	li r4, 1
/* 8039C7D8 00398618  4B ED 62 CD */	bl get__Q43scn4step5chara13ScriptTriggerFUl
/* 8039C7DC 0039861C  2C 03 00 00 */	cmpwi r3, 0
/* 8039C7E0 00398620  41 82 00 0C */	beq lbl_8039C7EC
/* 8039C7E4 00398624  38 00 00 01 */	li r0, 1
/* 8039C7E8 00398628  98 1F 00 08 */	stb r0, 8(r31)
lbl_8039C7EC:
...
/* 8039C7FC 0039863C  2C 03 00 00 */	cmpwi r3, 0
...
/* 8039C838 00398678  4B C6 AB 09 */	bl func_80007340
...
/* 8039C848 00398688  88 1C 00 08 */	lbz r0, 8(r28)
/* 8039C84C 0039868C  2C 00 00 00 */	cmpwi r0, 0
...
/* 8039C864 003986A4  2C 03 00 00 */	cmpwi r3, 0
...
/* 8039C878 003986B8  88 03 00 08 */	lbz r0, 8(r3)
/* 8039C87C 003986BC  2C 00 00 00 */	cmpwi r0, 0
...
/* 8039C8A8 003986E8  2C 1D 00 00 */	cmpwi r29, 0
...
/* 8039C8B8 003986F8  4B E9 9F B1 */	bl __ct__Q24util28StateFactory$$0Q24util6IState$$1FPv
/* 8039C8BC 003986FC  3C 60 80 49 */	lis r3, __vt__Q24util88StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4hero6common8StateRun$$4PQ43scn4step4hero4Hero$$1@ha
/* 8039C8C0 00398700  38 03 BF 78 */	addi r0, r3, __vt__Q24util88StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4hero6common8StateRun$$4PQ43scn4step4hero4Hero$$1@l
/* 8039C8C4 00398704  90 1D 00 00 */	stw r0, 0(r29)
/* 8039C8C8 00398708  93 FD 00 08 */	stw r31, 8(r29)
lbl_8039C8CC:
...
/* 8039C8F8 00398738  2C 1D 00 00 */	cmpwi r29, 0
...
/* 8039C908 00398748  4B E9 9F 61 */	bl __ct__Q24util28StateFactory$$0Q24util6IState$$1FPv
/* 8039C90C 0039874C  3C 60 80 49 */	lis r3, __vt__Q24util118StateFactoryArg2$$0Q24util6IState$$4Q53scn4step4hero6common9StateWait$$4PQ43scn4step4hero4Hero$$4Q43scn4step4hero10ScriptKind$$1@ha
/* 8039C910 00398750  38 03 BC 58 */	addi r0, r3, __vt__Q24util118StateFactoryArg2$$0Q24util6IState$$4Q53scn4step4hero6common9StateWait$$4PQ43scn4step4hero4Hero$$4Q43scn4step4hero10ScriptKind$$1@l
/* 8039C914 00398754  90 1D 00 00 */	stw r0, 0(r29)
/* 8039C918 00398758  93 DD 00 08 */	stw r30, 8(r29)
/* 8039C91C 0039875C  38 00 00 03 */	li r0, 3
...
/* 8039C940 00398780  4B C6 AA 4D */	bl func_8000738C
...
/* 8039C964 003987A4  F3 E1 00 98 */	psq_st f31, 152(r1), 0, qr0
...
/* 8039C998 003987D8  C0 02 D8 20 */	lfs f0, $$257941-_SDA2_BASE_(r2)
...
/* 8039C9D4 00398814  C0 03 00 08 */	lfs f0, 8(r3)
/* 8039C9D8 00398818  EC 20 07 F2 */	fmuls f1, f0, f31
/* 8039C9DC 0039881C  38 61 00 08 */	addi r3, r1, 8
/* 8039C9E0 00398820  C0 42 D8 24 */	lfs f2, $$257942-_SDA2_BASE_(r2)
...
/* 8039CA04 00398844  C0 01 00 08 */	lfs f0, 8(r1)
/* 8039CA08 00398848  EC 00 08 2A */	fadds f0, f0, f1
/* 8039CA0C 0039884C  D0 01 00 08 */	stfs f0, 8(r1)
...
/* 8039CA20 00398860  38 00 00 00 */	li r0, 0
/* 8039CA24 00398864  90 01 00 4C */	stw r0, 0x4c(r1)
/* 8039CA28 00398868  38 00 00 01 */	li r0, 1
...
/* 8039CA4C 0039888C  38 81 00 08 */	addi r4, r1, 8
...
/* 8039CA60 003988A0  38 63 00 08 */	addi r3, r3, 8
...
/* 8039CA90 003988D0  38 80 FF FF */	li r4, -1
/* 8039CA94 003988D4  4B E9 D6 1D */	bl __dt__Q24util39ObjRefHandle$$0Q43scn4step6weapon6Weapon$$1Fv
...
__vt__Q53scn4step4hero7fighter15StateDoubleKick:
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step4hero7fighter15StateDoubleKickFv
	.4byte procAnim__Q53scn4step4hero7fighter15StateDoubleKickFv
	.4byte procMove__Q53scn4step4hero7fighter15StateDoubleKickFv
	.4byte procConstraint__Q43scn4step4hero9StateBaseFv
	.4byte procFixPos__Q53scn4step4hero7fighter15StateDoubleKickFv
