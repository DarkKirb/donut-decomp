...
/* 803900E4 0038BF24  F3 E1 00 28 */	psq_st f31, 40(r1), 0, qr0
...
/* 80390100 0038BF40  90 1E 00 00 */	stw r0, 0(r30)
...
/* 8039012C 0038BF6C  38 61 00 08 */	addi r3, r1, 8
/* 80390130 0038BF70  4B E0 B2 2D */	bl velocity__Q24gobj4MoveCFv
/* 80390134 0038BF74  C3 E1 00 08 */	lfs f31, 8(r1)
/* 80390138 0038BF78  C0 02 D6 50 */	lfs f0, $$256284-_SDA2_BASE_(r2)
/* 8039013C 0038BF7C  FC 1F 00 40 */	fcmpo cr0, f31, f0
/* 80390140 0038BF80  40 80 00 18 */	bge lbl_80390158
/* 80390144 0038BF84  C0 02 D6 54 */	lfs f0, $$256285-_SDA2_BASE_(r2)
/* 80390148 0038BF88  FC 1F 00 40 */	fcmpo cr0, f31, f0
/* 8039014C 0038BF8C  40 81 00 0C */	ble lbl_80390158
/* 80390150 0038BF90  38 00 00 01 */	li r0, 1
/* 80390154 0038BF94  48 00 00 08 */	b lbl_8039015C
lbl_80390158:
/* 80390158 0038BF98  38 00 00 00 */	li r0, 0
lbl_8039015C:
/* 8039015C 0038BF9C  2C 00 00 00 */	cmpwi r0, 0
...
/* 80390170 0038BFB0  C0 02 D6 58 */	lfs f0, $$256286-_SDA2_BASE_(r2)
/* 80390174 0038BFB4  FC 1F 00 40 */	fcmpo cr0, f31, f0
/* 80390178 0038BFB8  7C 80 00 26 */	mfcr r4
/* 8039017C 0038BFBC  54 84 17 FE */	rlwinm r4, r4, 2, 0x1f, 0x1f
/* 80390180 0038BFC0  4B E0 85 01 */	bl __ct__25mint_wrapNative_helper$$0b$$1Fb
lbl_80390184:
...
/* 803901A8 0038BFE8  2C 03 00 00 */	cmpwi r3, 0
...
/* 8039022C 0038C06C  4B C7 71 19 */	bl func_80007344
/* 80390230 0038C070  7C 7D 1B 78 */	mr r29, r3
/* 80390234 0038C074  7C 9E 23 78 */	mr r30, r4
/* 80390238 0038C078  2C 03 00 00 */	cmpwi r3, 0
...
/* 80390248 0038C088  90 03 00 00 */	stw r0, 0(r3)
...
/* 80390254 0038C094  3B E0 00 00 */	li r31, 0
/* 80390258 0038C098  9B E3 00 08 */	stb r31, 8(r3)
...
/* 80390294 0038C0D4  4B C7 70 FD */	bl func_80007390
...
__vt__Q53scn4step4hero5stone8StateEnd:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q53scn4step4hero5stone8StateEndFv
	.byte4 procAnim__Q53scn4step4hero5stone8StateEndFv
	.byte4 procMove__Q53scn4step4hero5stone8StateEndFv
	.byte4 procConstraint__Q43scn4step4hero9StateBaseFv
	.byte4 procFixPos__Q53scn4step4hero5stone8StateEndFv
