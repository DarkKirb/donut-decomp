...
/* 802DAE28 002D6C68  90 1F 00 00 */	stw r0, 0(r31)
/* 802DAE2C 002D6C6C  38 00 00 00 */	li r0, 0
/* 802DAE30 002D6C70  98 1F 00 08 */	stb r0, 8(r31)
/* 802DAE34 002D6C74  98 1F 00 09 */	stb r0, 9(r31)
...
/* 802DAE58 002D6C98  38 80 00 07 */	li r4, 7
...
/* 802DAE9C 002D6CDC  F3 E1 00 28 */	psq_st f31, 40(r1), 0, qr0
/* 802DAEA0 002D6CE0  39 61 00 20 */	addi r11, r1, 0x20
/* 802DAEA4 002D6CE4  4B D2 C4 A1 */	bl func_80007344
...
/* 802DAEBC 002D6CFC  28 03 00 03 */	cmplwi r3, 3
...
/* 802DAEF0 002D6D30  4C 41 13 82 */	cror 2, 1, 2
/* 802DAEF4 002D6D34  40 82 00 B8 */	bne lbl_802DAFAC
/* 802DAEF8 002D6D38  88 1D 00 09 */	lbz r0, 9(r29)
/* 802DAEFC 002D6D3C  2C 00 00 00 */	cmpwi r0, 0
...
/* 802DAF14 002D6D54  38 80 00 01 */	li r4, 1
...
/* 802DAF44 002D6D84  4B FA 72 09 */	bl RuntimeTypeInfoImpl$$0Q53scn4step5enemy6scarfy6Custom$$1__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo
/* 802DAF48 002D6D88  7C 7F 1B 78 */	mr r31, r3
/* 802DAF4C 002D6D8C  2C 1E 00 00 */	cmpwi r30, 0
/* 802DAF50 002D6D90  41 82 00 48 */	beq lbl_802DAF98
/* 802DAF54 002D6D94  7F C3 F3 78 */	mr r3, r30
/* 802DAF58 002D6D98  81 83 00 00 */	lwz r12, 0(r3)
/* 802DAF5C 002D6D9C  81 8C 00 08 */	lwz r12, 8(r12)
...
/* 802DAF74 002D6DB4  38 00 00 01 */	li r0, 1
/* 802DAF78 002D6DB8  48 00 00 14 */	b lbl_802DAF8C
lbl_802DAF7C:
/* 802DAF7C 002D6DBC  80 63 00 00 */	lwz r3, 0(r3)
lbl_802DAF80:
/* 802DAF80 002D6DC0  2C 03 00 00 */	cmpwi r3, 0
/* 802DAF84 002D6DC4  40 82 FF E8 */	bne lbl_802DAF6C
/* 802DAF88 002D6DC8  38 00 00 00 */	li r0, 0
lbl_802DAF8C:
/* 802DAF8C 002D6DCC  2C 00 00 00 */	cmpwi r0, 0
/* 802DAF90 002D6DD0  41 82 00 08 */	beq lbl_802DAF98
/* 802DAF94 002D6DD4  48 00 00 08 */	b lbl_802DAF9C
lbl_802DAF98:
/* 802DAF98 002D6DD8  3B C0 00 00 */	li r30, 0
lbl_802DAF9C:
/* 802DAF9C 002D6DDC  7F C3 F3 78 */	mr r3, r30
/* 802DAFA0 002D6DE0  4B FF ED A1 */	bl onAngerFlag__Q53scn4step5enemy6scarfy6CustomFv
/* 802DAFA4 002D6DE4  38 00 00 01 */	li r0, 1
/* 802DAFA8 002D6DE8  98 1D 00 09 */	stb r0, 9(r29)
lbl_802DAFAC:
...
/* 802DAFBC 002D6DFC  2C 03 00 00 */	cmpwi r3, 0
/* 802DAFC0 002D6E00  41 82 00 60 */	beq lbl_802DB020
/* 802DAFC4 002D6E04  38 00 00 01 */	li r0, 1
/* 802DAFC8 002D6E08  98 1D 00 08 */	stb r0, 8(r29)
...
/* 802DB000 002D6E40  38 80 00 09 */	li r4, 9
...
/* 802DB018 002D6E58  38 80 00 01 */	li r4, 1
...
/* 802DB030 002D6E70  4B D2 C3 61 */	bl func_80007390
...
/* 802DB054 002D6E94  4B D2 C2 ED */	bl func_80007340
/* 802DB058 002D6E98  7C 7C 1B 78 */	mr r28, r3
/* 802DB05C 002D6E9C  88 03 00 08 */	lbz r0, 8(r3)
/* 802DB060 002D6EA0  28 00 00 01 */	cmplwi r0, 1
/* 802DB064 002D6EA4  40 82 00 FC */	bne lbl_802DB160
/* 802DB068 002D6EA8  80 83 00 0C */	lwz r4, 0xc(r3)
/* 802DB06C 002D6EAC  38 04 00 01 */	addi r0, r4, 1
...
/* 802DB130 002D6F70  2C 04 00 00 */	cmpwi r4, 0
/* 802DB134 002D6F74  41 82 00 28 */	beq lbl_802DB15C
/* 802DB138 002D6F78  3C 60 80 46 */	lis r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@ha
/* 802DB13C 002D6F7C  38 03 44 78 */	addi r0, r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@l
/* 802DB140 002D6F80  90 04 00 00 */	stw r0, 0(r4)
/* 802DB144 002D6F84  38 1F 00 90 */	addi r0, r31, 0x90
/* 802DB148 002D6F88  90 04 00 04 */	stw r0, 4(r4)
/* 802DB14C 002D6F8C  3C 60 80 48 */	lis r3, __vt__Q24util99StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy6scarfy15StateAngerChase$$4PQ43scn4step5enemy5Enemy$$1@ha
/* 802DB150 002D6F90  38 03 B3 38 */	addi r0, r3, __vt__Q24util99StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy6scarfy15StateAngerChase$$4PQ43scn4step5enemy5Enemy$$1@l
/* 802DB154 002D6F94  90 04 00 00 */	stw r0, 0(r4)
/* 802DB158 002D6F98  93 C4 00 08 */	stw r30, 8(r4)
lbl_802DB15C:
/* 802DB15C 002D6F9C  90 9F 00 0C */	stw r4, 0xc(r31)
lbl_802DB160:
/* 802DB160 002D6FA0  39 61 00 20 */	addi r11, r1, 0x20
/* 802DB164 002D6FA4  4B D2 C2 29 */	bl func_8000738C
...
__vt__Q53scn4step5enemy6scarfy15StateFaceChange:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q53scn4step5enemy6scarfy15StateFaceChangeFv
	.byte4 procAnim__Q53scn4step5enemy6scarfy15StateFaceChangeFv
	.byte4 procMove__Q53scn4step5enemy6scarfy15StateFaceChangeFv
