...
/* 803C7B84 003C39C4  4B FF D6 65 */	bl lbl_803C51E8
/* 803C7B88 003C39C8  3C 60 80 49 */	lis r3, lbl_804925A8@ha
/* 803C7B8C 003C39CC  38 03 25 A8 */	addi r0, r3, lbl_804925A8@l
/* 803C7B90 003C39D0  90 1F 00 00 */	stw r0, 0x0(r31)
/* 803C7B94 003C39D4  7F E3 FB 78 */	mr r3, r31
/* 803C7B98 003C39D8  4B D3 8C 49 */	bl lbl_801007E0
/* 803C7B9C 003C39DC  4B FF B1 0D */	bl lbl_803C2CA8
...
/* 803C7BAC 003C39EC  4B D3 8C 35 */	bl lbl_801007E0
/* 803C7BB0 003C39F0  4B FF B1 99 */	bl lbl_803C2D48
/* 803C7BB4 003C39F4  38 80 00 00 */	li r4, 0x0
/* 803C7BB8 003C39F8  4B D6 24 39 */	bl lbl_80129FF0
/* 803C7BBC 003C39FC  7F E3 FB 78 */	mr r3, r31
/* 803C7BC0 003C3A00  4B D3 8C 21 */	bl lbl_801007E0
/* 803C7BC4 003C3A04  4B FF B1 5D */	bl lbl_803C2D20
/* 803C7BC8 003C3A08  38 80 00 01 */	li r4, 0x1
/* 803C7BCC 003C3A0C  4B FF CE F9 */	bl lbl_803C4AC4
...
/* 803C7C0C 003C3A4C  3C 80 80 49 */	lis r4, lbl_804925A8@ha
/* 803C7C10 003C3A50  38 04 25 A8 */	addi r0, r4, lbl_804925A8@l
/* 803C7C14 003C3A54  90 03 00 00 */	stw r0, 0x0(r3)
/* 803C7C18 003C3A58  4B D3 8B C9 */	bl lbl_801007E0
/* 803C7C1C 003C3A5C  4B FF B1 05 */	bl lbl_803C2D20
/* 803C7C20 003C3A60  38 80 00 00 */	li r4, 0x0
/* 803C7C24 003C3A64  4B FF CE A1 */	bl lbl_803C4AC4
/* 803C7C28 003C3A68  7F C3 F3 78 */	mr r3, r30
/* 803C7C2C 003C3A6C  38 80 00 00 */	li r4, 0x0
/* 803C7C30 003C3A70  4B FF D5 D9 */	bl lbl_803C5208
...
/* 803C7C44 003C3A84  4B DF 7A D1 */	bl lbl_801BF714
.global lbl_803C7C48
lbl_803C7C48:
...
/* 803C7C80 003C3AC0  4B D3 8B 61 */	bl lbl_801007E0
/* 803C7C84 003C3AC4  4B FF B0 25 */	bl lbl_803C2CA8
/* 803C7C88 003C3AC8  7C 7F 1B 78 */	mr r31, r3
/* 803C7C8C 003C3ACC  C0 23 00 1C */	lfs f1, 0x1c(r3)
/* 803C7C90 003C3AD0  4B DD 3D 6D */	bl lbl_8019B9FC
...
/* 803C7CA8 003C3AE8  4B DD 3D 0D */	bl lbl_8019B9B4
/* 803C7CAC 003C3AEC  7F C3 F3 78 */	mr r3, r30
/* 803C7CB0 003C3AF0  4B D3 8B 31 */	bl lbl_801007E0
/* 803C7CB4 003C3AF4  4B FF B0 2D */	bl lbl_803C2CE0
/* 803C7CB8 003C3AF8  38 81 00 08 */	addi r4, r1, 0x8
/* 803C7CBC 003C3AFC  38 A1 00 0C */	addi r5, r1, 0xc
/* 803C7CC0 003C3B00  4B DD 38 69 */	bl lbl_8019B528
...
/* 803C7D10 003C3B50  4B D3 8A D1 */	bl lbl_801007E0
/* 803C7D14 003C3B54  4B FF B0 0D */	bl lbl_803C2D20
/* 803C7D18 003C3B58  4B FF CD FD */	bl lbl_803C4B14
...
/* 803C7D28 003C3B68  4B D3 8A B9 */	bl lbl_801007E0
/* 803C7D2C 003C3B6C  4B FF AF B5 */	bl lbl_803C2CE0
/* 803C7D30 003C3B70  4B DD 36 61 */	bl lbl_8019B390
.global lbl_803C7D34
lbl_803C7D34:
