...
/* 803907C0 0038C600  F3 E1 00 18 */	psq_st f31, 0x18(r1), 0, qr0
/* 803907C4 0038C604  93 E1 00 0C */	stw r31, 0xc(r1)
/* 803907C8 0038C608  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 803907E0 0038C620  90 1E 00 00 */	stw r0, 0x0(r30)
/* 803907E4 0038C624  93 FE 00 08 */	stw r31, 0x8(r30)
/* 803907E8 0038C628  38 00 00 00 */	li r0, 0x0
...
/* 80390810 0038C650  80 9E 00 08 */	lwz r4, 0x8(r30)
...
/* 80390820 0038C660  48 00 00 45 */	bl "param__Q53scn4step4hero5stone33@unnamed@StateFallScrewStart_cpp@FRQ43scn4step4hero4Hero"
/* 80390824 0038C664  C3 E3 00 00 */	lfs f31, 0x0(r3)
...
/* 80390850 0038C690  83 C1 00 08 */	lwz r30, 0x8(r1)
...
.global "param__Q53scn4step4hero5stone33@unnamed@StateFallScrewStart_cpp@FRQ43scn4step4hero4Hero"
"param__Q53scn4step4hero5stone33@unnamed@StateFallScrewStart_cpp@FRQ43scn4step4hero4Hero":
...
/* 8039089C 0038C6DC  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803908A0 0038C6E0  7C 7E 1B 78 */	mr r30, r3
/* 803908A4 0038C6E4  7C 9F 23 78 */	mr r31, r4
/* 803908A8 0038C6E8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803908B8 0038C6F8  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 803908EC 0038C72C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80390910 0038C750  4B C7 6A 35 */	bl lbl_80007344
/* 80390914 0038C754  7C 7E 1B 78 */	mr r30, r3
/* 80390918 0038C758  80 83 00 0C */	lwz r4, 0xc(r3)
/* 8039091C 0038C75C  38 04 00 01 */	addi r0, r4, 0x1
...
/* 80390928 0038C768  4B FF FF 3D */	bl "param__Q53scn4step4hero5stone33@unnamed@StateFallScrewStart_cpp@FRQ43scn4step4hero4Hero"
/* 8039092C 0038C76C  80 63 00 08 */	lwz r3, 0x8(r3)
...
/* 8039095C 0038C79C  2C 03 00 00 */	cmpwi r3, 0x0
/* 80390960 0038C7A0  41 82 00 60 */	beq lbl_803909C0
/* 80390964 0038C7A4  83 FE 00 08 */	lwz r31, 0x8(r30)
...
/* 8039098C 0038C7CC  2C 04 00 00 */	cmpwi r4, 0x0
/* 80390990 0038C7D0  41 82 00 2C */	beq lbl_803909BC
/* 80390994 0038C7D4  3C 60 80 46 */	lis r3, "__vt__Q24util28StateFactory<Q24util6IState>"@ha
/* 80390998 0038C7D8  38 03 44 78 */	addi r0, r3, "__vt__Q24util28StateFactory<Q24util6IState>"@l
/* 8039099C 0038C7DC  90 04 00 00 */	stw r0, 0x0(r4)
/* 803909A0 0038C7E0  38 1E 00 90 */	addi r0, r30, 0x90
/* 803909A4 0038C7E4  90 04 00 04 */	stw r0, 0x4(r4)
/* 803909A8 0038C7E8  3C 60 80 49 */	lis r3, "__vt__Q24util150StateFactoryArg2<Q24util6IState,Q53scn4step4hero5stone9StateFall,PQ43scn4step4hero4Hero,Q33std3tr149reference_wrapper<Q53scn4step4hero5stone7Context>>"@ha
/* 803909AC 0038C7EC  38 03 D9 A8 */	addi r0, r3, "__vt__Q24util150StateFactoryArg2<Q24util6IState,Q53scn4step4hero5stone9StateFall,PQ43scn4step4hero4Hero,Q33std3tr149reference_wrapper<Q53scn4step4hero5stone7Context>>"@l
/* 803909B0 0038C7F0  90 04 00 00 */	stw r0, 0x0(r4)
/* 803909B4 0038C7F4  93 A4 00 08 */	stw r29, 0x8(r4)
...
/* 803909C4 0038C804  4B C7 69 CD */	bl lbl_80007390
...
/* 803909FC 0038C83C  4B FF FE 69 */	bl "param__Q53scn4step4hero5stone33@unnamed@StateFallScrewStart_cpp@FRQ43scn4step4hero4Hero"
/* 80390A00 0038C840  C0 23 00 04 */	lfs f1, 0x4(r3)
/* 80390A04 0038C844  4B E0 AF F9 */	bl Create__Q24gobj14MoveParamDecelFf
/* 80390A08 0038C848  90 61 00 08 */	stw r3, 0x8(r1)
...
/* 80390A38 0038C878  38 81 00 08 */	addi r4, r1, 0x8
