...
/* 803C78C0 003C3700  4B FF D9 29 */	bl lbl_803C51E8
/* 803C78C4 003C3704  3C 60 80 49 */	lis r3, lbl_80492590@ha
/* 803C78C8 003C3708  38 03 25 90 */	addi r0, r3, lbl_80492590@l
/* 803C78CC 003C370C  90 1E 00 00 */	stw r0, 0x0(r30)
/* 803C78D0 003C3710  7F E3 FB 78 */	mr r3, r31
/* 803C78D4 003C3714  4B FF B3 D5 */	bl lbl_803C2CA8
/* 803C78D8 003C3718  C3 E3 00 18 */	lfs f31, 0x18(r3)
/* 803C78DC 003C371C  7F E3 FB 78 */	mr r3, r31
/* 803C78E0 003C3720  4B FF B3 C9 */	bl lbl_803C2CA8
...
/* 803C78F4 003C3734  4B FF 95 4D */	bl lbl_803C0E40
/* 803C78F8 003C3738  7F C3 F3 78 */	mr r3, r30
/* 803C78FC 003C373C  4B D3 8E E5 */	bl lbl_801007E0
/* 803C7900 003C3740  4B FF B4 49 */	bl lbl_803C2D48
/* 803C7904 003C3744  38 80 00 00 */	li r4, 0x0
/* 803C7908 003C3748  4B D6 26 E9 */	bl lbl_80129FF0
/* 803C790C 003C374C  7F C3 F3 78 */	mr r3, r30
/* 803C7910 003C3750  4B D3 8E D1 */	bl lbl_801007E0
/* 803C7914 003C3754  4B FF B4 0D */	bl lbl_803C2D20
/* 803C7918 003C3758  38 80 00 01 */	li r4, 0x1
/* 803C791C 003C375C  4B FF D1 A9 */	bl lbl_803C4AC4
/* 803C7920 003C3760  7F C3 F3 78 */	mr r3, r30
/* 803C7924 003C3764  4B D3 8E BD */	bl lbl_801007E0
/* 803C7928 003C3768  4B FF B3 F1 */	bl lbl_803C2D18
/* 803C792C 003C376C  38 80 00 02 */	li r4, 0x2
/* 803C7930 003C3770  4B EA 78 65 */	bl lbl_8026F194
...
/* 803C7980 003C37C0  3C 80 80 49 */	lis r4, lbl_80492590@ha
/* 803C7984 003C37C4  38 04 25 90 */	addi r0, r4, lbl_80492590@l
/* 803C7988 003C37C8  90 03 00 00 */	stw r0, 0x0(r3)
/* 803C798C 003C37CC  4B D3 8E 55 */	bl lbl_801007E0
/* 803C7990 003C37D0  4B FF B3 91 */	bl lbl_803C2D20
/* 803C7994 003C37D4  38 80 00 00 */	li r4, 0x0
/* 803C7998 003C37D8  4B FF D1 2D */	bl lbl_803C4AC4
/* 803C799C 003C37DC  38 7E 00 08 */	addi r3, r30, 0x8
/* 803C79A0 003C37E0  38 80 FF FF */	li r4, -0x1
/* 803C79A4 003C37E4  4B DA E1 C5 */	bl lbl_80175B68
/* 803C79A8 003C37E8  7F C3 F3 78 */	mr r3, r30
/* 803C79AC 003C37EC  38 80 00 00 */	li r4, 0x0
/* 803C79B0 003C37F0  4B FF D8 59 */	bl lbl_803C5208
...
/* 803C79C4 003C3804  4B DF 7D 51 */	bl lbl_801BF714
.global lbl_803C79C8
lbl_803C79C8:
...
/* 803C79E8 003C3828  4B FF 94 70 */	b lbl_803C0E58
...
/* 803C7A04 003C3844  4B D3 8D DD */	bl lbl_801007E0
/* 803C7A08 003C3848  4B FF B2 A1 */	bl lbl_803C2CA8
/* 803C7A0C 003C384C  7C 7F 1B 78 */	mr r31, r3
/* 803C7A10 003C3850  C0 23 00 04 */	lfs f1, 0x4(r3)
/* 803C7A14 003C3854  4B DD 3F E9 */	bl lbl_8019B9FC
...
/* 803C7A2C 003C386C  4B DD 3F 89 */	bl lbl_8019B9B4
/* 803C7A30 003C3870  7F C3 F3 78 */	mr r3, r30
/* 803C7A34 003C3874  4B D3 8D AD */	bl lbl_801007E0
/* 803C7A38 003C3878  4B FF B2 A9 */	bl lbl_803C2CE0
/* 803C7A3C 003C387C  38 81 00 08 */	addi r4, r1, 0x8
/* 803C7A40 003C3880  38 A1 00 0C */	addi r5, r1, 0xc
/* 803C7A44 003C3884  4B DD 3A E5 */	bl lbl_8019B528
...
/* 803C7A7C 003C38BC  4B D3 8D 65 */	bl lbl_801007E0
/* 803C7A80 003C38C0  4B FF B2 A1 */	bl lbl_803C2D20
/* 803C7A84 003C38C4  4B FF D0 91 */	bl lbl_803C4B14
...
/* 803C7A94 003C38D4  4B D3 8D 4D */	bl lbl_801007E0
/* 803C7A98 003C38D8  4B FF B2 89 */	bl lbl_803C2D20
/* 803C7A9C 003C38DC  7C 64 1B 78 */	mr r4, r3
/* 803C7AA0 003C38E0  38 61 00 10 */	addi r3, r1, 0x10
/* 803C7AA4 003C38E4  4B FF D0 79 */	bl lbl_803C4B1C
/* 803C7AA8 003C38E8  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 803C7AAC 003C38EC  C0 02 DB 10 */	lfs f0, lbl_80563A90@sda21(r2)
...
/* 803C7ABC 003C38FC  4B D3 8D 25 */	bl lbl_801007E0
/* 803C7AC0 003C3900  4B FF B2 21 */	bl lbl_803C2CE0
/* 803C7AC4 003C3904  4B DD 38 CD */	bl lbl_8019B390
/* 803C7AC8 003C3908  38 7E 00 08 */	addi r3, r30, 0x8
/* 803C7ACC 003C390C  4B FF 93 A5 */	bl lbl_803C0E70
...
/* 803C7AE4 003C3924  4B D3 8C FD */	bl lbl_801007E0
/* 803C7AE8 003C3928  4B FF B2 39 */	bl lbl_803C2D20
/* 803C7AEC 003C392C  7C 64 1B 78 */	mr r4, r3
/* 803C7AF0 003C3930  38 61 00 08 */	addi r3, r1, 0x8
/* 803C7AF4 003C3934  4B FF D0 29 */	bl lbl_803C4B1C
/* 803C7AF8 003C3938  C0 21 00 08 */	lfs f1, 0x8(r1)
/* 803C7AFC 003C393C  C0 02 DB 14 */	lfs f0, lbl_80563A94@sda21(r2)
...
.global lbl_803C7B0C
lbl_803C7B0C:
/* 803C7B0C 003C394C  C0 02 DB 10 */	lfs f0, lbl_80563A90@sda21(r2)
...
/* 803C7B1C 003C395C  4B D3 8C C5 */	bl lbl_801007E0
/* 803C7B20 003C3960  4B FF B1 C1 */	bl lbl_803C2CE0
/* 803C7B24 003C3964  C0 22 DB 14 */	lfs f1, lbl_80563A94@sda21(r2)
/* 803C7B28 003C3968  4B D6 2B D9 */	bl lbl_8012A700
.global lbl_803C7B2C
lbl_803C7B2C:
...
/* 803C7B38 003C3978  4B D3 8C A9 */	bl lbl_801007E0
/* 803C7B3C 003C397C  4B FF B1 95 */	bl lbl_803C2CD0
/* 803C7B40 003C3980  4B DD 23 89 */	bl lbl_80199EC8
/* 803C7B44 003C3984  48 00 00 14 */	b lbl_803C7B58
.global lbl_803C7B48
lbl_803C7B48:
/* 803C7B48 003C3988  7F C3 F3 78 */	mr r3, r30
/* 803C7B4C 003C398C  4B D3 8C 95 */	bl lbl_801007E0
/* 803C7B50 003C3990  4B FF B1 81 */	bl lbl_803C2CD0
/* 803C7B54 003C3994  4B DB F9 E5 */	bl lbl_80187538
.global lbl_803C7B58
lbl_803C7B58:
