...
/* 803A138C 0039D1CC  90 1E 00 00 */	stw r0, 0x0(r30)
/* 803A1390 0039D1D0  38 00 00 00 */	li r0, 0x0
/* 803A1394 0039D1D4  90 1E 00 08 */	stw r0, 0x8(r30)
...
/* 803A13A8 0039D1E8  38 80 00 01 */	li r4, 0x1
...
/* 803A13CC 0039D20C  38 80 00 01 */	li r4, 0x1
...
/* 803A1424 0039D264  38 80 00 05 */	li r4, 0x5
...
/* 803A1438 0039D278  38 63 00 04 */	addi r3, r3, 0x4
...
/* 803A1470 0039D2B0  C0 02 D8 98 */	lfs f0, "@59013_80563818"@sda21(r2)
...
/* 803A1498 0039D2D8  C0 42 D8 9C */	lfs f2, "@59014"@sda21(r2)
...
/* 803A14B8 0039D2F8  C0 02 D8 A0 */	lfs f0, "@59015"@sda21(r2)
/* 803A14BC 0039D2FC  EC 20 00 72 */	fmuls f1, f0, f1
/* 803A14C0 0039D300  38 61 00 08 */	addi r3, r1, 0x8
/* 803A14C4 0039D304  C0 42 D8 A4 */	lfs f2, "@59016"@sda21(r2)
...
/* 803A14D4 0039D314  38 00 00 06 */	li r0, 0x6
/* 803A14D8 0039D318  90 01 00 40 */	stw r0, 0x40(r1)
/* 803A14DC 0039D31C  38 00 00 01 */	li r0, 0x1
...
/* 803A1504 0039D344  38 81 00 08 */	addi r4, r1, 0x8
...
/* 803A1518 0039D358  38 63 00 08 */	addi r3, r3, 0x8
...
/* 803A1548 0039D388  38 80 FF FF */	li r4, -0x1
/* 803A154C 0039D38C  4B E9 8B 65 */	bl "__dt__Q24util39ObjRefHandle<Q43scn4step6weapon6Weapon>Fv"
...
/* 803A157C 0039D3BC  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803A1580 0039D3C0  7C 7E 1B 78 */	mr r30, r3
/* 803A1584 0039D3C4  7C 9F 23 78 */	mr r31, r4
/* 803A1588 0039D3C8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A1598 0039D3D8  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 803A15D4 0039D414  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 803A15F8 0039D438  4B C6 5D 4D */	bl lbl_80007344
/* 803A15FC 0039D43C  7C 7D 1B 78 */	mr r29, r3
/* 803A1600 0039D440  80 83 00 08 */	lwz r4, 0x8(r3)
/* 803A1604 0039D444  38 04 00 01 */	addi r0, r4, 0x1
/* 803A1608 0039D448  90 03 00 08 */	stw r0, 0x8(r3)
...
/* 803A161C 0039D45C  80 1D 00 08 */	lwz r0, 0x8(r29)
...
/* 803A164C 0039D48C  2C 1D 00 00 */	cmpwi r29, 0x0
...
/* 803A165C 0039D49C  4B E9 52 0D */	bl "__ct__Q24util28StateFactory<Q24util6IState>FPv"
/* 803A1660 0039D4A0  3C 60 80 48 */	lis r3, "__vt__Q24util89StateFactoryArg1<Q24util6IState,Q53scn4step4hero6common9StateWait,PQ43scn4step4hero4Hero>"@ha
/* 803A1664 0039D4A4  38 03 3F F8 */	addi r0, r3, "__vt__Q24util89StateFactoryArg1<Q24util6IState,Q53scn4step4hero6common9StateWait,PQ43scn4step4hero4Hero>"@l
/* 803A1668 0039D4A8  90 1D 00 00 */	stw r0, 0x0(r29)
/* 803A166C 0039D4AC  93 DD 00 08 */	stw r30, 0x8(r29)
.global lbl_803A1670
lbl_803A1670:
...
/* 803A1678 0039D4B8  4B C6 5D 19 */	bl lbl_80007390
