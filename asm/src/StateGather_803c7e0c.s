...
/* 803C7E28 003C3C68  4B FF D3 C1 */	bl lbl_803C51E8
/* 803C7E2C 003C3C6C  3C 60 80 49 */	lis r3, lbl_804925D8@ha
/* 803C7E30 003C3C70  38 03 25 D8 */	addi r0, r3, lbl_804925D8@l
/* 803C7E34 003C3C74  90 1E 00 00 */	stw r0, 0x0(r30)
/* 803C7E38 003C3C78  C0 02 DB 18 */	lfs f0, lbl_80563A98@sda21(r2)
/* 803C7E3C 003C3C7C  D0 1E 00 08 */	stfs f0, 0x8(r30)
/* 803C7E40 003C3C80  7F C3 F3 78 */	mr r3, r30
/* 803C7E44 003C3C84  4B D3 89 9D */	bl lbl_801007E0
/* 803C7E48 003C3C88  4B FF AE 91 */	bl lbl_803C2CD8
/* 803C7E4C 003C3C8C  7C 64 1B 78 */	mr r4, r3
/* 803C7E50 003C3C90  38 61 00 10 */	addi r3, r1, 0x10
/* 803C7E54 003C3C94  4B DB 47 75 */	bl lbl_8017C5C8
...
/* 803C7E70 003C3CB0  4B D8 3A F9 */	bl lbl_8014B968
/* 803C7E74 003C3CB4  93 FE 00 14 */	stw r31, 0x14(r30)
/* 803C7E78 003C3CB8  7F C3 F3 78 */	mr r3, r30
/* 803C7E7C 003C3CBC  4B D3 89 65 */	bl lbl_801007E0
/* 803C7E80 003C3CC0  4B FF AE C9 */	bl lbl_803C2D48
/* 803C7E84 003C3CC4  38 80 00 02 */	li r4, 0x2
/* 803C7E88 003C3CC8  4B D6 21 69 */	bl lbl_80129FF0
/* 803C7E8C 003C3CCC  7F C3 F3 78 */	mr r3, r30
/* 803C7E90 003C3CD0  4B D3 89 51 */	bl lbl_801007E0
/* 803C7E94 003C3CD4  38 80 00 00 */	li r4, 0x0
/* 803C7E98 003C3CD8  4B FF AD 55 */	bl lbl_803C2BEC
/* 803C7E9C 003C3CDC  7F C3 F3 78 */	mr r3, r30
/* 803C7EA0 003C3CE0  4B D3 89 41 */	bl lbl_801007E0
/* 803C7EA4 003C3CE4  38 80 00 00 */	li r4, 0x0
/* 803C7EA8 003C3CE8  4B FF AD 69 */	bl lbl_803C2C10
/* 803C7EAC 003C3CEC  7F C3 F3 78 */	mr r3, r30
/* 803C7EB0 003C3CF0  4B D3 89 31 */	bl lbl_801007E0
/* 803C7EB4 003C3CF4  4B FF AE 25 */	bl lbl_803C2CD8
/* 803C7EB8 003C3CF8  7C 64 1B 78 */	mr r4, r3
/* 803C7EBC 003C3CFC  38 61 00 1C */	addi r3, r1, 0x1c
/* 803C7EC0 003C3D00  4B DB 47 09 */	bl lbl_8017C5C8
/* 803C7EC4 003C3D04  C0 21 00 20 */	lfs f1, 0x20(r1)
/* 803C7EC8 003C3D08  C0 02 DB 1C */	lfs f0, lbl_80563A9C@sda21(r2)
...
/* 803C7ED8 003C3D18  4B D3 89 09 */	bl lbl_801007E0
/* 803C7EDC 003C3D1C  4B CA D8 55 */	bl lbl_80075730
/* 803C7EE0 003C3D20  4B E3 D6 E9 */	bl lbl_802055C8
...
/* 803C7EF0 003C3D30  4B EB 00 85 */	bl lbl_80277F74
...
/* 803C7F2C 003C3D6C  C0 02 DB 20 */	lfs f0, lbl_80563AA0@sda21(r2)
/* 803C7F30 003C3D70  EC 01 00 2A */	fadds f0, f1, f0
/* 803C7F34 003C3D74  D0 03 00 08 */	stfs f0, 0x8(r3)
/* 803C7F38 003C3D78  4B D3 88 A9 */	bl lbl_801007E0
/* 803C7F3C 003C3D7C  4B FF AD 6D */	bl lbl_803C2CA8
/* 803C7F40 003C3D80  80 03 00 D8 */	lwz r0, 0xd8(r3)
/* 803C7F44 003C3D84  C8 22 DB 28 */	lfd f1, lbl_80563AA8@sda21(r2)
...
/* 803C7F6C 003C3DAC  4B D3 88 75 */	bl lbl_801007E0
/* 803C7F70 003C3DB0  4B D5 8F 01 */	bl lbl_80120E70
/* 803C7F74 003C3DB4  7C 7F 1B 78 */	mr r31, r3
/* 803C7F78 003C3DB8  7F C3 F3 78 */	mr r3, r30
/* 803C7F7C 003C3DBC  4B D3 88 65 */	bl lbl_801007E0
/* 803C7F80 003C3DC0  4B D5 8E E1 */	bl lbl_80120E60
...
/* 803C7F90 003C3DD0  4B DA CD A9 */	bl lbl_80174D38
/* 803C7F94 003C3DD4  7C 64 1B 78 */	mr r4, r3
/* 803C7F98 003C3DD8  80 7E 00 14 */	lwz r3, 0x14(r30)
/* 803C7F9C 003C3DDC  4B FF 8D 39 */	bl lbl_803C0CD4
/* 803C7FA0 003C3DE0  7F C3 F3 78 */	mr r3, r30
/* 803C7FA4 003C3DE4  4B D3 88 3D */	bl lbl_801007E0
/* 803C7FA8 003C3DE8  38 80 00 01 */	li r4, 0x1
/* 803C7FAC 003C3DEC  4B FF A9 11 */	bl lbl_803C28BC
/* 803C7FB0 003C3DF0  7F C3 F3 78 */	mr r3, r30
/* 803C7FB4 003C3DF4  4B D3 88 2D */	bl lbl_801007E0
/* 803C7FB8 003C3DF8  4B FF A7 11 */	bl lbl_803C26C8
.global lbl_803C7FBC
lbl_803C7FBC:
...
/* 803C7FFC 003C3E3C  C0 02 DB 30 */	lfs f0, lbl_80563AB0@sda21(r2)
/* 803C8000 003C3E40  EF E1 00 24 */	fdivs f31, f1, f0
/* 803C8004 003C3E44  C0 22 DB 20 */	lfs f1, lbl_80563AA0@sda21(r2)
...
/* 803C8018 003C3E58  4B FF 8D 1D */	bl lbl_803C0D34
...
/* 803C8028 003C3E68  4B DD 73 8D */	bl lbl_8019F3B4
/* 803C802C 003C3E6C  38 61 00 08 */	addi r3, r1, 0x8
/* 803C8030 003C3E70  38 9F 00 0C */	addi r4, r31, 0xc
/* 803C8034 003C3E74  C0 02 DB 20 */	lfs f0, lbl_80563AA0@sda21(r2)
/* 803C8038 003C3E78  EC 20 F0 28 */	fsubs f1, f0, f30

.global lbl_803C803C
lbl_803C803C:
/* 803C803C 003C3E7C  4B DD 73 79 */	bl lbl_8019F3B4
...
/* 803C8060 003C3EA0  C0 02 DB 3C */	lfs f0, lbl_80563ABC@sda21(r2)
/* 803C8064 003C3EA4  EC 20 07 F2 */	fmuls f1, f0, f31
/* 803C8068 003C3EA8  C0 02 DB 38 */	lfs f0, lbl_80563AB8@sda21(r2)
/* 803C806C 003C3EAC  EC 20 00 72 */	fmuls f1, f0, f1
/* 803C8070 003C3EB0  C0 02 DB 34 */	lfs f0, lbl_80563AB4@sda21(r2)
/* 803C8074 003C3EB4  EC 20 00 72 */	fmuls f1, f0, f1
/* 803C8078 003C3EB8  4B D3 6A 29 */	bl lbl_800FEAA0
...
/* 803C8090 003C3ED0  4B DD 73 CD */	bl lbl_8019F45C
/* 803C8094 003C3ED4  7F E3 FB 78 */	mr r3, r31
/* 803C8098 003C3ED8  4B D3 87 49 */	bl lbl_801007E0
/* 803C809C 003C3EDC  4B FF AC 3D */	bl lbl_803C2CD8
/* 803C80A0 003C3EE0  38 81 00 20 */	addi r4, r1, 0x20
/* 803C80A4 003C3EE4  4B DD 29 01 */	bl lbl_8019A9A4
...
.global lbl_803C80D4
lbl_803C80D4:
/* 803C80D4 003C3F14  4B FF F3 34 */	b lbl_803C7408
