...
/* 802C83C8 002C4208  4B FC 59 FD */	bl lbl_8028DDC4
/* 802C83CC 002C420C  3C 60 80 48 */	lis r3, lbl_80479978@ha
/* 802C83D0 002C4210  38 03 99 78 */	addi r0, r3, lbl_80479978@l
...
/* 802C83E0 002C4220  4B FC DB 51 */	bl lbl_80295F30
/* 802C83E4 002C4224  7F C3 F3 78 */	mr r3, r30
/* 802C83E8 002C4228  4B E3 83 F9 */	bl lbl_801007E0
/* 802C83EC 002C422C  4B FB FC C9 */	bl lbl_802880B4
/* 802C83F0 002C4230  4B EB F1 49 */	bl lbl_80187538
/* 802C83F4 002C4234  7F C3 F3 78 */	mr r3, r30
/* 802C83F8 002C4238  4B E3 83 E9 */	bl lbl_801007E0
/* 802C83FC 002C423C  4B FB FD 21 */	bl lbl_8028811C
/* 802C8400 002C4240  4B FA 9F 39 */	bl lbl_80272338
/* 802C8404 002C4244  7F C3 F3 78 */	mr r3, r30
/* 802C8408 002C4248  4B E3 83 D9 */	bl lbl_801007E0
/* 802C840C 002C424C  4B FB FC C1 */	bl lbl_802880CC
/* 802C8410 002C4250  38 80 00 01 */	li r4, 0x1
/* 802C8414 002C4254  4B FA 8E 69 */	bl lbl_8027127C
/* 802C8418 002C4258  7F C3 F3 78 */	mr r3, r30
/* 802C841C 002C425C  4B E3 83 C5 */	bl lbl_801007E0
/* 802C8420 002C4260  4B FB FC A5 */	bl lbl_802880C4
/* 802C8424 002C4264  4B ED 2F 6D */	bl lbl_8019B390
...
/* 802C8468 002C42A8  3C 80 80 48 */	lis r4, lbl_80479978@ha
/* 802C846C 002C42AC  38 04 99 78 */	addi r0, r4, lbl_80479978@l
/* 802C8470 002C42B0  90 03 00 00 */	stw r0, 0x0(r3)
/* 802C8474 002C42B4  4B E3 83 6D */	bl lbl_801007E0
/* 802C8478 002C42B8  4B FB FC A5 */	bl lbl_8028811C
/* 802C847C 002C42BC  4B F6 4A 95 */	bl lbl_8022CF10
/* 802C8480 002C42C0  4B FA 4B 75 */	bl lbl_8026CFF4
/* 802C8484 002C42C4  7F C3 F3 78 */	mr r3, r30
/* 802C8488 002C42C8  4B E3 83 59 */	bl lbl_801007E0
/* 802C848C 002C42CC  4B FB FC 41 */	bl lbl_802880CC
/* 802C8490 002C42D0  4B FA 8E C1 */	bl lbl_80271350
/* 802C8494 002C42D4  38 7E 00 08 */	addi r3, r30, 0x8
/* 802C8498 002C42D8  38 80 FF FF */	li r4, -0x1
/* 802C849C 002C42DC  4B EA D6 CD */	bl lbl_80175B68
/* 802C84A0 002C42E0  7F C3 F3 78 */	mr r3, r30
/* 802C84A4 002C42E4  38 80 00 00 */	li r4, 0x0
/* 802C84A8 002C42E8  4B FC 59 45 */	bl lbl_8028DDEC
...
/* 802C84BC 002C42FC  4B EF 72 59 */	bl lbl_801BF714
.global lbl_802C84C0
lbl_802C84C0:
...
/* 802C84FC 002C433C  4B FC DA 99 */	bl lbl_80295F94
/* 802C8500 002C4340  38 7F 00 08 */	addi r3, r31, 0x8
/* 802C8504 002C4344  4B F0 03 BD */	bl lbl_801C88C0
...
/* 802C8514 002C4354  4B EF 49 E1 */	bl lbl_801BCEF4
/* 802C8518 002C4358  C0 02 BE 20 */	lfs f0, lbl_80561DA0@sda21(r2)
/* 802C851C 002C435C  EC 20 00 72 */	fmuls f1, f0, f1
/* 802C8520 002C4360  C0 02 BE 1C */	lfs f0, lbl_80561D9C@sda21(r2)
/* 802C8524 002C4364  EC 20 00 72 */	fmuls f1, f0, f1
/* 802C8528 002C4368  C0 02 BE 18 */	lfs f0, lbl_80561D98@sda21(r2)
/* 802C852C 002C436C  EC 20 00 72 */	fmuls f1, f0, f1
/* 802C8530 002C4370  4B E3 65 F1 */	bl lbl_800FEB20
/* 802C8534 002C4374  FF E0 08 90 */	fmr f31, f1
/* 802C8538 002C4378  7F E3 FB 78 */	mr r3, r31
/* 802C853C 002C437C  4B E3 82 A5 */	bl lbl_801007E0
/* 802C8540 002C4380  4B FB FB 6D */	bl lbl_802880AC
/* 802C8544 002C4384  4B ED 3B 5D */	bl lbl_8019C0A0
/* 802C8548 002C4388  C0 02 BE 28 */	lfs f0, lbl_80561DA8@sda21(r2)
/* 802C854C 002C438C  EC 40 F8 28 */	fsubs f2, f0, f31
/* 802C8550 002C4390  C0 02 BE 24 */	lfs f0, lbl_80561DA4@sda21(r2)
/* 802C8554 002C4394  EC 00 00 B2 */	fmuls f0, f0, f2
/* 802C8558 002C4398  EC 20 00 72 */	fmuls f1, f0, f1
/* 802C855C 002C439C  C0 02 BE 2C */	lfs f0, lbl_80561DAC@sda21(r2)
...
/* 802C8570 002C43B0  4B E3 82 71 */	bl lbl_801007E0
/* 802C8574 002C43B4  38 81 00 08 */	addi r4, r1, 0x8
/* 802C8578 002C43B8  4B FC 5F A9 */	bl lbl_8028E520
.global lbl_802C857C
lbl_802C857C:
...
.global lbl_802C859C
lbl_802C859C:
/* 802C859C 002C43DC  4B FC E3 30 */	b lbl_802968CC

.global lbl_802C85A0
lbl_802C85A0:
/* 802C85A0 002C43E0  4B FC E3 34 */	b lbl_802968D4
