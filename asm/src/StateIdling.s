...
/* 802C675C 002C259C  F3 E1 00 18 */	psq_st f31, 24(r1), 0, qr0
/* 802C6760 002C25A0  93 E1 00 0C */	stw r31, 0xc(r1)
/* 802C6764 002C25A4  93 C1 00 08 */	stw r30, 8(r1)
...
/* 802C6778 002C25B8  90 1E 00 00 */	stw r0, 0(r30)
/* 802C677C 002C25BC  38 00 00 00 */	li r0, 0
/* 802C6780 002C25C0  90 1E 00 08 */	stw r0, 8(r30)
...
/* 802C6790 002C25D0  4B FF F3 35 */	bl DynamicCastToRef$$0Q53scn4step5enemy8needlous6Custom$$4Q43scn4step5enemy7ICustom$$1__Q23hel6commonFPQ43scn4step5enemy7ICustom_RQ53scn4step5enemy8needlous6Custom
...
/* 802C67B4 002C25F4  C0 02 BD C8 */	lfs f0, $$256990-_SDA2_BASE_(r2)
...
/* 802C67C8 002C2608  38 80 00 02 */	li r4, 2
...
/* 802C67E0 002C2620  38 80 00 07 */	li r4, 7
...
/* 802C67F0 002C2630  2C 03 00 00 */	cmpwi r3, 0
...
/* 802C6818 002C2658  38 80 00 00 */	li r4, 0
...
/* 802C6858 002C2698  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 802C687C 002C26BC  93 C1 00 08 */	stw r30, 8(r1)
/* 802C6880 002C26C0  7C 7E 1B 78 */	mr r30, r3
/* 802C6884 002C26C4  7C 9F 23 78 */	mr r31, r4
/* 802C6888 002C26C8  2C 03 00 00 */	cmpwi r3, 0
...
/* 802C6898 002C26D8  90 03 00 00 */	stw r0, 0(r3)
...
/* 802C68A8 002C26E8  38 80 00 01 */	li r4, 1
...
/* 802C68BC 002C26FC  4B FF F2 09 */	bl DynamicCastToRef$$0Q53scn4step5enemy8needlous6Custom$$4Q43scn4step5enemy7ICustom$$1__Q23hel6commonFPQ43scn4step5enemy7ICustom_RQ53scn4step5enemy8needlous6Custom
/* 802C68C0 002C2700  38 80 00 00 */	li r4, 0
...
/* 802C6900 002C2740  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 802C6924 002C2764  93 C1 00 08 */	stw r30, 8(r1)
...
/* 802C6934 002C2774  4B FF F1 91 */	bl DynamicCastToRef$$0Q53scn4step5enemy8needlous6Custom$$4Q43scn4step5enemy7ICustom$$1__Q23hel6commonFPQ43scn4step5enemy7ICustom_RQ53scn4step5enemy8needlous6Custom
/* 802C6938 002C2778  7C 7F 1B 78 */	mr r31, r3
/* 802C693C 002C277C  80 7E 00 08 */	lwz r3, 8(r30)
/* 802C6940 002C2780  38 03 00 01 */	addi r0, r3, 1
/* 802C6944 002C2784  90 1E 00 08 */	stw r0, 8(r30)
...
/* 802C6978 002C27B8  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 802C699C 002C27DC  4B D4 09 A9 */	bl func_80007344
...
/* 802C69D8 002C2818  38 BE 00 04 */	addi r5, r30, 4
...
/* 802C69EC 002C282C  4B FF F0 D9 */	bl DynamicCastToRef$$0Q53scn4step5enemy8needlous6Custom$$4Q43scn4step5enemy7ICustom$$1__Q23hel6commonFPQ43scn4step5enemy7ICustom_RQ53scn4step5enemy8needlous6Custom
...
/* 802C69F8 002C2838  4B D4 09 99 */	bl func_80007390
...
/* 802C6A1C 002C285C  F3 E1 00 68 */	psq_st f31, 104(r1), 0, qr0
/* 802C6A20 002C2860  39 61 00 60 */	addi r11, r1, 0x60
/* 802C6A24 002C2864  4B D4 09 21 */	bl func_80007344
...
/* 802C6A34 002C2874  4B FF F0 91 */	bl DynamicCastToRef$$0Q53scn4step5enemy8needlous6Custom$$4Q43scn4step5enemy7ICustom$$1__Q23hel6commonFPQ43scn4step5enemy7ICustom_RQ53scn4step5enemy8needlous6Custom
...
/* 802C6A6C 002C28AC  2C 00 00 00 */	cmpwi r0, 0
...
/* 802C6A88 002C28C8  C0 02 BD CC */	lfs f0, $$257034-_SDA2_BASE_(r2)
/* 802C6A8C 002C28CC  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802C6A90 002C28D0  4C 41 13 82 */	cror 2, 1, 2
...
/* 802C6AB8 002C28F8  4B ED 93 FD */	bl Abs$$0f$$1__Q33hel4math4MathFf_Cf
/* 802C6ABC 002C28FC  C0 1E 00 3C */	lfs f0, 0x3c(r30)
/* 802C6AC0 002C2900  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802C6AC4 002C2904  4C 41 13 82 */	cror 2, 1, 2
...
/* 802C6AEC 002C292C  4B ED 93 C9 */	bl Abs$$0f$$1__Q33hel4math4MathFf_Cf
...
/* 802C6AFC 002C293C  C3 E2 BD D0 */	lfs f31, $$257035-_SDA2_BASE_(r2)
...
/* 802C6B2C 002C296C  2C 00 00 00 */	cmpwi r0, 0
...
/* 802C6B44 002C2984  2C 03 00 00 */	cmpwi r3, 0
...
/* 802C6B60 002C29A0  2C 00 00 00 */	cmpwi r0, 0
...
/* 802C6BA0 002C29E0  4B ED 1A E1 */	bl __ct__25mint_wrapNative_helper$$0b$$1Fb
lbl_802C6BA4:
...
/* 802C6BB8 002C29F8  80 1D 00 08 */	lwz r0, 8(r29)
...
/* 802C6BD4 002C2A14  38 61 00 08 */	addi r3, r1, 8
/* 802C6BD8 002C2A18  4B ED 47 85 */	bl velocity__Q24gobj4MoveCFv
/* 802C6BDC 002C2A1C  C0 21 00 0C */	lfs f1, 0xc(r1)
/* 802C6BE0 002C2A20  4B ED 92 D5 */	bl Abs$$0f$$1__Q33hel4math4MathFf_Cf
/* 802C6BE4 002C2A24  C0 02 BD D0 */	lfs f0, $$257035-_SDA2_BASE_(r2)
...
/* 802C6C14 002C2A54  2C 04 00 00 */	cmpwi r4, 0
/* 802C6C18 002C2A58  41 82 00 28 */	beq lbl_802C6C40
/* 802C6C1C 002C2A5C  3C 60 80 46 */	lis r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@ha
/* 802C6C20 002C2A60  38 03 44 78 */	addi r0, r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@l
/* 802C6C24 002C2A64  90 04 00 00 */	stw r0, 0(r4)
/* 802C6C28 002C2A68  38 1F 00 90 */	addi r0, r31, 0x90
/* 802C6C2C 002C2A6C  90 04 00 04 */	stw r0, 4(r4)
/* 802C6C30 002C2A70  3C 60 80 48 */	lis r3, __vt__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy8needlous11StateAttack$$4PQ43scn4step5enemy5Enemy$$1@ha
/* 802C6C34 002C2A74  38 03 94 A0 */	addi r0, r3, __vt__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy8needlous11StateAttack$$4PQ43scn4step5enemy5Enemy$$1@l
/* 802C6C38 002C2A78  90 04 00 00 */	stw r0, 0(r4)
/* 802C6C3C 002C2A7C  93 C4 00 08 */	stw r30, 8(r4)
lbl_802C6C40:
...
/* 802C6C54 002C2A94  4B D4 07 3D */	bl func_80007390
...
.global create__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy8needlous11StateAttack$$4PQ43scn4step5enemy5Enemy$$1Fv
create__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy8needlous11StateAttack$$4PQ43scn4step5enemy5Enemy$$1Fv:
/* 802C6C68 002C2AA8  7C 64 1B 78 */	mr r4, r3
/* 802C6C6C 002C2AAC  80 63 00 04 */	lwz r3, 4(r3)
/* 802C6C70 002C2AB0  2C 03 00 00 */	cmpwi r3, 0
/* 802C6C74 002C2AB4  4D 82 00 20 */	beqlr 
/* 802C6C78 002C2AB8  80 84 00 08 */	lwz r4, 8(r4)
...
.global __dt__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy8needlous11StateAttack$$4PQ43scn4step5enemy5Enemy$$1Fv
__dt__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy8needlous11StateAttack$$4PQ43scn4step5enemy5Enemy$$1Fv:
/* 802C6C84 002C2AC4  4B F6 7A 1C */	b __dt__Q24util89StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4boss6common9StateWait$$4PQ43scn4step4boss4Boss$$1Fv

.section .data, "wa"  # 0x80421040 - 0x80496700
.global __vt__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy8needlous11StateAttack$$4PQ43scn4step5enemy5Enemy$$1
__vt__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy8needlous11StateAttack$$4PQ43scn4step5enemy5Enemy$$1:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy8needlous11StateAttack$$4PQ43scn4step5enemy5Enemy$$1Fv
	.byte4 create__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy8needlous11StateAttack$$4PQ43scn4step5enemy5Enemy$$1Fv
.global __vt__Q53scn4step5enemy8needlous11StateIdling
__vt__Q53scn4step5enemy8needlous11StateIdling:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q53scn4step5enemy8needlous11StateIdlingFv
	.byte4 procAnim__Q53scn4step5enemy8needlous11StateIdlingFv
	.byte4 procMove__Q53scn4step5enemy8needlous11StateIdlingFv
	.byte4 procConstraint__Q43scn4step5enemy9StateBaseFv
	.byte4 procFixPos__Q53scn4step5enemy8needlous11StateIdlingFv
