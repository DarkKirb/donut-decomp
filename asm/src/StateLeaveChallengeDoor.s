...
/* 80380280 0037C0C0  90 1E 00 00 */	stw r0, 0(r30)
/* 80380284 0037C0C4  38 00 00 00 */	li r0, 0
/* 80380288 0037C0C8  90 1E 00 08 */	stw r0, 8(r30)
/* 8038028C 0037C0CC  80 7F 00 00 */	lwz r3, 0(r31)
/* 80380290 0037C0D0  80 1F 00 04 */	lwz r0, 4(r31)
/* 80380294 0037C0D4  90 7E 00 0C */	stw r3, 0xc(r30)
/* 80380298 0037C0D8  90 1E 00 10 */	stw r0, 0x10(r30)
/* 8038029C 0037C0DC  80 1F 00 08 */	lwz r0, 8(r31)
/* 803802A0 0037C0E0  90 1E 00 14 */	stw r0, 0x14(r30)
/* 803802A4 0037C0E4  C0 02 D4 E0 */	lfs f0, $$260395-_SDA2_BASE_(r2)
...
/* 803802C8 0037C108  38 80 00 01 */	li r4, 1
...
/* 803802F4 0037C134  38 80 00 00 */	li r4, 0
...
/* 80380324 0037C164  38 80 00 00 */	li r4, 0
...
/* 80380348 0037C188  38 80 00 00 */	li r4, 0
...
/* 80380360 0037C1A0  38 61 00 08 */	addi r3, r1, 8
/* 80380364 0037C1A4  4B EE F3 51 */	bl pos__Q43scn4step5chara8LocationCFv
/* 80380368 0037C1A8  C0 01 00 08 */	lfs f0, 8(r1)
...
/* 803803B0 0037C1F0  4B DF 60 11 */	bl __rf__Q33hel6common25ScopedPtr$$0Q23app7AppImpl$$1CFv
/* 803803B4 0037C1F4  88 03 03 E8 */	lbz r0, 0x3e8(r3)
/* 803803B8 0037C1F8  2C 00 00 00 */	cmpwi r0, 0
...
/* 803803D0 0037C210  38 80 00 01 */	li r4, 1
...
/* 803803E8 0037C228  38 80 00 03 */	li r4, 3
/* 803803EC 0037C22C  38 A0 00 00 */	li r5, 0
/* 803803F0 0037C230  4B EF 7A 79 */	bl setIsEnable__Q43scn4step4core12PauseTriggerFQ53scn4step4core12PauseTrigger10EnableKindb
/* 803803F4 0037C234  38 00 00 00 */	li r0, 0
/* 803803F8 0037C238  90 1E 00 08 */	stw r0, 8(r30)
...
/* 80380428 0037C268  93 C1 00 08 */	stw r30, 8(r1)
/* 8038042C 0037C26C  7C 7E 1B 78 */	mr r30, r3
/* 80380430 0037C270  7C 9F 23 78 */	mr r31, r4
/* 80380434 0037C274  2C 03 00 00 */	cmpwi r3, 0
...
/* 80380444 0037C284  90 03 00 00 */	stw r0, 0(r3)
...
/* 80380450 0037C290  38 80 00 00 */	li r4, 0
...
/* 80380464 0037C2A4  38 80 00 01 */	li r4, 1
...
/* 80380488 0037C2C8  4B DF 5F 39 */	bl __rf__Q33hel6common25ScopedPtr$$0Q23app7AppImpl$$1CFv
/* 8038048C 0037C2CC  88 03 03 E8 */	lbz r0, 0x3e8(r3)
/* 80380490 0037C2D0  2C 00 00 00 */	cmpwi r0, 0
...
/* 803804A4 0037C2E4  4B DF 5F 1D */	bl __rf__Q33hel6common25ScopedPtr$$0Q23app7AppImpl$$1CFv
/* 803804A8 0037C2E8  38 63 03 5C */	addi r3, r3, 0x35c
/* 803804AC 0037C2EC  4B EE 9B 35 */	bl medalKind__Q43scn4step9challenge5ScoreCFv
/* 803804B0 0037C2F0  2C 03 00 03 */	cmpwi r3, 3
...
/* 803804C4 0037C304  4B DF 5E FD */	bl __rf__Q33hel6common25ScopedPtr$$0Q23app7AppImpl$$1CFv
/* 803804C8 0037C308  38 63 03 5C */	addi r3, r3, 0x35c
/* 803804CC 0037C30C  4B EE 9B 15 */	bl medalKind__Q43scn4step9challenge5ScoreCFv
/* 803804D0 0037C310  2C 03 00 04 */	cmpwi r3, 4
...
/* 80380530 0037C370  38 80 00 03 */	li r4, 3
/* 80380534 0037C374  38 A0 00 01 */	li r5, 1
...
/* 80380564 0037C3A4  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 80380588 0037C3C8  93 C1 00 08 */	stw r30, 8(r1)
/* 8038058C 0037C3CC  7C 7E 1B 78 */	mr r30, r3
/* 80380590 0037C3D0  80 03 00 08 */	lwz r0, 8(r3)
/* 80380594 0037C3D4  2C 00 00 00 */	cmpwi r0, 0
/* 80380598 0037C3D8  41 82 00 10 */	beq lbl_803805A8
/* 8038059C 0037C3DC  2C 00 00 01 */	cmpwi r0, 1
...
/* 803805B8 0037C3F8  2C 03 00 00 */	cmpwi r3, 0
...
/* 803805CC 0037C40C  4B DF 5D F5 */	bl __rf__Q33hel6common25ScopedPtr$$0Q23app7AppImpl$$1CFv
/* 803805D0 0037C410  88 03 03 E8 */	lbz r0, 0x3e8(r3)
/* 803805D4 0037C414  2C 00 00 00 */	cmpwi r0, 0
...
/* 80380600 0037C440  4B DF 5D C1 */	bl __rf__Q33hel6common25ScopedPtr$$0Q23app7AppImpl$$1CFv
/* 80380604 0037C444  38 63 03 5C */	addi r3, r3, 0x35c
/* 80380608 0037C448  4B EE 99 D9 */	bl medalKind__Q43scn4step9challenge5ScoreCFv
/* 8038060C 0037C44C  2C 03 00 04 */	cmpwi r3, 4
...
lbl_80380630:
/* 80380630 0037C470  38 00 00 01 */	li r0, 1
/* 80380634 0037C474  90 1E 00 08 */	stw r0, 8(r30)
...
/* 80380664 0037C4A4  48 00 00 D1 */	bl setNextState$$0Q53scn4step4hero6common9StateWait$$4PQ43scn4step4hero4Hero$$1__Q24util41StateChanger$$0Q43scn4step4hero6IState$$4256$$1FPQ43scn4step4hero4Hero_v
/* 80380668 0037C4A8  38 00 00 03 */	li r0, 3
/* 8038066C 0037C4AC  90 1E 00 08 */	stw r0, 8(r30)
...
/* 80380698 0037C4D8  4B DF 5D 29 */	bl __rf__Q33hel6common25ScopedPtr$$0Q23app7AppImpl$$1CFv
/* 8038069C 0037C4DC  38 63 03 5C */	addi r3, r3, 0x35c
/* 803806A0 0037C4E0  4B EE 99 41 */	bl medalKind__Q43scn4step9challenge5ScoreCFv
/* 803806A4 0037C4E4  2C 03 00 02 */	cmpwi r3, 2
...
/* 803806B8 0037C4F8  4B DF 5D 09 */	bl __rf__Q33hel6common25ScopedPtr$$0Q23app7AppImpl$$1CFv
/* 803806BC 0037C4FC  38 63 03 5C */	addi r3, r3, 0x35c
/* 803806C0 0037C500  4B EE 99 21 */	bl medalKind__Q43scn4step9challenge5ScoreCFv
/* 803806C4 0037C504  2C 03 00 01 */	cmpwi r3, 1
...
/* 80380700 0037C540  2C 03 00 00 */	cmpwi r3, 0
...
/* 80380720 0037C560  83 C1 00 08 */	lwz r30, 8(r1)
...
.global setNextState$$0Q53scn4step4hero6common9StateWait$$4PQ43scn4step4hero4Hero$$1__Q24util41StateChanger$$0Q43scn4step4hero6IState$$4256$$1FPQ43scn4step4hero4Hero_v
setNextState$$0Q53scn4step4hero6common9StateWait$$4PQ43scn4step4hero4Hero$$1__Q24util41StateChanger$$0Q43scn4step4hero6IState$$4256$$1FPQ43scn4step4hero4Hero_v:
...
/* 80380744 0037C584  93 C1 00 08 */	stw r30, 8(r1)
...
/* 80380758 0037C598  2C 04 00 00 */	cmpwi r4, 0
/* 8038075C 0037C59C  41 82 00 1C */	beq lbl_80380778
/* 80380760 0037C5A0  38 1E 00 90 */	addi r0, r30, 0x90
/* 80380764 0037C5A4  90 04 00 04 */	stw r0, 4(r4)
/* 80380768 0037C5A8  3C 60 80 48 */	lis r3, __vt__Q24util89StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4hero6common9StateWait$$4PQ43scn4step4hero4Hero$$1@ha
/* 8038076C 0037C5AC  38 03 3F F8 */	addi r0, r3, __vt__Q24util89StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4hero6common9StateWait$$4PQ43scn4step4hero4Hero$$1@l
/* 80380770 0037C5B0  90 04 00 00 */	stw r0, 0(r4)
/* 80380774 0037C5B4  93 E4 00 08 */	stw r31, 8(r4)
lbl_80380778:
/* 80380778 0037C5B8  90 9E 00 0C */	stw r4, 0xc(r30)
/* 8038077C 0037C5BC  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 80380780 0037C5C0  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 803807A4 0037C5E4  93 C1 00 08 */	stw r30, 8(r1)
...
/* 803807C4 0037C604  4B FF FF 71 */	bl setNextState$$0Q53scn4step4hero6common9StateWait$$4PQ43scn4step4hero4Hero$$1__Q24util41StateChanger$$0Q43scn4step4hero6IState$$4256$$1FPQ43scn4step4hero4Hero_v
/* 803807C8 0037C608  38 00 00 03 */	li r0, 3
/* 803807CC 0037C60C  90 1E 00 08 */	stw r0, 8(r30)
/* 803807D0 0037C610  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 803807D4 0037C614  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 803807FC 0037C63C  80 03 00 08 */	lwz r0, 8(r3)
/* 80380800 0037C640  2C 00 00 00 */	cmpwi r0, 0
...
__vt__Q53scn4step4hero7gimmick23StateLeaveChallengeDoor:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q53scn4step4hero7gimmick23StateLeaveChallengeDoorFv
	.byte4 procAnim__Q53scn4step4hero7gimmick23StateLeaveChallengeDoorFv
	.byte4 procMove__Q53scn4step4hero7gimmick23StateLeaveChallengeDoorFv
	.byte4 procConstraint__Q43scn4step4hero9StateBaseFv
	.byte4 procFixPos__Q53scn4step4hero7gimmick23StateLeaveChallengeDoorFv
