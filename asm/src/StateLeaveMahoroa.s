...
/* 80380E78 0037CCB8  90 1F 00 00 */	stw r0, 0(r31)
/* 80380E7C 0037CCBC  38 00 00 01 */	li r0, 1
/* 80380E80 0037CCC0  90 1F 00 08 */	stw r0, 8(r31)
...
/* 80380EAC 0037CCEC  38 80 00 01 */	li r4, 1
...
/* 80380EBC 0037CCFC  38 80 00 00 */	li r4, 0
...
/* 80380EDC 0037CD1C  38 80 00 00 */	li r4, 0
...
/* 80380F10 0037CD50  38 80 00 01 */	li r4, 1
...
/* 80380F24 0037CD64  38 80 00 01 */	li r4, 1
...
/* 80380F38 0037CD78  38 80 00 01 */	li r4, 1
...
/* 80380F4C 0037CD8C  38 80 00 01 */	li r4, 1
...
/* 80380F64 0037CDA4  2C 03 00 00 */	cmpwi r3, 0
...
/* 80380F7C 0037CDBC  38 80 00 00 */	li r4, 0
/* 80380F80 0037CDC0  38 A0 00 01 */	li r5, 1
...
/* 80380F94 0037CDD4  4B E2 5C 75 */	bl allocatorAlloc__Q34util17Delegate$$0Fv_v$$464$$112DelegateHeapFUll
...
/* 80380FC4 0037CE04  93 C1 00 08 */	stw r30, 8(r1)
/* 80380FC8 0037CE08  7C 7E 1B 78 */	mr r30, r3
/* 80380FCC 0037CE0C  7C 9F 23 78 */	mr r31, r4
/* 80380FD0 0037CE10  2C 03 00 00 */	cmpwi r3, 0
...
/* 80380FE0 0037CE20  90 03 00 00 */	stw r0, 0(r3)
...
/* 80381010 0037CE50  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 80381048 0037CE88  2C 03 00 00 */	cmpwi r3, 0
...
/* 80381060 0037CEA0  38 80 00 00 */	li r4, 0
/* 80381064 0037CEA4  38 A0 00 01 */	li r5, 1
/* 80381068 0037CEA8  C0 22 D4 F0 */	lfs f1, $$258967-_SDA2_BASE_(r2)
...
/* 80381080 0037CEC0  2C 03 00 00 */	cmpwi r3, 0
...
/* 803810A4 0037CEE4  4B FF F6 91 */	bl setNextState$$0Q53scn4step4hero6common9StateWait$$4PQ43scn4step4hero4Hero$$1__Q24util41StateChanger$$0Q43scn4step4hero6IState$$4256$$1FPQ43scn4step4hero4Hero_v
...
/* 803810BC 0037CEFC  38 61 00 08 */	addi r3, r1, 8
/* 803810C0 0037CF00  4B F0 A0 65 */	bl getNururiDir__Q43scn4step5enemy6NururiCFv
/* 803810C4 0037CF04  C0 21 00 08 */	lfs f1, 8(r1)
/* 803810C8 0037CF08  C0 02 D4 F0 */	lfs f0, $$258967-_SDA2_BASE_(r2)
...
lbl_803810D8:
/* 803810D8 0037CF18  C0 02 D4 F4 */	lfs f0, $$258968-_SDA2_BASE_(r2)
/* 803810DC 0037CF1C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 803810E0 0037CF20  40 81 00 64 */	ble lbl_80381144
/* 803810E4 0037CF24  C0 21 00 08 */	lfs f1, 8(r1)
/* 803810E8 0037CF28  C0 02 D4 F0 */	lfs f0, $$258967-_SDA2_BASE_(r2)
...
/* 80381100 0037CF40  38 80 00 01 */	li r4, 1
/* 80381104 0037CF44  4B E1 75 7D */	bl __ct__25mint_wrapNative_helper$$0b$$1Fb
...
/* 80381118 0037CF58  38 80 00 00 */	li r4, 0
/* 8038111C 0037CF5C  4B E1 75 65 */	bl __ct__25mint_wrapNative_helper$$0b$$1Fb
lbl_80381120:
...
/* 8038113C 0037CF7C  4B FF F5 F9 */	bl setNextState$$0Q53scn4step4hero6common9StateWait$$4PQ43scn4step4hero4Hero$$1__Q24util41StateChanger$$0Q43scn4step4hero6IState$$4256$$1FPQ43scn4step4hero4Hero_v
...
/* 80381150 0037CF90  80 03 00 04 */	lwz r0, 4(r3)
/* 80381154 0037CF94  2C 00 00 00 */	cmpwi r0, 0
...
/* 80381168 0037CFA8  80 03 00 08 */	lwz r0, 8(r3)
/* 8038116C 0037CFAC  2C 00 00 00 */	cmpwi r0, 0
...
/* 80381190 0037CFD0  4B FF F5 A5 */	bl setNextState$$0Q53scn4step4hero6common9StateWait$$4PQ43scn4step4hero4Hero$$1__Q24util41StateChanger$$0Q43scn4step4hero6IState$$4256$$1FPQ43scn4step4hero4Hero_v
...
/* 803811A4 0037CFE4  2C 03 00 00 */	cmpwi r3, 0
...
/* 803811B8 0037CFF8  2C 03 00 00 */	cmpwi r3, 0
...
/* 803811E8 0037D028  2C 03 00 00 */	cmpwi r3, 0
...
/* 803811FC 0037D03C  2C 03 00 00 */	cmpwi r3, 0
...
/* 80381210 0037D050  2C 03 00 00 */	cmpwi r3, 0
...
/* 80381224 0037D064  2C 03 00 00 */	cmpwi r3, 0
...
/* 80381238 0037D078  2C 03 00 00 */	cmpwi r3, 0
...
/* 8038124C 0037D08C  2C 03 00 00 */	cmpwi r3, 0
...
/* 80381260 0037D0A0  2C 03 00 00 */	cmpwi r3, 0
...
/* 80381274 0037D0B4  2C 03 00 00 */	cmpwi r3, 0
...
/* 80381288 0037D0C8  2C 03 00 00 */	cmpwi r3, 0
...
/* 8038129C 0037D0DC  2C 03 00 00 */	cmpwi r3, 0
...
/* 803812B0 0037D0F0  2C 03 00 00 */	cmpwi r3, 0
...
/* 803812C4 0037D104  2C 03 00 00 */	cmpwi r3, 0
lbl_803812C8:
...
/* 80381310 0037D150  38 80 00 01 */	li r4, 1
...
/* 80381330 0037D170  38 80 00 01 */	li r4, 1
...
__vt__Q53scn4step4hero7gimmick17StateLeaveMahoroa:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q53scn4step4hero7gimmick17StateLeaveMahoroaFv
	.byte4 procAnim__Q53scn4step4hero7gimmick17StateLeaveMahoroaFv
	.byte4 procMove__Q53scn4step4hero7gimmick17StateLeaveMahoroaFv
	.byte4 procConstraint__Q43scn4step4hero9StateBaseFv
	.byte4 procFixPos__Q53scn4step4hero7gimmick17StateLeaveMahoroaFv
