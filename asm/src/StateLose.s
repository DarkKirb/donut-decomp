...
/* 80240F5C 0023CD9C  4B DC 63 E9 */	bl func_80007344
...
/* 80240F70 0023CDB0  90 1D 00 00 */	stw r0, 0(r29)
...
/* 80240F94 0023CDD4  4B FE D7 B9 */	bl RuntimeTypeInfoImpl$$0Q53scn4step4boss15challengemaster6Custom$$1__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo
/* 80240F98 0023CDD8  7C 7F 1B 78 */	mr r31, r3
/* 80240F9C 0023CDDC  2C 1E 00 00 */	cmpwi r30, 0
/* 80240FA0 0023CDE0  41 82 00 48 */	beq lbl_80240FE8
/* 80240FA4 0023CDE4  7F C3 F3 78 */	mr r3, r30
/* 80240FA8 0023CDE8  81 83 00 00 */	lwz r12, 0(r3)
/* 80240FAC 0023CDEC  81 8C 00 08 */	lwz r12, 8(r12)
...
/* 80240FC4 0023CE04  38 00 00 01 */	li r0, 1
/* 80240FC8 0023CE08  48 00 00 14 */	b lbl_80240FDC
lbl_80240FCC:
/* 80240FCC 0023CE0C  80 63 00 00 */	lwz r3, 0(r3)
lbl_80240FD0:
/* 80240FD0 0023CE10  2C 03 00 00 */	cmpwi r3, 0
/* 80240FD4 0023CE14  40 82 FF E8 */	bne lbl_80240FBC
/* 80240FD8 0023CE18  38 00 00 00 */	li r0, 0
lbl_80240FDC:
/* 80240FDC 0023CE1C  2C 00 00 00 */	cmpwi r0, 0
/* 80240FE0 0023CE20  41 82 00 08 */	beq lbl_80240FE8
/* 80240FE4 0023CE24  48 00 00 08 */	b lbl_80240FEC
lbl_80240FE8:
/* 80240FE8 0023CE28  3B C0 00 00 */	li r30, 0
lbl_80240FEC:
...
/* 8024101C 0023CE5C  4B DC 63 75 */	bl func_80007390
...
__vt__Q53scn4step4boss15challengemaster9StateLose:
	.incbin "baserom.dol", 0x461F48, 0x20
