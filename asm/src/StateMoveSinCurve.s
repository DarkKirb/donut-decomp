...
/* 802B94A4 002B52E4  F3 E1 00 48 */	psq_st f31, 72(r1), 0, qr0
...
/* 802B94C4 002B5304  90 1E 00 00 */	stw r0, 0(r30)
...
/* 802B94D4 002B5314  38 61 00 08 */	addi r3, r1, 8
...
/* 802B9500 002B5340  C0 02 BA E0 */	lfs f0, $$255872-_SDA2_BASE_(r2)
/* 802B9504 002B5344  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 802B9508 002B5348  38 7E 00 08 */	addi r3, r30, 8
...
/* 802B9514 002B5354  C0 02 BA E0 */	lfs f0, $$255872-_SDA2_BASE_(r2)
...
/* 802B9538 002B5378  38 80 00 00 */	li r4, 0
...
/* 802B9594 002B53D4  C0 03 00 04 */	lfs f0, 4(r3)
/* 802B9598 002B53D8  EC 01 00 2A */	fadds f0, f1, f0
/* 802B959C 002B53DC  D0 1E 00 14 */	stfs f0, 0x14(r30)
/* 802B95A0 002B53E0  C0 22 BA E4 */	lfs f1, $$255895-_SDA2_BASE_(r2)
...
/* 802B95BC 002B53FC  4C 41 13 82 */	cror 2, 1, 2
/* 802B95C0 002B5400  41 82 FF E8 */	beq lbl_802B95A8
/* 802B95C4 002B5404  C0 02 BA E0 */	lfs f0, $$255872-_SDA2_BASE_(r2)
...
/* 802B95E0 002B5420  2C 03 00 02 */	cmpwi r3, 2
...
/* 802B95F4 002B5434  2C 03 00 03 */	cmpwi r3, 3
...
/* 802B9608 002B5448  C0 02 BA E0 */	lfs f0, $$255872-_SDA2_BASE_(r2)
/* 802B960C 002B544C  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 802B9610 002B5450  48 00 00 18 */	b lbl_802B9628
lbl_802B9614:
/* 802B9614 002B5454  C0 02 BA E0 */	lfs f0, $$255872-_SDA2_BASE_(r2)
...
/* 802B9658 002B5498  90 61 00 08 */	stw r3, 8(r1)
...
/* 802B9668 002B54A8  C0 21 00 08 */	lfs f1, 8(r1)
/* 802B966C 002B54AC  C0 1E 00 08 */	lfs f0, 8(r30)
/* 802B9670 002B54B0  EC 01 00 2A */	fadds f0, f1, f0
/* 802B9674 002B54B4  D0 01 00 08 */	stfs f0, 8(r1)
...
/* 802B969C 002B54DC  38 81 00 08 */	addi r4, r1, 8
...
/* 802B96E0 002B5520  F3 E1 00 C8 */	psq_st f31, 200(r1), 0, qr0
...
/* 802B971C 002B555C  2C 00 00 00 */	cmpwi r0, 0
...
/* 802B9730 002B5570  2C 03 00 02 */	cmpwi r3, 2
...
/* 802B9744 002B5584  2C 03 00 03 */	cmpwi r3, 3
/* 802B9748 002B5588  41 82 00 3C */	beq lbl_802B9784
/* 802B974C 002B558C  C0 22 BA E8 */	lfs f1, $$255921-_SDA2_BASE_(r2)
...
/* 802B97A0 002B55E0  2C 00 00 00 */	cmpwi r0, 0
...
/* 802B97B4 002B55F4  2C 03 00 02 */	cmpwi r3, 2
...
/* 802B97C8 002B5608  2C 03 00 03 */	cmpwi r3, 3
/* 802B97CC 002B560C  41 82 00 3C */	beq lbl_802B9808
/* 802B97D0 002B5610  C0 22 BA EC */	lfs f1, $$255922-_SDA2_BASE_(r2)
...
/* 802B9820 002B5660  38 60 00 00 */	li r3, 0
/* 802B9824 002B5664  88 01 00 2E */	lbz r0, 0x2e(r1)
/* 802B9828 002B5668  2C 00 00 00 */	cmpwi r0, 0
/* 802B982C 002B566C  40 82 00 10 */	bne lbl_802B983C
/* 802B9830 002B5670  88 01 00 2F */	lbz r0, 0x2f(r1)
/* 802B9834 002B5674  2C 00 00 00 */	cmpwi r0, 0
/* 802B9838 002B5678  41 82 00 08 */	beq lbl_802B9840
lbl_802B983C:
/* 802B983C 002B567C  38 60 00 01 */	li r3, 1
lbl_802B9840:
/* 802B9840 002B5680  2C 03 00 00 */	cmpwi r3, 0
...
/* 802B9854 002B5694  2C 03 00 02 */	cmpwi r3, 2
...
lbl_802B9898:
/* 802B9898 002B56D8  C0 02 BA E8 */	lfs f0, $$255921-_SDA2_BASE_(r2)
...
/* 802B98C0 002B5700  38 61 00 08 */	addi r3, r1, 8
/* 802B98C4 002B5704  4B FB 5D F1 */	bl pos__Q43scn4step5chara8LocationCFv
/* 802B98C8 002B5708  C0 01 00 08 */	lfs f0, 8(r1)
/* 802B98CC 002B570C  EC 00 F8 28 */	fsubs f0, f0, f31
/* 802B98D0 002B5710  D0 1E 00 08 */	stfs f0, 8(r30)
lbl_802B98D4:
...
__vt__Q53scn4step5enemy5gordo17StateMoveSinCurve:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q53scn4step5enemy5gordo17StateMoveSinCurveFv
	.byte4 procAnim__Q43scn4step5enemy9StateBaseFv
	.byte4 procMove__Q53scn4step5enemy5gordo17StateMoveSinCurveFv
	.byte4 procConstraint__Q43scn4step5enemy9StateBaseFv
	.byte4 procFixPos__Q53scn4step5enemy5gordo17StateMoveSinCurveFv
