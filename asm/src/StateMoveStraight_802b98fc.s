...
/* 802B9924 002B5764  90 1E 00 00 */	stw r0, 0x0(r30)
...
/* 802B9934 002B5774  38 7E 00 08 */	addi r3, r30, 0x8
...
/* 802B9950 002B5790  38 61 00 08 */	addi r3, r1, 0x8
/* 802B9954 002B5794  4B FB 5D 61 */	bl pos__Q43scn4step5chara8LocationCFv
/* 802B9958 002B5798  C0 01 00 08 */	lfs f0, 0x8(r1)
...
/* 802B997C 002B57BC  38 80 00 00 */	li r4, 0x0
...
/* 802B99DC 002B581C  38 61 00 08 */	addi r3, r1, 0x8
/* 802B99E0 002B5820  38 9F 00 08 */	addi r4, r31, 0x8
/* 802B99E4 002B5824  4B EC 2B 85 */	bl __ml__Q33hel4math7Vector3CFf
/* 802B99E8 002B5828  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 802B99EC 002B582C  C0 01 00 08 */	lfs f0, 0x8(r1)
...
/* 802B9A24 002B5864  2C 03 00 04 */	cmpwi r3, 0x4
...
/* 802B9A38 002B5878  2C 03 00 05 */	cmpwi r3, 0x5
...
/* 802B9A9C 002B58DC  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802B9AC0 002B5900  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802B9AE0 002B5920  38 60 00 00 */	li r3, 0x0
/* 802B9AE4 002B5924  88 01 00 16 */	lbz r0, 0x16(r1)
/* 802B9AE8 002B5928  2C 00 00 00 */	cmpwi r0, 0x0
/* 802B9AEC 002B592C  40 82 00 10 */	bne lbl_802B9AFC
/* 802B9AF0 002B5930  88 01 00 17 */	lbz r0, 0x17(r1)
/* 802B9AF4 002B5934  2C 00 00 00 */	cmpwi r0, 0x0
/* 802B9AF8 002B5938  41 82 00 08 */	beq lbl_802B9B00
.global lbl_802B9AFC
lbl_802B9AFC:
/* 802B9AFC 002B593C  38 60 00 01 */	li r3, 0x1
.global lbl_802B9B00
lbl_802B9B00:
/* 802B9B00 002B5940  2C 03 00 00 */	cmpwi r3, 0x0
/* 802B9B04 002B5944  41 82 00 2C */	beq lbl_802B9B30
.global lbl_802B9B08
lbl_802B9B08:
/* 802B9B08 002B5948  38 61 00 08 */	addi r3, r1, 0x8
/* 802B9B0C 002B594C  38 9F 00 08 */	addi r4, r31, 0x8
/* 802B9B10 002B5950  C0 22 BA F0 */	lfs f1, "@55765"@sda21(r2)
/* 802B9B14 002B5954  4B EC 2A 55 */	bl __ml__Q33hel4math7Vector3CFf
/* 802B9B18 002B5958  C0 01 00 08 */	lfs f0, 0x8(r1)
/* 802B9B1C 002B595C  D0 1F 00 08 */	stfs f0, 0x8(r31)
