...
/* 803942CC 0039010C  90 1F 00 00 */	stw r0, 0x0(r31)
/* 803942D0 00390110  38 00 00 00 */	li r0, 0x0
/* 803942D4 00390114  90 1F 00 08 */	stw r0, 0x8(r31)
...
/* 803942FC 0039013C  38 80 00 02 */	li r4, 0x2
...
/* 8039431C 0039015C  38 A0 00 00 */	li r5, 0x0
...
/* 8039432C 0039016C  38 80 00 00 */	li r4, 0x0
...
/* 80394340 00390180  38 80 00 01 */	li r4, 0x1
...
/* 80394354 00390194  38 80 00 01 */	li r4, 0x1
...
/* 80394384 003901C4  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80394388 003901C8  7C 7E 1B 78 */	mr r30, r3
/* 8039438C 003901CC  7C 9F 23 78 */	mr r31, r4
/* 80394390 003901D0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803943A0 003901E0  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 803943C0 00390200  38 80 00 01 */	li r4, 0x1
...
/* 803943D4 00390214  38 00 00 00 */	li r0, 0x0
/* 803943D8 00390218  98 03 00 08 */	stb r0, 0x8(r3)
.global lbl_803943DC
lbl_803943DC:
/* 803943DC 0039021C  7F C3 F3 78 */	mr r3, r30
/* 803943E0 00390220  38 80 00 00 */	li r4, 0x0
/* 803943E4 00390224  4B FC 11 39 */	bl __dt__Q43scn4step4hero9StateBaseFv
/* 803943E8 00390228  7F E0 07 34 */	extsh r0, r31
/* 803943EC 0039022C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80394404 00390244  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80394428 00390268  4B C7 2F 1D */	bl lbl_80007344
/* 8039442C 0039026C  7C 7D 1B 78 */	mr r29, r3
/* 80394430 00390270  80 83 00 08 */	lwz r4, 0x8(r3)
/* 80394434 00390274  38 04 00 01 */	addi r0, r4, 0x1
/* 80394438 00390278  90 03 00 08 */	stw r0, 0x8(r3)
/* 8039443C 0039027C  28 00 00 08 */	cmplwi r0, 0x8
...
/* 8039445C 0039029C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80394480 003902C0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80394494 003902D4  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803944C0 00390300  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803944D4 00390314  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803944E8 00390328  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803944FC 0039033C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80394510 00390350  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80394524 00390364  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8039453C 0039037C  38 80 00 08 */	li r4, 0x8
/* 80394540 00390380  4B FA C8 AD */	bl isTrigger__Q43scn4step4hero3HidCFUl
/* 80394544 00390384  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80394570 003903B0  2C 1D 00 00 */	cmpwi r29, 0x0
...
/* 80394580 003903C0  4B EA 22 E9 */	bl "__ct__Q24util28StateFactory<Q24util6IState>FPv"
/* 80394584 003903C4  3C 60 80 49 */	lis r3, "__vt__Q24util103StateFactoryArg1<Q24util6IState,Q53scn4step4hero7parasol21StateParasolParachute,PQ43scn4step4hero4Hero>"@ha
/* 80394588 003903C8  38 03 DC E0 */	addi r0, r3, "__vt__Q24util103StateFactoryArg1<Q24util6IState,Q53scn4step4hero7parasol21StateParasolParachute,PQ43scn4step4hero4Hero>"@l
/* 8039458C 003903CC  90 1D 00 00 */	stw r0, 0x0(r29)
/* 80394590 003903D0  93 FD 00 08 */	stw r31, 0x8(r29)
.global lbl_80394594
lbl_80394594:
...
/* 803945AC 003903EC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803945C4 00390404  38 80 00 02 */	li r4, 0x2
...
/* 803945E4 00390424  38 03 00 01 */	addi r0, r3, 0x1
...
/* 80394600 00390440  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8039462C 0039046C  2C 1D 00 00 */	cmpwi r29, 0x0
...
/* 8039463C 0039047C  4B EA 22 2D */	bl "__ct__Q24util28StateFactory<Q24util6IState>FPv"
/* 80394640 00390480  3C 60 80 49 */	lis r3, "__vt__Q24util94StateFactoryArg1<Q24util6IState,Q53scn4step4hero6common13StatePlancher,PQ43scn4step4hero4Hero>"@ha
/* 80394644 00390484  38 03 BC 20 */	addi r0, r3, "__vt__Q24util94StateFactoryArg1<Q24util6IState,Q53scn4step4hero6common13StatePlancher,PQ43scn4step4hero4Hero>"@l
/* 80394648 00390488  90 1D 00 00 */	stw r0, 0x0(r29)
/* 8039464C 0039048C  93 DD 00 08 */	stw r30, 0x8(r29)
.global lbl_80394650
lbl_80394650:
...
/* 8039468C 003904CC  38 80 00 01 */	li r4, 0x1
...
/* 803946E0 00390520  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803946F0 00390530  38 80 00 03 */	li r4, 0x3
...
/* 803946F8 00390538  2C 03 00 00 */	cmpwi r3, 0x0
.global lbl_803946FC
lbl_803946FC:
