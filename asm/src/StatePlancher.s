...
/* 80367398 003631D8  2C 03 00 00 */	cmpwi r3, 0
/* 8036739C 003631DC  41 82 00 0C */	beq lbl_803673A8
/* 803673A0 003631E0  38 60 00 00 */	li r3, 0
...
/* 803673B0 003631F0  38 80 00 00 */	li r4, 0
/* 803673B4 003631F4  88 03 00 1E */	lbz r0, 0x1e(r3)
/* 803673B8 003631F8  2C 00 00 00 */	cmpwi r0, 0
/* 803673BC 003631FC  40 82 00 10 */	bne lbl_803673CC
/* 803673C0 00363200  88 03 00 1F */	lbz r0, 0x1f(r3)
/* 803673C4 00363204  2C 00 00 00 */	cmpwi r0, 0
/* 803673C8 00363208  41 82 00 08 */	beq lbl_803673D0
lbl_803673CC:
/* 803673CC 0036320C  38 80 00 01 */	li r4, 1
lbl_803673D0:
/* 803673D0 00363210  2C 04 00 00 */	cmpwi r4, 0
/* 803673D4 00363214  41 82 00 0C */	beq lbl_803673E0
/* 803673D8 00363218  38 60 00 00 */	li r3, 0
...
/* 803673E8 00363228  80 03 00 08 */	lwz r0, 8(r3)
...
/* 80367428 00363268  90 1F 00 00 */	stw r0, 0(r31)
/* 8036742C 0036326C  C0 02 D1 00 */	lfs f0, $$257709-_SDA2_BASE_(r2)
/* 80367430 00363270  D0 1F 00 08 */	stfs f0, 8(r31)
/* 80367434 00363274  7F E3 FB 78 */	mr r3, r31
/* 80367438 00363278  38 80 00 01 */	li r4, 1
...
/* 80367468 003632A8  93 C1 00 08 */	stw r30, 8(r1)
...
/* 80367490 003632D0  2C 03 00 00 */	cmpwi r3, 0
...
/* 803674A4 003632E4  38 80 00 01 */	li r4, 1
...
/* 803674B8 003632F8  38 80 00 01 */	li r4, 1
/* 803674BC 003632FC  4B F8 3A A5 */	bl setWarp__Q53scn4step5enemy9tsukikage6CustomFb
/* 803674C0 00363300  2C 1F 00 00 */	cmpwi r31, 0
...
/* 80367508 00363348  38 80 00 01 */	li r4, 1
...
/* 8036751C 0036335C  38 80 00 01 */	li r4, 1
...
/* 80367530 00363370  38 80 00 01 */	li r4, 1
...
/* 80367550 00363390  38 80 00 01 */	li r4, 1
...
/* 8036755C 0036339C  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 80367580 003633C0  93 C1 00 08 */	stw r30, 8(r1)
/* 80367584 003633C4  7C 7E 1B 78 */	mr r30, r3
/* 80367588 003633C8  7C 9F 23 78 */	mr r31, r4
/* 8036758C 003633CC  2C 03 00 00 */	cmpwi r3, 0
...
/* 8036759C 003633DC  90 03 00 00 */	stw r0, 0(r3)
...
/* 803675A8 003633E8  38 80 00 00 */	li r4, 0
...
/* 803675EC 0036342C  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 80367610 00363450  F3 E1 00 38 */	psq_st f31, 56(r1), 0, qr0
...
/* 80367644 00363484  38 61 00 08 */	addi r3, r1, 8
...
/* 8036765C 0036349C  C0 1F 00 08 */	lfs f0, 8(r31)
/* 80367660 003634A0  EC 00 08 2A */	fadds f0, f0, f1
/* 80367664 003634A4  D0 1F 00 08 */	stfs f0, 8(r31)
/* 80367668 003634A8  48 00 00 0C */	b lbl_80367674
lbl_8036766C:
/* 8036766C 003634AC  C0 02 D1 00 */	lfs f0, $$257709-_SDA2_BASE_(r2)
/* 80367670 003634B0  D0 1F 00 08 */	stfs f0, 8(r31)
lbl_80367674:
...
/* 80367690 003634D0  2C 03 00 00 */	cmpwi r3, 0
...
/* 803676BC 003634FC  2C 03 00 00 */	cmpwi r3, 0
...
/* 803676D4 00363514  2C 03 00 00 */	cmpwi r3, 0
...
/* 803676E8 00363528  2C 03 00 00 */	cmpwi r3, 0
...
/* 803676FC 0036353C  2C 03 00 00 */	cmpwi r3, 0
...
/* 80367710 00363550  2C 03 00 00 */	cmpwi r3, 0
...
/* 80367724 00363564  2C 03 00 00 */	cmpwi r3, 0
lbl_80367728:
...
/* 80367770 003635B0  C0 1F 00 08 */	lfs f0, 8(r31)
/* 80367774 003635B4  FC 00 08 40 */	fcmpo cr0, f0, f1
/* 80367778 003635B8  4C 41 13 82 */	cror 2, 1, 2
...
/* 8036778C 003635CC  2C 03 00 00 */	cmpwi r3, 0
...
/* 803677AC 003635EC  2C 03 00 00 */	cmpwi r3, 0
...
/* 803677BC 003635FC  38 80 00 03 */	li r4, 3
...
/* 803677C4 00363604  2C 03 00 00 */	cmpwi r3, 0
lbl_803677C8:
...
/* 803677EC 0036362C  93 C1 00 08 */	stw r30, 8(r1)
...
/* 803677FC 0036363C  38 63 00 08 */	addi r3, r3, 8
/* 80367800 00363640  4B F0 A9 09 */	bl isAttackCollide__Q43scn4step5chara7ObjCollCFv
/* 80367804 00363644  2C 03 00 00 */	cmpwi r3, 0
...
/* 80367830 00363670  2C 04 00 00 */	cmpwi r4, 0
/* 80367834 00363674  41 82 00 28 */	beq lbl_8036785C
/* 80367838 00363678  3C 60 80 46 */	lis r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@ha
/* 8036783C 0036367C  38 03 44 78 */	addi r0, r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@l
/* 80367840 00363680  90 04 00 00 */	stw r0, 0(r4)
/* 80367844 00363684  38 1F 00 90 */	addi r0, r31, 0x90
/* 80367848 00363688  90 04 00 04 */	stw r0, 4(r4)
/* 8036784C 0036368C  3C 60 80 49 */	lis r3, __vt__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4hero6common16StatePlancherHit$$4PQ43scn4step4hero4Hero$$1@ha
/* 80367850 00363690  38 03 BE A8 */	addi r0, r3, __vt__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4hero6common16StatePlancherHit$$4PQ43scn4step4hero4Hero$$1@l
/* 80367854 00363694  90 04 00 00 */	stw r0, 0(r4)
/* 80367858 00363698  93 C4 00 08 */	stw r30, 8(r4)
lbl_8036785C:
/* 8036785C 0036369C  90 9F 00 0C */	stw r4, 0xc(r31)
/* 80367860 003636A0  38 60 00 01 */	li r3, 1
/* 80367864 003636A4  48 00 00 08 */	b lbl_8036786C
lbl_80367868:
/* 80367868 003636A8  38 60 00 00 */	li r3, 0
lbl_8036786C:
/* 8036786C 003636AC  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 80367870 003636B0  83 C1 00 08 */	lwz r30, 8(r1)
...
.global create__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4hero6common16StatePlancherHit$$4PQ43scn4step4hero4Hero$$1Fv
create__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4hero6common16StatePlancherHit$$4PQ43scn4step4hero4Hero$$1Fv:
/* 80367884 003636C4  7C 64 1B 78 */	mr r4, r3
/* 80367888 003636C8  80 63 00 04 */	lwz r3, 4(r3)
/* 8036788C 003636CC  2C 03 00 00 */	cmpwi r3, 0
/* 80367890 003636D0  4D 82 00 20 */	beqlr 
/* 80367894 003636D4  80 84 00 08 */	lwz r4, 8(r4)
...
.global __dt__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4hero6common16StatePlancherHit$$4PQ43scn4step4hero4Hero$$1Fv
__dt__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4hero6common16StatePlancherHit$$4PQ43scn4step4hero4Hero$$1Fv:
/* 803678A0 003636E0  4B EC 6E 00 */	b __dt__Q24util89StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4boss6common9StateWait$$4PQ43scn4step4boss4Boss$$1Fv
...
__vt__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4hero6common16StatePlancherHit$$4PQ43scn4step4hero4Hero$$1:
	.4byte 0
	.4byte 0
	.4byte __dt__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4hero6common16StatePlancherHit$$4PQ43scn4step4hero4Hero$$1Fv
	.4byte create__Q24util97StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4hero6common16StatePlancherHit$$4PQ43scn4step4hero4Hero$$1Fv
.global __vt__Q53scn4step4hero6common13StatePlancher
__vt__Q53scn4step4hero6common13StatePlancher:
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step4hero6common13StatePlancherFv
	.4byte procAnim__Q53scn4step4hero6common13StatePlancherFv
	.4byte procMove__Q53scn4step4hero6common13StatePlancherFv
	.4byte procConstraint__Q43scn4step4hero9StateBaseFv
	.4byte procFixPos__Q53scn4step4hero6common13StatePlancherFv
	.4byte procObjCollReact__Q53scn4step4hero6common13StatePlancherFv
