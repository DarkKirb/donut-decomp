...
/* 803C8100 003C3F40  90 1E 00 00 */	stw r0, 0(r30)
/* 803C8104 003C3F44  38 61 00 08 */	addi r3, r1, 8
...
/* 803C8114 003C3F54  38 81 00 08 */	addi r4, r1, 8
/* 803C8118 003C3F58  4B DD 73 45 */	bl toVector3__Q33hel4math7Vector2CFv
/* 803C811C 003C3F5C  38 7E 00 08 */	addi r3, r30, 8
...
/* 803C8128 003C3F68  C0 02 DB 40 */	lfs f0, $$255473-_SDA2_BASE_(r2)
...
/* 803C8154 003C3F94  38 00 00 01 */	li r0, 1
...
/* 803C8164 003C3FA4  38 00 00 00 */	li r0, 0
...
/* 803C8188 003C3FC8  38 80 00 01 */	li r4, 1
...
/* 803C8198 003C3FD8  38 80 00 00 */	li r4, 0
...
/* 803C81AC 003C3FEC  38 80 00 00 */	li r4, 0
...
/* 803C81EC 003C402C  93 C1 00 08 */	stw r30, 8(r1)
/* 803C81F0 003C4030  7C 7E 1B 78 */	mr r30, r3
/* 803C81F4 003C4034  7C 9F 23 78 */	mr r31, r4
/* 803C81F8 003C4038  2C 03 00 00 */	cmpwi r3, 0
...
/* 803C8208 003C4048  90 03 00 00 */	stw r0, 0(r3)
...
/* 803C8244 003C4084  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 803C8274 003C40B4  2C 03 00 00 */	cmpwi r3, 0
...
/* 803C828C 003C40CC  2C 03 00 00 */	cmpwi r3, 0
...
/* 803C82C8 003C4108  2C 00 00 00 */	cmpwi r0, 0
/* 803C82CC 003C410C  41 82 00 38 */	beq lbl_803C8304
/* 803C82D0 003C4110  38 00 00 00 */	li r0, 0
...
/* 803C82E4 003C4124  38 61 00 08 */	addi r3, r1, 8
/* 803C82E8 003C4128  4B DB 42 E1 */	bl __ct__Q33hel4math7Vector3FRCQ33hel4math7Vector3
/* 803C82EC 003C412C  C0 01 00 08 */	lfs f0, 8(r1)
...
/* 803C8308 003C4148  2C 00 00 00 */	cmpwi r0, 0
/* 803C830C 003C414C  41 82 00 18 */	beq lbl_803C8324
/* 803C8310 003C4150  2C 00 00 01 */	cmpwi r0, 1
/* 803C8314 003C4154  41 82 00 1C */	beq lbl_803C8330
/* 803C8318 003C4158  2C 00 00 02 */	cmpwi r0, 2
...
/* 803C83CC 003C420C  90 61 00 08 */	stw r3, 8(r1)
/* 803C83D0 003C4210  38 61 00 08 */	addi r3, r1, 8
/* 803C83D4 003C4214  48 00 15 C5 */	bl isEnableSFXMonotone__Q43scn4step3map12DataAccessorCFv
/* 803C83D8 003C4218  2C 03 00 00 */	cmpwi r3, 0
...
/* 803C83EC 003C422C  2C 03 00 00 */	cmpwi r3, 0
...
lbl_803C8428:
/* 803C8428 003C4268  38 00 00 01 */	li r0, 1
...
/* 803C846C 003C42AC  2C 03 00 00 */	cmpwi r3, 0
...
/* 803C8490 003C42D0  38 00 00 02 */	li r0, 2
...
/* 803C84BC 003C42FC  F3 E1 00 58 */	psq_st f31, 88(r1), 0, qr0
/* 803C84C0 003C4300  DB C1 00 40 */	stfd f30, 0x40(r1)
/* 803C84C4 003C4304  F3 C1 00 48 */	psq_st f30, 72(r1), 0, qr0
...
/* 803C84E8 003C4328  C0 02 DB 44 */	lfs f0, $$255524-_SDA2_BASE_(r2)
...
/* 803C8524 003C4364  C0 02 DB 50 */	lfs f0, $$255527-_SDA2_BASE_(r2)
...
/* 803C8538 003C4378  90 61 00 08 */	stw r3, 8(r1)
...
/* 803C857C 003C43BC  38 81 00 08 */	addi r4, r1, 8
...
/* 803C85AC 003C43EC  2C 03 00 00 */	cmpwi r3, 0
...
/* 803C85D8 003C4418  2C 04 00 00 */	cmpwi r4, 0
/* 803C85DC 003C441C  41 82 00 28 */	beq lbl_803C8604
/* 803C85E0 003C4420  3C 60 80 46 */	lis r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@ha
/* 803C85E4 003C4424  38 03 44 78 */	addi r0, r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@l
/* 803C85E8 003C4428  90 04 00 00 */	stw r0, 0(r4)
/* 803C85EC 003C442C  38 1F 00 90 */	addi r0, r31, 0x90
/* 803C85F0 003C4430  90 04 00 04 */	stw r0, 4(r4)
/* 803C85F4 003C4434  3C 60 80 49 */	lis r3, __vt__Q24util88StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4item5state9StateWaft$$4PQ43scn4step4item4Item$$1@ha
/* 803C85F8 003C4438  38 03 25 F0 */	addi r0, r3, __vt__Q24util88StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4item5state9StateWaft$$4PQ43scn4step4item4Item$$1@l
/* 803C85FC 003C443C  90 04 00 00 */	stw r0, 0(r4)
/* 803C8600 003C4440  93 C4 00 08 */	stw r30, 8(r4)
lbl_803C8604:
...
.global create__Q24util88StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4item5state9StateWaft$$4PQ43scn4step4item4Item$$1Fv
create__Q24util88StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4item5state9StateWaft$$4PQ43scn4step4item4Item$$1Fv:
/* 803C8638 003C4478  7C 64 1B 78 */	mr r4, r3
/* 803C863C 003C447C  80 63 00 04 */	lwz r3, 4(r3)
/* 803C8640 003C4480  2C 03 00 00 */	cmpwi r3, 0
/* 803C8644 003C4484  4D 82 00 20 */	beqlr 
/* 803C8648 003C4488  80 84 00 08 */	lwz r4, 8(r4)
...
.global __dt__Q24util88StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4item5state9StateWaft$$4PQ43scn4step4item4Item$$1Fv
__dt__Q24util88StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4item5state9StateWaft$$4PQ43scn4step4item4Item$$1Fv:
/* 803C8654 003C4494  4B E6 60 4C */	b __dt__Q24util89StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4boss6common9StateWait$$4PQ43scn4step4boss4Boss$$1Fv

.section .data, "wa"  # 0x80421040 - 0x80496700
.global __vt__Q24util88StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4item5state9StateWaft$$4PQ43scn4step4item4Item$$1
__vt__Q24util88StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4item5state9StateWaft$$4PQ43scn4step4item4Item$$1:
	.4byte 0
	.4byte 0
	.4byte __dt__Q24util88StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4item5state9StateWaft$$4PQ43scn4step4item4Item$$1Fv
	.4byte create__Q24util88StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4item5state9StateWaft$$4PQ43scn4step4item4Item$$1Fv
