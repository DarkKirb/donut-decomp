...
/* 802387FC 0023463C  4B DC EB 49 */	bl func_80007344
...
/* 80238814 00234654  90 1D 00 00 */	stw r0, 0(r29)
/* 80238818 00234658  38 00 00 00 */	li r0, 0
/* 8023881C 0023465C  90 1D 00 08 */	stw r0, 8(r29)
...
/* 80238890 002346D0  88 1E 00 00 */	lbz r0, 0(r30)
/* 80238894 002346D4  2C 00 00 00 */	cmpwi r0, 0
/* 80238898 002346D8  41 82 00 14 */	beq lbl_802388AC
/* 8023889C 002346DC  38 60 00 01 */	li r3, 1
...
/* 802388B4 002346F4  4B DC EA DD */	bl func_80007390
...
/* 802388D8 00234718  93 C1 00 08 */	stw r30, 8(r1)
/* 802388DC 0023471C  7C 7E 1B 78 */	mr r30, r3
/* 802388E0 00234720  7C 9F 23 78 */	mr r31, r4
/* 802388E4 00234724  2C 03 00 00 */	cmpwi r3, 0
...
/* 802388F4 00234734  90 03 00 00 */	stw r0, 0(r3)
...
/* 80238934 00234774  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 80238958 00234798  93 C1 00 08 */	stw r30, 8(r1)
...
/* 80238970 002347B0  80 9F 00 08 */	lwz r4, 8(r31)
/* 80238974 002347B4  7C 04 30 40 */	cmplw r4, r6
/* 80238978 002347B8  40 80 00 10 */	bge lbl_80238988
/* 8023897C 002347BC  38 04 00 01 */	addi r0, r4, 1
/* 80238980 002347C0  90 1F 00 08 */	stw r0, 8(r31)
...
/* 802389B0 002347F0  38 03 00 01 */	addi r0, r3, 1
...
/* 802389C4 00234804  38 03 00 01 */	addi r0, r3, 1
...
/* 802389DC 0023481C  38 03 00 01 */	addi r0, r3, 1
...
/* 80238A0C 0023484C  2C 04 00 00 */	cmpwi r4, 0
/* 80238A10 00234850  41 82 00 28 */	beq lbl_80238A38
/* 80238A14 00234854  3C 60 80 46 */	lis r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@ha
/* 80238A18 00234858  38 03 44 78 */	addi r0, r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@l
/* 80238A1C 0023485C  90 04 00 00 */	stw r0, 0(r4)
/* 80238A20 00234860  38 1F 00 90 */	addi r0, r31, 0x90
/* 80238A24 00234864  90 04 00 04 */	stw r0, 4(r4)
/* 80238A28 00234868  3C 60 80 46 */	lis r3, __vt__Q24util89StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4boss6common9StateFall$$4PQ43scn4step4boss4Boss$$1@ha
/* 80238A2C 0023486C  38 03 52 20 */	addi r0, r3, __vt__Q24util89StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4boss6common9StateFall$$4PQ43scn4step4boss4Boss$$1@l
/* 80238A30 00234870  90 04 00 00 */	stw r0, 0(r4)
/* 80238A34 00234874  93 C4 00 08 */	stw r30, 8(r4)
lbl_80238A38:
/* 80238A38 00234878  90 9F 00 0C */	stw r4, 0xc(r31)
lbl_80238A3C:
/* 80238A3C 0023487C  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 80238A40 00234880  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 80238A6C 002348AC  4B DC E8 D5 */	bl func_80007340
...
/* 80238A94 002348D4  4B FF 5C 69 */	bl RuntimeTypeInfoImpl$$0Q53scn4step4boss7bonkers6Custom$$1__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo
/* 80238A98 002348D8  7C 7E 1B 78 */	mr r30, r3
/* 80238A9C 002348DC  2C 1D 00 00 */	cmpwi r29, 0
/* 80238AA0 002348E0  41 82 00 48 */	beq lbl_80238AE8
/* 80238AA4 002348E4  7F A3 EB 78 */	mr r3, r29
/* 80238AA8 002348E8  81 83 00 00 */	lwz r12, 0(r3)
/* 80238AAC 002348EC  81 8C 00 08 */	lwz r12, 8(r12)
...
/* 80238AC4 00234904  38 00 00 01 */	li r0, 1
/* 80238AC8 00234908  48 00 00 14 */	b lbl_80238ADC
lbl_80238ACC:
/* 80238ACC 0023490C  80 63 00 00 */	lwz r3, 0(r3)
lbl_80238AD0:
/* 80238AD0 00234910  2C 03 00 00 */	cmpwi r3, 0
/* 80238AD4 00234914  40 82 FF E8 */	bne lbl_80238ABC
/* 80238AD8 00234918  38 00 00 00 */	li r0, 0
lbl_80238ADC:
/* 80238ADC 0023491C  2C 00 00 00 */	cmpwi r0, 0
/* 80238AE0 00234920  41 82 00 08 */	beq lbl_80238AE8
/* 80238AE4 00234924  48 00 00 08 */	b lbl_80238AEC
lbl_80238AE8:
/* 80238AE8 00234928  3B A0 00 00 */	li r29, 0
lbl_80238AEC:
...
/* 80238B28 00234968  C0 22 A4 A8 */	lfs f1, $$256362-_SDA2_BASE_(r2)
...
/* 80238B3C 0023497C  2C 03 00 05 */	cmpwi r3, 5
/* 80238B40 00234980  40 80 00 0C */	bge lbl_80238B4C
/* 80238B44 00234984  C0 22 A4 AC */	lfs f1, $$256363-_SDA2_BASE_(r2)
/* 80238B48 00234988  48 00 00 08 */	b lbl_80238B50
lbl_80238B4C:
/* 80238B4C 0023498C  C0 22 A4 B0 */	lfs f1, $$256364-_SDA2_BASE_(r2)
lbl_80238B50:
/* 80238B50 00234990  80 1C 00 14 */	lwz r0, 0x14(r28)
/* 80238B54 00234994  28 00 00 01 */	cmplwi r0, 1
/* 80238B58 00234998  41 82 00 18 */	beq lbl_80238B70
/* 80238B5C 0023499C  28 00 00 02 */	cmplwi r0, 2
/* 80238B60 002349A0  41 82 00 34 */	beq lbl_80238B94
/* 80238B64 002349A4  28 00 00 03 */	cmplwi r0, 3
...
/* 80238BCC 00234A0C  3B C0 00 00 */	li r30, 0
/* 80238BD0 00234A10  40 82 00 08 */	bne lbl_80238BD8
/* 80238BD4 00234A14  3B C0 00 02 */	li r30, 2
lbl_80238BD8:
/* 80238BD8 00234A18  38 61 00 08 */	addi r3, r1, 8
...
/* 80238C0C 00234A4C  4B DC E7 81 */	bl func_8000738C
...
.global create__Q24util89StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4boss6common9StateFall$$4PQ43scn4step4boss4Boss$$1Fv
create__Q24util89StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4boss6common9StateFall$$4PQ43scn4step4boss4Boss$$1Fv:
/* 80238C20 00234A60  7C 64 1B 78 */	mr r4, r3
/* 80238C24 00234A64  80 63 00 04 */	lwz r3, 4(r3)
/* 80238C28 00234A68  2C 03 00 00 */	cmpwi r3, 0
/* 80238C2C 00234A6C  4D 82 00 20 */	beqlr 
/* 80238C30 00234A70  80 84 00 08 */	lwz r4, 8(r4)
...
.global __dt__Q24util89StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4boss6common9StateFall$$4PQ43scn4step4boss4Boss$$1Fv
...
__vt__Q24util89StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4boss6common9StateFall$$4PQ43scn4step4boss4Boss$$1:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q24util89StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4boss6common9StateFall$$4PQ43scn4step4boss4Boss$$1Fv
	.byte4 create__Q24util89StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4boss6common9StateFall$$4PQ43scn4step4boss4Boss$$1Fv
.global __vt__Q53scn4step4boss7bonkers13StateRainBomb
__vt__Q53scn4step4boss7bonkers13StateRainBomb:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q53scn4step4boss7bonkers13StateRainBombFv
	.byte4 procAnim__Q53scn4step4boss7bonkers13StateRainBombFv
	.byte4 procMove__Q53scn4step4boss7bonkers13StateRainBombFv
	.byte4 procConstraint__Q43scn4step4boss9StateBaseFv
	.byte4 procFixPos__Q53scn4step4boss7bonkers13StateRainBombFv
