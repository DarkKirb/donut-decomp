...
/* 803C8668 003C44A8  4B C3 EC DD */	bl func_80007344
...
/* 803C8680 003C44C0  90 1D 00 00 */	stw r0, 0(r29)
/* 803C8684 003C44C4  38 00 00 00 */	li r0, 0
/* 803C8688 003C44C8  90 1D 00 08 */	stw r0, 8(r29)
/* 803C868C 003C44CC  C0 02 DB 58 */	lfs f0, $$255795-_SDA2_BASE_(r2)
...
/* 803C86B4 003C44F4  38 80 00 01 */	li r4, 1
...
/* 803C86C8 003C4508  38 80 00 00 */	li r4, 0
...
/* 803C86DC 003C451C  38 80 00 00 */	li r4, 0
...
/* 803C8708 003C4548  38 61 00 08 */	addi r3, r1, 8
...
/* 803C8734 003C4574  4B C3 EC 5D */	bl func_80007390
...
/* 803C8760 003C45A0  F3 E1 00 58 */	psq_st f31, 88(r1), 0, qr0
...
/* 803C8780 003C45C0  80 1E 00 08 */	lwz r0, 8(r30)
/* 803C8784 003C45C4  7C 00 18 40 */	cmplw r0, r3
/* 803C8788 003C45C8  41 81 00 90 */	bgt lbl_803C8818
/* 803C878C 003C45CC  C8 42 DB 70 */	lfd f2, $$255836-_SDA2_BASE_(r2)
...
/* 803C87B8 003C45F8  C0 02 DB 64 */	lfs f0, $$255832-_SDA2_BASE_(r2)
/* 803C87BC 003C45FC  EC 20 00 72 */	fmuls f1, f0, f1
/* 803C87C0 003C4600  C0 02 DB 60 */	lfs f0, $$255831-_SDA2_BASE_(r2)
/* 803C87C4 003C4604  EC 20 00 72 */	fmuls f1, f0, f1
/* 803C87C8 003C4608  C0 02 DB 5C */	lfs f0, $$255830-_SDA2_BASE_(r2)
...
/* 803C8820 003C4660  80 64 00 00 */	lwz r3, 0(r4)
/* 803C8824 003C4664  80 04 00 04 */	lwz r0, 4(r4)
/* 803C8828 003C4668  90 61 00 08 */	stw r3, 8(r1)
/* 803C882C 003C466C  90 01 00 0C */	stw r0, 0xc(r1)
/* 803C8830 003C4670  80 04 00 08 */	lwz r0, 8(r4)
/* 803C8834 003C4674  90 01 00 10 */	stw r0, 0x10(r1)
/* 803C8838 003C4678  C0 01 00 08 */	lfs f0, 8(r1)
/* 803C883C 003C467C  C0 22 DB 68 */	lfs f1, $$255833-_SDA2_BASE_(r2)
/* 803C8840 003C4680  EC 00 00 72 */	fmuls f0, f0, f1
/* 803C8844 003C4684  D0 01 00 08 */	stfs f0, 8(r1)
...
/* 803C8860 003C46A0  80 61 00 08 */	lwz r3, 8(r1)
