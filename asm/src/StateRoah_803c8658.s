...
/* 803C8674 003C44B4  4B FF CB 75 */	bl lbl_803C51E8
/* 803C8678 003C44B8  3C 60 80 49 */	lis r3, lbl_80492618@ha
/* 803C867C 003C44BC  38 03 26 18 */	addi r0, r3, lbl_80492618@l
...
/* 803C868C 003C44CC  C0 02 DB 58 */	lfs f0, lbl_80563AD8@sda21(r2)
...
/* 803C869C 003C44DC  4B D3 81 45 */	bl lbl_801007E0
/* 803C86A0 003C44E0  4B FF A6 09 */	bl lbl_803C2CA8
/* 803C86A4 003C44E4  7C 7F 1B 78 */	mr r31, r3
/* 803C86A8 003C44E8  7F A3 EB 78 */	mr r3, r29
/* 803C86AC 003C44EC  4B D3 81 35 */	bl lbl_801007E0
/* 803C86B0 003C44F0  4B FF A6 99 */	bl lbl_803C2D48
/* 803C86B4 003C44F4  38 80 00 01 */	li r4, 0x1
/* 803C86B8 003C44F8  4B D6 19 39 */	bl lbl_80129FF0
/* 803C86BC 003C44FC  7F A3 EB 78 */	mr r3, r29
/* 803C86C0 003C4500  4B D3 81 21 */	bl lbl_801007E0
/* 803C86C4 003C4504  4B FF A6 25 */	bl lbl_803C2CE8
/* 803C86C8 003C4508  38 80 00 00 */	li r4, 0x0
/* 803C86CC 003C450C  4B EA 8B B1 */	bl lbl_8027127C
/* 803C86D0 003C4510  7F A3 EB 78 */	mr r3, r29
/* 803C86D4 003C4514  4B D3 81 0D */	bl lbl_801007E0
/* 803C86D8 003C4518  4B FF A6 49 */	bl lbl_803C2D20
/* 803C86DC 003C451C  38 80 00 00 */	li r4, 0x0
/* 803C86E0 003C4520  4B FF C3 E5 */	bl lbl_803C4AC4
/* 803C86E4 003C4524  38 61 00 10 */	addi r3, r1, 0x10
/* 803C86E8 003C4528  7F C4 F3 78 */	mr r4, r30
/* 803C86EC 003C452C  4B E9 B4 49 */	bl lbl_80263B34
...
/* 803C86FC 003C453C  4B CA D0 35 */	bl lbl_80075730
/* 803C8700 003C4540  4B E5 84 89 */	bl lbl_80220B88
/* 803C8704 003C4544  7C 64 1B 78 */	mr r4, r3
/* 803C8708 003C4548  38 61 00 08 */	addi r3, r1, 0x8
/* 803C870C 003C454C  4B E9 D5 5D */	bl lbl_80265C68
/* 803C8710 003C4550  C0 01 00 0C */	lfs f0, 0xc(r1)
/* 803C8714 003C4554  D0 1D 00 10 */	stfs f0, 0x10(r29)
/* 803C8718 003C4558  4B DB 24 95 */	bl lbl_8017ABAC
...
.global lbl_803C8748
lbl_803C8748:
/* 803C8748 003C4588  4B FF EC C0 */	b lbl_803C7408

.global lbl_803C874C
lbl_803C874C:
/* 803C874C 003C458C  4B EE 1D 28 */	b lbl_802AA474
...
/* 803C8770 003C45B0  4B D3 80 71 */	bl lbl_801007E0
/* 803C8774 003C45B4  4B FF A5 35 */	bl lbl_803C2CA8
...
/* 803C878C 003C45CC  C8 42 DB 70 */	lfd f2, lbl_80563AF0@sda21(r2)
...
/* 803C87B8 003C45F8  C0 02 DB 64 */	lfs f0, lbl_80563AE4@sda21(r2)
/* 803C87BC 003C45FC  EC 20 00 72 */	fmuls f1, f0, f1
/* 803C87C0 003C4600  C0 02 DB 60 */	lfs f0, lbl_80563AE0@sda21(r2)
/* 803C87C4 003C4604  EC 20 00 72 */	fmuls f1, f0, f1
/* 803C87C8 003C4608  C0 02 DB 5C */	lfs f0, lbl_80563ADC@sda21(r2)
/* 803C87CC 003C460C  EC 20 00 72 */	fmuls f1, f0, f1
/* 803C87D0 003C4610  4B D3 62 D1 */	bl lbl_800FEAA0
...
/* 803C87E8 003C4628  4B D3 7F F9 */	bl lbl_801007E0
/* 803C87EC 003C462C  4B FF A4 ED */	bl lbl_803C2CD8
/* 803C87F0 003C4630  7C 64 1B 78 */	mr r4, r3
/* 803C87F4 003C4634  38 61 00 2C */	addi r3, r1, 0x2c
/* 803C87F8 003C4638  4B DB 3D D1 */	bl lbl_8017C5C8
...
/* 803C8808 003C4648  4B D3 7F D9 */	bl lbl_801007E0
/* 803C880C 003C464C  4B FF A4 D5 */	bl lbl_803C2CE0
/* 803C8810 003C4650  FC 20 F8 90 */	fmr f1, f31
/* 803C8814 003C4654  4B DD 2B 6D */	bl lbl_8019B380
.global lbl_803C8818
lbl_803C8818:
/* 803C8818 003C4658  3C 60 80 54 */	lis r3, lbl_805452E8@ha
/* 803C881C 003C465C  38 83 52 E8 */	addi r4, r3, lbl_805452E8@l
...
/* 803C883C 003C467C  C0 22 DB 68 */	lfs f1, lbl_80563AE8@sda21(r2)
...
/* 803C8888 003C46C8  4B DD 31 2D */	bl lbl_8019B9B4
/* 803C888C 003C46CC  7F C3 F3 78 */	mr r3, r30
/* 803C8890 003C46D0  4B D3 7F 51 */	bl lbl_801007E0
/* 803C8894 003C46D4  4B FF A4 4D */	bl lbl_803C2CE0
/* 803C8898 003C46D8  38 81 00 20 */	addi r4, r1, 0x20
/* 803C889C 003C46DC  38 A1 00 14 */	addi r5, r1, 0x14
/* 803C88A0 003C46E0  4B DD 2B 35 */	bl lbl_8019B3D4
