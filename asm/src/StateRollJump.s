...
/* 80257A70 002538B0  4B DA F8 D5 */	bl func_80007344
...
/* 80257A88 002538C8  90 1D 00 00 */	stw r0, 0(r29)
/* 80257A8C 002538CC  38 00 00 00 */	li r0, 0
/* 80257A90 002538D0  90 1D 00 08 */	stw r0, 8(r29)
/* 80257A94 002538D4  90 1D 00 0C */	stw r0, 0xc(r29)
/* 80257A98 002538D8  C0 02 A9 C0 */	lfs f0, $$256524-_SDA2_BASE_(r2)
...
/* 80257AEC 0025392C  38 80 00 02 */	li r4, 2
...
/* 80257B60 002539A0  C0 02 A9 C0 */	lfs f0, $$256524-_SDA2_BASE_(r2)
...
lbl_80257B84:
/* 80257B84 002539C4  C0 03 00 00 */	lfs f0, 0(r3)
...
/* 80257B94 002539D4  D0 01 00 08 */	stfs f0, 8(r1)
...
lbl_80257BAC:
/* 80257BAC 002539EC  38 61 00 08 */	addi r3, r1, 8
lbl_80257BB0:
/* 80257BB0 002539F0  C0 03 00 00 */	lfs f0, 0(r3)
lbl_80257BB4:
...
/* 80257BC8 00253A08  C0 02 A9 C0 */	lfs f0, $$256524-_SDA2_BASE_(r2)
/* 80257BCC 00253A0C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80257BD0 00253A10  7C 80 00 26 */	mfcr r4
/* 80257BD4 00253A14  54 84 17 FE */	rlwinm r4, r4, 2, 0x1f, 0x1f
/* 80257BD8 00253A18  4B F4 0A A9 */	bl __ct__25mint_wrapNative_helper$$0b$$1Fb
/* 80257BDC 00253A1C  88 1E 00 00 */	lbz r0, 0(r30)
/* 80257BE0 00253A20  2C 00 00 00 */	cmpwi r0, 0
...
/* 80257C04 00253A44  4B DA F7 8D */	bl func_80007390
...
/* 80257C28 00253A68  93 C1 00 08 */	stw r30, 8(r1)
/* 80257C2C 00253A6C  7C 7E 1B 78 */	mr r30, r3
/* 80257C30 00253A70  7C 9F 23 78 */	mr r31, r4
/* 80257C34 00253A74  2C 03 00 00 */	cmpwi r3, 0
...
/* 80257C44 00253A84  90 03 00 00 */	stw r0, 0(r3)
...
/* 80257C84 00253AC4  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 80257CC0 00253B00  80 7E 00 08 */	lwz r3, 8(r30)
...
/* 80257CD0 00253B10  38 03 00 01 */	addi r0, r3, 1
/* 80257CD4 00253B14  90 1E 00 08 */	stw r0, 8(r30)
...
/* 80257CEC 00253B2C  2C 03 00 00 */	cmpwi r3, 0
...
/* 80257D00 00253B40  38 61 00 08 */	addi r3, r1, 8
...
/* 80257D18 00253B58  38 A1 00 08 */	addi r5, r1, 8
...
/* 80257D78 00253BB8  C0 22 A9 C4 */	lfs f1, $$256538-_SDA2_BASE_(r2)
/* 80257D7C 00253BBC  EC 00 00 72 */	fmuls f0, f0, f1
/* 80257D80 00253BC0  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 80257D84 00253BC4  C0 01 00 08 */	lfs f0, 8(r1)
/* 80257D88 00253BC8  EC 00 00 72 */	fmuls f0, f0, f1
/* 80257D8C 00253BCC  D0 01 00 08 */	stfs f0, 8(r1)
...
/* 80257D9C 00253BDC  38 A1 00 08 */	addi r5, r1, 8
...
/* 80257E08 00253C48  38 80 00 05 */	li r4, 5
...
/* 80257E60 00253CA0  F3 E1 00 58 */	psq_st f31, 88(r1), 0, qr0
/* 80257E64 00253CA4  DB C1 00 40 */	stfd f30, 0x40(r1)
/* 80257E68 00253CA8  F3 C1 00 48 */	psq_st f30, 72(r1), 0, qr0
...
/* 80257E88 00253CC8  80 1E 00 08 */	lwz r0, 8(r30)
/* 80257E8C 00253CCC  C8 42 A9 D8 */	lfd f2, $$256561-_SDA2_BASE_(r2)
...
/* 80257EC0 00253D00  D0 01 00 08 */	stfs f0, 8(r1)
/* 80257EC4 00253D04  C0 1E 00 14 */	lfs f0, 0x14(r30)
/* 80257EC8 00253D08  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80257ECC 00253D0C  C0 02 A9 C8 */	lfs f0, $$256556-_SDA2_BASE_(r2)
...
/* 80257F40 00253D80  38 81 00 08 */	addi r4, r1, 8
...
__vt__Q53scn4step4boss9moundeath13StateRollJump:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q53scn4step4boss9moundeath13StateRollJumpFv
	.byte4 procAnim__Q53scn4step4boss9moundeath13StateRollJumpFv
	.byte4 procMove__Q53scn4step4boss9moundeath13StateRollJumpFv
	.byte4 procConstraint__Q43scn4step4boss9StateBaseFv
	.byte4 procFixPos__Q53scn4step4boss9moundeath13StateRollJumpFv
