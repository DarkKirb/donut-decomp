...
/* 802D4E50 002D0C90  F3 E1 00 28 */	psq_st f31, 40(r1), 0, qr0
...
/* 802D4E68 002D0CA8  90 1F 00 00 */	stw r0, 0(r31)
/* 802D4E6C 002D0CAC  C0 02 C0 90 */	lfs f0, $$256183-_SDA2_BASE_(r2)
/* 802D4E70 002D0CB0  D0 1F 00 08 */	stfs f0, 8(r31)
...
/* 802D4EC8 002D0D08  38 61 00 08 */	addi r3, r1, 8
/* 802D4ECC 002D0D0C  4B FB 5E 95 */	bl floorNormal__Q43scn4step5enemy7MapCollCFv
/* 802D4ED0 002D0D10  C0 01 00 08 */	lfs f0, 8(r1)
/* 802D4ED4 002D0D14  D0 1F 00 08 */	stfs f0, 8(r31)
/* 802D4ED8 002D0D18  C0 01 00 08 */	lfs f0, 8(r1)
...
/* 802D4F04 002D0D44  C0 01 00 08 */	lfs f0, 8(r1)
...
/* 802D4F78 002D0DB8  2C 03 00 00 */	cmpwi r3, 0
...
/* 802D4FB8 002D0DF8  F3 E1 00 18 */	psq_st f31, 24(r1), 0, qr0
/* 802D4FBC 002D0DFC  93 E1 00 0C */	stw r31, 0xc(r1)
/* 802D4FC0 002D0E00  93 C1 00 08 */	stw r30, 8(r1)
...
/* 802D4FD8 002D0E18  C0 1E 00 08 */	lfs f0, 8(r30)
...
/* 802D502C 002D0E6C  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 802D5050 002D0E90  F3 E1 00 58 */	psq_st f31, 88(r1), 0, qr0
/* 802D5054 002D0E94  39 61 00 50 */	addi r11, r1, 0x50
/* 802D5058 002D0E98  4B D3 22 ED */	bl func_80007344
...
/* 802D5078 002D0EB8  2C 00 00 00 */	cmpwi r0, 0
...
/* 802D5090 002D0ED0  4B FA D2 9D */	bl RuntimeTypeInfoImpl$$0Q53scn4step5enemy5rocky6Custom$$1__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo
/* 802D5094 002D0ED4  7C 7E 1B 78 */	mr r30, r3
/* 802D5098 002D0ED8  2C 1F 00 00 */	cmpwi r31, 0
/* 802D509C 002D0EDC  41 82 00 48 */	beq lbl_802D50E4
/* 802D50A0 002D0EE0  7F E3 FB 78 */	mr r3, r31
/* 802D50A4 002D0EE4  81 83 00 00 */	lwz r12, 0(r3)
/* 802D50A8 002D0EE8  81 8C 00 08 */	lwz r12, 8(r12)
...
/* 802D50C0 002D0F00  38 00 00 01 */	li r0, 1
/* 802D50C4 002D0F04  48 00 00 14 */	b lbl_802D50D8
lbl_802D50C8:
/* 802D50C8 002D0F08  80 63 00 00 */	lwz r3, 0(r3)
lbl_802D50CC:
/* 802D50CC 002D0F0C  2C 03 00 00 */	cmpwi r3, 0
/* 802D50D0 002D0F10  40 82 FF E8 */	bne lbl_802D50B8
/* 802D50D4 002D0F14  38 00 00 00 */	li r0, 0
lbl_802D50D8:
/* 802D50D8 002D0F18  2C 00 00 00 */	cmpwi r0, 0
/* 802D50DC 002D0F1C  41 82 00 08 */	beq lbl_802D50E4
/* 802D50E0 002D0F20  48 00 00 08 */	b lbl_802D50E8
lbl_802D50E4:
/* 802D50E4 002D0F24  3B E0 00 00 */	li r31, 0
lbl_802D50E8:
/* 802D50E8 002D0F28  7F E3 FB 78 */	mr r3, r31
/* 802D50EC 002D0F2C  38 80 00 01 */	li r4, 1
...
/* 802D5118 002D0F58  2C 1D 00 00 */	cmpwi r29, 0
...
/* 802D5128 002D0F68  4B F6 17 41 */	bl __ct__Q24util28StateFactory$$0Q24util6IState$$1FPv
/* 802D512C 002D0F6C  3C 60 80 48 */	lis r3, __vt__Q24util91StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy5rocky9StateFall$$4PQ43scn4step5enemy5Enemy$$1@ha
/* 802D5130 002D0F70  38 03 AB 60 */	addi r0, r3, __vt__Q24util91StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy5rocky9StateFall$$4PQ43scn4step5enemy5Enemy$$1@l
/* 802D5134 002D0F74  90 1D 00 00 */	stw r0, 0(r29)
/* 802D5138 002D0F78  93 FD 00 08 */	stw r31, 8(r29)
lbl_802D513C:
...
/* 802D5154 002D0F94  38 61 00 08 */	addi r3, r1, 8
/* 802D5158 002D0F98  4B FB 5C 09 */	bl floorNormal__Q43scn4step5enemy7MapCollCFv
/* 802D515C 002D0F9C  C3 E1 00 08 */	lfs f31, 8(r1)
/* 802D5160 002D0FA0  C0 02 C0 90 */	lfs f0, $$256183-_SDA2_BASE_(r2)
...
/* 802D519C 002D0FDC  C0 22 C0 90 */	lfs f1, $$256183-_SDA2_BASE_(r2)
...
/* 802D51C8 002D1008  2C 1D 00 00 */	cmpwi r29, 0
...
/* 802D51D8 002D1018  4B F6 16 91 */	bl __ct__Q24util28StateFactory$$0Q24util6IState$$1FPv
/* 802D51DC 002D101C  3C 60 80 48 */	lis r3, __vt__Q24util91StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy5rocky9StateStay$$4PQ43scn4step5enemy5Enemy$$1@ha
/* 802D51E0 002D1020  38 03 AB 20 */	addi r0, r3, __vt__Q24util91StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy5rocky9StateStay$$4PQ43scn4step5enemy5Enemy$$1@l
/* 802D51E4 002D1024  90 1D 00 00 */	stw r0, 0(r29)
/* 802D51E8 002D1028  93 DD 00 08 */	stw r30, 8(r29)
lbl_802D51EC:
/* 802D51EC 002D102C  93 BF 00 0C */	stw r29, 0xc(r31)
/* 802D51F0 002D1030  48 00 00 38 */	b lbl_802D5228
lbl_802D51F4:
/* 802D51F4 002D1034  C0 01 00 08 */	lfs f0, 8(r1)
/* 802D51F8 002D1038  D0 1D 00 08 */	stfs f0, 8(r29)
/* 802D51FC 002D103C  C0 01 00 08 */	lfs f0, 8(r1)
...
/* 802D5238 002D1078  4B D3 21 59 */	bl func_80007390
...
__vt__Q53scn4step5enemy5rocky10StateSlope:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q53scn4step5enemy5rocky10StateSlopeFv
	.byte4 procAnim__Q53scn4step5enemy5rocky10StateSlopeFv
	.byte4 procMove__Q53scn4step5enemy5rocky10StateSlopeFv
	.byte4 procConstraint__Q43scn4step5enemy9StateBaseFv
	.byte4 procFixPos__Q53scn4step5enemy5rocky10StateSlopeFv
