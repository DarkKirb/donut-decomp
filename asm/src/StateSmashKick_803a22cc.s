...
/* 803A22DC 0039E11C  F3 E1 00 28 */	psq_st f31, 0x28(r1), 0, qr0
/* 803A22E0 0039E120  39 61 00 20 */	addi r11, r1, 0x20
/* 803A22E4 0039E124  4B C6 50 61 */	bl lbl_80007344
...
/* 803A22FC 0039E13C  90 1D 00 00 */	stw r0, 0x0(r29)
/* 803A2300 0039E140  93 DD 00 08 */	stw r30, 0x8(r29)
/* 803A2304 0039E144  38 00 00 00 */	li r0, 0x0
...
/* 803A2338 0039E178  38 80 00 01 */	li r4, 0x1
/* 803A233C 0039E17C  4B FA B8 61 */	bl setFixDir__Q43scn4step4hero5ModelFb
/* 803A2340 0039E180  3B E0 01 0F */	li r31, 0x10f
/* 803A2344 0039E184  80 1D 00 08 */	lwz r0, 0x8(r29)
/* 803A2348 0039E188  2C 00 00 00 */	cmpwi r0, 0x0
/* 803A234C 0039E18C  41 82 00 10 */	beq lbl_803A235C
/* 803A2350 0039E190  2C 00 00 01 */	cmpwi r0, 0x1
...
/* 803A238C 0039E1CC  80 1D 00 08 */	lwz r0, 0x8(r29)
...
/* 803A23BC 0039E1FC  80 1D 00 08 */	lwz r0, 0x8(r29)
/* 803A23C0 0039E200  54 00 18 38 */	slwi r0, r0, 3
/* 803A23C4 0039E204  7C 9E 02 14 */	add r4, r30, r0
/* 803A23C8 0039E208  C0 24 00 04 */	lfs f1, 0x4(r4)
...
/* 803A23FC 0039E23C  4B C6 4F 95 */	bl lbl_80007390
...
/* 803A2420 0039E260  4B C6 4F 25 */	bl lbl_80007344
/* 803A2424 0039E264  7C 7D 1B 78 */	mr r29, r3
/* 803A2428 0039E268  7C 9E 23 78 */	mr r30, r4
/* 803A242C 0039E26C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A243C 0039E27C  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 803A2448 0039E288  38 80 00 00 */	li r4, 0x0
...
/* 803A2460 0039E2A0  80 1D 00 08 */	lwz r0, 0x8(r29)
/* 803A2464 0039E2A4  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 803A24BC 0039E2FC  4B C6 4E D5 */	bl lbl_80007390
...
/* 803A24F0 0039E330  38 80 00 00 */	li r4, 0x0
/* 803A24F4 0039E334  4B ED 05 B1 */	bl get__Q43scn4step5chara13ScriptTriggerFUl
/* 803A24F8 0039E338  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A24FC 0039E33C  41 82 00 0C */	beq lbl_803A2508
/* 803A2500 0039E340  38 00 00 01 */	li r0, 0x1
...
/* 803A2518 0039E358  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A2550 0039E390  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 803A256C 0039E3AC  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 803A25AC 0039E3EC  83 C1 00 08 */	lwz r30, 0x8(r1)
...
__vt__Q53scn4step4hero5smash14StateSmashKick:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step4hero5smash14StateSmashKickFv
	.4byte procAnim__Q53scn4step4hero5smash14StateSmashKickFv
	.4byte procMove__Q53scn4step4hero5smash14StateSmashKickFv
	.4byte procConstraint__Q43scn4step4hero9StateBaseFv
	.4byte procFixPos__Q53scn4step4hero5smash14StateSmashKickFv
