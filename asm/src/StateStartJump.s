...
/* 80391544 0038D384  F3 E1 00 28 */	psq_st f31, 40(r1), 0, qr0
/* 80391548 0038D388  39 61 00 20 */	addi r11, r1, 0x20
/* 8039154C 0038D38C  4B C7 5D F9 */	bl func_80007344
...
/* 80391564 0038D3A4  90 1D 00 00 */	stw r0, 0(r29)
/* 80391568 0038D3A8  93 DD 00 08 */	stw r30, 8(r29)
...
/* 80391584 0038D3C4  80 7D 00 08 */	lwz r3, 8(r29)
/* 80391588 0038D3C8  4B E4 91 6D */	bl isDecideAnimEnd__Q25pause11ButtonPanelCFv
/* 8039158C 0038D3CC  2C 03 00 00 */	cmpwi r3, 0
...
/* 803915DC 0038D41C  2C 03 00 00 */	cmpwi r3, 0
...
/* 803915F4 0038D434  2C 03 00 00 */	cmpwi r3, 0
...
/* 80391608 0038D448  38 00 00 01 */	li r0, 1
/* 8039160C 0038D44C  98 03 00 08 */	stb r0, 8(r3)
lbl_80391610:
...
/* 80391644 0038D484  83 C3 00 08 */	lwz r30, 8(r3)
...
/* 80391654 0038D494  80 7D 00 08 */	lwz r3, 8(r29)
...
/* 80391670 0038D4B0  4B C7 5D 21 */	bl func_80007390
...
/* 80391694 0038D4D4  93 C1 00 08 */	stw r30, 8(r1)
/* 80391698 0038D4D8  7C 7E 1B 78 */	mr r30, r3
/* 8039169C 0038D4DC  7C 9F 23 78 */	mr r31, r4
/* 803916A0 0038D4E0  2C 03 00 00 */	cmpwi r3, 0
...
/* 803916B0 0038D4F0  90 03 00 00 */	stw r0, 0(r3)
...
/* 803916E8 0038D528  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 8039170C 0038D54C  93 C1 00 08 */	stw r30, 8(r1)
/* 80391710 0038D550  7C 7E 1B 78 */	mr r30, r3
/* 80391714 0038D554  80 63 00 08 */	lwz r3, 8(r3)
/* 80391718 0038D558  4B E4 8F DD */	bl isDecideAnimEnd__Q25pause11ButtonPanelCFv
/* 8039171C 0038D55C  2C 03 00 00 */	cmpwi r3, 0
...
/* 8039172C 0038D56C  80 9E 00 08 */	lwz r4, 8(r30)
...
/* 80391744 0038D584  2C 03 00 00 */	cmpwi r3, 0
/* 80391748 0038D588  41 82 00 18 */	beq lbl_80391760
/* 8039174C 0038D58C  83 FE 00 08 */	lwz r31, 8(r30)
...
/* 80391764 0038D5A4  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 8039178C 0038D5CC  80 63 00 08 */	lwz r3, 8(r3)
/* 80391790 0038D5D0  4B E4 8F 65 */	bl isDecideAnimEnd__Q25pause11ButtonPanelCFv
/* 80391794 0038D5D4  2C 03 00 00 */	cmpwi r3, 0
...
/* 803917C8 0038D608  38 81 00 08 */	addi r4, r1, 8
...
/* 80391820 0038D660  88 03 00 08 */	lbz r0, 8(r3)
/* 80391824 0038D664  2C 00 00 00 */	cmpwi r0, 0
...
/* 80391848 0038D688  2C 03 00 00 */	cmpwi r3, 0
/* 8039184C 0038D68C  41 82 00 10 */	beq lbl_8039185C
/* 80391850 0038D690  80 7F 00 08 */	lwz r3, 8(r31)
/* 80391854 0038D694  38 80 00 01 */	li r4, 1
...
__vt__Q53scn4step4hero5stone14StateStartJump:
	.4byte 0
	.4byte 0
	.byte4 __dt__Q53scn4step4hero5stone14StateStartJumpFv
	.byte4 procAnim__Q53scn4step4hero5stone14StateStartJumpFv
	.byte4 procMove__Q53scn4step4hero5stone14StateStartJumpFv
	.byte4 procConstraint__Q43scn4step4hero9StateBaseFv
	.byte4 procFixPos__Q53scn4step4hero5stone14StateStartJumpFv
