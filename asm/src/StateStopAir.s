...
/* 802C8E58 002C4C98  90 1E 00 00 */	stw r0, 0(r30)
/* 802C8E5C 002C4C9C  38 00 00 00 */	li r0, 0
/* 802C8E60 002C4CA0  90 1E 00 08 */	stw r0, 8(r30)
/* 802C8E64 002C4CA4  C0 02 BE 38 */	lfs f0, $$255952-_SDA2_BASE_(r2)
...
/* 802C8E8C 002C4CCC  2C 03 00 00 */	cmpwi r3, 0
/* 802C8E90 002C4CD0  41 82 00 10 */	beq lbl_802C8EA0
/* 802C8E94 002C4CD4  28 03 00 01 */	cmplwi r3, 1
...
/* 802C8EDC 002C4D1C  38 80 00 07 */	li r4, 7
...
/* 802C8EF4 002C4D34  C0 22 BE 38 */	lfs f1, $$255952-_SDA2_BASE_(r2)
...
/* 802C8F2C 002C4D6C  38 61 00 08 */	addi r3, r1, 8
...
/* 802C8F94 002C4DD4  38 A1 00 08 */	addi r5, r1, 8
...
/* 802C8FDC 002C4E1C  38 A1 00 08 */	addi r5, r1, 8
...
/* 802C902C 002C4E6C  F3 E1 00 18 */	psq_st f31, 24(r1), 0, qr0
/* 802C9030 002C4E70  93 E1 00 0C */	stw r31, 0xc(r1)
/* 802C9034 002C4E74  93 C1 00 08 */	stw r30, 8(r1)
/* 802C9038 002C4E78  7C 7F 1B 78 */	mr r31, r3
/* 802C903C 002C4E7C  80 83 00 08 */	lwz r4, 8(r3)
/* 802C9040 002C4E80  38 04 00 01 */	addi r0, r4, 1
/* 802C9044 002C4E84  90 03 00 08 */	stw r0, 8(r3)
...
/* 802C9058 002C4E98  80 1F 00 08 */	lwz r0, 8(r31)
...
/* 802C908C 002C4ECC  4B EC F5 F5 */	bl __ct__25mint_wrapNative_helper$$0b$$1Fb
...
/* 802C90D8 002C4F18  38 80 00 03 */	li r4, 3
...
/* 802C9104 002C4F44  2C 04 00 00 */	cmpwi r4, 0
/* 802C9108 002C4F48  41 82 00 28 */	beq lbl_802C9130
/* 802C910C 002C4F4C  3C 60 80 46 */	lis r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@ha
/* 802C9110 002C4F50  38 03 44 78 */	addi r0, r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@l
/* 802C9114 002C4F54  90 04 00 00 */	stw r0, 0(r4)
/* 802C9118 002C4F58  38 1F 00 90 */	addi r0, r31, 0x90
/* 802C911C 002C4F5C  90 04 00 04 */	stw r0, 4(r4)
/* 802C9120 002C4F60  3C 60 80 48 */	lis r3, __vt__Q24util91StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy5nruff9StateFall$$4PQ43scn4step5enemy5Enemy$$1@ha
/* 802C9124 002C4F64  38 03 97 20 */	addi r0, r3, __vt__Q24util91StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy5nruff9StateFall$$4PQ43scn4step5enemy5Enemy$$1@l
/* 802C9128 002C4F68  90 04 00 00 */	stw r0, 0(r4)
/* 802C912C 002C4F6C  93 C4 00 08 */	stw r30, 8(r4)
lbl_802C9130:
...
/* 802C9144 002C4F84  83 C1 00 08 */	lwz r30, 8(r1)
...
__vt__Q53scn4step5enemy5nruff12StateStopAir:
	.incbin "baserom.dol", 0x475B28, 0x20

.section .data7, "wa"  # 0x8055DF80 - 0x805643C0
.global $$255952
$$255952:
	.incbin "baserom.dol", 0x49C8F8, 0x8
