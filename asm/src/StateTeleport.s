...
/* 802BE474 002BA2B4  F3 E1 00 38 */	psq_st f31, 56(r1), 0, qr0
/* 802BE478 002BA2B8  DB C1 00 20 */	stfd f30, 0x20(r1)
/* 802BE47C 002BA2BC  F3 C1 00 28 */	psq_st f30, 40(r1), 0, qr0
...
/* 802BE498 002BA2D8  90 1E 00 00 */	stw r0, 0(r30)
/* 802BE49C 002BA2DC  38 00 00 00 */	li r0, 0
/* 802BE4A0 002BA2E0  90 1E 00 08 */	stw r0, 8(r30)
/* 802BE4A4 002BA2E4  C0 02 BB D0 */	lfs f0, $$257445-_SDA2_BASE_(r2)
...
/* 802BE4D4 002BA314  38 60 00 00 */	li r3, 0
/* 802BE4D8 002BA318  38 80 00 04 */	li r4, 4
...
/* 802BE510 002BA350  38 80 00 01 */	li r4, 1
...
/* 802BE538 002BA378  38 60 00 00 */	li r3, 0
/* 802BE53C 002BA37C  38 80 00 02 */	li r4, 2
/* 802BE540 002BA380  4B EB C5 05 */	bl Rand__Q23app6RandomFii
/* 802BE544 002BA384  2C 03 00 00 */	cmpwi r3, 0
/* 802BE548 002BA388  40 82 00 0C */	bne lbl_802BE554
/* 802BE54C 002BA38C  C0 02 BB D4 */	lfs f0, $$257446-_SDA2_BASE_(r2)
/* 802BE550 002BA390  EF DE 00 32 */	fmuls f30, f30, f0
lbl_802BE554:
/* 802BE554 002BA394  80 1F 00 6C */	lwz r0, 0x6c(r31)
/* 802BE558 002BA398  C8 22 BB D8 */	lfd f1, $$257450-_SDA2_BASE_(r2)
/* 802BE55C 002BA39C  90 01 00 0C */	stw r0, 0xc(r1)
/* 802BE560 002BA3A0  3C 60 43 30 */	lis r3, 0x4330
/* 802BE564 002BA3A4  90 61 00 08 */	stw r3, 8(r1)
/* 802BE568 002BA3A8  C8 01 00 08 */	lfd f0, 8(r1)
...
/* 802BE5DC 002BA41C  4B D4 8D 65 */	bl func_80007340
...
/* 802BE604 002BA444  4B FC 39 B9 */	bl RuntimeTypeInfoImpl$$0Q53scn4step5enemy4kabu6Custom$$1__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo
/* 802BE608 002BA448  7C 7E 1B 78 */	mr r30, r3
/* 802BE60C 002BA44C  2C 1D 00 00 */	cmpwi r29, 0
/* 802BE610 002BA450  41 82 00 48 */	beq lbl_802BE658
/* 802BE614 002BA454  7F A3 EB 78 */	mr r3, r29
/* 802BE618 002BA458  81 83 00 00 */	lwz r12, 0(r3)
/* 802BE61C 002BA45C  81 8C 00 08 */	lwz r12, 8(r12)
...
/* 802BE634 002BA474  38 00 00 01 */	li r0, 1
/* 802BE638 002BA478  48 00 00 14 */	b lbl_802BE64C
lbl_802BE63C:
/* 802BE63C 002BA47C  80 63 00 00 */	lwz r3, 0(r3)
lbl_802BE640:
/* 802BE640 002BA480  2C 03 00 00 */	cmpwi r3, 0
/* 802BE644 002BA484  40 82 FF E8 */	bne lbl_802BE62C
/* 802BE648 002BA488  38 00 00 00 */	li r0, 0
lbl_802BE64C:
/* 802BE64C 002BA48C  2C 00 00 00 */	cmpwi r0, 0
/* 802BE650 002BA490  41 82 00 08 */	beq lbl_802BE658
/* 802BE654 002BA494  48 00 00 08 */	b lbl_802BE65C
lbl_802BE658:
/* 802BE658 002BA498  3B A0 00 00 */	li r29, 0
lbl_802BE65C:
...
/* 802BE674 002BA4B4  38 84 00 01 */	addi r4, r4, 1
/* 802BE678 002BA4B8  90 9C 00 1C */	stw r4, 0x1c(r28)
/* 802BE67C 002BA4BC  80 1C 00 08 */	lwz r0, 8(r28)
/* 802BE680 002BA4C0  2C 00 00 00 */	cmpwi r0, 0
/* 802BE684 002BA4C4  41 82 00 18 */	beq lbl_802BE69C
/* 802BE688 002BA4C8  2C 00 00 01 */	cmpwi r0, 1
/* 802BE68C 002BA4CC  41 82 00 9C */	beq lbl_802BE728
/* 802BE690 002BA4D0  2C 00 00 03 */	cmpwi r0, 3
...
/* 802BE6C8 002BA508  38 80 00 00 */	li r4, 0
...
/* 802BE6EC 002BA52C  38 80 00 00 */	li r4, 0
...
/* 802BE700 002BA540  38 80 00 01 */	li r4, 1
/* 802BE704 002BA544  4B FB 4D D5 */	bl setForbidEffect__Q43scn4step5chara5WaterFb
/* 802BE708 002BA548  7F A3 EB 78 */	mr r3, r29
/* 802BE70C 002BA54C  38 80 00 01 */	li r4, 1
/* 802BE710 002BA550  4B FA F2 2D */	bl setValid__Q43scn4step5chara7CullingFb
/* 802BE714 002BA554  38 00 00 01 */	li r0, 1
/* 802BE718 002BA558  90 1C 00 08 */	stw r0, 8(r28)
/* 802BE71C 002BA55C  38 00 00 00 */	li r0, 0
...
/* 802BE74C 002BA58C  2C 03 00 00 */	cmpwi r3, 0
...
/* 802BE760 002BA5A0  38 80 00 00 */	li r4, 0
...
/* 802BE774 002BA5B4  38 80 00 00 */	li r4, 0
...
/* 802BE788 002BA5C8  38 80 00 00 */	li r4, 0
/* 802BE78C 002BA5CC  4B FC C3 8D */	bl setValid__Q43scn4step5enemy7MapCollFb
/* 802BE790 002BA5D0  38 00 00 02 */	li r0, 2
/* 802BE794 002BA5D4  90 1C 00 08 */	stw r0, 8(r28)
/* 802BE798 002BA5D8  48 00 01 C4 */	b lbl_802BE95C
lbl_802BE79C:
/* 802BE79C 002BA5DC  28 03 00 09 */	cmplwi r3, 9
...
/* 802BE7C4 002BA604  38 80 00 01 */	li r4, 1
...
/* 802BE7D8 002BA618  38 80 00 01 */	li r4, 1
/* 802BE7DC 002BA61C  4B FC F4 F9 */	bl setVisibility__Q43scn4step5enemy6ShadowFb
/* 802BE7E0 002BA620  38 00 00 00 */	li r0, 0
...
/* 802BE818 002BA658  2C 03 00 00 */	cmpwi r3, 0
...
/* 802BE82C 002BA66C  38 80 00 01 */	li r4, 1
...
/* 802BE840 002BA680  38 80 00 01 */	li r4, 1
...
/* 802BE854 002BA694  38 80 00 01 */	li r4, 1
...
/* 802BE868 002BA6A8  38 80 00 01 */	li r4, 1
...
/* 802BE880 002BA6C0  38 80 00 01 */	li r4, 1
...
/* 802BE8B8 002BA6F8  2C 03 00 00 */	cmpwi r3, 0
...
/* 802BE8E4 002BA724  2C 1D 00 00 */	cmpwi r29, 0
...
/* 802BE8F4 002BA734  4B F7 7F 75 */	bl __ct__Q24util28StateFactory$$0Q24util6IState$$1FPv
/* 802BE8F8 002BA738  3C 60 80 47 */	lis r3, __vt__Q24util100StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy6damage16StateDeadInWater$$4PQ43scn4step5enemy5Enemy$$1@ha
/* 802BE8FC 002BA73C  38 03 1B 80 */	addi r0, r3, __vt__Q24util100StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy6damage16StateDeadInWater$$4PQ43scn4step5enemy5Enemy$$1@l
/* 802BE900 002BA740  90 1D 00 00 */	stw r0, 0(r29)
/* 802BE904 002BA744  93 FD 00 08 */	stw r31, 8(r29)
lbl_802BE908:
...
/* 802BE934 002BA774  2C 1D 00 00 */	cmpwi r29, 0
...
/* 802BE944 002BA784  4B F7 7F 25 */	bl __ct__Q24util28StateFactory$$0Q24util6IState$$1FPv
/* 802BE948 002BA788  3C 60 80 47 */	lis r3, __vt__Q24util90StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy4kabu9StateFall$$4PQ43scn4step5enemy5Enemy$$1@ha
/* 802BE94C 002BA78C  38 03 7E C0 */	addi r0, r3, __vt__Q24util90StateFactoryArg1$$0Q24util6IState$$4Q53scn4step5enemy4kabu9StateFall$$4PQ43scn4step5enemy5Enemy$$1@l
/* 802BE950 002BA790  90 1D 00 00 */	stw r0, 0(r29)
/* 802BE954 002BA794  93 DD 00 08 */	stw r30, 8(r29)
lbl_802BE958:
/* 802BE958 002BA798  93 BF 00 0C */	stw r29, 0xc(r31)
lbl_802BE95C:
/* 802BE95C 002BA79C  39 61 00 20 */	addi r11, r1, 0x20
/* 802BE960 002BA7A0  4B D4 8A 2D */	bl func_8000738C
...
/* 802BE984 002BA7C4  F3 E1 00 48 */	psq_st f31, 72(r1), 0, qr0
...
/* 802BE9A4 002BA7E4  80 1E 00 08 */	lwz r0, 8(r30)
/* 802BE9A8 002BA7E8  2C 00 00 02 */	cmpwi r0, 2
...
/* 802BE9C0 002BA800  C0 02 BB E0 */	lfs f0, $$257508-_SDA2_BASE_(r2)
/* 802BE9C4 002BA804  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802BE9C8 002BA808  4C 41 13 82 */	cror 2, 1, 2
...
/* 802BE9DC 002BA81C  C0 02 BB E8 */	lfs f0, $$257510-_SDA2_BASE_(r2)
/* 802BE9E0 002BA820  EC 20 00 72 */	fmuls f1, f0, f1
/* 802BE9E4 002BA824  C0 02 BB E4 */	lfs f0, $$257509-_SDA2_BASE_(r2)
...
/* 802BEA14 002BA854  2C 00 00 00 */	cmpwi r0, 0
...
lbl_802BEA54:
/* 802BEA54 002BA894  28 00 00 01 */	cmplwi r0, 1
...
/* 802BEAEC 002BA92C  38 00 00 03 */	li r0, 3
/* 802BEAF0 002BA930  90 1E 00 08 */	stw r0, 8(r30)
lbl_802BEAF4:
/* 802BEAF4 002BA934  4B ED CF 01 */	bl Zero__Q24gobj14MoveParamDecelFv
/* 802BEAF8 002BA938  90 61 00 08 */	stw r3, 8(r1)
...
/* 802BEB10 002BA950  38 81 00 08 */	addi r4, r1, 8
...
/* 802BEB60 002BA9A0  38 61 00 08 */	addi r3, r1, 8
/* 802BEB64 002BA9A4  4B FC C1 35 */	bl result__Q43scn4step5enemy7MapCollCFv
/* 802BEB68 002BA9A8  38 60 00 00 */	li r3, 0
/* 802BEB6C 002BA9AC  88 01 00 08 */	lbz r0, 8(r1)
/* 802BEB70 002BA9B0  2C 00 00 00 */	cmpwi r0, 0
/* 802BEB74 002BA9B4  40 82 00 28 */	bne lbl_802BEB9C
/* 802BEB78 002BA9B8  88 01 00 09 */	lbz r0, 9(r1)
/* 802BEB7C 002BA9BC  2C 00 00 00 */	cmpwi r0, 0
/* 802BEB80 002BA9C0  40 82 00 1C */	bne lbl_802BEB9C
/* 802BEB84 002BA9C4  88 01 00 0A */	lbz r0, 0xa(r1)
/* 802BEB88 002BA9C8  2C 00 00 00 */	cmpwi r0, 0
/* 802BEB8C 002BA9CC  40 82 00 10 */	bne lbl_802BEB9C
/* 802BEB90 002BA9D0  88 01 00 0B */	lbz r0, 0xb(r1)
/* 802BEB94 002BA9D4  2C 00 00 00 */	cmpwi r0, 0
/* 802BEB98 002BA9D8  41 82 00 08 */	beq lbl_802BEBA0
lbl_802BEB9C:
/* 802BEB9C 002BA9DC  38 60 00 01 */	li r3, 1
lbl_802BEBA0:
...
/* 802BEBD0 002BAA10  54 00 07 BE */	clrlwi r0, r0, 0x1e
/* 802BEBD4 002BAA14  C8 22 BB D8 */	lfd f1, $$257450-_SDA2_BASE_(r2)
/* 802BEBD8 002BAA18  90 01 00 0C */	stw r0, 0xc(r1)
/* 802BEBDC 002BAA1C  3C 00 43 30 */	lis r0, 0x4330
/* 802BEBE0 002BAA20  90 01 00 08 */	stw r0, 8(r1)
/* 802BEBE4 002BAA24  C8 01 00 08 */	lfd f0, 8(r1)
/* 802BEBE8 002BAA28  EC 20 08 28 */	fsubs f1, f0, f1
/* 802BEBEC 002BAA2C  C0 02 BB EC */	lfs f0, $$257534-_SDA2_BASE_(r2)
/* 802BEBF0 002BAA30  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802BEBF4 002BAA34  4C 40 13 82 */	cror 2, 0, 2
...
/* 802BEC04 002BAA44  38 80 00 00 */	li r4, 0
...
/* 802BEC18 002BAA58  38 80 00 00 */	li r4, 0
...
/* 802BEC2C 002BAA6C  38 80 00 01 */	li r4, 1
...
/* 802BEC40 002BAA80  38 80 00 01 */	li r4, 1
...
.global __vt__Q53scn4step5enemy4kabu13StateTeleport
__vt__Q53scn4step5enemy4kabu13StateTeleport:
	.incbin "baserom.dol", 0x474338, 0x20

.section .data7, "wa"  # 0x8055DF80 - 0x805643C0
.global $$257445
$$257445:
	.incbin "baserom.dol", 0x49C690, 0x4
.global $$257446
$$257446:
	.incbin "baserom.dol", 0x49C694, 0x4
.global $$257450
$$257450:
	.incbin "baserom.dol", 0x49C698, 0x8
.global $$257508
$$257508:
	.incbin "baserom.dol", 0x49C6A0, 0x4
.global $$257509
$$257509:
	.incbin "baserom.dol", 0x49C6A4, 0x4
.global $$257510
$$257510:
	.incbin "baserom.dol", 0x49C6A8, 0x4
.global $$257534
$$257534:
	.incbin "baserom.dol", 0x49C6AC, 0x4
