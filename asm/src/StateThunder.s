...
/* 80250678 0024C4B8  90 1F 00 00 */	stw r0, 0(r31)
...
/* 802506E0 0024C520  93 C1 00 08 */	stw r30, 8(r1)
/* 802506E4 0024C524  7C 7E 1B 78 */	mr r30, r3
/* 802506E8 0024C528  7C 9F 23 78 */	mr r31, r4
/* 802506EC 0024C52C  2C 03 00 00 */	cmpwi r3, 0
...
/* 802506FC 0024C53C  90 03 00 00 */	stw r0, 0(r3)
...
/* 8025073C 0024C57C  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 80250760 0024C5A0  4B DB 6B E5 */	bl func_80007344
...
/* 80250774 0024C5B4  4B FD E1 69 */	bl RuntimeTypeInfoImpl$$0Q53scn4step4boss6dubior6Custom$$1__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo
/* 80250778 0024C5B8  7C 7E 1B 78 */	mr r30, r3
/* 8025077C 0024C5BC  2C 1F 00 00 */	cmpwi r31, 0
/* 80250780 0024C5C0  41 82 00 48 */	beq lbl_802507C8
/* 80250784 0024C5C4  7F E3 FB 78 */	mr r3, r31
/* 80250788 0024C5C8  81 83 00 00 */	lwz r12, 0(r3)
/* 8025078C 0024C5CC  81 8C 00 08 */	lwz r12, 8(r12)
...
/* 802507A4 0024C5E4  38 00 00 01 */	li r0, 1
/* 802507A8 0024C5E8  48 00 00 14 */	b lbl_802507BC
lbl_802507AC:
/* 802507AC 0024C5EC  80 63 00 00 */	lwz r3, 0(r3)
lbl_802507B0:
/* 802507B0 0024C5F0  2C 03 00 00 */	cmpwi r3, 0
/* 802507B4 0024C5F4  40 82 FF E8 */	bne lbl_8025079C
/* 802507B8 0024C5F8  38 00 00 00 */	li r0, 0
lbl_802507BC:
/* 802507BC 0024C5FC  2C 00 00 00 */	cmpwi r0, 0
/* 802507C0 0024C600  41 82 00 08 */	beq lbl_802507C8
/* 802507C4 0024C604  48 00 00 08 */	b lbl_802507CC
lbl_802507C8:
/* 802507C8 0024C608  3B E0 00 00 */	li r31, 0
lbl_802507CC:
...
/* 802507D8 0024C618  38 80 00 00 */	li r4, 0
/* 802507DC 0024C61C  48 02 22 C9 */	bl get__Q43scn4step5chara13ScriptTriggerFUl
/* 802507E0 0024C620  2C 03 00 00 */	cmpwi r3, 0
...
/* 80250800 0024C640  2C 03 00 00 */	cmpwi r3, 0
...
/* 8025082C 0024C66C  2C 04 00 00 */	cmpwi r4, 0
/* 80250830 0024C670  41 82 00 28 */	beq lbl_80250858
/* 80250834 0024C674  3C 60 80 46 */	lis r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@ha
/* 80250838 0024C678  38 03 44 78 */	addi r0, r3, __vt__Q24util28StateFactory$$0Q24util6IState$$1@l
/* 8025083C 0024C67C  90 04 00 00 */	stw r0, 0(r4)
/* 80250840 0024C680  38 1F 00 90 */	addi r0, r31, 0x90
/* 80250844 0024C684  90 04 00 04 */	stw r0, 4(r4)
/* 80250848 0024C688  3C 60 80 46 */	lis r3, __vt__Q24util89StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4boss6dubior9StateWait$$4PQ43scn4step4boss4Boss$$1@ha
/* 8025084C 0024C68C  38 03 74 B0 */	addi r0, r3, __vt__Q24util89StateFactoryArg1$$0Q24util6IState$$4Q53scn4step4boss6dubior9StateWait$$4PQ43scn4step4boss4Boss$$1@l
/* 80250850 0024C690  90 04 00 00 */	stw r0, 0(r4)
/* 80250854 0024C694  93 C4 00 08 */	stw r30, 8(r4)
lbl_80250858:
/* 80250858 0024C698  90 9F 00 0C */	stw r4, 0xc(r31)
lbl_8025085C:
/* 8025085C 0024C69C  39 61 00 20 */	addi r11, r1, 0x20
/* 80250860 0024C6A0  4B DB 6B 31 */	bl func_80007390
...
__vt__Q53scn4step4boss6dubior12StateThunder:
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step4boss6dubior12StateThunderFv
	.4byte procAnim__Q53scn4step4boss6dubior12StateThunderFv
	.4byte procMove__Q53scn4step4boss6dubior12StateThunderFv
	.4byte procConstraint__Q43scn4step4boss9StateBaseFv
	.4byte procFixPos__Q53scn4step4boss6dubior12StateThunderFv
