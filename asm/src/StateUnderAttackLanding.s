...
/* 8039AB28 00396968  F3 E1 00 28 */	psq_st f31, 40(r1), 0, qr0
...
/* 8039AB38 00396978  98 A1 00 08 */	stb r5, 8(r1)
...
/* 8039AB48 00396988  90 1E 00 00 */	stw r0, 0(r30)
/* 8039AB4C 0039698C  38 00 00 00 */	li r0, 0
/* 8039AB50 00396990  98 1E 00 08 */	stb r0, 8(r30)
...
/* 8039AB64 003969A4  88 01 00 08 */	lbz r0, 8(r1)
/* 8039AB68 003969A8  2C 00 00 00 */	cmpwi r0, 0
...
/* 8039ABA0 003969E0  38 80 00 03 */	li r4, 3
...
/* 8039AC20 00396A60  38 8D D0 70 */	addi r4, r13, $$256962-_SDA_BASE_
/* 8039AC24 00396A64  38 A1 00 08 */	addi r5, r1, 8
...
/* 8039AC30 00396A70  38 8D D0 74 */	addi r4, r13, $$256963-_SDA_BASE_
/* 8039AC34 00396A74  38 A1 00 08 */	addi r5, r1, 8
...
/* 8039AC74 00396AB4  93 C1 00 08 */	stw r30, 8(r1)
/* 8039AC78 00396AB8  7C 7E 1B 78 */	mr r30, r3
/* 8039AC7C 00396ABC  7C 9F 23 78 */	mr r31, r4
/* 8039AC80 00396AC0  2C 03 00 00 */	cmpwi r3, 0
...
/* 8039AC90 00396AD0  90 03 00 00 */	stw r0, 0(r3)
...
/* 8039ACA4 00396AE4  2C 03 00 00 */	cmpwi r3, 0
...
/* 8039ACF4 00396B34  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 8039AD28 00396B68  38 80 00 00 */	li r4, 0
/* 8039AD2C 00396B6C  4B ED 7D 79 */	bl get__Q43scn4step5chara13ScriptTriggerFUl
/* 8039AD30 00396B70  2C 03 00 00 */	cmpwi r3, 0
/* 8039AD34 00396B74  41 82 00 0C */	beq lbl_8039AD40
/* 8039AD38 00396B78  38 00 00 01 */	li r0, 1
/* 8039AD3C 00396B7C  98 1F 00 08 */	stb r0, 8(r31)
lbl_8039AD40:
/* 8039AD40 00396B80  88 1F 00 08 */	lbz r0, 8(r31)
/* 8039AD44 00396B84  2C 00 00 00 */	cmpwi r0, 0
...
/* 8039AD58 00396B98  2C 03 00 00 */	cmpwi r3, 0
...
/* 8039AD6C 00396BAC  2C 03 00 00 */	cmpwi r3, 0
...
/* 8039AD80 00396BC0  2C 03 00 00 */	cmpwi r3, 0
...
/* 8039AD9C 00396BDC  2C 03 00 00 */	cmpwi r3, 0
...
/* 8039ADD4 00396C14  93 C1 00 08 */	stw r30, 8(r1)
...
/* 8039AE08 00396C48  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 8039AE30 00396C70  4B C6 C5 11 */	bl func_80007340
/* 8039AE34 00396C74  7C 7C 1B 78 */	mr r28, r3
/* 8039AE38 00396C78  7C 9D 23 78 */	mr r29, r4
/* 8039AE3C 00396C7C  7C BE 2B 78 */	mr r30, r5
/* 8039AE40 00396C80  88 85 00 00 */	lbz r4, 0(r5)
/* 8039AE44 00396C84  30 04 FF FF */	addic r0, r4, -1
...
/* 8039AE74 00396CB4  C0 02 D7 F8 */	lfs f0, $$257777-_SDA2_BASE_(r2)
...
/* 8039AEA0 00396CE0  C0 3D 00 00 */	lfs f1, 0(r29)
...
/* 8039AEB0 00396CF0  88 1E 00 00 */	lbz r0, 0(r30)
/* 8039AEB4 00396CF4  2C 00 00 00 */	cmpwi r0, 0
...
/* 8039AECC 00396D0C  C0 1D 00 00 */	lfs f0, 0(r29)
/* 8039AED0 00396D10  EC 20 00 72 */	fmuls f1, f0, f1
/* 8039AED4 00396D14  C0 02 D7 FC */	lfs f0, $$257778-_SDA2_BASE_(r2)
...
lbl_8039AF24:
/* 8039AF24 00396D64  38 61 00 08 */	addi r3, r1, 8
/* 8039AF28 00396D68  C0 1D 00 00 */	lfs f0, 0(r29)
/* 8039AF2C 00396D6C  EC 20 00 72 */	fmuls f1, f0, f1
/* 8039AF30 00396D70  C0 42 D7 FC */	lfs f2, $$257778-_SDA2_BASE_(r2)
...
/* 8039AF4C 00396D8C  38 00 00 01 */	li r0, 1
...
/* 8039AF70 00396DB0  38 81 00 08 */	addi r4, r1, 8
...
/* 8039AF84 00396DC4  38 63 00 08 */	addi r3, r3, 8
...
/* 8039AFB4 00396DF4  38 80 FF FF */	li r4, -1
/* 8039AFB8 00396DF8  4B E9 F0 F9 */	bl __dt__Q24util39ObjRefHandle$$0Q43scn4step6weapon6Weapon$$1Fv
/* 8039AFBC 00396DFC  39 61 00 90 */	addi r11, r1, 0x90
/* 8039AFC0 00396E00  4B C6 C3 CD */	bl func_8000738C
