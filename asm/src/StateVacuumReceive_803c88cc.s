...
/* 803C88E8 003C4728  4B FF C9 01 */	bl lbl_803C51E8
/* 803C88EC 003C472C  3C 60 80 49 */	lis r3, lbl_80492630@ha
/* 803C88F0 003C4730  38 03 26 30 */	addi r0, r3, lbl_80492630@l
/* 803C88F4 003C4734  90 1E 00 00 */	stw r0, 0x0(r30)
/* 803C88F8 003C4738  38 7E 00 08 */	addi r3, r30, 0x8
/* 803C88FC 003C473C  4B EA 8F CD */	bl lbl_802718C8
/* 803C8900 003C4740  7F C3 F3 78 */	mr r3, r30
/* 803C8904 003C4744  4B D3 7E DD */	bl lbl_801007E0
/* 803C8908 003C4748  4B FF A4 41 */	bl lbl_803C2D48
/* 803C890C 003C474C  38 80 00 00 */	li r4, 0x0
/* 803C8910 003C4750  4B DE E9 05 */	bl lbl_801B7214
/* 803C8914 003C4754  7F C3 F3 78 */	mr r3, r30
/* 803C8918 003C4758  4B D3 7E C9 */	bl lbl_801007E0
/* 803C891C 003C475C  4B FF A4 0D */	bl lbl_803C2D28
/* 803C8920 003C4760  7C 64 1B 78 */	mr r4, r3
/* 803C8924 003C4764  38 61 00 10 */	addi r3, r1, 0x10
/* 803C8928 003C4768  4B E6 DB AD */	bl lbl_802364D4
/* 803C892C 003C476C  7F C3 F3 78 */	mr r3, r30
/* 803C8930 003C4770  4B D3 7E B1 */	bl lbl_801007E0
/* 803C8934 003C4774  4B FF A3 A5 */	bl lbl_803C2CD8
/* 803C8938 003C4778  7C 64 1B 78 */	mr r4, r3
/* 803C893C 003C477C  38 61 00 30 */	addi r3, r1, 0x30
/* 803C8940 003C4780  4B DB 3C 89 */	bl lbl_8017C5C8
...
/* 803C895C 003C479C  4B D8 30 0D */	bl lbl_8014B968
...
/* 803C8988 003C47C8  4B D8 2F E1 */	bl lbl_8014B968
/* 803C898C 003C47CC  7F C3 F3 78 */	mr r3, r30
/* 803C8990 003C47D0  4B D3 7E 51 */	bl lbl_801007E0
/* 803C8994 003C47D4  7C 64 1B 78 */	mr r4, r3
/* 803C8998 003C47D8  38 61 00 20 */	addi r3, r1, 0x20
/* 803C899C 003C47DC  4B FF A2 01 */	bl lbl_803C2B9C
/* 803C89A0 003C47E0  C0 22 DB 78 */	lfs f1, lbl_80563AF8@sda21(r2)
...
/* 803C89B4 003C47F4  4B EA 8F E9 */	bl lbl_8027199C
/* 803C89B8 003C47F8  7F C3 F3 78 */	mr r3, r30
/* 803C89BC 003C47FC  4B D3 7E 25 */	bl lbl_801007E0
/* 803C89C0 003C4800  4B FF A3 61 */	bl lbl_803C2D20
/* 803C89C4 003C4804  38 80 00 00 */	li r4, 0x0
/* 803C89C8 003C4808  4B FF C0 FD */	bl lbl_803C4AC4
/* 803C89CC 003C480C  7F C3 F3 78 */	mr r3, r30
/* 803C89D0 003C4810  4B D3 7E 11 */	bl lbl_801007E0
/* 803C89D4 003C4814  4B FF A3 55 */	bl lbl_803C2D28
/* 803C89D8 003C4818  38 80 00 00 */	li r4, 0x0
/* 803C89DC 003C481C  4B FF CC 09 */	bl lbl_803C55E4
/* 803C89E0 003C4820  7F C3 F3 78 */	mr r3, r30
/* 803C89E4 003C4824  4B D3 7D FD */	bl lbl_801007E0
/* 803C89E8 003C4828  4B FF A3 51 */	bl lbl_803C2D38
/* 803C89EC 003C482C  4B DD 14 DD */	bl lbl_80199EC8
/* 803C89F0 003C4830  7F C3 F3 78 */	mr r3, r30
/* 803C89F4 003C4834  4B D3 7D ED */	bl lbl_801007E0
/* 803C89F8 003C4838  4B FF A2 E9 */	bl lbl_803C2CE0
/* 803C89FC 003C483C  4B DD 29 95 */	bl lbl_8019B390
/* 803C8A00 003C4840  7F C3 F3 78 */	mr r3, r30
/* 803C8A04 003C4844  4B D3 7D DD */	bl lbl_801007E0
/* 803C8A08 003C4848  38 80 00 00 */	li r4, 0x0
/* 803C8A0C 003C484C  4B FF A1 E1 */	bl lbl_803C2BEC
/* 803C8A10 003C4850  7F C3 F3 78 */	mr r3, r30
/* 803C8A14 003C4854  4B D3 7D CD */	bl lbl_801007E0
/* 803C8A18 003C4858  38 80 00 00 */	li r4, 0x0
/* 803C8A1C 003C485C  4B FF A1 F5 */	bl lbl_803C2C10
...
/* 803C8A60 003C48A0  3C 80 80 49 */	lis r4, lbl_80492630@ha
/* 803C8A64 003C48A4  38 04 26 30 */	addi r0, r4, lbl_80492630@l
/* 803C8A68 003C48A8  90 03 00 00 */	stw r0, 0x0(r3)
/* 803C8A6C 003C48AC  4B D3 7D 75 */	bl lbl_801007E0
/* 803C8A70 003C48B0  4B FF A2 D9 */	bl lbl_803C2D48
/* 803C8A74 003C48B4  38 80 00 01 */	li r4, 0x1
/* 803C8A78 003C48B8  4B DE E7 9D */	bl lbl_801B7214
/* 803C8A7C 003C48BC  7F C3 F3 78 */	mr r3, r30
/* 803C8A80 003C48C0  38 80 00 00 */	li r4, 0x0
/* 803C8A84 003C48C4  4B FF C7 85 */	bl lbl_803C5208
...
/* 803C8A98 003C48D8  4B DF 6C 7D */	bl lbl_801BF714
.global lbl_803C8A9C
lbl_803C8A9C:
...
/* 803C8AD0 003C4910  4B EA 8F C5 */	bl lbl_80271A94
...
/* 803C8AE0 003C4920  4B D3 7D 01 */	bl lbl_801007E0
/* 803C8AE4 003C4924  4B FF A2 45 */	bl lbl_803C2D28
/* 803C8AE8 003C4928  4B FF CC 75 */	bl lbl_803C575C
/* 803C8AEC 003C492C  7F E3 FB 78 */	mr r3, r31
/* 803C8AF0 003C4930  4B D3 7C F1 */	bl lbl_801007E0
/* 803C8AF4 003C4934  38 80 00 01 */	li r4, 0x1
/* 803C8AF8 003C4938  4B FF 9D C5 */	bl lbl_803C28BC
/* 803C8AFC 003C493C  7F E3 FB 78 */	mr r3, r31
/* 803C8B00 003C4940  4B D3 7C E1 */	bl lbl_801007E0
/* 803C8B04 003C4944  4B FF 9B C5 */	bl lbl_803C26C8
.global lbl_803C8B08
lbl_803C8B08:
/* 803C8B08 003C4948  38 7F 00 08 */	addi r3, r31, 0x8
/* 803C8B0C 003C494C  4B EA 8F 09 */	bl lbl_80271A14
...
/* 803C8B40 003C4980  4B EA 8F 6D */	bl lbl_80271AAC
/* 803C8B44 003C4984  7F E3 FB 78 */	mr r3, r31
/* 803C8B48 003C4988  4B D3 7C 99 */	bl lbl_801007E0
/* 803C8B4C 003C498C  4B FF A1 DD */	bl lbl_803C2D28
/* 803C8B50 003C4990  7C 64 1B 78 */	mr r4, r3
/* 803C8B54 003C4994  38 61 00 18 */	addi r3, r1, 0x18
/* 803C8B58 003C4998  4B E6 D9 7D */	bl lbl_802364D4
/* 803C8B5C 003C499C  38 81 00 18 */	addi r4, r1, 0x18
/* 803C8B60 003C49A0  38 61 00 08 */	addi r3, r1, 0x8
/* 803C8B64 003C49A4  4B D8 2E 05 */	bl lbl_8014B968
...
/* 803C8B90 003C49D0  4B D8 2D D9 */	bl lbl_8014B968
/* 803C8B94 003C49D4  38 61 00 28 */	addi r3, r1, 0x28
/* 803C8B98 003C49D8  38 81 00 20 */	addi r4, r1, 0x20
/* 803C8B9C 003C49DC  4B DD 68 C1 */	bl lbl_8019F45C
/* 803C8BA0 003C49E0  7F E3 FB 78 */	mr r3, r31
/* 803C8BA4 003C49E4  4B D3 7C 3D */	bl lbl_801007E0
/* 803C8BA8 003C49E8  4B FF A1 31 */	bl lbl_803C2CD8
/* 803C8BAC 003C49EC  38 81 00 28 */	addi r4, r1, 0x28
/* 803C8BB0 003C49F0  4B DD 1D F5 */	bl lbl_8019A9A4
/* 803C8BB4 003C49F4  38 61 00 38 */	addi r3, r1, 0x38
/* 803C8BB8 003C49F8  38 9F 00 08 */	addi r4, r31, 0x8
/* 803C8BBC 003C49FC  4B EA 8E F9 */	bl lbl_80271AB4
/* 803C8BC0 003C4A00  7F E3 FB 78 */	mr r3, r31
/* 803C8BC4 003C4A04  4B D3 7C 1D */	bl lbl_801007E0
/* 803C8BC8 003C4A08  4B FF A1 21 */	bl lbl_803C2CE8
/* 803C8BCC 003C4A0C  38 81 00 38 */	addi r4, r1, 0x38
/* 803C8BD0 003C4A10  4B EA 87 49 */	bl lbl_80271318
