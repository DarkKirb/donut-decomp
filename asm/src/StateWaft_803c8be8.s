...
/* 803C8BFC 003C4A3C  4B FF C5 ED */	bl lbl_803C51E8
/* 803C8C00 003C4A40  3C 60 80 49 */	lis r3, lbl_80492658@ha
/* 803C8C04 003C4A44  38 03 26 58 */	addi r0, r3, lbl_80492658@l
/* 803C8C08 003C4A48  90 1F 00 00 */	stw r0, 0x0(r31)
/* 803C8C0C 003C4A4C  C0 02 DB 80 */	lfs f0, lbl_80563B00@sda21(r2)
/* 803C8C10 003C4A50  D0 1F 00 08 */	stfs f0, 0x8(r31)
/* 803C8C14 003C4A54  C0 02 DB 84 */	lfs f0, lbl_80563B04@sda21(r2)
...
/* 803C8C28 003C4A68  4B D3 7B B9 */	bl lbl_801007E0
/* 803C8C2C 003C4A6C  4B FF A1 1D */	bl lbl_803C2D48
/* 803C8C30 003C4A70  38 80 00 01 */	li r4, 0x1
/* 803C8C34 003C4A74  4B D6 13 BD */	bl lbl_80129FF0
/* 803C8C38 003C4A78  7F E3 FB 78 */	mr r3, r31
/* 803C8C3C 003C4A7C  4B D3 7B A5 */	bl lbl_801007E0
/* 803C8C40 003C4A80  4B DE E8 21 */	bl lbl_801B7460
/* 803C8C44 003C4A84  2C 03 00 05 */	cmpwi r3, 0x5
/* 803C8C48 003C4A88  40 82 00 24 */	bne lbl_803C8C6C
/* 803C8C4C 003C4A8C  C0 02 DB 88 */	lfs f0, lbl_80563B08@sda21(r2)
/* 803C8C50 003C4A90  D0 1F 00 08 */	stfs f0, 0x8(r31)
/* 803C8C54 003C4A94  7F E3 FB 78 */	mr r3, r31
/* 803C8C58 003C4A98  4B D3 7B 89 */	bl lbl_801007E0
/* 803C8C5C 003C4A9C  4B FF A0 E5 */	bl lbl_803C2D40
/* 803C8C60 003C4AA0  38 80 00 01 */	li r4, 0x1
/* 803C8C64 003C4AA4  4B EA A0 E9 */	bl lbl_80272D4C
/* 803C8C68 003C4AA8  48 00 00 94 */	b lbl_803C8CFC
.global lbl_803C8C6C
lbl_803C8C6C:
/* 803C8C6C 003C4AAC  7F E3 FB 78 */	mr r3, r31
/* 803C8C70 003C4AB0  4B D3 7B 71 */	bl lbl_801007E0
/* 803C8C74 003C4AB4  4B FF A0 75 */	bl lbl_803C2CE8
/* 803C8C78 003C4AB8  4B EA 88 71 */	bl lbl_802714E8
...
/* 803C8C9C 003C4ADC  3C A0 80 49 */	lis r5, lbl_80492648@ha
/* 803C8CA0 003C4AE0  38 A5 26 48 */	addi r5, r5, lbl_80492648@l
/* 803C8CA4 003C4AE4  4B DC 7A 8D */	bl lbl_80190730
/* 803C8CA8 003C4AE8  38 61 00 18 */	addi r3, r1, 0x18
/* 803C8CAC 003C4AEC  38 80 FF FF */	li r4, -0x1
/* 803C8CB0 003C4AF0  4B DB 32 99 */	bl lbl_8017BF48
/* 803C8CB4 003C4AF4  38 61 00 40 */	addi r3, r1, 0x40
/* 803C8CB8 003C4AF8  38 81 00 28 */	addi r4, r1, 0x28
/* 803C8CBC 003C4AFC  4B DC A1 71 */	bl lbl_80192E2C
...
/* 803C8CDC 003C4B1C  4B D3 7B 05 */	bl lbl_801007E0
/* 803C8CE0 003C4B20  4B FF A0 11 */	bl lbl_803C2CF0
/* 803C8CE4 003C4B24  38 80 01 32 */	li r4, 0x132
/* 803C8CE8 003C4B28  38 A1 00 08 */	addi r5, r1, 0x8
/* 803C8CEC 003C4B2C  4B EA 52 6D */	bl lbl_8026DF58
/* 803C8CF0 003C4B30  38 61 00 28 */	addi r3, r1, 0x28
/* 803C8CF4 003C4B34  38 80 FF FF */	li r4, -0x1
/* 803C8CF8 003C4B38  4B DB 39 99 */	bl lbl_8017C690
.global lbl_803C8CFC
lbl_803C8CFC:
/* 803C8CFC 003C4B3C  7F E3 FB 78 */	mr r3, r31
/* 803C8D00 003C4B40  4B D3 7A E1 */	bl lbl_801007E0
/* 803C8D04 003C4B44  38 80 00 01 */	li r4, 0x1
/* 803C8D08 003C4B48  4B FF 9E E5 */	bl lbl_803C2BEC
...
/* 803C8D38 003C4B78  4B D3 7A A9 */	bl lbl_801007E0
/* 803C8D3C 003C4B7C  4B FF 9E 21 */	bl lbl_803C2B5C
...
/* 803C8D4C 003C4B8C  C0 02 DB 8C */	lfs f0, lbl_80563B0C@sda21(r2)
/* 803C8D50 003C4B90  EC 21 00 2A */	fadds f1, f1, f0
/* 803C8D54 003C4B94  D0 3F 00 08 */	stfs f1, 0x8(r31)
/* 803C8D58 003C4B98  C0 02 DB 90 */	lfs f0, lbl_80563B10@sda21(r2)
...
/* 803C8DA0 003C4BE0  4B D3 7A 41 */	bl lbl_801007E0
/* 803C8DA4 003C4BE4  4B FF 9F 05 */	bl lbl_803C2CA8
...
/* 803C8DBC 003C4BFC  C0 02 DB 98 */	lfs f0, lbl_80563B18@sda21(r2)
/* 803C8DC0 003C4C00  EC 20 00 72 */	fmuls f1, f0, f1
/* 803C8DC4 003C4C04  C0 02 DB 94 */	lfs f0, lbl_80563B14@sda21(r2)
/* 803C8DC8 003C4C08  EC 20 00 72 */	fmuls f1, f0, f1
/* 803C8DCC 003C4C0C  4B D3 5C D5 */	bl lbl_800FEAA0
/* 803C8DD0 003C4C10  C0 02 DB 9C */	lfs f0, lbl_80563B1C@sda21(r2)
/* 803C8DD4 003C4C14  EF E0 00 72 */	fmuls f31, f0, f1
/* 803C8DD8 003C4C18  7F E3 FB 78 */	mr r3, r31
/* 803C8DDC 003C4C1C  4B D3 7A 05 */	bl lbl_801007E0
/* 803C8DE0 003C4C20  4B FF 9E F9 */	bl lbl_803C2CD8
/* 803C8DE4 003C4C24  7C 64 1B 78 */	mr r4, r3
/* 803C8DE8 003C4C28  38 61 00 10 */	addi r3, r1, 0x10
/* 803C8DEC 003C4C2C  4B DB 37 DD */	bl lbl_8017C5C8
/* 803C8DF0 003C4C30  7F E3 FB 78 */	mr r3, r31
/* 803C8DF4 003C4C34  4B D3 79 ED */	bl lbl_801007E0
/* 803C8DF8 003C4C38  7C 64 1B 78 */	mr r4, r3
/* 803C8DFC 003C4C3C  38 61 00 08 */	addi r3, r1, 0x8
/* 803C8E00 003C4C40  4B E9 AD 35 */	bl lbl_80263B34
...
/* 803C8E14 003C4C54  4B D3 79 CD */	bl lbl_801007E0
/* 803C8E18 003C4C58  4B FF 9E C1 */	bl lbl_803C2CD8
/* 803C8E1C 003C4C5C  38 81 00 10 */	addi r4, r1, 0x10
/* 803C8E20 003C4C60  4B DD 1B 85 */	bl lbl_8019A9A4
...
.global lbl_803C8E44
lbl_803C8E44:
/* 803C8E44 003C4C84  4B FF E5 C4 */	b lbl_803C7408
