...
/* 802C6CAC 002C2AEC  4B FC 71 19 */	bl lbl_8028DDC4
/* 802C6CB0 002C2AF0  3C 60 80 48 */	lis r3, lbl_804794D0@ha
/* 802C6CB4 002C2AF4  38 03 94 D0 */	addi r0, r3, lbl_804794D0@l
...
/* 802C6CC8 002C2B08  4B E5 A1 A9 */	bl lbl_80120E70
...
/* 802C6CEC 002C2B2C  C0 22 BD D8 */	lfs f1, lbl_80561D58@sda21(r2)
/* 802C6CF0 002C2B30  FC 40 08 90 */	fmr f2, f1
/* 802C6CF4 002C2B34  C0 62 BD DC */	lfs f3, lbl_80561D5C@sda21(r2)
/* 802C6CF8 002C2B38  4B ED 4C BD */	bl lbl_8019B9B4
/* 802C6CFC 002C2B3C  38 7E 00 08 */	addi r3, r30, 0x8
/* 802C6D00 002C2B40  38 81 00 2C */	addi r4, r1, 0x2c
/* 802C6D04 002C2B44  4B EB 58 49 */	bl lbl_8017C54C
/* 802C6D08 002C2B48  48 00 00 94 */	b lbl_802C6D9C
.global lbl_802C6D0C
lbl_802C6D0C:
/* 802C6D0C 002C2B4C  38 61 00 20 */	addi r3, r1, 0x20
/* 802C6D10 002C2B50  C0 22 BD E0 */	lfs f1, lbl_80561D60@sda21(r2)
/* 802C6D14 002C2B54  FC 40 08 90 */	fmr f2, f1
/* 802C6D18 002C2B58  C0 62 BD DC */	lfs f3, lbl_80561D5C@sda21(r2)
/* 802C6D1C 002C2B5C  4B ED 4C 99 */	bl lbl_8019B9B4
/* 802C6D20 002C2B60  38 7E 00 08 */	addi r3, r30, 0x8
/* 802C6D24 002C2B64  38 81 00 20 */	addi r4, r1, 0x20
/* 802C6D28 002C2B68  4B EB 58 25 */	bl lbl_8017C54C
/* 802C6D2C 002C2B6C  48 00 00 70 */	b lbl_802C6D9C
.global lbl_802C6D30
lbl_802C6D30:
/* 802C6D30 002C2B70  38 61 00 14 */	addi r3, r1, 0x14
/* 802C6D34 002C2B74  C0 22 BD E4 */	lfs f1, lbl_80561D64@sda21(r2)
/* 802C6D38 002C2B78  FC 40 08 90 */	fmr f2, f1
/* 802C6D3C 002C2B7C  C0 62 BD DC */	lfs f3, lbl_80561D5C@sda21(r2)
/* 802C6D40 002C2B80  4B ED 4C 75 */	bl lbl_8019B9B4
/* 802C6D44 002C2B84  38 7E 00 08 */	addi r3, r30, 0x8
/* 802C6D48 002C2B88  38 81 00 14 */	addi r4, r1, 0x14
/* 802C6D4C 002C2B8C  4B EB 58 01 */	bl lbl_8017C54C
/* 802C6D50 002C2B90  48 00 00 4C */	b lbl_802C6D9C
.global lbl_802C6D54
lbl_802C6D54:
/* 802C6D54 002C2B94  38 61 00 08 */	addi r3, r1, 0x8
/* 802C6D58 002C2B98  C0 22 BD E8 */	lfs f1, lbl_80561D68@sda21(r2)
/* 802C6D5C 002C2B9C  FC 40 08 90 */	fmr f2, f1
/* 802C6D60 002C2BA0  C0 62 BD DC */	lfs f3, lbl_80561D5C@sda21(r2)
/* 802C6D64 002C2BA4  4B ED 4C 51 */	bl lbl_8019B9B4
/* 802C6D68 002C2BA8  38 7E 00 08 */	addi r3, r30, 0x8
/* 802C6D6C 002C2BAC  38 81 00 08 */	addi r4, r1, 0x8
/* 802C6D70 002C2BB0  4B EB 57 DD */	bl lbl_8017C54C
/* 802C6D74 002C2BB4  7F C3 F3 78 */	mr r3, r30
/* 802C6D78 002C2BB8  4B E3 9A 69 */	bl lbl_801007E0
/* 802C6D7C 002C2BBC  4B FC 13 09 */	bl lbl_80288084
/* 802C6D80 002C2BC0  4B FC 57 F5 */	bl lbl_8028C574
/* 802C6D84 002C2BC4  C3 E3 00 94 */	lfs f31, 0x94(r3)
/* 802C6D88 002C2BC8  7F C3 F3 78 */	mr r3, r30
/* 802C6D8C 002C2BCC  4B E3 9A 55 */	bl lbl_801007E0
/* 802C6D90 002C2BD0  4B FC 13 D5 */	bl lbl_80288164
/* 802C6D94 002C2BD4  FC 20 F8 90 */	fmr f1, f31
/* 802C6D98 002C2BD8  4B ED 46 29 */	bl lbl_8019B3C0
.global lbl_802C6D9C
lbl_802C6D9C:
/* 802C6D9C 002C2BDC  7F C3 F3 78 */	mr r3, r30
/* 802C6DA0 002C2BE0  4B E3 9A 41 */	bl lbl_801007E0
/* 802C6DA4 002C2BE4  4B FC 13 11 */	bl lbl_802880B4
/* 802C6DA8 002C2BE8  4B ED 31 21 */	bl lbl_80199EC8
/* 802C6DAC 002C2BEC  7F C3 F3 78 */	mr r3, r30
/* 802C6DB0 002C2BF0  4B E3 9A 31 */	bl lbl_801007E0
/* 802C6DB4 002C2BF4  4B FC 13 19 */	bl lbl_802880CC
/* 802C6DB8 002C2BF8  38 80 00 03 */	li r4, 0x3
/* 802C6DBC 002C2BFC  4B FA A4 C1 */	bl lbl_8027127C
/* 802C6DC0 002C2C00  7F C3 F3 78 */	mr r3, r30
/* 802C6DC4 002C2C04  4B E3 9A 1D */	bl lbl_801007E0
/* 802C6DC8 002C2C08  4B FC 13 05 */	bl lbl_802880CC
/* 802C6DCC 002C2C0C  C0 3E 00 08 */	lfs f1, 0x8(r30)
/* 802C6DD0 002C2C10  C0 02 BD D8 */	lfs f0, lbl_80561D58@sda21(r2)
/* 802C6DD4 002C2C14  EC 21 00 24 */	fdivs f1, f1, f0
/* 802C6DD8 002C2C18  4B FA A4 B9 */	bl lbl_80271290
/* 802C6DDC 002C2C1C  7F C3 F3 78 */	mr r3, r30
/* 802C6DE0 002C2C20  4B E3 9A 01 */	bl lbl_801007E0
/* 802C6DE4 002C2C24  4B FC 13 B9 */	bl lbl_8028819C
/* 802C6DE8 002C2C28  4B FB 82 59 */	bl lbl_8027F040
...
.global lbl_802C6E14
lbl_802C6E14:
/* 802C6E14 002C2C54  4B FC AB A4 */	b lbl_802919B8
...
/* 802C6E30 002C2C70  4B E3 99 B1 */	bl lbl_801007E0
/* 802C6E34 002C2C74  4B FC 12 51 */	bl lbl_80288084
/* 802C6E38 002C2C78  4B FC 5C B9 */	bl lbl_8028CAF0
/* 802C6E3C 002C2C7C  7C 7E 1B 78 */	mr r30, r3
/* 802C6E40 002C2C80  7F E3 FB 78 */	mr r3, r31
/* 802C6E44 002C2C84  4B E3 99 9D */	bl lbl_801007E0
/* 802C6E48 002C2C88  4B FC 13 4D */	bl lbl_80288194
/* 802C6E4C 002C2C8C  4B FF EC 79 */	bl lbl_802C5AC4
/* 802C6E50 002C2C90  7C 7D 1B 78 */	mr r29, r3
/* 802C6E54 002C2C94  7F E3 FB 78 */	mr r3, r31
/* 802C6E58 002C2C98  4B E3 99 89 */	bl lbl_801007E0
/* 802C6E5C 002C2C9C  4B E5 A0 05 */	bl lbl_80120E60
...
/* 802C6E6C 002C2CAC  4B FF F0 6D */	bl lbl_802C5ED8
.global lbl_802C6E70
lbl_802C6E70:
...
/* 802C6E8C 002C2CCC  4B E3 99 55 */	bl lbl_801007E0
/* 802C6E90 002C2CD0  4B FC 12 35 */	bl lbl_802880C4
/* 802C6E94 002C2CD4  4B ED 45 09 */	bl lbl_8019B39C
/* 802C6E98 002C2CD8  7F E3 FB 78 */	mr r3, r31
/* 802C6E9C 002C2CDC  4B E3 99 45 */	bl lbl_801007E0
/* 802C6EA0 002C2CE0  4B FC 12 25 */	bl lbl_802880C4
/* 802C6EA4 002C2CE4  C0 3E 00 28 */	lfs f1, 0x28(r30)
/* 802C6EA8 002C2CE8  4B ED 44 D9 */	bl lbl_8019B380
/* 802C6EAC 002C2CEC  7F E3 FB 78 */	mr r3, r31
/* 802C6EB0 002C2CF0  4B E3 99 31 */	bl lbl_801007E0
/* 802C6EB4 002C2CF4  4B FC 12 29 */	bl lbl_802880DC
/* 802C6EB8 002C2CF8  38 80 02 02 */	li r4, 0x202
/* 802C6EBC 002C2CFC  48 13 BE 19 */	bl lbl_80402CD4
/* 802C6EC0 002C2D00  7F A3 EB 78 */	mr r3, r29
/* 802C6EC4 002C2D04  38 80 00 01 */	li r4, 0x1
/* 802C6EC8 002C2D08  4B EF 03 65 */	bl lbl_801B722C
/* 802C6ECC 002C2D0C  7F A3 EB 78 */	mr r3, r29
/* 802C6ED0 002C2D10  4B FF F0 51 */	bl lbl_802C5F20
...
/* 802C6EE0 002C2D20  4B E3 99 01 */	bl lbl_801007E0
/* 802C6EE4 002C2D24  4B FC 11 C9 */	bl lbl_802880AC
/* 802C6EE8 002C2D28  4B EB A7 ED */	bl lbl_801816D4
...
/* 802C6EF8 002C2D38  4B E3 98 E9 */	bl lbl_801007E0
/* 802C6EFC 002C2D3C  4B FC 11 B1 */	bl lbl_802880AC
/* 802C6F00 002C2D40  7F C4 F3 78 */	mr r4, r30
/* 802C6F04 002C2D44  4B ED 17 7D */	bl lbl_80198680
.global lbl_802C6F08
lbl_802C6F08:
/* 802C6F08 002C2D48  7F A3 EB 78 */	mr r3, r29
/* 802C6F0C 002C2D4C  38 80 00 01 */	li r4, 0x1
/* 802C6F10 002C2D50  4B FF F0 29 */	bl lbl_802C5F38
/* 802C6F14 002C2D54  7F E3 FB 78 */	mr r3, r31
/* 802C6F18 002C2D58  4B E3 98 C9 */	bl lbl_801007E0
/* 802C6F1C 002C2D5C  7C 7E 1B 78 */	mr r30, r3
/* 802C6F20 002C2D60  7F E3 FB 78 */	mr r3, r31
/* 802C6F24 002C2D64  4B E3 98 BD */	bl lbl_801007E0
/* 802C6F28 002C2D68  4B FC 12 7D */	bl lbl_802881A4
/* 802C6F2C 002C2D6C  7C 7F 1B 78 */	mr r31, r3
/* 802C6F30 002C2D70  48 13 EF D1 */	bl lbl_80405F00
...
/* 802C6F48 002C2D88  4B F6 F9 21 */	bl lbl_80236868
/* 802C6F4C 002C2D8C  3C 60 80 48 */	lis r3, lbl_80479470@ha
/* 802C6F50 002C2D90  38 03 94 70 */	addi r0, r3, lbl_80479470@l
...
.global lbl_802C6F78
lbl_802C6F78:
/* 802C6F78 002C2DB8  4B FC AA A0 */	b lbl_80291A18
...
/* 802C6F94 002C2DD4  4B E3 98 4D */	bl lbl_801007E0
/* 802C6F98 002C2DD8  4B FC 11 FD */	bl lbl_80288194
/* 802C6F9C 002C2DDC  4B FF EB 29 */	bl lbl_802C5AC4
/* 802C6FA0 002C2DE0  7C 7D 1B 78 */	mr r29, r3
/* 802C6FA4 002C2DE4  7F E3 FB 78 */	mr r3, r31
/* 802C6FA8 002C2DE8  4B E3 98 39 */	bl lbl_801007E0
/* 802C6FAC 002C2DEC  4B FC 11 51 */	bl lbl_802880FC
/* 802C6FB0 002C2DF0  7C 64 1B 78 */	mr r4, r3
/* 802C6FB4 002C2DF4  38 61 00 08 */	addi r3, r1, 0x8
/* 802C6FB8 002C2DF8  4B FC 3C E1 */	bl lbl_8028AC98
/* 802C6FBC 002C2DFC  3B C0 00 00 */	li r30, 0x0
/* 802C6FC0 002C2E00  7F E3 FB 78 */	mr r3, r31
/* 802C6FC4 002C2E04  4B E3 98 1D */	bl lbl_801007E0
/* 802C6FC8 002C2E08  4B FC 11 9D */	bl lbl_80288164
/* 802C6FCC 002C2E0C  4B FA 67 4D */	bl lbl_8026D718
...
/* 802C6FDC 002C2E1C  4B E3 98 05 */	bl lbl_801007E0
/* 802C6FE0 002C2E20  4B FC 10 D5 */	bl lbl_802880B4
/* 802C6FE4 002C2E24  4B EB A6 F1 */	bl lbl_801816D4
...
/* 802C700C 002C2E4C  4B E3 97 D5 */	bl lbl_801007E0
/* 802C7010 002C2E50  C0 22 BD EC */	lfs f1, lbl_80561D6C@sda21(r2)
/* 802C7014 002C2E54  4B FC 7E F1 */	bl lbl_8028EF04
...
/* 802C7024 002C2E64  4B FF EE FD */	bl lbl_802C5F20
...
/* 802C7034 002C2E74  4B E3 97 AD */	bl lbl_801007E0
/* 802C7038 002C2E78  4B FC 10 75 */	bl lbl_802880AC
/* 802C703C 002C2E7C  4B EB A6 99 */	bl lbl_801816D4
...
/* 802C704C 002C2E8C  4B E3 97 95 */	bl lbl_801007E0
/* 802C7050 002C2E90  4B FC 10 5D */	bl lbl_802880AC
/* 802C7054 002C2E94  7F C4 F3 78 */	mr r4, r30
/* 802C7058 002C2E98  4B ED 16 29 */	bl lbl_80198680
/* 802C705C 002C2E9C  7F A3 EB 78 */	mr r3, r29
/* 802C7060 002C2EA0  38 80 00 00 */	li r4, 0x0
/* 802C7064 002C2EA4  4B FF EE D5 */	bl lbl_802C5F38
.global lbl_802C7068
lbl_802C7068:
...
/* 802C7078 002C2EB8  4B E3 97 69 */	bl lbl_801007E0
/* 802C707C 002C2EBC  4B FC 10 49 */	bl lbl_802880C4
/* 802C7080 002C2EC0  4B ED 43 29 */	bl lbl_8019B3A8
/* 802C7084 002C2EC4  48 00 00 50 */	b lbl_802C70D4
.global lbl_802C7088
lbl_802C7088:
/* 802C7088 002C2EC8  7F E3 FB 78 */	mr r3, r31
/* 802C708C 002C2ECC  4B E3 97 55 */	bl lbl_801007E0
/* 802C7090 002C2ED0  7C 7E 1B 78 */	mr r30, r3
/* 802C7094 002C2ED4  7F E3 FB 78 */	mr r3, r31
/* 802C7098 002C2ED8  4B E3 97 49 */	bl lbl_801007E0
/* 802C709C 002C2EDC  4B FC 11 09 */	bl lbl_802881A4
/* 802C70A0 002C2EE0  7C 7F 1B 78 */	mr r31, r3
/* 802C70A4 002C2EE4  48 13 EE 5D */	bl lbl_80405F00
...
/* 802C70BC 002C2EFC  4B F6 F7 AD */	bl lbl_80236868
/* 802C70C0 002C2F00  3C 60 80 47 */	lis r3, lbl_80471E40@ha
/* 802C70C4 002C2F04  38 03 1E 40 */	addi r0, r3, lbl_80471E40@l
