...
/* 80383340 0037F180  90 1D 00 00 */	stw r0, 0x0(r29)
/* 80383344 0037F184  3B E0 00 00 */	li r31, 0x0
/* 80383348 0037F188  93 FD 00 08 */	stw r31, 0x8(r29)
...
/* 80383360 0037F1A0  3C A0 80 55 */	lis r5, "TARGET_OFFSET__29@unnamed@StateWarpStarIn_cpp@"@ha
/* 80383364 0037F1A4  38 A5 33 18 */	addi r5, r5, "TARGET_OFFSET__29@unnamed@StateWarpStarIn_cpp@"@l
...
/* 80383378 0037F1B8  C0 02 D5 30 */	lfs f0, "@60734"@sda21(r2)
/* 8038337C 0037F1BC  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 80383380 0037F1C0  C0 02 D5 34 */	lfs f0, "@60735"@sda21(r2)
/* 80383384 0037F1C4  D0 01 00 2C */	stfs f0, 0x2c(r1)
/* 80383388 0037F1C8  C0 02 D5 38 */	lfs f0, "@60736"@sda21(r2)
...
/* 803833CC 0037F20C  38 80 00 01 */	li r4, 0x1
...
/* 803833E4 0037F224  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80383414 0037F254  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8038345C 0037F29C  38 80 00 01 */	li r4, 0x1
...
/* 80383470 0037F2B0  38 80 00 00 */	li r4, 0x0
...
/* 80383484 0037F2C4  38 80 00 00 */	li r4, 0x0
...
/* 80383498 0037F2D8  38 80 00 00 */	li r4, 0x0
...
/* 803834A8 0037F2E8  38 80 00 00 */	li r4, 0x0
...
/* 803834B8 0037F2F8  38 80 00 00 */	li r4, 0x0
...
/* 803834C8 0037F308  38 80 00 00 */	li r4, 0x0
...
/* 803834DC 0037F31C  38 80 00 00 */	li r4, 0x0
...
/* 803834F0 0037F330  38 80 00 00 */	li r4, 0x0
...
/* 80383514 0037F354  38 80 00 01 */	li r4, 0x1
...
/* 8038352C 0037F36C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80383578 0037F3B8  38 80 00 01 */	li r4, 0x1
...
/* 8038358C 0037F3CC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8038359C 0037F3DC  38 8D CF 28 */	addi r4, r13, "@60737"@sda21
/* 803835A0 0037F3E0  38 A1 00 6C */	addi r5, r1, 0x6c
/* 803835A4 0037F3E4  38 60 00 00 */	li r3, 0x0
/* 803835A8 0037F3E8  38 00 00 05 */	li r0, 0x5
/* 803835AC 0037F3EC  7C 09 03 A6 */	mtctr r0
.global lbl_803835B0
lbl_803835B0:
/* 803835B0 0037F3F0  90 65 00 04 */	stw r3, 0x4(r5)
/* 803835B4 0037F3F4  94 65 00 08 */	stwu r3, 0x8(r5)
...
/* 803835C4 0037F404  4B E1 A3 F9 */	bl "Strncpy__Q33hel6common9Traits<c>FPcPCcUl"
/* 803835C8 0037F408  38 A1 00 AC */	addi r5, r1, 0xac
/* 803835CC 0037F40C  38 81 00 6C */	addi r4, r1, 0x6c
/* 803835D0 0037F410  38 00 00 05 */	li r0, 0x5
/* 803835D4 0037F414  7C 09 03 A6 */	mtctr r0
.global lbl_803835D8
lbl_803835D8:
/* 803835D8 0037F418  80 64 00 04 */	lwz r3, 0x4(r4)
/* 803835DC 0037F41C  84 04 00 08 */	lwzu r0, 0x8(r4)
/* 803835E0 0037F420  90 65 00 04 */	stw r3, 0x4(r5)
/* 803835E4 0037F424  94 05 00 08 */	stwu r0, 0x8(r5)
...
/* 803835FC 0037F43C  3C 80 80 49 */	lis r4, "@60738"@ha
/* 80383600 0037F440  38 84 CC 80 */	addi r4, r4, "@60738"@l
...
/* 80383628 0037F468  81 84 00 00 */	lwz r12, 0x0(r4)
...
/* 80383640 0037F480  38 AD CF 30 */	addi r5, r13, "@60739"@sda21
...
/* 8038369C 0037F4DC  38 80 00 01 */	li r4, 0x1
...
/* 803836BC 0037F4FC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803836DC 0037F51C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803836F4 0037F534  38 80 00 00 */	li r4, 0x0
...
/* 80383734 0037F574  38 61 00 08 */	addi r3, r1, 0x8
...
/* 80383744 0037F584  C0 01 00 08 */	lfs f0, 0x8(r1)
...
/* 8038378C 0037F5CC  C0 42 D5 3C */	lfs f2, "@60740"@sda21(r2)
...
/* 803837D0 0037F610  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803837D4 0037F614  7C 7E 1B 78 */	mr r30, r3
/* 803837D8 0037F618  7C 9F 23 78 */	mr r31, r4
/* 803837DC 0037F61C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80383808 0037F648  38 80 00 00 */	li r4, 0x0
...
/* 8038383C 0037F67C  38 80 00 01 */	li r4, 0x1
...
/* 8038384C 0037F68C  38 80 00 01 */	li r4, 0x1
...
/* 80383860 0037F6A0  38 80 00 01 */	li r4, 0x1
...
/* 80383874 0037F6B4  38 80 00 01 */	li r4, 0x1
...
/* 80383888 0037F6C8  38 80 00 01 */	li r4, 0x1
...
/* 8038389C 0037F6DC  38 80 00 01 */	li r4, 0x1
...
/* 803838B4 0037F6F4  38 80 00 01 */	li r4, 0x1
...
/* 803838C4 0037F704  38 80 00 01 */	li r4, 0x1
...
/* 803838D8 0037F718  38 80 00 00 */	li r4, 0x0
...
/* 803838EC 0037F72C  38 80 00 00 */	li r4, 0x0
...
/* 80383900 0037F740  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80383944 0037F784  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80383980 0037F7C0  90 03 00 08 */	stw r0, 0x8(r3)
...
/* 8038398C 0037F7CC  2C 03 00 00 */	cmpwi r3, 0x0
/* 80383990 0037F7D0  41 82 00 28 */	beq lbl_803839B8
/* 80383994 0037F7D4  80 1F 00 08 */	lwz r0, 0x8(r31)
...
.global lbl_803839B8
lbl_803839B8:
/* 803839B8 0037F7F8  80 1F 00 08 */	lwz r0, 0x8(r31)
...
/* 803839CC 0037F80C  90 61 00 08 */	stw r3, 0x8(r1)
...
/* 803839DC 0037F81C  C3 E2 D5 38 */	lfs f31, "@60736"@sda21(r2)
...
/* 80383A08 0037F848  2C 03 00 00 */	cmpwi r3, 0x0
/* 80383A0C 0037F84C  40 82 00 20 */	bne lbl_80383A2C
/* 80383A10 0037F850  C0 01 00 08 */	lfs f0, 0x8(r1)
/* 80383A14 0037F854  C0 22 D5 40 */	lfs f1, "@60835"@sda21(r2)
/* 80383A18 0037F858  EC 00 08 2A */	fadds f0, f0, f1
/* 80383A1C 0037F85C  D0 01 00 08 */	stfs f0, 0x8(r1)
...
/* 80383A38 0037F878  38 81 00 08 */	addi r4, r1, 0x8
...
/* 80383A4C 0037F88C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80383A60 0037F8A0  38 63 00 08 */	addi r3, r3, 0x8
...
/* 80383A7C 0037F8BC  38 63 00 04 */	addi r3, r3, 0x4
...
/* 80383AB4 0037F8F4  C0 22 D5 44 */	lfs f1, "@60836"@sda21(r2)
...
/* 80383AD4 0037F914  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80383B04 0037F944  2C 04 00 00 */	cmpwi r4, 0x0
/* 80383B08 0037F948  41 82 00 2C */	beq lbl_80383B34
/* 80383B0C 0037F94C  3C 60 80 46 */	lis r3, "__vt__Q24util28StateFactory<Q24util6IState>"@ha
/* 80383B10 0037F950  38 03 44 78 */	addi r0, r3, "__vt__Q24util28StateFactory<Q24util6IState>"@l
/* 80383B14 0037F954  90 04 00 00 */	stw r0, 0x0(r4)
/* 80383B18 0037F958  38 1F 00 90 */	addi r0, r31, 0x90
/* 80383B1C 0037F95C  90 04 00 04 */	stw r0, 0x4(r4)
/* 80383B20 0037F960  3C 60 80 49 */	lis r3, "__vt__Q24util102StateFactoryArg2<Q24util6IState,Q53scn4step4hero7gimmick17StateWarpStarFall,PQ43scn4step4hero4Hero,Ul>"@ha
/* 80383B24 0037F964  38 03 CC 98 */	addi r0, r3, "__vt__Q24util102StateFactoryArg2<Q24util6IState,Q53scn4step4hero7gimmick17StateWarpStarFall,PQ43scn4step4hero4Hero,Ul>"@l
/* 80383B28 0037F968  90 04 00 00 */	stw r0, 0x0(r4)
/* 80383B2C 0037F96C  93 C4 00 08 */	stw r30, 0x8(r4)
...
/* 80383B7C 0037F9BC  F3 E1 00 48 */	psq_st f31, 0x48(r1), 0, qr0
...
/* 80383B90 0037F9D0  2C 03 00 00 */	cmpwi r3, 0x0
/* 80383B94 0037F9D4  41 82 00 80 */	beq lbl_80383C14
/* 80383B98 0037F9D8  80 7F 00 08 */	lwz r3, 0x8(r31)
/* 80383B9C 0037F9DC  28 03 00 0A */	cmplwi r3, 0xa
/* 80383BA0 0037F9E0  40 81 00 74 */	ble lbl_80383C14
/* 80383BA4 0037F9E4  38 03 FF F6 */	addi r0, r3, -0xa
/* 80383BA8 0037F9E8  C8 22 D5 50 */	lfd f1, "@60851"@sda21(r2)
...
/* 80383BC0 0037FA00  C0 02 D5 48 */	lfs f0, "@60848"@sda21(r2)
/* 80383BC4 0037FA04  EC 21 00 24 */	fdivs f1, f1, f0
/* 80383BC8 0037FA08  C0 02 D5 3C */	lfs f0, "@60740"@sda21(r2)
/* 80383BCC 0037FA0C  EF E0 08 28 */	fsubs f31, f0, f1
/* 80383BD0 0037FA10  38 61 00 08 */	addi r3, r1, 0x8
...
/* 80383BF8 0037FA38  38 A1 00 08 */	addi r5, r1, 0x8
...
/* 80383C50 0037FA90  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80383C6C 0037FAAC  38 61 00 08 */	addi r3, r1, 0x8
...
/* 80383C80 0037FAC0  38 81 00 08 */	addi r4, r1, 0x8
...
.global "create__Q24util102StateFactoryArg2<Q24util6IState,Q53scn4step4hero7gimmick17StateWarpStarFall,PQ43scn4step4hero4Hero,Ul>Fv"
"create__Q24util102StateFactoryArg2<Q24util6IState,Q53scn4step4hero7gimmick17StateWarpStarFall,PQ43scn4step4hero4Hero,Ul>Fv":
/* 80383C9C 0037FADC  7C 65 1B 78 */	mr r5, r3
/* 80383CA0 0037FAE0  80 63 00 04 */	lwz r3, 0x4(r3)
/* 80383CA4 0037FAE4  2C 03 00 00 */	cmpwi r3, 0x0
/* 80383CA8 0037FAE8  4D 82 00 20 */	beqlr
/* 80383CAC 0037FAEC  80 85 00 08 */	lwz r4, 0x8(r5)
...
.global "__dt__Q24util102StateFactoryArg2<Q24util6IState,Q53scn4step4hero7gimmick17StateWarpStarFall,PQ43scn4step4hero4Hero,Ul>Fv"
