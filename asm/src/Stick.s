...
/* 801A477C 001A05BC  38 00 00 00 */	li r0, 0
/* 801A4780 001A05C0  90 03 00 04 */	stw r0, 4(r3)
/* 801A4784 001A05C4  90 03 00 08 */	stw r0, 8(r3)
/* 801A4788 001A05C8  4E 80 00 20 */	blr 

.global update__Q23hid5StickFii
update__Q23hid5StickFii:
/* 801A478C 001A05CC  90 83 00 04 */	stw r4, 4(r3)
/* 801A4790 001A05D0  90 A3 00 08 */	stw r5, 8(r3)
...
/* 801A47A0 001A05E0  90 01 00 08 */	stw r0, 8(r1)
/* 801A47A4 001A05E4  3C 00 43 30 */	lis r0, 0x4330
/* 801A47A8 001A05E8  90 01 00 10 */	stw r0, 0x10(r1)
/* 801A47AC 001A05EC  80 A4 00 00 */	lwz r5, 0(r4)
/* 801A47B0 001A05F0  80 04 00 08 */	lwz r0, 8(r4)
/* 801A47B4 001A05F4  C8 42 99 B0 */	lfd f2, $$249704-_SDA2_BASE_(r2)
/* 801A47B8 001A05F8  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 801A47BC 001A05FC  90 01 00 0C */	stw r0, 0xc(r1)
/* 801A47C0 001A0600  C8 01 00 08 */	lfd f0, 8(r1)
...
/* 801A4800 001A0640  D0 03 00 00 */	stfs f0, 0(r3)
/* 801A4804 001A0644  D0 63 00 04 */	stfs f3, 4(r3)
