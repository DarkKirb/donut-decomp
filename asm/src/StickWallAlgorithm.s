...
/* 803D8CBC 003D4AFC  90 83 00 00 */	stw r4, 0(r3)
...
lbl_803D8D44:
/* 803D8D44 003D4B84  88 01 00 09 */	lbz r0, 9(r1)
/* 803D8D48 003D4B88  2C 00 00 00 */	cmpwi r0, 0
/* 803D8D4C 003D4B8C  41 82 00 14 */	beq lbl_803D8D60
/* 803D8D50 003D4B90  80 7F 00 00 */	lwz r3, 0(r31)
/* 803D8D54 003D4B94  48 00 23 ED */	bl landConstraint__Q43scn4step6weapon6WeaponFv
/* 803D8D58 003D4B98  38 80 00 04 */	li r4, 4
...
/* 803D8D94 003D4BD4  80 63 00 00 */	lwz r3, 0(r3)
...
/* 803D8DA4 003D4BE4  2C 03 00 00 */	cmpwi r3, 0
/* 803D8DA8 003D4BE8  41 82 00 54 */	beq lbl_803D8DFC
/* 803D8DAC 003D4BEC  38 61 00 08 */	addi r3, r1, 8
...
/* 803D8DEC 003D4C2C  80 7E 00 00 */	lwz r3, 0(r30)
