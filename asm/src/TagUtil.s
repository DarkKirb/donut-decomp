...
/* 801AFE04 001ABC44  4B E5 75 41 */	bl func_80007344
/* 801AFE08 001ABC48  7C 7D 1B 78 */	mr r29, r3
/* 801AFE0C 001ABC4C  7C 9F 23 78 */	mr r31, r4
lbl_801AFE10:
/* 801AFE10 001ABC50  A0 9F 00 00 */	lhz r4, 0(r31)
...
/* 801AFE50 001ABC90  38 03 00 04 */	addi r0, r3, 4
/* 801AFE54 001ABC94  54 1E 04 3E */	clrlwi r30, r0, 0x10
...
lbl_801AFEC4:
/* 801AFEC4 001ABD04  3B C0 00 01 */	li r30, 1
/* 801AFEC8 001ABD08  7F A3 EB 78 */	mr r3, r29
/* 801AFECC 001ABD0C  81 83 00 00 */	lwz r12, 0(r3)
...
/* 801AFEEC 001ABD2C  4B E5 74 A5 */	bl func_80007390
...
/* 801AFF20 001ABD60  90 01 00 08 */	stw r0, 8(r1)
/* 801AFF24 001ABD64  38 00 00 00 */	li r0, 0
/* 801AFF28 001ABD68  90 01 00 0C */	stw r0, 0xc(r1)
/* 801AFF2C 001ABD6C  38 61 00 08 */	addi r3, r1, 8
...
/* 801AFF60 001ABDA0  90 01 00 08 */	stw r0, 8(r1)
/* 801AFF64 001ABDA4  B0 81 00 0C */	sth r4, 0xc(r1)
/* 801AFF68 001ABDA8  38 00 FF FF */	li r0, -1
/* 801AFF6C 001ABDAC  90 01 00 10 */	stw r0, 0x10(r1)
/* 801AFF70 001ABDB0  38 00 00 00 */	li r0, 0
/* 801AFF74 001ABDB4  90 01 00 14 */	stw r0, 0x14(r1)
/* 801AFF78 001ABDB8  38 61 00 08 */	addi r3, r1, 8
...
/* 801AFF98 001ABDD8  A0 03 00 00 */	lhz r0, 0(r3)
/* 801AFF9C 001ABDDC  B0 04 00 00 */	sth r0, 0(r4)
/* 801AFFA0 001ABDE0  A0 03 00 02 */	lhz r0, 2(r3)
/* 801AFFA4 001ABDE4  B0 05 00 00 */	sth r0, 0(r5)
/* 801AFFA8 001ABDE8  A0 03 00 04 */	lhz r0, 4(r3)
/* 801AFFAC 001ABDEC  B0 06 00 00 */	sth r0, 0(r6)
/* 801AFFB0 001ABDF0  38 03 00 06 */	addi r0, r3, 6
/* 801AFFB4 001ABDF4  90 07 00 00 */	stw r0, 0(r7)
/* 801AFFB8 001ABDF8  4E 80 00 20 */	blr 

.global ParseEndTag__Q23lyt7TagUtilFPCwRUsRUs
ParseEndTag__Q23lyt7TagUtilFPCwRUsRUs:
/* 801AFFBC 001ABDFC  A0 03 00 00 */	lhz r0, 0(r3)
/* 801AFFC0 001ABE00  B0 04 00 00 */	sth r0, 0(r4)
/* 801AFFC4 001ABE04  A0 03 00 02 */	lhz r0, 2(r3)
/* 801AFFC8 001ABE08  B0 05 00 00 */	sth r0, 0(r5)
...
/* 801AFFD0 001ABE10  A0 03 00 00 */	lhz r0, 0(r3)
/* 801AFFD4 001ABE14  54 00 F8 7E */	srwi r0, r0, 1
/* 801AFFD8 001ABE18  54 00 04 3E */	clrlwi r0, r0, 0x10
/* 801AFFDC 001ABE1C  B0 04 00 00 */	sth r0, 0(r4)
/* 801AFFE0 001ABE20  A0 03 00 02 */	lhz r0, 2(r3)
/* 801AFFE4 001ABE24  54 00 F8 7E */	srwi r0, r0, 1
/* 801AFFE8 001ABE28  54 00 04 3E */	clrlwi r0, r0, 0x10
/* 801AFFEC 001ABE2C  B0 05 00 00 */	sth r0, 0(r5)
/* 801AFFF0 001ABE30  38 63 00 04 */	addi r3, r3, 4
/* 801AFFF4 001ABE34  90 66 00 00 */	stw r3, 0(r6)
/* 801AFFF8 001ABE38  A0 05 00 00 */	lhz r0, 0(r5)
/* 801AFFFC 001ABE3C  54 00 08 3C */	slwi r0, r0, 1
/* 801B0000 001ABE40  7C 03 02 14 */	add r0, r3, r0
/* 801B0004 001ABE44  90 07 00 00 */	stw r0, 0(r7)
/* 801B0008 001ABE48  4E 80 00 20 */	blr 

.global SkipStartTag__Q23lyt7TagUtilFPQ34nw4r2ut15PrintContext$$0w$$1
SkipStartTag__Q23lyt7TagUtilFPQ34nw4r2ut15PrintContext$$0w$$1:
/* 801B000C 001ABE4C  80 A3 00 04 */	lwz r5, 4(r3)
/* 801B0010 001ABE50  A0 05 00 04 */	lhz r0, 4(r5)
/* 801B0014 001ABE54  54 04 F8 7E */	srwi r4, r0, 1
/* 801B0018 001ABE58  38 04 00 03 */	addi r0, r4, 3
/* 801B001C 001ABE5C  54 00 08 3C */	slwi r0, r0, 1
/* 801B0020 001ABE60  7C 05 02 14 */	add r0, r5, r0
/* 801B0024 001ABE64  90 03 00 04 */	stw r0, 4(r3)
/* 801B0028 001ABE68  4E 80 00 20 */	blr 

.global Append__Q23lyt7TagUtilFRQ33hel6common17FixedWString$$0384$$1PCw
Append__Q23lyt7TagUtilFRQ33hel6common17FixedWString$$0384$$1PCw:
...
/* 801B003C 001ABE7C  4B E5 73 09 */	bl func_80007344
...
/* 801B006C 001ABEAC  48 00 00 1D */	bl Append__Q23lyt7TagUtilFRQ33hel6common17FixedWString$$0384$$1UlPCwUl
/* 801B0070 001ABEB0  39 61 00 20 */	addi r11, r1, 0x20
/* 801B0074 001ABEB4  4B E5 73 1D */	bl func_80007390
...
.global Append__Q23lyt7TagUtilFRQ33hel6common17FixedWString$$0384$$1UlPCwUl
Append__Q23lyt7TagUtilFRQ33hel6common17FixedWString$$0384$$1UlPCwUl:
/* 801B0088 001ABEC8  54 80 08 3C */	slwi r0, r4, 1
/* 801B008C 001ABECC  7C 83 02 14 */	add r4, r3, r0
/* 801B0090 001ABED0  38 60 00 00 */	li r3, 0
/* 801B0094 001ABED4  7C C9 03 A6 */	mtctr r6
/* 801B0098 001ABED8  28 06 00 00 */	cmplwi r6, 0
...
/* 801B00A8 001ABEE8  38 63 00 02 */	addi r3, r3, 2
/* 801B00AC 001ABEEC  42 00 FF F4 */	bdnz lbl_801B00A0
lbl_801B00B0:
/* 801B00B0 001ABEF0  38 60 00 00 */	li r3, 0
...
/* 801B00C0 001ABF00  80 03 00 08 */	lwz r0, 8(r3)
/* 801B00C4 001ABF04  2C 00 FF FF */	cmpwi r0, -1
/* 801B00C8 001ABF08  40 82 00 1C */	bne lbl_801B00E4
/* 801B00CC 001ABF0C  54 84 04 3E */	clrlwi r4, r4, 0x10
/* 801B00D0 001ABF10  A0 03 00 04 */	lhz r0, 4(r3)
...
/* 801B00E0 001ABF20  90 03 00 08 */	stw r0, 8(r3)
lbl_801B00E4:
/* 801B00E4 001ABF24  80 83 00 0C */	lwz r4, 0xc(r3)
/* 801B00E8 001ABF28  38 04 00 01 */	addi r0, r4, 1
...
/* 801B0108 001ABF48  80 83 00 04 */	lwz r4, 4(r3)
/* 801B010C 001ABF4C  38 04 00 01 */	addi r0, r4, 1
/* 801B0110 001ABF50  90 03 00 04 */	stw r0, 4(r3)
...
/* 801B0118 001ABF58  80 03 00 04 */	lwz r0, 4(r3)
/* 801B011C 001ABF5C  7C 00 2A 14 */	add r0, r0, r5
/* 801B0120 001ABF60  90 03 00 04 */	stw r0, 4(r3)
