...
.global lbl_801B11D8
lbl_801B11D8:
/* 801B11D8 001AD018  C0 22 9A 40 */	lfs f1, lbl_8055F9C0@sda21(r2)
/* 801B11DC 001AD01C  4E 80 00 20 */	blr
.global lbl_801B11E0
lbl_801B11E0:
/* 801B11E0 001AD020  C0 22 9A 44 */	lfs f1, lbl_8055F9C4@sda21(r2)
...
/* 801B11F4 001AD034  4B FE 65 71 */	bl lbl_80197764
/* 801B11F8 001AD038  C8 22 9A 50 */	lfd f1, lbl_8055F9D0@sda21(r2)
...
/* 801B1210 001AD050  C0 02 9A 48 */	lfs f0, lbl_8055F9C8@sda21(r2)
...
/* 801B1234 001AD074  4B FE 65 5D */	bl lbl_80197790
/* 801B1238 001AD078  C8 22 9A 50 */	lfd f1, lbl_8055F9D0@sda21(r2)
...
/* 801B1250 001AD090  C0 02 9A 48 */	lfs f0, lbl_8055F9C8@sda21(r2)
...
.global lbl_801B1268
lbl_801B1268:
/* 801B1268 001AD0A8  C0 02 9A 58 */	lfs f0, lbl_8055F9D8@sda21(r2)
/* 801B126C 001AD0AC  D0 03 00 00 */	stfs f0, 0x0(r3)
/* 801B1270 001AD0B0  D0 03 00 04 */	stfs f0, 0x4(r3)
/* 801B1274 001AD0B4  C0 02 9A 5C */	lfs f0, lbl_8055F9DC@sda21(r2)
...
/* 801B1298 001AD0D8  4B FF FF D1 */	bl lbl_801B1268
/* 801B129C 001AD0DC  7F E3 FB 78 */	mr r3, r31
/* 801B12A0 001AD0E0  38 81 00 08 */	addi r4, r1, 0x8
/* 801B12A4 001AD0E4  3C A0 80 54 */	lis r5, lbl_805452F4@ha
/* 801B12A8 001AD0E8  38 A5 52 F4 */	addi r5, r5, lbl_805452F4@l
/* 801B12AC 001AD0EC  3C C0 80 54 */	lis r6, lbl_805452D0@ha
/* 801B12B0 001AD0F0  38 C6 52 D0 */	addi r6, r6, lbl_805452D0@l
/* 801B12B4 001AD0F4  4B FE D4 FD */	bl lbl_8019E7B0
...
/* 801B12F8 001AD138  4B FE D9 19 */	bl lbl_8019EC10
/* 801B12FC 001AD13C  4B FF FF 2D */	bl lbl_801B1228
/* 801B1300 001AD140  C0 01 00 0C */	lfs f0, 0xc(r1)
/* 801B1304 001AD144  EF E0 00 72 */	fmuls f31, f0, f1
/* 801B1308 001AD148  4B FF FE E1 */	bl lbl_801B11E8
...
/* 801B1350 001AD190  4B FF FE 99 */	bl lbl_801B11E8
/* 801B1354 001AD194  FF E0 08 90 */	fmr f31, f1
/* 801B1358 001AD198  4B FF FE D1 */	bl lbl_801B1228
...
/* 801B136C 001AD1AC  C0 A2 9A 40 */	lfs f5, lbl_8055F9C0@sda21(r2)
/* 801B1370 001AD1B0  C0 C2 9A 44 */	lfs f6, lbl_8055F9C4@sda21(r2)
/* 801B1374 001AD1B4  4B FE D7 B5 */	bl lbl_8019EB28
/* 801B1378 001AD1B8  38 61 00 08 */	addi r3, r1, 0x8
/* 801B137C 001AD1BC  38 80 00 00 */	li r4, 0x0
/* 801B1380 001AD1C0  4B FE 3C D5 */	bl lbl_80195054
/* 801B1384 001AD1C4  38 60 00 00 */	li r3, 0x0
/* 801B1388 001AD1C8  38 80 00 07 */	li r4, 0x7
/* 801B138C 001AD1CC  38 A0 00 00 */	li r5, 0x0
/* 801B1390 001AD1D0  4B E8 74 91 */	bl lbl_80038820
