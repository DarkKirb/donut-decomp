...
/* 801CCFA0 001C8DE0  4B E3 A3 8D */	bl func_8000732C
...
/* 801CCFBC 001C8DFC  90 1D 00 00 */	stw r0, 0(r29)
/* 801CCFC0 001C8E00  83 5F 00 00 */	lwz r26, 0(r31)
/* 801CCFC4 001C8E04  4B FF D0 15 */	bl allocator__Q26mintvm8VMObjectFv
/* 801CCFC8 001C8E08  90 7D 00 04 */	stw r3, 4(r29)
/* 801CCFCC 001C8E0C  93 5D 00 08 */	stw r26, 8(r29)
/* 801CCFD0 001C8E10  3B 20 00 00 */	li r25, 0
...
/* 801CCFE0 001C8E20  81 83 00 00 */	lwz r12, 0(r3)
...
/* 801CCFF4 001C8E34  38 A0 00 00 */	li r5, 0
...
/* 801CD008 001C8E48  38 A5 00 01 */	addi r5, r5, 1
/* 801CD00C 001C8E4C  38 63 00 04 */	addi r3, r3, 4
lbl_801CD010:
/* 801CD010 001C8E50  80 1D 00 08 */	lwz r0, 8(r29)
/* 801CD014 001C8E54  7C 05 00 40 */	cmplw r5, r0
/* 801CD018 001C8E58  41 80 FF E8 */	blt lbl_801CD000
/* 801CD01C 001C8E5C  3A E0 00 00 */	li r23, 0
/* 801CD020 001C8E60  3B 80 00 00 */	li r28, 0
...
/* 801CD02C 001C8E6C  3B 60 00 00 */	li r27, 0
...
/* 801CD040 001C8E80  2C 03 00 00 */	cmpwi r3, 0
...
/* 801CD050 001C8E90  80 84 00 04 */	lwz r4, 4(r4)
...
/* 801CD064 001C8EA4  93 58 00 00 */	stw r26, 0(r24)
/* 801CD068 001C8EA8  93 78 00 04 */	stw r27, 4(r24)
/* 801CD06C 001C8EAC  7F C3 F3 78 */	mr r3, r30
/* 801CD070 001C8EB0  80 99 00 00 */	lwz r4, 0(r25)
/* 801CD074 001C8EB4  4B FF 84 FD */	bl labelAddressWithReference__Q25mintx5XDataCFUi
/* 801CD078 001C8EB8  38 03 00 04 */	addi r0, r3, 4
/* 801CD07C 001C8EBC  90 18 00 08 */	stw r0, 8(r24)
/* 801CD080 001C8EC0  9B 78 00 0C */	stb r27, 0xc(r24)
/* 801CD084 001C8EC4  7F C3 F3 78 */	mr r3, r30
/* 801CD088 001C8EC8  80 99 00 04 */	lwz r4, 4(r25)
...
lbl_801CD09C:
/* 801CD09C 001C8EDC  38 7D 00 04 */	addi r3, r29, 4
/* 801CD0A0 001C8EE0  7F 04 C3 78 */	mr r4, r24
/* 801CD0A4 001C8EE4  48 00 00 35 */	bl add__Q26mintvm32MPtrArray$$0Q26mintvm10VMFunction$$1FPQ26mintvm10VMFunction
/* 801CD0A8 001C8EE8  3A F7 00 01 */	addi r23, r23, 1
/* 801CD0AC 001C8EEC  3B 9C 00 04 */	addi r28, r28, 4
lbl_801CD0B0:
/* 801CD0B0 001C8EF0  80 1F 00 00 */	lwz r0, 0(r31)
...
/* 801CD0C4 001C8F04  4B E3 A2 B5 */	bl func_80007378
...
.global add__Q26mintvm32MPtrArray$$0Q26mintvm10VMFunction$$1FPQ26mintvm10VMFunction
add__Q26mintvm32MPtrArray$$0Q26mintvm10VMFunction$$1FPQ26mintvm10VMFunction:
...
/* 801CD0E8 001C8F28  93 C1 00 08 */	stw r30, 8(r1)
/* 801CD0EC 001C8F2C  7C 7E 1B 78 */	mr r30, r3
/* 801CD0F0 001C8F30  7C 9F 23 78 */	mr r31, r4
/* 801CD0F4 001C8F34  80 C3 00 04 */	lwz r6, 4(r3)
/* 801CD0F8 001C8F38  80 03 00 08 */	lwz r0, 8(r3)
/* 801CD0FC 001C8F3C  7C 00 30 40 */	cmplw r0, r6
/* 801CD100 001C8F40  41 80 00 20 */	blt lbl_801CD120
/* 801CD104 001C8F44  3C 60 80 46 */	lis r3, $$2STRING$$2addPtr__Q26mintvm32MPtrArray$$0Q26mintvm10VMFunction$$1FPQ26mintvm10VMFunction@ha
/* 801CD108 001C8F48  38 63 CB 8C */	addi r3, r3, $$2STRING$$2addPtr__Q26mintvm32MPtrArray$$0Q26mintvm10VMFunction$$1FPQ26mintvm10VMFunction@l
/* 801CD10C 001C8F4C  38 80 00 6F */	li r4, 0x6f
/* 801CD110 001C8F50  3C A0 80 46 */	lis r5, $$2STRING$$2addPtr__Q26mintvm32MPtrArray$$0Q26mintvm10VMFunction$$1FPQ26mintvm10VMFunction$$20@ha
/* 801CD114 001C8F54  38 A5 CB 80 */	addi r5, r5, $$2STRING$$2addPtr__Q26mintvm32MPtrArray$$0Q26mintvm10VMFunction$$1FPQ26mintvm10VMFunction$$20@l
/* 801CD118 001C8F58  4C C6 31 82 */	crclr 6
/* 801CD11C 001C8F5C  4B FF 8E 89 */	bl panic__Q26mintvm14MintSystemCallFPCciPCce
lbl_801CD120:
/* 801CD120 001C8F60  80 7E 00 0C */	lwz r3, 0xc(r30)
/* 801CD124 001C8F64  80 1E 00 08 */	lwz r0, 8(r30)
/* 801CD128 001C8F68  54 00 10 3A */	slwi r0, r0, 2
/* 801CD12C 001C8F6C  7F E3 01 2E */	stwx r31, r3, r0
/* 801CD130 001C8F70  80 7E 00 08 */	lwz r3, 8(r30)
/* 801CD134 001C8F74  38 03 00 01 */	addi r0, r3, 1
/* 801CD138 001C8F78  90 1E 00 08 */	stw r0, 8(r30)
/* 801CD13C 001C8F7C  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 801CD140 001C8F80  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 801CD164 001C8FA4  4B E3 A1 DD */	bl func_80007340
...
/* 801CD180 001C8FC0  2C 03 00 00 */	cmpwi r3, 0
...
/* 801CD194 001C8FD4  90 1F 00 00 */	stw r0, 0(r31)
/* 801CD198 001C8FD8  38 00 00 01 */	li r0, 1
/* 801CD19C 001C8FDC  90 1F 00 04 */	stw r0, 4(r31)
/* 801CD1A0 001C8FE0  93 BF 00 08 */	stw r29, 8(r31)
/* 801CD1A4 001C8FE4  38 00 00 00 */	li r0, 0
...
lbl_801CD1B8:
/* 801CD1B8 001C8FF8  38 7C 00 04 */	addi r3, r28, 4
/* 801CD1BC 001C8FFC  7F E4 FB 78 */	mr r4, r31
/* 801CD1C0 001C9000  4B FF FF 19 */	bl add__Q26mintvm32MPtrArray$$0Q26mintvm10VMFunction$$1FPQ26mintvm10VMFunction
/* 801CD1C4 001C9004  7F E3 FB 78 */	mr r3, r31
/* 801CD1C8 001C9008  39 61 00 20 */	addi r11, r1, 0x20
/* 801CD1CC 001C900C  4B E3 A1 C1 */	bl func_8000738C
