...
/* 801CD3F0 001C9230  4B FF CB 3D */	bl lbl_801C9F2C
/* 801CD3F4 001C9234  3C 60 80 46 */	lis r3, lbl_8045CBC8@ha
/* 801CD3F8 001C9238  38 03 CB C8 */	addi r0, r3, lbl_8045CBC8@l
...
/* 801CD40C 001C924C  4B FF CB 21 */	bl lbl_801C9F2C
/* 801CD410 001C9250  3C 60 80 46 */	lis r3, lbl_8045CBD4@ha
/* 801CD414 001C9254  38 03 CB D4 */	addi r0, r3, lbl_8045CBD4@l
/* 801CD418 001C9258  90 1F 00 00 */	stw r0, 0x0(r31)
/* 801CD41C 001C925C  4B FF CB BD */	bl lbl_801C9FD8
...
/* 801CD42C 001C926C  48 00 00 99 */	bl lbl_801CD4C4
/* 801CD430 001C9270  3B DC 00 1C */	addi r30, r28, 0x1c
/* 801CD434 001C9274  7F C3 F3 78 */	mr r3, r30
/* 801CD438 001C9278  4B FF CA F5 */	bl lbl_801C9F2C
/* 801CD43C 001C927C  3C 60 80 46 */	lis r3, lbl_8045CB68@ha
/* 801CD440 001C9280  38 03 CB 68 */	addi r0, r3, lbl_8045CB68@l
/* 801CD444 001C9284  90 1E 00 00 */	stw r0, 0x0(r30)
/* 801CD448 001C9288  4B FF 8C 41 */	bl lbl_801C6088
/* 801CD44C 001C928C  83 A3 00 1C */	lwz r29, 0x1c(r3)
/* 801CD450 001C9290  4B FF CB 89 */	bl lbl_801C9FD8
...
/* 801CD570 001C93B0  4B FF C9 BD */	bl lbl_801C9F2C
/* 801CD574 001C93B4  3C 60 80 46 */	lis r3, lbl_8045CBC8@ha
/* 801CD578 001C93B8  38 03 CB C8 */	addi r0, r3, lbl_8045CBC8@l
...
/* 801CD588 001C93C8  4B FF 7F E5 */	bl lbl_801C556C
...
/* 801CD59C 001C93DC  4B FF 7F D5 */	bl lbl_801C5570
...
/* 801CD5AC 001C93EC  4B FF C9 81 */	bl lbl_801C9F2C
/* 801CD5B0 001C93F0  3C 60 80 46 */	lis r3, lbl_8045CBD4@ha
/* 801CD5B4 001C93F4  38 03 CB D4 */	addi r0, r3, lbl_8045CBD4@l
/* 801CD5B8 001C93F8  90 1A 00 00 */	stw r0, 0x0(r26)
/* 801CD5BC 001C93FC  4B FF CA 1D */	bl lbl_801C9FD8
...
/* 801CD5CC 001C940C  4B FF FE F9 */	bl lbl_801CD4C4
/* 801CD5D0 001C9410  3B 00 00 00 */	li r24, 0x0
/* 801CD5D4 001C9414  3A 80 00 00 */	li r20, 0x0
/* 801CD5D8 001C9418  3C 60 80 46 */	lis r3, lbl_8045CBE0@ha
/* 801CD5DC 001C941C  3B 83 CB E0 */	addi r28, r3, lbl_8045CBE0@l
/* 801CD5E0 001C9420  7E 9D A3 78 */	mr r29, r20
/* 801CD5E4 001C9424  3F C0 80 46 */	lis r30, lbl_8045CBF8@ha
/* 801CD5E8 001C9428  3F E0 80 46 */	lis r31, lbl_8045CBEC@ha
/* 801CD5EC 001C942C  48 00 00 BC */	b lbl_801CD6A8
.global lbl_801CD5F0
lbl_801CD5F0:
/* 801CD5F0 001C9430  4B FF C9 E9 */	bl lbl_801C9FD8
...
/* 801CD620 001C9460  4B FF 7F 51 */	bl lbl_801C5570
/* 801CD624 001C9464  7C 73 1B 78 */	mr r19, r3
/* 801CD628 001C9468  7F 23 CB 78 */	mr r3, r25
/* 801CD62C 001C946C  4B FF C9 01 */	bl lbl_801C9F2C
...
/* 801CD63C 001C947C  4B FF 7F 31 */	bl lbl_801C556C
...
/* 801CD650 001C9490  4B FF 7F 1D */	bl lbl_801C556C
...
/* 801CD670 001C94B0  38 7E CB F8 */	addi r3, r30, lbl_8045CBF8@l
/* 801CD674 001C94B4  38 80 00 6F */	li r4, 0x6f
/* 801CD678 001C94B8  38 BF CB EC */	addi r5, r31, lbl_8045CBEC@l
/* 801CD67C 001C94BC  4C C6 31 82 */	crclr 4*cr1+eq
/* 801CD680 001C94C0  4B FF 89 25 */	bl lbl_801C5FA4
.global lbl_801CD684
lbl_801CD684:
...
/* 801CD6BC 001C94FC  4B FF 7E B5 */	bl lbl_801C5570
...
/* 801CD6CC 001C950C  4B FF F8 C5 */	bl lbl_801CCF90
...
/* 801CD714 001C9554  3F A0 80 46 */	lis r29, lbl_8045CC14@ha
/* 801CD718 001C9558  3F C0 80 46 */	lis r30, lbl_8045CC08@ha
...
/* 801CD728 001C9568  38 7D CC 14 */	addi r3, r29, lbl_8045CC14@l
/* 801CD72C 001C956C  38 80 00 42 */	li r4, 0x42
/* 801CD730 001C9570  38 BE CC 08 */	addi r5, r30, lbl_8045CC08@l
/* 801CD734 001C9574  4C C6 31 82 */	crclr 4*cr1+eq
/* 801CD738 001C9578  4B FF 88 6D */	bl lbl_801C5FA4
.global lbl_801CD73C
lbl_801CD73C:
...
/* 801CD748 001C9588  48 00 06 61 */	bl lbl_801CDDA8
