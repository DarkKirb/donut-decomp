...
/* 8035890C 0035474C  90 03 00 00 */	stw r0, 0(r3)
/* 80358910 00354750  90 83 00 04 */	stw r4, 4(r3)
...
/* 80358960 003547A0  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 80358984 003547C4  93 C1 00 08 */	stw r30, 8(r1)
...
/* 80358998 003547D8  38 03 FF F5 */	addi r0, r3, -11
...
lbl_803589AC:
/* 803589AC 003547EC  3B FF FF FE */	addi r31, r31, -2
/* 803589B0 003547F0  42 00 FF FC */	bdnz lbl_803589AC
lbl_803589B4:
/* 803589B4 003547F4  80 7E 00 04 */	lwz r3, 4(r30)
/* 803589B8 003547F8  4B FE 79 ED */	bl soundSE__Q43scn4step4hero4HeroFv
/* 803589BC 003547FC  38 63 00 04 */	addi r3, r3, 4
/* 803589C0 00354800  57 E0 10 3A */	slwi r0, r31, 2
/* 803589C4 00354804  3C 80 80 42 */	lis r4, SOUND_TABLE__36$$2unnamed$$2VacuumAttackerCallback_cpp$$2@ha
/* 803589C8 00354808  38 84 A3 28 */	addi r4, r4, SOUND_TABLE__36$$2unnamed$$2VacuumAttackerCallback_cpp$$2@l
/* 803589CC 0035480C  7C 84 00 2E */	lwzx r4, r4, r0
/* 803589D0 00354810  48 0A A3 05 */	bl start__Q23snd11SERequestorFUl
/* 803589D4 00354814  80 7E 00 04 */	lwz r3, 4(r30)
...
/* 803589E0 00354820  2C 03 00 00 */	cmpwi r3, 0
/* 803589E4 00354824  41 82 00 84 */	beq lbl_80358A68
/* 803589E8 00354828  80 7E 00 04 */	lwz r3, 4(r30)
...
/* 80358A5C 0035489C  38 A0 00 01 */	li r5, 1
/* 80358A60 003548A0  C0 22 CF 80 */	lfs f1, $$256925-_SDA2_BASE_(r2)
/* 80358A64 003548A4  4B E4 0A 09 */	bl start__Q24gobj4AnimFUlbf
lbl_80358A68:
/* 80358A68 003548A8  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 80358A6C 003548AC  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 80358A94 003548D4  80 63 00 04 */	lwz r3, 4(r3)
...
/* 80358B40 00354980  80 63 00 04 */	lwz r3, 4(r3)
...
/* 80358B78 003549B8  80 63 00 04 */	lwz r3, 4(r3)
