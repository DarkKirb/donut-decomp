...
/* 803C55A0 003C13E0  48 00 DB 1D */	bl lbl_803D30BC
/* 803C55A4 003C13E4  3C 60 80 49 */	lis r3, lbl_80491F58@ha
/* 803C55A8 003C13E8  38 03 1F 58 */	addi r0, r3, lbl_80491F58@l
...
/* 803C55C0 003C1400  4B E7 49 C5 */	bl lbl_80239F84
...
.global lbl_803C55E0
lbl_803C55E0:
/* 803C55E0 003C1420  4B E7 08 44 */	b lbl_80235E24
.global lbl_803C55E4
lbl_803C55E4:
...
/* 803C5614 003C1454  4B CB 01 1D */	bl lbl_80075730
/* 803C5618 003C1458  4B E5 B6 0D */	bl lbl_80220C24
/* 803C561C 003C145C  38 80 00 00 */	li r4, 0x0
/* 803C5620 003C1460  7F E5 FB 78 */	mr r5, r31
/* 803C5624 003C1464  48 00 D2 4D */	bl lbl_803D2870
/* 803C5628 003C1468  48 00 00 1C */	b lbl_803C5644
.global lbl_803C562C
lbl_803C562C:
/* 803C562C 003C146C  80 63 00 18 */	lwz r3, 0x18(r3)
/* 803C5630 003C1470  4B CB 01 01 */	bl lbl_80075730
/* 803C5634 003C1474  4B E5 B5 F1 */	bl lbl_80220C24
/* 803C5638 003C1478  38 80 00 00 */	li r4, 0x0
/* 803C563C 003C147C  7F E5 FB 78 */	mr r5, r31
/* 803C5640 003C1480  48 00 D2 DD */	bl lbl_803D291C
.global lbl_803C5644
lbl_803C5644:
...
/* 803C56F4 003C1534  4B FF D6 5D */	bl lbl_803C2D50
/* 803C56F8 003C1538  7C 7F 1B 78 */	mr r31, r3
/* 803C56FC 003C153C  48 04 08 05 */	bl lbl_80405F00
...
/* 803C570C 003C154C  3C 60 80 46 */	lis r3, lbl_80464478@ha
/* 803C5710 003C1550  38 03 44 78 */	addi r0, r3, lbl_80464478@l
...
/* 803C5720 003C1560  3C 60 80 49 */	lis r3, lbl_80491F48@ha
/* 803C5724 003C1564  38 03 1F 48 */	addi r0, r3, lbl_80491F48@l
...
/* 803C573C 003C157C  4B FF D6 15 */	bl lbl_803C2D50
/* 803C5740 003C1580  48 04 06 39 */	bl lbl_80405D78
...
/* 803C5778 003C15B8  4B DC 2F 51 */	bl lbl_801886C8
...
/* 803C5878 003C16B8  4B FF FD E1 */	bl lbl_803C5658
.global lbl_803C587C
lbl_803C587C:
...
/* 803C58B4 003C16F4  4B D6 38 ED */	bl lbl_801291A0
...
/* 803C58C4 003C1704  4B FF D2 E1 */	bl lbl_803C2BA4
...
/* 803C58D4 003C1714  4B FF D3 21 */	bl lbl_803C2BF4
...
/* 803C58EC 003C172C  4B DC 2D DD */	bl lbl_801886C8
...
/* 803C5908 003C1748  48 00 02 39 */	bl lbl_803C5B40
...
/* 803C5924 003C1764  4B DD A5 19 */	bl lbl_8019FE3C
...
/* 803C5948 003C1788  4B DD A4 F5 */	bl lbl_8019FE3C
...
/* 803C596C 003C17AC  4B DD A4 D1 */	bl lbl_8019FE3C
...
/* 803C5990 003C17D0  4B DD A4 AD */	bl lbl_8019FE3C
...
/* 803C59A4 003C17E4  4B DD A4 99 */	bl lbl_8019FE3C
...
/* 803C5A34 003C1874  80 02 DA D8 */	lwz r0, lbl_80563A58@sda21(r2)
/* 803C5A38 003C1878  90 01 00 08 */	stw r0, 0x8(r1)
/* 803C5A3C 003C187C  38 61 00 40 */	addi r3, r1, 0x40
/* 803C5A40 003C1880  48 00 01 01 */	bl lbl_803C5B40
...
/* 803C5A50 003C1890  C0 62 DA DC */	lfs f3, lbl_80563A5C@sda21(r2)
/* 803C5A54 003C1894  4B CF 86 6D */	bl lbl_800BE0C0
...
/* 803C5A64 003C18A4  C0 62 DA DC */	lfs f3, lbl_80563A5C@sda21(r2)
/* 803C5A68 003C18A8  4B CF 86 59 */	bl lbl_800BE0C0
...
/* 803C5A78 003C18B8  C0 62 DA DC */	lfs f3, lbl_80563A5C@sda21(r2)
/* 803C5A7C 003C18BC  4B CF 86 45 */	bl lbl_800BE0C0
...
/* 803C5A8C 003C18CC  C0 62 DA DC */	lfs f3, lbl_80563A5C@sda21(r2)
/* 803C5A90 003C18D0  4B CF 86 31 */	bl lbl_800BE0C0
/* 803C5A94 003C18D4  38 61 00 50 */	addi r3, r1, 0x50
/* 803C5A98 003C18D8  4B C6 AA 49 */	bl lbl_800304E0
...
/* 803C5AA8 003C18E8  4B DC F8 3D */	bl lbl_801952E4
...
/* 803C5AC0 003C1900  4B DC FA A5 */	bl lbl_80195564
...
/* 803C5AD0 003C1910  4B DC F8 15 */	bl lbl_801952E4
...
/* 803C5AE0 003C1920  C0 22 DA E0 */	lfs f1, lbl_80563A60@sda21(r2)
/* 803C5AE4 003C1924  4B DC FC C5 */	bl lbl_801957A8
...
/* 803C5AF4 003C1934  C0 22 DA E0 */	lfs f1, lbl_80563A60@sda21(r2)
/* 803C5AF8 003C1938  4B DC FC B1 */	bl lbl_801957A8
...
/* 803C5B08 003C1948  C0 22 DA E0 */	lfs f1, lbl_80563A60@sda21(r2)
/* 803C5B0C 003C194C  4B DC FC 9D */	bl lbl_801957A8
...
/* 803C5B1C 003C195C  C0 22 DA E0 */	lfs f1, lbl_80563A60@sda21(r2)
/* 803C5B20 003C1960  4B DC FC 89 */	bl lbl_801957A8
/* 803C5B24 003C1964  38 61 00 40 */	addi r3, r1, 0x40
/* 803C5B28 003C1968  38 80 FF FF */	li r4, -0x1
/* 803C5B2C 003C196C  4B DD A3 11 */	bl lbl_8019FE3C
...
/* 803C5B58 003C1998  4B FF D1 81 */	bl lbl_803C2CD8
/* 803C5B5C 003C199C  7C 64 1B 78 */	mr r4, r3
/* 803C5B60 003C19A0  38 61 00 10 */	addi r3, r1, 0x10
/* 803C5B64 003C19A4  4B DB 6A 65 */	bl lbl_8017C5C8
...
/* 803C5B7C 003C19BC  C0 22 DA E4 */	lfs f1, lbl_80563A64@sda21(r2)
/* 803C5B80 003C19C0  C0 42 DA E8 */	lfs f2, lbl_80563A68@sda21(r2)
/* 803C5B84 003C19C4  FC 60 10 90 */	fmr f3, f2
/* 803C5B88 003C19C8  FC 80 08 90 */	fmr f4, f1
/* 803C5B8C 003C19CC  4B DD A2 19 */	bl lbl_8019FDA4
...
/* 803C5B9C 003C19DC  4B DD A2 A5 */	bl lbl_8019FE40
/* 803C5BA0 003C19E0  7F E3 FB 78 */	mr r3, r31
/* 803C5BA4 003C19E4  C0 22 DA DC */	lfs f1, lbl_80563A5C@sda21(r2)
/* 803C5BA8 003C19E8  C0 42 DA EC */	lfs f2, lbl_80563A6C@sda21(r2)
/* 803C5BAC 003C19EC  4B DD A2 95 */	bl lbl_8019FE40
...
/* 803C5BDC 003C1A1C  48 00 2C F0 */	b lbl_803C88CC
/* 803C5BE0 003C1A20  4E 80 00 20 */	blr

.global lbl_803C5BE4
lbl_803C5BE4:
/* 803C5BE4 003C1A24  4B E6 8A BC */	b lbl_8022E6A0
