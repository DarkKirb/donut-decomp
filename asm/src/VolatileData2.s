...
/* 804051B0 00400FF0  93 C1 00 08 */	stw r30, 8(r1)
/* 804051B4 00400FF4  7C 7E 1B 78 */	mr r30, r3
/* 804051B8 00400FF8  8B E3 00 00 */	lbz r31, 0(r3)
/* 804051BC 00400FFC  4B FF FF D9 */	bl init__Q27storage13VolatileData2Fv
/* 804051C0 00401000  9B FE 00 00 */	stb r31, 0(r30)
/* 804051C4 00401004  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 804051C8 00401008  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 804051E0 00401020  38 A1 00 04 */	addi r5, r1, 4
/* 804051E4 00401024  38 80 00 00 */	li r4, 0
/* 804051E8 00401028  38 00 02 09 */	li r0, 0x209
/* 804051EC 0040102C  7C 09 03 A6 */	mtctr r0
lbl_804051F0:
/* 804051F0 00401030  90 85 00 04 */	stw r4, 4(r5)
/* 804051F4 00401034  94 85 00 08 */	stwu r4, 8(r5)
/* 804051F8 00401038  42 00 FF F8 */	bdnz lbl_804051F0
/* 804051FC 0040103C  80 01 00 08 */	lwz r0, 8(r1)
/* 80405200 00401040  90 03 00 0C */	stw r0, 0xc(r3)
/* 80405204 00401044  38 C3 00 0C */	addi r6, r3, 0xc
/* 80405208 00401048  38 A1 00 08 */	addi r5, r1, 8
/* 8040520C 0040104C  38 00 01 E0 */	li r0, 0x1e0
/* 80405210 00401050  7C 09 03 A6 */	mtctr r0
lbl_80405214:
/* 80405214 00401054  80 85 00 04 */	lwz r4, 4(r5)
/* 80405218 00401058  84 05 00 08 */	lwzu r0, 8(r5)
/* 8040521C 0040105C  90 86 00 04 */	stw r4, 4(r6)
/* 80405220 00401060  94 06 00 08 */	stwu r0, 8(r6)
...
lbl_80405240:
/* 80405240 00401080  80 64 00 04 */	lwz r3, 4(r4)
/* 80405244 00401084  84 04 00 08 */	lwzu r0, 8(r4)
/* 80405248 00401088  90 65 00 04 */	stw r3, 4(r5)
/* 8040524C 0040108C  94 05 00 08 */	stwu r0, 8(r5)
...
/* 8040526C 004010AC  4B C0 20 D9 */	bl func_80007344
...
/* 80405280 004010C0  2C 03 00 00 */	cmpwi r3, 0
/* 80405284 004010C4  40 82 00 44 */	bne lbl_804052C8
/* 80405288 004010C8  80 1D 00 00 */	lwz r0, 0(r29)
...
/* 8040529C 004010DC  93 C3 00 04 */	stw r30, 4(r3)
/* 804052A0 004010E0  80 1D 00 00 */	lwz r0, 0(r29)
/* 804052A4 004010E4  1C 00 00 0C */	mulli r0, r0, 0xc
/* 804052A8 004010E8  7C 7D 02 14 */	add r3, r29, r0
/* 804052AC 004010EC  C0 1F 00 00 */	lfs f0, 0(r31)
/* 804052B0 004010F0  D0 03 00 08 */	stfs f0, 8(r3)
/* 804052B4 004010F4  C0 1F 00 04 */	lfs f0, 4(r31)
/* 804052B8 004010F8  D0 03 00 0C */	stfs f0, 0xc(r3)
/* 804052BC 004010FC  80 7D 00 00 */	lwz r3, 0(r29)
/* 804052C0 00401100  38 03 00 01 */	addi r0, r3, 1
/* 804052C4 00401104  90 1D 00 00 */	stw r0, 0(r29)
lbl_804052C8:
/* 804052C8 00401108  39 61 00 20 */	addi r11, r1, 0x20
/* 804052CC 0040110C  4B C0 20 C5 */	bl func_80007390
...
/* 804052E0 00401120  38 C0 00 00 */	li r6, 0
/* 804052E4 00401124  80 03 00 00 */	lwz r0, 0(r3)
/* 804052E8 00401128  7C 09 03 A6 */	mtctr r0
/* 804052EC 0040112C  28 00 00 00 */	cmplwi r0, 0
/* 804052F0 00401130  40 81 00 44 */	ble lbl_80405334
lbl_804052F4:
/* 804052F4 00401134  7C E3 32 14 */	add r7, r3, r6
/* 804052F8 00401138  80 07 00 04 */	lwz r0, 4(r7)
/* 804052FC 0040113C  7C 00 20 00 */	cmpw r0, r4
/* 80405300 00401140  40 82 00 2C */	bne lbl_8040532C
/* 80405304 00401144  C0 27 00 08 */	lfs f1, 8(r7)
/* 80405308 00401148  C0 05 00 00 */	lfs f0, 0(r5)
...
lbl_80405334:
/* 80405334 00401174  38 60 00 00 */	li r3, 0
...
/* 80405374 004011B4  88 05 00 00 */	lbz r0, 0(r5)
/* 80405378 004011B8  98 07 0F 0C */	stb r0, 0xf0c(r7)
/* 8040537C 004011BC  88 05 00 01 */	lbz r0, 1(r5)
/* 80405380 004011C0  98 07 0F 0D */	stb r0, 0xf0d(r7)
/* 80405384 004011C4  A0 05 00 02 */	lhz r0, 2(r5)
/* 80405388 004011C8  B0 07 0F 0E */	sth r0, 0xf0e(r7)
/* 8040538C 004011CC  88 05 00 04 */	lbz r0, 4(r5)
/* 80405390 004011D0  98 07 0F 10 */	stb r0, 0xf10(r7)
/* 80405394 004011D4  88 05 00 05 */	lbz r0, 5(r5)
/* 80405398 004011D8  98 07 0F 11 */	stb r0, 0xf11(r7)
/* 8040539C 004011DC  88 05 00 06 */	lbz r0, 6(r5)
/* 804053A0 004011E0  98 07 0F 12 */	stb r0, 0xf12(r7)
/* 804053A4 004011E4  80 C5 00 08 */	lwz r6, 8(r5)
...
/* 804053B4 004011F4  88 A5 00 00 */	lbz r5, 0(r5)
...
/* 8040541C 0040125C  38 60 00 01 */	li r3, 1
...
lbl_8040542C:
/* 8040542C 0040126C  38 60 00 00 */	li r3, 0
...
/* 80405434 00401274  38 00 00 00 */	li r0, 0
...
/* 80405474 004012B4  99 03 00 00 */	stb r8, 0(r3)
/* 80405478 004012B8  88 09 0F 0D */	lbz r0, 0xf0d(r9)
/* 8040547C 004012BC  98 03 00 01 */	stb r0, 1(r3)
/* 80405480 004012C0  A0 09 0F 0E */	lhz r0, 0xf0e(r9)
/* 80405484 004012C4  B0 03 00 02 */	sth r0, 2(r3)
/* 80405488 004012C8  88 09 0F 10 */	lbz r0, 0xf10(r9)
/* 8040548C 004012CC  98 03 00 04 */	stb r0, 4(r3)
/* 80405490 004012D0  88 09 0F 11 */	lbz r0, 0xf11(r9)
/* 80405494 004012D4  98 03 00 05 */	stb r0, 5(r3)
/* 80405498 004012D8  88 09 0F 12 */	lbz r0, 0xf12(r9)
/* 8040549C 004012DC  98 03 00 06 */	stb r0, 6(r3)
/* 804054A0 004012E0  C0 09 0F 14 */	lfs f0, 0xf14(r9)
/* 804054A4 004012E4  D0 03 00 08 */	stfs f0, 8(r3)
...
lbl_804054BC:
/* 804054BC 004012FC  38 80 00 00 */	li r4, 0
/* 804054C0 00401300  90 83 00 00 */	stw r4, 0(r3)
/* 804054C4 00401304  90 83 00 04 */	stw r4, 4(r3)
/* 804054C8 00401308  90 83 00 08 */	stw r4, 8(r3)
/* 804054CC 0040130C  90 83 00 0C */	stw r4, 0xc(r3)
/* 804054D0 00401310  38 00 FF FF */	li r0, -1
/* 804054D4 00401314  98 03 00 00 */	stb r0, 0(r3)
/* 804054D8 00401318  98 83 00 01 */	stb r4, 1(r3)
/* 804054DC 0040131C  98 83 00 04 */	stb r4, 4(r3)
/* 804054E0 00401320  98 83 00 05 */	stb r4, 5(r3)
/* 804054E4 00401324  98 83 00 06 */	stb r4, 6(r3)
/* 804054E8 00401328  C0 02 E3 F0 */	lfs f0, $$249921-_SDA2_BASE_(r2)
/* 804054EC 0040132C  D0 03 00 08 */	stfs f0, 8(r3)
...
/* 804054F8 00401338  80 03 00 04 */	lwz r0, 4(r3)
/* 804054FC 0040133C  7C 00 20 00 */	cmpw r0, r4
/* 80405500 00401340  4C 80 00 20 */	bgelr 
/* 80405504 00401344  90 83 00 04 */	stw r4, 4(r3)
