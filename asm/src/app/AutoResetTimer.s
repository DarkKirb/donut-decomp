...
/* 80176730 00172570  38 00 00 00 */	li r0, 0x0
/* 80176734 00172574  98 1F 00 08 */	stb r0, 0x8(r31)
...
/* 80176768 001725A8  88 03 00 08 */	lbz r0, 0x8(r3)
/* 8017676C 001725AC  2C 00 00 00 */	cmpwi r0, 0x0
/* 80176770 001725B0  41 82 00 7C */	beq lbl_801767EC
/* 80176774 001725B4  3B E0 00 00 */	li r31, 0x0
.global lbl_80176778
lbl_80176778:
/* 80176778 001725B8  80 6D ED 18 */	lwz r3, "object___Q33hel6common37ExplicitSingleton<Q23hid10HIDManager>"@sda21(r13)
...
/* 80176788 001725C8  38 61 00 08 */	addi r3, r1, 0x8
/* 8017678C 001725CC  48 02 C0 6D */	bl button__Q23hid11HIDAccessorCFv
/* 80176790 001725D0  38 61 00 08 */	addi r3, r1, 0x8
/* 80176794 001725D4  4B EF EF 9D */	bl GKI_getfirst
/* 80176798 001725D8  2C 03 00 00 */	cmpwi r3, 0x0
/* 8017679C 001725DC  41 82 00 0C */	beq lbl_801767A8
/* 801767A0 001725E0  38 00 00 01 */	li r0, 0x1
/* 801767A4 001725E4  48 00 00 14 */	b lbl_801767B8
.global lbl_801767A8
lbl_801767A8:
/* 801767A8 001725E8  3B FF 00 01 */	addi r31, r31, 0x1
/* 801767AC 001725EC  28 1F 00 04 */	cmplwi r31, 0x4
/* 801767B0 001725F0  41 80 FF C8 */	blt lbl_80176778
/* 801767B4 001725F4  38 00 00 00 */	li r0, 0x0
.global lbl_801767B8
lbl_801767B8:
/* 801767B8 001725F8  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 801767D8 00172618  2C 03 00 00 */	cmpwi r3, 0x0
/* 801767DC 0017261C  41 82 00 10 */	beq lbl_801767EC
/* 801767E0 00172620  80 6D ED 10 */	lwz r3, "object___Q33hel6common38ExplicitSingleton<Q23app11Application>"@sda21(r13)
