...
/* 80191C90 0018DAD0  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 80191C98 0018DAD8  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 80191CA0 0018DAE0  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 80191CA8 0018DAE8  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 80191CB0 0018DAF0  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 80191CB8 0018DAF8  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 80191CC0 0018DB00  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 80191CDC 0018DB1C  80 63 00 00 */	lwz r3, 0x0(r3)
/* 80191CE0 0018DB20  4B FF EC FD */	bl setFrame__Q23g3d9ModelAnimFf
/* 80191CE4 0018DB24  80 7F 00 04 */	lwz r3, 0x4(r31)
/* 80191CE8 0018DB28  7F E4 FB 78 */	mr r4, r31
/* 80191CEC 0018DB2C  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80191D24 0018DB64  80 63 00 00 */	lwz r3, 0x0(r3)
/* 80191D28 0018DB68  4B FF EC F1 */	bl setFrameToHead__Q23g3d9ModelAnimFv
/* 80191D2C 0018DB6C  80 7F 00 04 */	lwz r3, 0x4(r31)
/* 80191D30 0018DB70  7F E4 FB 78 */	mr r4, r31
/* 80191D34 0018DB74  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80191D6C 0018DBAC  80 63 00 00 */	lwz r3, 0x0(r3)
/* 80191D70 0018DBB0  4B FF EC B1 */	bl setFrameToTail__Q23g3d9ModelAnimFv
/* 80191D74 0018DBB4  80 7F 00 04 */	lwz r3, 0x4(r31)
/* 80191D78 0018DBB8  7F E4 FB 78 */	mr r4, r31
/* 80191D7C 0018DBBC  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80191DA0 0018DBE0  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 80191DA8 0018DBE8  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 80191DB0 0018DBF0  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 80191DB8 0018DBF8  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 80191DD0 0018DC10  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 80191DE0 0018DC20  2C 03 00 00 */	cmpwi r3, 0x0
/* 80191DE4 0018DC24  41 82 00 14 */	beq lbl_80191DF8
/* 80191DE8 0018DC28  80 7E 00 00 */	lwz r3, 0x0(r30)
...
/* 80191DFC 0018DC3C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80191E20 0018DC60  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 80191E30 0018DC70  2C 03 00 00 */	cmpwi r3, 0x0
/* 80191E34 0018DC74  41 82 00 14 */	beq lbl_80191E48
/* 80191E38 0018DC78  80 7E 00 00 */	lwz r3, 0x0(r30)
...
/* 80191E4C 0018DC8C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80191E60 0018DCA0  88 0D ED 88 */	lbz r0, "@GUARD@Instance__Q23g3d34NullModelAnimAccessorEventReceiverFv@obj"@sda21(r13)
/* 80191E64 0018DCA4  7C 00 07 74 */	extsb r0, r0
/* 80191E68 0018DCA8  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80191E78 0018DCB8  90 0D ED 8C */	stw r0, "@LOCAL@Instance__Q23g3d34NullModelAnimAccessorEventReceiverFv@obj"@sda21(r13)
/* 80191E7C 0018DCBC  38 00 00 01 */	li r0, 0x1
/* 80191E80 0018DCC0  98 0D ED 88 */	stb r0, "@GUARD@Instance__Q23g3d34NullModelAnimAccessorEventReceiverFv@obj"@sda21(r13)
.global lbl_80191E84
lbl_80191E84:
/* 80191E84 0018DCC4  38 6D ED 8C */	addi r3, r13, "@LOCAL@Instance__Q23g3d34NullModelAnimAccessorEventReceiverFv@obj"@sda21
...
/* 80191ED4 0018DD14  83 C1 00 08 */	lwz r30, 0x8(r1)
...
.global "@GUARD@Instance__Q23g3d34NullModelAnimAccessorEventReceiverFv@obj"
"@GUARD@Instance__Q23g3d34NullModelAnimAccessorEventReceiverFv@obj":
	.skip 0x4

.global "@LOCAL@Instance__Q23g3d34NullModelAnimAccessorEventReceiverFv@obj"
"@LOCAL@Instance__Q23g3d34NullModelAnimAccessorEventReceiverFv@obj":
	.skip 0x4
