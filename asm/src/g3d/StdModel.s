...
/* 80194A34 00190874  38 61 00 08 */	addi r3, r1, 0x8
...
/* 80194A60 001908A0  38 00 00 01 */	li r0, 0x1
...
/* 80194A94 001908D4  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80194A98 001908D8  7C 7E 1B 78 */	mr r30, r3
/* 80194A9C 001908DC  7C 9F 23 78 */	mr r31, r4
/* 80194AA0 001908E0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80194AE0 00190920  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80194B0C 0019094C  38 61 00 08 */	addi r3, r1, 0x8
/* 80194B10 00190950  4B FF A8 C9 */	bl handle__Q23g3d5ModelFv
/* 80194B14 00190954  7F E3 FB 78 */	mr r3, r31
/* 80194B18 00190958  38 81 00 08 */	addi r4, r1, 0x8
/* 80194B1C 0019095C  4B FF BB 49 */	bl "__ct__Q23g3d13ModelAccessorFRCQ24util26ObjRefHandle<Q23g3d5Model>"
/* 80194B20 00190960  38 61 00 08 */	addi r3, r1, 0x8
/* 80194B24 00190964  38 80 FF FF */	li r4, -0x1
/* 80194B28 00190968  4B FE 74 7D */	bl "__dt__Q24util26ObjRefHandle<Q23g3d5Model>Fv"
...
/* 80194BBC 001909FC  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 80194BE4 00190A24  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80194C18 00190A58  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80194C1C 00190A5C  7C 7E 1B 78 */	mr r30, r3
/* 80194C20 00190A60  7C BF 2B 78 */	mr r31, r5
/* 80194C24 00190A64  7C 83 23 78 */	mr r3, r4
/* 80194C28 00190A68  48 01 1F E1 */	bl "allocatorAlloc__Q34util17Delegate<Fv_v,64>12DelegateHeapFUll"
...
/* 80194C40 00190A80  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80194C68 00190AA8  4B E7 26 DD */	bl _savegpr_29
...
/* 80194CF4 00190B34  4B E7 26 51 */	bl _savegpr_29
...
/* 80194D64 00190BA4  4B E7 26 2D */	bl _restgpr_29
...
/* 80194D78 00190BB8  38 E0 00 00 */	li r7, 0x0
...
/* 80194D80 00190BC0  38 E0 00 01 */	li r7, 0x1
...
/* 80194DD8 00190C18  38 61 00 08 */	addi r3, r1, 0x8
...
/* 80194DE8 00190C28  80 63 00 00 */	lwz r3, 0x0(r3)
/* 80194DEC 00190C2C  80 84 00 04 */	lwz r4, 0x4(r4)
...
/* 80194F2C 00190D6C  4B E7 24 15 */	bl _savegpr_28
...
/* 80194F54 00190D94  30 03 FF FF */	addic r0, r3, -0x1
/* 80194F58 00190D98  7C 00 19 10 */	subfe r0, r0, r3
/* 80194F5C 00190D9C  2C 00 00 00 */	cmpwi r0, 0x0
/* 80194F60 00190DA0  40 82 00 0C */	bne lbl_80194F6C
/* 80194F64 00190DA4  38 60 00 00 */	li r3, 0x0
...
/* 80194F74 00190DB4  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80194F94 00190DD4  38 60 00 01 */	li r3, 0x1
.global lbl_80194F98
lbl_80194F98:
/* 80194F98 00190DD8  39 61 00 20 */	addi r11, r1, 0x20
/* 80194F9C 00190DDC  4B E7 23 F1 */	bl _restgpr_28
...
/* 80194FB4 00190DF4  2C 00 00 00 */	cmpwi r0, 0x0
