...
/* 801C6144 001C1F84  F3 E1 00 28 */	psq_st f31, 0x28(r1), 0, qr0
...
/* 801C6154 001C1F94  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801C6158 001C1F98  80 9F 00 08 */	lwz r4, 0x8(r31)
/* 801C615C 001C1F9C  48 00 00 7D */	bl getFR__Q26mintvm6RegsetCFUi
/* 801C6160 001C1FA0  80 03 00 00 */	lwz r0, 0x0(r3)
/* 801C6164 001C1FA4  C8 22 9C 58 */	lfd f1, "@49893_8055FBD8"@sda21(r2)
...
/* 801C6174 001C1FB4  90 01 00 08 */	stw r0, 0x8(r1)
/* 801C6178 001C1FB8  C8 01 00 08 */	lfd f0, 0x8(r1)
/* 801C617C 001C1FBC  EF E0 08 28 */	fsubs f31, f0, f1
/* 801C6180 001C1FC0  88 1F 00 04 */	lbz r0, 0x4(r31)
/* 801C6184 001C1FC4  2C 00 00 00 */	cmpwi r0, 0x0
/* 801C6188 001C1FC8  40 82 00 20 */	bne lbl_801C61A8
/* 801C618C 001C1FCC  3C 60 80 46 */	lis r3, "@STRING@setRet_f32__Q26mintvm13MintFuncProxyFf"@ha
/* 801C6190 001C1FD0  38 63 BD 04 */	addi r3, r3, "@STRING@setRet_f32__Q26mintvm13MintFuncProxyFf"@l
/* 801C6194 001C1FD4  38 80 00 5A */	li r4, 0x5a
/* 801C6198 001C1FD8  3C A0 80 46 */	lis r5, "@STRING@setRet_f32__Q26mintvm13MintFuncProxyFf@0"@ha
/* 801C619C 001C1FDC  38 A5 BC F0 */	addi r5, r5, "@STRING@setRet_f32__Q26mintvm13MintFuncProxyFf@0"@l
/* 801C61A0 001C1FE0  4C C6 31 82 */	crclr 4*cr1+eq
/* 801C61A4 001C1FE4  4B FF FE 01 */	bl panic__Q26mintvm14MintSystemCallFPCciPCce
.global lbl_801C61A8
lbl_801C61A8:
/* 801C61A8 001C1FE8  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801C61AC 001C1FEC  38 80 00 00 */	li r4, 0x0
/* 801C61B0 001C1FF0  4B FC 56 29 */	bl internal_getFR__Q26mintvm6RegsetFUi
/* 801C61B4 001C1FF4  D3 E3 00 00 */	stfs f31, 0x0(r3)
...
/* 801C61E8 001C2028  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 801C6200 001C2040  3C 60 80 45 */	lis r3, "@STRING@at__Q26mintvm24MArray<Q26mintvm6MValue>CFUl"@ha
/* 801C6204 001C2044  38 63 4F 98 */	addi r3, r3, "@STRING@at__Q26mintvm24MArray<Q26mintvm6MValue>CFUl"@l
/* 801C6208 001C2048  38 80 00 49 */	li r4, 0x49
/* 801C620C 001C204C  3C A0 80 45 */	lis r5, "@STRING@at__Q26mintvm24MArray<Q26mintvm6MValue>CFUl@0"@ha
/* 801C6210 001C2050  38 A5 4F 80 */	addi r5, r5, "@STRING@at__Q26mintvm24MArray<Q26mintvm6MValue>CFUl@0"@l
/* 801C6214 001C2054  7F E6 FB 78 */	mr r6, r31
/* 801C6218 001C2058  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 801C6230 001C2070  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 801C6260 001C20A0  80 7E 00 00 */	lwz r3, 0x0(r30)
/* 801C6264 001C20A4  80 9E 00 08 */	lwz r4, 0x8(r30)
/* 801C6268 001C20A8  4B FF FF 71 */	bl getFR__Q26mintvm6RegsetCFUi
/* 801C626C 001C20AC  C0 03 00 00 */	lfs f0, 0x0(r3)
/* 801C6270 001C20B0  FC 00 00 1E */	fctiwz f0, f0
/* 801C6274 001C20B4  D8 01 00 08 */	stfd f0, 0x8(r1)
/* 801C6278 001C20B8  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 801C627C 001C20BC  88 1E 00 04 */	lbz r0, 0x4(r30)
/* 801C6280 001C20C0  2C 00 00 00 */	cmpwi r0, 0x0
/* 801C6284 001C20C4  40 82 00 20 */	bne lbl_801C62A4
/* 801C6288 001C20C8  3C 60 80 46 */	lis r3, "@STRING@setRet_s32__Q26mintvm13MintFuncProxyFi"@ha
/* 801C628C 001C20CC  38 63 BC DC */	addi r3, r3, "@STRING@setRet_s32__Q26mintvm13MintFuncProxyFi"@l
/* 801C6290 001C20D0  38 80 00 59 */	li r4, 0x59
/* 801C6294 001C20D4  3C A0 80 46 */	lis r5, "@STRING@setRet_s32__Q26mintvm13MintFuncProxyFi@0"@ha
/* 801C6298 001C20D8  38 A5 BC C8 */	addi r5, r5, "@STRING@setRet_s32__Q26mintvm13MintFuncProxyFi@0"@l
/* 801C629C 001C20DC  4C C6 31 82 */	crclr 4*cr1+eq
/* 801C62A0 001C20E0  4B FF FD 05 */	bl panic__Q26mintvm14MintSystemCallFPCciPCce
.global lbl_801C62A4
lbl_801C62A4:
/* 801C62A4 001C20E4  80 7E 00 00 */	lwz r3, 0x0(r30)
/* 801C62A8 001C20E8  38 80 00 00 */	li r4, 0x0
/* 801C62AC 001C20EC  4B FC 55 2D */	bl internal_getFR__Q26mintvm6RegsetFUi
/* 801C62B0 001C20F0  93 E3 00 00 */	stw r31, 0x0(r3)
