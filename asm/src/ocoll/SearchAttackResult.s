...
.global lbl_801D8CB8
lbl_801D8CB8:
/* 801D8CB8 001D4AF8  90 85 00 04 */	stw r4, 0x4(r5)
/* 801D8CBC 001D4AFC  90 85 00 00 */	stw r4, 0x0(r5)
/* 801D8CC0 001D4B00  90 85 00 0C */	stw r4, 0xc(r5)
/* 801D8CC4 001D4B04  90 85 00 08 */	stw r4, 0x8(r5)
...
/* 801D8CF4 001D4B34  4B E2 E6 51 */	bl lbl_80007344
/* 801D8CF8 001D4B38  7C 7D 1B 78 */	mr r29, r3
/* 801D8CFC 001D4B3C  7C 9E 23 78 */	mr r30, r4
/* 801D8D00 001D4B40  80 03 00 00 */	lwz r0, 0x0(r3)
...
/* 801D8D28 001D4B68  80 7E 00 04 */	lwz r3, 0x4(r30)
/* 801D8D2C 001D4B6C  90 64 00 0C */	stw r3, 0xc(r4)
/* 801D8D30 001D4B70  90 04 00 08 */	stw r0, 0x8(r4)
/* 801D8D34 001D4B74  80 1E 00 08 */	lwz r0, 0x8(r30)
...
/* 801D8D5C 001D4B9C  80 7D 00 00 */	lwz r3, 0x0(r29)
/* 801D8D60 001D4BA0  38 03 00 01 */	addi r0, r3, 0x1
/* 801D8D64 001D4BA4  90 1D 00 00 */	stw r0, 0x0(r29)
.global lbl_801D8D68
lbl_801D8D68:
/* 801D8D68 001D4BA8  39 61 00 20 */	addi r11, r1, 0x20
/* 801D8D6C 001D4BAC  4B E2 E6 25 */	bl lbl_80007390
...
/* 801D8D90 001D4BD0  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 801D8DC4 001D4C04  83 C1 00 08 */	lwz r30, 0x8(r1)
