...
.global "RuntimeTypeInfoImpl<Q33scn7history12SceneHistory>__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo"
"RuntimeTypeInfoImpl<Q33scn7history12SceneHistory>__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo":
...
/* 8020E670 0020A4B0  88 0D EF 70 */	lbz r0, "@GUARD@RuntimeTypeInfoImpl<Q33scn7history12SceneHistory>__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo@ti"@sda21(r13)
/* 8020E674 0020A4B4  7C 00 07 74 */	extsb r0, r0
/* 8020E678 0020A4B8  2C 00 00 00 */	cmpwi r0, 0x0
/* 8020E67C 0020A4BC  40 82 00 24 */	bne lbl_8020E6A0
/* 8020E680 0020A4C0  4B F6 66 6D */	bl "RuntimeTypeInfoImpl<Q23scn6IScene>__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo"
/* 8020E684 0020A4C4  7C 64 1B 78 */	mr r4, r3
/* 8020E688 0020A4C8  38 6D EF 78 */	addi r3, r13, "@LOCAL@RuntimeTypeInfoImpl<Q33scn7history12SceneHistory>__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo@ti"@sda21
/* 8020E68C 0020A4CC  3C A0 80 45 */	lis r5, "@STRING@NoName__Q33hel6common15RuntimeTypeInfoFv"@ha
/* 8020E690 0020A4D0  38 A5 2B 1C */	addi r5, r5, "@STRING@NoName__Q33hel6common15RuntimeTypeInfoFv"@l
/* 8020E694 0020A4D4  4B F6 66 A5 */	bl __ct__Q33hel6common15RuntimeTypeInfoFPCQ33hel6common15RuntimeTypeInfoPCc
/* 8020E698 0020A4D8  38 00 00 01 */	li r0, 0x1
/* 8020E69C 0020A4DC  98 0D EF 70 */	stb r0, "@GUARD@RuntimeTypeInfoImpl<Q33scn7history12SceneHistory>__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo@ti"@sda21(r13)
.global lbl_8020E6A0
lbl_8020E6A0:
/* 8020E6A0 0020A4E0  38 6D EF 78 */	addi r3, r13, "@LOCAL@RuntimeTypeInfoImpl<Q33scn7history12SceneHistory>__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo@ti"@sda21
...
/* 8020E6D8 0020A518  90 03 00 00 */	stw r0, 0x0(r3)
/* 8020E6DC 0020A51C  38 63 00 04 */	addi r3, r3, 0x4
/* 8020E6E0 0020A520  38 80 00 00 */	li r4, 0x0
/* 8020E6E4 0020A524  4B ED 74 0D */	bl __ct__Q34nw4r3g3d6CameraFPQ34nw4r3g3d10CameraData
/* 8020E6E8 0020A528  38 A0 00 00 */	li r5, 0x0
...
/* 8020E6F8 0020A538  38 60 00 08 */	li r3, 0x8
.global lbl_8020E6FC
lbl_8020E6FC:
/* 8020E6FC 0020A53C  38 86 FF FC */	addi r4, r6, -0x4
/* 8020E700 0020A540  7C 69 03 A6 */	mtctr r3
.global lbl_8020E704
lbl_8020E704:
/* 8020E704 0020A544  90 A4 00 04 */	stw r5, 0x4(r4)
/* 8020E708 0020A548  94 A4 00 08 */	stwu r5, 0x8(r4)
/* 8020E70C 0020A54C  42 00 FF F8 */	bdnz lbl_8020E704
/* 8020E710 0020A550  98 A6 00 00 */	stb r5, 0x0(r6)
...
/* 8020E72C 0020A56C  3C 80 80 46 */	lis r4, "@54220"@ha
/* 8020E730 0020A570  38 84 15 18 */	addi r4, r4, "@54220"@l
/* 8020E734 0020A574  4B FD 45 FD */	bl "__ct__Q33hel6common15FixedString<64>FPCc"
/* 8020E738 0020A578  7C 64 1B 78 */	mr r4, r3
/* 8020E73C 0020A57C  38 61 00 98 */	addi r3, r1, 0x98
/* 8020E740 0020A580  4B FD 46 45 */	bl "add__Q33hel6common47MutableArray<Q33hel6common15FixedString<64>,24>FRCQ33hel6common15FixedString<64>"
/* 8020E744 0020A584  88 1C 00 08 */	lbz r0, 0x8(r28)
/* 8020E748 0020A588  2C 00 00 00 */	cmpwi r0, 0x0
/* 8020E74C 0020A58C  41 82 00 20 */	beq lbl_8020E76C
/* 8020E750 0020A590  38 61 00 18 */	addi r3, r1, 0x18
/* 8020E754 0020A594  3C 80 80 46 */	lis r4, "@54221"@ha
/* 8020E758 0020A598  38 84 15 2C */	addi r4, r4, "@54221"@l
/* 8020E75C 0020A59C  4B FD 45 D5 */	bl "__ct__Q33hel6common15FixedString<64>FPCc"
/* 8020E760 0020A5A0  7C 64 1B 78 */	mr r4, r3
/* 8020E764 0020A5A4  38 61 00 98 */	addi r3, r1, 0x98
/* 8020E768 0020A5A8  4B FD 46 1D */	bl "add__Q33hel6common47MutableArray<Q33hel6common15FixedString<64>,24>FRCQ33hel6common15FixedString<64>"
.global lbl_8020E76C
lbl_8020E76C:
/* 8020E76C 0020A5AC  38 61 00 98 */	addi r3, r1, 0x98
/* 8020E770 0020A5B0  38 81 00 0C */	addi r4, r1, 0xc
/* 8020E774 0020A5B4  38 A0 00 01 */	li r5, 0x1
/* 8020E778 0020A5B8  4B F7 A8 39 */	bl "DNProcess__Q24file7UtilityFRCQ33hel6common47MutableArray<Q33hel6common15FixedString<64>,24>RCQ24file8DNOptionb"
/* 8020E77C 0020A5BC  38 60 00 01 */	li r3, 0x1
/* 8020E780 0020A5C0  4B F7 A7 DD */	bl SetIsFileLoadWarningEnable__Q24file7UtilityFb
/* 8020E784 0020A5C4  88 1C 00 08 */	lbz r0, 0x8(r28)
/* 8020E788 0020A5C8  2C 00 00 00 */	cmpwi r0, 0x0
/* 8020E78C 0020A5CC  40 82 00 2C */	bne lbl_8020E7B8
/* 8020E790 0020A5D0  83 AD ED 10 */	lwz r29, "object___Q33hel6common38ExplicitSingleton<Q23app11Application>"@sda21(r13)
/* 8020E794 0020A5D4  38 61 00 08 */	addi r3, r1, 0x8
...
/* 8020E7A8 0020A5E8  3C 80 80 46 */	lis r4, "@54221"@ha
/* 8020E7AC 0020A5EC  38 84 15 2C */	addi r4, r4, "@54221"@l
...
/* 8020E7C4 0020A604  2C 03 00 00 */	cmpwi r3, 0x0
/* 8020E7C8 0020A608  41 82 00 18 */	beq lbl_8020E7E0
/* 8020E7CC 0020A60C  88 9C 00 00 */	lbz r4, 0x0(r28)
/* 8020E7D0 0020A610  88 BC 00 01 */	lbz r5, 0x1(r28)
/* 8020E7D4 0020A614  38 DC 00 04 */	addi r6, r28, 0x4
...
/* 8020E7E8 0020A628  80 7F 00 04 */	lwz r3, 0x4(r31)
/* 8020E7EC 0020A62C  80 01 00 10 */	lwz r0, 0x10(r1)
/* 8020E7F0 0020A630  90 1F 00 04 */	stw r0, 0x4(r31)
/* 8020E7F4 0020A634  90 61 00 10 */	stw r3, 0x10(r1)
/* 8020E7F8 0020A638  38 61 00 10 */	addi r3, r1, 0x10
/* 8020E7FC 0020A63C  38 80 FF FF */	li r4, -0x1
/* 8020E800 0020A640  48 00 00 2D */	bl "__dt__Q33hel6common30ScopedPtr<Q33scn7history4Main>Fv"
/* 8020E804 0020A644  38 61 00 98 */	addi r3, r1, 0x98
/* 8020E808 0020A648  38 80 FF FF */	li r4, -0x1
...
.global "__dt__Q33hel6common30ScopedPtr<Q33scn7history4Main>Fv"
"__dt__Q33hel6common30ScopedPtr<Q33scn7history4Main>Fv":
...
/* 8020E890 0020A6D0  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8020E8B4 0020A6F4  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8020E8B8 0020A6F8  7C 7E 1B 78 */	mr r30, r3
/* 8020E8BC 0020A6FC  7C 9F 23 78 */	mr r31, r4
/* 8020E8C0 0020A700  2C 03 00 00 */	cmpwi r3, 0x0
/* 8020E8C4 0020A704  41 82 00 30 */	beq lbl_8020E8F4
/* 8020E8C8 0020A708  38 63 00 04 */	addi r3, r3, 0x4
/* 8020E8CC 0020A70C  38 80 FF FF */	li r4, -0x1
/* 8020E8D0 0020A710  4B FF FF 5D */	bl "__dt__Q33hel6common30ScopedPtr<Q33scn7history4Main>Fv"
/* 8020E8D4 0020A714  7F C3 F3 78 */	mr r3, r30
/* 8020E8D8 0020A718  38 80 00 00 */	li r4, 0x0
/* 8020E8DC 0020A71C  4B F6 72 8D */	bl __dt__Q23scn6ISceneFv
/* 8020E8E0 0020A720  7F E0 07 34 */	extsh r0, r31
/* 8020E8E4 0020A724  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8020E8FC 0020A73C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8020E91C 0020A75C  38 63 00 04 */	addi r3, r3, 0x4
/* 8020E920 0020A760  4B F6 7A A1 */	bl "__rf__Q33hel6common25ScopedPtr<Q23app7AppImpl>CFv"
...
/* 8020E944 0020A784  38 63 00 04 */	addi r3, r3, 0x4
/* 8020E948 0020A788  4B F6 7A 79 */	bl "__rf__Q33hel6common25ScopedPtr<Q23app7AppImpl>CFv"
...
/* 8020E96C 0020A7AC  38 63 00 04 */	addi r3, r3, 0x4
/* 8020E970 0020A7B0  4B F6 7A 51 */	bl "__rf__Q33hel6common25ScopedPtr<Q23app7AppImpl>CFv"
...
/* 8020E994 0020A7D4  38 63 00 04 */	addi r3, r3, 0x4
/* 8020E998 0020A7D8  4B F6 7A 29 */	bl "__rf__Q33hel6common25ScopedPtr<Q23app7AppImpl>CFv"
...
/* 8020E9BC 0020A7FC  38 63 00 04 */	addi r3, r3, 0x4
/* 8020E9C0 0020A800  4B F6 7A 01 */	bl "__rf__Q33hel6common25ScopedPtr<Q23app7AppImpl>CFv"
...
/* 8020E9EC 0020A82C  38 64 00 04 */	addi r3, r4, 0x4
/* 8020E9F0 0020A830  4B F6 79 D1 */	bl "__rf__Q33hel6common25ScopedPtr<Q23app7AppImpl>CFv"
/* 8020E9F4 0020A834  80 03 16 F4 */	lwz r0, 0x16f4(r3)
/* 8020E9F8 0020A838  90 1F 00 00 */	stw r0, 0x0(r31)
/* 8020E9FC 0020A83C  88 03 16 F8 */	lbz r0, 0x16f8(r3)
/* 8020EA00 0020A840  98 1F 00 04 */	stb r0, 0x4(r31)
/* 8020EA04 0020A844  80 03 16 FC */	lwz r0, 0x16fc(r3)
/* 8020EA08 0020A848  90 1F 00 08 */	stw r0, 0x8(r31)
...
/* 8020EA3C 0020A87C  38 64 00 04 */	addi r3, r4, 0x4
/* 8020EA40 0020A880  4B F6 79 81 */	bl "__rf__Q33hel6common25ScopedPtr<Q23app7AppImpl>CFv"
/* 8020EA44 0020A884  80 03 17 04 */	lwz r0, 0x1704(r3)
/* 8020EA48 0020A888  90 1F 00 00 */	stw r0, 0x0(r31)
/* 8020EA4C 0020A88C  80 03 17 08 */	lwz r0, 0x1708(r3)
/* 8020EA50 0020A890  90 1F 00 04 */	stw r0, 0x4(r31)
/* 8020EA54 0020A894  80 03 17 0C */	lwz r0, 0x170c(r3)
/* 8020EA58 0020A898  90 1F 00 08 */	stw r0, 0x8(r31)
...
/* 8020EA80 0020A8C0  4B FF FB E4 */	b "RuntimeTypeInfoImpl<Q33scn7history12SceneHistory>__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo"
.include "macros.inc"
...
.global "@GUARD@RuntimeTypeInfoImpl<Q33scn7history12SceneHistory>__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo@ti"
"@GUARD@RuntimeTypeInfoImpl<Q33scn7history12SceneHistory>__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo@ti":
	.skip 0x8

.global "@LOCAL@RuntimeTypeInfoImpl<Q33scn7history12SceneHistory>__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo@ti"
"@LOCAL@RuntimeTypeInfoImpl<Q33scn7history12SceneHistory>__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo@ti":
	.skip 0x8
