...
/* 802290C0 00224F00  80 02 A2 E8 */	lwz r0, "@49397"@sda21(r2)
/* 802290C4 00224F04  90 03 00 00 */	stw r0, 0x0(r3)
/* 802290C8 00224F08  38 00 00 00 */	li r0, 0x0
/* 802290CC 00224F0C  90 03 00 04 */	stw r0, 0x4(r3)
/* 802290D0 00224F10  C0 02 A2 EC */	lfs f0, "@49403"@sda21(r2)
/* 802290D4 00224F14  D0 03 00 08 */	stfs f0, 0x8(r3)
/* 802290D8 00224F18  D0 03 00 0C */	stfs f0, 0xc(r3)
/* 802290DC 00224F1C  C0 02 A2 F0 */	lfs f0, "@49404"@sda21(r2)
...
/* 802290FC 00224F3C  4B F4 E9 B9 */	bl "isConstruct__Q23mem43ExplicitScopedPtr<Q23app16HIDErrorMenuImpl>CFv"
/* 80229100 00224F40  2C 03 00 00 */	cmpwi r3, 0x0
/* 80229104 00224F44  41 82 01 00 */	beq lbl_80229204
/* 80229108 00224F48  80 1F 00 04 */	lwz r0, 0x4(r31)
/* 8022910C 00224F4C  28 00 00 01 */	cmplwi r0, 0x1
/* 80229110 00224F50  41 82 00 10 */	beq lbl_80229120
/* 80229114 00224F54  28 00 00 02 */	cmplwi r0, 0x2
/* 80229118 00224F58  41 82 00 C8 */	beq lbl_802291E0
/* 8022911C 00224F5C  48 00 00 E8 */	b lbl_80229204
.global lbl_80229120
lbl_80229120:
/* 80229120 00224F60  C0 3F 00 08 */	lfs f1, 0x8(r31)
/* 80229124 00224F64  C0 02 A2 F4 */	lfs f0, "@49427"@sda21(r2)
/* 80229128 00224F68  EC 21 00 2A */	fadds f1, f1, f0
/* 8022912C 00224F6C  D0 3F 00 08 */	stfs f1, 0x8(r31)
/* 80229130 00224F70  C0 02 A2 F8 */	lfs f0, "@49428"@sda21(r2)
/* 80229134 00224F74  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80229138 00224F78  4C 41 13 82 */	cror eq, gt, eq
/* 8022913C 00224F7C  40 82 00 0C */	bne lbl_80229148
/* 80229140 00224F80  EC 01 00 28 */	fsubs f0, f1, f0
/* 80229144 00224F84  D0 1F 00 08 */	stfs f0, 0x8(r31)
.global lbl_80229148
lbl_80229148:
...
/* 80229158 00224F98  C0 02 A2 FC */	lfs f0, "@49429"@sda21(r2)
...
.global lbl_80229168
lbl_80229168:
/* 80229168 00224FA8  C0 3F 00 08 */	lfs f1, 0x8(r31)
/* 8022916C 00224FAC  C0 02 A3 04 */	lfs f0, "@49431"@sda21(r2)
/* 80229170 00224FB0  EC 20 00 72 */	fmuls f1, f0, f1
/* 80229174 00224FB4  C0 02 A3 00 */	lfs f0, "@49430"@sda21(r2)
...
/* 80229188 00224FC8  D8 01 00 08 */	stfd f0, 0x8(r1)
/* 8022918C 00224FCC  80 61 00 0C */	lwz r3, 0xc(r1)
/* 80229190 00224FD0  C0 02 A3 08 */	lfs f0, "@49432_80560288"@sda21(r2)
...
/* 802291A8 00224FE8  80 6D AA B4 */	lwz r3, "@49259_80558ED4"@sda21(r13)
/* 802291AC 00224FEC  80 0D AA B4 */	lwz r0, "@49259_80558ED4"@sda21(r13)
...
.global lbl_802291BC
lbl_802291BC:
/* 802291BC 00224FFC  80 6D AA B0 */	lwz r3, "@49258_80558ED0"@sda21(r13)
/* 802291C0 00225000  80 0D AA B0 */	lwz r0, "@49258_80558ED0"@sda21(r13)
...
.global lbl_802291D4
lbl_802291D4:
/* 802291D4 00225014  54 60 06 3E */	clrlwi r0, r3, 24
/* 802291D8 00225018  98 1F 00 03 */	stb r0, 0x3(r31)
/* 802291DC 0022501C  48 00 00 28 */	b lbl_80229204
.global lbl_802291E0
lbl_802291E0:
/* 802291E0 00225020  88 7F 00 03 */	lbz r3, 0x3(r31)
/* 802291E4 00225024  38 63 FF FB */	addi r3, r3, -0x5
/* 802291E8 00225028  2C 03 00 00 */	cmpwi r3, 0x0
/* 802291EC 0022502C  40 80 00 10 */	bge lbl_802291FC
/* 802291F0 00225030  38 60 00 00 */	li r3, 0x0
/* 802291F4 00225034  38 00 00 00 */	li r0, 0x0
/* 802291F8 00225038  90 1F 00 04 */	stw r0, 0x4(r31)
.global lbl_802291FC
lbl_802291FC:
/* 802291FC 0022503C  54 60 06 3E */	clrlwi r0, r3, 24
/* 80229200 00225040  98 1F 00 03 */	stb r0, 0x3(r31)
.global lbl_80229204
lbl_80229204:
...
/* 8022922C 0022506C  38 00 00 01 */	li r0, 0x1
/* 80229230 00225070  90 03 00 04 */	stw r0, 0x4(r3)
/* 80229234 00225074  4B F2 26 E1 */	bl __as__8_GXColorFRC8_GXColor
/* 80229238 00225078  C0 02 A2 EC */	lfs f0, "@49403"@sda21(r2)
/* 8022923C 0022507C  D0 1F 00 08 */	stfs f0, 0x8(r31)
...
/* 80229258 00225098  38 00 00 01 */	li r0, 0x1
/* 8022925C 0022509C  90 03 00 04 */	stw r0, 0x4(r3)
