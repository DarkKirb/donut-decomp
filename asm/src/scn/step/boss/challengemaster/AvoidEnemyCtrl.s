...
/* 8023AE6C 00236CAC  90 83 00 00 */	stw r4, 0x0(r3)
...
/* 8023AEEC 00236D2C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8023AF60 00236DA0  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8023AF98 00236DD8  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8023AFBC 00236DFC  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8023B000 00236E40  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8023B024 00236E64  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8023B028 00236E68  7C 7E 1B 78 */	mr r30, r3
/* 8023B02C 00236E6C  7C 9F 23 78 */	mr r31, r4
/* 8023B030 00236E70  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8023B060 00236EA0  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8023B0AC 00236EEC  81 83 00 00 */	lwz r12, 0x0(r3)
/* 8023B0B0 00236EF0  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 8023B0C8 00236F08  38 00 00 01 */	li r0, 0x1
/* 8023B0CC 00236F0C  48 00 00 14 */	b lbl_8023B0E0
.global lbl_8023B0D0
lbl_8023B0D0:
/* 8023B0D0 00236F10  80 63 00 00 */	lwz r3, 0x0(r3)
.global lbl_8023B0D4
lbl_8023B0D4:
/* 8023B0D4 00236F14  2C 03 00 00 */	cmpwi r3, 0x0
/* 8023B0D8 00236F18  40 82 FF E8 */	bne lbl_8023B0C0
/* 8023B0DC 00236F1C  38 00 00 00 */	li r0, 0x0
.global lbl_8023B0E0
lbl_8023B0E0:
/* 8023B0E0 00236F20  2C 00 00 00 */	cmpwi r0, 0x0
/* 8023B0E4 00236F24  41 82 00 08 */	beq lbl_8023B0EC
/* 8023B0E8 00236F28  48 00 00 08 */	b lbl_8023B0F0
.global lbl_8023B0EC
lbl_8023B0EC:
/* 8023B0EC 00236F2C  3B C0 00 00 */	li r30, 0x0
.global lbl_8023B0F0
lbl_8023B0F0:
...
/* 8023B104 00236F44  83 BC 00 04 */	lwz r29, 0x4(r28)
...
/* 8023B140 00236F80  3B DE 00 01 */	addi r30, r30, 0x1
...
.global lbl_8023B170
lbl_8023B170:
/* 8023B170 00236FB0  80 1C 00 04 */	lwz r0, 0x4(r28)
/* 8023B174 00236FB4  7C 1E 00 40 */	cmplw r30, r0
/* 8023B178 00236FB8  41 80 FF D0 */	blt lbl_8023B148
/* 8023B17C 00236FBC  80 7C 00 04 */	lwz r3, 0x4(r28)
/* 8023B180 00236FC0  38 03 FF FF */	addi r0, r3, -0x1
/* 8023B184 00236FC4  90 1C 00 04 */	stw r0, 0x4(r28)
.global lbl_8023B188
lbl_8023B188:
/* 8023B188 00236FC8  3B BD FF FF */	addi r29, r29, -0x1
.global lbl_8023B18C
lbl_8023B18C:
/* 8023B18C 00236FCC  2C 1D 00 00 */	cmpwi r29, 0x0
...
/* 8023B1BC 00236FFC  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8023B1E0 00237020  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8023B258 00237098  93 FD 00 08 */	stw r31, 0x8(r29)
...
/* 8023B2BC 002370FC  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8023B2F0 00237130  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8023B314 00237154  F3 E1 00 88 */	psq_st f31, 0x88(r1), 0, qr0
...
/* 8023B3D4 00237214  D0 03 00 00 */	stfs f0, 0x0(r3)
/* 8023B3D8 00237218  C0 03 00 04 */	lfs f0, 0x4(r3)
...
/* 8023B434 00237274  D0 03 00 00 */	stfs f0, 0x0(r3)
/* 8023B438 00237278  C0 23 00 04 */	lfs f1, 0x4(r3)
...
.global lbl_8023B46C
lbl_8023B46C:
/* 8023B46C 002372AC  3B BD 00 01 */	addi r29, r29, 0x1
.global lbl_8023B470
lbl_8023B470:
/* 8023B470 002372B0  80 1B 00 04 */	lwz r0, 0x4(r27)
/* 8023B474 002372B4  7C 1D 00 40 */	cmplw r29, r0
/* 8023B478 002372B8  41 80 FE D8 */	blt lbl_8023B350
/* 8023B47C 002372BC  38 60 00 00 */	li r3, 0x0
.global lbl_8023B480
lbl_8023B480:
...
/* 8023B4C0 00237300  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8023B4C4 00237304  7C 7E 1B 78 */	mr r30, r3
/* 8023B4C8 00237308  7C 9F 23 78 */	mr r31, r4
/* 8023B4CC 0023730C  80 03 00 04 */	lwz r0, 0x4(r3)
/* 8023B4D0 00237310  28 00 00 08 */	cmplwi r0, 0x8
...
/* 8023B4FC 0023733C  83 C1 00 08 */	lwz r30, 0x8(r1)
