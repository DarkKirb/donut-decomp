...
/* 8023C43C 0023827C  90 83 00 00 */	stw r4, 0x0(r3)
/* 8023C440 00238280  38 80 00 00 */	li r4, 0x0
/* 8023C444 00238284  90 83 00 04 */	stw r4, 0x4(r3)
/* 8023C448 00238288  90 83 00 08 */	stw r4, 0x8(r3)
/* 8023C44C 0023828C  38 00 00 01 */	li r0, 0x1
...
/* 8023C484 002382C4  48 00 00 C9 */	bl "DynamicCastToRef<Q53scn4step4boss15challengemaster6Custom,Q43scn4step4boss7ICustom>__Q23hel6commonFPQ43scn4step4boss7ICustom_RQ53scn4step4boss15challengemaster6Custom"
...
/* 8023C49C 002382DC  80 03 00 04 */	lwz r0, 0x4(r3)
/* 8023C4A0 002382E0  2C 00 00 00 */	cmpwi r0, 0x0
/* 8023C4A4 002382E4  40 82 00 90 */	bne lbl_8023C534
/* 8023C4A8 002382E8  80 7D 00 00 */	lwz r3, 0x0(r29)
...
/* 8023C4D4 00238314  90 1D 00 08 */	stw r0, 0x8(r29)
/* 8023C4D8 00238318  48 00 00 18 */	b lbl_8023C4F0
.global lbl_8023C4DC
lbl_8023C4DC:
/* 8023C4DC 0023831C  80 7D 00 08 */	lwz r3, 0x8(r29)
/* 8023C4E0 00238320  2C 03 00 00 */	cmpwi r3, 0x0
/* 8023C4E4 00238324  41 82 00 0C */	beq lbl_8023C4F0
/* 8023C4E8 00238328  38 03 FF FF */	addi r0, r3, -0x1
/* 8023C4EC 0023832C  90 1D 00 08 */	stw r0, 0x8(r29)
.global lbl_8023C4F0
lbl_8023C4F0:
...
.global "DynamicCastToRef<Q53scn4step4boss15challengemaster6Custom,Q43scn4step4boss7ICustom>__Q23hel6commonFPQ43scn4step4boss7ICustom_RQ53scn4step4boss15challengemaster6Custom"
"DynamicCastToRef<Q53scn4step4boss15challengemaster6Custom,Q43scn4step4boss7ICustom>__Q23hel6commonFPQ43scn4step4boss7ICustom_RQ53scn4step4boss15challengemaster6Custom":
...
/* 8023C55C 0023839C  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8023C560 002383A0  7C 7E 1B 78 */	mr r30, r3
/* 8023C564 002383A4  4B FF 21 E9 */	bl "RuntimeTypeInfoImpl<Q53scn4step4boss15challengemaster6Custom>__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo"
/* 8023C568 002383A8  7C 7F 1B 78 */	mr r31, r3
/* 8023C56C 002383AC  2C 1E 00 00 */	cmpwi r30, 0x0
/* 8023C570 002383B0  41 82 00 48 */	beq lbl_8023C5B8
/* 8023C574 002383B4  7F C3 F3 78 */	mr r3, r30
/* 8023C578 002383B8  81 83 00 00 */	lwz r12, 0x0(r3)
/* 8023C57C 002383BC  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 8023C594 002383D4  38 00 00 01 */	li r0, 0x1
/* 8023C598 002383D8  48 00 00 14 */	b lbl_8023C5AC
.global lbl_8023C59C
lbl_8023C59C:
/* 8023C59C 002383DC  80 63 00 00 */	lwz r3, 0x0(r3)
.global lbl_8023C5A0
lbl_8023C5A0:
/* 8023C5A0 002383E0  2C 03 00 00 */	cmpwi r3, 0x0
/* 8023C5A4 002383E4  40 82 FF E8 */	bne lbl_8023C58C
/* 8023C5A8 002383E8  38 00 00 00 */	li r0, 0x0
.global lbl_8023C5AC
lbl_8023C5AC:
/* 8023C5AC 002383EC  2C 00 00 00 */	cmpwi r0, 0x0
/* 8023C5B0 002383F0  41 82 00 08 */	beq lbl_8023C5B8
/* 8023C5B4 002383F4  48 00 00 08 */	b lbl_8023C5BC
.global lbl_8023C5B8
lbl_8023C5B8:
/* 8023C5B8 002383F8  3B C0 00 00 */	li r30, 0x0
.global lbl_8023C5BC
lbl_8023C5BC:
/* 8023C5BC 002383FC  7F C3 F3 78 */	mr r3, r30
/* 8023C5C0 00238400  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 8023C5C4 00238404  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8023C5E8 00238428  F3 E1 00 38 */	psq_st f31, 0x38(r1), 0, qr0
...
/* 8023C5F8 00238438  80 03 00 08 */	lwz r0, 0x8(r3)
/* 8023C5FC 0023843C  2C 00 00 00 */	cmpwi r0, 0x0
/* 8023C600 00238440  41 82 00 90 */	beq lbl_8023C690
/* 8023C604 00238444  38 00 00 00 */	li r0, 0x0
/* 8023C608 00238448  90 03 00 08 */	stw r0, 0x8(r3)
/* 8023C60C 0023844C  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 8023C61C 0023845C  80 7E 00 00 */	lwz r3, 0x0(r30)
...
/* 8023C654 00238494  C0 02 A5 08 */	lfs f0, "@55774"@sda21(r2)
...
/* 8023C670 002384B0  80 7E 00 00 */	lwz r3, 0x0(r30)
...
/* 8023C680 002384C0  38 A0 00 00 */	li r5, 0x0
...
/* 8023C6C4 00238504  F3 E1 00 18 */	psq_st f31, 0x18(r1), 0, qr0
/* 8023C6C8 00238508  93 E1 00 0C */	stw r31, 0xc(r1)
/* 8023C6CC 0023850C  7C 7F 1B 78 */	mr r31, r3
/* 8023C6D0 00238510  80 63 00 00 */	lwz r3, 0x0(r3)
/* 8023C6D4 00238514  4B FF 09 15 */	bl custom__Q43scn4step4boss4BossFv
/* 8023C6D8 00238518  4B FF FE 75 */	bl "DynamicCastToRef<Q53scn4step4boss15challengemaster6Custom,Q43scn4step4boss7ICustom>__Q23hel6commonFPQ43scn4step4boss7ICustom_RQ53scn4step4boss15challengemaster6Custom"
...
/* 8023C6E8 00238528  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8023C700 00238540  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8023C710 00238550  38 A0 00 00 */	li r5, 0x0
...
/* 8023C748 00238588  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8023C74C 0023858C  7C 7E 1B 78 */	mr r30, r3
/* 8023C750 00238590  38 00 00 01 */	li r0, 0x1
/* 8023C754 00238594  98 03 00 0D */	stb r0, 0xd(r3)
/* 8023C758 00238598  38 00 00 00 */	li r0, 0x0
/* 8023C75C 0023859C  98 03 00 0E */	stb r0, 0xe(r3)
/* 8023C760 002385A0  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 8023C770 002385B0  54 60 06 3E */	clrlwi r0, r3, 24
/* 8023C774 002385B4  2C 00 00 00 */	cmpwi r0, 0x0
...
.global lbl_8023C784
lbl_8023C784:
/* 8023C784 002385C4  80 7E 00 00 */	lwz r3, 0x0(r30)
...
/* 8023C794 002385D4  38 A0 00 00 */	li r5, 0x0
...
/* 8023C7A0 002385E0  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8023C7C8 00238608  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 8023C7D8 00238618  38 00 00 00 */	li r0, 0x0
...
/* 8023C80C 0023864C  80 83 00 04 */	lwz r4, 0x4(r3)
/* 8023C810 00238650  2C 04 00 00 */	cmpwi r4, 0x0
/* 8023C814 00238654  41 82 01 00 */	beq lbl_8023C914
/* 8023C818 00238658  38 04 FF FF */	addi r0, r4, -0x1
/* 8023C81C 0023865C  90 03 00 04 */	stw r0, 0x4(r3)
/* 8023C820 00238660  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 8023C830 00238670  80 1E 00 04 */	lwz r0, 0x4(r30)
/* 8023C834 00238674  C8 42 A5 20 */	lfd f2, "@55815"@sda21(r2)
...
/* 8023C89C 002386DC  C0 4D AB 30 */	lfs f2, "@55334_80558F50"@sda21(r13)
...
/* 8023C8B0 002386F0  80 64 00 00 */	lwz r3, 0x0(r4)
/* 8023C8B4 002386F4  80 04 00 04 */	lwz r0, 0x4(r4)
/* 8023C8B8 002386F8  90 61 00 08 */	stw r3, 0x8(r1)
/* 8023C8BC 002386FC  90 01 00 0C */	stw r0, 0xc(r1)
/* 8023C8C0 00238700  80 04 00 08 */	lwz r0, 0x8(r4)
/* 8023C8C4 00238704  90 01 00 10 */	stw r0, 0x10(r1)
/* 8023C8C8 00238708  C0 01 00 08 */	lfs f0, 0x8(r1)
/* 8023C8CC 0023870C  EC 00 00 72 */	fmuls f0, f0, f1
/* 8023C8D0 00238710  D0 01 00 08 */	stfs f0, 0x8(r1)
...
/* 8023C8EC 0023872C  80 61 00 08 */	lwz r3, 0x8(r1)
...
/* 8023C904 00238744  80 7E 00 00 */	lwz r3, 0x0(r30)
...
/* 8023C940 00238780  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 8023C950 00238790  90 1F 00 04 */	stw r0, 0x4(r31)
...
/* 8023C9B0 002387F0  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8023C9C0 00238800  38 00 00 01 */	li r0, 0x1
...
/* 8023C9EC 0023882C  F3 E1 00 18 */	psq_st f31, 0x18(r1), 0, qr0
...
/* 8023CA28 00238868  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8023CA38 00238878  C0 22 A5 28 */	lfs f1, "@55831_805604A8"@sda21(r2)
/* 8023CA3C 0023887C  C0 02 AD 60 */	lfs f0, ROT_H_TARGET__Q43scn4step5chara12ModelRotCtrl@sda21(r2)
