...
/* 80241A7C 0023D8BC  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 80241A8C 0023D8CC  4B FF 4D DD */	bl "__ct__Q24util28StateFactory<Q24util6IState>FPv"
/* 80241A90 0023D8D0  3C 60 80 46 */	lis r3, "__vt__Q24util105StateFactoryArg1<Q24util6IState,Q53scn4step4boss15challengemaster14StateSCFlyAway,PQ43scn4step4boss4Boss>"@ha
/* 80241A94 0023D8D4  38 03 5E C8 */	addi r0, r3, "__vt__Q24util105StateFactoryArg1<Q24util6IState,Q53scn4step4boss15challengemaster14StateSCFlyAway,PQ43scn4step4boss4Boss>"@l
/* 80241A98 0023D8D8  90 1E 00 00 */	stw r0, 0x0(r30)
/* 80241A9C 0023D8DC  93 BE 00 08 */	stw r29, 0x8(r30)
.global lbl_80241AA0
lbl_80241AA0:
/* 80241AA0 0023D8E0  93 DF 00 0C */	stw r30, 0xc(r31)
/* 80241AA4 0023D8E4  38 60 00 01 */	li r3, 0x1
/* 80241AA8 0023D8E8  48 00 00 08 */	b lbl_80241AB0
.global lbl_80241AAC
lbl_80241AAC:
/* 80241AAC 0023D8EC  38 60 00 00 */	li r3, 0x0
.global lbl_80241AB0
lbl_80241AB0:
...
/* 80241AF0 0023D930  90 1E 00 00 */	stw r0, 0x0(r30)
/* 80241AF4 0023D934  38 00 00 00 */	li r0, 0x0
/* 80241AF8 0023D938  98 1E 00 08 */	stb r0, 0x8(r30)
...
/* 80241B9C 0023D9DC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80241BAC 0023D9EC  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 80241BC8 0023DA08  38 A0 00 02 */	li r5, 0x2
...
/* 80241C4C 0023DA8C  38 80 00 00 */	li r4, 0x0
/* 80241C50 0023DA90  48 03 0E 55 */	bl get__Q43scn4step5chara13ScriptTriggerFUl
/* 80241C54 0023DA94  2C 03 00 00 */	cmpwi r3, 0x0
/* 80241C58 0023DA98  41 82 00 24 */	beq lbl_80241C7C
/* 80241C5C 0023DA9C  38 00 00 01 */	li r0, 0x1
/* 80241C60 0023DAA0  98 1D 00 08 */	stb r0, 0x8(r29)
...
/* 80241C74 0023DAB4  C0 22 A5 D8 */	lfs f1, "@56779"@sda21(r2)
/* 80241C78 0023DAB8  48 02 FA 91 */	bl initRotH__Q43scn4step5chara12ModelRotCtrlFf
.global lbl_80241C7C
lbl_80241C7C:
/* 80241C7C 0023DABC  88 1D 00 08 */	lbz r0, 0x8(r29)
/* 80241C80 0023DAC0  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80241CA8 0023DAE8  38 03 00 01 */	addi r0, r3, 0x1
...
/* 80241CD8 0023DB18  2C 1D 00 00 */	cmpwi r29, 0x0
...
/* 80241CE8 0023DB28  4B FF 4B 81 */	bl "__ct__Q24util28StateFactory<Q24util6IState>FPv"
/* 80241CEC 0023DB2C  3C 60 80 46 */	lis r3, "__vt__Q24util102StateFactoryArg1<Q24util6IState,Q53scn4step4boss15challengemaster11StateSCHide,PQ43scn4step4boss4Boss>"@ha
/* 80241CF0 0023DB30  38 03 55 48 */	addi r0, r3, "__vt__Q24util102StateFactoryArg1<Q24util6IState,Q53scn4step4boss15challengemaster11StateSCHide,PQ43scn4step4boss4Boss>"@l
/* 80241CF4 0023DB34  90 1D 00 00 */	stw r0, 0x0(r29)
/* 80241CF8 0023DB38  93 DD 00 08 */	stw r30, 0x8(r29)
.global lbl_80241CFC
lbl_80241CFC:
...
/* 80241D28 0023DB68  F3 E1 00 98 */	psq_st f31, 0x98(r1), 0, qr0
/* 80241D2C 0023DB6C  DB C1 00 80 */	stfd f30, 0x80(r1)
/* 80241D30 0023DB70  F3 C1 00 88 */	psq_st f30, 0x88(r1), 0, qr0
/* 80241D34 0023DB74  DB A1 00 70 */	stfd f29, 0x70(r1)
/* 80241D38 0023DB78  F3 A1 00 78 */	psq_st f29, 0x78(r1), 0, qr0
...
/* 80241D48 0023DB88  88 03 00 08 */	lbz r0, 0x8(r3)
/* 80241D4C 0023DB8C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80241D68 0023DBA8  C8 42 A5 F0 */	lfd f2, "@56807"@sda21(r2)
...
/* 80241D98 0023DBD8  C0 02 A5 DC */	lfs f0, "@56800"@sda21(r2)
...
/* 80241DCC 0023DC0C  2C 03 00 00 */	cmpwi r3, 0x0
/* 80241DD0 0023DC10  40 82 00 14 */	bne lbl_80241DE4
/* 80241DD4 0023DC14  38 61 00 48 */	addi r3, r1, 0x48
/* 80241DD8 0023DC18  38 80 FF FF */	li r4, -0x1
/* 80241DDC 0023DC1C  4B FE 5A 65 */	bl "__dt__Q24util35ObjRefHandle<Q43scn4step4boss4Boss>Fv"
...
/* 80241DF4 0023DC34  C0 02 A5 EC */	lfs f0, "@56804_8056056C"@sda21(r2)
...
/* 80241E04 0023DC44  C0 02 A5 E8 */	lfs f0, "@56803_80560568"@sda21(r2)
/* 80241E08 0023DC48  EC 20 07 B2 */	fmuls f1, f0, f30
/* 80241E0C 0023DC4C  4B FF 71 89 */	bl SinDegF__Q33hel4math4MathFf
/* 80241E10 0023DC50  C0 02 A5 E4 */	lfs f0, "@56802_80560564"@sda21(r2)
/* 80241E14 0023DC54  EC 20 F8 7A */	fmadds f1, f0, f1, f31
/* 80241E18 0023DC58  C0 02 A5 E0 */	lfs f0, "@56801"@sda21(r2)
/* 80241E1C 0023DC5C  EF E0 00 72 */	fmuls f31, f0, f1
/* 80241E20 0023DC60  C0 02 A5 D8 */	lfs f0, "@56779"@sda21(r2)
...
/* 80241E3C 0023DC7C  4B FB CB 81 */	bl "LinearInterpolation<f>__Q33hel4math4MathFRCfRCff_Cf"
...
/* 80241E50 0023DC90  4B FB CB 6D */	bl "LinearInterpolation<f>__Q33hel4math4MathFRCfRCff_Cf"
...
/* 80241E6C 0023DCAC  4B FB CB 51 */	bl "LinearInterpolation<f>__Q33hel4math4MathFRCfRCff_Cf"
...
/* 80241EF8 0023DD38  90 61 00 08 */	stw r3, 0x8(r1)
...
/* 80241F08 0023DD48  38 81 00 08 */	addi r4, r1, 0x8
...
/* 80241F14 0023DD54  38 80 FF FF */	li r4, -0x1
/* 80241F18 0023DD58  4B FE 59 29 */	bl "__dt__Q24util35ObjRefHandle<Q43scn4step4boss4Boss>Fv"
.global lbl_80241F1C
lbl_80241F1C:
...
/* 80241F98 0023DDD8  C8 42 A5 F0 */	lfd f2, "@56807"@sda21(r2)
...
/* 80241FC8 0023DE08  C0 02 A5 DC */	lfs f0, "@56800"@sda21(r2)
/* 80241FCC 0023DE0C  EC 20 00 72 */	fmuls f1, f0, f1
/* 80241FD0 0023DE10  C0 02 A5 FC */	lfs f0, "@56813"@sda21(r2)
/* 80241FD4 0023DE14  EC 20 00 72 */	fmuls f1, f0, f1
/* 80241FD8 0023DE18  C0 02 A5 F8 */	lfs f0, "@56812"@sda21(r2)
/* 80241FDC 0023DE1C  EC 20 00 72 */	fmuls f1, f0, f1
/* 80241FE0 0023DE20  4B EB CB 41 */	bl CosFIdx__Q24nw4r4mathFf
/* 80241FE4 0023DE24  C0 02 A6 00 */	lfs f0, "@56878"@sda21(r2)
/* 80241FE8 0023DE28  EC 20 08 28 */	fsubs f1, f0, f1
/* 80241FEC 0023DE2C  38 6D AB F8 */	addi r3, r13, "@55744"@sda21
/* 80241FF0 0023DE30  38 9D 01 84 */	addi r4, r29, 0x184
/* 80241FF4 0023DE34  4B FB C9 C9 */	bl "LinearInterpolation<f>__Q33hel4math4MathFRCfRCff_Cf"
...
/* 80242018 0023DE58  38 A0 00 02 */	li r5, 0x2
...
/* 80242050 0023DE90  38 80 FF FF */	li r4, -0x1
...
/* 80242070 0023DEB0  3B A0 00 00 */	li r29, 0x0
...
/* 80242080 0023DEC0  C0 62 A6 04 */	lfs f3, "@56879"@sda21(r2)
/* 80242084 0023DEC4  4B F7 38 B1 */	bl Equals__Q33hel4math4MathFfff
/* 80242088 0023DEC8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80242098 0023DED8  C0 5E 00 04 */	lfs f2, 0x4(r30)
/* 8024209C 0023DEDC  C0 62 A6 04 */	lfs f3, "@56879"@sda21(r2)
/* 802420A0 0023DEE0  4B F7 38 95 */	bl Equals__Q33hel4math4MathFfff
/* 802420A4 0023DEE4  2C 03 00 00 */	cmpwi r3, 0x0
/* 802420A8 0023DEE8  41 82 00 20 */	beq lbl_802420C8
/* 802420AC 0023DEEC  C0 21 00 4C */	lfs f1, 0x4c(r1)
/* 802420B0 0023DEF0  C0 5E 00 08 */	lfs f2, 0x8(r30)
/* 802420B4 0023DEF4  C0 62 A6 04 */	lfs f3, "@56879"@sda21(r2)
/* 802420B8 0023DEF8  4B F7 38 7D */	bl Equals__Q33hel4math4MathFfff
/* 802420BC 0023DEFC  2C 03 00 00 */	cmpwi r3, 0x0
/* 802420C0 0023DF00  41 82 00 08 */	beq lbl_802420C8
/* 802420C4 0023DF04  3B A0 00 01 */	li r29, 0x1
.global lbl_802420C8
lbl_802420C8:
/* 802420C8 0023DF08  2C 1D 00 00 */	cmpwi r29, 0x0
...
/* 802420E4 0023DF24  C0 22 A5 E4 */	lfs f1, "@56802_80560564"@sda21(r2)
...
/* 80242124 0023DF64  93 A1 00 08 */	stw r29, 0x8(r1)
...
/* 80242138 0023DF78  38 00 00 00 */	li r0, 0x0
...
/* 80242158 0023DF98  C0 03 00 04 */	lfs f0, 0x4(r3)
...
/* 80242168 0023DFA8  C0 03 00 08 */	lfs f0, 0x8(r3)
/* 8024216C 0023DFAC  FC 01 00 00 */	fcmpu cr0, f1, f0
/* 80242170 0023DFB0  40 82 00 08 */	bne lbl_80242178
/* 80242174 0023DFB4  38 00 00 01 */	li r0, 0x1
.global lbl_80242178
lbl_80242178:
/* 80242178 0023DFB8  2C 00 00 00 */	cmpwi r0, 0x0
/* 8024217C 0023DFBC  41 82 00 0C */	beq lbl_80242188
/* 80242180 0023DFC0  38 00 00 00 */	li r0, 0x0
...
/* 80242194 0023DFD4  38 00 00 01 */	li r0, 0x1
.global lbl_80242198
lbl_80242198:
/* 80242198 0023DFD8  2C 00 00 00 */	cmpwi r0, 0x0
/* 8024219C 0023DFDC  41 82 00 10 */	beq lbl_802421AC
/* 802421A0 0023DFE0  38 61 00 08 */	addi r3, r1, 0x8
/* 802421A4 0023DFE4  4B F5 C0 61 */	bl restruct__Q43hel4math10Direction32UpFv
/* 802421A8 0023DFE8  48 00 00 28 */	b lbl_802421D0
.global lbl_802421AC
lbl_802421AC:
/* 802421AC 0023DFEC  38 61 00 08 */	addi r3, r1, 0x8
...
/* 802421D4 0023E014  38 60 00 00 */	li r3, 0x0
/* 802421D8 0023E018  38 00 00 06 */	li r0, 0x6
/* 802421DC 0023E01C  7C 09 03 A6 */	mtctr r0
.global lbl_802421E0
lbl_802421E0:
/* 802421E0 0023E020  90 64 00 04 */	stw r3, 0x4(r4)
/* 802421E4 0023E024  94 64 00 08 */	stwu r3, 0x8(r4)
...
/* 80242244 0023E084  C0 03 00 04 */	lfs f0, 0x4(r3)
/* 80242248 0023E088  D0 01 00 94 */	stfs f0, 0x94(r1)
/* 8024224C 0023E08C  C0 03 00 08 */	lfs f0, 0x8(r3)
...
/* 80242270 0023E0B0  38 A0 00 02 */	li r5, 0x2
...
/* 80242294 0023E0D4  38 80 FF FF */	li r4, -0x1
...
.global "create__Q24util105StateFactoryArg1<Q24util6IState,Q53scn4step4boss15challengemaster14StateSCFlyAway,PQ43scn4step4boss4Boss>Fv"
"create__Q24util105StateFactoryArg1<Q24util6IState,Q53scn4step4boss15challengemaster14StateSCFlyAway,PQ43scn4step4boss4Boss>Fv":
/* 802422C0 0023E100  7C 64 1B 78 */	mr r4, r3
/* 802422C4 0023E104  80 63 00 04 */	lwz r3, 0x4(r3)
/* 802422C8 0023E108  2C 03 00 00 */	cmpwi r3, 0x0
/* 802422CC 0023E10C  4D 82 00 20 */	beqlr
/* 802422D0 0023E110  80 84 00 08 */	lwz r4, 0x8(r4)
...
.global "__dt__Q24util105StateFactoryArg1<Q24util6IState,Q53scn4step4boss15challengemaster14StateSCFlyAway,PQ43scn4step4boss4Boss>Fv"
"__dt__Q24util105StateFactoryArg1<Q24util6IState,Q53scn4step4boss15challengemaster14StateSCFlyAway,PQ43scn4step4boss4Boss>Fv":
/* 802422DC 0023E11C  4B FE C3 C4 */	b "__dt__Q24util89StateFactoryArg1<Q24util6IState,Q53scn4step4boss6common9StateWait,PQ43scn4step4boss4Boss>Fv"
.include "macros.inc"

.section .data, "wa"  # 0x80421040 - 0x80496700 ; 0x000756C0
.global "__vt__Q24util105StateFactoryArg1<Q24util6IState,Q53scn4step4boss15challengemaster14StateSCFlyAway,PQ43scn4step4boss4Boss>"
"__vt__Q24util105StateFactoryArg1<Q24util6IState,Q53scn4step4boss15challengemaster14StateSCFlyAway,PQ43scn4step4boss4Boss>":

	.4byte 0
	.4byte 0
	.4byte "__dt__Q24util105StateFactoryArg1<Q24util6IState,Q53scn4step4boss15challengemaster14StateSCFlyAway,PQ43scn4step4boss4Boss>Fv"
	.4byte "create__Q24util105StateFactoryArg1<Q24util6IState,Q53scn4step4boss15challengemaster14StateSCFlyAway,PQ43scn4step4boss4Boss>Fv"
...
__vt__Q53scn4step4boss15challengemaster14StateSCFlyAway:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step4boss15challengemaster14StateSCFlyAwayFv
	.4byte procAnim__Q53scn4step4boss15challengemaster14StateSCFlyAwayFv
	.4byte procMove__Q53scn4step4boss15challengemaster14StateSCFlyAwayFv
	.4byte procConstraint__Q43scn4step4boss9StateBaseFv
	.4byte procFixPos__Q53scn4step4boss15challengemaster14StateSCFlyAwayFv
...
.global "@56802_80560564"
"@56802_80560564":

	.4byte 0xBF800000

.global "@56803_80560568"
"@56803_80560568":

	.4byte 0x43B40000

.global "@56804_8056056C"
"@56804_8056056C":
