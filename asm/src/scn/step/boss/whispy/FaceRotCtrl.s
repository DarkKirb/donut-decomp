...
/* 8025C6B4 002584F4  4B DA AC 8D */	bl lbl_80007340
/* 8025C6B8 002584F8  7C 7C 1B 78 */	mr r28, r3
/* 8025C6BC 002584FC  C0 02 AA 58 */	lfs f0, "@54989_805609D8"@sda21(r2)
...
/* 8025C6CC 0025850C  4C 41 13 82 */	cror eq, gt, eq
/* 8025C6D0 00258510  41 82 FF F4 */	beq lbl_8025C6C4
/* 8025C6D4 00258514  C0 42 AA 58 */	lfs f2, "@54989_805609D8"@sda21(r2)
/* 8025C6D8 00258518  C0 02 AA 5C */	lfs f0, "@54990"@sda21(r2)
...
/* 8025C704 00258544  3B A0 00 00 */	li r29, 0x0
/* 8025C708 00258548  3B E0 00 00 */	li r31, 0x0
/* 8025C70C 0025854C  3C 60 80 41 */	lis r3, "T_TARGET_NODE__Q53scn4step4boss6whispy25@unnamed@FaceRotCtrl_cpp@"@ha
/* 8025C710 00258550  3B C3 75 A8 */	addi r30, r3, "T_TARGET_NODE__Q53scn4step4boss6whispy25@unnamed@FaceRotCtrl_cpp@"@l
.global lbl_8025C714
lbl_8025C714:
/* 8025C714 00258554  80 7C 00 00 */	lwz r3, 0x0(r28)
...
/* 8025C73C 0025857C  90 61 00 08 */	stw r3, 0x8(r1)
/* 8025C740 00258580  38 61 00 08 */	addi r3, r1, 0x8
...
/* 8025C750 00258590  38 80 FF FF */	li r4, -0x1
/* 8025C754 00258594  4B F1 FF 3D */	bl __dt__Q23g3d12NodeAccessorFv
/* 8025C758 00258598  3B BD 00 01 */	addi r29, r29, 0x1
/* 8025C75C 0025859C  3B FF 00 04 */	addi r31, r31, 0x4
/* 8025C760 002585A0  28 1D 00 03 */	cmplwi r29, 0x3
/* 8025C764 002585A4  41 80 FF B0 */	blt lbl_8025C714
/* 8025C768 002585A8  39 61 00 70 */	addi r11, r1, 0x70
/* 8025C76C 002585AC  4B DA AC 21 */	bl lbl_8000738C
...
/* 8025C790 002585D0  4B DA AB B1 */	bl lbl_80007340
/* 8025C794 002585D4  7C 7C 1B 78 */	mr r28, r3
/* 8025C798 002585D8  3B A0 00 00 */	li r29, 0x0
/* 8025C79C 002585DC  3B E0 00 00 */	li r31, 0x0
/* 8025C7A0 002585E0  3C 60 80 41 */	lis r3, "T_TARGET_NODE__Q53scn4step4boss6whispy25@unnamed@FaceRotCtrl_cpp@"@ha
/* 8025C7A4 002585E4  3B C3 75 A8 */	addi r30, r3, "T_TARGET_NODE__Q53scn4step4boss6whispy25@unnamed@FaceRotCtrl_cpp@"@l
.global lbl_8025C7A8
lbl_8025C7A8:
/* 8025C7A8 002585E8  80 7C 00 00 */	lwz r3, 0x0(r28)
...
/* 8025C7D0 00258610  90 61 00 08 */	stw r3, 0x8(r1)
/* 8025C7D4 00258614  38 61 00 08 */	addi r3, r1, 0x8
/* 8025C7D8 00258618  4B F3 6A 31 */	bl reset__Q23g3d20NodeLocalMtxAccessorCFv
/* 8025C7DC 0025861C  38 61 00 0C */	addi r3, r1, 0xc
/* 8025C7E0 00258620  38 80 FF FF */	li r4, -0x1
/* 8025C7E4 00258624  4B F1 FE AD */	bl __dt__Q23g3d12NodeAccessorFv
/* 8025C7E8 00258628  3B BD 00 01 */	addi r29, r29, 0x1
/* 8025C7EC 0025862C  3B FF 00 04 */	addi r31, r31, 0x4
/* 8025C7F0 00258630  28 1D 00 03 */	cmplwi r29, 0x3
/* 8025C7F4 00258634  41 80 FF B4 */	blt lbl_8025C7A8
/* 8025C7F8 00258638  39 61 00 30 */	addi r11, r1, 0x30
/* 8025C7FC 0025863C  4B DA AB 91 */	bl lbl_8000738C
