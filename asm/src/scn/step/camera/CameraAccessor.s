...
/* 80262A2C 0025E86C  90 83 00 00 */	stw r4, 0x0(r3)
/* 80262A30 0025E870  38 63 00 04 */	addi r3, r3, 0x4
/* 80262A34 0025E874  3C 80 80 47 */	lis r4, "@STRING@__ct__Q43scn4step6camera13ParamAccessorFv"@ha
/* 80262A38 0025E878  38 84 B1 28 */	addi r4, r4, "@STRING@__ct__Q43scn4step6camera13ParamAccessorFv"@l
...
/* 80262AFC 0025E93C  2C 04 00 01 */	cmpwi r4, 0x1
/* 80262B00 0025E940  40 82 00 14 */	bne lbl_80262B14
/* 80262B04 0025E944  80 63 00 00 */	lwz r3, 0x0(r3)
...
.global lbl_80262B14
lbl_80262B14:
/* 80262B14 0025E954  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 80262B3C 0025E97C  2C 04 00 01 */	cmpwi r4, 0x1
/* 80262B40 0025E980  40 82 00 14 */	bne lbl_80262B54
/* 80262B44 0025E984  80 63 00 00 */	lwz r3, 0x0(r3)
...
.global lbl_80262B54
lbl_80262B54:
/* 80262B54 0025E994  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 80262B88 0025E9C8  2C 04 00 01 */	cmpwi r4, 0x1
/* 80262B8C 0025E9CC  40 82 00 40 */	bne lbl_80262BCC
/* 80262B90 0025E9D0  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 80262BA0 0025E9E0  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 80262BAC 0025E9EC  2C 03 00 00 */	cmpwi r3, 0x0
/* 80262BB0 0025E9F0  41 82 00 14 */	beq lbl_80262BC4
/* 80262BB4 0025E9F4  80 7F 00 00 */	lwz r3, 0x0(r31)
...
.global lbl_80262BCC
lbl_80262BCC:
/* 80262BCC 0025EA0C  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 80262BDC 0025EA1C  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 80262BE8 0025EA28  2C 03 00 00 */	cmpwi r3, 0x0
/* 80262BEC 0025EA2C  41 82 00 14 */	beq lbl_80262C00
/* 80262BF0 0025EA30  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 80262C28 0025EA68  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 80262C90 0025EAD0  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 80262C9C 0025EADC  2C 03 00 00 */	cmpwi r3, 0x0
/* 80262CA0 0025EAE0  41 82 00 24 */	beq lbl_80262CC4
/* 80262CA4 0025EAE4  80 7F 00 00 */	lwz r3, 0x0(r31)
...
.global lbl_80262CD4
lbl_80262CD4:
/* 80262CD4 0025EB14  80 64 00 00 */	lwz r3, 0x0(r4)
...
/* 80262CE8 0025EB28  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 80262CF4 0025EB34  2C 03 00 00 */	cmpwi r3, 0x0
/* 80262CF8 0025EB38  41 82 00 24 */	beq lbl_80262D1C
/* 80262CFC 0025EB3C  80 7F 00 00 */	lwz r3, 0x0(r31)
...
.global lbl_80262D2C
lbl_80262D2C:
/* 80262D2C 0025EB6C  38 61 00 08 */	addi r3, r1, 0x8
...
/* 80262D38 0025EB78  38 81 00 08 */	addi r4, r1, 0x8
...
/* 80262DBC 0025EBFC  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 80262DC8 0025EC08  2C 03 00 00 */	cmpwi r3, 0x0
/* 80262DCC 0025EC0C  41 82 00 24 */	beq lbl_80262DF0
/* 80262DD0 0025EC10  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 80262DF8 0025EC38  90 7E 00 00 */	stw r3, 0x0(r30)
/* 80262DFC 0025EC3C  90 1E 00 04 */	stw r0, 0x4(r30)
/* 80262E00 0025EC40  80 01 00 34 */	lwz r0, 0x34(r1)
/* 80262E04 0025EC44  90 1E 00 08 */	stw r0, 0x8(r30)
/* 80262E08 0025EC48  48 00 00 84 */	b lbl_80262E8C
.global lbl_80262E0C
lbl_80262E0C:
/* 80262E0C 0025EC4C  80 64 00 00 */	lwz r3, 0x0(r4)
...
/* 80262E20 0025EC60  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 80262E4C 0025EC8C  38 81 00 08 */	addi r4, r1, 0x8
...
/* 80262E5C 0025EC9C  90 7E 00 00 */	stw r3, 0x0(r30)
/* 80262E60 0025ECA0  90 1E 00 04 */	stw r0, 0x4(r30)
/* 80262E64 0025ECA4  80 01 00 28 */	lwz r0, 0x28(r1)
/* 80262E68 0025ECA8  90 1E 00 08 */	stw r0, 0x8(r30)
/* 80262E6C 0025ECAC  48 00 00 20 */	b lbl_80262E8C
.global lbl_80262E70
lbl_80262E70:
/* 80262E70 0025ECB0  C0 02 AB 38 */	lfs f0, "@52507"@sda21(r2)
/* 80262E74 0025ECB4  D0 03 00 00 */	stfs f0, 0x0(r3)
/* 80262E78 0025ECB8  D0 03 00 04 */	stfs f0, 0x4(r3)
/* 80262E7C 0025ECBC  C0 02 AB 3C */	lfs f0, "@52508"@sda21(r2)
/* 80262E80 0025ECC0  D0 03 00 08 */	stfs f0, 0x8(r3)
...
/* 80262EFC 0025ED3C  80 7E 00 00 */	lwz r3, 0x0(r30)
...
/* 80262F08 0025ED48  2C 03 00 00 */	cmpwi r3, 0x0
/* 80262F0C 0025ED4C  41 82 00 24 */	beq lbl_80262F30
/* 80262F10 0025ED50  80 7E 00 00 */	lwz r3, 0x0(r30)
...
.global lbl_80262F40
lbl_80262F40:
/* 80262F40 0025ED80  80 64 00 00 */	lwz r3, 0x0(r4)
...
/* 80262F54 0025ED94  80 7E 00 00 */	lwz r3, 0x0(r30)
...
/* 80262F60 0025EDA0  2C 03 00 00 */	cmpwi r3, 0x0
/* 80262F64 0025EDA4  41 82 00 24 */	beq lbl_80262F88
/* 80262F68 0025EDA8  80 7E 00 00 */	lwz r3, 0x0(r30)
...
.global lbl_80262F98
lbl_80262F98:
/* 80262F98 0025EDD8  38 61 00 08 */	addi r3, r1, 0x8
...
/* 80262FA4 0025EDE4  38 81 00 08 */	addi r4, r1, 0x8
...
/* 80262FFC 0025EE3C  38 61 00 08 */	addi r3, r1, 0x8
...
/* 80263008 0025EE48  38 81 00 08 */	addi r4, r1, 0x8
...
/* 80263064 0025EEA4  38 61 00 08 */	addi r3, r1, 0x8
...
/* 80263074 0025EEB4  38 A1 00 08 */	addi r5, r1, 0x8
