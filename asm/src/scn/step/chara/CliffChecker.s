...
/* 8026D514 00269354  90 83 00 00 */	stw r4, 0x0(r3)
/* 8026D518 00269358  90 A3 00 04 */	stw r5, 0x4(r3)
/* 8026D51C 0026935C  90 C3 00 08 */	stw r6, 0x8(r3)
/* 8026D520 00269360  90 E3 00 0C */	stw r7, 0xc(r3)
/* 8026D524 00269364  D0 23 00 10 */	stfs f1, 0x10(r3)
/* 8026D528 00269368  38 00 00 00 */	li r0, 0x0
/* 8026D52C 0026936C  98 03 00 14 */	stb r0, 0x14(r3)
/* 8026D530 00269370  38 00 00 01 */	li r0, 0x1
...
/* 8026D58C 002693CC  C0 02 AC A0 */	lfs f0, "@52371_80560C20"@sda21(r2)
/* 8026D590 002693D0  EC 01 00 2A */	fadds f0, f1, f0
/* 8026D594 002693D4  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 8026D598 002693D8  C0 02 AC A4 */	lfs f0, "@52372"@sda21(r2)
/* 8026D59C 002693DC  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 8026D5A0 002693E0  C0 02 AC A8 */	lfs f0, "@52373"@sda21(r2)
/* 8026D5A4 002693E4  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 8026D5A8 002693E8  38 61 00 08 */	addi r3, r1, 0x8
...
/* 8026D5E0 00269420  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8026D5F4 00269434  2C 03 00 00 */	cmpwi r3, 0x0
/* 8026D5F8 00269438  40 82 00 20 */	bne lbl_8026D618
/* 8026D5FC 0026943C  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8026D610 00269450  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8026D630 00269470  C0 02 AC A4 */	lfs f0, "@52372"@sda21(r2)
/* 8026D634 00269474  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8026D638 00269478  41 80 00 CC */	blt lbl_8026D704
/* 8026D63C 0026947C  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8026D64C 0026948C  C8 22 AC B0 */	lfd f1, "@52377"@sda21(r2)
...
.global lbl_8026D674
lbl_8026D674:
/* 8026D674 002694B4  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8026D688 002694C8  2C 03 00 00 */	cmpwi r3, 0x0
/* 8026D68C 002694CC  40 82 00 78 */	bne lbl_8026D704
/* 8026D690 002694D0  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8026D6A4 002694E4  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8026D6B4 002694F4  C0 02 AC AC */	lfs f0, "@52374_80560C2C"@sda21(r2)
/* 8026D6B8 002694F8  EC 01 00 28 */	fsubs f0, f1, f0
/* 8026D6BC 002694FC  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 8026D6C0 00269500  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8026D6D4 00269514  2C 03 00 00 */	cmpwi r3, 0x0
/* 8026D6D8 00269518  40 82 00 2C */	bne lbl_8026D704
/* 8026D6DC 0026951C  80 7F 00 00 */	lwz r3, 0x0(r31)
