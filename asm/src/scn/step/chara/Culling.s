...
/* 8026D728 00269568  90 83 00 00 */	stw r4, 0x0(r3)
/* 8026D72C 0026956C  90 A3 00 04 */	stw r5, 0x4(r3)
/* 8026D730 00269570  38 00 00 01 */	li r0, 0x1
/* 8026D734 00269574  98 03 00 08 */	stb r0, 0x8(r3)
...
/* 8026D764 002695A4  80 9F 00 04 */	lwz r4, 0x4(r31)
/* 8026D768 002695A8  4B F0 EE 61 */	bl __ct__Q33hel4math7Vector3FRCQ33hel4math7Vector3
/* 8026D76C 002695AC  38 61 00 08 */	addi r3, r1, 0x8
...
/* 8026D77C 002695BC  38 81 00 08 */	addi r4, r1, 0x8
...
/* 8026D800 00269640  C8 22 AC C0 */	lfd f1, "@56041_80560C40"@sda21(r2)
...
/* 8026D83C 0026967C  C0 21 00 08 */	lfs f1, 0x8(r1)
...
/* 8026D854 00269694  38 80 FF FF */	li r4, -0x1
...
/* 8026D894 002696D4  88 03 00 08 */	lbz r0, 0x8(r3)
/* 8026D898 002696D8  2C 00 00 00 */	cmpwi r0, 0x0
/* 8026D89C 002696DC  40 82 00 0C */	bne lbl_8026D8A8
/* 8026D8A0 002696E0  38 60 00 00 */	li r3, 0x0
/* 8026D8A4 002696E4  48 00 00 80 */	b lbl_8026D924
.global lbl_8026D8A8
lbl_8026D8A8:
/* 8026D8A8 002696E8  C0 24 00 0C */	lfs f1, 0xc(r4)
/* 8026D8AC 002696EC  C0 02 AC B8 */	lfs f0, "@56037_80560C38"@sda21(r2)
/* 8026D8B0 002696F0  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8026D8B4 002696F4  41 80 00 38 */	blt lbl_8026D8EC
/* 8026D8B8 002696F8  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 8026D8C8 00269708  C8 22 AC C0 */	lfd f1, "@56041_80560C40"@sda21(r2)
...
/* 8026D914 00269754  38 61 00 08 */	addi r3, r1, 0x8
/* 8026D918 00269758  38 80 FF FF */	li r4, -0x1
...
/* 8026D93C 0026977C  98 83 00 08 */	stb r4, 0x8(r3)
...
/* 8026D954 00269794  F3 E1 00 88 */	psq_st f31, 0x88(r1), 0, qr0
...
/* 8026D968 002697A8  80 64 00 00 */	lwz r3, 0x0(r4)
...
/* 8026D974 002697B4  C0 42 AC C8 */	lfs f2, "@56053_80560C48"@sda21(r2)
...
/* 8026D988 002697C8  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8026D994 002697D4  C0 A2 AC CC */	lfs f5, "@56054_80560C4C"@sda21(r2)
...
/* 8026D9AC 002697EC  C0 02 AC C8 */	lfs f0, "@56053_80560C48"@sda21(r2)
...
/* 8026D9D4 00269814  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8026D9E8 00269828  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8026DA60 002698A0  2C 00 00 00 */	cmpwi r0, 0x0
/* 8026DA64 002698A4  41 82 00 70 */	beq lbl_8026DAD4
/* 8026DA68 002698A8  38 61 00 40 */	addi r3, r1, 0x40
/* 8026DA6C 002698AC  C0 22 AC D0 */	lfs f1, "@56055_80560C50"@sda21(r2)
/* 8026DA70 002698B0  C0 42 AC D4 */	lfs f2, "@56056_80560C54"@sda21(r2)
...
/* 8026DA80 002698C0  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8026DA98 002698D8  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8026DACC 0026990C  38 80 FF FF */	li r4, -0x1
/* 8026DAD0 00269910  4B F3 23 6D */	bl __dt__Q33hel3geo4RectFv
.global lbl_8026DAD4
lbl_8026DAD4:
/* 8026DAD4 00269914  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8026DAE0 00269920  C0 02 AC C8 */	lfs f0, "@56053_80560C48"@sda21(r2)
/* 8026DAE4 00269924  EF E0 00 72 */	fmuls f31, f0, f1
/* 8026DAE8 00269928  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 8026DAF4 00269934  C0 1E 00 00 */	lfs f0, 0x0(r30)
/* 8026DAF8 00269938  EC 00 F8 2A */	fadds f0, f0, f31
/* 8026DAFC 0026993C  D0 1E 00 00 */	stfs f0, 0x0(r30)
/* 8026DB00 00269940  C0 1E 00 04 */	lfs f0, 0x4(r30)
/* 8026DB04 00269944  EC 00 F8 28 */	fsubs f0, f0, f31
/* 8026DB08 00269948  D0 1E 00 04 */	stfs f0, 0x4(r30)
/* 8026DB0C 0026994C  C0 1E 00 08 */	lfs f0, 0x8(r30)
/* 8026DB10 00269950  EC 00 08 28 */	fsubs f0, f0, f1
/* 8026DB14 00269954  D0 1E 00 08 */	stfs f0, 0x8(r30)
