...
/* 802A4BC4 002A0A04  F3 E1 00 38 */	psq_st f31, 0x38(r1), 0, qr0
...
/* 802A4BDC 002A0A1C  90 1F 00 00 */	stw r0, 0x0(r31)
/* 802A4BE0 002A0A20  C0 02 B5 80 */	lfs f0, "@56311"@sda21(r2)
/* 802A4BE4 002A0A24  D0 1F 00 08 */	stfs f0, 0x8(r31)
/* 802A4BE8 002A0A28  38 00 00 00 */	li r0, 0x0
...
/* 802A4C08 002A0A48  38 80 00 06 */	li r4, 0x6
...
/* 802A4C20 002A0A60  38 61 00 08 */	addi r3, r1, 0x8
/* 802A4C24 002A0A64  4B FC AA 91 */	bl pos__Q43scn4step5chara8LocationCFv
/* 802A4C28 002A0A68  C3 E1 00 08 */	lfs f31, 0x8(r1)
...
/* 802A4C50 002A0A90  C0 02 B5 84 */	lfs f0, "@56312_80561504"@sda21(r2)
/* 802A4C54 002A0A94  48 00 00 08 */	b lbl_802A4C5C
.global lbl_802A4C58
lbl_802A4C58:
/* 802A4C58 002A0A98  C0 02 B5 88 */	lfs f0, "@56313"@sda21(r2)
.global lbl_802A4C5C
lbl_802A4C5C:
/* 802A4C5C 002A0A9C  D0 1F 00 08 */	stfs f0, 0x8(r31)
/* 802A4C60 002A0AA0  FC 20 00 18 */	frsp f1, f0
/* 802A4C64 002A0AA4  C0 02 B5 80 */	lfs f0, "@56311"@sda21(r2)
/* 802A4C68 002A0AA8  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802A4C6C 002A0AAC  7C 00 00 26 */	mfcr r0
/* 802A4C70 002A0AB0  54 00 17 FE */	extrwi r0, r0, 1, 1
...
/* 802A4CAC 002A0AEC  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802A4CB0 002A0AF0  7C 7E 1B 78 */	mr r30, r3
/* 802A4CB4 002A0AF4  7C 9F 23 78 */	mr r31, r4
/* 802A4CB8 002A0AF8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A4CC8 002A0B08  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 802A4CFC 002A0B3C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 802A4D20 002A0B60  F3 E1 00 88 */	psq_st f31, 0x88(r1), 0, qr0
/* 802A4D24 002A0B64  39 61 00 80 */	addi r11, r1, 0x80
/* 802A4D28 002A0B68  4B D6 26 19 */	bl lbl_80007340
...
/* 802A4D3C 002A0B7C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A4D54 002A0B94  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A4D7C 002A0BBC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A4D94 002A0BD4  38 80 00 06 */	li r4, 0x6
...
/* 802A4DD0 002A0C10  90 61 00 08 */	stw r3, 0x8(r1)
...
/* 802A4E10 002A0C50  80 61 00 08 */	lwz r3, 0x8(r1)
...
/* 802A4E74 002A0CB4  3B E0 00 00 */	li r31, 0x0
...
/* 802A4E84 002A0CC4  C0 62 B5 8C */	lfs f3, "@56351_8056150C"@sda21(r2)
/* 802A4E88 002A0CC8  4B F1 0A AD */	bl Equals__Q33hel4math4MathFfff
/* 802A4E8C 002A0CCC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A4E9C 002A0CDC  C0 5E 00 04 */	lfs f2, 0x4(r30)
/* 802A4EA0 002A0CE0  C0 62 B5 8C */	lfs f3, "@56351_8056150C"@sda21(r2)
/* 802A4EA4 002A0CE4  4B F1 0A 91 */	bl Equals__Q33hel4math4MathFfff
/* 802A4EA8 002A0CE8  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A4EAC 002A0CEC  41 82 00 20 */	beq lbl_802A4ECC
/* 802A4EB0 002A0CF0  C0 21 00 34 */	lfs f1, 0x34(r1)
/* 802A4EB4 002A0CF4  C0 5E 00 08 */	lfs f2, 0x8(r30)
/* 802A4EB8 002A0CF8  C0 62 B5 8C */	lfs f3, "@56351_8056150C"@sda21(r2)
/* 802A4EBC 002A0CFC  4B F1 0A 79 */	bl Equals__Q33hel4math4MathFfff
/* 802A4EC0 002A0D00  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A4EC4 002A0D04  41 82 00 08 */	beq lbl_802A4ECC
/* 802A4EC8 002A0D08  3B E0 00 01 */	li r31, 0x1
.global lbl_802A4ECC
lbl_802A4ECC:
/* 802A4ECC 002A0D0C  2C 1F 00 00 */	cmpwi r31, 0x0
/* 802A4ED0 002A0D10  41 82 00 38 */	beq lbl_802A4F08
/* 802A4ED4 002A0D14  C0 22 B5 90 */	lfs f1, "@56352_80561510"@sda21(r2)
/* 802A4ED8 002A0D18  C0 1C 00 08 */	lfs f0, 0x8(r28)
/* 802A4EDC 002A0D1C  EC 01 00 32 */	fmuls f0, f1, f0
/* 802A4EE0 002A0D20  D0 01 00 5C */	stfs f0, 0x5c(r1)
/* 802A4EE4 002A0D24  C0 02 B5 94 */	lfs f0, "@56353"@sda21(r2)
/* 802A4EE8 002A0D28  D0 01 00 60 */	stfs f0, 0x60(r1)
/* 802A4EEC 002A0D2C  C0 02 B5 80 */	lfs f0, "@56311"@sda21(r2)
...
/* 802A4F2C 002A0D6C  2C 1D 00 00 */	cmpwi r29, 0x0
...
/* 802A4F3C 002A0D7C  4B F9 19 2D */	bl "__ct__Q24util28StateFactory<Q24util6IState>FPv"
/* 802A4F40 002A0D80  3C 60 80 47 */	lis r3, "__vt__Q24util102StateFactoryArg1<Q24util6IState,Q53scn4step5enemy6damage18StateDamageCapture,PQ43scn4step5enemy5Enemy>"@ha
/* 802A4F44 002A0D84  38 03 54 48 */	addi r0, r3, "__vt__Q24util102StateFactoryArg1<Q24util6IState,Q53scn4step5enemy6damage18StateDamageCapture,PQ43scn4step5enemy5Enemy>"@l
/* 802A4F48 002A0D88  90 1D 00 00 */	stw r0, 0x0(r29)
/* 802A4F4C 002A0D8C  93 FD 00 08 */	stw r31, 0x8(r29)
.global lbl_802A4F50
lbl_802A4F50:
...
/* 802A4F80 002A0DC0  2C 1C 00 00 */	cmpwi r28, 0x0
...
/* 802A4F90 002A0DD0  4B F9 18 D9 */	bl "__ct__Q24util28StateFactory<Q24util6IState>FPv"
/* 802A4F94 002A0DD4  3C 60 80 47 */	lis r3, "__vt__Q24util109StateFactoryArg2<Q24util6IState,Q53scn4step5enemy6damage23StateDeadCaptureRelease,PQ43scn4step5enemy5Enemy,b>"@ha
/* 802A4F98 002A0DD8  38 03 53 E8 */	addi r0, r3, "__vt__Q24util109StateFactoryArg2<Q24util6IState,Q53scn4step5enemy6damage23StateDeadCaptureRelease,PQ43scn4step5enemy5Enemy,b>"@l
/* 802A4F9C 002A0DDC  90 1C 00 00 */	stw r0, 0x0(r28)
/* 802A4FA0 002A0DE0  93 DC 00 08 */	stw r30, 0x8(r28)
...
/* 802A4FF0 002A0E30  54 00 17 FE */	extrwi r0, r0, 1, 1
...
/* 802A5008 002A0E48  4B D6 23 85 */	bl lbl_8000738C
...
/* 802A5030 002A0E70  C0 22 B5 84 */	lfs f1, "@56312_80561504"@sda21(r2)
...
.global "create__Q24util102StateFactoryArg1<Q24util6IState,Q53scn4step5enemy6damage18StateDamageCapture,PQ43scn4step5enemy5Enemy>Fv"
"create__Q24util102StateFactoryArg1<Q24util6IState,Q53scn4step5enemy6damage18StateDamageCapture,PQ43scn4step5enemy5Enemy>Fv":
/* 802A5048 002A0E88  7C 64 1B 78 */	mr r4, r3
/* 802A504C 002A0E8C  80 63 00 04 */	lwz r3, 0x4(r3)
/* 802A5050 002A0E90  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A5054 002A0E94  4D 82 00 20 */	beqlr
/* 802A5058 002A0E98  80 84 00 08 */	lwz r4, 0x8(r4)
...
.global "__dt__Q24util102StateFactoryArg1<Q24util6IState,Q53scn4step5enemy6damage18StateDamageCapture,PQ43scn4step5enemy5Enemy>Fv"
"__dt__Q24util102StateFactoryArg1<Q24util6IState,Q53scn4step5enemy6damage18StateDamageCapture,PQ43scn4step5enemy5Enemy>Fv":
/* 802A5064 002A0EA4  4B F8 96 3C */	b "__dt__Q24util89StateFactoryArg1<Q24util6IState,Q53scn4step4boss6common9StateWait,PQ43scn4step4boss4Boss>Fv"
.include "macros.inc"
...
.global "@56351_8056150C"
"@56351_8056150C":

	.4byte 0x3727C5AC

.global "@56352_80561510"
"@56352_80561510":
