...
/* 802A8E58 002A4C98  4B D5 E4 ED */	bl lbl_80007344
...
/* 802A8E6C 002A4CAC  90 1D 00 00 */	stw r0, 0x0(r29)
/* 802A8E70 002A4CB0  38 00 00 00 */	li r0, 0x0
/* 802A8E74 002A4CB4  90 1D 00 08 */	stw r0, 0x8(r29)
/* 802A8E78 002A4CB8  C0 02 B6 90 */	lfs f0, "@57027_80561610"@sda21(r2)
...
/* 802A8EA4 002A4CE4  38 80 00 06 */	li r4, 0x6
...
/* 802A8EBC 002A4CFC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A8ED0 002A4D10  38 61 00 08 */	addi r3, r1, 0x8
...
/* 802A8EEC 002A4D2C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A8F20 002A4D60  38 C1 00 08 */	addi r6, r1, 0x8
...
/* 802A8F30 002A4D70  4B D5 E4 61 */	bl lbl_80007390
...
/* 802A8F54 002A4D94  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802A8F58 002A4D98  7C 7E 1B 78 */	mr r30, r3
/* 802A8F5C 002A4D9C  7C 9F 23 78 */	mr r31, r4
/* 802A8F60 002A4DA0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A8F70 002A4DB0  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 802A8F80 002A4DC0  C0 22 B6 90 */	lfs f1, "@57027_80561610"@sda21(r2)
...
/* 802A8F98 002A4DD8  C0 22 B6 90 */	lfs f1, "@57027_80561610"@sda21(r2)
...
/* 802A8FD4 002A4E14  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 802A8FF8 002A4E38  F3 E1 00 38 */	psq_st f31, 0x38(r1), 0, qr0
...
/* 802A9010 002A4E50  2C 03 00 00 */	cmpwi r3, 0x0
...
.global lbl_802A9024
lbl_802A9024:
/* 802A9024 002A4E64  80 7F 00 08 */	lwz r3, 0x8(r31)
/* 802A9028 002A4E68  38 03 00 01 */	addi r0, r3, 0x1
/* 802A902C 002A4E6C  90 1F 00 08 */	stw r0, 0x8(r31)
...
/* 802A9048 002A4E88  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A9080 002A4EC0  C0 42 B6 94 */	lfs f2, "@57067"@sda21(r2)
...
/* 802A9090 002A4ED0  C0 02 B6 98 */	lfs f0, "@57068"@sda21(r2)
/* 802A9094 002A4ED4  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802A9098 002A4ED8  4C 41 13 82 */	cror eq, gt, eq
...
/* 802A90AC 002A4EEC  C0 02 B6 90 */	lfs f0, "@57027_80561610"@sda21(r2)
/* 802A90B0 002A4EF0  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802A90B4 002A4EF4  40 80 00 10 */	bge lbl_802A90C4
/* 802A90B8 002A4EF8  C0 02 B6 98 */	lfs f0, "@57068"@sda21(r2)
...
/* 802A90C8 002A4F08  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802A90F0 002A4F30  D0 21 00 08 */	stfs f1, 0x8(r1)
...
/* 802A9100 002A4F40  C0 02 B6 90 */	lfs f0, "@57027_80561610"@sda21(r2)
/* 802A9104 002A4F44  FC 1F 00 40 */	fcmpo cr0, f31, f0
/* 802A9108 002A4F48  4C 41 13 82 */	cror eq, gt, eq
/* 802A910C 002A4F4C  41 82 00 20 */	beq lbl_802A912C
/* 802A9110 002A4F50  3C 60 80 45 */	lis r3, "@STRING@FSqrt__Q24nw4r4mathFf"@ha
/* 802A9114 002A4F54  38 63 31 54 */	addi r3, r3, "@STRING@FSqrt__Q24nw4r4mathFf"@l
/* 802A9118 002A4F58  38 80 02 73 */	li r4, 0x273
/* 802A911C 002A4F5C  3C A0 80 45 */	lis r5, "@STRING@FSqrt__Q24nw4r4mathFf@0"@ha
/* 802A9120 002A4F60  38 A5 31 30 */	addi r5, r5, "@STRING@FSqrt__Q24nw4r4mathFf@0"@l
/* 802A9124 002A4F64  4C C6 31 82 */	crclr 4*cr1+eq
/* 802A9128 002A4F68  4B E7 F2 C9 */	bl Warning__Q24nw4r2dbFPCciPCce
.global lbl_802A912C
lbl_802A912C:
/* 802A912C 002A4F6C  C0 22 B6 90 */	lfs f1, "@57027_80561610"@sda21(r2)
/* 802A9130 002A4F70  FC 1F 08 40 */	fcmpo cr0, f31, f1
/* 802A9134 002A4F74  4C 40 13 82 */	cror eq, lt, eq
...
.global lbl_802A914C
lbl_802A914C:
/* 802A914C 002A4F8C  C0 02 B6 90 */	lfs f0, "@57027_80561610"@sda21(r2)
...
.global lbl_802A915C
lbl_802A915C:
/* 802A915C 002A4F9C  C0 02 B6 9C */	lfs f0, "@57069_8056161C"@sda21(r2)
/* 802A9160 002A4FA0  EC 20 08 24 */	fdivs f1, f0, f1
/* 802A9164 002A4FA4  C0 01 00 08 */	lfs f0, 0x8(r1)
/* 802A9168 002A4FA8  EC 00 00 72 */	fmuls f0, f0, f1
/* 802A916C 002A4FAC  D0 01 00 08 */	stfs f0, 0x8(r1)
...
.global lbl_802A917C
lbl_802A917C:
/* 802A917C 002A4FBC  38 6D EE 40 */	addi r3, r13, BASIS_Y__Q33hel4math7Vector2@sda21
/* 802A9180 002A4FC0  38 81 00 08 */	addi r4, r1, 0x8
...
/* 802A919C 002A4FDC  C0 02 B6 A0 */	lfs f0, "@57070_80561620"@sda21(r2)
...
/* 802A91EC 002A502C  C0 22 B6 90 */	lfs f1, "@57027_80561610"@sda21(r2)
...
/* 802A9230 002A5070  C0 22 B6 A4 */	lfs f1, "@57073_80561624"@sda21(r2)
/* 802A9234 002A5074  4B EF 27 C9 */	bl Create__Q24gobj14MoveParamDecelFf
/* 802A9238 002A5078  90 61 00 08 */	stw r3, 0x8(r1)
/* 802A923C 002A507C  38 61 00 0C */	addi r3, r1, 0xc
/* 802A9240 002A5080  C0 22 B6 A8 */	lfs f1, "@57074_80561628"@sda21(r2)
/* 802A9244 002A5084  C0 42 B6 AC */	lfs f2, "@57075_8056162C"@sda21(r2)
/* 802A9248 002A5088  C0 62 B6 B0 */	lfs f3, "@57076_80561630"@sda21(r2)
...
/* 802A9274 002A50B4  38 81 00 08 */	addi r4, r1, 0x8
...
/* 802A92A4 002A50E4  F3 E1 00 78 */	psq_st f31, 0x78(r1), 0, qr0
...
/* 802A9308 002A5148  38 61 00 08 */	addi r3, r1, 0x8
/* 802A930C 002A514C  4B FC 63 A9 */	bl pos__Q43scn4step5chara8LocationCFv
/* 802A9310 002A5150  88 01 00 30 */	lbz r0, 0x30(r1)
/* 802A9314 002A5154  2C 00 00 00 */	cmpwi r0, 0x0
/* 802A9318 002A5158  41 82 00 30 */	beq lbl_802A9348
/* 802A931C 002A515C  38 00 00 01 */	li r0, 0x1
/* 802A9320 002A5160  98 1F 00 10 */	stb r0, 0x10(r31)
/* 802A9324 002A5164  C0 21 00 18 */	lfs f1, 0x18(r1)
/* 802A9328 002A5168  4B EF 6B 8D */	bl "Abs<f>__Q33hel4math4MathFf_Cf"
/* 802A932C 002A516C  C0 02 B6 B4 */	lfs f0, "@57100_80561634"@sda21(r2)
...
/* 802A934C 002A518C  2C 00 00 00 */	cmpwi r0, 0x0
/* 802A9350 002A5190  41 82 00 28 */	beq lbl_802A9378
/* 802A9354 002A5194  C0 21 00 18 */	lfs f1, 0x18(r1)
/* 802A9358 002A5198  4B EF 6B 5D */	bl "Abs<f>__Q33hel4math4MathFf_Cf"
/* 802A935C 002A519C  C0 02 B6 B8 */	lfs f0, "@57101_80561638"@sda21(r2)
...
.global lbl_802A9378
lbl_802A9378:
/* 802A9378 002A51B8  38 60 00 00 */	li r3, 0x0
/* 802A937C 002A51BC  88 01 00 32 */	lbz r0, 0x32(r1)
/* 802A9380 002A51C0  2C 00 00 00 */	cmpwi r0, 0x0
/* 802A9384 002A51C4  40 82 00 10 */	bne lbl_802A9394
/* 802A9388 002A51C8  88 01 00 33 */	lbz r0, 0x33(r1)
/* 802A938C 002A51CC  2C 00 00 00 */	cmpwi r0, 0x0
/* 802A9390 002A51D0  41 82 00 08 */	beq lbl_802A9398
.global lbl_802A9394
lbl_802A9394:
/* 802A9394 002A51D4  38 60 00 01 */	li r3, 0x1
.global lbl_802A9398
lbl_802A9398:
/* 802A9398 002A51D8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A93AC 002A51EC  C0 22 B6 BC */	lfs f1, "@57102_8056163C"@sda21(r2)
...
/* 802A93D0 002A5210  4B EF 6A E5 */	bl "Abs<f>__Q33hel4math4MathFf_Cf"
/* 802A93D4 002A5214  C0 02 B6 B8 */	lfs f0, "@57101_80561638"@sda21(r2)
...
.global lbl_802A93F0
lbl_802A93F0:
/* 802A93F0 002A5230  C0 21 00 08 */	lfs f1, 0x8(r1)
...
/* 802A9418 002A5258  C0 22 B6 BC */	lfs f1, "@57102_8056163C"@sda21(r2)
...
/* 802A942C 002A526C  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A9430 002A5270  41 82 00 10 */	beq lbl_802A9440
/* 802A9434 002A5274  38 03 FF FF */	addi r0, r3, -0x1
...
/* 802A9444 002A5284  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802A945C 002A529C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A9474 002A52B4  38 80 FF FF */	li r4, -0x1
...
/* 802A9490 002A52D0  38 80 FF FF */	li r4, -0x1
...
/* 802A94A0 002A52E0  38 80 FF FF */	li r4, -0x1
...
__vt__Q53scn4step5enemy6damage18StateDamageCapture:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step5enemy6damage18StateDamageCaptureFv
	.4byte procAnim__Q53scn4step5enemy6damage18StateDamageCaptureFv
	.4byte procMove__Q53scn4step5enemy6damage18StateDamageCaptureFv
	.4byte procConstraint__Q43scn4step5enemy9StateBaseFv
	.4byte procFixPos__Q53scn4step5enemy6damage18StateDamageCaptureFv
	.4byte procObjCollReact__Q43scn4step5enemy9StateBaseFv
.include "macros.inc"

.section .sdata2, "wa"  # 0x8055DF80 - 0x805643C0 ; 0x00006440
.global "@57027_80561610"
"@57027_80561610":
...
.global "@57069_8056161C"
"@57069_8056161C":

	.4byte 0x3F800000

.global "@57070_80561620"
"@57070_80561620":

	.4byte 0x42652EE1

.global "@57073_80561624"
"@57073_80561624":

	.4byte 0x38D1B717

.global "@57074_80561628"
"@57074_80561628":

	.4byte 0x3E4CCCCD

.global "@57075_8056162C"
"@57075_8056162C":

	.4byte 0x3BC49BA6

.global "@57076_80561630"
"@57076_80561630":

	.4byte 0x3BA3D70A

.global "@57100_80561634"
"@57100_80561634":

	.4byte 0x3F000000

.global "@57101_80561638"
"@57101_80561638":

	.4byte 0xBF800000

.global "@57102_8056163C"
"@57102_8056163C":
