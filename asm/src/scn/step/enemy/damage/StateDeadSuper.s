...
/* 802AAF84 002A6DC4  4B D5 C3 C1 */	bl lbl_80007344
...
/* 802AAF98 002A6DD8  90 1D 00 00 */	stw r0, 0x0(r29)
/* 802AAF9C 002A6DDC  C0 02 B7 70 */	lfs f0, "@57110_805616F0"@sda21(r2)
/* 802AAFA0 002A6DE0  D0 1D 00 08 */	stfs f0, 0x8(r29)
/* 802AAFA4 002A6DE4  38 60 00 00 */	li r3, 0x0
...
/* 802AAFB4 002A6DF4  38 00 00 02 */	li r0, 0x2
...
/* 802AAFF4 002A6E34  38 80 00 06 */	li r4, 0x6
...
/* 802AB020 002A6E60  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802AB034 002A6E74  38 80 00 00 */	li r4, 0x0
...
/* 802AB060 002A6EA0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802AB074 002A6EB4  38 61 00 08 */	addi r3, r1, 0x8
...
/* 802AB090 002A6ED0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802AB0C4 002A6F04  38 C1 00 08 */	addi r6, r1, 0x8
...
/* 802AB0D4 002A6F14  4B D5 C2 BD */	bl lbl_80007390
...
/* 802AB0F8 002A6F38  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802AB0FC 002A6F3C  7C 7E 1B 78 */	mr r30, r3
/* 802AB100 002A6F40  7C 9F 23 78 */	mr r31, r4
/* 802AB104 002A6F44  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802AB114 002A6F54  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 802AB124 002A6F64  C0 22 B7 70 */	lfs f1, "@57110_805616F0"@sda21(r2)
...
/* 802AB13C 002A6F7C  C0 22 B7 70 */	lfs f1, "@57110_805616F0"@sda21(r2)
...
/* 802AB178 002A6FB8  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 802AB19C 002A6FDC  F3 E1 00 38 */	psq_st f31, 0x38(r1), 0, qr0
...
/* 802AB1AC 002A6FEC  38 04 00 01 */	addi r0, r4, 0x1
...
/* 802AB1C0 002A7000  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802AB1E4 002A7024  2C 03 00 00 */	cmpwi r3, 0x0
/* 802AB1E8 002A7028  41 82 00 0C */	beq lbl_802AB1F4
/* 802AB1EC 002A702C  C3 E2 B7 74 */	lfs f31, "@57152_805616F4"@sda21(r2)
/* 802AB1F0 002A7030  48 00 00 08 */	b lbl_802AB1F8
.global lbl_802AB1F4
lbl_802AB1F4:
/* 802AB1F4 002A7034  C3 E2 B7 78 */	lfs f31, "@57153_805616F8"@sda21(r2)
.global lbl_802AB1F8
lbl_802AB1F8:
...
/* 802AB208 002A7048  C0 1F 00 08 */	lfs f0, 0x8(r31)
/* 802AB20C 002A704C  EC 3F 00 7A */	fmadds f1, f31, f1, f0
/* 802AB210 002A7050  D0 3F 00 08 */	stfs f1, 0x8(r31)
/* 802AB214 002A7054  C0 02 B7 7C */	lfs f0, "@57154_805616FC"@sda21(r2)
/* 802AB218 002A7058  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802AB21C 002A705C  4C 41 13 82 */	cror eq, gt, eq
/* 802AB220 002A7060  40 82 00 0C */	bne lbl_802AB22C
/* 802AB224 002A7064  EC 01 00 28 */	fsubs f0, f1, f0
/* 802AB228 002A7068  D0 1F 00 08 */	stfs f0, 0x8(r31)
.global lbl_802AB22C
lbl_802AB22C:
/* 802AB22C 002A706C  C0 3F 00 08 */	lfs f1, 0x8(r31)
/* 802AB230 002A7070  C0 02 B7 70 */	lfs f0, "@57110_805616F0"@sda21(r2)
/* 802AB234 002A7074  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802AB238 002A7078  40 80 00 10 */	bge lbl_802AB248
/* 802AB23C 002A707C  C0 02 B7 7C */	lfs f0, "@57154_805616FC"@sda21(r2)
/* 802AB240 002A7080  EC 01 00 2A */	fadds f0, f1, f0
/* 802AB244 002A7084  D0 1F 00 08 */	stfs f0, 0x8(r31)
.global lbl_802AB248
lbl_802AB248:
...
/* 802AB278 002A70B8  D0 21 00 08 */	stfs f1, 0x8(r1)
...
/* 802AB288 002A70C8  C0 02 B7 70 */	lfs f0, "@57110_805616F0"@sda21(r2)
/* 802AB28C 002A70CC  FC 1F 00 40 */	fcmpo cr0, f31, f0
/* 802AB290 002A70D0  4C 41 13 82 */	cror eq, gt, eq
/* 802AB294 002A70D4  41 82 00 20 */	beq lbl_802AB2B4
/* 802AB298 002A70D8  3C 60 80 45 */	lis r3, "@STRING@FSqrt__Q24nw4r4mathFf"@ha
/* 802AB29C 002A70DC  38 63 31 54 */	addi r3, r3, "@STRING@FSqrt__Q24nw4r4mathFf"@l
/* 802AB2A0 002A70E0  38 80 02 73 */	li r4, 0x273
/* 802AB2A4 002A70E4  3C A0 80 45 */	lis r5, "@STRING@FSqrt__Q24nw4r4mathFf@0"@ha
/* 802AB2A8 002A70E8  38 A5 31 30 */	addi r5, r5, "@STRING@FSqrt__Q24nw4r4mathFf@0"@l
/* 802AB2AC 002A70EC  4C C6 31 82 */	crclr 4*cr1+eq
/* 802AB2B0 002A70F0  4B E7 D1 41 */	bl Warning__Q24nw4r2dbFPCciPCce
.global lbl_802AB2B4
lbl_802AB2B4:
/* 802AB2B4 002A70F4  C0 22 B7 70 */	lfs f1, "@57110_805616F0"@sda21(r2)
/* 802AB2B8 002A70F8  FC 1F 08 40 */	fcmpo cr0, f31, f1
/* 802AB2BC 002A70FC  4C 40 13 82 */	cror eq, lt, eq
...
.global lbl_802AB2D4
lbl_802AB2D4:
/* 802AB2D4 002A7114  C0 02 B7 70 */	lfs f0, "@57110_805616F0"@sda21(r2)
...
.global lbl_802AB2E4
lbl_802AB2E4:
/* 802AB2E4 002A7124  C0 02 B7 80 */	lfs f0, "@57155_80561700"@sda21(r2)
/* 802AB2E8 002A7128  EC 20 08 24 */	fdivs f1, f0, f1
/* 802AB2EC 002A712C  C0 01 00 08 */	lfs f0, 0x8(r1)
/* 802AB2F0 002A7130  EC 00 00 72 */	fmuls f0, f0, f1
/* 802AB2F4 002A7134  D0 01 00 08 */	stfs f0, 0x8(r1)
...
.global lbl_802AB304
lbl_802AB304:
/* 802AB304 002A7144  38 6D EE 40 */	addi r3, r13, BASIS_Y__Q33hel4math7Vector2@sda21
/* 802AB308 002A7148  38 81 00 08 */	addi r4, r1, 0x8
...
/* 802AB324 002A7164  C0 02 B7 84 */	lfs f0, "@57156_80561704"@sda21(r2)
...
/* 802AB340 002A7180  C0 3F 00 08 */	lfs f1, 0x8(r31)
...
/* 802AB35C 002A719C  C0 3F 00 08 */	lfs f1, 0x8(r31)
...
/* 802AB374 002A71B4  C0 22 B7 70 */	lfs f1, "@57110_805616F0"@sda21(r2)
...
/* 802AB3BC 002A71FC  90 61 00 08 */	stw r3, 0x8(r1)
...
/* 802AB3EC 002A722C  38 81 00 08 */	addi r4, r1, 0x8
...
/* 802AB478 002A72B8  38 61 00 08 */	addi r3, r1, 0x8
/* 802AB47C 002A72BC  4B FC 42 39 */	bl pos__Q43scn4step5chara8LocationCFv
/* 802AB480 002A72C0  38 80 00 00 */	li r4, 0x0
/* 802AB484 002A72C4  88 01 00 30 */	lbz r0, 0x30(r1)
/* 802AB488 002A72C8  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802AB49C 002A72DC  C0 22 B7 88 */	lfs f1, "@57181_80561708"@sda21(r2)
...
/* 802AB4AC 002A72EC  38 80 00 01 */	li r4, 0x1
.global lbl_802AB4B0
lbl_802AB4B0:
/* 802AB4B0 002A72F0  88 01 00 31 */	lbz r0, 0x31(r1)
/* 802AB4B4 002A72F4  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802AB4C8 002A7308  C0 22 B7 88 */	lfs f1, "@57181_80561708"@sda21(r2)
...
/* 802AB4D8 002A7318  38 80 00 01 */	li r4, 0x1
.global lbl_802AB4DC
lbl_802AB4DC:
/* 802AB4DC 002A731C  38 60 00 00 */	li r3, 0x0
/* 802AB4E0 002A7320  88 01 00 32 */	lbz r0, 0x32(r1)
/* 802AB4E4 002A7324  2C 00 00 00 */	cmpwi r0, 0x0
/* 802AB4E8 002A7328  40 82 00 10 */	bne lbl_802AB4F8
/* 802AB4EC 002A732C  88 01 00 33 */	lbz r0, 0x33(r1)
/* 802AB4F0 002A7330  2C 00 00 00 */	cmpwi r0, 0x0
/* 802AB4F4 002A7334  41 82 00 08 */	beq lbl_802AB4FC
.global lbl_802AB4F8
lbl_802AB4F8:
/* 802AB4F8 002A7338  38 60 00 01 */	li r3, 0x1
.global lbl_802AB4FC
lbl_802AB4FC:
/* 802AB4FC 002A733C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802AB510 002A7350  C0 22 B7 88 */	lfs f1, "@57181_80561708"@sda21(r2)
...
/* 802AB520 002A7360  38 80 00 01 */	li r4, 0x1
.global lbl_802AB524
lbl_802AB524:
...
/* 802AB540 002A7380  C0 22 B7 88 */	lfs f1, "@57181_80561708"@sda21(r2)
...
/* 802AB550 002A7390  38 80 00 01 */	li r4, 0x1
.global lbl_802AB554
lbl_802AB554:
/* 802AB554 002A7394  C0 21 00 08 */	lfs f1, 0x8(r1)
...
/* 802AB57C 002A73BC  C0 22 B7 88 */	lfs f1, "@57181_80561708"@sda21(r2)
...
/* 802AB58C 002A73CC  38 80 00 01 */	li r4, 0x1
.global lbl_802AB590
lbl_802AB590:
/* 802AB590 002A73D0  2C 04 00 00 */	cmpwi r4, 0x0
/* 802AB594 002A73D4  41 82 00 10 */	beq lbl_802AB5A4
/* 802AB598 002A73D8  80 7F 00 0C */	lwz r3, 0xc(r31)
/* 802AB59C 002A73DC  38 03 00 01 */	addi r0, r3, 0x1
...
/* 802AB5CC 002A740C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802AB600 002A7440  38 80 FF FF */	li r4, -0x1
...
__vt__Q53scn4step5enemy6damage14StateDeadSuper:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step5enemy6damage14StateDeadSuperFv
	.4byte procAnim__Q53scn4step5enemy6damage14StateDeadSuperFv
	.4byte procMove__Q53scn4step5enemy6damage14StateDeadSuperFv
	.4byte procConstraint__Q43scn4step5enemy9StateBaseFv
	.4byte procFixPos__Q53scn4step5enemy6damage14StateDeadSuperFv
	.4byte procObjCollReact__Q43scn4step5enemy9StateBaseFv
.include "macros.inc"

.section .sdata2, "wa"  # 0x8055DF80 - 0x805643C0 ; 0x00006440
.global "@57110_805616F0"
"@57110_805616F0":

	.4byte 0

.global "@57152_805616F4"
"@57152_805616F4":

	.4byte 0x41E00000

.global "@57153_805616F8"
"@57153_805616F8":

	.4byte 0x420C0000

.global "@57154_805616FC"
"@57154_805616FC":

	.4byte 0x43B40000

.global "@57155_80561700"
"@57155_80561700":

	.4byte 0x3F800000

.global "@57156_80561704"
"@57156_80561704":

	.4byte 0x42652EE1

.global "@57181_80561708"
"@57181_80561708":
