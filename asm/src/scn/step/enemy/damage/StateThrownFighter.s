...
/* 802ABB48 002A7988  4B D5 B7 F9 */	bl lbl_80007340
...
/* 802ABB64 002A79A4  90 1C 00 00 */	stw r0, 0x0(r28)
/* 802ABB68 002A79A8  38 00 00 00 */	li r0, 0x0
/* 802ABB6C 002A79AC  90 1C 00 08 */	stw r0, 0x8(r28)
/* 802ABB70 002A79B0  C0 02 B7 B0 */	lfs f0, "@57792_80561730"@sda21(r2)
...
/* 802ABB9C 002A79DC  38 80 00 06 */	li r4, 0x6
...
/* 802ABBC4 002A7A04  38 80 00 00 */	li r4, 0x0
...
/* 802ABBE8 002A7A28  C0 02 B7 B0 */	lfs f0, "@57792_80561730"@sda21(r2)
...
.global lbl_802ABBF8
lbl_802ABBF8:
/* 802ABBF8 002A7A38  C0 02 B7 B4 */	lfs f0, "@57793_80561734"@sda21(r2)
/* 802ABBFC 002A7A3C  FC 00 08 00 */	fcmpu cr0, f0, f1
/* 802ABC00 002A7A40  7F E0 00 26 */	mfcr r31
/* 802ABC04 002A7A44  57 FF 1F FE */	extrwi r31, r31, 1, 2
/* 802ABC08 002A7A48  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 802ABC24 002A7A64  38 A0 00 00 */	li r5, 0x0
...
/* 802ABC84 002A7AC4  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 802ABCA0 002A7AE0  38 80 00 00 */	li r4, 0x0
...
/* 802ABCC0 002A7B00  38 61 00 08 */	addi r3, r1, 0x8
...
/* 802ABCD8 002A7B18  38 80 00 00 */	li r4, 0x0
/* 802ABCDC 002A7B1C  38 A0 00 00 */	li r5, 0x0
/* 802ABCE0 002A7B20  C0 22 B7 B8 */	lfs f1, "@57794"@sda21(r2)
/* 802ABCE4 002A7B24  38 C1 00 08 */	addi r6, r1, 0x8
/* 802ABCE8 002A7B28  7C C7 33 78 */	mr r7, r6
/* 802ABCEC 002A7B2C  39 00 00 01 */	li r8, 0x1
/* 802ABCF0 002A7B30  4B FC 62 C5 */	bl addAttack__Q43scn4step5chara7ObjCollFUlUlfRCQ33hel4math7Vector2RCQ33hel4math7Vector2b
.global lbl_802ABCF4
lbl_802ABCF4:
/* 802ABCF4 002A7B34  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 802ABD18 002A7B58  C0 02 B7 B4 */	lfs f0, "@57793_80561734"@sda21(r2)
...
/* 802ABD50 002A7B90  3B C0 00 00 */	li r30, 0x0
...
/* 802ABD60 002A7BA0  C0 62 B7 BC */	lfs f3, "@57795"@sda21(r2)
/* 802ABD64 002A7BA4  4B F0 9B D1 */	bl Equals__Q33hel4math4MathFfff
/* 802ABD68 002A7BA8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802ABD78 002A7BB8  C0 5F 00 04 */	lfs f2, 0x4(r31)
/* 802ABD7C 002A7BBC  C0 62 B7 BC */	lfs f3, "@57795"@sda21(r2)
/* 802ABD80 002A7BC0  4B F0 9B B5 */	bl Equals__Q33hel4math4MathFfff
/* 802ABD84 002A7BC4  2C 03 00 00 */	cmpwi r3, 0x0
/* 802ABD88 002A7BC8  41 82 00 20 */	beq lbl_802ABDA8
/* 802ABD8C 002A7BCC  C0 21 00 24 */	lfs f1, 0x24(r1)
/* 802ABD90 002A7BD0  C0 5F 00 08 */	lfs f2, 0x8(r31)
/* 802ABD94 002A7BD4  C0 62 B7 BC */	lfs f3, "@57795"@sda21(r2)
/* 802ABD98 002A7BD8  4B F0 9B 9D */	bl Equals__Q33hel4math4MathFfff
/* 802ABD9C 002A7BDC  2C 03 00 00 */	cmpwi r3, 0x0
/* 802ABDA0 002A7BE0  41 82 00 08 */	beq lbl_802ABDA8
/* 802ABDA4 002A7BE4  3B C0 00 01 */	li r30, 0x1
.global lbl_802ABDA8
lbl_802ABDA8:
/* 802ABDA8 002A7BE8  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 802ABDC0 002A7C00  C0 02 B7 C0 */	lfs f0, "@57796"@sda21(r2)
/* 802ABDC4 002A7C04  EC 00 00 72 */	fmuls f0, f0, f1
/* 802ABDC8 002A7C08  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 802ABDCC 002A7C0C  C0 02 B7 C4 */	lfs f0, "@57797_80561744"@sda21(r2)
/* 802ABDD0 002A7C10  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 802ABDD4 002A7C14  C0 02 B7 B0 */	lfs f0, "@57792_80561730"@sda21(r2)
...
/* 802ABDF4 002A7C34  38 80 FF FF */	li r4, -0x1
/* 802ABDF8 002A7C38  4B F8 48 D1 */	bl "__dt__Q24util35ObjRefHandle<Q43scn4step4hero4Hero>Fv"
/* 802ABDFC 002A7C3C  7F 83 E3 78 */	mr r3, r28
/* 802ABE00 002A7C40  39 61 00 70 */	addi r11, r1, 0x70
/* 802ABE04 002A7C44  4B D5 B5 89 */	bl lbl_8000738C
...
/* 802ABE28 002A7C68  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802ABE2C 002A7C6C  7C 7E 1B 78 */	mr r30, r3
/* 802ABE30 002A7C70  7C 9F 23 78 */	mr r31, r4
/* 802ABE34 002A7C74  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802ABE44 002A7C84  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 802ABE54 002A7C94  C0 22 B7 B0 */	lfs f1, "@57792_80561730"@sda21(r2)
...
/* 802ABE6C 002A7CAC  C0 22 B7 B0 */	lfs f1, "@57792_80561730"@sda21(r2)
...
/* 802ABEA0 002A7CE0  38 80 00 00 */	li r4, 0x0
...
/* 802ABED0 002A7D10  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 802ABEF4 002A7D34  F3 E1 00 38 */	psq_st f31, 0x38(r1), 0, qr0
/* 802ABEF8 002A7D38  93 E1 00 2C */	stw r31, 0x2c(r1)
/* 802ABEFC 002A7D3C  7C 7F 1B 78 */	mr r31, r3
/* 802ABF00 002A7D40  80 83 00 08 */	lwz r4, 0x8(r3)
/* 802ABF04 002A7D44  38 04 00 01 */	addi r0, r4, 0x1
/* 802ABF08 002A7D48  90 03 00 08 */	stw r0, 0x8(r3)
...
/* 802ABF20 002A7D60  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802ABF54 002A7D94  C0 42 B7 C8 */	lfs f2, "@57871_80561748"@sda21(r2)
...
/* 802ABF64 002A7DA4  C0 02 B7 CC */	lfs f0, "@57872_8056174C"@sda21(r2)
/* 802ABF68 002A7DA8  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802ABF6C 002A7DAC  4C 41 13 82 */	cror eq, gt, eq
...
/* 802ABF80 002A7DC0  C0 02 B7 B0 */	lfs f0, "@57792_80561730"@sda21(r2)
/* 802ABF84 002A7DC4  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 802ABF88 002A7DC8  40 80 00 10 */	bge lbl_802ABF98
/* 802ABF8C 002A7DCC  C0 02 B7 CC */	lfs f0, "@57872_8056174C"@sda21(r2)
...
/* 802ABF9C 002A7DDC  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802ABFBC 002A7DFC  38 61 00 08 */	addi r3, r1, 0x8
...
/* 802ABFD0 002A7E10  C0 01 00 08 */	lfs f0, 0x8(r1)
/* 802ABFD4 002A7E14  EF E0 08 3A */	fmadds f31, f0, f0, f1
/* 802ABFD8 002A7E18  C0 02 B7 B0 */	lfs f0, "@57792_80561730"@sda21(r2)
/* 802ABFDC 002A7E1C  FC 1F 00 40 */	fcmpo cr0, f31, f0
/* 802ABFE0 002A7E20  4C 41 13 82 */	cror eq, gt, eq
/* 802ABFE4 002A7E24  41 82 00 20 */	beq lbl_802AC004
/* 802ABFE8 002A7E28  3C 60 80 45 */	lis r3, "@STRING@FSqrt__Q24nw4r4mathFf"@ha
/* 802ABFEC 002A7E2C  38 63 31 54 */	addi r3, r3, "@STRING@FSqrt__Q24nw4r4mathFf"@l
/* 802ABFF0 002A7E30  38 80 02 73 */	li r4, 0x273
/* 802ABFF4 002A7E34  3C A0 80 45 */	lis r5, "@STRING@FSqrt__Q24nw4r4mathFf@0"@ha
/* 802ABFF8 002A7E38  38 A5 31 30 */	addi r5, r5, "@STRING@FSqrt__Q24nw4r4mathFf@0"@l
/* 802ABFFC 002A7E3C  4C C6 31 82 */	crclr 4*cr1+eq
/* 802AC000 002A7E40  4B E7 C3 F1 */	bl Warning__Q24nw4r2dbFPCciPCce
.global lbl_802AC004
lbl_802AC004:
/* 802AC004 002A7E44  C0 22 B7 B0 */	lfs f1, "@57792_80561730"@sda21(r2)
/* 802AC008 002A7E48  FC 1F 08 40 */	fcmpo cr0, f31, f1
/* 802AC00C 002A7E4C  4C 40 13 82 */	cror eq, lt, eq
...
.global lbl_802AC024
lbl_802AC024:
/* 802AC024 002A7E64  C0 02 B7 B0 */	lfs f0, "@57792_80561730"@sda21(r2)
...
.global lbl_802AC034
lbl_802AC034:
/* 802AC034 002A7E74  C0 02 B7 D0 */	lfs f0, "@57873_80561750"@sda21(r2)
/* 802AC038 002A7E78  EC 20 08 24 */	fdivs f1, f0, f1
/* 802AC03C 002A7E7C  C0 01 00 08 */	lfs f0, 0x8(r1)
/* 802AC040 002A7E80  EC 00 00 72 */	fmuls f0, f0, f1
/* 802AC044 002A7E84  D0 01 00 08 */	stfs f0, 0x8(r1)
...
.global lbl_802AC054
lbl_802AC054:
/* 802AC054 002A7E94  38 6D EE 40 */	addi r3, r13, BASIS_Y__Q33hel4math7Vector2@sda21
/* 802AC058 002A7E98  38 81 00 08 */	addi r4, r1, 0x8
...
/* 802AC074 002A7EB4  C0 02 B7 D4 */	lfs f0, "@57874_80561754"@sda21(r2)
...
/* 802AC0C4 002A7F04  C0 22 B7 B0 */	lfs f1, "@57792_80561730"@sda21(r2)
...
/* 802AC110 002A7F50  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802AC184 002A7FC4  2C 00 00 00 */	cmpwi r0, 0x0
/* 802AC188 002A7FC8  40 82 00 58 */	bne lbl_802AC1E0
/* 802AC18C 002A7FCC  38 60 00 00 */	li r3, 0x0
/* 802AC190 002A7FD0  88 01 00 2A */	lbz r0, 0x2a(r1)
/* 802AC194 002A7FD4  2C 00 00 00 */	cmpwi r0, 0x0
/* 802AC198 002A7FD8  40 82 00 10 */	bne lbl_802AC1A8
/* 802AC19C 002A7FDC  88 01 00 2B */	lbz r0, 0x2b(r1)
/* 802AC1A0 002A7FE0  2C 00 00 00 */	cmpwi r0, 0x0
/* 802AC1A4 002A7FE4  41 82 00 08 */	beq lbl_802AC1AC
.global lbl_802AC1A8
lbl_802AC1A8:
/* 802AC1A8 002A7FE8  38 60 00 01 */	li r3, 0x1
.global lbl_802AC1AC
lbl_802AC1AC:
/* 802AC1AC 002A7FEC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802AC1C4 002A8004  C0 21 00 08 */	lfs f1, 0x8(r1)
...
/* 802AC1F0 002A8030  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802AC208 002A8048  38 80 FF FF */	li r4, -0x1
...
/* 802AC224 002A8064  38 80 FF FF */	li r4, -0x1
...
/* 802AC234 002A8074  38 80 FF FF */	li r4, -0x1
...
__vt__Q53scn4step5enemy6damage18StateThrownFighter:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step5enemy6damage18StateThrownFighterFv
	.4byte procAnim__Q53scn4step5enemy6damage18StateThrownFighterFv
	.4byte procMove__Q53scn4step5enemy6damage18StateThrownFighterFv
	.4byte procConstraint__Q43scn4step5enemy9StateBaseFv
	.4byte procFixPos__Q53scn4step5enemy6damage18StateThrownFighterFv
