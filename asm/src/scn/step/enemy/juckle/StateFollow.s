...
/* 802BBC88 002B7AC8  F3 E1 00 18 */	psq_st f31, 0x18(r1), 0, qr0
/* 802BBC8C 002B7ACC  93 E1 00 0C */	stw r31, 0xc(r1)
/* 802BBC90 002B7AD0  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 802BBCA4 002B7AE4  90 1E 00 00 */	stw r0, 0x0(r30)
/* 802BBCA8 002B7AE8  38 00 00 00 */	li r0, 0x0
/* 802BBCAC 002B7AEC  90 1E 00 08 */	stw r0, 0x8(r30)
/* 802BBCB0 002B7AF0  C0 02 BB 60 */	lfs f0, "@55367_80561AE0"@sda21(r2)
...
/* 802BBCE0 002B7B20  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802BBCF4 002B7B34  38 80 00 04 */	li r4, 0x4
...
/* 802BBD08 002B7B48  4B FF FE E1 */	bl "DynamicCastToRef<Q53scn4step5enemy6juckle6Custom,Q43scn4step5enemy7ICustom>__Q23hel6commonFPQ43scn4step5enemy7ICustom_RQ53scn4step5enemy6juckle6Custom"
...
/* 802BBD3C 002B7B7C  C0 02 BB 60 */	lfs f0, "@55367_80561AE0"@sda21(r2)
...
.global lbl_802BBD4C
lbl_802BBD4C:
/* 802BBD4C 002B7B8C  C0 02 BB 64 */	lfs f0, "@55368_80561AE4"@sda21(r2)
...
/* 802BBD74 002B7BB4  C0 22 BB 68 */	lfs f1, "@55369_80561AE8"@sda21(r2)
/* 802BBD78 002B7BB8  48 00 00 08 */	b lbl_802BBD80
.global lbl_802BBD7C
lbl_802BBD7C:
/* 802BBD7C 002B7BBC  C0 22 BB 6C */	lfs f1, "@55370_80561AEC"@sda21(r2)
.global lbl_802BBD80
lbl_802BBD80:
...
/* 802BBD94 002B7BD4  2C 03 00 00 */	cmpwi r3, 0x0
/* 802BBD98 002B7BD8  41 82 00 30 */	beq lbl_802BBDC8
/* 802BBD9C 002B7BDC  C0 3E 00 0C */	lfs f1, 0xc(r30)
/* 802BBDA0 002B7BE0  C0 02 BB 60 */	lfs f0, "@55367_80561AE0"@sda21(r2)
...
/* 802BBDB4 002B7BF4  C0 02 BB 64 */	lfs f0, "@55368_80561AE4"@sda21(r2)
...
/* 802BBDCC 002B7C0C  C0 02 BB 60 */	lfs f0, "@55367_80561AE0"@sda21(r2)
...
/* 802BBDE0 002B7C20  C0 02 BB 70 */	lfs f0, "@55371_80561AF0"@sda21(r2)
...
/* 802BBE2C 002B7C6C  C0 02 BB 6C */	lfs f0, "@55370_80561AEC"@sda21(r2)
/* 802BBE30 002B7C70  EC 21 00 2A */	fadds f1, f1, f0
/* 802BBE34 002B7C74  D0 3E 00 0C */	stfs f1, 0xc(r30)
/* 802BBE38 002B7C78  C0 02 BB 70 */	lfs f0, "@55371_80561AF0"@sda21(r2)
...
/* 802BBE6C 002B7CAC  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 802BBE90 002B7CD0  F3 E1 00 38 */	psq_st f31, 0x38(r1), 0, qr0
/* 802BBE94 002B7CD4  39 61 00 30 */	addi r11, r1, 0x30
/* 802BBE98 002B7CD8  4B D4 B4 AD */	bl lbl_80007344
...
/* 802BBEBC 002B7CFC  4B FF FD 2D */	bl "DynamicCastToRef<Q53scn4step5enemy6juckle6Custom,Q43scn4step5enemy7ICustom>__Q23hel6commonFPQ43scn4step5enemy7ICustom_RQ53scn4step5enemy6juckle6Custom"
/* 802BBEC0 002B7D00  7C 7E 1B 78 */	mr r30, r3
/* 802BBEC4 002B7D04  80 7D 00 08 */	lwz r3, 0x8(r29)
/* 802BBEC8 002B7D08  80 1F 00 08 */	lwz r0, 0x8(r31)
/* 802BBECC 002B7D0C  7C 03 00 40 */	cmplw r3, r0
/* 802BBED0 002B7D10  40 80 00 10 */	bge lbl_802BBEE0
/* 802BBED4 002B7D14  38 03 00 01 */	addi r0, r3, 0x1
/* 802BBED8 002B7D18  90 1D 00 08 */	stw r0, 0x8(r29)
...
.global lbl_802BBEF0
lbl_802BBEF0:
/* 802BBEF0 002B7D30  80 1D 00 08 */	lwz r0, 0x8(r29)
/* 802BBEF4 002B7D34  C8 62 BB 78 */	lfd f3, "@55398_80561AF8"@sda21(r2)
/* 802BBEF8 002B7D38  90 01 00 0C */	stw r0, 0xc(r1)
/* 802BBEFC 002B7D3C  3C 60 43 30 */	lis r3, 0x4330
/* 802BBF00 002B7D40  90 61 00 08 */	stw r3, 0x8(r1)
/* 802BBF04 002B7D44  C8 01 00 08 */	lfd f0, 0x8(r1)
...
/* 802BBF1C 002B7D5C  80 1F 00 08 */	lwz r0, 0x8(r31)
...
/* 802BBF58 002B7D98  2C 03 00 00 */	cmpwi r3, 0x0
/* 802BBF5C 002B7D9C  41 82 00 10 */	beq lbl_802BBF6C
/* 802BBF60 002B7DA0  C0 02 BB 74 */	lfs f0, "@55395"@sda21(r2)
/* 802BBF64 002B7DA4  EF FF 00 28 */	fsubs f31, f31, f0
/* 802BBF68 002B7DA8  48 00 00 0C */	b lbl_802BBF74
.global lbl_802BBF6C
lbl_802BBF6C:
/* 802BBF6C 002B7DAC  C0 02 BB 74 */	lfs f0, "@55395"@sda21(r2)
...
/* 802BBF90 002B7DD0  4B D4 B4 01 */	bl lbl_80007390
...
/* 802BBFB4 002B7DF4  F3 E1 02 08 */	psq_st f31, 0x208(r1), 0, qr0
...
/* 802BBFD8 002B7E18  C0 03 00 04 */	lfs f0, 0x4(r3)
/* 802BBFDC 002B7E1C  D0 01 00 08 */	stfs f0, 0x8(r1)
/* 802BBFE0 002B7E20  C0 03 00 08 */	lfs f0, 0x8(r3)
...
/* 802BBFF4 002B7E34  C0 01 00 08 */	lfs f0, 0x8(r1)
...
/* 802BC004 002B7E44  C0 62 BB 60 */	lfs f3, "@55367_80561AE0"@sda21(r2)
...
/* 802BC048 002B7E88  80 64 00 00 */	lwz r3, 0x0(r4)
/* 802BC04C 002B7E8C  80 04 00 04 */	lwz r0, 0x4(r4)
/* 802BC050 002B7E90  90 61 00 10 */	stw r3, 0x10(r1)
/* 802BC054 002B7E94  90 01 00 14 */	stw r0, 0x14(r1)
/* 802BC058 002B7E98  80 04 00 08 */	lwz r0, 0x8(r4)
/* 802BC05C 002B7E9C  90 01 00 18 */	stw r0, 0x18(r1)
/* 802BC060 002B7EA0  C0 01 00 10 */	lfs f0, 0x10(r1)
/* 802BC064 002B7EA4  C0 22 BB 80 */	lfs f1, "@55413"@sda21(r2)
...
/* 802BC0D8 002B7F18  C0 21 00 08 */	lfs f1, 0x8(r1)
/* 802BC0DC 002B7F1C  C0 41 00 0C */	lfs f2, 0xc(r1)
/* 802BC0E0 002B7F20  C0 62 BB 60 */	lfs f3, "@55367_80561AE0"@sda21(r2)
...
/* 802BC15C 002B7F9C  C0 02 BB 84 */	lfs f0, "@55430"@sda21(r2)
/* 802BC160 002B7FA0  EC 20 08 2A */	fadds f1, f0, f1
/* 802BC164 002B7FA4  C0 02 BB 68 */	lfs f0, "@55369_80561AE8"@sda21(r2)
...
/* 802BC174 002B7FB4  C0 02 BB 68 */	lfs f0, "@55369_80561AE8"@sda21(r2)
...
__vt__Q53scn4step5enemy6juckle11StateFollow:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step5enemy6juckle11StateFollowFv
	.4byte procAnim__Q53scn4step5enemy6juckle11StateFollowFv
...
.global "@55367_80561AE0"
"@55367_80561AE0":

	.4byte 0

.global "@55368_80561AE4"
"@55368_80561AE4":

	.4byte 0x43340000

.global "@55369_80561AE8"
"@55369_80561AE8":

	.4byte 0x42340000

.global "@55370_80561AEC"
"@55370_80561AEC":

	.4byte 0xC2340000

.global "@55371_80561AF0"
"@55371_80561AF0":
