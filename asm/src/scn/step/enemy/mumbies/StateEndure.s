...
/* 802C58A4 002C16E4  90 1D 00 00 */	stw r0, 0x0(r29)
...
/* 802C58D8 002C1718  38 80 00 01 */	li r4, 0x1
...
/* 802C5900 002C1740  4B FB CC FD */	bl "RuntimeTypeInfoImpl<Q53scn4step5enemy7mumbies6Custom>__Q23hel6commonFv_RCQ33hel6common15RuntimeTypeInfo"
/* 802C5904 002C1744  7C 7F 1B 78 */	mr r31, r3
/* 802C5908 002C1748  2C 1E 00 00 */	cmpwi r30, 0x0
/* 802C590C 002C174C  41 82 00 48 */	beq lbl_802C5954
/* 802C5910 002C1750  7F C3 F3 78 */	mr r3, r30
/* 802C5914 002C1754  81 83 00 00 */	lwz r12, 0x0(r3)
/* 802C5918 002C1758  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 802C5930 002C1770  38 00 00 01 */	li r0, 0x1
/* 802C5934 002C1774  48 00 00 14 */	b lbl_802C5948
.global lbl_802C5938
lbl_802C5938:
/* 802C5938 002C1778  80 63 00 00 */	lwz r3, 0x0(r3)
.global lbl_802C593C
lbl_802C593C:
/* 802C593C 002C177C  2C 03 00 00 */	cmpwi r3, 0x0
/* 802C5940 002C1780  40 82 FF E8 */	bne lbl_802C5928
/* 802C5944 002C1784  38 00 00 00 */	li r0, 0x0
.global lbl_802C5948
lbl_802C5948:
/* 802C5948 002C1788  2C 00 00 00 */	cmpwi r0, 0x0
/* 802C594C 002C178C  41 82 00 08 */	beq lbl_802C5954
/* 802C5950 002C1790  48 00 00 08 */	b lbl_802C5958
.global lbl_802C5954
lbl_802C5954:
/* 802C5954 002C1794  3B C0 00 00 */	li r30, 0x0
.global lbl_802C5958
lbl_802C5958:
/* 802C5958 002C1798  7F C3 F3 78 */	mr r3, r30
/* 802C595C 002C179C  38 80 00 01 */	li r4, 0x1
...
/* 802C59A8 002C17E8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802C59DC 002C181C  38 61 00 08 */	addi r3, r1, 0x8
/* 802C59E0 002C1820  4B FA 9C D5 */	bl pos__Q43scn4step5chara8LocationCFv
/* 802C59E4 002C1824  C0 21 00 08 */	lfs f1, 0x8(r1)
...
/* 802C59F4 002C1834  57 FF 17 FE */	extrwi r31, r31, 1, 1
...
/* 802C5A20 002C1860  4B ED 2C 61 */	bl "__ct__25mint_wrapNative_helper<b>Fb"
.global lbl_802C5A24
lbl_802C5A24:
...
__vt__Q53scn4step5enemy7mumbies11StateEndure:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step5enemy7mumbies11StateEndureFv
	.4byte procAnim__Q43scn4step5enemy9StateBaseFv
	.4byte procMove__Q53scn4step5enemy7mumbies11StateEndureFv
	.4byte procConstraint__Q43scn4step5enemy9StateBaseFv
	.4byte procFixPos__Q53scn4step5enemy7mumbies11StateEndureFv
