...
/* 802F7BD8 002F3A18  90 03 00 00 */	stw r0, 0x0(r3)
/* 802F7BDC 002F3A1C  90 A3 00 04 */	stw r5, 0x4(r3)
/* 802F7BE0 002F3A20  90 C3 00 08 */	stw r6, 0x8(r3)
/* 802F7BE4 002F3A24  80 04 00 1C */	lwz r0, 0x1c(r4)
/* 802F7BE8 002F3A28  90 03 00 0C */	stw r0, 0xc(r3)
/* 802F7BEC 002F3A2C  38 00 00 01 */	li r0, 0x1
...
/* 802F7C34 002F3A74  90 03 00 00 */	stw r0, 0x0(r3)
/* 802F7C38 002F3A78  90 A3 00 04 */	stw r5, 0x4(r3)
/* 802F7C3C 002F3A7C  90 C3 00 08 */	stw r6, 0x8(r3)
/* 802F7C40 002F3A80  90 83 00 0C */	stw r4, 0xc(r3)
/* 802F7C44 002F3A84  98 E3 00 10 */	stb r7, 0x10(r3)
/* 802F7C48 002F3A88  54 E0 06 3E */	clrlwi r0, r7, 24
/* 802F7C4C 002F3A8C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802F7C88 002F3AC8  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802F7C8C 002F3ACC  7C 7E 1B 78 */	mr r30, r3
/* 802F7C90 002F3AD0  7C 9F 23 78 */	mr r31, r4
/* 802F7C94 002F3AD4  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802F7CA4 002F3AE4  90 03 00 00 */	stw r0, 0x0(r3)
/* 802F7CA8 002F3AE8  88 03 00 10 */	lbz r0, 0x10(r3)
/* 802F7CAC 002F3AEC  2C 00 00 00 */	cmpwi r0, 0x0
/* 802F7CB0 002F3AF0  41 82 00 10 */	beq lbl_802F7CC0
/* 802F7CB4 002F3AF4  80 63 00 08 */	lwz r3, 0x8(r3)
...
/* 802F7CC4 002F3B04  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802F7CDC 002F3B1C  83 C1 00 08 */	lwz r30, 0x8(r1)
