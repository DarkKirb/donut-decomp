...
/* 80304E00 00300C40  F3 E1 00 68 */	psq_st f31, 0x68(r1), 0, qr0
/* 80304E04 00300C44  DB C1 00 50 */	stfd f30, 0x50(r1)
/* 80304E08 00300C48  F3 C1 00 58 */	psq_st f30, 0x58(r1), 0, qr0
/* 80304E0C 00300C4C  DB A1 00 40 */	stfd f29, 0x40(r1)
/* 80304E10 00300C50  F3 A1 00 48 */	psq_st f29, 0x48(r1), 0, qr0
/* 80304E14 00300C54  DB 81 00 30 */	stfd f28, 0x30(r1)
/* 80304E18 00300C58  F3 81 00 38 */	psq_st f28, 0x38(r1), 0, qr0
...
/* 80304E2C 00300C6C  88 03 00 08 */	lbz r0, 0x8(r3)
...
/* 80304E54 00300C94  38 03 00 01 */	addi r0, r3, 0x1
/* 80304E58 00300C98  90 1F 00 04 */	stw r0, 0x4(r31)
.global lbl_80304E5C
lbl_80304E5C:
...
/* 80304E84 00300CC4  80 1F 00 04 */	lwz r0, 0x4(r31)
