...
.global "t_GetUnlockAnimName__33@unnamed@ChallengeDoorNormal_cpp@FQ33scn4step13ChallengeKind"
"t_GetUnlockAnimName__33@unnamed@ChallengeDoorNormal_cpp@FQ33scn4step13ChallengeKind":
/* 803098D8 00305718  3C 80 80 48 */	lis r4, "@54974"@ha
/* 803098DC 0030571C  38 84 0F C8 */	addi r4, r4, "@54974"@l
/* 803098E0 00305720  2C 03 00 00 */	cmpwi r3, 0x0
/* 803098E4 00305724  41 82 00 30 */	beq lbl_80309914
/* 803098E8 00305728  2C 03 00 01 */	cmpwi r3, 0x1
/* 803098EC 0030572C  41 82 00 30 */	beq lbl_8030991C
/* 803098F0 00305730  2C 03 00 02 */	cmpwi r3, 0x2
/* 803098F4 00305734  41 82 00 30 */	beq lbl_80309924
/* 803098F8 00305738  2C 03 00 04 */	cmpwi r3, 0x4
/* 803098FC 0030573C  41 82 00 30 */	beq lbl_8030992C
/* 80309900 00305740  2C 03 00 06 */	cmpwi r3, 0x6
/* 80309904 00305744  41 82 00 30 */	beq lbl_80309934
/* 80309908 00305748  2C 03 00 09 */	cmpwi r3, 0x9
/* 8030990C 0030574C  41 82 00 30 */	beq lbl_8030993C
/* 80309910 00305750  48 00 00 34 */	b lbl_80309944
.global lbl_80309914
lbl_80309914:
/* 80309914 00305754  38 64 00 00 */	addi r3, r4, 0x0
...
.global lbl_80309944
lbl_80309944:
/* 80309944 00305784  38 6D C2 50 */	addi r3, r13, "@54980"@sda21
...
/* 80309968 003057A8  3C C0 80 48 */	lis r6, "@54974"@ha
/* 8030996C 003057AC  38 C6 0F C8 */	addi r6, r6, "@54974"@l
...
/* 8030997C 003057BC  90 01 00 08 */	stw r0, 0x8(r1)
/* 80309980 003057C0  38 00 00 01 */	li r0, 0x1
...
/* 80309998 003057D8  38 C1 00 08 */	addi r6, r1, 0x8
...
/* 803099A8 003057E8  90 1E 00 00 */	stw r0, 0x0(r30)
...
/* 80309A14 00305854  4B FF FE C5 */	bl "t_GetUnlockAnimName__33@unnamed@ChallengeDoorNormal_cpp@FQ33scn4step13ChallengeKind"
...
/* 80309A30 00305870  C0 22 C8 50 */	lfs f1, "@55038_805627D0"@sda21(r2)
...
/* 80309A3C 0030587C  38 80 00 01 */	li r4, 0x1
...
/* 80309A70 003058B0  3C 80 80 48 */	lis r4, "@55043_804810AC"@ha
/* 80309A74 003058B4  38 84 10 AC */	addi r4, r4, "@55043_804810AC"@l
/* 80309A78 003058B8  4B EB 6F C1 */	bl setEntryPoint__Q24mint6RunnerFPCc
/* 80309A7C 003058BC  7F E3 FB 78 */	mr r3, r31
/* 80309A80 003058C0  38 80 00 01 */	li r4, 0x1
...
/* 80309AB4 003058F4  38 80 00 01 */	li r4, 0x1
...
/* 80309AC4 00305904  4B FF FE 15 */	bl "t_GetUnlockAnimName__33@unnamed@ChallengeDoorNormal_cpp@FQ33scn4step13ChallengeKind"
...
/* 80309AD8 00305918  38 80 00 00 */	li r4, 0x0
