...
/* 80310A10 0030C850  90 83 00 04 */	stw r4, 0x4(r3)
...
/* 80310A1C 0030C85C  90 03 00 00 */	stw r0, 0x0(r3)
/* 80310A20 0030C860  38 63 00 08 */	addi r3, r3, 0x8
/* 80310A24 0030C864  4B D0 AD DD */	bl OSCreateAlarm
/* 80310A28 0030C868  38 00 00 00 */	li r0, 0x0
...
/* 80310A48 0030C888  38 6D C3 20 */	addi r3, r13, "@52801_8055A740"@sda21
...
/* 80310B40 0030C980  F3 E1 00 68 */	psq_st f31, 0x68(r1), 0, qr0
/* 80310B44 0030C984  DB C1 00 50 */	stfd f30, 0x50(r1)
/* 80310B48 0030C988  F3 C1 00 58 */	psq_st f30, 0x58(r1), 0, qr0
/* 80310B4C 0030C98C  DB A1 00 40 */	stfd f29, 0x40(r1)
/* 80310B50 0030C990  F3 A1 00 48 */	psq_st f29, 0x48(r1), 0, qr0
...
/* 80310B68 0030C9A8  2C 00 00 00 */	cmpwi r0, 0x0
/* 80310B6C 0030C9AC  40 82 00 FC */	bne lbl_80310C68
/* 80310B70 0030C9B0  80 63 00 04 */	lwz r3, 0x4(r3)
/* 80310B74 0030C9B4  4B EE 94 D9 */	bl "data<Q43scn4step9challenge5Param>__Q25param13ParamAccessorCFv_RCQ43scn4step9challenge5Param"
/* 80310B78 0030C9B8  C3 E3 00 50 */	lfs f31, 0x50(r3)
/* 80310B7C 0030C9BC  80 7E 00 04 */	lwz r3, 0x4(r30)
/* 80310B80 0030C9C0  4B EE 94 CD */	bl "data<Q43scn4step9challenge5Param>__Q25param13ParamAccessorCFv_RCQ43scn4step9challenge5Param"
/* 80310B84 0030C9C4  C3 C3 00 54 */	lfs f30, 0x54(r3)
/* 80310B88 0030C9C8  80 7E 00 04 */	lwz r3, 0x4(r30)
/* 80310B8C 0030C9CC  4B EE 94 C1 */	bl "data<Q43scn4step9challenge5Param>__Q25param13ParamAccessorCFv_RCQ43scn4step9challenge5Param"
/* 80310B90 0030C9D0  C3 A3 00 58 */	lfs f29, 0x58(r3)
/* 80310B94 0030C9D4  38 61 00 28 */	addi r3, r1, 0x28
/* 80310B98 0030C9D8  80 9E 00 04 */	lwz r4, 0x4(r30)
...
/* 80310BC4 0030CA04  C0 1F 00 00 */	lfs f0, 0x0(r31)
...
/* 80310BD8 0030CA18  80 9E 00 04 */	lwz r4, 0x4(r30)
...
/* 80310C04 0030CA44  C0 1F 00 00 */	lfs f0, 0x0(r31)
...
.global lbl_80310C14
lbl_80310C14:
/* 80310C14 0030CA54  38 61 00 08 */	addi r3, r1, 0x8
/* 80310C18 0030CA58  80 9E 00 04 */	lwz r4, 0x4(r30)
...
/* 80310C24 0030CA64  C0 1F 00 04 */	lfs f0, 0x4(r31)
/* 80310C28 0030CA68  EC 21 00 28 */	fsubs f1, f1, f0
/* 80310C2C 0030CA6C  C0 02 C9 50 */	lfs f0, "@52848_805628D0"@sda21(r2)
...
.global lbl_80310C48
lbl_80310C48:
/* 80310C48 0030CA88  38 00 00 01 */	li r0, 0x1
/* 80310C4C 0030CA8C  90 1E 00 10 */	stw r0, 0x10(r30)
/* 80310C50 0030CA90  80 7E 00 04 */	lwz r3, 0x4(r30)
/* 80310C54 0030CA94  4B EE 93 F9 */	bl "data<Q43scn4step9challenge5Param>__Q25param13ParamAccessorCFv_RCQ43scn4step9challenge5Param"
/* 80310C58 0030CA98  7C 64 1B 78 */	mr r4, r3
/* 80310C5C 0030CA9C  38 7E 00 08 */	addi r3, r30, 0x8
...
.global "@52801_8055A740"
"@52801_8055A740":

	.4byte 0x44546F70
	.4byte 0x4C000000

.global "@52805_8055A748"
"@52805_8055A748":
