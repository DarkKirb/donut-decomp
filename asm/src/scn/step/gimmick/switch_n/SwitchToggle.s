...
/* 8032851C 0032435C  38 CD C5 68 */	addi r6, r13, "@52602_8055A988"@sda21
...
/* 8032852C 0032436C  90 1F 00 00 */	stw r0, 0x0(r31)
...
/* 80328568 003243A8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80328584 003243C4  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80328594 003243D4  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803285A4 003243E4  38 60 00 01 */	li r3, 0x1
/* 803285A8 003243E8  48 00 00 84 */	b lbl_8032862C
.global lbl_803285AC
lbl_803285AC:
/* 803285AC 003243EC  38 80 00 00 */	li r4, 0x0
/* 803285B0 003243F0  38 A0 00 00 */	li r5, 0x0
/* 803285B4 003243F4  38 C0 00 00 */	li r6, 0x0
/* 803285B8 003243F8  80 FF 00 08 */	lwz r7, 0x8(r31)
/* 803285BC 003243FC  2C 07 00 00 */	cmpwi r7, 0x0
/* 803285C0 00324400  41 82 00 18 */	beq lbl_803285D8
/* 803285C4 00324404  80 67 00 00 */	lwz r3, 0x0(r7)
...
/* 803285D4 00324414  38 C0 00 01 */	li r6, 0x1
.global lbl_803285D8
lbl_803285D8:
/* 803285D8 00324418  2C 06 00 00 */	cmpwi r6, 0x0
/* 803285DC 0032441C  41 82 00 14 */	beq lbl_803285F0
/* 803285E0 00324420  A0 07 00 04 */	lhz r0, 0x4(r7)
/* 803285E4 00324424  28 00 12 34 */	cmplwi r0, 0x1234
/* 803285E8 00324428  40 82 00 08 */	bne lbl_803285F0
/* 803285EC 0032442C  38 A0 00 01 */	li r5, 0x1
.global lbl_803285F0
lbl_803285F0:
/* 803285F0 00324430  2C 05 00 00 */	cmpwi r5, 0x0
/* 803285F4 00324434  41 82 00 14 */	beq lbl_80328608
/* 803285F8 00324438  80 07 00 08 */	lwz r0, 0x8(r7)
/* 803285FC 0032443C  28 00 00 10 */	cmplwi r0, 0x10
/* 80328600 00324440  41 80 00 08 */	blt lbl_80328608
/* 80328604 00324444  38 80 00 01 */	li r4, 0x1
.global lbl_80328608
lbl_80328608:
/* 80328608 00324448  7F E3 FB 78 */	mr r3, r31
/* 8032860C 0032444C  2C 04 00 00 */	cmpwi r4, 0x0
...
.global lbl_8032861C
lbl_8032861C:
/* 8032861C 0032445C  38 80 00 00 */	li r4, 0x0
.global lbl_80328620
lbl_80328620:
...
.global lbl_80328628
lbl_80328628:
/* 80328628 00324468  38 60 00 00 */	li r3, 0x0
.global lbl_8032862C
lbl_8032862C:
...
__vt__Q53scn4step7gimmick8switch_n12SwitchToggle:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step7gimmick8switch_n12SwitchToggleFv
	.4byte isChangeToOn__Q53scn4step7gimmick8switch_n12SwitchToggleFv
	.4byte isChangeToOff__Q53scn4step7gimmick8switch_n12SwitchToggleFv
	.4byte onChangeOffToOn__Q53scn4step7gimmick8switch_n12SwitchToggleFv
	.4byte onChangeToOn__Q53scn4step7gimmick8switch_n12SwitchToggleFv
	.4byte onChangeOnToOff__Q53scn4step7gimmick8switch_n6SwitchFv
	.4byte onChangeToOff__Q53scn4step7gimmick8switch_n12SwitchToggleFv
	.4byte 0
.include "macros.inc"

.section .sdata, "wa"  # 0x80556420 - 0x8055C6E0 ; 0x000062C0
.global "@52602_8055A988"
"@52602_8055A988":
