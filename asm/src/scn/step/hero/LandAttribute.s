...
/* 80344394 003401D4  90 83 00 00 */	stw r4, 0x0(r3)
/* 80344398 003401D8  38 00 00 00 */	li r0, 0x0
/* 8034439C 003401DC  90 03 00 04 */	stw r0, 0x4(r3)
/* 803443A0 003401E0  90 03 00 08 */	stw r0, 0x8(r3)
/* 803443A4 003401E4  90 03 00 0C */	stw r0, 0xc(r3)
/* 803443A8 003401E8  C0 02 CC D8 */	lfs f0, "@53684_80562C58"@sda21(r2)
...
/* 803443C4 00340204  F3 E1 00 38 */	psq_st f31, 0x38(r1), 0, qr0
/* 803443C8 00340208  DB C1 00 20 */	stfd f30, 0x20(r1)
/* 803443CC 0034020C  F3 C1 00 28 */	psq_st f30, 0x28(r1), 0, qr0
...
/* 803443EC 0034022C  38 61 00 08 */	addi r3, r1, 0x8
...
/* 8034440C 0034024C  3C 80 80 42 */	lis r4, "EFFECT_TABLE_L__Q43scn4step4hero27@unnamed@LandAttribute_cpp@"@ha
/* 80344410 00340250  38 84 9F E0 */	addi r4, r4, "EFFECT_TABLE_L__Q43scn4step4hero27@unnamed@LandAttribute_cpp@"@l
...
/* 8034445C 0034029C  F3 E1 00 38 */	psq_st f31, 0x38(r1), 0, qr0
/* 80344460 003402A0  DB C1 00 20 */	stfd f30, 0x20(r1)
/* 80344464 003402A4  F3 C1 00 28 */	psq_st f30, 0x28(r1), 0, qr0
...
/* 80344484 003402C4  38 61 00 08 */	addi r3, r1, 0x8
...
/* 803444A4 003402E4  3C 80 80 42 */	lis r4, "EFFECT_TABLE_S__Q43scn4step4hero27@unnamed@LandAttribute_cpp@"@ha
/* 803444A8 003402E8  38 84 A0 10 */	addi r4, r4, "EFFECT_TABLE_S__Q43scn4step4hero27@unnamed@LandAttribute_cpp@"@l
...
/* 803444F4 00340334  F3 E1 00 38 */	psq_st f31, 0x38(r1), 0, qr0
/* 803444F8 00340338  DB C1 00 20 */	stfd f30, 0x20(r1)
/* 803444FC 0034033C  F3 C1 00 28 */	psq_st f30, 0x28(r1), 0, qr0
...
/* 8034451C 0034035C  38 61 00 08 */	addi r3, r1, 0x8
...
/* 8034453C 0034037C  3C 80 80 42 */	lis r4, "EFFECT_TABLE_LANDING__Q43scn4step4hero27@unnamed@LandAttribute_cpp@"@ha
/* 80344540 00340380  38 84 A0 40 */	addi r4, r4, "EFFECT_TABLE_LANDING__Q43scn4step4hero27@unnamed@LandAttribute_cpp@"@l
...
/* 8034458C 003403CC  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80344590 003403D0  7C 7E 1B 78 */	mr r30, r3
/* 80344594 003403D4  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 803445A8 003403E8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803445BC 003403FC  80 7E 00 00 */	lwz r3, 0x0(r30)
...
/* 803445C8 00340408  2C 03 00 00 */	cmpwi r3, 0x0
/* 803445CC 0034040C  41 82 00 24 */	beq lbl_803445F0
/* 803445D0 00340410  2C 1F 00 00 */	cmpwi r31, 0x0
/* 803445D4 00340414  40 82 00 1C */	bne lbl_803445F0
/* 803445D8 00340418  80 7E 00 00 */	lwz r3, 0x0(r30)
/* 803445DC 0034041C  4B FF BD C9 */	bl soundSE__Q43scn4step4hero4HeroFv
/* 803445E0 00340420  38 63 00 04 */	addi r3, r3, 0x4
...
.global lbl_803445F0
lbl_803445F0:
/* 803445F0 00340430  80 7E 00 00 */	lwz r3, 0x0(r30)
...
/* 803445FC 0034043C  2C 03 00 00 */	cmpwi r3, 0x0
/* 80344600 00340440  41 82 00 24 */	beq lbl_80344624
/* 80344604 00340444  2C 1F 00 00 */	cmpwi r31, 0x0
/* 80344608 00340448  40 82 00 1C */	bne lbl_80344624
/* 8034460C 0034044C  80 7E 00 00 */	lwz r3, 0x0(r30)
/* 80344610 00340450  4B FF BD 95 */	bl soundSE__Q43scn4step4hero4HeroFv
/* 80344614 00340454  38 63 00 04 */	addi r3, r3, 0x4
...
.global lbl_80344624
lbl_80344624:
/* 80344624 00340464  80 7E 00 00 */	lwz r3, 0x0(r30)
/* 80344628 00340468  4B FF BD 7D */	bl soundSE__Q43scn4step4hero4HeroFv
/* 8034462C 0034046C  38 63 00 04 */	addi r3, r3, 0x4
/* 80344630 00340470  57 E0 10 3A */	slwi r0, r31, 2
/* 80344634 00340474  3C 80 80 42 */	lis r4, "SE_TABLE__Q43scn4step4hero27@unnamed@LandAttribute_cpp@"@ha
/* 80344638 00340478  38 84 A0 70 */	addi r4, r4, "SE_TABLE__Q43scn4step4hero27@unnamed@LandAttribute_cpp@"@l
...
/* 80344648 00340488  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8034466C 003404AC  4B CC 2C D9 */	bl lbl_80007344
/* 80344670 003404B0  7C 7D 1B 78 */	mr r29, r3
/* 80344674 003404B4  3B C0 00 00 */	li r30, 0x0
/* 80344678 003404B8  3B E0 00 00 */	li r31, 0x0
.global lbl_8034467C
lbl_8034467C:
/* 8034467C 003404BC  38 7D 00 04 */	addi r3, r29, 0x4
/* 80344680 003404C0  7F C4 F3 78 */	mr r4, r30
/* 80344684 003404C4  48 00 00 2D */	bl "__vc__Q33hel6common11Array<b,12>FUl"
/* 80344688 003404C8  9B E3 00 00 */	stb r31, 0x0(r3)
/* 8034468C 003404CC  3B DE 00 01 */	addi r30, r30, 0x1
...
/* 8034469C 003404DC  4B CC 2C F5 */	bl lbl_80007390
...
.global "__vc__Q33hel6common11Array<b,12>FUl"
"__vc__Q33hel6common11Array<b,12>FUl":
...
/* 803446C0 00340500  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 803446E0 00340520  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80344704 00340544  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8034471C 0034055C  3B E0 00 01 */	li r31, 0x1
/* 80344720 00340560  38 7E 00 04 */	addi r3, r30, 0x4
/* 80344724 00340564  4B FF FF 8D */	bl "__vc__Q33hel6common11Array<b,12>FUl"
/* 80344728 00340568  9B E3 00 00 */	stb r31, 0x0(r3)
.global lbl_8034472C
lbl_8034472C:
/* 8034472C 0034056C  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 80344730 00340570  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80344754 00340594  3B E0 00 01 */	li r31, 0x1
/* 80344758 00340598  38 63 00 04 */	addi r3, r3, 0x4
/* 8034475C 0034059C  38 80 00 08 */	li r4, 0x8
/* 80344760 003405A0  4B FF FF 51 */	bl "__vc__Q33hel6common11Array<b,12>FUl"
/* 80344764 003405A4  9B E3 00 00 */	stb r31, 0x0(r3)
...
/* 8034478C 003405CC  3B E0 00 01 */	li r31, 0x1
/* 80344790 003405D0  38 63 00 04 */	addi r3, r3, 0x4
/* 80344794 003405D4  38 80 00 09 */	li r4, 0x9
/* 80344798 003405D8  4B FF FF 19 */	bl "__vc__Q33hel6common11Array<b,12>FUl"
/* 8034479C 003405DC  9B E3 00 00 */	stb r31, 0x0(r3)
...
/* 803447C4 00340604  3B E0 00 01 */	li r31, 0x1
/* 803447C8 00340608  38 63 00 04 */	addi r3, r3, 0x4
/* 803447CC 0034060C  38 80 00 0A */	li r4, 0xa
/* 803447D0 00340610  4B FF FE E1 */	bl "__vc__Q33hel6common11Array<b,12>FUl"
/* 803447D4 00340614  9B E3 00 00 */	stb r31, 0x0(r3)
...
/* 80344820 00340660  80 7D 00 00 */	lwz r3, 0x0(r29)
...
/* 8034482C 0034066C  C0 5F 00 00 */	lfs f2, 0x0(r31)
...
/* 80344840 00340680  C0 1F 00 04 */	lfs f0, 0x4(r31)
...
/* 80344870 003406B0  80 7D 00 00 */	lwz r3, 0x0(r29)
...
/* 803448A4 003406E4  93 E1 00 08 */	stw r31, 0x8(r1)
...
/* 803448B8 003406F8  38 00 00 00 */	li r0, 0x0
...
/* 803448D8 00340718  C0 03 00 04 */	lfs f0, 0x4(r3)
...
/* 803448E8 00340728  C0 03 00 08 */	lfs f0, 0x8(r3)
/* 803448EC 0034072C  FC 01 00 00 */	fcmpu cr0, f1, f0
/* 803448F0 00340730  40 82 00 08 */	bne lbl_803448F8
/* 803448F4 00340734  38 00 00 01 */	li r0, 0x1
.global lbl_803448F8
lbl_803448F8:
/* 803448F8 00340738  2C 00 00 00 */	cmpwi r0, 0x0
/* 803448FC 0034073C  41 82 00 0C */	beq lbl_80344908
/* 80344900 00340740  38 00 00 00 */	li r0, 0x0
...
/* 80344914 00340754  38 00 00 01 */	li r0, 0x1
.global lbl_80344918
lbl_80344918:
/* 80344918 00340758  2C 00 00 00 */	cmpwi r0, 0x0
/* 8034491C 0034075C  41 82 00 10 */	beq lbl_8034492C
/* 80344920 00340760  38 61 00 08 */	addi r3, r1, 0x8
/* 80344924 00340764  4B E5 99 29 */	bl restruct__Q43hel4math10Direction34LeftFv
/* 80344928 00340768  48 00 00 28 */	b lbl_80344950
.global lbl_8034492C
lbl_8034492C:
/* 8034492C 0034076C  38 61 00 08 */	addi r3, r1, 0x8
...
/* 80344974 003407B4  4B CC 2A 1D */	bl lbl_80007390
...
/* 80344998 003407D8  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8034499C 003407DC  7C 7E 1B 78 */	mr r30, r3
/* 803449A0 003407E0  80 63 00 00 */	lwz r3, 0x0(r3)
/* 803449A4 003407E4  4B D0 F4 4D */	bl __wpadNoAlloc
/* 803449A8 003407E8  2C 03 00 00 */	cmpwi r3, 0x0
...
.global lbl_803449B8
lbl_803449B8:
/* 803449B8 003407F8  3B E0 00 01 */	li r31, 0x1
.global lbl_803449BC
lbl_803449BC:
...
/* 803449CC 0034080C  88 03 00 04 */	lbz r0, 0x4(r3)
/* 803449D0 00340810  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80344A10 00340850  C0 02 CC D8 */	lfs f0, "@53684_80562C58"@sda21(r2)
...
/* 80344A1C 0034085C  28 04 00 08 */	cmplwi r4, 0x8
/* 80344A20 00340860  41 81 00 5C */	bgt lbl_80344A7C
/* 80344A24 00340864  3C 60 80 48 */	lis r3, "@53793_80484DB0"@ha
/* 80344A28 00340868  38 63 4D B0 */	addi r3, r3, "@53793_80484DB0"@l
...
.global lbl_80344A3C
lbl_80344A3C:
/* 80344A3C 0034087C  38 60 00 01 */	li r3, 0x1
/* 80344A40 00340880  4E 80 00 20 */	blr

.global lbl_80344A44
lbl_80344A44:
/* 80344A44 00340884  38 60 00 02 */	li r3, 0x2
/* 80344A48 00340888  4E 80 00 20 */	blr

.global lbl_80344A4C
lbl_80344A4C:
/* 80344A4C 0034088C  38 60 00 03 */	li r3, 0x3
/* 80344A50 00340890  4E 80 00 20 */	blr

.global lbl_80344A54
lbl_80344A54:
/* 80344A54 00340894  38 60 00 04 */	li r3, 0x4
/* 80344A58 00340898  4E 80 00 20 */	blr

.global lbl_80344A5C
lbl_80344A5C:
/* 80344A5C 0034089C  38 60 00 05 */	li r3, 0x5
/* 80344A60 003408A0  4E 80 00 20 */	blr

.global lbl_80344A64
lbl_80344A64:
/* 80344A64 003408A4  38 60 00 06 */	li r3, 0x6
/* 80344A68 003408A8  4E 80 00 20 */	blr

.global lbl_80344A6C
lbl_80344A6C:
/* 80344A6C 003408AC  38 60 00 07 */	li r3, 0x7
/* 80344A70 003408B0  4E 80 00 20 */	blr

.global lbl_80344A74
lbl_80344A74:
/* 80344A74 003408B4  38 60 00 00 */	li r3, 0x0
/* 80344A78 003408B8  4E 80 00 20 */	blr

.global lbl_80344A7C
lbl_80344A7C:
/* 80344A7C 003408BC  38 60 00 00 */	li r3, 0x0
