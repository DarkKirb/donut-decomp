...
/* 803A465C 003A049C  2C 03 00 06 */	cmpwi r3, 0x6
/* 803A4660 003A04A0  41 82 00 10 */	beq lbl_803A4670
/* 803A4664 003A04A4  2C 03 00 07 */	cmpwi r3, 0x7
...
.global lbl_803A4680
lbl_803A4680:
/* 803A4680 003A04C0  38 60 00 00 */	li r3, 0x0
...
/* 803A469C 003A04DC  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 803A46AC 003A04EC  4B E9 21 BD */	bl "__ct__Q24util28StateFactory<Q24util6IState>FPv"
/* 803A46B0 003A04F0  3C 60 80 49 */	lis r3, "__vt__Q24util129StateFactoryArg2<Q24util6IState,Q53scn4step4hero11staffcredit13StateLookBoss,PQ43scn4step4hero4Hero,Q43scn4step4hero10ScriptKind>"@ha
/* 803A46B4 003A04F4  38 03 F0 68 */	addi r0, r3, "__vt__Q24util129StateFactoryArg2<Q24util6IState,Q53scn4step4hero11staffcredit13StateLookBoss,PQ43scn4step4hero4Hero,Q43scn4step4hero10ScriptKind>"@l
/* 803A46B8 003A04F8  90 1E 00 00 */	stw r0, 0x0(r30)
/* 803A46BC 003A04FC  93 9E 00 08 */	stw r28, 0x8(r30)
/* 803A46C0 003A0500  93 BE 00 0C */	stw r29, 0xc(r30)
.global lbl_803A46C4
lbl_803A46C4:
/* 803A46C4 003A0504  93 DF 00 0C */	stw r30, 0xc(r31)
/* 803A46C8 003A0508  38 60 00 01 */	li r3, 0x1
.global lbl_803A46CC
lbl_803A46CC:
...
/* 803A46F4 003A0534  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 803A470C 003A054C  90 1E 00 00 */	stw r0, 0x0(r30)
/* 803A4710 003A0550  38 00 00 00 */	li r0, 0x0
/* 803A4714 003A0554  98 1E 00 08 */	stb r0, 0x8(r30)
...
/* 803A474C 003A058C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 803A4770 003A05B0  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803A4774 003A05B4  7C 7E 1B 78 */	mr r30, r3
/* 803A4778 003A05B8  7C 9F 23 78 */	mr r31, r4
/* 803A477C 003A05BC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A478C 003A05CC  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 803A47C8 003A0608  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 803A47FC 003A063C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A4810 003A0650  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A482C 003A066C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A484C 003A068C  2C 03 00 06 */	cmpwi r3, 0x6
/* 803A4850 003A0690  41 82 00 18 */	beq lbl_803A4868
/* 803A4854 003A0694  2C 03 00 07 */	cmpwi r3, 0x7
/* 803A4858 003A0698  41 82 00 2C */	beq lbl_803A4884
/* 803A485C 003A069C  2C 03 00 08 */	cmpwi r3, 0x8
...
/* 803A48BC 003A06FC  38 00 00 01 */	li r0, 0x1
/* 803A48C0 003A0700  98 1D 00 08 */	stb r0, 0x8(r29)
.global lbl_803A48C4
lbl_803A48C4:
/* 803A48C4 003A0704  88 1D 00 08 */	lbz r0, 0x8(r29)
/* 803A48C8 003A0708  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 803A48E0 003A0720  38 80 00 00 */	li r4, 0x0
/* 803A48E4 003A0724  4B EC E1 C1 */	bl get__Q43scn4step5chara13ScriptTriggerFUl
/* 803A48E8 003A0728  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A48EC 003A072C  41 82 00 24 */	beq lbl_803A4910
/* 803A48F0 003A0730  38 00 00 00 */	li r0, 0x0
/* 803A48F4 003A0734  98 1D 00 08 */	stb r0, 0x8(r29)
...
/* 803A4924 003A0764  38 03 FE 9F */	addi r0, r3, -0x161
/* 803A4928 003A0768  28 00 00 01 */	cmplwi r0, 0x1
...
/* 803A4954 003A0794  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A4978 003A07B8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A49A4 003A07E4  2C 1D 00 00 */	cmpwi r29, 0x0
...
/* 803A49B4 003A07F4  4B E9 1E B5 */	bl "__ct__Q24util28StateFactory<Q24util6IState>FPv"
/* 803A49B8 003A07F8  3C 60 80 49 */	lis r3, "__vt__Q24util95StateFactoryArg1<Q24util6IState,Q53scn4step4hero11staffcredit9StateWait,PQ43scn4step4hero4Hero>"@ha
/* 803A49BC 003A07FC  38 03 F0 58 */	addi r0, r3, "__vt__Q24util95StateFactoryArg1<Q24util6IState,Q53scn4step4hero11staffcredit9StateWait,PQ43scn4step4hero4Hero>"@l
/* 803A49C0 003A0800  90 1D 00 00 */	stw r0, 0x0(r29)
/* 803A49C4 003A0804  93 DD 00 08 */	stw r30, 0x8(r29)
.global lbl_803A49C8
lbl_803A49C8:
...
/* 803A49FC 003A083C  F3 E1 00 98 */	psq_st f31, 0x98(r1), 0, qr0
...
/* 803A4A48 003A0888  3B A0 00 00 */	li r29, 0x0
...
/* 803A4A78 003A08B8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A4A9C 003A08DC  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A4AA0 003A08E0  41 82 00 84 */	beq lbl_803A4B24
/* 803A4AA4 003A08E4  38 61 00 60 */	addi r3, r1, 0x60
/* 803A4AA8 003A08E8  4B DD 7B 3D */	bl "isLink__Q24util51ObjListNode<Q23g3d5Model,Q24util16ObjListDummyType>CFv"
/* 803A4AAC 003A08EC  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A4AB0 003A08F0  41 82 00 0C */	beq lbl_803A4ABC
/* 803A4AB4 003A08F4  38 61 00 60 */	addi r3, r1, 0x60
/* 803A4AB8 003A08F8  4B E8 2C ED */	bl "unlink__Q24util60ObjListNode<Q43scn4step4boss4Boss,Q24util16ObjListDummyType>Fv"
.global lbl_803A4ABC
lbl_803A4ABC:
/* 803A4ABC 003A08FC  38 00 00 00 */	li r0, 0x0
...
/* 803A4ACC 003A090C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A4AE0 003A0920  4B DD 7B 05 */	bl "isLink__Q24util51ObjListNode<Q23g3d5Model,Q24util16ObjListDummyType>CFv"
/* 803A4AE4 003A0924  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A4AF4 003A0934  38 1E 00 04 */	addi r0, r30, 0x4
/* 803A4AF8 003A0938  90 01 00 08 */	stw r0, 0x8(r1)
/* 803A4AFC 003A093C  38 61 00 60 */	addi r3, r1, 0x60
/* 803A4B00 003A0940  4B E8 2C F1 */	bl "GetNodeFromPointer__Q34nw4r2ut81LinkList<Q24util60ObjListNode<Q43scn4step4boss4Boss,Q24util16ObjListDummyType>,0>FPQ24util60ObjListNode<Q43scn4step4boss4Boss,Q24util16ObjListDummyType>"
/* 803A4B04 003A0944  7C 65 1B 78 */	mr r5, r3
/* 803A4B08 003A0948  7F C3 F3 78 */	mr r3, r30
/* 803A4B0C 003A094C  38 81 00 08 */	addi r4, r1, 0x8
...
/* 803A4B18 003A0958  38 80 FF FF */	li r4, -0x1
/* 803A4B1C 003A095C  4B E8 2D 25 */	bl "__dt__Q24util35ObjRefHandle<Q43scn4step4boss4Boss>Fv"
/* 803A4B20 003A0960  48 00 00 1C */	b lbl_803A4B3C
.global lbl_803A4B24
lbl_803A4B24:
/* 803A4B24 003A0964  38 61 00 50 */	addi r3, r1, 0x50
/* 803A4B28 003A0968  38 80 FF FF */	li r4, -0x1
/* 803A4B2C 003A096C  4B E8 2D 15 */	bl "__dt__Q24util35ObjRefHandle<Q43scn4step4boss4Boss>Fv"
/* 803A4B30 003A0970  3B BD 00 01 */	addi r29, r29, 0x1
.global lbl_803A4B34
lbl_803A4B34:
...
/* 803A4B4C 003A098C  2C 00 00 00 */	cmpwi r0, 0x0
/* 803A4B50 003A0990  41 82 00 18 */	beq lbl_803A4B68
/* 803A4B54 003A0994  38 61 00 60 */	addi r3, r1, 0x60
/* 803A4B58 003A0998  38 80 FF FF */	li r4, -0x1
/* 803A4B5C 003A099C  4B E8 2C E5 */	bl "__dt__Q24util35ObjRefHandle<Q43scn4step4boss4Boss>Fv"
/* 803A4B60 003A09A0  38 60 00 00 */	li r3, 0x0
...
/* 803A4BF8 003A0A38  C0 02 D8 F0 */	lfs f0, "@57405_80563870"@sda21(r2)
...
/* 803A4C10 003A0A50  3B C0 00 00 */	li r30, 0x0
/* 803A4C14 003A0A54  C0 4D EE 28 */	lfs f2, ZERO__Q33hel4math7Vector2@sda21(r13)
/* 803A4C18 003A0A58  C0 62 D8 F4 */	lfs f3, "@57406_80563874"@sda21(r2)
/* 803A4C1C 003A0A5C  4B E1 0D 19 */	bl Equals__Q33hel4math4MathFfff
/* 803A4C20 003A0A60  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A4C24 003A0A64  41 82 00 24 */	beq lbl_803A4C48
/* 803A4C28 003A0A68  C0 21 00 1C */	lfs f1, 0x1c(r1)
/* 803A4C2C 003A0A6C  38 6D EE 28 */	addi r3, r13, ZERO__Q33hel4math7Vector2@sda21
/* 803A4C30 003A0A70  C0 43 00 04 */	lfs f2, 0x4(r3)
/* 803A4C34 003A0A74  C0 62 D8 F4 */	lfs f3, "@57406_80563874"@sda21(r2)
/* 803A4C38 003A0A78  4B E1 0C FD */	bl Equals__Q33hel4math4MathFfff
/* 803A4C3C 003A0A7C  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A4C40 003A0A80  41 82 00 08 */	beq lbl_803A4C48
/* 803A4C44 003A0A84  3B C0 00 01 */	li r30, 0x1
.global lbl_803A4C48
lbl_803A4C48:
/* 803A4C48 003A0A88  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 803A4C64 003A0AA4  38 6D EE 40 */	addi r3, r13, BASIS_Y__Q33hel4math7Vector2@sda21
...
/* 803A4C74 003A0AB4  C0 02 D8 F8 */	lfs f0, "@57408"@sda21(r2)
...
/* 803A4CAC 003A0AEC  C0 42 D8 FC */	lfs f2, "@57409"@sda21(r2)
/* 803A4CB0 003A0AF0  C0 02 D9 00 */	lfs f0, "@57410"@sda21(r2)
...
/* 803A4CC8 003A0B08  C0 42 D9 04 */	lfs f2, "@57411"@sda21(r2)
/* 803A4CCC 003A0B0C  C0 02 D9 08 */	lfs f0, "@57412"@sda21(r2)
...
/* 803A4CF4 003A0B34  C0 22 D9 0C */	lfs f1, "@57413"@sda21(r2)
...
/* 803A4D18 003A0B58  38 80 FF FF */	li r4, -0x1
/* 803A4D1C 003A0B5C  4B E8 2B 25 */	bl "__dt__Q24util35ObjRefHandle<Q43scn4step4boss4Boss>Fv"
/* 803A4D20 003A0B60  38 60 00 01 */	li r3, 0x1
.global lbl_803A4D24
lbl_803A4D24:
...
.global "create__Q24util129StateFactoryArg2<Q24util6IState,Q53scn4step4hero11staffcredit13StateLookBoss,PQ43scn4step4hero4Hero,Q43scn4step4hero10ScriptKind>Fv"
"create__Q24util129StateFactoryArg2<Q24util6IState,Q53scn4step4hero11staffcredit13StateLookBoss,PQ43scn4step4hero4Hero,Q43scn4step4hero10ScriptKind>Fv":
/* 803A4D54 003A0B94  7C 65 1B 78 */	mr r5, r3
/* 803A4D58 003A0B98  80 63 00 04 */	lwz r3, 0x4(r3)
/* 803A4D5C 003A0B9C  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A4D60 003A0BA0  4D 82 00 20 */	beqlr
/* 803A4D64 003A0BA4  80 85 00 08 */	lwz r4, 0x8(r5)
...
.global "create__Q24util95StateFactoryArg1<Q24util6IState,Q53scn4step4hero11staffcredit9StateWait,PQ43scn4step4hero4Hero>Fv"
"create__Q24util95StateFactoryArg1<Q24util6IState,Q53scn4step4hero11staffcredit9StateWait,PQ43scn4step4hero4Hero>Fv":
/* 803A4D74 003A0BB4  7C 64 1B 78 */	mr r4, r3
/* 803A4D78 003A0BB8  80 63 00 04 */	lwz r3, 0x4(r3)
/* 803A4D7C 003A0BBC  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A4D80 003A0BC0  4D 82 00 20 */	beqlr
/* 803A4D84 003A0BC4  80 84 00 08 */	lwz r4, 0x8(r4)
...
.global "__dt__Q24util129StateFactoryArg2<Q24util6IState,Q53scn4step4hero11staffcredit13StateLookBoss,PQ43scn4step4hero4Hero,Q43scn4step4hero10ScriptKind>Fv"
"__dt__Q24util129StateFactoryArg2<Q24util6IState,Q53scn4step4hero11staffcredit13StateLookBoss,PQ43scn4step4hero4Hero,Q43scn4step4hero10ScriptKind>Fv":
/* 803A4D90 003A0BD0  4B E8 99 10 */	b "__dt__Q24util89StateFactoryArg1<Q24util6IState,Q53scn4step4boss6common9StateWait,PQ43scn4step4boss4Boss>Fv"

.global "__dt__Q24util95StateFactoryArg1<Q24util6IState,Q53scn4step4hero11staffcredit9StateWait,PQ43scn4step4hero4Hero>Fv"
"__dt__Q24util95StateFactoryArg1<Q24util6IState,Q53scn4step4hero11staffcredit9StateWait,PQ43scn4step4hero4Hero>Fv":
/* 803A4D94 003A0BD4  4B E8 99 0C */	b "__dt__Q24util89StateFactoryArg1<Q24util6IState,Q53scn4step4boss6common9StateWait,PQ43scn4step4boss4Boss>Fv"
.include "macros.inc"
...
.global "@57405_80563870"
"@57405_80563870":

	.4byte 0x3F000000

.global "@57406_80563874"
"@57406_80563874":
