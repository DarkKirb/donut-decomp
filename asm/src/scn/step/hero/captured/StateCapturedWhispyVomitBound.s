...
/* 803850D4 00380F14  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 803850E8 00380F28  90 1E 00 00 */	stw r0, 0x0(r30)
/* 803850EC 00380F2C  C0 02 D5 98 */	lfs f0, "@58072"@sda21(r2)
/* 803850F0 00380F30  D0 1E 00 08 */	stfs f0, 0x8(r30)
/* 803850F4 00380F34  38 00 00 00 */	li r0, 0x0
...
/* 8038512C 00380F6C  38 80 00 01 */	li r4, 0x1
/* 80385130 00380F70  4B E1 35 51 */	bl "__ct__25mint_wrapNative_helper<b>Fb"
...
/* 80385188 00380FC8  38 63 00 04 */	addi r3, r3, 0x4
...
/* 803851A0 00380FE0  38 A0 00 01 */	li r5, 0x1
...
/* 803851B8 00380FF8  38 80 00 06 */	li r4, 0x6
...
/* 803851F4 00381034  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80385218 00381058  4B C8 21 2D */	bl lbl_80007344
/* 8038521C 0038105C  7C 7D 1B 78 */	mr r29, r3
/* 80385220 00381060  7C 9E 23 78 */	mr r30, r4
/* 80385224 00381064  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80385234 00381074  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 80385244 00381084  C0 22 D5 98 */	lfs f1, "@58072"@sda21(r2)
...
/* 8038525C 0038109C  C0 22 D5 98 */	lfs f1, "@58072"@sda21(r2)
...
/* 803852B4 003810F4  4B C8 20 DD */	bl lbl_80007390
...
/* 803852D8 00381118  F3 E1 00 38 */	psq_st f31, 0x38(r1), 0, qr0
...
/* 803852F8 00381138  C0 1E 00 08 */	lfs f0, 0x8(r30)
/* 803852FC 0038113C  EC 20 08 2A */	fadds f1, f0, f1
/* 80385300 00381140  D0 3E 00 08 */	stfs f1, 0x8(r30)
/* 80385304 00381144  C0 02 D5 9C */	lfs f0, "@58117_8056351C"@sda21(r2)
/* 80385308 00381148  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8038530C 0038114C  4C 41 13 82 */	cror eq, gt, eq
/* 80385310 00381150  40 82 00 0C */	bne lbl_8038531C
/* 80385314 00381154  EC 01 00 28 */	fsubs f0, f1, f0
/* 80385318 00381158  D0 1E 00 08 */	stfs f0, 0x8(r30)
.global lbl_8038531C
lbl_8038531C:
/* 8038531C 0038115C  88 1E 00 0C */	lbz r0, 0xc(r30)
/* 80385320 00381160  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80385348 00381188  D0 21 00 08 */	stfs f1, 0x8(r1)
/* 8038534C 0038118C  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80385350 00381190  3B E0 00 00 */	li r31, 0x0
/* 80385354 00381194  C0 4D EE 28 */	lfs f2, ZERO__Q33hel4math7Vector2@sda21(r13)
/* 80385358 00381198  C0 62 D5 A0 */	lfs f3, "@58118"@sda21(r2)
/* 8038535C 0038119C  4B E3 05 D9 */	bl Equals__Q33hel4math4MathFfff
/* 80385360 003811A0  2C 03 00 00 */	cmpwi r3, 0x0
/* 80385364 003811A4  41 82 00 24 */	beq lbl_80385388
/* 80385368 003811A8  C0 21 00 0C */	lfs f1, 0xc(r1)
/* 8038536C 003811AC  38 6D EE 28 */	addi r3, r13, ZERO__Q33hel4math7Vector2@sda21
/* 80385370 003811B0  C0 43 00 04 */	lfs f2, 0x4(r3)
/* 80385374 003811B4  C0 62 D5 A0 */	lfs f3, "@58118"@sda21(r2)
/* 80385378 003811B8  4B E3 05 BD */	bl Equals__Q33hel4math4MathFfff
/* 8038537C 003811BC  2C 03 00 00 */	cmpwi r3, 0x0
/* 80385380 003811C0  41 82 00 08 */	beq lbl_80385388
/* 80385384 003811C4  3B E0 00 01 */	li r31, 0x1
.global lbl_80385388
lbl_80385388:
/* 80385388 003811C8  2C 1F 00 00 */	cmpwi r31, 0x0
/* 8038538C 003811CC  40 82 00 38 */	bne lbl_803853C4
/* 80385390 003811D0  38 61 00 08 */	addi r3, r1, 0x8
/* 80385394 003811D4  4B E1 9C 89 */	bl normalize__Q33hel4math7Vector2Fv
/* 80385398 003811D8  38 6D EE 40 */	addi r3, r13, BASIS_Y__Q33hel4math7Vector2@sda21
/* 8038539C 003811DC  38 81 00 08 */	addi r4, r1, 0x8
...
/* 803853B8 003811F8  C0 02 D5 A4 */	lfs f0, "@58119"@sda21(r2)
...
/* 803853D4 00381214  C0 3E 00 08 */	lfs f1, 0x8(r30)
...
/* 803853F0 00381230  C0 22 D5 A8 */	lfs f1, "@58120"@sda21(r2)
...
/* 80385408 00381248  C0 3E 00 08 */	lfs f1, 0x8(r30)
...
/* 80385444 00381284  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 80385478 003812B8  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8038549C 003812DC  F3 E1 00 58 */	psq_st f31, 0x58(r1), 0, qr0
/* 803854A0 003812E0  39 61 00 50 */	addi r11, r1, 0x50
/* 803854A4 003812E4  4B C8 1E A1 */	bl lbl_80007344
...
/* 803854BC 003812FC  98 01 00 08 */	stb r0, 0x8(r1)
/* 803854C0 00381300  88 03 00 49 */	lbz r0, 0x49(r3)
/* 803854C4 00381304  98 01 00 09 */	stb r0, 0x9(r1)
...
/* 8038554C 0038138C  88 01 00 08 */	lbz r0, 0x8(r1)
/* 80385550 00381390  2C 00 00 00 */	cmpwi r0, 0x0
/* 80385554 00381394  41 82 00 C0 */	beq lbl_80385614
/* 80385558 00381398  88 1F 00 0C */	lbz r0, 0xc(r31)
/* 8038555C 0038139C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8038559C 003813DC  2C 04 00 00 */	cmpwi r4, 0x0
/* 803855A0 003813E0  41 82 00 2C */	beq lbl_803855CC
/* 803855A4 003813E4  3C 60 80 46 */	lis r3, "__vt__Q24util28StateFactory<Q24util6IState>"@ha
/* 803855A8 003813E8  38 03 44 78 */	addi r0, r3, "__vt__Q24util28StateFactory<Q24util6IState>"@l
/* 803855AC 003813EC  90 04 00 00 */	stw r0, 0x0(r4)
/* 803855B0 003813F0  38 1F 00 90 */	addi r0, r31, 0x90
/* 803855B4 003813F4  90 04 00 04 */	stw r0, 0x4(r4)
/* 803855B8 003813F8  3C 60 80 49 */	lis r3, "__vt__Q24util94StateFactoryArg2<Q24util6IState,Q53scn4step4hero6common10StateFaint,PQ43scn4step4hero4Hero,Ul>"@ha
/* 803855BC 003813FC  38 03 C6 30 */	addi r0, r3, "__vt__Q24util94StateFactoryArg2<Q24util6IState,Q53scn4step4hero6common10StateFaint,PQ43scn4step4hero4Hero,Ul>"@l
/* 803855C0 00381400  90 04 00 00 */	stw r0, 0x0(r4)
/* 803855C4 00381404  93 C4 00 08 */	stw r30, 0x8(r4)
...
/* 8038560C 0038144C  38 00 00 01 */	li r0, 0x1
...
/* 80385624 00381464  4B C8 1D 6D */	bl lbl_80007390
...
__vt__Q53scn4step4hero8captured29StateCapturedWhispyVomitBound:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step4hero8captured29StateCapturedWhispyVomitBoundFv
	.4byte procAnim__Q53scn4step4hero8captured29StateCapturedWhispyVomitBoundFv
	.4byte procMove__Q53scn4step4hero8captured29StateCapturedWhispyVomitBoundFv
	.4byte procConstraint__Q43scn4step4hero9StateBaseFv
	.4byte procFixPos__Q53scn4step4hero8captured29StateCapturedWhispyVomitBoundFv
