...
/* 8036BAE4 00367924  F3 E1 00 18 */	psq_st f31, 0x18(r1), 0, qr0
...
/* 8036BAFC 0036793C  90 1F 00 00 */	stw r0, 0x0(r31)
/* 8036BB00 00367940  38 00 00 00 */	li r0, 0x0
/* 8036BB04 00367944  90 1F 00 08 */	stw r0, 0x8(r31)
...
/* 8036BB54 00367994  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8036BB68 003679A8  38 80 00 01 */	li r4, 0x1
...
/* 8036BB90 003679D0  38 80 00 01 */	li r4, 0x1
...
/* 8036BBB4 003679F4  38 80 00 01 */	li r4, 0x1
...
/* 8036BBC8 00367A08  38 80 00 01 */	li r4, 0x1
...
/* 8036BC24 00367A64  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8036BC28 00367A68  7C 7E 1B 78 */	mr r30, r3
/* 8036BC2C 00367A6C  7C 9F 23 78 */	mr r31, r4
/* 8036BC30 00367A70  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8036BC40 00367A80  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 8036BC4C 00367A8C  38 80 00 00 */	li r4, 0x0
...
/* 8036BC90 00367AD0  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8036BCB8 00367AF8  80 83 00 08 */	lwz r4, 0x8(r3)
/* 8036BCBC 00367AFC  38 04 00 01 */	addi r0, r4, 0x1
/* 8036BCC0 00367B00  90 03 00 08 */	stw r0, 0x8(r3)
...
/* 8036BCE4 00367B24  80 1F 00 08 */	lwz r0, 0x8(r31)
...
/* 8036BD20 00367B60  4B C9 B6 21 */	bl lbl_80007340
/* 8036BD24 00367B64  7C 7C 1B 78 */	mr r28, r3
/* 8036BD28 00367B68  88 03 00 0C */	lbz r0, 0xc(r3)
/* 8036BD2C 00367B6C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8036BDDC 00367C1C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8036BDF4 00367C34  38 61 00 08 */	addi r3, r1, 0x8
/* 8036BDF8 00367C38  4B E2 F5 65 */	bl velocity__Q24gobj4MoveCFv
/* 8036BDFC 00367C3C  C0 21 00 0C */	lfs f1, 0xc(r1)
/* 8036BE00 00367C40  C0 02 D1 98 */	lfs f0, "@56442_80563118"@sda21(r2)
/* 8036BE04 00367C44  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8036BE08 00367C48  4C 40 13 82 */	cror eq, lt, eq
...
__vt__Q53scn4step4hero6common14StateSuperJump:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step4hero6common14StateSuperJumpFv
	.4byte procAnim__Q53scn4step4hero6common14StateSuperJumpFv
	.4byte procMove__Q53scn4step4hero6common14StateSuperJumpFv
	.4byte procConstraint__Q43scn4step4hero9StateBaseFv
	.4byte procFixPos__Q53scn4step4hero6common14StateSuperJumpFv
