...
/* 80375AE8 00371928  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 80375B00 00371940  90 1E 00 00 */	stw r0, 0x0(r30)
/* 80375B04 00371944  C0 02 D3 38 */	lfs f0, "@56907_805632B8"@sda21(r2)
/* 80375B08 00371948  D0 1E 00 08 */	stfs f0, 0x8(r30)
/* 80375B0C 0037194C  38 60 00 00 */	li r3, 0x0
...
/* 80375B24 00371964  2C 1F 00 00 */	cmpwi r31, 0x0
/* 80375B28 00371968  41 82 00 10 */	beq lbl_80375B38
/* 80375B2C 0037196C  2C 1F 00 01 */	cmpwi r31, 0x1
...
/* 80375BB0 003719F0  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80375BD4 00371A14  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80375BD8 00371A18  7C 7E 1B 78 */	mr r30, r3
/* 80375BDC 00371A1C  7C 9F 23 78 */	mr r31, r4
/* 80375BE0 00371A20  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80375BF0 00371A30  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 80375C00 00371A40  C0 22 D3 38 */	lfs f1, "@56907_805632B8"@sda21(r2)
...
/* 80375C18 00371A58  C0 22 D3 38 */	lfs f1, "@56907_805632B8"@sda21(r2)
...
/* 80375C5C 00371A9C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80375C80 00371AC0  F3 E1 00 38 */	psq_st f31, 0x38(r1), 0, qr0
...
/* 80375C90 00371AD0  38 84 00 01 */	addi r4, r4, 0x1
...
/* 80375CBC 00371AFC  C0 42 D3 3C */	lfs f2, "@56954_805632BC"@sda21(r2)
/* 80375CC0 00371B00  C0 1F 00 08 */	lfs f0, 0x8(r31)
/* 80375CC4 00371B04  EC 22 00 7A */	fmadds f1, f2, f1, f0
/* 80375CC8 00371B08  D0 3F 00 08 */	stfs f1, 0x8(r31)
/* 80375CCC 00371B0C  C0 02 D3 40 */	lfs f0, "@56955_805632C0"@sda21(r2)
/* 80375CD0 00371B10  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80375CD4 00371B14  4C 41 13 82 */	cror eq, gt, eq
/* 80375CD8 00371B18  40 82 00 0C */	bne lbl_80375CE4
/* 80375CDC 00371B1C  EC 01 00 28 */	fsubs f0, f1, f0
/* 80375CE0 00371B20  D0 1F 00 08 */	stfs f0, 0x8(r31)
.global lbl_80375CE4
lbl_80375CE4:
/* 80375CE4 00371B24  C0 3F 00 08 */	lfs f1, 0x8(r31)
/* 80375CE8 00371B28  C0 02 D3 38 */	lfs f0, "@56907_805632B8"@sda21(r2)
/* 80375CEC 00371B2C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80375CF0 00371B30  40 80 00 10 */	bge lbl_80375D00
/* 80375CF4 00371B34  C0 02 D3 40 */	lfs f0, "@56955_805632C0"@sda21(r2)
/* 80375CF8 00371B38  EC 01 00 2A */	fadds f0, f1, f0
/* 80375CFC 00371B3C  D0 1F 00 08 */	stfs f0, 0x8(r31)
.global lbl_80375D00
lbl_80375D00:
/* 80375D00 00371B40  88 1F 00 0C */	lbz r0, 0xc(r31)
/* 80375D04 00371B44  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80375D2C 00371B6C  D0 41 00 08 */	stfs f2, 0x8(r1)
/* 80375D30 00371B70  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 80375D34 00371B74  38 00 00 00 */	li r0, 0x0
/* 80375D38 00371B78  C0 0D EE 28 */	lfs f0, ZERO__Q33hel4math7Vector2@sda21(r13)
/* 80375D3C 00371B7C  FC 02 00 00 */	fcmpu cr0, f2, f0
/* 80375D40 00371B80  40 82 00 18 */	bne lbl_80375D58
/* 80375D44 00371B84  38 6D EE 28 */	addi r3, r13, ZERO__Q33hel4math7Vector2@sda21
/* 80375D48 00371B88  C0 03 00 04 */	lfs f0, 0x4(r3)
/* 80375D4C 00371B8C  FC 01 00 00 */	fcmpu cr0, f1, f0
/* 80375D50 00371B90  40 82 00 08 */	bne lbl_80375D58
/* 80375D54 00371B94  38 00 00 01 */	li r0, 0x1
.global lbl_80375D58
lbl_80375D58:
/* 80375D58 00371B98  2C 00 00 00 */	cmpwi r0, 0x0
/* 80375D5C 00371B9C  40 82 00 38 */	bne lbl_80375D94
/* 80375D60 00371BA0  38 61 00 08 */	addi r3, r1, 0x8
/* 80375D64 00371BA4  4B E2 92 B9 */	bl normalize__Q33hel4math7Vector2Fv
/* 80375D68 00371BA8  38 6D EE 40 */	addi r3, r13, BASIS_Y__Q33hel4math7Vector2@sda21
/* 80375D6C 00371BAC  38 81 00 08 */	addi r4, r1, 0x8
...
/* 80375D88 00371BC8  C0 02 D3 44 */	lfs f0, "@56956_805632C4"@sda21(r2)
...
/* 80375DA4 00371BE4  C0 3F 00 08 */	lfs f1, 0x8(r31)
...
/* 80375DC0 00371C00  C0 3F 00 08 */	lfs f1, 0x8(r31)
...
/* 80375DD8 00371C18  C0 22 D3 38 */	lfs f1, "@56907_805632B8"@sda21(r2)
...
/* 80375E18 00371C58  C0 22 D3 48 */	lfs f1, "@56961_805632C8"@sda21(r2)
/* 80375E1C 00371C5C  4B E2 5B E1 */	bl Create__Q24gobj14MoveParamDecelFf
/* 80375E20 00371C60  90 61 00 08 */	stw r3, 0x8(r1)
...
/* 80375E44 00371C84  38 81 00 08 */	addi r4, r1, 0x8
...
/* 80375E90 00371CD0  98 01 00 08 */	stb r0, 0x8(r1)
/* 80375E94 00371CD4  88 03 00 49 */	lbz r0, 0x49(r3)
/* 80375E98 00371CD8  98 01 00 09 */	stb r0, 0x9(r1)
...
/* 80375F90 00371DD0  2C 04 00 00 */	cmpwi r4, 0x0
/* 80375F94 00371DD4  41 82 00 30 */	beq lbl_80375FC4
/* 80375F98 00371DD8  3C 60 80 46 */	lis r3, "__vt__Q24util28StateFactory<Q24util6IState>"@ha
/* 80375F9C 00371DDC  38 03 44 78 */	addi r0, r3, "__vt__Q24util28StateFactory<Q24util6IState>"@l
/* 80375FA0 00371DE0  90 04 00 00 */	stw r0, 0x0(r4)
/* 80375FA4 00371DE4  38 1F 00 90 */	addi r0, r31, 0x90
/* 80375FA8 00371DE8  90 04 00 04 */	stw r0, 0x4(r4)
/* 80375FAC 00371DEC  3C 60 80 49 */	lis r3, "__vt__Q24util94StateFactoryArg2<Q24util6IState,Q53scn4step4hero6common10StateFaint,PQ43scn4step4hero4Hero,Ul>"@ha
/* 80375FB0 00371DF0  38 03 C6 30 */	addi r0, r3, "__vt__Q24util94StateFactoryArg2<Q24util6IState,Q53scn4step4hero6common10StateFaint,PQ43scn4step4hero4Hero,Ul>"@l
/* 80375FB4 00371DF4  90 04 00 00 */	stw r0, 0x0(r4)
/* 80375FB8 00371DF8  93 C4 00 08 */	stw r30, 0x8(r4)
...
.global lbl_80375FCC
lbl_80375FCC:
/* 80375FCC 00371E0C  88 01 00 08 */	lbz r0, 0x8(r1)
/* 80375FD0 00371E10  2C 00 00 00 */	cmpwi r0, 0x0
/* 80375FD4 00371E14  41 82 00 0C */	beq lbl_80375FE0
/* 80375FD8 00371E18  38 00 00 01 */	li r0, 0x1
...
.global "create__Q24util94StateFactoryArg2<Q24util6IState,Q53scn4step4hero6common10StateFaint,PQ43scn4step4hero4Hero,Ul>Fv"
"create__Q24util94StateFactoryArg2<Q24util6IState,Q53scn4step4hero6common10StateFaint,PQ43scn4step4hero4Hero,Ul>Fv":
/* 80375FF8 00371E38  7C 65 1B 78 */	mr r5, r3
/* 80375FFC 00371E3C  80 63 00 04 */	lwz r3, 0x4(r3)
/* 80376000 00371E40  2C 03 00 00 */	cmpwi r3, 0x0
/* 80376004 00371E44  4D 82 00 20 */	beqlr
/* 80376008 00371E48  80 85 00 08 */	lwz r4, 0x8(r5)
/* 8037600C 00371E4C  80 A5 00 0C */	lwz r5, 0xc(r5)
/* 80376010 00371E50  38 C0 00 00 */	li r6, 0x0
...
.global "__dt__Q24util94StateFactoryArg2<Q24util6IState,Q53scn4step4hero6common10StateFaint,PQ43scn4step4hero4Hero,Ul>Fv"
"__dt__Q24util94StateFactoryArg2<Q24util6IState,Q53scn4step4hero6common10StateFaint,PQ43scn4step4hero4Hero,Ul>Fv":
/* 8037601C 00371E5C  4B EB 86 84 */	b "__dt__Q24util89StateFactoryArg1<Q24util6IState,Q53scn4step4boss6common9StateWait,PQ43scn4step4boss4Boss>Fv"
.include "macros.inc"

.section .data, "wa"  # 0x80421040 - 0x80496700 ; 0x000756C0
.global "__vt__Q24util94StateFactoryArg2<Q24util6IState,Q53scn4step4hero6common10StateFaint,PQ43scn4step4hero4Hero,Ul>"
"__vt__Q24util94StateFactoryArg2<Q24util6IState,Q53scn4step4hero6common10StateFaint,PQ43scn4step4hero4Hero,Ul>":

	.4byte 0
	.4byte 0
	.4byte "__dt__Q24util94StateFactoryArg2<Q24util6IState,Q53scn4step4hero6common10StateFaint,PQ43scn4step4hero4Hero,Ul>Fv"
	.4byte "create__Q24util94StateFactoryArg2<Q24util6IState,Q53scn4step4hero6common10StateFaint,PQ43scn4step4hero4Hero,Ul>Fv"
...
__vt__Q53scn4step4hero6damage12StateExtreme:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step4hero6damage12StateExtremeFv
	.4byte procAnim__Q53scn4step4hero6damage12StateExtremeFv
	.4byte procMove__Q53scn4step4hero6damage12StateExtremeFv
	.4byte procConstraint__Q43scn4step4hero9StateBaseFv
	.4byte procFixPos__Q53scn4step4hero6damage12StateExtremeFv
...
.global "@56907_805632B8"
"@56907_805632B8":

	.4byte 0

.global "@56954_805632BC"
"@56954_805632BC":

	.4byte 0x41A00000

.global "@56955_805632C0"
"@56955_805632C0":

	.4byte 0x43B40000

.global "@56956_805632C4"
"@56956_805632C4":

	.4byte 0x42652EE1

.global "@56961_805632C8"
"@56961_805632C8":
