...
/* 80376664 003724A4  90 1F 00 00 */	stw r0, 0x0(r31)
/* 80376668 003724A8  C0 02 D3 80 */	lfs f0, "@56845_80563300"@sda21(r2)
/* 8037666C 003724AC  D0 1F 00 08 */	stfs f0, 0x8(r31)
/* 80376670 003724B0  38 60 00 00 */	li r3, 0x0
...
/* 803766E8 00372528  38 A0 00 01 */	li r5, 0x1
...
/* 803766FC 0037253C  38 80 00 02 */	li r4, 0x2
...
/* 8037672C 0037256C  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80376730 00372570  7C 7E 1B 78 */	mr r30, r3
/* 80376734 00372574  7C 9F 23 78 */	mr r31, r4
/* 80376738 00372578  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80376748 00372588  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 80376758 00372598  C0 22 D3 80 */	lfs f1, "@56845_80563300"@sda21(r2)
...
/* 80376770 003725B0  C0 22 D3 80 */	lfs f1, "@56845_80563300"@sda21(r2)
...
/* 803767C4 00372604  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 803767E8 00372628  F3 E1 00 38 */	psq_st f31, 0x38(r1), 0, qr0
...
/* 803767F8 00372638  38 04 00 01 */	addi r0, r4, 0x1
...
/* 80376820 00372660  C0 42 D3 84 */	lfs f2, "@56892_80563304"@sda21(r2)
/* 80376824 00372664  C0 1F 00 08 */	lfs f0, 0x8(r31)
/* 80376828 00372668  EC 22 00 7A */	fmadds f1, f2, f1, f0
/* 8037682C 0037266C  D0 3F 00 08 */	stfs f1, 0x8(r31)
/* 80376830 00372670  C0 02 D3 88 */	lfs f0, "@56893"@sda21(r2)
/* 80376834 00372674  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80376838 00372678  4C 41 13 82 */	cror eq, gt, eq
/* 8037683C 0037267C  40 82 00 0C */	bne lbl_80376848
/* 80376840 00372680  EC 01 00 28 */	fsubs f0, f1, f0
/* 80376844 00372684  D0 1F 00 08 */	stfs f0, 0x8(r31)
.global lbl_80376848
lbl_80376848:
/* 80376848 00372688  C0 3F 00 08 */	lfs f1, 0x8(r31)
/* 8037684C 0037268C  C0 02 D3 80 */	lfs f0, "@56845_80563300"@sda21(r2)
/* 80376850 00372690  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80376854 00372694  40 80 00 10 */	bge lbl_80376864
/* 80376858 00372698  C0 02 D3 88 */	lfs f0, "@56893"@sda21(r2)
/* 8037685C 0037269C  EC 01 00 2A */	fadds f0, f1, f0
/* 80376860 003726A0  D0 1F 00 08 */	stfs f0, 0x8(r31)
.global lbl_80376864
lbl_80376864:
/* 80376864 003726A4  88 1F 00 0C */	lbz r0, 0xc(r31)
/* 80376868 003726A8  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80376890 003726D0  D0 41 00 08 */	stfs f2, 0x8(r1)
/* 80376894 003726D4  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 80376898 003726D8  38 00 00 00 */	li r0, 0x0
/* 8037689C 003726DC  C0 0D EE 28 */	lfs f0, ZERO__Q33hel4math7Vector2@sda21(r13)
/* 803768A0 003726E0  FC 02 00 00 */	fcmpu cr0, f2, f0
/* 803768A4 003726E4  40 82 00 18 */	bne lbl_803768BC
/* 803768A8 003726E8  38 6D EE 28 */	addi r3, r13, ZERO__Q33hel4math7Vector2@sda21
/* 803768AC 003726EC  C0 03 00 04 */	lfs f0, 0x4(r3)
/* 803768B0 003726F0  FC 01 00 00 */	fcmpu cr0, f1, f0
/* 803768B4 003726F4  40 82 00 08 */	bne lbl_803768BC
/* 803768B8 003726F8  38 00 00 01 */	li r0, 0x1
.global lbl_803768BC
lbl_803768BC:
/* 803768BC 003726FC  2C 00 00 00 */	cmpwi r0, 0x0
/* 803768C0 00372700  40 82 00 38 */	bne lbl_803768F8
/* 803768C4 00372704  38 61 00 08 */	addi r3, r1, 0x8
/* 803768C8 00372708  4B E2 87 55 */	bl normalize__Q33hel4math7Vector2Fv
/* 803768CC 0037270C  38 6D EE 40 */	addi r3, r13, BASIS_Y__Q33hel4math7Vector2@sda21
/* 803768D0 00372710  38 81 00 08 */	addi r4, r1, 0x8
...
/* 803768EC 0037272C  C0 02 D3 8C */	lfs f0, "@56894"@sda21(r2)
...
/* 80376908 00372748  C0 3F 00 08 */	lfs f1, 0x8(r31)
...
/* 80376924 00372764  C0 22 D3 90 */	lfs f1, "@56895_80563310"@sda21(r2)
...
/* 8037693C 0037277C  C0 3F 00 08 */	lfs f1, 0x8(r31)
...
/* 8037697C 003727BC  C0 22 D3 94 */	lfs f1, "@56900_80563314"@sda21(r2)
/* 80376980 003727C0  4B E2 50 7D */	bl Create__Q24gobj14MoveParamDecelFf
/* 80376984 003727C4  90 61 00 08 */	stw r3, 0x8(r1)
...
/* 803769A8 003727E8  38 81 00 08 */	addi r4, r1, 0x8
...
/* 803769F4 00372834  98 01 00 08 */	stb r0, 0x8(r1)
/* 803769F8 00372838  88 03 00 49 */	lbz r0, 0x49(r3)
/* 803769FC 0037283C  98 01 00 09 */	stb r0, 0x9(r1)
...
/* 80376A88 003728C8  2C 03 00 00 */	cmpwi r3, 0x0
/* 80376A8C 003728CC  41 82 00 10 */	beq lbl_80376A9C
/* 80376A90 003728D0  38 03 FF FF */	addi r0, r3, -0x1
...
/* 80376AA0 003728E0  2C 00 00 00 */	cmpwi r0, 0x0
...
.global lbl_80376AB8
lbl_80376AB8:
/* 80376AB8 003728F8  88 01 00 08 */	lbz r0, 0x8(r1)
/* 80376ABC 003728FC  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80376AD4 00372914  38 00 00 01 */	li r0, 0x1
...
/* 80376AE4 00372924  38 00 00 00 */	li r0, 0x0
...
__vt__Q53scn4step4hero6damage12StateFireLv2:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step4hero6damage12StateFireLv2Fv
	.4byte procAnim__Q53scn4step4hero6damage12StateFireLv2Fv
	.4byte procMove__Q53scn4step4hero6damage12StateFireLv2Fv
	.4byte procConstraint__Q43scn4step4hero9StateBaseFv
	.4byte procFixPos__Q53scn4step4hero6damage12StateFireLv2Fv
