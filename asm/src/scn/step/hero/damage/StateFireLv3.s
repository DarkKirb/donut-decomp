...
/* 80376B24 00372964  90 1F 00 00 */	stw r0, 0x0(r31)
/* 80376B28 00372968  C0 02 D3 98 */	lfs f0, "@57010_80563318"@sda21(r2)
/* 80376B2C 0037296C  D0 1F 00 08 */	stfs f0, 0x8(r31)
/* 80376B30 00372970  38 60 00 00 */	li r3, 0x0
...
/* 80376BB4 003729F4  38 A0 00 01 */	li r5, 0x1
...
/* 80376BC8 00372A08  38 80 00 02 */	li r4, 0x2
...
/* 80376BF8 00372A38  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80376BFC 00372A3C  7C 7E 1B 78 */	mr r30, r3
/* 80376C00 00372A40  7C 9F 23 78 */	mr r31, r4
/* 80376C04 00372A44  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80376C14 00372A54  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 80376C24 00372A64  C0 22 D3 98 */	lfs f1, "@57010_80563318"@sda21(r2)
...
/* 80376C3C 00372A7C  C0 22 D3 98 */	lfs f1, "@57010_80563318"@sda21(r2)
...
/* 80376C90 00372AD0  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80376CB4 00372AF4  F3 E1 00 38 */	psq_st f31, 0x38(r1), 0, qr0
...
/* 80376CC4 00372B04  38 04 00 01 */	addi r0, r4, 0x1
...
/* 80376CEC 00372B2C  C0 42 D3 9C */	lfs f2, "@57057_8056331C"@sda21(r2)
/* 80376CF0 00372B30  C0 1F 00 08 */	lfs f0, 0x8(r31)
/* 80376CF4 00372B34  EC 22 00 7A */	fmadds f1, f2, f1, f0
/* 80376CF8 00372B38  D0 3F 00 08 */	stfs f1, 0x8(r31)
/* 80376CFC 00372B3C  C0 02 D3 A0 */	lfs f0, "@57058_80563320"@sda21(r2)
/* 80376D00 00372B40  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80376D04 00372B44  4C 41 13 82 */	cror eq, gt, eq
/* 80376D08 00372B48  40 82 00 0C */	bne lbl_80376D14
/* 80376D0C 00372B4C  EC 01 00 28 */	fsubs f0, f1, f0
/* 80376D10 00372B50  D0 1F 00 08 */	stfs f0, 0x8(r31)
.global lbl_80376D14
lbl_80376D14:
/* 80376D14 00372B54  C0 3F 00 08 */	lfs f1, 0x8(r31)
/* 80376D18 00372B58  C0 02 D3 98 */	lfs f0, "@57010_80563318"@sda21(r2)
/* 80376D1C 00372B5C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80376D20 00372B60  40 80 00 10 */	bge lbl_80376D30
/* 80376D24 00372B64  C0 02 D3 A0 */	lfs f0, "@57058_80563320"@sda21(r2)
/* 80376D28 00372B68  EC 01 00 2A */	fadds f0, f1, f0
/* 80376D2C 00372B6C  D0 1F 00 08 */	stfs f0, 0x8(r31)
.global lbl_80376D30
lbl_80376D30:
/* 80376D30 00372B70  88 1F 00 0C */	lbz r0, 0xc(r31)
/* 80376D34 00372B74  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80376D5C 00372B9C  D0 41 00 08 */	stfs f2, 0x8(r1)
/* 80376D60 00372BA0  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 80376D64 00372BA4  38 00 00 00 */	li r0, 0x0
/* 80376D68 00372BA8  C0 0D EE 28 */	lfs f0, ZERO__Q33hel4math7Vector2@sda21(r13)
/* 80376D6C 00372BAC  FC 02 00 00 */	fcmpu cr0, f2, f0
/* 80376D70 00372BB0  40 82 00 18 */	bne lbl_80376D88
/* 80376D74 00372BB4  38 6D EE 28 */	addi r3, r13, ZERO__Q33hel4math7Vector2@sda21
/* 80376D78 00372BB8  C0 03 00 04 */	lfs f0, 0x4(r3)
/* 80376D7C 00372BBC  FC 01 00 00 */	fcmpu cr0, f1, f0
/* 80376D80 00372BC0  40 82 00 08 */	bne lbl_80376D88
/* 80376D84 00372BC4  38 00 00 01 */	li r0, 0x1
.global lbl_80376D88
lbl_80376D88:
/* 80376D88 00372BC8  2C 00 00 00 */	cmpwi r0, 0x0
/* 80376D8C 00372BCC  40 82 00 38 */	bne lbl_80376DC4
/* 80376D90 00372BD0  38 61 00 08 */	addi r3, r1, 0x8
/* 80376D94 00372BD4  4B E2 82 89 */	bl normalize__Q33hel4math7Vector2Fv
/* 80376D98 00372BD8  38 6D EE 40 */	addi r3, r13, BASIS_Y__Q33hel4math7Vector2@sda21
/* 80376D9C 00372BDC  38 81 00 08 */	addi r4, r1, 0x8
...
/* 80376DB8 00372BF8  C0 02 D3 A4 */	lfs f0, "@57059_80563324"@sda21(r2)
...
/* 80376DD4 00372C14  C0 3F 00 08 */	lfs f1, 0x8(r31)
...
/* 80376DF0 00372C30  C0 22 D3 A8 */	lfs f1, "@57060_80563328"@sda21(r2)
...
/* 80376E08 00372C48  C0 3F 00 08 */	lfs f1, 0x8(r31)
...
/* 80376E48 00372C88  C0 22 D3 AC */	lfs f1, "@57065_8056332C"@sda21(r2)
/* 80376E4C 00372C8C  4B E2 4B B1 */	bl Create__Q24gobj14MoveParamDecelFf
/* 80376E50 00372C90  90 61 00 08 */	stw r3, 0x8(r1)
...
/* 80376E74 00372CB4  38 81 00 08 */	addi r4, r1, 0x8
...
/* 80376ED4 00372D14  2C 03 00 00 */	cmpwi r3, 0x0
/* 80376ED8 00372D18  41 82 00 10 */	beq lbl_80376EE8
/* 80376EDC 00372D1C  38 03 FF FF */	addi r0, r3, -0x1
...
/* 80376EEC 00372D2C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80376F04 00372D44  38 61 00 08 */	addi r3, r1, 0x8
/* 80376F08 00372D48  4B FB E0 69 */	bl result__Q43scn4step4hero7MapCollCFv
/* 80376F0C 00372D4C  88 01 00 08 */	lbz r0, 0x8(r1)
/* 80376F10 00372D50  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80376F4C 00372D8C  2C 04 00 00 */	cmpwi r4, 0x0
/* 80376F50 00372D90  41 82 00 30 */	beq lbl_80376F80
/* 80376F54 00372D94  3C 60 80 46 */	lis r3, "__vt__Q24util28StateFactory<Q24util6IState>"@ha
/* 80376F58 00372D98  38 03 44 78 */	addi r0, r3, "__vt__Q24util28StateFactory<Q24util6IState>"@l
/* 80376F5C 00372D9C  90 04 00 00 */	stw r0, 0x0(r4)
/* 80376F60 00372DA0  38 1F 00 90 */	addi r0, r31, 0x90
/* 80376F64 00372DA4  90 04 00 04 */	stw r0, 0x4(r4)
/* 80376F68 00372DA8  3C 60 80 49 */	lis r3, "__vt__Q24util94StateFactoryArg2<Q24util6IState,Q53scn4step4hero6common10StateFaint,PQ43scn4step4hero4Hero,Ul>"@ha
/* 80376F6C 00372DAC  38 03 C6 30 */	addi r0, r3, "__vt__Q24util94StateFactoryArg2<Q24util6IState,Q53scn4step4hero6common10StateFaint,PQ43scn4step4hero4Hero,Ul>"@l
/* 80376F70 00372DB0  90 04 00 00 */	stw r0, 0x0(r4)
/* 80376F74 00372DB4  93 C4 00 08 */	stw r30, 0x8(r4)
/* 80376F78 00372DB8  38 00 00 02 */	li r0, 0x2
...
/* 80376F8C 00372DCC  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80376FA4 00372DE4  38 00 00 01 */	li r0, 0x1
...
/* 80376FB4 00372DF4  38 00 00 00 */	li r0, 0x0
...
__vt__Q53scn4step4hero6damage12StateFireLv3:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step4hero6damage12StateFireLv3Fv
	.4byte procAnim__Q53scn4step4hero6damage12StateFireLv3Fv
	.4byte procMove__Q53scn4step4hero6damage12StateFireLv3Fv
	.4byte procConstraint__Q43scn4step4hero9StateBaseFv
	.4byte procFixPos__Q53scn4step4hero6damage12StateFireLv3Fv
...
.global "@57010_80563318"
"@57010_80563318":

	.4byte 0

.global "@57057_8056331C"
"@57057_8056331C":

	.4byte 0x41A00000

.global "@57058_80563320"
"@57058_80563320":

	.4byte 0x43B40000

.global "@57059_80563324"
"@57059_80563324":

	.4byte 0x42652EE1

.global "@57060_80563328"
"@57060_80563328":

	.4byte 0x42480000

.global "@57065_8056332C"
"@57065_8056332C":
