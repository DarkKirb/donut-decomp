...
/* 80377BCC 00373A0C  90 1F 00 00 */	stw r0, 0x0(r31)
/* 80377BD0 00373A10  C0 02 D3 E0 */	lfs f0, "@57010_80563360"@sda21(r2)
/* 80377BD4 00373A14  D0 1F 00 08 */	stfs f0, 0x8(r31)
/* 80377BD8 00373A18  38 60 00 00 */	li r3, 0x0
...
/* 80377C5C 00373A9C  38 A0 00 01 */	li r5, 0x1
...
/* 80377C70 00373AB0  38 80 00 04 */	li r4, 0x4
...
/* 80377CA0 00373AE0  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80377CA4 00373AE4  7C 7E 1B 78 */	mr r30, r3
/* 80377CA8 00373AE8  7C 9F 23 78 */	mr r31, r4
/* 80377CAC 00373AEC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80377CBC 00373AFC  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 80377CCC 00373B0C  C0 22 D3 E0 */	lfs f1, "@57010_80563360"@sda21(r2)
...
/* 80377CE4 00373B24  C0 22 D3 E0 */	lfs f1, "@57010_80563360"@sda21(r2)
...
/* 80377D38 00373B78  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80377D5C 00373B9C  F3 E1 00 38 */	psq_st f31, 0x38(r1), 0, qr0
...
/* 80377D6C 00373BAC  38 04 00 01 */	addi r0, r4, 0x1
...
/* 80377D94 00373BD4  C0 42 D3 E4 */	lfs f2, "@57057_80563364"@sda21(r2)
/* 80377D98 00373BD8  C0 1F 00 08 */	lfs f0, 0x8(r31)
/* 80377D9C 00373BDC  EC 22 00 7A */	fmadds f1, f2, f1, f0
/* 80377DA0 00373BE0  D0 3F 00 08 */	stfs f1, 0x8(r31)
/* 80377DA4 00373BE4  C0 02 D3 E8 */	lfs f0, "@57058_80563368"@sda21(r2)
/* 80377DA8 00373BE8  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80377DAC 00373BEC  4C 41 13 82 */	cror eq, gt, eq
/* 80377DB0 00373BF0  40 82 00 0C */	bne lbl_80377DBC
/* 80377DB4 00373BF4  EC 01 00 28 */	fsubs f0, f1, f0
/* 80377DB8 00373BF8  D0 1F 00 08 */	stfs f0, 0x8(r31)
.global lbl_80377DBC
lbl_80377DBC:
/* 80377DBC 00373BFC  C0 3F 00 08 */	lfs f1, 0x8(r31)
/* 80377DC0 00373C00  C0 02 D3 E0 */	lfs f0, "@57010_80563360"@sda21(r2)
/* 80377DC4 00373C04  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80377DC8 00373C08  40 80 00 10 */	bge lbl_80377DD8
/* 80377DCC 00373C0C  C0 02 D3 E8 */	lfs f0, "@57058_80563368"@sda21(r2)
/* 80377DD0 00373C10  EC 01 00 2A */	fadds f0, f1, f0
/* 80377DD4 00373C14  D0 1F 00 08 */	stfs f0, 0x8(r31)
.global lbl_80377DD8
lbl_80377DD8:
/* 80377DD8 00373C18  88 1F 00 0C */	lbz r0, 0xc(r31)
/* 80377DDC 00373C1C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80377E04 00373C44  D0 41 00 08 */	stfs f2, 0x8(r1)
/* 80377E08 00373C48  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 80377E0C 00373C4C  38 00 00 00 */	li r0, 0x0
/* 80377E10 00373C50  C0 0D EE 28 */	lfs f0, ZERO__Q33hel4math7Vector2@sda21(r13)
/* 80377E14 00373C54  FC 02 00 00 */	fcmpu cr0, f2, f0
/* 80377E18 00373C58  40 82 00 18 */	bne lbl_80377E30
/* 80377E1C 00373C5C  38 6D EE 28 */	addi r3, r13, ZERO__Q33hel4math7Vector2@sda21
/* 80377E20 00373C60  C0 03 00 04 */	lfs f0, 0x4(r3)
/* 80377E24 00373C64  FC 01 00 00 */	fcmpu cr0, f1, f0
/* 80377E28 00373C68  40 82 00 08 */	bne lbl_80377E30
/* 80377E2C 00373C6C  38 00 00 01 */	li r0, 0x1
.global lbl_80377E30
lbl_80377E30:
/* 80377E30 00373C70  2C 00 00 00 */	cmpwi r0, 0x0
/* 80377E34 00373C74  40 82 00 38 */	bne lbl_80377E6C
/* 80377E38 00373C78  38 61 00 08 */	addi r3, r1, 0x8
/* 80377E3C 00373C7C  4B E2 71 E1 */	bl normalize__Q33hel4math7Vector2Fv
/* 80377E40 00373C80  38 6D EE 40 */	addi r3, r13, BASIS_Y__Q33hel4math7Vector2@sda21
/* 80377E44 00373C84  38 81 00 08 */	addi r4, r1, 0x8
...
/* 80377E60 00373CA0  C0 02 D3 EC */	lfs f0, "@57059_8056336C"@sda21(r2)
...
/* 80377E7C 00373CBC  C0 3F 00 08 */	lfs f1, 0x8(r31)
...
/* 80377E98 00373CD8  C0 22 D3 F0 */	lfs f1, "@57060_80563370"@sda21(r2)
...
/* 80377EB0 00373CF0  C0 3F 00 08 */	lfs f1, 0x8(r31)
...
/* 80377EF0 00373D30  C0 22 D3 F4 */	lfs f1, "@57065_80563374"@sda21(r2)
/* 80377EF4 00373D34  4B E2 3B 09 */	bl Create__Q24gobj14MoveParamDecelFf
/* 80377EF8 00373D38  90 61 00 08 */	stw r3, 0x8(r1)
...
/* 80377F1C 00373D5C  38 81 00 08 */	addi r4, r1, 0x8
...
__vt__Q53scn4step4hero6damage13StateSparkLv3:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step4hero6damage13StateSparkLv3Fv
	.4byte procAnim__Q53scn4step4hero6damage13StateSparkLv3Fv
	.4byte procMove__Q53scn4step4hero6damage13StateSparkLv3Fv
	.4byte procConstraint__Q43scn4step4hero9StateBaseFv
	.4byte procFixPos__Q53scn4step4hero6damage13StateSparkLv3Fv
...
.global "@57010_80563360"
"@57010_80563360":

	.4byte 0

.global "@57057_80563364"
"@57057_80563364":

	.4byte 0x41A00000

.global "@57058_80563368"
"@57058_80563368":

	.4byte 0x43B40000

.global "@57059_8056336C"
"@57059_8056336C":

	.4byte 0x42652EE1

.global "@57060_80563370"
"@57060_80563370":

	.4byte 0x42480000

.global "@57065_80563374"
"@57065_80563374":
