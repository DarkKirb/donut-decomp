...
/* 8037C3A0 003781E0  90 1B 00 00 */	stw r0, 0x0(r27)
/* 8037C3A4 003781E4  3B E0 00 00 */	li r31, 0x0
/* 8037C3A8 003781E8  93 FB 00 08 */	stw r31, 0x8(r27)
...
/* 8037C470 003782B0  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8037C4A0 003782E0  2C 00 00 00 */	cmpwi r0, 0x0
/* 8037C4A4 003782E4  41 82 00 38 */	beq lbl_8037C4DC
/* 8037C4A8 003782E8  80 7F 00 08 */	lwz r3, 0x8(r31)
/* 8037C4AC 003782EC  38 03 00 01 */	addi r0, r3, 0x1
/* 8037C4B0 003782F0  90 1F 00 08 */	stw r0, 0x8(r31)
...
/* 8037C4BC 003782FC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8037C50C 0037834C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8037C56C 003783AC  4B E8 24 51 */	bl "LinearInterpolation<f>__Q33hel4math4MathFRCfRCff_Cf"
...
/* 8037C580 003783C0  38 81 00 08 */	addi r4, r1, 0x8
...
/* 8037C5A4 003783E4  80 63 00 08 */	lwz r3, 0x8(r3)
/* 8037C5A8 003783E8  38 03 FF D3 */	addi r0, r3, -0x2d
...
/* 8037C5F4 00378434  54 60 06 3E */	clrlwi r0, r3, 24
/* 8037C5F8 00378438  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8037C614 00378454  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8037C650 00378490  38 80 00 00 */	li r4, 0x0
...
/* 8037C660 003784A0  38 80 00 00 */	li r4, 0x0
...
/* 8037C670 003784B0  38 80 00 00 */	li r4, 0x0
...
/* 8037C680 003784C0  38 80 00 00 */	li r4, 0x0
...
/* 8037C6A8 003784E8  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8037C6C0 00378500  C0 02 D4 7C */	lfs f0, "@60714"@sda21(r2)
...
/* 8037C6E8 00378528  38 80 00 00 */	li r4, 0x0
/* 8037C6EC 0037852C  38 A1 00 18 */	addi r5, r1, 0x18
/* 8037C6F0 00378530  38 C0 00 00 */	li r6, 0x0
...
/* 8037C70C 0037854C  83 AD ED 10 */	lwz r29, "object___Q33hel6common38ExplicitSingleton<Q23app11Application>"@sda21(r13)
/* 8037C710 00378550  38 61 00 08 */	addi r3, r1, 0x8
