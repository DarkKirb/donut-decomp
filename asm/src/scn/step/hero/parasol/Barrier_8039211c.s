...
/* 80392194 0038DFD4  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 803921A8 0038DFE8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803921BC 0038DFFC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803921D0 0038E010  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803921E4 0038E024  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 803921F8 0038E038  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8039220C 0038E04C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80392220 0038E060  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80392254 0038E094  38 80 00 00 */	li r4, 0x0
...
/* 803922C8 0038E108  F3 E1 00 A8 */	psq_st f31, 0xa8(r1), 0, qr0
...
/* 803922F0 0038E130  C0 1F 00 00 */	lfs f0, 0x0(r31)
/* 803922F4 0038E134  D0 01 00 64 */	stfs f0, 0x64(r1)
/* 803922F8 0038E138  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 80392318 0038E158  38 A0 00 01 */	li r5, 0x1
...
/* 80392330 0038E170  38 80 FF FF */	li r4, -0x1
/* 80392334 0038E174  4B DE A3 5D */	bl __dt__Q23g3d12NodeAccessorFv
/* 80392338 0038E178  38 61 00 20 */	addi r3, r1, 0x20
/* 8039233C 0038E17C  C0 3F 00 04 */	lfs f1, 0x4(r31)
/* 80392340 0038E180  C0 5F 00 08 */	lfs f2, 0x8(r31)
...
/* 8039238C 0038E1CC  38 A0 00 00 */	li r5, 0x0
...
/* 803923A4 0038E1E4  38 80 FF FF */	li r4, -0x1
...
/* 803923C0 0038E200  2C 00 00 00 */	cmpwi r0, 0x0
/* 803923C4 0038E204  41 82 00 10 */	beq lbl_803923D4
/* 803923C8 0038E208  C0 02 D6 90 */	lfs f0, "@59019"@sda21(r2)
...
/* 803923F0 0038E230  38 61 00 08 */	addi r3, r1, 0x8
...
.global lbl_8039240C
lbl_8039240C:
/* 8039240C 0038E24C  38 00 00 00 */	li r0, 0x0
...
/* 80392424 0038E264  38 80 00 00 */	li r4, 0x0
...
/* 80392434 0038E274  38 80 FF FF */	li r4, -0x1
