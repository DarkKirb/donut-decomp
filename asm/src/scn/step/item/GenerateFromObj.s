...
/* 803C0FEC 003BCE2C  4B C4 63 59 */	bl lbl_80007344
...
/* 803C1004 003BCE44  38 C2 DA 38 */	addi r6, r2, "T_ODDSTABLE_ENEMY_1__Q43scn4step4item29@unnamed@GenerateFromObj_cpp@"@sda21
/* 803C1008 003BCE48  C0 02 DA 50 */	lfs f0, "@54118_805639D0"@sda21(r2)
/* 803C100C 003BCE4C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 803C1010 003BCE50  40 80 00 0C */	bge lbl_803C101C
/* 803C1014 003BCE54  38 C2 DA 48 */	addi r6, r2, "T_ODDSTABLE_ENEMY_3__Q43scn4step4item29@unnamed@GenerateFromObj_cpp@"@sda21
/* 803C1018 003BCE58  48 00 00 14 */	b lbl_803C102C
.global lbl_803C101C
lbl_803C101C:
/* 803C101C 003BCE5C  C0 02 DA 54 */	lfs f0, "@54119"@sda21(r2)
/* 803C1020 003BCE60  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 803C1024 003BCE64  40 80 00 08 */	bge lbl_803C102C
/* 803C1028 003BCE68  38 C2 DA 40 */	addi r6, r2, "T_ODDSTABLE_ENEMY_2__Q43scn4step4item29@unnamed@GenerateFromObj_cpp@"@sda21
.global lbl_803C102C
lbl_803C102C:
...
/* 803C1040 003BCE80  4B C4 63 51 */	bl lbl_80007390
...
/* 803C1064 003BCEA4  F3 E1 00 28 */	psq_st f31, 0x28(r1), 0, qr0
/* 803C1068 003BCEA8  39 61 00 20 */	addi r11, r1, 0x20
/* 803C106C 003BCEAC  4B C4 62 D5 */	bl lbl_80007340
/* 803C1070 003BCEB0  7C 7C 1B 78 */	mr r28, r3
/* 803C1074 003BCEB4  C3 E2 DA 58 */	lfs f31, "@54139"@sda21(r2)
/* 803C1078 003BCEB8  3B E0 00 00 */	li r31, 0x0
/* 803C107C 003BCEBC  3B C0 00 00 */	li r30, 0x0
/* 803C1080 003BCEC0  48 00 00 40 */	b lbl_803C10C0
.global lbl_803C1084
lbl_803C1084:
/* 803C1084 003BCEC4  80 7C 00 00 */	lwz r3, 0x0(r28)
...
/* 803C10A0 003BCEE0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803C10B8 003BCEF8  3B FF 00 01 */	addi r31, r31, 0x1
.global lbl_803C10BC
lbl_803C10BC:
/* 803C10BC 003BCEFC  3B DE 00 01 */	addi r30, r30, 0x1
.global lbl_803C10C0
lbl_803C10C0:
/* 803C10C0 003BCF00  80 7C 00 00 */	lwz r3, 0x0(r28)
...
/* 803C10D4 003BCF14  2C 1F 00 00 */	cmpwi r31, 0x0
/* 803C10D8 003BCF18  41 82 00 24 */	beq lbl_803C10FC
/* 803C10DC 003BCF1C  C8 22 DA 60 */	lfd f1, "@54143"@sda21(r2)
/* 803C10E0 003BCF20  93 E1 00 0C */	stw r31, 0xc(r1)
/* 803C10E4 003BCF24  3C 00 43 30 */	lis r0, 0x4330
/* 803C10E8 003BCF28  90 01 00 08 */	stw r0, 0x8(r1)
/* 803C10EC 003BCF2C  C8 01 00 08 */	lfd f0, 0x8(r1)
...
.global lbl_803C10FC
lbl_803C10FC:
/* 803C10FC 003BCF3C  C3 E2 DA 5C */	lfs f31, "@54140"@sda21(r2)
.global lbl_803C1100
lbl_803C1100:
...
/* 803C1114 003BCF54  4B C4 62 79 */	bl lbl_8000738C
...
/* 803C1138 003BCF78  4B C4 62 09 */	bl lbl_80007340
...
/* 803C1154 003BCF94  80 BD 00 04 */	lwz r5, 0x4(r29)
/* 803C1158 003BCF98  80 1F 00 00 */	lwz r0, 0x0(r31)
...
.global lbl_803C1178
lbl_803C1178:
/* 803C1178 003BCFB8  80 9F 00 04 */	lwz r4, 0x4(r31)
...
.global lbl_803C11A0
lbl_803C11A0:
/* 803C11A0 003BCFE0  38 05 00 01 */	addi r0, r5, 0x1
/* 803C11A4 003BCFE4  90 1D 00 04 */	stw r0, 0x4(r29)
/* 803C11A8 003BCFE8  7F 83 E3 78 */	mr r3, r28
/* 803C11AC 003BCFEC  48 00 00 1D */	bl "__ct__Q24util35ObjRefHandle<Q43scn4step4item4Item>Fv"
.global lbl_803C11B0
lbl_803C11B0:
/* 803C11B0 003BCFF0  39 61 00 20 */	addi r11, r1, 0x20
/* 803C11B4 003BCFF4  4B C4 61 D9 */	bl lbl_8000738C
...
.global "__ct__Q24util35ObjRefHandle<Q43scn4step4item4Item>Fv"
"__ct__Q24util35ObjRefHandle<Q43scn4step4item4Item>Fv":
...
/* 803C11DC 003BD01C  4B E7 8D A9 */	bl "__ct__Q24util39ObjRefHandle<Q43scn4step6weapon6Weapon>Fv"
...
.global "unlink__Q24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>Fv"
"unlink__Q24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>Fv":
...
/* 803C1208 003BD048  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803C120C 003BD04C  7C 7E 1B 78 */	mr r30, r3
/* 803C1210 003BD050  83 E3 00 08 */	lwz r31, 0x8(r3)
/* 803C1214 003BD054  48 00 00 31 */	bl "GetNodeFromPointer__Q34nw4r2ut81LinkList<Q24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>,0>FPQ24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>"
...
/* 803C1224 003BD064  38 00 00 00 */	li r0, 0x0
/* 803C1228 003BD068  90 1E 00 08 */	stw r0, 0x8(r30)
/* 803C122C 003BD06C  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 803C1230 003BD070  83 C1 00 08 */	lwz r30, 0x8(r1)
...
.global "GetNodeFromPointer__Q34nw4r2ut81LinkList<Q24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>,0>FPQ24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>"
"GetNodeFromPointer__Q34nw4r2ut81LinkList<Q24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>,0>FPQ24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>":
...
/* 803C1258 003BD098  2C 03 00 00 */	cmpwi r3, 0x0
/* 803C125C 003BD09C  40 82 00 20 */	bne lbl_803C127C
/* 803C1260 003BD0A0  3C 60 80 46 */	lis r3, "@STRING@GetNodeFromPointer__Q34nw4r2ut81LinkList<Q24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>,0>FPQ24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>"@ha
/* 803C1264 003BD0A4  38 63 48 94 */	addi r3, r3, "@STRING@GetNodeFromPointer__Q34nw4r2ut81LinkList<Q24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>,0>FPQ24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>"@l
/* 803C1268 003BD0A8  38 80 02 33 */	li r4, 0x233
/* 803C126C 003BD0AC  3C A0 80 46 */	lis r5, "@STRING@GetNodeFromPointer__Q34nw4r2ut81LinkList<Q24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>,0>FPQ24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>@0"@ha
/* 803C1270 003BD0B0  38 A5 48 70 */	addi r5, r5, "@STRING@GetNodeFromPointer__Q34nw4r2ut81LinkList<Q24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>,0>FPQ24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>@0"@l
/* 803C1274 003BD0B4  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803C12A4 003BD0E4  4B C4 60 9D */	bl lbl_80007340
/* 803C12A8 003BD0E8  7C 7C 1B 78 */	mr r28, r3
/* 803C12AC 003BD0EC  7C 9D 23 78 */	mr r29, r4
/* 803C12B0 003BD0F0  7C BE 2B 78 */	mr r30, r5
/* 803C12B4 003BD0F4  80 64 00 00 */	lwz r3, 0x0(r4)
/* 803C12B8 003BD0F8  4B DB 51 09 */	bl "__rf__Q33hel6common25ScopedPtr<Q23app7AppImpl>CFv"
/* 803C12BC 003BD0FC  80 63 04 9C */	lwz r3, 0x49c(r3)
/* 803C12C0 003BD100  4B C9 2B 31 */	bl __wpadNoAlloc
/* 803C12C4 003BD104  2C 03 00 00 */	cmpwi r3, 0x0
/* 803C12C8 003BD108  41 82 00 10 */	beq lbl_803C12D8
/* 803C12CC 003BD10C  7F 83 E3 78 */	mr r3, r28
/* 803C12D0 003BD110  4B FF FE F9 */	bl "__ct__Q24util35ObjRefHandle<Q43scn4step4item4Item>Fv"
/* 803C12D4 003BD114  48 00 01 18 */	b lbl_803C13EC
.global lbl_803C12D8
lbl_803C12D8:
/* 803C12D8 003BD118  3B E0 00 01 */	li r31, 0x1
/* 803C12DC 003BD11C  80 7D 00 00 */	lwz r3, 0x0(r29)
/* 803C12E0 003BD120  4B DB 50 E1 */	bl "__rf__Q33hel6common25ScopedPtr<Q23app7AppImpl>CFv"
/* 803C12E4 003BD124  80 63 04 9C */	lwz r3, 0x49c(r3)
/* 803C12E8 003BD128  4B C9 2B 09 */	bl __wpadNoAlloc
/* 803C12EC 003BD12C  2C 03 00 00 */	cmpwi r3, 0x0
/* 803C12F0 003BD130  41 82 00 08 */	beq lbl_803C12F8
/* 803C12F4 003BD134  3B E0 00 00 */	li r31, 0x0
.global lbl_803C12F8
lbl_803C12F8:
/* 803C12F8 003BD138  80 7D 00 00 */	lwz r3, 0x0(r29)
...
/* 803C1314 003BD154  38 80 00 03 */	li r4, 0x3
/* 803C1318 003BD158  38 C0 00 01 */	li r6, 0x1
...
/* 803C1328 003BD168  80 7D 00 00 */	lwz r3, 0x0(r29)
...
/* 803C1348 003BD188  2C 03 00 00 */	cmpwi r3, 0x0
/* 803C134C 003BD18C  41 82 00 1C */	beq lbl_803C1368
/* 803C1350 003BD190  38 00 00 00 */	li r0, 0x0
/* 803C1354 003BD194  90 1D 00 04 */	stw r0, 0x4(r29)
...
/* 803C136C 003BD1AC  4B E7 8C 19 */	bl "__ct__Q24util39ObjRefHandle<Q43scn4step6weapon6Weapon>Fv"
/* 803C1370 003BD1B0  7F 83 E3 78 */	mr r3, r28
/* 803C1374 003BD1B4  4B DB B2 71 */	bl "isLink__Q24util51ObjListNode<Q23g3d5Model,Q24util16ObjListDummyType>CFv"
/* 803C1378 003BD1B8  2C 03 00 00 */	cmpwi r3, 0x0
/* 803C137C 003BD1BC  41 82 00 0C */	beq lbl_803C1388
/* 803C1380 003BD1C0  7F 83 E3 78 */	mr r3, r28
/* 803C1384 003BD1C4  4B FF FE 75 */	bl "unlink__Q24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>Fv"
.global lbl_803C1388
lbl_803C1388:
/* 803C1388 003BD1C8  38 00 00 00 */	li r0, 0x0
...
/* 803C1398 003BD1D8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803C13AC 003BD1EC  4B DB B2 39 */	bl "isLink__Q24util51ObjListNode<Q23g3d5Model,Q24util16ObjListDummyType>CFv"
/* 803C13B0 003BD1F0  2C 03 00 00 */	cmpwi r3, 0x0
/* 803C13B4 003BD1F4  41 82 00 2C */	beq lbl_803C13E0
/* 803C13B8 003BD1F8  83 E1 00 18 */	lwz r31, 0x18(r1)
/* 803C13BC 003BD1FC  93 FC 00 08 */	stw r31, 0x8(r28)
/* 803C13C0 003BD200  38 1F 00 04 */	addi r0, r31, 0x4
/* 803C13C4 003BD204  90 01 00 08 */	stw r0, 0x8(r1)
/* 803C13C8 003BD208  7F 83 E3 78 */	mr r3, r28
/* 803C13CC 003BD20C  4B FF FE 79 */	bl "GetNodeFromPointer__Q34nw4r2ut81LinkList<Q24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>,0>FPQ24util60ObjListNode<Q43scn4step4item4Item,Q24util16ObjListDummyType>"
/* 803C13D0 003BD210  7C 65 1B 78 */	mr r5, r3
/* 803C13D4 003BD214  7F E3 FB 78 */	mr r3, r31
/* 803C13D8 003BD218  38 81 00 08 */	addi r4, r1, 0x8
...
/* 803C13E4 003BD224  38 80 FF FF */	li r4, -0x1
/* 803C13E8 003BD228  4B E7 40 15 */	bl "__dt__Q24util35ObjRefHandle<Q43scn4step4item4Item>Fv"
.global lbl_803C13EC
lbl_803C13EC:
/* 803C13EC 003BD22C  39 61 00 60 */	addi r11, r1, 0x60
/* 803C13F0 003BD230  4B C4 5F 9D */	bl lbl_8000738C
