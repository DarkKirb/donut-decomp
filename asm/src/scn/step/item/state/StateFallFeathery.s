...
/* 803C7B90 003C39D0  90 1F 00 00 */	stw r0, 0x0(r31)
...
/* 803C7BA4 003C39E4  D0 1F 00 08 */	stfs f0, 0x8(r31)
...
/* 803C7BB4 003C39F4  38 80 00 00 */	li r4, 0x0
...
/* 803C7BC8 003C3A08  38 80 00 01 */	li r4, 0x1
...
/* 803C7BF8 003C3A38  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803C7BFC 003C3A3C  7C 7E 1B 78 */	mr r30, r3
/* 803C7C00 003C3A40  7C 9F 23 78 */	mr r31, r4
/* 803C7C04 003C3A44  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803C7C14 003C3A54  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 803C7C50 003C3A90  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 803C7C94 003C3AD4  90 61 00 08 */	stw r3, 0x8(r1)
/* 803C7C98 003C3AD8  38 61 00 0C */	addi r3, r1, 0xc
/* 803C7C9C 003C3ADC  C0 3E 00 08 */	lfs f1, 0x8(r30)
...
/* 803C7CB8 003C3AF8  38 81 00 08 */	addi r4, r1, 0x8
...
/* 803C7CC4 003C3B04  C0 3E 00 08 */	lfs f1, 0x8(r30)
/* 803C7CC8 003C3B08  C0 1F 00 28 */	lfs f0, 0x28(r31)
/* 803C7CCC 003C3B0C  EC 21 00 28 */	fsubs f1, f1, f0
/* 803C7CD0 003C3B10  D0 3E 00 08 */	stfs f1, 0x8(r30)
...
/* 803C7CE0 003C3B20  D0 1E 00 08 */	stfs f0, 0x8(r30)
.global lbl_803C7CE4
lbl_803C7CE4:
...
/* 803C7D1C 003C3B5C  2C 03 00 00 */	cmpwi r3, 0x0
