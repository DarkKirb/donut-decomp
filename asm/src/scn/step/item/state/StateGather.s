...
/* 803C7E34 003C3C74  90 1E 00 00 */	stw r0, 0x0(r30)
/* 803C7E38 003C3C78  C0 02 DB 18 */	lfs f0, "@55059_80563A98"@sda21(r2)
/* 803C7E3C 003C3C7C  D0 1E 00 08 */	stfs f0, 0x8(r30)
...
/* 803C7E84 003C3CC4  38 80 00 02 */	li r4, 0x2
...
/* 803C7E94 003C3CD4  38 80 00 00 */	li r4, 0x0
...
/* 803C7EA4 003C3CE4  38 80 00 00 */	li r4, 0x0
...
/* 803C7EC8 003C3D08  C0 02 DB 1C */	lfs f0, "@55060_80563A9C"@sda21(r2)
...
/* 803C7EE4 003C3D24  38 63 00 08 */	addi r3, r3, 0x8
...
/* 803C7F28 003C3D68  C0 23 00 08 */	lfs f1, 0x8(r3)
/* 803C7F2C 003C3D6C  C0 02 DB 20 */	lfs f0, "@55072"@sda21(r2)
/* 803C7F30 003C3D70  EC 01 00 2A */	fadds f0, f1, f0
/* 803C7F34 003C3D74  D0 03 00 08 */	stfs f0, 0x8(r3)
...
/* 803C7F44 003C3D84  C8 22 DB 28 */	lfd f1, "@55075_80563AA8"@sda21(r2)
...
/* 803C7F5C 003C3D9C  C0 1E 00 08 */	lfs f0, 0x8(r30)
...
/* 803C7F88 003C3DC8  38 61 00 08 */	addi r3, r1, 0x8
...
/* 803C7FA8 003C3DE8  38 80 00 01 */	li r4, 0x1
...
/* 803C7FE4 003C3E24  F3 E1 00 58 */	psq_st f31, 0x58(r1), 0, qr0
/* 803C7FE8 003C3E28  DB C1 00 40 */	stfd f30, 0x40(r1)
/* 803C7FEC 003C3E2C  F3 C1 00 48 */	psq_st f30, 0x48(r1), 0, qr0
/* 803C7FF0 003C3E30  93 E1 00 3C */	stw r31, 0x3c(r1)
/* 803C7FF4 003C3E34  7C 7F 1B 78 */	mr r31, r3
/* 803C7FF8 003C3E38  C0 23 00 08 */	lfs f1, 0x8(r3)
/* 803C7FFC 003C3E3C  C0 02 DB 30 */	lfs f0, "@55079_80563AB0"@sda21(r2)
/* 803C8000 003C3E40  EF E1 00 24 */	fdivs f31, f1, f0
/* 803C8004 003C3E44  C0 22 DB 20 */	lfs f1, "@55072"@sda21(r2)
...
/* 803C802C 003C3E6C  38 61 00 08 */	addi r3, r1, 0x8
/* 803C8030 003C3E70  38 9F 00 0C */	addi r4, r31, 0xc
/* 803C8034 003C3E74  C0 02 DB 20 */	lfs f0, "@55072"@sda21(r2)
...
/* 803C8044 003C3E84  C0 01 00 08 */	lfs f0, 0x8(r1)
...
/* 803C8060 003C3EA0  C0 02 DB 3C */	lfs f0, "@55082_80563ABC"@sda21(r2)
/* 803C8064 003C3EA4  EC 20 07 F2 */	fmuls f1, f0, f31
/* 803C8068 003C3EA8  C0 02 DB 38 */	lfs f0, "@55081_80563AB8"@sda21(r2)
/* 803C806C 003C3EAC  EC 20 00 72 */	fmuls f1, f0, f1
/* 803C8070 003C3EB0  C0 02 DB 34 */	lfs f0, "@55080_80563AB4"@sda21(r2)
...
__vt__Q53scn4step4item5state11StateGather:
	...
	.4byte 0
	.4byte 0
	.4byte __dt__Q53scn4step4item5state11StateGatherFv
	.4byte procAnim__Q53scn4step4item5state11StateGatherFv
	.4byte procMove__Q53scn4step4item5state11StateGatherFv
	.4byte procFixPos__Q43scn4step4item9StateBaseFv
.include "macros.inc"

.section .sdata2, "wa"  # 0x8055DF80 - 0x805643C0 ; 0x00006440
.global "@55059_80563A98"
"@55059_80563A98":

	.4byte 0

.global "@55060_80563A9C"
"@55060_80563A9C":
...
.global "@55075_80563AA8"
"@55075_80563AA8":

	.4byte 0x43300000
	.4byte 0

.global "@55079_80563AB0"
"@55079_80563AB0":

	.4byte 0x41A00000

.global "@55080_80563AB4"
"@55080_80563AB4":

	.4byte 0x4222F983

.global "@55081_80563AB8"
"@55081_80563AB8":

	.4byte 0x3C8EFA35

.global "@55082_80563ABC"
"@55082_80563ABC":
