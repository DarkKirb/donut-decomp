...
/* 803C8C08 003C4A48  90 1F 00 00 */	stw r0, 0x0(r31)
/* 803C8C0C 003C4A4C  C0 02 DB 80 */	lfs f0, "@55346_80563B00"@sda21(r2)
/* 803C8C10 003C4A50  D0 1F 00 08 */	stfs f0, 0x8(r31)
/* 803C8C14 003C4A54  C0 02 DB 84 */	lfs f0, "@55347"@sda21(r2)
/* 803C8C18 003C4A58  D0 1F 00 0C */	stfs f0, 0xc(r31)
/* 803C8C1C 003C4A5C  38 00 00 00 */	li r0, 0x0
...
/* 803C8C30 003C4A70  38 80 00 01 */	li r4, 0x1
...
/* 803C8C44 003C4A84  2C 03 00 05 */	cmpwi r3, 0x5
/* 803C8C48 003C4A88  40 82 00 24 */	bne lbl_803C8C6C
/* 803C8C4C 003C4A8C  C0 02 DB 88 */	lfs f0, "@55348"@sda21(r2)
/* 803C8C50 003C4A90  D0 1F 00 08 */	stfs f0, 0x8(r31)
...
/* 803C8C60 003C4AA0  38 80 00 01 */	li r4, 0x1
...
/* 803C8C84 003C4AC4  81 84 00 00 */	lwz r12, 0x0(r4)
...
/* 803C8C9C 003C4ADC  3C A0 80 49 */	lis r5, "@55349"@ha
/* 803C8CA0 003C4AE0  38 A5 26 48 */	addi r5, r5, "@55349"@l
/* 803C8CA4 003C4AE4  4B DC 7A 8D */	bl nodeByName__Q23g3d13ModelAccessorCFPCc
/* 803C8CA8 003C4AE8  38 61 00 18 */	addi r3, r1, 0x18
/* 803C8CAC 003C4AEC  38 80 FF FF */	li r4, -0x1
...
/* 803C8CCC 003C4B0C  D0 41 00 08 */	stfs f2, 0x8(r1)
...
/* 803C8CE8 003C4B28  38 A1 00 08 */	addi r5, r1, 0x8
...
/* 803C8CF4 003C4B34  38 80 FF FF */	li r4, -0x1
...
/* 803C8D04 003C4B44  38 80 00 01 */	li r4, 0x1
...
/* 803C8D40 003C4B80  2C 03 00 00 */	cmpwi r3, 0x0
/* 803C8D44 003C4B84  41 82 00 2C */	beq lbl_803C8D70
/* 803C8D48 003C4B88  C0 3F 00 08 */	lfs f1, 0x8(r31)
/* 803C8D4C 003C4B8C  C0 02 DB 8C */	lfs f0, "@55390"@sda21(r2)
/* 803C8D50 003C4B90  EC 21 00 2A */	fadds f1, f1, f0
/* 803C8D54 003C4B94  D0 3F 00 08 */	stfs f1, 0x8(r31)
/* 803C8D58 003C4B98  C0 02 DB 90 */	lfs f0, "@55391"@sda21(r2)
/* 803C8D5C 003C4B9C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 803C8D60 003C4BA0  4C 41 13 82 */	cror eq, gt, eq
/* 803C8D64 003C4BA4  40 82 00 0C */	bne lbl_803C8D70
/* 803C8D68 003C4BA8  EC 01 00 28 */	fsubs f0, f1, f0
/* 803C8D6C 003C4BAC  D0 1F 00 08 */	stfs f0, 0x8(r31)
.global lbl_803C8D70
lbl_803C8D70:
...
/* 803C8D94 003C4BD4  F3 E1 00 38 */	psq_st f31, 0x38(r1), 0, qr0
...
/* 803C8DB8 003C4BF8  C0 3F 00 08 */	lfs f1, 0x8(r31)
/* 803C8DBC 003C4BFC  C0 02 DB 98 */	lfs f0, "@55399"@sda21(r2)
/* 803C8DC0 003C4C00  EC 20 00 72 */	fmuls f1, f0, f1
/* 803C8DC4 003C4C04  C0 02 DB 94 */	lfs f0, "@55398_80563B14"@sda21(r2)
/* 803C8DC8 003C4C08  EC 20 00 72 */	fmuls f1, f0, f1
/* 803C8DCC 003C4C0C  4B D3 5C D5 */	bl SinFIdx__Q24nw4r4mathFf
/* 803C8DD0 003C4C10  C0 02 DB 9C */	lfs f0, "@55400"@sda21(r2)
...
/* 803C8DFC 003C4C3C  38 61 00 08 */	addi r3, r1, 0x8
