...
/* 803C9BD8 003C5A18  38 80 00 02 */	li r4, 0x2
...
/* 803C9BE4 003C5A24  38 80 00 02 */	li r4, 0x2
...
/* 803C9BEC 003C5A2C  38 80 00 00 */	li r4, 0x0
...
/* 803C9BF8 003C5A38  38 80 00 00 */	li r4, 0x0
...
/* 803C9C00 003C5A40  38 80 00 01 */	li r4, 0x1
...
/* 803C9C0C 003C5A4C  38 80 00 01 */	li r4, 0x1
...
/* 803C9C68 003C5AA8  38 C0 00 00 */	li r6, 0x0
/* 803C9C6C 003C5AAC  38 80 00 00 */	li r4, 0x0
/* 803C9C70 003C5AB0  80 03 00 00 */	lwz r0, 0x0(r3)
/* 803C9C74 003C5AB4  7C 09 03 A6 */	mtctr r0
/* 803C9C78 003C5AB8  28 00 00 00 */	cmplwi r0, 0x0
/* 803C9C7C 003C5ABC  40 81 00 20 */	ble lbl_803C9C9C
.global lbl_803C9C80
lbl_803C9C80:
/* 803C9C80 003C5AC0  7C A3 22 14 */	add r5, r3, r4
/* 803C9C84 003C5AC4  80 05 00 04 */	lwz r0, 0x4(r5)
/* 803C9C88 003C5AC8  7C 1F 00 00 */	cmpw r31, r0
/* 803C9C8C 003C5ACC  40 82 00 08 */	bne lbl_803C9C94
/* 803C9C90 003C5AD0  38 C6 00 01 */	addi r6, r6, 0x1
.global lbl_803C9C94
lbl_803C9C94:
...
/* 803C9CC4 003C5B04  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 803C9CD4 003C5B14  38 C0 00 00 */	li r6, 0x0
/* 803C9CD8 003C5B18  38 80 00 00 */	li r4, 0x0
/* 803C9CDC 003C5B1C  80 03 00 00 */	lwz r0, 0x0(r3)
/* 803C9CE0 003C5B20  7C 09 03 A6 */	mtctr r0
/* 803C9CE4 003C5B24  28 00 00 00 */	cmplwi r0, 0x0
/* 803C9CE8 003C5B28  40 81 00 30 */	ble lbl_803C9D18
.global lbl_803C9CEC
lbl_803C9CEC:
/* 803C9CEC 003C5B2C  7C A3 22 14 */	add r5, r3, r4
/* 803C9CF0 003C5B30  80 05 00 04 */	lwz r0, 0x4(r5)
...
/* 803C9D04 003C5B44  38 65 00 04 */	addi r3, r5, 0x4
/* 803C9D08 003C5B48  48 00 00 14 */	b lbl_803C9D1C
.global lbl_803C9D0C
lbl_803C9D0C:
/* 803C9D0C 003C5B4C  38 C6 00 01 */	addi r6, r6, 0x1
.global lbl_803C9D10
lbl_803C9D10:
...
.global lbl_803C9D18
lbl_803C9D18:
/* 803C9D18 003C5B58  38 63 00 04 */	addi r3, r3, 0x4
.global lbl_803C9D1C
lbl_803C9D1C:
/* 803C9D1C 003C5B5C  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 803C9D20 003C5B60  83 C1 00 08 */	lwz r30, 0x8(r1)
