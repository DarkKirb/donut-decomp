...
/* 803CCE08 003C8C48  3C 80 80 49 */	lis r4, "@52031"@ha
/* 803CCE0C 003C8C4C  38 84 2C 38 */	addi r4, r4, "@52031"@l
...
/* 803CCE20 003C8C60  4B DA 95 A1 */	bl "__rf__Q33hel6common25ScopedPtr<Q23app7AppImpl>CFv"
...
/* 803CCE6C 003C8CAC  C0 22 DC 00 */	lfs f1, "@52071_80563B80"@sda21(r2)
/* 803CCE70 003C8CB0  C0 42 DC 04 */	lfs f2, "@52072_80563B84"@sda21(r2)
/* 803CCE74 003C8CB4  FC 60 10 90 */	fmr f3, f2
/* 803CCE78 003C8CB8  FC 80 08 90 */	fmr f4, f1
/* 803CCE7C 003C8CBC  C0 A2 DC 08 */	lfs f5, "@52073_80563B88"@sda21(r2)
...
/* 803CCEB8 003C8CF8  C0 22 DC 04 */	lfs f1, "@52072_80563B84"@sda21(r2)
...
/* 803CCF1C 003C8D5C  4B F7 4C 31 */	bl "data<Q43scn4step4hero15NodeAttachParam>__Q25param8JITParamCFv_RCQ43scn4step4hero15NodeAttachParam"
/* 803CCF20 003C8D60  4B DC 83 C5 */	bl SetColor__Q23gfx12EasyRender3DFRC8_GXColor
/* 803CCF24 003C8D64  C0 22 DC 08 */	lfs f1, "@52073_80563B88"@sda21(r2)
/* 803CCF28 003C8D68  C0 42 DC 00 */	lfs f2, "@52071_80563B80"@sda21(r2)
...
/* 803CCF40 003C8D80  C0 22 DC 04 */	lfs f1, "@52072_80563B84"@sda21(r2)
...
/* 803CCF50 003C8D90  C0 02 DC 00 */	lfs f0, "@52071_80563B80"@sda21(r2)
...
.global "@52071_80563B80"
"@52071_80563B80":

	.4byte 0x3F800000

.global "@52072_80563B84"
"@52072_80563B84":

	.4byte 0xBF800000

.global "@52073_80563B88"
"@52073_80563B88":
