...
/* 803FEC38 003FAA78  38 60 00 00 */	li r3, 0x0
/* 803FEC3C 003FAA7C  38 00 00 79 */	li r0, 0x79
/* 803FEC40 003FAA80  7C 09 03 A6 */	mtctr r0
.global lbl_803FEC44
lbl_803FEC44:
/* 803FEC44 003FAA84  90 66 00 04 */	stw r3, 0x4(r6)
/* 803FEC48 003FAA88  94 66 00 08 */	stwu r3, 0x8(r6)
...
.global lbl_803FEC84
lbl_803FEC84:
/* 803FEC84 003FAAC4  80 64 00 04 */	lwz r3, 0x4(r4)
/* 803FEC88 003FAAC8  84 04 00 08 */	lwzu r0, 0x8(r4)
/* 803FEC8C 003FAACC  90 65 00 04 */	stw r3, 0x4(r5)
/* 803FEC90 003FAAD0  94 05 00 08 */	stwu r0, 0x8(r5)
...
.global lbl_803FECC4
lbl_803FECC4:
/* 803FECC4 003FAB04  80 A6 00 04 */	lwz r5, 0x4(r6)
/* 803FECC8 003FAB08  84 06 00 08 */	lwzu r0, 0x8(r6)
/* 803FECCC 003FAB0C  90 A7 00 04 */	stw r5, 0x4(r7)
/* 803FECD0 003FAB10  94 07 00 08 */	stwu r0, 0x8(r7)
...
/* 803FECE0 003FAB20  38 00 00 09 */	li r0, 0x9
/* 803FECE4 003FAB24  7C 09 03 A6 */	mtctr r0
.global lbl_803FECE8
lbl_803FECE8:
/* 803FECE8 003FAB28  80 85 00 04 */	lwz r4, 0x4(r5)
/* 803FECEC 003FAB2C  84 05 00 08 */	lwzu r0, 0x8(r5)
/* 803FECF0 003FAB30  90 86 00 04 */	stw r4, 0x4(r6)
/* 803FECF4 003FAB34  94 06 00 08 */	stwu r0, 0x8(r6)
...
/* 803FED14 003FAB54  98 03 00 01 */	stb r0, 0x1(r3)
/* 803FED18 003FAB58  88 04 00 02 */	lbz r0, 0x2(r4)
/* 803FED1C 003FAB5C  98 03 00 02 */	stb r0, 0x2(r3)
/* 803FED20 003FAB60  88 04 00 03 */	lbz r0, 0x3(r4)
/* 803FED24 003FAB64  98 03 00 03 */	stb r0, 0x3(r3)
/* 803FED28 003FAB68  88 04 00 04 */	lbz r0, 0x4(r4)
/* 803FED2C 003FAB6C  98 03 00 04 */	stb r0, 0x4(r3)
/* 803FED30 003FAB70  88 04 00 05 */	lbz r0, 0x5(r4)
/* 803FED34 003FAB74  98 03 00 05 */	stb r0, 0x5(r3)
/* 803FED38 003FAB78  80 04 00 08 */	lwz r0, 0x8(r4)
/* 803FED3C 003FAB7C  90 03 00 08 */	stw r0, 0x8(r3)
...
/* 803FED74 003FABB4  4B C0 85 D1 */	bl _savegpr_29
...
.global lbl_803FEDC4
lbl_803FEDC4:
/* 803FEDC4 003FAC04  80 64 00 04 */	lwz r3, 0x4(r4)
/* 803FEDC8 003FAC08  84 04 00 08 */	lwzu r0, 0x8(r4)
/* 803FEDCC 003FAC0C  90 65 00 04 */	stw r3, 0x4(r5)
/* 803FEDD0 003FAC10  94 05 00 08 */	stwu r0, 0x8(r5)
...
/* 803FEDE0 003FAC20  38 00 00 03 */	li r0, 0x3
/* 803FEDE4 003FAC24  7C 09 03 A6 */	mtctr r0
.global lbl_803FEDE8
lbl_803FEDE8:
/* 803FEDE8 003FAC28  80 64 00 04 */	lwz r3, 0x4(r4)
/* 803FEDEC 003FAC2C  84 04 00 08 */	lwzu r0, 0x8(r4)
/* 803FEDF0 003FAC30  90 65 00 04 */	stw r3, 0x4(r5)
/* 803FEDF4 003FAC34  94 05 00 08 */	stwu r0, 0x8(r5)
/* 803FEDF8 003FAC38  42 00 FF F0 */	bdnz lbl_803FEDE8
/* 803FEDFC 003FAC3C  80 04 00 04 */	lwz r0, 0x4(r4)
/* 803FEE00 003FAC40  90 05 00 04 */	stw r0, 0x4(r5)
/* 803FEE04 003FAC44  3B A0 00 00 */	li r29, 0x0
...
.global lbl_803FEE38
lbl_803FEE38:
/* 803FEE38 003FAC78  93 A3 00 04 */	stw r29, 0x4(r3)
/* 803FEE3C 003FAC7C  97 A3 00 08 */	stwu r29, 0x8(r3)
/* 803FEE40 003FAC80  42 00 FF F8 */	bdnz lbl_803FEE38
/* 803FEE44 003FAC84  93 A3 00 04 */	stw r29, 0x4(r3)
/* 803FEE48 003FAC88  38 BF 00 08 */	addi r5, r31, 0x8
...
.global lbl_803FEE58
lbl_803FEE58:
/* 803FEE58 003FAC98  80 64 00 04 */	lwz r3, 0x4(r4)
/* 803FEE5C 003FAC9C  84 04 00 08 */	lwzu r0, 0x8(r4)
/* 803FEE60 003FACA0  90 65 00 04 */	stw r3, 0x4(r5)
/* 803FEE64 003FACA4  94 05 00 08 */	stwu r0, 0x8(r5)
...
/* 803FEE74 003FACB4  3B C0 00 00 */	li r30, 0x0
/* 803FEE78 003FACB8  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 803FEED8 003FAD18  38 00 00 03 */	li r0, 0x3
/* 803FEEDC 003FAD1C  7C 09 03 A6 */	mtctr r0
.global lbl_803FEEE0
lbl_803FEEE0:
/* 803FEEE0 003FAD20  93 C3 00 04 */	stw r30, 0x4(r3)
/* 803FEEE4 003FAD24  97 C3 00 08 */	stwu r30, 0x8(r3)
...
/* 803FEF20 003FAD60  4B C0 84 71 */	bl _restgpr_29
...
/* 803FEF8C 003FADCC  4B C0 83 B9 */	bl _savegpr_29
/* 803FEF90 003FADD0  7C 7E 1B 78 */	mr r30, r3
/* 803FEF94 003FADD4  7C 9F 23 78 */	mr r31, r4
/* 803FEF98 003FADD8  38 A0 00 00 */	li r5, 0x0
/* 803FEF9C 003FADDC  90 A3 00 00 */	stw r5, 0x0(r3)
/* 803FEFA0 003FADE0  80 04 03 B8 */	lwz r0, 0x3b8(r4)
/* 803FEFA4 003FADE4  2C 00 00 00 */	cmpwi r0, 0x0
/* 803FEFA8 003FADE8  41 82 00 10 */	beq lbl_803FEFB8
/* 803FEFAC 003FADEC  2C 00 00 01 */	cmpwi r0, 0x1
...
.global lbl_803FEFC4
lbl_803FEFC4:
/* 803FEFC4 003FAE04  90 A3 00 04 */	stw r5, 0x4(r3)
/* 803FEFC8 003FAE08  94 A3 00 08 */	stwu r5, 0x8(r3)
/* 803FEFCC 003FAE0C  42 00 FF F8 */	bdnz lbl_803FEFC4
/* 803FEFD0 003FAE10  90 A3 00 04 */	stw r5, 0x4(r3)
...
.global lbl_803FF09C
lbl_803FF09C:
/* 803FF09C 003FAEDC  80 64 00 04 */	lwz r3, 0x4(r4)
/* 803FF0A0 003FAEE0  84 04 00 08 */	lwzu r0, 0x8(r4)
/* 803FF0A4 003FAEE4  90 65 00 04 */	stw r3, 0x4(r5)
/* 803FF0A8 003FAEE8  94 05 00 08 */	stwu r0, 0x8(r5)
/* 803FF0AC 003FAEEC  42 00 FF F0 */	bdnz lbl_803FF09C
/* 803FF0B0 003FAEF0  80 04 00 04 */	lwz r0, 0x4(r4)
/* 803FF0B4 003FAEF4  90 05 00 04 */	stw r0, 0x4(r5)
...
.global lbl_803FF0E0
lbl_803FF0E0:
/* 803FF0E0 003FAF20  80 64 00 04 */	lwz r3, 0x4(r4)
/* 803FF0E4 003FAF24  84 04 00 08 */	lwzu r0, 0x8(r4)
/* 803FF0E8 003FAF28  90 65 00 04 */	stw r3, 0x4(r5)
...
/* 803FF120 003FAF60  4B C0 82 71 */	bl _restgpr_29
...
/* 803FF140 003FAF80  90 03 00 04 */	stw r0, 0x4(r3)
/* 803FF144 003FAF84  80 04 00 08 */	lwz r0, 0x8(r4)
/* 803FF148 003FAF88  90 03 00 08 */	stw r0, 0x8(r3)
...
/* 803FF15C 003FAF9C  38 00 00 07 */	li r0, 0x7
/* 803FF160 003FAFA0  7C 09 03 A6 */	mtctr r0
.global lbl_803FF164
lbl_803FF164:
/* 803FF164 003FAFA4  80 85 00 04 */	lwz r4, 0x4(r5)
/* 803FF168 003FAFA8  84 05 00 08 */	lwzu r0, 0x8(r5)
/* 803FF16C 003FAFAC  90 86 00 04 */	stw r4, 0x4(r6)
/* 803FF170 003FAFB0  94 06 00 08 */	stwu r0, 0x8(r6)
/* 803FF174 003FAFB4  42 00 FF F0 */	bdnz lbl_803FF164
/* 803FF178 003FAFB8  80 05 00 04 */	lwz r0, 0x4(r5)
...
/* 803FF190 003FAFD0  2C 00 00 01 */	cmpwi r0, 0x1
...
/* 803FF1FC 003FB03C  38 00 00 09 */	li r0, 0x9
...
/* 803FF224 003FB064  2C 04 00 00 */	cmpwi r4, 0x0
/* 803FF228 003FB068  4D 82 00 20 */	beqlr
/* 803FF22C 003FB06C  38 00 FF FF */	li r0, -0x1
...
/* 803FF250 003FB090  4B C0 80 F5 */	bl _savegpr_29
...
/* 803FF270 003FB0B0  81 83 00 00 */	lwz r12, 0x0(r3)
/* 803FF274 003FB0B4  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 803FF28C 003FB0CC  38 00 00 01 */	li r0, 0x1
/* 803FF290 003FB0D0  48 00 00 14 */	b lbl_803FF2A4
.global lbl_803FF294
lbl_803FF294:
/* 803FF294 003FB0D4  80 63 00 00 */	lwz r3, 0x0(r3)
.global lbl_803FF298
lbl_803FF298:
/* 803FF298 003FB0D8  2C 03 00 00 */	cmpwi r3, 0x0
/* 803FF29C 003FB0DC  40 82 FF E8 */	bne lbl_803FF284
/* 803FF2A0 003FB0E0  38 00 00 00 */	li r0, 0x0
.global lbl_803FF2A4
lbl_803FF2A4:
/* 803FF2A4 003FB0E4  2C 00 00 00 */	cmpwi r0, 0x0
/* 803FF2A8 003FB0E8  41 82 00 08 */	beq lbl_803FF2B0
/* 803FF2AC 003FB0EC  48 00 00 08 */	b lbl_803FF2B4
.global lbl_803FF2B0
lbl_803FF2B0:
/* 803FF2B0 003FB0F0  3B A0 00 00 */	li r29, 0x0
.global lbl_803FF2B4
lbl_803FF2B4:
...
/* 803FF32C 003FB16C  2C 00 00 04 */	cmpwi r0, 0x4
...
/* 803FF404 003FB244  38 00 00 00 */	li r0, 0x0
