...
.global "t_handler__19@unnamed@Alarm_cpp@FP7OSAlarmP9OSContext"
"t_handler__19@unnamed@Alarm_cpp@FP7OSAlarmP9OSContext":
...
/* 80405534 00401374  90 03 00 00 */	stw r0, 0x0(r3)
/* 80405538 00401378  48 00 00 99 */	bl init__Q24util5AlarmFv
/* 8040553C 0040137C  93 ED FB 50 */	stw r31, "object___Q33hel6common32ExplicitSingleton<Q24util5Alarm>"@sda21(r13)
...
/* 80405568 004013A8  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8040556C 004013AC  7C 7E 1B 78 */	mr r30, r3
/* 80405570 004013B0  7C 9F 23 78 */	mr r31, r4
/* 80405574 004013B4  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80405584 004013C4  90 03 00 00 */	stw r0, 0x0(r3)
/* 80405588 004013C8  38 00 00 00 */	li r0, 0x0
/* 8040558C 004013CC  90 0D FB 50 */	stw r0, "object___Q33hel6common32ExplicitSingleton<Q24util5Alarm>"@sda21(r13)
/* 80405590 004013D0  48 00 00 91 */	bl final__Q24util5AlarmFv
/* 80405594 004013D4  7F C3 F3 78 */	mr r3, r30
/* 80405598 004013D8  38 80 00 00 */	li r4, 0x0
/* 8040559C 004013DC  4B D6 FA 69 */	bl "__dt__Q33hel6common31ExplicitSingleton<Q23app5Reset>Fv"
/* 804055A0 004013E0  7F E0 07 34 */	extsh r0, r31
/* 804055A4 004013E4  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 804055BC 004013FC  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 804055E4 00401424  38 63 00 08 */	addi r3, r3, 0x8
/* 804055E8 00401428  4B C1 62 19 */	bl OSCreateAlarm
/* 804055EC 0040142C  80 AD FB 48 */	lwz r5, "T_PERIOD__19@unnamed@Alarm_cpp@"@sda21(r13)
/* 804055F0 00401430  80 CD FB 4C */	lwz r6, lbl_8055DF6C@sda21(r13)
/* 804055F4 00401434  38 7F 00 08 */	addi r3, r31, 0x8
/* 804055F8 00401438  7C C8 33 78 */	mr r8, r6
/* 804055FC 0040143C  7C A7 2B 78 */	mr r7, r5
/* 80405600 00401440  3C 80 80 40 */	lis r4, "t_handler__19@unnamed@Alarm_cpp@FP7OSAlarmP9OSContext"@ha
/* 80405604 00401444  39 24 55 14 */	addi r9, r4, "t_handler__19@unnamed@Alarm_cpp@FP7OSAlarmP9OSContext"@l
...
/* 80405638 00401478  30 03 FF FF */	addic r0, r3, -0x1
/* 8040563C 0040147C  7C 00 19 10 */	subfe r0, r0, r3
/* 80405640 00401480  98 01 00 08 */	stb r0, 0x8(r1)
/* 80405644 00401484  38 7F 00 08 */	addi r3, r31, 0x8
/* 80405648 00401488  4B C1 65 19 */	bl OSCancelAlarm
/* 8040564C 0040148C  38 61 00 08 */	addi r3, r1, 0x8
/* 80405650 00401490  38 80 FF FF */	li r4, -0x1
...
/* 80405684 004014C4  C8 22 E4 00 */	lfd f1, "@48924_80564380"@sda21(r2)
/* 80405688 004014C8  90 01 00 0C */	stw r0, 0xc(r1)
/* 8040568C 004014CC  3C 00 43 30 */	lis r0, 0x4330
/* 80405690 004014D0  90 01 00 08 */	stw r0, 0x8(r1)
/* 80405694 004014D4  C8 01 00 08 */	lfd f0, 0x8(r1)
/* 80405698 004014D8  EC 20 08 28 */	fsubs f1, f0, f1
/* 8040569C 004014DC  C0 02 E3 F8 */	lfs f0, "@48922_80564378"@sda21(r2)
/* 804056A0 004014E0  EC 20 00 72 */	fmuls f1, f0, f1
/* 804056A4 004014E4  4B C0 21 E5 */	bl __cvt_dbl_usll
/* 804056A8 004014E8  90 8D FB 4C */	stw r4, lbl_8055DF6C@sda21(r13)
/* 804056AC 004014EC  90 6D FB 48 */	stw r3, "T_PERIOD__19@unnamed@Alarm_cpp@"@sda21(r13)
...
.global "@48922_80564378"
"@48922_80564378":

	.4byte 0x3C888889
	.4byte 0

.global "@48924_80564380"
"@48924_80564380":
