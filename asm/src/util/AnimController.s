...
/* 80405708 00401548  C0 03 00 04 */	lfs f0, 0x4(r3)
/* 8040570C 0040154C  C0 23 00 08 */	lfs f1, 0x8(r3)
/* 80405710 00401550  EC 60 08 2A */	fadds f3, f0, f1
/* 80405714 00401554  38 00 00 00 */	li r0, 0x0
...
/* 80405744 00401584  4C 40 13 82 */	cror eq, lt, eq
/* 80405748 00401588  40 82 00 44 */	bne lbl_8040578C
/* 8040574C 0040158C  38 00 00 01 */	li r0, 0x1
...
/* 80405760 004015A0  4C 40 13 82 */	cror eq, lt, eq
...
/* 80405774 004015B4  38 00 00 01 */	li r0, 0x1
...
/* 804057D4 00401614  38 60 00 00 */	li r3, 0x0
...
/* 804057EC 0040162C  C0 23 00 00 */	lfs f1, 0x0(r3)
/* 804057F0 00401630  C0 03 00 04 */	lfs f0, 0x4(r3)
/* 804057F4 00401634  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 804057F8 00401638  4C 40 13 82 */	cror eq, lt, eq
/* 804057FC 0040163C  7C 60 00 26 */	mfcr r3
/* 80405800 00401640  54 63 1F FE */	extrwi r3, r3, 1, 2
...
/* 80405810 00401650  C0 03 00 04 */	lfs f0, 0x4(r3)
/* 80405814 00401654  FC 00 08 40 */	fcmpo cr0, f0, f1
/* 80405818 00401658  4C 40 13 82 */	cror eq, lt, eq
/* 8040581C 0040165C  7C 60 00 26 */	mfcr r3
/* 80405820 00401660  54 63 1F FE */	extrwi r3, r3, 1, 2
...
.global "@48941_80564388"
"@48941_80564388":

	.4byte 0

.global "@48942_8056438C"
"@48942_8056438C":
