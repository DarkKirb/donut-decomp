...
/* 80405CD8 00401B18  90 03 00 00 */	stw r0, 0x0(r3)
/* 80405CDC 00401B1C  90 83 00 04 */	stw r4, 0x4(r3)
/* 80405CE0 00401B20  38 A0 00 00 */	li r5, 0x0
/* 80405CE4 00401B24  90 A3 00 08 */	stw r5, 0x8(r3)
...
.global lbl_80405CF8
lbl_80405CF8:
/* 80405CF8 00401B38  90 A4 00 04 */	stw r5, 0x4(r4)
/* 80405CFC 00401B3C  94 A4 00 08 */	stwu r5, 0x8(r4)
...
/* 80405D18 00401B58  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80405D1C 00401B5C  7C 7E 1B 78 */	mr r30, r3
/* 80405D20 00401B60  7C 9F 23 78 */	mr r31, r4
/* 80405D24 00401B64  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80405D64 00401BA4  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80405D90 00401BD0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80405DC8 00401C08  80 03 00 08 */	lwz r0, 0x8(r3)
/* 80405DCC 00401C0C  2C 00 00 00 */	cmpwi r0, 0x0
...
.global lbl_80405DD8
lbl_80405DD8:
/* 80405DD8 00401C18  80 7F 00 04 */	lwz r3, 0x4(r31)
/* 80405DDC 00401C1C  7F E4 FB 78 */	mr r4, r31
/* 80405DE0 00401C20  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80405E3C 00401C7C  2C 00 00 00 */	cmpwi r0, 0x0
...
.global lbl_80405E48
lbl_80405E48:
/* 80405E48 00401C88  80 1F 00 08 */	lwz r0, 0x8(r31)
/* 80405E4C 00401C8C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80405E84 00401CC4  80 63 00 08 */	lwz r3, 0x8(r3)
/* 80405E88 00401CC8  38 80 FF FF */	li r4, -0x1
/* 80405E8C 00401CCC  81 83 00 00 */	lwz r12, 0x0(r3)
/* 80405E90 00401CD0  81 8C 00 08 */	lwz r12, 0x8(r12)
/* 80405E94 00401CD4  7D 89 03 A6 */	mtctr r12
/* 80405E98 00401CD8  4E 80 04 21 */	bctrl
/* 80405E9C 00401CDC  38 00 00 00 */	li r0, 0x0
/* 80405EA0 00401CE0  90 1F 00 08 */	stw r0, 0x8(r31)
...
/* 80405ED0 00401D10  38 80 FF FF */	li r4, -0x1
/* 80405ED4 00401D14  81 83 00 00 */	lwz r12, 0x0(r3)
/* 80405ED8 00401D18  81 8C 00 08 */	lwz r12, 0x8(r12)
/* 80405EDC 00401D1C  7D 89 03 A6 */	mtctr r12
/* 80405EE0 00401D20  4E 80 04 21 */	bctrl
/* 80405EE4 00401D24  38 00 00 00 */	li r0, 0x0
...
/* 80405F04 00401D44  2C 00 00 00 */	cmpwi r0, 0x0
