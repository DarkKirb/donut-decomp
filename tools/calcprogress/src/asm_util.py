...
class AsmUtil:
    ...
    @staticmethod
    def get_obj_files_mk_asm(obj_files_mk_path: str, asm_root: str,
                             obj_ext: str) -> List[str]:
    ...
    def get_section_type_from_name(name: str) -> int:
        ...
        """
        code = (".init", ".text")
        data = ("extab_", "extab", "._extab", "._exidx", "extabindex_",
                "extabindex", ".ctors", ".dtors", "._ctors", "._dtors",
                ".file", ".rodata", ".data", ".bss", ".sdata", ".sbss",
                ".sdata2", ".sbss2")
        if name in code:
    ...
    @staticmethod
    def get_obj_sections(obj_file: str, cw_map: Map, src_ext: str,
                         obj_ext: str) -> List["AsmUtil.Section"]:
                ...
                if sect_name not in sections_found:
                    try:
                        ...
                        section = AsmUtil.Section(
                            my_header.virt_ofs, my_header.size,
                            AsmUtil.get_section_type_from_name(sect_name))
    ...
    @staticmethod
    def get_obj_list_sections(obj_files: List[str], cw_map: Map, src_ext: str,
                              obj_ext: str) -> List["AsmUtil.Section"]:
        ...
        for obj_file in obj_files:
            sections += AsmUtil.get_obj_sections(obj_file, cw_map, src_ext,
                                                 obj_ext)
        return sections
